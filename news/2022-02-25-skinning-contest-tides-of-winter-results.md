...
The song selection menu greets us with a texture filled with mountains everywhere at the bottom section as if we are in the middle of Alps on a sightseeing tour. The remainder holds an elegant yet minimalistic aura, for which the creative structure of the pause and fail menus can be shown as an example. Furthermore, the gameplay section from top to bottom is left fairly simple, which goes with the general theme fascinatingly well! If you don't believe my words, check what sort of a masterpiece Azure Snowfall really is!
