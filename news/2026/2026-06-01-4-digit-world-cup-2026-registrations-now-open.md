...
As the longest-running rank-restricted world cup since its inception in 2018, the [4 Digit World Cup](Link!!!) has always sought to deliver on its promise to be the premier tournament for 4 digits (#1,000–9,999).

## What's new?

With its 9th iteration, 4WC2026 sees an all-new organising team in Project Hexagon. Hailing from the 6-digit tournament community, Project Hexagon is a group lead by ::{ flag=SG }:: [gamicrayola](https://osu.ppy.sh/users/29426345), ::{ flag=GB }:: [pericrayola](https://osu.ppy.sh/users/31184671), ::{ flag=UA }:: [Filoxen](https://osu.ppy.sh/users/24454271), ::{ flag=CH }:: [MirageFire](https://osu.ppy.sh/users/5316973) and ::{ flag=GB }:: [willwam](https://osu.ppy.sh/users/11674122), which seeks to uplift the baseline and innovate the peaks of tournament production.
...
To register, simply head over to the [registration form](link!!!). Players who sign up and meet the following criteria will be eligible to participate:

- You must not have violated the [osu! community rules](/wiki/Rules) within the past 12 months.
- You are within global rank #1,000–9,999 at the time of registrations closing. (21 June, 23:59 UTC)
