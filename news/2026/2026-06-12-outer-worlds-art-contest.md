...
Let go of earthly attachments and join our mascots beyond the stars, where the sky is no longer the limit!

![](/wiki/shared/news/2026-06-12-outer-worlds-art-contest/banner.jpg)

The summer solstice is upon us, and with it comes the time for our seasonal art contest! This year, we're taking a step beyond the familiar and inviting you to a journey beyond the boundaries of our world.

Your mission is simple...

**Draw any of the osu! (or community) mascots exploring the outer reaches of the osu!verse!**

Whether it's on the surface of a moon, floating in space beneath a sea of stars, or exploring the depth of a world overtaken by evil Dons, the possibilities are endless. As long as you're somewhere beyond Mother Earth, you're good!

Need more examples to help you kickstart your imagination? Here are some to get you started:
...
Don't forget to grab any of the existing [Spring 2026 Fanart Contest](https://osu.ppy.sh/home/news/2026-04-12-spring-2026-fanart-results) banners for extra profile drip before they disappear forever!

## Rules

- **By submitting your artwork to this contest, you grant us permission to use your artwork in the main menu client should it win, and to use it in promotional material for both the game (osu!) and the contest (Outer Worlds Art Contest).** You retain all rights to your creation and you can sell it and distribute it however you like — it's your work, after all. We're just saying here that if you submit your piece to this contest, you should be okay with us using it.
...
- **Do NOT leave the dotted osu! cookie template visible in your submission.** Keep the streak going, or you pillow will always be too warm at night. We will make sure of it.
...
*Header and promotional artwork by finalist [{{NAME}}](https://osu.ppy.sh/users/{{ID}}) from the [{{SOURCE}}]({{URL}})!*

If you've made it this far, you're ready start cooking up your masterpiece! When you're done, head over to the [Outer Worlds Art Contest listing](https://osu.ppy.sh/community/contests/284) and drag-and-drop your entry into the box with the plus sign in it.

You may reupload your entry to your heart's content if you want to make any adjustments, but you only have **21 days** to do so before the doors close off forever (6 July 2026, 18:00 UTC), so don't linger too long pondering how many stars to dot across the background.

Don't forget to also tag your social media posts with `#osufanart` for the world to see!

Safe travels, space cadets!
