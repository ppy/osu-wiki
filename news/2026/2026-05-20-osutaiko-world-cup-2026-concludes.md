...
Something seemed to change in Korea, though. A double FC from ::{ flag=KR }:: ::Peaceful::{ user=165027 } and ::{ flag=KR }:: [applerss](https://osu.ppy.sh/users/983349/taiko) on [HD2](https://osu.ppy.sh/beatmapsets/2541457#taiko/5627104) got them on the board, but just as quickly, Japan whipped out a double FC on DT1, with an astonishing 99.03% from mechanics superstar ::{ flag=JP }:: ::\1Kan2::{ user=7160196 }, and claimed another break point on [NM4](https://osu.ppy.sh/beatmapsets/2541555#taiko/5627367) to secure five match points. All hope seemed lost again, as it tends to be when your opponent invented the game you're playing.
...
With the illustration assets provided by ::Arushii::{ user=15664628 }, [-pineapple-](https://osu.ppy.sh/users/11523326), ::naraicat::{ user=6419788 } and [Panthullu](https://osu.ppy.sh/users/12580298), we were able to make our ambitious design scope possible to achieve.

As we continued to work on each section of the storyboard, we also received help from both VFX and GFX designers, with ::Polytetral::{ user=8612061 } and [AlexDunk](https://osu.ppy.sh/users/9194799) making more assets for us to animate. Notably, I was able to animate the interface design for the last kiai of the song.
