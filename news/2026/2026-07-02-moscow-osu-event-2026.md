...
The main game mode tournament has already went through both the open and closed qualifiers, with the following players taking guaranteed slots in the bracket: ::{ flag=BY }:: ::twennity::{ user-id=15803625 }, ::{ flag=RU }:: ::villix::{ user-id=12739835 }, ::{ flag=RU }:: ::Hober38::{ user-id=19887342 }, ::{ flag=RU }:: ::shadevr::{ user-id=8165685 }, ::{ flag=RU }:: ::GodRoPoNiKa::{ user-id=11195861 }, ::{ flag=RU }:: ::fedotoff::{ user-id=7351448 }, ::{ flag=RU }:: ::Antaanar::{ user-id=13206785 } and ::{ flag=RU }:: ::My Angel Kita::{ user-id=21101642 }. With 8 more directly invited players to be announced soon, a total of 16 participants will compete against each other on stage!
