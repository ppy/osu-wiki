...
From around the world, players fought tooth and nail for their chance to take the Waifu Cup. This iteration of Battle of the Box, the flagship tournament of ::xootynator::{ user=3717598 }, was filled with close matches and nail-biter moments, but finally, after a month of competition, a new champion has been crowned!
...
Congratulations to ::{ flag=PL }:: ::MALISZEWSKI::{ user=12408961 }, ::{ flag=PL }:: ::liliel::{ user=13108233 }, ::{ flag=PL }:: ::Ivaxa::{ user=15406985 } and ::{ flag=PL }:: ::ecca::{ user=30947671 } for winning the Waifu Cup! Fun fact: this was MALISZEWSKI's third time participating and their first-ever first-place finish! They beat the odds, coming back from the losers' bracket and securing a 7–2 bracket reset victory against ::{ flag=KR }:: ::Suyong\1::{ user=8799923 }, ::{ flag=KR }:: ::FlyingTuna::{ user=9224078 }, ::{ flag=KR }:: ::\1Karcher\1::{ user=11443437 } and ::{ flag=KR }:: ::mx10000::{ user=3730848 }, who finished in 2nd place. Finally, shout-outs to our 3rd-place-finishing team, which consisted of ::{ flag=KR }:: ::Amamya Kokoro::{ user=2511839 }, ::{ flag=HK }:: ::misha awa::{ user=14503423 }, ::{ flag=KR }:: ::Chipori::{ user=7027766 } and ::{ flag=KR }:: ::KRZY::{ user=114017 }!
...
<div class="osu-md__paragraph">
    <audio controls>
        <source src="https://assets.ppy.sh/media/news/2026-05-05-inochi.mp3">
    </audio>
</div>
...
<div class="osu-md__paragraph">
    <audio controls>
        <source src="https://assets.ppy.sh/media/news/2026-05-05-kageutsushi.mp3">
    </audio>
</div>
...
<div class="osu-md__paragraph">
    <audio controls>
        <source src="https://assets.ppy.sh/media/news/2026-05-05-hanashite.mp3">
    </audio>
</div>
...
<div class="osu-md__paragraph">
    <audio controls>
        <source src="https://assets.ppy.sh/media/news/2026-05-05-constellations.mp3">
    </audio>
</div>
...
<div class="osu-md__paragraph">
    <audio controls>
        <source src="https://assets.ppy.sh/media/news/2026-05-05-kehai.mp3">
    </audio>
</div>

## Staff shoutout

Every Battle of the Box wouldn't be possible without the contributions of its staff. With the most customs ever recorded in this tournament's history at **46**, the creativity was on full display for everyone to see!

To our team of tournament staff and contributors, of which the number exceeds **over 150**, we'd like to thank each and every one of you for the work that you've done! This tournament wouldn't be possible without the efforts of everyone who's poured their heart and soul into making it a success.

---

And with that, Battle of the Box shutters its doors for the foreseeable future. We can't promise when the next Battle of the Box will be, if there will even be one, but we're glad that we can end it on such a high note.

To commemorate this, both of us hosts wanted to write a personal message to all of you:
...
Once again, *thank you* to everyone for enjoying Battle of the Box over the years. This isn't goodbye, but instead, see you next time.
