---
layout: post
title: Mappers' Guild - Summer 2026 Priority Quests
date: 2026-08-06 04:00:00 +0000
series: mappers_guild
---

Most players who open the editor close it within 5 minutes. Only a few are brave enough to fully create their own maps, and even fewer have what it takes to complete the newest batch of Mappers' Guild quests.

![](/wiki/shared/news/banners/mappersguild.png)

The [**Mappers' Guild**](/wiki/Community/Mappers_Guild) is an MMO-inspired mapping system surrounding osu!'s [Featured Artists](https://osu.ppy.sh/beatmaps/artists). Mappers can [earn rewards](/wiki/Community/Mappers_Guild#rewards) for completing mapping-related tasks, like ranking maps and collaborating on [quests](/wiki/Community/Mappers_Guild#quests).

Despite the intimidating intro above, the Mappers' Guild is open to mappers of any skill level, including those without Ranked maps! See the [system's website](https://mappersguild.com/) or the [osu! Discord server](https://discord.com/invite/ppy)'s `#mappers-guild` channel for details.
...
The [priority quest board](https://mappersguild.com/missions) has **7** newly added quests! These will be available until **November 25, 2026**, with one exception. You can probably guess which it is.
...
It's time to undergo the Mappers' Guild initiation: rank your **first Featured Artist map** using any song from [osu!'s music library](https://osu.ppy.sh/beatmaps/artists)!
...
1. Find a Featured Artist page with at least 4 songs total, and 1 or more songs that aren't Ranked/Loved as of this quest's start date.
