...
| Phase | Day |
| --: | :-- |
| Registration closes | June 15th (0:00 UTC) |
...
Go to the [CTA website](https://cta.sheppsu.me/) and login by clicking the osu! logo in the top right (or in the header dropdown on mobile). On your dashboard page, there will be a button to register. Assuming you pass screening, you'll be eligible to participate. From there, you can create and join teams or change your free agent settings.
...
If you have any unanswered questions, try checking the FAQ section on the [CTA website](https://cta.sheppsu.me/) or joining the [Discord server](https://discord.gg/kuE5mTZgqK) and asking there (feel free to ping/direct message me @sheppsu).
