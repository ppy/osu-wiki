...
**[Download the mappool here! (131 MB)](https://packs.ppy.sh/P320%20-%20osu%21taiko%20World%20Cup%202026%3A%20Finals.zip)**
...
osu! original enjoyers ate good this week, with two brand-new songs being released for this year's osu!taiko World Cup Finals.
...
### ::{ flag=BR }:: Brazil vs. ::{ flag=TW }:: Taiwan

**[View the match information here!](https://osu.ppy.sh/community/matches/120962349)**
...
Welcome to the group interview! It's great to see many of the same designers returning to work on this sequel, including all of you on the storyboard team. How did it feel to return and work on a much more uplifting narrative this time? Did anything change in the way you collaborated on the storyboard?
...
For the majority of the projects I've been in, the narrative was always towards the dark side, leading to a gloomy storyboard. This storyboard was definitely a breath of fresh air from that! Nothing really changed from how I storyboarded before, I always lean towards the creative side of storyboarding and experiment a lot. This leads to a lot of unique storyboards that hopefully leave a mark on everyone that watches them!
...
Throughout the storyboard we saw Tatsuma meeting each osu! mascot one by one and helping them overcome their challenges before they join him on the journey. How did you approach building Tatsuma's journey through these individual encounters?
...
Working on Tatsuma's encounters with Mocha, pippi, the slimes, and the "love interest" Yuzu involved quite a bit of effort from the planning to execution of each of the scenes, with each scene intentionally leading into another. For example, the building minigame and airship scenes were all built around Yuzu being an angel for Tatsuma and the team to catch.
...
When working on each mini story, how did you decide what kind of visuals or interactions to use to represent each mascot's situation and Tatsuma's role in helping them? Were there any technical difficulties for your individual storyboard sections?
