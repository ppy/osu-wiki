...
<div align="center" class="osu-md__paragraph">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/media/news/aspire-6-voting.mp4" type="video/mp4" preload="none">
    </video>
</div>

That said, the best way to experience and vote for the entries is to actually play each of them, since we can't do all of them justice in ~15 seconds or so.
...
Note that if an entry wins on multiple categories, it will still receive a reward equivalent of one. On that note, the prizes for this contest are as follows:

**Aspirant**, awarded to the winners of each Aspire category. Both participants will receive:
...
**Runner-Up**, awarded to runner-ups and honourable mentions of each category. Honourable mentions are entries selected by the osu!team that are deemed worthy of a special mention.
...
Depending on the vote distribution, we may also consider awarding a mapper's pick.

## Entries

Here's a full list of entries. As mentioned, we recommend playing or viewing all entries before voting. Video links can be found on each beatmap page as an alternative.
