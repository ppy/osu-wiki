...
The 33rd cycle of the Community Mentorship Program is about to begin! Get ready to delve deep into the world of mapping, modding, or storyboarding.
...
If you're interested in the program, please read the [forum post](https://osu.ppy.sh/community/forums/topics/2190873?n=1) for a full rundown on how to apply. 

The mentee signups are currently open, and close on the **26th of April**!
...
| ::{ flag=US }:: ::-White::{ user=16276548 } | UTC-4 |
| ::{ flag=CA }:: ::Sparhten::{ user=7601720 } | UTC-3:30 |
| ::{ flag=GB }:: ::mnyui::{ user=14261540 } | UTC+0 |
...
| ::{ flag=FI }:: ::fllecc::{ user=14060327 } | UTC+3 |
...
| ::{ flag=DE }:: ::Undead Alice::{ user=17415683 } | UTC+2 |
...
| :-- | :-- | :-- |
| ::{ flag=US }:: ::Scorf::{ user=17038784 } | osu! | UTC-8 |
...
| ::{ flag=CN }:: ::Carpihat::{ user=10085090 } | osu!mania | UTC+2 |
| ::{ flag=CN }:: ::Breakrio::{ user=1653229 } | osu!mania | UTC+8 |
| ::{ flag=KR }:: ::SN707::{ user=31404061 } | osu!taiko | UTC+9 |
| ::{ flag=DE }:: ::DizzyOracel::{ user=32159666 } | osu!catch | UTC+2 |
| ::{ flag=AT }:: ::Daletto::{ user=7592136 } | osu!catch | UTC+2 |
...
| Mentor | Time zone |
| :-- | :-- |
| ::{ flag=US }:: ::Noffy::{ user=1541323 } & ::{ flag=IT }:: ::Kuroise::{ user=14547127 } | UTC-5 & UTC+2 |
