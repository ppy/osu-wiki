...
date: 2026-01-25 12:30:00 +0000
series: world_cups
---

The osu!mania 7K World Cup has begun with a bang! As the new year kicks off, so did this year's first World Cup.
...
We're also fortunate enough to have the support of ::yukina meng::{ user-id=9919550 }, [Normiplier](https://osu.ppy.sh/users/10069850), ::epic man 2::{ user-id=14566000 }, [SurfChu85](https://osu.ppy.sh/users/4469895), and ::SunApple::{ user-id=11817622 } who have been of great help to make this year's video recaps possible. Please look forward to their weekly recap in video form if you prefer a different medium!
...
| Seed | Country | Rank | Avg. score | Seed | Country | Rank | Avg. score |
| :-: | :-- | --: | --: | :-: | :-- | --: | --: |
| #1 | ::{ flag=KR }:: South Korea | 10 | 1,980,643 | #23 | ::{ flag=PT }:: Portugal | 194 | 1,879,349 |
| #2 | ::{ flag=PH }:: Philippines | 26 | 1,965,757 | #24 | ::{ flag=NL }:: Netherlands | 231 | 1,850,985 |
| #3 | ::{ flag=CN }:: China | 28 | 1,968,368 | #25 | ::{ flag=IE }:: Ireland | 233 | 1,845,671 |
| #4 | ::{ flag=ID }:: Indonesia | 40 | 1,959,173 | #26 | ::{ flag=BR }:: Brazil | 245 | 1,826,634 |
| #5 | ::{ flag=JP }:: Japan | 60 | 1,953,021 | #27 | ::{ flag=GB }:: United Kingdom | 253 | 1,837,520 |
| #6 | ::{ flag=PE }:: Peru | 60 | 1,946,384 | #28 | ::{ flag=NO }:: Norway | 253 | 1,834,573 |
| #7 | ::{ flag=HK }:: Hong Kong | 62 | 1,950,067 | #29 | ::{ flag=MO }:: Macau | 255 | 1,825,180 |
| #8 | ::{ flag=AU }:: Australia | 82 | 1,934,315 | #30 | ::{ flag=IT }:: Italy | 263 | 1,823,766 |
| #9 | ::{ flag=US }:: United States | 99 | 1,929,976 | #31 | ::{ flag=SG }:: Singapore | 279 | 1,803,559 |
| #10 | ::{ flag=TH }:: Thailand | 103 | 1,936,569 | #32 | ::{ flag=DK }:: Denmark | 282 | 1,795,580 |
| #11 | ::{ flag=PL }:: Poland | 103 | 1,927,569 | #33 | ::{ flag=LT }:: Lithuania | 286 | 1,790,505 |
| #12 | ::{ flag=VE }:: Venezuela | 119 | 1,922,440 | #34 | ::{ flag=FI }:: Finland | 288 | 1,806,578 |
| #13 | ::{ flag=RU }:: Russian Federation | 128 | 1,917,392 | #35 | ::{ flag=UA }:: Ukraine | 307 | 1,766,451 |
| #14 | ::{ flag=DE }:: Germany | 133 | 1,917,579 | #36 | ::{ flag=CL }:: Chile | 323 | 1,747,820 |
| #15 | ::{ flag=ES }:: Spain | 133 | 1,911,772 | #37 | ::{ flag=CO }:: Colombia | 324 | 1,748,565 |
| #16 | ::{ flag=FR }:: France | 136 | 1,917,809 | #38 | ::{ flag=MY }:: Malaysia | 336 | 1,720,946 |
| #17 | ::{ flag=CA }:: Canada | 140 | 1,909,112 | #39 | ::{ flag=CZ }:: Czechia | 350 | 1,621,636 |
| #18 | ::{ flag=SE }:: Sweden | 155 | 1,902,436 | #40 | ::{ flag=PK }:: Pakistan | 363 | 1,489,210 |
| #19 | ::{ flag=MX }:: Mexico | 162 | 1,903,082 | #41 | ::{ flag=KZ }:: Kazakhstan | 367 | 1,446,707 |
| #20 | ::{ flag=NZ }:: New Zealand | 165 | 1,900,508 | #42 | ::{ flag=BY }:: Belarus | 376 | 1,350,358 |
...
[**Download the pool here! (71 MB)**](https://osu.ppy.sh/beatmaps/packs/P309)

<div align="center" class="osu-md__paragraph">
    <iframe width="95%" style="aspect-ratio: 16 / 9;" src="https://player.twitch.tv/?video=2667622438&parent=osu.ppy.sh&autoplay=false&t=1h31m26s" frameborder="0" allowfullscreen="true" scrolling="no"></iframe>
</div>
...
The only exception to this was [Lin Xiao An - Tan Yun Xi](https://osu.ppy.sh/beatmapsets/2491926#mania/5475120) (LN2) by ::{ flag=CN }:: ::ExNeko::{ user-id=7590894 }. For those who have been following the series, this should not come as a surprise. The long note coordination picks are usually not the easiest ones to perform well in, even for our seasoned long note veterans. As such, this map was banned in 11 out of 16 matches.

On the opposite end, we had [KORDHELL x VALORANT - VYSE](https://osu.ppy.sh/beatmapsets/2491995#mania/5475288) (RC4) by ::{ flag=TW }:: ::Slowpoke104::{ user-id=23633474 }. Chordjack picks, especially those found in earlier rounds, are considered to be the easiest to get high accuracy on. Indeed, this week's highest scores were achieved on this very map, as seen in the [mappool statistics](https://docs.google.com/spreadsheets/d/1A0FwQaeqKzIrdANh-lGrzHEE793lbiWry8SodZ2Q0Ag/edit?rm=minimal&gid=1348598934#gid=1348598934).

## Round of 32 summary

| Team A |  |  | Team B |
| --: | :-: | :-: | :-- |
| Australia ::{ flag=AU }:: | 3 | **5** | ::{ flag=IE }:: **Ireland** |
| **Russian Federation** ::{ flag=RU }:: | **5** | 1 | ::{ flag=NZ }:: New Zealand |
| **Japan** ::{ flag=JP }:: | **5** | 0 | ::{ flag=NO }:: Norway |
| **South Korea** ::{ flag=KR }:: | **5** | 0 | ::{ flag=DK }:: Denmark |
| **Venezuela** ::{ flag=VE }:: | **5** | 4 | ::{ flag=TW }:: Taiwan |
| **Thailand** ::{ flag=TH }:: | **5** | 4 | ::{ flag=PT }:: Portugal |
| **Hong Kong** ::{ flag=HK }:: | **5** | 0 | ::{ flag=BR }:: Brazil |
| France ::{ flag=FR }:: | 4 | **5** | ::{ flag=CA }:: **Canada** |
| **United States** ::{ flag=US }:: | **5** | 1 | ::{ flag=NL }:: Netherlands |
| **Philippines** ::{ flag=PH }:: | **5** | 0 | ::{ flag=SG }:: Singapore |
| **China** ::{ flag=CN }:: | **5** | 1 | ::{ flag=IT }:: Italy |
| **Poland** ::{ flag=PL }:: | **5** | 0 | ::{ flag=VN }:: Vietnam |
| **Indonesia** ::{ flag=ID }:: | **5** | 1 | ::{ flag=MO }:: Macau |
| **Peru** ::{ flag=PE }:: | **5** | 0 | ::{ flag=GB }:: United Kingdom |
...
**[You can view the match information here!](https://osu.ppy.sh/community/matches/120329536)**\
...
The teams continued trading points, with Canada claiming most of the rice picks while France dominated the long note category, highlighting the strengths of their respective skill sets. The tides shifted when Canada picked [KORDHELL x VALORANT - VYSE](https://osu.ppy.sh/beatmapsets/2491995#mania/5475288) (RC4). In a series of unfortunate events, Canada suffered multiple misses, handing France their first rice pick win and a crucial break point. Notably, three out of four players — ::{ flag=FR }:: ::\[RUE\]Clamati::{ user-id=9049282 }, ::{ flag=FR }:: ::Jerem\[Monkey\]::{ user-id=13431947 }, and ::{ flag=CA }:: ::Dale940::{ user-id=13847951 } — achieved scores above 999,000. What an impressive display of accuracy!

With France consistently winning their LN picks, they chose [Qutabire - Stone pavement and Signposts](https://osu.ppy.sh/beatmapsets/2491958#mania/5475187) (EX2), confident it would seal the match. Unfortunately for France, the strategy backfired. During the second half of the map, Canada managed to overtake their score, forcing a tiebreaker. This clutch was in no small part won thanks to ::{ flag=CA }:: ::UmmmMrMoo::{ user-id=15314355 }'s performance, who managed to score a total of 994,034 points on one of the pool's most avoided picks.
...
- Two Canadian heroes, ::{ flag=CA }:: ::Sawdust Inhaler::{ user-id=18236316 } and ::{ flag=CA }:: ::UmmmMrMoo::{ user-id=15314355 }, showed us that skill ceilings are only skill suggestions, by top scoring [C.miler vs Juka_Box - ABYSSAL // COSMOS](https://osu.ppy.sh/beatmapsets/2491945#mania/5475152) (EX1) and [Qutabire - Stone pavement and Signposts](https://osu.ppy.sh/beatmapsets/2491958#mania/5475187) (EX2) respectively.
- Everyone was in awe of Thailand's returning veteran, ::{ flag=TH }:: ::LostCool::{ user-id=766374 }, who managed to top the scores on **all** three regular hybrid picks during the weekend. Very cool, indeed!
- An early-round recap would not be complete without highlighting the nuttiest scores on the chordjack pick, [KORDHELL x VALORANT - VYSE](https://osu.ppy.sh/beatmapsets/2491995#mania/5475288) (RC4). There were a whopping eleven (!!) players that hit the 999,000 score mark, but the crown went to both ::{ flag=KR }:: ::Kalkai::{ user-id=10790649 } and ::{ flag=JP }:: ::rainlily::{ user-id=485007 } who tied at 999,699. 301 points away from perfection.

---

We really hope you've enjoyed these three weeks of matches thus far — we sure have! For those who want to join in on the fun, feel free to spectate the last Round of 16 matches on [osulive](https://www.twitch.tv/osulive) or [osulive_2](https://www.twitch.tv/osulive_2), or join us next week for the next recap. And for those looking for any extra deets, the [wiki](/wiki/Tournaments/MWC/2026_7k) will have everything you may need!
