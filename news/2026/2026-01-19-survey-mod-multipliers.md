...
Many thanks to ::{ flag=PL }:: ::Maklovitz::{ user=9217626 }, ::{ flag=FI }:: ::Nyanaro::{ user=4157611 }, ::{ flag=UA }:: ::SomeMelGuy::{ user=8706541 }, ::{ flag=RU }:: ::StanR::{ user=7217455 }, ::{ flag=GB }:: ::tsunyoku::{ user=11315329 } and ::{ flag=FR }:: ::Zyf::{ user=7475179 }, who were involved in organising the survey and programming the spreadsheet. Also big thanks to ::{ flag=GB }:: ::Tanza::{ user=10379965 } for the cool banner.
