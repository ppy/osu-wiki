...
Breaking the mould in mapping is oftentimes a difficult affair. To find novel ways to exploit the game's most obscure quirks and to make a beatmap that is either visually and/or technically impressive is no easy task — let alone when running a race against the (contest's) clock!

This year was no different, leaving us with 40 awesome entries across all gamemodes. After tasking the community with [voting](https://osu.ppy.sh/home/news/2026-08-26-aspire-6-voting) for their favourites, we finally got the results everyone involved was so eagerly waiting for.
...
Despite six iterations of Aspire, we are still seeing exciting new things from the osu! editor. We still have no idea how limitless the possibilities are - the entries this year have shown us proof of that, some even without glitches. We must refine the format in order to bring out the best that the Ranking Criteria cannot offer.
