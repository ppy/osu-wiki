...
As if modern tech wasn't enough, ::Karoo13::{ user=1882522 } and ::Emotive::{ user=12381359 } have found a way to exploit an older version of osu!'s file format to create some truly whacky sliders, likely unlike anything you've seen.
...
Mappers ::add222::{ user=14261013 } and ::\_necroplasma::{ user=10805852 } used all techniques at their disposal including sliders distorted in every way possible, slider tick art, auto-played notes, and disjointed combo numbers, all for a showcase that paints the entire screen in sliders.
...
Very much leaning into the innovative gameplay call from Aspire is *HDHR*, mapped by ::PukPow::{ user=16407679 } and ::Zuika::{ user=10222009 }.
...
Throwing out the ranking criteria doesn't mean you have to rely on glitches to make your map stand out, and ::fowwo::{ user=4547551 } has proven just that with their entry.
...
::TheShadowOfDark::{ user=5795337 } and ::TheMagicAnimals::{ user=17274052 } made use of invisible sliders to make slider balls dancing around the playfield, making for an entry just as visually charming as it is fun to play.
...
When submitting their entry, ::Solor::{ user=25201175 } left us with the comment "quality over quantity", and it appears their philosophy has paid off.
...
Pushing the editor to the *limit*, ::Natsuko::{ user=8266817 } and ::Pitsuwa::{ user=8417565 } managed to place hypers where they shouldn't be possible.
...
This was storyboarding on a scale where it feels like a completely different game. Veterans of VSRGs are no stranger to visual gimmicks that challenge the player on their reading, but ::Tunnelblick::{ user=7737096 } and ::Utiba::{ user=11354436 } have got the technique of their creation down to near perfection.
...
Those looking for a more pure Aspire experience within osu!mania should look no further than with ::DraterTD::{ user=11671725 }'s entry of *Amethyst Aurora*.
...
Special congratulations to ::-Arko::{ user=8802914 }, ::blixys::{ user=13015896 }, ::Solor::{ user=25201175 }, ::Natsuko::{ user=8266817 }, ::Pitsuwa::{ user=8417565 }, ::Tunnelblick::{ user=7737096 }, and ::Utiba::{ user=11354436 }, our new Aspirants! Thank you for playing and see you next time!
