...
| [![YouTube](/wiki/shared/link/YouTube.png)](https://www.youtube.com/watch?v=1niNWsor54A "YouTube") [![Spotify](/wiki/shared/link/Spotify.png)](https://open.spotify.com/track/5IASQtdb2UDLdqOakVt5H3 "Spotify") | Ariabl'eyeS - Houkai no Bigaku | [![#1](/wiki/shared/link/Link.png)](https://osu.ppy.sh/beatmapsets/2401063) | CLAN2025 Day 2 HR1 |
| [![YouTube](/wiki/shared/link/YouTube.png)](https://www.youtube.com/watch?v=qgXgNCqL4C4 "YouTube") | Umeboshi Chazuke - Ao to Shiro no Hanataba wo | [![#1](/wiki/shared/link/Link.png)](https://osu.ppy.sh/beatmapsets/2401706) | CLAN2025 Day 2 HR4 |
| [![SoundCloud](/wiki/shared/link/SoundCloud.png)](https://soundcloud.com/halvsan/halv-akashic-hex "SoundCloud") [![Spotify](/wiki/shared/link/Spotify.png)](https://open.spotify.com/track/64RHNpQWs6uFz63X8fWrD3 "Spotify") | Halv - Akashic Hex | [![#1](/wiki/shared/link/Link.png)](https://osu.ppy.sh/beatmapsets/2401984) | CLAN2025 Day 2 TB |
|  | Aquine - Kabaki Komachi | [![#1](/wiki/shared/link/Link.png)](https://osu.ppy.sh/beatmapsets/2414333) | OCNCCS2 F & GF TB |
| [![YouTube](/wiki/shared/link/YouTube.png)](https://www.youtube.com/watch?v=TTC2WsL8648 "YouTube") | Now Field vs. uRyo - Bargentos | [![#1](/wiki/shared/link/Link.png)](https://osu.ppy.sh/beatmapsets/2407072) | otst:live! Face-off TB |
...
- **osu! World Cup**: ::{ flag=CN }:: China and ::{ flag=TW }:: Taiwan maintained steady performances, securing **Top 12** and **Top 16** placements respectively. ::{ flag=HK }:: Hong Kong, despite a major roster overhaul, advanced through the Qualifiers as the #40 seed. In a notable Group Stage encounter against ::{ flag=GR }:: Greece, ::{ flag=HK }:: ::misha awa::{ user=14503423 } played all 9 maps with a staggering 2.3 match cost to **lead a 5–4 comeback victory**, securing a hard-fought win to close out their campaign. Meanwhile, ::{ flag=MO }:: Macau showed significant growth following their 2024 return after a decade-long hiatus. They achieved a notably higher Qualifier rank this year with a compact 7-player roster, proving that even small communities possess immense vitality.
...
- **[5 Digit Taiwanese Showdown 2.5](https://osu.ppy.sh/community/forums/topics/2029518?n=1) & [3](https://osu.ppy.sh/community/forums/topics/2110474?n=1)**: These two iterations saw ::{ flag=TW }:: ::[ Luka ]::{ user=11923800 } and ::{ flag=TW }:: ::YoYu::{ user=10391882 } take their respective titles, proving themselves as the future of the Taiwanese scene.
- **[Osu For Fun Cup 5](https://osu.ppy.sh/community/forums/topics/2074099?n=1)**: Featuring a KOF-style format, this tournament required strategic planning to balance skill gaps within teams. Team **daiimu到處欠錢** (::{ flag=TW }:: ::GAO HAO::{ user=8964050 },::{ flag=TW }:: ::koutya_::{ user=14912108 }, ::{ flag=CN }:: ::Firia::{ user=9164037 }, and ::{ flag=TW }:: ::zomcys::{ user=1580033 }) ultimately claimed victory.
- **[Hello! Shanden Cup 5 : Limit Break](https://osu.ppy.sh/community/forums/topics/2142841?n=1)**: The year-end finale featured a "Limit Break" theme with more complex rules and difficult mappools. Team **大家好我是陳義與...** (::{ flag=TW }:: ::daiimu::{ user=17792515 }, ::{ flag=TW }:: ::Summer_Ouo::{ user=15184992 }, ::{ flag=TW }:: ::YoYu::{ user=10391882 }, and ::{ flag=TW }:: ::[ Luka ]::{ user=11923800 }) emerged victorious after an intense two-set Grand Final.
...
In the competitive mapping scene, **2025** has proven to be a rewarding year for the mapping community of Greater China, marked by standout performances across a wide selection of mapping contests.
...
The team **Hexagram**, consisting of ::{ flag=HK }:: ::Chaoslitz::{ user=3621552 }, ::{ flag=HK }:: ::Otosaka-Yu::{ user=3170678 }, ::{ flag=HK }:: ::seros::{ user=10562853 }, ::{ flag=KR }:: ::momoyo::{ user=12469536 }, and ::{ flag=JP }:: ::TARA-376::{ user=37407910 }, claimed **1st place** on the community vote, showcasing a contribution widely appreciated by the osu! community. Their [beatmap](https://osu.ppy.sh/beatmapsets/2412260) is bundled with the osu! client, so be sure to check it out!

<div align="center" class="osu-md__paragraph">
    <iframe width="95%" style="aspect-ratio: 16 / 9;" src="https://www.youtube.com/embed/_FOeVts_dVs" frameborder="0" allowfullscreen></iframe>
</div>

In the **[osu! Beatmapping World Championship (o!bwc)](https://osu.ppy.sh/home/news/2025-11-25-osu-beatmapping-world-championship-2025-results)**, the ::{ flag=TW }:: Taiwanese team, consisting of ::{ flag=TW }:: ::Plus4j::{ user=4086497 }, ::{ flag=TW }:: ::Matsuyuki Ame::{ user=12763959 }, ::{ flag=TW }:: ::Flask::{ user=959763 }, ::{ flag=TW }:: ::Imokora::{ user=2472609 }, ::{ flag=TW }:: ::9ami::{ user=1499997 }, and ::{ flag=TW }:: ::Alty::{ user=16407988 }, delivered an outstanding performance. Competing against over 60 teams from more than 20 countries, they distinguished themselves in fierce international competition and secured an impressive **3rd place**.

<div align="center" class="osu-md__paragraph">
    <iframe width="95%" style="aspect-ratio: 16 / 9;" src="https://www.youtube.com/embed/DD5PeHEd2eY" frameborder="0" allowfullscreen></iframe>
</div>

In **[Vocaloid Mapping Contest #3](https://www.vat.gg/vmc3)**, the duo of ::{ flag=CN }:: **::Garden::{ user=2849992 }** and ::{ flag=CN }:: **::iBell::{ user=4298072 }** took **1st place in Phase 1**. With Phase 2 currently underway, the competition remains intense. Check it out if you love Vocaloids, or you just want to support their continued journey!
...
::{ flag=CN }:: **::iBell::{ user=4298072 }** also appeared on the podium in individual mapper contests, claiming **1st place** in the **[Summer Mapping Contest 2](https://osu.ppy.sh/home/news/2025-06-14-summer-mapping-contest-2)**. This marks their **second consecutive championship** in the event, earning enough [contest points](/wiki/Contests/Contest_points) to be awarded the **Elite Mapper** title.

Another "second time champion" highlight came from **[Pending Cup 2025](https://osu.ppy.sh/home/news/2025-10-24-pending-cup-2025)**: ::{ flag=TW }:: **::Matsuyuki Ame::{ user=12763959 }** once again ranked first in one of the three track categories. They reaffirmed their consistent excellence in the Pending Cup!

2025 is also a fruitful year for novice mappers. **[Newspaper Cup 2025](https://osu.ppy.sh/home/news/2025-01-29-newspaper-cup-2025)** highlighted the rise of new talent from the Chinese mapping community, with three novice mappers ::{ flag=CN }:: **::PEALEERD_TAK::{ user=6214002 }**, ::{ flag=CN }:: **::Mimosa M::{ user=24010320 }**, and ::{ flag=CN }:: **::YeLing::{ user=14726718 }** sweeping the **top three positions**. Want to be one of them? Submissions for **[Newspaper Cup 2026](https://osu.ppy.sh/community/contests/270)** are now nearing the end, and new mappers are strongly encouraged not to miss this valuable opportunity to step onto the competitive stage!
...
As one of osu!'s most prominent content creators and a notable Chinese-American figure, ::BTMC::{ user=3171691 } has made immense contributions to the global community. His success demonstrates how a shared passion for the game can resonate across all cultural boundaries.
...
It is definitely a good sign that the regime of Chinese mapping has been changing and that the recent new mappers are taking the leading role. On the other hand, it has been a decade-long tradition to conform with the norms of mapping, which I believe more experienced mappers shall revisit and take the risk of breaking.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/10562853" style="background-image: url('/wiki/shared/avatars/seros.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/10562853">seros</a></p>

In the osu! community, we often discuss "Chinese Mapping" as a distinct style. As one of its core pillars, could you introduce how this school of mapping originated and who the pioneers were? Also, which mappers have had the greatest influence on your own style over the years?
...
As for my own style, ::NatsumeRin::{ user=151679 } (2012-2014) was my biggest early influence; much of my rhythm choice, overlaps, and slider shapes can be traced back there. In the middle stage (2015-2016), I studied ::Skystar::{ user=873961 }, the master who synthesized these styles with his own ideas. Later (2016-2018), I began exploring my own potential and realized that ::fanzhen::{ user=418699 }'s maps were in a league of their own regarding playability, so I spent a long time learning from him. Finally, in 2019, I integrated ::rustbell::{ user=227717 }'s rigid, high-difficulty expression. Since then, it's been about fine-tuning that 2019 version (e.g., mimicking ::Kencho::{ user=3178411 }'s flow or studying various old maps), though my energy has shifted toward my career. It took me seven years to finally feel satisfied with my own mapping.
  
<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/10562853" style="background-image: url('/wiki/shared/avatars/seros.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/10562853">seros</a></p>

We've also seen many new mappers emerge in 2025. Who do you think is the most promising mapper right now?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/1343783" style="background-image: url('/wiki/shared/avatars/pw384.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/1343783">pw384</a></p>

I would venture to say that ::WhiteCookies::{ user=13617153 } is the most impressive new mapper in 2025, and highly recommend you to take a look at his 1st ranked map — an extremely well-structured one with simple visuals but dedicated flow design. I am pretty sure it would be such an impossible achievement without his excellent playing skills. It is an honor for me to be one of the nominators.
...
Looking ahead to the Year of the Horse, do you have any messages or expectations for the Chinese mapping community as a whole?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/1343783" style="background-image: url('/wiki/shared/avatars/pw384.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/1343783">pw384</a></p>

I look forward to seeing more mappers step outside their comfort zones to explore unique styles. Let's keep the momentum going and continue to bring fresh ideas to the game.
...
Within the Chinese-speaking scene, ::Crystal::{ user=1646397 } is a symbol of resilience. A mainstay of the Chinese OWC roster since 2016, his decade-long consistency has made him a living legend for local players across multiple generations.
...
A talented Chinese designer, ::Sakura006::{ user=10365024 } serves as the Lead for the World Cup Design Team. His work on osu! originals and major tournaments has significantly enriched the visual experience for players worldwide.
...
You are the World Cup Design Team leader who has truly enriched the visual experience for everyone when they discover new osu! originals. What areas of growth or new challenges are you most excited to pursue in 2026? Do you have any advice for new designers who hope to work on World Cup projects in the future?
...
Not to mention how close-knit we are. Without language barriers between us, we naturally share a larger player base, and people are genuinely kind to one another.
New ideas are welcomed, and constructive feedback is always given to help strengthen the content and make everything more enjoyable.
...
<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/6701656">chiv</a></p>
  
The contrast between international tournaments and Chinese region-locked ones shows itself in countless ways. While "quality" is subjective, there's something uniquely charming about each Chinese tournament. From polished mappools and graphics, to the incredible dedication of staff members and the welcoming playerbase, it's always a pleasure seeing Chinese tournaments come around.
...
How would you define the unique "philosophy" behind mappools in Chinese-speaking tournaments?
...
It's also fascinating to see how we integrate custom maps into our mappools.
From this year alone: CYT:NE, China LAN, and otst:live! together accumulated over 60 customs, and the sheer number isn't even the most impressive part. When you look at each creation individually, you can really see the level of quality that's been consistently maintained.

All of this is made possible by the strong infrastructure and supportive environment we've built, that nurtures both the mapping and tournament scenes, leading to so many generational creations.
...
Looking toward 2026, what international trends would you love to see the community to explore more?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/6701656" style="background-image: url('/wiki/shared/avatars/chiv.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/6701656">chiv</a></p>

From the players, to the mappers, and all the staff in between, it'd be incredible to see parts of the Chinese community branch out into more international opportunities. There's a ton of dedication and talent hidden behind region-locked tournaments and contests, and exploring new horizons would definitely help diversify the game as a whole.

On the other side, there are hundreds of members in our community without Chinese flags who still have roots in China. Despite having a Canadian flag, it's been awesome being able to interact with Chinese tournaments like China LAN, and I hope to see some familiar faces get acquainted with the level of quality and dedication they bring.
