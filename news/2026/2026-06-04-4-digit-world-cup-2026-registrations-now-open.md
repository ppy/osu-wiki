...
With its 9th iteration, 4WC2026 sees an all-new organising team in Project Hexagon. Hailing from the 6-digit tournament community, Project Hexagon is a group led by ::{ flag=SG }:: ::gamicrayola::{ user=29426345 }, ::{ flag=GB }:: ::pericrayola::{ user=31184671 }, ::{ flag=UA }:: ::Filoxen::{ user=24454271 }, ::{ flag=CH }:: ::MirageFire::{ user=5316973 } and ::{ flag=GB }:: ::willwam::{ user=11674122 }, which seeks to raise the baseline and innovate the peaks of tournament production.
