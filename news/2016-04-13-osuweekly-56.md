...
**The long-awaited "Modding V2" is [finally in public testing](https://osu.ppy.sh/forum/t/442285)!** While the previous iteration made for the current website has long been unveiled, the entire system has been rebuilt for the sleek and modern [new.ppy.sh](https://osu.ppy.sh/home). We have some maps for modders to try it out first hand, so if you want to take part in some osu! history, head on over and check it out!
