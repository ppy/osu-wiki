...
Wh1teh gets another chart nominated into the Loved section with his rendition of Jomekka's _Eighto_. To call the chart relentless is an understatement—Eighto has nonstop 1/6 bursts at 234 BPM (351 BPM 1/4s) with occasional doubles, 1/4 split jumptrills, and many extended 1/6 light jumpstreams sandwiched in its fairly short 3 minute lifespan. The first 2 minutes practically has no break, so you'll most likely find yourself running on fumes by the time you reach the longer jumpstreams in the chart.
