...
Although having to choose only **3** of all those masterpieces might have led some of you to suffer from sea-sickness, in the end, a total of **15703** ballots are collected from **5914** unique voters as the ship sailed.
...
The mod icons look minimal, but are still information rich and cleverly concatenate on the results screen, showing how much Nikstrim values attention to detail. The absence of the usual effects included in a skin themed around techno-era, like massive glows and flashy effects, goes with the minimalistic approach superbly. Feeling the breeze of the future with notMiku will give you the feeling of a ride in a spaceship. The future is now!
...
**1849** users couldn't help but cast their vote for this masterpiece called [Minimalist 2.0](https://osu.ppy.sh/community/forums/topics/1286223), crafted by the very hands of [**Krizto**](https://osu.ppy.sh/users/13474556), reserving them 2nd place on the podium!
...
Rather than simplicity and minimalism harboured by most other submissions, FREEDOM DiVE↓ features a vivid theme with colourful visual effects, carried out masterfully with aesthetic hand-drawn elements. Inspired by the song belonging to one of the most iconic beatmaps of all time, [xi - FREEDOM DiVE](https://osu.ppy.sh/beatmapsets/39804), the skin revolves around the little animate orb greeting the user on every screen with its cute expressions.

Despite the extravagantly placed objects and richness in colour, BTMC team did a great job positioning, ensuring that none of the objects distract the player from clicking the circles. Appeasing the flamboyance-adorers with its well-designed artworks and animations, the skin guarantees you a pleasant and distraction-free gameplay session as well. Without a doubt, FREEDOM DiVE↓ is the perfect "osu! Champion approved" skin for those who like tagging along with the skin of their favourite osu! player.
...
All good things must come to an end. Well, here we are at the closure of the first-ever osu! skinning contest, hoping that both the contestants and those following the contest with keen eyes had a pleasant time throughout the contest! Even though we did our best to maintain such an environment, we eagerly await for your feedback on matters we should improve for the next iteration.

Off the ship departs!
