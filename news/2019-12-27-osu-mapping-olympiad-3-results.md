...
In **second place** is [**Kawawa**](https://osu.ppy.sh/users/4647754) with a total score of **120/150**. With excellent scores across each category and the highest score from judge Tailsdk, Kawawa's entry was very well executed.

And rounding out the podium in **third place** is [**\_VianK\_**](https://osu.ppy.sh/users/6889055) with a total score of **109/150**. Strong scores from each judge and in the technique and hitsounding categories helped push their entry into third place.

You can see all of the scores and comments from the judges via [this spreadsheet](https://docs.google.com/spreadsheets/d/1f1JEhs8iAbcWZppB2JJ25k4qerFE_RAOZCN_LYzo4NQ/edit?usp=sharing), and you can [click here to check out all of the entries](https://drive.google.com/open?id=1fbVsSd0R3TtpMn5F3FYKEiVcRd-njXBz).
...
We would like to give a big thank you to [Asherz007](https://osu.ppy.sh/users/9014047), [Leniane](https://osu.ppy.sh/users/7138602), and [Tailsdk](https://osu.ppy.sh/users/6751666) for stepping up to judge the entries. As with the taiko contest, we unfortunately ran into issues with getting judging completed for this contest. It was a huge help for these three to come in and judge the entries so that we could finish the contest. We could not have done it without you. Please note that while Asherz007 helped organize the beginning parts of this contest, he did not have access to the identities of the entries as the anonymization process was handled by Chaos.

Thank you to all of the participants and congratulations again to [PianoLuigi](https://osu.ppy.sh/users/9665915)! Be on the lookout for another osu!catch Olympiad contest coming soon, and an osu!standard contest on the horizon!

—Asherz007, Chaos, Protastic101
