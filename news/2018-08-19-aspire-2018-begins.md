...
* **Any entries with additional resources (hitsounds, storyboards, etc) must be submitted in .osz format.** There are no size restrictions this time around, but if your .osz file does not get accepted by the contest system for being too large, PM [Ephemeral](https://osu.ppy.sh/u/102335) via the forums for assistance.
