...
What is this *Mappers' Guild* thing? In short, it's a way for mappers to earn rewards for mapping songs from osu!'s [Featured Artists](https://osu.ppy.sh/beatmaps/artists). If you're out of the loop, check out the [Mappers' Guild wiki page](/wiki/Mappers_Guild) and [its website](https://mappersguild.com)!
...
For the **UNDEAD CORPORATION Touhou pack (osu!)** quest, the mappers had to create and rank at least 8 mapsets of UNDEAD CORPORATION's TOHO Complete Box songs, without a single user hosting more than two mapsets.

This quest was completed by **[Trynna](https://osu.ppy.sh/users/2652951)**, **[eiri-](https://osu.ppy.sh/users/3388410)**, **[Zelq](https://osu.ppy.sh/users/8953955)**, **[Lafayla](https://osu.ppy.sh/users/5312547)**, **[Seto Kousuke](https://osu.ppy.sh/users/2857314)** and **[Mirash](https://osu.ppy.sh/users/2841009)**
...
For the **Kurokotei mini-pack (osu!)** quest, the mappers had to create and rank at least 3 mapsets of songs by Kurokotei

This quest was completed by **[Crissa](https://osu.ppy.sh/users/5405836)**, **[Cris-](https://osu.ppy.sh/users/6175280)** and **[Hazu-](https://osu.ppy.sh/users/4668230)**
...
For the **ICDD: Yomi yori Kikoyu, Koukoku no Tou to Honoo no Shoujo & Fusyoku Ressentiment, Fushiyoku no Sarugakuza. (osu!taiko)** quest, the mappers had to create and rank 3 mapsets of songs by Imperial Circus Dead Decadence from their albums "Yomi yori..." and "Fusyoku...", each hosted by a different user.

This quest was completed by **[Vulkin](https://osu.ppy.sh/users/4901066)**, **[Capu](https://osu.ppy.sh/users/2474015)**, **[Nepuri](https://osu.ppy.sh/users/6637817)** and **[Raiden](https://osu.ppy.sh/users/2239480)**
...
For the **Zekk pack (osu!taiko)** quest, the mappers had to create and rank at least 5 mapsets of songs by Zekk, each hosted by a different user.
...
For the **HyuN double (osu!)** quest, the mappers had to create and rank 2 or more mapsets of songs by HyuN, each hosted by a different user.

This quest was completed by **[-Sylvari](https://osu.ppy.sh/users/3493804)** and **[Niva](https://osu.ppy.sh/users/197805)**
...
For the **Celldweller double (osu!taiko)** quest, the mappers had to create and rank 2 or more mapsets of songs by Klayton's Celldweller alias, each hosted by a different user.

This quest was completed by **[Lime717](https://osu.ppy.sh/users/7918664)** and **[Gamelan4](https://osu.ppy.sh/users/9856910)**
...
For the **PUP double (osu!catch)** quest, the mappers had to create and rank at least 2 mapsets of songs by PUP, each hosted by a different user.

This quest was completed by **[JBHyperion](https://osu.ppy.sh/users/4879508)**, **[Nelly](https://osu.ppy.sh/users/4741164)** and **[Jemzuu](https://osu.ppy.sh/users/7890134)**
...
For the **Rohi double (osu!taiko)** quest, the mappers had to create and rank at least 2 mapsets of songs by Rohi, each hosted by a different user.

This quest was completed by **[Idealism](https://osu.ppy.sh/users/3869519)**, **[Axer](https://osu.ppy.sh/users/7299864)**, **[eiri-](https://osu.ppy.sh/users/3388410)**, **[Trynna](https://osu.ppy.sh/users/2652951)**, **[Vulkin](https://osu.ppy.sh/users/4901066)** and **[Hivie](https://osu.ppy.sh/users/14102976)**
...
For the **Rivers of Nihil mini-pack (osu!, osu!taiko)** quest, the mappers had to create and rank at least 3 mapsets of songs by Rivers of Nihil.

This quest was completed by **[Daycore](https://osu.ppy.sh/users/5596337)**, **[Mao](https://osu.ppy.sh/users/2204515)**, **[h3ct1c](https://osu.ppy.sh/users/6885942)**, **[FCL](https://osu.ppy.sh/users/4715762)**, **[SILENCE PLAYER](https://osu.ppy.sh/users/6381153)**, **[Gero](https://osu.ppy.sh/users/1467715)** and **[Raiden](https://osu.ppy.sh/users/2239480)**
...
For the **Azure of the Horizon mini-pack (osu!, osu!taiko)** quest, the mappers had to create and rank at least 3 mapsets of songs on Fractal Dreamers' "Azure of the Horizon" album, each hosted by a different user.

This quest was completed by **[coco](https://osu.ppy.sh/users/9579526)**, **[Agatsu](https://osu.ppy.sh/users/5579871)** and **[Alwaysyukaz](https://osu.ppy.sh/users/4999506)**
...
For the **O2i3 mini-pack (osu!mania)** quest, the mappers had to create and rank at least 3 mapsets of songs by O2i3, each hosted by a different user.

This quest was completed by **[Unpredictable](https://osu.ppy.sh/users/7560872)**, **[-mint-](https://osu.ppy.sh/users/8976576)**, **[Keiga](https://osu.ppy.sh/users/6866022)**, **[Scotty](https://osu.ppy.sh/users/11085809)**, **[Kamuy](https://osu.ppy.sh/users/7439226)** and **[Hydria](https://osu.ppy.sh/users/808176)**
...
For the **Venetian Snares mini-pack (osu!taiko)** quest, the mappers had to create and rank at least 3 maps of songs by Venetian Snares.

This quest was completed by **[Gamelan4](https://osu.ppy.sh/users/9856910)**, **[Raiden](https://osu.ppy.sh/users/2239480)**, **[Axer](https://osu.ppy.sh/users/7299864)**, **[Nepuri](https://osu.ppy.sh/users/6637817)**, **[gaston_2199](https://osu.ppy.sh/users/5938161)** and **[-Kazu-](https://osu.ppy.sh/users/920861)**
...
For the **CircusP mini-pack (osu!)** quest, the mappers had to create and rank at least 3 mapsets of songs by CircusP, each hosted by a different user.

This quest was completed by **[eiri-](https://osu.ppy.sh/users/3388410)**, **[Noffy](https://osu.ppy.sh/users/1541323)**, **[Pachiru](https://osu.ppy.sh/users/2850983)**, **[fieryrage](https://osu.ppy.sh/users/3533958)** and **[Gero](https://osu.ppy.sh/users/1467715)**
...
For the **Hyper Potions mini-pack (osu!)** quest, the mappers had to create and rank at least 3 mapsets of songs by Hyper Potions, each hosted by a different user.

This quest was completed by **[Cheri](https://osu.ppy.sh/users/5226970)**, **[-Sylvari](https://osu.ppy.sh/users/3493804)**, **[wafer](https://osu.ppy.sh/users/9416836)** and **[Niva](https://osu.ppy.sh/users/197805)**
...
For the **dark cat mini-pack (osu!catch)** quest, the mappers had to create and rank at least 4 mapsets of songs by dark cat, without a single user hosting more than two mapsets.

This quest was completed by **[JBHyperion](https://osu.ppy.sh/users/4879508)**, **[Ascendance](https://osu.ppy.sh/users/2931883)**, **[wonjae](https://osu.ppy.sh/users/5032045)**, **[Absolute Zero](https://osu.ppy.sh/users/4847256)**, **[WildOne94](https://osu.ppy.sh/users/3482692)** and **[Benita](https://osu.ppy.sh/users/4023183)**
...
For the **goreshit mini-pack (osu!)** quest, the mappers had to create and rank at least 4 mapsets of songs by goreshit, without a single user hosting more than two mapsets.
...
For the **Street mini-pack (osu!taiko)** quest, the mappers had to create and rank at least 4 mapsets of songs by Street, each hosted by a different user.

This quest was completed by **[eiri-](https://osu.ppy.sh/users/3388410)**, **[tasuke912](https://osu.ppy.sh/users/2774767)**, **[Ulqui](https://osu.ppy.sh/users/1263669)**, **[Skull Kid](https://osu.ppy.sh/users/3044264)** and **[Trynna](https://osu.ppy.sh/users/2652951)**
...
For the **Kola Kid pack (osu!taiko)** quest, the mappers had to create and rank at least 5 mapsets of songs by Kola Kid (excluding those whose length is below 1:00), each hosted by a different user.

This quest was completed by **[Gamelan4](https://osu.ppy.sh/users/9856910)**, **[gaston_2199](https://osu.ppy.sh/users/5938161)**, **[Axer](https://osu.ppy.sh/users/7299864)**, **[Coryn](https://osu.ppy.sh/users/2828556)**, **[Etsu](https://osu.ppy.sh/users/3442319)** and **[Nepuri](https://osu.ppy.sh/users/6637817)**
...
For the **Celldweller pack (osu!)** quest, the mappers had to create and rank at least 6 mapsets of songs by Klayton's Celldweller alias without a single user hosting more than two mapsets.

This quest was completed by **[Daycore](https://osu.ppy.sh/users/5596337)**, **[PandaHero](https://osu.ppy.sh/users/1233255)**, **[Mirash](https://osu.ppy.sh/users/2841009)**, **[Pachiru](https://osu.ppy.sh/users/2850983)**, **[piroshki](https://osu.ppy.sh/users/7645522)**, **[Yugu](https://osu.ppy.sh/users/3161834)** and **[fieryrage](https://osu.ppy.sh/users/3533958)**
...
- [Celldweller - Good L_ck (Yo_'re F_cked)](https://osu.ppy.sh/beatmapsets/1069112#osu/2238109) hosted by [Daycore](https://osu.ppy.sh/users/5596337)
...
- **Hyper Potions single (osu!taiko, osu!)**: [Hyper Potions - Surf](https://osu.ppy.sh/beatmapsets/1192583#taiko/2485104) & [Hyper Potions & MYLK - Jelly](https://osu.ppy.sh/beatmapsets/1192586#osu/2485108) hosted by [eiri-](https://osu.ppy.sh/users/3388410)
...
Instead we'll be highlighting some of the big time contributors to the Mappers' Guild! Numbers below are for the period between our last update (2020-03-23) and today.
...
It's unbelievable how much the community has been contributing to the Featured Artist program together. Thank you to everyone who's participated, be it as a mapper completing quests or as a player unlocking medals.

We hope you enjoy everything here and we'll see you again in the next update!
