...
Here's a taste of the song for this contest - **HYPER★DRIVE** from our wickedly talented [_Featured Artist_](https://osu.ppy.sh/beatmaps/artists/), [**nanobii**](https://osu.ppy.sh/beatmaps/artists/10):
...
_(Please note that the above track is a sample of the full song - the actual track is 3:19 in length!)_
...
All contestants who enter a valid map will receive a number of points towards the _Elite Mapper_ rankings based on their map's end position in the contest scoring. We'll explain more of this system in the upcoming development meeting.
