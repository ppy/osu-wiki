...
<audio controls>
    <source src="https://assets.ppy.sh/artists/48/previews/1233.mp3" type="audio/mpeg">
</audio>

### BUTTS TITS MONEY

<audio controls>
    <source src="https://assets.ppy.sh/artists/48/previews/1224.mp3" type="audio/mpeg">
</audio>

### Overtime

<audio controls>
    <source src="https://assets.ppy.sh/artists/48/previews/1230.mp3" type="audio/mpeg">
</audio>

### Hanging On

<audio controls>
    <source src="https://assets.ppy.sh/artists/48/previews/1227.mp3" type="audio/mpeg">
</audio>
...
We're still keeping steady with the insane pace we set ourselves a few months ago, and there's no sign of things slowing down! In a little bit of an early hint, we have a huge batch of updates for our existing Featured Artists slated later on in the month, but as for next release...

Well, we've been chalking it out, and I think we're really going above and beyond on this next one. It's something extra vivid.

But what does it all mean? Find out in ten days time! Or try to guess in the comments for the grand prize of being able to brag to your friends about it.
