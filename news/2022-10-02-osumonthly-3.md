...
Of course, we were not able to cover everything from the patch notes, so if you are interested in all previous and future patch notes, you can find them [here](https://osu.ppy.sh/home/changelog), or if you'd rather watch a video digest of them check out the playlist embedded above!
