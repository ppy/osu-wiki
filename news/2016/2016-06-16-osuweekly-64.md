...
**osu!mania is [getting revisited](https://osu.ppy.sh/community/forums/topics/466617/start=0) by smoogipoo with the help of our friends in the osu! community!** Ever since it was first created by ::woc2006::{ user=1105845 } a few years ago, the game itself seldom received an update save for a couple of minor tweaks and bug fixes. Since then, multiple initiatives have been made in attempts to update the game mode and improve the editor. This looks to be what is just the beginning of many updates to core gameplay to come! It is important to note, however, that everything currently in the cutting-edge build represents a work in progress and is not ready to become the standard. If you have any feedback, do leave your suggestions in the thread!
