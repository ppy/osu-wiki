...
**Further additions to the osu!standard nominators:** With the last accepted invitations from ::ezek::{ user-id=180241 }, [sahuang](https://osu.ppy.sh/users/5318910), ::Zero\1\1wind::{ user-id=1822830 }, [Pentori](https://osu.ppy.sh/users/7452237) and ::Sieg::{ user-id=1404615 } to join the BNG, we conclude the batch of additions to the usergroup. For those modders who missed this opportunity there will be a new application process in the near future, so make sure you keep your activity and quality high enough to be able to participate in the next test!
