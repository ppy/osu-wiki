...
**The [October ranking charts](https://osu.ppy.sh/home/news/2016-12-01-october-2016-ranking-charts) have been released.** Head on over to see some of the better maps ranked in October for every game mode. We also have ranking chart [beatmap packs](https://osu.ppy.sh/p/packlist?t=r) thanks to ::Stefan.::{ user-id=626907 }
...
**::Jlastino::{ user-id=1556937 } is back again this year ready to make another amazing osu! wallpaper featuring the names of users from the community!** If you'd like to be a part of this year's piece, make sure you head on over to the [thread](https://osu.ppy.sh/community/forums/topics/528999) and fill out of the form listed in the OP. If you're unaware of his previous work, have [a glimpse of last year's wallpaper](https://puu.sh/mj0Vc/123e508db2.jpg). Any names in there you recognise?

## Scorewatch: December Week 1 (with ::Raveille::{ user-id=1388767 })

Another bustling OWC weekend comes to a close! Let's put your mind to rest with some amazing scores!

**::Cookiezi::{ user-id=124493 } has surged into the 13,000pp zone, setting a 99.03% 2 miss HDDT choke on [kradness&Reol - Remote Control](https://osu.ppy.sh/beatmaps/774965?m=0).** This play gave him 743pp and the second highest standard pp play. What can't this man do?

<br><center>![](https://osu.ppy.sh/ss/6731297)</center><br>

**Speaking of chokes, ::Vaxei::{ user-id=4787150 } makes it into a pasttime, but he sure didn't choke a HDDTHR pass on [Team Nekokan - Can't Defeat Airman](https://osu.ppy.sh/beatmapsets/24313).** I wish I was making this up. He managed to pass the map with 81.50%, and at one point managed to hold 130 combo. This is something you need to watch cause even some top players) were shocked by his performance.

<iframe width="560" height="315" src="https://www.youtube.com/embed/fnqGr_8FoYA" frameborder="0" allowfullscreen></iframe>

**Someone must've kidnapped ::HappyStick::{ user-id=256802 }, because he managed to pull off a DT SS on [Diana Garnet - Spinning World (Anime Ver.)](https://osu.ppy.sh/beatmaps/962959?m=0)**, grabbing 527pp in the process and the first ever DT SS on that map. Check out the live VOD of the play, all covered with the glorious HappyStick himself and the "AR10" chat. ;)

<iframe width="560" height="315" src="https://www.youtube.com/embed/oGwdoixVjA4" frameborder="0" allowfullscreen></iframe>

**::Halogen-::{ user-id=169992 } has gotten the 1 '200' curse alongside cheetose with a 1 '200' play on [Spawn of Possession - Apparition](https://osu.ppy.sh/beatmaps/797527?m=3).** There are now 2 100% scores on Apparition that are not an SS.

![](https://osu.ppy.sh/ss/6722181)

## OWC Week 4: Semifinals Gets Serious (with ::Evrien::{ user-id=791660 })
...
To end this week's edition, we have a brand new puzzle for you, thanks to ::Starrodkirby86::{ user-id=410 }. For this month, we've gone with something a bit more tricky, and have decided to go with a Code Cracker. The theme this time around is none other than the OWC.
