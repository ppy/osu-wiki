...
- **[MrSpazzaneve17 - osu! MEGAMIX](https://osu.ppy.sh/beatmapsets/399575) by ::Exile-::{ user=2559349 }** (Nominator: ::Irreversible::{ user=1287964 })
...
- [toby fox - MEGALOVANIA](https://osu.ppy.sh/beatmapsets/387700) by ::Kyshiro::{ user=640611 } (Nominator: ::Desperate-kun::{ user=2202645 })
...
- [REDALiCE feat. anporin - Beautiful Dream](https://osu.ppy.sh/beatmapsets/463361) by ::Dailycare::{ user=1634445 } (Nominator: ::Irreversible::{ user=1287964 })
...
- **[t+pazolite - Candy Crack Curtain Call](https://osu.ppy.sh/beatmapsets/237272) by ::tasuke912::{ user=2774767 }** (Nominator: ::OnosakiHito::{ user=290128 })
...
- [xi - .357 Magnum](https://osu.ppy.sh/beatmapsets/155749) by ::Sayaka-::{ user=398275 } (Nominator: ::MMzz::{ user=128993 })
...
- [Whispered - Kappa](https://osu.ppy.sh/beatmapsets/436703) by ::Raiden::{ user=2239480 } (Nominator: ::OnosakiHito::{ user=290128 })
...
- [Mitsuki Kotono - Fuyu ni Saku Hana](https://osu.ppy.sh/beatmapsets/401086) by ::Nardoxyribonucleic::{ user=876419 } (Nominator: ::OnosakiHito::{ user=290128 })
...
- [Froggie x Misato - Jekyll & Hyde](https://osu.ppy.sh/beatmapsets/463342) by ::hikikochan::{ user=6512678 } (Nominator: ::OnosakiHito::{ user=290128 })
...
- [Aimer with chelly (EGOIST) - ninelie (TV size)](https://osu.ppy.sh/beatmapsets/444285) by ::qoot8123::{ user=766371 } (Nominator: ::DakeDekaane::{ user=1425253 })
...
- **[wa. vs celas - Vajuranda](https://osu.ppy.sh/beatmapsets/221687) by ::alienflybot::{ user=636114 }** (Nominator: ::JBHyperion::{ user=4879508 })
...
- [ParagonX9 - Chaoz Japan](https://osu.ppy.sh/beatmapsets/460789) by ::Razor Sharp::{ user=3414261 } (Nominator: ::JBHyperion::{ user=4879508 })
...
- [Mami Kawada - Wings of Courage -Sora o Koete-](https://osu.ppy.sh/beatmapsets/245160) by ::examination::{ user=1806962 } (Nominator: ::JBHyperion::{ user=4879508 })
...
- [nano - Omoide Kakera](https://osu.ppy.sh/beatmapsets/454627) by ::Natsu::{ user=1953876 } (Nominator: ::JBHyperion::{ user=4879508 })
...
- [Hanatan - Kokoronashi](https://osu.ppy.sh/beatmapsets/449760) by ::Lavender::{ user=3850859 } (Nominator: ::JBHyperion::{ user=4879508 })
...
- [REDALiCE feat. anporin - Beautiful Dream](https://osu.ppy.sh/beatmapsets/463361) by ::Dailycare::{ user=1634445 } (Nominator: ::Kurokami::{ user=260933 })
...
- **[gmtn. (witch's slave) - furioso melodia](https://osu.ppy.sh/beatmapsets/307371) by ::Harbyter::{ user=1147679 }** (Nominator: ::Blocko::{ user=4075092 })
...
- [xi - Ascension to Heaven](https://osu.ppy.sh/beatmapsets/421541) by ::Jinjin::{ user=3360737 } (Nominator: ::Blocko::{ user=4075092 })
...
- [Camellia - Ultimate Ascension](https://osu.ppy.sh/beatmapsets/476565) by ::Fresh Chicken::{ user=3984370 } (Nominator: ::Feerum::{ user=4815717 })
...
- [sakuzyo - Laplace](https://osu.ppy.sh/beatmapsets/445079) by ::ZZHBOY::{ user=1565739 } (Nominator: ::Blocko::{ user=4075092 })
...
- [xi - Quietus Ray](https://osu.ppy.sh/beatmapsets/374277) by ::Kuo Kyoka::{ user=2596306 } (Nominator: ::Feerum::{ user=4815717 })
