...
- **[orangentle / Yu_Asahina - HAELEQUIN (Extended ver.)](https://osu.ppy.sh/beatmapsets/272333) by ::RLC::{ user=1047883 }** (Nominator: ::handsome::{ user=2123087 })
...
- [DJ TOTTO & Qrispy Joybox - Curtain Call Memories](https://osu.ppy.sh/beatmapsets/414940) by ::StarForYou::{ user=2045914 } (Nominator: ::handsome::{ user=2123087 })
...
- [Hana - Sakura no Uta](https://osu.ppy.sh/beatmapsets/440068) by ::Ultimate Madoka::{ user=1244312 } (Nominator: ::handsome::{ user=2123087 })
...
- [sakuzyo - Altale](https://osu.ppy.sh/beatmapsets/228815) by ::toybot::{ user=2848604 } (Nominator: ::handsome::{ user=2123087 })
...
- [onoken - Viden](https://osu.ppy.sh/beatmapsets/375402) by ::-kevincela-::{ user=266596 } (Nominator: ::pishifat::{ user=3178418 })
...
- [gya9 - Midnight Riders (kamome sano remix)](https://osu.ppy.sh/beatmapsets/473364) by ::ProfessionalBox::{ user=3250792 } (Nominator: ::handsome::{ user=2123087 })
...
- **[Demetori - Kuuchuu ni Shizumu Kishinjou ~ Counter-Clock World](https://osu.ppy.sh/beatmapsets/464535) by ::Surono::{ user=3611370 }** (Nominator: ::Nwolf::{ user=1910766 })
...
- [AAAA Chazuke - Hop Step Adventure*](https://osu.ppy.sh/beatmapsets/466471) by ::TKS::{ user=940878 } (Nominator: ::Nwolf::{ user=1910766 })
...
- [TOMOSUKE x Jazzin'park - LANA - Kiroku no Kakera (sasakure.UK Framework Remix)](https://osu.ppy.sh/beatmaps/871725) by ::tasuke912::{ user=2774767 } and ::SKSalt::{ user=3280542 } (Nominator: ::Nwolf::{ user=1910766 })
...
- [LeaF - Paraclete](https://osu.ppy.sh/beatmapsets/455109) by ::Nwolf::{ user=1910766 } (Nominator: ::S a n d::{ user=676578 })
...
- [SOUND HOLIC Vs. dj TAKA feat. YURiCa - TIEFSEE](https://osu.ppy.sh/beatmapsets/457878) by ::Nardoxyribonucleic::{ user=876419 } (Nominator: ::S a n d::{ user=676578 })
...
- [Chata - Nocte of desperatio](https://osu.ppy.sh/beatmapsets/432401) by ::Volta::{ user=4154071 } (Nominator: ::DakeDekaane::{ user=1425253 })
...
- **[Sengoku Nadeko (CV:Hanazawa Kana) - Mousou Express](https://osu.ppy.sh/beatmapsets/228539) by ::Spectator::{ user=702598 }** (Nominator: ::Chara::{ user=829284 })
...
- [sakuzyo - Altale](https://osu.ppy.sh/beatmapsets/228815) by ::toybot::{ user=2848604 } (Nominator: ::JBHyperion::{ user=4879508 })
...
- [Cocoa, Chino, Rize, Chiya, Syaro, Maya, Megu - Honjitsu wa Makoto ni Rarirurein](https://osu.ppy.sh/beatmapsets/465206) by ::Momochikun::{ user=2032824 } (Nominator: ::Kurokami::{ user=260933 })
...
- [Maon Kurosaki feat.TRUSTRICK - DEAD OR LIE &lt;tv size>](https://osu.ppy.sh/beatmapsets/481696) by ::Chaoslitz::{ user=3621552 } (Nominator: ::Deif::{ user=318565 })
...
- [Yousei Teikoku - Torikago](https://osu.ppy.sh/beatmapsets/412140) by ::Okorin::{ user=1623405 } (Nominator: ::Zak::{ user=1375955 })
...
- [Venetian Snares - She Runs](https://osu.ppy.sh/beatmapsets/319890) by ::fergas::{ user=3144542 } (Nominator: ::Zak::{ user=1375955 })
...
- **[xi - Double Helix](https://osu.ppy.sh/beatmapsets/398197) by ::Level 51::{ user=3617847 }** (Nominator: ::Evening::{ user=2193881 })
...
- [Mastermind(xi+nora2r) - Dreadnought](https://osu.ppy.sh/beatmapsets/400351) by ::Kyousuke-::{ user=2616570 } (Nominator: ::Feerum::{ user=4815717 })

I especially like that this map has a 4K and 7K difficulty. More variety in one mapset! Actually that's all I have to say.

- [Nightmare - Boulafacet](https://osu.ppy.sh/beatmapsets/254581) by ::MasterSonic10::{ user=1249224 } (Nominator: ::Evening::{ user=2193881 })
...
- [Wix Games - Glacier Theme](https://osu.ppy.sh/beatmapsets/371114) by ::Modren::{ user=1828621 } (Nominator: ::-Kamikaze-::{ user=2124783 })
...
- [Rche - entelecheia](https://osu.ppy.sh/beatmapsets/476394) by ::Starry-::{ user=2166199 } (Nominator: ::Feerum::{ user=4815717 })
