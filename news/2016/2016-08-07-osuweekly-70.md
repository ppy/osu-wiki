...
**Recently, we held a second Aspire mapping contest challenging osu!standard mappers to use their full potential to create a masterpiece.** However, this was only limited to osu!standard. [The osu!mania community held their own Aspire contest](https://osu.ppy.sh/community/forums/topics/457507) using Camellia - Lunatic Rough Party as the song. The contest has just finished with ::LordRaika::{ user=3265023 } taking first place. ::Nivrad00::{ user=1984634 } was close behind taking second place with third going to ::wizardoffail::{ user=2293992 }.
