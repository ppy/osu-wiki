...
osu! (lazer release) saw one of it's busiest weeks yet, with development contribution from the community skyrocketing over the course of the past week. You can check out these and more (recent) updates over at [peppy's development blog](https://blog.ppy.sh/).
