...
Behind the scenes, [Lugu](https://osu.ppy.sh/users/12851847) from the Mappers' Guild has been hard at work creating a [showcase beatmap](/wiki/Featured_Artists/Featured_Artist_showcase_beatmaps) for today's artist announcement. See how it turned out alongside osu! (lazer release)'s new built-in Performance Points counter, then check out the other previews below:
