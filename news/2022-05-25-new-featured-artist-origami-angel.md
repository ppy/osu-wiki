...
![](https://assets.ppy.sh/artists/269/header.jpg)
...
We've picked up **17** tracks from the band, including a bunch from their newest *GAMIGANG* album and the entirety of *Somewhere City*! Check out the full list from [**Origami Angel**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/269).

Ever wondered how many people recognize osu! out in the wild? The answer is *a lot*, especially if you're at a tournament full of dedicated gamers. Watch some Super Smash Bros. players attempt [Origami Angel - The Title Track](https://osu.ppy.sh/beatmapsets/1396156) on a makeshift setup, then check out a bunch more maps to play for yourself:

<div align="center">
    <video width="85%" controls>
        <source src="https://assets.ppy.sh/artists/269/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>
...
[**Origami Angel**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/269) has pre-timed beatmap templates for all the songs above AND a bunch more. If you've never tried mapping before, now's the time to learn.

That's all for now! The [@osugame Twitter](https://twitter.com/osugame) will be announcing our next Featured Artist on Saturday paired with another *cool thing*, so stay tuned.
