...
Despite being comprised of some of the biggest names surrounding the rhythm game scene, **La prière** surprisingly hasn't had much attention from osu! players until recently. You might need to investigate their sound for yourself, and this video of [*Senjou no Utahime*](https://osu.ppy.sh/beatmapsets/1398580) showcasing osu! (lazer release)'s newest mod is a good start (along with the other song previews below, of course).

<div align="center">
    <video width="90%" controls>
        <source src="https://assets.ppy.sh/artists/174/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>
...
The rest of **La prière**'s pop-filled tracks can be picked up from [their Featured Artist page](https://osu.ppy.sh/beatmaps/artists/174). Given the wide spread of composers behind these songs, the official osu! statisticians propose that there's a 96.4% chance you'll find a song that you like. Everyone also knows the osu! statisticians don't make up numbers. That'd never happen. Definitely impossible.

An earthquake could wipe out half the world's population tomorrow, but we guarantee that we would still announce a new Featured Artist this coming Saturday. Stay tuned to the [@osugame Twitter](https://twitter.com/osugame) for all the details and we'll see you then!
