...
- **osu!taiko:** ::Cryolien::{ user-id=1626983 }
...
Inspired to come out of mapping retirement, ::La Cataline::{ user-id=301279 }'s guest difficulty adds additional charm to ::Mirash::{ user-id=2841009 }'s tantalising mapset of her song - "Beginnings". This flagship difficulty has a taste from times long since past, but easily holds up to the modern standards of mapping.
...
With JINGO JUNGLE, ::Plaudible::{ user-id=7149815 } provides us with an incredibly fun mapset with a unique way of arranging patterns and selecting slider shapes. The concepts are consistent across all difficulties, which makes the spread feel very coherent. This one is totally worth checking out for those who enjoy alternating maps!
...
Oh my, what do we have here? Another map from ::\1yu68::{ user-id=6170507 }? After months of intense discussion, MANIERA is finally ranked! With additional support from 3 guest mappers, MANIERA spans an impressive 7 difficulties, catering to players of all levels.
...
Mania's had a rather lackluster month this time around, so ::Maxus::{ user-id=4335785 }'s newest marathon map YELL!, with long notes, slider velocity changes, and jacks is a refreshing addition to this month's spotlights.
