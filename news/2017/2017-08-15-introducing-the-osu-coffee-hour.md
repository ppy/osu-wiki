...
As an introduction to the osu! Coffee Hour, we'll be starting out simple but strong. ::HappyStick::{ user=256802 } will be hosting the show, joined by none other than the game's lead developer, ::peppy::{ user=2 }.
