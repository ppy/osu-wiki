...
Unfortunately, after nearly three years of service, our resident metadata expert ::IamKwaN::{ user=1856463 } has decided to step down from the QAT in order to seek some well-earned rest and relaxation. Her monumental efforts in the fields of metadata checking and standardisation have truly been a credit to osu! and the mapping community, and her absence will be a great loss to our team.
...
Some of you might remember the old Mapping with Rewards event, but ::Okorin::{ user=1623405 } has recently taken the lead and revived it. You can now choose from three awesome songs to create a beatmap set in any mode of your choosing for this contest.
...
If you want even more mapping events, ::Irreversible::{ user=1287964 } has something special planned for the coming month, so stay tuned!
