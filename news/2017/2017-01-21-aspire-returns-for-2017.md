...
Two Aspirants, ::Charles445::{ user-id=85000 } and [Monstrata](https://osu.ppy.sh/users/2706438) triumphed over this grand contest to critical acclaim with their performances on [LeaF - Evanescent](https://osu.ppy.sh/beatmapsets/227126) and [IAHN - Transform (Original Mix)](https://osu.ppy.sh/beatmapsets/484689) respectively.
...
- **Any entries with additional resources (hitsounds, storyboards, etc) must be submitted in .osz format, with a size no greater than 20mb.** Accounting for song size, you have roughly **11mb** of asset space available for your use. Petitions for additional space must be sent via forum PM to ::Ephemeral::{ user-id=102335 }.
