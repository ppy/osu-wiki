...
With the departure of ::IamKwaN::{ user=1856463 } last month, extra work has been funneled into metadata checking to assist our lone remaining specialist, ::Doyak::{ user=2046893 }. In order to alleviate some of this burden, **we recently opened a Discord server to discuss and catalogue metadata across newly Qualified maps**.
