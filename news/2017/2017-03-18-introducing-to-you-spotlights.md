...
- [Orange Heart(cv:Honda Mariko) Neptune(cv:Tanaka Rie) - Mousou Katharsis](https://osu.ppy.sh/beatmapsets/535272) by ::_underjoy::{ user=2235750 } (Nominator: ::-Kamikaze-::{ user=2124783 })
...
- [Helblinde - Memoria (Original Mix)](https://osu.ppy.sh/beatmapsets/518266) by ::Manwon::{ user=4129020 } (Nominator: ::_underjoy::{ user=2235750 })
...
- [XeoN - Xeus](https://osu.ppy.sh/beatmapsets/529212) by ::[Emiria]::{ user=2046044 } (Nominator: ::Jinjin::{ user=3360737 })
...
- [Team Grimoire - RougokuSTRIP (Grimoire crossbreed rmx)](https://osu.ppy.sh/beatmapsets/490717) by ::[Shana Lesus]::{ user=2881789 } (Nominator: ::Feerum::{ user=4815717 })
