...
- **osu!taiko:** ::Maitroxsk::{ user=4875451 }
...
**::Mirash::{ user=2841009 }** has done an excellent job in keeping all elements in mind when mapping this song - the background rhythm, the vocals and the instruments. With careful placement and neat accentuation Mirash has succeeded in offering the community a map which can be enjoyed by many people.

[![](/wiki/shared/news/2017-09-22-beatmap-spotlights-july-august-2017/zauberkugel.jpg)](https://osu.ppy.sh/beatmapsets/554892)

Yet again. **::pishifat::{ user=3178418 }** manages to impress the community with a map in this month's spotlights. Zauberkugel heavily focuses on slider speed changes as the song progresses. Those, combined with creative slider arrangements and great gameplay makes this a must-play!
...
The winner of the osu!taiko Spotlights this month is no one else but **::komasy::{ user=1980256 }**! Soumatou Labyrinth provides an extremely solid and consistent spread from Kantan to Inner Oni which will satisfy players of any skill level. Special shoutout to the Inner Oni that makes use of very intuitive 1/6 patterns while keeping an overall high difficulty with the usage of complex rhythms, suiting the song perfectly. A well deserved first place!
...
It's time to Cry Thunder! **::Surono::{ user=3611370 }** is storming this month's Spotlights with a 1/3 and 1/6-snap filled song by DragonForce!
...
Difficult rhythms, dense patterns, streams and various combined note snaps: My So-Called Life has everything, and **::Raiden::{ user=2239480 }** has combined them all into an amazing map. Also, don't get fooled by the long calm section in the first third of the song - the difficulty quickly ramps up as the song enters its more intense parts.
...
The July osu!catch Spotlights start with a bang! While this set by **::JBHyperion::{ user=4879508 }** doesn't really edge out on the star rating, it still is a wiggly map full of twists and turns for the player to hold their finger on. With his ever-distinct style present in the map, combined with the song's fast pace and uncommon rhythms, it sure is something that players would have to carefully (finger)dash for!

[![](/wiki/shared/news/2017-09-22-beatmap-spotlights-july-august-2017/yuragi.jpg)](https://osu.ppy.sh/beatmapsets/602506)

Surprising us with another entry, **::JBHyperion::{ user=4879508 }** has given us a solid mapset that shows mastery of balanced play-ability and flow. While it may comply with the standard settings of modern mapping, this map sets itself apart with solid flow and entertainment value. Great job!

[![](/wiki/shared/news/2017-09-22-beatmap-spotlights-july-august-2017/sad-machine.jpg)](https://osu.ppy.sh/beatmapsets/380329)

When you think of "marathons" in osu!catch, a Platter difficulty at 88.5 BPM doesn't typically spring to mind, but **::- Magic Bomb -::{ user=3071175 }** has brought something unique and different here with just such a map.
...
**::pwhk::{ user=4887865 }** is back once again with a 7-key BMS-style map. With the growing trend of fancy scroll speed changes and unique maps, sometimes it is also nice to look at maps that are kept simplistic yet deliver satisfaction.
...
Just when we all thought the days of mapping SDVX songs with the SFX were over, **::Skalim::{ user=2225008 }** gives us Bangin' Burst, an older map first submitted in 2014 with a style reminiscent of its time. Good stack usage and equal hand bias creates a balanced symmetry that's easy to read and comfortable to hit.
...
Featured as a guest difficulty for ::toybot::{ user=2848604 }'s set, we have Reminiscing by ::tasuke912::{ user=2774767 }! An approval sized map using complex yet intuitive 1/6 and 1/3 snapping combination throughout the map, making it quite challenging for a 5.94 Star Rated beatmap.
...
Despite a fairly repetitive song, ::butter0414::{ user=7935022 } managed to create a set with a good variety of patterning to dodge the song's natural tedium, with the density increasing gradually to encompass quintuplets mixed with ⅙ streams.
...
One of this month's three spotlighted full spread sets is ::maziari1105::{ user=4469725 }'s jazzy Din Don Dan, which won the 2nd Japanese osu!taiko beatmapping contest.
...
A well structured mapset by ::Nardoxyribonucleic::{ user=876419 }, almost completely bereft of any issues to point out. Simply superb all around.
...
Is it better to be BLACK or WHITE? The answer isn't obvious, but ::Arrival::{ user=1694000 }'s "White" difficulty stands spotlighted in a mapset that is predominantly "Black". How poetic.
...
A quite solid mapset brought up by ::komasy::{ user=1980256 } this month, yet again!
...
Swamp, predators, alligators and... anime grills? Once again we have ::Wonki::{ user=7898495 } featured as the top of the month with, yet again, another track by Zekk. A really catchy song combined with suited scroll velocity changes makes this set overall great.
...
::Kawawa::{ user=4647754 } is back again to bless the ranked section of osu!mania with another 7-key marathon length map, this time with a wide variety of patterns and techniques.
