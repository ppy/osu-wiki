...
Beloved by judge and community both, the winner of Aspire 2017: Stage Two is none other than **Intense Muskrat**, mapped by the extraordinarily talented ::Supairo::{ user=2837231 }, with a total score of **72.3/80** and **180** unique votes.
...
Gruellingly close but ever so far, **Powerful Viper** by ::tasuke912::{ user=2774767 } was nipping at the winning entry's heels every step of the way, scoring **67.2/80** with **162** unique votes.
...
Trailing behind the two frontrunners in third place overall was **Jovial Lark** by the much-loved ::S a n d::{ user=676578 }, scoring **56.1/80** with **128** unique votes overall.
