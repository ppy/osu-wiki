...
Halloween's quickly becoming something of an _osu!_ staple as far as seasonal events go, what with the [incredible showing](https://osu.ppy.sh/home/news/2016-10-29-halloween-cometh) from last year's spookiness.

We're aiming to match the glory of last year's showing, and to kick off the preparations, we're hosting another **Halloween-themed fanart contest, including all of the osu! community mascots!**
...
* **Artists should use the custom templates provided: [PSD template](https://assets.ppy.sh/events/fanart/templates/osu%21%20main%20menu%202732x1536.psd?2017) / [PNG template](https://assets.ppy.sh/events/fanart/templates/osu%21%20main%20menu%202732x1536.png?2017).** By use the templates we DON'T mean "leave the template visible in the artwork" - that just looks awful. The template shows what the in-game osu! cookie will hide. Make sure to **NOT** leave the template visible in your submission. Use it as a guide to figure out how to compose your piece, and that's it!
