...
The charts have been created by letting the [CAT](https://osu.ppy.sh/groups/21) and [BAT](https://osu.ppy.sh/groups/7) vote for the most noteworthy maps of each respective month. They will end on August 15th, 2014. **[You can check out the vote results here!](https://docs.google.com/spreadsheets/d/1bQQsvecPxgHJtFTMGWjSj25FcCmhGu82M8jvvNoKOic/edit)**

Congratulations to the winners of the May 2014 Ranking Charts. They get rewarded with a **1 month supporter tag**:

- **osu! standard:** ::randomizer89::{ user-id=648613 }
- **Taiko:** ::Konpaku Sariel::{ user-id=533502 }
- **Catch the Beat:** ::Serena-::{ user-id=2193444 }
- **osu!mania:** ::Qnyxiie::{ user-id=2940660 }

Additionally, we reward the highest voted map by providing **1 month supporter tag** to the mapper:

- **osu! standard:** ::RLC::{ user-id=1047883 } for [Himeringo - Yotsuya-san ni Yoroshiku](https://osu.ppy.sh/beatmaps/378781?m=0) (20 votes)
- **Taiko:** ::TKS::{ user-id=940878 } for [kors k - Insane Techniques](https://osu.ppy.sh/beatmapsets/155288) (10 votes)
- **Catch the Beat:** ::CLSW::{ user-id=531253 } for [nano - Nevereverland](https://osu.ppy.sh/beatmapsets/149570) (11 votes)
- **osu!mania:** ::Rumia-::{ user-id=1787171 } for [Sharlo - Sleeping Butterfly](https://osu.ppy.sh/beatmapsets/160695) (9 votes)
