...
- **osu! standard:** ::\_index::{ user-id=652457 } (Score: 54)
- **Taiko:** ::Axton777::{ user-id=3127106 }
- **Catch the Beat:** ::Dusk::{ user-id=533210 } (Score: 70)
...
- **Catch the Beat:** ::Zak::{ user-id=1375955 }

Additionally, we reward the highest voted map by providing 1 month supporter tag to the mapper:

- **osu! standard:** ::galvenize::{ user-id=381444 } for [Traktion - Mission ASCII](https://osu.ppy.sh/beatmapsets/53249) (9 votes)
- **Taiko:** ::CoroQuetz::{ user-id=499843 } for [Taishi - goldenslaughterer(Taishi's VW2 Edit)](https://osu.ppy.sh/beatmapsets/129354) (10 votes)
- **Catch the Beat:** ::CLSW::{ user-id=531253 } for [wowaka - Unhappy Refrain](https://osu.ppy.sh/beatmapsets/155930) (11 votes)
