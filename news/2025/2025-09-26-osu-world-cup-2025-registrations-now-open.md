...
![](/wiki/Tournaments/OWC/2025/img/owc2025-banner.jpg)

This year, we're shaking things up. For the first time ever in an osu! World Cup, the bracket will be expanded to **40 countries** in a brand new format designed to bring more teams into the fold and make early rounds more exciting than ever. To that end, we've also brought back the Group Stage (with a twist). 
...
While the tournament still features the classic Qualifier stage, the path forward for all teams has changed drastically. Instead of the usual 32 teams, there are **40 seeds** up for grabs – but there's a catch. The 40 qualifying teams will be divided into three distinct tiers:

- **Legends (Seeds 1–8):** The absolute best from the Qualifiers. These teams will receive a bye, skipping the group stage altogether and advancing directly to the Round of 16 winners bracket.
...
- **For Challengers**, all 16 teams advance. The top 2 from each group move into the Winners Bracket, while the bottom 2 drop to the Losers Bracket.
- **For Contenders**, the stakes are higher. Only the top 2 from each group will advance, moving directly into the Losers Bracket, while the bottom two are eliminated.
...
As always, for more details on this (and more!), please refer to the **[osu! World Cup 2025 wiki article](/wiki/Tournaments/OWC/2025)**. For this year in specific, we urge you to check the [Group stage instructions](/wiki/Tournaments/OWC/2025#group-stage-instructions) section, as it details how the group stage will work in full. You can also discuss this event in the **[official discussion thread](https://osu.ppy.sh/community/forums/topics/2133817)** or the public **[community server](https://discord.com/invite/0Vxo9AsejDkGlk3H)**.

## Tournament schedule

| Event | Timestamp |
| --: | :-- |
| Registration phase | Sep 26 (14:00 UTC) – Oct 10 (23:59 UTC) |
| Qualifier showcase | Oct 19 |
| Qualifier stage | Oct 25 & Oct 26 |
| Group Stage | Nov 1 – Nov 9 (two weekends) |
| Round of 16 | Nov 15 & Nov 16 |
| Quarterfinals | Nov 22 & Nov 23 |
| Semifinals | Nov 29 & Nov 30 |
| Finals | Dec 6 & Dec 7 |
| Grand Finals | Dec 13 & Dec 14 |

*Note: The Group stage adds one week to the overall tournament schedule.*

## Prizes

The osu! World Cup 2025 offers a $10,000 prize pool, along with limited-edition merch!

- **1st:** 50% of the prize pool, single-run merch, profile badge, **osu! Champion** user title for one year
- **2nd:** 30% of the prize pool, single-run merch, profile badge
- **3rd:** 20% of the prize pool, single-run merch, profile badge

## How do I register?

**[Click here!](https://osu.ppy.sh/community/tournaments/52)**
