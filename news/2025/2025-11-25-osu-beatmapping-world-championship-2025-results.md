...
![Podium of top 3 winning teams: USA, South Korea and Taiwan](/wiki/Contests/o!bwc/4/img/podium.jpg)

o!bwc kicked off with a qualifier round featuring all registered teams, followed by four intense clash rounds: Round of 16, Quarterfinal, Semifinal, and Final. In the qualifier round, 61 teams competed for 16 spots in the clash stage. Each clash round consisted of intense head-to-head matchups where only the winners advanced. For full details on the matchups, check out the [o!bwc bracket on Challonge](https://challonge.com/obwc2025) and the [livestream recordings](https://www.youtube.com/@osubwc8023) of each round.

The final stage featured two thrilling matches among the top four teams: ::{ flag=KR }:: South Korea vs. ::{ flag=US }:: United States for the championship, and ::{ flag=FR }:: France vs. ::{ flag=TW }:: Taiwan for third place. Both matches competed with the Featured Artist track *[Silentroom](https://osu.ppy.sh/beatmaps/artists/92) - F1055*. In a close 4–3 vote by the judges, Team United States triumphed over Team South Korea to claim the o!bwc 2025 championship. In another 4–3 vote, Team Taiwan won over Team France for the 3rd place.

| Team A |  |  | Team B |
| --: | :-: | :-: | :-- |
| **United States** ::{ flag=US }:: | **4** | 3 | ::{ flag=KR }:: South Korea |
| France ::{ flag=FR }:: | 3 | **4** | ::{ flag=TW }:: **Taiwan** |
...
> 
> This time, since the song is a uniquely styled IDM track, we all agreed that the CS5 AR9 setup fit perfectly, and we incorporated a lot of stylistic variation. For example, in the quieter sections we used some weird slider shapes, then switched to more angular ones as the orchestral part kicked in, and finally went all-out with a wild style during the chorus explosion.
> 
> We also hid a bunch of references — like a sudden Megalovania moment and the meme sound of THE ROCK. So of course, we added Sans from Undertale and the iconic THE ROCK slider. Huge thanks to the teammates for their amazing ideas!
> 
> Lastly, I want to thank my incredible teammates — I had a great time working on this. Without you all, Taiwan wouldn't have achieved such an outstanding result.
...
> 
> This map was, for us, the best we made among all our entries, because the whole team was able to spend much more free time on it. We were also quite inspired when finding the main theme, concepts, and so on. And I want to thank Pyo for her generosity and responsiveness in creating all of our animated banners for each of our entry descriptions.
...
—momoyo, Chaoslitz, seros, Lince Cosmico & Mafumafu
