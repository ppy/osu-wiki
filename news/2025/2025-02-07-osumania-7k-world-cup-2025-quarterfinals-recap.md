...
Japan (#4) versus Indonesia (#5) was bound to be a match between two titans fighting for their spot in the winners' bracket. Japan is well known for their strong rice skill thanks to ::{ flag=JP }:: ::butanic::{ user=1433586 } and ::{ flag=JP }:: ::rainlily::{ user=485007 }. With their returning teammates, ::{ flag=JP }:: ::Suzuha_l::{ user=6132697 } and ::{ flag=JP }:: ::[ misa ]::{ user=10011429 }, this made for an overall more balanced team as opposed to their opponents. Indonesia on the other hand has very strong LN players, courtesy of ::{ flag=ID }:: ::Onta_Bekasi::{ user=8677684 } being a force to be reckoned with throughout this tournament's history. With the help of ::{ flag=ID }:: ::_yea::{ user=20834055 } and ::{ flag=ID }:: ::[ -Asriel- ]::{ user=11829623 } alongside ::{ flag=ID }:: ::RaffCo::{ user=7589503 }'s consistency on rice sets, this made Indonesia yet another fairly well-balanced team. Given each team's strengths, this would be a match where hybrid maps would play a key role in their success.
