...
This first elimination round marked the end of the journey for 8 teams. The stakes are slowly rising as we progress in the bracket and approach the middle of the tournament, with a lot of action going on every week. Let's take a look at how things went!
...
This Round of 16 didn't feature as many close matches as the Round of 32, but it still had some interesting ones as well as a few surprises. Teams in the losers' bracket started fighting for their survival in the tournament, and 8 of them were eliminated. Only 8 teams remain undefeated in the winners' bracket, with the only one of them not being a top 8 seed being ::{ flag=PL }:: Poland, at seed 10. 4 of them will drop out of it next week in the Quarterfinals, so be on the lookout for some elite play from these teams next weekend!
...
So far the Qualifiers results are accurately predicting the outcomes of almost every match, but it's only a matter of time before things get shaken up, whether it is in the winners' or losers' bracket. With that being said, let's take a look at some highlight matches from this Round of 16!

### ::{ flag=US }:: United States vs. ::{ flag=SE }:: Sweden

**[You can view the match information here!](https://osu.ppy.sh/community/matches/118473926)**\
...
Looking at the winners' bracket matches last week, most people didn't anticipate a very exciting encounter between the United States (#1) and Sweden (#16). The mappool, even this early, wasn't easy enough for the teams way lower seeded than their opponents to go for an upset. Surely, last year's champions and number 1 seed wouldn't have any issues with the 16th seed, right?

Last year, the United States reached the Grand Finals week with only 2 points lost during their winners' bracket run, starting at their 7–1 win against against Chile during the Semifinals. Sweden on the other hand, finished top 24 last year, being eliminated in the Quarterfinals. They had already struggled to maintain themselves in the winners' bracket last week, managing to keep going thanks to a tiebreaker win against Peru.

Given all this, no one was really expecting Sweden to be able to compete against the United States in this matchup. So it was to everyone's suprise that they went and won their first pick, [NM1](https://osu.ppy.sh/beatmapsets/2388183#fruits/5168115), with a double FC from ::{ flag=SE }:: [amni sd](https://osu.ppy.sh/users/16669841) and ::{ flag=SE }:: [Shameimaru](https://osu.ppy.sh/users/20340480). With that, the United States' perfect record was already broken, with their flawless run unexpectedly coming to an end in this Round of 16.

The United States losing a point to Sweden, while unexpected, was also not something too shocking. With how good players have gotten, even lower-seeded teams are now able to compete and FC maps, only allowing a very slight margin of error for the top teams. The United States brushed that off as a misstep and stayed focused on their match, comfortably winning their next pick on [HR3](https://osu.ppy.sh/beatmapsets/2388197#fruits/5168156) with a second double FC in a row from ::{ flag=US }:: [Lexii](https://osu.ppy.sh/users/7226149) and ::{ flag=US }:: [Secre](https://osu.ppy.sh/users/2306637).

Sweden tried again on their [MM1](https://osu.ppy.sh/beatmapsets/2388341#fruits/5168359) pick but let the first breakpoint of the match slip away in the United States' favour. They were now down 2 points on their opponent's pick, and the match was going back to what one would expect of this matchup, a mostly one-sided victory from the United States. However, no one could have predicted what happened next.

The United States went and picked [HD2](https://osu.ppy.sh/beatmapsets/2388193#fruits/5168151), the low AR hidden pick, knowing what they're able to do on this map. ::{ flag=US }:: [Lexii](https://osu.ppy.sh/users/7226149) managed to get his third FC in a row and ::{ flag=US }:: [Dahcreeper](https://osu.ppy.sh/users/6926006) his second, but Sweden answered back with a double FC of their own from ::{ flag=SE }:: [amni sd](https://osu.ppy.sh/users/16669841) and ::{ flag=SE }:: [Setomi79](https://osu.ppy.sh/users/2205929) to win the point. Winning a single point against the champions was something, but a second one, and on their own pick? This match was getting intense, and Sweden were performing to the very best of their abilities.

And it did not stop here, with Sweden getting a mind-blowing 3-way FC on [NM2](https://osu.ppy.sh/beatmapsets/2388185#fruits/5168126) to win their own pick. It had been years since the last time the United States were contested like this so early in the bracket. However, champions don't become champions without a strong mental, and they went on to win the next 4 picks in a row, to close out the match 6–3. Even if they couldn't keep taking points from them, Sweden could be proud of their performance, as they gave the United States a battle that they're sure to remember for a while.
...
Despite a 6–2 result, the winners' bracket match between France (#5) and Canada (#12) was definitely one of the craziest ones this week, as well as one of the most anticipated ones. These two teams both have the potential to go for a deep bracket run, and none of them wanted to drop down to the losers' bracket this early on.

France started out very strong, winning on Canada's [MM1](https://osu.ppy.sh/beatmapsets/2388341#fruits/5168359) pick, while also setting the best team-score of the week on it, thanks to a double SS from ::{ flag=FR }:: [Ttobas](https://osu.ppy.sh/users/2084568) and ::{ flag=FR }:: [Electr0o](https://osu.ppy.sh/users/9484428) on Hard Rock and Hidden respectively, only matched by ::{ flag=CA }:: [CTBWhiteCat](https://osu.ppy.sh/users/7620002)'s own Hard Rock SS. France then went on to secure their breakpoint with a successful [HD2](https://osu.ppy.sh/beatmapsets/2388193#fruits/5168151) pick.

At this point, the maps were fairly close between the teams, with each having the potential to win essentially any pick depending on their performance. Canada barely managed to get on the board with their [HR2](https://osu.ppy.sh/beatmapsets/2388201#fruits/5168161) pick, only winning with a ridiculously small 775 points difference. Matches like these tend to be the most stressful ones for both the viewers and the players, because a single spin can make the difference. Canada could now breathe a bit as they had won the close point and secured their own pick. Surely no other pick will be this close...

France then went on to pick [NM3](https://osu.ppy.sh/beatmapsets/2388187#fruits/5168130) and once again set a top team-score, with ::{ flag=FR }:: [Electr0o](https://osu.ppy.sh/users/9484428) getting the only FC of the week on it. It was now up to Canada to pick, and they decided to go on [HR1](https://osu.ppy.sh/beatmapsets/2388200#fruits/5168160). And once again, on their second Hard Rock pick in a row, we would see a score difference of less than a thousand, with only 803 points of difference, but this time in favour of France. 

But what would be the nail in the coffin for Canada was France's next pick, the final Hard Rock map, [HR3](https://osu.ppy.sh/community/matches/118474861). Even on purpose the match couldn't have been more tragic for Canada, as they would go on to lose this map by a whole 4 points, one of the smallest score differences across all World Cups combined. France was now on match point, and despite Canada's successful [HD1](https://osu.ppy.sh/beatmapsets/2388192#fruits/5168150) pick, they would manage to close out the match 6–2 on [NM4](https://osu.ppy.sh/beatmapsets/2388325#fruits/5168335) with another double FC from ::{ flag=FR }:: [Electr0o](https://osu.ppy.sh/users/9484428) and ::{ flag=FR }:: [Ttobas](https://osu.ppy.sh/users/2084568), who would end up being ranked #1 and #2 best performers of the round on the [statistics sheet](https://docs.google.com/spreadsheets/d/1X1yRy2JXnWeeZPFa1voLP7EPifW2sQ11XvB56wKQpv8/edit?rm=minimal&gid=2090207382#gid=2090207382).
