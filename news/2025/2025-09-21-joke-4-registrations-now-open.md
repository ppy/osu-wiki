...
[Jaye's One Key Event](/wiki/Tournaments/JOKE) is a community for low-key osu!mania (1K–3K) players and mappers, spearheaded by ::Jaye::{ user-id=4841352 } and cohosted by ::Sparxe::{ user-id=5750235 } and [Sydosys](https://osu.ppy.sh/users/17523947). Across 1v1 tournaments, country-based team tournaments, dan courses and even an ARG, the JOKE series has seen many goofy and hype moments, and this year will prove to be no different!
