...
The saying "two heads is better than one" doesn't exactly apply to circle clicking, but ::ESCRUPULILLO::{ user=18217876 } and ::uatzap::{ user=16509171 } played [this map](https://osu.ppy.sh/beatmapsets/2391171) by ::Nagi Seishiro::{ user=6300910 } in tandem anyway. (And for anyone keeping track, this is the last [COE 2025](/wiki/Community/cavoe's_osu!_event) clip we have. For now.)
