...
This year's iteration will be hosted by ::{ flag=KR }:: ::momoyo::{ user-id=12469536 }, ::{ flag=HK }:: ::Chaoslitz::{ user-id=3621552 }, and ::{ flag=CN }:: ::Mafumafu::{ user-id=3076909 } with the help of ::{ flag=AR }:: ::Lince Cosmico::{ user-id=6070370 }, ::{ flag=HK }:: ::seros::{ user-id=10562853 } during clash rounds. Whether you're a seasoned mapper or a rising talent, we invite you to team up and take part in this beatmapping event! Join the [o!bwc Discord](https://discord.com/invite/QGzz3n655u) and visit the [forum thread](https://osu.ppy.sh/community/forums/topics/2060957?n=1) for more information, or just register for the contest [here](https://form-auth.ppy.sh/form/2025-bwc-registrations).
...
**[Click here to register for this contest!](https://form-auth.ppy.sh/form/2025-bwc-registrations)**
