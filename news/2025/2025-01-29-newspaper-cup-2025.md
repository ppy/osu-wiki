...
Newspaper Cup 2025, the 11th occurrence of this annual event, will be hosted by ::{ flag=CN }:: ::Mafumafu::{ user=3076909 }, ::{ flag=CN }:: ::Fycho::{ user=1876867 }, and ::{ flag=CN }:: ::Atrue::{ user=1758523 }. We strongly encourage and welcome novice mappers to participate!
...
- ::{ flag=CN }:: ::Pata-Mon::{ user=6149313 }
- ::{ flag=KR }:: ::momoyo::{ user=12469536 }
- ::{ flag=BR }:: ::Dada::{ user=9119507 }
- ::{ flag=IT }:: ::-kevincela-::{ user=266596 }
- ::{ flag=TW }:: ::Alty::{ user=16407988 }
- ::{ flag=JP }:: ::Satellite::{ user=1661227 }
- ::{ flag=HK }:: ::seros::{ user=10562853 }
- ::{ flag=CN }:: ::Luval::{ user=22414293 }
