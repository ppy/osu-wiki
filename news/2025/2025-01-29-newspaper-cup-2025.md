...
Newspaper Cup 2025, the 11th occurrence of this annual event, will be hosted by ::{ flag=CN }:: ::Mafumafu::{ user-id=3076909 }, ::{ flag=CN }:: ::Fycho::{ user-id=1876867 }, and ::{ flag=CN }:: ::Atrue::{ user-id=1758523 }. We strongly encourage and welcome novice mappers to participate!
...
- ::{ flag=CN }:: ::TtmnZk::{ user-id=2495509 }
...
- ::{ flag=CN }:: ::Pata-Mon::{ user-id=6149313 }
- ::{ flag=KR }:: ::momoyo::{ user-id=12469536 }
- ::{ flag=BR }:: ::Dada::{ user-id=9119507 }
- ::{ flag=IT }:: ::-kevincela-::{ user-id=266596 }
- ::{ flag=TW }:: ::Alty::{ user-id=16407988 }
- ::{ flag=JP }:: ::Satellite::{ user-id=1661227 }
- ::{ flag=HK }:: ::seros::{ user-id=10562853 }
- ::{ flag=CN }:: ::Luval::{ user-id=22414293 }
