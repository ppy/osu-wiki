...
For those unitiated on what LN Coordination is; LN Coordination, or "Timing Hell" as the more difficult mid to late-game maps withing this category are colloquially known as, is generally defined by high-tempo patterning primarily characterized by shields and decorated with LN flams, short bursts, complex staggered releases, and difficult one-handed patterning. This slot also typically tests consistency in LN patterning, as its physicality and technicality are fairly balanced. Especially in late-game, which means this slot can be on the longer side relative to the overall mappool.
