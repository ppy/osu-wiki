...
As 2026 approaches, we are updating both the match format and the tournament's design language (which looks amazing, by the way). Huge shoutout to our design team of ::AlexDunk::{ user-id=9194799 }, [ChillierPear](https://osu.ppy.sh/users/9501251), ::Detristy::{ user-id=38325708 }, and [LeeNarie](https://osu.ppy.sh/users/2667849) for this one. Here is what we have in store:
