...
| Mapping | ::{ flag=US }:: [-mint-](https://osu.ppy.sh/beatmapsets/2438747#mania/5318904), ::{ flag=CA }:: ::guden::{ user=11626065 }, ::{ flag=US }:: ::elexire::{ user=9206093 }, ::{ flag=US }:: ::0DZ0::{ user=28156707 }, ::{ flag=US }:: ::Toaph Daddy::{ user=7616811 }, ::{ flag=IT }:: ::rikan::{ user=25263357 }, ::{ flag=TH }:: ::MyZterioN-::{ user=8521723 }, ::{ flag=TW }:: ::[Crz]FolAH1217::{ user=6232458 } |
...
| Video | ::{ flag=SG }:: ::sugosugiii::{ user=15118952 } and ::{ flag=TW }:: ::DAi_::{ user=38467605 } |
...
Last but not least, while [Earth, Wind & Fire - September (yomoha remix)](https://osu.ppy.sh/beatmapsets/2438648#mania/5318620) (LN4) made many players choke on its many minijack shields, ::{ flag=US }:: ::Hello_Son::{ user=17308009 } was able to tame the beast and achieve a 990,229 score on, arguably, one of the hardest long note picks of this round's mappool.
