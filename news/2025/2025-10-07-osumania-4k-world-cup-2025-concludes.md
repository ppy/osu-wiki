...
But let us get straight to the point, for there are winners (and staff members!) to congratulate. For the last time this year, we want to extend our thanks to ::Dynascape::{ user=8784587 }, ::SunApple::{ user=11817622 }, ::Normiplier::{ user=10069850 }, and ::akace100::{ user=9308128 } for making the video recaps a reality. For those who are in dire need of a video while eating, may we suggest the following:
...
Similar to the Semifinals map pool, the Grand Finals pool also has an abundance of [osu! originals](/wiki/Community/Bespoke_music)! What better place to start than the very first slot of the pool? [LUZE - !!! IMPULSIVE <!!> WAVE !!!](https://osu.ppy.sh/beatmapsets/2438724#mania/5318853) (RC1) by ::{ flag=US }:: ::Valedict::{ user=2537082 } made its way in with single streams clocking in at an absurd 390 BPM. If you're at all familiar with MWC 4K pools from previous years, you might've thought it has similar structure to [a different song](https://osu.ppy.sh/beatmapsets/1796541#mania/3682631), made by [the same artist](https://osu.ppy.sh/beatmaps/artists/500), and charted by the same person, to which we'd tell you that was very much the idea behind it.

As expected of extratone, the patterns very much represent the amount of chaos going on, with the "easier" sections still giving you more technical patterns in order to always have you on edge for the entire duration of the song. With a spectacular illustration from ::{ flag=AU }:: ::-pineapple-::{ user=11523326 } and graphic design work by ::{ flag=US }:: ::mohca::{ user=14499702 } and ::{ flag=MY }:: ::Iyouka::{ user=7138499 }, there's a fully fledged original experience just itching to be played! But it's not for the faint of heart...
...
| Mapping | ::{ flag=US }:: [-mint-](https://osu.ppy.sh/beatmapsets/2438747#mania/5318904), ::{ flag=CA }:: ::guden::{ user=11626065 }, ::{ flag=US }:: ::elexire::{ user=9206093 }, ::{ flag=US }:: ::0DZ0::{ user=28156707 }, ::{ flag=US }:: ::Toaph Daddy::{ user=7616811 }, ::{ flag=IT }:: ::rikan::{ user=25263357 }, ::{ flag=TH }:: ::MyZterioN-::{ user=8521723 }, ::{ flag=TW }:: ::\1Crz\1FolAH1217::{ user=6232458 } |
| Illustration | ::{ flag=PH }:: ::Creameries::{ user=15851364 }, ::{ flag=ID }:: ::RianaRei::{ user=30314534 }, ::{ flag=CA }:: ::Envi9756::{ user=12084808 }, ::{ flag=MY }:: ::HiROdoge::{ user=15251809 } |
| Graphic design | ::{ flag=MY }:: ::Zeth::{ user=9912966 }, ::{ flag=CN }:: ::hourius::{ user=12580298 } |
| Storyboard | ::{ flag=IT }:: ::Kuroise::{ user=14547127 }, ::{ flag=US }:: ::binarie::{ user=15632854 }, ::{ flag=AU }:: ::Coppertine::{ user=7279762 }, ::{ flag=HU }:: ::Himada::{ user=10959366 } |
| Video | ::{ flag=SG }:: ::sugosugiii::{ user=15118952 } and ::{ flag=TW }:: ::DAi\1::{ user=38467605 } |
...
Being one of the hardest maps in the whole round, [LUZE - !!! IMPULSIVE <!!> WAVE !!!](https://osu.ppy.sh/beatmapsets/2438724#mania/5318853) (RC1) has been a thorn on many players' sides. Most players can't keep up with the crazy bursts, let alone holding their accuracy. There is but one exception: ::{ flag=US }:: ::Nepijin::{ user=11734610 } managed to achieve a score of 995,014 dominating their match and flabbergasting everyone along the way!

While ::{ flag=KR }:: ::ggeexx1::{ user=17494164 } has proven to be very skillful in many patterns, none are as strong as his jack skills. In [Camellia feat. chiisana - re:||VERSE](https://osu.ppy.sh/beatmapsets/2438731#mania/5318865) (RC4), they managed to get a (Score V1) SS with only 60 Perfects. That's a 1:59 ratio with a score over 999k points — the only one of the entire round!

Last but not least, while [Earth, Wind & Fire - September (yomoha remix)](https://osu.ppy.sh/beatmapsets/2438648#mania/5318620) (LN4) made many players choke on its many minijack shields, ::{ flag=US }:: ::Hello\1Son::{ user=17308009 } was able to tame the beast and achieve a 990,229 score on, arguably, one of the hardest long note picks of this round's mappool.
...
In a more direct sense, my main contribution outside of GFX was assisting with the video. I worked closely with ::sugosugiii::{ user=15118952 }, offering suggestions, advice, and providing design elements that she used to complete the final video reveal alongside ::DAi\1::{ user=38467605 }. From there, it's important to also recognize how every part of the team contributed to bringing the project together. The illustrators — ::Creameries::{ user=15851364 }, ::Minerva Rin::{ user=30314534 }, ::enviyu::{ user=12084808 }, and ::Hiro::{ user=15251809 } — supported the team by preparing all the character and background illustration assets. ::Panthullu::{ user=12580298 } worked alongside me on graphic design, also contributing to quality assurance duties. Storyboarding was handled by ::Kuroise::{ user=14547127 }, ::binarie::{ user=15632854 }, ::Coppertine::{ user=7279762 }, and ::Himada::{ user=10959366 }, who each brought their own unique touches to majority of the narrative.

This entire process was coordinated by ::Sakura006::{ user=10365024 }, with quality assurance provided by ::RedcXca::{ user=14056601 }, ::Panthullu::{ user=12580298 }, ::LenLitchu::{ user=34098325 }, and ::Noffy::{ user=1541323 } to ensure consistency across all assets. On the mapping side, ::-mint-::{ user=8976576 }, ::guden::{ user=11626065 }, ::elexire::{ user=9206093 }, ::0DZ0::{ user=28156707 }, ::Toaph Daddy::{ user=7616811 }, ::rikan::{ user=25263357 }, ::MyZterioN-::{ user=8521723 }, and ::\[Crz\]FolAH1217::{ user=6232458 } all came together to prepare the exciting beatmap. Finally, the replay was created by ::myucchii::{ user=10072733 }, who was on standby and completed it live in a voice channel with our team members watching.
...
When it comes to the osu!mania 4K World Cup, there are very few people as experienced as ::-mint-::{ user=8976576 } is. Having held the title of mappooler and advisor for so many years as well as taking part into multiple different roles, there are very few things she hasn't done. As they relay their torch to the next generation of poolers, we want to get her first-hand experience as an integral part of the tournament for so long!
...
I was also really young, and I barely understood the size of the daunting tasks ahead of me. People were extremely critical of my pooling in MWC 4K 2019, since I was honestly barely holding together as is. But I managed in the end, with the guidance of my pooling mentors from SOFT 4, ::lemonguy::{ user=4693052 }, ::stupud man::{ user=2141612 }, and ::Guilhermeziat::{ user=3661387 }, as well as my fellow map selectors in MWC 4K 2019, namely ::Feraligatr::{ user=7439226 } (AKA Dergo), ::juankristal::{ user=443656 }, ::WalterToro::{ user=5281416 }, and ::Shoegazer::{ user=2520707 }. I learned a lot about how to handle feedback and pressure, as well as navigating issues such as a mapper refusing to change something that had to be changed.

That's not to say the early years went fully smoothly by any means; there were a lot of hiccups along the way, and a multitude of mistakes that I made. But I continued to strive to become better at map selecting, and eventually, I was in charge of essentially the entire mappool — everything outside of SVs — by the time [MWC 4K 2022](/wiki/Tournaments/MWC/2022_4K) rolled around. Particular members were extremely helpful starting around the 2021-2022 era, such as ::guden::{ user=11626065 }, ::Paturages::{ user=1375479 }, and ::MyZterioN-::{ user=8521723 }. Ever since, we have tried to find new and better ways to make mappooling easier for everyone. Even now, I feel like we are still continuing to optimize and improve our workflows, which in turn allows for greater mapper creativity.
