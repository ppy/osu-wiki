...
But let us get straight to the point, for there are winners (and staff members!) to congratulate. For the last time this year, we want to extend our thanks to ::Dynascape::{ user=8784587 }, [SunApple](https://osu.ppy.sh/users/11817622), ::Normiplier::{ user=10069850 }, and [akace100](https://osu.ppy.sh/users/9308128) for making the video recaps a reality. For those who are in dire need of a video while eating, may we suggest the following:
