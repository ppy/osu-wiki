...
On August 17, we hosted a Twitch livestream to showcase all 42 entries in a countdown towards the winners of the contest. If you missed it, you can watch the full VOD below, featuring commentary from ::mangomizer::{ user-id=1893718 }, [Walavouchey](https://osu.ppy.sh/users/5773079), and ::Doomsday::{ user-id=18983 }.
...
- ::peppy::{ user-id=2 }, the creator of the game, favourites the beatmap
