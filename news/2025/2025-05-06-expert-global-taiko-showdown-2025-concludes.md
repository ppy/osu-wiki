...
Massive applauses to our podium finishers, ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 }, ::{ flag=JP }:: ::kanten_07::{ user=11680357 } and ::{ flag=JP }:: ::Maimaing::{ user=14520910 }, for creating such an unforgettable final week!
...
<div align="center" class="osu-md__paragraph">
    <iframe width="95%" style="aspect-ratio: 16 / 9;" src="https://www.youtube.com/embed/CVBCS3p2FZE" frameborder="0" allowfullscreen></iframe>
</div>
...
- In 2020, ::{ flag=CA }:: ::janitore::{ user=3307897 } went up against ::{ flag=JP }:: ::uone::{ user=5321719 } who sought to flip the script after being knocked into the lower bracket in Semifinals. uone proceeded to sweep janitore into a bracket reset and finished the job by defeating him 7–2.
- In 2021, ::{ flag=JP }:: ::ekumea1123::{ user=9119501 } and ::{ flag=JP }:: ::Seren58::{ user=15252950 } gave us the closest Grand Finals scoreline thus far with ekumea1123 resetting the bracket with a 3–7 victory, followed by a 7–4.
- In 2022, ::{ flag=JP }:: ::Seren58::{ user=15252950 } came back to defeat ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 } with a crushing 7–1 victory.

History seemed to repeat itself as ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 } pulled ahead with a 5–2 scoreline against ::{ flag=JP }:: ::kanten_07::{ user=11680357 }, and most were expecting one of the best HD player in osu!taiko to win the next pick of HD2. Yet, miraculously, ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 } found catastrophic misses in the final ten seconds which swayed the point, to the shock of everyone, to ::{ flag=JP }:: ::kanten_07::{ user=11680357 }'s bitterly held FC.

Three more consecutive points were tipped towards ::{ flag=JP }:: ::kanten_07::{ user=11680357 } with mostly razor-thin margins, save for a commendable 90k lead on HR2. At this point, all of a sudden, he was one point away from resetting the bracket.

::{ flag=JP }:: ::Grape_Tea::{ user=9540073 }'s final pick was between one of two incredibly painful maps: NM5, a chaotic polyrhythmic experience, and DT1, a speedy accuracy nightmare. His choice fell upon NM5, but no one could've anticipated the back-and-forth that ensued.

For the first and only time in the history of EGTS, players and viewers alike would be treated to a true world premiere: a genuine Grand Finals tiebreaker; an 11-minute gauntlet at the end of a nerve-wracking one-hour match to decide whether ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 } would be crowned the final EGTS champion, or whether he would have to prove himself all over again. By the end, ::{ flag=JP }:: ::kanten_07::{ user=11680357 } won with a 47,159-score difference.
...
For example, ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 } found a *1.042 million* HD score on FM3 to win the point, yet it would be impossible to overstate ::{ flag=JP }:: ::kanten_07::{ user=11680357 }'s FC with **HR** on his opponent's reading and accuracy-heavy pick.

Both continued to not give away any of their own picks, but it was apparent that something had changed in ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 }'s mind. A 2x100 HD FC on FM1, a *halving* of his previous 100 miss count on DT2 (albeit still losing the pick), and his **near SS** on HD2 showed the audience just what kind of determination he had brought to the match that he wasn't willing to give up on.

<div align="center" class="osu-md__paragraph">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/media/news/egts-2025-grape_tea-vs-kanten_07.mp4" type="video/mp4" preload="none">
    </video>
</div>
...
::{ flag=JP }:: ::kanten_07::{ user=11680357 }'s final pick was HR2, one which he had handily won in the previous match. However, despite some narrow misses at the start and at the end of this pick, ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 } didn't waver once, reducing his miss count from 73 to 7 and getting tantalisingly close to 99% accuracy, leaving ::{ flag=JP }:: ::kanten_07::{ user=11680357 } in the dust and securing himself the first break point of the bracket reset.

With a 5–6 lead, ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 } doubled down and picked HR1 — a pick which, again, ::{ flag=JP }:: ::kanten_07::{ user=11680357 } had won previously. By adding insult to injury on the home stretch, ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 } finished with an FC, replicating his opponent's feat from the previous match with much better accuracy to boot and denying his chance at another tiebreaker.

::{ flag=JP }:: ::Grape_Tea::{ user=9540073 }, the favourite to win since the very beginning, became the final EGTS champion, but absolutely no one could've anticipated what it took him to get there in the end.
...
Round of 32 then started, and what a lineup of players to start off with. ::{ flag=JP }:: ::hz404::{ user=14947043 }, ranked at #14, winning the 2023 edition of [Squad Global Taiko Showdown](https://osu.ppy.sh/community/forums/topics/1703263) and finishing 3rd in [Project Prism](https://osu.ppy.sh/community/forums/topics/1909279), facing off against ::{ flag=JP }:: ::Shamirin_mzk::{ user=11325757 }, ranked at #42, winning the 2021 [Continental Global Taiko Showdown](/wiki/Tournaments/GTS/CGTS_2021) tournament, as well as [TWC 2024](/wiki/Tournaments/TWC/2024) with the Japanese team.

With both players having both significant achievements on both the solo leaderboards and tournaments, the match was bound to be exciting. And exciting it was, with the third map, [(The) * Red Room](https://osu.ppy.sh/beatmapsets/2325015#taiko/4983573) ending with a 1,382-point difference, giving the win to ::{ flag=JP }:: ::hz404::{ user=14947043 }, for his first point in this match, as ::{ flag=JP }:: ::Shamirin_mzk::{ user=11325757 } was leading by 2 points at this point.

Somehow this was "only" the third lowest score difference. ::{ flag=JP }:: ::Shamirin_mzk::{ user=11325757 } scraped the match to a 4–4 tie on [Luminosity](https://osu.ppy.sh/beatmapsets/2325073#taiko/4983703) by 1,325 points, and just before the tiebreaker, the match got *even closer* on [Taffy](https://osu.ppy.sh/beatmapsets/2324286#taiko/4981586) with an absurd **57** points bringing both players to match point.

As for the tiebreaker's result, well, how about you go check it out on the VOD itself? You won't be disappointed.

### Round of 16: ::{ flag=JP }:: supesan vs. ::{ flag=US }:: mBiscuit

<div align="center" class="osu-md__paragraph">
    <iframe width="95%" style="aspect-ratio: 16 / 9;" src="https://www.youtube.com/embed/ta-RvWKRi64" frameborder="0" allowfullscreen></iframe>
</div>

Now, for a departure from top players facing off in extra early rounds, for Round of 16's highlight, we will be talking about a match-up of two very underrated players. This match is between ::{ flag=JP }:: ::supesan::{ user=14623658 }, who, despite being #185 on osu!taiko's performance point ranking, seeded #8 through our Qualifiers, and ::{ flag=US }:: ::mBiscuit::{ user=17061174 }, who achieved a very respectable seed of #46 considering his pp-based rank, being #411.

Nothing really announced this to be such a close match. Although ::{ flag=JP }:: ::supesan::{ user=14623658 } definitely has a higher skill cap thanks to his rank, ::{ flag=US }:: ::mBiscuit::{ user=17061174 } is possibly one of the best players in terms of reading and gimmick abilities, and this match showcased all of this in the most perfect ways possible.

Between ::{ flag=US }:: ::mBiscuit::{ user=17061174 } winning on [HD1](https://osu.ppy.sh/beatmapsets/2328983#taiko/4994070), [FM1](https://osu.ppy.sh/beatmapsets/2328977#taiko/4994051), [FM2](https://osu.ppy.sh/beatmapsets/2329063#taiko/4994258), [FM3](https://osu.ppy.sh/beatmapsets/2329068#taiko/4994266), [NM4](https://osu.ppy.sh/beatmapsets/2329039#taiko/4994216), a mix of reading, consistency and gimmick picks, and ::{ flag=JP }:: ::supesan::{ user=14623658 } winning on [NM3](https://osu.ppy.sh/beatmapsets/2329033#taiko/4994202), [DT2](https://osu.ppy.sh/beatmapsets/2329049#taiko/4994233), [NM2](https://osu.ppy.sh/beatmapsets/2329034#taiko/4994203), [NM5](https://osu.ppy.sh/beatmapsets/2328994#taiko/4994086), [HR1](https://osu.ppy.sh/beatmapsets/2329036#taiko/4994210), and the [tiebreaker](https://osu.ppy.sh/beatmapsets/2329073#taiko/4994275), the more mechanics-focused picks in this pool, this match made for one of the most interesting contrasts to look at for such a close match.
...
Now we're into the late stage of EGTS. This is probably now known as one of the biggest upsets in the entire tournament, knowing how good ::{ flag=KR }:: ::Peaceful::{ user=165027 } has always been at this level of tournament performance, and it reflected in the pick'ems, with 90.5% of votes predicting the win going his way.

However, ::{ flag=JP }:: ::kanten_07::{ user=11680357 } was prepared to prove us wrong, in every way conceivable. The first 4 picks went as planned for both players, each of them winning their respective picks for a tied match. But then, ::{ flag=KR }:: ::Peaceful::{ user=165027 } picked [HD1, *parallel skydive*](https://osu.ppy.sh/beatmapsets/2332962#taiko/5006346), and this was the start of the most unexpected run, as he would get 10 misses, whereas ::{ flag=JP }:: ::kanten_07::{ user=11680357 } just went and FC'd it. Despite being known as a No Mod player mainly, he went and stole away a point on a slow SV HD map against the best reading player in the game.

After that, the match went on for 3 picks in a row, where neither player could even win their own pick, especially with [Fortuna for Tuna](https://osu.ppy.sh/beatmapsets/2333012#taiko/5006460) being won by ::{ flag=KR }:: ::Peaceful::{ user=165027 } with a 112-point difference.
...
Back to a tie again at 4–4. With each player having one pick left, they manage to both win their respective picks, although it was by 5,429 and 2,567 points respectively, with the last one being especially impressive to look back on...
...
By the time of the song's breakdown section, the misses started coming in. ::{ flag=KR }:: ::Peaceful::{ user=165027 } missed 3 in a row, and ::{ flag=JP }:: ::kanten_07::{ user=11680357 } traded them back with 15 in a row. Everything seemed hopeless at this point, even with 4 additional misses from ::{ flag=KR }:: ::Peaceful::{ user=165027 }, but then the very last section came up...
...
::{ flag=JP }:: ::kanten_07::{ user=11680357 } won in one of the most exciting ways a tiebreaker could end, namely by a slim 3,775 points, and advanced to the Semifinals in the winners' bracket.
...
We're now in the first round of Semifinals for the losers' bracket with a legendary line-up of players to say the least. On one side we have ::{ flag=KR }:: ::Peaceful::{ user=165027 }, current [Project Prism champion](https://osu.ppy.sh/community/forums/topics/1909279) and 4-time TWC podium finisher. On the other side we have ::{ flag=JP }:: ::_Kan2::{ user=7160196 }, having one of the highest skill caps for a tournament player despite not playing in tournaments, showcased with his unmatched 2-miss score on [TremENDouS](https://osu.ppy.sh/beatmapsets/1632807#taiko/3332914), EGTS 2021's Grand Finals tiebreaker, and being the only player that has won both Squad Global Taiko Showdowns of 2021 and 2023.

Now, how could this match between such juggernauts of osu!taiko go? Picks for both players were pretty unsurprising, with ::{ flag=KR }:: ::Peaceful::{ user=165027 } choosing the reading aspect of the mappool, with [FM3](https://osu.ppy.sh/beatmapsets/2336583#taiko/5016186), [HR2](https://osu.ppy.sh/beatmapsets/2336561#taiko/5016142), [HD1](https://osu.ppy.sh/beatmapsets/2336375#taiko/5015685), [FM1](https://osu.ppy.sh/beatmapsets/2336556#taiko/5016129), [NM4](https://osu.ppy.sh/beatmapsets/2336545#taiko/5016102), and [NM6](https://osu.ppy.sh/beatmapsets/2336555#taiko/5016128), as a mechanics-oriented final pick. For ::{ flag=JP }:: ::_Kan2::{ user=7160196 }, we ended up with [NM1](https://osu.ppy.sh/beatmapsets/2336548#taiko/5016113), [NM3](https://osu.ppy.sh/beatmapsets/2336550#taiko/5016115), [NM5](https://osu.ppy.sh/beatmapsets/2336559#taiko/5016136), [HR1](https://osu.ppy.sh/beatmapsets/2336376#taiko/5015688), [NM2](https://osu.ppy.sh/beatmapsets/2336557#taiko/5016130), and [DT2](https://osu.ppy.sh/beatmapsets/2336377#taiko/5015689). This entire match went according to plan for the first 4 picks, but ::{ flag=KR }:: ::Peaceful::{ user=165027 } then lost on HD1, losing the slow HD reading map for the second match in a row, and giving ::{ flag=JP }:: ::_Kan2::{ user=7160196 } the first break point of the match.

Sadly for him, this would not be the last break point, as ::{ flag=KR }:: ::Peaceful::{ user=165027 } ended up retaliating by first winning [HR1](https://osu.ppy.sh/beatmapsets/2336376#taiko/5015688) in dominating fashion (an FC), then tying up the match, and finally, winning [DT2](https://osu.ppy.sh/beatmapsets/2336377#taiko/5015689) in one of the most impressive break points imaginable, with just 483 points to decide the whole match.
...
Here we were, the final match deciding who would face off against ::{ flag=JP }:: ::Grape_Tea::{ user=9540073 }, in the Grand Finals of EGTS 2025 the following day.

Everyone was expecting this match to be extremely close, especially as it was a revenge match from Semifinals, where ::{ flag=JP }:: ::Maimaing::{ user=14520910 } came out on top at 7–5.
...
However, with the first quarter of the map done, it started looking hopeless, as ::{ flag=JP }:: ::Maimaing::{ user=14520910 } was already 23,145 points ahead. With ::{ flag=JP }:: ::kanten_07::{ user=11680357 } being 31 misses behind, this seemed like a done deal, especially with none of the song's hard parts having come up yet.
...
Whatever it was that happened in his mind to hit all of this, this was the turning point of the map, as ::{ flag=JP }:: ::kanten_07::{ user=11680357 } took the lead and never looked back, winning by a jaw-dropping 7,627 points.
...
::blobdash::{ user=8337877 } makes his return to GTS in grand fashion, with [VOID ELEVATOR](https://soundcloud.com/blobdash/void-elevator), returning after his three songs provided to [EGTS 2022](/wiki/Tournaments/GTS/EGTS_2022). He's become a reliable part of GTS since then with many recurring contributions:
...
The map by ::My Angel Seia::{ user=17797595 } has absolutely nothing angelic about it. The easy parts are when 220 BPM streams are mapped at the normal SV, but whenever you see an SV slowdown in this map, the only answer is to run, frankly.
...
The sheer scale of this collaboration is definitely absurd, and the map made by ::Hivie::{ user=14102976 } for it definitely follows it through, ending up as a defining pick for both Grand Finals matches.
...
::kanten_07::{ user=11680357 } finished at 2nd place for this year's EGTS with one of the most surprising bracket runs in the entire tournament, forcing the closest Grand Finals in EGTS history.
...
You've had the most impressive run in this year's EGTS, with a lot of upsets to your name. How did you feel after these numerous upsets you managed to get, and how did you prepare for them?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/11680357" style="background-image: url('/wiki/shared/avatars/kanten_07.jpg')"></a>
...
Are there any other players in the tournament that surprised you with their performance during the tournament?
...
The two people that surprised me with their performance were ::Grape_Tea::{ user=9540073 } and ::chibamasu::{ user=16067522 }:

- ::Grape_Tea::{ user=9540073 } really surprised me by SSing every map in the Qualifiers, and with their overwhelming consistency in the map pools every week.
...
::4sbet1::{ user=11563671 } was one of the head mappoolers for this year's EGTS, having helped tremendously in terms of improving communication with Japanese users, as well as having worked on a huge part of the general mappooling with ::ekumea1123::{ user=9119501 }, especially for later stages.
...
<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/35127759">Foodbot</a></p>
...
::Z419::{ user=9912966 } (a.k.a. Zeth) has been the main designer for this final edition of EGTS, being in charge of making the most appealing designs possible for everything that was not an original song.
...
With EGTS 2025 being such a massive gathering of original songs, how did it affect your personal experience in terms of designing for this tournament?
...
It 100% was a super fun experience for me personally, being able to work with so many different music artists and come up with all the visuals for so many different things, and the chances to collaborate between the different designers on many of these projects is a once-in-a-lifetime experience, and I think many viewers of EGTS are equally as excited as us, waiting for each week's new visuals for the custom songs, so I just hope everyone enjoyed the designs as much as we enjoyed making them.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/6177263" style="background-image: url('/wiki/shared/avatars/Kasumi-sama.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/6177263">Kasumi-sama</a></p>

How was the working environment like in the tournament, especially in the designers' channel? Did engaging with other designers and musicians help motivate your creativity?
...
::overdahedge2015::{ user=9864847 } has been a force to be reckoned with in tournament staffing over the years, taking on playtesting for numerous osu!taiko tournaments. EGTS was no stranger to this, as he was the head playtester for this tournament as well.
...
While having been the main playtester for this tournament, having playtested half of the pools nearly entirely by yourself, how hard is it to keep in mind your own player opinions, as well as trying to balance them what would be best for the mappools?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/9864847" style="background-image: url('/wiki/shared/avatars/overdahedge2015.jpg')"></a>
...
After your experiences in tournaments, how do you think the tournament scene should move forward with its mappool system?
...
Describe GTS in less than 10 words.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/11563671" style="background-image: url('/wiki/shared/avatars/4sbet1.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/11563671">4sbet1</a></p>

The definitive conclusion to a community tournament series

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/35127759" style="background-image: url('/wiki/shared/avatars/Foodbot.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/35127759">Foodbot</a></p>

I hope GTS CAR becomes a real merch someday.
