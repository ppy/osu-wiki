...
We've had **Powerwolf** in our backlog for a long time — since before [COE 2024](/wiki/Community/cavoe's_osu!_event/2024), where ::Optimism::{ user=2064831 } blasted through the streams of [Christ & Combat](https://osu.ppy.sh/beatmapsets/1013426) by ::piroshki::{ user=7645522 } using only his thumb and index finger. We're not sure how it's possible either, but the proof is here:
...
Try out [this Ranked map](https://osu.ppy.sh/beatmapsets/1044785) also mapped by ::piroshki::{ user=7645522 } or [this Loved rendition](https://osu.ppy.sh/beatmapsets/764649) hosted by ::Amberessence::{ user=10145026 }!
