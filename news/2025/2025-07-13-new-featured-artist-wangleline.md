...
German producer **WangleLine** is as prolific as one can be. With 14 albums created to date, plus tracks for the [osu!catch World Cup](/wiki/Tournaments/CWC), [Lazer Grand Arena](/wiki/Tournaments/LGA), and various [community tournaments](/wiki/Community/Bespoke_music), **WangleLine** has developed a style that perfectly suits the needs of rhythm game players. (Given her background as both an ::osu! player::{ user-id=7994819 } and a game developer, that shouldn't be a surprise.)
...
Try [the World Cup map](https://osu.ppy.sh/beatmapsets/2402735) mapped by ::Phob::{ user-id=6069462 } and [wwwww](https://osu.ppy.sh/users/8434466) for yourself!
...
Take a trip through [the map made for last year's osu!catch World Cup](https://osu.ppy.sh/beatmapsets/2202809) hosted by ::Bunnrei::{ user-id=829284 } or [this circle-filled rendition](https://osu.ppy.sh/beatmapsets/2325809) hosted by ::tatemae::{ user-id=5223028 }!
...
Experience [the map from Lazer Grand Arena](https://osu.ppy.sh/beatmapsets/2222345) hosted by ::riot1133::{ user-id=11877992 }!
...
Check out [this map](https://osu.ppy.sh/beatmapsets/1951967) hosted by ::hehe::{ user-id=2123087 }!
...
Play [this map](https://osu.ppy.sh/beatmapsets/1881362) hosted by ::keevy::{ user-id=10584295 }!
...
Test your luck on [this map](https://osu.ppy.sh/beatmapsets/2005921) hosted by ::hehe::{ user-id=2123087 }! Apparently osu!catch players like the convert for this one, so have fun with that too!
