...
| Team A |  |  | Team B |
| --: | :-: | :-: | :-- |
| **Russian Federation** ::{ flag=RU }:: | **6** | 2 | ::{ flag=ES }:: Spain |
| **New Zealand** ::{ flag=NZ }:: | **6** | 1 | ::{ flag=SE }:: Sweden |
| Romania ::{ flag=RO }:: | 5 | **6** | ::{ flag=TW }:: **Taiwan** |
| **France** ::{ flag=FR }:: | **6** | 1 | ::{ flag=JP }:: Japan |
| **Philippines** ::{ flag=PH }:: | **6** | 1 | ::{ flag=ID }:: Indonesia |
| **Brazil** ::{ flag=BR }:: | **6** | 4 | ::{ flag=FI }:: Finland |
| **Norway** ::{ flag=NO }:: | **6** | 2 | ::{ flag=TR }:: Türkiye |
| **Canada** ::{ flag=CA }:: | **6** | 3 | ::{ flag=DE }:: Germany |
| **Chile** ::{ flag=CL }:: | **6** | 1 | ::{ flag=AT }:: Austria |
| **United States** ::{ flag=US }:: | **6** | 0 | ::{ flag=GB }:: United Kingdom |

### ::{ flag=RO }:: Romania vs. ::{ flag=TW }:: Taiwan
...
| Team A |  |  | Team B |
| --: | :-: | :-: | :-- |
| **Australia** ::{ flag=AU }:: | **6** | 2 | ::{ flag=KR }:: South Korea |
| France ::{ flag=FR }:: | 3 | **6** | ::{ flag=NZ }:: **New Zealand** |
| **Poland** ::{ flag=PL }:: | **6** | 1 | ::{ flag=CN }:: China |
| Taiwan ::{ flag=TW }:: | 2 | **6** | ::{ flag=CL }:: **Chile** |
...
### ::{ flag=FR }:: France vs. ::{ flag=NZ }:: New Zealand
...
It was the biggest win in New Zealand's OWC history, securing their first-ever place in the Semifinals week and with it their first-ever guaranteed top 12 finish, silencing any who may have doubted their potential following their Qualifier performance.
...
<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/beatmaps/artists/5" style="background-image: url('/wiki/shared/avatars/Helblinde.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-fa" href="https://osu.ppy.sh/beatmaps/artists/5">Helblinde</a></p>

I'm incredibly thankful, I've mentioned it before but I used to use osu! back in 2008 to prepare for Counter-Strike tournaments and I've always had a strong connection to it. Even though I am quite an old man now, it was heartwarming to see that so many remember my songs to this day. To also end up with such an amazing art team and mappers made it even better, and now my goal is to get decent enough at the game again to be able to at least pass the tiebreaker. Honestly, it has made me want to put in a little bit more effort into music again, which I never really expected.
...
While I'm not going to name all of them, "oblivion calls you home" refers to the old track that was in the Aspire competition in 2016. I used some of the same synths that I did for that track, as a bit of a continuation of what was made previously. I basically leaned in to the past as much as I could, both for the sake of nostalgia and going "full circle". And of course mania had to be mentioned in there somewhere...
...
Absolutely, I had a clear goal going in but as per usual it ended up nothing like I originally intended. But I wanted to have a bit of variety, looking back I could have probably done a bit of a better job with that but honestly the mappers did such an excellent job. When the last full screen jump section came on I laughed a bit because that was partly why I made it pure 4/4 without a lot of distraction in the end. The collaboration was probably one of my best experiences I've had over the years, clear communication, taking my thoughts and feelings into consideration; and everyone being really good at what they do. It was so good that it invoked a feeling of wanting to collaborate more instead of going solo as I have for so long, so that's saying something.
...
Start small, build a small community of others that are in a similar position and grow together. If you try to reach out too far initially you'll put way too much pressure on yourself, and you need that tight-knit community group to help form each other and to be able to give good feedback. It's also way easier to take feedback from good buddies. If time allows, I've considered mentoring and building a foundation for new artists to have a good space to express themselves as I haven't found anything like it.

At some point you will find your little niche where you can start adding individuality to it, that's when it gets real fun. If someone out there is reading this and considering making music, I promise that you can. I have no musical background whatsoever, but I learned through observation, failing a lot, and loving the kick that music gives you. It's cliche but if I can do it, you can too.
...
Welcome back to storyboarding! Many in the community already recognize your name from your iconic lyric storyboards. For those discovering your designs for the first time, can you tell us a bit about yourself? How would you describe yourself as a storyboard designer?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/5383942" style="background-image: url('/wiki/shared/avatars/LowGraphics.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/5383942">LowGraphics</a></p>

Hi there, I'm LowGraphics! I've been storyboarding since 2021, some of you may recognize the first project I ever worked on which was the [TUYU Songs Compilation](https://osu.ppy.sh/beatmapsets/1382858#osu/3063448). Having no knowledge in video production or motion design, I thought it would be an interesting challenge to try to recreate their music videos. That took a year. But now, with last year's [Lies Playing Truth](https://youtu.be/v5ZaTeibemI), I somehow actually managed to make an actual music video within osu!, and I couldn't be happier with how my storyboarding career has gone.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/10365024" style="background-image: url('/wiki/shared/avatars/Sakura006.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/10365024">Sakura006</a></p>

Your specialty lies in lyric storyboards. However, Nástrǫnd was a very different project. This song had less vocals and a heavy atmosphere. How did the absence of lyrics affect your approach towards planning the storyboard? What changed in your workflow compared to previous lyric-driven storyboards like [Lies Playing Truth](https://youtu.be/v5ZaTeibemI) and [Veil of Ash](https://youtu.be/1a8kmvlpSj4)?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/5383942" style="background-image: url('/wiki/shared/avatars/LowGraphics.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/5383942">LowGraphics</a></p>

In lyric-driven storyboards, the animation of the text is usually the main selling point. With Nástrǫnd, what I usually rely on for visual flair just wasn't there. The lack of vocals shifts the focus entirely onto the atmosphere and narrative, which meant the animations had to carry the emotional weight of the song on their own.

We joked during planning that the whole storyboard was going to be themed around vibe, but in reality it was a huge challenge to meet that expectation. Because the track is so intense, it felt like every second needed to be a visual spectacle. Matching the feeling of the song is the main priority, and that was a very different kind of challenge compared to lyrical songs.

For some sections, we even had to work backwards. I needed to first imagine what kind of animation would suit the mood or energy, and only after figuring out the movement and pacing could we decide which illustrations or motifs best supported that idea. It was a new workflow for me, but also a really fun way to rethink how I approach storytelling.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/10365024" style="background-image: url('/wiki/shared/avatars/Sakura006.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/10365024">Sakura006</a></p>

Helblinde introduced Nástrǫnd with the theme of harsh afterlife rooted in Norse mythology, giving the team full creative freedom to explore the theme. Did the freedom to explore such a grim concept influence the ideas you had early on? Were there any design elements that drove your decisions?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/5383942" style="background-image: url('/wiki/shared/avatars/LowGraphics.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/5383942">LowGraphics</a></p>

Having full creative control can be a blessing and curse at times. On one hand, you don't have to worry about what the musician envisioned things to be like, but on the other hand where do you even start with the planning?
...
It's always an inspiring experience to work with a large team where each role contributes a unique piece to the final production. What was the collaboration experience like for you? Has it opened up any new directions or ideas you'd like to explore in future designs?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/5383942" style="background-image: url('/wiki/shared/avatars/LowGraphics.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-no-group" href="https://osu.ppy.sh/users/5383942">LowGraphics</a></p>

As the title storyboarder suggests, it's my role to plan out how the song's narrative is told. I usually come in with references and rough visuals so the team can get a sense of the direction I'm imagining. But that has its own problem as I tend to think within the limits of my own experience, so my initial ideas can be a bit tunnel visioned.

One of the things that I absolutely love about collaborating is how naturally we bounce ideas off one another. Everyone brings something a little bit new to the table, and that back and forth always pushes the concept further than whatever we had at the start. If these projects have taught me anything, it's to trust the collective experience of everyone involved.

I honestly can't say enough about how lucky we are to have such talented designers on board. Collaborations always help to push ideas further, and the end product that the audience gets to enjoy is something that I'm always going to be proud to share.
...
—Azer, Dada, D I O, Sakura006, shdewz & this1neguy
