...
Speaking of highlights, let's talk about the star of the pool: [aran - Yoake Mae feat. shully](https://osu.ppy.sh/beatmapsets/2303945#mania/4924806) (LN1) by ::{ flag=MY }:: ::\1Kobii::{ user=6209713 }. Whereas in previous years this would've been a long note pick with a focus on releases, this time around the poolers decided to test players' finger coordination as a whole. Other noteworthy maps include [Mono. - skip&step](https://osu.ppy.sh/beatmapsets/2303942#mania/4924800) (RC3) by ::{ flag=US }:: ::Blocko::{ user=4075092 }, a fun and varied rice experience meant to keep players on their toes — or shall we say, their fingers? Finally, we have [seatrus - Hekikuu no Yakusoku](https://osu.ppy.sh/beatmapsets/2303946#mania/4924807) (HB2) by ::{ flag=MY }:: ::Critical\1Star::{ user=3793196 }. Players got a little of tiebreakers to come, as well as the intensity they should expect.
...
Kicking things off, we've got ::\1Kobii::{ user=6209713 } to tell us how pooling works from the perspective of a head pooler. While _Kobii's experience extends beyond tournaments alone, their work as a mapper and playtester ever since they joined the pooling theam in 2022 has given them a ton of insight over the years. A feat that has got them promoted to where they are right now!
