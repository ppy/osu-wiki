...
I don't have many storyboards to showcase, but my strength in narrative design is reflected in my maps for [SeventH-HeaveN](https://osu.ppy.sh/beatmapsets/2293637#osu/4897782) and the recent [TWC 2025](/wiki/Tournaments/TWC/2025) Grand Finals tiebreaker [BUZZ CUTZ](https://osu.ppy.sh/beatmapsets/2358247#taiko/5090722). That project was a storyboard collaboration with ::RiceSS::{ user=8271436 }, ::Coppertine::{ user=7279762 }, and ::Noffy::{ user=1541323 }, where I played a major role in shaping the underlying story.
...
We had ::Hiro::{ user=15251809 } and ::Xiaoraini::{ user=3607337 } collaborating on the illustrations. Both of them did phenomenal work. They quickly understood the vision, delivered high-quality work quickly, and brought their own flair to the project. Our character Lucine started with her "light form" in the first half of the song, so I figured Hiro's cute and vibrant drawing style would fit better. After Lucine made a "dark form" transformation in the second half of the song, Xiaoraini's dynamic texture drawing style were able to shine.
...
As mentioned before, Kyuare laid the groundwork with the early sketches, which made scene planning easier. Noffy broke down the story into sections, helping us to think through each part without getting overwhelmed. On the illustration side, Hiro and Xiaoraini gave life to Lucine with their distinct illustration styles and added cohesion to the visual flow between scenes. ::Len::{ user=34098325 } and ::Polytetral::{ user=8612061 } worked on the video simultaneously as we planned everything, offering even more scene ideas and cinematic renders for us to use. Graphic design was done by ::Panthullu::{ user=12580298 }, ::Boolmaster Flex::{ user=5394681 }, and ::AlexDunk::{ user=9194799 }, who did amazing collaboration to create the background and cover designs of the song. Supporting the team behind the scenes, our design quality assurance members ::Saturn::{ user=22001295 }, ::TheFunk::{ user=13981991 }, and ::Coppertine::{ user=7279762 } ensured everything stayed on track across their respective expertise. Finally, ::Sakura006::{ user=10365024 } brought everyone together, coordinated the project and established the foundation for the design workflow.

This project wasn't just a design effort. We also had ::autofanboy::{ user=636114 }, ::Bunnrei::{ user=829284 }, ::-Ken::{ user=4430811 }, ::wwwww::{ user=8434466 }, and ::Zyzyx::{ user=2888013 } working tirelessly on the map, with ::fayew::{ user=12498861 } doing hitsounding and ::qwhj79::{ user=7547506 } contributing to the replay. It truly felt like a team accomplishment across all staff members. Honestly, if even one person had been missing, I don't think this project would have been possible.
...
None of this would have been achieved without the motivation we had as a team, as a family, as a friendship. We went through a lot but I would like to thank the friends i have as colleagues. My best friends are ::Zeus::{ user=8329151 }, ::Alex::{ user=17738253 }, ::VelperK::{ user=348467 }, ::Naarkz::{ user=19490380 }, ::Gonza::{ user=17309439 } and I want to say thanks for everything to them and for the supporters that were there every single match and day to pray for our win ❤️
