...
### Vocal track winner - ::Ryuusei Aika::{ user=7777875 }
...
### Featured Artist track winner - ::Matsuyuki Ame::{ user=12763959 }
...
Be sure to try [this winning entry](https://osu.ppy.sh/beatmapsets/2301648#osu/4926360) by ::Matsuyuki Ame::{ user=12763959 } yourself to truly experience the epic renaissance hardcore, along with entries by ::Luval::{ user=22414293 }, ::[W]hiteRBQ 033::{ user=8678443 }, and ::Saki::{ user=3420746 }!
...
| Placement | Prizes |
| :-: | :-- |
| 1st | **Wooting 60HE+** (courtesy of ::Ttmnzk::{ user=2495509 }), custom Pending Cup 2024 physical badges and sticker set |
| 2nd | **[osu! deskmat](https://osu.ppy.sh/store/products/1347)** of the finalist's choice (courtesy of ::Chaoslitz::{ user=3621552 }), custom Pending Cup 2024 physical badges and sticker set |
...
| Mapper | Points |
| :-- | --: |
| ::{ flag=CN }:: ::Ryuusei Aika::{ user=7777875 } | +2 |
| ::{ flag=ID }:: ::William K::{ user=2261651 } | +2 |
| ::{ flag=TW }:: ::Matsuyuki Ame::{ user=12763959 } | +2 |
| ::{ flag=CN }:: ::Shijie::{ user=10927454 } | +1 |
| ::{ flag=CN }:: ::Hyasalia::{ user=3375004 } | +1 |
| ::{ flag=US }:: ::Jayblue::{ user=19618924 } | +1 |
