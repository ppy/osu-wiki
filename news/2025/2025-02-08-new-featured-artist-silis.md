...
Here's what you're actually here for: **23** new songs on [**SiLiS**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/434), each paired with a pre-timed beatmap template.

See what's in store for yourself:
...
<div align="center" class="osu-md__paragraph">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/media/news/silis_release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>
...
Or bash some drums to [this map](https://osu.ppy.sh/beatmapsets/2241960) by ::Slyme::{ user=11695793 }!
...
Cool off with [this osu!taiko map](https://osu.ppy.sh/beatmapsets/2262171) hosted by ::iRedi::{ user=8005579 }!
...
Finish up with [this 4K osu!mania map](https://osu.ppy.sh/beatmapsets/2234586) from [last year's 4KMWC](/wiki/Tournaments/MWC/2024_4K) mapped by ::RuleBlazing::{ user=7312402 }!
...
Every song above (and a bunch more) can be found on [**SiLiS**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/434) waiting for a mapper like you to do what you do best.

What comes next? If you're here a week from now, you'll find yet another Featured Artist announcement on osu!'s home page. If you're here a year from now, you'll have a lot of Featured Artists to catch up on.
