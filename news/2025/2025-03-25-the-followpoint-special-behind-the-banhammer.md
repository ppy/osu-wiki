...
And now with a small introduction done, let's get to the interview!
...
Why are GMT members' names red in osu! Stable chat despite the usergroup having green color?
...
<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/5999631" style="background-image: url('/wiki/shared/avatars/avatar-Venix.jpg')"></a>
...
This later escalated into a more general and wide Slowpoke spread in the moderator communities, notably with [Civil oath](https://osu.ppy.sh/users/3216107) building identity around it; Slowpoke naming strategies arouse from that momentum just as well and somehow sticked around to this day.
...
Was there ever a case where the players' reaction to some rule made GMT change it or a punishment for breaking it? And if so, do you think that's a good thing or a bad thing, and why?
...
Yes. The current rules page was reworked in 2017 and the GMT had a more direct control over what was on it. We gathered suggestions for specific rule changes and had a vote afterwards. Most of the time the implemented changes haven't been major rules changes, the vibes are out of our control, after all we don't set the vision of how the community should be moderated, we only upheld it.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/18152711" style="background-image: url('/wiki/shared/avatars/avatar-MegaMix.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-lvd" href="https://osu.ppy.sh/users/18152711">MegaMix</a></p>

Since GMT [usergroup page](https://osu.ppy.sh/groups/4) refers to NAT as their sibling team, who do you think would come out on top if these two were put into a boxing ring?
