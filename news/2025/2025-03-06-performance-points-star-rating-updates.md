...
A [change](https://github.com/ppy/osu/pull/31055) proposed by ::StanR::{ user=7217455 } has been created in order to ensure this penalty is applied correctly, and uses a more concrete estimation of the difficult sliders in a beatmap.
...
A [change](https://github.com/ppy/osu/pull/30907) proposed by ::Givikap120::{ user=10560705 } has been created in order to nerf speed PP on scores with a very high tapping deviation.

Tapping deviation is a statistic similar to unstable rate created by ::Frostium::{ user=8202998 }, combining a score's hit statistics, OD and amount of difficult "speed notes" (high-strain notes relevant to speed PP) in a beatmap.
...
- ::YaniFR::{ user=11260982 }
- ::BabySnakes::{ user=4669728 }
- ::rloseise::{ user=6793778 }
...
A [set](https://github.com/ppy/osu/pull/31208) [of](https://github.com/ppy/osu/pull/31510) [changes](https://github.com/ppy/osu/pull/31512) proposed by ::ltca::{ user=11475208 } (with contributions from ::rloseise::{ user=6793778 }) have been created in order to add a new measure of difficulty assessment — reading. This new skill aims to award additional bonuses depending on the difficulty of reading patterns.
...
A [change](https://github.com/ppy/osu/pull/31285) proposed by ::ltca::{ user=11475208 } has been created in order to consider the ratios of patterns when awarding colour difficulty.
...
A [change](https://github.com/ppy/osu/pull/31337) proposed by ::ltca::{ user=11475208 } has been created in order to better factor speed into stamina calculations:
...
- A [set](https://github.com/ppy/osu/pull/31338) of [rebalances](https://github.com/ppy/osu/pull/31556) proposed by ::ltca::{ user=11475208 } in order to align final values with community expectations
- A [change](https://github.com/ppy/osu/pull/31195) proposed by ::ltca::{ user=11475208 } to weight accuracy better on lower ODs
- A [change](https://github.com/ppy/osu/pull/31499) proposed by ::Natelytle::{ user=17607667 } to remove the lower cap on accuracy calculations, providing a larger nerf to lower accuracies
- A [change](https://github.com/ppy/osu/pull/30591) proposed by ::ltca::{ user=11475208 } to implement basic difficulty calculations for the Relax mod
- A [change](https://github.com/ppy/osu/pull/31067) proposed by ::YaniFR::{ user=11260982 } to scale star rating on lower difficulties more harshly
- A [fix](https://github.com/ppy/osu/pull/31579) proposed by ::tsunyoku::{ user=11315329 } to ensure rhythm uses the correct hit windows
- A [refactor](https://github.com/ppy/osu/pull/31191) proposed by ::ltca::{ user=11475208 } to aid with development

## osu!catch

## Buzz slider fixes

A [change](https://github.com/ppy/osu/pull/31126) proposed by ::bastoo0::{ user=4864877 } has been created in order to ensure "buzz sliders" are treated correctly.
