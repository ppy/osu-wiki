...
The full list of rules and operational procedures can be found [here](link to wiki), but we felt that the following points deserved particular attention and highlighting:
...
Entry Submission Deadline: June 30th 2025
Community Voting Period: July 2025
Results Stream: early August 2025

Teams must be registered in order to submit an entry, so we recommend doing so once your team is formed so that we may contact you with updates throughout the competition. 
...
For the full list of rules, operational procedures, and support available to you, please refer to [the wiki page](link)

Announcements for the contest will be coordinated through the #locus channel on the osu!dev Discord(invite link)
—-----	
