...
For any complete entry submitted before the entry submission deadline, team members will be awarded a profile badge if they are able to rank the set before the next iteration of the contest (they will be prioritised on Mappers' Guild quests).
