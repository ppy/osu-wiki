...
However, we cannot deny that team Poland held their own during the NM3 match, pulling ahead with a very close lead yet unfortunately losing it in the end. Despite their FC on the map alongside ::{ flag=PL }:: [bernard351](https://osu.ppy.sh/users/9511518) dropping a very impressive SS, it was not enough to go against Vietnam's wrath.
