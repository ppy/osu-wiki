...
**2nd place** - ::{ flag=RU }:: **::ksuenoot::{ user=5069845 }**, a winner of last year's cosplay show, with a cosplay of Burnice from *Zenless Zone Zero*. She became the only person to reach the top 3 in the cosplay shows for 2 consecutive years.
...
- ::{ flag=RU }:: ::DaHuJka::{ user=6830745 }, ::{ flag=RU }:: ::gamer228666::{ user=5981005 }, ::{ flag=RU }:: ::KOCT9H::{ user=6585939 }, ::{ flag=RU }:: ::Lexu2S::{ user=8251785 }, ::{ flag=RU }:: ::-Din-::{ user=7972980 }, ::{ flag=RU }:: ::maxim::{ user=9459674 }, ::{ flag=RU }:: ::reimia::{ user=11243772 }, ::{ flag=RU }:: ::xayoto::{ user=13334336 } as finalists of the ["Road to #moe2025" Tournament Rating](https://link.play-osu.ru/moe25rating)
- ::{ flag=RU }:: ::Skrowell::{ user=9694263 } as the winner of #russian osu! cup 2024
- ::{ flag=RU }:: ::Welter::{ user=11552867 } as the winner of #russian osu! cup klassic '25
- ::{ flag=RU }:: ::11iq pleer::{ user=13206785 }, ::{ flag=RU }:: ::BJIADOC::{ user=17031854 }, ::{ flag=RU }:: ::fedotoff::{ user=7351448 }, ::{ flag=RU }:: ::GodRoPoNiKa::{ user=11195861 } from the Closed Qualifier
- ::{ flag=KZ }:: ::nejzha::{ user=8105138 }, ::{ flag=BY }:: ::Vudek::{ user=8816345 } as the wildcard attendees!

The tournament had a single-elimination bracket and began from a Round of 16.

### Match highlights

#### ::{ flag=RU }:: ::BJIADOC::{ user=17031854 } vs. ::{ flag=RU }:: ::Lexu2S::{ user=8251785 }
...
::{ flag=RU }:: ::Lexu2S::{ user=8251785 } was very good with his speed picks, as well as the flow stream one. ::{ flag=RU }:: ::BJIADOC::{ user=17031854 }, on the other hand, showed himself well on the snap alt and Hidden mod picks, with HD3 being the only close map (14,627-point difference!) up until the tiebreaker. The tiebreaker itself was even closer, but with a total difference of 13,725 points, ::{ flag=RU }:: ::Lexu2S::{ user=8251785 } managed to win and advance to the next stage!

#### ::{ flag=RU }:: ::Skrowell::{ user=9694263 } vs ::{ flag=RU }:: ::Welter::{ user=11552867 }
...
The final match of the tournament. ::{ flag=RU }:: ::Welter::{ user=11552867 }, the runner-up for the last 2 iterations of MOE, now got a third chance to win the tournament. On the other end, even though ::{ flag=RU }:: ::Skrowell::{ user=9694263 } hadn't got this far before and actually lost to ::{ flag=RU }:: ::Welter::{ user=11552867 } last year, he also was a high contender to win it all this time.

The first half of the match went pretty straightforward: both players were easily taking their picks up until the score of 3–3. After that, something went wrong and 3 break points have happened in a row, getting the score to 4–5 in favour of ::{ flag=RU }:: ::Welter::{ user=11552867 }, leaving him with a pick at match point.

In the end, with a score of 6–4, ::{ flag=RU }:: ::Welter::{ user=11552867 } got the last point and won Moscow osu! Event for the first time, breaking his second-place curse. His performance during the whole tournament was astonishing, making him one of the best Russian players without a doubt!
...
The osu!taiko tournament featured ::{ flag=RU }:: ::\_TheXFactory\_::{ user=15013948 }, ::{ flag=RU }:: ::Den4ik228::{ user=7115174 }, ::{ flag=RU }:: ::SceptifyMK::{ user=20843003 }, and ::{ flag=RU }:: ::taikoshallah::{ user=11117835 } from the Russian Federation team of the [osu!taiko World Cup 2025](/wiki/Tournaments/TWC/2025).

| Player A |  |  | Player B | VOD link |
| --: | :-: | :-: | :-- | :-: |
| ::Den4ik228::{ user=7115174 } ::{ flag=RU }:: | 0 | **4** | ::{ flag=RU }:: **::\_TheXFactory\_::{ user=15013948 }** | [![](/wiki/shared/link/Link.png)](https://youtube.com/watch?v=xatn-BXpMho&t=26269) |
| ::SceptifyMK::{ user=20843003 } ::{ flag=RU }:: | 1 | **4** | ::{ flag=RU }:: **::taikoshallah::{ user=11117835 }** | [![](/wiki/shared/link/Link.png)](https://youtube.com/watch?v=fIpS-LFpB7w&t=254) |
| ::\_TheXFactory\_::{ user=15013948 } ::{ flag=RU }:: | 0 | **5** | ::{ flag=RU }:: **::taikoshallah::{ user=11117835 }** | [![](/wiki/shared/link/Link.png)](https://youtube.com/watch?v=fIpS-LFpB7w&t=31432) |

### osu!catch

The osu!catch tournaments featured ::{ flag=RU }:: ::BocDyx::{ user=7926192 }, ::{ flag=RU }:: ::snailbrack::{ user=6650048 }, ::{ flag=RU }:: ::smelly DVD box::{ user=6647589 }, and, *uh... a player under the name \~R\~?*

To make things a little more interesting, the fourth player for that tournament was kept in secret until their first match. It turned out they were ::{ flag=RU }:: ::ThankYou::{ user=4571241 }, one of the hosts of the event!

| Player A |  |  | Player B | VOD link |
| --: | :-: | :-: | :-- | :-: |
| **::BocDyx::{ user=7926192 }** ::{ flag=RU }:: | **4** | 0 | ::{ flag=RU }:: ::ThankYou::{ user=4571241 } | [![](/wiki/shared/link/Link.png)](https://youtube.com/watch?v=xatn-BXpMho&t=4622) |
| ::snailbrack::{ user=6650048 } ::{ flag=RU }:: | 1 | **4** | ::{ flag=RU }:: **::smelly DVD box::{ user=6647589 }** | [![](/wiki/shared/link/Link.png)](https://youtube.com/watch?v=xatn-BXpMho&t=7055) |
| ::BocDyx::{ user=7926192 } ::{ flag=RU }:: | 2 | **5** | ::{ flag=RU }:: **::smelly DVD box::{ user=6647589 }** | [![](/wiki/shared/link/Link.png)](https://youtube.com/watch?v=fIpS-LFpB7w&t=5953) |

### osu!mania 4K

The osu!mania 4K tournament featured ::{ flag=RU }:: ::-Oni-Chan-::{ user=10036005 }, ::{ flag=RU }:: ::Dystire::{ user=11585213 }, ::{ flag=RU }:: ::kloofhi::{ user=29627572 }, and ::{ flag=RU }:: ::VikaGamer228::{ user=20049082 }, two of which were in the [osu!mania 4K World Cup 2024](/wiki/Tournaments/MWC/2024_4K)!

| Player A |  |  | Player B | VOD link |
| --: | :-: | :-: | :-- | :-: |
| **::Dystire::{ user=11585213 }** ::{ flag=RU }:: | **4** | 0 | ::{ flag=RU }:: ::VikaGamer228::{ user=20049082 } | [![](/wiki/shared/link/Link.png)](https://youtube.com/watch?v=LzItzsD4nH0&t=3745) |
| ::kloofhi::{ user=29627572 } ::{ flag=RU }:: | 2 | **4** | ::{ flag=RU }:: **::-Oni-Chan-::{ user=10036005 }** | [![](/wiki/shared/link/Link.png)](https://youtube.com/watch?v=LzItzsD4nH0&t=6429) |
| **::Dystire::{ user=11585213 }** ::{ flag=RU }:: | **5** | 1 | ::{ flag=RU }:: ::-Oni-Chan-::{ user=10036005 } | [![](/wiki/shared/link/Link.png)](https://youtube.com/watch?v=fIpS-LFpB7w&t=2811) |
