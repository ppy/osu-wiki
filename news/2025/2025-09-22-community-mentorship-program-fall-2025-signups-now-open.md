---
layout: post
title: Community Mentorship Program Fall 2025 Signups Now Open
date: 2025-09-22 11:00:00 +0000
series: online_events
---

The 31st cycle of the Community Mentorship Program is upon us! Get ready to delve deep into the world of mapping, modding, or storyboarding.
...
If you're interested in the program, please read the [forum post](https://osu.ppy.sh/community/forums/topics/2124558?n=1) for a full rundown on how to apply. 

The mentee signups are currently open, and close on the 29th of September! Mentors listed as one pair are working together and pick one set of mentees as a whole this time around!
...
| ::{ flag=US }:: ::\-White::{ user-id=16276548 } & ::{ flag=US }:: ::Scorf::{ user-id=17038784 } | UTC-8 |
| ::{ flag=US }:: ::Usaha::{ user-id=6443117 } | UTC-5 |
| ::{ flag=US }:: ::Local Hero::{ user-id=16134122 } | UTC-5 |
| ::{ flag=CA }:: ::Sparhten::{ user-id=7601720 } | UTC-3:30 |
| ::{ flag=ES }:: ::flouah::{ user-id=8030129 } | UTC+1 |
| ::{ flag=DE }:: ::Kojio::{ user-id=2054596 } | UTC+2 |
| ::{ flag=IT }:: ::zekk::{ user-id=9704802 } | UTC+2 |
| ::{ flag=PL }:: ::App::{ user-id=13650508 } | UTC+2 |
| ::{ flag=DE }:: ::Okoayu::{ user-id=1623405 } & ::{ flag=DE }:: ::\-eNVy-::{ user-id=10632422 } | UTC+2 |
| ::{ flag=RU }:: ::NeKroMan4ik::{ user-id=11387664 } & ::{ flag=KR }:: ::momoyo::{ user-id=12469536 } | UTC+2 |
...
| ::{ flag=NL }:: ::Muse Dash::{ user-id=13695676 } | UTC+2 |
| ::{ flag=CN }:: ::Carpihat::{ user-id=10085090 } | UTC+2 |
| ::{ flag=RU }:: ::Kurisu Makise::{ user-id=2790640 } | UTC+3 |
| ::{ flag=VN }:: ::\1TCD\1 Dzar03::{ user-id=16712231 } | UTC+7 |
| ::{ flag=CN }:: ::RTrigger::{ user-id=25308131 } | UTC+8 |
...
| ::{ flag=IT }:: ::chmekoe::{ user-id=7807444 } | UTC+2 |
...
| :-- | :-- | :-- |
| ::{ flag=US }:: ::GodHacc::{ user-id=10023225 } | osu! | UTC-7 |
| ::{ flag=KR }:: ::KeyWee::{ user-id=10476879 } & ::{ flag=CL }:: ::melleganol::{ user-id=16452371 } | osu! | UTC-6 |
| ::{ flag=IT }:: ::zekk::{ user-id=9704802 } | osu! | UTC+2 |
| ::{ flag=NL }:: ::Syph::{ user-id=4858573 } & ::{ flag=US }:: ::Jennifer::{ user-id=6761853 } | osu! | UTC+2 |
| ::{ flag=RU }:: ::Daycore::{ user-id=5596337 } | osu! | UTC+3 |
| ::{ flag=FI }:: ::fllecc::{ user-id=14060327 } | osu! | UTC+3 |
| ::{ flag=TH }:: ::Electoz::{ user-id=6485263 } | osu! | UTC+7 |
| ::{ flag=DO }:: ::Antalf::{ user-id=8793773 } | osu!mania | UTC-4 |
| ::{ flag=KR }:: ::secXcscX::{ user-id=13543418 } | osu!mania | UTC+9 |
| ::{ flag=CL }:: ::ulko::{ user-id=1263669 } | osu!taiko | UTC-4 |
| ::{ flag=FR }:: ::Kin::{ user-id=480689 } | osu!taiko | UTC+2 |
...
| Mentor | Timezone |
| :-- | :-- |
| ::{ flag=IT }:: ::Kuroise::{ user-id=14547127 } | UTC+2 |
| ::{ flag=DE }:: ::Tunnelblick::{ user-id=7737096 } | UTC+2 |
| ::{ flag=VN }:: ::Hokichi::{ user-id=6607303 } | UTC+7 |
