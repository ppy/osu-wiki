...
Quarterfinals only gave us one [osu! original](/wiki/Community/Bespoke_music), but it's absolutely nothing to scoff at! [Sad Keyboard Guy & Myntian - Void//Shader (feat. xia)](https://osu.ppy.sh/beatmapsets/2428561#mania/5287940) charted by ::{ flag=CA }:: ::guden::{ user=11626065 }, ::{ flag=TH }:: ::MyZterioN-::{ user=8521723 }, and ::{ flag=US }:: ::0DZ0::{ user=28156707 } was the first original tiebreaker for the tournament, and as such, was a **VERY** impressive piece of work. In typical tiebreaker fashion, this chart holds just about everything you'd expect from something with the goal to test all skill sets.

The chart itself isn't the only good thing to look at, as a massive amount of work went into making all the visuals and song as amazing as they are! With the illustration done by ::{ flag=CA }:: ::Xiaoraini::{ user=3607337 }, ::{ flag=CA }:: ::RedcXca::{ user=14056601 }, and ::{ flag=AU }:: ::tehfire::{ user=7082924 }, graphic design by ::{ flag=CN }:: ::AlexDunk::{ user=9194799 }, storyboard by ::{ flag=US }:: ::Noffy::{ user=1541323 }, and the video being done by both ::{ flag=MY }:: ::Iyouka::{ user=7138499 } and ::{ flag=CN }:: ::Sakura006::{ user=10365024 } the team delivered far beyond what we could've expected.
