...
| :-- | :-- | :-- | :-- | :-- | :-- |
| Winner | ::tyrcs::{ user=13026904 } | [Axya - Again, Weeping Brilliantly](https://osu.ppy.sh/beatmapsets/2384801) | - | - | +2 (9 total) |
| Runner-up | ::oct4::{ user=10303887 } | [linear ring - lalabai call me](https://osu.ppy.sh/beatmapsets/2384834) | ![](https://assets.ppy.sh/profile-badges/mbc-2020-3.png) | *Elite Mapper* | +1 (6 total) |
...
The ~~3rd~~ ~~4th~~ 5th time's the charm. After **5** podium placements in different Monthly Beatmapping Contests, ::oct4::{ user=10303887 } has finally managed to join the ranks as one of osu!'s *Elite Mappers*.

::tyrcs::{ user=13026904 } deserves praise for winning too of course, but he's already won enough Monthly Beatmapping Contests to earn the *Elite Mapper* title months ago!
...
And of course, we can't forget the folks who helped judge this month's contest: ::ExNeko::{ user=7590894 }, [Maxus](https://osu.ppy.sh/users/4335785), ::Tailsdk::{ user=6751666 }, [Blocko](https://osu.ppy.sh/users/4075092), and ::\1Kobii::{ user=6209713 }!
