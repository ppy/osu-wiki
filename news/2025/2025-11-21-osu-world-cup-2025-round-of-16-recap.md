...
For those who prefer a visual recap of the week's action, you can once more check out ::D I O::{ user=3958619 }'s video here:
...
**[Download the pool here! (197 MB)](https://osu.ppy.sh/beatmaps/packs/P303)**
...
The most popular pick, however, was a familiar face mapping a familiar song, but with a newer coat of paint. It was none other than ::Satellite::{ user=1661227 }'s map... of [a song by senya](https://osu.ppy.sh/beatmapsets/2462140#osu/5386832). Sometimes all you want is the comfort of the known, and the Yuuhei Satellite ex-vocalist's music has been a mainstay in any tournament's DT pools for a long time.
...
I, as the writer of this column, cannot describe the track, or its map, made by our resident mad scientist ::Ryuusei Aika::{ user=7777875 }, in good enough wording in a short enough word count. Just go [give it a quick listen](https://www.youtube.com/watch?v=_KgODmONdZA). It's less than two minutes of your time — I promise you'll understand why it defies description.
...
| Team A |  |  | Team B |
| --: | :-: | :-: | :-- |
| **Australia** ::{ flag=AU }:: | **5** | 0 | ::{ flag=RO }:: Romania |
| **Poland** ::{ flag=PL }:: | **5** | 1 | ::{ flag=PH }:: Philippines |
| Italy ::{ flag=IT }:: | 3 | **5** | ::{ flag=TR }:: **Türkiye** |
| **Canada** ::{ flag=CA }:: | **5** | 0 | ::{ flag=NO }:: Norway |
| **South Korea** ::{ flag=KR }:: | **5** | 0 | ::{ flag=CL }:: Chile |
| Netherlands ::{ flag=NL }:: | 0 | **5** | ::{ flag=TW }:: **Taiwan** |
| **United Kingdom** ::{ flag=GB }:: | **5** | 3 | ::{ flag=NZ }:: New Zealand |
| Thailand ::{ flag=TH }:: | 4 | **5** | ::{ flag=JP }:: **Japan** |
| Russian Federation ::{ flag=RU }:: | 3 | **5** | ::{ flag=CN }:: **China** |
| **Indonesia** ::{ flag=ID }:: | **5** | 2 | ::{ flag=KZ }:: Kazakhstan |
| **Austria** ::{ flag=AT }:: | **5** | 1 | ::{ flag=SG }:: Singapore |
| **Sweden** ::{ flag=SE }:: | **5** | 3 | ::{ flag=MY }:: Malaysia |
| **Finland** ::{ flag=FI }:: | **5** | 1 | ::{ flag=PE }:: Peru |
| **United States** ::{ flag=US }:: | **5** | 2 | ::{ flag=FR }:: France |
| **Spain** ::{ flag=ES }:: | **5** | 1 | ::{ flag=AR }:: Argentina |
| **Germany** ::{ flag=DE }:: | **5** | 1 | ::{ flag=BR }:: Brazil |

The schedule for day 1 of this year's bracket stage was a sparse one, featuring only 5 of the week's 16 total matches, but it would be a showcase of four top 8 seeds making their first appearance in head-to-head matches of the year: overall #1 and #3 seeds and pre-tournament favourites Poland and Australia, perennial podium contenders Canada, and defending champions South Korea.
...
<div align="center" class="osu-md__paragraph">
    <iframe width="95%" style="aspect-ratio: 16 / 9;" src="https://player.twitch.tv/?video=2619201548&parent=osu.ppy.sh&autoplay=false" frameborder="0" allowfullscreen="true" scrolling="no"></iframe>
</div>

It was left to the lone losers' bracket match of Saturday to produce a competitive match, and the battle between Italy and Türkiye delivered in spades. Italy's players were out to prove to the world that their 0–15 map score in the Group Stage was a fluke, while Türkiye sought to continue a strong run of form that saw them finish 3–0 in Group F.
...
The score lead kept flickering with neither team managing to gain a major advantage until disaster struck three quarters into the map, with Japan losing all of their FCs and Thailand being able to close out the pick and force tiebreaker. The tiebreaker would mark the end of their tournament run though, as Japan's superior consistency earned them the win with a 221,225 point difference, finishing off the only tiebreaker match of the week.

---

The remaining teams in the bracket stage make their way onward starting early, with the first losers' round match of the *Russian Federation vs. Spain* starting **today at 20:00 UTC**, while the remaining matches span the rest of the weekend. As always, you can find the complete week's schedule on the [wiki page](/wiki/Tournaments/OWC/2025) and [information sheet](https://docs.google.com/spreadsheets/d/1QM6MUJzZFW-mtD7r1ExRBQOCjs2eWoOmWNDDG-n2PHE?rm=minimal) before joining the streams at [osulive](https://www.twitch.tv/osulive) and [osulive_2](https://www.twitch.tv/osulive_2) to follow the action live throughout all three days of play. We hope to see you there!
