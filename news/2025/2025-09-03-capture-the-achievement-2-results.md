...
The competition for the top spots was fierce, with 1st place frequently swapping throughout the event. [Check out this timelapse to see how the leaderboard scuffle went down!](https://www.youtube.com/watch?v=553VEjgSx5k)).

In short, **Pawsome 🖐️** and **osu!friends** were top contenders fighting for the lead throughout the event, with several other teams including **bc3 ultra** (also briefly holding first place early on), **Magic's Animals**, **EXEC_with.METHOD_METAFALICA/.** and **thought it was a normal tourney** racing to shake up the volatile podium spots.

In the final week, team **thought it was a normal tourney** was creeping up on a sizeable lead by team **osu!friends**. After two long days nearing day 13, they slowly managed to push past them, continuing on with determined and consistent effort to secure the victory while the clock was ticking down its last hours. During those hours, team **osu!friends** ended up finishing in 3rd, with team **Pawsome 🖐️** coming back to snatch 2nd place *right before the end*!

Congratulations to the top 3 teams! You'll find the full point breakdown of points for the winning teams right below:

### 1st place: team "thought it was a normal tourney"

7,613 points / 90 completed achievements:

| Player | Points | Completions | Individual placement |
| :-: | :-: | :-: | :-- |
| ::frutiger aero::{ user-id=10976672 } | 3746 | 46 | 4 |
| ::Aveil::{ user-id=11635646 } | 2044 | 23 | 23 |
| ::21Jeff21::{ user-id=11050944 } | 1441 | 17 | 36 |
| ::--Glitchy--::{ user-id=30644569 } | 192 | 2 | 159 |
| ::WhiteDoable::{ user-id=24868424 } | 190 | 2 | 160 |

### 2nd place: team "Pawsome 🖐️"

7,132 points / 84 completed achievements:

| Player | Points | Completions | Individual placement |
| :-: | :-: | :-: | :-- |
| ::Flyer::{ user-id=9767342 } | 3243 | 36 | 8 |
| ::- joshh::{ user-id=17957276 } | 1317 | 17 | 39 |
| ::Skrub::{ user-id=10306849 } | 1075 | 12 | 44 |
| ::brandwagen::{ user-id=13925852 } | 915 | 12 | 47 |
| ::Lunar\1::{ user-id=13688990 } | 582 | 7 | 78 |

### 3rd place: team "osu!friends"

6,938 points / 85 completed achievements:

| Player | Points | Completions | Individual placement |
| :-: | :-: | :-: | :-- |
| ::ming0328ming::{ user-id=2984074 } | 5505 | 67 | 1 |
| ::BrandonH::{ user-id=5988903 } | 733 | 9 | 59 |
| ::Chloe Wing Kiu::{ user-id=10625776 } | 494 | 6 | 91 |
| ::Zefkiel::{ user-id=7989469 } | 114 | 2 | 197 |
| ::Jurme::{ user-id=6282195 } | 92 | 1 | 211 |

## Achievement highlights

There were many great achievements, and many people gave different answers on their favourite achievements, but here's a small handful of achievements that felt especially worth highlighting. For a list of all the achievements, check the [CTA2 achievements page](https://cta.sheppsu.me/iterations/2/achievements).
...
| Creator | ::{ flag=PT }:: ::-Rinne-::{ user-id=13407431 } |
| Completions | 5 |
| Solution | [Click here](https://cta.sheppsu.me/achievements/179) |

This achievement certainly had the most time and effort put into it, with even a custom map from ::TamamoLover::{ user-id=7772622 }. It was made to be a quite difficult achievement, so congrats to the 5 teams that completed it! Here's a comment from ::-Rinne-::{ user-id=13407431 } about the achievement:
...
If I had to say what was the biggest hurdle, it would 100% be the description. As some might know from [CTA1](https://cta.sheppsu.me/iterations/1), there was an achievement that I made called "Butchering a Name" has a writing style very similar, where I like to write a very long description with the hints sprinkled in it. The problem with that is of course the word soup that might be created, and when the first description draft was submitted, ::Sheppsu::{ user-id=14895608 } clearly saw that as a problem, and after 4 iterations, the final description was reached, even if ::Sheppsu::{ user-id=14895608 } thought it was a bit too long, I didn't want to budge anymore, feeling that I would be sacrificing my style.

So yeah, that was Sound In Motion, once again thanks to ::Sheppsu::{ user-id=14895608 } for giving the idea for and making the slider anchors and ::TamamoLover::{ user-id=7772622 } for making the map. I promise the next one will be even better.
...
| Mode | Catch |
| Creator | ::{ flag=US }:: ::Sheppsu::{ user-id=14895608 } |
| Completions | 7 |
| Solution | [Click here](https://cta.sheppsu.me/achievements/314) |

As the creator of this achievement (::Sheppsu::{ user-id=14895608 }), I'm certainly biased, but it was definitely my favourite. The idea was initially proposed by ::Anonymoose::{ user-id=11153810 } to somehow use the cryptic language in [Yooh - Eternity](https://osu.ppy.sh/beatmapsets/2402789#fruits/5211146) for an achievement — this being before the translation was revealed. After finding some free time, I was trying to decipher it with ::yandax::{ user-id=17465623 } also joining in.

After an hour, we had a table of symbols to letters (except J and Z, which we're pretty sure were not used anywhere). In the process, ::yandax::{ user-id=17465623 } had translated the text on all 5 rocks. Come a few days later, I finally had a good idea of how we could use this all in an achievement, and thus **The Everlasting Epigrapher** was born. The CWC team absolutely cooked with this tiebreaker and I think it's pretty cool that we were able to use their little easter egg. Like the "Sound In Motion" achievement, this one was also made to be pretty difficult, so well done to the 7 teams that completed it!
...
| Mode | Any |
| Creator | ::{ flag=CA }:: ::yandax::{ user-id=17465623 } |
| Completions | 19 |
| Solution | [Click here](https://cta.sheppsu.me/achievements/271) |

::yandax::{ user-id=17465623 } made several puzzle-oriented achievements that were widely loved. It's tough to pick just one to highlight, but this one was among the favourites. Best of all, you can [try it yourself](https://yanda-dy.github.io/cta2-external/graphic_2b2d5018fe0cb636.html)! You can [read yandax's write-up on the solution here](https://yanda-dy.github.io/cta2-external/solutions_e1529b90acab3664/solutions.html#graphic-design-is-my-passion).
...
| Mode | Mania |
| Creator | ::{ flag=CA }:: ::Dragon20942::{ user-id=6147964 } |
| Completions | 40 |
| Solution | [Click here](https://cta.sheppsu.me/achievements/215) |

::Dragon20942::{ user-id=6147964 } made several achievements with interesting wordplay, and **INSERT COIN** was liked by many. If you liked this one, you should also check out **Perpertually Anxious** and **Ball Load Error** on the [achievements page](https://cta.sheppsu.me/iterations/2/achievements). I'll let ::Dragon20942::{ user-id=6147964 } take it away from here:
...
1. I floated the idea of the mods spelling something - ::Daanny::{ user-id=7183087 } had also thought of this
2. I asked about a canonical mod order - ::yandax::{ user-id=17465623 } found it and also generated a list of possible words we could spell out
3. We brainstormed and found a few words/maps to try (like SODA and DANS)
4. I suggested COIN and Insert Coin mapsets
5. ::yandax::{ user-id=17465623 } playtested the COIN mod combination
6. ::Daanny::{ user-id=7183087 } and I tuned the final difficulty/polish:
...
Thank you to everyone who took a crack at it!
...
| Mode | Any |
| Creator | ::{ flag=LV }:: ::Anonymoose::{ user-id=11153810 } |
| Completions | 23 |
...
| Creator | ::{ flag=US }:: ::catgirl enjoyer::{ user-id=18319269 } |
