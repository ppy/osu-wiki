...
| :-: | :-- | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=PL }:: ::MALISZEWSKI::{ user=12408961 } | Physical trophy, £625 |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=PL }:: ::milosz::{ user=13108233 } | £325 |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=GB }:: ::fudge::{ user=11592896 } | £230 |

16 people played through a 1-day single-elimination bracket on Saturday after qualifying among 40 players the day before.

Huge congratulations to ::{ flag=PL }:: ::MALISZEWSKI::{ user=12408961 } for winning the whole thing and taking home the trophy, with ::{ flag=PL }:: ::milosz::{ user=13108233 } and ::{ flag=GB }:: ::fudge::{ user=11592896 } (a.k.a. rudj) taking the remaining podium spots and slightly smaller cash prizes!
...
One more event was in store: ::chromb::{ user=10238680 }'s "osu! Community Taskmaster", where members of the osu! community were spurred into completing various tasks both online and IRL, such as:
...
The final round was held on the venue's main stage, in preparation for which the participants had to complete some tasks during the LAN! ::ilw8::{ user=14167692 } ended up winning the round, congrats! (The overall winner is to be determined.)
...
- ::fudge::{ user=11592896 }'s swift hands won at the PC building speedrun booth with a time of 7.801 seconds!
