...
This week, we had LN consistency as the new category for the LN pool, and what better way to introduce our new category than with an osu! original by [Marmalade butcher](https://osu.ppy.sh/beatmaps/artists/220)? They composed [CuttingEdgeInsaneArtifact](https://osu.ppy.sh/beatmapsets/2321277#mania/4973089) (LN3), which was then mapped by ::Lung_P::{ user=8271308 } and ::Muses::{ user=9705896 }. As the name of the category implies, this pick is all about testing players' consistency in LN prowess. This map has a wide range of LN patterning, which also adds another layer of difficulty as players have to be proficient in all of them in order to perform well.
...
With Japan on the rear after losing the first two maps, they spared no time to pick and selected [Wolpis Carter - Oxalis (Cut Ver.)](https://osu.ppy.sh/beatmapsets/2321276#mania/4973088) (RC6) as their next choice of map. Additionally, they decided to tag ::{ flag=JP }:: ::rainlily::{ user=485007 } out in favour of ::{ flag=JP }:: ::Suzuha-l::{ user=6132697 } — a strategy that would pay off. Japan secured their first point by a decisive margin, with ::{ flag=JP }:: ::butanic::{ user=1433586 } achieving an impressive score of 988,493 and an equally impressive ratio, slowly closing the gap with their rivals.
...
Japan still had an ace up their sleeve, and decided to take their chance with [Kolaa - async](https://osu.ppy.sh/beatmapsets/2321301#mania/4973175) (RC4) before it was too late for a comeback. The map's volatile, easy-to-miss patterns caused both teams to struggle keeping up their combos. While there wasn't a clear leader throughout the map, Japan ultimately won the point with an 11,803-point lead. The Philippines weren't taking any of it though, and after picking [Yooh - Divinity (Short Ver.)](https://osu.ppy.sh/beatmapsets/2321274#mania/4973086) (LN2), ::{ flag=PH }:: ::Ojisan-::{ user=11420405 } took the chance to shine once again with their extraordinary full combo and 982,737 score, sealing their victory.
...
::tyrcs::{ user=13026904 } needs little to no introduction. 7K player extraordinaire, their performance during the tournament has left many users in awe. Even those who were already familiar with their skills were still impressed by consistently providing us with amazing scores throughout the tournament. The scores highlights section may've as well been theirs!
...
- The quest to get the highest possible score on [Kohta Imafuku - Last Fireworks](https://osu.ppy.sh/beatmapsets/2321256#mania/4973036) (RC3) this week was won by ::{ flag=JP }:: ::rainlily::{ user=485007 }, thanks to their 996k run on their [match against Peru](https://www.twitch.tv/videos/2381488373). Notably, this was the only 990k+ score on the chart during the weekend.
- ::{ flag=KR }:: ::dressurf::{ user=758406 } had quite a good run on the rice pool. That said, we think that their 986k score on [Kolaa - async](https://osu.ppy.sh/beatmapsets/2321301#mania/4973175) (RC4) is the best showcase of their skills by playing some of the most complex patterns found in the pool.
- The title "LN Inverse Specialist" should be bestowed to ::{ flag=CN }:: ::[Crz]Satori::{ user=7082178 } at this point after their 985k run on [Sayuri x MY FIRST STORY - Reimei (Cut Ver.)](https://osu.ppy.sh/beatmapsets/2321280#mania/4973092) (LN1).
- ::{ flag=PH }:: ::Ojisan-::{ user=11420405 }'s overall performance this weekend was quite something. This includes (but isn't limited to) their two weekend-topping runs on [Marmalade butcher - CuttingEdgeInsaneArtifact](https://osu.ppy.sh/beatmapsets/2321277#mania/4973089) (LN3) (987k vs. Indonesia, 984k vs. Japan), and another top score on [KOTOKO - agony (Cut ver.)](https://osu.ppy.sh/beatmapsets/2321282#mania/4973094) (LN4) (980k).
