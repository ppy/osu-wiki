...
| :-- | :-- | :-- | :-- | :-- |
| Winner | ::Sadu::{ user=16301262 } | [Annabel - glimmer](https://osu.ppy.sh/beatmapsets/2352099) | ![](https://assets.ppy.sh/profile-badges/mbc-2020-1.png) | +2 (2 total) |
| Runner-up | ::Jemzuu::{ user=7890134 } | [Ester - Abandoned Planet](https://osu.ppy.sh/beatmapsets/2353158) | - | +1 (7 total) |
...
| Placement | Users | Beatmap | Badge prize | [Contest points](/wiki/Contests/Contest_points) |
| :-- | :-- | :-- | :-- | :-- |
| Winner | ::oct4::{ user=10303887 } | [kanemiko - Cold Fusion](https://osu.ppy.sh/beatmapsets/2352124) | ![](https://assets.ppy.sh/profile-badges/mbc-2020-2.png) | +2 (5 total) |
| Runner-up | ::tyrcs::{ user=13026904 } | [Ludicin - Lost Requiem](https://osu.ppy.sh/beatmapsets/2352216) | - | +1 (7 total) |
