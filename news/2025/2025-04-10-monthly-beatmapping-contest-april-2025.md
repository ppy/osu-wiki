...
Additionally, we'll be collaborating with the [7K GLOBAL](https://osu.ppy.sh/community/forums/topics/2065328?n=1) community. The best submission from each slot — as determined by the judges — will be pooled into the 7K GLOBAL event, and their mappers will be eligible for extra rewards!
