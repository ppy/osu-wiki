...
Check out [the map from the video above](https://osu.ppy.sh/beatmapsets/2049932) hosted by ::Hinsvar::{ user=1249323 }!
...
Or check out [this new osu!catch map](https://osu.ppy.sh/beatmapsets/2096026) by ::Chatie::{ user=6524765 }!
...
| --: | :-- | :-- | :-- |
| #1 | ::{ flag=RU }:: ::desuqe::{ user=9712285 } | 10 | **10** |
| #2 | ::{ flag=MY }:: ::Zeph2003::{ user=10343292 } | 5 | **11** |
| #3 | ::{ flag=US }:: ::Willy::{ user=3521482 } | 3 | 3 |
| #4 | ::{ flag=FI }:: ::Wolfey-::{ user=10504284 } | 2 | 7 |
| #5 | ::{ flag=US }:: ::yencis::{ user=10852203 } | 2 | 4 |
| #6 | ::{ flag=US }:: ::mjmroh::{ user=25479104 } | 1 | 3 |
| #7 | ::{ flag=US }:: ::Majernja::{ user=11379588 } | 1 | 2 |
| #8 | ::{ flag=US }:: ::HiroFMS::{ user=16416081 } | 1 | 1 |
| #9 | ::{ flag=US }:: ::Doggie::{ user=4930467 } | 1 | 1 |
| #10 | ::{ flag=US }:: ::Stoppedpuma::{ user=12654568 } | 1 | 4 |

### osu!taiko

| Rank | User | Points earned | [Total points](/wiki/People/Featured_Artists/Featured_Artist_playlists#cumulative-leaderboard) |
| --: | :-- | :-- | :-- |
| #1 | ::{ flag=JP }:: ::Eriha::{ user=16320311 } | 10 | **10** |
| #2 | ::{ flag=JP }:: ::HaLTi::{ user=16650552 } | 5 | **10** |
| #3 | ::{ flag=US }:: ::AuroraPhasmata::{ user=13664116 } | 3 | **18** |
| #4 | ::{ flag=FR }:: ::Ranshi::{ user=6680785 } | 2 | 2 |
...
| Rank | User | Points earned | [Total points](/wiki/People/Featured_Artists/Featured_Artist_playlists#cumulative-leaderboard) |
| --: | :-- | :-- | :-- |
| #1 | ::{ flag=CA }:: ::WadBot::{ user=14571181 } | 10 | **10** |
| #2 | ::{ flag=BR }:: ::Predominador::{ user=4568537 } | 5 | **10** |
| #3 | ::{ flag=VN }:: ::Primakien::{ user=23941998 } | 3 | **12** |
| #4 | ::{ flag=ID }:: ::Mochi -::{ user=20424806 } | 2 | 2 |
| #5 | ::{ flag=NL }:: ::Chatie::{ user=6524765 } | 2 | 8 |
| #6 | ::{ flag=RU }:: ::Kimitakari::{ user=4741164 } | 1 | **10** |
| #7 | ::{ flag=GB }:: ::Adisi::{ user=12182399 } | 1 | 1 |
| #8 | ::{ flag=CL }:: ::DateLix::{ user=9200197 } | 1 | 1 |
| #9 | ::{ flag=MK }:: ::MysticalTeaPot::{ user=25198181 } | 1 | 2 |
| #10 | ::{ flag=IL }:: ::LiL L1ghtMare::{ user=16782179 } | 1 | 1 |
...
| #6 | ::{ flag=JP }:: ::Mi0117::{ user=15501680 } | 1 | 2 |
| #7 | ::{ flag=HK }:: ::Irone OSU::{ user=10678230 } | 1 | 1 |
| #8 | ::{ flag=US }:: ::netzoid::{ user=25673755 } | 1 | 2 |
| #9 | ::{ flag=US }:: ::Torru::{ user=18248035 } | 1 | 1 |
| #10 | ::{ flag=ID }:: ::Aphelion-::{ user=8370351 } | 1 | 2 |
