...
To this day, there are only *14* mappers who have reached the incredible milestone of creating **one hundred** (or more) Ranked beatmaps, so after some *light interrogation* of these industrious creators, we're excited to bring you the all-new [Centurion](/wiki/People/Centurions) packs! Each pack represents a selection of a given Centurion's most beloved creations, namely the beatmaps they're most proud of making.
...
In addition to the packs, all of the mappers to have achieved this ridiculous milestone have also been granted an *exquisite* new profile badge (many thanks to ::Tanza3D::{ user=10379965 } for the design).

In particular, for their astounding dedication to the creation of beatmaps, the entire team would like to extend utmost congratulations to ::{ flag=TH }:: ::DJPop::{ user=2363 }, ::{ flag=IT }:: ::Andrea::{ user=33599 }, ::{ flag=US }:: ::ztrot::{ user=6347 }, ::{ flag=FR }:: ::Sotarks::{ user=4452992 }, ::{ flag=DE }:: ::Lasse::{ user=896613 }, ::{ flag=US }:: ::Nao Tomori::{ user=5364763 }, ::{ flag=US }:: ::Annabel::{ user=3388410 }, ::{ flag=US }:: ::Ascendance::{ user=2931883 }, ::{ flag=US }:: ::Nevo::{ user=7451883 }, ::{ flag=HK }:: ::Faputa::{ user=845733 }, ::{ flag=GR }:: ::Genjuro::{ user=3196091 }, ::{ flag=CN }:: ::Ryuusei Aika::{ user=7777875 }, ::{ flag=US }:: ::Secre::{ user=2306637 } and ::{ flag=RU }:: ::SMOKELIND::{ user=9327302 }!
