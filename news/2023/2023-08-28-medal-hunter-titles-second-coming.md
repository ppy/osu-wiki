...
Within the first few minutes of the medal releasing, players immediately began poring over all this information and quickly noticed the medal icon itself clearly referenced a popular [Frums](https://osu.ppy.sh/beatmaps/artists/68) track titled *theyaremanycolors*. From there, aspiring medal hunters were swift to piece together that the wording from the medal hint/flair may be hinting at the RGB colour spectrum in some capacity, but nobody could quite figure out how. Fixated on this particular fact, much of the early exploration of the medal neglected other parts of the hint that would later prove to be integral in deciphering the riddle once and for all.

Setting out to find how to translate these RGB-related suspicions into in-game scores, much was considered and tried. Red, green, and blue imagery all shows up prominently in the video associated with many *theyaremanycolors* beatmaps, so many initial theories involved exploring failing at particular parts of the video, or only comboing up to the first appearances of specific colours. Speculations grew wild and fast — could it have been to do with setting certain grades of scores back to back? After all, as every (mostly) sane prospective medal hunter knows, D ranks are red, A ranks are green, and B ranks are blue.

When this did not bear any fruit, considerations started turning towards mod colours in the default skin, Hard Rock is red, Easy is green — but wait... *expert* Hush-Hush means absolutely no difficulty-reducing mods, so that couldn't be it. Also, while "hues of madness" seemed to be critical in figuring out the medal solution, just what in the world could "bask in the shade of an ailing mind" mean?
...
This particular revelation from peppy let on that the solution may need to be altered because it depended on something that could be changed in the future. This left only two possibilities: something to do with osu!(lazer), and the website. Some began to suspect that the medal involved the colours of a given difficulty as shown on the site, which seemed to line up with the wording in the medal's basic description. There was a downside to this hint though: while peppy's preaching had basically confirmed this theory about difficulty colours had some merit, it started to throw some off the rails a little bit.
