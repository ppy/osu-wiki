...
**cygnus** (known here on osu! as ::Matrix::{ user=5052899 }) is the embodiment of the circle clicker's dream: living in Japan and producing rhythm game songs all day every day.
...
Resident 4K Featured Artist mapper ::FAMoss::{ user=7707789 } is here to deliver [this map](https://osu.ppy.sh/beatmapsets/1987180) to all of osu!'s piano smashers.
...
Experience [this newly ranked map](https://osu.ppy.sh/beatmapsets/1947301) hosted by ::Mirash::{ user=2841009 }!
...
Or try out some low-BPM streams on [this map](https://osu.ppy.sh/beatmapsets/1968108) hosted by ::stacker::{ user=7279141 }!
...
Try [the first Ranked **cygnus** map](https://osu.ppy.sh/beatmapsets/1884657) hosted by ::Matrix::{ user=5052899 } (a.k.a. **cygnus**!)
...
Try [the map from the liveplay video above](https://osu.ppy.sh/beatmapsets/1943426) hosted by ::Matrix::{ user=5052899 }!
...
If you want *another* map, ::Dada::{ user=9119507 } created [this one](https://osu.ppy.sh/beatmapsets/1980586) just for you.
...
To round things out, try playing [the literal matrix](https://osu.ppy.sh/beatmapsets/1984505) hosted by ::allein::{ user=6221637 }!
