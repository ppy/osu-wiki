...
Runner-ups ::acnozei::{ user=10141268 } and ::flake::{ user=7627157 } earned [a point of progress towards the *Elite Mapper* user title](/wiki/Contests/Contest_points) too. If you're looking for an easier map than the winner, [this one](https://osu.ppy.sh/beatmapsets/1971997) may be worth a try!
...
While judges favored ::DeviousPanda::{ user=4966334 } and ::iljaaz::{ user=8501291 }'s map, the wider osu! community took a different stance.

[This submission](https://osu.ppy.sh/beatmapsets/1972749) by ::Sylas::{ user=3906405 } and ::Mimari::{ user=14339830 } stood out above the rest according to the [community vote](https://osu.ppy.sh/community/contests/166) we held with osu!(lazer)'s playlists. Only players who finished a difficulty from every submission were capable of voting, so all mapsets were considered with each vote!

That said, ::Sylas::{ user=3906405 } and ::Mimari::{ user=14339830 } have been granted the profile badge below thanks to circle clickers like you.
...
Sitting atop the podium is [this submission](https://osu.ppy.sh/beatmapsets/1972268) by legendary osu!taiko residents ::uone::{ user=5321719 } and ::iceOC::{ user=5482401 }! Each of them have a longstanding history in the osu!taiko community, winning tournaments left and right, and now they're here to put a mapping competition into their portfolios too!
...
Just missing the winner's threshold was [this submission](https://osu.ppy.sh/beatmapsets/1975181) created by a not-so-conventional pairing. ::Horiiizon::{ user=8071438 } is an osu!taiko mapping legend, while their partner ::fieryrage::{ user=3533958 } dominates the osu! scene through an unmatched trio of mapping, modding, and playing capabilties.
...
Sorry to those who root for the underdogs — ::Jemzuu::{ user=7890134 } and his partner ::-Rustyy::{ user=16355636 } are here to take the gold in yet another mapping contest. [Their submission](https://osu.ppy.sh/beatmapsets/1972145) impressed both the judges, only barely surpassing ::Deif::{ user=318565 } and ::autofanboy::{ user=636114 } in almost all categories.
...
Neck and neck, ::Deif::{ user=318565 } and ::autofanboy::{ user=636114 } narrowly took the lead from ::Jemzuu::{ user=7890134 } and ::-Rustyy::{ user=16355636 } in the [community vote](https://osu.ppy.sh/community/contests/168)!
...
One of osu!mania's top players is now proven to be one of osu!mania's top mappers too. ::tyrcs::{ user=13026904 } and mapping veteran ::richardfeder::{ user=2446000 } impressed all 5 members of the judging panel with [their 7K submission](https://osu.ppy.sh/beatmapsets/1972242)!
...
::AutotelicBrown::{ user=4238941 } and resident NAT member ::Akasha-::{ user=2596306 } fell just short of first place with [this 4K submission](https://osu.ppy.sh/beatmapsets/1972034). While they're not the winners, runner-ups receive [a point of progress towards the *Elite Mapper* user title](/wiki/Contests/Contest_points)!
...
In an unprecedented scenario, osu!mania's [community vote](https://osu.ppy.sh/community/contests/169) resulted in a **3-way tie** between ::BringoBrango::{ user=10274043 }/::Stability::{ user=6701738 }, ::Hytex::{ user=8536263 }/::Ucitysm::{ user=14768693 }, and ::MapleSyrup-::{ user=1192936 }/::lenpai::{ user=5314573 }!

We've let the judges' scores act as a tiebreaker! Out of the three submissions, [this one](https://osu.ppy.sh/beatmapsets/1972411#mania/4092859) created by ::MapleSyrup-::{ user=1192936 } and ::lenpai::{ user=5314573 } scored the highest, so they'll earn the community vote prize!
