...
If you haven't heard **Euchaeta**'s sound yet, that's about to change. Witness ::Regou::{ user=419954 } play through [A Songwriter's Cosmos](https://osu.ppy.sh/beatmapsets/1858201) with mouse only, then follow your gut by clicking on every other preview:
...
Check out [the map from the video above](https://osu.ppy.sh/beatmapsets/1858201) hosted by ::Niva::{ user=197805 }!
...
Also check out [this map created for this announcement](https://osu.ppy.sh/beatmapsets/1857409) hosted by ::Hinsvar::{ user=1249323 }!
...
Try [this low-difficulty marathon](https://osu.ppy.sh/beatmapsets/1460070) hosted by **Euchaeta**'s biggest fan ::P\_O::{ user=831979 }!
...
Or try [this other marathon](https://osu.ppy.sh/beatmapsets/1590203) hosted by ::P\_O::{ user=831979 }!
...
Orrrr maybe try [yet another marathon](https://osu.ppy.sh/beatmapsets/1622155) hosted yet again by ::P\_O::{ user=831979 }!
