...
A great video by community member [Willy](https://osu.ppy.sh/users/3521482) outlines what's written here and more regarding the usage of tablets as input devices:
...
A month later on December 15th, touch screen scores had their pp reduced, touch screen detection was introduced, and a new touch screen "Touch Device" mod was added, which would reduce the amount of pp gained from jumps on any map.
...
This is still a hotly debated topic, but if you want to get an opinion of a pro player, look no further than [BTMC](https://osu.ppy.sh/users/3171691)'s video on the rapid trigger feature:
