...
**16** songs make up [**Krimek**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/371), including every tune from **Krimek**'s debut album *GALAXY OF MIND/MINE*!

If you're debating whether or not to map one of these tracks, gain some inspiration from ::ChillierPear::{ user=9501251 } warming up to an intense tournament while vibing to one of **Krimek**'s many chill and soothing soundscapes:
...
If music production weren't enough, ::**Krimek**::{ user=2345078 } also created [a map for his own song](https://osu.ppy.sh/beatmapsets/1978614)!
...
Try out [this brand-new map](https://osu.ppy.sh/beatmapsets/2008599) hosted by ::fergas::{ user=3144542 } created specifically for an ongoing tournament!
...
Scoring algorithms in osu!(lazer) were adjusted while this playlist was ongoing, so scores set using the previous algorithms have been reprocessed to match the current scoring formulas. In some cases, users couldn't improve their scores because plays set with the previous algorithms generally resulted in higher scores.

Because of this, we've decided to reward users based on their **highest placement** in the playlist *before* reprocessing or the playlist *after* reprocessing.

#### osu!

| Rank (before) | (after) | User | Points earned | Total points |
| --: | --: | :-- | :-- | :-- |
| #1 | #3 | ::{ flag=CA }:: ::Vararaup::{ user=8257675 } | **10** | **10** |
| #2 | #2 | ::{ flag=DE }:: ::Maxe191::{ user=2184751 } | 5 | 6 |
| #3 | #1 | ::{ flag=BY }:: ::TemaZpro::{ user=5510197 } | **10** | **10** |
| #4 | #6 | ::{ flag=RO }:: ::nanoya::{ user=12366071 } | 2 | 2 |
| #5 | #4 | ::{ flag=FI }:: ::Wolfey-::{ user=10504284 } | 2 | 4 |
...
| Rank (before) | (after) | User | Points earned | Total points |
| --: | --: | :-- | :-- | :-- |
| #1 | #1 | ::{ flag=US }:: ::mashu::{ user=12028216 } | **10** | **10** |
| #2 | #2 | ::{ flag=TH }:: ::Monpluk::{ user=23299675 } | 5 | 5 |
| #3 | #5 | ::{ flag=DE }:: ::ERA Punish::{ user=10615367 } | 3 | 3 |
| #4 | #6 | ::{ flag=PL }:: ::bagjettka::{ user=18338179 } | 2 | 2 |
| #5 | #8 | ::{ flag=TH }:: ::ZeroKungz::{ user=23155757 } | 2 | 2 |
| #6 | #9 | ::{ flag=CL }:: ::-Kori::{ user=12490530 } | 1 | 1 |
| #7 | N/A | ::{ flag=US }:: ::Sparky::{ user=3187959 } | 1 | 1 |
| #8 | N/A | ::{ flag=FI }:: ::PianoLuigi::{ user=9665915 } | 1 | 1 |
| #9 | #3 | ::{ flag=DE }:: ::ERA Sirbeyy::{ user=12917829 } | 3 | 3 |
| #10 | N/A | ::{ flag=ID }:: ::Aphelion-::{ user=8370351 } | 1 | 1 |
| N/A | #4 | ::{ flag=TH }:: ::Noobleh::{ user=11986603 } | 2 | 2 |
| N/A | #7 | ::{ flag=TH }:: ::KaiWut::{ user=19623499 } | 1 | 1 |
| N/A | #10 | ::{ flag=TH }:: ::IMaxI::{ user=29186011 } | 1 | 1 |
