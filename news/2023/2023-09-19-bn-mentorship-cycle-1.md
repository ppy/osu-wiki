...
Those who are keen on following news related to mapping and the [Beatmap Nominators](/wiki/People/Beatmap_Nominators) may have caught word of some suspicious rumblings related to a certain project that looks to give people an alternative way of learning modding and potentially becoming a Beatmap Nominator — with a [prototype cycle](https://twitter.com/osu_nat/status/1637312140057927681) for it having run in April and May earlier this year.
...
| :-- | :-- | :-- |
| ::{ flag=BR }:: ::Dada::{ user-id=9119507 } | ::{ flag=TN }:: ::Hivie::{ user-id=14102976 } | ::{ flag=ID }:: ::Maxus::{ user-id=4335785 } |
| ::{ flag=BE }:: ::enneya::{ user-id=10959501 } | ::{ flag=US }:: ::radar::{ user-id=7131099 } | ::{ flag=ES }:: ::RandomeLoL::{ user-id=7080063 } |
