...
Well... 12 years later and [ThePooN](https://osu.ppy.sh/users/718454) along with various open-source contributors finally made it happen! You can now [download osu!stream](https://play.google.com/store/apps/details?id=sh.ppy.osustream&pli=1) on your Android phone and enjoy custom maps along with mechanics only found on osu!stream (one example being the hold hit circle).

A few years back all the song DLC's have been made free for everyone, so everyone will get a chance to fully experience osu!stream without needing to shell out money for the later additions to the song pool. Have fun!
...
osu!taiko on the other hand, ranked **4,873** difficulties across **1,116** sets for a total increase of **37.4%** from 2021, amounting to **12,778** minutes of content. Thanks to the efforts of the Taiko NAT and BNG, they were able to pump out quite a good amount of content, with no signs of stopping in 2023!

On the other hand, osu!catch couldn't *catch* a break, having an overall increase of **0.2%** with **1,780** difficulties across **364** sets being Ranked or the equivalent of **3,593** minutes of playtime. We'd really hope that bringing these numbers up will encourage more people to help with the mode's content output.

Finally, our biggest outlier is osu!mania with **4,622** difficulties ranked across **891** sets for a MASSIVE **115.73%** increase, totalling to **12,000** minutes of content. This is *huge*. There are various reasons for this growth to have happened. Let it be a good increase in the number of BNs, recent and impactful changes to the way hitsounds and spreads are handled in the mode, or the community's proactive ness at making the mode better just to put a few examples.
...
[shinchikuhome](https://osu.ppy.sh/users/3174184) strikes again! This time, being the first FC on a map considered by many to be one of the hardest maps currently ranked. This map is Nepuri's Set of [New Game Plus](https://osu.ppy.sh/beatmapsets/797710#taiko/1675265), a 9* map that remained un-FCed for nearly 4 and a half years, until this month. Known for its near-impossible 400BPM dense speed sections, it was recently FC'ed by shinchikuhome with a solid 97.46%, earning them #1 on the map. If you haven't seen this play before, or you want to rewatch it again, please check it out below!

<iframe width="100%" height="315" src="https://www.youtube.com/embed/AI1OZBOkxMM" frameborder="0" allowfullscreen></iframe> 

Another notable play worthy of mention this month is [Majimanjiwwwww's](https://osu.ppy.sh/users/12337864/taiko) HDNC 1218pp play on [Aletheia (fake lover, fake summer)](https://osu.ppy.sh/beatmapsets/1895850#taiko/3907074), earning themselves the pp record and #1 on the map! This map is notable for its 300bpm streams, only made harder with Hidden and Nightcore, making it well deserving of the new pp record. Feel free to check it out below!
...
If you want more official information about mapping, BNs or NAT, please go to the [Mappers Guild website](https://bn.mappersguild.com/home).
...
By the way, even if we don't mention all the beatmaps that have been ranked this month, you should know that they are all great, so don't hesitate to take a look at the beatmap section of the osu! website and check out the most recent beatmaps!

#### Leah Kate - Life Sux (Sped Up Ver.) - Community favourite

After the great success of [10 Things I Hate About You (Sped Up & Cut Ver.)](https://osu.ppy.sh/beatmapsets/1881428) and [Twinkle Twinkle (Sped Up & Cut Ver.)](https://osu.ppy.sh/beatmapsets/1901049), [Life Sux (Sped Up Ver.)](https://osu.ppy.sh/beatmapsets/1905234) by [Log Off Now](https://osu.ppy.sh/users/4378277) was equally well received. An artist who has not been seen much in the ranked section so far and who was a real discovery, thanks to her catchy music and her beautiful voice. Beatmaps always pleasant to play no matter the situation, and new music, Log Off Now has definitely the winning wicket to please the players!

#### 15 Voices - Non-breath oblige mapped by Delis - Community favourite

If you checked Twitter even once this month (or towards the end of December), you'll have probably seen clips of the best osu! players on this map to get the best plays. We're obviously talking about [Delis](https://osu.ppy.sh/users/1603923)' set on [Non-breath oblige](https://osu.ppy.sh/beatmapsets/1889729), which was more than well received as the mind-blowing number of favourites the set showed us — reaching almost 1,800 favourites in a month thanks to the fact the mapset had a difficulty that was able to challenge all skill levels thanks to the multiple GDers in the set.

#### Pmarusama. - S'il vous President - osu!monthly Mapping Team's favorite

Are you *-w-* or *-v-* ? If you haven't understood yet, we are obviously referring to [S'il vous President](https://osu.ppy.sh/beatmapsets/1763440) hosted by [TtmnZk](https://osu.ppy.sh/users/2495509) and more particularly its Extreme difficulty by [nika mika](https://osu.ppy.sh/users/3878832) with its more than amusing concepts on a lively song, with many patterns in the form of emojis, or punctuation following the song. A conceptual but still fun way to represent such a catchy song, which can be found on all the difficulties. So many reasons that made us appreciate the map and encourage you to go and have a look at it!

#### HOYO-MiX - The Stellar Moments Vol. 2 - Bonus

In organising such a huge and ambitious project, we could not fail to mention it here. Compiling almost thirty minutes of tracks from Genshin Impact, [The Stellar Moments Vol. 2](https://osu.ppy.sh/beatmapsets/1702721), a sequel to the already very popular [The Stellar Moments](https://osu.ppy.sh/beatmapsets/1588624) by [Shurelia](https://osu.ppy.sh/users/3807986) and with participation from ~20 mappers, is a real masterpiece. A way to link two very popular games in an original way and so well done, whether it's the excellent mapping, the perfect hitsounds, or the not too intrusive storyboard that allows you to simply hold the hand of the players throughout the experience. We really invite you to go and try it out!

### Mappers Highlight

Obviously, behind each set, each beatmap on osu! is a mapper and hours of work to produce this grouping of hit notes that you play. So we wanted to put here some of the mappers that stood out from the rest this month. Keep in mind that all the mappers are doing a great job even if we only select some of them, so you should definitely check out everyone's work!

#### VINXIS - Best Mapper

VINXIS, besides being one of the most popular featured artists of osu!, the person at the head of many community projects that made osu! move forward like [Corsace](https://open.corsace.io/info), [MCA (Mapper's Choice Awards)](https://mca.corsace.io/2021/) or even the [AYI (A Year in Mapping)](https://ayim.corsace.io/2021/), is a very good mapper known by all. This month he said goodbye to the community on January 1st, erasing all his digital identities to focus on his real life, but he still left us 6 maps that were ranked this month and that are all more excellent than the others and which we urge you to check out, such as [PINK BLOOD](https://osu.ppy.sh/beatmapsets/1490238) or [KICK BACK (TV Size)](https://osu.ppy.sh/beatmapsets/1864478) which has already been very positively received by the players. We obviously wish him the best and hope that people as involved as him will take over!

#### chaser01 - Rising Stars

Quite active in the ranked section since the beginning of 2022, [chaser01](https://osu.ppy.sh/users/18730172) is now starting to accumulate a lot of difficulties and beatmaps. With a total of 13 beatmaps, 2 of which were ranked this month, he often renews himself by proposing beatmaps that can be both visually represented rather classic like [Sekai no Hate de](https://osu.ppy.sh/beatmapsets/1829057), or rather conceptual like [I Ain't Got Time!](https://osu.ppy.sh/beatmapsets/1844850#osu/3789610), but that always represents the song so well and makes the whole thing enjoyable to play. A promising mapper that we should continue to see progress in the future with many beatmaps ranked to come!

#### KennethBBG - Rising Stars

Here is a person who is really on the rise. Until the end of 2022, [KennethBBG](https://osu.ppy.sh/users/13032817) was still part of the big family of mappers with about five ranked maps, but since this January, he hasn't stopped for a second and has ranked about 6 more maps! An astronomical amount that surely required a lot of effort, but that made him jump straight into the big league with Japanese and rhythmic music like [Only you! (Short Ver.)](https://osu.ppy.sh/beatmapsets/1853621). We hope that he will continue like this and that other people as motivated as him will do the same in the coming months!

### Mapping Around Community

Numerous projects, small or large, managed independently or by large teams, and with the aim of reaching out to the osu! mapping community, are created regularly but often have too little visibility. We will therefore try to summarize in this section the different events accomplished and to come by the community, throughout the month.

#### A Year In Mapping 2022

At the beginning of the year, this small project made by [YamYA](https://osu.ppy.sh/users/4470854) was much talked about because it allows a very visual way of viewing the data of maps ranked throughout 2022. In this way, [A Year In Mapping 2022](https://lookerstudio.google.com/u/0/reporting/394c39bb-6630-4ff7-9794-6ae73b2e7d95/page/hj1uB) using the [Looker Studio](https://lookerstudio.google.com/) tool has made it possible to enable filters to display statistics only for certain countries or modes, often allowing mappers to see where they stand in relation to others. If you haven't had a chance to take a look yet, don't hesitate!

#### The Mappers Table

[The Mappers Table Podcast](https://www.youtube.com/@themapperstablepodcast) is a group of mappers now consisting of [hanabyte](https://osu.ppy.sh/users/8617799), [CallieCube](https://osu.ppy.sh/users/7535045) and [PaRaDogi](https://osu.ppy.sh/users/2054596) who have this month produced the first episode of a podcast about mapping. This month's guest, [Camo](https://osu.ppy.sh/users/5194391) spoke with them about different topics around mapping such as their favourite maps or more complex topics such as whether fun also means good. In short, a new ambitious project by the community for mappers that we hope will be a success and will last for a long time.

#### MasterMapper 2023

Have you been looking for a serious mapping tournament for a long time but can't find one? Then hurry up and sign up for [MasterMapper 2023](https://osu.ppy.sh/community/forums/topics/1699534?n=1), which is accepting participants until February 4th. This tournament, now in its 3rd iteration, and hosted by [Gordon](https://osu.ppy.sh/users/7856835), brings together mappers of all levels (with certain criteria such as having been active recently, or having ranked maps) to compete on featured artist tracks over several months. So don't hesitate to take a look at it even if you just want to see the entries of the participants!
...
<iframe width="100%" height="315" src="https://www.youtube.com/embed/videoseries?list=PLA2Nwtxa4WMorBTgwYc7puyftc30_h1Ta" frameborder="0" allowfullscreen></iframe>
