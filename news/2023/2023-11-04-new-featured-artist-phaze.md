...
Ever tried clicking circles without your index finger? It's uncomfortable. And that's what renowned mapper ::LMT::{ user=7262798 } does all the time. Watch him play [PHAZE - Mirai Isho](https://osu.ppy.sh/beatmapsets/1989072) from [COE](/wiki/Community/cavoe's_osu!_event/2023), then check out the rest of these previews:
...
Try out [the map from the video above](https://osu.ppy.sh/beatmapsets/1989072) hosted by ::KaedeharaKazuha::{ user=6300910 }!
...
Or try [this recently Ranked map](https://osu.ppy.sh/beatmapsets/2047330) hosted by ::AirinCat::{ user=11119539 }!
