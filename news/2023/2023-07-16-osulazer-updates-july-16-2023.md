...
- **Scores will be recalculated to ScoreV2.** If you didn't know, the old scoring osu!(lazer) scoring system was scrapped and tossed aside, in favour of returning to a system widely used in tournaments. Check out [this news post](https://osu.ppy.sh/home/news/2023-07-11-community-meeting-recap) (or the above video) for more details on that.
- **New notification sounds.** Thanks to ::nekodex::{ user-id=102 }, getting notified in-game has never sounded so good.
- **New osu!taiko hitsounds for the argon skin.** Now hitting your keyboard will sound more like actual taiko drums. Resident sound designer nekodex's comments on it may interest you, so check the video above to find out if that's the case.
...
- **Huge performance improvements.** The details are too technical to summarise, but even ::peppy::{ user-id=2 } was excited by how substantial the optimisations are.
...
What do you think? You can update to the latest version of it by opening osu!(lazer) or downloading it [here](https://osu.ppy.sh/home/download).
