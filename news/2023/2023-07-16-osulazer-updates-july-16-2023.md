...
- **New notification sounds.** Thanks to ::nekodex::{ user=102 }, getting notified in-game has never sounded so good.
...
- **Huge performance improvements.** The details are too technical to summarise, but even ::peppy::{ user=2 } was excited by how substantial the optimisations are.
