...
You can check out all the entries on the [contest results page](https://osu.ppy.sh/community/contests/178), and if you want to discuss the results of the contest, you can do so on the [discussion thread](https://osu.ppy.sh/community/forums/topics/1762288).

If this contest inspired you to try out skinning, be sure to check out the [skinning tutorial](https://skinship.xyz/tutorial/introduction) or reach out to the community via the [skinship Discord server](https://discord.skinship.xyz/)!
