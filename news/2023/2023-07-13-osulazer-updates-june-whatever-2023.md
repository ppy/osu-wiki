---
layout: post
title: "osu!(lazer) Updates: June 21, 2023"
...
Now that our corporate overlords are satisfied, let's jump into what this release has to offer!

<div align="center">
    <iframe width="95%" style="aspect-ratio: 16 / 9;" src="https://www.youtube.com/embed/QMBmLI8BFcw" frameborder="0" allowfullscreen></iframe>
</div>

### Changes

- **New notification sounds.** Thanks to [nekodex](https://osu.ppy.sh/users/102) getting notified in-game has never sounded so good.
- **Visual effects for hotkeys have been added to the editor.** Whenever you use a hotkey the button correlating to it will be highlighted for a brief moment, showing what action your hotkey performed.
- **Two new skinnable elements.** You can now skin the key counter and add a custom "retry" sound. That's one small step for the osu!team, one giant leap for the skinning community.
