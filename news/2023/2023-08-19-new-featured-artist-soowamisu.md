...
![](https://assets.ppy.sh/artists/376/header.jpg)

**soowamisu** takes an unorthodox approach towards music. Each of their breakcore tunes dives into something new, often disregarding conventional music structure in favour of a distinct aural experience.
...
Those songs are only the tip of the iceberg. Scroll through [**soowamisu**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/376) to find the rest of the songs (and the template for your next map).

## Featured Artist playlists

In [**YUC'e**'s Featured Artist announcement](https://osu.ppy.sh/home/news/2023-07-15-new-featured-artist-yuce#featured-artist-playlists), we launched a batch of [**Featured Artist playlists** in osu!(lazer)](/wiki/People/Featured_Artists/Featured_Artist_playlists). Those finished just a few days ago, so we're here to announce the results!
...
Another batch of [**Featured Artist playlists** in osu!(lazer)](/wiki/People/Featured_Artists/Featured_Artist_playlists) will be launching on September 2nd.

Stay tuned for that and another Featured Artist next week!
