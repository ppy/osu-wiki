...
Need a sample of **Kou!**'s musical dexterity? (Hint: the correct answer is *yes*.) Take a peek at ::Accolibed::{ user=9269034 } as he tries an 8-star map live at [COE](/wiki/Community/cavoe's_osu!_event/2023)!
...
Try [the collab marathon from above](https://osu.ppy.sh/beatmapsets/1948258) hosted by ::9ami::{ user=1499997 } or [this osu!mania rendition](https://osu.ppy.sh/beatmapsets/1913683) hosted by ::FlappiBakuse::{ user=11724295 }!
...
Experience [this brand-new osu!catch map](https://osu.ppy.sh/beatmapsets/2069616) hosted by ::autofanboy::{ user=636114 }!
...
If you're still in the marathon mood, here's [another osu!mania masterpiece](https://osu.ppy.sh/beatmapsets/1939285) made by ::-mint-::{ user=8976576 } and [an osu!catch classic](https://osu.ppy.sh/beatmapsets/1729729) crafted by ::Jemzuu::{ user=7890134 }!
...
Through [this osu!taiko map](https://osu.ppy.sh/beatmapsets/1699711) hosted by ::paz08::{ user=9964420 }, **Kou!** has reached the Ranked category in every game mode! (Feel free to check out [this osu!catch rendition](https://osu.ppy.sh/beatmapsets/2023486) hosted by ::-Rustyy::{ user=16355636 } too!)
...
| --: | :-- | :-- | :-- |
| #1 | ::{ flag=KR }:: **::yadon::{ user=6922333 }** | **10** | **10** |
| #2 | ::{ flag=GB }:: ::rudj::{ user=11592896 } | 5 | 5 |
| #3 | ::{ flag=PL }:: ::Sowisty::{ user=6808620 } | 3 | 4 |
| #4 | ::{ flag=US }:: ::1103::{ user=7306698 } | 2 | 4 |
| #5 | ::{ flag=US }:: ::mjmroh::{ user=25479104 } | 2 | 2 |
| #6 | ::{ flag=US }:: ::yencis::{ user=10852203 } | 1 | 2 |
| #7 | ::{ flag=US }:: ::Leebs::{ user=7636779 } | 1 | 2 |
| #8 | ::{ flag=MY }:: ::Zeph2003::{ user=10343292 } | 1 | 6 |
| #9 | ::{ flag=US }:: ::Stoppedpuma::{ user=12654568 } | 1 | 3 |
| #10 | ::{ flag=FI }:: ::Wolfey-::{ user=10504284 } | 1 | 5 |

### osu!taiko

| Rank | User | Points earned | [Total points](/wiki/People/Featured_Artists/Featured_Artist_playlists#cumulative-leaderboard) |
| --: | :-- | :-- | :-- |
| #1 | ::{ flag=US }:: **::AuroraPhasmata::{ user=13664116 }** | **10** | **15** |
| #2 | ::{ flag=JP }:: ::HaLTi::{ user=16650552 } | 5 | 5 |
| #3 | ::{ flag=US }:: ::Arityle::{ user=18397349 } | 3 | 6 |
| #4 | ::{ flag=US }:: ::TGGD::{ user=27486456 } | 2 | 2 |
...
| #7 | ::{ flag=US }:: ::KcHecKa::{ user=4584427 } | 1 | 1 |
| #8 | ::{ flag=US }:: ::TPColor::{ user=19102458 } | 1 | 2 |
| #9 | ::{ flag=US }:: ::Playboi Carti::{ user=4833676 } | 1 | 1 |
| #10 | ::{ flag=GB }:: ::Zoobin4::{ user=10055204 } | 1 | 1 |
