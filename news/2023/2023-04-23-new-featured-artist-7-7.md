...
Before even touching music production, ::**7\_7**::{ user=7491106 } was one of us.
...
If you're struggling to map something by **7\_7** (or any of our other Featured Artists), check out the `#featured-artists` channel in the [osu! Discord Server](https://discord.gg/ppy).
...
<div align="center">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/artists/356/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>
...
<audio controls>
    <source src="https://assets.ppy.sh/artists/356/Songs/7_7%20-%20_.mp3">
</audio>

### 7\_7 - Ehe^^

<audio controls>
    <source src="https://assets.ppy.sh/artists/356/Songs/7_7%20-%20Ehe%5E%5E.mp3">
</audio>

### 7\_7 - cafca

<audio controls>
    <source src="https://assets.ppy.sh/artists/356/Songs/7_7%20-%20cafca.mp3">
</audio>

---

20+ more tracks can be found on [**7\_7**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/356), all pre-timed for instantly gratifying mapping journey. Also, do NOT investigate the timing of *7\_7 feat. kasane vavzed - 7D*. You'll regret it.

That's all for this week! Head to `#featured-artists` in the osu! server for some quick mapping advice, and track the [@osugame Twitter](https://twitter.com/osugame) if you want to know who's joining our Featured Artist library next week.
