---
layout: post
title: Global Moderation Team applications are now open!
...
While usually we seek new members in a [process of recommendations and nominations](/wiki/People/The_Team/Global_Moderation_Team#becoming-a-moderator), we're also opening apps from time to time to look for fresh blood we might be not noticing — not everyone is so outspoken and perceptible at the end of the day! While we will still continue using the our classic methods, we believe that such diversification of lookup methods is vastly valuable to the team's health.
...
- **Your account must be at least one year old.** This is to ensure you are somewhat familliar with the osu! community at very least.
- You must be active within osu! community. While we will not stick to chat or forums metrics explicitly (at least when it's not your everyday area of focus), we expect you to be active and engaged in certain communities.
