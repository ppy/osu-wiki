---
layout: post
title: "New Featured Artist: C-Show"
date: 2023-09-02 20:00:00 +0000
series: featured_artists
---

osu!'s red carpet unrolls for **C-Show**, our latest Featured Artist!

![](https://assets.ppy.sh/artists/378/header.jpg)
...
If you want to actually *experience* some of what **C-Show** has to offer, a new batch of [**Featured Artist playlists** in osu!(lazer)](/wiki/People/Featured_Artists/Featured_Artist_playlists) is here! The **top 10 players** in each playlist are eligible to earn some slick profile badges:
...
Wondering how **C-Show** translates to circles and sliders? ::Ekoro::{ user=284905 } gave a demonstration at [COE](/wiki/Community/cavoe's_osu!_event/2023) using the Easy mod! ...With no time to prepare. Here's how that went:

<div align="center">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/artists/378/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>

### C-Show - Rocking to the Beat

Try playing [the map from the video above](https://osu.ppy.sh/beatmapsets/305938) hosted by ::Avena::{ user=2198472 } or [this brand-new set](https://osu.ppy.sh/beatmapsets/2031865) hosted by ::Strategas::{ user=2971837 }!
...
Check out [the first Ranked **C-Show** map](https://osu.ppy.sh/beatmapsets/77441) hosted by ::Agka::{ user=64811 }!
...
Experience [this recently Ranked map](https://osu.ppy.sh/beatmapsets/2044626) hosted by ::SMOKELIND::{ user=9327302 } or [this 4K osu!mania map](https://osu.ppy.sh/beatmapsets/2047648) hosted by ::Virtue-::{ user=6144772 }!
...
Or attempt [this Loved map](https://osu.ppy.sh/beatmapsets/503580) hosted by ::ProfessionalBox::{ user=3250792 }!
...
Make some noise (specifically with your keyboard) while playing [this map](https://osu.ppy.sh/beatmapsets/1305940) hosted by ::MaridiuS::{ user=4496961 }!
...
Try out [another new beatmap](https://osu.ppy.sh/beatmapsets/2035357) hosted by ::Hinsvar::{ user=1249323 }!
