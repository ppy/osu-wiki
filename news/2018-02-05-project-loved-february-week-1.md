...
With over 550 favourites, Snow Drive by [jieusieu](https://osu.ppy.sh/users/759439) might be the most popular map in the vote this week, and for good reason.
...
Returning for its chance at redemption after not passing during the old voting system is [handsome](https://osu.ppy.sh/users/2123087)'s unravel.
...
[![](/wiki/shared/news/2018-02-05-project-loved-february-week-1/osu/genesis-at-oasis.jpg)](https://osu.ppy.sh/community/forums/topics/699477)

A full set of a brutal aim map that disguises itself as a stream map. [Krimek](https://osu.ppy.sh/users/2345078)'s Genesis at Oasis is an incredibly high tempo map that builds its intensity towards the end of the map all at a blistering 212 BPM. See if you can handle this behemoth.
...
[Cassu2](https://osu.ppy.sh/users/2587961)'s Foolish Hero bundles lapix's Hi-Tech style with some interesting high-tech slider patterns themselves. Overall, this proves to be an incredibly enjoyable and popular addition to the Loved vote this week.
...
[ProfessionalBox](https://osu.ppy.sh/users/3250792), [Asahina Momoko](https://osu.ppy.sh/users/3650145), and [Nathan](https://osu.ppy.sh/users/4785223) join forces in a fantastic collab to a fantastic song, with a few lower difficulties by [toybot](https://osu.ppy.sh/users/2848604) and [NeilPerry](https://osu.ppy.sh/users/841391) to fill out the set.
...
With almost 300 favourites and a guest difficulty by Guy, [ShiraKai](https://osu.ppy.sh/users/487668)'s Responsibility Response is a classic mapset which has seen tons of multiplayer play since 2015.
...
[Shiro](https://osu.ppy.sh/users/113005)'s latest masterpiece, GvP gained quick popularity as an equally difficult jump and stream map. Shiro makes great use of various patterns throughout a very repetitive song including a guitar slider and an outro treble clef.
...
Returning for another chance at Loved after the initial rounds of voting, Grenade by [Nanashima Asami](https://osu.ppy.sh/users/7370134) is a very well constructed tech map that has been featured in multiple tournaments.
...
Getting another crack at the Loved category, [Zapy](https://osu.ppy.sh/users/251395)'s famous Game Brain mapset makes its return for individual map voting.
...
Dnagib Kaerb, or Break Bigband as we'll be calling it, is an extremely infamous map. The TWC Finals Tie-Breaker, mapped by the also infamous [Firce777](https://osu.ppy.sh/users/274072), is one of, if not the, hardest maps ever used in a world cup.
...
A very old map by today's standards, Knife is a map that has seen community-wide adoration. [LZD](https://osu.ppy.sh/users/224335)'s style shines in one of his oldest maps.
...
[yea](https://osu.ppy.sh/users/6874332)'s Figue Folle is a really interesting take. Employing lots of spinners and sliders throughout, it separates it's take on the song from other maps by just simply being unique.
...
Ah, a funny little quirk about this map. The description for this actually says "This WILL be my first ranked mapset, or else I am not BrambleClaw!". Well, [BrambleClaw](https://osu.ppy.sh/users/3487731) actually changed his name to Bramble, and this will possibly be his first Loved mapset.
...
Souzou Forest is one of [17VA](https://osu.ppy.sh/users/1895984)'s most popular charts, it is a fun LN chart which is decently fast but also fairly simplistic stair based patterning, which makes it both easy to hit and hard to get good accuracy on.
...
A great collaboration between veteran charter [Fullerene-](https://osu.ppy.sh/users/2531335) and veteran speedster [Staiain](https://osu.ppy.sh/users/86188), which we're sure you'll enjoy.
...
Are you dexterous enough? Then do we have the mapset for you! Here it is, a full range of 4K to 7K marathon-length charts clocking in at a whopping 20 minutes of what can only be perceived as bloody psychopathic content by [arcwinolivirus](https://osu.ppy.sh/users/2039089), of featured artist Helblinde's DEAD END. Where we're going, we don't need roads.

[![](/wiki/shared/news/2018-02-05-project-loved-february-week-1/mania/kumo-no-kireme.jpg)](https://osu.ppy.sh/community/forums/topics/699506)
...
Our seventh chart on the list is a classic. This chart, created by [Cirno](https://osu.ppy.sh/users/373999) in 2013, is a chart that's heavily inspired by IIDX with some very interesting concepts executed.
...
The next submission is Quo Vadis, a mapset by [JamesHappy](https://osu.ppy.sh/users/3901876), with guest difficulties from [arcwinolivirus](https://osu.ppy.sh/users/2039089), [Evening](https://osu.ppy.sh/users/2193881) and XleonQ.
...
Another fan favourite, ApolloN is a mapset by (fairly) prolific charters [bbu2](https://osu.ppy.sh/users/4307930) and [LeiN-](https://osu.ppy.sh/users/2162939). LeiN-, being one of the best 4K charters in 2015, places another feather in his cap with solid 4K difficulties.
...
Once again, [PiraTom](https://osu.ppy.sh/users/1847698) and [inteliser](https://osu.ppy.sh/users/1824775) pull off an enjoyable LN chart which still stands as a popular challenge today.
