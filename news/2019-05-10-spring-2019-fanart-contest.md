...
* **Artists should use the custom templates provided ([PSD template](https://assets.ppy.sh/events/fanart/templates/osu%21%20main%20menu%202732x1536.psd?2017) / [PNG template](https://assets.ppy.sh/events/fanart/templates/osu%21%20main%20menu%202732x1536.png?2017)) when composing their piece as a guideline to understand where the osu! cookie will be placed on the main menu and during the voting process.** These templates show where the big osu! cookie will be overlayed during the voting process and if your background makes it to the main-menu.
...
[Head on over to the Spring 2018 Fanart Contest listing and enter now!](https://osu.ppy.sh/community/contests/78)
