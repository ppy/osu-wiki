...
Here's the songs for the first reboot session:
...
- The participation per gamemode per song will be evaluated in order for a song to be determined to be competitive - the amount of active mappers plays a role here for determining this.
