...
Taking the lead with **1687** votes is an entry utilising a beautiful fusion of mapping and storyboarding by ::Mr HeliX::{ user-id=2330619 }. Time Traveler offers a decent challenge featuring a mix of difficult streams and overlapping sliders, all alongside a meticulously crafted storyboard that gives you a true sense of travelling through time!
...
Once again we'd like to give a huge thanks to our category selectors, ::pishifat::{ user-id=3178418 }, [Zelq](https://osu.ppy.sh/users/8953955), ::Nuvolina::{ user-id=10974170 }, [Feerum](https://osu.ppy.sh/users/4815717), ::Unpredictable::{ user-id=7560872 }, [Yumeno Himiko](https://osu.ppy.sh/users/1806962), ::Doomsday::{ user-id=18983 }, and [jackylam5](https://osu.ppy.sh/users/1540807). I'd also like to give a thanks to ::heyronii::{ user-id=5642779 }, who helped with processing the beatmaps from entry to distribution.
