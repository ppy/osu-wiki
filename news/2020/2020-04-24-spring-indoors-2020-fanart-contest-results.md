...
In first place with **3495** votes reigns ::**TofuMang**::{ user=4817223 }'s wonderful take on a pyjama-donned pippi losing horribly to Chirou in the freshly-patented-please-do-not-steal card game known as uso!.
...
Nipping on first place's heels throughout the whole contest and ending up with **3477** votes, ::**xxxxxx2800**::{ user=4084853 } very nearly stole the show entirely with his stunningly vibrant rendition of pippi viewing cherry blossoms from the safety of her home.
...
Esteemed fanart contest veteran ::**snowyani2000**::{ user=2691590 } made his presence known once again, with **3210** voters being curtly reminded to wash their filthy hands.
...
**2961** voters succumbed to pippi's Absolute Territory conjured forth by ::**Shuuzo**::{ user=3661521 }'s artistic mettle. Bored as she looks with watching a live stream of cherry blossom trees, we all know who the real flower was in this piece.

[![](https://assets.ppy.sh/contests/92/banners/thomashuckle.jpg)](https://assets.ppy.sh/contests/92/winners/thomashuckle.png)

**2836** said yes to ::**thomashuckle**::{ user=14471273 }'s take on a very comfortable pippi and Mocha enjoying some time in front of the sun.
...
**2823** voters cast their approval like petals in the wind for ::**10nya**::{ user=678794 }'s rendition of a schoolgirl pippi gazing out upon a blossoming cherry tree.
...
Inked in some of the finest colouring work we've seen in a fanart contest so far, **2693** voters cast their eye towards ::**Sjao**::{ user=7295733 }'s Mocha attired in an airy dress as she admires her yard from her window.
...
**2470** voters joined ::**Hecatia**::{ user=8244635 }'s pippi for some socially-distanced boba set to the gentle tones of sunset.
...
**2403** voters understood that M is for Mocha (and for midriff) in ::**157**::{ user=9315038 }'s take on our most adorable mascot lazing around in a storm of sunlit petals.
...
**2160** people snuck a sneak peek into Chirou's room as imagined by ::**Aoki chiaki**::{ user=7692958 }, and were gobsmacked by its cleanliness and botanical theme.
...
**1940** voters watched along with Mocha as she gazes upon pippi's feeble attempts to conquer the ancestor of her most beloved game mode, courtesy of ::**Phillette**::{ user=9457944 }'s artistic skills.
...
::**HEKUSODASU**::{ user=9044692 } drew **1901** tiny chibi pippis doing tiny chibi pippi things. Oh, and that many people voted for the entry as well.
...
In perhaps the most sombre take of all the entries thus far, ::**Eternity Youmu**::{ user=1012268 }'s take on an unfortunately feverish pippi drew sympathy from the hearts of **1765** voters.

Get well soon!

[![](https://assets.ppy.sh/contests/92/banners/VoidSynatic.jpg)](https://assets.ppy.sh/contests/92/winners/VoidSynatic.png)

**1765** people snickered at how bad Mocha is at card games, courtesy of ::**VoidSynatic**::{ user=8270353 }'s rendition of Aiko profoundly rolling her in a game of Old Maid.
...
**1763** curious butterflies flitted past ::**Dreamxiety**::{ user=13103233 }'s pippi studying the art of osu! in book form within a library.
...
**1505** voters were convinced to stay home by ::**ShovelKun**::{ user=9948284 }'s fashionably spring-attired Maria. Simple, clean, and an absolute pleasure to look at.

[![](https://assets.ppy.sh/contests/92/banners/kuroshi-n.jpg)](https://assets.ppy.sh/contests/92/winners/kuroshi-n.png)

When **1456** people saw ::**kuroshi-n**::{ user=9887975 }'s Yuzu smile, they had no choice but to press the button.
...
**1430** voters found ::**Amy-chan**::{ user=5213909 }'s catgirl pippi very relatable as she feasts upon a bag of Nom brand potato snacks, lounging on a couch.

[![](https://assets.ppy.sh/contests/92/banners/iegno.jpg)](https://assets.ppy.sh/contests/92/winners/iegno.png)

Not to be left out of snacking time, **1363** people approved of ::**iegno**::{ user=7736026 }'s Mocha enjoying some snacks of her own, and probably running around smacking people in the head with bug nets within an unnamed game of choice involving animals and crossings.

[![](https://assets.ppy.sh/contests/92/banners/rukanyaaan.jpg)](https://assets.ppy.sh/contests/92/winners/rukanyaaan.png)

**1353** joined ::**rukanyaaan**::{ user=16690734 }'s pippi and Chirou in realizing that there's (probably) no rules about standing inside and looking at your yard with the door open.
