...
For transparency's sake, the screening users this month are  ::Cris-::{ user=6175280 }, [Noffy](https://osu.ppy.sh/users/1541323),  ::Nuvolina::{ user=10974170 }, [Realazy](https://osu.ppy.sh/users/918297), ::ScubDomino::{ user=8972308 }, [Sing](https://osu.ppy.sh/users/3795679), ::Smokeman::{ user=2140676 }, [Uberzolik](https://osu.ppy.sh/users/1314547), ::Venix::{ user=5999631 }, and [Zelq](https://osu.ppy.sh/users/8953955). In case any of them drop out, back-up screening users are ::Cheri::{ user=5226970 }, [Myxo](https://osu.ppy.sh/users/2202645), and ::Sinnoh::{ user=4236057 }. All of these users will be reviewing the submissions without knowledge of who their creators are, and each of their preferred submissions will be viewable when the top 5 entries are announced.
