...
For transparency's sake, the screening users this month are  ::Cris-::{ user=6175280 }, ::Noffy::{ user=1541323 },  ::Nuvolina::{ user=10974170 }, ::Realazy::{ user=918297 }, ::ScubDomino::{ user=8972308 }, ::Sing::{ user=3795679 }, ::Smokeman::{ user=2140676 }, ::Uberzolik::{ user=1314547 }, ::Venix::{ user=5999631 }, and ::Zelq::{ user=8953955 }. In case any of them drop out, back-up screening users are ::Cheri::{ user=5226970 }, ::Myxo::{ user=2202645 }, and ::Sinnoh::{ user=4236057 }. All of these users will be reviewing the submissions without knowledge of who their creators are, and each of their preferred submissions will be viewable when the top 5 entries are announced.
