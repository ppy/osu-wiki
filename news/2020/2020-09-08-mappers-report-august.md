...
Moving on to another mapper who also has been mapping for a while but deserves more attention, ::pocket-::{ user=6808091 } has made some really amazing maps over the years! Although pocket has just one ranked map, that one ranked map is nothing to scoff at as it leaves most mappers and players alike in awe!
...
- **For osu!taiko by ::radar::{ user=7131099 }**:
...
- **For osu!catch by ::Baron::{ user=10286499 }**:
...
- **For osu!mania by ::Davvy::{ user=10047413 }**:
