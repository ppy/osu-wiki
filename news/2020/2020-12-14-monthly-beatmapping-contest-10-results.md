...
| :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| \#1 | [flora](https://osu.ppy.sh/beatmapsets/1322809) by ::0ppInOsu::{ user=12551840 } | [see details](https://mappersguild.com/contests/results?submission=5fad8f5d5abb614f7025b192) | 58 | 56 | 60 | 34 | **208** |
| \#2 | [Dragon Blood](https://osu.ppy.sh/beatmapsets/1317855) by ::Mao::{ user=2204515 } | [see details](https://mappersguild.com/contests/results?submission=5fad8f5c5abb614f7025b190) | 56 | 49 | 57 | 35 | **197** |
| \#3 | [connection](https://osu.ppy.sh/beatmapsets/1320472) by ::fowwo::{ user=4547551 } | [see details](https://mappersguild.com/contests/results?submission=5fad8f585abb614f7025b16c) | 53 | 52 | 55 | 34 | **194** |
| \#4 | [connection](https://osu.ppy.sh/beatmapsets/1317565) by ::Halgoh::{ user=4109923 } | [see details](https://mappersguild.com/contests/results?submission=5fad8f5e5abb614f7025b19e) | 49 | 59 | 48 | 32 | **188** |
| \#5 | [flora](https://osu.ppy.sh/beatmapsets/1318355) by ::William K::{ user=2261651 } | [see details](https://mappersguild.com/contests/results?submission=5fad8f5c5abb614f7025b18e) | 51 | 58 | 47 | 32 | **188** |
| \#6 | [mango sago](https://osu.ppy.sh/beatmapsets/1317561) by ::xbopost::{ user=6842421 } | [see details](https://mappersguild.com/contests/results?submission=5fad8f5e5abb614f7025b19c) | 51 | 44 | 57 | 32 | **184** |
| \#7 | [toast.girl](https://osu.ppy.sh/beatmapsets/1317542) by ::Sylas::{ user=3906405 } | [see details](https://mappersguild.com/contests/results?submission=5fad8f5a5abb614f7025b17c) | 47 | 42 | 52 | 30 | **171** |

### Winner

Rising from seemingly nowhere as a first-time MBC participant, ::0ppInOsu::{ user=12551840 } blasted all expectations with his **winning** map for [kiraku - flora](https://osu.ppy.sh/beatmapsets/1322809).
...
::Mao::{ user=2204515 } is in practically the opposite situation.
...
For the last few contests their picks have aligned with the contest winner, but that can't be said about this round's praise for ::Halgoh::{ user=4109923 } on [kiraku - connection](https://osu.ppy.sh/beatmapsets/1317565). With 3 screeners picking this as their favourite submission and 3 others putting it in their top 3, Halgoh undoubtedly had a solid performance!
...
| :-- | :-- |
| ::Mao::{ user=2204515 } | 9 |
| ::Sylas::{ user=3906405 } | 9 |
| ::Acylica::{ user=1943309 } | 8 |
| ::Cris-::{ user=6175280 } | 6 |
| ::hypercyte::{ user=9155377 } | 6 |
| ::UndeadCapulet::{ user=2523533 } | 5 |
| ::xbopost::{ user=6842421 } | 5 |
...
| :-- | :-- | :-- | :-- |
| ::Uberzolik::{ user=1314547 } | 9 | 1 | **10** |
| ::Myxo::{ user=2202645 } | 9 | 1 | **10** |
| ::Nuvolina::{ user=2202645 } | 5 | 5 | **10** |
| ::Cheri::{ user=5226970 } | 8 | 0 | **8** |
| ::Niva::{ user=197805 } | 7 | 0 | **7** |
| ::Agatsu::{ user=5579871 } | 7 | 0 | **7** |
| ::Mazzerin::{ user=2942381 } | 0 | 6 | **6** |
| ::Trynna::{ user=2652951 } | 6 | 0 | **6** |
| ::Regou::{ user=419954 } | 6 | 0 | **6** |
| ::Nozhomi::{ user=2716981 } | 5 | 0 | **5** |
| ::coco::{ user=9579526 } | 5 | 0 | **5** |
| ::Zelq::{ user=8953955 } | 4 | 1 | **5** |

Huge props to those 3 at the top for helping with every contest. Oh, and ::Agatsu::{ user=5579871 } deserves a special shoutout for submitting maps to the MBC each of the times he didn't screen!
