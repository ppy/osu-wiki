...
There's still plenty more of **Rohi**'s sound left to discover though, so make sure to give these a listen:
...
Check out [this classic set](https://osu.ppy.sh/beatmapsets/58737) hosted by ::NatsumeRin::{ user=151679 }!
...
Check out [this osu! and osu!taiko set](https://osu.ppy.sh/beatmapsets/93555) hosted by ::NatsumeRin::{ user=151679 }, and [an osu!taiko set](https://osu.ppy.sh/beatmapsets/111635) by ::mintong89::{ user=966210 }!
...
Check out [this classic set](https://osu.ppy.sh/beatmapsets/95148) hosted by ::pieguy1379::{ user=107485 }!
...
<audio controls>
    <source src="https://assets.ppy.sh/artists/82/previews/2162.mp3" type="audio/mpeg">
</audio>
...
Keep your eyes peeled on the [@osugame Twitter](https://twitter.com/osugame) for more details throughout the week, and until then, enjoy!
