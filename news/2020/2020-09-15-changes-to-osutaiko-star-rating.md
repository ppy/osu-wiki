...
A huge thank you goes out to ::morth1::{ user=7246874 } for pioneering much of these changes and soliciting the osu!taiko community for feedback during the process. Another big thank you goes to [bdach](https://github.com/bdach) for helping to describe much of these changes and for contributions to the code.
