...
Aspire first began with [LeaF - Evanescent](https://osu.ppy.sh/beatmapsets/227126) by ::Charles445::{ user=85000 } back in 2014, and since then we have seen several more maps rise to become Aspire class beatmaps, such as [IAHN - Transform (Original Mix)](https://osu.ppy.sh/beatmapsets/484689) by ::Monstrata::{ user=2706438 }, which blew the contest away with its animated shapes.
...
A classic amongst the community, [Graces of Heaven](https://osu.ppy.sh/beatmapsets/147910) by ::rustbell::{ user=227717 } mixes a variety of unrankable techniques, creating a unique and challenging experience!

[Mayday](https://osu.ppy.sh/beatmapsets/756794) by ::Voltaeyx::{ user=2715118 } combines a storyboard with overlapping sliders to create a visual spectacle that is guaranteed to blow any audience away, solidifying its spot as the most favorited [Loved](https://osu.ppy.sh/beatmapsets?sort=favourites_desc&s=loved) beatmap.

Breaking the bounds in a completely different way, [Shiny Smily Story](https://osu.ppy.sh/beatmapsets/1122763) by ::Jerry::{ user=605973 } uses a storyboard and skin trickery to create a completely different gamemode!
...
If you are interested in being a judge and categorising the entries, please contact ::-Mo-::{ user=2202163 }. Please note however that judges cannot participate in entering the contest.
