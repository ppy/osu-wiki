...
Brought to prominence in osu! by ::one intrepid user's efforts::{ user=4378277 } in the past year or two, **MIMI** is a Japanese producer and artist focused on working with the *VOCALOID* lineup.
...
Check out [this set](https://osu.ppy.sh/beatmapsets/952409) by ::Log Off Now::{ user=4378277 }!
...
Check out [this set](https://osu.ppy.sh/beatmapsets/968171) by ::Log Off Now::{ user=4378277 }!
...
Check out [this set](https://osu.ppy.sh/beatmapsets/962088) by ::Log Off Now::{ user=4378277 }!
