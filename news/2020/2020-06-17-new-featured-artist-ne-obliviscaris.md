---
layout: post
title: "New Featured Artist: Ne Obliviscaris"
date: 2020-06-17 08:00:00 +0000
...
Check out [this classic, critically acclaimed set](https://osu.ppy.sh/beatmapsets/724192) by ::mithew::{ user=2571893 }!
...
Check out [this modern showcase set](https://osu.ppy.sh/beatmapsets/1177346) from the Mappers' Guild created by ::Seto Kousuke::{ user=2857314 }!
...
Check out [this modern osu!taiko set](https://osu.ppy.sh/beatmapsets/1117322#taiko/2333970) mapped by ::Heaxys::{ user=5671417 }!
...
<audio controls>
    <source src="https://assets.ppy.sh/artists/86/previews/2231.mp3" type="audio/mpeg">
</audio>

### Libera (Part I) - Saturnine Spheres

<audio controls>
    <source src="https://assets.ppy.sh/artists/86/previews/2227.mp3" type="audio/mpeg">
</audio>

---

All of the above plus so much more are available right now over at [**Ne Obliviscaris**' Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/86), pre-timed and well prepared for your creative enterprises. Even though there's only slightly over a dozen new tracks, this represents nearly three hours of original music to sink your teeth into, so what're you waiting for?
...
We'll be back next week with more incredible talent for the creative among us to test their mapping mettle on, so make sure you stay tuned and keep on top of things by paying attention to the [@osugame Twitter](https://twitter.com/osugame/). The train just never stops, seriously.
