...
::Mao::{ user=2204515 } from the Mappers' Guild has also been hard at work creating a brand new modern showcase map set to [Wagering Lights](https://osu.ppy.sh/beatmapsets/1163910), so make sure to check it out if you want to experience the new to go with the old!

Check out a sample of what's available:

### Sync

Check out [this classic set](https://osu.ppy.sh/beatmapsets/95510) by ::\[Luanny\]::{ user=802909 }!
...
Check out [this classic set](https://osu.ppy.sh/beatmapsets/426652) by ::Bonsai::{ user=987334 }!
...
Check out [this classic set](https://osu.ppy.sh/beatmapsets/190284) by ::Leader::{ user=631530 }!
