...
We are very thankful to **all the contestants**, **::yaspo::{ user=4945926 }**, **[Ryuusei Aika](https://osu.ppy.sh/users/7777875)**, **::Electoz::{ user=6485263 }**, **[Sonnyc](https://osu.ppy.sh/users/11771)**, **::Myxo::{ user=2202645 }**, **[Stack](https://osu.ppy.sh/users/6122935)** and **::Seto Kousuke::{ user=2857314 }** that did an immense work by judging hundreds of entries while still respecting all the short deadlines. Nothing would have happen without them! Please give a round of applause to **::Milan-::{ user=1052994 }** that managed to solely handle the website management during the whole period!
