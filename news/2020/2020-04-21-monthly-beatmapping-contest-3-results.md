...
Receiving a hefty **85** votes, ::Sylas::{ user-id=3906405 } (previously known as TheKoala) managed to top the community vote poll with his entry of [Sound Souler - Bubble Flower](https://osu.ppy.sh/beatmapsets/1152182#osu/2404833) and is **this month's winner!**
...
Gathering **83** votes, ::hypercyte::{ user-id=9155377 }'s submission of [Sound Souler - Bubble Flower](https://osu.ppy.sh/beatmapsets/1152177#osu/2404822) came in a close second, making him the **community vote's runner-up.**
...
And while he didn't win, we'd like to give a shoutout to ::Mao::{ user-id=2204515 }'s entry of [Sound Souler - Blackorient](https://osu.ppy.sh/beatmapsets/1152185#osu/2404842) for using the slowest base slider velocity allowed by the editor. It's legitimately impressive that he was able to make a decent map under that condition, so check it out!

---

And as per usual, all participants in March's contest received a message showing how the screening crew viewed their entry. Thanks to ::coco::{ user-id=9579526 }, [fieryrage](https://osu.ppy.sh/users/3533958), ::Moecho::{ user-id=5075660 }, [Niva](https://osu.ppy.sh/users/197805), ::Cheri::{ user-id=5226970 }, [Nuvolina](https://osu.ppy.sh/users/10974170), ::Myxo::{ user-id=2202645 }, [Regou](https://osu.ppy.sh/users/419954), ::Seolv::{ user-id=8067876 }, [Trynna](https://osu.ppy.sh/users/2652951), ::Uberzolik::{ user-id=1314547 }, [Venix](https://osu.ppy.sh/users/5999631), and ::Zelq::{ user-id=8953955 } for screening all 60 contest submissions, and thanks to you for voting in the community poll.
