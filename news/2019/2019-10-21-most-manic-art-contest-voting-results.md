...
Taking home first place with his wonderfully vibrant take on our keyed-in twins-to-be, ::**TofuMang**::{ user=4817223 } nabs the win with **1986** votes.
...
Trailing just behind at **1830** votes, ::**Hecatia's**::{ user=8244635 } Nana and Shin captivated a score of onlookers with their ribbon-laced charm.
...
In perhaps the closest result in any art contest we've held so far, ::**crystalsuicune**'s::{ user=9974 } Mani and Max stormed into the top three with **1827** votes.
...
- #4: ::**JinairuSensie**::{ user=10932731 } with **1819** votes
- #5: ::**Laridae**::{ user=2610348 } with **1783** votes
- #6: ::**leleisama29**::{ user=12992044 } with **1605** votes
- #7: ::**kurisu illusia**::{ user=6140529 } with **1592** votes
- #8: ::**xiemon**::{ user=5203667 } with **1531** votes
- #9: ::**blarackoklahoma**::{ user=7457620 } with **1524** votes
- #10: ::**bty**::{ user=7425199 } with **1204** votes
