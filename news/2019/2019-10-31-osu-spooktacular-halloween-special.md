...
Soaring to victory with an incredible **6136** votes, ::**Sunako**::{ user-id=2801166 }'s broomstick-toting pippi and Mocha flying across a city skyline was a hit, and it shows!
...
**4669** voters were held at knifepoint and forced to cast their lot for ::**SJPumpkin**::{ user-id=4840900 }'s rendition of a very... *passionate* pippi.

We're sure the splotchy streaks on the walls are just pink spray paint. Right...?

[![](https://assets.ppy.sh/contests/81/banners/157.jpg)](https://assets.ppy.sh/contests/81/winners/157.png)

**3863** pumpkin ghosts were enchanted by ::**157**::{ user-id=9315038 }'s take on a rather spooky Mocha and her eerie one-eyed cat.
...
Enchanted by her great lengths of billowing hair, **3850** voters approved of ::**xxxxxx2800**::{ user-id=4084853 }'s devilishly demure pippi enjoying a definitely-not-poisoned apple in a rather picturesque Halloween town.
...
[![](https://assets.ppy.sh/contests/81/banners/10nya.jpg)](https://assets.ppy.sh/contests/81/winners/10nya.png)

**3423** were clued in to ::**10nya**::{ user-id=678794 }'s witch pippi and her fearsome secret: she's adorable as all heck.
...
**3414** voters got sparkles in their eyes from ::**Salty Because**::{ user-id=7736026 }'s rendition of a gorgeously attired witch Mocha taking a joyride through the sky.
...
[![](https://assets.ppy.sh/contests/81/banners/Laridae.jpg)](https://assets.ppy.sh/contests/81/winners/Laridae.png)

AWOO! **2925** people rolled over at ::**Laridae**::{ user-id=2610348 }'s werewolf Mocha and her costumed compatriots.
...
**2793** voters adored ::**Tachion1**::{ user-id=4429331 }'s beautifully unique take on pippi and Mocha taking flight in true Halloween spirit beneath the full moon. With bats.

Because it isn't Halloween (or osu!) without the BAT. If you understand this joke, you've been playing the game too long.

[![](https://assets.ppy.sh/contests/81/banners/LanceLMiku.jpg)](https://assets.ppy.sh/contests/81/winners/LanceLMiku.png)

**2792** voters got snatched away, much like ::**LanceLMiku**::{ user-id=1809907 }'s take on Chirou being pilfered from a demon-pippi and Mocha showcasing her uncanny ability to balance oversized vegetables (and a don) on her head.

It seems Chirou is used to this turn of events, judging from the look on her face. We'll leave you to figure out why.

[![](https://assets.ppy.sh/contests/81/banners/Arind.jpg)](https://assets.ppy.sh/contests/81/winners/Arind.png)

Like stars in the night sky, **2734** voters could not resist ::**Arind**::{ user-id=12116469 }'s hooded Halloween pippi striking a pose before the full moon.

Simple and wonderful, that's all there is to it.

[![](https://assets.ppy.sh/contests/81/banners/Dreamy%20Daylite.jpg)](https://assets.ppy.sh/contests/81/winners/Dreamy%20Daylite.png)

**2530** voters were asked "trick or treat?" by ::**Dreamy Daylite**::{ user-id=13103233 }'s mischievous vampire pippi and witch Mocha, only to find out that it was a rhetorical question and the devil don had already made off with their candy.

[![](https://assets.ppy.sh/contests/81/banners/saoie.jpg)](https://assets.ppy.sh/contests/81/winners/saoie.png)

**2468** minions bowed before the gaze of ::**saoie**::{ user-id=6015875 }'s' fallen angel Mocha. If you squint really hard, you can see their faces in the darkness of her window.

I lied, you can't, but you should absolutely be squinting at that gorgeous rendition of a decidedly more mature Mocha. Damn.

[![](https://assets.ppy.sh/contests/81/banners/pyun.jpg)](https://assets.ppy.sh/contests/81/winners/pyun.png)

**2460** voters watched on in horror as ::**pyun**::{ user-id=981534 }'s Chirou zoomed away on her broom nomming on some pumpkin candy, presumably stolen from a witch-attired pippi in hot pursuit, complete with a neko-themed Taikonator.
...
AVAST ME HEARTIES! **2406** scurvy dogs set sail on ::**snowyani2000**::{ user-id=2691590 }'s harrowing piratical seas sporting more references than you can shake a stick at, including a *suspiciously familiar* seagull figurehead getting up close and personal with a rather enthusiastic tentacle.

There's something I'd never thought I'd have to write in one of these posts.

[![](https://assets.ppy.sh/contests/81/banners/Misakko.jpg)](https://assets.ppy.sh/contests/81/winners/Misakko.png)

**2333** voters joined ::**Misakko**::{ user-id=3173752 }'s batwinged Aiko in a flight above eerie, skyborne ruins, with lakes that look strangely like liquid taffy.
