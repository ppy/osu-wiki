...
The judging for the first [osu!mania Mapping Olympiad contest](https://osu.ppy.sh/community/contests/67) has been completed! Congratulations to **::PianoLuigi::{ user=9665915 }**, the first osu!mania Mapping Olympian and our newest *Elite Mapper*!
...
| :-: | :-- | :-- | --: | --: | --: | --: | --: | --: | --: |
| #1 | **::PianoLuigi::{ user=9665915 }** | Uplifting Badger | 27 | 26 | 26 | 27 | 15 | 12 | **133** |
| #2 | **::Kawawa::{ user=4647754 }** | Vile Dragon | 25 | 22 | 24 | 23 | 12 | 14 | **120** |
| #3 | **::\_VianK\_::{ user=6889055 }** | Unnerved Dragon | 21 | 21 | 23 | 21 | 13 | 10 | **109** |
| #4 | **::Noch Einen::{ user=12668735 }** | Gloomy Goose | 21 | 24 | 18 | 19 | 10 | 11 | **103** |
| #5 | **::Hira::{ user=6177202 }** | Malevolent Magpie | 21 | 21 | 18 | 20 | 11 | 11 | **102** |
| #6 | **::Sinnoh::{ user=4236057 }** | Nervy Kinglet | 19 | 19 | 19 | 18 | 12 | 14 | **101** |
| #7 | **::MEGAtive::{ user=3094101 }** | Magnificent Cottonmouth | 20 | 16 | 20 | 19 | 11 | 14 | **100** |
| #8 | **::Hydria::{ user=808176 }** | Charming Opossum | 22 | 19 | 19 | 17 | 7 | 11 | **95** |
| #9 | **::DE-CADE::{ user=3734394 }** | Unethical Pintal | 18 | 18 | 19 | 17 | 10 | 12 | **94** |
| #10 | **::LordRaika::{ user=3265023 }** | Distracted Lark | 18 | 22 | 16 | 17 | 11 | 8 | **92** |
| #11 | **::Nivrad00::{ user=1984634 }** | Alarmed Teal | 17 | 18 | 15 | 16 | 6 | 9 | **81** |
| #12 | **::Lenfried-::{ user=5314573 }** | Jolly Fox | 12 | 19 | 14 | 13 | 7 | 8 | **73** |
| #13 | **::Cuma Iseng::{ user=10418463 }** | Vigilant Weasel | 11 | 21 | 7 | 9 | 5 | 6 | **59** |

In **first place** is **::PianoLuigi::{ user=9665915 }** with a total score of **133/150**! Their entry scored the highest in an impressive 5 of the 6 categories and was the highest scoring entry from judges Asherz007 and Leniane! This was an entry that stood high above the rest and is well deserving of the top spot for this contest. Congratulations!

In **second place** is **::Kawawa::{ user=4647754 }** with a total score of **120/150**. With excellent scores across each category and the highest score from judge Tailsdk, Kawawa's entry was very well executed.

And rounding out the podium in **third place** is **::\_VianK\_::{ user=6889055 }** with a total score of **109/150**. Strong scores from each judge and in the technique and hitsounding categories helped push their entry into third place.

You can see all of the scores and comments from the judges via [this spreadsheet](https://docs.google.com/spreadsheets/d/1f1JEhs8iAbcWZppB2JJ25k4qerFE_RAOZCN_LYzo4NQ/edit?usp=sharing), and you can [click here to download all of the entries](https://drive.google.com/open?id=1fbVsSd0R3TtpMn5F3FYKEiVcRd-njXBz) via Google Drive.
