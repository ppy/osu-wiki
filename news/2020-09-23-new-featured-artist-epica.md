...
<audio controls>
    <source src="https://assets.ppy.sh/artists/100/previews/2689.mp3" type="audio/mpeg">
</audio>
...
We'll be making a few changes to the way things happen in the future as well - namely that we will be releasing **two** new Featured Artists every week, one on Wednesday as you've grown used to, and another one on Saturday - starting this week. This new schedule will continue for as long as we have the backlog to support it, which means it may slow back down to one weekly release without warning. We figure this is better than leaving artists in the wings for weeks when we could just release them instead. In addition to this, we'll no longer be releasing hints for new releases like before.

Other than that, we're grateful to have you with us during this wild musical ride, and we look forward to seeing what you all make in the future with our growing catalog of absurdly talented artists. Maybe one day in a few years time we'll look back on this announcement and think, "aww, only one hundred artists? How cute."

Check back this Saturday for more details about our next Featured Artist, and keep an eye on the [@osugame Twitter](https://twitter.com/osugame) for more tidbits and news you're sure to want to know.
