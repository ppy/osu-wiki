...
We've pulled **7** songs from their archives, all of which are freely available to map from [**rN**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/115)!
...
The remaining tracks can be found on [**rN**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/115), all with timing done in advance! Considering how many BPM changes some of these songs have, pre-timed beatmap templates will really come in handy. You're welcome.
