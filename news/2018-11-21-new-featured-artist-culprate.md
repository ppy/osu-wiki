...
<audio controls>
    <source src="https://assets.ppy.sh/artists/29/previews/624.mp3" type="audio/mpeg">
</audio>

### Relucent (featuring ZES)

*A special bonus track on the end of the digital edition of Deliverance, Relucent is a celebration of all the acoustic-electronic fusion displayed throughout the album.*

<audio controls>
    <source src="https://assets.ppy.sh/artists/29/previews/631.mp3" type="audio/mpeg">
</audio>

### Impulse (featuring Au5)

*From the second part of the Unity Project albums is perhaps one of the most iconic osu! tracks in recent years, thanks to [handsome's award winning map](https://osu.ppy.sh/beatmapsets/705788#osu/1492654).*

<audio controls>
    <source src="https://assets.ppy.sh/artists/29/previews/625.mp3" type="audio/mpeg">
</audio>

### Pencilina (featuring Dictate)

*From part two of the Unity Project is a collaboration track with our own Dictate, merging their two distinct sounds to produce something very, very special.*

<audio controls>
    <source src="https://assets.ppy.sh/artists/29/previews/627.mp3" type="audio/mpeg">
</audio>

### Aurora (featuring Bloom)

*Rocking in on the third part of the Unity Project albums is a distinctly funky twist on Culprate's classic sound. You may be familiar with this one from the recent OWC 2018 streams.*

<audio controls>
    <source src="https://assets.ppy.sh/artists/29/previews/626.mp3" type="audio/mpeg">
</audio>

### Mechanic Heartbeat (featuring Keota & Sophie Meiers)

*Otherworldly vocals set amid resonating synths and a distinct, two-tap beat pose a unique challenge for mappers to tackle in perhaps one of the most difficult song picks we've selected for the Featured Artist project.*
