...
Don't feel too bad if you don't actually recognize **A-One**'s name. Throughout osu!, most people refer to their songs by their vocalists' names, like the classic [*Shihori - Magic Girl !!*](https://osu.ppy.sh/beatmapsets/53519) hosted by ::Frostmourne::{ user=199669 }. In case you weren't around at the time, relive the moment ::Azer::{ user=2155578 } became a magic girl through the video below, or check out all these other unforgettable maps:

<div align="center">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/artists/168/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>

### A-One feat. Shihori - Day Breaker

Check out [this beatmap](https://osu.ppy.sh/beatmapsets/91606) by ::Frostmourne::{ user=199669 }!
...
Or check out [this beatmap](https://osu.ppy.sh/beatmapsets/128432) by ::Lortus::{ user=1008962 }!
...
Maybe check out [this beatmap](https://osu.ppy.sh/beatmapsets/39056) yet again by ::Frostmourne::{ user=199669 }. We think he might be an **A-One** fan.
...
If these are too easy for you, try out [this loved map](https://osu.ppy.sh/beatmapsets/1026767) by ::Settia::{ user=2445897 }!
...
Play [this beatmap](https://osu.ppy.sh/beatmapsets/46223) by none other than ::Frostmourne::{ user=199669 }. He definitely likes **A-One**.
...
If that's enough circle clicking for you, try out [this osu!taiko beatmap](https://osu.ppy.sh/beatmapsets/832564) hosted by ::eiri-::{ user=3388410 }.
