...
In case you're the one osu! player who still hasn't heard these songs (yes, I'm talking to you Tim), feel free to sample any of the previews or watch ::Aireu::{ user=1650010 } play with low approach rates below:
...
Play the [classic map](https://osu.ppy.sh/beatmapsets/41686) by ::val0108::{ user=243917 } or try this [more modern interpretation](https://osu.ppy.sh/beatmapsets/528089) by ::pkk::{ user=3620525 }!
...
Try out another [old-school map](https://osu.ppy.sh/beatmapsets/20201) by ::Kochiya Sanae::{ user=395591 }!
...
Play this massive [osu! x osu!taiko x osu!mania mapset](https://osu.ppy.sh/beatmapsets/110547) hosted by ::Bara-::{ user=2533040 }!
...
Check out this [easier mapset](https://osu.ppy.sh/beatmapsets/46623) by ::spboxer3::{ user=197974 }!
