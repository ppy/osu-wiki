...
What could be a better way to experience **T & Sugah**'s sound than a quad-map exhibit? Drum & bass fanatics ::Strategas::{ user=2971837 } and ::Zer0-::{ user=4260033 } have been hard at work creating some [showcase maps](/wiki/Featured_Artists/Featured_Artist_showcase_beatmaps) specifically for this announcement, so give them a kudosu or two for their efforts.
...
Experience [this full-length osu! map](https://osu.ppy.sh/beatmapsets/1519300) hosted by ::Zer0-::{ user=4260033 }!
...
Or check out [this osu! map](https://osu.ppy.sh/beatmapsets/1511518) hosted by ::Strategas::{ user=2971837 }!
...
Enjoy [this osu! map](https://osu.ppy.sh/beatmapsets/1496811) also hosted by ::Strategas::{ user=2971837 }!
...
And finish things off with [this classic OWC 2016 map](https://osu.ppy.sh/beatmapsets/471562) *also* hosted by ::Strategas::{ user=2971837 }!
