...
Created with care by ::Inflique::{ user=13865585 }, [Arknights Ch'en v2.0](https://osu.ppy.sh/community/forums/topics/1365860) ensures you a cyberpunk-esque gaming experience featuring Ch'en from the popular mobile game Arknights. Presenting you with a futuristic song selection panel, the skin makes you feel as if you're in a cockpit of a high-tech spaceship.
...
[Raiden Shogun - Baal](https://osu.ppy.sh/community/forums/topics/1381997) revolves around one of the characters from the well-known gacha game, Genshin Impact. Withholding a peaceful and serene theme, Raiden Shogun attributes a misty aura to the user interface with the top-notch help of ::pikabrownie::{ user=13140446 }'s excellence in skinning.
