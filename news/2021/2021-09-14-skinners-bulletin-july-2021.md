...
Created with care by ::Inflique::{ user-id=13865585 }, [Arknights Ch'en v2.0](https://osu.ppy.sh/community/forums/topics/1365860) ensures you a cyberpunk-esque gaming experience featuring Ch'en from the popular mobile game Arknights. Presenting you with a futuristic song selection panel, the skin makes you feel as if you're in a cockpit of a high-tech spaceship.
...
[Raiden Shogun - Baal](https://osu.ppy.sh/community/forums/topics/1381997) revolves around one of the characters from the well-known gacha game, Genshin Impact. Withholding a peaceful and serene theme, Raiden Shogun attributes a misty aura to the user interface with the top-notch help of ::pikabrownie::{ user-id=13140446 }'s excellence in skinning.
...
We would like to thank ::Matt2e2::{ user-id=12144912 } and [Master-TigerKun](https://osu.ppy.sh/users/10688456) for pouring their creativity into the banner design, ::watterino::{ user-id=3512261 } for preparing all the showcase videos of this issue, ::Roan::{ user-id=8214639 } for helping us compile the July 2021 statistics, and you, the readers, for allocating your precious time to read our bulletin!
