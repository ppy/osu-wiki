...
**PTB10** might be a new name to some osu! players, so you're lucky that ::Altai::{ user=5745865 } from the Mappers' Guild has prepared a showcase beatmap of [PTB10 - Starfall](https://osu.ppy.sh/beatmapsets/1648460). See how it looks when the cursor is replaced with a literal marble, then listen through the rest of the previews!
...
Try [the map seen above](https://osu.ppy.sh/beatmapsets/1648460) hosted by ::Altai::{ user=5745865 }!
