...
Thanks to ::Walavouchey::{ user=5773079 } for this month’s picks!

### VenerableNyanta

With increasingly refined storyboards this year, ::VenerableNyanta::{ user=12243368 } has shown their determination for improvement project after project! It's easy to tell they have an eye for design when the visuals fill the screen with nothing but pure eye candy!
...
A confident storyboarder for a couple of years now, ::TheDuckMask::{ user=7405768 } has shown expertise nowadays in more niche sides of storyboard design.
...
Should you plan any contest in the future and would like to have it advertised in the Mappers’ Report, please contact ::Feerum::{ user=4815717 } with all the details about it!
...
If you're interested, check out [this thread](https://osu.ppy.sh/community/forums/topics/723358) then DM ::Parachor::{ user=5241655 } with an example of uniqueness in your mapping. The event is entirely run on Discord, so a Discord account is required as well.
...
As always, should you have anything interesting mapping or modding related you would like to see being mentioned in the next issue, please do not hesitate to contact ::Feerum::{ user=4815717 } or drop by in the `#mappers-report` channel on the [osu! community Discord server](https://discord.gg/0Vxo9AsejDkGlk3H)!
