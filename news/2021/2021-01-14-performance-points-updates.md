...
As suggested by ::**Xexxar**::{ user=2773526 }, the following change has been applied:
...
As suggested by ::**StanR**::{ user=7217455 } in [this pull request](https://github.com/ppy/osu-performance/pull/127), the following change has been applied:
...
As suggested by ::**StanR**::{ user=7217455 } in [this pull request](https://github.com/ppy/osu-performance/pull/110), the following change has been applied:
...
A big thank you to everyone involved in these changes, and especially to ::**Xexxar**::{ user=2773526 }, who has floated the major triad of the top-level changes this time around, performing all the formulaic wizardry required to make them tick largely on his own.
