...
Check out [the beatmap from the video above](https://osu.ppy.sh/beatmapsets/9040) hosted by ::yeahyeahyeahhh::{ user=58042 } and [this other beatmap](https://osu.ppy.sh/beatmapsets/22082) hosted by ::IceBeam::{ user=208440 }!
...
Play through [another classic beatmap](https://osu.ppy.sh/beatmapsets/8299) hosted by ::Ultimate::{ user=53940 }!
...
Enjoy [yet another beatmap](https://osu.ppy.sh/beatmapsets/11153) by ::Metroid::{ user=10542 }!
...
Have fun with [the first ranked **Wiklund** map](https://osu.ppy.sh/beatmapsets/6499) hosted by ::v0xtrot::{ user=52832 }!
...
Last but not least, check out [this beatmap](https://osu.ppy.sh/beatmapsets/11100) hosted by ::GladiOol::{ user=23326 }!
