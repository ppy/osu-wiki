...
date: 2021-03-31 09:30:00 +0000
series: featured_artists
---

**Xanthochroid** brings sounds from another world to the Featured Artist library!

![](https://assets.ppy.sh/artists/152/header.jpg)

Crafting their own cinematic metal universe with back to back masterpieces, **Xanthochroid** is a first-rate progressive rock/metal band who's been aggressively charming eardrums since 2005. Following their 2012 debut album's release, the band toured the US with a climactic performance at *Blizzcon* in 2013, and has continued to expand their music's narrative through new songs to this day.
...
<div align="center">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/artists/152/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>
...
Try out [this map](https://osu.ppy.sh/beatmapsets/1018888) created by top player ::Dereban::{ user=4882979 }!
...
Check out [this map](https://osu.ppy.sh/beatmapsets/1069086) mapped by ::ItsWinter::{ user=6381153 }, who seems to really like this band.
...
Play [yet another map](https://osu.ppy.sh/beatmapsets/1151696) by yet another top player: ::SWAGGYSWAGSTER::{ user=7813296 }!
...
Delve into [this map](https://osu.ppy.sh/beatmapsets/1277834) hosted by ::AsaBen::{ user=7867617 }!
...
Looking for even more? [**Xanthochroid**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/152) has all the metal magic you could possibly ask for, already pre-timed and ready for you to stretch your mapping muscles.

That's all for now, but we'll be back at the end of the week for another stop on the Featured Artist circuit. Stay tuned to the [@osugame Twitter](https://twitter.com/osugame/) if you're itching for the details.
