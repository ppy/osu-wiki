...
Each World Cup comes with new and exciting things, and this time around will be no exception. With our previous organisers ::juankristal::{ user=443656 } and [WalterToro](https://osu.ppy.sh/users/5281416) stepping down, their large shoes are to be filled.

Starting from today, ::ChillierPear::{ user=9501251 }, [LeoFLT](https://osu.ppy.sh/users/3668779), and ::Azer::{ user=2155578 } will all be stepping up to meet the challenges and expectations as the new organisers of the osu! World Cups. The three of us are very excited for this opportunity. In recent years, most, if not all of our time on osu! has been dedicated towards developing and nurturing the tournament scene.
