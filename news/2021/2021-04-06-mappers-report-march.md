...
- **osu!:** ::Lafayla::{ user=5312547 }, ::riffy::{ user=597957 }, ::Battle::{ user=4037545 } & ::BaAR_Vendel::{ user=8679346 }
- **osu!taiko:** ::frukoyurdakul::{ user=7612550 }
- **osu!catch:** ::GIGACHAD::{ user=11081858 }, ::Phob::{ user=6069462 } & ::Secre::{ user=2306637 }

### NAT Additions

A new red-name appeared out of nowhere! ::Zelq::{ user=8953955 } has decided to join the red crusade after two years as a BN and will support the NAT from now on by assisting in keeping things running in tip-top shape. Welcome to the team, Zelq!
...
| ![BN Badge (4 years)](https://assets.ppy.sh/profile-badges/BN4y.jpg "Longstanding contribution to the Beatmap Nominators - 4 years") | ::Mafumafu::{ user=3076909 }, ::Rivals_7::{ user=4610379 }, ::Stefan::{ user=626907 }, ::Xinely::{ user=1521445 } |
...
A newer yet very promising mapper, ::Maimaing::{ user=14520910 } has quickly caught on to the particulars of mapping and has been something of a rising star from the moment he started delving into the editor in late 2020.
...
A mapper whose popularity has been on the rise among high-level players, ::X a v y::{ user=3738344 } burst into the ranked section for the first time in early 2021 with [Houshou Marine - Ahoy!! Warera Houshou Kaizokudan\*](https://osu.ppy.sh/beatmapsets/1282787), a marathon version of a pirate v-tuber's debut song.
