...
Behind the scenes, ::Lugu::{ user=12851847 } from the Mappers' Guild has been hard at work creating a [showcase beatmap](/wiki/Featured_Artists/Featured_Artist_showcase_beatmaps) for today's artist announcement. See how it turned out alongside osu!lazer's new built-in Performance Points counter, then check out the other previews below:
...
Check out [this showcase set](https://osu.ppy.sh/beatmapsets/1589495) hosted by ::Lugu::{ user=12851847 } from the video above!
