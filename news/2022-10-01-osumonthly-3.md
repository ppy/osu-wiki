...
This month osu!(lazer) was graced with a brand new default skin, argon! While it is currently in it's early stages and not optimized fully for framerates or readability, it aims to set a high standard for the future of osu! skinning with endless new possibilities that osu!(lazer) provides! You can find the skin and try it out for yourself with the [2022.923.0](https://osu.ppy.sh/home/changelog/lazer/2022.923.0) update, it should be the first skin in the dropdown menu.
...
- osu!(lazer)'s internal clock system has been reworked, which means universal offset actually works now, alongside other things
...
<div align="center">
    <video width="100%" controls>
        <source src="https://assets.ppy.sh/media/osu-monthly/2022-09/lazer-ui-scaling-1.mp4" type="video/mp4" preload="none">
    </video>
</div>

Of course, we were not able to cover everything from the patch notes, so if you are interested in all previous and future patch notes, you can find them [here](https://osu.ppy.sh/home/changelog), or if you'd rather watch a video digest of them check out the playlist that's embed above!

## Community recap

![](https://assets.ppy.sh/contests/153/header.jpg?1)

The voting for osu!'s[15th anniversary the art competition](https://osu.ppy.sh/community/contests/153) has concluded! Congratulations to [Dreamxiety](https://osu.ppy.sh/users/13103233) on first place with a whopping 7912 votes, [illuminae2005](https://osu.ppy.sh/users/29866964) was right under them with 7248 votes and third place was taken by [urgutz](https://osu.ppy.sh/users/11731553) with 6671 votes. Even though only the top 3 entries get a profile badge made from their artwork, you will be able to see a wide range of top voted entries be officially added into osu! as part of the main menu seasonal backgrounds!

If you are interested in checking out all of the entries, [you can do so here](https://osu.ppy.sh/community/contests/153)! As for downloading entries, if you are interested in downloading any of the finalist entries, check out [the archive](https://assets.ppy.sh/contests/153/winners/osu15anniversaryfinalists.zip), for downloads of any non-finalist entries you will need to reach out to the artist.

![](/wiki/shared/news/2022-10-01-osumonthly-3/medalsbanner.jpg)

After two years the community has finally received a new batch of Hush-Hush medals along with 3 new beatmap pack medals!
The medals were officially announced via [0x84f](https://osu.ppy.sh/users/7944724)'s [How Zetera became a Medal Hunter](https://osu.ppy.sh/home/news/2022-09-09-how-zetera-became-a-medal-hunter) news post, however prior to release the Medal Hunter community has already [found all of the beatmap packs](https://twitter.com/osekaiapp/status/1564871086617071616) medals prior to the official announcement, and Ephemeral [teased 2 out of 3 new Hush-Hush medals](https://twitter.com/osekaiapp/status/1564610856381464580) in the [Medal Hunters Discord](https://discord.com/invite/8qpNTs6)!

The community managed to figure out all of the medals within 5 days of their release, with the Lightless medal giving the biggest headache and taking 4 days of non-stop searching to solve! Word on the street is that there will be more Hush-Hush medals coming soon, so if you want to join the hunt or even just participate, join the Medal Hunters Discord linked above!
...
![](/wiki/shared/news/2022-10-01-osumonthly-3/corsacetop3.jpg)
...
We decided to make a small change to how the quiz works as we prepare to start writing harder questions. Starting from this month, there will be a time limit of 1 month (since the release of the news post) to answer the question, if the question is not answered by the time next month's osu!monthly is released, the reward will not be claimable anymore.
...
- After several weeks of hard work by creators and the voting phase coming and going, we should soon be able to see the results of the [triangles Beatmapping Contest](/wiki/Contests/triangles_Beatmapping_Contest/en.md). Who was able to combine the best storyboard, hitsound, and mapping around the triangles theme? We can't wait to see!
