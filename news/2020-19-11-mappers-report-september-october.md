...
As with every issue of the Mappers' Report we want to show you more unknown mappers which deserve some spotlight for their maps! And this double issue is no exception. This time we have osu!taiko and osu!catch for you! So let's dive right into it
...
[-MomoX](https://osu.ppy.sh/users/2150415) is a promising osu!catch mapper in the Philippines. Starting off his mapping career since 2018, -MomoX has a solid understanding of mapping concepts, techniques and musical knowledge. As a high-tier fruit catcher, -MomoX has been incorporating innovative patterns and difficulty settings into his renditions to test on players' reading, speed and stamina.

In terms of mapping style, -MomoX is a slider enthusiast who loves to emphasize strong beats by hyperdash sliders. He is capable of maneuvering such gimmicks consistently without breaking the flow. Prime example would be [rejection - Signal feat. Such](https://osu.ppy.sh/beatmapsets/1129636#fruits/2359821), his recently ranked marathon. Hereby I also introduce his slider hell map [Halozy - Kikoku Doukoku Jigokuraku](https://osu.ppy.sh/beatmapsets/990511#fruits/2071833), which features a flurry of droplets by using high slider tick rate to design odd-shaped sliders.
