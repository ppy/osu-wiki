...
![](https://osu.ppy.sh/help/wiki/shared/banners/catch_logo.png)
...
![](http://puu.sh/wlMXd/5d7138f174.png)
...
Once again the players were put to the test, sterner still in order to weed out the weak from the strong. There were mixed feelings regarding the NoMod pool, with [dj MAX STEROID - Arabian Rave Night](https://osu.ppy.sh/b/1254591&m=2) being picked up six times, more than any other map in the QF pool, whereas [AKI AKANE - Kando*Reduction](https://osu.ppy.sh/b/598867&m=2) was banned twice but never picked. Hidden and DoubleTime were equally favoured, whereas HardRock saw the least of the action, perhaps owing to the length and technical nature of the maps chosen making it a sizeable risk to maintain consistency.
...
![](http://puu.sh/wqwwm/217558f403.png)
...
![](http://puu.sh/wqxfn/a3c4317cb3.png)
...
![](https://puu.sh/wqyPO/fc5fca5a89.png)
