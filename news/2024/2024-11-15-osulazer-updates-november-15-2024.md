...
Below you will find ::peppy::{ user=2 } and [pishifat](https://osu.ppy.sh/users/3178418) discussing the rollout as well as all the new neat changes in the game. Below that, you'll find the most notable changes in text form.
...
- **The osu!mania ruleset selection sample has been reworked.** Our audio engineer ::nekodex::{ user=102 } has been at it again. Take a listen:
