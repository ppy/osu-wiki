...
- **Various performance improvements, especially for intense storyboards.** These have been spearheaded by ::EVAST::{ user=8195163 }, and there are more improvements in the pipeline already!
...
The argon skin now has received brand-new hitsounds masterfully crafted by the one and only ::nekodex::{ user=102 }! Sit back, put some headphones on, and enjoy the showcase video below.
