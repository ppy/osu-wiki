...
Mappers should be very happy, as this month's changes are mostly focused around the editor! Sit back, grab some tea, and indulge yourself by watching one ::pishi::{ user-id=3178418 } go over each notable change in detail, or keep reading for the summary:
...
<div align="center" class="osu-md__paragraph">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/media/news/2024-06-25-grid-rotation.mp4" type="video/mp4" preload="none">
    </video>
</div>
...
- **Daily challenges are almost ready to be released.** The devs are working hard to set everything up, and we should be seeing them in the next release.
- **Basic support for pass and fail storyboard layers have been added.** This means that the storyboard will change based on the amount of health you have during gameplay (above 50% for passing, below for failing).

<div align="center" class="osu-md__paragraph">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/media/news/2024-06-25-storyboard-pass-fail.mp4" type="video/mp4" preload="none">
    </video>
</div>

---

Now is the perfect time to get ready for the upcoming daily challenges by [downloading osu!(lazer)](https://osu.ppy.sh/home/download) and grinding out some top scores! Other than that, you can always check out the [changelog](https://osu.ppy.sh/home/changelog/lazer/2024.625.0) for the full change details.
