...
Inspired by the design of [Navia](https://genshin-impact.fandom.com/wiki/Navia) from *Genshin Impact*, [Chromasia](https://osu.ppy.sh/users/7306251) has once again put themselves near the top of the list. Even though this is their 2nd time entering a skinning contest, they have quickly solidified themselves in the upper echelon of the skinning community. Their newest entry does not miss the mark either, basking users with some tastefully placed golden yellow accents across the entire skin, along with Navia as the centre piece on the song selection screen.
