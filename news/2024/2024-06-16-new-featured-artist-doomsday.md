...
<div align="center">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/artists/425/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>

### Doomsday - TGGT

Play through [the map from *The Perennial*](https://osu.ppy.sh/beatmapsets/2198890) hosted by ::zekk::{ user=9704802 }!
...
Or try [the map from *Battle of the Box*](https://osu.ppy.sh/beatmapsets/2134395) hosted by ::Tycani::{ user=6693266 }!
...
Or if tournaments aren't your thing, [this osu!catch map](https://osu.ppy.sh/beatmapsets/2138030) by ::Jemzuu::{ user=7890134 } is up next.
...
The only thing better than listening to **Doomsday**'s music is *mapping* **Doomsday**'s music. Visit [**Doomsday**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/425) to get a head start with some pre-timed beatmap templates.

While today is **Doomsday**'s day, we'll be introducing another artist after 7 more!
