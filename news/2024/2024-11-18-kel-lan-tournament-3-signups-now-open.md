...
The stage is set for an exciting showdown where every match counts. In this fun and fierce 1v1 double-elimination tournament, players will face off in a battle of skill, with every click adding to the excitement and bringing them one step closer to victory!

Below is the bracket schedule:

| Day | Brackets |
| --: | :-- |
| **Day 1** | Round of 32, Round of 16, Quarterfinals |
| **Day 2** | Semifinals, Finals, Grand Finals |
...
[One of those guests have been revealed already.](https://youtube.com/watch?v=quAevI_lYf0) Welcome aboard, ::Rafis::{ user-id=2558286 }. Here's the next set of guests:
