...
Curious who's involved in this massive collection of tunes? Look no further:

- [**Cansol**](https://osu.ppy.sh/beatmaps/artists/407)
...
Here's a taste of what **Rubatonin** has to offer:

<div align="center">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/artists/418/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>

### Hexacube - SUPER-ENTHUSIASTIC!!

Play [this recently Qualified map](https://osu.ppy.sh/beatmapsets/2049613) hosted by ::Strategas::{ user=2971837 }!
...
Begin your 4K journey with [this map](https://osu.ppy.sh/beatmapsets/2174509) hosted by ::fvrex::{ user=11863699 }!
...
Take the next step in that 4K journey with [this map](https://osu.ppy.sh/beatmapsets/2115263) by ::Ucitysm::{ user=14768693 }!
...
And finish off that 4K journey with [this map](https://osu.ppy.sh/beatmapsets/2098237) by ::fvrex::{ user=11863699 }!
...
Experiment with [the map that'll probably be a tournament tiebreaker one day](https://osu.ppy.sh/beatmapsets/2089942) hosted by ::ikin5050::{ user=4007649 }!
...
Given the amount of talent involved in these songs, there's more variety than we can feasibly showcase in one video and a few previews. Check out [**Rubatonin**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/418) for *everything*. You can thank us (and **Rubatonin**) later.
