...
Lagging behind and desperately in need of momentum, Poland picked NM3. After an uncertain ending with ::{ flag=AU }:: ::Trainjumper::{ user=2272587 }'s client freezing on the livestream, the results were revealed in the [match logs](https://osu.ppy.sh/community/matches/113190844). Australia won again and now had the advantage at 2-3. They shot for NM2 and won yet another point, somehow flipping the script and making Australia the one with match point against the would-be winners of the tournament.
...
The first half of the match already revealed the stars of the show, with ::{ flag=CA }:: ::ploot::{ user=7802400 } carrying the Canadian team throughout their picks, and especially so during HD2, [t+pazolite - Heartache Debug feat. Akagawa Nene](https://osu.ppy.sh/beatmapsets/1833716#osu/3764512), snatching the lobby's only S-rank score at 99.45% accuracy. This was not without a fight from ::{ flag=US }:: ::gilgamesh815::{ user=14040810 } and ::{ flag=US }:: ::zfr::{ user=11536421 }, who also performed exceptionally well throughout.

Canada's slightly higher seed (#2 vs. #4) was first questioned when they almost lost on their own pick of ::Hollow Wings::{ user=416662 }'s famous map of [Halozy - Sentimental Skyscraper](https://osu.ppy.sh/beatmapsets/100348#osu/412288), falling behind yet taking it back on the second half. Carrying this momentum forward, Canada took the first breakpoint on America's HR3 pick, but traded it right back with America's double EZ roster on FM2.

Another win from the US' own pick later and the two podium finalists were taken to the tiebreaker of [Sydosys - Epsilon](https://osu.ppy.sh/beatmapsets/2166904#osu/4571684). After a mostly smooth first section of the song, everyone breaks combo on the transition except for two Canadians, and with ::{ flag=CA }:: ::FetherFall::{ user=15296550 }'s subsequent break it was ::{ flag=CA }:: ::Birchman::{ user=10676573 }'s time to shine while building a devastating lead. The scoreline swung in Canada's favour, and with Birchman's 430k-score performance topping the lobby, Canada's advancement to Grand Finals against Poland was sealed at this moment.
...
Team Canada, which includes ::Birchman::{ user=10676573 }, went on to place 2nd this year in the 5 Digit World Cup 2024, narrowly behind Poland.
...
> 
> But on a more positive note, a day after the tournament concluded, ::LumenLogic::{ user=8171404 } made an announcement in the Canadian 5wc server highlighting our performance, as well as Canada B and C team's respective placements in the 5wc's Minor League (a separately hosted tournament). In the same announcement he also gave a shoutout to all the people who were involved with tryouts and roster making this year, which was a nice way to wrap up 5wc for Canada.
...
> The process was mainly based on my section-by-section workflow. I start by getting a main inspiration for the theme (since there was no specific instruction in that regard) then when that's laid out, I start thinking about the bigger picture. In this case since I was doing a tiebreaker, I decided on what the focus would be (a tech tb this time around) and what genres I'd put in. Then it's just a cycle of figuring out what the next section is, finding a reference for said section and making it.
> 
> From a more abstract perspective, I wanted to have some kind of sci-fi vibe going because that's what I'm comfortable with, but I took the opportunity to make the track as a homage to [Akira Complex](https://osu.ppy.sh/beatmaps/artists/51) by referencing [Reality Distortion](https://soundcloud.com/akira-complex/vs-akira-complex-reality-distortion-original-mix) heavily in the composition and track name.
> 
> I also referenced some other smaller parts from tracks with Akira Complex, but they aren't as notable as the main inspiration.
...
::ajmosca::{ user=19884809 } mapped 5 beatmaps specifically for the 5 Digit World Cup 2024, or 5 "custom maps" as they're commonly known.
...
> Compared to my other original song maps, the highlight for this occasion was how closely I was able to work with the song artist themselves. Working closely with ::Naikou::{ user=29139453 } during the various stages of creating this map was wonderful.
> 
...
::Lupa::{ user=4722369 } stepped up to the role of administration for 5WC 2024, as well as selecting the beatmaps that players can use in their matches (a process known as *mappooling*).
...
> 
> To me it was a very intimidating process at first, but as time has gone on it's become more enjoyable than playing the game itself at times!

Have there been challenges in running 5WC that were specific to it, or have there been things to worry about that were common to many tournaments you've staffed in?

> There's always lots of challenges that arise when running a tournament, from scheduling conflicts between international teams to making sure deadlines are met in preparation for the actual matches. In terms of 5WC specifically though, one of the biggest things that you don't have to deal with in other tournaments is the sheer number of entrants.
> 
> Outside of 100k+, this is the largest rank range with a world cup, and the amount of dedicated *tournament* players is enormous, in my opinion larger than any of the other rank ranges. This year we had 2847 registrations alone, all of which were convened in one discord server and all of which then had to be directed to their country organizer to handle the tryout procedure.
...
> 
> Alongside BlankTap's frankly perfect commentary and a map that came down to a 28k score difference on 2.5 million team scores it made for an insanely emotional moment that really reminds me how much I love this game and the community that comes with it <3
