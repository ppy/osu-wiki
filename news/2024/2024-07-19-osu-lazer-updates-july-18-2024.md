...
- **Beatmap contents can now be edited externally.** Due to the way osu!(lazer) handles beatmaps, you were not able to just open the songs folder and edit whatever you wanted, however after today, that is possible. The sounds of cheering from mapping enthusiasts can be heard around the world.
...
- **New "No Release" mod has been added to osu!mania.** This is effectively relax for osu!mania, completely removing the accuracy judgment from slider ends in gameplay.
