...
**633397** is best known for their ominously titled breakcore tunes that incorporate elements from across the genre spectrum. Given ::his background in osu!mania::{ user=11392390 }, it should come as no surprise that **633397** pulls inspiration from well-known figures in the osu! space like [goreshit](https://osu.ppy.sh/beatmaps/artists/57), [Camellia](https://osu.ppy.sh/beatmaps/artists/31), [Kobaryo](https://osu.ppy.sh/beatmaps/artists/96), and ::Kurokotei::{ user=398275 }!
...
Experience a bit of **633397** for yourself:
...
Play [the map from the video above](https://osu.ppy.sh/beatmapsets/2131700) hosted by ::Hinsvar::{ user=1249323 }!
...
If you're into osu!taiko, you can instead try out [this map](https://osu.ppy.sh/beatmapsets/2138377) hosted by ::ikin5050::{ user=4007649 }!
...
Alternatively, you can sprint through [this map](https://osu.ppy.sh/beatmapsets/2138818) hosted by ::Alchyr::{ user=4993032 }!
...
In the words of **633397**...

> osu! and the artists I discovered by playing it is what made me get into music production in the first place, and it makes me so happy that I'm able to give back to the community after all this time. I hope I also inspire people in the same way.

Start mapping with a pre-timed beatmap template from [**633397**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/419) (and stay tuned for another artist next week!).
