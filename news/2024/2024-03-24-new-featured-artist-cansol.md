...
**5** songs are up for grabs on [**Cansol**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/407), including a brand new [osu! original](/wiki/osu!_originals) that debuted on [today's TWC livestream](https://www.twitch.tv/osulive):
...
Baby's first mapping tutorial:

- Click this link: [**Cansol**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/407)
- Download one of the pre-timed beatmap templates
- Open the file with osu! (or drag it into the game — either works)
- Click the "circle" button on the left side
- Place a circle by clicking somewhere on the playfield

Congratulations! You've created 1/1000th of a map!
