...
The result? A grand rerun of most songs in the mappool using cumulative points (i.e. all scores on all maps summed together) to decide the victor, which turned out to be ::maliszewski::{ user=12408961 }.
...
::alden::{ user=3545323 }, one of the writers, had the following to say about this whole project:

> The secretary was originally an inside joke between ::koitsumii::{ user=6271053 } who is her designer, and I. Although we were happy it got the attention that it did, koitsumii didn't want the secretary to be a mascot moving forward.
> 
