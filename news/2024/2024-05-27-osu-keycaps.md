...
Nearly two decades later, you'd be hard-pressed to find an osu! player who doesn't use a mechanical keyboard, so it's about time we stepped up.
...
It's impossible to please both sides of *light mode* vs. *dark mode* debates. Actually, nevermind — we included `Esc` keys for both, designed by ::Tanza3D::{ user=10379965 }.
...
And in case you haven't figured it out yet, [you can get the keycaps here!](https://www.thekapco.com/products/osu-pippi-keycap-set)
