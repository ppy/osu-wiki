...
The three originals in the regular part of the pool were also very much worthy of attention. In the No Mod pool, there were two: [Naples Yellow Mango](https://osu.ppy.sh/beatmapsets/2288022#osu/4881869) by [Attoclef](https://osu.ppy.sh/beatmaps/artists/451) was a funky, ever-changing song made into an extremely tough gimmick map by the combined efforts of Chinese legends ::fanzhen0019::{ user=418699 } and [Hollow Wings](https://osu.ppy.sh/users/416662). [Corrupted Paywall](https://osu.ppy.sh/beatmapsets/2287942#osu/4881677), the frenetic speedcore track by [XH](https://osu.ppy.sh/beatmaps/artists/452), was adapted by ::Cellina::{ user=2490770 } to be a relentless speed challenge with a good amount of tech added on top. Finally, [XIchedelic Nova Trinity](https://osu.ppy.sh/beatmapsets/2287963#osu/4881714) was [DJ Genki](https://osu.ppy.sh/beatmaps/artists/295)'s contribution this year, with an electronic offering equal parts groovy and vibrant, mapped by ::Pho::{ user=3624692 } as a true test of aim and finger control in the Hidden pool.

Some highlights of the other maps include the unexpected appearance of a custom by ::elchxyrlia::{ user=1722835 }, more well known as lahphnya or Arles, with their take on [Sky of Twilight](https://osu.ppy.sh/beatmapsets/2287859#osu/4881501) — the famous Graveyard high-SR mapper making the map in a similarly mechanically intensive way; a map of [Rubik's Cube](https://osu.ppy.sh/beatmapsets/2288047#osu/4881933) by the previously mentioned Heilia, a popular song with an adaptation here that the writer of this section can only define as "quite squarey"; and the final map to be mentioned coincides with the final map played in the whole tournament — [unravel](https://osu.ppy.sh/beatmapsets/2287914#osu/4881614), the famous song made into an insanely hard alt map by ::aishiteiru-::{ user=10566388 }.

Thanks for everyone who made the pools possible this year, and we hope to see you next year!

## Grand Finals recap

Much like in past years, ::Junihuhn::{ user=4182339 } has created a video recap of every stage. You'll find the latest one below in the match recaps, or you can also [binge the playlist of video recaps](https://www.youtube.com/playlist?list=PLqJuZKl72XH_bQChx2C0ppRZ4tdf0tYe-) on Junihuhn's channel, if that's more your style.

You could also read all about what happened during the final two matches, and you can thank ::D I O::{ user=3958619 } and [this1neguy](https://osu.ppy.sh/users/1797189)'s penmanship for that.
...
The match would finish off with another set of traded points. The Aussies took their [HR1](https://osu.ppy.sh/beatmapsets/1392496#osu/2874944) last pick by virtue of their supporting scores being better, while ::{ flag=US }:: ::hydrogen bomb::{ user=7813296 } matched ::{ flag=AU }:: ::mrekk::{ user=7562902 } and top-scored the lobby, and the Americans took their [FM1](https://osu.ppy.sh/beatmapsets/2287983#osu/4881757) last pick in much the same way, with ::{ flag=AU }:: ::mrekk::{ user=7562902 } top-scoring the lobby with 908,435 points. When the match got to 6–6, only one map remained; it was time for the tiebreaker!

This last map, however, was not where we would see the peak of OWC dominance finally fall. [Operation: Zenithfall](https://osu.ppy.sh/beatmapsets/2287992#osu/4881796) would go to the Americans, with ::{ flag=AU }:: ::mrekk::{ user=7562902 } top-scoring the lobby once again but ::{ flag=US }:: ::Utami::{ user=7512553 }, ::{ flag=US }:: ::hydrogen bomb::{ user=7813296 }, and ::{ flag=US }:: ::WindowLife::{ user=4108547 } all outscoring the second-best score on team Australia. Despite how close this match ended up, with many points traded for both teams and less than a 200,000 score difference, the end result still favoured the reigning champs. For the tenth time in a row, the United States would move on to the Grand Finals to face off against South Korea.
...
The United States' next pick was the CS 7.8 [HR2](https://osu.ppy.sh/beatmapsets/2287973#osu/4881729) pick; led by a 540,581 score from ::{ flag=KR }:: ::byeok2044::{ user=8472976 }, South Korea took its first break point of the match. Next, they decided to stay in the HR pool by picking [HR3](https://osu.ppy.sh/beatmapsets/1116399#osu/2332178), where it was ::{ flag=KR }:: ::fragranceofpage::{ user=11399348 }'s turn to lead the way for the Koreans with a 671,622 score en route to a victory. Despite an uncertain moment for South Korea following ::{ flag=KR }:: ::byeok2044::{ user=8472976 } disconnecting on DT4, ::{ flag=KR }:: ::FlyingTuna::{ user=9224078 }'s 731k score led them to another break point, and suddenly the match was tied. South Korea had stolen two break points from the United States, they had grabbed the momentum, and they would not look back.

[NM4](https://osu.ppy.sh/beatmapsets/2287939#osu/4881668) was the next pick for South Korea, where a massive 1841 combo from ::{ flag=KR }:: ::byeok2044::{ user=8472976 } helped secure them another map and a 5–4 lead in the match. The comeback was in full force, and the tables had unequivocally turned.

The United States opted into [HR1](https://osu.ppy.sh/beatmapsets/1392496#osu/2874944), but it was another fruitless endeavour, as ::{ flag=KR }:: ::byeok2044::{ user=8472976 } continued to display his incredible level of play by top-scoring it with a 795,672 play, taking a third straight break point and setting up a championship point for South Korea.

Never willing to let the cinematic potential of such a moment go to waste, their selected map was [NM3](https://osu.ppy.sh/beatmapsets/2287914#osu/4881614), a brutally challenging aim control alt map. South Korea raced to an early advantage and the United States could do nothing but watch their hopes and their dynasty unravel as the map played out. By the time all was said and done, ::{ flag=KR }:: ::worst hr player::{ user=14106450 } would be atop the map with a 433,888 score, leading his team to victory on the map and with it the tournament.
...
::FlyingTuna::{ user=9224078 } was the captain of the winning team of osu! World Cup 2024, South Korea.
...
You have ::Nopekjk::{ user=4585186 } listed as an analyst on your team collab, and ::Allegrissimo::{ user=9052194 } shouted him out with smoke writing during the TB showcase. What was his role this year as an analyst and past player for OWC South Korea?
...
Honest answer is, I love every work I've put out so far. Though [LIGHT LEFT BEHIND](https://osu.ppy.sh/beatmapsets/2062241) will always have a special spot in my heart, during July 2023 I have the luckiest moment of my life, to be commissioned by ::mangomizer::{ user=1893718 } to make a custom background for this osu! original by [BilliumMoto](https://osu.ppy.sh/beatmaps/artists/38), as my first art debut to quite a big scale of audience. I have been a fan of his songs for so long, so to be given an opportunity to do this while I was pretty much an unknown in the GFX sphere was beyond unthinkable.
...
Other than that, the CWC 2024 Grand Finals tiebreaker: [Frost Walker](https://osu.ppy.sh/beatmapsets/2202823) by [Kou!](https://osu.ppy.sh/beatmaps/artists/383) is such an enormous production from start to finish. I am very grateful to even be able to be part of it and contribute to this project (Big shout out to ::Sakura006::{ user=10365024 } and the illustrators involved (::Dreamxiety::{ user=13103233 }, [Saturn](https://osu.ppy.sh/users/22001295), ::Nepperoni::{ user=7082924 }) for the carry).
