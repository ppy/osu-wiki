...
If you are somehow not familiar with COE or its 1v1 tournament, [COE](/wiki/Community/cavoe's_osu!_event) is osu!'s largest community-hosted event, organised by ::Meyer::{ user=5452367 } and ::cavoeboy::{ user=7361815 } from July 30th up until August 4th. Along with the event itself, for the 3rd year in a row the largest LAN tournament of the year will be held there as well, with hundreds of live viewers at the event and even more online on [Twitch](https://www.twitch.tv/COEvent)!
...
Just want to chill out? There will be plenty of community panels, whether it's ::mangomizer::{ user=1893718 }'s pub quiz, ::Nytro::{ user=11327918 }'s mapping panel, the storyboarding panel, or challenges such as ::Bubbleman::{ user=5182050 }'s pp farming race, along with Yuki Aim, Wooting and ::wooz::{ user=6888206 }'s arcade booths that you can leisurely peruse.
