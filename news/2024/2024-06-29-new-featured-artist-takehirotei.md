...
Tons of osu! players have shared this thought, but ::**takehirotei**::{ user=11793794 } is one of the few who actually made it happen.
...
Try [the map from the video above](https://osu.ppy.sh/beatmapsets/2168355) hosted by ::Garden::{ user=2849992 }!
...
- [The map this song was created for](https://osu.ppy.sh/beatmapsets/1889529) hosted by ::Jerry::{ user=605973 }
- ::Nifty::{ user=4956097 }'s [easier rendition](https://osu.ppy.sh/beatmapsets/2134516) — in his words: "one for slightly less god players"
- [Soon-to-be-ranked 10-star osu! map](https://osu.ppy.sh/beatmapsets/2048690) hosted by ::sladkoru::{ user=10748381 }
...
Play through [this osu!taiko map](https://osu.ppy.sh/beatmapsets/2158145) hosted by ::BlackBN::{ user=6291741 }!
...
Try out [any difficulty from this full spread](https://osu.ppy.sh/beatmapsets/2134747) hosted by ::HEAVENLY MOON::{ user=13681283 }!
...
We obviously can't forget [this mapping contest classic](https://osu.ppy.sh/beatmapsets/1390004) hosted by ::Shocola::{ user=6781232 }!
...
Finish things off with [this tournament map](https://osu.ppy.sh/beatmapsets/2030024) hosted by ::overdahedge2015::{ user=9864847 }!
