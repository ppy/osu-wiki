...
Oh yeah definitely. Speed is in a very unbalanced state right now, and I'm hopeful for the upcoming reworks that seem to aim to help with that issue, such as [Xexxar's rework](https://pp.huismetbenen.nl/rankings/players/length-bonus-removal). I really hope to see a meta that's more focused on high BPM aim than anything as that skill set is very fun to me!
