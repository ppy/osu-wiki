...
Unfortunately, the answer was despair. After an early break, he was regaining combo when the lobby came to a crashing halt. It was a disconnect from the world #1 player, his internet having dropped at the worst possible time. The map continued on for the seven other players — unaware of what had occurred, the ::{ flag=US }:: United States eventually won by a margin of 844,321. ::{ flag=AU }:: [mrekk](https://osu.ppy.sh/users/7562902) would not have been able to make up the difference in score, so by rule the ::{ flag=US }:: United States won the pick and with it the match.
