...
As with every year, we rely heavily on community members for help with many aspects of tournament production. This time, we're mainly looking for mappers and playtesters for the modes listed in the next section.
...
Playtesters will be responsible for playing and giving feedback for a plethora of beatmaps (as requested by the mappooling team) to gauge aspects such as difficulty, suitability for a certain slot, skill representativity among others (specific workflows vary for each team). Playtesters are generally expected to have considerable skill on their respective game mode.

Please note that if you are accepted into either team, you will not be eligible to participate as a player in that tournament.

## osu!taiko World Cup 2024

The osu!taiko World Cup mappooling team headed by [Nurend](https://osu.ppy.sh/users/9905079) and [Raphalge](https://osu.ppy.sh/users/3918650) is looking for **mappers** and **playtesters**. To sign up, follow [this link](https://forms.gle/Z3nR1W8tcY4rCakf8). Player registrations for TWC 2024 are slated to open Feb 15. 

## osu!catch World Cup 2024

The osu!catch World Cup mappooling team headed by [wwwww](https://osu.ppy.sh/users/8434466) and [Yoshi_green](https://osu.ppy.sh/users/1035891) is looking for **mappers**, **map modders**, and **playtesters**. To sign up, follow [this link](https://forms.gle/p3BVaqXx77S2DoET6). Player registrations for CWC 2024 are slated to open Apr 18.
