...
**Sparxe**'s music has been at the forefront of the competitive side of osu!taiko for years. From [the former highest osu!taiko pp score](https://osu.ppy.sh/scores/taiko/173764399) to 17 [osu! originals](/wiki/osu!_originals) (most of which were for various tournaments), practically everyone invested in osu!taiko knows **Sparxe**.
...
- [osu!taiko map](https://osu.ppy.sh/beatmapsets/1754903) hosted by ::Gamelan4::{ user=9856910 }
- [osu! map](https://osu.ppy.sh/beatmapsets/1904860) hosted by ::Nozuchi::{ user=5858447 }
...
Or try [the map that led to a broken pp record](https://osu.ppy.sh/beatmapsets/1785711) hosted by ::HomieLove::{ user=8693851 }!
...
Experience [this map](https://osu.ppy.sh/beatmapsets/1837865) from [EGTS 2022](/wiki/Tournaments/GTS/EGTS_2022) hosted by ::Cynplytholowazy::{ user=3901754 }!
...
Packed with pre-timed beatmap templates for every song above (and more), [**Sparxe**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/398) is only one click away! If you want to get more clicks out of it, you can head to the navigation bar above, hover "beatmaps", click "featured artists", then find **Sparxe** in the list. Have fun with that.
