...
Self-proclaimed "buffoons", Russian band **Zmey Gorynich** made a name for itself by playing an unusual combo of cheerful extreme metal since 2012. They were brought to the forefront of osu! by metal mastermind ::Mazzerin::{ user=2942381 } with [Sorochinskaya Yarmarka](https://osu.ppy.sh/beatmapsets/1191853), a stream map featuring unreal slider-centric design perfectly fitting the insanity of the tune.
...
Words aren't very good at describing music. osu! gameplay does a better job:
...
- [The map from the video above](https://osu.ppy.sh/beatmapsets/1191853) hosted by ::Mazzerin::{ user=2942381 }
- [osu!taiko spread](https://osu.ppy.sh/beatmapsets/1399899) hosted by ::liku::{ user=11357694 }
- [4K osu!mania map](https://osu.ppy.sh/beatmapsets/1899136) hosted by ::keksikosu::{ user=23097320 }
...
Here's [a classic osu!taiko spread](https://osu.ppy.sh/beatmapsets/1647772) hosted by ::liku::{ user=11357694 }!
...
Test yourself with [this osu!taiko marathon](https://osu.ppy.sh/beatmapsets/1849644) hosted by ::a familiar face::{ user=11357694 }!
...
If you're looking for more tracks (which you obviously are), [**Zmey Gorynich**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/450) has pre-timed map templates for everything osu! has to offer. Do what needs to be done.

Look forward to a technical music reveal next weekend. As with most of our hints, we mean that in the most misleading way possible.
