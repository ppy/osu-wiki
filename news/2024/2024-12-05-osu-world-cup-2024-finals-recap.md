...
On the existing maps side, we had picks such as [roots](https://osu.ppy.sh/beatmapsets/2139515#osu/4502914) by [seros](https://osu.ppy.sh/users/10562853) acting as an aim pick with a sprinkle of alt, and [Aynane](https://osu.ppy.sh/beatmapsets/1842684#osu/3784901) (by one of our newest Featured Artists, [Zmey Gorynich](https://osu.ppy.sh/beatmaps/artists/450)) mapped by [Mazzerin](https://osu.ppy.sh/users/2942381), being the pool's main stream map, both in Hard Rock. In DT, we had 3 existing maps, including [Blue Night](https://osu.ppy.sh/beatmapsets/31333#osu/116006), a classic 2011 map by [DoKiTo](https://osu.ppy.sh/users/537084) which when infused with Double Time becomes a challenge to keep up with! [Lagtrain](https://osu.ppy.sh/beatmapsets/1313664#osu/2722655) is there too, although despite the song's popularity it wasn't picked at all this week.
...
In the lower bracket, four teams, each with their own story to tell, sought the rarefied air of a spot on the podium: Australia, looking to retain their place among the top 3; Germany, one of the most consistent top finishers in World Cup history; Russia, finally having broken their so-called “semifinals curse”, and the United Kingdom, vying to re-establish themselves among the upper echelon of the osu!standard scene.

- ::{ flag=AU }:: Australia and ::{ flag=RU }:: Russia kicked off last weekend, with both teams coming out and firing with their first picks. ::{ flag=AU }:: Australia mustered up the first break point of the match on ::{ flag=RU }:: Russia's second pick of [Blue Night](https://osu.ppy.sh/beatmapsets/31333#osu/116006), after which they never looked back, dropping only one more point the rest of the way and ending the match at 7–2. ::{ flag=AU }:: Australia moved on to the 4th place match, while ::{ flag=RU }:: Russia was sent home, but they could hold their heads high, living up to lofty expectations with a strong top 6 finish.
- The 2nd match of the week pitted old foes ::{ flag=DE }:: Germany and the ::{ flag=GB }:: United Kingdom against each other once more. With ::{ flag=DE }:: [criller](https://osu.ppy.sh/users/8116659), ::{ flag=DE }:: [WhiteCat](https://osu.ppy.sh/users/4504101), and the rest of the team performing like a well-oiled machine, ::{ flag=DE }:: Germany raced to a 6–0 lead in this match. However, a 3-way S rank on [Dear The Night I Loved](https://osu.ppy.sh/beatmapsets/2284389#osu/4872029) won the ::{ flag=GB }:: United Kingdom that map by a mere 54,882 points, and they followed it up with another miniscule victory by 88,393 on [Horobi o Inorishi Mono](https://osu.ppy.sh/beatmapsets/2284565#osu/4872576), then took the anti-mod [SILVERY](https://osu.ppy.sh/beatmapsets/1581365#osu/3229080) pick by over 200k. Some thought a historic reverse sweep was in the making, but ::{ flag=DE }:: Germany shattered those dreams, opting into [Eiyuu no Tsurugi](https://osu.ppy.sh/beatmapsets/1864097#osu/3833517) and ending the match with a tight margin of 88,814 points, despite ::{ flag=GB }:: [Bubbleman](https://osu.ppy.sh/users/5182050)'s best efforts with a lobby-best 716k score. It was on to ::{ flag=AU }:: Australia and a shot at the podium for ::{ flag=DE }:: Germany, while the ::{ flag=GB }:: United Kingdom were eliminated with a top 6 placement for the first time since 2021.
- The final match of the weekend, with a podium position on the line, was a clash between ::{ flag=AU }:: Australia and ::{ flag=DE }:: Germany. Each team had looked dominant in their wins the day before, but could ::{ flag=DE }:: Germany slow down the MVP-calibre performance of ::{ flag=AU }:: [mrekk](https://osu.ppy.sh/users/7562902), who by this point led their team to a 4–0 lead? ::{ flag=DE }:: Germany finally took their first point on [Hold Your Colour](https://osu.ppy.sh/beatmapsets/702272#osu/1485947), and after they lost two more maps to bring the score to 6–1. ::{ flag=DE }:: [Tim Kackner](https://osu.ppy.sh/users/14385814) put another point on ::{ flag=DE }:: Germany's side with hard rock FC on [Eiyuu no Tsurugi](https://osu.ppy.sh/beatmapsets/1864097#osu/3833517), followed by a ::{ flag=DE }:: [criller](https://osu.ppy.sh/users/8116659) and ::{ flag=DE }:: [WhiteCat](https://osu.ppy.sh/users/4504101) masterclass on [Mondaymania](https://osu.ppy.sh/beatmapsets/2284699#osu/4872865) to put up their third point of the match. ::{ flag=AU }:: Australia, though, would not be denied. It was a double FC from ::{ flag=AU }:: [mrekk](https://osu.ppy.sh/users/7562902) and ::{ flag=AU }:: [Zyntex](https://osu.ppy.sh/users/11806306) on [roots](https://osu.ppy.sh/beatmapsets/2139515#osu/4502914) to seal the deal, finalizing a 7–3 win for the ::{ flag=AU }:: Aussies and sending them onward to the grand finals week and a date with familiar nemeses the ::{ flag=US }:: United States.

In the upper bracket, ::{ flag=KR }:: South Korea and the ::{ flag=US }:: United States were set to meet for the fourth time in the last three years. ::{ flag=KR }:: South Korea won in 2022's semifinals round, but the ::{ flag=US }:: United States had the momentum in the matchup, taking ultimate victory in the 2022 and 2023 grand finals. Now, set to meet in a winners bracket final for the first time, could the ::{ flag=KR }:: Koreans flip the script? Read on for an in-depth analysis of what would go on to be one of the best matches of the entire tournament.
