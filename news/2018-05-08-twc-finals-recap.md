...
It has been quite the tough year for Canada, and [janitoreihil](https://osu.ppy.sh/users/3307897) will give us some perspective on their cup experience with the help of his team:

### Finals Mappool

There was bound to be diversity in the picks, since teams required a whole 7 map wins in order to win in this stage. Despite that, [Raiden](https://osu.ppy.sh/users/2239480)'s map in FreeMod, [The Flashbulb - Passage D](https://osu.ppy.sh/beatmapsets/587426/#taiko/1243907), has not been played so far, but that might change this weekend. Considering the low amount of matches, the 8 bans were also spread out in the sense that one map from every mod bracket got banned atleast once. As the work for the mappool selectors this year has come to an end, here are their closing comments:
