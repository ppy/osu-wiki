...
**The [October ranking charts](https://osu.ppy.sh/news/153921090753) have been released.** Head on over to see some of the better maps ranked in October for every game mode. We also have ranking chart [beatmap packs](https://osu.ppy.sh/p/packlist?t=r) thanks to [Stefan.](https://osu.ppy.sh/users/626907)


**After a long wait, the first Community Mapping Contest is [open for voting](https://osu.ppy.sh/news/153944715428).** If you have the time, head on over to the [voting page](https://osu.ppy.sh/community/contests/6), download the map packsand vote for what you think is the best out there.
