...
![](https://assets.ppy.sh/artists/267/header.jpg)

osu! is one of the few rhythm games that promotes *every* genre of music, and **JOYLESS** is here to help prove it. These catchy punk tunes are far from average rhythm game content, but mappers who love artists like [*PUP*](https://osu.ppy.sh/beatmaps/artists/79) will discover that **JOYLESS** is their next addiction.
...
<div align="center">
    <video width="100%" controls>
        <source src="https://assets.ppy.sh/artists/267/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>
...
As per usual, more mapping material is available from [**JOYLESS**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/267)! Jump straight into the action with any of our pre-timed map templates.

Looking for something else? Something like... a new Featured Artist to explore next Saturday? Oddly specific request, but we can provide that. Check the [@osugame Twitter](https://twitter.com/osugame) for the first look at our upcoming Featured Artist announcements and we'll see you in a few days!
