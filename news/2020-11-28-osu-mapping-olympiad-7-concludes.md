...
We would like to thank everyone who took part in this contest, and we'd like to congratulate the top three podium finishers! Below are the rewards for each winner:

- **First place**: 4 months of osu!supporter, 6 Olympiad Points (resulting in *Mapping Olympian* badge), winning mapset pushed to Ranked section, and the **Elite Mapper** user title.
