...
You might not know **happy30** as a musician yet, but you're most definitely familiar with ::**happy30** as a legendary osu! mapper::{ user-id=27767 }.
...
Check out [the map from the video above](https://osu.ppy.sh/beatmapsets/1873680) hosted by ::Kyouren::{ user-id=2013571 }!
...
Check out [this artist x mapper collaboration](https://osu.ppy.sh/beatmapsets/1177936) featuring ::PandaHero::{ user-id=1233255 } and happy30!
