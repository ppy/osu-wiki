...
Taking top spot with pippi, Mocha and Chirou enjoying a scenic bike ride through a springtime park is none other than two-time (now three) finalist ::**Dreamxiety**::{ user=13103233 } with a whopping **3713** votes!
...
Showcasing another springtime spectacle, ::**utaaa**::{ user=9315038 }'s academic artistry portrays pippi and Mocha in a schooltime setting to the approval of **3270** voters.
...
The very aptly named ::**Llamartist**::{ user=14697690 } impressed **2938** voters with a beautiful bout of pippi and Mocha appreciating aquatic aesthetics.
...
::**DGen**::{ user=13290907 } won **2813** votes with a rendition of pippi and Chirou enjoying a vast assortment of Japanese foods, complete with "Choked Top Play Soy Sauce (with Extra Salt)", presumably freshly harvested from your favourite osu! streamer or top player of choice.

[![](https://assets.ppy.sh/contests/142/banners/PacifiedPaints.jpg)](https://assets.ppy.sh/contests/142/winners/PacifiedPaints.png)

The very unaptly named ::**PacifiedPaints**::{ user=8377453 } produced a punchy punk picture of pippi and Mocha engaging in some urban art to the approval of **2727** voters.
...
::**Sjao**::{ user=7295733 } returns once again with a windswept pippi and Mocha before a blissful springtime vista that **2646** voters could not help but adore.

[![](https://assets.ppy.sh/contests/142/banners/ZunK.jpg)](https://assets.ppy.sh/contests/142/winners/ZunK.png)

Springtime camping is on the cards in ::**ZunK**::{ user=1070783 }'s entry showcasing pippi, Mocha and the Dean "peppy" Herbert in a most huggable doll form. **2594** voters likely smashed the vote button so hard that they sprained something afterwards.
...
::**cubey**::{ user=87861 } went fishing for votes with pippi and Tama, and pulled up **2327** of them.
...
Hark! The fantastical imaginings of ::**Swarmsii**::{ user=11716111 } depicting an adventuring ensemble of Mocha, Yuzu and Chirou impressed **2213** denizens of the realm.
...
Dialling attitude up to maximum, ::**Kwms024**::{ user=11516014 } ruthlessly intimidated (or just straight up convinced, your choice) **2207** voters into supporting their urban osu! piece.
...
The cheers of **2137** voters lifted up ::**Dem4eg-**::{ user=7206818 }'s piece of pippi and Mocha taking centre stage as charming idols, complete with a fanatic crowd cheering and swinging their pastel glowsticks.

[![](https://assets.ppy.sh/contests/142/banners/lILY1231.jpg)](https://assets.ppy.sh/contests/142/winners/lILY1231.png)

::**lILY1231**::{ user=29265711 }'s rendition of pippi and Alisa enjoying some sparklers ignited the hearts of **2097** voters. How can you say no to those faces?

[![](https://assets.ppy.sh/contests/142/banners/tehfire.jpg)](https://assets.ppy.sh/contests/142/winners/tehfire.png)

::**tehfire**::{ user=7082924 }'s most orbital arrangement of basically the entire official cast (plus the Taikonator) floating in space impressed **2055** voters. If you look really closely, they're all there, and what could be mistaken for solar panels is in fact, an osu!mania playfield. Or could be.
...
**2003** voters gazed across the neon lights of a cyberpunky cityscape with ::**Porukana**::{ user=12992775 }'s rendition of pippi and Aiko in special osu!-branded athletic wear. Looking stylish!

[![](https://assets.ppy.sh/contests/142/banners/araran.jpg)](https://assets.ppy.sh/contests/142/winners/araran.png)

**1886** voters couldn't help but fall for the charms of ::**araran**::{ user=8937198 }'s fox-type pippi, Chirou and an eared don enjoying some time at their local slider gallery. There's a joke to be made here about tech maps, but I will not be the one to do it.
