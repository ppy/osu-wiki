...
Check out [the map from the video above](https://osu.ppy.sh/beatmapsets/1767671) hosted by ::Yugu::{ user=3161834 }!
...
Or play through [the map that introduced **NILFRUITS** to osu!](https://osu.ppy.sh/beatmapsets/1541499) hosted by ::Astrolis::{ user=12357714 }!
...
Slam some drums to [this osu!taiko map](https://osu.ppy.sh/beatmapsets/1786165) hosted by ::Gamelan4::{ user=9856910 }!
