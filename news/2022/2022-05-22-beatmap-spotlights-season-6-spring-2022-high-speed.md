...
[King Gizzard & The Lizard Wizard - Robot Stop [REDLIGHT (VIP)]](https://osu.ppy.sh/beatmapsets/1610231#osu/3287767), mapped by ::olc::{ user=7081160 }\
*primarily suggested by ::Omgforz::{ user=578943 }*\
*described by ::Omgforz::{ user=578943 }, with some help from ::DeviousPanda::{ user=4966334 }*
...
[mafumafu - Hello Dystopia [Collapsing Reality]](https://osu.ppy.sh/beatmapsets/809048#taiko/1697683), mapped by ::JarvisGaming::{ user=8601048 }\
*primarily suggested by Nepuri*\
*described by ::Axer::{ user=7299864 }*
...
[TUYU - Daemonisch [KTYN's Inner Oni]](https://osu.ppy.sh/beatmapsets/1444402#taiko/2983308), mapped by ::KTYN::{ user=2250574 }\
*described and primarily suggested by ::Axer::{ user=7299864 }*
...
[Chroma - Made In Love [Rei's MAXIMUM]](https://osu.ppy.sh/beatmapsets/1028944#fruits/2151543), mapped by ::Bunnrei::{ user=829284 }\
*described and primarily suggested by ::wonjae::{ user=5032045 }*
...
[SHK - Halloween Party [Juansy's Rain]](https://osu.ppy.sh/beatmapsets/1609415#fruits/3286191), mapped by ::Juansy-::{ user=12588215 }\
*primarily suggested by ::x\_angelkawaii\_x::{ user=566276 }*\
*described by ::Nelly::{ user=4741164 }*
...
::OnosakiHito::{ user=290128 } will also say farewell to the osu!taiko curators' team after leading it since the very first season of modern Spotlights, but worry not, because Hivie will take over his tasks.
