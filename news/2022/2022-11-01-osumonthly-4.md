...
Welcome to the 4th edition of osu!monthly, now with a new halloween themed banner (thank you ::Hubz::{ user=10379965 })!
...
The editor has been a big focus for many quality of life enhancements during October, with examples like updated visuals and shortcuts for the settings, which should feel more at home in osu!(lazer)'s general appearance. Ongoing work by ::OliBomby::{ user=6573093 }, [ekrctb](https://github.com/ekrctb) and others cover a large number of bugfixes and general improvements to overall performance. Mapping in osu!(lazer) only gets better by the week!
...
*Please note that the osu! team is not affiliated with Dreamcore Private Limited and Matrix. Special thanks to ::Coppertine::{ user=7279762 } for the video.*
...
19 entries ended up making it to the main menu, with a piece by ::Dreamxiety::{ user=13103233 } attaining the top spot with 3749 votes for her third consecutive art contest victory (never before achieved by *anyone*) and her fifth triumph overall.
...
*Section written by ::Pisapou::{ user=16640021 }*

What happens when the #1 osu! player plays an iconic map with DT? ::mrekk::{ user=7562902 } showed us the answer this month with an unbelievable HDDT FC on [Cycle Hit](https://osu.ppy.sh/beatmapsets/636839#osu/1351114)!
...
*Section written by ::ianpep::{ user=7699030 }*
...
After being ranked for over 3 years, the living legend ::applerss::{ user=983349 } has FC'ed [Scattered Faith](https://osu.ppy.sh/beatmapsets/812539#taiko/1704294)! Being 8 minutes long and reaching up to a BPM of 380 near the ending, this map is well deserving of its 9.07 star difficulty, not even mentioning the 1/6th bursts plus an overall BPM of over 500! The replay is an amazing sight to see as well, please watch it if you have the time!
...
::ExGon::{ user=214187 } has emerged from the shadows once again and set what might be one of the most meta-breaking plays in the entire game, getting an HRFL SS on the top diff of [ded_ED](https://osu.ppy.sh/beatmapsets/1705910#fruits/3800941), a 30 second long, CS 9.1, AR 0 map maxed out with the tightest jumps you can imagine. You just have to see it to believe it.

<iframe width="100%" height="315" src="https://www.youtube.com/embed/WtUCel2sChA" frameborder="0" allowfullscreen></iframe>

Don't let this play steal all of the spotlight, as October held more crazy score-based surprises, like the [first S rank](https://osu.ppy.sh/scores/fruits/209751344) on the top difficulty of [HUG & KILL](https://osu.ppy.sh/beatmapsets/1687036#fruits/3451294) set by ::Motion::{ user=3885626 }, dominating one of the fastest maps in catch the beat, or yet another high CS play by ::ExGon::{ user=214187 } obtaining a full combo on his own map [Broken Hearts](https://osu.ppy.sh/beatmapsets/461355#fruits/988074) with FL, setting the first FC on the map (even while counting NM or HT).

### Notable mania plays of the month

*Section written by ::RandomeLoL::{ user=7080063 }*

It took them many, many tries. Months went by and their Perfect counts kept decreasing, but at the very beginning of the month ::BossPlays::{ user=7341471 } managed to do what everyone else was only able to dream of: the very first 1 million score on [The Lost Dedicated](https://osu.ppy.sh/beatmapsets/224173#mania/523391).

<iframe width="100%" height="315" src="https://www.youtube.com/embed/jw5NO-_0RSw" frameborder="0" allowfullscreen></iframe>

For the unaware, ::Zyph::{ user=1600432 }'s The Lost Dedicated is a very ~~in~~famous chart, not quite to the point of the original .bms file it was based on, but still notorious in the 4K VSRG community nonetheless. The importance of this achievement may not be fully conveyed within these two paragraphs, but we hope they will encourage more players to set more magnificent plays such as this one!

## Did you know?

Since 2012 and until very recently, the longest osu! ranked map was ::Armin::{ user=105902 }'s set on [The Unforgiving by Within Temptation](https://osu.ppy.sh/beatmapsets/29157#osu/156352) with a total drain time of 45 minutes. But this long kept record has been beaten recently by ::Nokduro::{ user=2998248 } and his osu!taiko set of [DigitalOffline0011 Hayakore Tatsumi by Hayakore Tatsumi](https://osu.ppy.sh/beatmapsets/1860299#taiko/3824509), which runs for a whopping *57* minutes of total drain time.

If we also include loved maps, ::katacheh::{ user=6651672 }'s map for [Nana Party by Nanahira](https://osu.ppy.sh/beatmapsets/750284#taiko/1904970) has the longest run time of any of osu! beatmap with a total drain time of 178 minutes. You can fit the Bee Movie in that kind of time frame *twice*.

## Monthly community quiz

Congratulations to ::Karol Duchon::{ user=18791964 } for being the first person to answer last month's question and score themselves 1 month of osu!supporter! As promised last month, we will be providing the answer to last month's question — "Who rewrote the medal system in 2016?".

The answer was: ::MillhioreF::{ user=941094 }!

This month we've prepared a themed question (thanks ::chromb::{ user=10238680 }!), and that question is:
...
- ::Ephemeral::{ user=102335 } has shared a sneak peek of a new Hush-Hush medal in the [Medal Hunters Discord](https://discord.com/invite/8qpNTs6), this led to some community datamining from which 3 more beatmap pack medals were uncovered! This indicates that there is a high possibility of a new batch of medals that will be going live soon!
