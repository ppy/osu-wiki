...
But there was one last surprise: the [custom tiebreaker](https://osu.ppy.sh/beatmapsets/1846639#mania/3793375). Players got to experience the skill peak of the tournament, expressed on a beatmap charted by ::-mint-::{ user=8976576 }, ::guden::{ user=11626065 }, ::MyZterioN-::{ user=8521723 }, and ::Toaph Daddy::{ user=7616811 }. And if that was not enough, the organisers also managed to add [ああああ](https://osu.ppy.sh/beatmaps/artists/301) (which in the western alphabet means *AAAA*) as an official Featured Artist! Let's also not forget about ::poca\1p0ca::{ user=5082685 } and their amazing GFX proficiency.
