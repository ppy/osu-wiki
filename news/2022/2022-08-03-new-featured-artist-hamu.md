...
![](https://assets.ppy.sh/artists/289/header.jpg)

Founder of the music label *Foxtail-Grass Studio*, you might already be familiar with some of [**Hamu**](https://osu.ppy.sh/beatmaps/artists/289)'s work if you're a fan of the Touhou Project and its sprawling catalogue of fan rearrangements. Beyond that, if you've ever watched a stream from the tremendously popular Virtual YouTuber talents of *Shirakami Fubuki*, *Sakura Miko* and *Minato Aqua* from *Hololive Production*, you've likely heard some of his BGM tracks before, not to mention his role as the producer for a few of the aforementioned's original songs.
...
Thanks to the crowned creators of the [Mappers' Guild](https://mappersguild.com/), we're also excited to showcase an all-new beatmap to get things rolling, played by esteemed osu! veteran ::Mlaw::{ user=3126596 } and corn connoisseur ::Woey::{ user=3792472 } IRL at COE2022:

<div align="center">
    <video width="100%" controls>
        <source src="https://assets.ppy.sh/artists/289/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>

### Secret Clover

Check out [the beatmap featured in the video above](https://osu.ppy.sh/beatmapsets/1815789) made by ::Heroine::{ user=12727076 } of the Mappers' Guild!
...
Check out [this collaborative set](https://osu.ppy.sh/beatmapsets/1799400) hosted by ::Usaha::{ user=6443117 } of the Mappers' Guild!
...
<audio controls>
    <source src="https://assets.ppy.sh/artists/289/Songs/Hamu%20-%20Nemurenu%20Ukiyo%20No%20Tsukiakari.mp3" type="audio/mpeg">
</audio>
