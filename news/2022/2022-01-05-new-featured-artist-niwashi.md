...
The complexity and density of these tracks perfectly lends to novel beatmaps, as made clear through ::Down::{ user=4694602 }'s iconic beatmap of [Playing With Ruby](https://osu.ppy.sh/beatmapsets/1306570). See the map's rank \#1 and \#2 scores in the video below, then check out the rest of what's up for grabs:
...
- [osu! mapset](https://osu.ppy.sh/beatmapsets/1306570) hosted by ::Down::{ user=4694602 } as seen in the video above
- [Loved osu! mapset](https://osu.ppy.sh/beatmapsets/1178229) hosted by ::CallieCube::{ user=7535045 }
- [osu!taiko mapset](https://osu.ppy.sh/beatmapsets/1328323) hosted by ::Cychloryn::{ user=6921736 }
