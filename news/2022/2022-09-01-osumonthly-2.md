...
Featuring over 30 hours of live stage events, COE 2022 was certainly ambitious in both range and scale. The immensely popular COE 1v1 tournament made its return, with ::okinamo::{ user=3765989 } crowned champion. In addition, COE 2022 continued to feature a large variety of Q&A panels, including [an incredibly technical dev talk](https://www.youtube.com/watch?v=HVBVqvpFVL4) hosted by ::ThePooN::{ user=718454 } and [peppy](https://osu.ppy.sh/users/2). Group activities such as Efteling and all-you-can-eat sushi were returning favourites, alongside newer entries such as Survivor and ::Sotarks::{ user=4452992 }' Blind Music Quiz.
...
- If you are a fan of doujin music, check out the [Taishi Appreciation Team Beatmapping Contest (TATBC) 2022](https://osu.ppy.sh/community/forums/topics/1631506?n=1) hosted by ::-Tochi::{ user=3664366 } and [Lince Cosmico](https://osu.ppy.sh/users/6070370). The songs to be used for the mapping competition were only recently announced, so you'll have all the time you need to get into the mapping groove.
- Submissions for the [osu! Featured Artist Mapping Contest (FAMC) 2022](https://osu.ppy.sh/community/forums/topics/1619393?n=1) hosted by ::Mafumafu::{ user=3076909 } and [pishifat](https://osu.ppy.sh/users/3178418) are open until the 25th of September, so as they say, better late than never!
