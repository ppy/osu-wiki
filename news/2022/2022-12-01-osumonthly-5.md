...
![](/wiki/shared/news/2022-12-01-osumonthly-5/banner.jpg)

Welcome to the 5th edition of osu!monthly! A lot has happened tournament-wise this month (with a lot more coming in December as well!), particularly with the conclusion of the osu! World Cup. Read on to find out more about that, as well as lots of other cool things happening within the realm of osu!.

If you want to contribute, feel free to reach out! The osu!monthly project is organised in the [osu!dev Discord server](https://discord.com/invite/ppy), and if you have suggestions you can also contact 0x84f#0001 on Discord.

If you are interested in checking out all of the previous editions, feel free to have a look at the [forum post](https://osu.ppy.sh/community/forums/topics/1614314)!
...
- [Things to look out for in December](#things-to-look-out-for-in-december)
- [End word](#end-word)
...
First of all, argon (the new default osu!(lazer) skin) has finally received its initial implementation for osu!taiko, making the skin available for osu! gamers of all game modes. As announced by ::peppy::{ user=2 } in the update video above, the mania portion of the argon skin will receive another pass of fine-tuning in the future, following various feedback from players.
...
*Section written by ::Junihuhn::{ user=4182339 }*
...
![](/wiki/shared/news/2022-12-01-osumonthly-5/OTMT2022-banner.jpg)

The 2nd edition of osu!taiko Malaysian Tournament (OTMT for short) has concluded! For the 2nd edition the production has gone up quite drastically, with 10 commissioned songs made for the tournament ([all released for free on Bandcamp](https://iristocrats.bandcamp.com/album/cons-is-c)), custom maps and even their own mascot, IRIS!

| Placing | Player |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::CrabCow::{ user=9755504 } |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::HHVanilla Ice::{ user=12803930 } |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::JyaKeii::{ user=12086753 } |

After crawling back out of the Losers' Bracket by dealing a swift 7-1 blow to ::JyaKeii::{ user=12086753 }, [HHVanilla Ice](https://osu.ppy.sh/users/12803930) was well on their way to defend their OTMT 2021 Champion title by forcing a 7-5 bracket reset against ::CrabCow::{ user=9755504 } and even pushing for an initial 4-1 lead in the second set. However, CrabCow quickly found their footing and blasted through the remaining maps to challenge HHVanilla Ice in an epic tiebreaker showdown, closing off the tournament with a 30k point difference and securing their first OTMT Champion title.
...
9 new badges have appeared out of thin air this month to the delight of medal hunters and players. 3 Hush-Hush medals, 3 beatmap pack medals (1 of them being a challenge beatmap pack!) and 3 skill medals have been released. Despite the elusive nature of Hush-Hush medals, it took less than a day for the medal hunters to find all of the solutions, which shows that the community loves this sort of content and is craving for more!
...
It is already a very hard feat to be recognised as one of the best, most versatile players 4K osu!mania has ever seen. ::SillyFanGirl::{ user=2288363 } has not only been able to achieve this, but is also an active [content creator](https://www.youtube.com/@SillyFangirlosu), an active tournament player, and overall an incredible community member to interact with!
...
*Section written by ::0x84f::{ user=7944724 }*

Month after month ::mrekk::{ user=7562902 } keeps proving why he is the best osu! player in the world, and if you *still* needed some justification as to why people consider him as one of the greatest players of all time, check out his HDDT play on [Save Me](https://osu.ppy.sh/beatmapsets/594170#osu/1256809).

This 11-minute long marathon by ::Drummer::{ user=4102249 } has been considered by some as the "endgame" map to FC with HDDT, but unfortunately mrekk choked at the end with 4 misses and a couple of slider breaks. Nonetheless, it's an amazing play to witness.
...
*Section written by ::Blushing::{ user=5927823 }*

It's one thing to get the number one spot on the leaderboard with Hidden, but it's another to be the only FC with a mod at all. Though, ::Peaceful::{ user=165027 } took up the challenge and managed to absolutely *violate* [The Violation](https://osu.ppy.sh/beatmapsets/1452092#taiko/2985808).
...
*Section written by ::RandomeLoL::{ user=7080063 }*

Roughly 24 hours passed since [stεganography](https://osu.ppy.sh/beatmapsets/1846639#mania/3793375) — osu!mania's most recent challenging chart — was released. That's the amount of time it took ::bojii::{ user=10083439 } to submit the first Full Combo in its leaderboards.
...
There are many [user groups](/wiki/People/The_Team#user-groups) on osu!, most often recognisable by their title or colour, indicating their membership in that group.

During this month, a new group has appeared on the osu! website. Indeed, the [Beatmap Spotlight Curators](https://osu.ppy.sh/groups/48) have received their own group as a means to distinguish them from regular users and provide more transparency as to who is involved with the project.

Furthermore, descriptions have been added to all user groups, informing players of the purpose of said groups. All in all a very good addition to the website.
...
Thanks to ::chromb::{ user=10238680 } we have got yet another puzzling question for you, and that question is...
...
Thank you for reading this month's edition of osu!monthly! Next month will see the start of *new content* in this monthly post, so keep your eyes peeled. As always, if you have any words of encouragement or criticism, we would also love for you to reach out and let us know what you would like to see.
