...
![](https://assets.ppy.sh/artists/245/header.jpg)
...
While these songs aren't nearly as intense as your average rhythm game song, they can still be difficult under the right circumstances. Watch ::kurtis-::{ user=5477343 } play through [City Girl - L2M (feat. Kelsey Kuan)](https://osu.ppy.sh/beatmapsets/1668789) with approach rates between 8.5 and 11 (yes, *eleven*), then tap along to these other previews:
...
Try out [the map from the video above](https://osu.ppy.sh/beatmapsets/1668789) hosted by ::Hinsvar::{ user=1249323 }!
...
Or try [the map that introduced **City Girl** to osu!](https://osu.ppy.sh/beatmapsets/1455209) hosted by ::GIGAROBLOXIAN21::{ user=15315086 }!
...
Check out [yet another map](https://osu.ppy.sh/beatmapsets/1521806) hosted by ::GIGAROBLOXIAN21::{ user=15315086 }!
...
Wander from the crowded metropolitan streets into [**City Girl**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/245). Those pre-timed beatmap templates are impossible to resist, so don't even try. Just open the editor already.

In case you've been having trouble keeping up with all our Featured Artist announcements, the [@osugame Twitter](https://twitter.com/osugame) is the easiest way to stay on top of things. Keep an eye on that and we'll see you next Wednesday with more musical artistic talent to showcase!
