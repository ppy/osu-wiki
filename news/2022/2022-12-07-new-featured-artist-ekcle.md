...
In classic ::DeviousPanda::{ user-id=4966334 } fashion, we'll be showcasing **Ekcle**'s talents with an 8-star rendition of [Crafted In Ice](https://osu.ppy.sh/beatmapsets/1868244), played by the one and only ::Ekoro::{ user-id=284905 }.
...
Play through [the map from the video above](https://osu.ppy.sh/beatmapsets/1868244) hosted by ::DeviousPanda::{ user-id=4966334 }!
...
Or play [this map intertwining mapping and storyboarding ideas](https://osu.ppy.sh/beatmapsets/862640) hosted by ::Rhonen::{ user-id=8422432 }!
...
If clicking circles isn't your thing, you can also try out [this 4K osu!mania map](https://osu.ppy.sh/beatmapsets/643857) hosted by ::Parachor::{ user-id=5241655 }!
