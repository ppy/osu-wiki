...
Grasp the story by mapping any of the **16** tracks on [**GLORYHAMMER**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/311)!

Check it all out through this video showcasing osu!(lazer)'s in-play leaderboards and the rest of these stellar maps:

<div align="center">
    <video width="100%" controls>
        <source src="https://assets.ppy.sh/artists/311/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>

### Rise Of The Chaos Wizards

Try out [the map from the video above](https://osu.ppy.sh/beatmapsets/1621226) hosted by stream savant ::nebuwua::{ user=14729352 } or [this multi-million-play Loved map](https://osu.ppy.sh/beatmapsets/694464) hosted by ::xChorse::{ user=2217628 }!
...
[More than 8 minutes of **GLORYHAMMER**](https://osu.ppy.sh/beatmapsets/1848202) have arrived, provided by ::Nymphe::{ user=10507407 } specifically for this Featured Artist announcement!
...
Play [the introduction to the story](https://osu.ppy.sh/beatmapsets/1072728) hosted by ::greenhue::{ user=4967662 }!
...
Challenge yourself with [this marathon](https://osu.ppy.sh/beatmapsets/1630218) hosted by ::iamtickrate::{ user=10772580 }!
