...
In case you're allergic to text, we livestreamed the contest results too! Check out the full showcase in the video below, including commentary from ::pishifat::{ user=3178418 }, ::Mismagius::{ user=19048 }, and ::Mao::{ user=2204515 }, along with brief input from each map/storyboard's creators!
...
Let's kick things off with [**this submission**](https://osu.ppy.sh/beatmapsets/1842041) by ::Fisky::{ user=8352623 }, ::ScubDomino::{ user=8972308 }, ::fanzhen0019::{ user=418699 }, ::Tommy Phelps::{ user=10974581 } and ::VenerableNyanta::{ user=12243368 }! Despite earning #3 overall, this entry managed to win the **#1 spot in the storyboarding department!**
...
Combining the expertise of ::Tommy Phelps::{ user=10974581 } and ::VenerableNyanta::{ user=12243368 } (a.k.a. two of osu!'s most well-known storyboarders), it's no surprise that this team managed to win the hearts of the storyboarder panel.
...
Veteran winners from our previous team-based mapping contest [A Labour of Love](/wiki/Contests/A_Labour_of_Love_Contest) made a return this year with [**the most artsy submission around**](https://osu.ppy.sh/beatmapsets/1841845)! Created by ::Altai::{ user=5745865 }, ::DeviousPanda::{ user=4966334 }, ::Mao::{ user=2204515 }, ::Noffy::{ user=1541323 } and ::TheDuckMask::{ user=7405768 }, this submission came super close to the winning spot in all categories, ultimately making it the **overall runner-up** in the contest!
...
Tackling the challenge of a <1MB storyboard led many teams to use minimalistic vector styles, but ::Noffy::{ user=1541323 } and ::TheDuckMask::{ user=7405768 } took the challenge in a completely different direction — they drew a story uniting all of osu!'s mascots (including the new mascot *DJ peppy*), all with original artwork drawn by the two artists.
