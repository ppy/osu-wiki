...
In case you're allergic to text, we livestreamed the contest results too! Check out the full showcase in the video below, including commentary from ::pishifat::{ user=3178418 }, [Mismagius](https://osu.ppy.sh/users/19048), and ::Mao::{ user=2204515 }, along with brief input from each map/storyboard's creators!
...
Let's kick things off with [**this submission**](https://osu.ppy.sh/beatmapsets/1842041) by ::Fisky::{ user=8352623 }, [ScubDomino](https://osu.ppy.sh/users/8972308), ::fanzhen0019::{ user=418699 }, [Tommy Phelps](https://osu.ppy.sh/users/10974581) and ::VenerableNyanta::{ user=12243368 }! Despite earning #3 overall, this entry managed to win the **#1 spot in the storyboarding department!**
...
Combining the expertise of ::Tommy Phelps::{ user=10974581 } and [VenerableNyanta](https://osu.ppy.sh/users/12243368) (a.k.a. two of osu!'s most well-known storyboarders), it's no surprise that this team managed to win the hearts of the storyboarder panel.
...
Veteran winners from our previous team-based mapping contest [A Labour of Love](/wiki/Contests/A_Labour_of_Love_Contest) made a return this year with [**the most artsy submission around**](https://osu.ppy.sh/beatmapsets/1841845)! Created by ::Altai::{ user=5745865 }, [DeviousPanda](https://osu.ppy.sh/users/4966334), ::Mao::{ user=2204515 }, [Noffy](https://osu.ppy.sh/users/1541323) and ::TheDuckMask::{ user=7405768 }, this submission came super close to the winning spot in all categories, ultimately making it the **overall runner-up** in the contest!
...
Telling a story about how osu! reaches all corners of the world, [this submission](https://osu.ppy.sh/beatmapsets/1841885) by ::yf\1bmp::{ user=1243669 }, [TtmnZk](https://osu.ppy.sh/users/2495509), ::Yugu::{ user=3161834 }, [Chaoslitz](https://osu.ppy.sh/users/3621552) and ::Yumeno Himiko::{ user=1806962 } is not only the **overall winner**, but also the **highest scoring entry from the mapper judge panel** and the **community vote winner** by over 100 votes!
...
- Easy playlist: ::-Matyr-::{ user=13771539 }
- Normal playlist: ::TheRealStevie::{ user=12153630 }
- Hard playlist: ::fieryrage::{ user=3533958 }
- Insane playlist: ::fieryrage::{ user=3533958 }
- Expert playlist: ::Intercambing::{ user=2546001 }
