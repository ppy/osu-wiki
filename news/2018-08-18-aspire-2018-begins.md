...
Put simply, Aspire is about breaking the rules and getting away with it, about breaking the game and producing a breathtaking result at the end of it. Aspire is all about demonstrating your mastery over the editor, and the techniques that make beatmaps what they are.

Three Aspirants, namely [Charles445](https://osu.ppy.sh/u/85000) with [LeaF - Evanescent](https://osu.ppy.sh/s/227126), [Monstrata](https://osu.ppy.sh/u/2706438) with [IAHN - Transform (Original Mix)](https://osu.ppy.sh/s/484689) and [ProfessionalBox](https://osu.ppy.sh/u/3250792) with [Helblinde - The Solace of Oblivion](https://osu.ppy.sh/s/594751) took the beatmapping world by storm, and enshrined their names in osu!'s history forever for their efforts.
...
Given the rising presence of "spectacle" entries into the Aspire contests, I will also be introducing a new scoring category revolving around visual impression, aka, spectacle. 
...
Visuals will remain an important aspect of Aspire, but this new scoring should allow for more focus on the beatmapping aspect of creativity for those not so visually inclined. The super-high achievers among you may also note that the winning entry can also conceivably score 1st place in the normal criteria, and also win the spectacle voting for two prizes in one.
...
Use everything you've got. Storyboarding, hitsounding, timing points, if the game can do it, it's yours to use.
...
[**Enter your creation over at the contest listing now!**](https://new.ppy.sh/community/contests/68)
