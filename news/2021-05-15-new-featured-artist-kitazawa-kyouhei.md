...
![](https://assets.ppy.sh/artists/165/header.jpg)

Forging moody atmospheres with each of their tracks, **Kitazawa Kyouhei** is the mastermind producer and composer behind a new tonal brand of VOCALOID. His works dive into dark themes with their lyrics while pushing a progressive style of instrumentation, pulling ideas from modern pop to catchy trap rhythms and anything in between.
...
<div align="center">
    <video width="95%" controls>
        <source src="https://assets.ppy.sh/artists/165/release_showcase.mp4" type="video/mp4" preload="none">
    </video>
</div>
...
Treat yourself to everything above plus a handful more from [**Kitazawa Kyouhei**'s Featured Artist listing](https://osu.ppy.sh/beatmaps/artists/165). And in case you missed it earlier, these templates come loaded with breathtaking artwork and music videos! Load any of them in the editor and you'll find yourself immediately inspired to spam circles.

The week may be over, but we've already scheduled our 2 artists for next week. The [@osugame Twitter](https://twitter.com/osugame) is the place to go if you're keen on finding out more!

Be ready for next Wednesday!
