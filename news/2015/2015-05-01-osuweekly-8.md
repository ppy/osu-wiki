...
Continuing the android development theme from last week, we have a new android app in development by **::ga2mer::{ user=3271843 }** called **[osu!info](https://osu.ppy.sh/community/forums/topics/321905/start=0)** that can be used to view profiles, download beatmaps and skins for osu!droid and opsu, to view osu!'s changelog and a list of osu! livestreams. osu!info can be **[downloaded as an .apk](https://puu.sh/hl1dJ/e67b938930.apk)** or **[downloaded directly from google play.](https://play.google.com/store/apps/details?id=cf.ga2mer.osuclient)**
