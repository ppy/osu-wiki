...
_[The results for the 8th MBC, an official mapping contest held every month, have been announced!](https://osu.ppy.sh/home/news/2015-04-08-monthly-beatmapping-contest-8-results)_ The winner of this month's contest was _::Damnae::{ user-id=989377 }_ with a judge score of 175 points. The second place entry was from _::Cherry Blossom::{ user-id=1156742 }_ with 162 points, and finally a two way tie between _::Frey::{ user-id=695678 }_ and _[Shadren](https://osu.ppy.sh/users/745494)_ with 158 points. The map will be bundled into the game, but you can _[download it now here](https://osu.ppy.sh/beatmaps/671412)_ if you'd like. You can also _[check out the results page](https://osu.ppy.sh/p/contestresults?c=17)_ to see maps and judge scores of all entrants, or can _[download a pack of the top 20 mapping contest results](https://dl.dropboxusercontent.com/u/41152277/ShareX/2015/04/raja_ffm%20-%20the%20light.osz)_ supplied by _::loopuleasa::{ user-id=4053944 }_
...
_[osu!Sync](https://osu.ppy.sh/community/forums/topics/270446&start=0)_, a really cool project made by _::naseweis520::{ user-id=4729376 }_ that allows you to generate, export and import beatmaps to osu! This is a very powerful tool, as you can share a large amount of maps quickly with friends, back up a list of all of your songs, and many more uses. Definitely be sure to check this one out!
