...
The winner of the osu!standard portion of the contest was ::Gamu::{ user=611174 } with a score of _121_ points, closely followed by ::TestApple::{ user=2248413 } with a score of 119 and ::K i A i::{ user=747356 } with a score of 118.

The Taiko portion of the contest was won cleanly by ::MMzz::{ user=128993 } with a score of _129_ points, followed by ::Nwolf::{ user=1910766 } with 119 points and ::qoot8123::{ user=766371 } with 116 points.

Unfortunately, only two competitors stepped forward for the CtB portion of the contest, with ::Deif::{ user=318565 } nearly taking the win by default with _84_ points, closely followed by ::CLSW::{ user=531253 } with 79 points.

The osu!mania portion of the contest was won solidly by ::ExPew::{ user=665612 }, blowing away the rest of the competition with a _118_ point lead, followed by ::shionelove::{ user=501551 } with 96 points and ::Tear::{ user=1340650 } with 86 points.
