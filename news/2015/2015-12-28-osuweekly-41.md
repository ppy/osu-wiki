...
- **[YUGEN](https://www.youtube.com/watch?v=dCHz8xbJALg)** (Created by ::Garin::{ user-id=2130664 }) - A minimalistic skin focused on providing comfortable and unimpaired gameplay with slick aesthetics, available for all game modes!
- **[Summer Flowers](https://www.youtube.com/watch?v=wP3Ymfy-R_s)** (Created by ::SweetSweet::{ user-id=2564158 }) - The cold gets the better of all of us eventually, but it certainly isn't cold on osu! Here is a heated up and easygoing skin featuring warm colours and neat hit-bursts!
