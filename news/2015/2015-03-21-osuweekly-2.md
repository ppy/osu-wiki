...
**::osu! player and streamer HappyStick::{ user-id=256802 }** is attempting to do a full time streaming gig on twitch streaming osu!. If you want to show your support or tune in to see what his stream is like, you can take a look **[here](https://www.twitch.tv/happystick)**.

**[osu!profile](https://osu.ppy.sh/community/forums/topics/252160)** is a program created by **::Entrivax::{ user-id=884950 }** to track your pp progress while playing. The program works with each game mode and can even be integrated into OBS for ease of streaming and to enhance viewer experience.
