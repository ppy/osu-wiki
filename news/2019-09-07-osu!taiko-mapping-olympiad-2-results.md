...
The judging for the first osu!taiko Mapping Olympiad contest has been completed and the results are in: congratulations to the first **osu!taiko Mapping Olympian** and taiko's newest *Elite Mapper*!

[![](https://osu.ppy.sh/wiki/shared/news/banners/osu_mapping_olympiad.jpg)](https://osu.ppy.sh/community/contests/65)

For the inaugural taiko Olympiad contest, we tasked mappers to create a full spread showcasing their proficiency in taiko mapping on the song *Bwa !* from [**Thaehan**](https://osu.ppy.sh/beatmaps/artists/7). There were a total of 33 entries and below are the results for the **top 10 entries**:
...
In **first place** is [Nofool](https://osu.ppy.sh/users/672430) with a score of **119.5**. Their entry received the best score from judge incandescence, as well as the overall 'Judging Impression' score! Overall an excellent entry across the board. Congratulations!
 
Following close behind in **second place** is [Nifty](https://osu.ppy.sh/users/4956097) who received a total of **117.5** points. They earned the best scoring in the 'Flow and Structure' and 'Creativity' categories, not to mention they received an impressive overall score of 44/50 by judge Nepuri!
 
[Volta](https://osu.ppy.sh/users/4154071) closes the podium by earning **third place** with a score of **106.3**. Their entry showcased a mastery of difficulty spread, receiving a score of 27/30 which was the highest among all entries.
...
- **First place**: 3 months of osu!supporter, 6 Olympiad Points (Results in 'Mapping Olympian' badge), *Elite Mapper* title
