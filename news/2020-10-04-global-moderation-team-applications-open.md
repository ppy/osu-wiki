...
Are you interested in helping keep the osu! community clean and suitable for everyone? The Global Moderation Team is now accepting applications for new members!

![](https://assets.ppy.sh/media/gmt_generic.jpg)

Once upon a distant past, the Global Moderation Team opened an application process to add new members to the team. We're pleased to announce that we're bringing a return to applications for a chance at becoming a part of the GMT.
...
* General requirements to join the GMT have not changed. You can read in detail about what we expect on [the GMT wiki page](https://osu.ppy.sh/help/wiki/People/The_Team/Global_Moderation_Team#becoming-a-global-moderation-team-member), but in summary: you must be active in the in-game chat and/or the forums, you must demonstrate good behaviour by treating fellow community members with respect, you must possess a strong understanding of [osu!'s community rules](https://osu.ppy.sh/help/wiki/Rules) and follow them, and you must already be contributing to bettering the community (by assisting other users, submitting reports for other users breaking the rules, etc).
