...
[MY FIRST STORY - Fukagyaku Replace](https://osu.ppy.sh/beatmapsets/227021) by ::Moway::{ user=1352672 }, [toybot](https://osu.ppy.sh/users/2848604), ::Saut::{ user=3799202 }, [pkhg](https://osu.ppy.sh/users/343624) and ::Aka::{ user=1307553 }\
*written by ::Kaifin::{ user=2596942 }*

With a staggering 791 favourites, ::Moway::{ user=1352672 }'s [Fukagyaku Replace](https://osu.ppy.sh/beatmapsets/227021) is insanely popular, and it's easy to see why. The mapset is incredibly clean, featuring an easily rankable spread of difficulties by several notable mappers and a top difficulty which has been featured in too many tournaments to count. Hopefully this beloved map can finally receive the scoreboard it deserves through Loved!
...
[JerryC - Canon Rock](https://osu.ppy.sh/beatmapsets/203734) by ::momo1101::{ user=4220343 } et al.\
*written by ::Kaifin::{ user=2596942 }*

[Canon Rock](https://osu.ppy.sh/beatmapsets/203734) is a mapset hosted by mania mapper ::momo1101::{ user=4220343 } that features high quality difficulties for all 4 modes. It's clear that a tremendous amount of work has gone into this mapset based on the thread, and the 200 people who have favorited the map are a testament to the appeal of the map. With a full spread for standard including a notable extra by the mapper previously known as ::Fort::{ user=2805457 }, you're sure to find some enjoyment here, no matter your skill level!
...
[Hatsuki Yura - Shoujo to Ougonryuu no Monogatari](https://osu.ppy.sh/beatmapsets/357361) by ::Lortus::{ user=1008962 }\
*written by ::Toy::{ user=2757689 }*

Once again, a map that has can possibly attribute a part of its popularity to top player livestreams, ::Lortus::{ user=1008962 }'s [Shoujo to Ougonryuu no Monogatari](https://osu.ppy.sh/beatmapsets/357361) has a quite infamous slider velocity change that has been known to break combos as featured in a popular clip from [Azer's channel](https://clips.twitch.tv/FurryStupidOysterSoonerLater). Since then, the map has amassed nearly 200 favorites since 2015 and has been used in tournament mappools to further bolster its track record. The large jumps fully encapture the booming sounds within the song and make for an experience that feel truly rewarding when hit perfectly.
...
[Maid-chan (CV: Horie Yui) - Maid-chan yori.](https://osu.ppy.sh/beatmapsets/369623) by ::Shirasaka Koume::{ user=3062998 }\
*written by ::Toy::{ user=2757689 }*

The biggest anime plot twist of 2018 arrived in the form of well-versed tournament player and mapper ::Shirasaka Koume::{ user=3062998 } openly admitted to also be the owner of the now restricted account Roll\_Pan. The once faceless graveyard mapper can now be properly credited for their extremely popular mapsets, with [Maid-chan yori](https://osu.ppy.sh/beatmapsets/369623) being among them. The single difficulty GD from ::Koume::{ user=3062998 } has become somewhat of a cult classic, garnering 170+ favorites since 2015 and achieving widespread popularity among players and tournament mappoolers alike.
...
[Dollscythe - Flashes (Extended)](https://osu.ppy.sh/beatmapsets/512648) by ::Skystar::{ user=873961 }, [Vert](https://osu.ppy.sh/users/3420746) and ::yf\_bmp::{ user=1243669 }\
*written by ::Kaifin::{ user=2596942 }*

[Flashes](https://osu.ppy.sh/beatmapsets/512648) is a masterful map by the master himself, ::Skystar::{ user=873961 }. The top diff was the winner of Pending Cup 4, a very highly regarded Chinese mapping contest, and it's incredibly clear why: the crisp, inventive patterns and genius use of 2B elements put this map in a league of its own. If you've never seen this mapset before, I implore you to check it out because you're definitely missing out!
...
[Yooh - MariannE (NotTaiko Edit)](https://osu.ppy.sh/beatmapsets/673935) by ::Gezoda::{ user=481582 }, [Mew104](https://osu.ppy.sh/users/2345156) and ::katacheh::{ user=6651672 }\
*written by ::Gezoda::{ user=481582 }*

MariannE sounds like a familiar name in the Loved section, right? Well, [yes](https://osu.ppy.sh/beatmapsets/521862). This is a fast-paced challenge that will require focus at all times. It's a collaboration between ::Gezoda::{ user=481582 }, [Mew104](https://osu.ppy.sh/users/2345156) and ::katacheh::{ user=6651672 }, each providing their own gimmicks! Now known as Yukiko's Challenge, this thing will either make you yell in triangles, or just label every mod that ever shows up as banned/illegal. To those who are coming for the full combo, we hope you still remembered that this isn't Taiko anymore!
...
[Minamotoya feat. Kuroa\* - Hana Kagerou](https://osu.ppy.sh/beatmapsets/491879) by ::K-2::{ user=1807472 } and [KamizonoShinobu](https://osu.ppy.sh/users/1163051)\
*written by ::Gezoda::{ user=481582 }*

If you liked [KHAMEN BREAK](https://osu.ppy.sh/beatmapsets/426572), you will love [Hana Kagerou](https://osu.ppy.sh/beatmapsets/491879) so much that you will replay it. Made by ::Ni-Sokkususu::{ user=1807472 } (now known as K-2), and with a difficulty made by ::KamizonoShinobu::{ user=1163051 }, this set uses a variety of hitsounds to enhance the high-quality mapping provided. Ranging from traditional Japanese instruments to more western kick drums, and without forgetting the infamous banging noise from SOUND VOLTEX, this beatmap is a delight to the ears!
...
[Remixed by DJ Command - Mermaid girl -AKIBA KOUBOU MIX-](https://osu.ppy.sh/beatmapsets/55126) by ::Langmaor::{ user=1396001 }\
*written by ::Gezoda::{ user=481582 }*
...
[USAO - Night sky](https://osu.ppy.sh/beatmapsets/376397) by ::Mel::{ user=1696312 } et al.\
*written by ::Gezoda::{ user=481582 }*

Stop everything and look at the night sky outside! Isn't it very starry? Because this is what this map is. This set of four difficulties made by ::DarkVortex::{ user=1940325 }, [Nishizumi](https://osu.ppy.sh/users/2496768) and ::jomnhnk::{ user=298328 } is something you should not miss for any reason, because every diff is two minutes of pure fun set to a fantastic song by USAO! The views of each mapper make this set a great experience to anyone touching it, and the starry night sky's stars will end up in your eyes after playing the map!
...
[BlackY - B(Camellia's"BlAst-Off"Remix)](https://osu.ppy.sh/beatmapsets/718270) by ::yea::{ user=6874332 }\
*written by ::Backfire::{ user=263110 }*

Last but not least, we have [B](https://osu.ppy.sh/beatmapsets/718270). Yes, that is really the title of the song; B. However, don't let the underwhelming title fool you, B is most certainly an overwhelm to the senses. At 280BPM and filled to the brim with difficult patterns, this is one of ::yea::{ user=6874332 }'s most exciting maps yet. This one is for the players who really want to test their speed and streaming ability!
...
[Between The Buried and Me - Telos](https://osu.ppy.sh/beatmapsets/609826) by ::Phil::{ user=3191489 }\
...
The Telos chart in XeoStyle's marathon is actually a toned down version of this chart (this was done to prevent the chart from skewing the difficulty curve of the marathon too much). ::Phil::{ user=3191489 }'s unfettered chart is aggressive and compelling, but pensive and meticulous in many other sections. Blisteringly fast trills, fast-paced jumpgluts, long shrill jumpstreams, solemn slow PR'd sections, those are a few things that you will find in this progressive epic. In my eyes, while ::Phil::{ user=3191489 }'s chart might not be quite as ambitious as ::XeoStyle::{ user=3377280 }'s full album marathon, the chart itself encompasses what is required for a progressive marathon chart to be considered memorable. That memorability is what makes it stand out from other marathon charts, and it is what makes this chart a viable nominee for the Loved section.
...
[9mm Parabellum Bullet - Punishment](https://osu.ppy.sh/beatmapsets/532682) by ::Valedict::{ user=2537082 }\
*written by ::Shoegazer::{ user=2520707 }*

If you were to ask me for the absolute most frenzied and aggressive chart that I can think of, it would be ::Valedict::{ user=2537082 }'s chart for [Punishment](https://osu.ppy.sh/beatmapsets/532682). To call it intense is an understatement; the song itself is among 9mm Parabellum Bullet's most adrenaline-filled (who has multiple other frenzied songs to their name), and ::Valedict::{ user=2537082 }'s approach to this chart encompasses the frenzied nature of the track with a sense of grittiness that is practically irreplicable with a cleaner approach.
...
Like ::Valedict::{ user=2537082 }'s other Loved charts, while this may not be ::Valedict::{ user=2537082 }'s most technically sound chart, it is one of his most memorable. There are not many songs that are as intense as Punishment that are charted for osu!mania, and ::Valedict::{ user=2537082 } did a fantastic job in capturing that level of intensity that Punishment provides. It most certainly helps that the chart itself is excellent and is already played in competitive circles as well.
...
The 7K mapset, mapped by ::LordRaika::{ user=3265023 } are charted with some creative and fun ideas like 1/4 LN streams to the synths, it has (similarly to the 4K mapset) tasteful and simplistic SV usage and pretty complex layering in higher difficulties where you can clearly see the difficulty progression throughout. Mixing the LN style and streams with some dense buildups, tricky bursts, finger independence heavy patterning and even a section of inverse in the break. It's a very nicely mixed package which doesn't get boring.
...
[Danny Baranowsky - The Battle of Lil' Slugger (Ch 1 Boss Extended Cut) (250bpm)](https://osu.ppy.sh/beatmapsets/79839) by ::Staiain::{ user=86188 } and [samurai7694](https://osu.ppy.sh/users/1033229)\
*written by ::Kamikaze::{ user=2124783 }*

Up next we have a classic chart from the hands of the resident speed demon viking ::Staiain::{ user=86188 } and legendary American StepMania player ::samurai7694::{ user=1033229 }, and it is a hard one.
...
[Saiya - Remote Control](https://osu.ppy.sh/beatmapsets/308297) by ::Arzenvald::{ user=3027421 }\
*written by ::Kamikaze::{ user=2124783 }*

And now we are presenting a work by a man who goes by many nicknames, ajeemaniz, ExUsagi, Miyamoto Usagi and nowadays known as ::Arzenvald::{ user=3027421 }. A 9K work to that. Here's a song known to pretty much anyone who's played or heard of osu!, [Saiya's Remote Control](https://osu.ppy.sh/beatmapsets/308297).
...
[osu!mania 7K Dan Course - Insane Level (Regular)](https://osu.ppy.sh/beatmapsets/450069) by ::Jinjin::{ user=3360737 }\
*written by ::aitor98::{ user=3154852 }*

This time, the set we are going to talk about is made entirely to test the player's skill level accurately. ::Jinjin::{ user=3360737 } created this set that goes by the name of [osu!mania 7K Dan Course - Insane Level (Regular)](https://osu.ppy.sh/beatmapsets/450069) to help people see how good they are at certain patterns, specially jacks, mixed patterns, speed and stamina (this set has been recently updated to be more up to date with today's standards). You actually need to achieve an accuracy of 96% or above to be able to move on to the next level, and so on.
