...
- **osu!taiko:** ::-\[ ix Ishida xi \]-::{ user=242910 }
...
With his latest ranked map of Dream Theater's "On The Backs Of Angels", ::LMT::{ user=7262798 } manages to find a great balance between playability and capturing the complexity of a nearly 9 minute long progressive metal song.
...
You might know the artist Saitama Saisyu Heiki (aka S.S.H.) as the composer of Intersect Thunderbolt which had a great past in osu!taiko. And now, ::DarkVortex::{ user=1940325 } has successfully brought S.S.H. back to our mode with a great mapset to the song Daedalus!
...
After being absent from the ranked section for a few months, ::Raiden::{ user=2239480 } returns with an amazing map of  Transport by Sota Fujimori, and let me tell you, it's an AMAZING map.
...
An outstanding 1/6 map by the new face ::lazyboy007::{ user=7882675 } this month. Despite not having much experience with taiko, he still produced an excellent map with consistent structure. Furthermore, the excellent 1/6 usage and control of pattern density extracts the essence of the song perfectly, making it a worthy contender for this month's Spotlight!

### osu!catch

[![](/wiki/shared/news/2018-06-06-beatmap-spotlights-march-and-april-2018/nirvana.jpg)](https://osu.ppy.sh/beatmapsets/694025)

Taking the top spot for this edition of the Spotlights is Camellia's rendition of "Nirvana" mapped by ::Spectator::{ user=702598 }! While being of lower star rating than the usual Camellia map, it features several patterns that make the map harder than it seems.
...
Starting off his mapping career with a bang, ::Damnjelly::{ user=1666355 } comes onto the scene with his mapset of "Iwashi ga Tsuchi kara Haete Kurunda". The highest difficulty features an escalation style reading challenge, slowly introducing complex rhythms and culminating with overlapping streams.
...
With his latest ranked map of the song "Gabriel Drop Kick" by Tomita Miyu, Onishi Saori, Ohzora Naomi and Hanazawa Kana, ::Okoratu::{ user=1623405 } brings us a great collaborative mapset that spans across all modes.

In his own difficulties, the mapper follows the song perfectly by using structured patterning whenever the music is calm and dishevelled patterning when the song is more chaotic. Combined with a guest Insane by ::Yuii-::{ user=2935923 } that uses an interesting hitsounding concept, this mapset is an experience not to be missed this month!
...
::Delis::{ user=1603923 } is already well-known as the resident spotlight hogger, but for good reasons! Sono Chi no Sadame is a really intense and epic song, and Delis' representation of the map was done impeccably. High and low points of the song were captured perfectly with variations on spacing and rhythms, and all not without a touch of the classic Delis style™. A solid addition to this month's Spotlight!
...
After the slamming success of both "Cycle Hit" and "We Are Number One" back in 2017, ::Midnaait::{ user=1506011 } is back again this year with their next(a) hit, lapix's "Nexta"!
...
::Kyuare::{ user=2705312 }'s latest mapset of "Turii \~Panta rhei\~" brings us an exhilarating experience! This mid-length mapset has an even spread of 5 decent difficulties, fitting players at all level.
...
Large multi-mode collaborations can sometimes fall flat if each particular game mode didn't receive enough dedicated attention, but fortunately, this is far from the case here. ::Sc4v4ng3r::{ user=4838429 }'s osu!catch difficulty spread for "Gabriel Drop Kick" is a beautifully clean affair, but also sports a variety of different patterns and flows fitting each different section.
...
"Don't mess the timing with your eyes. Feel the rhythm with your soul!" ::Lenfried-::{ user=5314573 } brings us here the probably most enjoyable and fun mapset which consist only out of easy difficulties! The BASIC consist mostly of 2/1 and 1/1 pattern which got placed in order to the vocals from the music. It's perfect for every new player.
...
::\_underjoy::{ user=2235750 } came back with his undoubtfully insane 7K mapset with Gekikara Mania's "Deublithick". The spread features three extreme difficulties, including ::Blocko::{ user=4075092 } as a guest mapper, and an Insane difficulty accompanied by ::capsafangirl::{ user=4308015 }, which present extreme streaming burst at the chorus section of the song, along with complex usage of multiple chord stream jump hands.
...
Debuting his first ranked map, ::Mentholzzz::{ user=7182779 }'s "ONIGIRI FREEWAY" by featured artist OISHII is quite the active chart for an active song. Featuring twisting long notes with well crafted inverse sections, it's certainly a break from the established norm.
...
::Turrim::{ user=3846265 }, new mania mapper has made his appearance with his first ranked mapset, DJ Genki VS Camellia feat. moimoi - YELL!
