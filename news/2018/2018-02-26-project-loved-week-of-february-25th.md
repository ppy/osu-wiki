...
With that out of the way, let's get on to this week's picks! For this round, ::Strato::{ user=6492199 } made some awesome showcase videos for each mode. Check them out at the beginning of each section if you prefer a video format!
...
The cutest song on the list goes to ::Nattu::{ user=1886722 }'s [Gokusotu Angel Ennmachan](https://osu.ppy.sh/beatmapsets/541540). This map features spaced streams and moe sliders to match the song's high-paced nature. Whatever mood you're in, this song is always a pleasure to play.
...
This next map by ::Exile-::{ user=2559349 }, better known as a storyboard master, is a map of a very popular featured artist song, [Putin's Boner](https://osu.ppy.sh/beatmapsets/339939) by Helbinde. As you'd expect, this map has a great storyboard, so be sure to play with it on at least once!
...
If you're like me, you have played this map far far FAR too many times. [Unbreakable \(Nightcore Mix\)](https://osu.ppy.sh/beatmapsets/210679) by ::Smokeman::{ user=2140676 } is an incredibly popular jump map that plays super well set to an **incredibly uplifting** nightcore tune. Come let out your inner secret nightcore lover and have a great time playing this classic mulitplayer map!
...
Drop the bass with ::Irixo::{ user=6566698 }'s Nightcore Remix rendition of [Bring the Madness](https://osu.ppy.sh/beatmapsets/384166). The map currently sits at 415 favorites, and with a whole 3 minutes of 230BPM jumps, it can be truly said that this map has brought on a new kind of madness.
...
One of the most popular unranked maps around, ::Raikozen::{ user=3827077 }'s [Warriors](https://osu.ppy.sh/beatmapsets/431135) became incredibly popular amongst top players following a version made by ::Axarious::{ user=2614511 } for OWC 2015 finals, though sitting at 8.32\*, it is exceptionally harder. Large full-screen jumps litter the screen in this high-energy pump-up mantra that hails over 475 favorites.
...
A more conventional map compared to most maps this round, having only 150 BPM and not too many crazy SV changes. The most outstanding part of this map by ::steven1::{ user=3090416 } is the high amount of 1/6 bursts, with some [Tiger Rampage](https://osu.ppy.sh/beatmapsets/279175)-style 1/6+1/4 combinations in the kiai sections.
...
Probably one of the most awaited beatmaps from ::Minato Yukina::{ user=531253 }. With an average BPM of 270 that will go to 520 in one of the speedups, players would need to be constant to perform well in this beatmap. Careful the short-snapped hyperdashes patterns!
...
Another intriguing map previously featured in the 2017 osu!catch World Cup, here ::Kyuare::{ user=2705312 } presents a less-commonly seen approach to stream mapping remeniscent of [ICE - L](https://osu.ppy.sh/beatmapsets/196230) and other classics from the past. This, combined with an array of different rhythms encompassing 1/4, 1/6 and 1/8 and the use of Approach Rate 8, results in an excellent test of reading skill not available anywhere else.
...
In essence, while I feel that ::Chrubble::{ user=2594280 }'s Feelin' Sky can be rough around the edges at points, it certainly shows a lot of heart. That display of heart is something that resonates with the charting zeitgeist today, and it is something that, I believe, makes this a solid nominee for the Loved section.
...
Our sixth chart on the list is a legendary chart among the 7K community. From the legendary o2jam-bred charter ::Entozer::{ user=277044 } arises one of the hardest challenges in osu!mania to this day. Representing the good old o2jam style of charting, full of tasty noodles and hard difficulty spikes with some SV changes mixed in as well, a true ET chart.
...
Up next we have [The Glory Days](https://osu.ppy.sh/beatmapsets/373357), one of the most popular unranked charts in 2016, a full spread mapset by a well known Korean charter ::CloudHolic::{ user=3924047 }, known mostly for his mixed style and fun oriented patterning.
...
This set is something special. Brought by our own Elite Mapper ::LordRaika::{ user=3265023 }, it is a mapset that really nicely conveys what kind of a charter LordRaika is.

Not only is this mapset keysounded, the song itself is LordRaika's mix of it, and it also has a wonderful storyboard by the elite storyboarder ::Exile-::{ user=2559349 }.
...
Professional nerd ::Nivrad00::{ user=1984634 } with another masterpiece which twists the boss rush theme made prominent in the rhythm game scene via Renard's MungYoDance series, as to accompany his own compositions. Thirteen different bosses which each test your abilities to an ultimate, with attack after pummelling attack of dense patterning, rapid-fire streams and flexible fingerwork.
