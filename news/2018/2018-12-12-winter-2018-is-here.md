...
Featuring pippi and Mocha all decked up in reindeer costumes and festive winter dresses, **::Chiruuu::{ user=8911572 }**'s entry warmed the hearts of **4695** voters, landing a solid first place result.
...
Sporting a jacket-clad pippi enjoying a rest in a wintery park with teeny tiny takes on Aiko, Yuzu and Maria, **::PisRyder::{ user=3457622 }**'s entry nabbed **4085** votes, scoring second place overall.
...
**::Shuuzo::{ user=3661521 }**'s take on Mocha, the Taikonator (in his winter form) Yuzu and pippi enjoying some time in the snow resulted in **3771** icy spheres pelted squarely at Yuzu's face.
...
**3701** snowflakes fell into Aiko's grasp in **::Misakko::{ user=3173752 }**'s compelling piece depicting a rather majestic jaunt through a snow-tinged and aurora-lit sunset.

[![](https://assets.ppy.sh/contests/73/winners/banners/zeyez.jpg)](https://assets.ppy.sh/contests/73/winners/zeyez.png)

**3653** votes lit up **::zeyez::{ user=13237846 }**'s beautifully decorated shot of Mocha enjoying some Christmas lights. Oooh, shiny.

[![](https://assets.ppy.sh/contests/73/winners/banners/Wa_coo.jpg)](https://assets.ppy.sh/contests/73/winners/Wa_coo.jpg)

**3417** voters got stars in their eyes from **::Wa\1coo::{ user=6538071 }**'s almost criminally cute take on Mocha enjoying a walk over a snowy bridge. She's excited that you voted for her, duh.

[![](https://assets.ppy.sh/contests/73/winners/banners/Sylux6.jpg)](https://assets.ppy.sh/contests/73/winners/Sylux6.png)

Enjoying a mountaintop walk with a distinctly Japanese-themed take on pippi, **::Sylux6::{ user=2607507 }** scored **3297** votes. Gorgeous stuff, and beautifully executed.
...
A new contender for medley-style pieces enters the fray, with **::D A R K N E S S::{ user=4676233 }**' work scoring **3202** votes. There's an *absurd* amount of effort in this piece with over half a dozen unique takes and costumes for a great ensemble of official and community mascots.
...
Snagging **3108** votes, ::snowyani2000::{ user=2691590 } is back at it again with a reference-loaded winter wonderland. How many can you pick out?
...
**3066** voters thoroughly approved of ::\[ Pink Dreams \]::{ user=3204205 }'s utterly adorable take on pippi enjoying some time in the snow. Did I mention that she's adorable?

[![](https://assets.ppy.sh/contests/73/winners/banners/llNaokill.jpg)](https://assets.ppy.sh/contests/73/winners/llNaokill.png)

**::llNaokill::{ user=7755095 }**'s gloriously colourful take on a rugged-up pippi complete with translucent scarf won over the hearts of **2991** voters, and rightfully so!
...
**::elizabethgg::{ user=7503187 }**'s snapshot of pippi and Mocha looking out over a dimly lit bridge on a cold winter's night is like two hundred times more comfortable than it aught to be, and **2865** voters agreed.

[![](https://assets.ppy.sh/contests/73/winners/banners/ShovelKun.jpg)](https://assets.ppy.sh/contests/73/winners/ShovelKun.png)

It's Maria time! **::ShovelKun::{ user=9948284 }** showcased everybody's favorite osu!mania mascot in all of her adorable glory beside a simplistic but beautifully executed iconographic background, impressing **2858** voters.

[![](https://assets.ppy.sh/contests/73/winners/banners/ovelhenta.jpg)](https://assets.ppy.sh/contests/73/winners/ovelhenta.png)

Oh deer! **::ovelhenta::{ user=7284442 }**'s piece of pippi snapping a candid shot with some of the local wildlife in a snowy forest is a beautifully colourful display of some classic winter tones with a stylistic touch. **2786** voters hit that like button!

[![](https://assets.ppy.sh/contests/73/winners/banners/SJPumpkin.jpg)](https://assets.ppy.sh/contests/73/winners/SJPumpkin.png)

All rugged up and rose-tinged from the cold, **::SJPumpkin::{ user=4840900 }**'s beanie-clad pippi saw **2474** voters show their support in full.
