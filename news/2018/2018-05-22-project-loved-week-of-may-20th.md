...
*All osu! descriptions were written by ::Toy::{ user=2757689 }*
...
[Helblinde - Disconnected](https://osu.ppy.sh/beatmapsets/169874) by ::Taikuta::{ user=207967 }

What's a round of Loved voting without one mapset that's more popular for its song and jump spam? This 2014 classic by ::Taikuta::{ user=207967 } made its rounds through the community as the ultimate jump "pass challenge", further cementing its place in history as it collected 189 favorites. Pick your poison on either AR9 or AR10, and do your best to keep up with the neverending jump spam.
...
[Umaru Doma [CV: Aimi Tanaka] - Kakushinteki\*Metamaruphose!](https://osu.ppy.sh/beatmapsets/334440) by ::-H a y a-::{ user=5440423 }\
*written by ::Gezoda::{ user=481582 }*
...
[Silent Siren - Hachigatsu no Yoru](https://osu.ppy.sh/beatmapsets/410556) by ::suni::{ user=4126437 }\
*written by ::Backfire::{ user=263110 }*

With over 30 favorites and a great grasp of rhythm and just the right amount of challenge to keep most players entertained, you would figure this wasn't ::suni::{ user=4126437 }'s first map but, you'd be surprised to find out that it is! For a first map, [Hachigatsu no Yoru](https://osu.ppy.sh/beatmapsets/410556) is certainly impressive. With its fun variety of patterns and infectiously catchy use of vocal mapping, you really can't go wrong!
...
[Hapi - THE MEDLEY OF KIRBY SSDX](https://osu.ppy.sh/beatmapsets/205717) by ::alecreit::{ user=2586173 } et al.\
*written by ::Backfire::{ user=263110 }*
...
[seiya-murai feat.ALT - Sumidagawa Karenka](https://osu.ppy.sh/beatmapsets/359719) by ::Gommy::{ user=3555114 }\
*written by ::SartNYAN OwO xD::{ user=4100941 }*
...
[Akiyama Uni - Kanpan Tasogare Shinbun](https://osu.ppy.sh/beatmapsets/448332) by ::Kyptoric::{ user=1361268 }\
*written by ::Tenshichan::{ user=1101600 }*

Similar to the standard equivalent of the song [Kanpan Tasogare Shinbun](https://osu.ppy.sh/beatmapsets/448332) this map starts out rather slow. That is until the kiai kicks in and you get confronted with a bunch of fast sliders and more tricky movement. ::Kyptoric::{ user=1361268 } has done a really good job in bringing the intensity of the kiai into a catch specific version. It is kind of a challenge yet it doesn't feel overdone in the slightest. A great mix of nice pattering and good difficulty scaling makes this a map which can be appreciated by the majority of the community.
...
[Hilight Tribe - Free Tibet (Vini Vici Remix)](https://osu.ppy.sh/beatmapsets/490402) by ::Jole::{ user=2883132 }\
*written by ::Shoegazer::{ user=2520707 }*

A fairly known chart in competitive circles, ::Jole::{ user=2883132 } gets his second nominated chart for the Loved section with [Free Tibet (Vini Vici Remix)](https://osu.ppy.sh/beatmapsets/490402). Psychedelic trance is a genre that is extremely undercharted in osu!mania, and this chart is every bit as mesmerising and psychedelic as its accompanying track. The chart is extremely jack-heavy, utilises a substantial amount of repetition, and is captivating in a way that differs substantially from your typical blood-boiling sprint.
...
[Hatsuki Yura - The Clockwork Rose -Tokei Shikake no Bara Shoujo-](https://osu.ppy.sh/beatmapsets/740979) by ::Gekido-::{ user=4693052 }\
*written by ::Shoegazer::{ user=2520707 }*
...
[Hino isuika - Dreamin' attraction!!(Extended)](https://osu.ppy.sh/beatmapsets/517221) by ::qodtjr::{ user=3021168 }\
*written by ::aitor98::{ user=3154852 }*

Please, give a warm welcome to ::qodtjr::{ user=3021168 } (also known as baengseok) and his map, [hino isuika – Dreamin' attraction!!](https://osu.ppy.sh/beatmapsets/517221). Being featured in the 7K osu!mania World Cup 2017 Finals/Grand Finals mappool, this map brings us a unique BMS experience with mid-high density chordstreams, light jacks and light Long Note sections during the first half. After that, we can appreciate a small break to rest our hands and prepare to the upcoming section.
...
[Bill wurtz - outside](https://osu.ppy.sh/beatmapsets/735580) by ::Nivrad00::{ user=1984634 }\
*written by ::Kamikaze::{ user=2124783 }*

Our last chart in the list, comes from the charter that at this point, everyone knows. The most unique persona in osu!mania's charting scene - ::Nivrad00::{ user=1984634 }. This time we are featuring one of his works made specifically for this year's 7K osu!mania World Cup - [Outside](https://osu.ppy.sh/beatmapsets/735580).
