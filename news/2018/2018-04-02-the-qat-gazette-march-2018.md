...
::Nepuri::{ user=6637817 }, [-Kazu-](https://osu.ppy.sh/users/920861), ::Faputa::{ user=845733 }, [hikikochan](https://osu.ppy.sh/users/6512678), ::Ascendance::{ user=2931883 }, [Sanyi](https://osu.ppy.sh/users/7496029), ::JeirYagtama::{ user=7483452 }, [Arzenvald](https://osu.ppy.sh/users/3027421), ::AJamez::{ user=7890134 }, and [error_exe777](https://osu.ppy.sh/users/7975796)!

Additionally, ::mancuso\1JM\1::{ user=521568 } and [Kisses](https://osu.ppy.sh/users/4276114) are now qualified to check osu!taiko maps alongside their original qualification in osu!
...
- **Metadata branch**: the primary job of the members of this branch is to check the metadata of qualified maps, in order to ensure proper metadata (artist, title, source, tags...). **Members**: ::Kurai (L)::{ user=77089 }, [Doyak](https://osu.ppy.sh/users/2046893), ::Fycho::{ user=1876867 } and [Lanturn](https://osu.ppy.sh/users/1446665).
- **Disqualification branch**: this branch's purpose is mainly to check the reports made by the Quality Assurance Helpers explained above, inform of their validity and disqualify maps accordingly. **Members**: ::Mao (L)::{ user=2204515 }, [Myxomatosis (L)](https://osu.ppy.sh/users/2202645), ::Fycho::{ user=1876867 }, [Lasse](https://osu.ppy.sh/users/896613), ::Mir::{ user=8688812 }, [-Mo-](https://osu.ppy.sh/users/2202163), ::Gabe::{ user=654108 }, [Raiden](https://osu.ppy.sh/users/2239480), ::Nardoxyribonucleic::{ user=876419 }, [JBHyperion](https://osu.ppy.sh/users/4879508), ::Deif::{ user=318565 }, [Kurokami](https://osu.ppy.sh/users/260933), ::Asherz007::{ user=9014047 } and [Protastic101](https://osu.ppy.sh/users/6712747).
- **Moderation Branch**: a branch that spawned with the only purpose of moderating inappropriate beatmap submissions (NSFW content, stolen beatmaps...). **Members**: ::Kurai (L)::{ user=77089 }, [JBHyperion](https://osu.ppy.sh/users/4879508), ::Raiden::{ user=2239480 }, [Deif](https://osu.ppy.sh/users/318565), ::Kurokami::{ user=260933 }, [Fycho](https://osu.ppy.sh/users/1876867) and ::Gabe::{ user=654108 }.
- **Applications branch**: the purpose of this branch is to **judge Beatmap Nominator applicants** of their respective game mode every 6 weeks. **Members**: ::Deif (L)::{ user=318565 }, [JBHyperion](https://osu.ppy.sh/users/4879508), ::Raiden::{ user=2239480 }, [Doyak](https://osu.ppy.sh/users/2046893), ::Fycho::{ user=1876867 }, [Kurai](https://osu.ppy.sh/users/77089), ::Lasse::{ user=896613 }, [Nardoxyribonucleic](https://osu.ppy.sh/users/876419), ::Asherz007::{ user=9014047 }, [Protastic101](https://osu.ppy.sh/users/6712747), ::pishifat::{ user=3178418 }, [Kurokami](https://osu.ppy.sh/users/260933), ::Mao::{ user=2204515 }, [Myxomatosis](https://osu.ppy.sh/users/2202645) and ::Naxess::{ user=8129817 }.
- **Divisions branch**: the Divisions branch is in charge of managing the various Beatmap Nominator subdivisions. **Members**: ::Naxess (L)::{ user=8129817 } and [Mao (L)](https://osu.ppy.sh/users/2204515).
- **Gazette branch**: as the name implies, the members of this branch are responsible of publishing the monthly QAT Gazette which you are reading right now! **Members**: ::JBHyperion (L)::{ user=4879508 }, [Asherz007](https://osu.ppy.sh/users/9014047), ::Protastic101::{ user=6712747 } and [Raiden](https://osu.ppy.sh/users/2239480).
- **Spotlights branch**: its purpose is the management of the monthly Spotlights. **Members**: ::Kurokami (L)::{ user=260933 }, [Nardoxyribonucleic](https://osu.ppy.sh/users/876419) and ::Mao::{ user=2204515 }.
- **UBKRC branch**: the members of this branch take the lead on the Ranking Criteria reworks. **Members**: ::pishifat (L)::{ user=3178418 }.
...
- ::-Mo-::{ user=2202163 } and [Mir](https://osu.ppy.sh/users/8688812), who will be joining the **Disqualification** branch;
- ::Gabe::{ user=654108 }, who will partake the **Moderation** branch;
- ::Feerum::{ user=4815717 }, an old hand who just couldn't stay away and is back once again to rejoin the **Disqualification** branch;
- and finally, ::Lanturn::{ user=1446665 }, who will assist the **Metadata** branch.
