...
Before we begin though, please join me in showing the utmost appreciation for some of our longest serving contributors in the Beatmap Nominators — ::alienflybot::{ user-id=636114 }, [Kagetsu](https://osu.ppy.sh/users/6203841), ::sahuang::{ user-id=5318910 } and [Strategas](https://osu.ppy.sh/users/2971837) (two years of service each), ::Kibbleru::{ user-id=3193504 } (three years) and ::Gero::{ user-id=1467715 }, [jonathanlfj](https://osu.ppy.sh/users/270377), ::Natsu::{ user-id=1953876 } and [smallboat](https://osu.ppy.sh/users/243049), each with a staggering **four years** of cumulative service.

From the Quality Assurance Team, we would also like to recognize the incomparable efforts of ::Deif::{ user-id=318565 } and [p3n](https://osu.ppy.sh/users/123703), who have served admirably in their respective fields for an incredible **four years**.
...
### Status of Beatmap Nominator Applications
