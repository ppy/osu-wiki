...
There was bound to be diversity in the picks, since teams required a whole 7 map wins in order to win in this stage. As the work for the mappool selectors this year has come to an end, here is a closing comment from ::mangomizer::{ user=1893718 }:
...
For more information surrounding the tournament, you can check out [the wiki page](/wiki/Tournaments/TWC/2018) or [the statistics sheet](https://docs.google.com/spreadsheets/d/e/2PACX-1vSp05eL_jYsj4RGa2-lsS39wC1AQDLYXidmQJn0jcLU3c6nETCVZW2BhB5Cy_uIQ_Cp3K_BuTtLJDy4/pubhtml#) by ::Nwolf::{ user=1910766 } and [deadbeat](https://osu.ppy.sh/users/128370).
