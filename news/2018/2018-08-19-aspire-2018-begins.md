...
These three Aspirants, namely ::Charles445::{ user=85000 } with [LeaF - Evanescent](https://osu.ppy.sh/beatmapsets/227126), ::Monstrata::{ user=2706438 } with [IAHN - Transform (Original Mix)](https://osu.ppy.sh/beatmapsets/484689) and ::ProfessionalBox::{ user=3250792 } with [Helblinde - The Solace of Oblivion](https://osu.ppy.sh/beatmapsets/594751) took the beatmapping world by storm, and enshrined their names in osu!'s history forever for their efforts.
...
- **Any entries with additional resources (hitsounds, storyboards, etc) must be submitted in .osz format.** There are no size restrictions this time around, but if your .osz file does not get accepted by the contest system for being too large, PM ::Ephemeral::{ user=102335 } via the forums for assistance.
