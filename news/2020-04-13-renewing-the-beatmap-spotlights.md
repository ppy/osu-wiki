...
- **We'll be hosting weekly timeshift lobbies created from Spotlight beatmap pools** using osu! (lazer release). Timeshift functions similarly to how beatmap charts currently do - if you have never heard of timeshift multiplayer lobbies before, [you should read peppy's article about the new multiplayer paradigm](https://blog.ppy.sh/enjoying-osu-with-others/), or just [hop into osu! (lazer release) yourself and give it a try](https://github.com/ppy/osu/releases).
