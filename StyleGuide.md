# Wiki-styling guide <a name="wsg"></a>

## Table of Contents <a name="TOC"></a>
_Special thanks: <http://ecotrust-canada.github.io/markdown-toc/> (sourced from @TPGPL)_
...
* [Link](#link)
  + [General](#general)
    ...
    - [Wiki Internal links](#wiki-internal-links)
* [Images](#images)
* [Table styling](#table-styling)
* [Unconfirmed](#unconfirmed)
* [GFM offline testing](#gfm-offline-testing)
...
[Click me to go to the title of the page](#wsg "Wiki-styling guide")

---
## Deprecated <a name="#deprecated"></a>

### Table of Content (from @LiquidPL and @TPGPL on Discord, not needed. End-result website will auto-generate TOC) <a name="#dtoc"></a>
_(removed)_

---
## Download <a name="#download"></a>
This comment in downloadable tidy .txt format:

Older versions:-
- v6: [stylingDraftv6.txt](https://github.com/ppy/osu-wiki/files/679812/stylingDraftv6.txt)
- v5: [stylingDraftv5.txt](https://github.com/ppy/osu-wiki/files/679754/stylingDraftv5.txt)
- v4: [stylingDraftv4.txt](https://github.com/ppy/osu-wiki/files/679753/stylingDraftv4.txt)
- v3: [stylingDraftv3.txt](https://github.com/ppy/osu-wiki/files/654885/stylingDraftv3.txt)
- v2: [stylingDraftv2.txt](https://github.com/ppy/osu-wiki/files/644630/stylingDraftv2.txt)
- v1: [stylingDraft.txt](https://github.com/ppy/osu-wiki/files/643622/stylingDraft.txt)
