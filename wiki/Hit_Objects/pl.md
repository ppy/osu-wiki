Obiekt to główny element rozgrywki w osu!. Są trzy typy obiektów:

-   [Kółko](PL:Hit_Circle "wikilink")
-   [Slider](PL:Slider "wikilink")
-   [Spinner](PL:Spinner "wikilink")

Kółka i slidery występują często, natomiast spinnery sporadycznie. Wszystko z czym wchodzisz w reakcję podczas grania w osu! to obiekty.

Kółko
-----

<img src="Hit_circle.png" title="Kółko w domyślnej skórce." alt="Kółko w domyślnej skórce." width="100" />
...
<img src="Slider2.jpg" title="fig:Slider w domyślnej skórce." alt="Slider w domyślnej skórce." width="200" /> ***Osobny artykuł: [Slider](PL:Slider "wikilink")***
