**.osu** to możliwy do przeczytania przez człowieka format plików zawierający informacje o pojedynczej beatmapie.

Format
======

Pierwsza linia pliku oznacza wersję pliku beatmapy. Przykład:

`osu file format v12`

Informacje w tym pliku są podzielone na następujące sekcje (ich nazwy zawsze występują w nawiasach kwadratowych):
...
-   Events -Lista zdarzeń tła
-   Timing Points - Lista punktów rytmiki i dźwięków beatmapy.
-   Colours - Wartości RGB kolorów combo.
-   Hit Objects - Lista obiektów beatmapy.
...
[Category:File Formats/PL](Category:File_Formats/PL "wikilink")
