...
- Si `sliderstartcircle`/`sliderendcircle` existe en una skin sin `sliderstartcircleoverlay`/`sliderendcircleoverlay`, entonces `hitcircleoverlay` no se muestra en los inicios o finales de los sliders.
