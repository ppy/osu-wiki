**skin.ini** adalah file text yang berada di [skin](ID:Skinning "wikilink") folder. File ini dapat digunakan untuk mendefinisikan/Mengatur Skins. [Credits untuk MLGnom.](http://osu.ppy.sh/forum/viewtopic.php?p=815247#p815247)

Seperti di .osu dan .osb files, single-line comments adalah OK:
...
//Your skin's name Name: User

//Your name. Using your forum username is preferred Author: peppy

//The skin version . Use 'latest' to always use the latest skin version. //See main article for more detail on each version. Version: latest
...
`//These should be changed only by the mania binding wizard in the options`
`//The keybind for the first key`
`Key0: A`
`Key1: S`
`Key2: D`
`Key3: F`
