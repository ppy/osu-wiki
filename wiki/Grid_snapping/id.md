...
**Grid snapping** mengacu pada tindakan menggunakan fungsi tombol `Grid Snap` di [editor beatmap](/wiki/Beatmap_Editor). Mengaktifkannya akan memaksa setiap [hit object](/wiki/Hit_object) yang berinteraksi dengan mapper untuk pindah ke posisi terdekat di sepanjang persimpangan grid, atau, dengan kata lain, *"snapping"*. Tombol `Grid Snap` dapat ditemukan di sisi kanan editor.
