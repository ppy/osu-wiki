...
- La première beatmap ranked qui contient au moins une difficultée osu!catch spécifique est [Yousei Teikoku - Dare so Ka no Gekka (TV Size) (NatsumeRin), avec la beatmap osu!catch invitée mappée par Uran](https://osu.ppy.sh/beatmapsets/13676)
