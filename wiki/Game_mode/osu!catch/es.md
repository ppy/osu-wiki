...
- El primer beatmap clasificado que contenía al menos una dificultad de osu!catch fue [Yousei Teikoku - Dare so Ka no Gekka (TV Size)](https://osu.ppy.sh/beatmapsets/13676), con el conjunto de mapas alojado por ::{ flag=CN }:: ::NatsumeRin::{ user-id=151679 } y la dificultad de invitado de osu!catch mapeada por ::{ flag=CN }:: ::Uran::{ user-id=133302 }.
- El primer beatmap clasificado de osu!catch fue [Rita - Hajimari no Toki](https://osu.ppy.sh/beatmapsets/91485) que fue alojado y realizado por ::{ flag=ES }:: ::Deif::{ user-id=318565 }.
