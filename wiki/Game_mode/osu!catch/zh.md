...
- 第一张至少含有一个 osu!catch 难度的上架谱面是 [Yousei Teikoku - Dare so Ka no Gekka (TV Size)](https://osu.ppy.sh/beatmapsets/13676)，谱面主是 ::{ flag=CN }:: ::NatsumeRin::{ user-id=151679 }，osu!catch 客串难度作者是 ::{ flag=CN }:: ::Uran::{ user-id=133302 }。
- 第一张上架的 osu!catch 专谱是 [Rita - Hajimari no Toki](https://osu.ppy.sh/beatmapsets/91485)，谱师是 ::{ flag=ES }:: ::Deif::{ user-id=318565 }。
