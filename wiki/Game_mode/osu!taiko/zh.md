...
- 第一张至少含有一个 osu!taiko 难度的上架谱面是 ::Kharl::{ user=452 } 的 [Taiko no Tatsujin - Saitama2000](https://osu.ppy.sh/beatmapsets/210)。
- 第一张上架的 osu!taiko 专谱是 ::lepidopus::{ user=194807 } 的 [Mutsuhiko Izumi - Red Goose](https://osu.ppy.sh/beatmapsets/55920)。
