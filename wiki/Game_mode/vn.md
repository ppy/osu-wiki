...
osu! hiện tại có 4 **chế độ chơi** tích hợp trong game với những cơ chế khác nhau, thường là được lấy cảm hứng từ các tựa game nhịp điệu khác:
...
Trong osu!(lazer), chúng ta có thể cài thêm một số chế độ chơi tùy chỉnh (có thể gọi là tinh chỉnh quy tắc) qua các file `.dll`. Chúng sử dụng thu viện beatmap hiện có để giới thiệu các cách mới để chơi game osu!. Những chế độ tùy chỉnh này cũng giống những chế độ chính, chúng thường được lấy cảm hứng từ những tựa game nhịp điệu khác.
