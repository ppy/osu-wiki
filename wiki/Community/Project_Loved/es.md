...
- **Los puntos de tiempo no heredados deben ser iguales en todas las dificultades de un mapa.** Esto se puede ignorar en el caso de ciertas mecánicas de juego que involucran cambiar el BPM, velocidad del slider u otros factores que no son relevantes en todas las dificultades.
