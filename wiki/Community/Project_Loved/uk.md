...
**Project Loved** (*проект «Улюблені Мапи»*, також *«Лавед»*) — це платформа для голосування, через яку мапи потрапляють у категорію [Loved](/wiki/Beatmap/Category#loved). Проектом керує [команда Project Loved](/wiki/People/Project_Loved_Team).

## Просування мапи до Loved

Карти отримують статус Loved в процесі номінації та голосування.
...
- [Деякі моменти із розділу метаданих в рейтингових критеріях](/wiki/Ranking_Criteria#metadata):
...
Також, щоб якість аудіо пісні була на достатньому рівні, аудіо файл мапи повинен мати бітрейт як мінімум 128 кіло-біт/с.
...
Починаючи з Лютого 2023, бітмапи режиму гри osu!, які розглядаються для статусу Loved, будуь відповідати новим категорія, а також, правилам і рекомендаціям нижче, які схожі до рейтингових критерій, але адаптовані для менш строгого відбору, за що і є відомий Project Loved.

#### Категоризація

Кожен місця, бітмапи обираються відповідно до 9 категорій з метою забезпечення різноманітності для кожної вибірки мап зробленої капітанами.
...
| Віхилені Рейтингові | Бітмапи, які мають повний набір складностей, який відповідає рейтинговим критеріям, які ще ніколи не досягали Рейтингового статусу. |
...
- **Власник бітмапи не може бути обмеженим.** Рішення щодо гостьових складності від обмежених користувачів будуть прийматися від випадку до випадку, коли мапа розглядається для номінації капітаном Loved.
...
- **Кожна складність бітмапи повинна мати мінімальну тривалість в 20 секунд.** Це є менше ніж 30-секундний мінімум в рейтингових критеріях, задля пслаблення обмежень.
...
- **Всі правила рейтингових критерій і рекомендацій, які прямо не вказані як правила, все ще використовуються як рекомендації.** Рішення щодо примусового виконання цих рекомендацій приймається від випадку до випадку під час процесу номінації Loved, і мапер буде сповіщений на рахунок будь-яких необхідних змін. Зауважте, що повний набір складностей не є необхідним за виключенням категорії *Відхилені Рейтингові*.
- **Метадані бітмапи повинні бути точні настільки, наскільки це можилво.** Бітмапи, які номіновані для голосування Loved, проходять фінальну перевірку метаданих спеціалізованими учасниками ком'юніті. Коректні метадані спрощують пошук бітмапи. Якщо ви сумніваєтресь у їх коректності, зв'яжіться з капітаном Loved.
