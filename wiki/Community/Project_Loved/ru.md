...
Чтобы подать заявку на добавление карты в Loved, [заполните форму](https://loved.sh/submit) на сайте Project Loved. После публикации карту можно будет найти среди прочих номинаций в выбранном режиме игры:
...
Карта, которую номинируют на добавление в Loved, должна соответствовать ряду требований. У каждого режима — свои требования, ниже — универсальный список:
...
Карты, номинируемые на Loved, также должны соответствовать нескольким наборам правил:
...
С февраля 2023 г. карты режима osu!, номинируемые на Loved, должны попадать в одну из указанных ниже категорий, а также следовать дополнительным правилам и рекомендациям. Эти требования похожи на критерии ранкинга, но менее строги — как и сам процесс отбора в Loved.
...
| Категория | Суть |
| :-: | :-- |
| Popular Playcounts | Относительно популярные карты (минимум 100 тысяч игр) |
| Outstanding Oldies | Карты, опубликованные более шести лет назад |
| Small Spectacles | Оригинальные, по мнению капитанов, карты, имеющие менее 5 тысяч игр |
| Daredevil Difficulties | Исключительно сложные карты, разжигающие соперничество между топ-игроками |
...
| Gameplay Gimmicks | Карты, использующие уникальные приёмы: влияющий на игру сториборд, маппинг в стиле Aspire, и т.д. |
...
| Chill Champions | Карты для расслабленной, несоревновательной игры (5 звёзд и ниже) |
...
- **У каждой сложности, входящей в карту, должно быть не менее 20 секунд игрового времени.** По сравнению с критериями ранкинга (30 секунд) это ограничение специально сделано слабее, чтобы меньше сковывать авторов.
...
- **Метаданные карты должны быть как можно более точными** — перед номинацией их проверят специально обученные люди. Этот пункт важен, поскольку карты с правильными метаданными проще найти. Если вы не уверены в точности сведений, покажите карту капитану Loved.
