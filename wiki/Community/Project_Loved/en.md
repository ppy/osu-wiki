...
- **Every person involved in the beatmap must not disapprove of it being Loved.** This includes guest difficulty creators, hitsounders, skinners, and storyboarders. If one of the users involved in the mapset explicitly states their disagreement with their contribution being Loved, then it is to be removed from the mapset after its nomination.
