...
Starting from February 2023, osu! standard beatmaps considered for Loved will follow the Categorisation rules and the Basic Loved Requirements, a set of guidelines similar to the ranking criteria, adapted for a more lenient process Project Loved is known for.
...
Additionally, up to three wildcard beatmaps may be chosen from any category, adding to a total of twelve maps per month. For any questions regarding what goes in each category, contact the osu!standard Loved captains.
