...
Old Avatar Week as an annual event in celebration of the upcoming new year. On December 28 of every year people would change their avatar to one of their older one for one week. This would remind OT regulars of an older time when the person had the avatar, giving a sense of reflection between current times and older times like the transition from the old year to the new year.

### Dancing anime girls

People in the early off-topic days occasionally created threads dedicated to dancing anime girls. If a thread was bad then posting a few dancing anime girls made it better. When people started making threads about quitting OT and actually not quitting, people took that as attention grabbing and posted dancing anime girls to change thread's topic. Eventually posting dancing anime girls on any goodbye or welcome thread was a common thing to do, and thus solidifying as a tradition [[6]](#references).

On 9 June 2017 Ephemeral asserted slightly different version of the tradition into the [off-topic rules](https://osu.ppy.sh/community/forums/topics/604424) by requiring people to post no less than 3 dancing anime girls on birthday threads. This made its way to the osu!'s official rules [[7]](#references) up until 11 November 2019 when it was removed in a cleanup effort. As of writing the rule still stands in the off-topic subforum's rules.


### Exile

Exile is an unofficial moderation concept introduced by Ephemeral in [the grand edict thread](https://osu.ppy.sh/community/forums/topics/604424) in response to people repeatedly spamming the subforum and creating otherwise annoying content. The exile system is enforced by moderation by removing any thread, and sometimes posts, by the person who is exiled. It serves as an indicator that the person is on the verge of being heavily sanctioned by more official means of moderation.

### Denizen

Since the off-topic subforum is composed of mostly the same regulars chatting among themselves in threads, everyone comes to know one another other. Those who stick around long enough to be considered regulars are called "denizen". While this term was first used by Ephemeral in [this thread](https://osu.ppy.sh/community/forums/posts/1607086), it was not adopted by regulars until its popularization by the [OT!News thread series](https://osu.ppy.sh/community/forums/topics/577518).

### OT Lore

OT Lore is an effort started by [abraker](https://osu.ppy.sh/users/4635891) and perpetuated by other denizens to create a story narrative consisting out of various threads people in OT create. The culmination of this effort was compiled into the [OT!Chronicles](https://osu.ppy.sh/community/forums/posts/6230570), and shaped a time period of OT which consisted of many improvised roleplay related threads.

### Thread Derails

Thread derailment is common in OT due to the definition of its nature - "Off-topic". This means a thread created with a topic in mind cannot be expected to remain on that topic.

## Notable threads

Despite majority of OT being nonsense and misc content of unimportance, there are some notable mentions for people unfamiliar with the subforum to check out.
...
OT Court is OT Lore material involving a detailed imitation of an actual trial. Its organization was improvised on the spot and, against all odds, it successfully lasted from beginning to end without lost of interest or being derailed.
...
2. [ppy's announcement of the new subforum](https://osu.ppy.sh/community/forums/posts/8814)

3. [Mention of off-topic subforum's old name](https://osu.ppy.sh/community/forums/posts/132900)

4. [Mention how forum games were being trolled](https://osu.ppy.sh/community/forums/posts/313614)

5. [People's reactions to the off-topic subforum change (Thread 2)](https://osu.ppy.sh/community/forums/posts/316732)
...
7. [Aug 17 2022 capture of osu! official rules ](http://web.archive.org/web/20170817161329/http://osu.ppy.sh/help/wiki/Rules)

8. [Pull request removing osu! off-topic rules from the rules page](https://github.com/ppy/osu-wiki/pull/2655)
