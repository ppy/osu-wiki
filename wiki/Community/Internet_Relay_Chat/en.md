...
| [Konversation](https://konversation.kde.org/) | Check `Hide Join/Part/Nick Events` under Menubar -> `Settings` -> `Configure Konversation...`(`Ctrl`+`Shift`+`,`) -> `Behavior` -> `Chat Window` |
