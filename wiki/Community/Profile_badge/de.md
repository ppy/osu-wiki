...
Ein Nebeneffekt dieses Layout-Schemas war, dass die standardmäßige, nicht erweiterte Höhe von [Benutzerseiten](/wiki/osu!supporter#editierbare-profilsektion) durch das Sammeln weiterer Abzeichen vergrößert werden konnte. Obwohl dies nicht beabsichtigt war, wurde es zu einem Running Gag in der Turnierszene. ::{ flag=US }:: ::Toy::{ user=2757689 } veranschaulichte dies in [einem populären Tweet](https://twitter.com/droombs/status/1036050610687074304), in dem er seinen Rekord für die meisten gewonnenen Abzeichen zum Zeitpunkt der Veröffentlichung zeigte.
...
- Die ersten beiden Profilabzeichen wurden am 6. September 2009 an ::{ flag=PL }:: ::niedzwiedz1124::{ user=9610 } und ::{ flag=PL }:: ::White Wolf::{ user=39828 } für den Gewinn des [*Tag Tournament*](https://osu.ppy.sh/community/forums/topics/17169) verliehen.
