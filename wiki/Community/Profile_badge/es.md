...
- Las dos primeras insignias de perfil se otorgaron a ::{ flag=PL }:: ::niedzwiedz1124::{ user=9610 } y ::{ flag=PL }:: ::White Wolf::{ user=39828 } el 6 de septiembre de 2009 [por ganar el *Tag Tournament*](https://osu.ppy.sh/community/forums/topics/17169).
