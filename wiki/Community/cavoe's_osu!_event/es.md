...
La iteración de 2018 adquirió notoriedad con más de 300 asistentes y una duración de 10 días, presentando a algunos jugadores conocidos como ::{ flag=KR }:: ::chocomint::{ user-id=124493 } (en ese entonces Cookiezi), ::{ flag=US }:: ::BTMC::{ user-id=3171691 } (en ese entonces BeasttrollMC), y ::{ flag=PL }:: ::WubWoofWolf::{ user-id=39828 }.
