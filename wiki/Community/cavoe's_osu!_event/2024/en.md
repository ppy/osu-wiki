...
| Stage coordinator | ::{ flag=CA }:: [Gordon](https://osu.ppy.sh/users/7856835), ::{ flag=FR }:: [Nozhomi](https://osu.ppy.sh/users/2716981), ::{ flag=FR }:: [ThePooN](https://osu.ppy.sh/users/718454) |
...
| :-- | :-- | :-- |
| Efteling trip | July 29 (10:00–20:00) | A trip to [Efteling](https://en.wikipedia.org/wiki/Efteling), a local theme park, via chartered bus |
