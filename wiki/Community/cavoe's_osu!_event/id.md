...
**cavoe's osu! event** (***COE***) merupakan konvensi osu! tahunan di Belanda yang dipelopori oleh ::{ flag=NL }:: ::cavoeboy::{ user=7361815 }. Acara ini merupakan tuan rumah bagi berbagai turnamen dan menghadirkan tempat duduk *bring-your-own computer* (BYOC) yang dapat direservasi, gerai permainan, acara panggung seputar osu!, serta aneka aktivitas lainnya.
...
Konvensi ini kemudian dikembangkan pada tahun 2018 dengan lebih dari 300 peserta selama 10 hari, yang menghadirkan berbagai pemain kenamaan seperti ::{ flag=KR }:: ::chocomint::{ user=124493 } (Cookiezi), ::{ flag=US }:: ::BTMC::{ user=3171691 } (BeasttrollMC), dan ::{ flag=PL }:: ::WubWoofWolf::{ user=39828 }.
