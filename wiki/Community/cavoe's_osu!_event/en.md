...
[Website](https://cavoe.events/) • [Twitter](https://twitter.com/CavoesOsuEvent) • [YouTube](https://www.youtube.com/@coevent) • [Twitch](https://www.twitch.tv/coevent) • [Discord](https://discord.com/invite/d6ru6PVcSY)

:::

**cavoe's osu! event** (***COE***) is an annual osu! convention hosted in the Netherlands, founded by ::{ flag=NL }:: ::cavoeboy::{ user=7361815 }. The event hosts tournaments and features reservable bring-your-own-computer (BYOC) seating, game booths, osu!-related stage events, and other activities.
...
The 2018 iteration expanded into notability with over 300 attendees and a runtime of 10 days, featuring top players such as ::{ flag=KR }:: ::chocomint::{ user=124493 } (then Cookiezi), ::{ flag=US }:: ::BTMC::{ user=3171691 } (then BeasttrollMC), and ::{ flag=PL }:: ::WubWoofWolf::{ user=39828 }.
