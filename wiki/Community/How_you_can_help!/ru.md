...
В 2017 peppy и его команда начали работать над [osu! (lazer release)](https://github.com/ppy/osu) — новым клиентом игры — и [переписывать сайт](https://github.com/ppy/osu-web) на более современные технологии, выложив и то, и другое в открытый доступ.
