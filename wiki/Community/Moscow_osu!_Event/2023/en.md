...
- [Reddit post with group photo of participants](https://www.reddit.com/r/osugame/comments/15fgwc5/moscow_osu_event_2023_july_2930/)

## Organizers
MOE 2023 was held with the help of various members of the osu! [community](wiki/Community)  
| Position | User(s) |
| :-- | :-- |
Organizer | ::{ flag=RU }:: [Stanwald](https://osu.ppy.sh/users/1628227), ::{ flag=RU }:: [\[kr\]](https://osu.ppy.sh/users/9472862), ::{ flag=RU }:: [ThankYou](https://osu.ppy.sh/users/4571241) |
Developer | ::{ flag=RU }:: [\[kr\]](https://osu.ppy.sh/users/9472862), ::{ flag=RU }:: [ThankYou](https://osu.ppy.sh/users/4571241) |
Graphics | ::{ flag=RU }:: [vr_virtux](https://osu.ppy.sh/users/11531550), ::{ flag=RU }:: [Arhella](https://osu.ppy.sh/users/4411044), ::{ flag=RU }:: [-database-](https://osu.ppy.sh/users/4411044) |
Technical specialist | ::{ flag=RU }:: [Rainbowtaves](https://osu.ppy.sh/u/10079847), ::{ flag=RU }:: [InditaiX](https://osu.ppy.sh/users/8303943) | 
