...
Les **quêtes** récompensent les mappeurs pour avoir suivi certaines exigences pendant la création des beatmaps Featured Artists. Le plus souvent, les quêtes impliquent qu'un certain nombre de beatmaps pour un Artiste Associé soit crée, cependant les quêtes impliquent aussi quelques petits gadgets.
