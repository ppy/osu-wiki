...
**up.ppy.sh**, often referred to as **upppy**, was a file uploading service run and hosted by ::{ flag=AU }:: ::peppy::{ user=2 }. It was first established in January 2007, predating osu! itself[^upppy-launch-date-ref], and was mainly used to share images and files within the osu! community.
