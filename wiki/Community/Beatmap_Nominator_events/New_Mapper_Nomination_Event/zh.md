...
**萌新谱师审核活动**于 2021 年 **3 月 1 日**至 **5 月 31 日**之间举行。

在活动期间，谱面审核成员 (BN) 的任务是根据自己选择的游戏模式，为从未在该模式下上架过谱面（俗称飞图）的用户所创作的谱面进行审核，并尝试帮助他们将图上架。只有在活动期间[过审](/wiki/Beatmap_ranking_procedure#qualification)的谱面才有资格被提名上架。
