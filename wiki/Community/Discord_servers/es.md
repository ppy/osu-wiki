...
| [![](img/Mentorship.png)](https://discord.com/invite/Ft2FtXmBgx) | [Mentorship](https://discord.com/invite/Ft2FtXmBgx) | ::{ flag=DE }:: [Okoayu](https://osu.ppy.sh/users/1623405) | El servidor **Mentorship** gestiona el [Community Mentorship Program](/wiki/Community/Community_Mentorship_Program), albergando clases por temporadas para enseñar y aprender a [mapear](/wiki/Beatmapping) y a [modear](/wiki/Modding) para todos los modos de juego. |
...
| [![](img/poolingcore.png)](https://discord.com/invite/gpEbCBE7Jg) | [poolingcore](https://discord.com/invite/gpEbCBE7Jg) | ::{ flag=CA }:: [chiv](https://osu.ppy.sh/users/6701656) | **poolingcore** ofrece recursos en torno al mappooling y el mapping de torneos, principalmente en el modo de juego osu!. El servidor organiza ocasionalmente juegos y concursos relacionados con el mappooling y permite a los anfitriones verificados reclutar mappoolers activos y mappers para sus torneos. |
