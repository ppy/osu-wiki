...
| [![](img/ThePooN.png)](https://discord.gg/ThePooN) | [ThePooN](https://discord.gg/ThePooN) | ::{ flag=FR }:: [ThePooN](https://osu.ppy.sh/users/718454) | **ThePooN**'s Discord server is the main hub for users encountering issues with osu! on [Linux](https://en.wikipedia.org/wiki/Linux). It also provides general tech support. |
