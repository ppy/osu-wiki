...
| [![](img/ThePooN.png)](https://discord.gg/ThePooN) | [ThePooN](https://discord.gg/ThePooN ) | ::{ flag=FR }:: [ThePooN](https://osu.ppy.sh/users/718454) | **ThePooN**'s Discord server is the main hub for any issues you may have with osu! on Linux, and also has channels for general tech support and chatting. |
