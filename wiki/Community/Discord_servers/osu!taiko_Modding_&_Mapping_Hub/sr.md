...
![Server banner](img/banner.jpg "osu!taiko Modding & Mapping Hub банер сервера, дизајнирано од стране корисника Jerry")
...
- Место за дељење редова за модификовање како би корисници стекли више искуства.
