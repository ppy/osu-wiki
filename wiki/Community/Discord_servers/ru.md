...
| [![](img/ThePooN.png)](https://discord.gg/ThePooN) | [ThePooN](https://discord.gg/ThePooN) | ::{ flag=FR }:: [ThePooN](https://osu.ppy.sh/users/718454) | Discord-сервер **ThePooN** является сервером для пользователей, имеющих проблемы с osu! на [Linux](https://ru.wikipedia.org/wiki/Linux). Также предоставляет общую техническую поддержку. |
