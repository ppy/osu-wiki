...
- Die Versionsnummer oder das Veröffentlichungsdatum eines osu!-Clients
- Die Veröffentlichungsart eines osu!-Clients (`Stable`, `Stable (Fallback)`, `Beta`, oder `Cutting Edge (Experimental)`)
