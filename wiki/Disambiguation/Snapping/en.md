...
- [Beat snapping](/wiki/Beatmapping/Beat_snapping), a hit object's position within a single musical beat, which is split automatically using the [beat snap divisor](/wiki/Client/Beatmap_editor/Beat_snap_divisor)
