# Snapping (disambiguasi)

**Snapping** dapat memiliki beberapa arti:

## Beatmapping

- [Beat snapping](/wiki/Beatmapping/Beat_snapping), posisi dari sebuah *hit object* pada satu ketukan musik, yang dibagi secara otomatis menggunakan [beat snap divisor](/wiki/Client/Beatmap_editor/Beat_snap_divisor)
