# Snapping (désambiguïsation)

Le **Snapping** peut avoir plusieurs significations :

## Beatmapping

- Le [beat snapping](/wiki/Beatmapping/Beat_snapping), la position d'un objet dans un seul temps musical, qui est divisé automatiquement en utilisant le [beat snap divisor](/wiki/Client/Beatmap_editor/Beat_snap_divisor).
