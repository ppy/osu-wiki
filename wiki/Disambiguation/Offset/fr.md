...
- Le [Online offset](/wiki/Beatmap/Online_offset), un changement de timing appliqué par un membre du [NAT](/wiki/People/The_Team/Nomination_Assessment_Team) aux beatmaps classés avec un offset incorrect non hérité afin de l'ajuster.
- Le [Décalage local ("hors ligne")](/wiki/Glossary#local-song-offset), un paramètre par beatmap qui décale les objets dans le temps pendant le jeu.
