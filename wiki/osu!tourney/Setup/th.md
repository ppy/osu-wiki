...
**โน้ต:** ต้องมี supporter tag ในการใช้ osu!tourney
...
ซึ่งในการทำแบบนี้ คัดลอกไฟล์ `osu!.exe` และวางไว้ที่โฟลเดอร์เปล่าและเปิดไฟล การติดตั้ง osu! ใหม่จะถูกสร้างขึ้นมา และนี่เป็นการติดตั้งเดียวที่จะถูกแก้ไขต่อจากนี้ไป
...
เพิ่มเพลงจากแมพพูลไปที่โฟลเดอร์ `/Songs/` ก่อนที่จะเปิดตัว client แมพใดก็ตามที่ client ไม่มีจะถูกดาวน์โหลดโดยอัตโนมัติ (ต้องเป็นแมพที่อัปโหลดแล้ว)
...
อย่าแก้ไขไฟล `tournament.cfg` ระหว่างที่ osu! กำลังทำงานอยู่ ปิด osu! และแก้ไขหรือเพิ่มสิ่งต่อไปนี้ตามที่จำเป็น :
...
- `acronym`: ชื่อย่อของทัวร์นาเมนต์ ซึ่งจะมีผลต่อกรตั้งชื่อห้องทัวร์นาเมนต์ สามารถดูข้อมูลเพิ่มเติมได้ที่ [การใช้งานในห้องผู้เล่นหลายคน](/wiki/osu!tourney/Multiplayer_Usage)
...
- `Height`: ความสูงของพื้นที่ที่จะถ่ายทอดสดของ client
  - Client จะหาความกว้างโดนใช้อัตราส่วน 16:9
  ...
  - ค่าเริ่มต้น: 720 ระยะของค่าที่อนุญาติ: 568-2160
