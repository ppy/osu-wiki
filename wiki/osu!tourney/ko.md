...
사용의 **문제**가 있는 경우 **[문제해결](KO:Osu!tourney#문제해결 "wikilink")** 섹션을 읽거나, **[이 스레드](https://osu.ppy.sh/forum/t/327120)**에 게시 할 수 있습니다. 
...
-   **acronym:** 당신의 토너먼트에 대한 약자를 넣으세요, 예) 'OWC 2013'. **[멀티플레이 세션 생성 및 조작에 대한 자세한 내용](KO:Osu!tourney#플레이어 세션 생성 및 조작 "wikilink")**.
...
**[자세한 내용은 멀티플레이어 세션 생성 및 조작을 참조하십시오.](KO:Osu!tourney#멀티플레이어 세션 생성 및 조작 "wikilink")**
...
예를 들어, 이 값은 **[설정]**(KO:Osu!tourney#설정 "wikilink"). "Test Tourney"로 정의되었습니다. 다음 예제에서는 템플릿을 사용합니다.
...
**osu!tourney 사용법** 섹션에서 설명한대로, 클라이언트의 각 화면은 멀티 플레이어 로비슬롯에 배정됩니다. 
...
배경파일이 다음위치에 있는지 확인하십시오. `.../osu!/Skins/User/tournament/background.png`. See **[스킨](KO:Osu!tourney#스킨 "wikilink")**.
...
-   정확한 멀티방 이름을 사용했는지 확인하십시오. (see **[매칭설정](KO:Osu!tourney#매칭설정 "wikilink")**). 참조하십시오.
-   실수한 경우 방을 다시 만듭니다.
