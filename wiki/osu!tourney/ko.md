...
이 클라이언트를 사용하면서 **문제에** 직면한 경우 [troubleshooting guide](/wiki/osu!tourney/Troubleshooting "Troubleshooting") 를 읽거나  [tournaments@ppy.sh](mailto:tournaments@ppy.sh) 로 메일을 보내주세요.
