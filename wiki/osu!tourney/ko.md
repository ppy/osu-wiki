...
열린 창 개수는 현재 변경할 수 없지만, 이 동작은 나중에 수정됩니다.
...
-   **acronym:** 당신의 토너먼트에 대한 약자를 넣으세요, 예) 'OWC 2013'. **[멀티플레이 세션 생성 및 조작에 대한 자세한 내용](Osu!tourney#Multiplayer_session_creation_and_handling "wikilink")**.
...
**[자세한 내용은 멀티플레이어 세션 생성 및 조작을 참조하십시오.](Osu!tourney#Multiplayer_session_creation_and_handling "wikilink")**
...
예를 들어, 이 값은 **[Setup]**(Osu!tourney#Setup "wikilink"). "Test Tourney"로 정의되었습니다. 다음 예제에서는 템플릿을 사용합니다.
...
경기가 끝나면, ㄹ`!mp close` 명령을 보내 방을 닫아야 합니다. 
