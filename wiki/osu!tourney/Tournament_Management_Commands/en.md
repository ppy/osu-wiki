...
- `!mp makeprivate <name>` - Creates a private tournament room with the specified name. This command works the same as `!mp make` but match history is only visible to room creator and participant.
