...
ต่อไปนี้คือคำสั่งเพื่อที่จะใช้ในการจัดการทัวร์นาเม้นในห้องผู้เล่นหลายคน:

- `!mp make <ชื่อห้อง>` - สร้างห้องทัวร์นาเม้นด้วยชื่อที่กำหนดไว้ สามารถสร้างห้องได้มากสุด 4 ห้อง
...
- `!mp invite <ชื่อผู้ใช้>` - เชิญู้เล่นเข้าห้องผู้เล่นหลายคน
  - จำไว้ว่านี่*ไม่*ได้เป็นข้อยกเว้นของ "ไม่รับข้อความส่วนตัวจากคนที่ไม่ใช่เพื่อน" ดังนั้นทีมงานของทัวร์นาเม้นจะต้องบอกผู้เล่นว่าให้ปิด "ไม่รับข้อความส่วนตัวจากคนที่ไม่ใช่เพื่อน" ในการตั้งค่าของ osu!
- `!mp lock` - ล็อกเพื่อไม่ให้ผู้เล่นเปลี่ยนทีมหรือตำแหน่งของช่อง
- `!mp unlock` - ยกเลิกอันข้างบน
...
- `!mp host <ชื่อผู้ใช้>` - โอนสถานะเจ้าของห้องให่ผู้เล่นอื่น
...
- `!mp timer [<เวลา>]` - เริ่มตัวจับเวลา
  ...
  - ตัวจับเวลาจะประกาศทุก ๆ นาที, 30วิ, 10วิ, 5วิ และน้อยกว่านั้น
...
พวกเราหวังว่าคุณจะใช้คำสั่งเหล่านี้อย่างเป็นประโยชน์และมีความรับผิดชอบ การละเมิดคำสั่งเหล่านี้ในการรบกวรการเล่นของผู้เล่น จะถูกลงโทษเนื่องจากเป็นการขัดต่อ [กฎของชุมชน](/wiki/Rules)
