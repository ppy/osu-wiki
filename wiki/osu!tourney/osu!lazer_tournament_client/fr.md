...
Ouvrez le osu!lazer tournament client et vous verrez cet écran de configuration :

![Écran de configuration de osu!lazer tournament client](img/setup-screen.png)
