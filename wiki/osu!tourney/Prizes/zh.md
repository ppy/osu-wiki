...
玩家的违规行为将不会被具体说明，也不会提供这些帐户状态的进一步信息。请不要要求任何细节或证据，无可奉告。对筛选结果不满意的个体玩家应直接咨询 accounts@ppy.sh。

Staff 在比赛期间发现任何潜在的可疑行为，有义务通过 tournaments@ppy.sh 报告给支持团队。
...
如果你的比赛符合以上所有标准，并有一个徽章设计可供提交，**请联系 tournaments@ppy.sh** 并包含以下信息：
