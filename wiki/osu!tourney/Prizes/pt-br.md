...
O osu!team pode (a seu critério), fornecer a um torneio feito pela comunidade com uma *medalha de perfil*, uma recompensa especial visível no perfil do jogador.

Essas medalhas tipicamente mostram a habilidade e destreza de um jogador em um torneio e, portanto, são regulamentados para garantir que retenham seu valor e valor.

### Critério para torneios aplicáveis
