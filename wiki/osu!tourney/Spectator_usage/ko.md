...
![방이 제대로 생성되었다면, 클라이언트 하단에 방의 이름이 표시됩니다.](img/Osutourneyroomlist.png)

방이 제대로 생성되어 목록에서 확인할 수 있게 되면, 이를 클릭할 수 있게 됩니다. 이는 osu!tourney 클라이언트가 해당 방의 관전을 시작하게 해줍니다.

![팀명과 플레이어명은 자동으로 배정됩니다.](img/Osutourneyidle.png)

![현재 팀 별 점수와 현재 무슨 곡을 플레이하는 중인지 표시됩니다.](img/Osutourneyspectate.png)

![매치가 종료되면 승자가 자동으로 선언되며, 승리 팀에 별이 추가됩니다. 페일한 플레이어의 화면은 회색빛으로 바뀝니다.](img/Osutourneyresults.png)

마우스 좌클릭으로 별의 개수를 늘리거나 우클릭으로 별의 개수를 낮출 수 있습니다.

![제어판에서 주석을 작동시킴으로서 주석을 표시할 수 있습니다.](img/Osutourneywarmup.png)
