...
-   [토너먼트 스텝](https://osu.ppy.sh/g/26)그룹에 속하는지 확인하세요. 사용자 그룹. 대부분의 경우에는 일시적으로 추가되므로 액세스가 만료되었을 수 있습니다.
...
스트리밍을 설정하려면 Open Broadcaster Software를 사용하는 것이 좋지만 액세스 권한이 있는 다른 스트리밍 클라이언트를 자유롭게 사용할 수도 있습니다. osu! tourney의 윗부분의 해상도는 1280x720입니다. 검은색 컨트롤 패널을 스트리밍하지 마십시오.
