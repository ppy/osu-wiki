...
5. Секция `Beatmap Ranking` доступна только для карт с онлайн-топом: ([квалифицированных](/wiki/Beatmap/Category#qualified), [ранкнутых](/wiki/Beatmap/Category#ranked) или [любимых](/wiki/Beatmap/Category#loved)). Вам также нужно подключение к Интернету, чтобы увидеть этот раздел.
   ...
   4. `Ranked Score`: ваш [лучший счёт](/wiki/Score/Ranked_score) на карте.
...
6. Секция `Overall Ranking`. Доступно только для карт с онлайн-топом. Вам также нужно подключение к Интернету, чтобы увидеть этот раздел.
   ...
   4. [`Ranked Score`](/wiki/Score/Ranked_score): число очков, полученных за все ранкнутые карты, которые вы сыграли, засчитывается только лучший результат на каждой карте.
   5. [`Total Score`](/wiki/Score/Total_score): то же, что и ranked score, но учитывает все доступные на сайте osu! карты, а также недоигранные и проваленные попытки. Влияет на ваш уровень.
