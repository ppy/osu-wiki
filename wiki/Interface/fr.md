...
![Écran d'introduction](img/Intro_static.jpg)
...
- \[10\] En haut à droite se trouve le juke-box osu ! qui joue les chansons dans un ordre aléatoire. Le haut indique la chanson en cours de lecture. Les boutons, de gauche à droite, fonctionnent comme suit :
  ...
  - Prochaine piste
  - Voir les informations sur la chanson. La barre du haut affiche les informations sur la chanson de façon permanente ou temporaire. Lorsqu'elle est permanente, la barre d'information reste visible jusqu'à ce qu'elle s'efface avec le reste de l'interface utilisateur. Lorsqu'elle est temporaire, elle disparaîtra un peu après qu'une chanson ait été choisie. Elle reste cachée jusqu'à ce qu'on la fasse basculer à nouveau ou qu'une autre chanson soit jouée.
...
![Menu de jeu](img/Introscreen2.jpg)

- Cliquez sur `Solo` (`P`) pour jouer seul.
- Cliquez sur `Multi` (`M`) pour jouer avec d'autres personnes. Vous serez dirigé vers le lobby du [Multi](/wiki/Multi) (voir ci-dessous).
- Cliquez sur `Back` pour revenir au menu principal.

## Lobby du Multijoueur
...
![Écran de sélection des chansons](img/Soloplay1.jpg)

Vous pouvez identifier le mode actuel sélectionné soit en regardant l'icône en bas à droite, en haut de Mode, soit en regardant l'icône transparente au centre de l'écran. Ce sont les quatre que vous verrez :

- ![][Osu!] est [osu!](/wiki/osu!)
- ![][Taiko] est [osu!taiko](/wiki/osu!taiko)
- ![][Ctb] est [osu!catch](/wiki/osu!catch)
- ![][Mania] est [osu!mania](/wiki/osu!mania)

Avant de continuer, cet écran comporte trop d'éléments à noter avec des chiffres facilement perceptibles. Les sous-sections ci-dessous se concentrent sur une partie de l'écran à la fois, en partant du haut vers le bas et de gauche à droite.

### Informations Beatmap
...
Cliquez sur l'un des onglets pour **trier votre liste de chansons en fonction du critère sélectionné**.
...
- `creator`: Nom du créateur du beatmap
- `ar`: Taux d'approche
- `cs`: Taille du cercle
...
Vous pouvez également entrer un numéro d'identification (beatmap ou beatmapset) dans votre recherche pour obtenir un résultat unique.
...
- Classement des pays\*
- Classement mondial
- Classement mondial (Mods sélectionnés)\*
- Classement des amis\*

\*Vous devez être un [osu!supporter](/wiki/osu!supporter) pour y accéder.
...
Cliquez sur le bouton `Mods` ou pressez `F1` pour ouvrir le **[Écran de sélection du mod](/wiki/Game_Modifiers/)**.

Dans cet écran, vous pouvez appliquer des modifications ("mods" en abrégé) au gameplay. Certains mods diminuent la difficulté et appliquent un multiplicateur qui fait baisser le score que vous obtenez. Inversement, certains mods augmentent la difficulté, mais appliquent un multiplicateur qui augmente le score que vous obtenez. Enfin, certains mods modifient le gameplay d'une manière différente. [Relax](/wiki/Game_Modifiers/#Relax) et [Auto Pilot](/wiki/Game_Modifiers/#Auto_Pilot) font partie de cette catégorie.
Placez votre souris sur l'icône d'un mod pour voir une courte description de son effet. Cliquez sur une icône pour sélectionner ou désélectionner ce mod. Certains mods, comme Double Time, ont de multiples variations ; cliquez à nouveau sur le mod pour le parcourir. La valeur du multiplicateur de score affiche l'effet combiné que les multiplicateurs du ou des mods que vous avez sélectionnés auront sur votre score. Cliquez sur "Reset all mods" ou appuyez sur 1 pour désélectionner tous les mods actuellement sélectionnés. Cliquez sur `Close` ou pressez `2` ou `Esc` pour revenir à l'écran de sélection des chansons.

Tant que vous êtes sur l'écran de sélection du modem, vous ne pouvez pas accéder aux consoles de chat et de chat étendu. De plus, les skins peuvent modifier le texte et/ou l'icône des mods, mais les effets seront toujours les mêmes.

Cliquez sur le bouton `Random` ou pressez `F2` Vous ne pouvez pas sélectionner une carte de rythme vous-même avant qu'elle n'ait fini de défiler.

*Note : Vous pouvez appuyer sur `Shift` + le bouton `Random` ou `F2` pour revenir à la feuille de route que vous aviez sélectionnée avant de faire votre choix au hasard.*

![Commandes possibles pour un beatmap](img/Soloplay9.jpg)
...
![Précision dans osu!standard](img/Accuracy_osu!.jpg)

Il s'agit de l'écran de notes affiché après que vous ayez réussi à passer le beatmap. Vous pouvez accéder à vos résultats en ligne en faisant défiler l'écran vers le bas ou en appuyant sur le bouton "évident".

**Note:** Le grade de la peau varie selon la peau utilisée.

Vous trouverez ci-dessous les écrans de classement des autres modes de jeu.

![Précision dans Taiko](img/Accuracy_Taiko.jpg "osu!taiko")

![Précision dans osu!mania](img/Accuracy_Mania.jpg "osu!mania")

![Précision dans Catch the Beat](img/Accuracy_CtB.jpg "osu!catch")

### Tableau d'affichage en ligne

![C'est vrai : Exemple d'un score osu!online. (6) a été édité dans .](img/Osu!_Online_score.jpg)
...
![Débloquer une médaille](img/MedalUnlock.jpg)

Ci-dessus, vous voyez à quoi ressemble une médaille.
