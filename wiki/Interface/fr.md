...
Le [logo d'osu!](/wiki/fr/Glossary/Cookie) \[1], situé au milieu de l'écranm bat en fonction du [BPM](/wiki/fr/Beatmapping/Beats_per_minute) de la musique en cours de lecture. On peut également voir plusieurs barres autour du logo qui changent de taille en fonction du volume de la musique. Si aucun morceau n'est joué, le logo bat par défaut à un rythme de 60 BPM.

Voici les éléments du menu principal (les raccourcis claviers sont indiqués entre parenthèses) :

-   \[2] Cliquez sur `Play` (`P`) ou sur le logo pour accéder au menu concernant le mode de jeu (Solo ou Multi).
-   \[3] Cliquez sur `Edit` (`E`) pour ouvrir le menu de sélection des beatmaps dans l'[éditeur](/wiki/fr/Beatmap_Editor).
-   \[4] Cliquez sur `Options` (`O`) pour afficher l'écran des [options](/wiki/fr/Options).
...
-   \[8] Le statut de la connexion à [Bancho](/wiki/fr/Bancho_(server))!. Il n'est pas présent sur l'image ci-dessus, mais le statut est représenté par un maillon de chaîne. Un coeur est également présent si vous êtes un osu!supporter
-   \[9] En bas à droite se trouve les boutons de contrôles du [tchat](/wiki/fr/Internet_Relay_Chat)(les raccourcis clavier sont `F8` pour le bouton "Show Chat" et `F9` pour le bouton "Online Users").
-   \[10] Si vous êtes un osu!supporter, le bouton à la droite de l'écran (normalement invisible) permet de télécharger des beatmaps directement depuis osu!.
-   \[11] En haut droite se situe un jukebox qui joue les musiques que vous possédez dans le jeu dans un ordre aléatoire. La partie la plus haute indique la musique actuellement jouée. Les boutons, de gauche à droite, effectuent ces actions:
    -   Passer à la musique précédente
    -   Jouer la musique
    -   Mettre en pause la musique
    -   Arrêter la musique (ici, si on réappuie sur le bouton, la musique recommence du début au lieu de reprendre là où on l'a mise en pause)
    -   Passer à la musique suivante
    -   Voir le nom de la musique. Cette option change le statut de la barre du haut entre "permanente" et "temporaire". Si son statut est permanent, elle restera présente à l'écran jusqu'à ce qu'on change de menu. Si son statut est temporaire, elle disparaîtra au bout de quelques secondes après le choix de la musique et restera cachée jusqu'à ce qu'on change son statut ou au moment où la musique change.
    -   Afficher la liste des musiques présentes dans le jeu
-   \[12] A côté de votre profil se situe le nombre de beatmaps que vous possédez, le temps depuis lequel osu! est en marche et l'heure qu'affiche votre ordinateur.
-   \[13] Dans le coin supérieur gauche se trouve votre profil, cliquez dessus pour afficher vos options en tant que tel.
...
2.  `Se déconnecter`: Vous déconnecte d'osu! (le menu latéral des [options](/wiki/fr/Options) apparaîtra, vous permettant de rentrer votre pseudonyme et votre mot de passe)
3.  `Changer d'avatar`: Ouvre la page permettant de modifier votre photo de profil dans votre navigateur Internet.
...
_Pour plus d'informations: [Multi](/wiki/fr/Multi)_
...
-   \[2] Votre profil.
-   \[3] Le jukebox.
-   \[4] La liste des joueurs. On peut y voir le nom des joueurs, leur rang (hôte ou participant), les [mods](/wiki/fr/Game_modifier) qu'ils ont choisis (s'il y en a, voir #7), leur classement sur osu!, ainsi que leur équipe (si le type de partie est réglé sur `Team VS` ou `Tag-team VS`).
-   \[5] Le nom de la salle et les paramètres du mot de passe.
-   \[6] La beatmap choisie. Elle est montrée comme dans le menu de sélection de musique dans le mode Solo.
-   \[7] Les [mods](/wiki/fr/Game_modifier) que vous avez activé (voir #12), ainsi que l'option pour les sélectionner. L'option intitulée "Mods libres" décide de si les joueurs peuvent choisir leurs propres mods ou non. Si elle est activée, les joueurs peuvent choisir n'importe quelle combinaison de mods _sauf les mods altérant la vitesse de la beatmap, c'est-à-dire [Double Time](/wiki/fr/Game_modifier/Double_Time) et [Half Time](/wiki/fr/Game_modifier/Half_Time)_. Si elle est désactivée, l'hôte décide de quels mods seront utilisés. L'hôte peut choisir les mods altérant la vitesse de la beatmap peu importe si l'option "Mods libres" est activée ou non.
-   \[8] Le type de partie et les conditions de victoire.
-   \[9] Le bouton "Je suis prêt !".
-   \[10] La [console de tchat](/wiki/fr/Chat_Console).
-   \[11] Le bouton "Quitter la salle".
-   \[12] Là où se trouvent les mods activés, que ce soit par vous ou par l'hôte.
...
-   ![](/wiki/shared/mode/osu.png) correspond au mode [osu!](/wiki/fr/Game_mode/osu!)
-   ![](/wiki/shared/mode/taiko.png) correspond au mode [osu!taiko](/wiki/fr/Game_mode/osu!taiko)
-   ![](/wiki/shared/mode/catch.png) correspond au mode [osu!catch](/wiki/fr/Game_mode/osu!catch)
-   ![](/wiki/shared/mode/mania.png) correspond au mode [osu!mania](/wiki/fr/Game_mode/osu!mania)
...
![](img/beatmap-metadata-FR.jpg "Métadonnées d'une beatmap")

Dans cette partie de l'écran se situe **les informations sur la difficulté de la beatmap choisie.** Par défaut, la beatmap dant la musique a été choisie dans le jukebox est choisie quand on entre dans l'écran de sélection. En haut à gauche se situe la catégorie de la map (par exemple, deux chevrons signifient que la beatmap est _classée._). A sa droite se situe le titre de la beatmap. Par défaut, le titre romanisé est affiché, mais si vous sélectionnez `Métadonnées des maps dans leur langue d'origine dès que possible` dans les [options](/wiki/fr/Options), le titre au format Unicode sera affiché, comme on peut voir sur la première image. Le créateur de la beatmap est également affiché, ainsi que les informations de la beatmap en dessous. De gauche à droite, on peut lire :

-   **Durée**: La durée totale de la beatmap, du début à la fin et en comptant les pauses. A ne pas confondre avec la [longueur de drain](/wiki/fr/Gameplay/Drain_time).
-   **BPM**: Le BPM de la beatmap. Si (comme sur la deuxième image) deux BPMS sont présents, dont un entre parenthèses, cela veut dire que le BPM change pendant la musique. On peut y voir le BPM le plus lent et le BPM le plus rapire, tandis que la valeur entre parenthèses est le BPM au début de la beatmap.
-   **Objets**: Le nombre total d'[objets](/wiki/fr/Hit_Objects) dans la beatmap.
...
-   **OD**: La [difficulté générale](/wiki/fr/Beatmapping/Overall_Difficulty) de la beatmap.
-   **HP**: Le taux de drain de votre barre de vie. Dans osu! et osu!catch, cette valeur détermine combien de PV (points de vie) sont perdus en ratant une note, combien de PV sont gagnés en cliquant sur une note, et à quelle vitesse la barre de vie se vide quand aucune action n'est effectuée. Dans osu!mania, son fonctionnement est identique, sauf que ce coup ci la barre de vie ne se vide pas toute seule. Dans osu!taiko, cette valeur détermine à quelle vitesse la barre de vie se remplit et combien de PV sont perdus quand une note est ratée.
-   **Stars**: La difficulté (en étoiles) de la beatmap. Elle est également visible sur le rectangle de la beatmap.

### Regrouper et trier

![](img/beatmap-filters-FR.jpg "Onglets contenant les critères disponibles")

Cliquez sur un des onglets pour **trier votre liste de musique en fonction du critère choisi**.

**Regrouper** - La plupart de ces options organisent les beatmaps en plusieurs groupes:

-   `Ne rien regrouper` - Les beatmaps ne seront pas regroupées, mais seront quand même triés dans l'ordre choisi dans le menu Trier.
...
-   `Par créateur` - Les beatmaps seront regroupées en fonction de la première lettre du nom du créateur de celles-ci.
...
-   `Par difficulté` - Les beatmaps seront regroupées en fonction de leur difficulté (arrondie à l'entier près).
...
-   `Collections` - Les collections que vous avez créées seront affichées. _Attention : ce paramètre cachera toutes les beatmaps ne faisant pas parties d'une collection!_
-   `Favoris` - Seules les beatmaps faisant partie de vos favoris (visibles sur votre profil en ligne) seront affichées.
-   `Mes beatmaps` - Seules les beatmaps que vous avez créées (ou dont le nom du créateur correspond au votre) seront affichées.
...
-   `Par difficulté` - Les beatmaps seront triées en fonction de leur difficulté, de la plus facile à la plus difficile.  _Attention : ce paramètre séparera les difficultés des sets de beatmaps!_
...
_Remarque: Il est impossible d'effectuer une recherche tout en ayant la console de chat ou le menu des options ouvert. En effet, tout ce qui sera écrit sera considéré comme un message dans le chat ou une recherche dans les options._

Seules les beatmaps correspondant au(x) critère(s) présent(s) dans votre recherche seront affichés. Par défaut, toutes les recherches seront comparées aux artistes, titres, créateurs et mots-clés des beatmaps.

En plus de rechercher des mots en particulier, vous pouvez utiliser des filtres pour effectuer une recherche en fonction d'autres données eb combinant un des filtres supportés (voir ci-dessous) avec une comparaison associée à une valeur (par exemple, `hp>6`).

Filtres supportés (en anglais):
...
-   `keys`: Nombre de touche (uniquement en osu!mania et pour les beatmaps converties)
-   `stars`: Difficulté (en étoiles)
-   `bpm`: Battements par minute
-   `length`: Durée (en secondes)
-   `drain`: Temps de drain (en secondes)
-   `mode`: Le mode. La valeur peut être `osu`, `taiko`, `catchthebeat`, ou `mania` (ou, pour faire court, `o`/`t`/`c`/`m`).
...
-   `unplayed`: N'affiche uniquement les beatmaps non jouées. Une comparaison sans valeur ajoutée doit être utilisée (la comparaison en elle même étant ignorée).
-   `speed`: La vitesse de défilement sauvegardée en osu!mania. Cette valeur sera toujours égale à 0 sur les beatmaps non jouées si l'option [Se souvenir des vitesses de défilement sur chaque map osu!mania](/wiki/fr/Options#gameplay) est désactivée.
...
-   Une boîte "Latest pending version" qui apparaît signifie que la beatmap a été mise en ligne sur le site d'osu!, mais n'est pas encore classée.
-   Si des replays correspondants au paramètre d'affichage de la beatmap existent, ils seront affichés à la place de la boîte indiquant le statut de celle-ci, comme on peut le voir sur l'image ci-dessus.
    -   En dessous des classements publics (par exemple, Général, National, etc.), votre meilleur score sera affiché en bas, ainsi que votre rang dans celui-ci.
-   Une boîte "No records set!" indiquant qu'il n'existe aucun replay pour le paramètre d'affichage actuel (on la voit très souvent dans le paramètre d'affichage "Local" si vous venez juste de télécharger ou d'éditer une beatmap).
...
\*Pour y accéder, vous devez être un [osu!supporter](/wiki/fr/osu!supporter).
...
-   Appuyez sur `3` ou `Echap` ou cliquez sur le bouton `Cancel` pour retourner au menu de sélection de musique.

Tant que vous êtes sur ce menu, il est impossible d'accéder à la console de chat et à la console de chat étendue.
...
L'icône transparente au milieu de l'écran ainsi que celui dans le bouton `Mode` vont changer pour représenter le mode choisi.

![](img/game-modifiers-FR.jpg "Écran de sélection des mods")

Cliquez sur le bouton `Mods` ou appuyez sur `F1` pour accéder à l'**[écran de sélection des mods](/wiki/fr/Game_modifier)**.

Sur cet écran, vous pouvez modifier le gameplay. Certains mods baissent la difficulté de la beatmap et appliquent un multiplicateur qui diminue le score que vous obtenez. Inversement, certains mods augmentent la difficulté tout en appliquant un multiplicateur qui augmente le score obtenu. Enfin, certains mods changent le gameplay d'une autre manière. Les mods [Relax](/wiki/fr/Game_modifier/Relax) et [Auto Pilot](/wiki/fr/Game_modifier/Autopilot) tombent dans cette catégorie.

Mettez le curseur au dessus de l'icône d'un mod pour voir une description courte de son effet sur le gameplay. Cliquez sur celui-ci pour le sélectionner ou le déselectionner. Certains mods, comme le mod [Double Time](/wiki/fr/Game_modifier/Double_Time), ont plusieurs variations. Cliquez une nouvelle fois sur ce mod pour voir les différentes versions de celui-ci.
...
Tant que vous êtes sur ce menu, il est impossible d'accéder à la console de chat et à la console de chat étendue. De plus, les skins peuvent altérer le texte et/ou les icônes des mods, mais leurs effets resteront identiques.
...
_Remarque: Pour revenir à la beatmap choisie avant que le jeu en choisisse une au hasard, appuyez sur `Shift`, puis sur le bouton `Random` ou sur `F2`._

![](img/beatmap-options-FR.jpg "Options disponibles pour une beatmap")

Cliquez sur le bouton `Beatmap Options`, appuyez sur `F3` ou faites un clic droit sur une beatmap pour afficher le **menu des options pour la beatmap actuellement choisie**.
...
-   Appuyez sur `4` ou cliquez sur `Efacer les scores locaux` pour supprimer tous les replays des scores que vous avez effectués sur cette beatmap. (Pas de panique, seuls les scores présents sur votre ordinateur seront supprimés.)
...
Cliquez sur le **[logo d'osu!](/wiki/fr/Glossary/Cookie)** pour **commencer à jouer la beatmap sélectionnée**.
...
1.  Votre profil. Il montre vos [PP](/wiki/fr/Performance_Points), votre rang global, votre score total, votre [précision](/wiki/fr/Accuracy) globale, ainsi que votre niveau.
...
5.  La section `Beatmap Ranking`. Elle est disponible uniquement pour les beatmaps avec un classement en ligne ([qualifiée](/wiki/fr/Beatmap/Category#qualified), [classée](/wiki/fr/Beatmap/Category#ranked), or [loved](/wiki/fr/Beatmap/Category#loved)). Vous devez également être en ligne pour voir cette section.
    1.  `Général`: Votre position dans le classement de la beatmap, où vous pouvez vous mesurer à d'autres joueurs qui ont utilisé des [mods](/wiki/fr/Game_modifier), même si vous n'en avez pas utilisé.
    2.  `Précision`: La [précision](/wiki/fr/Accuracy) avec laquelle vous avez jouée la beatmap. Elle n'est comptée que si vous avez battu votre ancien record.
    3.  `Max Combo`: Votre plus grand combo sur la beatmap jouée.
    4.  `Score classé`: Votre [meilleur score](/wiki/fr/Score#ranked-score) sur la beatmap.
    5.  `Score total`: Il n'affecte pas votre position dans le classement, du coup il n'est pas pris en compte.
    6.  `Performance`: Le nombre de [PP unweighted](/wiki/fr/Performance_points#pourquoi-n'ai-je-pas-gagné-la-totalité-des-pp-d'une-beatmap-que-j'ai-jouée-?) obtenus sur cette partie.
6.  La section `Overall Ranking`. Elle est disponible uniquement pour les beatmaps avec un classement en ligne. Vous devez également être en ligne pour voir cette section.
    1.  `Général`: Votre classement global dans le monde.
    2.  `Précision`: Votre [précision](/wiki/fr/Accuracy#accuracy) globale sur toutes les beatmaps que vous avez jouées.
    3.  `Max Combo`: Votre plus grand combo sur toutes les beatmaps que vous avez jouées.
    4.  [`Score classé`](/wiki/fr/Score#score-classé): Le nombre total de points que vous avez obtenu sur toutes les beatmaps **classées** que vous avez jouées, chaque beatmap ne comptant qu'une seule fois.
    5.  [`Score total`](/wiki/fr/Score#score-total): Le fonctionnement est identique à celui du score classé, mais il prend en compte toutes les beatmaps présentes sur le site d'osu!, ainsi que les beatmaps quittées avant la fin de celles-ci et celles où vous avez perdu. Ce score compte dans votre niveau.
    6.  `Performance`: Affiche votre nombre total de Points de Performance, ainsi que le nombre de PP votre score a rapporté.
