...
Pour accéder à l'assistant de décalage, ouvrez le menu [Options](/wiki/Options) et tapez `décalage` dans la recherche rapide. Cliquez ensuite sur le bouton `Démarrer l'assistant`.
