...
Geben Sie einfach ein, wonach Sie suchen möchten. Der Text in der Suchleiste wird _zittern_, wenn Ihre Suche ungültig ist und verweigert Ihnen weitere ungültige Buchstaben einzugeben.

**Anmerkung:** b(Jahr)(Monat)(Tag).(Überarbeitung) = Public Build. Also, b20140323.3 bedeutet: Public Build vom 23. März 2014, dritte Überarbeitung. Man findet diese ganz am _Ende_ des Optionsmenüs.
...
| DirectX (Default) | Benutzt Shader, um die Performance zu verbessern, kann sich aber schlecht auf _sehr_ alten Geräten auswirken.                                                                      |
