...
| ------------------- | --------------------------------------------------------------------------------------------------------------------- | -------- | ---------- |
| `Username`          | Sign in input for your username.                                                                                      | Text     | _(empty)_  |
| `Password`          | Sign in input for your password.                                                                                      | Password | _(empty)_  |
...
_Note: When the game client is not the active window, the fps limit is dropped to 30fps automatically._

_Caution to laptop users: using `Unlimited (gameplay)` may cause your laptop to overheat!_
