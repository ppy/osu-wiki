...
| [Piotrekol](https://osu.ppy.sh/users/304520) | Développement et maintenance d'[osu!stats](http://osustats.ppy.sh/) ainsi que d'un grand nombre d'outils pour la communauté. |
| [MillhioreF](https://osu.ppy.sh/users/941094) | Performance extraordinaire dans le test de nouvelles fonctionnalités, la correction de bugs et le support technique. |
