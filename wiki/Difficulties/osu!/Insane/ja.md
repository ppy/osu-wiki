...
Insaneの難易度における最も大きな問題がovermapです。これはオブジェクトが実際の曲に対して難しく置かれることで、具体的には難しくするために不必要な[ジャンプが置かれたり](/wiki/Mapping_Techniques/Jumps)、スライダーの速度を上げたり、あるいはよく分からない不明な音を拾ったりすることです。これらを回避するには2つの方法があります。
