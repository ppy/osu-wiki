...
El mayor problema con las dificultades Insane es la existencia del [Overmapping](ES:Overmapping). Esto ocurre cuando el ritmo o colocación de las notas están dispuestos de una forma en la que no se ajusta a la canción. Esto puede suceder cuando se añaden jumps innecesarios o cambios/aumentos en la velocidad de los sliders, o colocando notas sin saber dónde en un intento de añadir dificultad (ejemplo: Añadiendo notas en los ticks azules cuando la canción solo está usando los ticks rojos). Hay dos maneras de evitar esto:
