...
It could be the extra *5th* difficulty (if beatmaps are formatted in ![Easy icon](/wiki/shared/diff/easy-o.png "Easy icon")![Normal icon](/wiki/shared/diff/normal-o.png "Normal icon")![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon")![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon")![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")) or the *4th* (if beatmaps are formatted in ![Easy icon](/wiki/shared/diff/easy-o.png "Easy icon")![Normal icon](/wiki/shared/diff/normal-o.png "Normal icon")![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon")![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon")![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")). These maps, like [Insane](/wiki/Difficulties/osu!/Insane), quote, "generally exemplifications of the mapper's skill, and are the difficulties where creativity can be easily shown."

On the osu!beatmap listing page (for example: [Rise Against - The Good Left Undone (pishifat) \[Extreme\]](https://osu.ppy.sh/b/774564)), one may tell it is an Expert map with this icon: ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")
