...
Une beatmap de difficulté Expert peut être la *5ème* difficulté supplémentaire (si les beatmaps sont dans cet ordre : ![Easy icon](/wiki/shared/Easy-s.png "Easy icon")![Normal icon](/wiki/shared/Normal-s.png "Normal icon")![Hard icon](/wiki/shared/Hard-s.png "Hard icon")![Insane icon](/wiki/shared/Insane-s.png "Insane icon")![Expert icon](/wiki/shared/Expert-s.png "Expert icon")) ou la *4ème* (si les beatmaps sont dans cet ordre : ![Normal icon](/wiki/shared/Normal-s.png "Normal icon")![Hard icon](/wiki/shared/Hard-s.png "Hard icon")![Insane icon](/wiki/shared/Insane-s.png "Insane icon")![Expert icon](/wiki/shared/Expert-s.png "Expert icon")). Cette difficulté, comme [Insane](/wiki/Difficulties/osu!/Insane), peuvent être définiées comme une "amplification générale des compétences du mappeur, et où là créativité peut être facilement illustrée."

Sur la page d'une beatmap sur osu! (par exemple: [Rise Against - The Good Left Undone (Extreme)](https://osu.ppy.sh/b/774564)), on savoir qu'il y a une difficulté Expert avec cette icône: ![Expert icon](/wiki/shared/Expert-s.png "Expert icon")
