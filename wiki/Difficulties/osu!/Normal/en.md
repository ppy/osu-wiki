...
-   `HP Drain Rate (HP)`: 5 or below
-   `Circle Size (CS)`: 3 or 4
-   `Approach Rate (AR)`: 5 or below
-   `Overall Difficulty (OD)`: 5 or below
...
1. If you have an [Easy](/wiki/Difficulties/osu!/Easy), make sure your Normal is a bit harder than your Easy, of course. If you do not have an Easy, you should still make your Normal suitable for beginners. A 1.6-1.7 star Normal will comfortably make up for an Easy.

2. Well, unless you spam 1/4 sliders everywhere. Or shoehorn 1/2 sliders in for that matter. Certain [BAT members](/wiki/People/Beatmap_Nomination_Group) have been known to rage via PMs over this sort of thing.
