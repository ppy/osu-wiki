...
_Tidak sama dengan [Beatmaps](/wiki/Beatmaps)._

**Kesulitan** beatmap menggambarkan tingkat keterampilan yang diperlukan untuk menyelesaikannya. Nama tiap tingkat dan _star rating_ dari sebuah beatmap biasanya memberikan informasi yang cukup untuk mengetahui seberapa sulit sebuah beatmap.

## Tingkat kesulitan

_Lihat juga: [Penamaan Tingkat Kesulitan](/wiki/Ranking_Criteria/Difficulty_Naming)_
...
Di situs web, beatmap secara otomatis diberikan ikon kesulitan berdasarkan rentang _star rating_ ini:
