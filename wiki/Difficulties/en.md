...
-   From the [Ranking Criteria](/wiki/Ranking_Criteria):
    -   Below 1.5: Easy ![Easy icon](/wiki/shared/diff/easy-o.png "Easy icon")
    -   Below 2.25: Normal ![Normal icon](/wiki/shared/diff/normal-o.png "Normal icon")
    -   Below 3.75: Hard ![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon")
    -   Below 5.25: Insane ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon")
    -   Above 5.25: Expert ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")
...
-   Consecutive order means this is the expected full spread ![Easy icon](/wiki/shared/diff/easy-o.png "Easy icon") ![Normal icon](/wiki/shared/diff/normal-o.png "Normal icon") ![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon") ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon") ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")
-   Depending on the star rating gap several combinations of lower difficulties are theoretically allowed:
    -   ![Easy icon](/wiki/shared/diff/easy-o.png "Easy icon")(1.4) ![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon")(2.5) ![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon")(3.6)
    -   ![Easy icon](/wiki/shared/diff/easy-o.png "Easy icon")(1.4) ![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon")(2.6) ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon")(3.8)
...
-   It is generally allowed to skip the **[Easy]** difficulty if the **[Normal]** difficulty follows the general guidelines of an Easy map
    -   ![Normal icon](/wiki/shared/diff/normal-o.png "Normal icon") ![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon") ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon") ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")

-   It is **not** allowed to skip a huge difficulty range like **[Hard]** or **[Insane]**
    -   ![Easy icon](/wiki/shared/diff/easy-o.png "Easy icon") ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon") ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon") ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")
    -   ![Normal icon](/wiki/shared/diff/normal-o.png "Normal icon") ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon") ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon") ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")
    -   ![Normal icon](/wiki/shared/diff/normal-o.png "Normal icon") ![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon") ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon") ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")
...
-   Depending on the prevalent gameplay elements in your **[Insane]** and **[Expert]** you could be asked to include another lower or higher rated additional **[Insane]**
    -   ![Normal icon](/wiki/shared/diff/normal-o.png "Normal icon")(1.9) ![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon")(3.2) ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon")(5.1) ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")(5.9) needs the addition of something like ![Normal icon](/wiki/shared/diff/normal-o.png "Normal icon")(1.9) ![Hard icon](/wiki/shared/diff/hard-o.png "Hard icon")(3.2) ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon")**(4.3)** ![Insane icon](/wiki/shared/diff/insane-o.png "Insane icon")(5.1) ![Expert icon](/wiki/shared/diff/expert-o.png "Expert icon")(5.9)
