...
The most common beatmap difficulty names for existing gameplay modes are listed below. Definitions can be found under the specific mode's [ranking criteria](/wiki/Ranking_Criteria).
