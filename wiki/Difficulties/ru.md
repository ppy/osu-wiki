...
Сложности карт *описывает* уровень навыка игрока, необходимый для ее прохождения.

## Звездочная оценка

![Оценка по звёздам](img/SR-range.png "Star rating ranges")

Для [Критерий Ранка](/wiki/Ranking_Criteria), оценка по звёздам обычно соответствует этим названиям сложностей
...
Обратите внимание, что указанные диапозоны не являются точными. Карты могут отличатся от указанных диапозонов и оставаться в рамках правил.

### Веб-иконки

Приведенные выше диапазоны оценок по звездам определяют, какой значок будет у сложности. Если следовать за этим диапазонам, то у вас будет сбалансированное распределение сложностей в мапсете. Также существуют некоторые рекомендации  (Посмотрите [Раздел «Набор карт» в Критериях Ранка](/wiki/Ranking_Criteria/#mapset)) которым вы можете следовать, чтобы улучшить разнос сложностей.
