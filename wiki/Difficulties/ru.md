...
*Смотрите также: [Критерии ранка § Мапсет](/wiki/Ranking_Criteria/#mapset)*

Сложности карт *присывают* уровень навыка игрока, необходимый для ее прохождения.

## Звездочная оценка

![Звездочная оценка](img/SR-range.png "Star rating ranges")

Для [Критерий Ранка](/wiki/Ranking_Criteria), star ratings typically correspond to these difficulties:
...
Обратите внимание, что указанные диапозоны не являются точными. Карты могут отличатся от указанных диапозонах и быть приемлемыми.

### Веб-иконги

Приведенные выше диапазоны звездочной оценки определяют, какого цвета значок будет у сложности. Следование за этими диапазонами обычно дает вам сбалансированное распределений сложностей в мапсете. Так же существуют некоторые рекомендации  (Посмотрите [Раздел «Набор карт» в Критериях Ранка](/wiki/Ranking_Criteria/#mapset)) которым вы можете следовать, чтобы улучшить сложности на вашем мапсете.
