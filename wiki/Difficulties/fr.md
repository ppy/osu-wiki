...
_À ne pas confondre avec: [Beatmaps](/wiki/Beatmaps)_

La difficulté d'une beatmap _décrit_ le niveau de compétence requis pour pouvoir la finir. Le nom de difficulté et le nombre d'étoiles d'une beatmap donnent généralement assez d'informations pour dire leur difficulté.

## Niveaux de difficulté

_Voir aussi : [Nom des difficultés](/wiki/Ranking_Criteria/Difficulty_Naming)_
