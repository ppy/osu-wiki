...
_Not to be confused with: [Stage (basic)](#stage-(basic))_
...
_Not to be confused with: [Stage (advanced)](#stage-(advanced))_
...
_Notice: Column lines are drawn on the left side of the inside of each column (except for the last column, which has both drawn on both sides of the inside of the last column)._
...
_Note: Notes are drawn on top of column lines, if they happen to overlap._
...
_See also: [Skinning/osu!mania](/wiki/Skinning/osu!mania)_

### Keys (basic)

_Not to be confused with: [Notes](#notes-(basic))_
...
_Not to be confused with: [Keys](#keys-(basic))_
...
_Not to be confused with: [Columns (basic)](#columns-(basic))_
...
_Not to be confused with: [Columns (advanced)](#columns-(advanced))_
...
_Notice: The ranking screen will use hit scores from the root skin folder, not the ones defined in the skin configuration._
...
_Notice: Centring of the stage will be inconsistent between differing ratio aspects. You may want to provide extra download links for other common ratio aspects._
...
_Notice: You will need to round the number to make it an integer. Because of this, the stage may be off by a unit to the left or right. In most cases, this will not be very noticeable._
