...
In the song selection screen, the number next to the _K_ shows how many keys will be used for the play. The beatmap will be played with looser judgement if "↓" symbol was appended at the end of _K_.
...
_Refer to [Play Styles page under osu!mania](/wiki/Play_Styles#osu-mania)._
...
_Scoring Values can be found in [Score under osu!mania Scoring Values section](/wiki/Score#osu-mania)._
...
_Refer to [Skinning page of osu!mania](/wiki/Skinning/osu!mania) for full information._
...
-   When played by [Auto](/wiki/Game_Modifiers), the player name will be _osu!topus_.
