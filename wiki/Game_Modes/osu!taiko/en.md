...
-    Unlike the other game modes, [Kiai Time](/wiki/Kiai-Time) has an effect on scores because it refers to the "Go-Go Time" in Taiko no Tatsujin. While Kiai Time is active, the drum in the upper-left changes animation (named pippidon or Don/Katsu in Taiko no Tatsujin), the playfield has a background gradient and the hit area gains a fire graphic around it.
