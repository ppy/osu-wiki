...
Les bananes peuvent être ignorées sans pénalité sur la vie. Cependant, collecter les bananes peut vous donner des points bonus et une récupération de vie. Notamment, les mods [Auto](/wiki/Game_Modifiers) iront au delà et attraperont _toutes_ les bananes sans en manquer une.
...
_[Reportez vous à la page Style de jeu dans osu!catch](/wiki/Play_Styles)._
...
_[Les valeurs de base peuvent être trouvées dans la section score d’osu!catch](/wiki/Score#osu-catch)._
...
Un S ou SS argenté peut être obtenu en utilisant les mods _[Hidden](/wiki/Game_Modifiers)_ et/ou  _[Flashlight](/wiki/Game_Modifiers)_.
...
_[Référez vous à la page Skinning d’osu!catch pour plus d’informations](/wiki/Skinning/osu!catch)._
...
-   [Auto](/wiki/Game_Modifiers) vont _toujours_ collecter toutes les bananes.
...
-   Quand vous jouez en auto [Auto](/wiki/Game_Modifiers), le joueur sera nommé _salad!_.
