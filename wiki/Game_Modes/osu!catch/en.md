...
_Refer to [Play Styles page under osu!catch](/wiki/Play_Styles)._
...
_Scoring Values can be found in [Score under osu!catch Scoring Values section](/wiki/Score#osu-catch)._
...
_Refer to [Skinning page of osu!catch](/wiki/Skinning/osu!catch) for full information._
...
-   [Auto](/wiki/Game_Modifiers) will _always_ collect all the bananas.
...
-   When played by [Auto](/wiki/Game_Modifiers), the player name will be _salad!_.
