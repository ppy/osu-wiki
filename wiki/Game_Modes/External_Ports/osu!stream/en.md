...
-   Plug-in your iDevice to your computer (that has osu!stream).
...
-   You do not need an account to download song packs.
-   You can integrate osu!stream with your Twitter account.
-   Your high score may be sent anonymously to the site under the name of "Guest" (if happen but requires Internet connection).
-   The circle timer is replaced and moved to the bottom with a small border line which is coloured depending on your accuracy. \[Bottom(Long)\]
-   **Average Timing** is given at the grade page.
-   You can't save old records nor can you save replays.
...
Os FG.jpg|Finger Guides display Os CB.png|Connected Beats Hold circles.jpg|Hold circle 1 Hold circles2.jpg|Hold circle 2
...
-   You can disable this feature from the option menu or after you have completed your tutorial.
...
<img src="Easy.jpg" title="fig:Right|Easy mode" alt="Right|Easy mode" width="300" /> **Difficulty: Easy + [NoFail](NF "wikilink")**
Easy mode is for new-comers to get used of the osu!stream game-play. The gameplay are considerably slower for new player to understand the flow and timing to hit. No lifebar will be issued and playing Easy mode will not unlock Expert mode even when you have 100% accuracy.

The background colour is Green.

#### Stream mode

<img src="Normal.jpg" title="fig:Right|Stream mode" alt="Right|Stream mode" width="200" /> **Difficulty: Easy ("Stream Down!" from Normal) ~ Normal (start point) ~ Hard ("Stream Up!" from Normal)**
...
In short, you start in between Easy and Hard.

Do note you **must score at least A (&gt;80% accuracy) rank in this mode in order to unlock the Expert mode of the song**. Accuracy lower than 80% even when you managed to full-combo does not count as A (it will be counted as B as usual).

The background colour is Green (Easy), Blue (Normal) and Pink (Hard).

Os SU.png|Stream Up! Os SD.png|Stream Down! Os Zero1.png|Critical health Os Zero2.png|Game Over
...
Os MM.png|Main Menu Osu!stream SONG.jpg|Song list Os store.jpg|Store screem Os DS.png|Selecting style menu Os SI.png|Song Information Osu!stream Example.jpg|Example of gameplay Os Pause.png|Pause menu Os FM.png|Failed menu Os SC.png|Stage cleared! Osu!stream Grade.jpg|Grade screen Os O1.png|Option screen 1 Os O2.png|Option screen 2
...
[`Accuracy`](Accuracy "wikilink")` = HitValue / (PerfectHitValue)`
...
<img src="Osu!stream Grade.jpg" title="fig:Grade screen" alt="Grade screen" width="200" /> **<u>Normal grades</u>**
...
<img src="STREAM UP!.jpg" title="fig:Example of Stream Up! from Normal" alt="Example of Stream Up! from Normal" width="200" /> In **Stream Mode** however, player is given **three lifebars and player starts with the second half-filled lifebar at start**. Player (gain/lose) the lifebar by (Stream Up!/Stream Down!) message for (filling the lifebar full/used up all the HP on that lifebar). After the message is shown, the game will show an animation at the background which (tune up/tune down) the difficulty and issue you a half-filled lifebar. If a player is issued a "Stream Down!", player is given temporary invisibility (due to no health left in the currently using lifebar) until the animation is completed in which the lifebar will be substituted with a half-filled one from the previous difficulty.
...
Can you post the credits here?
------------------------------

-   [Click me.](Media:Os_C.jpg "wikilink")
