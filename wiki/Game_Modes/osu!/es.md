...
[Relax wikilink]: /wiki/Game_Modifiers "se puede encontrar más información en Modificadores de Juego bajo el nombre de Relax"
...
[osu_spinner image]: /wiki/shared/osu_spinner.jpg "Ruletas de osu!"
[osu! Interface image]: /wiki/shared/Interface_osu.jpg "Interfaz de osu!"
[Options keyboard image]: /wiki/shared/Options_keyboard.jpg "Icono de Opciones de Entrada, sección de Teclado"
[Slider ticks image]: /wiki/shared/Sliderticks.png "Imagen que muestra un control deslizante con marcas de control deslizante, con la parte superior durante el Editar y parte inferior durante el juego"
[osu_smoke image]: /wiki/shared/osu_smoke.jpg "Uso del Humo"
[osu_smoke_set image]: /wiki/shared/osu_smoke_set.jpg "Humo en Atajos de Teclado"
[Combo Fire image]: /wiki/shared/combo-fire.jpg "Combo de fuego"
...
![Interfaz de osu!][osu! Interface image]

_Interfaz dentro del juego en osu!_

La barra superior izquierda es la barra de vida, que disminuirá a un ritmo constante (dependiendo de la configuración de dificultad del beatmap), pero puede rellenarse tocando notas en el momento adecuado o girando la ruleta.
...
**[Consulte la página Skinning de osu! para obtener información completa.][Skinning#osu! wikilink]**

## Beatmapping

**[Consulte la página de Beatmapping  para obtener información completa.][Beatmapping wikilink]**

## Trivialidades

### Juganbilidad

![Efecto de humo de osu!][osu_smoke image]

_Uso del humo_

![configuracion del humo en osu!][osu_smoke_set image]
