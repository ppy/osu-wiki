[300px|thumb|right|Rozgrywka osu!standard](image:Hierophobicintro.jpg "wikilink")
...
Z racji że większość użytkowników komputera nie ma żadnego tabletu do dyspozycji, komputerowa wersja osu! została stworzona do gry myszką, jak również innymi kontrolerami o których można pomyśleć. Różne style gry są opisane w artykule [Style Gry](PL:Play_Styles "wikilink"). Są piosenki które są praktycznie niemożliwe do przejścia dla grających na myszce, ale wszystkie rankingowe mapy (tzw. ***ranked*** i ***approved***) zostały dogłębnie sprawdzone i (większość z nich) jest do przejścia na myszce.

### Mechanika gry

`Samouczek `[`Oryginalny` `samouczek`](http://osu.ppy.sh/s/3756)`, `[`Rankingowa` `wersja` `samouczka`](http://osu.ppy.sh/s/19928)
...
Jakie więc są rodzaje obiektów do klikania?
...
Ta sekcja wyjaśni wszystkie zawiłości dotyczące zdobywania punktów, w tym matematyczne wzory.

### Celność

| colspan=2|Celność = Całkowita ilość punktów / (Całkowita ilość uderzeń \* 300) |
|--------------------------------------------------------------------------------|
| Całkowita ilość punktów                                                        |
| Całkowita ilość uderzeń                                                        |
...
<u>**Odnośnie "Ocen" na stronie profilu**</u>
...
Mój wynik nie wzrasta! Czy to bug?
----------------------------------
...
[Category: Game Modes/PL](Category:_Game_Modes/PL "wikilink") <Category:osu!Standard/PL>
