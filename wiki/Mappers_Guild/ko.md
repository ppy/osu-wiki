...
**매퍼스 길드**는 osu!의 [피쳐드 아티스트](/wiki/Featured_Artists)를 위한 [비트맵](/wiki/Beatmaps)을 만드는 책임이 있는 매퍼들의 그룹입니다. MMO-스타일의 길드 형식을 차용해서, 이는 매퍼들이 피쳐드 아티스트 비트맵의 랭크 과정에 참여하고, 매핑과 관련된 퀘스트를 위해 협력하면서 보상을 받을 수 있도록 합니다.
