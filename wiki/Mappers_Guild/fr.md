...
Les quêtes expirent après 3 mois d'inactivité. N'importe quel utilisateur peut rouvrir une quête en dépensant sa réserve disponible de points de la Mappers' Guild.
...
La Mappers' Guild a été lancer avec un groupe de moins de 10 joueurs vers fin 2017. Compte tenu des informations qu'ont leurs avait fourni sur un nouvel artiste associé, [MOtOLOiD](https://osu.ppy.sh/beatmaps/artists/19), ils étaient chargés de créer 5 beatmaps pour accompagner [la publication](https://osu.ppy.sh/home/news/2017-11-07-new-featured-artist-motoloid) sur l'artiste.
...
Alors que le plan initial de la Mappers' Guild était d'avoir des éléments MMO tel que des quêtes, cela c'est avéré peu pratique à gérer tout en gérant manuellement les date limite pour le nombre limité de participants à la guilde. ![][flag_US] [pishifat](https://osu.ppy.sh/users/3178418) et ![][flag_CL] [Milan-](https://osu.ppy.sh/users/1052994) commencèrent donc le développement d'un site web pour automatiser la Mappers' Guild vers la fin de l'année 2018, permettant une gestion plus adéquate des récompenses et du système de quête/parties.

Le [site web de la Mappers' Guild](https://mappersguild.com/) fut lancer le 1er Mars 2019 et c'est ici que tout ce qui concerne la Mappers' Guild est actuellement contrôlé. Depuis son ouverture au public, la guilde a atteint un nombre de membres supérieurs à 500 et à publier des [articles de mise à jour](https://osu.ppy.sh/home/news/2019-11-29-featured-artist-beatmap-updates-from-the-mappers-guild) pour garder le reste de la communauté d'osu! à jour sur le contenu de mapping d'artistes associés.
