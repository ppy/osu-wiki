...
Le client affichera les icônes se trouvant sous le chemin `/tournament/Skins/User/icons` pour les mettre à côté du nom des équipes. Ce peut être utilisé pour montrer le drapeau du pays ou des avatars.
