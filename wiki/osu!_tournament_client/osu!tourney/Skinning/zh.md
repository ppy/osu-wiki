...
osu!tourney 支持使用皮肤来为你的比赛进行自定义。为此，你需要在你的 osu!tourney 目录下创建 `/tournament/Skins/User`。皮肤可以放在该文件夹里，支持 `.jpg` 或 `.png` 文件扩展名。
...
客户端可以在队名旁显示放在 `/tournament/Skins/User/icons` 路径里的图片。它们可以是玩家头像、队伍队标或是国家旗帜。
