...
Klien mendukung berbagai modifikasi sehingga anda dapat memodifikasinya untuk turnamen. Untuk melakukannya, anda perlu membuat susunan folder `/tournament/Skins/User` di direktori instalasi klien. Elemen-elemen skin dapat ditempatkan di folder ini dan mendukung ekstensi file `.jpg` and `.png`.
...
Klien akan menampilkan ikon yang terletak di `/tournament/Skins/User/icons` di samping nama-nama tim. Elemen ini dapat digunakan untuk menampilkan misalnya bendera negara atau avatar.
