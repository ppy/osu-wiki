...
- `!mp make <name>` — создать комнату с указанным названием (максимум — до 4 комнат).
  - Эта комната — особенная: во-первых, она не закрывается после выхода всех игроков, во-вторых, она защищена паролем на случай, если в неё попробует зайти посторонний игрок.
...
- `!mp start [<time>]` - начать матч через `time` секунд, либо сразу же, если время не указано.
...
Список команд можно получить, отправив в личку BanchoBot команду `!mp help`.
