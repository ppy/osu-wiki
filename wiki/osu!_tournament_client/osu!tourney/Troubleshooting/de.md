...
- Überprüfe, dass du in osu! eingeloggt bist und dass die Checkboxen `Benutzername speichern` und `Passwort speichern` gesetzt sind.
...
Es kann passieren, dass dein Raum inkorrekt benannt wurde oder du das falsche Akronym in der Datei `tournament.cfg` benutzt hast.
...
Die Auflösung des oberen Teils von osu!tourney kann in der Datei `tournament.cfg` angepasst werden, aber standardmäßig ist sie `1280 x 720`. Überprüfe, dass die Auflösung deines Monitors größer als dieser Wert ist. Siehe die [Einrichtungsanleitung](/wiki/osu!tourney/Setup) für Informationen darüber, wie sich die Auflösung ändern lässt.

Vergesse nicht, den Ausschnitt einzustellen, um das schwarze Bedienfeld aus dem Stream zu entfernen!
...
Sende eine E-Mail an [tournaments@ppy.sh](mailto:tournaments@ppy.sh), sofern du ein Problem hast, das hier nicht in der Liste ist. Stelle sicher, dass die E-Mail beschreibend ist und stelle wenn möglich Screenshots zur Verfügung.
