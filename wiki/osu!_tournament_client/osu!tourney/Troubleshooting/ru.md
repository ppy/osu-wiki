...
- Проверьте, что вы залогинились в osu! и отметили при этом пункты "Remember Username" и "Remember Password".
- Проверьте, что вы не изменили настройку `privateserver` в файле `tournament.cfg`.
...
## Клиент не стримит действия игроков
...
Размеры верхней области osu!tourney можно настроить в файле `tournament.cfg`, по умолчанию он равен `1280x720`. Проверьте, что эти размеры меньше, чем разрешение вашего экрана. Подробнее см. [Настройка osu!tourney](/wiki/osu!tourney/Setup).

Не забудьте обрезать область стриминга, чтобы ваши зрители не видели панель управления турниром!

## Моей проблемы здесь нет, что делать?

Проверьте, что osu! не запущена с правами администратора (она сама попросит об этом при необходимости), а также что у вас последняя версия osu! из ветки обновлений CuttingEdge.
