...
_Note: Tous les mods changeant la difficulté sur osu!mania n'augmenteront jamais le multiplicateur de score._
...
| ![Nightcore](/wiki/shared/mods/NC.png)    | Nightcore (NC)    | ![][o!s] ![][o!t]: 1.12x • ![][o!c]: 1.06x • ![][o!m]: 1.00x                                       | Augmente la vitesse et ajoute un son de métronome.         |
| ![Hidden](/wiki/shared/mods/HD.png)       | Hidden (HD)       | ![][o!s] ![][o!t] ![][o!c]: 1.06x • ![][o!m]: 1.00x                                                | Les notes vont disparaître avant d'être cliquées.          |
| ![Fade In](/wiki/shared/mods/FI.png)      | Fade In (FI)      | ![][o!m]: 1.00x                                                                                    | Les touches vont arriver en dégradé.                       |
| ![Flashlight](/wiki/shared/mods/FL.png)   | Flashlight (FL)   | ![][o!s] ![][o!t] ![][o!c]: 1.12x • ![][o!m]: 1.00x                                                | Limite la champ de vision autour du curseur.               |
| ![Relax](/wiki/shared/mods/RL.png)        | Relax (RL)        | ![][o!s] ![][o!t] ![][o!c]: 0.00x (unrankable)                                                     | Juste, vise.                                               |
| ![Auto Pilot](/wiki/shared/mods/AP.png)   | Auto Pilot (AP)   | ![][o!s]: 0.00x (unrankable)                                                                       | Clique, une petite pause s'impose.                         |
| ![Spun Out](/wiki/shared/mods/SO.png)     | Spun Out (SO)     | ![][o!s]: 0.90x                                                                                    | Les spinners sont tournés automatiquement.                 |
...
_Note: Ce tableau s'applique uniquement aux beatmaps converties à partir d'osu!standard vers osu!mania par le jeu, et pas aux beatmaps créés spécifiquement pour osu!mania._
...
_Note: Afin que ce tableau ne soit pas trop long, on considère que les relations sont réciproques._
