...
В дополнение к данному документу, пожалуйста, ознакомьтесь с [Условиями использования сервиса](/wiki/Legal/Terms).
...
Во время настройки профиля (который публично доступен всем пользователям) в него можно добавить:
...
Вся перечисленная выше информация публично доступна, но её можно в любой момент мгновенно и навсегда убрать с помощью [страницы настроек](https://osu.ppy.sh/home/account/edit).
...
- Мы стараемся, чтобы даже при срабатывании никакая информация, по которой можно было бы вас идентифицировать, не ушла за пределы экосистемы osu!. 
