...
Последнее обновление: 24 апреля 2026 г. [История изменений](https://github.com/ppy/osu-wiki/commits/master/wiki/Legal/Privacy/en.md).
...
Для предоставления этих услуг нам зачастую приходится собирать, хранить и передавать персональные данные. Мы стараемся быть максимально прозрачными в каждом аспекте работы osu!, и данная политика конфиденциальности написана, чтобы помогать нам придерживаться этой цели.
...
- Интересы;
- Род деятельности;
- Страницы в социальных сетях (Twitter, Discord, личный сайт);
...
Мы не передаём ваши персональные данные третьим лицам. Все собранные аналитические данные находятся под нашим контролем. Ограниченный набор диагностических данных может быть передан доверенным разработчикам из нашей команды, чтобы они могли отладить и исправить проблемы в работе игры или сайта.

Тем не менее, в ходе некоторых действиях вы всё же будете взаимодействовать с третьими лицами:

- Обращения в поддержку по электронной почте обрабатываются через Enchant.
- Заказы физических товаров обрабатываются через Shopify и других партнёров магазина.
- Оплата osu!supporter и прочих нематериальных покупок обрабатывается через Xsolla или PayPal. Никаких сведений об оплате и доставке мы не храним.
