...
通过使用我们的服务，您确认您已阅读并了解我们的[服务条款](/wiki/Legal/Terms)以及这个隐私政策，包括我们如何和为何使用您的信息，以及您对服务的使用受到适用的服务条款和隐私政策的限制。如果您不希望我们收集或处理在此描述的您的个人信息，您有几种选择，包括限制我们收集的您的信息，或不使用我们的网络或产品及服务。
