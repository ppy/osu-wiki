<img src="Ranking procedure.png" title="Ranking flowchart." alt="Ranking flowchart." width="270" />
...
Before a beatmap can become ranked by a [BN](Beatmap_Nomination_Group "wikilink"), it must first get bubbled. In order for a [beatmap](beatmap "wikilink") to become bubbled, it must follow and be in accordance with the [ranking criteria](ranking_criteria "wikilink"), and it must have at least 12 [Star Priority](Star_Priority "wikilink") (or SP). You can actively gain SP in two different ways. First, you can have others help mod your map. If you find their mod to be useful and give kudosu, you will gain 1 SP. You and/or others can also spend [kudosu](kudosu "wikilink") in order to "star" your map (A star costs 1 kudosu, and can be done through either the [mapper](mappers "wikilink")'s profile or through the [map](beatmap "wikilink")'s thread). Once a beatmap has at least 12 SP, a [BN](Beatmap_Nomination_Group "wikilink") can bubble it if they feel it meets two conditions:

1.  The beatmap meets the [Ranking Criteria](ranking_criteria "wikilink"). Basically, this must mean that the map has the correct [timing](timing "wikilink"), has at least 2 [difficulties](difficulty "wikilink") (one of which is an [Easy](Easy_(Difficulty) "wikilink") or a [Normal](Normal "wikilink")), and is overall both mapped to the music and playable.
...
Mode-Specific Bubbles are bubbles applied to hybrid mapsets for specific modes. The criteria for any of these bubbles is regulated to its respective [Ranking Criteria](Ranking_Criteria "wikilink"), however only Mode-Specific BNs<sup>\[citation\\ needed\]</sup> can apply these bubbles. For a list of available BNs, see [the respective list on its article](Beatmap_Appreciation_Team#Team_Members "wikilink") or [this post](https://osu.ppy.sh/forum/p/2430411).
...
Note: If your map has a bubble, then it will be popped if you update it. If the update wasn't drastic (ex. All you did was fix a [slider](Hit_Objects#Sliders "wikilink")), then just ask the BN who bubbled it to rebubble it. Your map will gain 5 [SP](Star_Priority "wikilink") for a popped bubble icon.

Qualified / Ranked ![](heart.gif "fig:heart.gif")
-------------------------------------------------
