...
Online-Offset wurde im September 2008[^changelog-add] für das [Beatmap Appreciation Team](/wiki/Modding/Beatmap_Appreciation_Team) implementiert, damit das Timing von Beatmaps behoben werden kann, ohne deren Ranked-Status entfernen zu müssen. Über die Zeit wurde es für die Mitglieder der verschiedenen Teams zugänglich gemacht, die das Ranking-Verfahren beaufsichtigen. Hierzu zählen aufgrund ähnlicher Benutzergruppenberechtigungen beispielsweise das [Quality Assurance Team](/wiki/Modding/Quality_Assurance_Team) (QAT), das [Nomination Assessment Team](/wiki/People/The_Team/Nomination_Assessment_Team) (NAT) und das [globale Moderationsteam](/wiki/People/The_Team/Global_Moderation_Team).

Im Mai 2019 hat das NAT während der weiteren Restrukturierung des QATs[^qat-restructuring-follow-up-pr] erklärt, dass ein unzulässiges Offset das Entfernen des Ranked-Status von Beatmaps erfordert und dass dies nicht über die entsprechenden Einstellungen auf der Webseite behoben werden kann. Ungeachtet dessen wurde das gesamte Beatmap-Managementpanel für die [Beatmap Nominators](/wiki/People/The_Team/Beatmap_Nominators) sichtbar gemacht.
