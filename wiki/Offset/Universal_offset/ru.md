...
В большинстве случаев универсальный оффсет стоит оставить равным `0`, поскольку неправильное значение приведёт к проблемам с таймингом на всех картах. Тем не менее, если вы замечаете постоянные одинаковые проблемы с таймингом **на всех картах**, нестандартный универсальный оффсет может вам помочь.[^local-offset] Следует отметить, что разным игрокам помогут разные значения универсального оффсета, так как «железо» и настройки системы у всех разные.

## Настройка

![](img/uo-settings-button.png "Настройки универсального оффсета: слайдер и кнопка перехода к мастеру настройки")
