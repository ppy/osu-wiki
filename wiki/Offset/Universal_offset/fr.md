...
::: alert-note
**Remarque** : Pour des instructions étape par étape sur la façon de régler l'universal offset à la valeur correcte, voir [Comment utiliser l'assistant de décalage](/wiki/Guides/How_to_use_the_Offset_Wizard).
:::
