...
Le local offset est personnalisé en fonction de chaque beatmap. Il fonctionne en déplaçant tous les éléments ([objets](/wiki/Gameplay/Hit_object), les fonds d'écran [storyboardés](/wiki/Storyboard), les vidéos, ainsi que les échantillons sonores du storyboard) par rapport à la piste audio d'un nombre spécifié de milisecondes :
