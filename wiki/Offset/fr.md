...
Selon le type de décalage, il est défini par le créateur de la beatmap, personnalisé par le joueur ou ajusté par l'un des administrateurs du site. La plupart des décalages sont appliqués par beatmap à l'exception du [universal offset](#gameplay).

## Types

### Gameplay

- [Local offset](/wiki/Offset/Local_offset), un paramètre par beatmap qui décale tous les éléments du jeu par rapport à la piste audio.
...
- Beatmap offset, la quantité de temps entre le début du fichier audio et le premier [downbeat](/wiki/Music_theory/Downbeat) de la chanson, tel que contrôlé par les points de synchronisation.

## Paramètres de beatmap

*Note: Les décalages de l'introduction et de la vidéo ne sont modifiables que par l'[édition de fichier de beatmap](/wiki/Client/File_formats/Osu_(file_format)).*

- offset de compte à rebours, un paramètre qui affecte le temps d'apparition du  [compte à rebours](/wiki/Beatmap/Countdown) avant le premier objet, mesuré en [beats](/wiki/Music_theory/Beat).
- [Lead-in](/wiki/Beatmap/Lead-in_time), une période de retard supplémentaire avant que la beatmap ne commence.
