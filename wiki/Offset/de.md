...
::: alert-notice
**Hinweis**
Die Einleitung des Audios und Video-Offsets können nur durch die [Editierung der Beatmapdatei](/wiki/Client/File_formats/osu_(file_format)) eingestellt werden.
:::
