...
pippi, ayrıca pippidon, küçük "p" ile stilize edilir, 2008-07 tarihinde katılan standart osu! maskotudur. osu!taiko'da pippidon olarak da bilinir ve [Yandere Simulator](https://yanderesimulator.com) 'de bir NPC'dir. İlk konsept tasarımı ::Sarumaru::{ user=9427 } tarafından yapılmıştır, pippidon sprite'ı ::crystalsuicune::{ user=9974 } tarafından yapılmıştır, ve şu anki tasarımı ::Daru::{ user=32480 } tarafından yapılmıştır.
...
Yuzu, 2014-06-22 tarihinde katılan osu!catch maskotudur. 2000-04-10 tarihinde doğdu, 172 santimetre boyunda, ve 65 kilo ağırlığında. şu anki tasarımı ::Thievley::{ user=4717672 } tarafından tasarlanmıştır. Oysa ilk tasarımı ve yakalayıcı sprite'ı ::ztrot::{ user=6347 } tarafından yapılmıştır; Daru kombo patlaması resmini oluşturdu..
...
Mocha, osu!taiko maskotu. Aslen ilk kez [altıncı fanart yarışması](https://osu.ppy.sh/community/contests/2) esnasında ::Crowie::{ user=6894067 } tasarlanmıştır, oylamada ise 21. sırada yer almıştır.
...
Ryuuta, ::LuigiHann::{ user=1079 }'nın temasında da yer aldı, [Elite Beat osu! HD (1.0 Complete!)](https://osu.ppy.sh/community/forums/topics/190357).
...
Agent J, ::LuigiHann::{ user=1079 }'nın temasında da yer aldı [Elite Beat osu! HD (1.0 Complete!)](https://osu.ppy.sh/community/forums/topics/190357).
...
::crystalsuicine::{ user=9974 } tarafından tasarlanmıştır. Tama, osu!taiko maskot tasarım yarışmasına sadece 15 yaşında genç katılımcılardan biriydi (ya da öyle mi?), Tama'nın taiko drumming'e karşı büyük bir tutkusu vardır. Ve gök gürültülü fırtınalara. Ve özellikle de herhangi bir yerde takoyaki bulabileceği festivallere. Her zaman meydan okumaya hazır, Tama, genç görünüşünün arkasında gizemli bir geçmişi saklıyor.
