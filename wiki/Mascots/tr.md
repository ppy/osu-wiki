...
pippi, ayrıca pippidon, küçük "p" ile stilize edilir, 2008-07 tarihinde katılan standart osu! maskotudur. osu!taiko'da pippidon olarak da bilinir ve [Yandere Simulator](https://yanderesimulator.com) 'de bir NPC'dir. İlk konsept tasarımı ::Sarumaru::{ user-id=9427 } tarafından yapılmıştır, pippidon sprite'ı ::crystalsuicune::{ user-id=9974 } tarafından yapılmıştır, ve şu anki tasarımı ::Daru::{ user-id=32480 } tarafından yapılmıştır.
...
Yuzu, 2014-06-22 tarihinde katılan osu!catch maskotudur. 2000-04-10 tarihinde doğdu, 172 santimetre boyunda, ve 65 kilo ağırlığında. şu anki tasarımı ::Thievley::{ user-id=4717672 } tarafından tasarlanmıştır. Oysa ilk tasarımı ve yakalayıcı sprite'ı ::ztrot::{ user-id=6347 } tarafından yapılmıştır; Daru kombo patlaması resmini oluşturdu..
...
Mocha, osu!taiko maskotu. Aslen ilk kez [altıncı fanart yarışması](https://osu.ppy.sh/community/contests/2) esnasında ::Crowie::{ user-id=6894067 } tasarlanmıştır, oylamada ise 21. sırada yer almıştır.
...
Ryuuta, ::LuigiHann::{ user-id=1079 }'nın temasında da yer aldı, [Elite Beat osu! HD (1.0 Complete!)](https://osu.ppy.sh/community/forums/topics/190357).
...
Agent J, ::LuigiHann::{ user-id=1079 }'nın temasında da yer aldı [Elite Beat osu! HD (1.0 Complete!)](https://osu.ppy.sh/community/forums/topics/190357).

### Don

![Don](img/Don.png "Don")

> Don [Taiko no Tatsujin](https://en.wikipedia.org/wiki/Taiko_no_Tatsujin) Serisinin kahramanıdır. Beyaz kenarlı ve dört ayaklı bir taiko davulu, kırmızı bir yüz (moly turuncusu gibi görünüyor), ve açık mavi bir gövde. Don'un hayali Taiko'nun güzelliğini dünyayla paylaşmaktır. Wada House'a taşınmasından bu yana üç yıl geçti, ve o kasaba çevresinde oldukça popüler oldu. Korkunç bir iştahı var ve bazen Wada House'da pahalı alışveriş yapıyor. Genellikle cümlelerini Japonca "Ba-dum" anlamına gelen "Ta-don" ile bitirir.
...
::JMC::{ user-id=774010 } tarafından tasarlanmıştır. osu!taiko maskot tasarım yarışmasına katılanlardan biriydi. O osu!taiko için tutkulu ve enerjik bir kızdır, o en iyisi olmasa bile! Bir çift şık "Tabi" spor ayakkabısı ve pippidon aksesuarları beraberliğinde, yıpranmış maskot bu cesur kızda yaşıyor. Sadece 154 santimetrede oldukça kısadır, ve 1999-04-06 tarihinde doğmuştur.

### Alisa

![Alisa](img/Alisa.png "Alisa")

::\[ Glitch \]::{ user-id=3781400 } tarafından tasarlanmıştır. Alisa, osu!taiko maskot tasarım yarışmasına katılanlardan biriydi. Çocukluğundan beri osu!taiko oynuyor, başkaları için şarkı çalmaya düşkün, çok müzikal olarak yönlendirilmiş, ve uyumadığında ya da yemek yemediğinde, osu!taiko oynuyor, veya tekmeler için retro video oyunları oynuyor!

### Chirou

![Chirou](img/Chirou.png "Chirou")

::pyun::{ user-id=981534 } tarafından tasarlanmıştır. Chirou osu!taiko maskot tasarım yarışmasına katılanlardan biriydi, kendisi çok katı ve talepkardır, mükemmeliyetçi, ve hata yapmayı sevmez - özellikle osu!taiko'daki vuruşlarında. Ama sert görünüşünün ardında, onun yumuşak noktasına gidersen, yumuşacık ve sevimli olabilir. O 14 yaşında. 25 Ekim'de AB kan grubu ile doğdu. Ayrıca 4 feet 11 inç ve 100 kilo ağırlığında. Hobileri arasında davul çalma, pelerininde sıcak durmak, ve taş veya çakıl toplamak bulunur. Chirou, çeşitli kullanıcı fanart başvurularında bazı görünümler aldı.

### Taikonator

![Taikonator](img/Taikonator.png "Taikonator")

Taikonator, Taikonator 3000 olarak da bilinir, osu!taiko maskot tasarım yarışmasına katılanlardan biriydi. Bir takım nedenlerden dolayı bazı gruplar içerisinde içsel şaka ile beraber popülerlik kazandı. Kökeni bir sır olarak kalıyor; buna rağmen, diğer osu!taiko maskot tasarım başvurularından çok daha eşsiz ve çeşitli kullanıcı fanart gönderilerinde birçok görünüşe sahiptir.

### Tama

![Tama](img/Tama.png "Tama")

::crystalsuicine::{ user-id=9974 } tarafından tasarlanmıştır. Tama, osu!taiko maskot tasarım yarışmasına sadece 15 yaşında genç katılımcılardan biriydi (ya da öyle mi?), Tama'nın taiko drumming'e karşı büyük bir tutkusu vardır. Ve gök gürültülü fırtınalara. Ve özellikle de herhangi bir yerde takoyaki bulabileceği festivallere. Her zaman meydan okumaya hazır, Tama, genç görünüşünün arkasında gizemli bir geçmişi saklıyor.
