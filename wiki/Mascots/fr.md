...
pippi, stylisée avec un "p" minuscule, est la mascotte du mode de jeu osu! qui a rejoint le jeu en juillet 2008. Elle est également connue sous le nom de pippidon dans le mode osu!taiko et est apparue dans [Yandere Simulator](https://yanderesimulator.com) en tant que PNJ. Le concept initial a été créé par ::{ flag=US }:: ::Sarumaru::{ user-id=9427 }, le sprite de pippidon a été créé par ::{ flag=HK }:: ::crystalsuicune::{ user-id=9974 }, et le concept actuel a été conçu par ::{ flag=US }:: ::Daru::{ user-id=32480 }.
...
Yuzu est la mascotte d'osu!catch qui a rejoint le 22/06/2014. Il est né le 10/04/2000, mesure 172 centimètres et pèse 65 kilogrammes. Son design actuel a été conçu par ::{ flag=US }:: ::Thievley::{ user-id=4717672 }. Son design initial et les sprites de l'attrapeur ont été réalisés par ::{ flag=US }:: ::ztrot::{ user-id=6347 }. Daru a créé le graphisme du comboburst.
...
Moka est la mascotte d'osu!taiko. Elle a été initialement conçue lors du [sixième concours de fanarts](https://osu.ppy.sh/community/contests/2) par ::{ flag=US }:: ::Crowie::{ user-id=6894067 }, et s'est classée 21e dans les sondages.
...
Ryuuta figure également dans le skin de ::{ flag=US }:: ::LuigiHann::{ user-id=1079 }, [Elite Beat osu! HD (1.0 Complete !)](https://osu.ppy.sh/community/forums/topics/190357).
...
L'agent J figure également dans le skin de ::{ flag=US }:: ::LuigiHann::{ user-id=1079 }, [Elite Beat osu! HD (1.0 Complete!)](https://osu.ppy.sh/community/forums/topics/190357).
