...
Puede encontrar la documentación de la API en [la wiki de osu-api](https://github.com/ppy/osu-api/wiki). La versión actual de la API utiliza claves privadas para autenticar las solicitudes. Puede obtener una clave de la API a través de la [página de configuración de la cuenta](https://osu.ppy.sh/home/account/edit#legacy-api). Tenga en cuenta que la documentación en la wiki de osu!api puede no ser completa o extensa, y la API en sí no está en desarrollo activo.
...
- Publicación original en el foro: [osu!api open beta](https://osu.ppy.sh/community/forums/topics/141240) por ::peppy::{ user-id=2 }
