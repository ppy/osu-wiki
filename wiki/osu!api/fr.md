...
Vous pouvez trouver la documentation de l'API sur [Wiki d'osu-api](https://github.com/ppy/osu-api/wiki). La version actuelle de l'API utilise des clés privées pour authentifier les demandes. Vous pouvez demander une clé API sur la [page d'application](https://osu.ppy.sh/p/api) sur le site d'osu!. Notez que la documentation sur le wiki osu-api n'est peut-être pas entièrement complète ni étendu et que l'API elle-même n'est pas en cours de développement actif. Une nouvelle API, beaucoup plus robuste, est en préparation sur [osu-web](https://github.com/ppy/osu-web).
