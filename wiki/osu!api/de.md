...
Denke aber daran, dass die Dokumentation der osu!api nicht vollständig oder umfangreich ist, und die API nicht aktiv entwickelt wird. Eine neue und bessere API ist gerade in Arbeit und zu finden auf [osu-web](https://github.com/ppy/osu-web).
