...
Du kannst eine Dokumentation von der API auf der [Wikiseite der osu!api](https://github.com/ppy/osu-api/wiki) finden. Die aktuelle Version der API nutzt private Lizenzschlüssel für die Authentifizierung der Anfragen. Du kannst dir einen API-Key in den [Einstellungen](https://osu.ppy.sh/home/account/edit#legacy-api) besorgen. Denke aber daran, dass die Dokumentation der osu!api eventuell nicht vollständig oder umfangreich ist und die API nicht aktiv entwickelt wird.
...
Die Authentifizierung für die neue API folgt dem [OAuth-2-Protokoll](https://oauth.net/2/). Clients können in den [Einstellungen](https://osu.ppy.sh/home/account/edit#oauth) verwaltet werden.

## Siehe auch

- Originaler Forumsbeitrag: [osu!api Open Beta](https://osu.ppy.sh/community/forums/topics/141240) von ::peppy::{ user-id=2 }
