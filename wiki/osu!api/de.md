...
Die Authentifizierung für die neue API folgt dem [OAuth-2-Protokoll](https://oauth.net/2/). Clients können in den [Account-Einstellungen](https://osu.ppy.sh/home/account/edit#oauth) verwaltet werden.
