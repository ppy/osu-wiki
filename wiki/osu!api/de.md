...
Du kannst eine Dokumentation von der API auf der [Wikiseite der osu!api](https://github.com/ppy/osu-api/wiki) finden. Die aktuelle Version der API nutzt private Keys für die Authentifizierung der Anfragen. Du kannst dir einen API Key auf der [Beantragungsseite](https://osu.ppy.sh/p/api) besorgen. Denke aber daran, dass die Dokumentation der osu!api eventuell nicht vollständig oder umfangreich ist, und die API nicht aktiv entwickelt wird.

---

Version 2 der osu!api ist gerade in Arbeit und zu finden im [osu-web](https://github.com/ppy/osu-web). Die Dokumentation (keine Garantie, dass diese vollständig ist) findet sich auf ihrer [Referenzseite](https://docs.ppy.sh).
