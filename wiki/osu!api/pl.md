...
Dokumentacja API znajduje się na [oficjalnej wiki osu-api](https://github.com/ppy/osu-api/wiki). Obecna wersja API korzysta z prywatnych kluczy do autoryzacji żądań. Możesz ubiegać się o klucz API na [stronie rejestracji aplikacji](https://osu.ppy.sh/p/api) osu!. Miej na uwadze, że dokumentacja zawarta na wiki osu!api może nie być kompletna lub wyczerpująca, a samo API nie jest obecnie rozwijane.

---

Nowa wersja API jest w trakcie powstawania na [repozytorium osu-web](https://github.com/ppy/osu-web), zaś jej celem jest zwiększona stabilność względem oryginału. Dokumentację (niekoniecznie aktualną) można znaleźć na jej [stronie tytułowej](https://docs.ppy.sh).
