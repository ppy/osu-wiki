...
[^main-game-mode]: Основным режимом карты считается тот, для которого замапано больше всего сложностей. Если у каких-то режимов их поровну, выбирается тот, в котором больше сложностей сделано автором карты. Если и тут нет преимущества, то основным режимом будет считаться первый номинированный.
