...
Создатель карты может пометить свою работу как `WIP (в разработке)` или `Pending (готова для ранка)`. Карты в обеих категориях предназначены для получения отзывов и мнений от сообщества игры.
