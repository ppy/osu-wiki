...
Some beatmaps may be stalled from entering the ranking queue for a variety of reasons, usually due to remaining open problems or suggestions. A beatmap may only be qualified if these are resolved. If, on the other hand, issues are posted on a beatmap after it has already been qualified, these have to be addressed within a period of **48 hours**. Otherwise, the [Nomination Assessment Team](/wiki/People/Nomination_Assessment_Team) will [disqualify](/wiki/Beatmap_ranking_procedure#nomination-resets) the beatmap. After resolving all issues, the beatmap may be re-qualified, which can alter the timer. Beatmaps may also be disqualified earlier to apply changes from already addressed discussions.
