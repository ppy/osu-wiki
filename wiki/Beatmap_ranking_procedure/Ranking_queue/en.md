...
Problem or suggestion stamps posted on a beatmap's discussion page will not stop the timer from counting down, but will stop the beatmap from being ranked after the timer reaches zero in 7 days. Once all problems and suggestions are resolved, the beatmap will be able to become ranked.

Some qualified beatmaps may be stalled from entering the ranked section for a variety of reasons, usually due to a lack of closure on open problems or suggestions. Any beatmap with issues that have not been addressed after a period of **48 hours** since the date it was supposed to be ranked will be [disqualified](/wiki/Beatmap_ranking_procedure#nomination-resets) by the [Nomination Assessment Team](/wiki/People/Nomination_Assessment_Team). After resolving all issues, the beatmap may be re-qualified, which can alter the timer. Beatmaps may also be disqualified earlier to apply changes from already addressed discussions.
