...
เมื่อคัดลอกข้อความจากเมนูหรือปุ่ม ควรคัดลอกตัวพิมพ์เล็ก-ใหญ่ตามที่ปรากฏ (ตัวอย่างที่แสดงด้านล่าง)
...
ข้อความที่จัดรูปแบบไว้ล่วงหน้า (หรือที่เรียกว่าบล็อคโค้ด) จะต้องล้อมรั้วโดยใช้เครื่องหมายหลุมฝังศพสามอัน พวกเขาควรตั้งค่าตัวระบุภาษาสำหรับการ highlight รูปแบบ
...
ควรคัดลอก URL จากแถบที่อยู่ของเว็บเบราว์เซอร์ของคุณเหมือนกับเมื่อลิงก์ไปยังหน้าเว็บ osu! เว็บต้องเก็บส่วน `https://osu.ppy.sh` ของ URL
...
ต้องใช้โปรโตคอล "https" เว้นแต่ไซต์จะไม่รองรับ ลิงก์ภายนอกต้องเป็นลิงก์ที่สะอาดและตรงไปยังแหล่งที่เชื่อถือได้ ควรคัดลอก URL จากแถบที่อยู่ของเว็บเบราว์เซอร์เหมือนกับเมื่อลิงก์ไปยังหน้าภายนอกอื่น ๆ

ไม่มีความแตกต่างทางสายตาระหว่างภายนอกและ ลิงค์เว็บ osu! ด้วยเหตุนี้ ชื่อเว็บไซต์จึงควรรวมอยู่ในข้อความชื่อ ดูตัวอย่างต่อไปนี้:
