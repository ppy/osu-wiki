...
::: alert-note
**หมายเหตุ:** สำหรับมาตรฐานการเขียน, ดู [เกณฑ์รูปแบบบทความ/การเขียน](../Writing)
:::
...
::: alert-notice
**ประกาศ**
เว็บไซต์จะให้ผู้อ่านได้บทความที่มีเป็นภาษาตามที่ผู้อ่านได้ตั้งภาษา ถ้าไม่มีภาษานั้น เว็บไซต์จะให้ภาษาอังกฤษแทน
:::
...
::: alert-notice
**ประกาศ**
หลีกเลี่ยงการแปลบทความภาษาอังกฤษที่มีแท็กนี้ นอกจากนี้ ควรเพิ่มแท็กนี้เมื่อการแปลจำเป็นต้องถูกแก้เยอะ
:::
...
::: alert-notice
**ประกาศ**
หลีกเลี่ยงการแปลบทความภาษาอังกฤษที่มีแท็กนี้ หากบทความภาษาอังกฤษมีแท็กนี้ คำแปลต้องมีแท็กนี้ด้วย
:::
...
::: alert-notice
**ประกาศ**
ผู้ดูแลวิกิจะกำหนดและใช้เครื่องหมายนี้ก่อนที่จะ merge
:::
...
::: alert-caution
**ข้อควรระวัง**
การอัปโหลดไฟล์ Markdown โดยใช้ `CRLF` (การขึ้นบรรทัดใหม่และการป้อนบรรทัด) ผ่าน GitHub จะส่งผลให้ไฟล์เหล่านั้นใช้ `CRLF` เพื่อป้องกันสิ่งนี้ ให้ตั้งค่าบรรทัดที่ลงท้ายด้วย `LF` (การฟีดบรรทัด) ก่อนอัปโหลด
:::
...
::: alert-note
**หมายเหตุ:** อย่าสับสนกับ [หมายเหตุ](#notice)
:::
...
```markdown
::: alert-note
**หมายเหตุ:** สำหรับ {คำอธิบาย} โปรดดูที่ {บทความ}
:::

::: alert-note
**หมายเหตุ:** สำหรับ {คำอธิบาย} ดู {บทความ} และ {บทความ}
:::
```
...
```markdown
::: alert-note
**หมายเหตุ:** อย่าสับสนกับ {บทความ}.
:::

::: alert-note
**หมายเหตุ:** อย่าสับสนกับ {บทความ} หรือ {บทความ}.
:::
```
...
```markdown
::: alert-note
**หมายเหตุ:** สำหรับความหมายอื่น ดูที่ {บทความแก้ความกำกวม}
:::
```
...
::: alert-notice
**ประกาศ**
บนเว็บไซต์ หัวเรื่องระดับ 4 และ 5 จะไม่ปรากฏในสารบัญ
:::
...
::: alert-notice
**ประกาศ**
เมื่อแสดงถึงตัวอักษรนั้นเองที่ไม่ใช่แป้นคีย์บอร์ด ให้ใช้เครื่องหมายคำพูดแทน
:::
...
::: alert-notice
**ประกาศ**
รูปแบบไฟล์ (เพื่อไม่ให้สับสนกับนามสกุลไฟล์) ต้องเขียนด้วยอักษรตัวพิมพ์ใหญ่โดยไม่มี fullstop นำหน้า (`.`)
:::
...
::: alert-notice
**ประกาศ**
การเน้นไวยากรณ์สำหรับข้อความที่จัดรูปแบบไว้ล่วงหน้ายังใช้งานบนเว็บไซต์ไม่ได้
:::
...
::: alert-notice
**ประกาศ**
ลิงก์ภายในหมายถึงลิงก์ที่อยู่ภายในโดเมน `https://osu.ppy.sh/`
:::
...
::: alert-notice
**ประกาศ**
บนเว็บไซต์ หัวเรื่องระดับ 4 และ 5 ไม่ได้รับแอตทริบิวต์ id ซึ่งหมายความว่าไม่สามารถเชื่อมโยงโดยตรงได้
:::
...
```markdown
::: alert-note
**หมายเหตุ:** สำหรับกฎการจับเวลา โปรดดู [เกณฑ์การจัดอันดับ § เวลา](/wiki/Ranking_criteria#timing)
:::
```
...
::: alert-notice
**ประกาศ**
ลิงก์ภายนอกหมายถึงลิงก์ที่อยู่นอกโดเมน `https://osu.ppy.sh/`
:::
...
::: alert-notice
**ประกาศ**
นามสกุลไฟล์ต้องใช้อักษรตัวพิมพ์เล็ก มิฉะนั้น จะไม่สามารถโหลดได้!
:::
...
::: alert-notice
**ประกาศ**
ขณะนี้ยังไม่สามารถลอยรูปภาพหรือมีข้อความล้อมรอบได้
:::
...
::: alert-notice
**ประกาศ**
หากคุณไม่ต้องการเปลี่ยนการตั้งค่าปัจจุบันสำหรับวิกิ คุณสามารถย้าย `osu!.<ComputerUser>.cfg` ออกจาก osu! โฟลเดอร์และย้ายกลับในภายหลัง
:::
...
::: alert-note
**หมายเหตุ:** สำหรับรายการไอคอนธง โปรดดู [issue \#328](https://github.com/ppy/osu-wiki/issues/328 "GitHub")
:::
