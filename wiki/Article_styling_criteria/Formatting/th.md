...
มาร์กอัปสำหรับโค้ดคือเครื่องหมาย grave mark (`` ` ``) ในการใส่เครื่องหมาย grave mark ในโค้ด ให้ใช้เครื่องหมายหลุมฝังศพคู่แทน ถ้าหลุมศพอยู่ที่จุดเริ่มต้นหรือจุดสิ้นสุด ให้เว้นช่องว่างหนึ่งช่อง (ตัวอย่างที่แสดงด้านล่าง)
