...
มาร์กอัปสำหรับโค้ดคือเครื่องหมายหลุมฝังศพ (`` ` ``) ในการใส่เครื่องหมายหลุมฝังศพในโค้ด ให้ใช้เครื่องหมายหลุมฝังศพคู่แทน ถ้าหลุมศพอยู่ที่จุดเริ่มต้นหรือจุดสิ้นสุด ให้เว้นช่องว่างหนึ่งช่อง (ตัวอย่างที่แสดงด้านล่าง)
...
<!-- Uh I don't know what ` called in thailand -->
...
```markdown
![][flag_AU] [Fast](https://osu.ppy.sh/users/2)
```
