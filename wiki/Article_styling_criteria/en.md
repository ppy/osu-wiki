...
::: alert-note
**Note:** For news posts, see [News Styling Criteria](/wiki/News_styling_criteria)
:::
...
::: alert-notice
**Notice**
The articles below use [RFC 2119](https://tools.ietf.org/html/rfc2119) to describe requirement levels.
:::
