...
*ข้อสังเกต: บทความนี้ใช้ [RFC 2119](https://tools.ietf.org/html/rfc2119) เพื่ออธิบายระดับความต้องการ*

ทุกบทความที่เป็นภาษาอังกฤษต้องใช้ภาษาอังกฤษแบบปกติเท่านั้น

## ทะเบียนภาษา

วิกิมีการลงทะเบียนสองภาษา: เป็นกลางและไม่เป็นทางการ

การลงทะเบียนเป็นกลางเป็นค่าเริ่มต้นบนวิกิ

การลงทะเบียนอย่างไม่เป็นทางการนั้นพิเศษและมอบให้กับบทความจำนวนเล็กน้อย ตัวอย่างบางส่วนของการลงทะเบียนนี้ ได้แก่ [คำถามที่พบบ่อย](/wiki/FAQ) และ [ศูนย์ช่วยเหลือ](/wiki/Help_Centre)

สำหรับการลงทะเบียนทั้งสอง กฎทั้งหมดในส่วนนี้ของเกณฑ์ลักษณะบทความต้องปฏิบัติตาม จะมีการบันทึกข้อยกเว้นสำหรับการลงทะเบียนอย่างใดอย่างหนึ่ง

## ภาษาอังกฤษ

ต้องใช้รูปแบบการสะกดคำภาษาอังกฤษแบบอังกฤษเมื่อมีการสะกดคำภาษาอังกฤษที่ขัดแย้งกัน ตัวอย่างเช่น ใช้:
...
```markdown
หากคุณต้องการทราบข้อมูลเพิ่มเติมเกี่ยวกับการแชท โปรดดูที่ [Chat Console](/wiki/Chat_Console)
```

### ตัวดัดแปลงเกม

ตัวดัดแปลงเกมต้องมีคำว่า `mod` หลังชื่อ `mod` เพื่อลดความกำกวม ต้องสะกดตามที่เห็นด้านล่าง (ตัวพิมพ์ใหญ่และระยะห่างต้องตรงกัน):
...
- `1K`, `2K`, `3K`, `4K`, `5K`, `6K`, `7K`, `8K`, and `9K`
  - หากกล่าวถึงตัวดัดแปลงหลักโดยรวม ให้ใช้ `xK`.
- `Co-op` หรือ `CO`
- `Random` หรือ `RD`
- `Mirror` หรือ `MR`
- `Auto` หรือ `AT`
...
ตัวดัดแปลงเกมเหล่านี้ไม่ได้ใช้โดย osu!; อย่างไรก็ตาม หากจำเป็น จะต้องสะกดตามที่เห็นด้านล่าง (ตัวพิมพ์ใหญ่และตัวพิมพ์ควรตรงกัน):
...
ชื่อภาษาต้องเป็นตัวพิมพ์ใหญ่ ต่อไปนี้เป็นตัวอย่าง:
...
คำนามต้องเป็นตัวพิมพ์ใหญ่ ต่อไปนี้เป็นตัวอย่าง:
...
เวลาเขียนในรูปแบบ 24 ชั่วโมง และตัวเลขเดี่ยวใดๆ จะต้องนำหน้าด้วยศูนย์ เขตเวลาจะต้องเขียนทันทีหลังจากเวลานั้น และควรอยู่ใน UTC+0 สำหรับเหตุการณ์ทั่วโลก หรือในเขตเวลาของกิจกรรมสำหรับกิจกรรมที่มีขนาดเล็กกว่า ใช้ `UTC`  แทน `GMT`
...
`UTC` (ไม่มีออฟเซ็ต) ถูกบอกเป็นนัยว่าเป็น `UTC+0` อาจใช้อย่างใดอย่างหนึ่ง แต่การใช้งานต้องสอดคล้องกัน UTC ที่มีออฟเซ็ต 0 อย่างชัดเจนต้องใช้สัญลักษณ์บวก (`+`)
...
ชื่อของเกม osu! ต้องไม่เป็นตัวพิมพ์ใหญ่หรือตัวเอียง โอสุ! ตราสินค้าอย่างเป็นทางการจะต้องไม่ใช้ช่องว่างใด ๆ ตัวอย่าง ได้แก่
...
ชื่อผู้ใช้ที่มี `osu!` ซึ่งเป็นส่วนหนึ่งของชื่อหัวข้อจะต้องเป็นตัวพิมพ์ใหญ่ ตัวอย่าง ได้แก่

- `osu! Alumni`
- `osu! Champion`

สำหรับเงื่อนไขอื่นๆ ทั้งหมด osu! ต้องถือว่าเป็น[คำนามที่มีคุณสมบัติ](https://en.wikipedia.org/wiki/Noun_adjunct) นี่หมายถึงการเพิ่มช่องว่างระหว่าง osu! และคำนามที่ปรับเปลี่ยน ตัวอย่าง ได้แก่
...
`osu!` ไม่ควรจบประโยค หากใช่ ให้ใช้จุดเต็ม (`.`) หรือเครื่องหมายคำถามเพื่อรับ `osu!.` หรือ `osu!?`

`osu!` ต้องไม่ตามด้วยเครื่องหมายอัศเจรีย์ (เช่น `osu!!`) ประโยคจะต้องเขียนใหม่เพื่อให้แน่ใจว่าสิ่งนี้จะไม่เกิดขึ้น

## คำศัพท์

คำเหล่านี้ต้องสะกดดังนี้ (ระยะห่างต้องตรงกัน):
...
- `BN` หรือ `Beatmap Nominators` เมื่อพูดถึง *ผู้เสนอชื่อบีทแมป*.
...
ตัวย่อ, คำย่อ และอักษรย่อ ต้องมีความหมายเขียนออกมาเมื่อเกิดขึ้นครั้งแรก เหตุการณ์อื่นๆ เป็นทางเลือก แต่จะทำเมื่อจำเป็นเท่านั้น ต่อไปนี้เป็นตัวอย่าง:
...
`you` และ `your` ควรหลีกเลี่ยง `I` จะต้องไม่ใช้ `we`, `he` หรือ `his`, และ `she` หรือ `her` จะต้องไม่ใช้ (ดูข้อกำหนดอื่นๆ ด้านบน)

---

[บทความที่มีการลงทะเบียนอย่างไม่เป็นทางการ](#language-register) อาจละเว้นส่วนนี้ อย่างไรก็ตาม ควรหลีกเลี่ยง `I` ในย่อหน้า
...
[บทความที่มีการลงทะเบียนอย่างไม่เป็นทางการ](#language-register) อาจใช้การย่อ; อย่างไรก็ตาม การใช้งานควรมีความสอดคล้องกันตลอดทั้งบทความ
...
[บทความที่มีการลงทะเบียนอย่างไม่เป็นทางการ](#language-register) อาจละเว้นส่วนนี้ อย่างไรก็ตาม การใช้งานควรมีความสอดคล้องกันตลอดทั้งบทความ

### อัฒภาค

[บทความที่มีการลงทะเบียนอย่างไม่เป็นทางการ](#language-register) ควรหลีกเลี่ยงการใช้เครื่องหมายอัฒภาค (`;`)
