...
**Программные файлы osu!** — это набор файлов для запуска osu! и отслеживания действий пользователя во время игры.
...
Папка Chat создаётся при включении параметра «Вести логи личных сообщений», или когда пользователь выполняет команду `/savelog` в [окне чата](/wiki/Chat_Console).
...
Папка Localisations появляется при изменении языка в настройках игры. В ней находятся текстовые файлы с переводом osu!, которые могут использоваться для замены английского текста на основе выбранной локализации.
