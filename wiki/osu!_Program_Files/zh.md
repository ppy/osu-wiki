...
当你使用 [Skin Selector's "导出.osk"](Options#Skin_Selector "wikilink") or [Beatmap Editor's "导出包"后出现](Beatmap_Editor/Menu#File "wikilink").**保存你从osu! 导出的.osz(beatmap)/.osk(皮肤)文件.**[For how-to, click me](Osu!_File_Formats#From_the_game "wikilink").
