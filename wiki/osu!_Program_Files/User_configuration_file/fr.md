...
| Precision                    | Autrefois activait/désactivait "Enable mouse precision" en jeu. Cette option n'éxiste plus et à été remplacé part RawInput                                                                                 |
| Width                        | Largeur de osu! en mode fenêtré. Changez cette valeur pour une largeur personalisée                                                                                                                        |
...
| OnlineDefault                | Autrefois basculait entre en classement local ou le classement général. Cette option n'éxiste plus et a été remplacé par RankMode                                                                          |
| Video                        | Active/Désactive la vidéo en arrière-plan en jeu                                                                                                                                                           |
| NotifySubmittedThread        | Coche automatiquement "Receive email notification on reply" à la soumission d'une beatmap via le système de soumission de beatmat (BSS)                                                                    |
...
| SaveReplay                   | Autrefois cochait automatiquement "Save replay" sur l'écran des résultats. Cette option n'éxiste plus, les replays sont toujours sauvgardés                                                                |
...
| EditorSliderCurveType        | Autrefois affichait le dernier type de courbe de slider utilisé dans l'éditeur. Cette option n'éxiste plus, les types de courbes de slider oné été enlevées de l'éditeur.                                  |
...
| SnakingSliders               | Active/Désactive "Snaking Sliders" en jeu                                                                                                                                                                  |
...
| AbsoluteScroll               | Autrefois activait/désactivait "Absolute Scrolling" dans le menu de séléction des chansons. Cette option n'éxiste plus, le défilement absolu a été implémenté de manière permanente. Faites clic droit dans le menu de séléction des chansons pour l'utiliser. |
| HoverSelect                  | Autrefois activait/désactivait "Hover Select" dans le menu de séléction des chansons. Cette option n'éxiste plus, "hover select" a été enlevé                                                              |
| HoverReturn                  | Autrefois activait/désactivait "Hover Return" dans le menu de séléction des chansons. Cette option n'éxiste plus                                                                                           |
...
| Renderer                     | Quel renderer osu! utilise - OpenGL ou DirectX                                                                                                                                                             |
...
| FrameSyncD3d                 | Détermine quelle limite d'images par secondes doit être utilisé lors du basculement d'OpenGL vers DirectX                                                                                                  |
| FrameSyncGl                  | Détermine quelle limite d'images par secondes doit être utilisé lors du basculement d'DirectX vers OpenGL                                                                                                  |
| ShowSpectators               | Active/Désactive "Affiche la liste des spéctateurs en jeu" en jeu                                                                                                                                          |
| MsnIntegration               | Active/Désactive "Intégrer au message perso MSN" en jeu                                                                                                                                                    |
...
| IncreaseAccuracy             | Entrée de RawInput                                                                                                                                                                                         |
...
| keySpunOut                   |
| keyAuto                      |
| keyIncreaseSpeed             | Augmente la vitesse de défillement d'osu!mania                                                                                                                                                             |
| keyDescreseSpeed             | Réduit la vitesse de défillement d'osu!mania                                                                                                                                                               |
...
| LobbyShowInProgress          |                                                                                                                                                                                                            |
| keyBossKey                   | Raccourci pour minimiser osu! dans la barre des tâches                                                                                                                                                     |
| ShowUnicode                  |                                                                                                                                                                                                            |
...
| GuideTips                    |                                                                                                                                                                                                            |
| DimLevel                     | Définie une dimension globale pour les beatmaps en jeu                                                                                                                                                     |
...
| AutomaticDownload            | Télécharge automatiquement les nouvelles beatmap via osu!direct                                                                                                                                            |
| CursorRipple                 | Active "cursor ripples" lors d'un click                                                                                                                                                                    |
...
| ShowInterface                | Affiche/Cache l'interface (par défaut shift+tab)                                                                                                                                                           |
| @AutoSendNowPlaying          |                                                                                                                                                                                                            |
