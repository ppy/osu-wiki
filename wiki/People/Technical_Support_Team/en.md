...
| :-- | :-- |
| ::{ flag=IT }:: ::- Marco -::{ user-id=1273955 } | Italian |
| ::{ flag=US }:: ::Blushing::{ user-id=5927823 } |  |
| ::{ flag=GB }:: ::chromb::{ user-id=10238680 } |  |
| ::{ flag=KR }:: ::Civil oath::{ user-id=3216107 } | Korean, Japanese |
| ::{ flag=DE }:: ::Lyawi::{ user-id=5851253 } | German |
| ::{ flag=PH }:: ::Nathanael::{ user-id=2295078 } | Filipino |
| ::{ flag=PL }:: ::spaceman\1atlas::{ user-id=3035836 } | Polish |
