# Użytkownicy z unikalnymi tytułami

Tytuły są zazwyczaj związane z [grupami użytkowników](/wiki/People/User_group), jednak użytkownicy wymienieni poniżej otrzymali je z innych powodów. Większość z nich została przyznana za nadzwyczajne osiągnięcia lub wkład w grę, podczas gdy reszta upamiętnia kultowe i śmieszne momenty z historii gry. 

## Obecni zwycięzcy mistrzostw świata

Zwycięzcy corocznych [oficjalnych mistrzostw świata](/wiki/Tournaments#oficjalne) otrzymują tytuł **osu!/osu!taiko/osu!catch/osu!mania Champion**, który noszą aż do roztrzygnięcia kolejnej edycji wydarzenia.

Zwycięzcy [OWC 2024](/wiki/Tournaments/OWC/2024) posiadający tytuł **osu! Champion**:
...
Zwycięzcy [TWC 2025](/wiki/Tournaments/TWC/2025) posiadający tytuł **osu!taiko Champion**:
...
Zwycięzcy [CWC 2025](/wiki/Tournaments/CWC/2025) posiadający tytuł **osu!catch Champion**:
...
Zwycięzcy [MWC 4K 2024](/wiki/Tournaments/MWC/2024_4K) posiadający tytuł **osu!mania 4k Champion**:
...
Zwycięzcy [MWC 7K 2025](/wiki/Tournaments/MWC/2025_7K) posiadający tytuł **osu!mania 7k Champion**:
...
## Zwycięzcy poprzednich edycji mistrzostw świata

Od listopada 2021 roku zwycięzcy poprzednich edycji mistrzostw świata są nagradzani tytułem **Former osu!/osu!taiko/osu!catch/osu!mania Champion**. Gracze, którzy wygrali wiele edycji, otrzymują tytuł na podstawie ostatniego wygranego turnieju.

Zwycięzcy poprzednich edycji mistrzostw świata osu! posiadający tytuł **Former osu! Champion**:

| Turniej | Tytuł | Posiadacze tytułu |
| :-: | :-- | :-- |
...
Zwycięzcy poprzednich edycji mistrzostw świata osu!taiko posiadający tytuł **Former osu!taiko Champion**:
...
Zwycięzcy poprzednich edycji mistrzostw świata osu!catch posiadający tytuł **Former osu!catch Champion**:
...
Zwycięzcy poprzednich edycji mistrzostw świata osu!mania posiadający tytuł **Former osu!mania Champion**:
...
Większość oficjalnych konkursów w tworzeniu beatmap nagradza zwycięzców [punktami konkursowymi](/wiki/Contests/Contest_points), a uzyskanie ich dostatecznie dużej liczby dodatkowo nagradza użytkownika tytułem **Elite Mapper**. Dawniej tytuł był dawany zwycięzcom konkursu.
...
::: alert-note
**Główny artykuł:** [Elitarni nominatorzy](/wiki/People/Elite_Nominators)
:::

Od 2020 roku wkład [nominatorów beatmap](/wiki/People/Beatmap_Nominators) i członków [zespołu oceniania nominacji (NAT)](/wiki/People/Nomination_Assessment_Team) w rozwój systemu rankingowego jest nagradzany tytułem **Elite Nominator**. Jest on przyznawany na początku każdego roku za całokształt pracy w roku poprzednim. Użytkownicy noszą tytuł przez jeden rok lub do momentu opuszczenia zespołu.
...
## Zwycięzcy konkursu osu!remix

Zwycięzcy konkursu osu!remix są nagradzani tytułem **osu!mixer**.

- ::{ flag=US }:: [BilliumMoto](https://osu.ppy.sh/users/3862471)[^billiummoto-note]
- ::{ flag=FR }:: [Shinwoir](https://osu.ppy.sh/users/8984574)

## Posiadacze tytułu osu!trivium Quiz

Konkursy [osu!trivium Quiz](/wiki/Contests/osu!trivium_Quiz) nagradzają zwycięzców tytułem **osu!trivium Champion**, który jest odbierany po jednym roku. Posiadacze tytułu za zwycięstwo edycji z 2021 roku to:
...
## Zwycięzcy konkursu Locus

Zwycięzcy konkursu [Locus](/wiki/Contests/Locus/2025) zostali nagrodzeni tytułem nawiązującym do roli, jaką pełnili w tworzeniu beatmapy w swojej drużynie.

Członkowie drużyn odpowiedzialni za stworzenie beatmapy otrzymali tytuł **Mapping Architect**:
...
Członkowie drużyn odpowiedzialni za elementy graficzne otrzymali tytuł **Visual Architect**:
...
Członkowie drużyn odpowiedzialni za stworzenie utworu otrzymali tytuł **Musical Architect**:
...
Poniżsi użytkownicy otrzymali tytuł **osu!musician** za swój wkład w oficjalną oprawę dźwiękową we wczesnych latach gry:

- ::{ flag=NO }:: [cYsmix](https://osu.ppy.sh/users/272870)
- ::{ flag=AU }:: [nekodex](https://osu.ppy.sh/users/102)

## Zwycięzcy konkursu na projekt maskotek

Zespół osu! organizował konkursy dające użytkownikom możliwość zaprojektowania lub wykonania nowego projektu niektórych maskotek gry. Zwycięzcy tych konkursów oraz osoby, których projekty zostały ostatecznie wykorzystane jako oficjalne, otrzymali tytuł **osu!artist**.

- ::{ flag=US }:: Użytkownik [Crowie](https://osu.ppy.sh/users/6894067) zaprojektował wygląd **Mochy** oraz pomógł przy wielu innych oficjalnych grafikach.
- ::{ flag=ID }:: Użytkownik [JMC](https://osu.ppy.sh/users/774010) wygrał konkurs [Fan Art 6: osu!taiko mascot](https://osu.ppy.sh/community/contests/2).
- ::{ flag=US }:: Użytkownik [Thievley](https://osu.ppy.sh/users/4717672) wykonał nowy projekt **Yuzu**.
- ::{ flag=ID }:: Użytkownik [xiemon](https://osu.ppy.sh/users/5203667) zaprojektował wygląd **Mani i Mari**.

## Hall of Fame

Poniżsi użytkownicy otrzymali tytuł **osu! Hall of Famer** za grę na najwyższym poziomie oraz znaczący wkład w rozwój gry na jej wczesnym etapie.
...
## Elitarni twórcy storyboardów

Twórcy storyboardów, którzy wykazali się niezwykłym talentem i ponadprzeciętnymi umięjętnościami w ich tworzeniu otrzymali tytuł **Elite Storyboarder**.
...
## Tytuły związane z rozgrywką

::: alert-note
**Zobacz także:** [Komplecjoniści](/wiki/People/Completionists)
:::

Poniżsi gracze otrzymali swoje tytuły za niesamowite osiągnięcia związane z grą lub za ukończenie pewnych wyzwań.

| Użytkownik | Tytuł | Osiągnięcie |
| :-- | :-- | :-- |
| ::{ flag=NO }:: [-GN](https://osu.ppy.sh/users/895581) | Champion Above Champions | Uzyskanie pierwszego Full Combo bez użycia modów na beatmapie [Shotgun Symphony+ [Impossibly Intense]](https://osu.ppy.sh/beatmapsets/7671#osu/32570) |
| ::{ flag=US }:: [EEEEEEEEEEEEEEE](https://osu.ppy.sh/users/2927048) | osu!completionist | Zagranie wszystkich rankingowych beatmap w trybie osu! (stan na 15 marca 2023) |
| ::{ flag=AU }:: [Jaye](https://osu.ppy.sh/users/4841352) | Drum Decimator | Uzyskanie Full Combo na wszystkich rankingowych beatmapach w trybie osu!taiko (stan na 3 listopada 2019) |
| ::{ flag=PL }:: [Przegrany](https://osu.ppy.sh/users/7635621) | osu!completionist | Zagranie wszystkich rankingowych beatmap w trybie osu! (stan na 11 sierpnia 2021) |
| ::{ flag=NL }:: [Shirotora_old](https://osu.ppy.sh/users/11820) | Bested the Reaper's Game | Nadany przez użytkownika ::{ flag=CA }:: [awp](https://osu.ppy.sh/users/2650) w 2008 roku za osiągnięcie 104 miejsca w rankingu globalnym, co było nawiązaniem do gry [*The World Ends with You*](https://pl.wikipedia.org/wiki/The_World_Ends_with_You) <!-- źródło: https://osu.ppy.sh/community/forums/posts/60664 (stara sygnatura użytkownika Shirotora_old) --> |
| ::{ flag=US }:: [xasuma](https://osu.ppy.sh/users/3172980) | The First Completionist | Zagranie wszystkich rankingowych beatmap w trybie osu! (stan na 27 kwietnia 2019 roku) |
| ::{ flag=DE }:: [Zetera](https://osu.ppy.sh/users/587737) | Medal Hunter | Pierwsza osoba, [która odblokowała medal *The Girl in the Forest*](https://osu.ppy.sh/community/forums/topics/662279) |
| ::{ flag=US }:: [UberFazz](https://osu.ppy.sh/users/8646059) | Medal Hunter | Pierwsza osoba, [która odblokowała medal *Internment*](https://twitter.com/osugame/status/1696007320663359800) |
| ::{ flag=FI }:: [Tactic](https://osu.ppy.sh/users/6291386) | Prince of Disco | Zdobycie maksymalnego możliwego wyniku na [Kenji Ninuma - DISCO★PRINCE](https://osu.ppy.sh/beatmapsets/1) i zapewnienie sobie na zawsze pierwszego miejsca w rankingu beatmapy. |
| ::{ flag=AU }:: [mrekk](https://osu.ppy.sh/users/7562902) | Limit Breaker | [Przekroczenie 16-bitowego limitu pp na osu!(stable)](https://osu.ppy.sh/home/changelog/stable40/20250306.2) |
| ::{ flag=BR }:: [Dropinx](https://osu.ppy.sh/users/4687701) | Medal Hunter | Pierwsza osoba, która odblokowała wszystkie medale we wszystkich czterech trybach gry (stan na 16 października 2025 roku) |

## Pomocnicy

Poniżsi użytkownicy otrzymali swoje tytuły za znaczący wkład w danej części gry lub za bycie w niej wzorcową postacią.

| Użytkownik | Tytuł |
| :-- | :-- |
| ::{ flag=CA }:: [Azer](https://osu.ppy.sh/users/2155578) | World Cup Organiser |
| ::{ flag=CN }:: [Ballance](https://osu.ppy.sh/users/165946) | osu!painter<!-- osiągnięcia oraz różne inne grafiki --> |
...
| ::{ flag=US }:: [Daru](https://osu.ppy.sh/users/32480) | osu!painter<!-- Maria, Yuzu oraz różne inne grafiki starej strony internetowej --> |
...
| ::{ flag=DE }:: [LastExceed](https://osu.ppy.sh/users/6232245) | Master of the Fade<!-- implementacja modów Fade In oraz Hidden w osu!(lazer), a także znany gracz Fade In --> |
...
| ::{ flag=SE }:: [PuffBuck](https://osu.ppy.sh/users/4234525) | Always Watching<!-- moderator osulive, hype train conductor oraz pomocnik w organizowaniu mistrzostw świata w osu! --> |
...
Poniżsi użytkownicy otrzymali swoje tytuły z różnych powodów.

| Użytkownik | Tytuł |
| :-- | :-- |
| ::{ flag=SH }:: [BanchoBot](https://osu.ppy.sh/users/3) | w00t p00t |
| ::{ flag=US }:: [Derekku](https://osu.ppy.sh/users/91341) | COOL DUDE<!-- nadany przez użytkownika phill, mem z czasów starego forum (https://osu.ppy.sh/community/forums/posts/869213) --> |
| ::{ flag=AU }:: [Ephemeral](https://osu.ppy.sh/users/102335) | Inland Empire<!-- nawiązanie do Disco Elysium --> |
| ::{ flag=DE }:: [Loctav](https://osu.ppy.sh/users/71366) | Popcorn Fairy<!-- zdjęcia kin w czatach zespołu osu! (https://discord.com/channels/90072389919997952/276231513702400001/278117445968068608) --> |
...
[^mao-note]: ::{ flag=DE }:: Użytkownik [Mao](https://osu.ppy.sh/users/2204515) otrzymał tytuł **Elite Mapper II** za zdobycie tytułu Elite Mapper na dwa różne sposoby: wygranie konkursu [A Labour of Love](/wiki/Contests/A_Labour_of_Love_Contest) oraz uzyskanie 6 punktów w nowym systemie [Monthly Beatmapping Contest](/wiki/Contests/Monthly_Beatmapping_Contest).
[^elite-note]: ::{ flag=ID }:: Użytkownicy [Maxus](https://osu.ppy.sh/users/4335785), ::{ flag=US }:: [Monoseul](https://osu.ppy.sh/users/16010604) oraz ::{ flag=RU }:: [NeKroMan4ik](https://osu.ppy.sh/users/11387664) otrzymali tytuł **Elite Nominator II** za dwukrotne zdobycie tytułu Elite Nominator. Użytkownik ::{ flag=CN }:: [gzdongsheng](https://osu.ppy.sh/users/8660315) otrzymał tytuł **Elite Nominator III** za trzykrotne zdobycie tytułu Elite Nominator.
[^charles445-note]: ::{ flag=US }:: Użytkownik [Charles445](https://osu.ppy.sh/users/85000) otrzymał tytuł **Elite Mapper II: Aspirant** za wygranie [pierwszego Monthly Beatmapping Contest](https://osu.ppy.sh/home/news/2013-10-20-monthly-beatmapping-contest-1-results) oraz [Monthly Beatmapping Contest: Aspire (2014)](https://osu.ppy.sh/home/news/2014-11-13-monthly-beatmapping-contest-aspire-results).
[^billiummoto-note]: Użytkownik ::{ flag=US }:: [BilliumMoto](https://osu.ppy.sh/users/3862471) otrzymał tytuł **osu!mixer II** za wygranie [osu!remix contest #1](https://osu.ppy.sh/home/news/2016-08-29-osuremix-contest-1-results) oraz konkursu [A Labour of Love](/wiki/Contests/A_Labour_of_Love_Contest).
[^yf-note]: ::{ flag=CN }:: Użytkownik [yf_bmp](https://osu.ppy.sh/users/1243669) otrzymał tytuł **Elite Storyboarder II**, gdyż [zdobył tytuł Elite Storyboard](https://osu.ppy.sh/home/news/2021-03-19-community-contributors-2020) za swój szczególny wkład w tej części gry, a ponadto stworzył storyboard dla zwycięskiej beatmapy w [triangles Beatmapping Contest](/wiki/Contests/triangles_Beatmapping_Contest).
