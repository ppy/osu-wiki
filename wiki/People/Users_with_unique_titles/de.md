...
| ::{ flag=AU }:: [mrekk](https://osu.ppy.sh/users/7562902) | Limit Breaker | [Übertraf die 16-Bit-Ganzzahlgrenze von 32.767 in der Performancepunkte-Anzeige in osu!(stable)](https://osu.ppy.sh/home/changelog/stable40/20250306.2) |
| ::{ flag=BR }:: [Dropinx](https://osu.ppy.sh/users/4687701) | Medal Hunter | War die erste Person, die mit Stand vom 16. Oktober 2025 alle Medaillen in allen vier Spielmodi freigeschalten hat |
...
[^elite-note]: ::{ flag=ID }:: [Maxus](https://osu.ppy.sh/users/4335785), ::{ flag=US }:: [Monoseul](https://osu.ppy.sh/users/16010604) und ::{ flag=RU }:: [NeKroMan4ik](https://osu.ppy.sh/users/11387664) wurden stattdessen mit dem Titel **Elite Nominator II** ausgezeichnet, da sie insgesamt zwei Jahre als Elite Nominators betitelt wurden. ::{ flag=CN }:: [gzdongsheng](https://osu.ppy.sh/users/8660315) wurde stattdessen mit dem Titel **Elite Nominator III** ausgezeichnet, da er insgesamt für drei Jahre als Elite Nominator betitelt wurde.
