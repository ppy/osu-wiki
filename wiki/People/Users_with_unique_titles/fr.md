...
Les titres utilisateurs sont généralement associés avec [user groups](/wiki/People/The_Team#user-groups), mais les utilisateurs listés ci-dessous ont reçu leurs titres pour d'autres raisons. La plupart de ces titres sont des récompenses pour des contributions ou des succès, le reste étant des preuves de l'histoire iconique ou drôle 

## Par catégorie, avec les raisons

### Gagnants de World Cup

Un des prix donnés a la première place de [official World Cups](/wiki/Tournaments#official-world-cups) est un titre utilisateur qui dure pour un an.

Gagnants de [OWC 2020](/wiki/Tournaments/OWC/2020) avec le titre utilisateur **osu! Champion**:
...
Gagnants de [TWC 2020](/wiki/Tournaments/TWC/2020) avec le titre utilisateur **osu!taiko Champion**:
...
Gagnants de [CWC 2020](/wiki/Tournaments/CWC/2020) avec le titre utilisateur **osu!catch Champion**:
...
Gagnants de [MWC 4K 2020](/wiki/Tournaments/MWC/2020_4K) avec le titre utilisateur **osu!mania Champion**:
