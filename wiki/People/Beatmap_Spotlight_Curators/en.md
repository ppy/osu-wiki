...
The **Beatmap Spotlight Curators** (***BSC***) is a group that assists in selecting high-quality maps for each season of the [Beatmap Spotlights](/wiki/Beatmap_Spotlights). They are distinguished by their moonstone blue [user group](/wiki/People/User_group) badge that reads `BSC`.
