...
| :-- | :-- | :-- | :-- |
| ::{ flag=US }:: [clayton](https://osu.ppy.sh/users/3666350) | [cl8n](https://github.com/cl8n) | 不活跃 |  |
| ::{ flag=AU }:: [Ephemeral](https://osu.ppy.sh/users/102335) | [Ephemeralis](https://github.com/Ephemeralis) | 不活跃 |  |
| ::{ flag=TN }:: [Hivie](https://osu.ppy.sh/users/14102976) | [Hiviexd](https://github.com/Hiviexd) | **活跃** | 阿拉伯语 |
| ::{ flag=US }:: [Joehu](https://osu.ppy.sh/users/8549835) | [Joehuu](https://github.com/Joehuu) | 不活跃 |  |
...
以下列出的是负责常规维护工作外，还参与管理、编辑、批准网站上所有[新闻](https://osu.ppy.sh/home/news)的维护者。
