...
현재 NAT 리더는 ::{ flag=TN }:: ::Hivie::{ user=14102976 }와 ::{ flag=US }:: ::radar::{ user=7131099 }입니다.
...
| 닉네임 | 구사 언어 | 배정 그룹 |
| :-- | :-- | :-- |
| ::{ flag=GB }:: ::-Mo-::{ user=2202163 } |  | 고문[^task-mo] |
| ::{ flag=BY }:: ::AirinCat::{ user=11119539 } | 벨라루스어, 러시아어 | 평가위원 |
| ::{ flag=HK }:: ::Chaoslitz::{ user=3621552 } | 광둥어, 중국어 | 평가위원 |
| ::{ flag=BR }:: ::Dada::{ user=9119507 } | 포르투갈어 | 평가위원 |
| ::{ flag=AU }:: ::elicz1::{ user=8039342 } |  | 평가위원 |
| ::{ flag=BE }:: ::enneya::{ user=10959501 } | 네덜란드어 | 평가위원 |
| ::{ flag=CN }:: ::Firika::{ user=9590557 } | 중국어 | 평가위원 |
| ::{ flag=DE }:: ::FuJu::{ user=10773882 } | 독일어 | 평가위원, 고문[^task-fuju] |
| ::{ flag=CN }:: ::Garden::{ user=2849992 } | 중국어 | 평가위원 |
| ::{ flag=SE }:: ::Naxess::{ user=8129817 } | 스웨덴어 | 고문[^task-naxess] |
| ::{ flag=US }:: ::Noffy::{ user=1541323 } |  | 평가위원 |
| ::{ flag=HK }:: ::Petal::{ user=7354729 } | 광둥어, 중국어 | 평가위원 |
| ::{ flag=US }:: ::pishifat::{ user=3178418 } |  | 고문[^task-pishifat] |
| ::{ flag=CN }:: ::Ryuusei Aika::{ user=7777875 } | 중국어 | 평가위원 |
| ::{ flag=US }:: ::StarCastler::{ user=12402453 } |  | 평가위원, 고문[^task-star] |
| ::{ flag=BE }:: ::yaspo::{ user=4945926 } | 네덜란드어 | 평가위원 |
| ::{ flag=US }:: ::Yogurtt::{ user=2649717 } |  | 평가위원 |
| ::{ flag=PL }:: ::Zelq::{ user=8953955 } | 폴란드어 | 평가위원 |

### osu!taiko

| 이름 | 구사 언어 | 배정 그룹 |
| :-- | :-- | :-- |
| ::{ flag=DE }:: ::Capu::{ user=2474015 } | 독일어 | 평가위원 |
| ::{ flag=GB }:: ::Dusk-::{ user=6092181 } | 우르두어, 일부 아랍어 | 평가위원 |
| ::{ flag=TN }:: ::Hivie::{ user=14102976 } | 아랍어, 프랑스어, 일부 이탈리아어 | 리더 |
| ::{ flag=BR }:: ::Ideal::{ user=3869519 } | 포르투갈어 | 평가위원 |
| ::{ flag=US }:: ::radar::{ user=7131099 } |  | 리더 |

### osu!catch

| 이름 | 구사 언어 | 배정 그룹 |
| :-- | :-- | :-- |
| ::{ flag=ES }:: ::Deif::{ user=318565 } | 스페인어, 독일어 | 평가위원 |
| ::{ flag=NL }:: ::Greaper::{ user=2369776 } | 네덜란드어 | 평가위원 |
| ::{ flag=US }:: ::Secre::{ user=2306637 } |  | 평가위원 |

### osu!mania

| 이름 | 구사 언어 | 배정 그룹 |
| :-- | :-- | :-- |
| ::{ flag=VN }:: ::Akasha-::{ user=2596306 } | 베트남어 | 평가위원 |
| ::{ flag=CN }:: ::gzdongsheng::{ user=8660315 } | 중국어 | 평가위원 |
| ::{ flag=ID }:: ::Maxus::{ user=4335785 } | 인도네시아어 | 평가위원 |
| ::{ flag=DK }:: ::Tailsdk::{ user=6751666 } | 덴마크어 | 평가위원 |
