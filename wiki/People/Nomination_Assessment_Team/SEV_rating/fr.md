...
::: alert-notice
**Note**
Une réinitialisation effectuée pour corriger des choses qui seraient considérées comme correctes si elles n'étaient pas corrigées est toujours notée 0/0. Ceci afin de ne pas décourager les moddeurs et l'application d'améliorations sur les [beatmaps qualifiées](/wiki/Beatmap/Category#qualified).
:::
