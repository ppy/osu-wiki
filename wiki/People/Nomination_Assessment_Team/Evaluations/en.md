...
Once the feedback is written and reviewed, it will be sent and accompany any [user group](/wiki/People/User_group) changes needed. The feedback will be delivered by the ::Nomination Assessment Team bot::{ user=6616586 } as an [announcement message](/wiki/Announcement_messages).
...
Once a consensus for the resignation terms has been reached, the NAT will send the BN an announcement message via the ::Nomination Assessment Team bot::{ user=6616586 } informing them of their status and when they can reapply to become a BN if they so choose.
