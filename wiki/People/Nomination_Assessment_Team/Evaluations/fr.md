...
Une fois les commentaires rédigés et examinés, ils seront envoyés et accompagneront tout changement de [groupe d'utilisateurs](/wiki/People/User_group) nécessaire. Les commentaires seront transmis par le ::Nomination Assessment Team bot::{ user=6616586 } sous la forme d'un [message d'annonce](/wiki/Announcement_messages).
...
Une fois qu'un consensus sur les conditions de la démission aura été atteint, la NAT enverra au BN un message d'annonce via le ::Nomination Assessment Team bot::{ user=6616586 } l'informant de son statut et de la date à laquelle il pourra, s'il le souhaite, présenter une nouvelle demande pour devenir BN.
