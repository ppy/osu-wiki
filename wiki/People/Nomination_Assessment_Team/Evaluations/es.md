...
Una vez redactado y revisado el informe, se enviará y se realizarán los cambios necesarios en los [grupos de usuarios](/wiki/People/User_group). El ::bot del Nomination Assessment Team::{ user=6616586 } enviará el informe en forma de [mensaje de anuncio](/wiki/Announcement_messages).
...
Una vez que se haya llegado a un acuerdo sobre los términos de la renuncia, el NAT le enviará un mensaje de anuncio al BN a través del ::bot del Nomination Assessment Team::{ user=6616586 } informándole de su situación y de cuándo puede volver a solicitar convertirse en un BN si así lo desea.
