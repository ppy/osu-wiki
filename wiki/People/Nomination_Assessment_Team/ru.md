...
| ::{ flag=CN }:: [MadBricktree](https://osu.ppy.sh/users/4790958) | Корейский | Оценка |
...
| :-- | :-- | :-- |
| ::{ flag=XX }:: [Nomination Assessment Team](https://osu.ppy.sh/users/6616586) | Официальное представление команды |
