...
| ::{ flag=BY }:: ::AirinCat::{ user-id=11119539 } | เบลารุส, รัสเซีย | Evaluation |
| ::{ flag=HK }:: ::Chaoslitz::{ user-id=3621552 } | กวางตุ้ง, จีน | Evaluation |
| ::{ flag=BR }:: ::Dada::{ user-id=9119507 } | โปรตุเกส | Evaluation |
| ::{ flag=AU }:: ::elicz1::{ user-id=8039342 } |  | Evaluation |
| ::{ flag=BE }:: ::enneya::{ user-id=10959501 } | ดัตช์ | Evaluation |
| ::{ flag=CN }:: ::Firika::{ user-id=9590557 } | จีน | Evaluation |
| ::{ flag=DE }:: ::FuJu::{ user-id=10773882 } | เยอรมัน | Evaluation, structural |
| ::{ flag=CN }:: ::Garden::{ user-id=2849992 } | จีน | Evaluation |
| ::{ flag=SE }:: ::Naxess::{ user-id=8129817 } | สวีเดน | Structural |
| ::{ flag=US }:: ::Noffy::{ user-id=1541323 } |  | Evaluation |
| ::{ flag=HK }:: ::Petal::{ user-id=7354729 } | กวางตุ้ง, จีน | Evaluation |
| ::{ flag=US }:: ::pishifat::{ user-id=3178418 } |  | Structural |
| ::{ flag=CN }:: ::Ryuusei Aika::{ user-id=7777875 } | จีน | Evaluation |
| ::{ flag=US }:: ::StarCastler::{ user-id=12402453 } |  | Evaluation, structural |
| ::{ flag=BE }:: ::yaspo::{ user-id=4945926 } | ดัตช์ | Evaluation |
| ::{ flag=US }:: ::Yogurtt::{ user-id=2649717 } |  | Evaluation |
| ::{ flag=PL }:: ::Zelq::{ user-id=8953955 } | โปแลนด์ | Evaluation |

### osu!taiko

| ชื่อ | ภาษาเพิ่มเติม | หน้าที่หลัก |
| :-- | :-- | :-- |
| ::{ flag=DE }:: ::Capu::{ user-id=2474015 } | เยอรมัน | Evaluation |
| ::{ flag=GB }:: ::Dusk-::{ user-id=6092181 } | อูรดู, อาหรับ บ้าง | Evaluation |
| ::{ flag=TN }:: ::Hivie::{ user-id=14102976 } | อาหรับ, ฝรั่งเศส, อิตาลี บ้าง | Leadership |
| ::{ flag=BR }:: ::Ideal::{ user-id=3869519 } | โปรตุเกส | Evaluation |
...
| ชื่อ | ภาษาเพิ่มเติม | หน้าที่หลัก |
| :-- | :-- | :-- |
| ::{ flag=ES }:: ::Deif::{ user-id=318565 } | สเปน, เยอรมัน | Evaluation |
| ::{ flag=NL }:: ::Greaper::{ user-id=2369776 } | ดัตช์ | Evaluation |
...
| ชื่อ | ภาษาเพิ่มเติม | หน้าที่หลัก |
| :-- | :-- | :-- |
| ::{ flag=VN }:: ::Akasha-::{ user-id=2596306 } | เวียดนาม | Evaluation |
| ::{ flag=CN }:: ::gzdongsheng::{ user-id=8660315 } | จีน | Evaluation |
| ::{ flag=ID }:: ::Maxus::{ user-id=4335785 } | อินโดนีเซีย | Evaluation |
| ::{ flag=DK }:: ::Tailsdk::{ user-id=6751666 } | เดนมาร์ก | Evaluation |
