...
| :-- | :-- | :-- |
| ::{ flag=GB }:: ::-Mo-::{ user-id=2202163 } |  | Оценка, Модерация |
| ::{ flag=HK }:: ::Chaoslitz::{ user-id=3621552 } | Кантонски, Китайски | Оценка |
| ::{ flag=GB }:: ::hypercyte::{ user-id=9155377 } | Бенгалски, малко Арабски | Оценка, Структура, Модерация, Комуникация |
| ::{ flag=SE }:: ::Naxess::{ user-id=8129817 } | Шведски | Структура, Комуникация |
| ::{ flag=US }:: ::Noffy::{ user-id=1541323 } |  | Оценка, Структура, Комуникация |
| ::{ flag=US }:: ::pishifat::{ user-id=3178418 } |  | Структура |
| ::{ flag=US }:: ::UberFazz::{ user-id=8646059 } |  | Оценка |
| ::{ flag=CL }:: ::Uberzolik::{ user-id=1314547 } | Испански, Френски | Оценка |
| ::{ flag=BE }:: ::yaspo::{ user-id=4945926 } | Немски | Оценка |
| ::{ flag=PL }:: ::Zelq::{ user-id=8953955 } | Полски | Оценка |

### osu!taiko

| Име | Допълнителен език | Основни отговорности |
| :-- | :-- | :-- |
| ::{ flag=DE }:: ::Capu::{ user-id=2474015 } | Немски | Оценка |
| ::{ flag=HK }:: ::Faputa::{ user-id=845733 } | Кантонски, Китайски | Оценка |
| ::{ flag=US }:: ::radar::{ user-id=7131099 } |  | Оценка |

### osu!catch

| Име | Допълнителен език | Основни отговорности |
| :-- | :-- | :-- |
| ::{ flag=ES }:: ::Deif::{ user-id=318565 } | Испански, Немски | Оценка, Модерация |
| ::{ flag=NL }:: ::Greaper::{ user-id=2369776 } | Немски | Оценка, Структура |
| ::{ flag=KR }:: ::Spectator::{ user-id=702598 } | Корейски | Оценка, Комуникация |

### osu!mania

| Име | Допълнителен език | Основни отговорности |
| :-- | :-- | :-- |
| ::{ flag=ES }:: ::Quenlla::{ user-id=4725379 } | Spanish, Portuguese, Galician, Italian, Japanese | Оценка |
| ::{ flag=DZ }:: ::Scotty::{ user-id=11085809 } | Арабски, Френски | Оценка |
| ::{ flag=US }:: ::Unpredictable::{ user-id=7560872 } |  | Оценка |
