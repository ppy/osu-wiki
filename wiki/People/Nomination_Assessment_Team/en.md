...
The current NAT leader is ::{ flag=TN }:: ::Hivie::{ user=14102976 }.
...
| :-- | :-- |
| ::{ flag=IT }:: ::-kevincela-::{ user=266596 } | Italian |
| ::{ flag=US }:: ::-White::{ user=16276548 } |  |
| ::{ flag=FI }:: ::Asphyxia::{ user=1715720 } | Finnish |
| ::{ flag=SE }:: ::byd::{ user=6398464 } | Swedish |
| ::{ flag=TH }:: ::Electoz::{ user=6485263 } | Thai |
| ::{ flag=BE }:: ::enneya::{ user=10959501 } | Dutch |
...
| ::{ flag=TW }:: ::Muchin::{ user=9834516 } | Chinese |
| ::{ flag=RO }:: ::bsm::{ user=12366071 } | Romanian |
...
| ::{ flag=HK }:: ::BlackBN::{ user=6291741 } | Cantonese, Chinese |
...
| Name | Additional languages |
| :-- | :-- |
| ::{ flag=AT }:: ::Daletto::{ user=7592136 } | German |
| ::{ flag=KR }:: ::Rocma::{ user=566276 } | Korean |
| ::{ flag=KR }:: ::Spectator::{ user=702598 } | Korean |
...
| ::{ flag=DO }:: ::Antalf::{ user=8793773 } | Spanish |
| ::{ flag=CN }:: ::gzdongsheng::{ user=8660315 } | Chinese |
| ::{ flag=IT }:: ::Harbyter::{ user=1147679 } | Italian |
...
| ::{ flag=NL }:: ::Greaper::{ user=2369776 } | [Nomination Planner](https://bnplanner.greaper.net/beatmaps) and [Mapset Verifier](https://github.com/Naxesss/MapsetVerifier) development |
...
In addition, the ::Nomination Assessment Team bot::{ user=6616586 } acts as a proxy for the NAT to collectively deliver messages under one user account without directly attributing them to anyone. It may be used for evaluation responses, mock evaluations, mediations, reports, and content reviews, along any other miscellaneous purposes.
