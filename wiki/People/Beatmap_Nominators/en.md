...
The **Beatmap Nominators** (***BN***) is a group in charge of [beatmap nomination](/wiki/Beatmap_ranking_procedure). They are distinguished in by their purple user title and [user group](/wiki/People/User_group) badge that reads `BN`.
