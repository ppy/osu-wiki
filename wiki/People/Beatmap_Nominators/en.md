...
The **Beatmap Nominators** (***BN***) is a group in charge of [beatmap nomination](/wiki/Beatmap_ranking_procedure). hey are distinguished in the forums and in [beatmap discussions](/wiki/Beatmap_discussion) by their purple [user group](/wiki/People/User_group) badge that reads `BN`.
...
| ::{ flag=CN }:: [MadBricktree](https://osu.ppy.sh/users/4790958) | Korean |
...
| ::{ flag=US }:: [Alicenometry](https://osu.ppy.sh/users/29978316) | Japanese |
