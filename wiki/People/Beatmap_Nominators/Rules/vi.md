...
Người đề cử beatmap có công cụ để đề cử beatmap và định hình hệ sinh thái osu! qua thúc đẩy nội dung mới hướng tới việc được đưa vào danh sách chính thức; vì lý do này, họ đều phải chấp hành các quy tắc này mọi lúc. Việc vi phạm bất kì những điều này có thể dẫn đến người đề cử beatmap tương ứng bị xóa khỏi Nhóm đề cử beatmap. Các vi phạm với mỗi quy tắc có thể được báo cáo trực tiếp đến NAT thông qua [website quản lý BN](https://bn.mappersguild.com/reports)
...
- **Tuân thủ [Quy tắc cộng đồng osu!](/wiki/Rules) và [Quy tắc ứng xử đối với modding và mapping](/wiki/Rules/Code_of_conduct_for_modding_and_mapping) tại mọi thời điểm.** Với tư cách là một người đề cử beatmap, hành vi của bạn nên được làm gương tích cực đến những thành viên khác trong cộng đồng. Vi phạm Bộ Quy Tắc Ứng Xử có thể dẫn đến việc bạn nhận được cảnh báo về hành vi, hoặc trong trường hợp nghiêm trọng, bạn sẽ bị loại khỏi người đề cử beatmap. 
- **Không được góp phần hoặc tham gia vào các modding, xếp hạng trả phí HOẶC nhận hoa hồng qua việc làm beatmap.** Không được để tồn tại bất kỳ nghi ngờ nào nào đến tính hợp pháp hoặc động cơ với bất kỳ các thành viên thuộc đội ngũ osu! (BN, NAT hoặc người khác) liên quan đến [quá trình xếp hạng](/wiki/Beatmap_ranking_procedure)

## Hoạt động

Hoạt động của người đề cử beatmap được đáng giá trên số lượng đề cử,[^multi-key-mode] và được đánh giá trong các đợt đánh giá BN thường xuyên, điều này diễn ra khoảng 90 ngày mỗi lần. 
...
- Khi nhận được cảnh báo hoạt động, các yêu cầu hoạt động tối hiểu phải được đáp ứng sau 30 ngày
...
- **Các vấn đề có thể được giảm bớt qua offset trực tuyến, tag hoặc tương tự vẫn phải bị loại.** Trong trường hợp không khả thi, hãy liên hệ một thành viên NAT, offset trực tuyến và tag chỉ áp dụng được với wedsite, vì vậy người chơi vẫn sẽ có vấn đề trong client ngoài trừ sửa trước khi xếp hạng. 
