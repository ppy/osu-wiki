...
- **Не номинируйте карты, на которые наложено вето:** сначала оно должно быть снято. Этого можно добиться двумя путями: вето снимается либо наложившим его номинатором после перепроверки карты, либо после командного голосования, где большинство признало вето незначительным или вредящим карте.
