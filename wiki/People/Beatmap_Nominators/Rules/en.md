...
When a Beatmap Nominator's evaluation is created and they still need to meet their minimum activity requirements, they will receive a reminder via the ::NAT bot::{ user-id=6616586 } and will be given **7** days to meet their quota.
