...
+ **You can veto a pending or qualified beatmap set by posting the issues you think need to be addressed before reaching Ranked status, and then contacting a QAT member for a disqualification if necessary.** You must participate in the resulting discussion and attempt to reach a mutual agreement. The veto post must include a clear problem and reasoning for stopping the beatmap set's Ranking process.
