...
- Hybrid Beatmap Nominators must nominate at least **3** beatmaps per proficient game mode over a 90-day period.
  - Falling below **2** nominations per proficient game mode in a 90-day period will result in a removal.
  - Falling below the **3** nomination requirement per proficient game mode with **2** or more nominations will result in an activity warning.
