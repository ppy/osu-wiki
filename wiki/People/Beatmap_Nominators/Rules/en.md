...
+ **You can veto a qualified beatmap set by posting the issues you think need to be addressed before reaching Ranked status, and then contacting a member of the QAT.** You must participate in the resulting discussion and attempt to reach a mutual agreement. The following conditions must be met before the veto is applied and the set is disqualified, however:
  + The veto post must include a clear problem and reasoning for pausing the beatmap set's ranking process.
  + Unless the beatmap set reaches Ranked status in less than 1 day, the veto post must be at least 1 day old to allow for observation of test plays and additional feedback.
