...
+ **Make sure no mod posts in the beatmap thread have been ignored before nominating a beatmap.** Posts without a sufficient reply may count as ignored. When in doubt, double check if the Code of Conduct for Mapping and Modding has been violated on the beatmap thread and act accordingly.
...
+ **Every beatmapset is approved through two nominations.** Other factors such as the beatmapset itself being a Marathon, a normal spread or its length do not matter, the amount of nominations required in order to move it to the Qualified section remains at two. More nominations than necessary must not be done.
...
+ **If a bubbled beatmap contains unrankable issues, its nomination(s) must be popped.** This applies even if you do not intend to nominate the beatmapset.
