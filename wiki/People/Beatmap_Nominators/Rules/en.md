...
+ **The first line in the disqualification post must contain a short reason for the disqualification.** This includes requested disqualifications; simply writing that it was requested is not enough. You must also link any related issues posted in the beatmap discussions unless there are too many to post, however, avoid posting only links in the first line of the post.
