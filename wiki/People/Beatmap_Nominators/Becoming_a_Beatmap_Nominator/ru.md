...
- В случае кандидатов в номинаторы для [osu!](/wiki/Game_mode/osu!) — минимум 200 [кудосу](/wiki/Modding/Kudosu), для остальных режимов — 150 [кудосу](/wiki/Modding/Kudosu).
- Ссылки на 3 мода, демонстрирующих навыки кандидата в роли номинатора.
...
Моды, приводимые в качестве примеров, должны отражать навыки анализа и улучшения карт на уровне номинатора.
...
- **Умение донести свою мысль до автора карты.**
  - Ваши моды должны рассказывать о найденных недочётах и их решениях так чётко и кратко, как только возможно, чтобы маппер смог не только понять суть проблемы, но и правильно её адресовать. Не рекомендуется использовать специализированную терминологию без надобности.
...
На данном этапе оцениваются не только навыки моддинга, но и поведение автора заявки: проверяющие обратят внимание на положительные и отрицательные стороны в написанных модах, после чего каждый из них отдаст за заявку положительный, нейтральный или отрицательный голос.

Критерии оценки следующие:

- **Моддинг:** знание [критериев ранкинга](/wiki/Ranking_criteria) — как общих, так и специфичных для [выбранных режимов игры](/wiki/Game_mode). Выполнение [ожиданий от моддинга](#modding-expectations). Additional abilities relating to metadata, timing, and some others will also be taken into consideration.
