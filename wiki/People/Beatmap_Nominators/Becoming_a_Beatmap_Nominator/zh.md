...
之后，评估流程结束并即将存档（提供以后可能的参考）。评估员们会撰写并补充反馈意见，来补充负责这个申请的评估员所遗漏的信息。结果会由 ::NAT 机器人::{ user=6616586 } 通过[通知消息](/wiki/Announcement_messages)的方式反馈给申请者。如果申请通过，申请者将在结果送出后马上加入实习 BN。
