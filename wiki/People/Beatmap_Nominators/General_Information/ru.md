...
**С помощью этой кнопки карту можно номинировать на ранк.** Для этого у неё должно быть как минимум 5 [хайпов](/wiki/Beatmap/Hype), а все проблемы или предложения в обсуждении должны быть закрыты. Перед номинацией убедитесь, что у вас нет претензий ни к одной сложности (даже в режимах игры, в которых вы не разбираетесь). Если на карту было наложено вето, убедитесь, что оно решено или снято. Когда у карты будет 2 номинации (или больше, если это [гибрид](/wiki/Beatmap_ranking_procedure#примечания)), она сменит статус на [Qualified](/wiki/Beatmap/Category#qualified) и попадёт в [очередь ранкинга](/wiki/Beatmap_ranking_procedure/Ranking_queue).
...
Полноправные номинаторы могут в любое время проверять карты в категории Qualified на предмет наличия ошибок.

### Рассмотрение вето

В голосовании за вето участвуют все номинаторы и члены NAT, разбирающиеся в её режимах игры. Если вето не связано с конкретным режимом, то за него могут голосовать все желающие. Когда вето откроется для голосования, NAT даст вам об этом знать, прислав инструкции по голосованию на [веб-сайте для номинаторов](http://bn.mappersguild.com). По окончанию рассмотрения голоса суммируются для принятия итогового решения об отмене или сохранении вето.
