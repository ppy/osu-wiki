...
- [Mapset Verifier](https://osu.ppy.sh/community/forums/topics/943895): A tool built by NAT member ::Naxess::{ user=8129817 }. This tool checks for a wide range of unrankable issues, and features a snapshot feature to easily compare versions of maps, which is beneficial when rechecking. **This should not replace checking a beatmap yourself**, but instead be used as a tool to help double-check nothing slipped by.
