...
- [作图验证器 (Mapset Verifier)](https://osu.ppy.sh/community/forums/topics/943895)：NAT 成员 ::Naxess::{ user=8129817 } 制作的一款工具。这个工具可用来检查大量导致谱面无法上架的问题，并且包含一个快照功能，可以轻松对比不同版本的谱面——这对于再次检查非常有用。**但是，这一工具不应该代替人工谱面检查**。它应该在二次确认时使用，以确保谱面没有遗漏的问题。
