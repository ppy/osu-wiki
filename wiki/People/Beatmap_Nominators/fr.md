...
Les **Beatmap Nominators** (***BN***) sont un groupe chargé de la [nomination des beatmaps](/wiki/Beatmap_ranking_procedure). Ils se distinguent par la couleur pourpre de leur badge de [groupe utilisateurs](/wiki/People/User_group) sur lequel on peut lire `BN`.
