...
::Echo::{ user=431 } created a prototype for the first modding test in 2008; however, it was not used for new BN (previously known as [Beatmap Approval Team](/wiki/People/Beatmap_Appreciation_Team) (*BAT*)) applicants. Users were expected to point out mistakes in an intentionally flawed beatmap, [Arashi - Kitto Daijoubu](http://up.ppy.sh/files/Arashi%20-%20Kitto%20Daijoubu.rar).
