...
设立见习期的目的，是用来帮助 NAT 关注新的或者待定的 BN 的行为。见习成员的主要职责是在实际推送谱面上架流程中打好作为 BN 的基本功。谱面若要上架 (Ranked)，则提名者中必须有至少一位正式成员。因此，见习成员不能提名已被其他相同游戏模式的见习成员提名过的谱面。
...
| ::{ flag=BA }:: [Stompy_](https://osu.ppy.sh/users/16429579) | 波斯尼亚语 |
...
| 名字 | 语言 |
| :-- | :-- |
| ::{ flag=US }:: [-Kazuha](https://osu.ppy.sh/users/29978316) | 日语 |
...
| ::{ flag=ID }:: [Dapuluous](https://osu.ppy.sh/users/8140944) | 印度尼西亚语 |
...
| ::{ flag=PL }:: [Phob](https://osu.ppy.sh/users/6069462) | 波兰语 |
| ::{ flag=US }:: [Usaha](https://osu.ppy.sh/users/6443117) |  |
...
| ::{ flag=CN }:: [MadBricktree](https://osu.ppy.sh/users/4790958) | 韩语 |
...
| ::{ flag=ID }:: [Suzume Ayase](https://osu.ppy.sh/users/14190991) | 印度尼西亚语 |
...
| ::{ flag=DE }:: [Vincus](https://osu.ppy.sh/users/16124906) | 德语 |
...
| 名字 | 语言 |
| :-- | :-- |
| ::{ flag=AR }:: [Hareimu](https://osu.ppy.sh/users/4138746) | 西班牙语 |
...
| ::{ flag=KR }:: [ssapgosu](https://osu.ppy.sh/users/16564480) | 韩语 |
| ::{ flag=ID }:: [Ucitysm](https://osu.ppy.sh/users/14768693) | 印度尼西亚语 |
