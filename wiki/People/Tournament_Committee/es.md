...
El **comité de torneos** es un panel de organizadores y ayudantes expertos establecidos en la escena de los torneos. Los miembros del comité de torneos se distinguen por su título de usuario naranja y su insignia de [grupo de usuarios](/wiki/People/User_groups) que dice `TC`. El panel se anunció por primera vez al público el 22 de julio de 2021 a través del canal `#tournaments` en el [servidor de Discord osu!](https://discord.com/invite/ppy) en respuesta al rápido crecimiento de la escena de los torneos de la comunidad en osu!.
...
- Tramitar los tickets enviados a través del [sitio web del comité de torneos](https://tcomm.hivie.tn/tickets/create).
...
Los [tickets](https://tcomm.hivie.tn/tickets/create) son la forma preferida para que los jugadores y el personal de un torneo le puedan plantear al comité de torneos preguntas que requieran una discusión en grupo. Los tickets le permiten al comité responder sin tener que pasar por el [equipo de soporte de cuentas](/wiki/People/Account_support_team), lo que da como resultado tiempos de respuesta mucho más rápidos en comparación con el correo electrónico. Las solicitudes para el soporte oficial deben enviarse **siempre** por correo electrónico. Ten en cuenta que cualquier ticket enviado aquí es **público**. Para consultas privadas o anónimas, se recomienda ponerse en contacto por correo electrónico.

### Revisión de los torneos

Una vez que un torneo ha finalizado y ha solicitado un premio en forma de insignia, se asignan dos miembros al azar del comité de torneos para examinar el torneo. Si alguno de esos miembros tiene un conflicto de intereses, está obligado a comunicarlo para que se pueda designar a otra persona en su lugar. Los miembros asignados se asegurarán de que el torneo cumpla con todos los criterios del [soporte oficial](/wiki/Tournaments/Official_support), incluyendo:
...
- Los mappools del torneo son públicos y no infringen ninguna [regla del uso de contenido](/wiki/Rules/Content_usage_permissions).

Los miembros asignados indicarán los torneos que superen el proceso de revisión como aptos para recibir insignias. El equipo de soporte de cuentas aplicará las insignias más adelante a los perfiles de los ganadores. Si un torneo no pasa el proceso de revisión, los miembros revisores podrán informar al equipo de soporte de cuentas sobre los cambios que deben comunicarse a los organizadores del torneo.
...
- Una vez concluida la investigación y cuando el comité de torneos considere la posibilidad de aplicar el castigo correspondiente, se realizará una votación para determinar si se aplica o no y la severidad de dicho castigo.
...
Si el organizador de un torneo considera que su torneo ha alcanzado el máximo nivel posible de calidad de producción y organización, puede solicitar que se le concedan premios en forma de insignia para los tres finalistas de su torneo. Si un organizador solicita que se le conceda esta distinción, los miembros asignados también lo notificarán al resto del comité de torneos para su discusión. Después de esta discusión, se llevará a cabo una votación.
...
El método principal para comunicarse con el público es a través de los canales `#tournaments` y `#tournament-news` del [servidor de Discord osu!](https://discord.gg/ppy). El canal `#tournaments` es un lugar ideal para hacer preguntas rápidas que no requieran una deliberación interna exhaustiva. Para temas más complejos, se recomienda abrir un [ticket](https://tcomm.hivie.tn/tickets).

El [sitio web del comité de torneos](https://tcomm.hivie.tn/) es un recurso que los usuarios pueden usar para ponerse en contacto directamente con el comité a través de reportes y tickets. El sitio web también cuenta con una [herramienta](https://tcomm.hivie.tn/mappool-compliance) para comprobar si los beatmaps cumplen con las [reglas del uso de contenido](/wiki/Rules/Content_usage_permissions). El comité usa este sitio para organizar votaciones, mantener los recursos de la comunidad, hacer revisiones y actualizar el estado de las solicitudes para el soporte oficial.
...
El comité de torneos mantiene una [cuenta en Twitter](https://twitter.com/osu_tcomm), donde se pueden publicar actualizaciones y cambios de diversos tipos. Ten en cuenta que este método de comunicación es un complemento a las fuentes anteriores y ha sido reemplazado en gran medida por el canal `#tournament-news`.
...
Los candidatos seleccionados suelen reunir la mayoría de estas cualidades:

- Participa activamente en torneos oficiales y/o en la escena de torneos organizados por la comunidad
- Aporta una perspectiva única de la que actualmente carece el comité
- Demuestra experiencia en un área concreta de la escena de los torneos
- Mantiene un comportamiento y una conducta excelentes en línea
- Suele tener una excelente reputación dentro de la comunidad

Los solicitantes pueden presentar su solicitud en línea rellenando el [formulario de solicitud](https://forms.gle/3c51xGd3DzW2JCqV6) o enviando un correo electrónico a [tournaments@ppy.sh](mailto:tournaments@ppy.sh). Todos los solicitantes que envíen su solicitud por correo electrónico deberán detallar exhaustivamente sus contribuciones, su impacto y su participación en la escena de los torneos. El comité prefire (y recomienda usar) el formulario de solicitud, ya que ofrece mucho más contexto que un correo electrónico.

Una vez que un posible miembro envíe su solicitud por correo electrónico a [tournaments@ppy.sh](mailto:tournaments@ppy.sh) o [a través del formulario](https://forms.gle/3c51xGd3DzW2JCqV6), el comité mantendrá una discusión en profundidad sobre el candidato. Se presta especial atención a su actividad en la escena de los torneos, su prestigio, sus contribuciones a la comunidad y cómo podrían beneficiar al comité. Después de dicha discusión, se lleva a cabo una votación para decidir si se añade al candidato al comité.

Los solicitantes que no reúnan suficientes votos positivos serán rechazados y no podrán volver a presentar una solicitud hasta que hayan transcurrido seis meses desde la fecha de respuesta a su solicitud. El comité tiene como objetivo responder a los solicitantes en un plazo de dos semanas a partir de la fecha de la solicitud.
...
El comité de torneos solo puede ver el contenido de los correos electrónicos dirigidos a [tournaments@ppy.sh](mailto:tournaments@ppy.sh). Los correos electrónicos son redactados internamente por los miembros del comité antes de ser revisados y enviados por el equipo de soporte de cuentas. No pueden enviar correos electrónicos o ver los metadatos, como la dirección de correo electrónico o el nombre del remitente, solo el contenido del correo electrónico.
...
¡Puedes ayudar al comité de torneos al continuar organizando excelentes torneos! Si tienes algún problema o inquietud con respecto a cualquier aspecto de un torneo de la comunidad, te alentamos a que nos lo comuniques a través del formulario de [reportes para torneos](https://tcomm.hivie.tn/reports/create).

Los interesados en unirse al comité deben leer detenidamente la sección [«Incorporación de nuevos miembros»](#incorporación-de-nuevos-miembros) para conocer las expectativas del equipo y el proceso de solicitud.
...
En la [página del grupo del comité de torneos](https://osu.ppy.sh/groups/50) se enumeran a todos los miembros actuales del comité de torneos y concursos.
