...
- 审查[官方支持](/wiki/Tournaments/Official_support)比赛所发放的奖牌是否具有资格。
- 决定哪些比赛有向三位决赛选手颁发奖牌的资格。

此外，锦标赛委员会也会自行履行以下职责：

- 定期审查[官方锦标赛支持](/wiki/Tournaments/Official_support)页，进行必要的修订。
- 调查[锦标赛举报表格](https://tcomm.hivie.tn/reports/create)中的举报。
- 处理通过[锦标赛委员会网站](https://tcomm.hivie.tn/tickets/create)提交的工单。
...
[锦标赛举报](https://tcomm.hivie.tn/reports/create)是玩家和锦标赛工作人员发起举报的首选方式，用于举报不满足其标准和资格，但取得了[官方锦标赛支持](/wiki/Tournaments/Official_support)的比赛。当接收到新的举报时，所有锦标赛委员会成员都会自动收到通知。他们会根据举报内容，决定是否采取行动。这些行动包括但不限于：
...
建议玩家与锦标赛工作人员优先使用[工单](https://tcomm.hivie.tn/tickets/create)向委员会询问需要团队讨论的问题。工单让委员会无需经由[账号支持团队](/wiki/People/Account_support_team)即可发出回应，从而拥有比电子邮件快得多的响应速度。即便如此，官方支持请求必须**总**用电子邮件发送。请注意，在网站上提交的工单都是**公开可见**的。对于私人或匿名问题，推荐使用电子邮件联系。

### 锦标赛审查

锦标赛结束并请求颁发奖牌后，将给来自锦标赛委员会的两个随机的成员分配审查锦标赛的任务。如果任意一人由于冲突或兴趣而无法进行审查，他们必须作出声明，以便于将工作分配给其它成员。被分配的成员负责保证锦标赛遵循所有[官方支持](/wiki/Tournaments/Official_support)规则，包括如下内容：
...
- 锦标赛的图池公开可见，且遵守[内容使用规范](/wiki/Rules/Content_usage_permissions)。

指定的成员会公布通过审核，能够颁发奖章的锦标赛。在此之后，账户支持团队会将奖章添加到获胜者的主页上。如果锦标赛未通过审核，那么审核成员应向账户支持团队提出需要修改的内容，以便于他们与锦标赛主持者联系。如果锦标赛已经结束，无法完成修改，那么锦标赛委员会将主持匿名投票，决定是否撤销官方支持，或者对锦标赛组织者进行处罚。

[锦标赛举报表格](https://tcomm.hivie.tn/reports/create)有可能收到举报，指出锦标赛违反了官方锦标赛支持标准。对于已经结束的锦标赛（并且已经发送官方支持请求邮件），如果被举报，锦标赛委员会将采取以下行动：
...
锦标赛委员会通过几个频道与公众进行交流。这些频道的目的有时重叠，但所有频道都是取得锦标赛委员会最新信息的官方渠道。

[osu! Discord 服务器](https://discord.gg/ppy)的 `#tournaments` 与 `#tournament-news` 频道是公众交流的主要方式。`#tournaments` 频道很适合用来询问不需要长时间内部讨论的小问题。对于更复杂的话题，请去提交[工单](https://tcomm.hivie.tn/tickets)。

[锦标赛委员会网站](https://tcomm.hivie.tn/)是用户可通过举报与工单直接联系委员会的资源站。该网站还有一个[工具](https://tcomm.hivie.tn/mappool-compliance)，用于检查谱面是否符合[内容使用规范](/wiki/Rules/Content_usage_permissions)。委员会使用该网站来举行投票、维护社区资源、进行审查，以及维持官方支持状态。
...
锦标赛委员会维护着一个 [Twitter 账户](https://twitter.com/osu_tcomm)，用于发布各式各样的重要变化和更改。请注意，这种方式是对上述方式的补充，目前基本已被 `#tournament-news` 频道取代。
...
申请者可以通过填写[申请表格](https://forms.gle/3c51xGd3DzW2JCqV6)或向 [tournaments@ppy.sh](mailto:tournaments@ppy.sh) 发送电子邮件来提交申请。若使用电子邮件递交申请，则申请者需要详尽阐释其在锦标赛中的贡献、影响力与投入。委员会更建议使用申请表格，因为它能提供的信息比电子邮件丰富得多。

一旦潜在的成员通过发送邮件给 [tournaments@ppy.sh](mailto:tournaments@ppy.sh)，或[填写表格](https://forms.gle/3c51xGd3DzW2JCqV6)申请加入，锦标赛委员会将会就该候选人展开深入讨论。委员会将会重点考察候选人在锦标赛中的活跃度、声望、社区贡献，以及能为委员会带来的益处。讨论结束后，将会举行投票来决定是否接纳该候选人加入委员会。

若申请人未能获得足够支持票，则申请将被拒绝，并且自其收到回复起的 6 个月内都不能再申请。委员会力求在申请提交后的 2 周内给予申请人答复。

### 投票

锦标赛委员会经常通过投票来作出重要决定。典型的例子已经在上文列出，但投票的用处并不止这些。基于投票议题，投票要求也会变化。所有投票也需要满足“严格参与”原则。这意味着，若投票截止时参与的委员会成员未达 75%，投票截止时间将会无限期延长，直至达到参与门槛。此外，所有投票都需要获得绝对多数票（即至少 50%）才能采取行动。许多议题的投票要求相同，但下表列出的一些常见议题略有不同。

*备注：参与门槛只考虑到未因利益冲突而弃权的成员。*

| 投票类型 | 最短时间（天数） | 议题通过门槛 | 最低参与率 |
| :-- | --: | --: | --: |
| 中止奖牌支持 | 3 | 50% | 75% |
| 锦标赛封禁 | 3 | 50% | 75% |
| 锦标赛主办与工作人员封禁 | 3 | 50% | 75% |
| 前三名奖牌支持 | 4 | 80% | 100% |
| 接收新成员 | 4 | 80% | 100% |

## 锦标赛封禁时间长短

常见锦标赛封禁时间的长短可在[赛事处罚](/wiki/Help_centre/Tournament_sanctions#reasons) Wiki 页面找到。
...
锦标赛委员会只能看到发送到 [tournaments@ppy.sh](mailto:tournaments@ppy.sh) 的电子邮件的内容。回复由委员会成员内部起草完毕，随后由账户支持团队审阅并发出。他们不能直接发送邮件，也不能看到邮件元数据（例如发送者的电子邮件地址或名字），只能看到邮件内容。

### 我急需帮助！该怎么做？

若需要即时协助，请加入 [osu! Discord 服务器](https://discord.com/invite/ppy)，在 `#tournaments` 频道中提及 `@tournament-committee` 身份组。这种方法仅应在立即需要干预的紧急情况中使用。对于其他紧急问题，请提交[工单](https://tcomm.hivie.tn/tickets)并注明紧急情况。

## 我该如何贡献自己的力量？

你可以通过继续举办优秀的锦标赛来帮助锦标赛委员会！如果您对社区比赛的任何方面有任何问题或担忧，我们鼓励您通过[锦标赛报告表格](https://tcomm.hivie.tn/reports/create)告诉我们。

有兴趣加入锦标赛委员会的人应仔细阅读[“接收新的成员”一节](#接收新的成员)，了解团队对申请者的期望与申请流程。
...
[锦标赛委员会成员用户页](https://osu.ppy.sh/groups/50) 列出了当前所有的锦标赛委员会与竞赛委员会成员。
