...
申请者可以通过填写[申请表格](https://forms.gle/3c51xGd3DzW2JCqV6)或向 [tournaments@ppy.sh](mailto:tournaments@ppy.sh) 发送电子邮件来进行在线申请。若使用电子邮件递交申请，则申请者需要详尽阐释其在锦标赛中的贡献、影响力与投入。委员会更建议使用申请表格，因为它能提供的信息与电子邮件相比丰富得多。

一旦潜在的成员通过发送邮件给 [tournaments@ppy.sh](mailto:tournaments@ppy.sh)，或[填写表格](https://forms.gle/3c51xGd3DzW2JCqV6)申请加入，锦标赛委员会将对于该候选人进行深入探讨。委员会特别关注候选人在锦标赛中的活跃度、地位、社区贡献，以及该成员加入能够对锦标赛委员会有何种益处。经过上述讨论之后，将会举行投票来决定是否允许候选者加入。

没能取得足够支持票的申请者将会被拒绝加入，并且收到回复的 6 个月内都不能再申请。提交申请后，委员会将在 2 周内发送申请回复。

### 投票

锦标赛委员会经常通过投票来作出重要决定。典型的例子已经在上文列出，但投票的用处并不止这些。基于投票议题，投票要求也会变化。所有投票也需要满足“严格参与”原则。这意味着，若投票截止时参与的委员会成员未达 75%，投票截止时间将会无限期延长，直至达到参与门槛。此外，所有投票表决的议题执行前，需要绝大多数人的支持（最低 50%）。对于大部分议题，投票要求是一致的，但是正如下文所列出的那样，一些常见议题有轻微的差别。

*备注：参与门槛只考虑到未因利益冲突而弃权的成员。*

| 投票类型 | 最短时间（天数） | 议题通过门槛 | 参与门槛 |
| :-- | --: | --: | --: |
| 中止奖牌支持 | 3 | 50% | 75% |
| 锦标赛封禁 | 3 | 50% | 75% |
| 锦标赛工作人员封禁 | 3 | 50% | 75% |
...
锦标赛委员会只能看到发送到 [tournaments@ppy.sh](mailto:tournaments@ppy.sh) 的电子邮件的内容。回复由委员会成员内部起草完毕，随后由账户支持团队审阅并发出。他们不能写或发送邮件，也不能看到邮件元数据（例如发送者的电子邮件地址或名字），只能看到邮件内容。
...
有兴趣加入锦标赛委员会的人应仔细阅[“接收新的成员”一节](#接收新的成员)，了解团队期望与申请流程。
