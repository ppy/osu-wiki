...
**Команда глобальной модерации** (ранее — администраторы, неформально — «зелёные BAT»), или **GMT**, — группa пользователей, которые следят за поведением игроков в сообществе osu!, а также решают различные связанные с этим проблемы. Модераторы отличаются от остальных пользователей наличием титула и ника, который имеет цитрусовый цвет на форуме и кирпично-красный — в osu!.

**Модераторы обязаны не только соблюдать [правила игры](/wiki/Rules), но и следовать [кодексу профессиональной этики](/wiki/Contributor_Code_of_Conduct).**

## Сфера деятельности

***Примечание: если модератор нарушает правила, злоупотребляет полномочиями или иным образом нарушает кодекс профессиональной этики, на него можно пожаловаться в [службу поддержки](/wiki/People/The_Team/Account_support_team#support@ppy.sh).***\
*См. также: [Система репортов](/wiki/Reporting_Bad_Behaviour)*

Модераторы отвечают за порядок в сообществе в целом. Им стоит писать по поводу любых вещей, связанных с правилами и их нарушением, к примеру (список неполный):

- беспорядок в чате (спам, оскорбления);
- нарушение правил форума;
- спам или оскорбления в комментариях или обсуждении карты;
- модерирование профилей (всё, что нарушает правила и находится на странице пользователя).

## Как стать модератором

В модераторы обычно берут тех, кто уже вносит вклад в поддержание порядка в игре. Таких пользователей часто замечают за их помощь остальным, активность в сообществе и прилежное поведение. Знание каких-то языков помимо английского также будет значительным плюсом. Все кандидаты в модераторы обсуждаются внутри команды и оцениваются с разных сторон, чтобы было понятно, как они могут себя проявить в новой должности.
...
1. Будьте вежливы и относитесь к другим пользователям с уважением. Не нарушайте правил, не получайте сайленсов, имейте хорошую репутацию.
...
3. Знайте [правила](/wiki/Rules), что они означают и как и когда применяются. Очень важно уметь провести границу между допустимым и неприемлемым поведением.
...
В общем случае за кандидатами наблюдают в течение нескольких недель или месяцев, чтобы убедиться, что они стоят добавления в команду. Не спешите. Если у вас есть какие-то вопросы относительно правил, поведения в чате, отправки репортов и подобных вещей, задавайте их любому модератору.

### Что лучше не делать

1. Не стоит регулярно спрашивать модераторов о своей кандидатуре. В GMT не добавляют в качестве «награды» за помощь и что-то полезное, это работает в другом направлении. Помогайте, чтобы помогать, а не чтобы куда-то продвинуться.
...
4. Не переусердствуйте с помощью. Модерирование — это процесс, а не результат, и он требует выносливости и долговременного вклада, а не всплесков активности. От чрезмерных усилий можно выгореть и потерять мотивацию. Относитесь ко всему проще!

## Состав команды

*Примечание: помимо перечисленных языков, каждый модератор знает английский, если не указано обратное.*

Актуальный список — всегда на странице группы: [команда глобальной модерации](https://osu.ppy.sh/groups/4). В дополнение к перечисленным обязанностям, все модераторы участвуют в [проверке аудио- и визуального содержимого карт](/wiki/Rules/Visual_Content_Considerations#что-делать,-если-вы-не-уверены-в-контенте?).
...
| ![][flag_US] [Death](https://osu.ppy.sh/users/3242450) |  | Модерация чата, техподдержка |
| ![][flag_ES] [Deif](https://osu.ppy.sh/users/318565) | Испанский | Турниры |
...
| ![][flag_CA] [Gabe](https://osu.ppy.sh/users/654108) | Французский | Модерация чата, модерация форума |
...
| ![][flag_HK] [kanpakyin](https://osu.ppy.sh/users/394326) | Кантонский диалект, китайский, японский | Модерация чата, модерация карт |
...
| ![][flag_DE] [Okoratu](https://osu.ppy.sh/users/1623405) | Немецкий | Модерация форума |
...
| ![][flag_CH] [TicClick](https://osu.ppy.sh/users/672931) | Русский | Модерация чата, администрирование вики |
...
| ![][flag_CL] [WalterToro](https://osu.ppy.sh/users/5281416) | Испанский | Турниры, модерация чата, администрирование вики |
