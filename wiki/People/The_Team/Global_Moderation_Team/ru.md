...
**Команда глобальной модерации** (ранее известная как Команда глобальных модераторов, Администраторы или «GreenBAT») или **Global Moderation Team** — это члены сообщества, которые сосредоточены в первую очередь на модерации игроков и вопросах, имеющих отношение к команде и сообществу в целом.

## Роли и обязанности

Команда глобальной модерации ответственна за благополучие чата/форума и заботится о взаимодействии с сообществом. К ним следует обращаться, если у Вас есть какие-либо вопросы, касающиеся аспекта модерации игры, которые включают в себя (но не ограничиваются этим) проблемы с чатом (например, заглушения или преследование) и форумом (спам или неуместные комментарии).

## Становление членом Команды глобальной модерации

Чтобы стать членом Команды глобальной модерации требуется значительное количество внесённого вклада. Потенциальные члены обычно подмечаются за их стремление помочь другим пользователям, активность в сообществе и хорошее поведение. Настоятельно рекомендуется иметь способность говорить на языках, отличных от английского. Командой проводится обсуждение кандидатов относительно возможности потенциального пополнения членов команды.

### Как попасть на рассмотрение

Наиболее важными факторами для рассмотрения являются поведение, активность, понимание правил и терпение:

1. Демонстрируйте хорошее поведение, проявляя вежливость и уважительное отношение к другим пользователям. Важно сохранять свой аккаунт без каких-либо серьёзных заглушений или проблем;
2. Демонстрируйте внутриигровую активность путём участия в чате и/или форумах. Сообщайте о любых нарушениях и проблемах через систему жалоб. Отвечайте на вопросы и помогайте другим в решении проблем;
3. Достаточно разберитесь в [правилах](/wiki/Rules) и их применении. Важно знать, что приемлимо в рамках osu!, а что нет;
4. Будьте терпеливы. Команда глобальной модерации не добавляет спонтанно тех членов, что помогали всего лишь несколько дней. Для них требуется время, чтобы оценить кого-то⁠, его личность, то, чем он может помочь, его активность и т.д.

Как правило, команда будет наблюдать за людьми в течение нескольких недель, чтобы убедиться, что они являются достойным дополнением. Пожалуйста, проявите терпение и не перебарщивайте. Не стесняйтесь задавать любому члену Команды глобальной модерации вопросы, касающиеся правил, жалоб на пользователей и каких-либо других проблем.
...
[Страница группы Команды глобальной модерации](https://osu.ppy.sh/groups/4) содержит список всех её членов.

*Примечание: Все члены Команда глобальной модерации говорят по-английски в дополнение к языкам, перечисленным ниже, если не указано иное.*

| Имя | Дополнительные языки | Область внимания |
| :-- | :-- | :-- |
| ![][flag_MY] [- [bibitaru] -](https://osu.ppy.sh/users/4482419) | Китайский, малайский | Модерация чата |
| ![][flag_DE] [- Felix](https://osu.ppy.sh/users/8503985) | Немецкий | Модерация чата |
| ![][flag_US] [Chaos](https://osu.ppy.sh/users/2628870) |  | Модерация чата, модерация карт |
...
| ![][flag_US] [Death](https://osu.ppy.sh/users/3242450) |  | Модерация чата, техподдержка, модерация карт |
| ![][flag_ES] [Deif](https://osu.ppy.sh/users/318565) | Испанский | Турниры, модерация карт |
...
| ![][flag_BG] [Flanster](https://osu.ppy.sh/users/447818) | Болгарский | Хостинг osu!idol, модерация форума, модерация карт |
...
| ![][flag_TR] [heyronii](https://osu.ppy.sh/users/5642779) | Турецкий | Модерация чата |
| ![][flag_GB] [JBHyperion](https://osu.ppy.sh/users/4879508) |  | Модерация чата, модерация карт |
| ![][flag_AR] [juankristal](https://osu.ppy.sh/users/443656) | Испанский | Турниры |
| ![][flag_HK] [kanpakyin](https://osu.ppy.sh/users/394326) | Кантонский, китайский, японский | Модерация чата |
...
| ![][flag_BR] [Kuron-kun](https://osu.ppy.sh/users/2697284) | Португальский | Модерация чата, модерация карт |
...
| ![][flag_PH] [Nathanael](https://osu.ppy.sh/users/2295078) | Филиппинский | Модерация чата, модерация форума, техподдержка, модерация карт |
| ![][flag_FR] [Neil Watts](https://osu.ppy.sh/users/3048059) | Французский | Модерация чата |
| ![][flag_DE] [Okoratu](https://osu.ppy.sh/users/1623405) | Немецкий | Критерии для получения рейтинга, модерация форума, модерация чата, модерация карт |
...
| ![][flag_ES] [Raiden](https://osu.ppy.sh/users/2239480) | Испанский, каталанский | Модерация чата |
| ![][flag_MX] [Repflez](https://osu.ppy.sh/users/201392) | Испанский | Модерация чата, администрация вики |
| ![][flag_KR] [ruexia](https://osu.ppy.sh/users/385069) | Корейский | Модерация чата |
| ![][flag_JP] [S o h](https://osu.ppy.sh/users/2234772) | Японский | Модерация чата |
| ![][flag_SE] [Saten](https://osu.ppy.sh/users/444506) | Шведский, испанский | Модерация чата, модерация карт |
| ![][flag_IT] [Seijiro](https://osu.ppy.sh/users/2581696) | Итальянский | Модерация чата |
...
| ![][flag_AT] [Stefan](https://osu.ppy.sh/users/626907) | Немецкий | Модерация чата, модерация форума |
| ![][flag_CH] [TicClick](https://osu.ppy.sh/users/672931) | Русский | Модерация чата |
| ![][flag_KR] [ToGlette](https://osu.ppy.sh/users/1076236) | Корейский | Модерация чата |
| ![][flag_FR] [Tommay](https://osu.ppy.sh/users/3132818) | Французский | Модерация чата |
