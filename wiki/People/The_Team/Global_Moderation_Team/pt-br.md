...
| ::{ flag=FR }:: [Imakuri](https://osu.ppy.sh/users/6100837) | Francês | Moderação de chat |
...
| ::{ flag=NL }:: [Uni](https://osu.ppy.sh/users/617106) | Holandês | Moderação de chat |
...
| ::{ flag=TR }:: [Orkay](https://osu.ppy.sh/users/9321674) | Turco | Moderação de chat |
