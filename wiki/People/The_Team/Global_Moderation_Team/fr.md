...
L **'équipe de modération globale** (_Global Moderation Team_ ou _GMT_ en anglais), dont les membres sont aussi connus sous le nom de **global mods** ou simplement **modos**, sont des membres du staff d'osu! dont l'objectif premier est d'encadrer la communauté sur le chat et le forum à l'aide du [règlement](/wiki/Rules).
...
_Veuillez noter que tous les GMT peuvent également parler anglais en plus des langues listées ci-dessous, sauf s'il est noté le contraire._
...
| ![][flag_CA] [mm201](https://osu.ppy.sh/users/30655)              | <!-- not sure -->   | développement d'osu!                                                                 |
