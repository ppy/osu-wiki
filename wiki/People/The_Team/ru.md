...
*См. также: [история команд osu!](/wiki/Staff_Log)*
 ...
 <!-- не знаю, что тут хорошего написать, пусть пока будет так -->
...
Помимо перечисленных выше, за различными сторонами osu! следят специальные группы пользователей. Их можно опознать по особым цветам ников на форуме или в чате, а также титулам и значкам в профиле.
