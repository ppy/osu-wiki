...
- **Mod regularly.** Beatmap Nominators are not only expected to ensure and improve rankability, but also quality, of maps they nominate. They should be able to thoroughly mod where necessary. Modding done outside of beatmap discussions should still be accessible there as proof (e.g. through logs/summaries).
