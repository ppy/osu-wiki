...
- Les beatmap Nominators doivent rester en dessous d'un nombre maximum de nominations dans une période de 90 jours, avec pour chaque mode de jeu sa propre limitation de nomination. Surpasser cette limite entraînera un avertissement, puis une exclusion s'ils n'arrivent pas à gérer leur activité en conséquence.
