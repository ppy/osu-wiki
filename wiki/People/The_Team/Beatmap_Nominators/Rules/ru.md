...
- **Не занимайтесь за деньги моддингом, маппингом или номинированием карт.** Поступки и мотивы членов любых «официальных» команд osu! (номинаторов, NAT и др.), связанных с ранкингом карт, не должны вызывать сомнений.
