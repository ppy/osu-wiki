...
Ниже перечислены качества, которыми должны обладать номинаторы. Вашу заявку могут отклонить, если в перечисленных в ней модах не видно хотя бы одной из этих черт.
...
- **Сопоставление разных участков карты как аргументация своих замечаний;**
...
- **Умение находить как конкретные недочёты, так и проблемы, присущие всей карте целиком;**
- **Понимание намерений маппера при поиске проблем или возможных улучшений.**
...
- Поданные заявки проверяют члены NAT соответствующего игрового режима. Они обращают внимание на следующие стороны:
  - Общее поведение: тон общения и подача модов, а также другие пункты из [соответствующего свода правил](/wiki/Rules/Code_of_Conduct_for_Modding_and_Mapping), включая поведение в чате и на форумах в принципе.
...
Кулдаун — срок, через который можно будет повторно отправить заявку. Он бывает нескольких типов.
