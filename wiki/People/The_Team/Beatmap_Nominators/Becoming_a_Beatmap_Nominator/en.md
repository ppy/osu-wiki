...
Applications are conducted via the [NAT website](https://bn.mappersguild.com/bnapps "NAT/BN Management").
...
- [The website](https://bn.mappersguild.com/bnapps "NAT/BN Management") has a tool for calculating `ModScore` on its main page.
