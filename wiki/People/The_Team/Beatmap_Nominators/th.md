...
*ดูสิ่งนี้ด้วย: [กฎของ Beatmap Nominators](Rules), [ความคาดหวังสำหรับ Beatmap Nominators](Expectations), [ข้อมูลทั่วไปสำหรับ Beatmap Nominators](General_Information), และ [การมาเป็น Beatmap Nominators](Becoming_a_Beatmap_Nominator)*
...
สมาชิกของกลุ่ม Beatmap Nominators รับผิดชอบหลัก ๆ ในการ[วิจารณ์บีทแมพ](/wiki/Modding)ที่อยู่ในสถานะ [pending](/wiki/Beatmaps#work-in-progress-and-pending) และอนุมัติไปในการแรงค์ โดย Beatmap Nominators เป็นผู้คนที่สามารถถามได้เกี่ยวกับคำแนะนำ หรือคำขอต่าง ๆ เกี่ยวกับเรื่องใด ๆ ก็ได้ที่เกี่ยวกับการแมปหรือการวิจารณ์บีทแมพ Beatmap Nominators คนใดก็ได้สามารถยับยั้งการแรงค์บีทแมพ ([veto](Beatmap_Veto)) หากเขารู้สึกว่าแมปที่ถูกเสนอมีปัญหา หรือมีข้อกังวลที่ต้องถูกแก้ ที่ไม่ได้ละเมิดกฎการแรงค์แบบตรง ๆ

นอกเหนือจากนี้ Beatmap Nominators ทุกคนถูกคาดหวังให้ยึดมั่นในอุดมคติหลวม ๆ ที่เล็งไปที่ประโยชน์ต่อชุมชนส่วนรวม โดยการให้ความสนใจไปในแมป และคนทำแมปอย่างกว้างขวาง และมุ่งมั่นที่จะเพิ่มพูนความสามารถของตัวเอง ซึ่งได้ระบุไว้ในบทความ [ความคาดหวังสำหรับ Beatmap Nominators](Expectations)

สมาชิกของกลุ่ม Beatmap Nominators ได้ถูกแบ่งเป็นสองกลุ่ม: สมาชิกเต็มรูปแบบ และสมาชิกภาคทัณฑ์

### Beatmap Nominators เต็มรูปแบบ

นอกเหนือจากการวิจารณ์บีทแมพและแรงค์โดยธรรมดาแล้ว สมาชิกเต็มรูปแบบของกลุ่ม Beatmap Nominators มีความรับผิดชอบในการปลด (disqualify) บีทแมพในหมวด qualified ที่มีปัญหา โดย Beatmap Nominators เต็มรูปแบบสามารถมีส่วนร่วมในการประเมินใบสมัครเข้าร่วมกลุ่ม Beatmap Nominators หากพวกเขามีความสนใจในการเข้าร่วม Nomination Assessment Team ในอนาคต

ประมาณทุก ๆ สามเดือน สมาชิก Beatmap Nominators เต็มรูปแบบทุกคน จะถูกประเมินพฤติกรรม กิจกรรม และคุณภาพในการเสนอ โดย [Nomination Assessment Team](/wiki/People/The_Team/Nomination_Assessment_Team) หากการเสนอของพวกเขาถูกรีเซ็ตบ่อย ๆ อย่างมีสาเหตุ หรือหากพฤติกรรมของพวกเขาไม่สามารถถูกรับได้ พวกเขาอาจจะถูกย้ายไปกลุ่มสมาชิกภาคทัณฑ์

สมาชิกเต็มรูปแบบของกลุ่ม Beatmap Nominators จะไม่โดนภาคทัณฑ์หากกิจกรรมของพวกเขาน้อยเกินไป แต่พวกเขาจะโดนปลดจากกลุ่มนี้หากกิจกรรมของเขาไม่ดีขึ้น

### Beatmap Nominators ภาคทัณฑ์

การภาคทัณฑ์ถูกใช้เพื่อการสังเกตการณ์ Beatmap Nominators ใหม่ หรือที่มีพฤติกรรมน่ากังวล อย่างใกล้ชิด โดยหน้าที่หลักของ Beatmap Nominators ภาคทัณฑ์คือการสร้างรากฐานในการเป็น Beatmap Nominators โดยการเสนอบีทแมพ (อย่างเดียว) ในกระบวนการแรงค์ โดยในการเลื่อนขั้นบีทแมพ Beatmap Nominators เต็มรูปแบบต้องมีส่วนร่วมอย่างน้อยหนึ่งคน ดังนั้น Beatmap Nominators ภาคทัณฑ์จึงไม่สามารถเป็นคนสุดท้ายที่เสนอบีทแมพที่ได้รับการเสนอจาก Beatmap Nominators ภาคทัณฑ์คนอื่น สำหรับเกมโหมดนั้น ๆ

สมาชิก Beatmap Nominators ใหม่เริ่มต้นด้วยช่วงภาคทัณฑ์เป็นเวลาหนึ่งเดือน หากการเสนอบีทแมพ และพฤติกรรมของพวกเขาน่าพึงพอใจ เขาจะถูกเลื่อนขั้นไปเป็น Beatmap Nominators เต็มรูปแบบ มิเช่นนั้นพวกเขาจะถูกภาคทัณฑ์เป็นเวลาอีกหนึ่งเดือน หรือถูกปลดจากการเป็น Beatmap Nominators

เมื่อ Beatmap Nominators ถูกภาคทัณฑ์ พวกเขาจะไม่สามารถถูกภาคทัณฑ์เนื่องจากสาเหตุเดียวกันได้อีก อาทิเช่น หาก Beatmap Nominator คนหนึ่งถูกภาคทัณฑ์เนื่องจากพฤติกรรมที่แย่ เขาจะถูกปลดจากการเป็น Beatmap Nominators หากเขาแสดงพฤติกรรมเดิมอีก แม้ว่าเขาจะเป็น Beatmap Nominator เต็มรูปแบบในการละเมิดครั้งที่สอง
