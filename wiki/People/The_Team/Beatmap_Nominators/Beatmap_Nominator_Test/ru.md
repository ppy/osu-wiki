...
**Тест на номинатора карт** — набор заданий, призванный оценить знания претендентов на должность [номинатора карт](/wiki/People/The_Team/Beatmap_Nominators) (*BN*).

Пользователи, подавшие заявку на вступление в команду номинаторов, должны пройти соответствующий тест на [веб-сайте для номинаторов](https://bn.mappersguild.com/). Его результаты будут доступны членам [команды оценки номинаций](/wiki/People/The_Team/Nomination_Assessment_Team) (*NAT*), которые и будут принимать решение о дальнейшей судьбе претендента.
...
Задания для теста берутся из огромного банка с вопросами, разбитого на несколько категорий:
...
Первый тест по моддингу придумал [Echo](https://osu.ppy.sh/users/431) в 2008 г., но его тест не был направлен на будущих номинаторов (тогда их ещё называли [Beatmap Approval Team](/wiki/Modding/Beatmap_Appreciation_Team), или *BAT*). В рамках теста пользователи должны были найти ошибки в специально подготовленной карте, [Arashi - Kitto Daijoubu](http://up.ppy.sh/files/Arashi%20-%20Kitto%20Daijoubu.rar).
...
Эти задания использовались вплоть до 2017 г., когда от их использования пришлось отказаться из-за списывания. С того момента контроль над зачислением в номинаторы был передан в руки [команды оценки качества](/wiki/Modding/Quality_Assurance_Team), позднее — NAT.
