...
| ::{ flag=SG }:: [Kotoha](https://osu.ppy.sh/users/7823498) | Chino | Evaluador |
...
| ::{ flag=ES }:: [Quenlla](https://osu.ppy.sh/users/4725379) | Español, portugués, gallego, italiano, japonés | Evaluador |
