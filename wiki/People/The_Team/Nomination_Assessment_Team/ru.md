...
**Команда оценки номинаций** или **Nomination Assessment Team** (***КОН*** или ***NAT***, соответственно) — это модераторы [Номинаторов карт](/wiki/People/Beatmap_Nominators). Они отвечают за рассмотрение заявок НК, создание тестов для претендентов, оценку текущих членов команды и контроль вето в процессе выдачи рейтинга. Все члены КОН могут играть роль НК в моддинге и процессе выдачи рейтинга, однако они не имеют таких строгих требований к активности, как НК.

Члены КОН отличаются своими красными именами пользователей и титулами. Как и у [Команды глобальной модерации](/wiki/People/Global_Moderation_Team), у них также есть разрешения на модерацию на уровне сайта и тёмно-красное имя пользователя в каналах внутриигрового чата.

## Члены команды

[Страница группы Команды оценки номинаций](https://osu.ppy.sh/groups/7) содержит список всех членов команды.

*Примечание: Все члены КОН говорят по-английски в дополнение к языкам, указанным ниже, если не указано иное.*
