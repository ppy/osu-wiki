...
В дополнение к возможности модерировать, члены NAT могут [номинировать](/wiki/Beatmap_ranking_procedure#nominations) карты, напрямую [перемещать их в Qualified](/wiki/Beatmap_ranking_procedure#qualification) и [сбрасывать номинации](/wiki/Beatmap_ranking_procedure#nomination-resets). При данных действиях они считаются [полноправными номинаторами](/wiki/People/The_Team/Beatmap_Nominators#полноправные-номинаторы) и должны следовать тем же правилам и ожиданиям, что и номинаторы (за исключением требований к активности), однако, ввиду обилия обязанностей и задач, от них не ожидается активность в номинировании.
...
| ![][flag_GB] [hypercyte](https://osu.ppy.sh/users/9155377) | Бенгальский, частично арабский | Аттестация номинаторов, структурирование, обратная связь |
...
| ![][flag_SE] [Naxess](https://osu.ppy.sh/users/8129817) | Шведский | Структурирование, обратная связь |
| ![][flag_US] [Noffy](https://osu.ppy.sh/users/1541323) |  | Аттестация номинаторов, структурирование, обратная связь |
| ![][flag_US] [pishifat](https://osu.ppy.sh/users/3178418) |  | Структурирование |
| ![][flag_BR] [Seto Kousuke](https://osu.ppy.sh/users/2857314) | Португальский | Аттестация номинаторов, структурирование, обратная связь |
...
| ![][flag_NL] [Greaper](https://osu.ppy.sh/users/2369776) | Нидерландский | Аттестация номинаторов |
