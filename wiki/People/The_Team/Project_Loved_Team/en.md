...
![][flag_US] [clayton](https://osu.ppy.sh/users/3666350) and ![][flag_LT] [huu](https://osu.ppy.sh/users/6044237) oversee the project, write news and forum posts, maintain the public spreadsheets, and help moderate discussions about Loved. ![][flag_US] [Noffy](https://osu.ppy.sh/users/1541323) and ![][flag_GB] [hypercyte](https://osu.ppy.sh/users/9155377) check metadata of beatmaps that will go up for voting. The rest of the team are captains:
