...
::{ flag=US }:: **[clayton](https://osu.ppy.sh/users/3666350)** 负责监督该项目并撰写新闻和论坛帖子，::{ flag=LT }:: [huu](https://osu.ppy.sh/users/6044237) 负责维护公共表格，并帮助版主管理有关 Loved 的讨论帖，最后是 ::{ flag=US }:: [Noffy](https://osu.ppy.sh/users/1541323)，::{ flag=GB }:: [hypercyte](https://osu.ppy.sh/users/9155377) 和 ::{ flag=US }:: [eiri-](https://osu.ppy.sh/users/3388410) 负责检查谱面的元数据，这些元数据会用于社区投票。其余成员则是每一种模式的队长：
