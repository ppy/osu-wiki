...
# Екип на "Проект обичани"

**Екипът на проект обичани** са членове от обществото на osu! които управляват "[Проект обичани](/wiki/Community/Project_Loved)", платформата за гласувате чрез която се определя кой [бийтмап](/wiki/Beatmap) ще получи категория "[Обичан](/wiki/Beatmap/Category#loved)". Те се отличават по значката на потребителската им група `LVD` и тяхното потребителско име с бонбонено розов цвят във форумите.

В [групата на проект обичани](https://osu.ppy.sh/groups/31) са изброени всички членове.

## Капитани

Екипът на "Проект обичани" се състои основно от *капитани* за всеки [вид игра](/wiki/Game_mode). Капитаните отговарят за номиниране на бийтмапове към категория "Обичан" и действат като представители на обществото с добро усещане за избор на бийтмап. Те също оставят кратко описание относно номинирания бийтмап за обща представа на читателите, да знаят какво представлява в случай че не са го виждали или играли преди.
...
Модераторите проверяващи съдържание се състоят от обучени членове на [глобалния модераторски екип](/wiki/People/The_Team/Global_Moderation_Team) и [екипа за оценка на номинатори](/wiki/People/The_Team/Nomination_Assessment_Team), които вземат участие в проверката на аудиовизуално съдържание включено в бийтмаповете за които ще се гласува.
...
Долу в списъка са потребители, които преди бяха част от екипа на "Проект обичани".
...
- ![][flag_US] [Toy](https://osu.ppy.sh/users/2757689) създаде оригиналния екип от капитани през септември 2017 заедно със системата за [избор на капитан](/wiki/Beatmap/History_of_Loved#captain's-pick-and-project-loved-(sep-2017-–-present)), която по-късно се превърна в "Проект обичани". До края на 2019 той надзирава и управлява целият проект.
