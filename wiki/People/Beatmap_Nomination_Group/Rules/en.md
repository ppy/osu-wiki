...
+ **Do not nominate maps with unrankable issues.** The General Ranking Criteria and additionally all mode-specific Ranking Criteria apply to all sets with mode-specific difficulties.
    - i feel dumb that we thought that was necessary given that at the time we wrote it there was a test about this stuff
...
+ **At least 24 hours must pass between a bubble and a qualification on every mapset.** This gives other Beatmap Nominators and also the wider community the chance to provide additional suggestions before qualification and veto the placed bubble if necessary.
...
+ **Do not nominate a beatmap if you are unsure of something.** In such cases, ask fellow nominators for assistance before making any rushed decisions. This includes unfamiliar game modes, suspiciously gray area/unrankable issues, quality issues or complex timing.
    - how to enforce / check this? General mindset stuff seems weird if we cannot check for it
...
+ **You cannot rebubble a map you nominated until the Nominator who placed the bubble-pop agrees to it.** In these cases another nominator may rebubble the map if they disagree with the bubble pop.
