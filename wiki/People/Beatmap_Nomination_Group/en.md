...
+ The point in time at which the Kudosu has been awarded to you mod post does not matter, the only relevant information about a mod post is its post date and time in UTC+0 as well as the fact that it has been awarded Kudosu. In order to find out the exact post date and time, hover over the text of a forum post telling you how long ago it was last updated.
