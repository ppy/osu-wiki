...
- ::{ flag=US }:: ::xasuma::{ user=3172980 } 因为是第一个完成这个成就的玩家，所以他收到了 *The First Completionist* [玩家头衔](/wiki/Community/User_title)。
- ::{ flag=AU }:: ::Jaye::{ user=4841352 } 因为是第一个完成这个成就的太鼓玩家，并且，他在每张 osu!taiko 上架谱面上都打出了全连成绩，所以他收到了 *Drum Decimator* 玩家头衔。
