...
**Комплишионисты** - это игроки, которые прошли все [ранкнутые](/wiki/Beatmap/Category#ranked) [карты](/wiki/Beatmap) определённого [режима игры](/wiki/Game_mode). Поскольку количество ранкнутых карт увеличивается с каждым днём, достичь этой цели становится всё труднее.
...
Эти игроки были проверены командой osu! и удостоены титула комплишиониста:

### osu!

| Игрок | Дата прохождения | Количество сыгранных сложностей |
| :-- | :-- | :-- |
...
- До сентября 2023 года players игроки могли получить титул *osu!completionist*, который затем был заменён на значки профиля.
