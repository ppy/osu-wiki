...
| :-- | :-- | :-- |
| ::{ flag=US }:: ::xasuma::{ user=3172980 } | 27/4/2019 | 60 845 |
| ::{ flag=PL }:: ::PookieBear::{ user=7635621 } | 11/8/2021 | 82 298 |
| ::{ flag=US }:: ::EEEEEEEEEEEEEEE::{ user=2927048 } | 12/3/2023 | 99 842 |

### osu!taiko

| Jugador | Fecha de finalización | Dificultades totales jugadas |
| :-- | :-- | :-- |
| ::{ flag=AU }:: ::Jaye::{ user=4841352 } | 3/11/2019 | 8841 |
| ::{ flag=MY }:: ::\[Zeth\]::{ user=9912966 } | 14/8/2023 | 22 170 |

## Curiosidades

- ::{ flag=US }:: ::xasuma::{ user=3172980 } recibió el [título de usuario](/wiki/Community/User_title) *The First Completionist* por ser el primer jugador en lograr esta hazaña.
- ::{ flag=AU }:: ::Jaye::{ user=4841352 } recibió el título de usuario *Drum Decimator* por ser el primer completacionista de osu!taiko y conseguir combos completos en cada beatmap de osu!taiko clasificado.
