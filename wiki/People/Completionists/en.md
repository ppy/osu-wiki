...
- ::{ flag=US }:: ::xasuma::{ user-id=3172980 } was awarded the [user title](/wiki/Community/User_title) *The First Completionist* for being the first player to ever achieve this feat.
- ::{ flag=AU }:: ::Jaye::{ user-id=4841352 } was awarded the user title *Drum Decimator* for being the first osu!taiko completionist and scoring full combos on every Ranked osu!taiko beatmap.
