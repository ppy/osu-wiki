...
| :-- | :-- | :-- |
| ::{ flag=US }:: ::xasuma::{ user=3172980 } | 2019-04-27 | 60,845 |
| ::{ flag=PL }:: ::PookieBear::{ user=7635621 } | 2021-08-11 | 82,298 |
| ::{ flag=US }:: ::EEEEEEEEEEEEEEE::{ user=2927048 } | 2023-03-12 | 99,842 |

### osu!taiko

| Player | Date of completion | Total played difficulties |
| :-- | :-- | :-- |
| ::{ flag=AU }:: ::Jaye::{ user=4841352 } | 2019-11-03 | 8,841 |
| ::{ flag=MY }:: ::\[Zeth\]::{ user=9912966 } | 2023-08-14 | 22,170 |

## Trivia

- ::{ flag=US }:: ::xasuma::{ user=3172980 } was awarded the [user title](/wiki/Community/User_title) *The First Completionist* for being the first player to ever achieve this feat.
- ::{ flag=AU }:: ::Jaye::{ user=4841352 } was awarded the user title *Drum Decimator* for being the first osu!taiko completionist and scoring full combos on every Ranked osu!taiko beatmap.
