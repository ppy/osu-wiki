...
Al hacer clic en las insignias, se accederá a las listas del grupo respectivo, mientras que los nombres se vinculan a los artículos de la wiki.
...
| 22 | [![SPT](/wiki/shared/group/SPT.png)](https://osu.ppy.sh/groups/22) | [Technical Support Team](/wiki/People/Technical_Support_Team) | Ayuda y asistencia |
| 26 |  | Tournament Staff[^private] | Usuarios con [comandos para la gestión de torneos](/wiki/osu!_tournament_client/osu!tourney/Tournament_management_commands) más extensos |
...
| 29 | ![BOT](/wiki/shared/group/BOT.png) | [Chat Bots](/wiki/Bot_account)[^private] | Cuentas especiales administradas por servicios automatizados en lugar de personas reales |
...
| 33 | ![PPY](/wiki/shared/group/PPY.png) | ppy[^private] | Reservado para [peppy](/wiki/People/peppy), el creador de osu! |
| 35 | [![FA](/wiki/shared/group/FA.png)](https://osu.ppy.sh/groups/35) | [Featured Artists](/wiki/People/Featured_Artists) | Creadores musicales que se han asociado con osu! |
...
[^private]: La lista de usuarios de este grupo no es pública.
