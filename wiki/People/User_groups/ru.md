...
Ниже перечислены **группы пользователей**, в которых состоят участники сообщества osu!, помогающие поддерживать игру. Большинство из этих групп можно узнать по их цветам на [форуме](/wiki/Community/Forum), цветам во [внутриигровом чате](/wiki/Client/Interface/Chat_console), [титулам](/wiki/Community/User_title), и/или значкам групп пользователей.

Нажатие на значок приведёт вас на страницу участников группы, а на название - к статье на вики.
...
[^private]: Список пользователей этой группы не является публичным.
