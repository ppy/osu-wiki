...
| ::{ flag=US }:: [ChillierPear](https://osu.ppy.sh/users/9501251) | Смотритель за порядком, организатор и администратор [международных турниров](/wiki/Tournaments#официальные-мировые-турниры) |
| ::{ flag=US }:: [Death](https://osu.ppy.sh/users/3242450) | Смотритель за порядком, [модератор](/wiki/People/Global_Moderation_Team), сотрудник технической поддержки |
...
| ::{ flag=AU }:: [nekodex](https://osu.ppy.sh/users/102) | Мастер по спецэффектам, исполнитель из каталога [Featured Artist](https://osu.ppy.sh/beatmaps/artists/1) |
| ::{ flag=JP }:: [notbakaneko](https://osu.ppy.sh/users/10751776) | Разработчик osu!web |
| ::{ flag=DE }:: [Okoayu](https://osu.ppy.sh/users/1623405) | Советник по вопросам моддинга и маппинга |
...
| ::{ flag=PL }:: [spaceman_atlas](https://osu.ppy.sh/users/3035836) | Разработчик osu!, сотрудник технической поддержки |
...
| ::{ flag=ES }:: [Trosk-](https://osu.ppy.sh/users/3469385) | Смотритель за порядком, администратор турниров, THE OPERATOR |
| ::{ flag=US }:: [tybug](https://osu.ppy.sh/users/12092800) | Смотритель за порядком, чистильщик |
| ::{ flag=PL }:: [Venix](https://osu.ppy.sh/users/5999631) | [Модератор](/wiki/People/Global_Moderation_Team), менеджер [Beatmap Spotlights](/wiki/Beatmap_Spotlights) |
...
| ::{ flag=US }:: [Dntm8kmeeatu](https://osu.ppy.sh/users/5428812) | [Модератор](/wiki/People/Global_Moderation_Team) |
| ::{ flag=NZ }:: [Echo](https://osu.ppy.sh/users/431) | Разработчик osu!, автор интеграции IRC для внутриигрового чата, администратор сайта |
| ::{ flag=AU }:: [Ephemeral](https://osu.ppy.sh/users/102335) | Администратор и лидер сообщества, менеджер по связям с [Featured Artist](/wiki/People/Featured_Artists) |
