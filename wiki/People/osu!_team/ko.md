...
상기 인원 이외에도, [계정 지원 팀](/wiki/People/Account_support_team)이 손에 닿지 않는 부분에 대해 도움을 드리고 있습니다.
...
| ::{ flag=DE }:: [Loctav](https://osu.ppy.sh/users/71366) | 월드컵 주최자 및 관리자, QAT 리더, 커뮤니티 매니저 |
| ::{ flag=US }:: [LuigiHann](https://osu.ppy.sh/users/1079) | 특별한 스킨 디자이너, 기본 스킨 및 아이콘 기여자. [DeviantArt](https://luigihann.deviantart.com/) |
...
| ::{ flag=DE }:: [Tom94](https://osu.ppy.sh/users/1857058) | osu! 및 pp 개발자 |
