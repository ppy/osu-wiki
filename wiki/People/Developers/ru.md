...
Разработчиков можно отличить от остальных пользователей по наличию розовых титулов "osu!dev" или "osu!team", а также по [значку группы](/wiki/People/User_groups) с надписью `DEV`.

## Состав команды

Актуальный список — всегда на странице группы: [разработчики](https://osu.ppy.sh/groups/11).

Усилия по разработке osu! возглавляет ::{ flag=AU }:: **::peppy::{ user=2 }**, создатель игры.

### Разработчики игры

- ::{ flag=SK }:: ::Domco::{ user=3562660 }
- ::{ flag=SA }:: ::frenzibyte::{ user=14210502 }
- ::{ flag=AU }:: ::peppy::{ user=2 }
- ::{ flag=AU }:: ::smoogipoo::{ user=1040328 }
- ::{ flag=PL }:: ::spaceman\_atlas::{ user=3035836 }
...
- ::{ flag=CA }:: ::DrabWeb::{ user=6946022 }
- ::{ flag=JP }:: ::ekr::{ user=4497706 }
- ::{ flag=BY }:: ::EVAST::{ user=8195163 }
- ::{ flag=CN }:: ::huoyaoyuan::{ user=2428732 }
- ::{ flag=US }:: ::Joehu::{ user=8549835 }
...
- ::{ flag=JP }:: ::ekr::{ user=4497706 }
- ::{ flag=CN }:: ::huoyaoyuan::{ user=2428732 }
- ::{ flag=AU }:: ::Samah::{ user=343490 }
- ::{ flag=HR }:: ::Susko3::{ user=18945305 }
- ::{ flag=RU }:: ::TocoToucan::{ user=1326350 }
...
- ::{ flag=ID }:: ::GPR::{ user=10721349 }
- ::{ flag=PL }:: ::LiquidPL::{ user=5044384 }
- ::{ flag=PL }:: ::TPGPL::{ user=3944705 }
- ::{ flag=PL }:: ::Venix::{ user=5999631 }
...
| Пользователь | Роль |
| :-- | :-- |
| ::{ flag=AU }:: ::Ephemeral::{ user=102335 } | Коммьюнити-менеджер |
| ::{ flag=NO }:: ::MillhioreF::{ user=941094 } | Разработчик игры |
| ::{ flag=DE }:: ::Tom94::{ user=1857058 } | Разработчик игры |
