...
Разработката на osu! е водена от ::{ flag=AU }:: **::peppy::{ user-id=2 }**, създател на osu!.
...
| Потребител | Роля |
| :-- | :-- |
| ::{ flag=NO }:: ::MillhioreF::{ user-id=941094 } | Разработчик на клиент за игра |
| ::{ flag=US }:: ::RBRat3::{ user-id=307202 } | Дизайнер |
| ::{ flag=DE }:: ::Tom94::{ user-id=1857058 } | Разработчик на клиент за игра |
