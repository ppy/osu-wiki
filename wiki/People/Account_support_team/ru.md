...
::: alert-note
**Примечание:** Эта статья – о службе поддержки, отвечающей на электронные письма по адресам `@ppy.sh`. О группе пользователей, помогающих на форумах, см. [Команда технической поддержки](/wiki/People/Technical_Support_Team).
:::
...
- Добровольное [признание в нарушении правил](/wiki/Reporting_bad_behaviour/Handling_foul_play#admit).
...
::: alert-notice
**Внимание**
Если вы хотите пожаловаться на домогательства или крайне неприемлемое поведение со стороны другого пользователя (в том числе модератора), см. [Жалобы на приставания](/wiki/Reporting_bad_behaviour/Abuse).
:::
