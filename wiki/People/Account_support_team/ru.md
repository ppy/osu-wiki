...
*Эта статья – о службе поддержки, отвечающей на электронные письма по адресам `@ppy.sh`. О группе пользователей, помогающих на форумах, см. [Команда технической поддержки](/wiki/People/Technical_Support_Team).*
