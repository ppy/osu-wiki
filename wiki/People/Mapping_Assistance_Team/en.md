...
The **Mapping Assistance Team** (***MAT***) was a group responsible for assessing the quality of [pending](/wiki/Beatmap/Category#wip-and-pending) [beatmaps](/wiki/Beatmap) and recommending them for [ranking](/wiki/Beatmap/Category#ranked) in the [forum modding](/wiki/Modding/Forum_modding) system. The MAT served as a first point of contact for mappers looking to rank their maps, where previously this would have been part of the role of the [Beatmap Appreciation Team](/wiki/People/Beatmap_Appreciation_Team) (*BAT*). MATs passed their recommendations for ranking to the BAT by placing a [proto-bubble](/wiki/Modding/Proto-bubble) on the beatmap, and the BAT would then make the final decision on whether the beatmap should enter Ranked.
...
The MAT was formed on the 27th of December, 2009, with initial members being hand-picked by members of the BAT.[^1] The first interim leader of the MAT was ::{ flag=AU }:: [Ephemeral](https://osu.ppy.sh/users/102335).
