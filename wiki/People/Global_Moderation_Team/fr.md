...
| ::{ flag=IT }:: [- Marco -](https://osu.ppy.sh/users/1273955) | Italien | Modération du tchat, modération du forum |
...
| ::{ flag=CN }:: [\_Stan](https://osu.ppy.sh/users/1653229) | Chinois | Modération de la communauté modding/mapping, modération du forum |
...
| ::{ flag=BR }:: [DizzyH](https://osu.ppy.sh/users/9896172) | Portugais | Modération du tchat |
...
| ::{ flag=DE }:: [Hopes](https://osu.ppy.sh/users/4907504) | Allemand, turc | Modération du tchat |
...
| ::{ flag=BR }:: [Jaguar](https://osu.ppy.sh/users/3660954) | Portugais | Modération du tchat |
...
| ::{ flag=GB }:: [Log Off Now](https://osu.ppy.sh/users/4378277) |  | Modération du tchat, modération de la communauté modding/mapping |
...
| ::{ flag=FI }:: [Riverism](https://osu.ppy.sh/users/4980738) | Finnois, un peu de suédois, un peu de japonais | Modération de la communauté modding/mapping, modération du forum |
...
| ::{ flag=PE }:: [Tiburon](https://osu.ppy.sh/users/18115022) | Espagnol | Modération du tchat |
...
| ::{ flag=IT }:: [VoidGod](https://osu.ppy.sh/users/4724656) | Italien | Modération du tchat |
