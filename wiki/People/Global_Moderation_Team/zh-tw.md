...
| 名稱 | 額外語言 | 重點關注 |
| :-- | :-- | :-- |
| ::{ flag=MY }:: [\_Kobii](https://osu.ppy.sh/users/6209713) |  | 製圖/Mod 圖社群管理員 |
...
| ::{ flag=KR }:: [Spectator](https://osu.ppy.sh/users/702598) |  | 製圖/Mod 圖社群管理員 |
...
| ::{ flag=CL }:: [ZiRoX](https://osu.ppy.sh/users/200768) |  | 製圖/Mod 圖社群管理員 |
