...
| :-- | :-- | :-- |
| ::{ flag=DE }:: ::- Felix::{ user=8503985 } | Niemiecki | Moderowanie czatu |
| ::{ flag=IT }:: ::- Marco -::{ user=1273955 } | Włoski | Moderowanie czatu, moderowanie forum |
| ::{ flag=IT }:: ::-kevincela-::{ user=266596 } | Włoski | Moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=US }:: ::-NoName-::{ user=10400730 } |  | Moderowanie czatu |
| ::{ flag=MY }:: ::\_Kobii::{ user=6209713 } | Chiński, malajski, kantoński, japoński (częściowo) | Moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=CN }:: ::\_Stan::{ user=1653229 } | Chiński | Moderowanie społeczności twórców i moderów beatmap, moderowanie forum |
| ::{ flag=CH }:: ::\[ryuu\]::{ user=5698467 } | Rosyjski | Moderowanie czatu |
| ::{ flag=RS }:: ::0x84f::{ user=7944724 } | Serbski | Team leadership, general moderation |
| ::{ flag=US }:: ::abraker::{ user=4635891 } |  | Moderowanie forum |
| ::{ flag=GB }:: ::aceticke::{ user=8838763 } |  | Moderowanie czatu, moderowanie społeczności twórców i moderów beatmap, general moderation |
| ::{ flag=NL }:: ::Albionthegreat::{ user=9853595 } | Niderlandzki, niemiecki (częściowo) | General moderation |
| ::{ flag=US }:: ::Atrue::{ user=1758523 } | Chiński | Moderowanie czatu, moderowanie forum, moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=CA }:: ::Aurele::{ user=654108 } | Francuski | Moderowanie czatu, moderowanie forum, moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=CA }:: ::Azer::{ user=2155578 } |  | Organizowanie turniejów |
| ::{ flag=MY }:: ::bibitaru::{ user=4482419 } | Chiński, malajski | Moderowanie czatu |
| ::{ flag=US }:: ::Blushing::{ user=5927823 } |  | Moderowanie czatu, moderowanie forum, pomoc techniczna |
| ::{ flag=US }:: ::ChillierPear::{ user=9501251 } | Szwedzki, hiszpański | General moderation, organizowanie turniejów |
| ::{ flag=GB }:: ::chromb::{ user=10238680 } |  | Moderowanie czatu |
| ::{ flag=KR }:: ::Civil oath::{ user=3216107 } | Koreański, japoński | Moderowanie czatu |
| ::{ flag=FR }:: ::Corne2Plum3::{ user=15646039 } | Francuski | Moderowanie forum |
| ::{ flag=CA }:: ::D I O::{ user=3958619 } | Hiszpański (częściowo) | Organizowanie turniejów |
| ::{ flag=BR }:: ::DizzyH::{ user=9896172 } | Portugalski | Moderowanie czatu |
| ::{ flag=US }:: ::Death::{ user=3242450 } |  | Moderowanie forum, pomoc techniczna |
| ::{ flag=US }:: ::Dntm8kmeeatu::{ user=5428812 } |  | Pomoc techniczna |
| ::{ flag=AU }:: ::Ephemeral::{ user=102335 } |  | Zarządzanie społecznością, zarządzanie wiki osu! |
| ::{ flag=FI }:: ::Flutteh::{ user=5042507 } | Fiński, szwedzki (częściowo) | Moderowanie czatu |
| ::{ flag=CN }:: ::Fycho::{ user=1876867 } | Chiński | Moderowanie czatu, moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=PL }:: ::Galkan::{ user=169570 } | Polski | Moderowanie czatu |
| ::{ flag=FR }:: ::Ganondorf::{ user=10660738 } | Francuski | Moderowanie czatu |
| ::{ flag=US }:: ::Halfslashed::{ user=4598899 } |  | Moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=DE }:: ::Hopes::{ user=4907504 } | Niemiecki, turecki | Moderowanie czatu |
| ::{ flag=ID }:: ::Ilham::{ user=3057154 } | Indonezyjski | Moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=FR }:: ::Imakuri::{ user=6100837 } | Francuski, hiszpański | Moderowanie czatu |
| ::{ flag=BR }:: ::Jaguar::{ user=3660954 } | Portugalski | Moderowanie czatu |
| ::{ flag=HK }:: ::kanpakyin::{ user=394326 } | Kantoński, chiński, japoński | Moderowanie czatu |
| ::{ flag=RU }:: ::Kobold84::{ user=3227533 } | Rosyjski | Team leadership, moderowanie czatu, moderowanie forum |
| ::{ flag=RU }:: ::Kudou Chitose::{ user=9936528 } | Rosyjski | Moderowanie czatu |
| ::{ flag=FI }:: ::Laurakko::{ user=7253731 } | Fiński, szwedzki (częściowo) | Moderowanie czatu |
| ::{ flag=BR }:: ::LeoFLT::{ user=3668779 } | Portugalski, hiszpański | Moderowanie czatu, organizowanie turniejów |
| ::{ flag=VE }:: ::Leon Brigido::{ user=13570072 } | Hiszpański | Moderowanie czatu |
| ::{ flag=DE }:: ::Loctav::{ user=71366 } | Niemiecki | Moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=GB }:: ::Log Off Now::{ user=4378277 } |  | Moderowanie czatu, moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=DE }:: ::Lyawi::{ user=5851253 } | Niemiecki | Moderowanie czatu, moderowanie forum |
| ::{ flag=GB }:: ::mangomizer::{ user=1893718 } | Kantoński, chiński | Organizowanie turniejów |
| ::{ flag=BR }:: ::maot::{ user=3914271 } | Portugalski | Moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=NO }:: ::MillhioreF::{ user=941094 } |  | Rozwój gry |
| ::{ flag=VN }:: ::My Angel Chino::{ user=20547597 } | Wietnamski | Moderowanie czatu |
| ::{ flag=PH }:: ::Nathanael::{ user=2295078 } | Filipiński | Moderowanie czatu, moderowanie forum, pomoc techniczna |
| ::{ flag=US }:: ::Nevo::{ user=7451883 } |  | Moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=ID }:: ::Niva::{ user=197805 } | Indonezyjski | Moderowanie czatu |
| ::{ flag=FR }:: ::Nozhomi::{ user=2716981 } | Francuski | Moderowanie czatu |
| ::{ flag=DE }:: ::OnosakiHito::{ user=290128 } | Niemiecki, serbski | Moderowanie czatu, moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=AU }:: ::osu!team::{ user=4341397 } |  | Oficjalny profil zespołu gry |
| ::{ flag=FR }:: ::Pachiru::{ user=2850983 } | Francuski | Moderowanie czatu, moderowanie forum |
...
| ::{ flag=DE }:: ::RockRoller::{ user=8388854 } | Niemiecki | Skinning community moderation, moderowanie forum |
| ::{ flag=JP }:: ::S o h::{ user=2234772 } | Japoński | Moderowanie czatu |
| ::{ flag=SE }:: ::Saten::{ user=444506 } | Szwedzki, hiszpański | Moderowanie czatu |
| ::{ flag=FR }:: ::Shiro::{ user=113005 } | Francuski, hiszpański | Moderowanie czatu |
| ::{ flag=ID }:: ::Shurelia::{ user=3807986 } | Indonezyjski | Moderowanie czatu |
| ::{ flag=ID }:: ::Sies::{ user=6491991 } | Indonezyjski, wietnamski (częściowo) | Moderowanie czatu, moderowanie forum |
| ::{ flag=TW }:: ::spboxer3::{ user=197974 } | Chiński | Moderowanie czatu |
...
| ::{ flag=TH }:: ::Trigonoculus::{ user=7627013 } | Tajski | Moderowanie czatu |
| ::{ flag=ES }:: ::Trosk-::{ user=3469385 } | Hiszpański | Pomoc techniczna |
| ::{ flag=PL }:: ::Venix::{ user=5999631 } | Polski | Team leadership, moderowanie czatu, moderowanie społeczności twórców i moderów beatmap |
| ::{ flag=IT }:: ::VoidGod::{ user=4724656 } | Włoski | Moderowanie czatu |
| ::{ flag=ID }:: ::wowcake::{ user=16121851 } | Indonezyjski | Moderowanie czatu |
| ::{ flag=PL }:: ::Yason::{ user=2574392 } | Polski | Moderowanie czatu |
| ::{ flag=HM }:: ::Zallius::{ user=55 } |  | Moderowanie czatu |
| ::{ flag=CL }:: ::ZiRoX::{ user=200768 } | Hiszpański | Moderowanie społeczności twórców i moderów beatmap |
