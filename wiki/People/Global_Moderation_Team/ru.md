...
- **[osu!supporter](/wiki/osu!supporter)**: Тег osu!supporter что остаётся на протяжении срока членства в команде.
- **Значок стажа**: Это [значок в профиле](/wiki/Community/Profile_badge) который показывает сколько лет модератор находится в команде, от 1 до 10.
...
Когда модератор решает уйти из команды, в зависимости от ситуации они могут получить такие награды:

- **Титул [osu! Alumni](/wiki/People/osu!_Alumni)**: он выдаётся модераторам которые были частью команды на протяжении хотябы 1 года, или сделали внушительный вклад внутри команды на протяжении более короткого срока.
- **osu!supporter**: Модераторы награждаются тегом osu!supporter который будет длится в два раза дольше, чем время которое они провели в команде, на тех же условиях, что и статус osu! Alumni.
...
**Каждый член команды модерации может заниматься любой задачей в любой категории по своему усмотрению, независимо от указанной ниже сферы деятельности.** Например: Модератор что в основном занимается модерацией чата может так же помочь с модерацией форумов.
...
| ::{ flag=US }:: [Blushing](https://osu.ppy.sh/users/5927823) |  | Модерация чата, модерация форума |
...
| ::{ flag=HU }:: [Spkz](https://osu.ppy.sh/users/2964029) | Венгерский | Модерация чата |
...
| ::{ flag=JP }:: [TKS](https://osu.ppy.sh/users/940878) | Японский | Модерация маппинг-сообщества |
