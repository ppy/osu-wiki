...
| ::{ flag=FR }:: [Ganondorf](https://osu.ppy.sh/users/169570) | <!-- TODO --> | Chat moderation |
...
| ::{ flag=FI }:: [terho](https://osu.ppy.sh/users/940878) | <!-- TODO --> | Chat moderation |
| ::{ flag=NZ }:: [THAT_otaku](https://osu.ppy.sh/users/11798717) | <!-- TODO --> | Forum moderation |
