...
| :-- | :-- | :-- |
| ::{ flag=MY }:: [\_Kobii](https://osu.ppy.sh/users/6209713) |  | Moderação da comunidade de mapping/modding |
...
| ::{ flag=KR }:: [Spectator](https://osu.ppy.sh/users/702598) |  | Moderação da comunidade de mapping/modding |
...
| ::{ flag=CL }:: [ZiRoX](https://osu.ppy.sh/users/200768) |  | Moderação da comunidade de mapping/modding |
