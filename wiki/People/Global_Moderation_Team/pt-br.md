...
| ::{ flag=IT }:: [- Marco -](https://osu.ppy.sh/users/1273955) | Italiano | Moderação de chat, moderação de fórum |
...
| ::{ flag=CN }:: [\_Stan](https://osu.ppy.sh/users/1653229) | Chinês | Moderação da comunidade de mapping/modding, moderação de fórum |
...
| ::{ flag=BR }:: [DizzyH](https://osu.ppy.sh/users/9896172) | Português | Moderação de chat |
...
| ::{ flag=DE }:: [Hopes](https://osu.ppy.sh/users/4907504) | Alemão, turco | Moderação de chat |
...
| ::{ flag=BR }:: [Jaguar](https://osu.ppy.sh/users/3660954) | Português | Moderação de chat |
...
| ::{ flag=GB }:: [Log Off Now](https://osu.ppy.sh/users/4378277) |  | Moderação de chat, moderação da comunidade de mapping/modding |
...
| ::{ flag=FI }:: [Riverism](https://osu.ppy.sh/users/4980738) | Finlandês, um pouco de sueco, um pouco de japonês | Moderação da comunidade de mapping/modding, moderação de fórum |
