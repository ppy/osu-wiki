...
| ::{ flag=RS }:: [0x84f](https://osu.ppy.sh/users/7944724) | Sérvio |  |
| ::{ flag=US }:: [abraker](https://osu.ppy.sh/users/4635891) |  | Moderação de fórum |
| ::{ flag=NL }:: [Albionthegreat](https://osu.ppy.sh/users/9853595) | Holandês, um pouco de alemão |  |
...
| ::{ flag=CA }:: [D I O](https://osu.ppy.sh/users/3958619) | Um pouco de espanhol |  |
| ::{ flag=AR }:: [Darksonic](https://osu.ppy.sh/users/570042) | Espanhol | Moderação de chat |
...
| ::{ flag=GB }:: [mangomizer](https://osu.ppy.sh/users/1893718) | Cantonês, chinês |  |
...
| ::{ flag=CA }:: [Shad0wStar](https://osu.ppy.sh/users/16866460) |  | Moderação de chat, moderação da comunidade de mapping/modding |
...
| ::{ flag=KR }:: [Spectator](https://osu.ppy.sh/users/702598) |  | Moderação de chat, moderação da comunidade de mapping/modding |
...
| ::{ flag=JP }:: [TKS](https://osu.ppy.sh/users/940878) | Japonês | Moderação da comunidade de mapping/modding |
...
| ::{ flag=CL }:: [ZiRoX](https://osu.ppy.sh/users/200768) |  | Moderação de chat, moderação da comunidade de mapping/modding |
