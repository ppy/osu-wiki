...
::: alert-notice
**알림**
특별한 언급이 없는 한 모든 GMT 구성원들은 영어를 구사할 수 있습니다.
:::

| 이름 | 언어 | 주요 활동 |
| :-- | :-- | :-- |
| ::{ flag=DE }:: ::- Felix::{ user=8503985 } | 독일어 | 채팅 관리 |
| ::{ flag=IT }:: ::- Marco -::{ user=1273955 } | 이탈리아어 | 채팅 관리, 포럼 관리 |
| ::{ flag=IT }:: ::-kevincela-::{ user=266596 } | 이탈리아어 | 매핑/모딩 커뮤니티 관리 |
| ::{ flag=US }:: ::-NoName-::{ user=10400730 } |  | 채팅 관리 |
| ::{ flag=MY }:: ::\_Kobii::{ user=6209713 } | 중국어, 말레이어, 광둥어, 약간의 일본어 | 매핑/모딩 커뮤니티 관리 |
| ::{ flag=CN }:: ::\_Stan::{ user=1653229 } | 중국어 | 매핑/모딩 커뮤니티 관리, 포럼 관리 |
| ::{ flag=CH }:: ::\[ryuu\]::{ user=5698467 } | 러시아어 | 채팅 관리 |
| ::{ flag=RS }:: ::0x84f::{ user=7944724 } | 세르비아어 | 팀 리더, general moderation |
| ::{ flag=US }:: ::abraker::{ user=4635891 } |  | 포럼 관리 |
| ::{ flag=GB }:: ::aceticke::{ user=8838763 } |  | 채팅 관리, 매핑/모딩 커뮤니티 관리, general moderation |
| ::{ flag=NL }:: ::Albionthegreat::{ user=9853595 } | 네덜란드어, 약간의 독일어 | General moderation |
| ::{ flag=US }:: ::Atrue::{ user=1758523 } | 중국어 | 채팅 관리, 포럼 관리, 매핑/모딩 커뮤니티 관리 |
| ::{ flag=CA }:: ::Aurele::{ user=654108 } | 프랑스어 | 채팅 관리, 포럼 관리, 매핑/모딩 커뮤니티 관리 |
| ::{ flag=CA }:: ::Azer::{ user=2155578 } |  | 토너먼트 관리 |
| ::{ flag=MY }:: ::bibitaru::{ user=4482419 } | 중국어, 말레이어 | 채팅 관리 |
| ::{ flag=US }:: ::Blushing::{ user=5927823 } |  | 채팅 관리, 포럼 관리, 기술 지원 |
| ::{ flag=US }:: ::ChillierPear::{ user=9501251 } | 스웨덴어, 스페인어 | General moderation, 토너먼트 관리 |
| ::{ flag=GB }:: ::chromb::{ user=10238680 } |  | 채팅 관리 |
| ::{ flag=KR }:: ::Civil oath::{ user=3216107 } | 한국어, 일본어 | 채팅 관리 |
| ::{ flag=FR }:: ::Corne2Plum3::{ user=15646039 } | 프랑스어 | 포럼 관리 |
| ::{ flag=CA }:: ::D I O::{ user=3958619 } | 약간의 스페인어 | 토너먼트 관리 |
| ::{ flag=BR }:: ::DizzyH::{ user=9896172 } | 포르투갈어 | 채팅 관리 |
| ::{ flag=US }:: ::Death::{ user=3242450 } |  | 포럼 관리, 기술 지원 |
| ::{ flag=US }:: ::Dntm8kmeeatu::{ user=5428812 } |  | 기술 지원 |
| ::{ flag=AU }:: ::Ephemeral::{ user=102335 } |  | 플레이어 지원, 위키 관리 |
| ::{ flag=FI }:: ::Flutteh::{ user=5042507 } | 핀란드어, 약간의 스웨덴어 | 채팅 관리 |
| ::{ flag=CN }:: ::Fycho::{ user=1876867 } | 중국어 | 채팅 관리, 매핑/모딩 커뮤니티 관리 |
| ::{ flag=PL }:: ::Galkan::{ user=169570 } | 폴란드어 | 채팅 관리 |
| ::{ flag=FR }:: ::Ganondorf::{ user=10660738 } | 프랑스어 | 채팅 관리 |
| ::{ flag=US }:: ::Halfslashed::{ user=4598899 } |  | 매핑/모딩 커뮤니티 관리 |
| ::{ flag=DE }:: ::Hopes::{ user=4907504 } | 독일어, 튀르키예어 | 채팅 관리 |
| ::{ flag=ID }:: ::Ilham::{ user=3057154 } | 인도네시아어 | 매핑/모딩 커뮤니티 관리 |
| ::{ flag=FR }:: ::Imakuri::{ user=6100837 } | 프랑스어, 스페인어 | 채팅 관리 |
| ::{ flag=BR }:: ::Jaguar::{ user=3660954 } | 포르투갈어 | 채팅 관리 |
| ::{ flag=HK }:: ::kanpakyin::{ user=394326 } | 광둥어, 중국어, 일본어 | 채팅 관리 |
| ::{ flag=RU }:: ::Kobold84::{ user=3227533 } | 러시아어 | 팀 리더, 채팅 관리, 포럼 관리 |
| ::{ flag=RU }:: ::Kudou Chitose::{ user=9936528 } | 러시아어 | 채팅 관리 |
| ::{ flag=FI }:: ::Laurakko::{ user=7253731 } | 핀란드어, 약간의 스웨덴어 | 채팅 관리 |
| ::{ flag=BR }:: ::LeoFLT::{ user=3668779 } | 포르투갈어, 스페인어 | 채팅 관리, 토너먼트 관리 |
| ::{ flag=VE }:: ::Leon Brigido::{ user=13570072 } | 스페인어 | 채팅 관리 |
| ::{ flag=DE }:: ::Loctav::{ user=71366 } | 독일어 | 매핑/모딩 커뮤니티 관리 |
| ::{ flag=GB }:: ::Log Off Now::{ user=4378277 } |  | 채팅 관리, 매핑/모딩 커뮤니티 관리 |
| ::{ flag=DE }:: ::Lyawi::{ user=5851253 } | 독일어 | 채팅 관리, 포럼 관리 |
| ::{ flag=GB }:: ::mangomizer::{ user=1893718 } | 광둥어, 중국어 | 토너먼트 관리 |
| ::{ flag=BR }:: ::maot::{ user=3914271 } | 포르투갈어 | 매핑/모딩 커뮤니티 관리 |
| ::{ flag=NO }:: ::MillhioreF::{ user=941094 } |  | osu! 개발 |
| ::{ flag=VN }:: ::My Angel Chino::{ user=20547597 } | 베트남어 | 채팅 관리 |
| ::{ flag=PH }:: ::Nathanael::{ user=2295078 } | 필리핀어 | 채팅 관리, 포럼 관리, 기술 지원 |
| ::{ flag=US }:: ::Nevo::{ user=7451883 } |  | 매핑/모딩 커뮤니티 관리 |
| ::{ flag=ID }:: ::Niva::{ user=197805 } | 인도네시아어 | 채팅 관리 |
| ::{ flag=FR }:: ::Nozhomi::{ user=2716981 } | 프랑스어 | 채팅 관리 |
| ::{ flag=DE }:: ::OnosakiHito::{ user=290128 } | 독일어, 세르비아어 | 채팅 관리, 매핑/모딩 커뮤니티 관리 |
| ::{ flag=AU }:: ::osu!team::{ user=4341397 } |  | 공식 팀 |
| ::{ flag=FR }:: ::Pachiru::{ user=2850983 } | 프랑스어 | 채팅 관리, 포럼 관리 |
...
| ::{ flag=DE }:: ::RockRoller::{ user=8388854 } | 독일어 | 스킨 커뮤니티 관리, 포럼 관리 |
| ::{ flag=JP }:: ::S o h::{ user=2234772 } | 일본어 | 채팅 관리 |
| ::{ flag=SE }:: ::Saten::{ user=444506 } | 스웨덴어, 스페인어 | 채팅 관리 |
| ::{ flag=FR }:: ::Shiro::{ user=113005 } | 프랑스어, 스페인어 | 채팅 관리 |
| ::{ flag=ID }:: ::Shurelia::{ user=3807986 } | 인도네시아어 | 채팅 관리 |
| ::{ flag=ID }:: ::Sies::{ user=6491991 } | 인도네시아어, 약간의 베트남어 | 채팅 관리, 포럼 관리 |
| ::{ flag=TW }:: ::spboxer3::{ user=197974 } | 중국어 | 채팅 관리 |
...
| ::{ flag=TH }:: ::Trigonoculus::{ user=7627013 } | 태국어 | 채팅 관리 |
| ::{ flag=ES }:: ::Trosk-::{ user=3469385 } | 스페인어 | 기술 지원 |
| ::{ flag=PL }:: ::Venix::{ user=5999631 } | 폴란드어 | 팀 리더, 채팅 관리, 매핑/모딩 커뮤니티 관리 |
| ::{ flag=IT }:: ::VoidGod::{ user=4724656 } | 이탈리아어 | 채팅 관리 |
| ::{ flag=ID }:: ::wowcake::{ user=16121851 } | 인도네시아어 | 채팅 관리 |
| ::{ flag=PL }:: ::Yason::{ user=2574392 } | 폴란드어 | 채팅 관리 |
| ::{ flag=HM }:: ::Zallius::{ user=55 } |  | 채팅 관리 |
| ::{ flag=CL }:: ::ZiRoX::{ user=200768 } | 스페인어 | 매핑/모딩 커뮤니티 관리 |
