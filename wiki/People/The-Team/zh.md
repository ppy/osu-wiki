...
| 名 | 描述 |
| ---- | ----------- |
| [Global Moderation Team](https://osu.ppy.sh/wiki/Global_Moderation_Team) | 管理论坛和聊天室 |
| [Beatmap Nomination Group](https://osu.ppy.sh/wiki/Beatmap_Nomination_Group) | 使你的图能够上架的普通用户 |
| [Developers](http://osu.ppy.sh/g/11) | 通过添加新功能和修复 Bugs 使游戏变得有趣 |
| [osu! alumni](https://osu.ppy.sh/wiki/Osu!_Alumni) | 曾经为社区做出了杰出贡献 |
| [Support Team Redux](https://osu.ppy.sh/wiki/Support_Team) | 处理帮助/新功能请求的助手 |
