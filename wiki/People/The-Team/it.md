...
| Nome | Descrizione |
| ---- | ----------- |
| [Global Moderation Team](https://osu.ppy.sh/wiki/Global_Moderation_Team) | Controllano il forum e la chat nel gioco |
| [Beatmap Nomination Group](https://osu.ppy.sh/wiki/Beatmap_Nomination_Group) | Gli utenti che vanno oltre il dovere per assicurare che le tue mappe siano qualificate |
| [Sviluppatori](http://osu.ppy.sh/g/11) | Rendono il gioco eccellente aggiungendo nuove funzioni e correggendo i bug |
| [osu! alumni](https://osu.ppy.sh/wiki/Osu!_Alumni) | Coloro che sono conosciuti per il loro contributi che se ne sono andati |
| [Support Team Redux](https://osu.ppy.sh/wiki/Support_Team) | Help/Feature Request assistance |
...
| [Quality Assurance Team](https://osu.ppy.sh/wiki/Quality_Assurance_Team) | Ti aiutiamo a farti piacere osu!, iniziando dalla qualità delle beatmaps. |
