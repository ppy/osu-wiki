...
- Sebelum 28 April 2021, [halaman grup Project Loved](https://osu.ppy.sh/groups/31) tidak bersifat publik dan hanya digunakan untuk tujuan administratif. Namun sekarang, itu tersedia untuk umum.
  - Sampai 16 April 2021, satu-satunya orang yang ada di grup itu adalah ::{ flag=US }:: ::clayton::{ user-id=3666350 }, ::{ flag=LT }:: ::huu::{ user-id=6044237 }, ::{ flag=SG }:: ::Shoegazer::{ user-id=2520707 }, dan ::{ flag=US }:: ::Toy::{ user-id=2757689 }. Namun sekarang, semua tim Project Loved sudah berada di dalam grup.
