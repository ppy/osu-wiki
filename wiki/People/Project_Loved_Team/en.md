...
- ::{ flag=US }:: ::Toy::{ user=2757689 } created the original team of captains in September 2017 along with the [Captain's Pick](/wiki/History_of_osu!/History_of_Loved#captain's-pick-and-project-loved-(sep-2017-–-present)) system that was later renamed to Project Loved. Until late 2019, he oversaw and managed the whole project.
- Prior to the 28 April 2021, the [Project Loved group page](https://osu.ppy.sh/groups/31) was not public and used only for administrative purposes. As of now, it is publicly available.
  - Until the 16 April 2021, the only people that had been in the group were ::{ flag=US }:: ::clayton::{ user=3666350 }, ::{ flag=LT }:: ::huu::{ user=6044237 }, ::{ flag=SG }:: ::Shoegazer::{ user=2520707 }, and ::{ flag=US }:: ::Toy::{ user=2757689 }. Now, all of the Project Loved Team belongs to the group.
