...
- *内容审核员*：确保每个被提名的谱面都符合[歌曲内容规范](/wiki/Rules/Song_content_rules)和[视觉内容注意事项](/wiki/Rules/Visual_content_considerations)。
- *描述校对员*：检查队长撰写的谱面说明是否存在拼写和语法上的错误。
- *元数据校对员*：确保被提名谱面的元数据无误。

[Project Loved 成员页面](https://osu.ppy.sh/groups/31)列出了所有团队成员。关于 Project Loved 团队中各个职位的更加详细的成员名单，以及历届成员信息，可以在 [Project Loved 网站](https://loved.sh/team)上找到。
...
Project Loved 团队成员将获得一个显示其加入 Project Loved 年限的任期的[主页奖牌](/wiki/Community/Profile_badge)。
...
- ::{ flag=US }:: ::Toy::{ user=2757689 } 于 2017 年 9 月创建了最初的队长团队，并建立了[队长精选](/wiki/History_of_osu!/History_of_Loved#captain's-pick-and-project-loved-(sep-2017-–-present))系统，该系统后来更名为 Project Loved。直到 2019 年底，他一直都监督和管理着整个项目。
- 在 2021 年 4 月 28 日之前，[Project Loved 团队页面](https://osu.ppy.sh/groups/31)并未公开，仅用于管理目的。目前，此页面已公开。
  - 在 2021 年 4 月 16 日之前，该小组中仅有的成员有 ::{ flag=US }:: ::clayton::{ user=3666350 }、::{ flag=LT }:: ::huu::{ user=6044237 }、::{ flag=SG }:: ::Shoegazer::{ user=2520707 } 和 ::{ flag=US }:: ::Toy::{ user=2757689 }。现在，所有 Project Loved 团队成员均属于该小组。
