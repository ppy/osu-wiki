...
**Featured Artist-Playlists** werden in [osu!(lazer)](/wiki/Client/Release_stream/Lazer) veröffentlicht und heben Inhalte der [gesponserten Künstler](/wiki/People/Featured_Artists) in allen [Spielmodi](/wiki/Game_mode) hervor. Diese Playlists haben kein strenges Format, d.h. ihre Parameter, die Auswahl der Beatmaps und die Preiskriterien sind in jeder Playlist unterschiedlich.

![Lobby einer Featured Artist-Playlist](img/playlist.jpg "Lobby einer Featured Artist-Playlist in osu!(lazer)")

Du gelangst zu den Playlists, indem du in osu!(lazer) auf **spielen** klickst und in der rechten oberen Ecke nach **Featured Artists** filterst.

![Auflistung der Featured Artist-Playlists](img/playlist-listing.jpg)

## Preise

Spieler können entsprechend der unten stehenden **kumulierten Rangliste** Profilabzeichen erlangen, die sich auf den jeweiligen Spielmodus beziehen.

![Featured Artist-Profilabzeichen](https://assets.ppy.sh/profile-badges/fa-playlists/fapl-osu!.png) ![Featured Artist-Profilabzeichen](https://assets.ppy.sh/profile-badges/fa-playlists/fapl-osu!taiko.png) ![Featured Artist-Profilabzeichen](https://assets.ppy.sh/profile-badges/fa-playlists/fapl-osu!catch.png) ![Featured Artist-Profilabzeichen](https://assets.ppy.sh/profile-badges/fa-playlists/fapl-osu!mania.png)
...
| Platzierung in der Rangliste der Playlist | Punkte |
| :-- | :-- |
| 1. | **10** |
| 2. | 5 |
| 3. | 3 |
...
Für vollständige Informationen zu den Playlists, siehe die [Auflistung der Mehrspieler-Räume](https://osu.ppy.sh/multiplayer/rooms/latest).

### Juni 2022

- 8 Beatmaps
- Alle Spielmodi
- [Hidden (HD)](/wiki/Gameplay/Game_modifier/Hidden)-Mod erforderlich
- [No Fail (NF)](/wiki/Gameplay/Game_modifier/No_Fail) und [Mirror (MR)](/wiki/Gameplay/Game_modifier/Mirror) optional verwendbar
- Preise wurden den drei besten Spielern jeder Playlist verliehen

### Juli 2022

- 5 Beatmaps
- Alle Spielmodi
- 15 erlaubte Versuche über alle Einträge der Playlist hinweg
- [Hidden (HD)](/wiki/Gameplay/Game_modifier/Hidden), [Hard Rock (HR)](/wiki/Gameplay/Game_modifier/Hard_Rock), [No Fail (NF)](/wiki/Gameplay/Game_modifier/No_Fail) und [Mirror (MR)](/wiki/Gameplay/Game_modifier/Mirror) optional verwendbar
- Preise wurden den besten 0,5 % der Spieler jeder Playlist verliehen
...
- Die 8 besten Beatmaps aus dem [Twin Trials Contest](/wiki/Contests/Twin_Trials_Contest) mit separaten Preisen
- Alle Spielmodi
