...
Featured Artists with osu! accounts are given the cyan [user title](/wiki/Community/User_title) and [user group](/wiki/People/User_group) badge that reads `FA` to show their involvement.
