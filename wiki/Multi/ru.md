...
Мульти (сокращение от _мультиплеер_) был добавлен в публичную версию osu! b335 и является игровым режимом для онлайн-игры с другими игроками, число которых может доходить до 16 человек.  

Это тема также освещена в [шестом выпуске](https://www.youtube.com/watch?v=cyYRl-a5xII) [osu!academy](/wiki/osu!academy) наравне со [списком игроков в сети](/wiki/Chat_Console#расширенное-окно-чата).

## Как начать

### Минимальные требования

![](/wiki/shared/Beatmaps_peppy.jpg "Как распаковать мапу \(наглядно\).")

- Стабильное подключение к интернету;
- Произведенный вход в osu! (вход производится клиентом автоматически во время запуска);
- Знание того, [как скачивать карты, не выходя из лобби](/wiki/Beatmaps). 
...
![](img/Multi_lobby.jpg "Типичный день в Мультиплеере")
...
По умолчанию в [основном окне чата](/wiki/Chat_Console) откроется `#lobby`, и чат будет открыт все время.
...
![](img/Multi_roomhost.jpg "Комната с правами хоста")

![](img/Multi_roomplayer.jpg "Пример комнаты со свободными модами")

Наверху экрана отображается ваша роль в комнате (хост или обыкновенный игрок), ваш ранг и кнопка паузы.

---

Снизу экрана находится [основное окно чата](/wiki/Chat_Console). 
При входе в комнату в чате автоматически открывается новая вкладка `#multiplayer`, в которую [БанчоБот](/wiki/BanchoBot) отправляет ссылку на историю матча с подписью `(Match history available here)`. 
...
![](img/Multi_host_song_change.jpg "Во время смены карты вместо нее будет отображаться эта плашка.")

![](img/Multi_SS.jpg "Процесс выбора мапы со стороны хоста.")
...
Cannot update the beatmap       | Возможно, у хоста [модифицированная версия карты.](https://osu.ppy.sh/community/forums/topics/135726 "ppy's reply on a bug report.")
...
- Если _Quit_: [Auto](/wiki/Game_Modifiers#auto) будет играть за ушедшего игрока.
...
Если был включен [Easy (EZ)](/wiki/Game_Modifiers#easy) мод, полоска здоровья будет, как обычно, дважды восполняться, но сразу после этого опустошится полностью и карта будет проиграна. 
Игроки, использующие [Sudden Death (SD)](/wiki/Game_Modifiers#sudden-death)/[Perfect (PF)](/wiki/Game_Modifiers#perfect), будут иметь немного отличающийся интерфейс, особенно в плане эффектов. 
