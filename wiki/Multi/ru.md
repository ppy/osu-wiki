...
При входе в комнату в чате автоматически открывается новая вкладка `#multiplayer`, в которую [BanchoBot](/wiki/BanchoBot) отправит ссылку на историю матча с подписью `(Match history available here)`. 
...
В данной секции показываются изображение, символ режима игры, название, автор карты, исполнитель и сложность текущей карты. Также, если навести курсор на нее, будут показаны BPM, длительность и свойства карты.
