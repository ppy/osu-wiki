...
Нажатие клавиши `Esc` (Escape) на клавиатуре *не ставит матч на паузу*; вместо этого снизу справа появится предупреждение о том, что для выхода из комнаты нужно нажать клавишу `Esc` еще раз.
Чтобы выйти из комнаты и вернуться в мультиплеер, нажмите `Esc` *снова*.
...
Если же ошибку сделает игрок, *использующий* мод, игроки проиграют незамедлительно.
