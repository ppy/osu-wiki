...
[Match History link]: https://osu.ppy.sh/mp/x
...
The [osu!academy][osu!academy wikilink] covered this topic in [Episode 6 (6:52)][osu!academy Ep6] along with the [Online Users Panel][Chat_Console#Extended Chat Console wikilink].
...
The link is `https://osu.ppy.sh/mp/x` (replace "x" with digits generated by Bancho for this Match Setup), which will be removed after one month.
