...
- Скачайте **[пак карт](http://osu.ppy.sh/p/packlist)**. Это архив, содержащий сразу несколько карт. Зачастую это .zip или .rar архив. Скачайте архив, распакуйте, используя ваш любимый архиватор (например [7-Zip](http://www.7-zip.org/)) и импортируйте распакованные .osz файлы, как вы это обычно делаете.
...
###### Как установить
- Перейдите на [страницу загрузки](http://osu.ppy.sh/p/download) и нажмите на ссылку "OS X installer", для загрузки последней версии.
...
###### Добавление карт
>[Оригинальный пост](http://osu.ppy.sh/forum/p/909738)
...
>Эта инструкция скорее всего устарела! Проверьте [последние страницы этой темы](http://osu.ppy.sh/forum/t/14614) на форуме.
...
>[Оригинальный пост](http://osu.ppy.sh/forum/t/62680)
...
##### Как установить (С помощью телефона)
>[Оригинальный пост](http://osu.ppy.sh/forum/t/58640)
...
##### Как установить
- Используйте [эту ссылку](http://osu.ppy.sh/forum/t/176495) для поиска пошаговой инструкции для установки osu! на джейлбрейкнутый iPhone с версией iOS 7.0.4 .
