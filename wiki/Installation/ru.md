...
-   **Что-то еще пошло не так?**
    -   Если вы нашли баг или ошибку, которых нету выше, проверьте [форум отчетов о багах](https://osu.ppy.sh/forum/5) и напишите здесь (настоятельно рекомендуется сначала поискать существующие темы). Кто-то, безусловно, будет рядом чтобы помочь. Убедитесь что вы сообщаете вашу проблему четко и предоставляете информацию о действиях, причинивших ошибку (как скриншоты, видео, и/или ваши пошаговые действия).
