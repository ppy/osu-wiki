...
### T-Aiko \[Taiko\] (неофициальная версия)

iOS устройства
--------------

### osu! iPhone (неофициальная версия)
...
-   **Что-то еще пошло не так?**
    -   Если вы нашли баг или ошибку, которых нету выше, проверьте [форум отчетов о багах](http://osu.ppy.sh/forum/5) и напишите здесь (настоятельно рекомендуется сначала поискать существующие темы). Кто-то, безусловно, будет рядом чтобы помочь. Убедитесь что вы сообщаете вашу проблему четко и предоставляете информацию о действиях, причинивших ошибку (как скриншоты, видео, и/или ваши пошаговые действия).
...
-   Сделаете ли вы <название возможности>?
    -   Создайте вашу заявку в [теме запросов на добавление новых возможностей](http://osu.ppy.sh/forum/t/62313).
...
-   Я не могу играть на своем Android телефоне!
    ...
    -   Если вы нашли (баг/проблему), пожалуйста, напишите [в этом посте на форуме](http://osu.ppy.sh/forum/t/58640), сообщив какой телефон вы используете и ваши пошаговые действия, что призводят к проблеме.
