...
- 1 GHz 以上的中央處理器
- 512 MB 以上的記憶體
- [NET框架3.5以上](https://microsoft.com/zh-hk/download/details.aspx?id=48130)
...
- 下載**[譜面合集](https://osu.ppy.sh/beatmaps/packs)**。地圖包是把幾個譜面整合。他們一般都是.zip或.r​​ar檔。下載一個你喜歡的壓縮程式提取它（例如[7-Zip](https://7-zip.org)），並導入提取.osz文件。
