...
*Див. також: [Встановлення в macOS](/wiki/Installation/macOS)*

Ця сторінка скаже вам, як заставити osu! працювати на вашому Windows-пристрої. В [osu!academy](/wiki/osu!academy) є [відео-туторіал](https://www.youtube.com/watch?v=0V5GwzmMhpU), яких об\'ясняє процес встановлення osu! на Windows.
...
3. Коли установник в стані запуску, у вас є 10 секунд, щоб дозволити вам вибрати місце встановлення.
...
4. Коли установник закінчить роботу, osu! запуститься. Для завантаження для вас декількох початкових карт, буде використаний osu!direct.
...
Якщо ви використовуєте 64-бітну Windows 7, ви можете мати ускладнення із правильним встановленням osu!. Спробуйте встановити 64-бітну версію .NET Framework-у, в цьому випадку, це не йде в комплект із установником osu!. [Скачайте це тут](https://download.microsoft.com/download/2/0/e/20e90413-712f-438c-988e-fdaa79a8ac3d/dotnetfx35.exe)

---

**Якщо установник гри показує помилки, під час встановлення, ви можете спробувати декілька речей:**

- Спробуйте перевстановити останню версію .NET Framework-у. [Ви можете знайти це тут](https://dotnet.microsoft.com/download).
- Очистіть ваш ПК - Перевірте його антивірусною програмою, очистіть реєстр. Хороша програма для глобальної очистки - CCleaner. Вона сканує ваші файли і ваш реєстр. Установник також може давати збої, якщо тут є "хвости" від минулої копіїT osu!, які раніше були в вашій системі.

## Додавання карт

*Див. також: [Карти](/wiki/Beatmaps)*

Є два способа додавання карт, через сайт або osu!direct (для останнього потрібен тег [osu!supporter](/wiki/osu!supporter)).
...
4. Знайдіть і відкрийте файл із набором карт, він має розширення `.osz`.
...
5. osu! автоматично обробить для вас залишки і завантажить набір карт.
   - Якщо по якийсь причині ви не бачите завантежених карт, настисніть `F5` в [Екрані вибору пісні](/wiki/Interface#song-selection-screen) для повторної їх обробки.

### osu!direct

*Примітка: Вам потрібно мати тег osu!supporter і Інтернет-з\'єднання для використання osu!direct.*

1. Відкрийте osu! і натисніть на кнопку osu!direct в правій частині головного екрану.
...
4. Коли osu! закінчить завантаження набору карт, вона автоматично вивантажить його.
   - Якщо по якийсь причині ви не бачите завантажених карт, натисніть `F5` в [Екрані вибору пісні](/wiki/Interface#song-selection-screen) для повторної їх обробки.
