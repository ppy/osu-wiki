...
This page will tell you how to get osu! working on your Windows device. The [osu!academy](/wiki/osu!academy) has a [video tutorial](https://youtube.com/watch?v=0V5GwzmMhpU) that explains how to install osu! on Windows.
...
5. osu! will automatically handle the rest for you and load the beatmapset.
   - If, for any reason, you do not see them, press `F5` in [Song Selection](/wiki/Interface) to re-process your beatmaps.
