...
- 1 GHz+ Processzor
- 512 MB+ RAM
- [Microsoft .NET Framework (3.5+)](https://microsoft.com/hu-hu/download/details.aspx?id=48130)
...
> A számítógépeden telepítve kell legyen az [iTunes](https://apple.com/itunes).
...
- **Megpróbálom futtatni az osu!-t, de "Initialization Error"-t kapok**
  - Bizonyosodj meg róla, hogy telepítve van a [.NET Framework 3.5](https://microsoft.com/hu-hu/download/details.aspx?id=48130).
