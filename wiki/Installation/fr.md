...
_Voir également: [Installation/macOS](/wiki/Installation/macOS)_
...
_Voir également: [Beatmaps](/wiki/Beatmaps) et [Beatmapsets](/wiki/Beatmapsets)_
...
5.  osu! se chargera automatiquement du reste et chargera la beatmap.
    -   Si, pour une raison quelconque, vous ne les voyez pas, pressez `F5` en [Mode Solo](/wiki/Solo_mode) pour re-traiter vos beatmaps. _Ce processus prendra du temps si vous avez beaucoup de beatmaps._

### osu!direct

_Remarque: vous devez disposer du tag "osu!supporter" et d'une connexion internet pour pouvoir utiliser osu!direct._
...
_Voir également: [Skins](/wiki/Skins) et [Skinning](/wiki/Skinning)_
