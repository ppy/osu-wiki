...
5. osu! s'occupera automatiquement du reste pour vous et chargera la beatmap.
   - Si, pour une raison quelconque, vous ne les voyez pas, appuyez sur `F5` dans la [sélection des chansons](/wiki/Interface#ecran-de-sélection-des-beatmaps) pour retraiter vos beatmaps.
