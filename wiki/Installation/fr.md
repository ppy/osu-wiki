...
Cette page vous dira approximativement comment installer osu! sur votre appareil Windows pour qu'il fonctionne. [osu!academy](/wiki/osu!academy) possède un [tutoriel vidéo](https://youtube.com/watch?v=0V5GwzmMhpU) qui va vous expliquer comment installer osu! sous Windows.

## Configuration minimale requise

- .NET framework 4+ (le programme d’installation devrait vous demander de le télécharger, sinon, vous pouvez [le trouver ici](https://microsoft.com/fr-fr/download/details.aspx?id=48130))
...
*Voir également: [Beatmaps](/wiki/Beatmaps) et [Beatmapsets](/wiki/Beatmapset)*
