...
2. You will see the `osu!.app` folder, which will look like an application. right click, and select open.
...
3. The installer will automatically run. The installation location cannot be changed and will be installed directly to `osu!.app`. Moving `osu!.app` will move all of the files that come with it. You can also right-click and click `Show Package Contents` to view the files within the folder.
