...
Esta página te dirá mas o menos cómo obtener a osu! funcionando en tu dispositivo de Windows. La [osu!academy](/wiki/osu!academy) tiene un [video tutorial](https://youtube.com/watch?v=0V5GwzmMhpU) que explica cómo instalar osu! en Windows.

## Requerimientos mínimos del sistema

- .NET framework 4+ (el instalador debería pedirle que lo descargue, de lo contrario, puedes [encontrarlo aquí](https://microsoft.com/es-es/download/details.aspx?id=48130) )
...
*Ver también: [Beatmaps](/wiki/Beatmaps) y [Beatmapsets](/wiki/Beatmapset)*
...
5. osu! se encargará automáticamente del resto y cargará el beatmapset.
   - Si, por alguna razón, no los ves, presiona `F5` en [Modo Solo](/wiki/Interface) para volver a procesar tus mapas de ritmo.
...
4. Cuando osu! termine de descargar el beatmapset, lo cargará automáticamente si estás en modo Solo, en la pantalla [Song Selection] (/wiki/Interface).
   - Si, por alguna razón, no los ves, presiona `F5` en [Modo Solo](/wiki/Interface) para volver a procesar tus mapas de ritmo.
