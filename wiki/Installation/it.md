...
Questa pagina ti spiegherà approssimativamente come far funzionare osu! su un dispostivo Windows. L'[osu!academy](/wiki/osu!academy) ha un [video tutorial](https://youtube.com/watch?v=0V5GwzmMhpU) che spiega come installare osu! su Windows (in inglese).

## Requisiti minimi di sistema

- .NET framework 4+ (l'installer dovrebbe indirizzarti al relativo download, altrimenti, puoi [trovarlo qui](https://microsoft.com/it-it/download/details.aspx?id=48130))
...
*Vedi anche: [Beatmaps](/wiki/Beatmaps) e [Beatmapsets](/wiki/Beatmapset)*
