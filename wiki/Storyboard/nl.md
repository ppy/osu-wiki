...
Storyboards worden opgeslagen in beatmap-bestandsmappen als ofwel losstaande [`.osb`-bestanden](/wiki/Client/File_formats/Osb_(file_format)) of extenesies op de `[Events]`-sectie van een [`.osu`-bestand](/wiki/Client/File_formats/Osu_(file_format)). Hierdoor is het mogelijk om verschillende storyboards te maken voor verschillende moeilijkheidsgraden binnen een [beatmap](/wiki/Beatmap).
