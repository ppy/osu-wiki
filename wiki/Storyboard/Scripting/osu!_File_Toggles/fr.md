...
Permet aux storyboards de faire référence aux sprites du skin actuel du joueur par leur nom de fichier. Ceci est inutile si vous forcez déjà un skin (incluez simplement les fichiers nécessaires) ou si vous utilisez un skin spécifique à la beatmap. [Source](https://osu.ppy.sh/community/forums/topics/1869?start=141760)
