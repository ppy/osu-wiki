...
::: alert-warning
**Warning**
Avoid editing storyboard scripts of a [beatmap](/wiki/Beatmap) currently open in the [beatmap editor](/wiki/Client/Beatmap_editor). Your work may be overwritten when saving the beatmap.
:::
...
Various tools have been made by the community to abstract and build upon storyboard scripting, such as ::{ flag=FR }:: ::Damnae::{ user=989377 }'s [storybrew](https://github.com/Damnae/storybrew "GitHub repository").
