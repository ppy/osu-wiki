...
Various tools have been made by the community to abstract and build upon storyboard scripting, such as ::{ flag=FR }:: ::Damnae::{ user-id=989377 }'s [storybrew](https://github.com/Damnae/storybrew "GitHub repository").
