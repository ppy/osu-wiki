...
В сообществе osu! есть собственные инструменты, скрывающие низкоуровневый код сторибордов и позволяющие перейти к более абстрактным конструкциям — например, [storybrew](https://github.com/Damnae/storybrew) от ::{ flag=FR }:: ::Damnae::{ user-id=989377 }.
