...
- Le jeu passe à [l'écran des résultats](/wiki/Client/Interface#results-screen) dès que le dernier événement se produit, ou que l'utilisateur clique sur le bouton `Skip` ou appuie sur `Space`.
