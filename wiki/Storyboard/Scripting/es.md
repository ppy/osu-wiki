...
La comunidad ha creado varias herramientas para abstraer y desarrollar secuencias de comandos de los storyboards, como la herramienta [storybrew](https://github.com/Damnae/storybrew "«repositorio de GitHub»"), hecha por ::{ flag=FR }:: ::Damnae::{ user=989377 }.
