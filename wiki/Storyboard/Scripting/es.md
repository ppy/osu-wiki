# Secuencias de comandos de storyboards
...
La comunidad ha creado varias herramientas para abstraer y desarrollar secuencias de comandos de storyboards, como la herramienta [storybrew](https://github.com/Damnae/storybrew "«repositorio de GitHub»"), hecha por ::{ flag=FR }:: [Damnae](https://osu.ppy.sh/users/989377).
