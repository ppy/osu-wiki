...
::: alert-warning
**Warnung**
Vermeide die Bearbeitung von Storyboard-Skripten einer [Beatmap](/wiki/Beatmap), die aktuell im [Beatmap-Editor](/wiki/Client/Beatmap_editor) geöffnet ist. Deine Arbeit könnte beim Speichern der Beatmap überschrieben werden.
:::
...
Diverse Tools wurden von der Community erstellt, um Storyboard-Scripting zu abstrahieren und zu erweitern, wie zum Beispiel [storybrew](https://github.com/Damnae/storybrew "GitHub-Repository") von ::{ flag=FR }:: ::Damnae::{ user=989377 }.
