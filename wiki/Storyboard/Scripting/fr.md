...
Divers outils ont été créés par la communauté pour abstraire et développer le scripting des storyboards, comme [storybrew](https://github.com/Damnae/storybrew "GitHub repository") par ::{ flag=FR }:: ::Damnae::{ user=989377 }.
