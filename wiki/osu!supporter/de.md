...
Übergeleitet von diesem Link: <http://osu.ppy.sh/p/support>
...
-   [Chat Console](DE:Chat_Console "wikilink"): <span style="color:#FFC700">Hellgelber</span> Name im Chat (die anderen sehen dich in dieser Farbe, du siehst dich nach wie vor in weiß).
-   [Beatmap listing](http://osu.ppy.sh/p/beatmaplist) (?): Unterscheidet Beatmap Suchergebnisse zwischen "Gespielt" und "Ungespielt".
...
-   [Feature Requests](http://osu.ppy.sh/forum/4): Zusätzliche Votes für das Feature Requests Forum (Zwei Stück pro Monat).
...
-   [Performance Ranking](http://osu.ppy.sh/p/pp): Die Option "filter to friends" ist verfügbar.
