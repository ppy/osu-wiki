...
![Badge du osu!supporter](/wiki/shared/osu!supporter.png "Badge du osu!supporter")

osu! est un jeu ne se basant que sur les dons de ses joueurs. Le badge de "**osu!supporter**" est ainsi distribué aux joueurs ayant participé à son financement et ce pour une période déterminée par le montant donné.
...
- Les éléments graphiques suivants des [skins](/wiki/Skinning) deviennent modifiables :
...
![Un exemple](./img/sup_decide.jpg "Un exemple")

[Utilisez ce convertisseur d'unités](http://www.oanda.com/currency/converter/) ou [demandez à Google](https://www.google.com.my/#q=10$+en+euros) pour connaître le prix dans votre monnaie. Ce dernier est exprimé en dollars US ($USD) par défaut.
