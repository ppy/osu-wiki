...
Vous ne pouvez acheter ou offrir osu!supporter qu'à un utilisateur à la fois sur cet écran. Pour offrir à un autre utilisateur, vous devrez revenir à [la page du magasin osu!supporter](https://osu.ppy.sh/store/products/supporter-tag) et répétez les étapes pour ajouter un autre utilisateur.

### Vérification

Une fois que vous avez terminé, cliquez sur `Ajouter au panier` pour le mettre dans le panier osu!store.

![panier osu!store](img/shopping-cart.jpg "panier osu!store avec osu!supporter pour flyte")
...
![Page utilisateur avec osu!supporter](img/userpage.jpg "Page utilisateur avec osu!supporter")

![Carte utilisateur avec osu!supporter](img/usercard.png "Page utilisateur avec osu!supporter")
...
*Remarque: cette section apparaît uniquement après avoir obtenu l'osu!supporter.*
