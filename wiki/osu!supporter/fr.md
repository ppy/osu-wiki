...
![Badge du osu!supporter](img/store-product.jpg "Badge du osu!supporter")
...
- Possibilité d'afficher uniquement les beatmaps déjà jouées dans la [liste des beatmaps](https://osu.ppy.sh/beatmapsets)
...
- Accès à des [classements](https://osu.ppy.sh/rankings/osu/performance) avancés :
  - Des amis
  - National
...
La souscription au statut de supporter se fait [sur cette page](https://osu.ppy.sh/home/support).
