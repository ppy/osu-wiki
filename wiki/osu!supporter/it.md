...
| :-- | :-: | :-: |
| [Beatmap in attesa](/wiki/Beatmap/Category#work-in-progress-and-pending) | `4 + min(beatmap classificate, 4)`, fino ad **8**[^pending-beatmaps-ref] | `8 + min(beatmap classificate, 12)`, fino a **20**[^pending-beatmaps-ref] |
