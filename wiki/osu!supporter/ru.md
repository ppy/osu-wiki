...
outdated: true
---
![Значок саппорта](Supporter tag.png "Значок саппорта")

Введение
========

Посмотрите эту ссылку: <https://osu.ppy.sh/p/support>
...
-   Голоса для [раздела предложений](https://osu.ppy.sh/forum/4) (по 2 за каждый купленный месяц саппорта, весят в 2 раза больше голоса обычного пользователя).
...
-   Включение фильтра по друзьям в [мировом рейтинге](https://osu.ppy.sh/p/pp).
...
Чтобы проверить, когда саппорт закончится, [откройте страницу покупки](https://osu.ppy.sh/p/support).
