...
[![Рекламное изображение osu!supporter](img/supporter-eyecatch.jpg)](https://osu.ppy.sh/home/support)
...
Похожим образом можно поменять и основной цвет профиля:

- Откройте свой профиль и нажмите на значок карандаша в нижнем правом углу обложки;
- Цвет профиля влияет на оттенки большинства элементов: баннера, кнопок, ссылок и текста.

Когда саппортер закончится, выбранный цвет сохранится, но его нельзя будет заменить — только сбросить на стандартный.

### Однократная бесплатная смена ника

::: alert-notice
**Внимание**
Если вы хотите незначительно изменить ник, то техподдержку можно бесплатно попросить и без покупки саппорта — см. [Справочный центр/Аккаунт § Можно ли поменять ник?](/wiki/Help_centre/Account#name-changes)
:::
...
| Размер команды | 8 | `8 + 4 * число саппортеров в команде`, максимум **256** |
...
::: Infobox
![](img/profile-gift-supporter.png "Меню в профиле, через которое можно подарить саппортер")
:::

Саппортер можно не только купить себе, но и подарить другому игроку: для этого нужно ввести ник игрока в поле под карточкой, расположенной на странице покупки, либо в меню в чужом профиле выбрать `Подарить тег osu!supporter`. Чтобы сделать несколько подарков разным людям, повторите этот процесс несколько раз.

Получатель не видит, кто ему отправил саппортер, но в ходе оформления заказа можно написать небольшое сообщение, которое попадёт в письмо-оповещение о подарке.
...
Факт отправки саппортера можно скрыть, если при оформлении заказа отметить пункт `Скрыть все сообщения о тегах osu!supporter из секции активности в моём профиле после покупки`. Это может пригодиться для анонимных подарков, чтобы получатель не мог вычислить предполагаемого отправителя на основании активности.

Кроме того, и отправителю, и получателю саппортера придёт электронное письмо с уведомлением.

## Примечания

[^pending-beatmaps-ref]: [Пост от peppy в теме «Increase the number of pending beatmap slots», 14.09.2021](https://osu.ppy.sh/community/forums/posts/8294132)
