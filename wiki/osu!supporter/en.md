...
- `{username} has supported osu! - thanks for your generosity!` if it is the first time the user gets osu!supporter or makes a gift.
- `{username} has once again chosen to support osu! - thanks for your generosity!` if the user has been an osu!supporter or has made a gift before.
