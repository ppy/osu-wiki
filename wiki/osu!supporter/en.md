...
Note: Price shown are by per individual account. There are no promotions for group gifting.
...
It is recommended to use [PayPal](https://www.paypal.com "PayPal") or `Credit Card` services. There are other ways to pay (such as `SMS` or local service providers such as [Cherry Credits](https://www.cherrycredits.com/ "Cherry Credits")) but additional fees may apply.
