...
L'extension **.osz** est une archive globale, elle contient **un** beatmap set. Lors d'un téléchargement, cette extension contient plusieurs fichiers différents.
