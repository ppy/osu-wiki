...
| ULEB128 | Variable | A variable length integer. See [ULEB128](https://en.wikipedia.org/wiki/ULEB128). |
...
| Long | Time stamp ([Windows ticks](https://docs.microsoft.com/en-us/dotnet/api/system.datetime.ticks)) |
