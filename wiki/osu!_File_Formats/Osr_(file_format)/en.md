...
| Long | Time stamp ([Windows ticks](https://docs.microsoft.com/en-us/dotnet/api/system.datetime.ticks "Microsoft")) |
...
The remaining data contains information about mouse movement and key presses in an [LZMA](https://en.wikipedia.org/wiki/Lempel–Ziv–Markov_chain_algorithm "Wikipedia") stream.
...
As seen on the [osu! API](https://github.com/peppy/osu-api/wiki#mods "GitHub").
