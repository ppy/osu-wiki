...
For host-side, the host can enable Free Mods to allow players to use any mods except Speed ([DT][Double Time wikilink]/[NC][Nightcore wikilink],[HT][Half Time wikilink]) mods.
...
If [SD][Sudden Death wikilink]/[PF][Perfect wikilink] was used, revival from failed state is impossible.
