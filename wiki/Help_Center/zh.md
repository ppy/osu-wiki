...
如果这种方法没有成功 (或者您没法登录您的注册邮箱), 请发邮件给 [support team](mailto:accounts@ppy.sh)， 并向我们提供尽可能多的可以证明您是账号拥有者的信息。
...
如果您是这种情况，这个被封的账号不是您所创建的第一个账号，您仍可以正常地登录您的第一个注册账号。一般来说，被禁用的账号都是大部分时间不活跃的账号。
...
这并不意味你可以创建一个新的账号来达到这一目的！在社区中，多个账号（开小号）行为是不受认可的，我们将会禁用(disable)掉这种引起注意的账号。
...
如果一个玩家6个月没有登录游戏，他们的用户名被回收，其他玩家可以在 [osu! 商店]中支付并使用这些用户名。

对于所有游戏模式，每500次打图，将会增加1年（365天）的回收周期。这样是为了防止有人占取活跃玩家或只是近期不活跃玩家的用户名。
...
**这是你多次登录失败后的保护措施，请10-20分钟后再尝试登录。**

如果你遇到了这种情况，只需等待一段时间再登录。

登录限制会在最多几个小时后解除，你可以再次登录。
