...
<font size="5">คำเตือน: ไม่ว่าจะเกิดอะไรขึ้น ห้ามสร้างบัญชีเพิ่มอีก เพราะถ้าทำจริง <span style="color:#FF0000">**บัญชีที่สร้างและบัญชีของคุณจะถูกระงับทันที**</span>
...
**<font size="5"><span style="color:#000000">ถ้าใช่ ก็<span style="color:#FF0000">สมน้ำหน้า</span>ครับ แค่นั้นแหละ ไม่ต้องยื่นอุทรณ์ คราวนี้จะไปไหนก็ไป</span></font>**
...
คุณจะถูกแบนเป็นระยะเวลา<font size="4">อย่างน้อย</font>หก (6) เดือนนับตั้งแต่เวลาที่คุณถูกแบน

หลักจากพ้นกำหนดแล้ว เราจะรับคำอุทรณ์เพียง<font size="4">คำอุทรณ์เดียว</font>เท่านั้น คำอุทรณ์นี้ต้องรวมถึงความคิดที่มีเหตุผลพอที่ว่า "ทำไมเราควรให้โอกาสคุณอีกครั้งในชุมชน osu! และเราจะมั่นใจได้อย่างไรว่าคุณจะไม่ละเมิดกฎอีกต่อไปในอนาคต" ทั้งหมดนี้เป็นภาษาอังกฤษ ส่งไปที่ account@ppy.sh
...
ฉันยังไม่ได้รับ Supporter Tag ทั้งๆ ที่จ่ายเงินไปแล้วด้วย
---------------------------------------------------------
...
User page โดนล็อคและก็แก้ไขไม่ได้ด้วย ทำไมอะ
--------------------------------------------
...
อะไรคือ "user page" ที่ฉันเห็นบนโปรไฟล์ของผู้เล่นคนอื่น
-------------------------------------------------------

User page เป็นหนึ่งในอภิสิทธิ์จำนวนมากของ osu!supporter are given the privilege of editing their very own page for display on their profile for the world to see. User pages may contain anything you like - so long as it follows the community rules!
...
ฉันต้องใช้อีเมล์ในการลงทะเบียนหรือไม่
-------------------------------------
...
ฉันหาชื่อศิลปินที่มีความยาวน้อยกว่า 3 ตัวอักษรไม่ได้
----------------------------------------------------
...
ข้อมูลสถิติหน้าโปรไฟล์เพี้ยนหมดเลย ช่วยด้วย
-------------------------------------------
...
เกิดอาการกระตุกระหว่างเล่น
--------------------------

การกระตุกสามารถเกิดขึ้นได้จากหลายกรณี ต่อไปนี้จะเป็นสาเหตุที่เกมกระตุกที่พบบ่อย

-   **โปรแกรมที่รันอยู่พื้นหลัง โปรแกรมแอนตี้ไวรัส ฯลฯ** แนะนำว่าให้ปิดตอนที่คุณกำลังเล่นอยู่ (เข้า Task Manager &gt; Process &gt; เลือก Process &gt; End Process)
-   **"ไวรัส", สปายแวร์, โทรจัน** สามารถทำให้เกมกระตุกได้แนะนำให้สแกนโดยใช้โปรแกรมแอนตี้ไวรัสก่อนเล่น
-   **คอมพิวเตอร์ของคุณต้องการ "การพัฒนา"** คอมพิวเตอร์ที่เก่ามากๆ (10 ปีขึ้นไป) จะเป็นปัญหาใหญ่ในการเล่นเกมนี้ โดยเฉพาะพวก "Integrated GPU" ทางเดียวที่จะแก้ปัญหานี้ได้คือ "ปรับปรุงคอมพิวเตอร์ของคุณให้แรงกว่าเดิม"
-   **ไดร์เวอร์ล้าสมัย** ทำได้โดยการอัพเดทไดร์เวอร์ จบ
-   ลองเปิดโหมด OpenGL และ/หรือปรับการตั้งค่าบางอย่างลง
-   สำหรับขั้นตอนการแก้ปัญหาเกมกระตุกอย่างละเอียด ลองดูลิงก์นี้ [Game Lag: Common Causes and Solutions](https://osu.ppy.sh/wiki/Help_Center#Game_Lag:_Common_Causes_and_Solutions)
...
เกมกระตุกมาก และคอมก็ใหม่เอี่ยมซิงๆ ด้วย
----------------------------------------

ลองปรับการตั้งค่าดู (ตัวเรนเดอร์, จำกัดเฟรม, ฯลฯ) This can also happen if you have faulty audio drivers or output devices, so make sure everything is firmly plugged in and you have the latest/proper audio drivers for your soundcard.
...
ฉันใช้วินโดวส์ 64 บิต และลง osu! ไม่ได้เลย
------------------------------------------

ลง .NET Framework เวอร์ชั่น 64 บิต (ซึ่งต้องมาคู่กับตัวลงเกม)
