...
Все игроки, возвращающиеся из рестрикта на стандартных условиях апелляции, получают бан на участие в турнирах [минимум на один год](/wiki/Help_centre/Account_restrictions#reasons). Этот запрет может быть продлён по решению [службы техподдержки](/wiki/People/The_Team/Account_support_team).
...
## Что можно делать во время турнирного бана? {#activities}
