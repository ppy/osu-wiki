...
무기한 토너먼트 차단은 처음 적용하고 최소 **2년**(24개월)이 경과한 후에 항소할 수 있습니다. 무기한 토너먼트 차단에 항소하는 사용자는 이 기간동안 더 광범위한 osu! 커뮤니티 혹은 토너먼트 등에서 흠잡을 데 없는 행동 기록이 있어야 합니다. 항소에 실패한 사용자는 마지막 항소한 날짜로부터 최소 **1년**(12개월)을 기다려야 다시 이의제기가 가능합니다.
