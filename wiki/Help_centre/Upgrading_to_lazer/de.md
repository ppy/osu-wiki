...
*Für eine liste der Unterschiede in den Spielmechaniken, siehe: [Client/Updatequelle/Lazer/Unterschiede im Gameplay in osu!(lazer)](/wiki/Client/Release_stream/Lazer/Gameplay_differences_in_osu!(lazer))*
