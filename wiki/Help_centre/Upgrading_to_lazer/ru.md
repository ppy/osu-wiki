...
Ниже приведёны таблицы функций **текущей версии** lazer по сравнению со stable. Заметьте: это статья будет постоянно обновляться, так как одной из целей является разработка как всех функций, предсталенных в статье, так и тех, что хотят игроки.
