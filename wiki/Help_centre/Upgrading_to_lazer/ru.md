...
Если вы хотите проверить, как это влияет на задержку ввода, а также испытать своё восприятие, запустите тестировщик задержки (latency certifier), открыв в настройках раздел `Отладка`.
