...
Bạn có thể tải nó ở [đây](https://osu.ppy.sh/home/download). Trong tương lai gần, bạn sẽ có thể chuyển sang lazer từ bản ổn định (trong phần cài đặt `Phiên bản`) và tìm link tải về trên trang web osu!.
