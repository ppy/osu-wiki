...
### Я перешел на встроенные драйвера планшета в osu!(lazer), и область изменилась! {id=tablet-area}

В osu!(lazer) встроен [OpenTabletDriver](https://opentabletdriver.net/). Если вы ранее не использовали этот драйвер, то область планшета изменилась, поскольку он не был корректно настроен под новый драйвер.

Чтобы правильно перенести область из старого драйвера в OpenTabletDriver, прочитайте руководство по [конвертации области планшета](/wiki/Guides/Tablet_conversion).
