...
### Я перешел на встроенные драйвера планшета в osu!(lazer) и моя область изменилась! {id=tablet-area}

У osu!(lazer) есть встроенный [OpenTabletDriver](https://opentabletdriver.net/). Если вы ранее не использовали эти драйвера, тогда это происходит, потому что ваш планшет некорректно настроен в этом драйвере.

Посмотрите статью [Tablet conversion](/wiki/Guides/Tablet_conversion) для того, чтобы понять как корректно перенести вашу область из старого драйвера в настройки OpenTabletDriver.
...
Подробные инструкции есть в [справочной базе McAfee](https://download.mcafee.com/products/webhelp/5/1033/index.html#GUID-68D866FC-3978-4665-940E-9CA5CC0836E2.html).
