...
**У серверов osu! иногда бывают проблемы. Об инцидентах можно узнать на [странице состояния серверов](https://status.ppy.sh) и в твиттере [@osustatus](https://x.com/osustatus).**
