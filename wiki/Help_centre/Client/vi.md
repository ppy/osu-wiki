...
Nếu bạn dang có rất nhiều beatmap, hãy chờ ít nhất 10–15 phút trước khi đổ lỗi cho gây lag vì bản cập nhật . Trình osu! có thể đang xử lý lại các map của bạn để tính toán độ khó.
