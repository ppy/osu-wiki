...
### Tôi đã thay đổi cài đặt của mình, và bây giờ tôi không thể bắt đầu osu! hoặc bị treo game
...
### Game của bạn có đang chạy dưới chế độ tương thích với Windows không?
...
### Bạn đã thiết lập trình duyệt web mặc định chưa?
...
### Trò chơi của tôi không cập nhật đúng cách!
...
### Tôi gặp phải lỗi về "kiểu chữ" Khi tôi cố gắng mở trò chơi!
...
### Một số beatmap của tôi bị thiếu!
...
### Bạn có mới cài lại client game không?
...
### osu! có được phép trong tường lửa hoặc phần mềm anti-virus của bạn không?
...
### Các trạng thái beatmap của bạn có chính xác không?
...
### Bạn có thể tải lên điểm số tôi đã đạt với mình?
...
### Các nốt nhạc có vẻ bị lệch hoặc không đúng thời gian với nhạc!
...
### Tôi không thể đăng nhập hoặc kết nối vào game!
...
Để mở Command Prompt, nhấn và giữ phím Windows rồi nhấn phím R, sau đó gõ cmd và bấm OK. Để biết thêm thông tin, hãy xem bài viết trong cơ sở kiến thức của Windows.
...
### Tôi nhận được lỗi từ phía máy chủ khi cố gắng chơi trực tuyến!
...
### Tôi đã trở thành osu!supporter nhưng tên của tôi không có màu vàng trong game!
...
### Làm sao để osu! chạy mát hơn nếu máy tính của bạn bị quá nhiệt?
...
VSync sẽ chạy trò chơi với tốc độ làm mới (refresh rate) tương đương với màn hình chính của bạn.

Power Saving và Optimal sẽ chạy trò chơi với tần số làm mới gấp đôi và gấp 8 lần tần số làm mới của màn hình, tối đa lên tới 960Hz.

### Máy tính của tôi khởi động lại khi đang chơi osu!

Chúng tôi khuyên bạn nên sử dụng VSync trong những tình huống mà nhiệt độ máy tính là vấn đề.

Bạn cũng có thể tìm hiểu về các phần mềm cho phép bạn điều khiển tốc độ quạt CPU và GPU để giúp giảm nhiệt độ máy tính.

Nếu máy tính của bạn bị khởi động lại khi chơi osu!, điều này thường do quá nhiệt của một hoặc nhiều linh kiện trong máy tính của bạn, thường là card đồ họa hoặc CPU.

Để xác định nguyên nhân, chúng tôi khuyến khích bạn sử dụng phần mềm giám sát nhiệt độ GPU/CPU và theo dõi nhiệt độ của chúng khi chơi osu! ở chế độ nền. Một phần mềm tốt để sử dụng cho mục đích này là Speccy.

Nếu bạn nhận thấy nhiệt độ của GPU hoặc CPU vượt quá 90°C (194°F), máy tính của bạn đang hoạt động quá nóng và gần đến ngưỡng tắt máy tự động của hầu hết các hệ thống.

### Máy tính của tôi không quá nóng, nhưng trò chơi vẫn khiến máy tính của tôi khởi động lại!

Nếu máy tính của bạn không bị quá nhiệt nhưng vẫn bị khởi động lại khi chơi osu!, nguyên nhân phổ biến nhất của vấn đề này là do sự cố với card âm thanh, tiếp theo là các thiết bị ngoại vi bị lỗi.

Các trình điều khiển hoặc phần mềm của card âm thanh cũ có thể gây ra sự cố với osu!, nhưng đây không phải là vấn đề của hầu hết người dùng. Hãy thử cập nhật trình điều khiển card âm thanh hoặc driver của bo mạch chủ.

Ngoài ra, bạn cũng có thể thử tháo bớt các thiết bị ngoại vi kết nối qua USB, đặc biệt là nếu chúng có liên quan đến âm thanh. Tai nghe hoặc card âm thanh USB đôi khi có thể gây ra sự cố nếu chúng hoặc cổng USB mà chúng đang kết nối bị lỗi.
...
Giải pháp duy nhất thực sự là mua một bàn phím có thể hỗ trợ nhiều lần nhấn phím cùng lúc. Bạn có thể tìm kiếm tính năng gọi là "n-key rollover" (hoặc NKRO). Các bàn phím NKRO không gặp vấn đề ghosting trong hầu hết các trường hợp, nhưng thường sẽ khá đắt.

### Con trỏ của tôi bị loạn mỗi khi tôi cố gắng chơi osu!
...
### Tôi đang gặp hiện tượng giật lag hoặc giật hình khi chơi!
...
Bạn có mở nhiều chương trình cùng lúc khi chơi osu! không?
Một số tiến trình nền có thể cạnh tranh tài nguyên với osu! và làm cho trải nghiệm chơi rất khó chịu.

Hãy thử đóng bớt những chương trình không cần thiết khi đang chơi, hoặc đóng hết chúng đi.

### Máy tính của bạn có được bảo mật không?
