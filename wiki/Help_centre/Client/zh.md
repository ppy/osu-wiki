...
### 我修改了设置，现在 osu! 打不开或直接卡住了！ {#incorrect-settings}
...
### 我的连击数、分数和准度消失了！ {#missing-interface}
...
#### 在 Windows 防火墙中允许程序联网{#firewall-whitelist-windows}
...
### 我成为了 osu!支持者，但是游戏里我的用户名不是黄的！ {#white-username}
