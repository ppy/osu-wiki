...
**Відповіть в більшість ситуацій - так, але перевірте [статус серверів osu!](https://status.ppy.sh) або [Твітер @osustatus](https://x.com/osustatus), щоб бути впевненим, що все працює належним чином в нашому кінці.**
...
Ви завжди можете перенадіслати ваше повідомлення заради запитання про статус вашої справи, але упевніться, що ви не робите це більше, ніж один раз або двічі за тиждень. Ви також можете контактувати з нами в Twitter в [@osusupport](https://x.com/osusupport) для запитання про ваш лист.
