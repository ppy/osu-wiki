...
Деякі гравці можуть стати обмеженими ще раз після прийнятої апеляції. Це автоматичний процес і він буде знятий в періоді 24-ох годин. Не бійтесь задавати питання нам на твітер [@osusupport](https://x.com/osusupport) або надсиланням повiдомлення на нашу електронну пошту [accounts@ppy.sh](mailto:accounts@ppy.sh), якщо це трапиться з вами!
