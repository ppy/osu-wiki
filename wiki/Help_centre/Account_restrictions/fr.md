...
Si votre compte d'origine n'est pas soumis à des restrictions, vous pouvez vous y connecter et continuer à jouer normalement, mais veillez à ne pas vous connecter à vos multi-comptes à partir de ce moment-là, car cela pourrait entraîner d'autres sanctions.
...
Les personnes ayant fait appel dans les conditions standard ci-dessus sont également [bannies des tournois officiels et avec des badges en récompense](/wiki/Help_centre/Tournament_bans), à la fois en tant que compétiteur et membre de l'équipe du tournoi. La durée de cette interdiction est d'un an par infraction (si un utilisateur en est à son deuxième appel, l'interdiction dure deux ans). L'e-mail de restriction précisera la durée de cette interdiction.

**La tricherie ou le partage de compte lors d'un tournoi officiel ou avec badge en récompenses entraînera le bannissement indéfini de l'utilisateur de tout tournoi futur.** Cette interdiction peut faire l'objet d'un appel après deux ans, mais ne sera accordée que si l'utilisateur a fait des efforts significatifs pour améliorer les tournois de la communauté.
