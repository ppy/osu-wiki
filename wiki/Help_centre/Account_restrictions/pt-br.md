...
## Minha conta foi restrita! O que eu faço? {id=what}
...
## Por que eu estou restrito? {id=why}
...
## O que faço enquanto espero o cooldown antes de enviar um recurso? {id=while-on-cooldown}
...
## Meu cooldown passou. Como mando um recurso? {id=appeal}
...
## E se meu recurso for concedido? {id=appeal-granted}
...
## Meu recurso foi negado! {id=appeal-denied}
...
## Meus emails estão sendo ignorados / Acho que a conclusão do meu recurso não foi justa {id=appeal-review}
...
## Razões comuns de restrição e seus cooldowns {id=reasons}
