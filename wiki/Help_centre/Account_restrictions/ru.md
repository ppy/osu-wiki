...
В стандартные условия снятия рестрикта входит [запрет на участие](/wiki/Help_centre/Tournament_bans) в официальных турнирах и турнирах с наградой в виде значка в профиле — как в роли участника, так и в роли одного из организаторов турнира. Длительность такого ограничения составляет 1 год за нарушение (если у пользователя это уже вторая апелляция, бан длится 2 года). В письме со снятием рестрикта будет указан срок ограничения.
