...
Если у вас несколько аккаунтов, и основной из них не попал в рестрикт, им можно пользоваться и дальше. Не используйте другие аккаунты, так как это может привести к дальнейшим санкциям.

Если вы недавно подавали апелляцию, и она была одобрена, а потом вы снова получили рестрикт после игры, не переживайте. Ошибочные рестрикты, выданные автоматически, будут сняты в течение 24 часов. Если это нужно сделать быстрее, отправьте нам письмо или твит.
...
- **Вы очень часто нарушали правила или постили что-то очень плохое.** Пользователи, продолжающие получать [сайленсы](/wiki/Help_centre/Silences) за нарушение правил в чате, коментариях, при моддинге карты, на форуме и т.д, в конечном итоге попадут в рестрикт. Перед этим кто-нибудь из [модераторов](/wiki/People/Global_Moderation_Team) чаще всего выдаёт последнее предупреждение, если дело именно в количестве или серьёзности сайленсов.
...
В стандартные условия снятия рестрикта входит [запрет на участие](/wiki/Help_centre/Tournament_sanctions) в официальных турнирах и турнирах с наградой в виде значка в профиле — как в роли участника, так и в роли одного из организаторов турнира. Длительность такого ограничения составляет 1 год за нарушение (если у пользователя это уже вторая апелляция, бан длится 2 года). В письме со снятием рестрикта будет указан срок ограничения.
