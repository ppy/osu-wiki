...
- Организация или участие в турнирах и конкурсах, имеющих официальную поддержку
- Мультиплеер
- Внутриигровой чат
- Личные сообщения
...
- **Подождите 24 часа.** Иногда ограничение выдаётся автоматически. Если это произошло по ошибке, то оно будет снято в течение 24 часов, так как новые случаи ограничений проверяются ежедневно.
- **Свяжитесь со [службой поддержки по вопросам аккаунтов](/wiki/People/Account_support_team).** Если аккаунт остался ограничен после 24 часов, напишите письмо на [accounts@ppy.sh](mailto:accounts@ppy.sh) **с электронной почты, привязанной к аккаунту**, чтобы выяснить подробности. Укажите в письме свой ник, а также все возможные причины, по которым аккаунт мог быть ограничен. Чем больше подробностей вы сообщите, тем проще будет решить проблему.
- Если вы точно убеждены, что ограничение было ошибочным, свяжитесь с нами как можно скорее для пересмотра решения.

Если аккаунт был ограничен за нарушение [правил](/wiki/Rules), то перед отправкой апелляции обязательно должно пройти как минимум **три месяца** (шесть месяцев — в случае, если вы использовали читы). Этот период называется *кулдауном* (англ. *cooldown*).

Если у вас несколько аккаунтов, и основной из них не попал под ограничения, им можно пользоваться и дальше. Не используйте другие аккаунты, так как это может привести к дальнейшим санкциям.

Если вы недавно подавали апелляцию, и она была одобрена, а потом ваш аккаунт снова был ограничен после игры, не переживайте. Ошибочные ограничения, выданные автоматически, будут сняты в течение 24 часов. Если это нужно сделать быстрее, отправьте нам письмо или твит.

## Почему мой аккаунт ограничен? {id=why}

Этому может быть несколько причин.

- **Это не ваш первый аккаунт.** Мульти-аккаунтинг (англ. *multi-accounting*) запрещён правилами. Чаще всего с самого первого созданного аккаунта можно играть дальше, но все остальные аккаунты будут ограничены навсегда. При серьёзных или злостных нарушениях на основной аккаунт может быть наложен предупредительный сайленс (англ. *silence*), призывающий прекратить создание новых аккаунтов. Если поведение не изменится, основной аккаунт будет ограничен. Если только один из аккаунтов был ограничен, а другие остались, пожалуйста, не пользуйтесь ими и играйте только на первом аккаунте. Если вы потеряли доступ к первому аккаунту или не можете его активировать, свяжитесь с [accounts@ppy.sh](mailto:accounts@ppy.sh) для восстановления доступа.
- **Вашим аккаунтом кто-то пользовался.** Правила запрещают использовать один аккаунт сразу нескольким игрокам: проблемный аккаунт ограничат, а другой игрок, скорее всего, либо получит длительный сайленс, либо тоже попадёт под ограничения. Если это вышло случайно, свяжитесь с нами через [accounts@ppy.sh](mailto:accounts@ppy.sh) как можно скорее.
- **Вы использовали читы.** Использование сторонних программ, макросов или любых других форм получения нечестного преимущества влечёт за собой немедленное ограничение аккаунта.
- **Вы очень часто нарушали правила или постили что-то очень плохое.** Пользователи, продолжающие получать сайленсы за нарушение правил в чате, коментариях, при моддинге карты, на форуме и т.д, в конечном итоге будут ограничены. Перед этим кто-нибудь из [модераторов](/wiki/People/Global_Moderation_Team) чаще всего выдаёт последнее предупреждение, если дело именно в количестве или серьёзности сайленсов.
- **Иная ситуация.** Служба поддержки по вопросам аккаунтов имеет право накладывать ограничения даже в случаях, не перечисленных выше.

Если ограничение было заслуженным, перед подачей апелляции нужно подождать. Время ожидания также называется *кулдаундом*, и его длительность зависит от совершённых нарушений.
...
Напишите письмо на [accounts@ppy.sh](mailto:accounts@ppy.sh) с темой письма `Restriction Appeal: <ваш ник>`. Отправьте апелляцию с адреса электронной почты, привязанного к вашему аккаунту, и ждите ответа в течение двух недель. Если никто не ответил, не стесняйтесь спросить ещё одним письмом о статусе обращения: есть шанс, что первое письмо по какой-то причине потерялось.
...
- **Любое серьёзное нарушение влечёт за собой немедленное ограничение вашего аккаунта**. К таким нарушениям относятся и длительные сайленсы.

В стандартные условия снятия ограничения входит [запрет на участие](/wiki/Help_centre/Tournament_sanctions) в официальных турнирах и турнирах с наградой в виде значка в профиле — как в роли участника, так и в роли одного из организаторов турнира. Длительность такого ограничения составляет 1 год за нарушение (если у пользователя это уже вторая апелляция, бан длится 2 года). В письме о снятии ограничения будет указан его срок.

**Использование читов или передача аккаунта во время официального турнира или турнира с наградой в виде значка в профиле приведёт к бессрочному бану пользователя в любых будущих турнирах.** На такой бан можно подать апелляцию только через два года после выдачи — при условии, что пользователь за это время активно участвовал в развитии турнирной сцены.
