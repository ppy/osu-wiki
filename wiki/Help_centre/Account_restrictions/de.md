...
Wenn dein Account aufgrund von [Regelbruch](/wiki/Rules) eingeschränkt wurde, musst du mindestens **drei Monate** warten, bis du ein Gesuch zur Aufhebung deiner Einschränkung einlegen darfst. Diese Zeitspanne wird von uns als *Auszeit* bezeichnet, und wenn du geschummelt hast, beträgt sie stattdessen sechs Monate.
...
- **Du hast dauernd Regelverstöße begangen oder unangemessene Inhalte eingereicht.** Accounts von Nutzer, die immer wieder wegen Fehlverhaltens im Chat, in den Kommentaren, in Beatmap-Diskussionen, in den Foren, oder unter anderen Umständen [stumm geschaltet](/wiki/Help_centre/Silences) werden, werden irgendwann eingeschränkt. Das globale Moderationsteam gibt oft Nutzern, die sich wegen ihrer neulichen Stummschaltungen und Regelverstößen einer Einschränkung nähern, letzte Warnungen.
- **Andere Gründe.** Das Account-Team behält sich das Recht vor, Accounts auch aus anderen Gründen einzuschränken.

Wir bitten Spieler von zu Recht eingeschränkten Accounts einige Zeit zu warten, bevor sie ihr Gesuch einreichen. Das wird als *Auszeit* bezeichnet, und die Dauer variiert abhängig von den begangenen Verstößen.

## Was mache ich während der Auszeit vor dem Einreichen eines Gesuchs? {id=while-on-cooldown}
...
## Meine Auszeit ist vorbei. Wie reiche ich ein Gesuch ein? {id=appeal}

Du kannst durch eine E-Mail mit dem Betreff `Restriction Appeal: <Benutzername>` an [accounts@ppy.sh](mailto:accounts@ppy.sh) ein Gesuch einreichen. Stelle sicher, dass du die E-Mail von der E-Mail-Adresse aus sendest, die mit deinem Account verknüpft ist. Erwarte eine Antwort innerhalb von zwei Wochen, nachdem du das Gesuch eingereicht hast. Wenn du danach immer noch keine Antwort erhalten hast, dann sende uns bitte eine weitere E-Mail — deine erste E-Mail ist vielleicht aus irgendwelchen Gründen verloren gegangen.
...
## Was, wenn meinem Gesuch Recht gegeben wird? {id=appeal-granted}
...
## Mein Gesuch wurde abgelehnt! {id=appeal-denied}
...
Wenn du zum Beispiel wegen Schummelns eingeschränkt wirst, nach einem Gesuch zurückkehrst und dann erneut schummelst, wirst du für mindestens 12 Monate eingeschränkt (das Doppelte der sechs Monate), bevor wir irgendein Gesuch von dir prüfen. Wenn du danach zurückkehrst und noch einmal schummelst, wirst du für mindestens 24 Monate eingeschränkt.

Außerdem wird es nach dem ersten Verstoß immer schwieriger, ein Gesuch einzureichen, da wir deine früheren Taten berücksichtigen werden und prüfen müssen, ob es überhaupt die Zeit und das Risiko wert ist, dich wieder anzunehmen. Nur sehr wenige Spieler (wenn es überhaupt welche gibt) kehren nach ihrer dritten Einschränkung erfolgreich in die Community zurück.

## Meine E-Mails werden ignoriert / Ich meine nicht, dass mein Gesuch/meine Beschwerde ordnungsgemäß bearbeitet wurde {id=appeal-review}
...
- Alle vorher eingesendete Gesuche/Beschwerden, die ignoriert/verweigert wurde
...
| Exzessives Multi-Accounting | 3 Monate | Gesuchsbedingungen treffen zu, Sperrung von Turnieren für ein Jahr |
| Teilen des Accounts | 3 Monate | Gesuchsbedingungen treffen zu, Sperrung von Turnieren für ein Jahr, und teilweise Rücksetzung |
| Folgeverstöße (Multi-Accounting, Account-Sharing, Community-Verhalten) | 6 Monate | Gesuchsbedingungen treffen zu, Rücksetzung (sofern angebracht), Sperrung von Turnieren für ein Jahr pro Verstoß |
| Cheaten | 6 Monate | Gesuchsbedingungen treffen zu, Sperrung von Turnieren für ein Jahr, und vollständige Rücksetzung |
| Exzessives Fehlverhalten | Variabel | Gesuchsbedingungen treffen zu. Auszeit hängt von dem früheren Verhalten ab. |
| Cheaten/Teilen für einen Turnier | 12 Monate | Gesuchsbedingungen treffen zu, entsprechende Rücksetzung, dauerhafte Sperrung von Turnieren |
| Nachfolgende Verstöße (Cheaten) | 12 bis 24 Monate | Gesuchsbedingungen treffen zu, Rücksetzung, Sperrung von Turnieren für ein Jahr pro Verstoß |
| Verabscheuenswürdiges oder schwer missbräuchliches Fehlverhalten | Unbestimmt | Oftmals für immer und ohne Chance auf Aufhebung durch Gesuch |
