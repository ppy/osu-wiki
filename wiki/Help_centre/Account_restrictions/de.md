...
- **Du hast dauernd Regelverstöße begangen oder unangemessene Inhalte eingereicht.** Accounts von Nutzer, die immer wieder [stumm geschaltet](/wiki/Help_centre/Silences) werden wegen Fehlverhaltens im Chat, in den Kommentaren, in Beatmap-Diskussionen, in den Foren, oder unter anderen Umständen, werden irgendwann eingeschränkt. Das globale Moderationsteam gibt oft Nutzer, die sich wegen ihrer neulichen Stummschaltungen und Regelverstöße eine Einschränkung nähern, letzte Warnungen.
