...
- **Contacta a nuestro [equipo de soporte de cuentas](/wiki/People/Account_support_team).** Si tu cuenta sigue restringida después de ese tiempo, por favor, envía un correo electrónico a [accounts@ppy.sh](mailto:accounts@ppy.sh) **desde el correo electrónico enlazado a tu cuenta** para más detalles de tu restricción. Asegúrate de agregar el nombre de tu cuenta, junto con cualquier detalle que nos pueda proveer sobre razones por las que pudiste ser restringido. Entre más detalles nos cuentes, más fácil será para nosotros resolver el problema.
