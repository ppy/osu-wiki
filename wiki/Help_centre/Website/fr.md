...
## Problèmes courants {id=common-issues}

### Je n'ai pas reçu de réponse à mon ticket d'assistance et cela fait plus de 2 semaines ! {id=support-no-reply}
...
### Puis-je empêcher complètement un autre utilisateur de me contacter ? {id=ignore-user}
...
#### Empêcher un utilisateur de vous contacter dans le jeu {id=ignore-user-in-game}
...
#### Bloquer l'envoi de messages privés dans le jeu à tous les non-amis {id=ignore-strangers-in-game}
...
#### Empêcher les nouveaux messages privés du forum de vous parvenir {id=ignore-strangers-website}
...
### Que faire si j'ai toujours des problèmes avec un utilisateur après l'avoir bloqué ? {id=ignore-did-not-help}
...
### Que sont ces pages "moi!" que je vois sur les profils des autres joueurs ? {id=userpage}
...
### Le contenu de la page moi! a disparu ! {id=userpage-removed}
...
### Dois-je utiliser mon adresse e-mail pour m'inscrire ? {id=email-purpose}
...
Si vous avez des difficultés à vous connecter via le client de jeu, veuillez vérifier les paramètres de votre pare-feu et de votre antivirus pour vous assurer que le site d'osu! n'est pas bloqué.
...
### Pourquoi les statistiques de la page de mon profil d'utilisateur sont-elles erronées ? {id=wrong-statistics}

**Vous regardez peut-être vos statistiques pour un autre mode de jeu !**

Si vous avez été inactif pendant une longue période et que vos statistiques sont affichées de manière incorrecte, il vous suffit de jouer quelques beatmaps pour les afficher à nouveau. Les utilisateurs inactifs ont leurs scores cachés pour que les classements restent frais.
