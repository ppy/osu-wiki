...
### Puis-je empêcher complètement un autre utilisateur de me contacter ? {#ignore-user}
...
#### Empêcher les nouveaux messages privés du forum de vous parvenir {#ignore-strangers-website}
...
### Que faire si j'ai toujours des problèmes avec un utilisateur après l'avoir bloqué ? {#ignore-did-not-help}
...
### Que sont ces pages "moi!" que je vois sur les profils des autres joueurs ? {#userpage}
...
### Le contenu de la page moi! a disparu ! {#userpage-removed}
...
### Pourquoi les statistiques de la page de mon profil d'utilisateur sont-elles erronées ? {#wrong-statistics}
