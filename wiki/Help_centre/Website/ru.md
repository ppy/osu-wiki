...
О статусе вашего запроса можно спросить в уже открытом тикете техподдержки (постарайтесь не писать туда чаще, чем раз или два в неделю). Кроме того, вы можете спросить в Твиттере: мы ведём аккаунт [@osusupport](https://x.com/osusupport).
