...
## Häufige Probleme {id=common-issues}

### Ich habe keine Antwort auf mein Support-Ticket erhalten und es sind schon über 2 Wochen vergangen! {id=support-no-reply}
...
### Kann ich einen anderen Nutzer komplett daran hindern, mich zu kontaktieren? {id=ignore-user}
...
#### Einen Nutzer daran hindern, dich im Spiel zu kontaktieren {id=ignore-user-in-game}
...
#### Blockieren des Versendens privater Nachrichten im Spiel für alle Nicht-Freunde {id=ignore-strangers-in-game}
...
#### Verhindern, dass dich neue private Nachrichten aus dem Forum erreichen {id=ignore-strangers-website}
...
### Was ist, wenn ich nach dem Blockieren eines Nutzers immer noch Probleme mit ihm habe? {id=ignore-did-not-help}
...
### Was sind diese "ich!"-Seiten, die ich auf anderen Spielerprofilen sehe? {id=userpage}
...
### Die Inhalte meiner ich!-Seite fehlen! {id=userpage-removed}
...
### Muss ich meine E-Mail-Adresse für die Registrierung verwenden? {id=email-purpose}
...
### Warum sind die Statistiken in meinem Nutzerprofil falsch? {id=wrong-statistics}
