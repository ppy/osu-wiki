...
Все що відносситься до твого аккаунту. Знайти рішення до твоєї проблеми можна нижче.
...
Якщо пройшло більше чим 24 години і у вас немає supporter'а напишіть будь ласка на [support@ppy.sh](mailto:support@ppy.sh) і розкажіть про свою проблему.
...
### Що таке Бан?{#what-is-restriction}
...
Якщо ми впевнені що ви грали не чесно або або зробили щось не так, ми попросимо вас почекати **три місяці** перед тим як ми приймемо ваше оскарження бану, і розблокуємо вас.
...
Є декілька речей які могли б зробити що вийти з цієї ситуації:
...
**Відключіть їх перед тим як під'єднуватись, це скоріш за все вирішить ваші проблеми.**
...
### Я не отримую ніяких писем від osu!/Я забув адрес своєї електронної пошти! {#email-issues}
...
=======
Після зміни імені ви можете змінювати ім'я купивши [username change](https://osu.ppy.sh/store/products/32) в магазині.Проте, кожна зміна імені буде рости в ціні: друга зміна буде коштувати $8 USD, третя $16 USD, і так далі до $100 USD. Ме стараємося не давати людям змінювати їхні ніки необдумано.
...
Якщо ж вам треба тільки виправити помилку, ви можете написати на [accounts@ppy.sh](mailto:accounts@ppy.sh) і попросити бесплатно виправити помилку. Але **зверніть до уваги** що ми можемо зробити це лише пару раз, тому обдумуйте своє рішення!
...
### Чи можна видалити мою історію нікнеймів? {#hide-username-history}
 
**Тільки за деяких умов.**
 
На вашому профілю будуть показані всі ваші колишні імена, але ми можемо видалити ті які створюють вам проблеми. Якщо ваші минулі імена погрожують вашій безпеці (наприклад ті які містять ваше реальне ім'я) або розкривають якісь персональні дані, напишіть на [accounts@ppy.sh](mailto:accounts@ppy.sh).
...
В osu!, ми проти того щоб гравці мали багато аккаунтів, і через це ми ввели строге правило - один аккаунт на одну людину. Якщо ви маєте хоч одну гру на аккаунті він ваш назавжди.
...
Якщо ви граєте в публічних місцях, удостовіртесь що ваш аккаунт в безпеці. Публічні комп'ютери є основною цілью вірусних програм.
