...
在我们有绝对证据证明你有违反规定或不当行为的情况下，我们会要求你从你上次违规起等待 **3 个月**，之后才会考虑你提出的申诉，允许你回到游戏。

更多关于账号限制和申诉流程的信息，请参阅 *[账号限制](/wiki/Help_centre/Account_restrictions)*
...
关于禁赛相关的更多信息，请参见：[赛事处罚](/wiki/Help_centre/Tournament_sanctions)
...
对于获取 `network.log` 文件的说明，请参见[帮助中心 § 日志文件](/wiki/Help_centre#log-files)。
...
如果你购买（或作为礼物收到）[支持者标签](https://osu.ppy.sh/home/support)，你将会获得**一次**免费改名的机会。改名卡可以在 [osu! 商店](https://osu.ppy.sh/store/products/32) 中兑换。
...
另外，你不能占据已经拥有[上架谱面](/wiki/Beatmap/Category#ranked)或[主页奖牌](/wiki/Community/Profile_badge)的玩家的用户名。
