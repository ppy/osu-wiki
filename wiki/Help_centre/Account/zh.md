...
玩家可能会在比赛期间因违反 osu! 社区规定受到禁赛，这取决于行为的严重程度。包括但不限于试图在官方支持的比赛中以任何方式获得任何不平等的优势，对参与比赛的任何人进行辱骂或故意扰乱比赛阻碍比赛正常进行。

大多数禁赛会有一个固定的期限，少至三个月到一年不等，多至终身禁赛。无论禁赛期限的长短，所有禁赛的结果都无法被改变，不能像被限制一样进行上诉。
...
是的，任何用户可以发邮件至 [privacy@ppy.sh](mailto:privacy@ppy.sh) 请求删除帐号。请记住，删除您的帐户是**永久操作**，这意味着它无法撤消或撤消。删除你的帐号不意味着你可以创建一个新账户，拥有多个帐号违反 [规章制度](/wiki/Rules#社区规定)。这意味着你将无法再使用 osu! 的在线功能。
