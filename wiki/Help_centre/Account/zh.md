...
如果一个玩家至少 6 个月没有上线并且没有任何游玩记录，其他玩家可以在 [osu! 商店改名页](https://osu.ppy.sh/store/products/32) 购买改名次数并使用这些用户名。

如果该玩家**确实**在任何一个游戏模式中进行了游戏，我们将在 6 个月的基础上使用一个 [非线性函数](https://www.desmos.com/calculator/b89siyv9j8) 来计算这个用户名的可用时间。这样是为了防止有人抢占活跃玩家或只是近期不活跃的玩家的用户名。
...
如果你长期一直从与你个人资料所在国家或地区不同的地方登录，系统将提示你在 [帐户设置](https://osu.ppy.sh/home/account/edit) 页面中更新国家或地区。
