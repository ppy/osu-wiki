...
### После покупки саппортера ничего не происходит {#missing-supporter}
...
## Рестрикт {#restriction}

### Что такое рестрикт? {#what-is-restriction}
...
## Турнирный бан {#tournament-bans}

### Что такое турнирный бан? {#what-is-tournament-ban}
...
## Доступ к аккаунту {#sign-in}

### Не удаётся вспомнить логин или пароль {#lost-access}
...
### Ошибка 'Bancho authentication error' {#authentication-error}
...
#### Неправильно введённый пароль {#authentication-wrong-password}
...
#### Использование прокси или VPN {#authentication-vpn}
...
### Ошибка не проходит {#authentication-unknown-cause}
...
### Веб-сайт пишет, что я слишком часто пытаюсь зайти {#sign-in-throttling}
...
### Письма от osu! не приходят (или нет доступа к почте) {#email-issues}
...
## Смена ника {#name-changes}

### Можно ли поменять ник? {#change-username}
...
### Можно ли взять чужой ник? {#take-existing-username}
...
### Можно ли отменить смену ника? {#revert-username}
...
### Кто-то изменил мой ник {#why-username-reverted}
...
### Можно ли скрыть историю изменений ника? {#hide-username-history}
...
## Другие проблемы {#other}

### Неправильный флаг в профиле {#wrong-flag}
...
### Можно ли иметь несколько аккаунтов? {#no-multiaccounting}
...
### Можно ли сбросить всю игровую статистику? {#statistics-reset}
...
### Можно ли удалить свой аккаунт? {#account-deletion}
...
### Я не хочу играть, но и аккаунт удалять не хочу {#account-lock}
...
### Можно ли играть с чужого компьютера? {#shared-pc}
...
### Где найти все сыгранные или скачанные карты? {#all-played-beatmaps}
