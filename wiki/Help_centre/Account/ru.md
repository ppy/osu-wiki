...
### Могу ли я сменить страну/флаг в профиле? {id=wrong-flag}

**Да, при определённых обстоятельствах.**

Если вы, в течение длительного периода, постоянно подключались из страны, отличающейся от указанной в вашем аккаунте, вам будет предложено изменить страну вашего профиля на [странице настроек профиля](https://osu.ppy.sh/home/account/edit).
