...
Turneringskarantæner bliver meget sjældent udstedt alene, men som regel får næsten alle spillere, som kommer tilbage efter en almindelig anmodning for ophævelse af en [kontobegrænsing](/wiki/Help_centre/Account_restrictions), en turneringskarantæne, som er mindst et år langt.

Grundet de høje satser, der findes i turneringer, bliver turneringskarantæner taget meget seriøst, og bliver ikke behandlet med samme grad af mildhed som kontobegrænsninger.

### Hvad fører til, at nogen får en tidsbestemt turneringskarantæne? {id=why-temporary}

Enhver grov overtrædelse af [fællesskabsreglerne](/wiki/Rules), der finder sted i en [officielt understøttet turnering](/wiki/Tournaments/Official_support), fører sandsynligvis til en turneringskarantæne, selvom overtrædelsen normalt ville have medført en mildere straf udenfor det kompetitive miljø.
...
Alle brugere, som kommer tilbage til spillet på de almindelige betingelser efter en begrænsning, får også [en karantæne fra turneringer for en bestemt periode af mindst 1 år](/wiki/Help_centre/Account_restrictions#reasons), som kan forlænges i [kontostøtteholdets](/wiki/People/Account_support_team) skøn.

### Hvad fører til, at nogen får en tidsubestemt turneringskarantæne? {id=why-permanent}

Ethvert brug af eksterne programmer eller andre værktøjer til at snyde eller få en uretfærdig fordel i forhold til andre deltagere i en officielt støttet turnering vil medføre en tidsubestemt turneringskarantæne. I nogle situationer kan særligt grove tilfælde af misbrug udløse en sådan straf i kontostøtteholdets skøn.
...
### Hvad må jeg gøre, mens jeg er i turneringskarantæne? {id=while-banned}
...
Oplysninger om, hvorvidt du er i turneringskarantæne, kan videregives til turneringsarrangører efter anmodning, uafhængigt af, om de modtager officiel støtte eller ej.

### Hyppige grunde til og varigheder af turneringskarantæner {id=reasons}

| Grunden til turneringskarantænen | Varighed | Bemærkninger |
| :-- | :-- | :-- |
| Overtrædelse af fællesskabsreglerne i en turnering | 1 måned eller mere | Kan være længere i kontostøtteholdets skøn |
| Respektløshed overfor medhjælpere eller spild af tid | 1 måned eller mere |  |
| Medvirken til en anden spillers multiaccounting eller snyd i en turnering | 6 måneder eller mere |  |
| Uacceptabelt opførsel fra en spiller i en officielt støttet turnering | 1-2 år |  |
| Tilbagevenden på almindelige betingelser | 1-2 år | Kan være længere i kontostøtteholdets skøn |
| Multiaccounting eller kontodeling i en officielt støttet turnering | Ubestemt | Vil også medføre en begrænsning |
| Brug af eksterne værktøjer eller andet snyd i en officielt støttet turnering | Ubestemt | Vil også medføre en begrænsning |
...
En medhjælperkarantæne (*staffing ban* på engelsk) forhindrer en bruger i at hjælpe til i officielt støttede turneringer, med undtagelse af at streame, kommentere, og designe grafik.

## Kan jeg klage over en turneringssanktion? {id=appeal}

Der kan klages over turneringssanktioner, som har blevet pålagt en bruger på andre måder end de [almindelige anmodningsbetingelser](/wiki/Help_centre/Account_restrictions#appeal-granted), indenfor en 72-timers frist, før sanktionen træder i kraft. Efter denne frist udløber, er det ikke muligt at klage over turneringssanktioner, med undtagelse af tidsubestemte turneringskarantæner.

Brugere kan anmode om ophævelse af en tidsubestemt turneringskarantæne, hvis der er gået mindst **to år** (24 måneder), siden det trådte i kraft. Brugere, der prøver at få en tidsubestemt turneringskarantæne ophævet, forventes at have involveret sig positivt i det bredere osu!-fællesskab, i turneringer eller andetsteds, og at have udvist intet problematisk adfærd i denne periode. Hvis en anmodning nægtes, skal brugeren vente mindst **et år** (12 måneder) efter datoen for deres sidste anmodning, før de anmoder igen.

Selvom det er muligt at anmode om ophævelse af tidsubestemte turneringskarantæner som beskrevet, skal det understreges, at der forventes betydelige anstrengelser i fællesskabet udenfor at skrive en anmodning for at have nogen realistisk chance for succes. En liste af alle brugere, der har fået deres tidsubestemte turneringskarantæner ophævet efter anmodning, kan findes [på dette forumemne](https://osu.ppy.sh/community/forums/topics/1798871).
