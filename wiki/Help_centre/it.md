...
Hai problemi con qualcosa? Siamo qui per aiutarti! Guarda le soluzioni ai problemi comuni nella barra sul lato sinistro del tuo schermo. Se il tuo problema non è nella lista, o se hai ancora problemi, manda una mail a [support@ppy.sh](mailto:support@ppy.sh). Oppure, puoi chiedere aiuto al [Forum di Supporto](https://osu.ppy.sh/community/forums/5), dove qualcuno saprà aiutarti.
...
5. Nella finestra appena aperta, assicurati che il box `Errore` sia selezionato e clicca `OK`.
...
**Il Frame Time Graph è una funzione di osu! che può aiutare a ottenere più informazioni sui problemi di performance che potresti riscontrare.**
