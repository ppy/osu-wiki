...
Что-то сломалось? Возможно, вы найдёте подходящее решение на одной из перечисленных ниже страниц. Если ответ не удалось найти, или вам ничего не помогло, напишите письмо на английском языке на [support@ppy.sh](mailto:support@ppy.sh). Помимо этого, можно оставить сообщение на форуме, чтобы кто-нибудь мог помочь:
...
**Логи — это текстовые файлы, с помощью которых мониторится и записывается работа клиента osu!. Они понадобятся техподдержке для понимания того, чем именно вызвана ваша проблема.**
