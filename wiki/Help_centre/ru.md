...
Что-то сломалось? Возможно, вы найдёте подходящее решение на одной из перечисленных ниже страниц. Если ответ не удалось найти, или ничего не помогло, напишите письмо на английском языке на [support@ppy.sh](mailto:support@ppy.sh). Помимо этого, можно оставить сообщение на форуме, чтобы кто-нибудь помог:
...
| Раздел | Содержание |
| :-- | :-- |
| [Аккаунт](/wiki/Help_centre/Account) | osu!supporter, бан аккаунта, вход в игру, смена ника, игровой профиль |
...
## Как помочь техподдержке

### Сбор логов

**Логи — это файлы, в которых достаточно подробно описана работа клиента osu!. Они понадобятся техподдержке для понимания того, чем именно вызвана ваша проблема.**
...
**Event Viewer (рус. *Просмотр событий*) — встроенный компонент Windows, где можно увидеть причину вылета osu! в ситуации, когда в логах ничего нет. Эта информация, в свою очередь, может помочь в решении вашей проблемы.**
...
**Frame Time Graph — это встроенный инструмент osu!, наглядно показывающий производительность клиента игры.**
