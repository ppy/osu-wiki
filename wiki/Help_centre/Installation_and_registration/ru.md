...
**Просто нажмите `Установить сейчас`, находится в центре от [официальный osu! домашняя страница сайта](https://osu.ppy.sh/home). Так-же вы можете найти ссылку через `дом` раскрывающийся раздел, расположенный на панели навигации, на любой странице.**
