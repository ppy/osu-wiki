...
**Просто нажмите `Установить сейчас`, находится в центре от [оффициальный osu! домашняя страница сайта](https://osu.ppy.sh/home). Так-же вы можете найти ссылку через `дом` раскрывающийся раздел, расположенный на панели навигации, на любой странице.**
...
**Установи osu! через [здесь](https://osu.ppy.sh/home/download), после запусти его. Игра предложит вам раздел, в котором вы сможете создать учетную запись.**
