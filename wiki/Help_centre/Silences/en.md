...
Silences are publicly visible under the `Account Standing` tab of the silenced user's profile for 28 days after being applied. If the silence is currently active, its remaining duration will also be displayed in this tab. If the user has 3 or more recent infringements, or if one or more of their recent silences is 43 hours or longer, a warning about the user's account standing is displayed.
