...
## Ich möchte meine Anschrift ändern! {id=address}
...
Beim Kauf eines Produkts aus dem osu!store erhältst du eine E-Mail mit einer Sendungsverfolgung, sobald das Produkt versandt wurde.

Wenn deine Bestellung in deinem Land ankam, aber noch nicht geliefert wurde, wird sie möglicherweise bei deinem lokalen Postamt aufbewahrt. Wende dich an die Poststelle und nenne deine Sendungsnummer für weitere Details! Das ist für internationale Käufe, bei denen Zollgebühren oder andere Abgaben anfallen, manchmal erforderlich.
...
Kontaktiere [merch@ppy.sh](mailto:merch@ppy.sh) und wir versuchen, dir zu helfen.
