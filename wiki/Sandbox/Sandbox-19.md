...
T-Aiko! is a rhythm game inspired by Taiko no Tatsujin (Taiko Drum Master) with the huge library of songs from osu! which is compatible with T-Aiko!
...
-   Use your phone (must be Android) and go online (by Wi-Fi or Packet Data).
...
**<u>Device way</u>** [Alternative guide](http://osudroid.com/forum/viewtopic.php?f=17&t=30)

-   Get connected to the internet.
-   Open T-Aiko! and press "Get Maps"
    -   If the "Get Maps" is grayed out, it means you are not connected to the internet. A small guide on how to get beatmaps can also be found here.
...
-   Character (like Don and Katsu) will not appear \[due to copyright issues\].
...
-   Placement of taiko-specific background is somewhat off placement (due to screen size and cropping it is not a good idea).
...
-   If you wish to log-in (requires internet connection), you have to log-in your osu!droid/T-Aiko! account or sign up if you haven't in either one of it.
-   If you choose not to log-in, you will be treated as "Guest".
