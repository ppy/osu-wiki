...
[Osu! Tatakae! Ouendan](http://en.wikipedia.org/wiki/Osu!_Tatakae!_Ouendan) ist ein Rythmusspiel für den Nintendo DS. Die Spielmechanik besteht aus nur drei Teilen: Kreise auf dem Touchscreen treffen, einen Ball über einen festgelegten Pfad ziehen und einen Spinner schnell rotieren zu lassen. All diese Elemente sind im Takt zu populären japanischen Songs (oder ihren Covern). So sieht das auf dem Nintendo DS aus:

![](Ouendan.jpg "Ouendan.jpg")

Auf dem unteren Bildschirm befinden sich die Objekte, welche es zu treffen gilt, und auf dem oberen Bildschirm die Story. Jedes Level ist im Grunde eine eigenständige Geschichte über eine Person in Not. Da kommt das Ouendan (Cheerleaderteam) ins Spiel. Durch die magische Kraft des männlichen Cheerleading, muss man den Menschen in Not helfen.

Spielanleitung
--------------

Da die meisten PC-Spieler keinen Touchscreen zur Verfügung haben, ist es möglich dieses Spiel mit der Maus, sowie mit allen möglichen Eingabegeräten zu spielen. Unterschiedliche Spielstile sind in der [Play Styles](Play_Styles "wikilink") Seite einsehbar. Es gibt einige Lieder, welche die Maus (und dich) an die Grenze des Machbaren stoßen lassen, aber alle (Ranked und Approved) Beatmaps wurden getestet und (die meisten) sind mit einer Maus machbar.
...
Das Gameplay legt seinen Schwerpunkt auf deine/dein:-

-   Anpassbarkeit und Reaktion zu Impulsen (wenn Objekte auf dem ganzen Bildschirm in Lichtgeschwindigkeit auftauchen)
-   Fähigkeit, den Beat sowie das Design des Liedes zu erkennen.
-   Mauskontrolle (oder deine Finger/Stiftstocher-Fähigkeiten, falls du ein Tablet benutzt)
-   Timing die Objekte, die auf dem Bildschirm auftauchen, richtig zu treffen.
-   Fähigkeit, die Maus (oder deinen Finger/Stift beim Tablet) in Kreisen drehen zu lassen.
-   physische Ausdauer (besonders bei Marathonmaps).
-   exakte Mauspositionierung und Hand-Auge-Koordination.
-   Hardwaretauglichkeit (besonders mit Maus/Tablet).

Dies sind die wichtigen Fähigkeiten, die du auf deinem Weg zum osu!-Rhythm Master erlernen wirst. Bevor du jedoch ein Rhythm Master werden kannst, solltest du die Grundlagen (und Theorie) der Hitobjects lernen.

Lass uns mit dem Lernen anfangen, oder?

#### Hit-circles

<img src="Hitcircles.jpg" title="Hitcircles.jpg" alt="Hitcircles.jpg" width="400" height="300" />

-   Hier siehst du den Kreis, den auf den du klicken musst.
...
-   Sliver SS (SSH) = 100% accuracy with '[hidden](hidden "wikilink")' and/or '[flashlight](flashlight "wikilink")' mod.
-   Sliver S (SH) = Over 90% 300s, less than 1% 50s and no misses with '[hidden](hidden "wikilink")' and/or '[flashlight](flashlight "wikilink")' mod.
...
[Category: Game Modes](Category:_Game_Modes "wikilink")
