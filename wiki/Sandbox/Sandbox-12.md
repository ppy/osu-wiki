...
<img src="Intro_static.jpg" title="fig:Introduction screen" alt="Introduction screen" width="415" /> This is the screen that you will always see after starting up [osu!](osu! "wikilink")

-   clicking on the [osu!cookie](Glossary#osu!cookie "wikilink") will open the [\#Main Menu](#Main_Menu "wikilink")

:\*alternatively, pressing: \[P\], \[E\], or \[O\] (o, not *zero*) will open the [\#Main Menu](#Main_Menu "wikilink")
...
<img src="introscreen.png" title="Main menu" alt="Main menu" width="415" />

*The keyboard shortcut is in parentheses.*

-   \[1\] [osu!cookie](Glossary#osu!cookie "wikilink")

:\*will pulse according to the [BPM](Timing "wikilink") of any song currently playing

:\*if no song is playing, it pulses at a default slow rate

:\*clicking on the logo will open the [\#Play menu](#Play_menu "wikilink")

-   \[2\] Click Play (\[P\]) or the logo once more to open the [\#Play menu](#Play_menu "wikilink")
-   \[3\] Click Edit (\[E\]) to open the song selection screen for the [\#Editor](#Editor "wikilink")
-   \[4\] Click Options (\[O\]) to open the [Options](Options "wikilink") screen
-   \[5\] Click Exit (\[Esc\] or \[Alt\] + \[F4\] or clicking on the "close button") to exit osu!

:\*pressing (\[Esc\]) will prompt you, to make sure you didn't mistap \[Esc\]

-   \[6\] A random useful tip
-   \[7\] Copyright

:\*clicking on it will link you to the [Website](Website "wikilink")

-   \[8\] Connection to [Bancho](Bancho "wikilink")

:\*if icon (broken chain) appears, you're not connected with [Bancho](Bancho "wikilink") (all plays are unranked until reconnection)

-   \[9\] The [chat](Internet_Relay_Chat "wikilink") controls (\[F8\] or \[F9\]).
-   \[10\] osu!jukebox

:\*after a few seconds, the title will fade out and will require you to move or shake your mouse to make it reappear

:\*will play songs in a random order

:\*controls, most are self-explanatory

::\*shortcut to controls follows (works only at this screen):

:::\*\[Z\] (or \[&lt;-\] (left arrow)) previous song

:::\*\[X\] play (if paused, the song will continue from where it stopped; if playing, the song will play from beginning)

:::\*\[C\] pause/unpause (if playing, pause; if paused, play)

:::\*\[V\] (or \[-&gt;\] (right arrow)) next song

-   \[11\] Statistics, will contain:

:\*number of beatmaps (this number will count up the ranked, approved, pending, graveyard-ed, and unsubmitted beatmaps)

:\*run time (incriminating timer since osu! started)

:\*current time (from your computer)

-   \[12\] Your user panel

:\*click on it to display [\#User Options](#User_Options "wikilink")
...
Access this screen by clicking your user panel at the top left of the [\#Main Menu](#Main_Menu "wikilink"). You cannot access the [Chat Console](Chat_Console "wikilink") while viewing this screen.

You may press the corresponding number or click on the tab to trigger listed action.

1.  **View Profile**: Opens up your profile page in your web browser
2.  **Sign Out**: Logout your account and login window will slide out
3.  **Change Avatar**: Open up the edit avatar page in your web browser
4.  **Close** : Close the User Options window

Play menu
---------

<img src="introscreen2.png" title="fig:Play Menu" alt="Play Menu" width="415" /> Clicking the [osu!cookie](Glossary#osu!cookie "wikilink") or pressing \[P\] after opening the [\#Main Menu](#Main_Menu "wikilink") will open this menu

-   Click Solo (\[P\]) to play [\#Solo](#Solo "wikilink").
-   Click Multi (\[M\]) to play with other people. You will be directed to [\#Multiplayer](#Multiplayer "wikilink") Screen. **(Cutting-Edge will require )**
-   Click Charts to access the charts
-   Click Back (\[B\]) to return to Main Menu
...
<img src="Soloplay1.jpeg" title="fig:Song Selection (Top: Unicode; Bottom: Romanized)" alt="Song Selection (Top: Unicode; Bottom: Romanized)" width="300" /> Due to the complexity of this screen, we'll break it down into smaller chunks; starting from the Left-Right from Top-Bottom.

### Beatmap Information

<img src="Soloplay2.jpeg" title="fig:Beatmap Information (Top: Unicode; Bottom: Romanized)" alt="Beatmap Information (Top: Unicode; Bottom: Romanized)" width="400" />
In the upper-left corner, this area displays **information on the beatmap difficulty currently selected.** The beatmap selected from the osu!jukebox will be readily selected upon entering the [\#Song Selection](#Song_Selection "wikilink") screen.

-   A ![](heart.gif "fig:heart.gif") heart symbol denotes a Ranked beatmap

:\*A ![](fire.gif "fig:fire.gif") flame symbol denotes an Approved beatmap (not pictured but would go where the heart icon is located)

:\*A question mark symbol denotes a Graveyard-ed or Pending beatmap (not pictured but would go where the heart icon is located)

:\*No symbols will denote an unsubmitted difficulty

-   The Unicode title will be used if [allowed non-English metadata at Options under General section](Options#Language "wikilink") and the beatmap itself has Unicode title/artist.

:\*Format: {Source} ({Artist}) - {Title} \[{Difficulty selected}\]

-   "Length" is the duration of the beatmap (not the [Drain Time](Drain_Time "wikilink"))
-   "BPM" will list the lowest to highest bpm with the deviation between highest and lowest BPM that occurs in the beatmap (timing section changes) in parentheses.
-   "Objects" is the total number of [Hit Objects](Hit_Objects "wikilink") in the beatmap.

:\*Below lists the objects specifically

-   CS - Number value that represents the [Circle Size](Circle_Size "wikilink")
-   AR - Number value that represents the [Approach Rate](Approach_Rate "wikilink")
-   OD - Number value that represents the [Overall Difficulty](Overall_Difficulty "wikilink")
-   HP - Number value that represents the [Health Points](Health_Points "wikilink")
-   Stars - Number value that represents the [Difficulty](Difficulty "wikilink")

### Group and Sort

<img src="soloplay3.jpeg" title="fig:Grouping and Sorting Menus (Tabs underneath are shortcuts for Grouping)" alt="Grouping and Sorting Menus (Tabs underneath are shortcuts for Grouping)" width="450" /> Click on one of the tabs to group/sort your song list according to the selected criterion. Note that Sort will change based off of what Group you selected.
...
-   By Key Count - By number of keys **([Mania](Mania "wikilink") mode only)**
-   By Length - By number of minutes: five groups for "under 1-5" and two for over and under 10
-   By Mode - By one of the four **mapped** game modes
...
-   Favourites - Displays only your online favorites (single group; no header)
-   My Maps - Displays only beatmap sets you mapped (single group; no header)
...
<img src="soloplay5.jpeg" title="fig:The search bar" alt="The search bar" width="450" />
Typing anywhere in the Song Selection screen ([Chat Console](Chat_Console "wikilink") must not be active during typing or it will be considered Chat's text) and this search will be activated. Notes:
...
-   Pressing **\[Ctrl\] + \[Backspace\]** will clear the last word you typed, rather than the last character.
...
-   **hp** - HP drain rate
-   **keys** - Number of keys **([Mania](Mania "wikilink") maps only)**
-   **stars** - Star difficulty rating
-   **bpm** - Beats per minute
-   **length** - Length in seconds
-   **drain** - Drain time in seconds
-   **mode** - Mode - value can be: (use bolded letter for short)
    -   **o**su
    -   **t**aiko
    -   **c**atchthebeat
    -   **m**ania
-   **status** - Ranked status - value can be: (use bolded letter for short)
    -   **r**anked
    -   **a**pproved
    -   **p**ending
    -   **n**otsubmitted
...
-   **speed** - saved [Mania](Mania "wikilink") scroll speed - always 0 for unplayed maps or if the "[Remember osu!mania scroll speed per beatmap option](Options#Gameplay_section "wikilink")" is off
...
<img src="soloplay6.jpeg" title="fig:Beatmap Song list, with thumbnails" alt="Beatmap Song list, with thumbnails" width="450" /> The **song list displays all the beatmaps you have downloaded**, with possible narrowing down depending on your selections in this screen. The song list will use the following colours:
...
You can navigate the beatmap list using the:

-   \[1\]mouse wheel,
-   \[2\]up and down arrow keys,
-   \[3\]drag it while holding the left mouse button, or
-   \[4\]clicking the right mouse button (previously known as Absolute Scrolling) which will scroll based on your cursor placement prior to clicking.
-   Note: Shaking the mouse left and right quickly is the gesture to scroll to the selected song

Clicking on a non-white-colored box to select that beatmap and display its information on the upper left corner, high scores (if any) on the left and, if you've cleared it, the letter grade of the highest score you've achieved.

-   \[1\]Click the box again,
-   \[2\]press "\[Enter\]," or
-   \[3\]click the osu! logo at the lower right to begin playing the beatmap.

If the box have a lighter colour, it means that you have not played that beatmap difficulty yet.
...
==Match Room (Host)== <img src="Multi play! (Host).jpg" title="fig:Multi play! (Host).jpg" alt="Multi play! (Host).jpg" width="415" /> The following will list the numbered items from above (note: players will not see many of these)

1.  *You are the host!* - an indicator that your hosting the game or not
2.  Your profile card
3.  Jukebox (just a pause button)
4.  Player list
5.  Room setup
    1.  Box underneath *Game Name* is the room's name
    2.  Click *Change Password…* to change the room's password

6.  Selected beatmap (Game will automatically select one upon creation of room)
    1.  Click ''Change… to change it
        1.  While changing, the players will be notified that the host is changing the beatmap

7.  Mods
    1.  Clicking *Change…* will force everyone to use the selected mods,
        1.  unless *Free Mods* is checked

    2.  Player selected mods will be shown on the player list

8.  Team Mode and Win Condition
9.  Ready-up button, click it again to unready yourself
10. Chat
11. *Leave Match* - clicking it twice will make you leave the room
12. Host's selected mods
