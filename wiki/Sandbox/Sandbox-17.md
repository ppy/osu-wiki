...
Na dolnym ekranie mamy wspomniane wcześniej kółka, na górnym zaś przedstawiona jest historia. Generalnie każdy poziom jest historyjką o jakiejś osobie w potrzebie. W tym momencie przybywa Quendan (drużyna zagrzewająca). Dzięki mocy męskiego cheerleadowania, możesz pomóc potrzebującemu.
...
`Samouczek: `[`(dołączony` `do` `osu!)` `Oryginalny` `samouczek`](http://osu.ppy.sh/s/3756)`, `[`Rankingowa` `wersja` `samouczka`](http://osu.ppy.sh/s/19928)

Rozgrywka naciska na:

-   zdolność adaptacji i reagowania na bodźce (czyli, na obiekty do naciśnięcia, które pojawiają się z dużą prędkością);
...
To jest interfejs rozgrywki w trybie osu!standard.

-   Pasek w lewym górnym rogu to twoje "życie".
    -   Wartość tego paska będzie się stale zmniejszać \[zależnie od wartości HP ustawionej przez mappera\], ale możesz ją podnieść naciskając obiekty w odpowiednim momencie.
    -   Perfekcyjne naciśnięcie (trafienie 300 albo Geki) zwiększy twoje życie bardziej niż wciśnięty nie na czas - za wcześnie/za późno (trafienie 50).
    -   Pudło zabierze ci całkiem spory kawałek HP.
-   Po prawo od paska życia jest twój wynik.
-   Pod wynikiem znajduje się celność.
-   Kółko obok celności i pod wynikiem to pasek postępu (ukazuje długość mapy).
-   Liczba w lewym dolnym rogu to licznik combo/mnożnik wyniku.
...
Tak jak w trybie osu!standard, wyróżniamy trzy elementy rozgrywki.
...
Domyślne sterowanie dla trybu Taiko:

`Czerwone kółka: [Myszka] Lewy przycisk, [Klawiatura] [X] lub [C], [TaTaCon] Centralna powierzchnia bębna.`
`Niebieskie kółka: [Myszka] Prawy przycisk, [Klawiatura] [Z] lub [V], [TaTaCon] Zewnętrzna powierchnia bębna.`
`W trakcie gry umiejscowienie kursora nie jest ważne.`

Jeśli chcesz, możesz zmienić przypisanie klawiszy względem własnym potrzeb w opcjach.
...
<img src="Mania Key Bind.png" title="fig:[Symetryczny]Kolory klawiszy i ich położenie w zależności od ilości klawiszy (przestarzałe)" alt="[Symetryczny]Kolory klawiszy i ich położenie w zależności od ilości klawiszy (przestarzałe)" width="200" /> Są 2 typy przypisań klawiszy: Symetryczny i Lewo-Prawo.
...
Styl przypisania **Lewo-Prawo** (w stylu Beatmanii IIDX)

-   Od dołu do góry, z góry do dołu itd.: (K1)**Z**, (K2)**S**, (K3)**X**, (K4)**D**, (K5)**C**, (K6)**F**, (K7)**V**, (K8)**G** .
-   Specjalny przycisk — (S1)**lewy SHIFT** and **lewy CTRL**.

<img src="Mania KEY Layouts.jpg" title="Domyślne przypisanie klawiszy w osu!manii " alt="Domyślne przypisanie klawiszy w osu!manii " width="500" />
...
<thead>
<tr class="header">
<th align="center"><p>L. Klawiszy</p></th>
...
-   SS = 100% celności
-   S = Ponad 90% 300s, mniej niż 1% 50s oraz 0 pudeł.
-   A = Ponad 80% 300s oraz 0 pudeł **ALBO** ponad 90% 300s.
-   B = Ponad 70% 300s oraz 0 pudeł **ALBO** ponad 80% 300s.
-   C = Ponad 60% 300s.
-   D = Cokolwiek innego.
...
-   SS = 100% Accuracy.
-   S = Ponad 95% (90+% GREATów, lub mniej niż 1 GOOD na każde 10 nut).
-   A = Ponad 90% (80+% GREATów, lub mniej niż 1 GOOD na każde 5 nut)
-   B = Ponad 85% (70+% GREATów, lub mniej niż 1 GOOD na każde 3.33 nuty)
...
-   SS = 100.00% celności
-   S = Od 98.01% do 99.99% celności (Możesz mieć ocenę 'S' nawet jeżeli straciłeś kilka owoców, tak jak w osu!manii).
-   A = Od 94.01% do 98.00% celności
-   B = Od 90.01% do 94.00% celności
-   C = Od 85.01% do 90.00% celności
-   D = Jakakolwiek celność poniżej 85.00%.

### ![](mania.gif "fig:mania.gif") osu!mania

<u>**Normalne oceny**</u>

-   SS = 100% celności (tylko MAXy oraz/lub 300).
...
-   Srebrne SS (SSH) = 100% celności z modem [Hidden](PL:Hidden "wikilink") oraz/albo [Flashlight](PL:Flashlight "wikilink").
-   Silver S (SH) = Ponad 90% 300s, mniej niż 1% 50s oraz 0 pudeł z modem [Hidden](PL:Hidden "wikilink") oraz/albo [Flashlight](PL:Flashlight "wikilink").
...
### Czemu moje statystyki są inne w grze niż na stronie?

Miej na uwadze że osu! ma cztery tryby gry, więc może patrzysz na zły.

Zmień ręcznie tryb gry na ten na który chcesz.

![](Profile_Mode_Buttons.gif "Profile_Mode_Buttons.gif")

### Czemu gdy gram, ciągle pojawiają się białe linie?
...
### Czemu nie mam pełnego combo? Przecież nie mam żadnych pudeł!
...
Pytania dot. Performance Points
-------------------------------

Credit: CXu's Performance Points FAQ [1](https://osu.ppy.sh/forum/p/4587984)

### Mapa która powinna daje 100pp, dała mi tylko 30pp. Dlaczego?!
...
### Dlaczego nic nie dostaję, gdy gram beatmapy dające 100pp?
...
### Po zagraniu beatmapy, moje konto straciło 384495 miejsc! Czemu moja liczba pp tak bardzo spadła?
...
### Przed chwilą został przeze mnie ustanowiony nowy wynik na beatmapie i moja liczba pp spadła. Dlaczego wynik który daje więcej pp nie zostaje?
...
### Czemu ten modyfikator jest over-/underweighted? Bez sensu!
...
### Czemu ta beatmap jest over-/underweighted? Bez sensu!
