...
**Project Loved** (*проект «Любимые карты»*, также *«Лавд»*) — это платформа для голосования, через которую карты попадают в категорию [Loved](/wiki/Beatmaps/Category#loved). Проектом управляет [одноимённая команда](/wiki/People/The_Team/Project_Loved_Team).
...
- Она не находится в категориях [Qualified](/wiki/Beatmaps/Category#qualified), [Ranked](/wiki/Beatmaps/Category#ranked) или [Approved](/wiki/Beatmaps/Category#approved).
...
Несмотря на то, что почти все карты из категории [Pending](/wiki/Beatmaps/Category#pending) соответствуют этим критериям, из-за более строгих требований к номинации далеко не все из них попадают в категорию Loved.
