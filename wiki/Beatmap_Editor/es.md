...
El **beatmap editor** (editor de beatmap) es una interfaz gráfica en osu! que sirve para crear [beatmaps](ES:Beatmaps "wikilink"). Está separado en 4 modos:

-   [Compose](ES:Compose "wikilink") (Componer): Aquí es donde los [hit objects](ES:Hit_Objects "wikilink") son puestos y editados. La mayoría del tiempo empleado en el editor pasa aquí.
