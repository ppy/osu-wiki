...
![Расположение раздела "Настройки песни"](Song_Setup_nav.jpg "Расположение раздела "Настройки песни"")
...
![Пример заполненных данных](Song_Setup.jpg "Пример заполненных данных")
...
![Размер кругов по убыванию.](Circle_sizes.png "Размер кругов по убыванию.")
