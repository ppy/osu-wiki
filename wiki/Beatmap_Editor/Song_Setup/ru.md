...
![Расположение раздела "Настройки песни"](img/Song_Setup_nav.jpg "Расположение раздела "Настройки песни"")
...
![Пример заполненных данных](img/Song_Setup.jpg "Пример заполненных данных")
...
Здесь вы можете выбрать звучание сэмплов (*Normal*) или (*Soft*). Так же вы можете включить [пользовательский набор сэмплов](/wiki/Beatmap_Editor_Guides/Custom_Sample_Overrides)
