**Настройки песни** — это раздел в [Эдиторе](/wiki/Beatmap_Editor), содержащий много важных параметров, которые необходимо знать, чтобы сделать хорошую карту. <img src="Song Setup nav.jpg" title="fig:Расположение раздела &quot;Настройки песни&quot;" alt="Расположение раздела &quot;Настройки песни&quot;" width="350" />
