...
大部分的谱面使用 CS3、4、5。但 6 有时会用到，而 7 基本上不会被用到（大小基本上与光标大小相当）。CS7 可能通过打开[Hard Rock](/wiki/Game_modifier) mod 见到。这里有[使用 CS3, 5, 6, 7](https://osu.ppy.sh/beatmapsets/2008) 和 [使用 0, 1, 3, 4](https://osu.ppy.sh/beatmapsets/1208)的例子。
...
- [Hard Rock](/wiki/Game_modifier)：AR 增加40%，最多增加到 AR10。
- [Double Time](/wiki/Game_modifier)：AR 变快50%，与 HR 的 AR 增长不同，它是以毫秒计时增长的，最多增加到 AR11。
- [Easy](/wiki/Game_modifier)：AR 减半。
- [Half Time](/wiki/Game_modifier)：AR 降低33%，以毫秒计时，可以低于0。
...
- [Easy](/wiki/Game_modifier)：OD 折半。
- [Hard Rock](/wiki/Game_modifier)：OD 值乘1.4，最大增长到 OD10。
- [Double Time](/wiki/Game_modifier)：增长 OD 值使得判定区间缩短33%。
- [Half Time](/wiki/Game_modifier)：降低 OD 值使得判定区间增长50%。
