...
Ici vous pouvez choisir entre les sets de sons Normal, Soft (doux) ou Drum (tambours) par défaut. Vous pouvez aussi [activer des sons personalisés](/wiki/Custom_Sample_Overrides) (Ajoutez des fichiers de hitsounds dans le dossier de la map d'abord).
