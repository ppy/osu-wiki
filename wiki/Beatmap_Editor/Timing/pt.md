...
<img src="TimingSetup.png" title="fig:O painel de timelines mostrando um beatmap com BPM variável e mudanças de sampleset." alt="O painel de timelines mostrando um beatmap com BPM variável e mudanças de sampleset." width="300" /> <img src="Pt-bpm.png" title="fig:Tabela de BPM." alt="Tabela de BPM." width="300" />
