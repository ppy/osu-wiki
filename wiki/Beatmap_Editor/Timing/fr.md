...
![Screenshot of the "Timing and Control Points" window](img/TimingSetup.jpg "Le dialogue de configuration du timing montre les fluctuations du BPM de la map et les changements de jeu d'échantillons")
...
Une section de minutage régulière est affichée sous forme de ligne rouge dans l'éditeur. Chaque beatmap doit en avoir au moins une. Cependant, certains beatmaps changent de BPM pendant le morceau et nécessitent par conséquent plusieurs sections de timing régulier.
