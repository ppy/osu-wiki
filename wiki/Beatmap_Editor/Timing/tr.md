*Buna da bakın: [Şarkılar nasıl zamanlanır](/wiki/Guides/How_to_Time_Songs)*
...
Zamanlama noktaları editördeki (varsayılan kısayolu `F6`) `Zamanlama ve Kontrol Noktaları` penceresinden eklenebilir. Zamanlama noktaları, bir şarkının zamanlamasındaki değişiklikleri doğru bir şekilde yansıtabilmek için bir şarkıyı parçalara böler.

### Devralınmamış zamanlama noktası

Devralınmamış zamanlama noktası, kırmızı çizgiyle gösterilir. BPM'in, offsetin, metrenin ve zamanlama bölümünün temelidir. Her beatmap en az bir kırmızı çizgi içermelidir, ancak bazı şarkılar yapıları veya canlı kaydedilmişse olası zaman kaymalarından dolayı daha fazla kırmızı çizgiye ihtiyaç duyabilir.
