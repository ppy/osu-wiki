...
- [SB Load](SB_Load): 스토리보드가 요구하는 작업 처리 양을 나타내는 값입니다. 나타내는 값이 5배수를 넘는 경우, 오래된 PC라면 무리가 올 수 있습니다.
- [Slider](Slider): 비트맵에 기본이 되는 노트 중 슬라이더가 _osu!_ 에서 어떻게 작동되는지에 대한 기본 설명
