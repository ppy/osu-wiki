...
[Song setup](/wiki/Beatmap_Editor/Song_Setup) fills in a song's [metadata](/wiki/Beatmap_Editor/Song_Setup#song-and-map-metadata) and other things universal to a [beatmapset](/wiki/Beatmaps/Beatmapsets). This includes the title of a song, the artist, the difficulty name, combo colours, etc.
