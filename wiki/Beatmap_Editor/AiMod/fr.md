...
| :-- | :-- | :-- |
| Aucun problème n'a été trouvé sur cette carte ! | AiMod n'a trouvé aucun problème avec votre carte ! | Vous pouvez télécharger votre beatmap à l'aide de BSS pour permettre aux osu!modders de trouver d'autres erreurs et problèmes avec votre beatmap. |

#### Meta

| Message | Précisions | Solution |
| :-- | :-- | :-- |
| Le taux de HP pour Easy/Normal devrait être d'au moins 4. | Cartes osu!mania uniquement ! | Accédez aux paramètres de la chanson et définissez le taux de HP sur 4 ou plus. |
| Le taux de HP pour Hard et plus devrait être d'au moins 7. | Cartes osu!mania uniquement ! | Accédez aux paramètres de la chanson et définissez le taux de HP sur 7 ou plus. |
| Le taux de OD pour les cartes avec peu de curseurs devrait être d'au moins 7. | Cartes osu!mania uniquement ! | Accédez aux paramètres de la chanson et définissez le taux OD sur 7 ou plus. |
| La vitesse du curseur doit être de 1,40 ou 1,60. | Cartes osu!taiko uniquement ! | Accédez à l'onglet Timing et modifiez la vitesse du curseur sur 1,40 ou 1,60 |
...
| Ce combo est très long. Pensez à le diviser. | La longueur des combos peut affecter la difficulté de la carte, ainsi que la quantité de fruits qui seront empilés sur l'assiette du receveur. | Accédez aux combos incriminés et décidez par où commencer le nouveau combo. (Il est préférable que la durée des combos soit au maximum de 15 à 18) |
...
| La fin de l'objet est hors écran ! | Les objets hors écran peuvent ne pas être visibles dans les clients osu! Exécutés dans des proportions d'un ratio 4:3. | Supprimer ou déplacer l'extrémité de l'objet |
| L'objet est hors écran ! | Les objets hors écran peuvent ne pas être visibles dans les clients osu! Exécutés dans des proportions d'un ratio 4:3. | Supprimer ou déplacer l'objet |
...
| Ces deux objets existent au même moment ! | Deux objets sont superposés. Cela rendra la carte impossible à classer ! | Trouvez les deux objets touchés et déplacez-les ou supprimez-les. |
...
| Cette carte peut nécessiter un avertissement d'épilepsie, car elle contient des story-boards fréquemment basculés. | | |
| Dossier manquant : | | |
...
| Cette beatmap dure plus de 6 minutes. Envisagez de la raccourcir si ce n'est pas une carte de style marathon. | | |
...
| Un point d'aperçu pour cette carte n'est pas défini. Pensez à en définir un dans le menu Timing. | | |
...
| Plus du tiers de la carte correspond à l'heure de Kiai. Pensez à réduire cela. | | |
| Plus de la moitié de la carte de taille TV correspond à l'heure de Kiai. Pensez à réduire cela. | | |
| Kiai n'est pas cassé ! | | |
| La fin de Kiai n'est pas cassée ! | | |
| Le temps de pause n'est pas suggéré pour les cartes mania | | |
...
| Le compte à rebours n'est pas autorisé en mode mania. | Cartes osu!mania uniquement ! | Allez dans Paramètres de la chanson et désactivez le compte à rebours dans l'onglet "Design" |
| La boîte aux lettres n'est pas autorisée en mode mania. | Cartes osu!mania uniquement ! | |
| Le taux de OD devrait être d'au moins 5. | Cartes osu!mania uniquement ! | Accédez aux paramètres de la chanson et définissez le taux OD sur 5 ou plus |
| Le taux de OD pour les cartes avec très peu de curseurs devrait être d'au moins 8. | Cartes osu!mania uniquement ! | |
| Le compte à rebours n'est pas autorisé en mode taiko. | Cartes osu!taiko uniquement ! | |
| L'avertissement d'épilepsie n'est pas autorisé en mode taiko. | Cartes osu!taiko uniquement ! | |
| La boîte aux lettres n'est pas autorisée en mode taiko. | Cartes osu!taiko uniquement ! | |
...
| Ce jeu de cartes ne peut pas avoir une diff folle sans une diff dure. | | |
| La Beatmap dépasse la taille de téléchargement autorisée ({0}kb autorisé) | Le zippé en `.osz` est trop large | |
| Ce jeu de cartes n'a pas de diff : {0} | | |
| Ce jeu de cartes a besoin d'au moins 2 différences osu!catch. | Cartes osu!catch uniquement ! | |
| Ce jeu de cartes a besoin d'au moins 1 différence Easy/Normal | | |
| Ce jeu de cartes a besoin d'au moins 2 différence osu!mania . | Cartes osu!mania uniquement ! | |
| Ce jeu de cartes nécessite au moins 2 différences standard. | Cartes standard uniquement ! | |
| Ce jeu de cartes nécessite au moins 2 différences osu!taiko. | Cartes osu!taiko uniquement ! | |
