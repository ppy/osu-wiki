<img src="Kiai_Time.jpg" title="fig:ดาวที่แสดงขึ้นเป็นตัวประกอบบนจอเวลาถึงจุด kiai." alt="ดาวที่แสดงขึ้นเป็นตัวประกอบบนจอเวลาถึงจุด kiai." width="200" /> <img src="Kiai_Time_Edit_Mode.jpg" title="fig:Kiai โชว์บนมุมซ้ายบนของจอในโหมด edit." alt="Kiai โชว์บนมุมซ้ายบนของจอในโหมด edit." width="200" /> **Kiai Time** (หรือแปลไทยให้งงกว่าเดิม; **ช่วงเวลา Kiai**) คือจุดที่กำหนดไว้โดย [mapper](/wiki/Glossary) บน [beatmap](/wiki/Beatmaps) โดยเกิดจาก<s>ขั้วบวกขั้วลบ</s> เส้น [Timing Sections](/wiki/Beatmap_Editor/Timing) 2 เส้น คุณสามารถรู้ว่าถึงท่อน kiai ได้ เพราะจอจะสว่าง และคุณจะ<s>เจอตัวประกอบ</s>ดาว ที่พุ่งขึ้นมา, และตัว<s>ดูด</s>โน๊ตจะสว่างตามจังหวะเพลง และดาว<s>นาเม็ก</s>จะระเบิดจาก cursor เมื่อกดโดนตัว<s>ดูด</s>โน๊ต หรือไม่ก็<s>สอบ</s>ตกจากสไลเดอร์หรือสปินเนอร์.
