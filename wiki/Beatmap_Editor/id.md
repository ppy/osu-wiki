...
Tab [Compose](/wiki/Beatmap_Editor/Compose) merupakan bagian dari editor yang dipergunakan untuk menempatkan [hit objects](/wiki/Hit_Objects) dan elemen-elemen permainan lainnya. Pada umumnya, para mapper akan meluangkan sebagian besar waktunya pada tab ini.
