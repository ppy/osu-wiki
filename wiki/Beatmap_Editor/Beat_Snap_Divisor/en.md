...
The 1/1 snap divisor allows for hit objects to be placed on every *full beats*. It is being represented by white-coloured ticks on the editor timeline.
...
The 1/2 snap divisor allows for hit objects to be placed on every *half beats* and its multiples (e.g. 1/2). It is being represented by red-coloured ticks on the editor timeline.
...
The 1/3 snap divisor allows for hit objects to be placed on *triplets*, which is the third fraction of a beat and its multiples (e.g. 1/3 and 2/3). It is being represented by purple-coloured ticks on the editor timeline.
...
The 1/4 snap divisor allows for hit objects to be placed on every *quarter beats*, which is the fourth fraction of a beat and its multiples (e.g. 1/4 and 3/4). It is being represented by blue-coloured ticks on the editor timeline.
...
The 1/5 snap divisor allows for hit objects to be placed on the fifth fraction of a beat and its multiples (e.g. 1/5, 2/5, 3/5, and 4/5). It is being represented by yellow-coloured ticks on the editor timeline.
...
The 1/6 snap divisor allows for hit objects to be placed on *double triplets*, which is the sixth fraction of a beat and its multiples (e.g. 1/6 and 5/6). It is being represented by purple-coloured ticks on the editor timeline.
...
The 1/7 snap divisor allows for hit objects to be placed on the seventh fraction of a beat and its multiples (e.g. 1/7, 2/7, 3/7, and so on). It is being represented by yellow-coloured ticks on the editor timeline.
...
The 1/8 snap divisor allows for hit objects to be placed on the eighth fraction of a beat and its multiples (e.g. 1/8, 3/8, 5/8, and 7/8). It is being represented by yellow-coloured ticks on the editor timeline.
...
The 1/9 snap divisor allows for hit objects to be placed on the ninth fraction of a beat and its multiples (e.g. 1/9, 2/9, 3/9, and so on). It is being represented by yellow-coloured ticks on the editor timeline.
...
The 1/12 snap divisor allows for hit objects to be placed on the twelfth fraction of a beat and its multiples (e.g. 1/12, 5/12, 7/12, and so on). It is being represented by grey-coloured ticks on the editor timeline.
...
The 1/16 snap divisor allows for hit objects to be placed on the sixteenth fraction of a beat and its multiples (e.g. 1/16, 3/16, 5/16, and so on). It is being represented by  grey-coloured ticks on the editor timeline.
