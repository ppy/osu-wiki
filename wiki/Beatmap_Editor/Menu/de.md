...
_Hauptseite: [Komposition](/wiki/Beatmap_Editor/Compose)_
...
| Name                     | Beschreibung                                                                                                      |
| :----------------------- | :---------------------------------------------------------------------------------------------------------------- |
| Alle Objekte verschieben | Bewegen Sie _alle_ Objekte um #ms. Ganz nützlich, wenn Sie .mp3 Datei austauschen oder das Offset geändert haben. |
