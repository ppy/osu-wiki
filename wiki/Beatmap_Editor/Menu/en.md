...
| Name            | Description                                                                                         |
| :-------------- | :-------------------------------------------------------------------------------------------------- |
| Exit... (`Esc`) | Exit Beatmap Editor. May prompt you to save recent changes. Sometimes _ignores_ Design tab changes. |
...
| Disable Undo States | Give up the ability to _undo_ for osu! to be faster during editing (this comes in handy for long marathon maps)    |

## Compose

_Main page: [Compose](/wiki/Beatmap_Editor/Compose)_
...
_Main page: [Design](/wiki/Beatmap_Editor/Design)_

![Design menu](img/M_Design.jpg "Design menu")

| Name                         | Description                                                               |
| :--------------------------- | :------------------------------------------------------------------------ |
| Move all elements on time... | Move _everything_ by #ms value. Useful if you changed the .mp3 or offset. |

## Timing

_Main page: [Timing](/wiki/Beatmap_Editor/Timing)_
