...
A **user title** is a short label on a user's profile page set by the [osu!team](/wiki/People/The_Team). Most titles show membership of a [user group](/wiki/People/The_Team#user-groups), but some people have earned [more unique titles](/wiki/People/Users_with_unique_titles) for specific achievements or contributions.
...
On the forum sections of the [old osu! website](https://old.ppy.sh)<!-- TODO: wiki page -->, users could obtain titles by reaching post count milestones. These were shown only on the sidebars of forum posts, not the users' profiles, and were not shown if a custom title was already set.
