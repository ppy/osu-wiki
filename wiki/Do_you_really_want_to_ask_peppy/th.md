...
สวัสดีทุกคน! peppy เข้าใจว่าพวกคุณต้องการจะติดต่อเป็นการส่วนตัว แต่ เขาต้องถามคุณก่อนว่าคุณก่อนว่าคุณเข้าใจว่าที่นี้ **ไม่ใช่** ที่สำหรับที่ขอความช่วยเหลือใดๆที่เกี่ยวกับเกม peppy นั้นแยก osu! กับ ข้อความส่วนตัว และ คิดว่าการตอบแชทในฟอรัมนั้นก็ยากที่จะตอบทุกๆคน ดังนั้นเขาจึงขอว่าให้ทำอย่างใดอย่างนึงดังนี้:
