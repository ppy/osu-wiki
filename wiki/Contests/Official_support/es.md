...
Se espera que los organizadores de los concursos supervisen su concurso para detectar cualquier cosa que vaya en contra de las expectativas descritas a continuación, y son los únicos responsables de informar de tales incidentes al equipo de soporte de cuentas a través de [tournaments@ppy.sh](mailto:tournaments@ppy.sh). En caso contrario, se les podrá retirar el soporte oficial.

### Concursos

Los concursos organizados por la comunidad que reciban este soporte deberán respetar los siguientes ideales generales:
...
Además, todo el material promocional o cualquier servicio asociado a un concurso que reciba soporte oficial deberá cumplir las [reglas de la comunidad de osu!](/wiki/Rules). Esto incluye cosas como cuentas de Twitter, servidores de Discord, etc.

### Expectativas adicionales

Si bien las siguientes expectativas se aplican principalmente a los torneos, se espera que los concursos las cumplan en la medida de lo posible:

- [Personal](/wiki/Tournaments/Official_support#personal)
- [Jugadores](/wiki/Tournaments/Official_support#jugadores)
...
- **Los hilos del foro asociados al concurso DEBEN contener un enlace claramente visible y accesible al formulario de reportes del concurso.** El enlace debe colocarse al final de la publicación original.
