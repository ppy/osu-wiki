# คะแนนการประกวด (Contest points)

**คะแนนการประกวด (Contest points)** คือคะแนนที่ใช้เป็นรางวัลในการประกวดทำแมพอย่างเป็นทางการ โดยส่วนใหญ่จะใช้เพื่อพิจารณาคุณสมบัติของผู้ใช้ในการรับตำแหน่ง *Elite Mapper* ซึ่งจะมอบให้กับผู้ที่สะสมคะแนนได้ครบ **6 คะแนน** และสำหรับผู้ที่มีผลงานยอดเยี่ยมยิ่งกว่านั้น สามารถรับตำแหน่ง *Elite Mapper II* ได้เมื่อสะสมครบ 12 คะแนน!

คะแนนการประกวดอาจมอบให้เป็นส่วนหนึ่งของสิทธิประโยชน์จาก [การสนับสนุนการประกวดทำบีทแมพอย่างเป็นทางการ](/wiki/Contests/Official_support) ภายใต้ [เงื่อนไขที่กำหนด](/wiki/Contests/Official_support#คุณสมบัติเบื้องต้น-(Eligibility))

## เกณฑ์การให้คะแนน (Points key)

สำหรับการประกวดแบบเดี่ยว คะแนนการประกวดจะอิงตามจำนวนผลงานที่ถูกต้องที่ถูกส่งเข้าประกวด นี่คือแนวทางทั่วไปในการกระจายคะแนน ซึ่งอาจมีข้อยกเว้นตามดุลยพินิจของ [คณะกรรมการการประกวด (Contest Committee)](/wiki/People/Tournament_Committee#contest-committee) เมื่อมีการขอรับการสนับสนุนอย่างเป็นทางการ

| จำนวนผลงานที่ส่ง | คะแนนอันดับ 1 | คะแนนอันดับ 2 | คะแนนอันดับ 3 |
| :-- | :-- | :-- | :-- |
| 10–19 | 1 | 0 | 0 |
| 20–39 | 2 | 1 | 0 |
| 40 ขึ้นไป | 3 | 2 | 1 |

สำหรับการประกวดแบบทีม คะแนน Elite Mapper จะถูกประเมินเป็นรายกรณีไป โดยขึ้นอยู่กับขนาดของทีม, ข้อกำหนดด้านความคิดสร้างสรรค์ และจำนวนผลงานทั้งหมดที่ส่งเข้าประกวด

## การประกวดที่ผ่านมา

คะแนนการประกวดถูกนำมาใช้ในการประกวดดังต่อไปนี้:
...
*(หมายเหตุ: ชื่อที่แสดงเป็น **ตัวหนา** คือผู้ที่ได้รับตำแหน่ง Elite Mapper แล้ว)*

### osu!

| ผู้ใช้ | คะแนน | การประกวด |
| :-- | :-- | :-- |
...
| ::{ flag=TH }:: [rew0825](https://osu.ppy.sh/users/2488026) | 2 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=FI }:: [Spectator](https://osu.ppy.sh/users/702598) | 2 | [Twin Trials](/wiki/Contests/Twin_Trials_Contest) |
| ::{ flag=KR }:: [CLSW](https://osu.ppy.sh/users/531253) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=AU }:: [Dafi-](https://osu.ppy.sh/users/13143313) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=RU }:: [Nelly](https://osu.ppy.sh/users/4741164) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=CL }:: [Plasmox](https://osu.ppy.sh/users/10214313) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=TH }:: [Yio](https://osu.ppy.sh/users/13341146) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |

### osu!mania

| ผู้ใช้ | คะแนน | การประกวด |
| :-- | :-- | :-- |
| ::{ flag=US }:: [**Toaph Daddy**](https://osu.ppy.sh/users/7616811) | **6** | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=ID }:: [**Maxus**](https://osu.ppy.sh/users/4335785) | **6** | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=US }:: [Guilhermeziat](https://osu.ppy.sh/users/10371089) | 4 | [Twin Trials](/wiki/Contests/Twin_Trials_Contest) (2), [VMC2](/wiki/Contests/VMC/2) (2) |
| ::{ flag=GB }:: [Whisper-](https://osu.ppy.sh/users/13114434) | 3 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=ID }:: [Mirea](https://osu.ppy.sh/users/8404646) | 2 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=KR }:: [Oriental](https://osu.ppy.sh/users/16142512) | 2 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=CN }:: [RedBall](https://osu.ppy.sh/users/7109142) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=VN }:: [AHHHHHHHHHHHHHH](https://osu.ppy.sh/users/8249608) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=US }:: [Abraxos](https://osu.ppy.sh/users/13114434) | 1 | [Twin Trials](/wiki/Contests/Twin_Trials_Contest) |
| ::{ flag=RS }:: [MissTitannia](https://osu.ppy.sh/users/4490361) | 1 | [VMC2](/wiki/Contests/VMC/2) |
| ::{ flag=ID }:: [shikane_](https://osu.ppy.sh/users/13143313) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=US }:: [XZ-1](https://osu.ppy.sh/users/12337329) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=US }:: [zero2zero](https://osu.ppy.sh/users/12337329) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=ID }:: [Xinely](https://osu.ppy.sh/users/1521445) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=CN }:: [GZ-Sama](https://osu.ppy.sh/users/14726718) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
| ::{ flag=VN }:: [NguyenThanh](https://osu.ppy.sh/users/12464535) | 1 | [MBC](/wiki/Contests/Monthly_Beatmapping_Contest) |
