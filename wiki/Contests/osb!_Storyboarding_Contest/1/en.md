...
| User | Responsibility |
| :-- | :-- |
| ::{ flag=CA }:: ::Sidetail::{ user=2036217 } | Host, administrator |
| ::{ flag=VN }:: ::Hokichi::{ user=6607303 } | Co-host, graphic designer, judge |
| ::{ flag=GB }:: ::WildOne94::{ user=3482692 } | Staff member, judge |
| ::{ flag=AU }:: ::Coppertine::{ user=7279762 } | Staff member, judge |
| ::{ flag=DE }:: ::Darky1::{ user=3372928 } | Staff member, judge |
| ::{ flag=CA }:: ::Marblelemons::{ user=8286416 } | Staff member, judge |
| ::{ flag=BR }:: ::Dada::{ user=9119507 } | Judge |
| ::{ flag=ID }:: ::LordRaika::{ user=3265023 } | Judge |
| ::{ flag=US }:: ::Starrodkirby86::{ user=410 } | Judge |
| ::{ flag=SE }:: ::Naxess::{ user=8129817 } | Logo designer |
...
| Placing | Participant |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=CA }:: ::TheDuckMask::{ user=7405768 } |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=UA }:: ::PantyDev::{ user=5420543 } |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=CA }:: ::Gaia::{ user=2683648 } |
