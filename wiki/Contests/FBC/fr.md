...
| Place | Mappeurs |
| :-: | :-- |
| ![Couronne en or](/wiki/shared/crown-gold.png "Première place") | ::{ flag=FR }:: ::Secretpipe::{ user=2208964 } |
| ![Couronne en argent](/wiki/shared/crown-silver.png "Seconde place") | ::{ flag=FR }:: ::Kin::{ user=480689 } |
| ![Couronne en bronze](/wiki/shared/crown-bronze.png "Troisième place") | ::{ flag=FR }:: ::rezoons::{ user=1893035 } |

### Vainqueurs du mode osu!taiko

| Place | Mappeurs |
| :-: | :-- |
| ![Couronne en or](/wiki/shared/crown-gold.png "Première place") | ::{ flag=FR }:: ::Nofool::{ user=672430 } |
| ![Couronne en argent](/wiki/shared/crown-silver.png "Seconde place") | ::{ flag=FR }:: ::Aldwych::{ user=1416484 } |
| ![Couronne en bronze](/wiki/shared/crown-bronze.png "Troisième place") | ::{ flag=FR }:: ::Gezoda::{ user=481582 } |

### Vainqueurs du mode osu!mania

| Place | Mappeurs |
| :-: | :-- |
| ![Couronne en or](/wiki/shared/crown-gold.png "Première place") | ::{ flag=CA }:: ::Julie::{ user=2420987 } |
| ![Couronne en argent](/wiki/shared/crown-silver.png "Seconde place") | ::{ flag=FR }:: ::Todestrieb::{ user=4056690 } |

### Vainqueurs du mode osu!catch

| Place | Mappeurs |
| :-: | :-- |
| ![Couronne en or](/wiki/shared/crown-gold.png "Première place") | ::{ flag=FR }:: ::rezoons::{ user=1893035 } |

### Organisation

| Rôle | Membres |
| :-- | :-- |
| Organisateur | ::{ flag=FR }:: ::Kurai::{ user=77089 } |
| Juges | ::{ flag=PL }:: ::Krfawy::{ user=1478292 }, ::{ flag=IT }:: ::-kevincela-::{ user=266596 }, ::{ flag=IT }:: ::Leader::{ user=631530 }, ::{ flag=US }:: ::OzzyOzrock::{ user=465153 }, ::{ flag=MX }:: ::DakeDekaane::{ user=1425253 }, ::{ flag=GB }:: ::Mysticalia::{ user=2728676 } |
...
| Place | Mappeurs |
| :-: | :-- |
| ![Couronne en or](/wiki/shared/crown-gold.png "Première place") | ::{ flag=CA }:: ::sheela::{ user=1138027 } |
| ![Couronne en argent](/wiki/shared/crown-silver.png "Seconde place") | ::{ flag=FR }:: ::Secretpipe::{ user=2208964 } |
| ![Couronne en bronze](/wiki/shared/crown-bronze.png "Troisième place") | ::{ flag=FR }:: ::Nozhomi::{ user=2716981 } |

### Organisation

| Rôles | Membres |
| :-- | :-- |
| Organisateur | ::{ flag=FR }:: ::Ovoui::{ user=2282098 } |
| Juges | ::{ flag=FR }:: ::Kin::{ user=480689 }, ::{ flag=DE }:: ::Pho::{ user=3624692 }, ::{ flag=AU }:: ::sahuang::{ user=5318910 } |
...
| Place | Mappeurs |
| :-: | :-- |
| ![Couronne en or](/wiki/shared/crown-gold.png "Première place") | ::{ flag=FR }:: ::Sotarks::{ user=4452992 } |
| ![Couronne en argent](/wiki/shared/crown-silver.png "Seconde place") | ::{ flag=FR }:: ::BOUYAAA::{ user=405449 } |
| ![Couronne en bronze](/wiki/shared/crown-bronze.png "Troisième place") | ::{ flag=CH }:: ::Irreversible::{ user=1287964 } |

### Organisation

| Rôle | Membres |
| :-- | :-- |
| Organisateurs | ::{ flag=FR }:: ::Pachiru::{ user=2850983 }, ::{ flag=CA }:: ::Gabe::{ user=654108 } |
| Juges | ::{ flag=FR }:: ::Kin::{ user=480689 }, ::{ flag=FR }:: ::Kurai::{ user=77089 }, ::{ flag=FR }:: ::Nozhomi::{ user=2716981 }, ::{ flag=FR }:: ::Pachiru::{ user=2850983 } |
...
| :-- | :-- |
| Organisateurs | ::{ flag=FR }:: ::Pachiru::{ user=2850983 }, ::{ flag=CA }:: ::Gabe::{ user=654108 } |
| Juges | ::{ flag=US }:: ::Hobbes2::{ user=8157492 }, ::{ flag=DE }:: ::Mir::{ user=8688812 }, ::{ flag=US }:: ::ailv::{ user=6933054 }, ::{ flag=IT }:: ::MrSergio::{ user=2581696 } |
