...
| Designer | ::{ flag=MY }:: ::\[Zeth\]::{ user=9912966 } |
| Judge | ::{ flag=US }:: ::Alchyr::{ user=4993032 }, ::{ flag=AR }:: ::Axer::{ user=7299864 }, ::{ flag=US }:: ::Nifty::{ user=4956097 }, ::{ flag=MY }:: ::\[Zeth\]::{ user=9912966 } |
...
| Placing | User |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=KR }:: ::woosungko::{ user=14184157 } |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=TH }:: ::Ph0eNiiXZ::{ user=9463721 } |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=IT }:: ::D3kuu::{ user=7807444 } |
...
[^prizes-ranked]: ::{ flag=TN }:: ::Hivie::{ user=14102976 } and ::{ flag=US }:: ::Nifty::{ user=4956097 } will mod and push the winning entry to Ranked if the winner chooses to, and **if they get the necessary difficulties to form a rankable spread when needed**.
