...
| 名次 | 谱师 |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") 冠军 | ::{ flag=CN }:: ::BKwind::{ user=8900975 } |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") 亚军 | ::{ flag=CN }:: ::\_Yiiiii::{ user=6066359 } |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") 季军 | ::{ flag=CN }:: ::tyrcs::{ user=13026904 } |
| 参与奖（第4-第7） | ::{ flag=CN }:: ::Boomushroom::{ user=10588550 }, ::{ flag=CN }:: ::Seiran-::{ user=14351534 }, ::{ flag=RU }:: ::FlappiBakuse::{ user=11724295 }, ::{ flag=CN }:: ::wIntEr7z::{ user=16509588 } |
