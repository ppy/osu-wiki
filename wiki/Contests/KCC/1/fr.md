...
| Responsable | ::{ flag=KR }:: ::Oni Suika::{ user=4848023 } |
| Designer | ::{ flag=KR }:: ::POCARI SWEAT::{ user=5082685 } |
| Juges | ::{ flag=PL }:: ::\1underjoy::{ user=2235750 }, ::{ flag=KR }:: ::Garalulu::{ user=757783 }, ::{ flag=GT }:: ::Hoto Cocoa::{ user=6974536 }, ::{ flag=KR }:: ::Kawawa::{ user=4647754 }, ::{ flag=KR }:: ::Pengdoll::{ user=6392061 } |
...
| Places | Mappeur |
| :-: | :-- |
| ![Couronne en or](/wiki/shared/crown-gold.png "Première place") | ::{ flag=KR }:: ::11Bit::{ user=14804526 } |
| ![Couronne d'argent](/wiki/shared/crown-silver.png "Seconde place") | ::{ flag=KR }:: ::Sherie::{ user=9113475 } |
| ![Couronne de bronze](/wiki/shared/crown-bronze.png "Troisième place") | ::{ flag=CA }:: ::arpia97::{ user=6363008 } |
