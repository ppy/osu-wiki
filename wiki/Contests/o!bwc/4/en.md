...
| Position | Member(s) |
| :-- | :-- |
| Hosts | ::{ flag=KR }:: ::momoyo::{ user=12469536 }, ::{ flag=HK }:: ::Chaoslitz::{ user=3621552 }, ::{ flag=AR }:: ::Lince Cosmico::{ user=6070370 }, ::{ flag=CN }:: ::Mafumafu::{ user=3076909 }, ::{ flag=HK }:: ::seros::{ user=10562853 } |
| Commentators | ::{ flag=US }:: ::Noffy::{ user=1541323 }, ::{ flag=US }:: ::fieryrage::{ user=3533958 }, ::{ flag=US }:: ::Halfslashed::{ user=4598899 }, ::{ flag=US }:: ::-White::{ user=16276548 } |
| Judges (qualifier round) | ::{ flag=ZA }:: ::Mattay::{ user=9748303 }, ::{ flag=CL }:: ::Uberzolik::{ user=1314547 }, ::{ flag=RU }:: ::Mirash::{ user=2841009 }, ::{ flag=AR }:: ::Lince Cosmico::{ user=6070370 }, ::{ flag=HK }:: ::seros::{ user=10562853 } |
| Judges (clash rounds) | ::{ flag=PL }:: ::Kalibe::{ user=3376777 }, ::{ flag=KR }:: ::Luscent::{ user=2688581 }, ::{ flag=BR }:: ::Froslass::{ user=19048 }, ::{ flag=EE }:: ::iljaaz::{ user=8501291 }, ::{ flag=GB }:: ::AJT::{ user=3181083 }, ::{ flag=BY }:: ::Flins::{ user=11119539 }, ::{ flag=CN }:: ::pw384::{ user=1343783 } |
| Sponsors | ::{ flag=US }:: ::Nightcor3::{ user=19173340 }, ::{ flag=KR }:: ::Enon::{ user=2043401 }, ::{ flag=CN }:: ::FcEazy::{ user=7825227 }, ::{ flag=HK }:: ::RVMathew::{ user=3718151 }, ::{ flag=CN }:: ::Mafumafu::{ user=3076909 }, ::{ flag=HK }:: ::seros::{ user=10562853 }, ::{ flag=HK }:: ::Regou::{ user=419954 } |
| GFX | ::{ flag=CN }:: ::Ttmnzk::{ user=2495509 } |
...
|  | Team | Members |
| :-: | :-: | :-- |
| ::{ flag=AR }:: | **Argentina** | **::jaski03::{ user=28579947 }**, ::Benisuzume::{ user=12207972 }, ::Agusacco::{ user=12206089 }, ::xBerzox::{ user=5359972 }, ::Umi Sonoda::{ user=7755084 }, ::fusionnqn::{ user=11606403 } |
| ::{ flag=AR }:: | **Argentina** | **::Megafan::{ user=6632605 }**, ::MaestroSplinter::{ user=6707918 }, ::-Links::{ user=10804237 }, ::azphyx::{ user=15137544 }, ::slynna::{ user=10099005 } |
| ::{ flag=AU }:: | **Australia** | **::Iceluin::{ user=3558897 }**, ::-paper::{ user=12956073 }, ::Gibune::{ user=5778687 }, ::yours-::{ user=21345722 }, ::Whl::{ user=16158336 } |
| ::{ flag=AU }:: | **Australia** | **::tity::{ user=12318332 }**, ::Kyairie::{ user=10910405 }, ::Cubby::{ user=10914582 }, ::awawa::{ user=4166621 }, ::bobbybaseball06::{ user=4967662 }, ::xLolicore-::{ user=4525153 } |
| ::{ flag=AU }:: | **Australia** | **::Karai::{ user=17493476 }**, ::oslash::{ user=13228917 }, ::nominomu::{ user=30485380 }, ::ramuu::{ user=9447753 }, ::Malky::{ user=13906869 } |
| ::{ flag=AT }:: | **Austria** | **::hakashii::{ user=11688893 }**, ::tomadoi::{ user=5712451 }, ::whalermelon::{ user=11904298 }, ::Poggers::{ user=14142110 }, ::Maarvin::{ user=6411631 } |
| ::{ flag=BY }:: | **Belarus** | **::Eterdesp::{ user=11436348 }**, ::Satte::{ user=9390208 }, ::Time Freeze::{ user=8092686 }, ::foreyn::{ user=26215857 }, ::Route 174::{ user=7723213 } |
...
| ::{ flag=FI }:: | **Finland** | **::fllecc::{ user=14060327 }**, ::kuuti::{ user=11756000 }, ::oatmilk::{ user=16516525 }, ::-Zel::{ user=7042978 } |
| ::{ flag=FR }:: | **France** | **::Blacky Design::{ user=11540165 }**, ::Timevid::{ user=9125335 }, ::Pisapou::{ user=16640021 }, ::Yumerios::{ user=11681430 }, ::Nozuchi::{ user=5858447 }, ::Lyvai::{ user=17081761 } |
| ::{ flag=FR }:: | **France** | **::Xahlt::{ user=13466351 }**, ::Ferdeza::{ user=5880949 }, ::AsuKow::{ user=11270361 }, ::Fuxi66::{ user=24230576 } |
...
| ::{ flag=PL }:: | **Poland** | **::App::{ user=13650508 }**, ::Venix::{ user=5999631 }, ::Inae::{ user=15545596 }, ::sainoo::{ user=8715734 }, ::EnuHQ::{ user=5281072 }, ::Gresiu::{ user=3930357 } |
| ::{ flag=PL }:: | **Poland** | **::olsonn::{ user=8617799 }**, ::MrTerror::{ user=8828420 }, ::Kuki1537::{ user=6174349 }, ::PAJWOJ::{ user=4899393 }, ::wiwit::{ user=10610309 } |
| ::{ flag=PL }:: | **Poland** | **::procq::{ user=3054130 }**, ::LosPedros::{ user=8337056 }, ::Bluenation::{ user=10903500 }, ::Antares-::{ user=2194763 }, ::Skubi::{ user=3687666 }, ::trancemegamix::{ user=2246417 } |
| ::{ flag=PL }:: | **Poland** | **::subahibi::{ user=10627594 }**, ::NcFix::{ user=19229141 }, ::nhlx::{ user=3827077 }, ::-koreangod1111::{ user=18750002 }, ::John Amazon::{ user=16740086 } |
| ::{ flag=RU }:: | **Russian Federation** | **::f e e l::{ user=20044444 }**, ::deadnya::{ user=22356454 }, ::1066::{ user=13733804 }, ::Wavewy::{ user=17352850 }, ::Ziny::{ user=20098206 }, ::nemidnight::{ user=14204590 } |
| ::{ flag=RU }:: | **Russian Federation** | **::aiyoko::{ user=12357714 }**, ::fyuu::{ user=11558207 }, ::kolman::{ user=19334055 }, ::Parad0xa::{ user=12187937 }, ::yousick::{ user=13883978 } |
| ::{ flag=RU }:: | **Russian Federation** | **::aukina::{ user=15550102 }**, ::Nikilodka::{ user=13632688 }, ::zadknus::{ user=12101917 }, ::871::{ user=1038339 }, ::ADR1Ft::{ user=15698567 }, ::add222::{ user=14261013 } |
| ::{ flag=RU }:: | **Russian Federation** | **::kurumilove::{ user=10515166 }**, ::-Apache::{ user=11290347 }, ::NaoKanade::{ user=7603404 }, ::sljm::{ user=10281083 } |
...
| ::{ flag=GB }:: | **United Kingdom** | **::7VII::{ user=10880277 }**, ::DeviousPanda::{ user=4966334 }, ::Yusomi::{ user=4174940 }, ::Ishtiaq::{ user=6405262 }, ::Pseudonymous::{ user=15587166 }, ::The Cube::{ user=7535045 } |
| ::{ flag=GB }:: | **United Kingdom** | **::touka-::{ user=13406179 }**, ::enryotoki::{ user=10639122 }, ::-jordan-::{ user=7288862 }, ::demapping::{ user=30309457 }, ::synoxa::{ user=10333154 } |
| ::{ flag=US }:: | **United States** | **::-Doodle::{ user=12337329 }**, ::Carcinogenesis::{ user=11160462 }, ::nooj::{ user=8271086 }, ::Napoca::{ user=13066691 }, ::Lunicia::{ user=4369309 }, ::espol::{ user=34200480 } |
| ::{ flag=US }:: | **United States** | **::6pXgEj3hc7Umj5H::{ user=18130046 }**, ::fowwo::{ user=4547551 }, ::Pandize::{ user=5490937 }, ::phyr::{ user=13181574 }, ::Weoweet::{ user=16861790 } |
| ::{ flag=US }:: | **United States** | **::Local Hero::{ user=16134122 }**, ::captin1::{ user=689997 }, ::Aeril::{ user=4334976 }, ::wispy::{ user=11106929 }, ::jas::{ user=8920907 }, ::ajmosca::{ user=19884809 } |
...
| ::{ flag=VN }:: | **Vietnam** | **::xiaomao::{ user=9829680 }**, ::Lott::{ user=13821222 }, ::Nagabi::{ user=10352099 }, ::Zawajiro::{ user=15082028 } |
