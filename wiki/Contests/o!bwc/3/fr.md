...
|  | Pays | Nom | Membres |
| :-: | :-: | :-: | :-- |
| ::{ flag=AR }:: | **Argentine** | **MaestroSplinter** | **::MaestroSplinter::{ user=6707918 }**, ::Birke::{ user=3265658 }, ::Chaphe::{ user=8428983 }, ::fusionnqn::{ user=11606403 }, ::Lince Cosmico::{ user=6070370 }, ::Megafan::{ user=6632605 } |
| ::{ flag=AU }:: | **Australie** | **bunnings truck** | **::wetdog123::{ user=2164888 }**, ::ChigaMyMommy::{ user=12905443 }, ::Coppertine::{ user=7279762 } |
| ::{ flag=AU }:: | **Australie** | **DELIVEROO** | **::Pentori::{ user=7452237 }**, ::- Heatwave -::{ user=4166621 }, ::Cubby::{ user=10914582 }, ::elicz1::{ user=8039342 } |
...
| ::{ flag=GE }:: | **Géorgie** | **Clown Fiesta** | **::Kyuunex::{ user=9236044 }**, ::Hopp::{ user=11716440 }, ::NikaRuso::{ user=5391748 } |
| ::{ flag=DE }:: | **Allemagne** | **AtLeastWeTriedXD** | **::DragoBruder::{ user=10944421 }**, ::Big Doc Bazuso::{ user=11726139 }, ::Enterprise::{ user=11766551 } |
| ::{ flag=DE }:: | **Allemagne** | **Dönerladen** | **::0ppInOsu::{ user=12551840 }**, ::Cacturne::{ user=13646997 }, ::FuJu::{ user=10773882 }, ::Lulu-::{ user=4201715 }, ::PaRaDogi::{ user=2054596 }, ::Ykybfz::{ user=9522967 } |
...
| ::{ flag=NL }:: | **Pays-Bas** | **#modhelp enjoyer** | **::Waitrose::{ user=14918572 }**, ::CMeFly::{ user=12195391 }, ::Jelljel::{ user=11939459 }, ::yukic::{ user=6977273 } |
| ::{ flag=NL }:: | **Pays-Bas** | **drop** | **::Castagne::{ user=12270596 }**, ::Chizuru::{ user=1026491 }, ::Ermi::{ user=8468590 }, ::taku::{ user=684433 } |
| ::{ flag=NO }:: | **Norvège** | **Shigeru Miyamoto** | **::Fisky::{ user=8352623 }**, ::-PC::{ user=2916414 }, ::YokesPai::{ user=6399568 } |
...
| ::{ flag=RO }:: | **Roumanie** | **Echipa Pe Cimpoi** | **::MaddaFakka-sama::{ user=6584266 }**, ::entsetzen::{ user=10261883 }, ::Prodii::{ user=15744737 } |
| ::{ flag=RU }:: | **Fédération de Russie** | **Azamat Aytaliev** | **::3mplify::{ user=5688171 }**, ::Aphestra::{ user=11949191 }, ::Daycore::{ user=5596337 }, ::IntegerTempest::{ user=10301398 }, ::Myahkey::{ user=6684556 }, ::smozit::{ user=6983995 } |
| ::{ flag=RU }:: | **Fédération de Russie** | **baltika7 fanclub** | **::piroshki::{ user=7645522 }**, ::Caspar::{ user=6084669 }, ::FCL::{ user=4715762 }, ::GazPriest::{ user=8874115 } |
| ::{ flag=RU }:: | **Fédération de Russie** | **Djulus' Normal** | **::Shmiklak::{ user=5504231 }**, ::Cami::{ user=10286675 }, ::Djulus::{ user=4960893 }, ::kuyusu::{ user=11758667 }, ::Lokidoki::{ user=6566632 }, ::NeKroMan4ik::{ user=11387664 } |
| ::{ flag=RU }:: | **Fédération de Russie** | **Nekroloh** | **::wenet::{ user=10261029 }**, ::-Light-::{ user=6017901 }, ::2zz::{ user=8201267 }, ::Delette::{ user=7835664 } |
| ::{ flag=RU }:: | **Fédération de Russie** | **Seven Colors** | **::xbopost::{ user=6842421 }**, ::AYE1337::{ user=9131844 }, ::Frakturehawkens::{ user=7458583 }, ::h3ct1c::{ user=6885942 }, ::NeilPerry::{ user=841391 }, ::Senseabel::{ user=6184386 } |
| ::{ flag=RU }:: | **Fédération de Russie** | **Team Gambia** | **::Natteke desu::{ user=1848318 }**, ::attendant::{ user=12416885 }, ::Mirash::{ user=2841009 }, ::PandaHero::{ user=1233255 }, ::Rue::{ user=417551 }, ::tokiko::{ user=2836455 } |
| ::{ flag=SG }:: | **Singapour** | **circuit breaker** | **::Yuuki Noa::{ user=11016828 }**,  ::Mocaotic::{ user=9487458 }, ::P4ndemonium::{ user=6639059 }, ::Rtyzen::{ user=2439822 }, ::sorciere::{ user=2500099 } |
...
| ::{ flag=TW }:: | **Taïwan** | **超市無敵** | **::Hey lululu::{ user=4086497 }**, ::- AzRaeL -::{ user=10027577 }, ::arronchu1207::{ user=2226083 }, ::Flask::{ user=959763 }, ::knowledgeking::{ user=8022517 }, ::zyoi::{ user=4360287 } |
| ::{ flag=TR }:: | **Turquie** | **Sheeeeeesh Kebab** | **::mezelyus::{ user=5938859 }**, ::Cyberia950::{ user=9143539 }, ::EgzotikButters::{ user=9655150 }, ::Entry::{ user=10213311 }, ::Nymphe::{ user=10507407 }, ::Skytuna::{ user=9079936 } |
| ::{ flag=UA }:: | **Ukraine** | **NM ty** | **::Dafiely::{ user=7197186 }**, ::Esutarosa::{ user=12024753 }, ::lexa on osu::{ user=4382562 } |
| ::{ flag=GB }:: | **Royaume-Uni** | **otter** | **::Gelidium::{ user=14261540 }**, ::Blacken::{ user=10880277 }, ::enryotoki::{ user=10639122 }, ::Ishtiaq::{ user=6405262 }, ::skylaa::{ user=9505704 }, ::udder::{ user=9314914 } |
| ::{ flag=GB }:: | **Royaume-Uni** | **Tesco Finest** | **::-jordan-::{ user=7288862 }**, ::CallieCube::{ user=7535045 }, ::KnightC0re::{ user=7894340 }, ::Shii::{ user=9186316 }, ::Skidooskei::{ user=10079029 } |
