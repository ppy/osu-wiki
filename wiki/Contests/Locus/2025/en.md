...
- Teams must submit their entry as a `.osz` by the submission deadline. Do not upload your entry to the website via BSS — there will be a separate submission for this.
  ...
  - Spread
    - The `.osz` should aim to contain an ENHIX spread that satisfies the current ranking criteria for the osu! gamemode. Your submission should contain no more than 5 difficulties.
