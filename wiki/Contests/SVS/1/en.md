...
- **Submissions must be submitted via .osz format.** Sending in `.osu` files only is not allowed. If you don’t know how to export a .osz file, please follow [this guide](/wiki/Client/File_formats). All `.osu` files submitted will be disqualified if a .osz is not sent afterwards.
