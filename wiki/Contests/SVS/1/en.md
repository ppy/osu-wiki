...
The **Slider Velocity Showdown** (***SVS***) was the 1st iteration of the osu!taiko mapping contest with a focus on creativity and innovation. This contest was open to all that want to flex their creative muscles, whether they’ve never placed an inherited point in your life or if they’ve been mapping for years.
...
| Submission phase | 2021-08-01/2021-09-01 23:59 |
| Judging phase | 2021-09-01/2021-09-14 |
...
- **The contest will consist of one round where contestants will map any song of their choosing.** The chosen song must not breach the osu! [song content rules](https://osu.ppy.sh/wiki/en/Rules/Song_Content_Rules); if you wouldn’t upload it to your profile, then don’t use it here. Anything that violates the osu! rules will be disqualified.
- **Each contestant is limited to a single difficulty of any level.**
- **Your map must be an osu!taiko map.**
- **Every entry should utilize only timing points (BPM changes) and inherited points (slider velocities).** NThe maps don’t need to be rankable; in fact, It's to give up on any chance of making a rankable map. If it helps, think of this like Aspire, but incredibly simplified. All entries that include storyboarding, hitsounding, and skinning will be disqualified. You may use sliders and spinners. Fringe entries will be dealt with on a case-by-case basis.
...
- **Submissions must be submitted via .osz format.** Sending in `.osu` files only is not allowed. If you don’t know how to export a .osz file, please follow [this guide](https://osu.ppy.sh/wiki/en/osu%21_File_Formats). All `.osu` files submitted will be disqualified if a .osz is not sent afterwards.
...
- **Songs must be under 5 minutes in length.** Judging requires maps to be played multiple times, this rule is just to be respectful of their time.
