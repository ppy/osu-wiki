...
| Position | Member(s) |
| :-- | :-- |
| Host | ::{ flag=US }:: ::Nifty::{ user=4956097 }, ::{ flag=AR }:: ::Axer::{ user=7299864 }, ::{ flag=JP }:: ::komasy::{ user=1980256 } |
| Designer | ::{ flag=AR }:: ::Atreevete::{ user=2615199 } |
| Judge | ::{ flag=US }:: ::Alchyr::{ user=4993032 }, ::{ flag=JP }:: ::iceOC::{ user=5482401 }, ::{ flag=DE }:: ::Mew::{ user=2345156 }, ::{ flag=BR }:: ::Ppus::{ user=5918857 }, ::{ flag=DE }:: ::xMrtn-::{ user=866297 } |
| Translator | ::{ flag=AR }:: ::Axer::{ user=7299864 } (Spanish), ::{ flag=JP }:: ::komasy::{ user=1980256 } (Japanese) |
...
| Placing | User |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=TW }:: ::katacheh::{ user=6651672 } |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=SG }:: ::\_gt::{ user=8301957 } |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=PH }:: ::Fynbi::{ user=2164993 } |
