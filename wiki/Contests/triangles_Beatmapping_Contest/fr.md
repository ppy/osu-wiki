...
**triangles** est un concours de mapping et de storyboarding centré sur la chanson thème de [osu!(lazer)](/wiki/Client/Release_stream/Lazer) *[cYsmix](https://osu.ppy.sh/beatmaps/artists/2) - triangles*.

Les candidatures à ce concours sont les suivantes

- Une beatmap sur le thème du triangle...
  - de la musique *[cYsmix](https://osu.ppy.sh/beatmaps/artists/2) - triangles*
  - en suivant les [critères de classement](/wiki/Ranking_criteria)
  - avec 5 difficultés au total : Easy, Normal, Hard, Insane et Expert
- Un storyboard sur le thème de triangle avec un fichier `.osb` de moins de 1 MB.
- Une équipe de 2 à 5 participants.
- Une soumission complète de moins de 10 Mo au total.
...
| --: | :-- |
| Annonce | 31/05/2022 |
| Phase de soumission | 30/05/2022/27/07/2022 |
| Phase de jugement | 28/07/2022/31/08/2022 |
| Vote de la communauté et listes de lecture | 06/09/2022/25/09/2022 |
| Annonce des résultats en direct | 02/10/2022 |

## Liens

- [Liste des concours](https://osu.ppy.sh/community/contests/147)
- [Article de news sur le concours](https://osu.ppy.sh/home/news/2022-05-31-triangles)
- [Article de news sur le vote](https://osu.ppy.sh/home/news/2022-09-08-triangles-voting-phase)
- [Résultats en direct](https://www.twitch.tv/videos/1607587424)
- [Article de news sur les résultats](https://osu.ppy.sh/home/news/2022-10-06-results-triangles)

## Équipes

| Nom de l'équipe | Beatmappeurs | Storybordeurs | Soumission |
| :-- | :-- | :-- | :-- |
...
| Rang | Soumission de l'équipe | Panneau de mapping | Panel de storyboarders | Total moyen |
| :-- | :-- | :-- | :-- | :-- |
...
Voir le jugement détaillé [ici](https://docs.google.com/spreadsheets/d/1VwajV4Ibn-k_sNHiiPAXX0raXiX34-v7_6SBWUq2pPY/edit#gid=0).

## Prix

Le concours sera jugé par deux groupes de mappeurs et de storyboarders. Chaque groupe ayant sa propre spécialité, l'équipe ayant obtenu le meilleur score dans chaque groupe recevra un prix distinct.

### Vote communautaire

- Un joueur doit jouer toutes les difficultés d'une playlist lazer **triangles** pour pouvoir voter.
- Prix
  - **Deuxième :** 3 mois d'osu!supporter
  - **Gagnant :** 6 mois d'osu!supporter + badge de profil *Community Pick*

![Badge de profil "Community Pick"](/wiki/shared/news/2022-05-26-triangles/community@2x.png)

### Panneau de mapping

- Axé sur le mapping du contenu
- Prix
  - **Deuxième :** 3 mois d'osu!supporter
...
![Badge de profil Mappers' Pick](/wiki/shared/news/2022-05-26-triangles/mappers@2x.png)

### Panel de storyboarders

- Concentré sur le contenu du storyboard
- Prix
  - **Deuxième :** 3 mois d'osu!supporter
  - **Gagnant :**  6 mois d'osu!supporter + Badge de profil *Storyboarders' Pick*
- Panélistes :
  - ::{ flag=GB }:: [-Mo-](https://osu.ppy.sh/users/2202163)
...
![Badge de profil Storyboarders' Pick](/wiki/shared/news/2022-05-26-triangles/storyboarders@2x.png)

### Prix global

- Combinaison des deux panels axés sur tous les domaines de la soumission
- **Deuxième :** 3 mois d'osu!supporter + Badge de profil *Overall runner-up*
- **Gagnant :**
  - 6 mois d'osu!supporter
  - Badge de profil *Overall winner*
  - Titres d'utilisateurs **Elite Mapper** et **Elite Storyboarder**.
  - Soumission en même temps que les nouvelles installations de lazer (après avoir atteint le statut "Ranked")

![Badge de profil Overall runner-up](/wiki/shared/news/2022-05-26-triangles/overallrunnerup@2x.png)

![Badge de profil Overall winner](/wiki/shared/news/2022-05-26-triangles/overallwinner@2x.png)

Si une équipe gagne dans plusieurs des catégories ci-dessus, elle recevra un badge de profil reflétant toutes les catégories pertinentes.

Les joueurs peuvent également prétendre à des prix s'ils participent aux listes de lecture "lazer" :

- **Leader des playlists Easy/Normal/Hard/Insane :** 1 mois d'osu!supporter par personne
- **Leader de la playlist Expert :** 1 mois d'osu!supporter + badge de profil *triangle aficionado*

![Badge de profil triangle aficionado](/wiki/shared/news/2022-05-26-triangles/aficionado@2x.png)

## Règles

- **La soumission doit comprendre les éléments suivants :**
  - Une beatmap de *cYsmix - triangles* avec **CINQ DIFFICULTÉS TOTALES** : Easy, Normal, Hard, Insane et Expert. [Téléchargez le modèle de la beatmap ici !](https://assets.ppy.sh/artists/2/Songs/cYsmix%20-%20triangles.osz)
  - Un storyboard avec un fichier `.osb` ne dépassant pas **1 MB**. Cela permet de s'assurer que le storyboard est bien optimisé et qu'il ne prend pas trop de temps à analyser et à charger dans le jeu.
- **La soumission ne doit pas dépasser 10 Mo.** Bien que cela ne soit pas obligatoire, nous recommandons des conceptions qui utilisent des formes simples, réduisent les ressources au minimum et s'alignent sur l'approche de lazer en matière de conception de l'interface utilisateur.
- **La soumission doit être au format `.osz`.**
- **Les beatmaps doivent être en mode de jeu *osu!* uniquement.** Comparer les beatmaps de différents modes dans un scénario de jugement n'est malheureusement pas réaliste.
...
- **Le nom et les membres de l'équipe doivent être confirmés par [ce formulaire](https://docs.google.com/forms/d/e/1FAIpQLSeExd07kLYqp-Mx-lM7Wwxii_qidSUasAlMi3HUHUsdfVSUyg/viewform?usp=sf_link).**
  ...
  - Les équipes doivent être composées de 2 à 5 membres.
