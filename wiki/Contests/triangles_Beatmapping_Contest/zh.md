...
**三角作图比赛**是以 [osu!(lazer)](/wiki/Client/Release_stream/Lazer) 的主题曲 *[cYsmix](https://osu.ppy.sh/beatmaps/artists/2) - triangles* 为焦点的作图和故事板设计比赛。
...
| 社区投票、lazer 课题开启 | 2022-09-06/2022-09-25 |
| 直播公布结果 | 2022-10-02 |
...
| Crazy Thursday | ::{ flag=CN }:: ::Yugu::{ user=3161834 }, ::{ flag=CN }:: ::yf\1bmp::{ user=1243669 }, ::{ flag=CN }:: ::TtmnZk::{ user=2495509 }, ::{ flag=HK }:: ::Chaoslitz::{ user=3621552 } | ::{ flag=HK }:: ::Chaoslitz::{ user=3621552 }, ::{ flag=CN }:: ::yf\1bmp::{ user=1243669 }, ::{ flag=CN }:: ::Yumeno Himiko::{ user=1806962 } | [谱面链接](https://osu.ppy.sh/beatmapsets/1841885) |
...
| TV Sizers | ::{ flag=CL }:: ::MystyCute::{ user=10210657 }, ::{ flag=IL }:: ::TheSword::{ user=14004374 }, ::{ flag=CL }:: ::Cris-::{ user=6175280 }, ::{ flag=CL }:: ::kanocchi::{ user=2321050 }, ::{ flag=CL }:: ::\1-Evil-\1::{ user=10234313 } | ::{ flag=IL }:: ::TheSword::{ user=14004374 } | [谱面链接](https://osu.ppy.sh/beatmapsets/1841923) |
...
比赛评判将分为两个方面，分别为谱师组和故事板组。因为每个小组都是按某个方面特化评价的，所以每个小组内得分最高的队伍还将获得一个单独的奖项。

### 社区投票

- 玩家必须游玩过 **triangles** lazer 课题的所有参赛作品才能投票
- 奖励
  - **参与者：** 3 个月的 osu! 支持者
...
- **冠军**
  ...
  - 作品将被包含在新安装 lazer 版游戏时，同步下载的谱面包内（当谱面上架后）
...
如果玩家参与游玩了 lazer 版课题，也有资格获得奖励：

- **Easy/Normal/Hard/Insane 课题第一：** 每项第一获得 1 个月的 osu! 支持者
- **Expert 课题第一：** 1 个月的 osu! 支持者 + *三角迷*主页奖牌
...
- **参赛作品不能大于 10 MB。** 虽然并不是规定，但我们建议使用简单形状的设计，尽量节省资源，并参考 lazer 版的 UI 设计。
- **参赛作品必须是 `.osz` 格式。**
- **谱面只能是 *osu!* 游戏模式。** 不幸的是，给不同游戏模式的谱面统一评分不太现实。
- **谱面应符合[谱面上架标准 (RC)](/wiki/Ranking_criteria)**。 虽然我们可以忽视谱面失误，但如果参赛作品含有不大幅度修改就无法上架的问题，还是会被取消资格。
