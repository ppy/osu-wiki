...
La bannière ci-dessus représente la contribution de ::Kleinne Lui::{ user=27725651 } au concours artistique [Journey into a Beatmap World](https://osu.ppy.sh/community/contests/175).
...
| :-- | :-- |
| ::{ flag=RS }:: ::0x84f::{ user=7944724 } | Rédacteur de news |
...
| ::{ flag=TR }:: ::Zeus-::{ user=5464437 } | Planification du concours |
