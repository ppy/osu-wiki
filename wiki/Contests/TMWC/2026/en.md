...
| Position | Member(s) |
| :-- | :-- |
| Host | ::{ flag=NL }:: ::ikin5050::{ user=4007649 }, ::{ flag=AT }:: ::Yasuho::{ user=8458835 },  ::{ flag=PT }:: [Warp](https://osu.ppy.sh/community/users/18649724) |
| Designers | ::{ flag=MY }:: ::Jerry::{ user=605973 } |
| Judges | ::{ flag=HK }:: ::Cynplytholowazy::{ user=3901754 }, ::{ flag=DE }:: ::OnosakiHito::{ user=290128 }, ::{ flag=CL }:: ::ulko::{ user=1263669 }, ::{ flag=GB }:: ::Skidooskei::{ user=10079029 }, ::{ flag=VN }:: ::davidminh0111::{ user=9623142 },  ::{ flag=DE }:: ::Undead Alice::{ user=17415683 }, ::{ flag=FR }:: ::Heaxys::{ user=5671417 }, ::{ flag=PH }:: ::Kulalaying::{ user=1259391 } |
