...
| Placing | Prize(s) |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | 55% of total cash prize, unique profile badge, [3 contest points](/wiki/Contests/Contest_points) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | 30% of total cash prize, [2 contest points](/wiki/Contests/Contest_points) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | 15% of total cash prize, [1 contest point](/wiki/Contests/Contest_points) |

The amount of contest points awarded will be determined by the number of mappers participating in the contest, as detailed in the [contest points key](/wiki/Contests/Contest_points#points-key). The cash prize will be crowd-funded and those who wish to support the contest can do so via [ikin5050's Ko-fi page](https://ko-fi.com/ikin5050).
...
| Position | Member(s) |
| :-- | :-- |
| Host | ::{ flag=NL }:: ::ikin5050::{ user-id=4007649 }, ::{ flag=AT }:: ::Yasuho::{ user-id=8458835 },  ::{ flag=PT }:: [Warp](https://osu.ppy.sh/community/users/18649724) |
| Designers | ::{ flag=MY }:: ::Jerry::{ user-id=605973 } |
| Judges | ::{ flag=HK }:: ::Cynplytholowazy::{ user-id=3901754 }, ::{ flag=DE }:: ::OnosakiHito::{ user-id=290128 }, ::{ flag=CL }:: ::ulko::{ user-id=1263669 }, ::{ flag=GB }:: ::Skidooskei::{ user-id=10079029 }, ::{ flag=VN }:: ::davidminh0111::{ user-id=9623142 },  ::{ flag=DE }:: ::Undead Alice::{ user-id=17415683 }, ::{ flag=FR }:: ::Heaxys::{ user-id=5671417 }, ::{ flag=PH }:: ::Kulalaying::{ user-id=1259391 } |
...
- Round 1 will act as a seeding round. Round 2 will feature a knockout round according to the seeding from Round 1. The top teams from each group will progress to Round 3 (the final). Every team will get to participate in Rounds 1 and 2. Teams will be expected to produce 1 map per round.
