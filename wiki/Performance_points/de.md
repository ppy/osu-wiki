...
Es blieb in dieser Weise mehr als ein Jahr lang im Einsatz, bis ::Tom94::{ user=1857058 }, der Ersteller des Bewertungssystems namens *osu!tp*, dem [osu!-Team](/wiki/People/osu!_team) beitrat und sein Design in das System implementierte. Das resultierende System wurde *ppv2* genannt und am 27. Januar 2014 in Betrieb genommen. Infolgedessen wurde das alte System zu *[ppv1](/wiki/Performance_points/ppv1)* umbenannt.

Am 16. Januar 2021 wurde das ppv2-System verändert, mit dem Ziel an schwierigere Aspekte von Beatmaps eine passendere Anzahl von pp zu vergeben. Diese Veränderungen wurden größtenteils mit der Hilfe von verschiedenen Einzelpersonen, wie ::Xexxar::{ user=2773526 } und ::StanR::{ user=7217455 } vorgenommen. Die Details der Änderungen werden ausführlich erläutert im [dazugehörigen Newsbeitrag](https://osu.ppy.sh/home/news/2021-01-14-performance-points-updates). Die wichtigsten Punkte sind:
