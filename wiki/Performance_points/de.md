...
::: alert-notice
**Hinweis**
Ein kleiner Bonus an pp wird vergeben, basierend auf der Anzahl an gerankten Beatmaps, auf denen du einen Score gesetzt hast.
:::
...
### Mit wie vielen Bonus-pp werde ich belohnt, wenn ich Scores auf gerankten Beatmaps habe?

**Bis zu 413,894 Bonus-pp werden für das Setzen von 1.000 Scores ausgehändigt.**

Du kannst den genauen Wert berechnen, indem du die [folgende Formel](https://www.desmos.com/calculator/ll2foxmgp3) benutzt, bei der `N` die Anzahl der Scores ist, die du auf gerankten Beatmaps gesetzt hast:
