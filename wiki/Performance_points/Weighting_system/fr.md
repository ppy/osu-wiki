...
Le **weighting system** détermine le [total des points de performances](/wiki/Performance_Points/Total_Performance_Points) d'un joueur en pondérant chaque valeur individuelle de [points de performance](/wiki/Performance_Points) par rapport aux autres. Le système attribue ensuite un montant de plus en plus faible pour la deuxième meilleure valeur, la troisième meilleure valeur, et ainsi de suite. Cela garantit qu'un joueur doit s'améliorer pour progresser dans le système de points de performance. Pour une explication plus précise, voir la formule suivante :
