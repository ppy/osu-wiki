...
- Le score par beatmap est évalué par rapport à la difficulté de la beatmap, en se basant sur des statistiques qui ne sont pas disponibles au public,
...
- Toutes les beatmaps *ranked* et *approved* sont prises en compte dans les calculs,
...
- Si un score n'est pas placé dans le top 500 d'une beatmap, il n'est pas compté.

## Grimper dans le classement

Votre classement est principalement lié à vos performances sur des beatmaps individuelles. La manière la plus facile de l'améliorer est d'améliorer votre classement sur des beatmaps difficiles.
...
- Classez-vous sur les beatmaps les plus populaires, où il est plus dur de s'y faire une place,
- Jouez à des beatmaps difficiles,
