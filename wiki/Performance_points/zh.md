...
玩家所游玩的谱面难度决定了表现分上限。表现分计算主要分为 4 块：**[精准 (aim)](#aim)**、**[速度 (speed)](#speed)**、**[精确 (accuracy)](#accuracy)**、**[耐力 (strain)](#strain)**。这 4 个值按照不同的权重组合在一起，得出谱面中不同[难度](/wiki/Beatmap/Difficulty)的星数，以及玩家在该谱面上获得的表现分。
