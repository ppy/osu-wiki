...
มันมีจุดมุ่งหมายที่จะแสดงความสามารถของผู้เล่น โดยจะดูจากเวลาที่ใช้เล่นไปทั้งหมด จนถึงการคำนวณความสามารถจริง ๆ ของผู้เล่น ซึ่งค่านี้จะนำมาจากการคำนวณคะแนนที่ขึ้นอยู่กับระดับความยากและคะแนนที่ผู้เล่นได้ใน [บีทแมพ(beatmap)](/wiki/Beatmaps) นั้น ๆ
...
ไม่กี่เดือนหลังจากการเปิดตัว ระบบนี้ก็ได้มีการมาใช้อย่างเต็มที่ในอัปเดต osu! 20120722-24่ เพื่อนำมาใช้แทนระบบคะแนน [Ranked](/wiki/Beatmaps/Category#ranked) แบบเก่า คะแนนใหม่จะถูกคำนวณทุก ๆ 30 นาที และหลังจากนั้นในเดือนสิงหาคม ได้มีการพัฒนาให้มีการอัปเดตแบบ real-time
...
ในบีทแมพที่มีส่วนต่าง ๆ ที่ต้องการความเร็วสูงหรือมี [pattern](/wiki/Beatmaps/Pattern) ที่มีความยากนั้นจะเพิ่มค่าความเครียด เช่น บีทแมพที่มี [stream](/wiki/Beatmaps/Pattern/Stream) เยอะ ๆ หรือการ jumps ที่เร็วก็จะทำให้ค่าความเครียดสูงเช่นกัน และจำนวน pp ที่ได้รับจะเพิ่มขึ้นตามไปด้วย
