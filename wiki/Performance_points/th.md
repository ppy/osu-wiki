...
ในบีทแมพที่มีส่วนต่างๆที่ต้องการความเร็วสูงหรือมี [pattern](/wiki/Beatmaps/Pattern) ที่มีความยากนั้นจะเพิ่มค่าความเครียด เช่น บีทแมพที่มี [stream](/wiki/Beatmaps/Pattern/Stream) ที่เยอะ หรือการ jumps ที่เร็วๆก็จะทำให้ค่าความเครียดสูงเช่นกัน และจำนวน pp ที่ได้รับจะเพิ่มขึ้นตามไปด้วย
