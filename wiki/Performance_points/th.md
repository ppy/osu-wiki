...
มันมีจุดมุ่งหมายที่จะแสดงความสามารถของผู้เล่น โดยจะดูจากเวลาที่ใช้เล่นไปทั้งหมด จนถึงการคำนวณความสามารถจริง ๆ ของผู้เล่น คซึ่งค่านี้จะนำมาจากการคำนวณคะแนนที่ขึ้นอยู่กับระดับความยากและคะแนนที่ผู้เล่นได้ใน [บีทแมพ(beatmap)](/wiki/Beatmaps) นั้น ๆ
...
ไม่กี่เดือนหลังจากการเปิดตัว ระบบนี้ก็ได้มีการมาใช้อย่างเต็มที่ในอัปเดต osu! 20120722-24่ เพื่อนำมาใช้แทนระบบคะแนน [Ranked](/wiki/Beatmaps#ranked) แบบเก่า คะแนนใหม่จะถูกคำนวนทุก ๆ 30 นาที และหลังจากนั้นในเดือนสิงหาคม ได้มีการพัฒนาให้มีการอัปเดตแบบ real-time
...
หลังจากนั้น คะแนนจะถูกนำมา "ชั่งน้ำหนัก" กับคะแนนอื่น ๆเพื่อที่จะมั่นใจว่าคะแนนที่ดีที่สุดเท่านั้น ที่จะมีผลกับค่าประสิทธิภาพรวมของผู้เล่น [*การชั่งน้ำหนัก*](#ระบบการชั่งน้ำหนัก) เป้าหมายของมันคือการป้องกันการเล่นแมพง่าย ๆอย่างต่อเนื่อง เพื่อที่จะได้ pp โดยการลดจำนวน pp ที่ได้จริง ๆโดยจะอ้างอิงจากคะแนนสูงสุดของผู้เล่น
...
*การเล็ง* คือค่าหลักที่จะคำนวนว่ามันยากขนาดไหนที่จะกดโดนโน้ตต่าง ๆในบีทแมพ
...
ไม่ ระบบนี่นั้นมันสมบูรณ์แบบอยู่แล้ว และจำนวน performance point รวมจะแตกต่างกันในทุก ๆ แมพและม็อดต่าง ๆ แม้เมื่อความยากจริง ๆ ของแมพนั้น น้อยกว่าความยากที่คำนวนไว้
