...
Ele continuou a existir dessa forma por mais de um ano de serviço até que ::Tom94::{ user-id=1857058 }, o criador da métrica de pontuação *osu!tp*, se juntou à [equipe osu!](/wiki/People/osu!_team) e implementou seu design no sistema. O sistema resultante foi intitulado *ppv2*, e entrou em funcionamento em 27 de janeiro de 2014, renomeando o antigo sistema para *[ppv1](/wiki/Performance_points/ppv1)*.

Em 16 de janeiro de 2021, mudanças foram feitas no sistema ppv2 com o objetivo de premiar com mais precisão os aspectos mais difíceis das beatmaps. Essas mudanças foram feitas em grande parte com a ajuda de vários membros da comunidade, como ::Xexxar::{ user-id=2773526 } e [StanR](https://osu.ppy.sh/users/7217455). Os detalhes das mudanças podem ser encontrados no [post de notícias correspondente](https://osu.ppy.sh/home/news/2021-01-14-performance-points-updates). Muito brevemente, os principais pontos de interesse dessa atualização foram os seguintes:
