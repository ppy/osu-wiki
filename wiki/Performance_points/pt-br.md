...
Em 16 de janeiro de 2021, mudanças foram feitas no sistema ppv2 com o objetivo de premiar com mais precisão os aspectos mais difíceis das beatmaps. Essas mudanças foram feitas em grande parte com a ajuda de vários membros da comunidade, como ::Xexxar::{ user=2773526 } e [StanR](https://osu.ppy.sh/users/7217455). Os detalhes das mudanças podem ser encontrados no [post de notícias correspondente](https://osu.ppy.sh/home/news/2021-01-14-performance-points-updates). Muito brevemente, os principais pontos de interesse dessa atualização foram os seguintes:
