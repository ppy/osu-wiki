A **<span style="color:#FF8000">Muzukashii</span>** difficulty is now for those who got used to [Taiko](Taiko "wikilink"); who know how to handle basic patterns and different spacings. These properties from **<span style="color:#00BF40">Kantan</span>** and **<span style="color:#0000FF">Futsuu</span>** appear in a Muzukashii as well, but in a large amount. - **Patterns can become longer and spacings more infrequent.** Additional to this, a Muzukashii can also provide **short 1/4, 1/3 and 1/6 patterns** which structure is preferable monotonically and short. The rule of thumb is the following one:

-   Stick to simple 1/4 patterns like *'<span style="color:#FF0000">ddd</span> **/** <span style="color:#0000FF">kkk</span>*', *'<span style="color:#FF0000">dd</span><span style="color:#0000FF">k</span> **/** <span style="color:#0000FF">kk</span><span style="color:#FF0000">d</span>*' <u>but do not overuse them</u>.
