...
- ::osu!-Profil von nekodex::{ user-id=102 }
- ::osu!-Profil von tieff::{ user-id=89619 }
- ::osu!-Profil von Natteke::{ user-id=157177 }
...
| daniwellP - Nekomimi Switch | Team STREAM (::{ flag=GB }:: ::RandomJibberish::{ user-id=157879 } und ::{ flag=CL }:: ::Krisom::{ user-id=99269 }) | ![7/10](img/dif7.png "7/10") |
...
| OK Go - WTF | Team STREAM (::{ flag=CA }:: ::mm201::{ user-id=30655 } und ::{ flag=AU }:: ::Lilac::{ user-id=58197 }) | ![6/10](img/dif6.png "6/10") |
...
| Song | Mapper | Schwierigkeitsgrad |
| :-- | :-- | :-- |
| SHIKI - Lapis | Team STREAM (::{ flag=GB }:: ::RandomJibberish::{ user-id=157879 } und ::{ flag=FR }:: ::Kurai::{ user-id=77089 }) | ![5/10](img/dif5.png "5/10") |
