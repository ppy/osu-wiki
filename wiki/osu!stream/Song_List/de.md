...
::: alert-note
**Anmerkung:** Für Informationen über das Hauptspiel, siehe [osu!stream](/wiki/osu!stream)
:::
...
- ::osu!-Profil von nekodex::{ user=102 }
- ::osu!-Profil von tieff::{ user=89619 }
- ::osu!-Profil von Natteke::{ user=157177 }
...
| daniwellP - Nekomimi Switch | Team STREAM (::{ flag=GB }:: ::RandomJibberish::{ user=157879 } und ::{ flag=CL }:: ::Krisom::{ user=99269 }) | ![7/10](img/dif7.png "7/10") |
...
| OK Go - WTF | Team STREAM (::{ flag=CA }:: ::mm201::{ user=30655 } und ::{ flag=AU }:: ::Lilac::{ user=58197 }) | ![6/10](img/dif6.png "6/10") |
...
| Song | Mapper | Schwierigkeitsgrad |
| :-- | :-- | :-- |
| SHIKI - Lapis | Team STREAM (::{ flag=GB }:: ::RandomJibberish::{ user=157879 } und ::{ flag=FR }:: ::Kurai::{ user=77089 }) | ![5/10](img/dif5.png "5/10") |
