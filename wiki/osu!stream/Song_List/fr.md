...
| :-- | :-- | :-- |
| nekodex - Liquid Future | ::{ flag=CA }:: ::mm201::{ user=30655 } | ![7/10](img/dif7.png "7/10") |
| tieff & Natteke - Endless Tower | ::{ flag=GB }:: ::RandomJibberish::{ user=157879 } | ![2/10](img/dif2.png "2/10") |
| tieff & Natteke - Sunrise | ::{ flag=GB }:: ::jericho2442::{ user=88904 } | ![4/10](img/dif4.png "4/10") |
| SkyMarshall - Hitchhikers | ::{ flag=MX }:: ::Gens::{ user=23062 } | ![3/10](img/dif3.png "3/10") |
...
- ::Profil osu! de nekodex::{ user=102 }
- ::Profil osu! de tieff::{ user=89619 }
- ::Profil osu! de Natteke::{ user=157177 }
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| haru☆ - March Handyman | ::{ flag=FR }:: ::Sushi::{ user=43108 } | ![4/10](img/dif4.png "4/10") |
| Garbled Waves - Apatisk | ::{ flag=GB }:: ::RandomJibberish::{ user=157879 } | ![6/10](img/dif6.png "6/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| Aperture Science - Want You Gone | ::{ flag=DE }:: ::Larto::{ user=12328 } | ![7/10](img/dif7.png "7/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| Bomb Boy - Ignition, Set, GO! | ::{ flag=GB }:: ::D33d::{ user=791387 } | ![8/10](img/dif8.png "8/10") |
| daniwellP - Nekomimi Switch | Team STREAM (::{ flag=GB }:: ::RandomJibberish::{ user=157879 } and ::{ flag=CL }:: ::Krisom::{ user=99269 }) | ![7/10](img/dif7.png "7/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| Cranky - 1970 | ::{ flag=RU }:: ::IceBeam::{ user=208440 } | ![4/10](img/dif4.png "4/10") |
| Cranky - Crocus | ::{ flag=SE }:: ::Xgor::{ user=98661 } | ![4/10](img/dif4.png "4/10") |
| Cranky - Into the Unknown | ::{ flag=AU }:: ::Samah::{ user=343490 } | ![8/10](img/dif8.png "8/10") |
| Cranky - Dee Dee Cee | ::{ flag=GB }:: ::D33d::{ user=791387 } | ![9/10](img/dif9.png "9/10") |

Voir également :

- [**Liste Featured Artist de Cranky**](https://osu.ppy.sh/beatmaps/artists/23)
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| OK Go - All Is Not Lost | ::{ flag=CA }:: ::mm201::{ user=30655 } | ![5/10](img/dif5.png "5/10") |
| OK Go - End Love | ::{ flag=GB }:: ::RandomJibberish::{ user=157879 } | ![3/10](img/dif3.png "3/10") |
| OK Go - This Too Shall Pass | ::{ flag=AU }:: ::m980::{ user=3288 } | ![7/10](img/dif7.png "7/10") |
| OK Go - WTF | Team STREAM (::{ flag=CA }:: ::mm201::{ user=30655 } et ::{ flag=AU }:: ::Lilac::{ user=58197 }) | ![6/10](img/dif6.png "6/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| Koizumi UNDERGROUND - Get Back! | ::{ flag=GB }:: ::D33d::{ user=791387 } | ![7/10](img/dif7.png "7/10") |
| samplingmasters Koizumi - With Me | ::{ flag=GB }:: ::D33d::{ user=791387 } | ![4/10](img/dif4.png "4/10") |
| samplingmasters Koizumi - Love is a Danger Zone | ::{ flag=GB }:: ::D33d::{ user=791387 } | ![6/10](img/dif6.png "6/10") |
| samplingmasters Koizumi - Infinity Loop | ::{ flag=GB }:: ::D33d::{ user=791387 } | ![7/10](img/dif7.png "7/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| Kenneth Nilsen - Space Music | ::{ flag=GB }:: ::jericho2442::{ user=88904 } | ![6/10](img/dif6.png "6/10") |
| Kenneth Nilsen - Woohoo! | ::{ flag=CL }:: ::Krisom::{ user=99269 } | ![8/10](img/dif8.png "8/10") |
| NIGHTkilla - Fracture | ::{ flag=GB }:: ::jericho2442::{ user=88904 } | ![7/10](img/dif7.png "7/10") |
| SkyMarshall - It's True | ::{ flag=GB }:: ::jericho2442::{ user=88904 } | ![8/10](img/dif8.png "8/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| Odyssey - Wings of Burning Love | ::{ flag=DE }:: ::Larto::{ user=12328 } | ![7/10](img/dif7.png "7/10") |
| Odyssey - Cherry Blossoms (2010 Mix) | ::{ flag=GB }:: ::Mashley::{ user=41481 } | ![5/10](img/dif5.png "5/10") |
| Mortimer - Rive | ::{ flag=US }:: ::ouranhshc::{ user=139493 } | ![5/10](img/dif5.png "5/10") |
| Travis Stebbins - Magnetic Love | ::{ flag=CA }:: ::mm201::{ user=30655 } | ![3/10](img/dif3.png "3/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| Souleye - Positive Force | ::{ flag=GB }:: ::RandomJibberish::{ user=157879 } | ![5/10](img/dif5.png "5/10") |
| Souleye - Pressure Cooker | ::{ flag=SE }:: ::Xgor::{ user=98661 } | ![6/10](img/dif6.png "6/10") |
| Souleye - Potential for Anything | ::{ flag=DE }:: ::Larto::{ user=12328 } | ![7/10](img/dif7.png "7/10") |
| Souleye - Passion for Exploring | ::{ flag=CA }:: ::mm201::{ user=30655 } | ![3/10](img/dif3.png "3/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| SHIKI - Lapis | Team STREAM (::{ flag=GB }:: ::RandomJibberish::{ user=157879 } et ::{ flag=FR }:: ::Kurai::{ user=77089 }) | ![5/10](img/dif5.png "5/10") |
| SHIKI - Pure Ruby | ::{ flag=US }:: ::Lybydose::{ user=64501 } | ![9/10](img/dif9.png "9/10") |
| SHIKI - BABYLON | ::{ flag=SE }:: ::Xgor::{ user=98661 } | ![8/10](img/dif8.png "8/10") |
| SHIKI - Jade Star | ::{ flag=KR }:: ::Nakagawa-Kanon::{ user=87065 } | ![7/10](img/dif7.png "7/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| Amane - Eternal Fullmoon | ::{ flag=PH }:: ::James::{ user=5728 } | ![0/10](img/dif0.png "0/10") |
| Amane - Snow, White, Echo | ::{ flag=NZ }:: ::Echo::{ user=431 } | ![0/10](img/dif0.png "0/10") |
| sou1 - The Maid's Blood and the Pocket Watch | ::{ flag=TW }:: ::Alace::{ user=25993 } | ![4/10](img/dif4.png "4/10") |
| Lix - Phantom Ensemble -Ark Trance mix- | ::{ flag=PH }:: ::James::{ user=5728 } | ![4/10](img/dif4.png "4/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| Lix - Electro Magnetic Pulse | ::{ flag=AU }:: ::peppy::{ user=2 } | ![3/10](img/dif3.png "3/10") |
| haru☆ - Septette for the Dead Princess | ::{ flag=US }:: ::Lybydose::{ user=64501 } | ![4/10](img/dif4.png "4/10") |
| Amane - BOOZEHOUND (DJ mix) | ::{ flag=FR }:: ::Sushi::{ user=43108 } | ![2/10](img/dif2.png "2/10") |
| Amane - Being Proof | ::{ flag=PH }:: ::James::{ user=5728 } | ![3/10](img/dif3.png "3/10") |
