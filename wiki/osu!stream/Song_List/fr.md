...
- ::Profil osu! de nekodex::{ user-id=102 }
- ::Profil osu! de tieff::{ user-id=89619 }
- ::Profil osu! de Natteke::{ user-id=157177 }
...
| OK Go - WTF | Team STREAM (::{ flag=CA }:: ::mm201::{ user-id=30655 } et ::{ flag=AU }:: ::Lilac::{ user-id=58197 }) | ![6/10](img/dif6.png "6/10") |
...
| Musique | Mappeur | Niveau de difficulté |
| :-- | :-- | :-- |
| SHIKI - Lapis | Team STREAM (::{ flag=GB }:: ::RandomJibberish::{ user-id=157879 } et ::{ flag=FR }:: ::Kurai::{ user-id=77089 }) | ![5/10](img/dif5.png "5/10") |
