...
- ::nekodex's osu! profile::{ user=102 }
- ::tieff's osu! profile::{ user=89619 }
- ::Natteke's osu! profile::{ user=157177 }
...
| OK Go - WTF | Team STREAM (::{ flag=CA }:: ::mm201::{ user=30655 } and ::{ flag=AU }:: ::Lilac::{ user=58197 }) | ![6/10](img/dif6.png "6/10") |
...
| Song | Mapper | Difficulty Rating |
| :-- | :-- | :-- |
| SHIKI - Lapis | Team STREAM (::{ flag=GB }:: ::RandomJibberish::{ user=157879 } and ::{ flag=FR }:: ::Kurai::{ user=77089 }) | ![5/10](img/dif5.png "5/10") |
