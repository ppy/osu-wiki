...
Зачастую, когда в osu! мапают песню из другой игры, вместе с этим заимствуют и схему наименования сложностей. Тем не менее, эти названия можно использовать для любых песен — здесь они приведены в качестве примера того, как организовать карту.
