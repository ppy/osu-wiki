...
- ::{ flag=US }:: ::Charles445::{ user=85000 } (perwakilan mapper Amerika)
- *(lowong)* (perwakilan pemain Amerika)
- ::{ flag=FR }:: ::Cherry Blossom::{ user=1156742 } (perwakilan mapper Eropa)
- ::{ flag=GB }:: ::Doomsday::{ user=18983 } (perwakilan pemain Eropa)
- *(lowong)* (perwakilan mapper Asia)
- ::{ flag=TH }:: ::Frostmourne::{ user=199669 } (perwakilan pemain Asia)
- ::{ flag=US }:: ::Garven::{ user=244216 } (perwakilan QAT)
- ::{ flag=DE }:: ::Mao::{ user=2204515 } (perwakilan QAT)

### Anggota-anggota divisi osu!taiko

- ::{ flag=US }:: ::OzzyOzrock::{ user=465153 } (perwakilan mapper Amerika)
- ::{ flag=US }:: ::Shyguy::{ user=178038 } (perwakilan pemain Amerika)
- ::{ flag=DE }:: ::Nwolf::{ user=1910766 } (perwakilan mapper Eropa)
- *(lowong)* (perwakilan pemain Eropa)
- ::{ flag=TW }:: ::qoot8123::{ user=766371 } (perwakilan mapper Asia)
- ::{ flag=KR }:: ::bbj0920::{ user=87546 } (perwakilan pemain Asia)
- ::{ flag=US }:: ::MMzz::{ user=128993 } (perwakilan QAT)
- ::{ flag=MX }:: ::DakeDekaane::{ user=1425253 } (perwakilan QAT)

### Anggota-anggota divisi osu!catch

- ::{ flag=CL }:: ::ZiRoX::{ user=200768 } (perwakilan mapper Amerika)
- ::{ flag=US }:: ::Zak::{ user=1375955 } (perwakilan pemain Amerika)
- ::{ flag=GB }:: ::JBHyperion::{ user=4879508 } (perwakilan mapper Eropa)
- *(lowong)* (perwakilan pemain Eropa)
- ::{ flag=KR }:: ::Spectator::{ user=702598 } (perwakilan mapper Asia)
- ::{ flag=SG }:: ::He Ang Erika::{ user=2451381 } (perwakilan pemain Asia)
- ::{ flag=ES }:: ::Deif::{ user=318565 } (perwakilan QAT)
- ::{ flag=HU }:: ::Kurokami::{ user=260933 } (perwakilan QAT)

### Anggota-anggota divisi osu!mania

- ::{ flag=CA }:: ::Fullerene-::{ user=2531335 } (perwakilan mapper Amerika)
- ::{ flag=US }:: ::Halogen-::{ user=169992 } (perwakilan pemain Amerika)
- ::{ flag=PL }:: ::-Kamikaze-::{ user=2124783 } (perwakilan mapper Eropa)
- ::{ flag=GB }:: ::Hayabusa::{ user=3104108 } (perwakilan pemain Eropa)
- ::{ flag=US }:: (::{ flag=KR }::) ::Jinjin::{ user=3360737 } (perwakilan mapper Asia)
- ::{ flag=MY }:: ::Cryolien::{ user=1626983 } (perwakilan pemain Asia)
- ::{ flag=GB }:: ::Starry-::{ user=2166199 } (perwakilan QAT)
- ::{ flag=US }:: ::Blocko::{ user=4075092 } (perwakilan QAT)
...
- ::{ flag=US }:: ::pishifat::{ user=3178418 } (Koordinator)
- ::{ flag=DE }:: ::Okoratu::{ user=1623405 } (Koordinator)
...
- ::{ flag=DE }:: ::Okoratu::{ user=1623405 } (Koordinator)
- ::{ flag=ES }:: ::Raiden::{ user=2239480 } (Koordinator)
...
- ::{ flag=GB }:: ::JBHyperion::{ user=4879508 } (Koordinator)
- ::{ flag=ES }:: ::Deif::{ user=318565 } (Koordinator)
...
- ::{ flag=DE }:: ::Feerum::{ user=4815717 } (Koordinator)
- ::{ flag=ID }:: ::Maxus::{ user=4335785 } (Koordinator)
...
- ::{ flag=HK }:: ::IamKwaN::{ user=1856463 } (Koordinator)
- ::{ flag=DE }:: ::Okoratu::{ user=1623405 } (Koordinator)
...
- ::{ flag=SE }:: ::Naxess::{ user=8129817 } (Koordinator)
- ::{ flag=DE }:: ::Okoratu::{ user=1623405 } (Koordinator)
