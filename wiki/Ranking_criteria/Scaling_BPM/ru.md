...
- **При темпе ниже ~120 BPM** можно постепенно начать использовать 1/4. В районе 120 BPM ритмы в 1/4 должны встречаться достаточно редко, в виде цепочек из примерно двух объектов.
