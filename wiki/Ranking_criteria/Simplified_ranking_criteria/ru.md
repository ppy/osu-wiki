...
- **Названия сложностей должны идти по возрастанию.**
  ...
  - **Исключение:** у самой высокой сложности может быть уникальное название, например, Normal -> Hard -> *Melancholy*.
...
- **У каждого объекта, по которому можно кликнуть, должна быть обратная связь  в виде слышимого звука.**
...
- **Добавьте ники всех, кто участвовал в создании карты.** Моддеры не считаются.
...
- **В описании карты оставьте ссылку на источник, откуда вы взяли фон.**
...
Звучит просто, но для многих это самый спорный аспект ранкинга карт! Не существует *самого правильного* способа маппать под песни, поэтому у каждого маппера получается по-своему. [Номинаторы карт](/wiki/People/Beatmap_Nominators), в свою очередь, решают, насколько ваша интерпретация подходит для статуса Ranked.
...
- **Соотносите интенсивность карты и песни.**
  ...
  - **Дизайн:** в напряжённых частях структура карты сложнее, чем в спокойных.
...
- **Будьте последовательны — в пределах разумного.**
  ...
  - Копирование и вставка одного и того же не приветствуются, поэтому меняйте повторяющийся участок так, чтобы маппинг выглядел свежо, но в целом следовал вашей прежней интерпретации такого же куска.
...
- **Подумайте, как вашу карту воспримут другие игроки и мапперы.** Если не очень понятно, что вы хотели передать с помощью маппинга, другим будет казаться, что карта не замапана под песню!
