...
- 判定严度 (OD) 应低于 3。
- 回血速度 (HP) 应高于 8。在音符数目较多时，回血速度可以适当降低到 8 以下。音符较少时，则可以适当增加。
...
- 判定严度 (OD) 应低于 4。
- 回血速度 (HP) 应高于 7。在音符数目较多时，回血速度可以适当降低到 7 以下。音符较少时，则可以适当增加。
...
- 判定严度 (OD) 应低于 5。
- 回血速度 (HP) 应高于 6。在音符数目较多时，回血速度可以适当降低到 6 以下。音符较少时，则可以适当增加。
