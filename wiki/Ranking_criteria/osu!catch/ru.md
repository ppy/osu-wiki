...
[^proper-spread]: Подборка (англ. *proper spread*) *сложностей уровня Insane и выше* подразумевает карту, в которой разрыв между ними примерно такой же, как между более низкими [сложностями](/wiki/Beatmap/Difficulty#уровни-сложности) из [соответствующего раздела данной статьи](#критерии-для-отдельных-сложностей).
