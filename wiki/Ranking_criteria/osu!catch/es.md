...
- **No se deben usar [hyperdashes](/wiki/Gameplay/Hyperdash) fuertes.** Para hyperdashes de [snap básico](/wiki/Gameplay/Dash_snapping#basic-snapped) se recomienda un límite de 1.5 veces la [distancia de activación](/wiki/Beatmapping/Trigger_distance) is recommended. En cambio, para hyperdashes de [snap alto](/wiki/Gameplay/Dash_snapping#higher-snapped) hyperdashes, se recomienda un límite de 1.3 veces la distancia de activación.
