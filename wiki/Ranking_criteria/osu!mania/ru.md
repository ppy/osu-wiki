...
[^proper-spread]: Подборка (англ. *proper spread*) *сложностей уровня Insane и выше* подразумевает, что после этого уровня сохранится такой же разрыв, как между более низкими [сложностями](/wiki/Beatmap/Difficulty#уровни-сложности) из [соответствующего раздела данной статьи](#критерии-для-отдельных-сложностей).
