...
**Критерии ранкинга osu!mania** — это свод [правил и рекомендаций](/wiki/Ranking_criteria) для [карт](/wiki/Beatmap) режима [osu!mania](/wiki/Game_mode/osu!mania), которые участвуют в [процедуре ранкинга](/wiki/Beatmap_ranking_procedure).
...
- **Колонка/столбец (англ. *column*)**: одна из вертикальных полос на [игровом поле](/wiki/Game_mode/osu!mania#playfield), где располагаются ноты. При [копировании нот](/wiki/Modding/Timestamp) в редакторе номер колонки обозначается с помощью чисел и отсчитывается с нуля.
- **Режим/число клавиш (англ. *key mode*)**: число колонок в сложности.
- **Стиль игры**: [назначение клавиш](/wiki/Game_mode/osu!mania#controls) или положение рук, с учётом которого маппер сделал сложность.
- **Стандартный стиль игры**: наиболее распространённый стиль для 10 и менее клавиш, где каждая колонка контролируется отдельным пальцем и не имеет особого значения.
  - Примеры стандартных стилей: 4K, 7K, 10K
  - Примеры **не**стандартных стилей: 7K+1, 10K2S, 14K DP
- **Стиль игры N+1**: стиль, при котором самая левая колонка мапается независимо от всех остальных, которые формируют стандартный стиль. 
- **Кейсаундинг (англ. *keysounding*)**: использование сэмплов из песни (или очень сильно похожих на них звуков) в качестве хитсаундов в аналогичных моментах. Кейсаундинг обычно обеспечивает плохую обратную связь во время игры.
...
- **В картах можно использовать только определённое число клавиш: от 4 до 10, а также 12, 14, 16 или 18.**
  - **Если используется больше 10 клавиш, [стиль](#общая-терминология) игры должен быть [10K2S](/wiki/Beatmapping/osu!mania_10K_plus_playstyles#10K2S), [DP](/wiki/Beatmapping/osu!mania_10K_plus_playstyles#DP), [EZ2AC](/wiki/Beatmapping/osu!mania_10K_plus_playstyles#EZ2AC), [10K8K](/wiki/Beatmapping/osu!mania_10K_plus_playstyles#10K8K), либо [9K9K](/wiki/Beatmapping/osu!mania_10K_plus_playstyles#9K9K).**
- **Если в карте используется больше 10 клавиш, либо разные [количества клавиш](#общая-терминология) или [стили игры](#общая-терминология), то они должны быть упомянуты в названии каждой сложности. Если стиль или число клавиш везде одни и те же, их не надо указывать.**
- **Все нестандартные [стили игры](#общая-терминология), представленные в карте, должны быть добавлены в её теги.**
- **Если карта использует [стиль N+1](#общая-терминология), нужно включить настройку `Use special style (N+1 style) for mania` на вкладке `Advanced` в настройках карты, а также добавить "N+1" в теги.** В рамках этого правила стили N+1 рассматриваются только при числе клавиш ниже 10.[^n-plus-1]
- **Если [игровое время](/wiki/Beatmap/Drain_time) каждой сложности…**
  - **…короче 2:00**, то под каждое [число клавиш](#общая-терминология) и [стиль игры](#общая-терминология) замапать сложность уровня Normal или ниже, либо собрать подборку[^proper-spread] как минимум из 4 сложностей.
  - **…между 2:00 и 2:45**, то под каждое [число клавиш](#общая-терминология) и [стиль игры](#общая-терминология) замапать сложность уровня Normal или ниже, либо собрать подборку[^proper-spread] как минимум из 3 сложностей.
  - **…между 2:45 и 3:30**, то под каждое [число клавиш](#общая-терминология) и [стиль игры](#общая-терминология) замапать сложность уровня Normal или ниже, либо собрать подборку[^proper-spread] как минимум из 2 сложностей.
...
*Рекомендации для разного [числа клавиш](#общая-терминология) основаны на режимах, которые чаще всего встречаются в ранкнутых картах (4K и 7K). Если ваша сложность замапана под другое число клавиш или другой [стиль игры](#общая-терминология), следуйте рекомендациям там, где это имеет смысл.*
...
[^n-plus-1]: Настройка "N+1" пока ни на что не влияет, но, возможно, это когда-нибудь изменится. Пока неясно, как именно она будет влиять на сложности с 10 и более клавишами, поэтому её нельзя там включать.
[^proper-spread]: Подборка (англ. *proper spread*) *для сложностей уровня Insane и выше* — это набор сложностей, где между ними сложность повышается примерно так же, как между более низкими [сложностями](/wiki/Beatmap/Difficulty#difficulty-levels) из [соответствующего раздела данной статьи](#критерии-для-отдельных-сложностей).
