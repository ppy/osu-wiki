...
- **Colonne** : Couloirs verticaux du [terrain de jeu](/wiki/Game_mode/osu!mania#terrain-de-jeu) où les notes sont placées. Notez que les [timestamps de l'éditeur](/wiki/Modding/Timestamp) se réfèrent aux colonnes par leur position à l'index zéro en partant de la gauche.
