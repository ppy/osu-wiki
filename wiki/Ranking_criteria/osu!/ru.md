...
- **Старайтесь не использовать цвета комбо и слайдеров, имеющие яркость около 220 и выше, во время киаи,** поскольку яркие вспышки могут быть неприятны для глаз.
