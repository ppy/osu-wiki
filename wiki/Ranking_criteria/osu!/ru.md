...
- **Старайтесь не использовать цвета комбо и границ слайдеров, имеющие яркость около 50 и ниже,** потому что это ухудшает видимость аппроачей при затемнении экрана, а также размывает границы игровых элементов.
- **Старайтесь не использовать цвета комбо и тел слайдеров, имеющие яркость около 220 и выше, во время киаи,** поскольку яркие вспышки могут быть неприятны для глаз.
