...
**Критерии ранкинга osu!** — это свод [правил и рекомендаций](/wiki/Ranking_criteria) для [карт](/wiki/Beatmap) режима [osu!](/wiki/Game_mode/osu!), которые участвуют в [процедуре ранкинга](/wiki/Beatmap_ranking_procedure).
...
- **На каждой нажимаемой части объекта должен быть как минимум один слышимый [хитсаунд](/wiki/Beatmapping/Hitsound), не сливающийся с песней,** в противном случае игроки будут плохо ощущать обратную связь от нажатий. Например, не разрешается использовать [кейсаунды](/wiki/Beatmapping/Hitsound#кейсаунды) в качестве hitnormal без сочетания с хорошо различимыми хитсаундами.
...
- **Старайтесь не использовать цвета для комбо, поверхностей нот (англ. *hitcircle overlay*) и границ слайдеров, имеющие яркость около 50 и ниже.** Такие цвета ухудшают видимость аппроачей при затемнении экрана, а также приводят к плохой различимости границ элементов на фоне игрового поля.
- **Старайтесь не использовать цвета для комбо и тел слайдеров, имеющие яркость около 220 и выше, во время киаи.** Такие цвета создают яркие вспышки, которые могут быть неприятны для глаз.
...
- **Траектория движения по каждому слайдеру должна хорошо прослеживаться от начала и до конца.** Не используйте слайдеры без явных границ, которые пересекают сами себя, а также слайдеры, отдельные участки которых плохо читаются. Конец слайдера должен быть чётко виден, даже если игрок не видит сам круг (например, если концы слайдеров в его скине сделаны прозрачными).
  - Разрешается использовать слайдеры, которые можно пройти на 300, не убирая курсор с их начала.
