...
以下列出谱面集根据掉血时间应有的[难度分布](/wiki/Beatmap/Difficulty_spread)。如果一个谱面集的不同难度拥有不同掉血时间，以掉血时间最短的难度为准。

#### 规定

- **如果谱面的[掉血时间](/wiki/Beatmap/Drain_time)...**
  - **...小于 2:30**，则最低难度必须低于或等于 Normal。**
  - **...在 2:30 到 3:15 之间**，则最低难度必须低于或等于 Hard。
  - **...在 3:15 到 4:00 之间**，则最低难度必须低于或等于 Insane。
