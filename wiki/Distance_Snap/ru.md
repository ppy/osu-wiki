**Distance Snap** — фиксированный миножитель расстояния между нотами. <img src="500px-Beatspacing-rus.jpg" title="fig:Пример того, как используется Distance Snap." alt="Пример того, как используется Distance Snap." width="200" />
