...
**\#modreqs** is a channel in osu! chat where players can request help ([modding](modding "wikilink")) with their maps by linking them with the /np command. Some modders and even [Beatmap Nomination Group](Beatmap_Nomination_Group "wikilink") members may be on the lookout for good maps being linked in this channel.

[Bancho](Glossary#Bancho "wikilink") keeps track of the 20 most recent requests and allows potential modders to find them in a number of ways:
...
-   Visiting a [special map listing](http://osu.ppy.sh/p/beatmaplist&r=8) on the main site will list the 20 most recent requests plus a few extras.
...
Directly asking other users is a great way to get mods, too, if you ask the right ones. Look for a normal user with a lot of [kudosu](kudosu "wikilink") and no modding queue; often they'll accept your request if they're not busy. Also, directly asking [BNs](Beatmap_Nomination_Group "wikilink") is almost a necessity to getting your map ranked. Here are some tips:

-   If somebody's signature or [user page](user_page "wikilink") says, "I don't take requests", then don't ask them if they aren't your friend.
