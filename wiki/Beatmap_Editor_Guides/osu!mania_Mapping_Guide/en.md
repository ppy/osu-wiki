...
<td><p>The inherited point are also called “Green Lines”. These points are used to add “effects” to your map. With these, you can change the volume, the sample set, the slider velocity (SV) and you can add a <a href="/wiki/Beatmap_Editor/Kiai_Time">Kiai-Time</a>.</p></td>
</tr>
<tr class="odd">
<td><p>Kiai:</p></td>
