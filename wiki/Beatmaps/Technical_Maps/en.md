...
*Notice: the "broadest" defintion only requires one or two of the aspects listed to be present in order to define a beatmap as tech.*
...
*Notice: the most "restrice/specific" definition requires **all** all of the aspects listed to be present in order to define a beatmap as tech.*
...
Good examples of tech maps that fit this defintion are <!--PLACEHOLDER--> and <!--PLACEHOLDER-->.

### Mapper's definiton

*Notice: the "mapper's defintion" is a list conjured up from the perspective of a typical osu!standard mapper.*
