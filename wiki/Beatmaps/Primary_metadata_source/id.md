...
Beatmaps bertujuan untuk mendapatkan status [Ranked](/wiki/Beatmaps/Category#ranked) yang membutuhkan metadata dari sumber utama. Lihat [kriteria ranking](/wiki/Ranking_Criteria#metadata) untuk peraturan lebih lanjut dan panduan mengenai beatmap metadata.
