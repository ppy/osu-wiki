...
_Remarque: Les modifications apportées aux paramètres visuels sont enregistrées par beatmap, mais seront perdues après la fermeture de osu!. Pour les définir de manière globale et définitive, rendez-vous dans les [options](/wiki/options)._
