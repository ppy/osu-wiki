...
![Menu des paramètres visuels](img/VisualSettings-FR.jpg "Menu des paramètres visuels")
...
| Nom | Effets | Remarque |
| --- | --- | --- |
| `Arrière-plan sombre` | Assombrir l'arrière-plan. | Pendant les pauses, l'atténuation est réduite de 30% (ceci peut être désactivé dans les options). |
...
| `Ignorer le skin de la beatmap` | Utilisez le skin sélectionné par le joueur au lieu du skin inclus dans la beatmap. | Il faudra redémarrer la beatmap pour que cette option prenne effet. |
| `Ignorer les sons de la beatmap` | Utilisez les hitsounds du skin sélectionné par le joueur au lieu des hitsounds personnalisés de la beatmap. | Il faudra redémarrer la beatmap pour que cette option prenne effet. |
