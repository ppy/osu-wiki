...
_Notice: Visual settings changes are saved per beatmap but will be lost after closing osu!. To set these globally (and forever) use the [options](/wiki/options) sidebar._
