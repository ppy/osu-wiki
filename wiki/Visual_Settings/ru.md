...
| `Игнорировать хитсаунды карты` | Будут оспользоваться хитсаунды выбранного скина игрока вместо пользовательских хитсаундов карты, если таковые имеются. | Это требует перезапуска карты для вступления в силу. |
| `Отключить видео` | Не воспроизводит фоновое видео. Это не удаляет сториборды. | Это требует перезапуска карты, если активирован после начала игрового процесса. Эта опция отключена, если нет фонового видео для воспроизведения. |
