...
_Примечание: визуальные изменения настроек сохраняются для каждой карты, но будут потеряны после закрытия osu!. Чтобы установить их глобально (и навсегда), используйте боковую панель [опций](/wiki/options)._
