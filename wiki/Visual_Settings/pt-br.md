...
| Desabilitar storyboard | Remove todos os elementos do storyboard. Não afeta [Kiai Time](/wiki/Kiai_time) ou vídeo de fundo. | É recomendado para jogadores epilépticos em mapas com aviso de epilepsia. Essa opção é descartada se não existir storyboard. |
