...
*Pour les critères de classement spécifiques au [modes de jeu](/wiki/Game_mode), voir : [osu!](osu!), [osu!taiko](osu!taiko), [osu!catch](osu!catch), et [osu!mania](osu!mania).*
...
**N'oubliez pas que le [code de conduite pour le modding et le mapping](/wiki/Rules/Code_of_Conduct_for_Modding_and_Mapping), le guide sur le [timing des musiques avec des signatures en #/8](/wiki/Ranking_Criteria/Timing_Songs_With_8-Signatures) ainsi que les [règles générales relatives au contenu des musiques](/wiki/Rules/Song_Content_Rules) font partie des critères de classement et s'appliquent à tous les modes de jeu.**
...
- **Les [pause](/wiki/Beatmap/Break) doivent être insérés avec les restrictions de l'[éditeur de beatmap](/wiki/Client/Beatmap_editor).**
- **Les [paramètres de difficulté](/wiki/Client/Beatmap_editor/Song_Setup#difficulty) ne doivent pas être plus précis que ce qui est possible dans l'[éditeur de beatmap](/wiki/Client/Beatmap_editor)..**
- **Le paramètre `Letterbox during breaks` doit être cohérent entre les difficultés du même mode si elles contiennent des périodes de pause et, le cas échéant, le même storyboard.**
...
- **Les créateurs des médias utilisés dans une beatmap doivent être crédités dans la description de la beatmap.** Selon les [Directives d'utilisation du contenu](/wiki/Rules/Content_Usage_Guidelines), l'utilisation des médias utilisés dans les beatmaps devrait être autorisée dans osu!, et leur licence détaillera probablement la manière de créditer leurs créateurs. Les raisons courantes d'omettre les crédits dans la description sont les suivantes : difficulté excessive à trouver des sources, souhait des créateurs de ne pas être crédités et présence de crédits dans les champs artiste, titre ou source.
- **La réutilisation directe de vos propres difficultés classées dans d'autres beatmaps classées est déconseillée.** Cela permet d'éviter de gonfler inutilement le contenu du classement.
- **Le slider tick rate ne doit pas être modifié par le fichier `.osu`.** La plupart des valeurs personnalisées donnent lieu à des unsnapped slider ticks, mais les tick rates 0,5, 1,333 et 1,5 ont une utilité pratique et ne peuvent être appliqués que lorsqu'ils ne donnent pas lieu à des slider ticks unsnapped.
- **Le Kiai devrait commencer sur un son dans la musique.** Sinon, le kiai flash n'a aucun rapport avec la musique.
...
- **Tous les modes de jeu au sein d'une beatmap doivent former un éventail commençant par le niveau de difficulté le plus bas, dicté par le [drain time](/wiki/Gameplay/Drain_time) de la musique.** Pour les difficultés supérieures au niveau de difficulté le plus bas requis, l'écart ne peut sauter aucun niveau de difficulté et il ne peut y avoir d'écart de difficulté trop important entre deux difficultés.
...
- **Chaque difficulté d'une beatmap doit avoir un [drain time](/wiki/Gameplay/Drain_time) minimum de 30 secondes.**
- **Si le [drain time](/wiki/Gameplay/Drain_time) de chaque difficulté est...**
  - **...inférieur à 3:30**, la difficulté la plus faible de chaque mode de jeu inclus ne peut pas être plus difficile qu'un Normal.
  - **...entre 3:30 et 4:15**, la plus faible difficulté de chaque mode de jeu inclus ne peut être plus difficile qu'un Hard.
  - **...entre 4:15 et 5:00**, la difficulté la plus faible de chaque mode de jeu inclus ne peut pas être plus difficile qu'un Insane.
  - **Les difficultés inférieures à la difficulté la plus élevée peuvent combiner les temps de pause avec les drain time pour atteindre les seuils ci-dessus.** Cela ne s'applique pas aux difficultés dont le drain time est inférieur à 30 secondes. L'appréciation de l'adéquation des éléments de gameplay utilisés pour les difficultés les plus basses (Hard et Insane) est du ressort des [Beatmap Nominators](/wiki/People/The_Team/Beatmap_Nominators) et de la [Nomination Assessment Team](/wiki/People/The_Team/Nomination_Assessment_Team) pour les modes de jeu correspondants.
  - **Les beatmaps osu!mania sont liés par un ensemble différent de seuils de drain time et d'autres règles de diffusion définies dans les [critères de classement osu!mania](/wiki/Ranking_Criteria/osu!mania).**
- **Les noms des difficultés dans une beatmap doivent être clairement progressifs et indiquer avec précision leurs difficultés respectives, à l'exclusion :**
  ...
  - Les plus hautes difficultés de chaque mode de jeu avec un niveau de difficulté similaire, s'appliquant uniquement aux difficultés Insane et Extra (par exemple, les difficultés Insane d'un jeu ENHIIII ou les difficultés Extra d'un jeu ENHIIXXX).
...
- **L'[hôte d'une beatmap](/wiki/Beatmap/Beatmap_host) ne peut pas indiquer la possession dans le nom d'une difficulté.** (par exemple, Beatmap Host's Insane). Les conflits causés par le beatmapping de plusieurs beatmaps avec les mêmes métadonnées et les [difficultés collaborative](/wiki/Beatmap/Beatmap_collaborations) sont les seules exceptions. Les [difficultés des invités](/wiki/Beatmap/Guest_difficulty), cependant, peuvent indiquer la possession avec le nom d'utilisateur ou le surnom de leurs créateurs.
- **L'[hôte d'une beatmap](/wiki/Beatmap/Beatmap_host) doit avoir battu des difficultés égales ou supérieures à celles de tout créateur des [difficultés des invités](/wiki/Beatmap/Guest_difficulty).** Il s'agit de rendre à César ce qui appartient à César. Les [difficultés collaborative](/wiki/Beatmap/Beatmap_collaborations) ne sont considérées que comme des difficultés partielles, et le [drain time](/wiki/Gameplay/Drain_time) sera utilisé pour déterminer le montant de la contribution lorsqu'un invité a réalisé beaucoup plus de beatmaps que l'hôte.
- **L'[hôte d'une beatmap](/wiki/Beatmap/Beatmap_host) et les [difficultés des invités](/wiki/Beatmap/Guest_difficulty) peuvent modifier leurs difficultés respectives comme ils le souhaitent.** S'il y a un désaccord entre les deux, l'hôte de la beatmap doit supprimer la contribution de l'invité sur demande. Si un créateur de difficulté des invités ne peut être contacté pendant un mois, il sera supposé être d'accord avec tout changement.
...
- **Évitez les noms de difficultés comportant des éléments descriptifs qui ne sont pas clairement liés à un créateur d'une [difficulté invité](/wiki/Beatmap/Guest_difficulty) ou à un niveau de difficulté.** (e.g. Beatmap Creator's Tragic Love Extra)
- **Les noms d'utilisateur indiquant la possession d'une [difficulté des invités](/wiki/Beatmap/Guest_difficulty) doivent être cohérents entre plusieurs beatmaps.** Les différents surnoms d'un même utilisateur rendent l'interprétation de l'auteur d'une difficulté ambiguë ou trompeuse.
- **Évitez les caractères Unicode non alphanumériques dans le nom d'une difficulté.** Ceux-ci peuvent provoquer des erreurs dans le système de soumission des beatmaps et des problèmes pour certains utilisateurs lorsqu'ils apparaissent dans le tchat. 
...
- **Vous devez utiliser le champ Source si la musique provient ou est directement liée à un autre média tel qu'un jeu vidéo, un film, une série, un événement, etc.** Cela s'applique également si la musique a été présentée ou liée à un média après sa sortie, mais qu'elle est principalement connue grâce à cette source. Si une musique a plusieurs sources potentielles, toutes les options sont valables. 
  ...
  - Dans les cas où une [compilations de musiques](/wiki/Beatmapping/Song_compilation)/remix/medley/etc. comporte des musiques sans source commune, les sources doivent être placées dans les tags au lieu du champ source (sauf si la compilation est liée de manière évidente à une source elle-même).
  - Le terme `osu!` lui-même ne doit jamais être utilisé dans le champ source, sauf dans les cas où la piste a été spécifiquement créée pour osu! (également connu sous le nom *osu! original*), comme les pistes de départage de tournois commandés.
...
- **Si la musique mappée est une musique sous licence de la bibliothèque Featured Artist, il faut ajouter `featured artist` aux tags.**
- **Les tags doivent être liées à la beatmap et ne pas induire en erreur pour les résultats de recherche.** Les tags décrivant le style, la musique, le storyboard, la vidéo ou l'arrière-plan de la beatmap sont considérées comme liées à la beatmap.
...
- **Toute forme de `vs.`, `VS`, etc. doit être écrite comme `vs.` lorsqu'elle est utilisée comme indicateur de collaboration entre deux ou plusieurs artistes.** Une appellation alternatif peut être utilisé pour s'harmoniser avec le reste du champ.
- **Toute forme de `feat.`, `feat`, `ft.`, etc. doit être écrite comme `feat.` lorsqu'elle est utilisée comme indicateur d'un artiste figurant dans la musique.** Une appellation alternatif peut être utilisé pour s'harmoniser avec le reste du champ.
- **Lorsqu'un personnage fictif est crédité en tant que chanteur d'une musique, son crédit doit être formaté en tant que `Personnage (CV : Acteur vocal)`.** Pour les films en direct, ne créditez que la voix de l'acteur.
- **Si une musique est utilisée dans un programme de télévision, une série web ou une série en vidéo directe, comme une musique d'ouverture/fin/insertion, utilisez un marqueur `(TV Size)` à la fin du titre actuel.** S'il y a un marqueur de taille TV existant dans le titre, remplacez-le par `(TV Size)`.
...
- **Les versions coupées non officielles des musiques doivent ajouter un marqueur `(Cut Ver.)` à la fin du titre courant.** Si un marqueur de longueur figure déjà dans le titre du morceau, `(Cut Ver.)` le remplacera. Cela permet de distinguer les coupures non officielles d'une musique des versions complètes. Les musiques qui sont raccourcies d'une manière qui correspond presque à leur version officielle, et les musiques qui sont une boucle complète d'une piste en boucle ne seront pas considérées comme coupées.
...
- **Si une série applicable comme source contient des sous-séries, le tag le plus précis doit être utilisée comme source.** Si une musique a plusieurs sous-séries applicables, la série/franchise principale peut être utilisée à la place.
...
- **Les musiques dont les métadonnées sont en russe/cyrillique doivent être romanisées en utilisant la méthode du système BGN/PCGN dans les champs romanisés.** Il en va de même pour le champ Source si le mappeur préfère une source romanisée. Е et е doivent être romanisés en `ye` s'ils sont seuls ou après `a`, `e`, `ё`, `и`, `о`, `у`, `ы`, `э`, `ю`, `я`, `й`, `ъ`, `ь`. Dans les autres cas, il doit être romanisé en `e`. `ё` doit être romanisé en `yo`, cependant, utilisez `o` si le caractère vient après `ж`, `ч`, `ш`, ou `щ`. Ignorez toutes les autres règles dans le fichier fourni, elles ne sont pas pertinentes ou n'aideraient pas dans le jeu. Pour la plupart des autres caractères, reportez-vous à la [première page de ce document](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/807920/ROMANIZATION_OF_RUSSIAN.pdf).
...
- **Les musiques dont les métadonnées contiennent des caractères unicode ambigus ou difficiles à écrire doivent ajouter aux tags de la beatmap des variations ou des romanisations facilement recherchées de ces mots.**
...
- **Pour les musiques où le(s) compositeur(s) et le(s) chanteur(s) sont des personnes différentes, le(s) chanteur(s) peut(vent) être listé(s) après le(s) compositeur(s) ou le nom du cercle/groupe après un indicateur `feat.`.**
...
- **Si la musique d'une beatmap a été réalisée par plusieurs artistes, ils peuvent être listés avec des virgules entre eux.** S'il y a trois artistes ou plus qui contribuent et qu'ils ne font pas partie d'un groupe officiellement étiqueté, `Various Artists` ou d'autres tags d'artistes descriptives peuvent être utilisées à la place.
- **Pour les remixes/reprises, l'artiste original peut être utilisé dans le champ artiste, à condition que le champ titre soit modifié pour indiquer clairement que la musique est remixée.** Ce marqueur doit être entre parenthèses et contenir l'artiste Remix/Cover suivi du descripteur.

## Timing

### Règles

- **Les [points de timing non hérités](/wiki/Client/Beatmap_editor/Timing#points-de-timing-non-hérités) doivent être utilisés pour mapper avec précision les signatures temporelles de la musique.** Si une signature temporelle incorrecte dure plus d'une mesure, un point de temps non hérité doit être ajouté sur le prochain downbeat pour réinitialiser la signature temporelle. Pour les signatures #/4 non supportées par l'éditeur, les réinitialisations du métronome ou l'édition du fichier `.osu` sont acceptables. Pour les autres signatures temporelles non prises en charge, reportez-vous à ce [tableau exemplaire](/wiki/shared/timing/Timing_signature_reference_chart.png), et consultez [ce guide](/wiki/Ranking_Criteria/Timing_Songs_With_8-Signatures) pour plus d'informations.
- **Les beatmaps doivent être parfaitement timé.** Cela signifie que le [BPM](/wiki/Beatmapping/Beats_par_minute) et l'[offset](/wiki/Beatmapping/Offset) sont exactement synchronisés avec la chanson. Les beatmaps dont le BPM change constamment peuvent être impossibles à timer parfaitement et doivent être aussi précis que possible sans affecter négativement la jouabilité. Un timing complexe pendant les breaks ou les spinners est facultatif.
- **Les [points de timing non hérités](/wiki/Client/Beatmap_editor/Timing#points-de-timing-non-hérités) doivent être les mêmes dans toutes les difficultés d'une beatmap.** Chaque point doit avoir le même [BPM](/wiki/Beatmapping/Beats_par_minute) et [offset](/wiki/Beatmapping/Offset) dans chaque difficulté.
- **Il ne doit pas y avoir de [points de timing non hérités](/wiki/Client/Beatmap_editor/Timing#points-de-timing-non-hérités) supplémentaires dans aucune difficulté.** Ils peuvent accidentellement affecter les pulsations du menu principal, ajouter des sons indésirables au mod Nightcore ou provoquer un décalage du timing. Les utilisations acceptables sont les suivantes :
...
- **Le premier [point de timing non hérité](/wiki/Client/Beatmap_editor/Timing#points-de-timing-non-hérités) d'une beatmap ne peut pas être utilisé pour activer/désactiver le kiai.** Si vous faites cela, le kiai clignotera avant que les objets n'apparaissent. Un [point hérité](/wiki/Client/Beatmap_editor/Timing#points-de-timing-hérités) dans la même position que le premier point non hérité doit être utilisé pour faire clignoter le kiai à la place.
- **Les objets doivent être snapped aux ticks de la timeline, conformément à AiMod.** Les objets d'une section musicale nécessitant des diviseurs de temps non supportés (par exemple 1/11) peuvent soit :
  - Non snapped, tant qu'ils s'alignent sur le diviseur de l'instant de battement prévu.
  - Être snapped par un changement temporaire du [BPM](/wiki/Beatmapping/Beats_par_minute).
- **Un objet qui est mal snapped parce qu'il passe ou se termine légèrement avant un nouveau [point de timing non hérité](/wiki/Client/Beatmap_editor/Timing#points-de-timing-non-hérités) doit voir son tail snapped dans la nouvelle section de timing.** Pour les spinners et les notes longues d'osu!mania, cela peut être réalisé en faisant glisser l'extrémité de l'objet dans la timeline. Pour les sliders, cela peut être réalisé en manipulant le slider velocity ou en éditant le fichier `.osu`.

## Audio

### Règles

- **Le fichier audio d'une beatmap doit utiliser le format de fichier `.mp3` ou `.ogg` et avoir un débit binaire moyen ne dépassant pas 192kbps.**
...
- **Le fichier audio et les fichiers hitsound d'une musique doivent être de qualité raisonnable.** Essayez de trouver le fichier source de la plus haute qualité disponible plutôt que d'extraire un fichier d'un site de vidéo en continu. Les musiques doivent être normalisées en fonction de leur volume de sortie original et ne doivent pas être encodées à un débit binaire supérieur à celui de leurs fichiers originaux.
- **Les beatmaps doivent être hitsoundé.** Les hitnormal donnent un feedback au joueur, et les ajouts (whistles, claps, et finishes) accentuent les parties les plus importantes de la musique.
  - **Les beatmaps d'osu!mania ne nécessitent pas l'ajout de hitsound.** Cela permet de faciliter l'approche des mappeurs osu!mania de différentes origines. Il est toujours fortement recommandé d'ajouter des hitsounds afin d'améliorer la sensation de vos beatmaps. Dans les cas où les hitsounds ne sont pas utilisés, *aucun* ajout ne peut être placé, et *aucun* point de contrôle de l'échantillon ne doit être utilisé (par exemple pour ajuster le volume).
- **Tous les objets sur lesquels on clique doivent avoir des [hitsounds actifs](/wiki/Beatmapping/Hitsound#hitsound-actif) audibles.** Les difficultés d'osu!mania en sont exemptes en raison de la construction rythmique du mode.
- **Les [hitsounds actifs](/wiki/Beatmapping/Hitsound#hitsound-actif) doivent utiliser les formats de fichier `.wav` ou `.ogg`.** Les fichiers `.mp3` ont de légers retards, et sont donc réservés aux [hitsounds passifs](/wiki/Beatmapping/Hitsound#hitsound-passif), plus longs comme les bruits d'ambiance.
- **Les [hitsounds actifs](/wiki/Beatmapping/Hitsound#hitsound-actif) ne peuvent avoir un délai supérieur à 5 millisecondes.** "Le "Delay" prend en compte le pic d'un son plutôt que son introduction. Cela permet de synchroniser efficacement le retour du hitsound avec une musique. Le skin par défaut `normal-hitfinish.wav` a un léger retard, mais peut toujours être utilisé comme un hitsound personnalisé.
...
- **Les [sons de jeu](/wiki/Skinning/Sounds#gameplay) à l'exception des [hitsounds actifs](/wiki/Beatmapping/Hitsound#hitsound-actif) doivent utiliser les formats de fichier `.mp3` ou `.ogg`.** Ces fichiers ont généralement de longues durées et les fichiers .wav sont inutilement volumineux en comparaison, mais les fichiers .wav doivent être utilisés lorsqu'ils permettent d'obtenir une taille de fichier plus petite.
- **Évitez de remplacer la finition des hits dans les jeux d'échantillons soft/normal par des échantillons de hits personnalisés fréquemment utilisés.** L'utilisation de ces finitions pour représenter des caisses claires/basses ou la mélodie d'une musique peut sonner de façon désagréable pour toute personne désactivant les hitsounds des beatmaps. Il est recommandé de remplacer les hits sifflets/claps parce que ces échantillons sont utilisés plus souvent. Les beatmaps osu!taiko sont exemptés de cette directive et ont leur propre directive d'échantillon de hitsound spécifique au mode.

## Vidéo et arrière-plan

### Règles

- **Vous devez avoir un arrière-plan sur chaque difficulté de votre beatmap.** Des arrière-plan différents pour des difficultés différentes sont acceptables.
...
- **Le [offset](/wiki/Beatmapping/Offset) d'une vidéo doit être correct s'il est timer avec la musique.** Un offset incorrect peut donner lieu à une représentation visuelle trompeuse de la chanson. Si la même vidéo apparaît dans plusieurs difficultés, elle doit toujours avoir le(s) même(s) offset(s).
...
- **Les éléments skinnée doivent être conservés au format `.png` s'ils utilisent la transparence.** S'ils n'utilisent aucune transparence, ils peuvent utiliser le format qui utilise le moins d'espace et qui est supporté pour le skinning dans osu!.
...
- **Pensez à laisser une bordure de transparence d'un pixel autour des images de storyboard des sprites tournés pour que l'interpolation fonctionne correctement.** osu! n'utilise pas l'anticrénelage autour des images, et en tant que tel, cela devient très visible si les bords sont visibles et que le sprite est tourné.
...
- **Assurez-vous que le storyboard est optimisé au maximum,** dans la mesure du possible.
  ...
  - **Suppression des sprites activés par les déclencheurs après utilisation.** Les déclencheurs s'activent dès leur première commande possible et restent actifs jusqu'à la fin de la difficulté, c'est pourquoi il est préférable de les éteindre lorsqu'ils sont terminés.
