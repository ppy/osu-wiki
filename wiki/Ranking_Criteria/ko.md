...
- **가이드라인(Guidelines):** 가이드라인은 **예외적인** 상황에서 어길 수 있습니다. 이러한 예외적인 경우는 반드시 가이드라인을 어긴 이유와 왜 그렇게 하지 않으면 창작물의 퀄리티가 떨어지는지에 대해 자세한 설명을 통해 정당화되어야 합니다.
...
- **만약 각 난이도의 [드레인 타임](/wiki/Gameplay/Drain_time)이...**
  ...
  - ...**3분 30초에서 4분 15초 사이라면,** 포함된 각 게임 모드의 최하 난이도는 Hard보다 어려워서는 안 됩니다.
