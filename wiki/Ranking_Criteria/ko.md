...
- **비트맵 설명란에 비트맵에서 사용된 콘텐츠의 창작자를 명시해야 합니다.** [콘텐츠 사용 가이드라인](/wiki/Rules/Content_Usage_Guidelines)에 따라, 비트맵에 사용된 콘텐츠는 osu!에서 사용할 수 있도록 허가를 받아야 하며 창작자가 설정한 라이선스에 맞추어 명시해야 합니다. 출처를 찾기 어렵거나 창작자가 출처 명시를 원치 않은 경우, 혹은 아티스트, 제목, 출처 필드에 명시되어 있다면 추가로 명시하지 않아도 됩니다.
