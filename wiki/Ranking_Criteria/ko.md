...
- **곡 2개가 합쳐진 비트맵은 긴 곡의 길이에 해당하는 최소 스프레드 요구 사항을 따라야 합니다.**[^songs-comp-note] 위에서 설명한 시간제한을 회피하기 위해 곡을 인위적으로 확장하는 것을 방지하기 위함입니다. 독점적으로 함께 발매된 곡의 경우에는 예외가 될 수 있습니다.
