...
**Спейсинг должен быть постоянным,** дабы приучить игроков к зависимости между появлениями нот в музыке и их положением на игровом поле. В общем и целом, вы должны стремиться к идеально читаемой сложности, которая при этом не будет однообразной в плане ритма. К читаемости также относится выбор AR: он должен подходить к [BPM](RU:BPM "wikilink") и скорости слайдеров, чтобы на поле не появлялось нагромождений нот.
...
В [критериях ранкинга](RU:RC "wikilink") написано следующее:
