**Ranking Criteria – Minősítési Kritériumok**
...
-   **Meg kell vágnod az mp3 fájlt, ha kevesebb, mint 80%-át használod.** Ebbe nem tartozik bele az intro, így ez csak arra vonatkozik, ha az outro több, mint 20%-a nincs mapelve. Ha a számnak csak egy részét tervezed mapelni, akkor az egész mp3 fölöslegesen foglalja a helyet. Sok olyan mp3 szerkesztő program létezik, mint pl. \[url=<http://osu.ppy.sh/forum/viewtopic.php?f=56&t=34303%5Dez%5B/url%5D>, ami egyszerűvé teszi a szám elhalkítását és megvágását. Viszont ha megfelelő okod van arra, hogy az egész mp3 fájlt megtartsd (pl. a map vége után még folytatódó storyboard miatt), akkor az rendben van.
...
-   **A Kiai-k kezdődjenek fehér csíkon** (vagy ami még általánosabb, a nagy fehér csíkon (\[url=<http://osu.ppy.sh/forum/viewtopic.php?f=10&t=20998%5Ddownbeat%5B/url%5D>)). Általában ezen a ponton kezdődik a refrén fő része.
-   **A dal ne legyen túl hosszú.** Próbáld meg 3 percben maximalizálni; bármi, ami hosszabb, fárasztóvá válik. Amennyiben szükséged van segítségre, hogy egy dalt rövidebbre vágj, kérdezz nyugodtan a fórum \[url= <http://osu.ppy.sh/forum/viewforum.php?f=56>\] Általános Kérdések (General Questions)\[/url\] részében.
