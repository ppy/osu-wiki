...
-   **Todo slider deve ter um caminho visível e limpo do começo ao fim.** Sliders que cobrem a si mesmos de uma forma que fazem uma seção ilegível ou ambígua (incluindo [Burai sliders](/wiki/Mapping_Techniques/Sliders)) não podem ser usados. Isso serve para que nenhum tenha aparência confusa ou impossível de ser lida. Além disso, as bordas do slider nunca devem ser cobertas por causa da curva do slider ser muito compressa. Porém, sliders que cruzam a si mesmos não são um problema desde que as bordas estejam perfeitamente visíveis.
...
-   **A adição de notas deve seguir a regra de distancia/tempo** (usando [distance snap](/wiki/Beatmap_Editor/Distance_Snap) para auxiliar nesse processo). Isso significa que você não deve ter notas rápidas com uma enorme distancia seguidas por notas próximas (porém lentas). Isso se torna muito confuso se o jogador não foi a pessoa que criou o beatmap! Ter lógica na colocação de notas deve ser sempre uma das suas metas.
