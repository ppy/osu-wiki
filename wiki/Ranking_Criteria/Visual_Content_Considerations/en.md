...
We ask that you take these considerations into mind when determining whether something is appropriate for osu! or not, and also understand that we are an all-ages game with a multicultural userbase that has widely varied expectations for the media we consume. What is acceptable to one person may not be acceptable to another.
...
Any imagery that portrays gore, mutilation, severe maiming, wounding or graphcial depictions of recent death with an obvious cause present (such as hanging, choking or bleeding out) is not acceptable or to be tolerated.

### Depictions of sexual innuendo in excess
...
Any imagery that imitates sexual acts or involves obviously phallic objects is not acceptable.

### Depictions of explicit or sexual posturing

Any imagery that is highly suggestive or directly implies imminent sexual intent or anticipation is not allowed.

This also applies to "accidental" posturing, such as imagery depicting characters being caught unawares during bathing, or other such situations
...
Ideal content for use in osu! is benign and able to be consumed by an all-ages audience. When in doubt, consult the local classification for such material (if available) - if it is considered as suitable for an audience under the age of 12 (PEGI12 or a "G" rating in the US and Commonwealth countries), it should largely be acceptable.
...
Highly excessive is a broad term, but is generally taken to mean when an image treads well into the line of questionable content, such as when a character may be wearing a swimsuit far too small to adequately cover their physical assets, or said physical assets command a dominating amount of the scene.
...
Any depiction of classical artwork or the rendition of the human form where the portrayal of full-frontal or partial nudity is done in a strictly artistic and non-sexual context may be allowed upon review from the GMT.

However, said artistc nudity must possess some contextual relevance to the other content it is associated with in order for this exception to apply.

### Romance or intimate affection
...
The anecdotal 'rule of thumb' is that one should generally be comfortable with their family members or other judgmental authority figure viewing the content and be capable of adequately explaining what is going on in it. 
