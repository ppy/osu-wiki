...
- ![](/wiki/shared/diff/easy-o.png) Beginner: i en standard Easy-Normal-Hard-Insane-Expert- spridning hänvisar den till den lägsta svårighetsgraden, även under Easy.
- ![](/wiki/shared/diff/normal-o.png) Advanced: i en standard Easy-Normal-Hard-Insane-Expert- spridning är det en svårighetsgrad mellan Normal och Hard.
- ![](/wiki/shared/diff/hard-o.png) Hyper: i en standard Easy-Normal-Hard-Insane-Expert- spridning är det en svårighetsgrad mellan Hard och Insane.
- ![](/wiki/shared/diff/expert-o.png) Extra: kan användas som ersättning för Expert.
- ![](/wiki/shared/diff/expertplus-o.png) Extreme: kan användas för att representera en beatmap svårare än Expert.
