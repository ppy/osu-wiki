...
- **Используйте 1/2 только в примитивных паттернах, после которых идёт перерыв.** В них также не должно быть финишеров. Если песня построена на свинг-ритме, это ограничение заменяется на 1/3.
...
- **Между нотой и началом спиннера должен быть перерыв длиной минимум 1/2,** чтобы не было сильного оверлапа, и оба объекта легко читались.
- **Оставляйте перерыв длиной как минимум 3/1 после каждого непрерывно замапанного участка длиной от 16/1 до 20/1.** Перерывы можно ставить и реже, если они не сочетаются с песней, либо если отрезок карты и так достаточно сильно щадит игрока.
...
- **Между нотой и началом спиннера должен быть перерыв длиной минимум 1/2,** чтобы не было сильного оверлапа, и оба объекта легко читались.
- **Оставляйте перерыв длиной как минимум 2/1 после каждого непрерывно замапанного участка длиной от 16/1 до 20/1.** Перерывы можно ставить и реже, если они не сочетаются с песней, либо если отрезок карты и так достаточно сильно щадит игрока.
...
- **Между нотой и началом спиннера должен быть перерыв длиной минимум 1/4,** чтобы не было сильного оверлапа, и оба объекта легко читались.
