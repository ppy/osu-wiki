...
- **Слайдер / барабанная дробь (drumroll):** жёлтая полоса с точками, которая выбивается нажатиями любых клавиши. Точки обычно расставлены под 1/4 в зависимости от BPM песни. Если BPM ниже 125, расстановка точек меняется на 1/8, если выше 250 — на 1/2. В случае, если частота слайдертиков равна 3, точки будут расставлены под 1/3.
