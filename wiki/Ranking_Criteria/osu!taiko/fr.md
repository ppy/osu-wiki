...
Ces directives et conseils ont été discuté dans [ce sujet](https://osu.ppy.sh/community/forums/posts/1275323). De nouvelles règles ou recommandations peuvent être suggérées dans [ce forum](https://osu.ppy.sh/forum/87) et seront mises en place lorsqu'une décision est prise.
...
Utilisez les avec modération et gardez un espace d'1/2 entre eux et une note adjacente. Evitez les Sliders pour des musiques de 125 BPM ou moins (car les ticks se changent en 1/8) sauf si vous pensez qu'ils se couplent bien avec la musique. Utilisez un Tick Rate égal à 3 si la musique est en 1/3.

-   **Shakers (Spinners)**

Utilisez les avec modération et gardez un espace d'1/2 entre eux et une note adjacente. Vous pouvez les utiliser pendant les streams. Les Spinners courts sont déconseillés car ils recouvrent les notes suivantes et peut causer le joueur à miss à force d'appuyer frénétiquement sur les touches.
