...
- **The drum sampleset must not be used unless default hit sound samples are replaced by custom samples.** The sampleset's default hit sounds do not follow the tone guideline for dons and kats.
