...
- **Beatmapsets cannot contain significant portions of difficulties belonging to other users without their explicit involvement or permission.** Guest difficulties (with involvement from the guest) are ok; this is more aimed at preventing potentially stolen beatmaps from being ranked. If you as a modder find the original beatmap(s), and there is no permission given, link those in the discussion of the offending beatmapset and wait for a resolution.
