...
- **The audio file of a song should have average peak frequencies of 16kHz or higher.** Lower values usually result in noticeably low audio quality and it is recommended to use a better `.mp3` unless none can be found. Average peak frequency can be shown in [audio spectogram generators](http://spek.cc/), which typically display 128kbps and 192kbps songs with average peak frequencies of 16kHz and 18kHz respectively. 
