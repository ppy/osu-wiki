...
- **Artist names should be consistent between different songs from the same person or group in the Ranked or Loved sections.** This is unless the person or group intentionally uses a different alias for different song or album releases.
