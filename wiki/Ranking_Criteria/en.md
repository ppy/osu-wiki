...
- **If a symbol is used to group part of a title, the group including the surrounding symbols must be surrounded by a space before and after.** For example, `Song★Title★` becomes `Song ★Title★`.
