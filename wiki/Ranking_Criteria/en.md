...
- **Hit objects must be snapped within less than 2 ms of any timeline tick.** AiMod will report these issues, as well as rare false positives. Objects in a musical section requiring unsupported beat snap divisors (e.g. 1/11) can either:
