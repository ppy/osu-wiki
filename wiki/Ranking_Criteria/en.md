...
- **When a fictional character is credited as the singer of a song, the artist is to be formatted in a `Character (CV: Voice Actor)` format.** For live action, credit the voice actor only.
