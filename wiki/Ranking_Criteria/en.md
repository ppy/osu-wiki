...
- **If the [drain time](/wiki/Gameplay/Drain_time) of each difficulty is...**
  ...
  - **osu!mania beatmaps are binded by a different set of spread rules defined in the [osu!mania-specific Ranking Criteria](https://osu.ppy.sh/wiki/en/Ranking_Criteria/osu%21mania).** This is to allow for easier approachability to osu!mania mappers of different upbringings, and to account for the special characteristics of the mode's rhythm construction.
