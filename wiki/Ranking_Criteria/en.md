...
- **Completely silent sound files must use [this 44-byte file](https://up.ppy.sh/files/blank.wav "uppppy").** Other files have unnecessarily large file sizes and 0-byte files do not function.
