...
- **If the [drain time](/wiki/Gameplay/Drain_time) of each difficulty is...**
  ...
  - **If the song is sufficiently complex, exceptions can be made to omit the requirement for a Normal difficulty.** This applies to songs containing long sections of exclusively unorthodox rhythms, frequent metronome resets, or BPM changes. These songs provide a poor experience for new players as they lack an intuitive layer to follow, making them inherently difficult to comprehend.
