Só lembrando, Já estão incluidas as mudanças recentes feitas For the record, these include the recent changes made [pelo forum de discussão](http://osu.ppy.sh/forum/87). Qualquer regra que estiver sendo discutida será listada aqui como de costume e será atualizada uma vez que a discussão chegue a uma conclusão.

Termos
======

-   Não-expert = Easy, Normal. (Basic, Standard)
-   Expert = Hard, Insane. (Hyper, Another)
-   Coluna = 5K, 5 colunas. A coluna central é algumas vezes chamada de Especial ou Step column.
...
Observação: 1K, 2K, 3K, 9K <span style="text-decoration:line-through;">e 10K</span> são de uma atualização instável, não é recomendado mapeá-los no momento.
