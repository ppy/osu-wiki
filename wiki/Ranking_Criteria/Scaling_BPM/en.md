...
The Ranking Criteria's rules and guidelines are based around songs of 180BPM with 4/4 time signatures. This guide clarifies how that scaling works!
...
For the most part, 120BPM and 240BPM act as breaking points for when a map's rhythm should be doubled and halved according to guidelines. As BPM approaches these values, rhythm should reflect that through changes in density. For the sake of this example guideline, it's best to assume that using 1/4 above 120BPM or 1/2 above 240BPM is not a good choice for a Normal difficulty.

The same general concept applies to other rhythm-related guidelines as well, such as the osu! Normal difficulty guideline, "**Avoid more than three actively clicked 1/2 rhythms in a row.**" As BPM increases from 180 to 240, active 1/2 should be gradually removed and frequency of conseuctive 1/2 sliders should go down. As BPM decreases from 180 to 120, active 1/2 can gradually increase as well as 1/2 slider usage.

While this guide is oriented around guidelines for osu! Normal difficulties, it also applies to other difficulties and game modes. For example, osu! Easy difficulties require 4 beats of recovery time after spinners according to the Ranking Criteria. At 180BPM, that is true, however at 120BPM, it would be fine to use 3 beats of recovery, and that could gradually shift to 2 beats at 90BPM.
