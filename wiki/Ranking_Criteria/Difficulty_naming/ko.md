...
난이도 명은 맵이 얼마나 어려운지를 나타내야 하므로, 이 문서에서는 오랜 시간동안 일반적으로 사용된 이름 및 대체적으로 사용된 이름을 제시합니다. 그러나 비트맵의 각 난이도 차이를 명확하게 설명하고 있는 한 원하는 형태로 난이도 명을 작성할 수 있습니다.

## 기본

다음 난이도 명은 각 게임 모드에서 가장 일반적으로 쓰인 것입니다.

*참고: **Marathon** 난이도는 예전에 플레이 타임이 긴 맵을 업로드 하기 위해 필요했던 이름으로, 단일 난이도에 자주 쓰이게 됐습니다. 요즘에는 긴 맵이나 송 컴필레이션에 특별한 의미 없이 대중적으로 쓰입니다.*
...
다른 리듬 게임에서 가져온 음악의 비트맵셋은 종종 해당 게임의 난이도 명을 차용합니다. 또한 해당 난이도 명은 다른 음악에도 사용할 수 있습니다. 다음은 osu!에 적용되는 몇 가지 작명 방식입니다:
