...
Зачастую, когда в osu! мапают песню из другой ритм-игры, вместе с этим заимствуют и схему наименования сложностей. Тем не менее, эти названия можно использовать для любых песенё — здесь они приведены в качестве примера того, как организовать карту.
...
*Примечание: карты песен из SOUND VOLTEX, где много сложностей, часто содержат названия из нескольких версий игры, даже если песня появляется далеко не везде.*
