...
- **Avoid using extremely short long notes (shorter than 1/12 of a beat)**. Shorter long notes may be unreasonable to play with full accuracy due to software or hardware limitations.
