...
- **Slider velocity**: The speed at which the notes/bar lines move on the playfield. Base slider velocity (1.0x) is based on the user's set scroll speeds and additional changes can be made through inherited (green) timing points.
