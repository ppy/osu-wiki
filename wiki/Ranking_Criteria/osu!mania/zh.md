...
所有的规定都是硬性的_规定_。他们_不同于_指南，在_任何_情况下都_不应_被打破。
...
_键位模式相关的指南基于最常用的 Ranked 键位（4 键和 7 键）建立。当可用时，其他键位也应适用相应的指南。_
...
如果Normal是_谱面集中的最低难度_，这些附加**规定**同样适用：
...
如果Hard是_谱面集中的最低难度_，这些额外的**指南**同样适用：
