...
- **Если [игровое время](/wiki/Beatmap/Drain_time) карты…**
  - **…короче 2:30**, то самая низкая сложность для каждого числа клавиш не должна превышать Normal, **ЛИБО** для каждого числа клавиш нужно замапать прогрессию сложностей, начинающуюся как минимум на 3 уровня раньше самой высокой сложности.
  - **…между 2:30 и 3:15**, то самая низкая сложность для каждого числа клавиш не должна превышать Hard, **ЛИБО** для каждого числа клавиш нужно замапать прогрессию сложностей, начинающуюся как минимум на 2 уровня раньше самой высокой сложности.
  - **…между 3:15 и 4:00**, то самая низкая сложность для каждого числа клавиш не должна превышать Insane, **ЛИБО** для каждого числа клавиш нужно прогрессию сложностей, начинающуюся как минимум на 1 уровень раньше самой высокой сложности.
...
- **Если в карте есть несколько тайминг-секций, они должны иметь единую скорость прокрутки, достигнутую с помощью изменения SV.** Для этого нужно скорость прокрутки каждой секции заменить на наиболее часто используемую скорость. Нужное вам число показывается в скобках на экране выбора песен там, где указан диапазон BPM, например, `BPM: 60-160 (130)`. Эта рекомендация не распространяется на перепады скорости, созданные намеренно (SV-эффекты).
