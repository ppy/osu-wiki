...
- **Если [игровое время](/wiki/Beatmap/Drain_time) каждой сложности…**
  - **…короче 2:30**, то самая низкая сложность для каждого числа клавиш не должна превосходить Normal, **ЛИБО** для каждого числа клавиш нужно замапать прогрессию[^proper-spread] как минимум из 4 сложностей.
  - **…между 2:30 и 3:15**, то самая низкая сложность для каждого числа клавиш не должна превосходить Hard, **ЛИБО** для каждого числа клавиш нужно замапать прогрессию[^proper-spread] как минимум из 3 сложностей.
  - **…между 3:15 и 4:00**, то самая низкая сложность для каждого числа клавиш не должна превосходить Insane, **ЛИБО** для каждого числа клавиш нужно замапать прогрессию[^proper-spread] как минимум из 2 сложностей.
