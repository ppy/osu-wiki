...
Если в карте присутствуют только сложности уровня *Insane и выше*, то прогрессия — это набор сложностей с примерно такими же относительными изменениями, как между более простыми [сложностями](/wiki/Beatmap/Difficulty#уровни-сложности) — см. [Критерии для отдельных сложностей](#difficulty-specific).
