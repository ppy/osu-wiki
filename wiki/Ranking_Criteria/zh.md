...
- **带有日文元数据的歌曲必须使用[平文式罗马字](https://https://zh.wikipedia.org/wiki/%E5%B9%B3%E6%96%87%E5%BC%8F%E7%BD%97%E9%A9%AC%E5%AD%97)罗马音化。** 如果作图者偏好罗马音的 Source，则也应用于该字段。对于非 Unicode 域，长元音如 `おう` 和 `うう` 应该写作罗马音 `ou` 和 `uu`，以避免长元音符号。
