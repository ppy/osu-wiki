...
- **歌曲不应被人为延长以突破谱面上架标准规定的掉血时间最低难度限制。** 包括但不限于：重复播放歌曲的部分段落，降低整首歌或者歌曲一部分的 [BPM](/wiki/Beatmapping/Beats_per_minute)，或者增加一小段突兀不合曲的音乐等。如果制作[歌曲混编](/wiki/Beatmap/Song_compilation)，或者音频文件短于 30 秒，则可忽略此条准则。
- **如果谱面结尾空白部分大于等于歌曲全长的 20%，则应截短歌曲。** 谱面的前奏空白段不包括在内。如果谱面结尾空白部分存在视频或故事板，或因为这部分歌曲段落因为含有复杂变奏、有渐出效果而不适合制作谱面时，则可忽略此条准则。
- **编入[歌曲混编](/wiki/Beatmap/Song_compilation)的单曲数量应大于等于 3 首。** 若只编入两首单曲，对于玩家来说会非常无趣。此时将其拆分成两张单独的谱面会更好。如果编入的两首单曲属于独家同时发布，则可忽略此条准则。
