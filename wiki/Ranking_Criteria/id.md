...
- **Objek ketukan wajib disnap dalam waktu kurang dari 2 ms dari setiap *timeline tick*.** [AiMod](/wiki/Client/Beatmap_editor/AiMod) akan melaporkan masalah ini, serta dengan laporan positif palsu yang jarang terjadi. Positif palsu terjadi, terutama pada ujung slider dan sebalikannya, dan harus diverifikasi secara manual atau dengan alat-alat lain. Objek di bagian musik yang membutuhkan pembagi beat snap yang tidak didukung (mis. 1/11) dapat:
...
- **Berkas audio dari sebuah beatmap wajib...**
  ...
  - **...memiliki rata-rata bit rate tidak kurang dari 128 kbps**, apabila tidak menemukan sumber yang lebih baik. Sebaliknya, gunakan ketersediaan kualitas yang lebih baik.
  - **...tidak di-*encoded* ke lebih tinggi dari bitrate yang rendah.**
...
- **Berkas audio dan berkas hitsound dari sebuah beatmap tidak boleh menampilkan distorsi suara terdengar dan tanpa sebab**, seperti *clipping*, *muffling*, atau *crackling* yang jelas-jelas tidak dimaksudkan oleh artis atau bukan bagian dari identitas lagu. Penentuan tentang ini paling baik dengan mendengarkan audio, daripada menggunakan perangkat lunak.
