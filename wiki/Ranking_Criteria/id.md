...
- **Jika karakter fiksi digunakan sebagai penyanyi lagu, nama mereka harus dirubah dalam format `Nama Karakter (CV: Aktor Suara)` atau format `Nama Karakter (CV: Aktor Suara)`[^character-voice-actor].** Untuk laga hidup, gunakan pengisi suara saja.
