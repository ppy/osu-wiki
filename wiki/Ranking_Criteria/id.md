...
- **Beatmap harus terhitsound.** Hitnormals memberikan umpan balik kepada pemain, dan additions (peluit, tepuk tangan, dan penutup) memberi aksen pada bagian penting dari musik.
  - **Untuk beatmaps osu!mania yang hanya berisi tingkat kesulitan Insane atau lebih tinggi, additions tidak diperlukan.**
...
- **Setelan `Widescreen support` harus diaktifkan jika beatmap berisi storyboard untuk layar lebar.** Jika storyboard dirancang untuk resolusi 4:3, widescreen support harus dinonaktifkan. Pengaturan ini tidak akan memengaruhi apa pun di dalam beatmap yang tidak memiliki storyboard.
