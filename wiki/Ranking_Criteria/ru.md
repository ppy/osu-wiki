...
**Имейте в виду, что [нормы поведения](/wiki/Rules/Code_of_Conduct_for_Modding_and_Mapping), [руководство по таймингу песен с #/8-тактом](/wiki/Guides/Timing_Songs_With_8-Signatures), а также [правила для содержания песен](/wiki/Rules/Song_Content_Rules) являются частью критериев ранкинга и применяются ко всем существующим игровым режимам в osu!.**
