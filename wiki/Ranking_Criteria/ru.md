...
**Критерии ранкинга** — это свод [правил и рекомендаций](#общая-терминология) для [карт](/wiki/Beatmap), которые собираются участвовать в [процедуре ранкинга](/wiki/Beatmap_ranking_procedure).
...
- **Правила:** если что-то помечено как правила, то это нельзя нарушать **ни в каких случаях.**
