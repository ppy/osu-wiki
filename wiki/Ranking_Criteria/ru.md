...
**Имейте в виду, что [нормы поведения](/wiki/Rules/Code_of_Conduct_for_Modding_and_Mapping) и [правила для содержания песен](/wiki/Rules/Song_Content_Rules) являются частью критериев ранкинга и применяются ко всем существующим игровым режимам в osu!.**
