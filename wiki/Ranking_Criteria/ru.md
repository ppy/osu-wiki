...
**Критерии ранкинга** — это свод [правил и рекомендаций](#общая-терминология) для [карт](/wiki/Beatmap), которые участвуют в [процедуре ранкинга](/wiki/Beatmap_ranking_procedure).

Изменение этих правил и рекомендаций можно предлагать и обсуждать в [специальном разделе форума]((https://osu.ppy.sh/community/forums/87) — см. подробности в теме *[How to propose Ranking Criteria changes](https://osu.ppy.sh/community/forums/topics/720532)*. Правки, которые не затрагивают смысловое содержание документа (перефразировка, исправление опечаток, изменение структуры и т.д.), можно вносить без предварительного обсуждения на форуме.

**Обратите внимание: [кодекс поведения при моддинге и маппинге](/wiki/Rules/Code_of_Conduct_for_Modding_and_Mapping), а также [правила для содержания песен](/wiki/Rules/Song_Content_Rules) являются частью критериев ранкинга и применяются ко всем игровым режимам osu!.**

## Инструменты

Для проверки карты настоятельно рекомендуется использовать [Mapset Verifier (MV)](https://github.com/Naxesss/MapsetVerifier), поскольку [AiMod](/wiki/Client/Beatmap_editor/AiMod) из стабильной версии osu! уже устарел и давно не обновлялся, а в новой версии osu! (lazer) работа над проверками [ещё не закончена](https://github.com/ppy/osu/issues/12091#issuecomment-878760791).

При этом необходимо помнить следующее:

- Запуск автоматических проверок не избавляет вас от чтения критериев ранкинга и самостоятельной оценки карты.
...
- **Правила:** всё, что помечено как правила, и что нельзя нарушать **ни в каких случаях.**
- **Рекомендации:** все остальные пункты. Они могут быть нарушены при **исключительных** обстоятельствах, при этом от маппера ожидается подробное объяснение того, почему каждая из рекомендаций была нарушена и почему, если её не нарушить, качество карты ухудшится.
...
- **В карте не должно быть неприемлемых изображений.** Под этим понимаются [фоны](/wiki/Beatmap/Background)/сториборды/видео с наготой, сексуальными намеками, насилием, использованием наркотиков и т.д. — подробнее см. [критерии визуального содержания](/wiki/Rules/Visual_Content_Considerations).
- **Карты с пульсацией, яркими вспышками, быстрыми изменениями контраста, яркости или цвета в сториборде или видео должны содержать предупреждение об эпилепсии.** Если предупреждение мешает игре, необходимо увеличить вступление в аудиофайле. В большинстве случаев о пульсациях с частотой реже 3 мерцаний в секунду не нужно предупреждать. Если вы не уверены, то добавьте предупреждение и посмотрите, что скажут моддеры.
- **В папке с картой не должно быть файлов, которые не используются или имеют размер 0 байт.** Файлы, «весящие» 0 байт, препятствуют корректной публикации карты. Единственное исключение из этого правила — файлы `thumbs.db`.
- **[Перерывы](/wiki/Beatmap/Break) можно добавлять только через [внутриигровой редактор](/wiki/Client/Beatmap_editor).**
- **Точность [настроек сложности](/wiki/Client/Beatmap_editor/Song_Setup#difficulty) не должна превышать точность, настраиваемую через [внутриигровой редактор](/wiki/Client/Beatmap_editor).**
...
- **Авторы материалов, которые используются в карте, должны быть упомянуты в её описании.** В соответствии с правилами [использования медиа](/wiki/Rules/Content_Usage_Guidelines), творческие работы в osu! можно использовать только с разрешения их создателей — скорее всего, в тексте лицензии есть и требования к указанию авторства. Авторство можно не указывать по разным уважительным причинам, среди которых – сложность определения авторства, личное нежелание авторов, а также их упоминания в названии, источнике или исполнителе песни.
...
- **Каждый игровой режим должен содержать подборку сложностей. Она начинается с минимальной сложности, уровень которой зависит от [игрового времени](/wiki/Gameplay/Drain_time) песни.** Сложности должны идти по порядку, без пропусков, а также без сильных скачков в сложности игры.
...
- **Минимальное [игровое время](/wiki/Gameplay/Drain_time) карты — 30 секунд.**
- **Если игровое время карты…**
  ...
  - **При рассмотрении любой сложности, кроме самой высокой, в игровое время можно включать перерывы** (это **не** относится к сложностям с игровым временем короче 30 секунд). Если самая низкая сложность карты – Hard или Insane, то целесообразность её игровых элементов оценивается [номинаторами](/wiki/People/The_Team/Beatmap_Nominators) и членами [команды оценки номинаций](/wiki/People/The_Team/Nomination_Assessment_Team) соответствующего режима игры.
  - **Карты osu!mania подчиняются отдельным правилам в плане игрового времени и подборок сложностей — см. [критерии ранкинга osu!mania](/wiki/Ranking_Criteria/osu!mania).**
...
- **Наивысшая сложность карты должна соответствовать общей атмосфере песни.** Карта может состоять из одной сложности Easy или Normal, если её ритм не был упрощен. В противном случае необходимо добавить более высокие сложности (например, Hard).
...
- **Названия [гостевых сложностей](/wiki/Beatmap/Guest_difficulty), указывающие на их авторов, должны быть согласованы между несколькими картами.** Использование различных форм ника затрудняет понимание того, кто создал сложность, и вводит в заблуждение.
- **Избегайте не-алфавитно-цифровых символов Юникода в названиях сложностей.** Они могут привести к ошибкам при [публикации карт](/wiki/Submission), а также при появлении названия в чате у некоторых пользователей.
...
- **Ники создателей [гостевых сложностей](/wiki/Beatmap/Guest_difficulty), сториборда, скина и хитсаундов должны быть добавлены в теги карты.** Это необходимо, чтобы отдать должное авторам всех материалов, содержащихся в карте. Если в никах имеются одиночные символы, разделенные пробелами, то вместо пробелов необходимо использовать подчеркивания.
- **Метаданные должны браться из [первичных источников](/wiki/Beatmap/Primary_metadata_source).** Изменять такие метаданные разрешено только для [стандартизации](#стандартизация). Если первичных источников для песни не существует, используйте наиболее узнаваемые и распространённые метаданные.
...
- **Необходимо заполнить поле Source, если песня прозвучала во время какого-то ивента, в другом медиа — видеоигре, фильме, сериале и т.д., – или напрямую с ним связана.** Это также относится к песням, которые были выпущены независимо от медиа, но приобрели популярность преимущественно благодаря ему. Если потенциальных источников несколько, разрешается брать любой.
  ...
  - В случае [компиляций](/wiki/Beatmapping/Song_compilation), миксов, мэшапов и т.д. с песнями без общего источника названия источников нужно поместить не в Source, а в теги, если сама компиляция не имеет конкретного источника.
...
- **Если песня взята из библиотеки [Featured Artist](/wiki/Featured_Artists), в теги нужно добавить словосочетание `featured artist`.**
...
- **В тегах карты должны содержаться [жанр и язык песни](/wiki/Beatmap/Genre_and_language),** чтобы поиск по ним работал и внутри игры. Для инструментальных треков необходимо добавить тег `instrumental`. Этой рекомендации можно не следовать, если жанр и/или язык сложно определить (в случае нескольких вариантов рекомендуется добавить в теги их все).
...
- **Карты должны быть идеально затаймлены:** их [BPM](/wiki/Beatmapping/Beats_per_minute) и [оффсет](/wiki/Beatmapping/Offset) должны быть синхронизированы с песней. Если BPM постоянно меняется, вместо идеального используйте как можно более точный тайминг, который не вредит процессу игры. Допускается не настраивать сложный тайминг во время спиннеров и перерывов.
- **[«Красные» секции](/wiki/Client/Beatmap_editor/Timing#uninherited-timing-point) должны быть одинаковыми во всех сложностях карты.** У каждой секции должен быть один и тот же [BPM](/wiki/Beatmapping/Beats_per_minute) и [оффсет](/wiki/Beatmapping/Offset) во всех сложностях.
- **Ни в одной сложности не должно быть лишних [«красных» секций](/wiki/Client/Beatmap_editor/Timing#uninherited-timing-point),** поскольку они могут сбить пульсацию логотипа osu! в главном меню, добавить лишние звуки во время игры с модом [Nightcore](/wiki/Game_modifier/Nightcore), или сбить тайминг. Исключения:
...
- **Все объекты карты должны быть снапнуты (проверка производится через [AiMod](/wiki/Client/Beatmap_editor/AiMod)).** Если объект нужно поставить на момент, где в редакторе нет тика на временной шкале (например, в случае 1/11), допускается один из двух вариантов:
  - Оставить объект анснапнутым, но чтобы он был расположен согласно воображаемому шагу временной шкалы.
  - Временно изменить [BPM](/wiki/Beatmapping/Beats_per_minute) на участке карты, чтобы объект попадал на какой-нибудь тик шкалы.
...
- **Аудиофайл с песней должен быть формата `.mp3` или `.ogg` и иметь средний битрейт не выше 192 кбит/с.**
...
- **Аудиофайл с песней, а также хитсаунды должны быть приемлемого качества.** Постарайтесь найти источник, где можно взять аудио хорошего качества. Необходимо, чтобы аудио сохраняло оригинальный уровень громкости, а также не было перекодировано в более высокий битрейт.
- **В карте должны быть расставлены [хитсаунды](/wiki/Beatmapping/Hitsound).** Основные звуки (хитнормалы) обеспечивают обратную связь, а дополнения (свистки, хлопки и финиши) выделяют важные моменты песни.
...
- **Не удлиняйте аудиофайл только для того, чтобы подстроиться под рамки критериев ранкинга.** К порицаемым методам относятся закольцовывание участков аудио, понижение [BPM](/wiki/Beatmapping/Beats_per_minute) или искусственное добавление фрагментов музыки для заполнения (список неполный). Эта рекомендация не относится к [компиляциям](/wiki/Beatmapping/Song_compilation), а также аудиофайлам короче, чем минимально возможная ранкабельная длина песни.
...
- **Размеры фонового видео не должны превышать 1280 пикселей в ширину и 720 пикселей в высоту,** чтобы оно не было излишне большим. Кроме того, старайтесь не растягивать видео.
- **Видео должно быть закодировано с помощью кодека H.264.**
- **У видео должен быть выставлен правильный [оффсет](/wiki/Beatmapping/Offset), если оно синхронизировано с песней,** чтобы визуальное представление песни не вводило в заблуждение. Одно и то же видео в разных сложностях должно иметь один и тот же оффсет.
- **Из видео должна быть удалена аудиодорожка** для экономии размера карты, потому что она не используется osu! (это необходимо сделать даже для видео с беззвучной аудиодорожкой).
...
- **Перед использованием спрайтов, сделанных другим игроком, попросите разрешения.** Важно уважать чужой труд: если вы не знаете, кто сделал спрайт, не используйте его.
...
- **Спрайты с прозрачностью должны быть формата `.png`.** Если прозрачных областей нет, можно использовать любой подходящий формат, распознаваемый osu!.
