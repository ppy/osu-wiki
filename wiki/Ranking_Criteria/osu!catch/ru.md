...
- **Если [игровое время](/wiki/Beatmap/Drain_time) каждой сложности…**
  - **…короче 2:30**, то самая низкая сложность не должна превосходить Salad.
  - **…между 2:30 и 3:15**, то самая низкая сложность не должна превосходить Platter.
  - **…между 3:15 и 4:00**, то самая низкая сложность не должна превосходить Rain.
  - **Ради достижения перечисленных критериев к [игровому времени](/wiki/Beatmap/Drain_time) можно прибавить [перерывы](/wiki/Beatmap/Break).** В случае самой высокой сложности нельзя прибавлять более 30 секунд перерывов. Кроме того, перерывы вообще нельзя так учитывать, если игровое время сложности короче 30 секунд.
