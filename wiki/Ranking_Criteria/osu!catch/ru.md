...
- **Не используйте [простой дэш](/wiki/Gameplay/Dash_snapping#простой-дэш) больше двух раз в идущих подряд [фруктах](/wiki/Hit_object/Fruit).**
- **После [быстрого дэша](/wiki/Gameplay/Dash_snapping#быстрый-дэш) всегда должен идти [переход](/wiki/Gameplay/Walk).**
...
- **По внешнему виду паттернов должно быть понятно, как их поймать: с помощью [перехода](/wiki/Gameplay/Walk) или [дэша](wiki/Gameplay/Dash).** Так игроки лучше научатся узнавать паттерны, где требуется дэш.
...
- **Не используйте [простой гипердэш](/wiki/Gameplay/Dash_snapping#простой-дэш) больше двух раз в идущих подряд [фруктах](/wiki/Hit_object/Fruit).**
...
- **Не используйте [простой дэш](/wiki/Gameplay/Dash_snapping#простой-дэш) больше четырёх раз в идущих подряд [фруктах](/wiki/Hit_object/Fruit).**
...
- **Не используйте [простой гипердэш](/wiki/Gameplay/Dash_snapping#простой-дэш) более четырёх раз в идущих подряд [фруктах](/wiki/Hit_object/Fruit).**
- **Не используйте [простой гипердэш](/wiki/Gameplay/Dash_snapping#простой-дэш) более двух раз в одном слайдере,** при этом слайдер должен легко проходиться.
...
- **Не используйте [быстрый гипердэш](/wiki/Gameplay/Dash_snapping#быстрый-дэш) на слайдерах.**
...
- **Используйте [гипердэши](/wiki/Gameplay/Hyperdash) вместе с [дропами](/wiki/Hit_object/Juice_stream#drop) или повторами слайдеров, только если слайдер легко проходится.** Это необходимо, чтобы избежать хаотичного или излишне сложного движения по слайдеру: ловить дропы на слайдерах сложной формы при включённом гипердэше обычно достаточно неприятно, точность при этом ощутимо падает, а взамен игрок не получает почти ничего.
