...
В целом, эта пометка предназначена для музыки, которую автор карты не может поменять без использования сторонних аудиоредакторов. [Служба техподдержки](/wiki/People/Account_support_team) оставляет за собой право запрещать определённые музыкальные треки, если сочтут это нужным.
