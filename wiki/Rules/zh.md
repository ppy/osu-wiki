...
6. **保持聊天室绿色健康** osu!不是约会或交友软件。对不愿意的用户使用露骨语言或图片或在公共或私聊中强行勾搭的行为，均不能被容忍。如果某人对你使用让你感到不自在的语言，请向我们[匿名举报](/wiki/Reporting_bad_behaviour/Abuse)，我们会保护你！这也能为其他用户净化社区环境，避免再次发生。
