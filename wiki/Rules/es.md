...
1. **Cada jugador puede tener sólamente *UNA* cuenta, en todo momento.** La *primera* cuenta que creas durante el registro será tu única cuenta de osu!, desde el momento de su creación para siempre jamás. Ésta cuenta eres TÚ. No es nadie más - no es tu hermano, ni tu madre, ni tu hermana, ni tu amigo - eres TÚ. No compartas tu cuenta con nadie más. No podrás hacer una nueva si pierdes acceso a tu cuenta. Mantenla segura.
...
3. **Se bueno con los demás.** El acoso o cualquier otro tipo de antagonismo no tiene lugar dentro de la comunidad de osu!. Estamos aquí para clickear círculos, golpear tambores, atrapar frutas y teclear hasta dieciocho teclas al mismo tiempo, no para ser estúpidos los unos con los otros.
...
5. **Estamos en una comunidad para todas las edades.** Esto significa que cualquier contenido 18+/[NSFW](https://en.wikipedia.org/wiki/Not_safe_for_work "Wikipedia>Not Safe For Work") (no apropiado) como uso de drogas o tópicos de contenido sexual no son bienvenidos aquí. Se hacen excepciones en el caso de que sean apropiadas, pero hablando en términos generales, mantenlo decente.
...
1. **Sé respetuoso y considerado con otros usuarios en el canal y evita bombardear mensajes o spammear.** Que una persona se tome la mitad de la pantalla escribiendo es molesto, así que evita hacerlo en la medida de lo posible. ¡Otras personas están tratando de leer el chat también!
...
3. **Si alguien ha sido advertido, silenciado o restringido, déjalos y no comiences a hablar sobre ellos.** Si alguien está restringido, su caso solo les incumbe a ellos y a la administración del juego - ¡absolutamente a nadie más!
4. **Anima el juego limpio y no prestes atención a tramposos o usuarios tóxicos.** Estas personas desafortunadamente existen y el prestarles atención sólo los incentiva a continuar o incluso provocar a otros a actuar igual que ellos. Repórtalos a través del comando de chat `!report` o con los botones en su página de perfil y no te molestes con ellos.
5. **Mantén el chat limpio y apropiado para una comunidad para todas las edades, evitando temas NSFW siempre que sea posible.** NSFW claramente no es apropiado para una comunidad para todas las edades. Puedes hacer lo que quieras en los chats privados (con mesura claro), pero mantén los canales públicos limpios por el bien de todos.
...
7. **Mantén los enlaces a sitios legales y adecuados.** Sitios de transmisiones piratas (sitios oficialmente licenciados como Animelab y Crunchyroll están bien) y cualquier cosa relacionada a piratería o programas pirateados de cualquier tipo no están bien y no los queremos en nuestro chat. Promocionar enlaces de Twitch para otros videojuegos está bien, pero SOLO en `#videogames`.
8. **No promociones servidores de chat de terceros de ningún tipo, incluyendo servidores/grupos de Discord, Teamspeak o Skype.** El chat de osu! es principalmente sobre osu! y no sobre compartir links a tus servidores personales. Hazlo a través de mensajes privados (MP) si es que realmente tienes que hacerlo.
...
1. **Publica solo contenido/temas significativos, interesantes o de otra forma, atractivos.** Los foros son principalmente sobre discusiones, así que asegúrate de esforzarte en hacer que valga la pena el tiempo de todos.
2. **Mantén tus publicaciones y respuestas adecuadas para personas de todas las edades.** NSFW no es apropiado para una comunidad para todas las edades, aunque no hay nada que te detenga de discutir éste tipo de cosas en mensajes privados.
...
5. **Mantén tus avatares y firmas razonables.** Si son animados, no deberían parpadear o destellar de forma excesiva. También deben tener un tamaño de archivo lo suficientemente pequeño para que usuarios con conecciones más lentas no sientan su presencia en la página, idealmente bajo medio megabyte (500 kilobytes) en lo posible.
...
*Nota: Estas reglas aplican **a todos los beatmaps publicados**, no solo los rankeados. Para reglas más específicas en cuanto a beatmaps rankeados, vea el [Criterio de Rankeo](/wiki/Ranking_Criteria).*

Estas reglas aplican estríctamente a los beatmaps que sean presentados a través del [Beatmap Submission System](/wiki/Glossary#bss) (Sistema de Publicación de Beatmaps) dentro del juego. Estos hilos/discusiones son creados a través del cliente osu! cuando un beatmap es presentado a través del [editor](/wiki/Beatmap_Editor).

1. **Asegúrate de que tienes permiso de usar cualquier tipo de contenido involucrado en tu beatmap.** Esto incluye canciones, videos, sonidos de ritmo, arte gráfico y cualquier otro contenido que no sea de tu creación propia. Si no estás seguro de dónde encontrar contenido que sea de uso libre, revisa nuestra librería creciente de [Artistas Destacados](https://osu.ppy.sh/beatmaps/artists/) para música 100% licenciada para su uso en osu! y la [Guía de Uso del Contenido](Content_Usage_Guidelines) para más información.
...
4. **Sigue las [Reglas de Contenido en Canciones](Song_Content_Rules) y las [Consideraciones en cuanto al Contenido Visual](Visual_Content_Considerations).**

## ¿Qué pasa si rompo las reglas?

Si te encuentras en el lado equivocado de nuestras reglas de la comunidad, cosas malas pasarán.
...
- La pérdida del privilegio de editar o modificar tu página de usuario o detalles de tu perfil.
...
Si después de varias infracciones, continúas rompiendo las reglas, tu cuenta puede será permanente e irrevocablemente restringida.

Cuentas restringidas no pueden jugar en línea, establecer puntajes, conversar con otros usuarios y son, para todas las intenciones y propósitos, "baneados" de interactuar con la comunidad. Las restricciones para la violación de las reglas de la comunidad solo pueden ser removidas en apelación al personal del juego luego de pasado 3 meses ([pueden aplicarse más condiciones](/wiki/Help_Centre/Account_Restrictions#common-restriction-reasons-and-cooldowns)).
