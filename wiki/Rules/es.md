...
5.  **Donde las reglas no prevalecen, Usa el sentido común.** La administración tiene la explicita discreción de aplicar su jucio así sea necesario.
...
2.  **Deja que los moderadores manejen los problemas del chat.** Puedes mencionarles algun punto donde infrinjan las reglas usando el comando `!report <usuario> <motivo>` y ellos se encargarán del resto.
