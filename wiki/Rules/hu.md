...
5.  **Ahol a szabályok nem érvényesülnek, ott a józan ész igen.** Az adminisztrátorok megítélésük alapján bírálhatják ezt, ahol szerintük szükséges.

Játékon Belüli Chat Szabályok
------------------

1.  **Legyél tisztelettudó és figyelmes a másikhoz a csatornában, és ne flood-olj vagy spam-elj.** Ha egy ember foglalja el a fél képernyőt, az elég idegesítő tud lenni, szóval kerüld, amennyire lehetséges. A többiek is próbálnak beszélgetni!
...
5.  **Tartsd a chat-et tisztán, és korhatár nélküli közösséghez illően, kerülve a felnőtt tartalmakat/témákat, ahol lehetséges.** Felnőtt tartalmak egyáltalán nem illőek egy korhatár nélküli közösségbe. Tegyél amit szeretnél privát üzenetekben (az ésszerűség határain belül), de hagyd a nyilvános csatornákat tisztán, mindenki érdekében.
...
2.  **Tartsd a posztjaidat és a válaszaidat a korhatár nélküli közösséghez megfelelően.** Felnőtt tartalomnak semmi keresnivalója egy korhatár nélküli közösségben, ugyanakkor semmi sem állít meg ezeknek a megvitatása privát üzenetekben.
...
4.  **Tartsd a szálakat relevánsan, és ne élessz fel régi témákat, ha kihaltak a beszélgetések.** Ha a téma már évek óta halott, nem igazán releváns többé, hagyd azt eltűnni. Posztolj újat, vagy keress és nézd meg, hogy valaki nem-e válaszolta meg már a kérdésed előtte.
5.  **Az avatarjaid és az aláírásaid maradjanak ésszerűek.** Ha animáltak, ne villogjanak túlságosan. Egyúttal, a fájlméretük legyen alacsony, hogy a lassabb internetcsatlakozással rendelkezők is kényelmesen tudják böngészni az oldalt. Ez ideálisan maximum fél megabyte (500 kilobyte), ahol lehetséges.
...
Ezek a szabályok szigorúan azokra a beatmap-ekre vonatkoznak amik a játékon belüli [Beatmap Közzétételi Rendszer](/wiki/Beatmap_Submission_System) használatával lettek közzétéve. Ezek a szálak az osu! kliens által automatikusan jönnek létre, amikor a [szerkesztő](/wiki/editor) segítségével a beatmap-ek publikálásra kerülnek.
...
1. **Győződj meg arról, hogy engedélyed van mindenre, amit a beatmap-edben használsz.** Ez magába foglalja a zenéket, videókat, ütéshangokat, grafikákat, vagy bármi egyéb tartalmat, ami nem a te munkád gyümölcse. Ha nem vagy benne biztos, hogy merre kéne az efféle tartalmakat keresned, nekünk van egy folyamatosan bővülő zenegyűjteményünk a [Kiemelt Előadó](https://osu.ppy.sh/beatmaps/artists/) részlegnél, ahol az összes zene 100%-os licenccel rendelkezik az _osu!_ használatához.
...
3.  **Ne plagizálj vagy próbáld ellopni mások munkáját.** Szintúgy ne töltsd fel és használd a másik munkáját az engedélyük nélkül (beleértve, de nem korlátozva, témákat és vendég nehézségeket).
...
A némítások és egyéb áthágások időtartama **automatikusan** növekszik majdnem exponenciálisan minden újabb megszegéssel. A moderátorok nem befolyásolják az adott sértésért járó némítás időtartamát - többszörös szabálysértők igen hosszú időtartamú elvonásban részesülnek.
...
Nagyon súlyos szabálysértés esetén, ami minden határon túlnyúlik, az illegális tartalomra vonatkozó nemzetközi szabályok alapján, a felhasználói fiók azonnali eltávolításával jár. Ez csak a legsúlyosabb szabálysértésekre vonatkozik, mint például gyermek-pornográfia megosztása vagy hasonlóan felkavaró tartalmak.
