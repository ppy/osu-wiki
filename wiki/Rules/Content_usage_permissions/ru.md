...
Все треки, перечисленные в [списке Featured Artist](https://osu.ppy.sh/beatmaps/artists), одобрены для использования в создании карт для osu!. Треки от Featured Artist, которые не указаны в их списке, *не* лицензированы, и для их использования могут потребоваться дополнительные разрешения.
...
| :-- | :-- | :-- | :-- |
|  | a\_hisa | ![][partial] | Свяжитесь перед публикацией — это можно сделать [по почте](mailto:hisaweb_info@yahoo.co.jp) или через [Bandcamp](https://a-hisa.bandcamp.com/). |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/51) | [Akira Complex](https://osu.ppy.sh/beatmaps/artists/51) | ![][partial] | Не используйте и не публикуйте треки, которых нет на странице автора в листинге Featured Artist. |
