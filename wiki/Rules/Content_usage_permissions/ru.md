...
Если подобного разрешения нет, вы рискуете как [картами](/wiki/Beatmap) — они могут быть удалены, — так и своим доступом к системе публикации карт в соответствии с [политикой защиты авторских прав osu!](/wiki/Legal/Copyright). Чтобы подобного не случилось, рекомендуется использовать чужие работы только в следующих случаях:
...
## Как разрешить другим использовать свои работы

Артисты, желающие добавить или обновить данные о себе в этом списке, могут обратиться к команде лицензирования музыки osu! по адресу [music@ppy.sh](mailto:music@ppy.sh).

Также может рассмотриваться возможность связаться с командой для обсуждения условий лицензирования. Подробности смотрите на [странице лицензирования музыки для osu!](/wiki/Legal/Music_licensing).

## Аудио

*Внимание: публикация или трансляция игрового процесса на других сайтах потенциально может подпадать под другие требования лицензирования, которые необходимо заранее понимать или согласовывать — пожалуйста, не забывайте про это.*
...
Этот раздел описывает, какие артисты разрешили использование своих работ в osu! и на каких условиях (где это применимо).

Все треки, перечисленные в [каталоге Featured Artist](https://osu.ppy.sh/beatmaps/artists), лицензированы и одобрены для использования при создании карт для osu!, даже если в таблицах и списках ниже какой-то исполнитель указан как под запретом. Треки, не перечисленные в каталоге Featured Artist, *не* лицензированы, и для их использования могут потребоваться дополнительные разрешения.
...
Дата последнего обновления: 18 февраля 2016 г.

| Исполнитель |  | Статус | Примечания |
| :-- | :-- | :-- | :-- |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/466) | [ak+q](https://osu.ppy.sh/beatmaps/artists/466) | ![][partial] | Не используйте и не публикуйте треки, которых нет на странице автора в каталоге Featured Artist. |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/51) | [Akira Complex](https://osu.ppy.sh/beatmaps/artists/51) | ![][partial] | Не используйте и не публикуйте треки, которых нет на странице автора в каталоге Featured Artist. |
...
У всех визуальных работ должно быть указано авторство, включая ссылку на источник. Если прямую ссылку использовать по каким-либо причинам нельзя, сошлитесь на профиль автора на той платформе, где он или она наиболее активны.

В большинстве случаев автор явно указывает, как можно распоряжаться его творчеством. Если это нигде не написано, не используйте чужую работу до тех пор, пока не обговорите условия использования лично с её автором.
...
Для публикации материалов, непосредственно связанных с самой игрой (например, [гостевых сложностей](/wiki/Beatmap/Guest_difficulty) или чартов из других ритм-игр), тоже нужно просить разрешение у автора работы.
...
[^monstercat-gold]: Этот исполнитель лицензирован совместно с [Monstercat](https://osu.ppy.sh/beatmaps/artists/255) — права на использование медиа на других платформах можно получить по подписке [Monstercat Gold](https://www.monstercat.com/gold) (подробнее о лицензии см. сайт Monstercat).

[FA]: /wiki/shared/group/FA.png "Featured Artist"
[true]: /wiki/shared/true.png "Разрешено"
[false]: /wiki/shared/false.png "Запрещено"
[partial]: /wiki/shared/partial.png "Разрешено с оговорками"
