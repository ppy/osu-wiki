...
如果你是希望在此列表中添加或更新与自己有关条目的艺术家，请通过 [music@ppy.sh](mailto:music@ppy.sh)，随时联系 osu! 音乐授权团队。

请多多考虑授权的相关事宜，并与团队协商。参见 [osu! 音乐授权页](/wiki/Legal/Music_licensing)了解更多。
...
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/68) | [Frums](https://osu.ppy.sh/beatmaps/artists/68) | ![][partial] | 对于未收录在精选艺术家列表中的曲目，请参考 [Frums 非商用公开曲目一览](https://docs.google.com/spreadsheets/d/1_M0BqHSrbE1HOF0uhKX5ebVCvWnqlx0qz_wIEZzSFG0/edit?gid=0#gid=0) |
|  | gxxberlol | ![][partial] | 请勿使用标题为 "KICKICKICKICKICKICKIKI" 或 "newb artist rave" 的曲目。其他曲目则被允许使用。 |
...
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/163) | [Reku Mochizuki](https://osu.ppy.sh/beatmaps/artists/163) | ![][partial] | 请勿使用或上传未在该创作者的精选艺术家列表中提供的曲目。 |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/92) | [Silentroom](https://osu.ppy.sh/beatmaps/artists/92) | ![][partial] | 请勿使用或上传未在该创作者的精选艺术家列表中提供的曲目。 |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/357) | [Synthion](https://osu.ppy.sh/beatmaps/artists/357) | ![][partial] | 请勿使用或上传未在该创作者的精选艺术家列表中提供的曲目。 |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/132) | [Yuyoyuppe / DJ'TEKINA//SOMETHING](https://osu.ppy.sh/beatmaps/artists/132) | ![][partial] | 请勿使用或上传来自或围绕 *东方 Project* 主题创作的曲目。 |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/76) | [Zekk](https://osu.ppy.sh/beatmaps/artists/76) | ![][partial] | 请勿使用或上传未在该创作者的精选艺术家列表中提供的曲目。 |
...
[^monstercat-gold]: 该艺术家是与 [Monstercat](https://osu.ppy.sh/beatmaps/artists/255) 合作才获得的许可，用户可以通过订阅 [Monstercat Gold](https://www.monstercat.com/gold)，获得在其他地方使用这些媒体内容的权限。有关此许可证的具体详细信息，请参阅他们的网站。

[FA]: /wiki/shared/group/FA.png "精选艺术家"
[true]: /wiki/shared/true.png "允许"
[false]: /wiki/shared/false.png "不允许"
[partial]: /wiki/shared/partial.png "部分允许，有例外"
