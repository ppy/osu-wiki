...
음악은 저작권이 제한된 있는 경우가 많지만, 사용자 지정 히트사운드에 사용되는 사운드 효과는 자유롭게 사용할 수 있는 경우가 많습니다. 예를 들어, 필하모니아 관현악단은 [악기 사운드 샘플](https://philharmonia.co.uk/resources/sound-samples/)을 무료로 제공하며, [Freesound](https://freesound.org)에서는 사용 권한별로 필터링된 사운드 샘플을 검색할 수 있습니다.

### 아티스트 권한

이 섹션에서는 osu!에서 아티스트의 오디오 작품 사용 여부 및 조건부(해당하는 경우) 허용할 것인지 자세히 설명합니다.
