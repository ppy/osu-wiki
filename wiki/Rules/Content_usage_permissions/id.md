...
- Bebas dari hak cipta

## Keikutsertaan sukarela

Bagi artis yang ingin menambahkan atau memperbarui entri mereka ke daftar ini, silakan hubungi tim lisensi musik osu! di [music@ppy.sh](mailto:music@ppy.sh).

Mohon pertimbangkan juga untuk menghubungi tim kami guna membahas perjanjian lisensi. Lihat halaman [lisensi musik osu!](/wiki/Legal/Music_licensing) untuk informasi lebih lanjut.

## Audio

*Catatan: Memposting atau menyiarkan permainan osu! pada situs lain dapat dikenai dengan persyaratan lisensi berbeda yang perlu dipahami atau dinegosiasikan lebih lanjut. Mohon untuk bertindak dengan cermat pada saat menyiarkan permainan osu! ke hadapan penonton.*

osu! menyediakan pustaka lagu yang telah terlisensi kepada para mapper melalui program [Featured Artist](/wiki/People/Featured_Artists). Seluruh lagu yang tersedia pada [daftar ini](https://osu.ppy.sh/beatmaps/artists) dapat digunakan secara bebas di dalam lingkungan osu! tanpa berisiko untuk dihapus.

Pada saat mencari lagu yang tidak tersedia pada katalog Featured Artist osu!, periksalah apakah artis lagu ini telah secara gamblang menyatakan ketentuan penggunaan lagu mereka. Informasi ini sering kalinya dapat ditemukan di kolom deskripsi pada platform tempat musik ini dirilis (mis. Bandcamp, Soundcloud, YouTube) atau pada situs web pribadi milik artis. Apabila lagu ini dirilis dengan [lisensi Creative Commons](https://creativecommons.org/about/cclicenses/) atau tersedia untuk digunakan secara non-komersial, lagu ini akan aman untuk diunggah dan digunakan pada beatmap.

Apabila lagu yang ingin digunakan tidak memiliki izin guna yang jelas, kamu disarankan untuk menghubungi artis lagu ini demi meminta izin sebelum membuat beatmap. Sebagian besar artis pada umumnya memiliki informasi kontak yang tertulis pada platform tempat mereka merilis lagu, situs web pribadi, dan media sosial mereka.

Hal ini mungkin terkesan sulit, namun para mapper yang sudah-sudah sering kalinya dapat berhasil memperoleh izin dari artis yang bersangkutan hanya dengan bertanya sebelum menggunakan konten tanpa izin. Kamu mungkin akan terbantu apabila kamu menyebutkan bahwa osu! adalah permainan gratis yang tidak memiliki iklan, atau menautkan [halaman lisensi osu!](/wiki/Legal/Music_licensing) untuk memberikan artis ini gambaran seputar bagaimana konten ini akan digunakan.

Di sisi lain, tidak seperti musik yang pada umumnya terbatas hak cipta, efek suara yang digunakan untuk hitsound lebih seringnya tersedia secara bebas. Sebagai contoh, orkestra Philharmonia menyediakan [sampel instrumen gratis](https://philharmonia.co.uk/resources/sound-samples/) dan [Freesound](https://freesound.org) memungkinkan pencarian sampel berdasarkan ketentuan pengunaan.
...
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/118) | [orangentle / Yu_Asahina](https://osu.ppy.sh/beatmaps/artists/118) | ![][true] |
...
| :-- | :-- | :-- | :-- |
|  | a_hisa | ![][partial] | Hubungi sebelum mengunggah. Dapat dijangkau melalui [email](mailto:hisaweb_info@yahoo.co.jp) atau [Bandcamp](https://a-hisa.bandcamp.com/). |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/466) | [ak+q](https://osu.ppy.sh/beatmaps/artists/466) | ![][partial] | Jangan gunakan atau unggah lagu yang tidak tersedia pada daftar Featured Artist. |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/51) | [Akira Complex](https://osu.ppy.sh/beatmaps/artists/51) | ![][partial] | Jangan gunakan atau unggah lagu yang tidak tersedia pada daftar Featured Artist. |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/319) | [HoneyComeBear](https://osu.ppy.sh/beatmaps/artists/319) | ![][partial] | Jangan gunakan atau unggah lagu yang tidak tersedia pada daftar Featured Artist. |
|  | Igorrr | ![][partial] | Hanya lagu kolaborasi yang tersedia pada daftar Featured Artist [Ruby My Dear](https://osu.ppy.sh/beatmaps/artists/370) yang dapat digunakan. Jangan gunakan atau unggah lagu lainnya. |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/124) | [Jun Kuroda](https://osu.ppy.sh/beatmaps/artists/124) | ![][partial] | Jangan gunakan atau unggah lagu yang tidak tersedia pada daftar Featured Artist. |
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/449) | [Lusumi](https://osu.ppy.sh/beatmaps/artists/449) | ![][partial] | Jangan gunakan lagu berjudul "execution_program". |
...
Aset visual (yang meliputi [gambar latar](/wiki/Beatmap/Background), [storyboard](/wiki/Storyboard), dan video beatmap) juga tunduk pada syarat penggunaan yang sama dengan aset audio.

Situs web hosting gambar (*image hosting*) sering kalinya memiliki filter pencarian untuk mencari gambar yang berlisensi Creative Commons atau yang dapat digunakan secara non-komersial. Beberapa situs web yang sering digunakan oleh para mapper untuk mencari gambar latar yang bebas dari hak cipta meliputi antara lain:

- [pixabay](https://pixabay.com/)
- [Unsplash](https://unsplash.com/)
- [Pexels](https://www.pexels.com/)

Seluruh aset visual harus diatribusikan dengan selayaknya, yang meliputi tautan yang merujuk pada sumber aset ini. Apabila sumber ini tidak dapat ditautkan secara langsung karena satu dan lain hal, tautan lain yang merujuk pada presensi utama artis visual ini harus digunakan sebagai gantinya.

Dalam kebanyakan kasus, artis visual akan menerangkan secara jelas apakah mereka mengizinkan gambar mereka untuk digunakan pada platform lain. Apabila artis ini tidak memberikan izin yang jelas, jangan gunakan gambar mana pun dari artis ini hingga ketentuan penggunaan yang sesuai dapat dikonfirmasi dengan artis ini secara individu.

Apabila terdapat artis musik yang telah secara gamblang mengizinkan lagu mereka untuk digunakan, gambar album atau gambar resmi lainnya dari artis ini juga kemungkinan akan dapat digunakan pada beatmap. Meskipun demikian, sekali lagi, mintalah izin ke artis yang bersangkutan apabila izin ini masih samar-samar.

## Permainan

Pada saat mengunggah beatmap, pengguna harus memiliki izin untuk menggunakan segala aset yang terkait dengan permainan seperti [tingkat kesulitan tamu](/wiki/Beatmap/Guest_difficulty) (*guest difficulty*) atau tingkat kesulitan yang berasal dari permainan ritme lainnya.

Kami tidak membenarkan submisi yang mengandung tatanan (atau objek) permainan yang sama persis dengan yang ada pada permainan lainnya, karena hal ini tidak menghormati komunitas permainan ritme.

## Catatan

[^monstercat-gold]: Artis ini dilisensikan bekerja sama dengan [Monstercat](https://osu.ppy.sh/beatmaps/artists/255), dan pengguna dapat memperoleh hak guna media eksternal untuk artis ini melalui langganan [Monstercat Gold](https://www.monstercat.com/gold). Silakan kunjungi situs web Monstercat untuk rincian lebih lanjut seputar lisensi ini.

[FA]: /wiki/shared/group/FA.png "Featured Artist"
[true]: /wiki/shared/true.png "Diizinkan"
[false]: /wiki/shared/false.png "Tidak diizinkan"
[partial]: /wiki/shared/partial.png "Diizinkan, dengan pengecualian"
