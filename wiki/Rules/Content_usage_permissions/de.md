...
Während Musik häufig urheberrechtlich geschützt ist, stehen Soundeffekte für benutzerdefinierte Hitsounds öfter kostenlos zur Verfügung. Zum Beispiel bietet das Philharmonia Orchestra kostenlose [Hörbeispiele von Instrumenten](https://philharmonia.co.uk/resources/sound-samples/) an und [Freesound](https://freesound.org) erlaubt die Suche nach Hörbeispielen, entsprechend gefiltert nach Nutzungsrechten.

### Genehmigungen von Künstlern
...
Dieser Abschnitt wurde zuletzt am 18. Februar 2026 aktualisiert.
...
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/68) | [Frums](https://osu.ppy.sh/beatmaps/artists/68) | ![][partial] | Siehe [Frums nicht-kommerzielle Nutzungsanforderungen](https://docs.google.com/spreadsheets/d/1_M0BqHSrbE1HOF0uhKX5ebVCvWnqlx0qz_wIEZzSFG0/edit?gid=0#gid=0) für Songs die nicht auf der "Featured Artist"-Seite des Künstlers verfügbar sind. |
|  | gxxberlol | ![][partial] | Songs mit den Namen "KICKICKICKICKICKICKIKI" und "newb artist rave" dürfen nicht verwendet werden. Andere Songs sind erlaubt. |
...
|  | Mlumìn // SoundWarper | ![][partial] | Es wurde Erlaubnis erteilt, den Song "Spinner (DnB Remix)" zu verwenden. Kontaktiere die Künstler für eine Erlaubnis andere Songs zu verwenden. |
...
| [![][FA]](https://osu.ppy.sh/beatmaps/artists/92) | [Silentroom](https://osu.ppy.sh/beatmaps/artists/92) | ![][partial] | Verwende oder lade keine Songs hoch, die nicht auf der "Featured Artist"-Seite des Künstlers verfügbar sind. |
...
Wenn ein Musikkünstler eine explizite Erlaubnis erteilt hat, seinen Song, sein Album-Cover oder ein anderes offizielles Kunstwerk benutzen zu dürfen, kann es voraussichtlich auch in einer Beatmap verwendet werden. Aber auch hier gilt: Frage nach einer Genehmigung, wenn das nicht klar ist.

## Gameplay

Beim Hochladen einer Beatmap sollten Nutzer eine Nutzungserlaubnis für Spielinhalte, wie zum Beispiel [Gastschwierigkeiten](/wiki/Beatmap/Guest_difficulty) oder Gameplay von anderen Rhythmusspielen, haben.
...
[false]: /wiki/shared/false.png "Untersagt"
[partial]: /wiki/shared/partial.png "Erlaubt, mit Ausnahmen"
