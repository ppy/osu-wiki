...
Так как песни порой не поддаются однозначной оценке, за **самую первую удалённую карту** маппер не понесёт никакого наказания (это **не** относится к крайне неприемлемым песням). За повторные нарушения, помимо удаления карты, выдаётся [сайленс](/wiki/Silence) длительностью в 43 часа.
