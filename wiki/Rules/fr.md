...
Ces règles s'appliquent strictement aux maps soumises via le [système de soumission des beatmaps](/wiki/Submission). Ces fils de discussion sont créés via le client d'osu! lorsqu'une beatmap est soumise via l'[éditeur](/wiki/Client/Beatmap_editor).
