...
2. **Jouez fair-play.** L'utilisation d'utilitaires tiers de quelque nature que ce soit pour obtenir un avantage quelconque n'est pas acceptable. Cela inclut des choses comme les programmes de macro, les programmes d'aide à la visée, la modification de l'échelle de temps, et ainsi de suite. Si un programme fait quelque chose pour vous aider à jouer alors que vous devriez le faire vous-même, ce n'est pas acceptable !
...
4. **Ne sois pas un con.** Si, à un moment donné, vous ne savez pas si vous enfreignez cette règle, c'est probablement le cas.
...
6. **Maintenez-le propre.** osu! n'est pas un lieu pour les rencontres ou les flirts. Utiliser un langage ou des images à caractère sexuel ou faire des avances non désirées à d'autres membres de la communauté en public ou en privé n'est PAS acceptable. Si vous ne vous sentez pas à l'aise avec la façon dont quelqu'un vous parle, [signalez-le nous de façon confidentielle](/wiki/Reporting_Bad_Behaviour/Abuse) afin que nous puissions vous aider (et éviter que d'autres personnes soient affectées).
7. **Lorsque les règles ne prévalent pas, c'est le bon sens qui prévaut.** L'administration dispose d'une discrétion explicite pour appliquer son jugement sur ce point comme elle l'entend.
...
2. **Laissez les modérateurs gérer les problèmes dans le tchat.** Vous pouvez leur signaler certaines choses avec [la commande `!report`](/wiki/Reporting_Bad_Behaviour) et ils s'occuperont du reste.
3. **Si quelqu'un se voit imposer un mute, un silence ou une restriction, laissez-le tranquille et ne commencez pas à parler de lui.** Si quelqu'un est soumis à des restrictions, son cas n'implique que lui et l'administration du jeu - absolument personne d'autre !
4. **Encouragez le fair-play et ne prêtez pas attention aux tricheurs ou autres utilisateurs toxiques.** Ces personnes existent malheureusement, et leur accorder de l'attention peut les encourager à continuer, ou inciter d'autres personnes à agir comme elles le font. Signalez-les à l'aide de la commande `!report` ou des boutons sur leur page de profil et passez à autre chose.
...
8. **Ne faites pas de publicité pour des serveurs de discussion tiers, quels qu'ils soient, y compris les serveurs/groupes Discord, TeamSpeak ou Skype.** Le chat d'osu! concerne avant tout osu! et non le partage de liens vers vos serveurs personnels. Faites-le par MP si vous devez absolument le faire.
...
1. **Ne publiez que des contenus/sujets significatifs, intéressants ou autrement engageants.** Les forums sont avant tout des lieux de discussion, alors assurez-vous de faire les efforts nécessaires pour que chacun y trouve son compte.
2. **Faites en sorte que vos messages et vos réponses conviennent à des personnes de tous âges.** Le contenu NSFW n'est pas approprié pour une communauté de tout âges, mais rien ne vous empêche de discuter de ce genre de choses dans des messages privés.
3. **Soyez productif dans vos critiques sans recourir à des attaques personnelles.** La critique est une chose merveilleuse lorsqu'elle est bien faite, mais si vous recourez à des attaques personnelles pour faire valoir votre point de vue, vous vous y prenez mal et vous devriez vous sentir mal.
4. **Gardez les fils de discussion pertinents et évitez de ressusciter des sujets plus anciens si la conversation s'est éteinte.** Si un sujet est mort depuis des années, il n'est plus vraiment pertinent, alors laissez-le disparaître. Postez-en un nouveau ou cherchez si quelqu'un a déjà répondu à votre question.
5. **Gardez vos signatures et avatars raisonnables.** Si elles sont animées, elles ne doivent pas être trop stroboscopiques ou clignotantes. Les images doivent également avoir une taille de fichier suffisamment petite pour que les utilisateurs disposant de connexions plus lentes ne ressentent pas leur présence sur la page, idéalement moins d'un demi-mégaoctet (500 kilo-octets (ko)) si possible.
6. **Ne publiez pas de publicités, de liens de parrainage ou tout autre contenu gênant ou intrusif.** Des choses comme les liens d'affiliation et de référence sont amusantes pour la personne qui les publie et ennuyeuses pour tous les autres, alors ne le faites pas. Le chargement automatique ou la lecture automatique de contenu ou d'images relève également de cette règle.
7. **La création de liens vers des applications ou des utilitaires dont l'intention est incertaine n'est pas autorisée.** En d'autres termes, s'il existe le moindre doute quant à la légalité de ces services publics, il n'est pas souhaitable de les afficher.

## Règles de soumission des beatmaps

*Note : Ces règles s'appliquent à **toutes les maps soumises**, pas seulement les maps classées. Pour des règles plus spécifiques concernant les beatmaps classées, voir les [critères de classement](/wiki/Ranking_Criteria).*

Ces règles s'appliquent strictement aux maps soumises via le [système de soumission des beatmaps](/wiki/Submission). Ces fils de discussion sont créés via le client d'osu! lorsqu'une beatmap est soumise via l'[éditeur](/wiki/Beatmap_Editor).

1. **Assurez-vous d'avoir la permission d'utiliser tout contenu impliqué dans votre beatmap.** Cela inclut les chansons, les vidéos, les sons, les graphiques et tout autre contenu qui n'est pas votre propre création. Si vous ne savez pas où trouver du contenu dont l'utilisation est gratuite, consultez notre bibliothèque [Featured Artist](https://osu.ppy.sh/beatmaps/artists) en pleine expansion, qui contient de la musique dont l'utilisation est autorisée à 100 % dans osu! et les [directives d'utilisation du contenu](Content_Usage_Guidelines) pour plus d'informations.
2. **Restez dans le sujet dans les [discussions sur les beatmaps](/wiki/Beatmap_Discussions).** Ces fils/discussions portent sur la beatmap en question, et rien d'autre. Si vous avez un problème avec quelque chose qui ne concerne pas directement la beatmap, postez-le dans le forum approprié.
...
Si vous vous trouvez du mauvais côté de nos règles communautaires, de mauvaises choses se produiront.
