...
- **Вариант, за который проголосовало более 70% модераторов и NAT из числа участников.**
- Если порог в 70% модераторов и NAT не преодолён, начинают учитываться голоса номинаторов.
...
Решение считается **окончательным**, и его может оспорить только [служба поддержки](/wiki/People/The_Team/Account_support_team).
