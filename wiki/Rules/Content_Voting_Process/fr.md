...
1. Un mappeur, un moddeur ou un membre de la communauté soulève tout élément visuel dans un beatmap pour le soumettre à l'examen des [considérations relatives au contenu visuel](/wiki/Rules/Visual_Content_Considerations) en le signalant via le [site web des BN](https://bn.mappersguild.com/reports).
