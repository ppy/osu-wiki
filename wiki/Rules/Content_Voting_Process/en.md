...
Content submitted to the Beatmap Nominators (BN), Global Moderation Team (GMT) and the Nomination Assessment Team (NAT) for review via the [BN website](https://bn.mappersguild.com/discussionvote) undergoes a special voting process as outlined below.

## Process

1. A mapper, modder or concerned member of the community raises any visual element in a beatmap for review under the [Visual Content Considerations](Rules/Visual_Content_Considerations) by posting it for discussion on the [BN website](https://bn.mappersguild.com/discussionvote).
2. A new "content case" is made live and available for voting immediately. All members of the BN, GMT and NAT are eligible to vote.
