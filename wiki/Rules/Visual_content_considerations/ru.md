...
Процедура оценки, упомянутая ниже, **не применяется** к изображениям, не входящим в состав карт (аватарки, обложки для профилей, юзерпейджи и т.д.) — они могут быть удалены в любое время по решению [команды глобальной модерации](/wiki/People/Global_Moderation_Team) (GMT).
...
Модераторы удалят изображение или видео и, скорее всего, выдадут [сайленс](/wiki/Help_centre/Silences) тому, кто их разместил, — как минимум на 43 часа, в зависимости от серьёзности проступка и истории нарушений пользователя.

За изображение или видео, содержащиеся в картах, сайленса не будет, если они не излишне неприемлемы, и если автор карты уберёт их за разумный срок.
