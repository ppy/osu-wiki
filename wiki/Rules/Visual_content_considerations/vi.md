...
Vì lợi ích duy trì cho mọi thứ trong sạch nhất có thể , Quy tắc cộng đồng số 5 được áp dụng cho nội dung được coi là "có vấn đề" một cách hợp lý.
...
Không được phép sử dụng hình ảnh hoặc nội dung trực quan có chứa những thứ sau đây là không được phép:

- **Nội dung liên quan đến tình dục hoặc nhắm đến trẻ chưa vị thành niên**
- **Mang yếu tố bạo lực,máu me,kinh dị,giết người** 
- **Có ý nghĩa ám chỉ về tình dục**
- **Tư thế tình dục hoặc gạ gẫm**
- **Mang tính chất khiêu dâm hoặc hiển thị về tình dục**
- **Ví dụ về việc sử dụng, pha chế hoặc nhận dạng chất cấm bằng nội dung về chất cấm bất hợp pháp** [^drug-nature1]
...
Hình ảnh hoặc thành phần trực quan chứa các ví dụ sau đây được coi là tạm chấp nhận được:
