...
Theo nguyên tắc chung, quy định về nội dung không phù hợp chỉ áp dụng ngoại lệ với bài hát người dùng không thể chỉnh sửa một cách hợp lý bởi các công cụ được trò chơi cung cấp, và cũng có thể bị thu hồi riêng cho từng bài nhạc theo quyết định của [đội ngũ hỗ trợ tài khoản](/wiki/People/Account_support_team)
