...
Эти правила применяются к картам, загруженным через [систему публикации карт](/wiki/Submission) — форумные темы и обсуждения для них создаются автоматически при публикации из [редактора](/wiki/Client/Beatmap_editor).
