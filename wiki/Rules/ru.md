...
Эти правила применимы только к картам, опубликованным через внутриигровую [Систему Публикации Карт](/wiki/Submission). Треды для этих карт создаются автоматически при публикации [редактор](/wiki/editor).
