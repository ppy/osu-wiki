...
2. **Не ведите разговоров на посторонние темы в [обсуждении карты](/wiki/Beatmap_Discussions).** Если вы хотите высказаться по какому-то другому поводу, то идите в комментарии или на форум.
...
- Вы не сможете писать в игровой чат в течение какого-то времени, то есть получите молчанку, или [сайленс](/wiki/Silence);
...
Длительность [сайленса](/wiki/Silence) и других ограничений **автоматически** удваивается после каждого нарушения. Модераторы не устанавливают длительность сайленса вручную, она растёт сама, поэтому чем чаще вы себя будете плохо вести, тем дольше не сможете общаться или играть.
