...
Приведённые ниже правила помогают поддерживать уют и гостеприимство osu!.
...
2. **Играйте честно.** Не используйте сторонние приложения, дающие игровое преимущество перед другими пользователями. Сюда относятся программы, которые помогают целиться или менять скорость игры, и тому подобные вещи. Макросы, комбинации клавиш или устройства, физическое действие на которых не совпадает с аналогичным игровым действием (например, одно нажатие клавиши), тоже запрещены.[^macros] Иными словами, если приложение делает за вас что-то, связанное с игровым процессом, оно, скорее всего, запрещено.
...
5. **Сообщество osu! не имеет возрастных ограничений.** Это означает, что 18+ ([NSFW](https://ru.wikipedia.org/wiki/NSFW)) материалы здесь не приветствуются (например, обсуждение интимных вещей или наркотиков). Ссылки, изображения или видео, которые вы размещаете на серверах osu! или на которые ссылаетесь, **должны** соответствовать [критериям визуального содержания](Visual_Content_Considerations).
...
8. **Не рекламируйте никакие сторонние сервера для общения, будь то Discord, TeamSpeak и т.д.** Чат прежде всего предназначен для osu!, а не для рекламы сторонних серверов. Если вам необходимо кого-то пригласить, то сделайте это через личные сообщения.
...
::: alert-notice
**Внимание**
эти пункты распространяются на **все загруженные карты**, включая не ранкнутые. На карты, идущие на ранк, дополнительно действуют [критерии ранкинга](/wiki/Ranking_criteria).
:::
...
- Вы не сможете играть или записываться на турниры, имеющие официальную поддержку, т.е. получите [турнирный бан](/wiki/Help_centre/Tournament_sanctions#tournament-bans).

Продолжительность [сайленса](/wiki/Help_centre/Silences) и других ограничений **автоматически** как минимум удваивается после каждого нарушения, поэтому чем чаще вы будете нарушать правила, тем дольше не сможете общаться и в принципе взаимодействовать с другими игроками.
...
Кроме того, за частые нарушения правил, либо за особо серьёзные нарушения вроде читерства, можно [попасть в рестрикт](/wiki/Help_centre/Account_restrictions). В этом случае вы не сможете играть онлайн, ставить рекорды, общаться в чате, и в каком-то смысле будет изолированы от остальных. Рестрикт за нарушение правил может быть снят через три месяца ([а иногда и позже](/wiki/Help_centre/Account_restrictions#reasons)) после апелляции.
...
[^macros]: Клавиши или кнопки, отвечающие за действия K1 и K2, можно переназначать, если одно их физическое нажатие соответствует одному нажатию игровой клавиши, а одно физическое отпускание — одному отпусканию игровой клавиши. Запрещается, например, делать так, чтобы при нажатии происходило отпускание игровой клавиши, или чтобы одна физическая клавиша приводила более чем к одному циклу нажатия и отпускания клавиши в игре.
