...
2.  **Пусть модераторы разбираются с проблемами в чате.** Вы можете указать на нарушение с помощью команды `!report`, все остальное сделают модераторы.
...
4.  **Поддерживайте честную игру и не обращайте внимания на читеров или других плохих ребят.** Подобные игроки, к сожалению, существуют, и если уделять им внимание, то они будут только рады, а другие игроки могут и вовсе последовать их примеру. Сообщайте о таких игроках с помощью команды `!report` или соответствующей кнопки в профиле, после чего просто забудь о них.
...
6.  **Аккуратнее с тем, что Вы отправляете другим, особенно если содержимое может быть неприятным или шокирующим.** Если Вы сомневаетесь в том, не нарушает ли Ваша ссылка правила, то лучше воздержитесь делиться ею. Избегайте контента с ярким и быстрым мерцанием, кровью, жестокостью или демонстрацией наготы.
7.  **Ссылки не должны вести на пиратские сайты.** Нам не нужны ссылки на неофициальные сайты с аниме, торрент-трекеры и прочие нелегальные страницы.
Рекламировать Twitch-каналы с играми, отличных от osu!, можно только в `#videogames`.
8.  **Не рекламируйте никакие сторонние чат-сервисы, будь то Discord, TeamSpeak или Skype.** Чат osu! предназначен для общения в osu!, а не для рекламы сторонних чатов. Если Вам очень нужно пригласить кого-то в свой чат, сделайте это через личные сообщения.
9.  **В языковых каналах стоит говорить только на языке канала (английский в #english, японский в #japanese и т. д.), если Вы хотите что-то обсудить.** Если язык канала чётко не указан или не исходит из названия канала, используется английский язык. В `#lobby` и `#help` разрешено общение на любом языке. *Участникам [модераторского персонала](/wiki/People/Global_Moderation_Team) разрешено не следовать этому правилу при выполнении своих обязанностей.*

Правила форума
-------------------------------------

1.  **Создавайте только интересные и содержательные темы.** Форумы служат для обсуждений, поэтому прилагайте больше усилий, чтобы людям не приходилось тратить своё время впустую.
2.  **Не допускайте похабщины в своих темах или ответах.** Не забывайте, что в нашем сообществе есть несовершеннолетние. Обсуждайте подобные темы только в личных сообщениях.
3.  **Критикуйте, не переходя на личности.** Критика прекрасна, когда подается правильно. Если же Вы переходите на личности, то Вы делаете что-то неправильно, поэтому Вам должно быть стыдно.
...
5.  **Загружайте приемлемые аватары и картинки к подписям.** Анимированная графика не должна чрезмерно мерцать. Размер файлов должен быть достаточно маленьким для пользователей с медленным соединением, в идеале, меньше половины мегабайта (500 килобайт), если это возможно.
6.  **Не размещайте рекламу, реферальные ссылки или другой раздражающий или навязчивый контент.** Партнерские и реферальные ссылки приносят удовольствие только тем, кто публикует их, но раздражают других пользователей, поэтому не нужно так делать. Автоматически загружаемый или автоматический воспроизводимый контент тоже попадает под это правило.
...
Данные правила применимы только к тем картам, которые опубликованы через внутриигровую [Систему Публикации Карт](/wiki/Beatmap_Submission_System).
Темы, упомянутые в этом разделе, создаются автоматически через клиент osu! во время публикации карт через [редактор](/wiki/editor).

Более подробные правила создания карт описаны в [Критериях Ранкинга](/wiki/Ranking_Criteria).

1.  **Убедитесь в том, что у Вас есть разрешение на использование любого контента, включенного в Вашу карту.** Это включает в себя песни, видео, звуки ударов, графику и остальной контент, который создали не Вы. Если же Вам тяжело найти материалы, которые можно свободно использовать, Вы можете воспользоваться нашей постоянно пополняющейся библиотекой треков, доступных в списке [избранных исполнителей](https://osu.ppy.sh/beatmaps/artists/) – они на 100% лицензированы для использования в _osu!_.
2.  **В теме карты обсуждайте только саму карту.** Эти темы касаются только карт, и ничего больше. Если у Вас появилась проблема с чем-то, что никак не связано с картой, спросите об этом на соответствующем разделе форума.
...
* С Вашего юзерпейджа, профиля или опубликованных карт может быть удалено любое содержимое, нарушающее авторские права
...
За серьезные нарушения на Вас могут наложить сайленс с длительностью от 48 часов и более. К такому типу нарушений можно отнести распространение эротических материалов или принесение вреда другим пользователям.

Если Вы уперто продолжаете нарушать правила, Ваша учетная запись может получить рестриктед.
