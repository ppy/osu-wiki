...
Эти правила применяются к картам, загруженным через [систему публикации карт](/wiki/Glossary#bss) — форумные темы и обсуждения для них создаются автоматически при публикации из [редактора](/wiki/Beatmap_Editor).
