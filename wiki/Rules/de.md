...
1. **Jeder Spieler darf zu jedem Zeitpunkt nur *EINEN* Account besitzen.** Dieser Account bist du und niemand sonst - nicht dein Bruder, deine Mutter, deine Schwester, dein Freund - sondern nur DU. Teile deinen Account mit niemanden sonst.
...
1. **Nimm Rücksicht auf die anderen Nutzer im Kanal und vermeide es zu spammen.** Es nervt, wenn eine Person den halben Bildschirm einnimmt, also versuche es zu vermeiden. Andere Leute wollen sich auch unterhalten!
...
8. **Wirb nicht für Chat-Server anderer Platformen jeglicher Art, einschließlicch Discord, Teamspeak oder Skype.** Im osu! Chat geht es um osu! und nicht, um deine Server zu füllen. Nutze private Nachrichten, wenn es unbedingt sein muss.
...
1. **Poste nur sinnvolle, interessante oder anderweitig wertvolle Inhalte oder Themen.** In Foren geht es erst einmal um Diskussionen, also gib dir Mühe, damit es sich für alle anderen auch lohnt.
2. **Alle Posts sollten jugendfrei gehalten werden.** Nicht jugendfreie Inhalte sind in einer Community für alle Altersgruppen unerwünscht. Keiner wird dich jedoch davon abhalten, dich in privaten Nachrichten darüber zu unterhalten.
3. **Übe nur konstruktive Kritik, ohne persönlich zu werden.** Kritik ist eine tolle Sache, wenn sie richtig gemacht wird. Wirst du aber persönlich, machst du es falsch und du solltest dich schämen.
4. **Bleib beim Thema und hebe nicht alte Themen aus der Versenkung, die bereits ausgestorben sind.** Wenn ein Thema seit Jahren nicht mehr besprochen wurde, ist es nicht mehr wirklich relevant - also lass es in Frieden ruhen. Eröffne ein neues Thema und schau nach, ob jemand deine Frage bereits in einem anderen Thema beantwortet hat.
5. **Verwende Avatare und Signaturen vernünftig.** Sollten sie animiert sein, dürfen sie nicht exzessiv pulsieren oder blinken. Außerdem sollte die Dateigröße klein gehalten werden, damit langsame Verbindungen keine Probleme bekommen.
6. **Poste keine Werbung, Referral Links oder andere nervige oder aufdringliche Inhalte.** Dinge wie Affiliate oder Referral Links bringen nur dem etwas, der sie postet, aber nerven jeden anderen - also lass es.  Automatisch abspielende oder ladende Inhalte zählen ebenfalls dazu.
7. **Poste keine Programme oder Applikationen mit unklarem Nutzen.** Einfach gesagt, sollte daran Zweifel bestehen ob diese Applikation erlaubt ist oder nicht, ist sie es nicht.
...
Darüber hinaus existieren noch detaillierte Regeln zu Erstellung von Beatmaps, wenn sie gerankt werden sollen - die [Ranking Criteria](/wiki/Ranking_Criteria).

1. **Stelle sicher, dass du die Berechtigung hast, jeden Inhalt in deiner Beatmap zu verwenden.** Das umschließt das Lied, Videos, Hitsounds, Bilder oder andere Inhalte, die nicht von dir direkt selbst erstellt wurden. Solltest du nicht sicher sein, wo du frei nutzbare Inhalte finden kannst, kannst du die Bibliothek von Liedern unserer [Featured Artists](https://osu.ppy.sh/beatmaps/artists/) durchsuchen. Damit bist du zu 100% auf der sicheren Seite.
2. **Komm in Beatmap-Threads nicht vom Thema ab.** Die Threads und Diskussionen gelten der Beatmap und sonst nichts. Wenn du ein Problem mit etwas hast, was sich nicht direkt auf die Beatmap bezieht, poste es stattdessen in das richtige Forum.
...
Diese schlechten Dinge umfassen unter anderem:

* Der zeitbegrenzten Ausschluss aus dem Chat im Spiel (auch bekannt als Silence)
...
* Der Verlust deiner Privilegien, an offiziellen Turnieren teilzunehmen.

Silences und andere Maßnahmen gegen Verstöße nehmen **automatisch** exponenziell an Härte mit jedem Verstoß zu. Moderaten kontrollieren nicht die Länge dieser Maßnahmen - zahlreiche Verstöße führen also zu immer längeren Strafen.

Gewisse Verstöße haben eine Mindestdauer zufolge (meistens 48 Stunden oder mehr) - jedoch nur bei besonders schlimmen Vergehen, beispielsweise das Teilen expliziter Inhalte oder das nachgiebe Belästigen anderer Nutzer.

Solltest du nach zahlreichen Verstößen weiterhin die Regeln brechen, kann dein Account permanant und unwiderruflich restricted werden.

Restricted Accounts können nicht online spielen, Scores erzielen, mit anderen Nutzern sprechen und sind im Großen und Ganzen von allen Interaktionen mit der Community 'gebannt'. Restrictions können nur entfernt werden, wenn nach 3 Monaten ein entsprechendes Gesuch bei den Administratoren eingereicht wird.
