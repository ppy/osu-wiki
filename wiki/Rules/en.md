...
9.  **In language-specific channels, you must speak the dominant language (English for `#english`, Thai for `#thai`, etc) if you are participating in discussion.** Where the language for a channel is not explicitly stated, it is always English. The `#lobby` and `#help` channels can be used with any and every language, unlike other channels. _Members of the [moderation staff](/wiki/People/The_Team/Global_Moderation_Team) do not need to follow this rule when doing their work._
...
_Note: These rules apply to **all submitted maps**, not just Ranked ones. For more specific rules regarding Ranked beatmaps, see the [Ranking Criteria](/wiki/Ranking_Criteria)._
...
These bad things may include (_but are not limited to_):
