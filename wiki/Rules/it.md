...
Queste regole si applicano strettamente alle beatmap inviate tramite il gioco [Beatmap Submission System](/wiki/Submission). Questi thread/discussioni sono creati tramite il client di osu! quando una beatmap viene inviata tramite [editor](/wiki/editor).
