...
5. **Siamo una community di tutte le età.** Ciò significa che i contenuti 18+/[NSFW](https://en.wikipedia.org/wiki/Not_safe_for_work) come l'uso di droghe ed argomenti di natura sessuale non sono i benvenuti qui.
...
Queste regole si applicano strettamente alle beatmap inviate tramite il [Sistema di Invio Beatmap](/wiki/Submission) all'interno del gioco. Questi thread/discussioni sono creati automaticamente tramite il client di osu! quando una beatmap viene inviata tramite [l'editor](/wiki/editor).

1. **Assicurati di avere il permesso di usare qualsiasi contenuto coinvolto nella tua beatmap.** Questo include canzoni, video, suoni, immagini e qualsiasi altro contenuto che non sia di tua creazione. Se non sei sicuro di dove trovare il contenuto che è libero di essere utilizzato, abbiamo una libreria di brani in crescita disponibile nella scheda [Artisti in Primo Piano](https://osu.ppy.sh/beatmaps/artists/), tutti al 100% concessi in licenza per l'uso in osu!.
2. **Rimani coerente nella [discussione della beatmap](/wiki/Beatmap_Discussions).** Questi thread/discussioni riguardano la beatmap in questione e nient'altro. Se hai un problema con qualcosa che non appartiene direttamente alla beatmap, pubblicalo nel forum appropriato.
