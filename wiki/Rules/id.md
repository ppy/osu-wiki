...
2. **Biarkan masalah yang muncul di dalam obrolan ditangani oleh para moderator.** Alih-alih bermain hakim sendiri, gunakan [perintah `!report`](/wiki/Reporting_bad_behaviour) dan biarkan para moderator menindak mereka yang bermasalah secara langsung.
3. **Apabila terdapat pengguna yang dikeluarkan dari kanal percakapan *(timed out)*, di-*silence*, atau di-*restrict*, abaikan mereka dan jangan mulai membicarakannya.** Apabila terdapat pengguna yang di-*restrict*, kasus mereka akan otomatis jatuh pada ranah yang hanya melibatkan staf osu! dan diri mereka sendiri.
...
Peraturan berikut berlaku bagi seluruh beatmap yang diunggah dengan [Beatmap Submission System](/wiki/Submission). Pada saat beatmap diunggah untuk pertama kalinya melalui [editor](/wiki/Client/Beatmap_editor), osu! akan secara otomatis membuat laman diskusi baru untuk beatmap yang bersangkutan.
