...
1. **비트맵과 관련된 콘텐츠의 사용을 허락받았는지 확인하세요.** 이것은 음악, 동영상, 히트 사운드, 그래픽, 그리고 자신이 만들지 않은 모든 항목들에 적용됩니다. 만약 자유롭게 사용이 가능한 콘텐츠를 찾지 못하겠다면, [Featured Artist](https://osu.ppy.sh/beatmaps/artists/) 목록을 확인하세요. 이곳에 있는 곡들은 전부 _osu!_에서 허용됩니다.
...
2. **심하게 바보 같은 행동은 좋지 않습니다.** 단순히 가벼운 느낌으로 의미 없는 글을 쓰는 것은 괜찮습니다. 하지만 완전히 바보 같은 행동을 해서는 안 됩니다. 이 둘을 구분하지 못한다면 이미 규칙을 위반하고 있는 겁니다.
