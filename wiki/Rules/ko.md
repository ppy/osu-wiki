...
3.  **문제를 일으키지 마세요.** 규칙을 어겼을지도 모른다는 생각이 들었을 때는 이미 늦었을 수도 있습니다.
4.  **이 커뮤니티는 모든 연령대를 위한 것입니다.** 약물이나 성적인 주제와 같은 불건전한 내용은 허용되지 않습니다. 주제에 맞는 곳에서는 예외적으로 가능하지만, 보통은 주제를 깨끗하게 유지해야 합니다.
...
1. **비트맵과 관련된 콘텐츠의 사용을 허락을 받았는지 확인하세요.** 이것은 음악, 동영상, 히트사운드, 그래픽, 그리고 자신이 만들지 않은 모든 항목들에 적용됩니다. 만약 자유롭게 사용이 가능한 콘텐츠를 찾지 못하겠다면, [Featured Artist](https://osu.ppy.sh/beatmaps/artists/) 목록을 확인하세요. 이곳에 있는 곡들은 전부 _osu!_에서 허용됩니다.
