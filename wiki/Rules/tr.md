...
9.  **Eğer dile özel kanallarda sohbete katılacaksanız baskın dili (`#english`'te İngilizce, `#german`'da Almanca vs.) konuşmak zorundasınız.** Kanalın dili açık bir şekilde belirtilmemişse dominant dil İngilizcedir. Diğer kanalların aksine, `#lobby` ve `#help` kanallarında her dil konuşulabilir. _[Moderatörler](/wiki/People/The_Team/Global_Moderation_Team) işlerini yaparken bu kurala uymak zorunda değillerdir._
...
_Not: Bu kurallar yalnızca Derecli beatmapler için değil, **gönderilen bütün beatmapler** için geçerlidir. Dereceli beatmapler için geçerli olan spesifik kurallar için bakınız: [Ranking Criteria](/wiki/Ranking_Criteria)._

Yalnızca oyun içerisinde bulunan [Beatmap Gönderme Sistemi](/wiki/Glossary#bss) üzerinden gönderilen beatmapler bu kurala tabiidir. Bu konu başlıkları/tartışmalar, bir beatmap [editör](/wiki/Beatmap_Editor) üzerinden gönderildiğinde osu! istemcisi tarafından oluşturulur.
...
Kuralları herhangi bir şekilde çiğnemeniz durumunda, kötü sonuçlarına katlanırsınız.

Kötü sonuçlar, _aşağıdakilerle sınırlı kalmamakla beraber_, şunları içerir:
...
Birtakım kural ihlalleri, özellikle ağır bir tane olması halinde, belirli bir minimum süre bulundururlar (genellikle 48 saat veya daha fazla), lakin bu cezalar hemen hemen yalnızca çok ağır suçlara mahsustur; müstehcen içerik paylaşmak, başkalarına devamlı zorbalık yapmak gibi.

Eğer birçok kez ceza almanıza rağmen yine de kuralları çiğnemeye devam ederseniz, hesabınız süresiz ve geri alınamaz bir şekilde kısıtlandırılabilir.

Kısıtlı hesaplar çevrimiçi oynayamazlar, skor kaydedemezler, diğer kullanıcılarla sohbet edemezler, ve tüm bu niyetler ve amaçlar doğrultusunda topluluk ile iletişim kurmaktan men edilirler. Topluluk kurallarını çiğnemekten kısıtlandırılmış hesapların cezası ancak 3 ay geçtikten sonra oyun yetkililerine başvurulması halinde kaldırılabilir ([daha başka koşullar uygulanabilir](/wiki/Help_Centre/Account_Restrictions#common-restriction-reasons-and-cooldowns)).
