...
Если вы собираетесь использовать в картах чужие работы, вам необходимо разрешение от их владельцев. Если такого разрешения нет, вы рискуете как картами — они могут быть удалены, — так и своим доступом к системе публикации карт в соответствии с [политикой защиты авторских прав osu!](/wiki/Legal/Copyright).

Чтобы подобного не случилось, рекомендуется использовать чужие работы только в следующих случаях:

- У материала есть лицензия для использования в osu!;
- У вас есть разрешение на использование материала, полученное от автора;
...
В понятие визуального содержимого входят [фон карты](/wiki/Beatmap/Background), её [сториборд](/wiki/Storyboards) и видео. Они регулируются теми же правилами, что и аудиоматериалы.
