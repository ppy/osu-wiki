...
En tant que mappeur, vous devez avoir l'autorisation des détenteurs de droits d'auteur pour les éléments audio/visuels/de jeu inclus dans vos soumissions de beatmaps. Sans autorisation, vos beatmaps risquent d'être supprimés et l'accès au système de soumission risque de vous être refusé, conformément à la [politique de copyright d'osu!](/wiki/Legal/Copyright).

Pour garantir le bon fonctionnement de votre compte, il est recommandé de créer des maps en utilisant des actifs parmi les suivants :
...
Si vous avez reçu l'autorisation d'un musicien d'utiliser sa chanson, l'œuvre d'art de son album ou toute autre œuvre d'art officielle de l'artiste peut également être utilisée comme arrière-plan/storyboard. Toutefois, si cela n'est pas clair, demandez l'autorisation.

## Gameplay

Lorsque vous soumettez une beatmap, vous devez obtenir l'autorisation d'utiliser des ressources liées au gameplay, telles que les [difficultés invités](/wiki/Beatmap/Guest_difficulty) ou les graphiques d'autres jeux de rythme.
