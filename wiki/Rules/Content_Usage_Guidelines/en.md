...
osu! provides its userbase a library of licensed songs via the [Featured Artist](/wiki/Featured_Artists) program. Each song on this listing is free for use within osu! and has no risk of removal.
...
As with music, it is recommended to seek out an artist's input on usage terms and to ask for permission when those terms are unclear. For example, if you're interested in using a background from an artist on pixiv, locate their profile for usage terms or send them a message asking for permission.
...
We do not condone submissions featuring gameplay (hit objects) matching that of other games, as this is not respectful to the rhythm game community.
