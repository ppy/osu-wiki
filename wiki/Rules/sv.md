...
5. **Vår community är för alla åldrar** Detta betyder att 18+/[NSFW](https://en.wikipedia.org/wiki/Not_safe_for_work) innehåll som narkotikamissbruk eller sexuella ämnen är inte välkomna här. Undantag görs där det är lämpligt för detta, men håll det rent i allmänhet.
...
2. **Låt moderatorerna ta hand om problem i chatten.** Du kan påpeka saker till dem med [`!report` kommandot](/wiki/Reporting_Bad_Behaviour) om nödvändigt så tar dem hand om resten.
...
7. **Håll länkar till relevanta och lagliga webbplatser** Bootleg-streamingwebbplatser (officiellt licenserade sidor som Animelab och Crunchyroll är okej) aoch allt relaterat till "warez" eller piratkopierad programvara av något slag är inte okej, och vi vill inte ha dem i vår chatt.  Du får göra reklam för spel och Twitchlänkar, men ENDAST i `#videogames`.
...
Silences och andra överträdelser ökar **automatiskt** i varaktighet exponentiellt med varje regelbrytning. Moderatorer kontrollerar inte hur länge du blir tystad för en regelbrytning - upprepade regelbrytare kommer bli utlåsta från spelet i allt längre tider.
