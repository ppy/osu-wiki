...
5. **Fællesskabet er for alle aldre.** Det betyder, at 18+/[NSFW](https://da.wikipedia.org/wiki/NSFW) indhold, såsom brug af stoffer eller emner af seksuel natur, ikke er velkomment her. Alle billeder, videoer eller links, som bliver uploadet til eller tilgængeliggjort fra osu!, **skal** følge [overvejelserne for visuelt indhold](Visual_Content_Considerations) (dog er deling af ellers upassende indhold i private beskeder ikke imod reglerne, hvis modtageren samtykker til det).
