...
- Цель моддинга — помочь мапперу с улучшением карты, чтобы её при желании можно было [ранкнуть](/wiki/Beatmap/Category#ranked). Если у вас нет цели помочь, не встревайте в обсуждение, чтобы не *навредить*.
- Учитывайте, кому адресованы ваши замечания, какую цель вы преследуете, и какой ответ ожидаете получить. Эти вопросы помогут написать понятный и доброжелательный мод.
...
- Убедитесь, что у вас добрые намерения, и что вы собираетесь оставлять конкретные замечания. Вряд ли кому-то понравится грубо или лениво написанный мод-пост.
- При моддинге отделяйте объективные или широко признанные недостатки от моментов, которые не нравятся лично вам. **Можно комментировать как одно, так и другое, главное — явно обозначить разницу.**
  ...
  - **Субъективные недостатки** связаны только с вашим личным мнением и впечатлениями. Если с ними согласны много людей, субъективные недостатки могут перейти в категорию широко признанных.
- Моддинг должен быть направлен на улучшение карты **в рамках первоначальной задумки.** Не пытайтесь навязать мапперу свои собственные взгляды на карту; **исключение — ситуация, когда идея, взятая за основу карты, изначально плоха или ошибочна.** Если у карты слишком много серьёзных недостатков, чтобы каждый из них можно было разобрать отдельно, постарайтесь выделить общие проблемы и обрисовать, куда двигаться дальше.
...
В идеале, каждое замечание должно включать в себя четыре части, некоторые из которых можно пропустить, в зависимости от опытности маппера и ваших с ним взаимоотношений:

1. **Суть проблемы и место, где она проявляется.** Копируйте из редактора конкретный момент времени, чтобы к нему можно было быстро перейти.
...
- [Номинаторы](/wiki/People/The_Team/Beatmap_Nominators) и члены [команды оценки номинаций](/wiki/People/The_Team/Nomination_Assessment_Team) (NAT) читают обсуждение карты перед тем, как изменять её статус. Полноценные ответы на моды и аргументация помогут им в понимании вашей позиции, а также избавят всех участников дискуссии от необходимости обсуждать одно и то же по нескольку раз.
