...
# Verfahren zur Abstimmung über Inhalte

Inhalte, die die [Beatmap-Nominatoren](/wiki/People/Beatmap_Nominators) (BN), das [globale Moderationsteam](/wiki/People/Global_Moderation_Team) (GMT) und das [Nomination-Assessment-Team](/wiki/People/Nomination_Assessment_Team) (NAT) zur Überprüfung anschauen, durchlaufen ein spezielles Abstimmungsverfahren, das im Folgenden beschrieben wird.
...
FrüchteSammlerin möchte einen Hintergrund für ihre neue Beatmap nutzen, aber ist sich unsicher, ob das Hintergrundbild erlaubt ist. Gemäß dem Prozess oben meldet sie den Inhalt für eine Abstimmung.

Nach 3 Tagen ist die Wahl beendet und das Ergebnis steht fest.
...
Da dies nicht über der benötigten 70%-Hürde liegt, ist das Bild nicht für die Verwendung zugelassen und FrüchteSammlerin muss ein anderes Bild aussuchen.

#### Beispiel 2

Eine Nutzerin meldet eine qualifizierte Beatmap, die von KreiseEnthusiast erstellt wurde, da sie der Meinung ist, dass das Hintergrundbild unangemessen ist. Sie meldet den Inhalt wie oben beschrieben.

Die Meldung wird vom GMT und vom NAT überprüft. Da sich beide Teams unsicher sind, wird für eine Abstimmung auf der Diskussionsseite der Beatmap ein Vorschlag veröffentlicht, um zu verhindern, dass die Beatmap gerankt wird.

Nach 7 Tagen ist die Abstimmung beendet. Das GMT und NAT stimmen zu 71 % dafür, dass das Bild in Ordnung ist. 29 % entscheiden sich dagegen.

Da aus dem GMT und dem NAT eine Mehrheit von mindestens 70 % für die Freigabe des Bilds gestimmt hat, werden die BN-Stimmen nicht berücksichtigt.

Der Diskussionsbeitrag wird als gelöst markiert und KreiseEnthusiast wird darüber informiert, dass seine Beatmap ohne Änderungen gerankt werden darf.
