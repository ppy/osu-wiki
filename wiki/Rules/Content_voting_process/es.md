...
2. Luego, el reporte es evaluado por el NAT y el GMT[^beatmap-nominators]. Para todas las situaciones, excepto las más obvias, se publica un nuevo «caso de contenido» que se somete a votación lo antes posible. Todos los miembros de los BN, el GMT y el NAT tienen derecho a votar.
3. Mientras la votación esté activa, ningún mapa que contenga dicho elemento visual podrá ser nominado ni calificado. Si el mapa está calificado, se publicará una sugerencia en la discusión del modding, lo que impedirá que el mapa sea clasificado hasta que finalice la votación.
...
Un usuario reporta un beatmap calificado creado por StableStreamer porque cree que su fondo es inapropiado. Lo reporta tal y como se ha descrito anteriormente.

El reporte es revisado por el GMT y el NAT. Tras alcanzar un consenso mixto, el contenido se somete a votación y se publica una sugerencia en la discusión del beatmap para impedir que el mapa sea clasificado.

Después de 7 días, la votación concluye. El 71 % del GMT y el NAT están de acuerdo en que la imagen es aceptable. El 29 % no lo está.

Teniendo en cuenta que al menos el 70 % del GMT y el NAT coincidieron en que la imagen es aceptable, los votos de los BN no se tienen en cuenta.

Se resuelve la discusión del beatmap y se le informa a StableStreamer que su beatmap puede clasificarse sin cambios.

## Notas

[^beatmap-nominators]: Los [Beatmap Nominators](/wiki/People/Beatmap_Nominators) que envían contenido para someterlo a votación pueden saltarse el proceso de revisión y comenzar una nueva votación inmediatamente.
