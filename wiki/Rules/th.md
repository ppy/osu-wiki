...
5. **เราเป็นชุมชนที่มีทุกวัย** ดังนั้นแปลว่า อะไรก็ตามที่เป็น 18+/[NSFW](https://en.wikipedia.org/wiki/Not_safe_for_work) เช่นเรื่องการเสพยา หรือเรื่องหื่นกามต่าง ๆ จะไม่ถูกต้อนรับที่นี่ จะมีข้อยกเว้นเฉพาะในเรื่องที่เหมาะสม แต่ถ้าตามปกติแล้ว อย่าพูดถึงเรื่องพวกนี้
6. **ถ้าเรื่องอะไรอยู่นอกเหนือกฎ ควรใช้ความคิดเบื้องต้นคิดเอง** ทีมงานมีสิทธิ์ที่จะดูแลลงโทษผู้ใช้ตามความเหมาะสม
...
กฎพวกนี้มีผลต่อบีทแมพที่ถูกอัปโหลดผ่าน [Beatmap Submission System](/wiki/Glossary#bss) ภายในเกม โดยกระทู้/การสนทนา จะถูกสร้างขึ้นด้วย osu! client ในระหว่างที่บีทแมพถูกอัปโหลดผ่าน [เครื่องมือแก้ไขบีทแมพ](/wiki/Beatmap_Editor)
