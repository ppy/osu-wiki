...
*Οι ακόλουθοι κανόνες ισχύουν ΜΟΝΟ για το [Off-Topic](https://osu.ppy.sh/community/forums/52) υπο-φόρουμ, εκτός εάν δηλώνεται διαφορετικά.*
...
Τα silences και άλλες παραβάσεις αυξάνονται **αυτόματα** και σταδιακά σε διάρκεια με κάθε παράβαση. Οι συντονιστές δεν ελέγχουν το χρονικό διάστημα του silence που έχετε για ένα παράπτωμα - οι επαναλαμβανόμενοι παραβάτες θα βρεθούν κλειδωμένοι από το παιχνίδι για όλο και μεγαλύτερες χρονικές περιόδους.
...
Οι περιορισμένοι λογαριασμοί δεν μπορούν να παίξουν online, να υποβάλλουν σκορ, να συνομιλήσουν με άλλους χρήστες και είναι σε κάθε περίπτωση «απαγορευμένοι» από κάθε αλληλεπίδραση με την κοινότητα. Ο περιορισμός λόγω της παραβίασης των κανόνων της κοινότητας μπορεί να αφαιρεθεί μετά από έφεση στο προσωπικό του παιχνιδιού μετά από 3 μήνες.
