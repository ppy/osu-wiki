...
7.  **Διατηρήστε τους συνδέσμους που δημοσιεύετε με σχετικές και νόμιμες ιστοσελίδες.** Οι ιστοσελίδες Bootleg streaming (όσα έχουν επίσημη άδεια όπως το Animelab και Crunchyroll είναι εντάξει) και οτιδήποτε σχετίζεται με λογισμικό "warez" ή πειρατικό λογισμικό οποιουδήποτε είδους δεν είναι αποδεκτό και δεν τα θέλουμε στο chat μας. Η διαφήμιση συνδέσμων Twitch για άλλα βιντεοπαιχνίδια είναι εντάξει, αλλά ΜΟΝΟ στο `#videogames`.
...
3.  **Μην κλέβετε beatmaps αλλωνών, παρουσιάζοντάς τα σαν δικά σας.** Επίσης, μην ανεβάζετε και μην χρησιμοποιείτε έργα αλλωνών χωρίς τη ρητή άδειά τους (συμπεριλαμβανομένων, αλλά χωρίς περιορισμό, των skins και guest difficulties).
...
2.  **Η υπερβολική ανοησία είναι κακή.** Είναι εντάξει να αστειεύεστε από 'δώ και από 'κεί, έτσι λειτουργεί άλλωστε και το "shitposting",  αλλά όχι να γράφετε συνέχεια ανοησίες. Αν δεν μπορείτε να διακρίνετε τη διαφορά μεταξύ αυτών των δύο, παραβιάζετε ήδη τον κανόνα.
