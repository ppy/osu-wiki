...
8. **Não compartilhe servidores de terceiros de qualquer tipo, incluindo grupos/servidores do Discord, Teamspeak ou Skype.** Os canais do osu! são em sua maioria utilizados apenas para conversas relacionadas ao _osu!_, e não para compartilhar links do seu servidor pessoal. Faça-o através da mensagem privada caso realmente seja necessário.
