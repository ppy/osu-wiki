...
4.  **Encorage um jogo mais justo, e não dê atenção a trapaceiros, cheaters, ou usuários tóxicos.** Essas pessoas infelizmente existem, e dar atenção a elas por motivá-las a continuar com o comportamento, ou provocar outros a agirem da mesma forma. Reporte-as pelo comando `!report` ou com o botão em seu perfil e siga em frente.
5.  **Mantenha o canal limpo e apropriado para todas as idades, evitando tópicos impróprios sempre que possível.** Conteúdo NSFW não é apropriado para uma comunidade livre para todas as idades. Faça o que bem entender em mensagens privadas (caso exista motivos) mas mantenha os canais públicos limpos pelo bem de todos.
...
3.  **Produza críticas construtivas sem resultar em ataques pessoais.** Críticas são algo incrível caso sejam feitas apropriadamente, mas caso você esteja pensando em realizar ataques pessoais para esclarecer um ponto feito, você está fazendo isso errado e deveria se sentir mal por isso.
...
Silences e outras infrações **automaticamente** aumentam sua duração quase que exponencialmente à partir de cada infração. Moderadores não controlam o tempo do seu silence por uma ofensa. Usuários que repetirem as mesmas ofensas se encontrarão impossibilitados de ter acesso ao jogo por um longo período de tempo.
