...
Кликнете върху трите точки от дясно на проблемния туит и опция 'Докладване на туита'. Уверете се че следвате указанията и ги четете внимателно. Може също да прочетете [напътствията на Twitter за докладване на неприлично поведение](https://help.x.com/en/safety-and-security/report-abusive-behavior) като допълнителна информация за процеса.

Впоследствие, също блокирайте или заглушете въпросния потребител с клик върху трите точки от дясно на неговия туит (ако използвате уебсайта или мобилно приложение). Консултирайте се с [урока на Twitter за блокиране на акаунти](https://help.x.com/en/using-twitter/blocking-and-unblocking-accounts) за повече информация.
