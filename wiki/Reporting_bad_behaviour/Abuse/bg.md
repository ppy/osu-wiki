...
- ::peppy::{ user=2 } (създател на игра)
- ::Ephemeral::{ user=102335 } (управител на общност)
...
За да направите това, кликнете върху име на член от GMT в списъка от горната връзка. Това ще ви изпрати към профилната им страница. Ако не сте сигурни кого да изберете, просто използвайте ::тази връзка::{ user=5999631 }.
