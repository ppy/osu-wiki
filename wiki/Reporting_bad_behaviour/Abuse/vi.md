...
Địa chỉ email lạm dụng chỉ có thể được xem bởi ::peppy::{ user-id=2 }(người tạo ra trò chơi).
...
Ngoài ra, bạn cũng có thể nhấp vào tên người dùng của bất kỳ thành viên GMT nào trong danh sách trên trang wiki trên để đến hồ sơ của họ. Nếu bạn không biết nên chọn ai để báo cáo, ::hãy sử dụng liên kết này::{ user-id=5999631 }.
