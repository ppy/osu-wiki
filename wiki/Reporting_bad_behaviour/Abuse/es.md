...
La dirección de correo electrónico de abuso solo la puede ver ::peppy::{ user=2 } (el creador del juego).
...
Alternativamente, haz clic en el nombre de usuario de cualquier miembro del equipo de moderadores en la lista de esa página. Esto te llevará a su perfil. Si no estás seguro de a quién hacer clic, simplemente usa ::este enlace::{ user=5999631 }.
