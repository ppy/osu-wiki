...
Si te sientes lo suficientemente incómodo como para estar leyendo esta página, ponte en contacto con nosotros de inmediato a [abuse@ppy.sh](mailto:abuse@ppy.sh) con el mayor detalle posible sobre tu problema.
...
Desplázate a través de los subtítulos para averiguar qué hacer, dependiendo de dónde haya ocurrido todo esto.
...
También puedes reportar al usuario escribiendo `!report <persona> <problema>`, donde `<persona>` es el nombre de usuario de la persona que te causa problemas y `<problema>` es una breve explicación de los problemas. Si hay espacios en el nombre de usuario de la persona, reemplázalos por guiones bajos (`_`).
...
[Reporta la publicación](/wiki/Reporting_bad_behaviour#forum) a nuestro [equipo de moderación global](/wiki/People/Global_Moderation_Team) lo antes posible.

Para hacerlo, haz clic en el botón `Reportar publicación` en la esquina superior derecha de la publicación del foro.

Alternativamente, haz clic en el usuario de cualquier miembro del equipo de moderadores en la lista de esa página. Esto te llevara a su perfil. Si no estás seguro de a quién hacer clic, simplemente usa [este enlace](https://osu.ppy.sh/users/102335).
...
Pega el enlace de la publicación del foro que contiene el contenido problemático y cuéntale al GMT un poco lo que está pasando. Ellos eliminarán la publicación por ti lo más pronto posible.

Si la publicación sigue sin desaparecer dentro de un periodo de tiempo razonable, por favor envía un correo a [abuse@ppy.sh](mailto:abuse@ppy.sh) conteniendo la mayor cantidad posible de información.
...
Envía un correo a [abuse@ppy.sh](mailto:abuse@ppy.sh) conteniendo la mayor cantidad posible de información **inmediatamente**. Esto incluye capturas de pantalla, registros del chat, básicamente cualquier cosa que puedas adjuntar en un correo electrónico.

Si cualquier cosa que incluyas te hace sentir avergonzado, por favor déjalo en blanco.
...
Si no tienes evidencia pero sí historias o rumores que crees que sean lo suficientemente sustanciales para actuar al respecto, envíanos un correo de todas formas. Recibimos quejas como esta seriamente e investigaremos profundamente todos los reportes.

## ¡Mi correo electrónico ha sido ignorado!

Si no has recibido una respuesta a tu correo electrónico después de un par de semanas, envía un correo de seguimiento.

Lo más probable es que el correo electrónico se haya perdido en algún momento, pero aun así queremos investigar tu informe.
