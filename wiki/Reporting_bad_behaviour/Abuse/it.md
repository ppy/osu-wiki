...
L'indirizzo email per gli abusi è visibile solo da ::peppy::{ user=2 } (il creatore del gioco).
...
In alternativa, clicca sul nome utente di un qualsiasi membro del GMT nella lista su quella pagina. Questo ti porterà al suo profilo. Se non sei sicuro di chi contattare, usa ::questo link::{ user=5999631 }.
