...
L'adresse électronique d'abus n'est vue que par ::peppy::{ user=2 } (le créateur du jeu).
...
Alternativement, cliquez sur le nom d'utilisateur d'un membre de la GMT dans la liste de cette page. Vous accéderez ainsi à son profil. Si vous ne savez pas sur qui cliquer, utilisez simplement ::ce lien à la place::{ user=5999631 }.
