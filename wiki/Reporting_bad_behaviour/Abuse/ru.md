...
::: alert-notice
**Внимание**
всё общение с людьми, разбирающими жалобы по почте, должно происходить на английском языке. При общении с модератором там, где этого требует ситуация, можно использовать любой понятный ему язык.
:::
...
Указанную выше почту читает только [peppy](https://osu.ppy.sh/users/2), создатель игры. Всё, что вы отправите на [abuse@ppy.sh](mailto:abuse@ppy.sh), будет доступно только ему и никому больше.
...
Пожаловаться также можно, отправив в чат команду `!report ник причина`, где `ник` — это ник проблемного пользователя, а `причина` — ваша жалоба (на английском). Пробелы в чужом нике нужно заменить на подчёркивания (`_`).
...
Как можно скорее [пожалуйтесь на сообщение](/wiki/Reporting_bad_behaviour#форум) любому из [модераторов](/wiki/People/Global_Moderation_Team). Для этого нажмите на кнопку `Report post` в правом верхнем углу сообщения.

Вместо этого можно также написать модераторам лично лично: перейдите по ссылке выше и кликните по нику любого модератора, чтобы перейти к его профилю. Если вы не знаете, кого выбрать, [нажмите сюда](https://osu.ppy.sh/users/5999631).
...
Если вдобавок к этому вы знаете ник нарушителя в osu!, свяжитесь с нами по адресу [abuse@ppy.sh](mailto:abuse@ppy.sh), указав в письме как можно больше подробностей о случившемся. Мы не наказываем пользователей за действия на других платформах, поэтому не даём никаких гарантий. Тем не менее, мы запишем информацию о нарушителе и в будущем будем иметь её в виду.
...
Если твиттер-аккаунт привязан к профилю в osu! (под аватаркой пользователя есть иконка с птицей, где указана ссылка на твиттер), свяжитесь с нами по адресу [abuse@ppy.sh](mailto:abuse@ppy.sh). К письму необходимо приложить скриншот твита, а также как можно больше подробностей о случившемся. Мы не наказываем пользователей за действия на других платформах, поэтому не даём никаких гарантий. Тем не менее, мы запишем информацию о нарушителе и в будущем будем иметь её в виду.

## Член команды волонтёров (NAT или GMT) пристаёт ко мне или пишет гадости!

**Как можно скорее** свяжитесь с нами по адресу [abuse@ppy.sh](mailto:abuse@ppy.sh), указав в письме как можно больше подробностей о случившемся (скриншоты, логи переписок и т.д.).

Если вам стыдно за какие-то подробности, зацензурьте их или закрасьте в графическом редакторе.
...
## Мою жалобу проигнорировали!

Если вам не ответили в течение пары недель, напишите повторное письмо на случай, если первое затерялось: мы всё равно хотим разобраться после вашей жалобы.
