...
Указанную выше почту читает только ::peppy::{ user-id=2 }, создатель игры. Всё, что вы отправите на [abuse@ppy.sh](mailto:abuse@ppy.sh), будет доступно только ему и никому больше.
...
Вместо этого можно также написать модераторам лично лично: перейдите по ссылке выше и кликните по нику любого модератора, чтобы перейти к его профилю. Если вы не знаете, кого выбрать, ::нажмите сюда::{ user-id=5999631 }.
