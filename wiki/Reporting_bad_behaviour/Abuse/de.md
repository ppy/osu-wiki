...
Die E-Mail-Adresse für Missbrauch wird nur von ::peppy::{ user=2 } (dem Erfinder des Spiels) angesehen.
...
Alternativ kannst du auf den Benutzernamen eines beliebigen GMT-Mitglieds in der Liste auf dieser Seite klicken. Dadurch gelangst du zu dessen Profil. Wenn du unsicher bist, auf wen du klicken sollst, verwende stattdessen einfach ::diesen Link::{ user=5999631 }.
