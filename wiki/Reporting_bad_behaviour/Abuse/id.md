...
Akun email penyalahgunaan kami hanya dapat diakses ::peppy::{ user=2 } (selaku pembuat osu!).
...
Sebagai alternatifnya, klik nama pengguna salah satu GMT yang tertera pada halaman di atas. Hal ini akan membawamu ke profil mereka masing-masing. Apabila kamu tidak yakin kepada siapa kamu harus melapor, kamu dapat ::langsung menghubungi pengguna ini::{ user=5999631 }.
