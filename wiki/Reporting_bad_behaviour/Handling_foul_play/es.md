...
## ¡Demuéstrame que yo/otros usuarios estaban haciendo trampa! ¡Quisiera saber cómo lo saben!
...
**Esta es la mejor forma de reportar tus sospechas de juego sucio, ya que proporciona la mayor cantidad de información a los miembros del equipo de soporte.**

En el perfil del usuario, al hacer clic en los tres puntos que hay junto al botón de `Mensaje`, aparecerá un botón de `Reportar`. Escribe cualquier tipo de información que pueda demostrar que el usuario está realizando una mala acción.
