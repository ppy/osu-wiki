...
```
!report username
!report username (дальше идёт жалоба в свободной форме)
```
...
1. Нажмите на его ник, а затем кликните по красной кнопке `Report User...`
...
![](img/report-user-comment.png "Кнопка отправки жалобы под комментарием")
...
![](img/report-user-discussion.png "Кнопка отправки жалобы в обсуждении карты")
