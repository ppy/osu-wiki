...
管理员团队会忽视误举报的玩家。但如果玩家恶意发送无效举报，则可能会导致被[禁言](url)。
...
在聊天中出现的不当行为是最常见的侵权行为。要举报它，最好在出现侵权消息的频道内，使用 [`!report`](https://osu.ppy.sh/community/forums/topics/34843) 命令。不要感到压力：如果你的举报命令是 `!report` 开头，那么这条举报消息**仅对频道管理员可见**，频道内的其他人都无法看见。如果你仍然担心举报信息会泄露，也可以按照以下的示意，在游戏内覆盖层举报。

聊天不当行为是最常见的侵权行为。要报告它，请使用！报告命令，最好是在发生侵权的渠道。不要感到压力：如果你的信息开头是！报告和一个空间，它只对主持人可见，聊天中没有其他人。如果您仍然担心，也可以通过游戏内覆盖使用报告功能，如下所示。
