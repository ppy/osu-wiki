...
- Bazı kişisel hesaplar sohbet botları grubundadır çünkü sahipleri sundukları hizmet için ayrı bir bot hesabı açmak istememişler ya da talep etmemişlerdir, örneğin ::{ flag=DE }:: ::Tillerino::{ user-id=2070907 } ve ::{ flag=FR }:: ::ThePooN::{ user-id=718454 }. Bu tarz bir kurulum artık teklif edilmemektedir, ve gruba dahil olan yeni botlar her zaman için özel bir hesapta bulunurlar.
