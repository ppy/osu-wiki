...
- Some personal accounts are in the chat bots group because the owners didn't want or request to have a separate bot account for their service, for example ::{ flag=DE }:: ::Tillerino::{ user=2070907 } and ::{ flag=FR }:: ::ThePooN::{ user=718454 }. This setup is no longer offered, and new bots entering the group will always be given an exclusive account.
