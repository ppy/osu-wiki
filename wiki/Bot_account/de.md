...
- Einige persönliche Accounts sind in der Chatbots-Gruppe, weil ihre Betreiber keine Anfrage eingereicht haben, einen separaten Bot-Account für ihren Dienst zu erstellen, beispielsweise ::{ flag=DE }:: ::Tillerino::{ user=2070907 } und ::{ flag=FR }:: ::ThePooN::{ user=718454 }. Dieses Setup wird nicht mehr angeboten und neue Bots, die der Gruppe beitreten, werden immer einen exklusiven Account erhalten.
