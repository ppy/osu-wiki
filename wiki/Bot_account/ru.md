...
Главное отличие бот-аккаунтов — более лояльные ограничения на [использование чата](/wiki/Chat_Console), что избавляет от риска получения [сайленса](/wiki/Glossary#сайленс) при слишком частой отправке сообщений:
