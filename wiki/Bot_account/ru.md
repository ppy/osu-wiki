...
Ограничения действуют только на личные сообщения и каналы `#multiplayer` и `#spectator`. В остальные каналы ботам писать запрещено, как и отправлять нежелательные личные сообщения.
