...
_Listę komend klienta gry możesz sprawdzić tutaj: [Czat](/wiki/Chat_Console)_
...
_Ważne: Komenda `SEARCH` nie została uwzględniona, gdyż nie jest już obsługiwana._

_Ważne: Na atrybut `użytkownik` nie ma wpływu wielkość liter._
...
_Ważne: Atrybut `user` dla komendy `REPORT` nie jest uwzględniony._
...
_Ważne: BanchoBot nie poda informacji z jakiego trybu pochodzą statystyki._

_Ważne: BanchoBot wyświetli `User not found`, jeżeli użytkownik nie zagrał żadnej beatmapy, nawet jeśli posiada on własne konto._
...
_Ważne: Zostanie wyświetlony tylko kraj w którym obecnie mieszka użytkownik._
...
_Ważne: Jeżeli chcesz zgłosić moderatora, wyślij wiadomość e-mail pod adres [support@ppy.sh](mailto:support@ppy.sh)._

_Ważne: Możesz także użyć panelu użytkownika, aby zgłosić innych._
