...
*인-게임 클라이언트 명령어의 목록은 [Chat Console](/wiki/Chat_Console) 을 참조하세요.*
...
신고를 [Global Moderation Team](/wiki/Global_Moderation_Team) 혹은 [Language Moderators](/wiki/Global_Moderation_Team) 에게 보냅니다.
