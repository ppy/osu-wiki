...
**Not: Bütün komutlarınızın başına `/` eklemek _zorundasınız_!** Bütün etki listesi komut listesinden kelimesi kelimesinedir. Notlar _italik_ olarak gösterilir.

### Standart komutlar

_Standart komutların tablosu için [Chat Console](/wiki/Chat_Console) makalesine bakınız._
