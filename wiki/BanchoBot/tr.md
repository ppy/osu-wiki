...
**BanchoBot** (*Bancho* olarak da adlandırılır) oyun-içi sohbette oyun ile ilgili duyuru mesajları göndererek (örn. toplam oynama, tekrarlama sayısı, gibi), ve birtakım komutlara yanıt vererek onlara yardımcı olan osu! için yapılmış bir çevrimiçi sohbet botudur. [Bancho IRC](/wiki/Community/Internet_Relay_Chat) (Internet Relay Chat) altyapısının sağlayıcısı ::{ flag=NZ }:: ::Echo::{ user=431 } tarafından programlanmıştır.

BanchoBot aynı zamanda kendine ait bir ::osu! profiline::{ user=3 } ve [Twitter hesabına](https://twitter.com/banchoboat) sahiptir.
