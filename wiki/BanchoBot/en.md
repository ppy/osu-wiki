...
| `STATS`   | `<user_name>`          | Displays the stats of the user depending on the mode they're playing                    | `!stats Nathanael`                    | "Stats for [Nathanael](https://osu.ppy.sh/u/2295078): <br> Score:    3,932,370,747 (#83535) <br> Plays:    42978 (lv100) <br> Accuracy: 98.38%" |
| `WHERE`   | `<user_name>`          | Shows the current location of the user.                                                 | `!where Nathanael`                    | "Nathanael is in Philippines" |
