...
Ещё у бота есть собственные профили в [osu!](https://osu.ppy.sh/users/3) и [Твиттере](https://twitter.com/banchoboat).
...
Команды можно отправлять в личку BanchoBot или прямо в общий чат (в этом случае их никто, кроме отправителя, не увидит).
...
Показать список доступных команд для BanchoBot.
...
Выбрать случайное число в диапазоне от 1 до указанного (по умолчанию — 100).
...
Показать краткую статистику по режиму, в который последний раз играл пользователь.
...
Показать, в какой стране сейчас находится пользователь.

*Примечание: будет показана только страна, без города.*
...
Пожаловаться на игрока [модераторам каналов](/wiki/Language_Moderators) или [глобальным модераторам](/wiki/Global_Moderation_Team).
