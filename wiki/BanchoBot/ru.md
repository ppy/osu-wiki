...
*Вы также можете ознакомиться с [полным списком команд чата](/wiki/Chat_Console).*
...
Отправляет жалобу на игрока [модераторам каналов](/wiki/Global_Moderation_Team) или [глобальным модераторам](/wiki/Global_Moderation_Team).
