...
BanchoBot is een bot (d.w.z. een verzameling van opdrachten met geautomatiseerde antwoorden) die mensen in de chat helpt door bepaalde informatie weer te geven en spelgerelateerde berichten aan te kondigen. Hij werd geprogrammeerd door ::{ flag=NZ }:: ::Echo::{ user=431 } en is de host van de [Bancho IRC](/wiki/Community/Internet_Relay_Chat) (Internet Relay Chat). BanchoBot heeft ook z’n eigen ::osu! profile::{ user=3 } en [Twitteraccount](https://twitter.com/banchoboat)!
