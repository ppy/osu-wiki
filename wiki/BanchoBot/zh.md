...
BanchoBot 是 [Bancho IRC](/wiki/Internet_Relay_Chat) 的主体，其 ID 为 _[#3](https://osu.ppy.sh/users/3)_ （就比 ID 是 [#2](https://osu.ppy.sh/users/2) 的 peppy 大一号）。_同时，它也有一个[推特账号](https://twitter.com/banchoboat)。_
...
_查阅客户端指令列表，请参见 [聊天窗口](/wiki/Chat_Console#命令列表) 。_
