...
**BanchoBot** (หรืออีกชื่อหนึ่งว่า *Bancho*) เป็นแชทบอทสำหรับช่วยเหลือผู้นเล่นผ่านทางช่องแชทในเกม osu! โดยจะบอกข้อมูลที่เกี่ยวข้องกับเกม อาทิ จำนวนเกมที่เล่น จำนวนครั้งที่เริ่มใหม่ ฯลฯ และจะรับคำสั่งบางคำสั่ง
...
หากผู้ใช้ทั่วไปสั่งคำสั่งผ่านทางช่องแชทสาธารณะ ผู้ใช้อื่นจะไม่เห็นคำสั่งและการตอบกลับแต่อย่างใด ซึ่งการตอบกลับจะส่งผ่านทางช่องแชทส่วนตัวของ BanchoBot แทน

ผู้ใช้สามารถใช้คำสั่ง `/bb` เพื่อเรียกช่องแชทส่วนตัวของ BanchoBot ได้
...
*หมายเหตู: คำสั่ง `!request` ไม่สามารถใช้ได้แล้ว*
...
คำสั่ง `!stats` จะแสดงสถานะและสติถิของผู้ใช้นั้น โดยสถิติจะขึ้นอยู่กับ[โหมดของเกม](/wiki/Game_Modes)สุดท้ายที่ผู้ใช้นั้นเล่นไป อย่างไรก็ตาม BanchoBot จะไม่ได้แสดงว่าสถิตินั้นมาจาก[โหมดของเกม](/wiki/Game_Modes)ใด
...
คำสั่ง `!where` จะแสดงสถาณที่ของผู้ใช้ณ ขณะนั้น โดยทัวไปจะแสดงเพียงประเทศที่อยู่อาศัย แต่ถ้าผู้ใช้นั้นเปิด `Share your city location with others` จะแสดงข้อมูลของจังหวัด/รัฐ/เมือง ด้วย
...
คำสั่ง `!faq` จะแสดงข้อมูลของข้อความนั้น แต่ถ้าข้อความเป็น `list` จะแสดงข้อความที่สามารถใส่ได้ทั้งหมดแทน โดยที่วไป BanchoBot จะตอบกลับเป็นภาษาอังกฤษ แต่ถ้าเติม[รหัสภาษา 2 ตัว](/wiki/Article_Styling_Criteria#locales)หน้าข้อความตามด้วยเครื่องหมายทวิภาค(`:`) BanchoBot จะตอบกลับเป็นภาษานั้นได้ ถ้าหากมีข้อมูลภาษานั้น
...
สำหรับการรายงานผู้ดูแล ให้ส่งอีเมลไปที่ [support@ppy.sh](mailto:support@ppy.sh) แทน
...
- หน้าผู้ใช้ของ BanchoBot จะแสดงคำว่า "Here since the beginning" แทนที่วันที่เข้าร่วม
  - วันที่เข้าร่วมของ BanchoBot จริงคือเวลา 10:09:14 UTC+7 วันที่ 28 กรกฏาคม พ.ศ.2550
