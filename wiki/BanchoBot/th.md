...
*สำหรับรายการคำสั่งภายในตัวเกม Client ดูที่: [หน้าต่างแชท (Chat console)](#รายการคำสั่ง-(commands-list)) (Chat_console#commands-list)*
