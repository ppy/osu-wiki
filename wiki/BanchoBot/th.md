...
BanchoBot เขียนขึ้นโดย ::{ flag=NZ }:: ::Echo::{ user=431 } และ BanchoBot ก็เป็นผู้ให้บริการ [Bancho IRC](/wiki/Community/Internet_Relay_Chat) (ไออาร์ซี)

BanchoBot มีทั้ง ::หน้าผู้ใช้ของ osu!::{ user=3 } และ [บัญชีผู้ใช้ทวิตเตอร์](https://twitter.com/banchoboat)
...
::: alert-notice
**ประกาศ**
คำสั่ง `!request` ไม่สามารถใช้ได้แล้ว
:::
