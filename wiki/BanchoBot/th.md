...
BanchoBot เขียนขึ้นโดย ::{ flag=NZ }:: ::Echo::{ user-id=431 } และ BanchoBot ก็เป็นผู้ให้บริการ [Bancho IRC](/wiki/Community/Internet_Relay_Chat) (ไออาร์ซี)

BanchoBot มีทั้ง ::หน้าผู้ใช้ของ osu!::{ user-id=3 } และ [บัญชีผู้ใช้ทวิตเตอร์](https://twitter.com/banchoboat)
