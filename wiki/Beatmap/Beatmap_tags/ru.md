...
Теги, добавленные маппером, можно использовать в качестве фильтра в [меню выбора песен](/wiki/Client/Interface#экран-выбора-песни), а также в [списке карт](https://osu.ppy.sh/beatmapsets) на сайте.
