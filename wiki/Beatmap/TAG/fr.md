...
Le terme **TAG** est le terme utilisé pour décrire les modes de jeu en mode [multijoueur](/wiki/Client/Interface/Multiplayer) appelés [Tag Coop ou Tag Team Vs](/wiki/Client/Interface/Multiplayer#tag-coop-/-tag-team-vs) où les joueurs essaient de compléter une [beatmap](/wiki/Beatmap) ensemble. Les beatmaps qui sont spécifiquement conçues pour ces modes sont généralement appelés **TAG beatmaps/difficulties**.
