...
Le terme **TAG** est le terme utilisé pour décrire les modes de jeu en mode [multijoueur](/wiki/Gameplay/Multiplayer) appelés [Tag Coop ou Tag Team Vs](/wiki/Gameplay/Multiplayer#tag-coop-/-tag-team-vs) où les joueurs essaient de compléter une [beatmap](/wiki/Beatmap) ensemble. Les beatmaps qui sont spécifiquement conçues pour ces modes sont généralement appelés **TAG beatmaps/difficulties**.
