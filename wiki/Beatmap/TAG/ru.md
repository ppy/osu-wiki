...
**TAG** — это термин, используемый для описания [многопользовательских](/wiki/Gameplay/Multiplayer) командных режимов под названием [Tag Coop или Tag Team Vs](/wiki/Gameplay/Multiplayer#tag-coop-/-tag-team-vs), в которых несколько игроков пытаются пройти [карту](/wiki/Beatmap) совместными усилиями.
