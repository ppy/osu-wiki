...
**TAG**とは、[マルチプレイヤー](/wiki/Gameplay/Multiplayer)のチームモードである[Tag CoopもしくはTag Team Vs](/wiki/Gameplay/Multiplayer#tag-coop-/-tag-team-vs)を指し、プレイヤーが協力して[ビートマップ](/wiki/Beatmap)をクリアしようとする際に使われる用語です。これらのモードに特化したビートマップは、**TAGビートマップ/難易度**と呼ばれています。
