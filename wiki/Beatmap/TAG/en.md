...
**TAG** is a term used to describe [multiplayer](/wiki/Gameplay/Multiplayer) team modes named [Tag Coop or Tag Team Vs](/wiki/Gameplay/Multiplayer#tag-coop-/-tag-team-vs) where players try to complete a [beatmap](/wiki/Beatmap) cooperatively. Beatmaps that are specifically designed for those modes are usually referred to as **TAG beatmaps/difficulties**.
