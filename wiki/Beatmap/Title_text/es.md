...
Solo los miembros del [NAT](/wiki/People/Nomination_Assessment_Team) y los administradores del sitio pueden actualizar el texto del título de los beatmaps; es una configuración en línea en lugar de algo que se encuentra en los archivos locales del beatmap. Si desea actualizar el texto del título de su propio mapa, puede comunicarse con personas que pertenecen a estos grupos.

Cuando se ponga en contacto con una de estas personas, deberá proporcionarle una cadena que describa el contenido y el formato del texto del título. osu! requiere que esta cadena se escriba de una manera muy particular, como se especifica en la siguiente sección.
...
| `hold` | Cuánto tiempo se mostrará la línea antes de comenzar a desvanecerse, en milisegundos. | *Cambios por línea* |
| `size` | El tamaño de fuente de la línea, en [puntos](https://es.wikipedia.org/wiki/Punto_tipográfico). | 40 |
| `time` | El tiempo en la canción en el que esta línea comenzará a aparecer, en milisegundos. | *Cambios por línea* |
