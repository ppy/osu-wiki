...
Le **beatmap TAG** (o solo *TAG*) sono beatmap create specificamente per le [modalità Tag co-op e Tag-team VS](/wiki/Gameplay/Multiplayer#tag-co-op-/-tag-team-vs) nelle [lobby multigiocatore](/wiki/Gameplay/Multiplayer). In quanto tali, spesso è necessario che due o più giocatori nella lobby cooperino in gioco per riuscire a completare queste beatmap.
