...
![Un esempio di beatmap TAG](img/tag-beatmap-example.png "Un esempio di beatmap TAG")
...
A causa della loro natura, le difficoltà TAG sono per la maggior parte non classificate, [Approvate](/wiki/Beatmap/Category#approvate), o [Amate](/wiki/Beatmap/Category#amate). Tuttavia, in rare occasioni, le beatmap TAG che seguono i [criteri di classificazione](/wiki/Ranking_criteria) e sono ritenute idonee ad essere classificate dai [Nominatori di Beatmap](/wiki/People/Beatmap_Nominators) potrebbero farsi strada nella sezione [Classificate](/wiki/Beatmap/Category#classificate).
