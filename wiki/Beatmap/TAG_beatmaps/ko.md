...
**TAG**는 플레이어끼리 협력하여 [비트맵](/wiki/Beatmap)을 클리어하는 멀티플레이 팀 모드 [TAG Co-op 혹은 TAG Team vs](/wiki/Gameplay/Multiplayer#tag-co-op-/-tag-team-vs)를 설명하는 용어입니다. 이 모드를 위해 특별히 제작된 비트맵을 보통 **TAG 비트맵/난이도**라고 부릅니다.
