...
**Beatmap** (czasami nazywana *beatmapset*) to zestaw poziomów gry ([trudnośći](#difficulty)) złożony z różnych [objektów uderzeń](/wiki/Gameplay/Hit_object), które niemal zawsze odpowiada jednej piosence. Zawiera również inne elementy, wszystkie spakowane w plik z [rozszerzeniem `.osz`](/wiki/Client/File_formats/osz_(file_format)):
