...
Чтобы карту в теории могли [номинировать](/wiki/Beatmap_ranking_procedure#номинация) и продвинуть дальше по процедуре ранкинга, она должна иметь не менее 5 хайпов (одну целую зелёную полоску).
