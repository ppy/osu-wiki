...
Длительность пребывания объекта на экране (без каких-либо игровых модификаторов) варьируется от 1800 мс при AR 0 до 450 мс при AR 10. Соседние значения AR ниже 5 отличаются друг от друга на 120 мс, а выше 5 — на 150 мс.
