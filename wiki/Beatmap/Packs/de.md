...
Beatmap-Pakete werden anhand ihres Inhalts, ihrer Kategorie und nach der Reihenfolge, in der sie hochgeladen wurden, benannt. Als Beispiel das folgende Beatmap-Paket:
...
Beatmap-Pakete werden in 7 Kategorien mit jeweils einem bestimmten Buchstaben als Kennung eingeteilt:
...
| **T** | Thema | Beatmaps, die ein gemeinsames Thema teilen |
| **A** | Künstler/Album | Songs von bestimmten Künstlern oder Alben |

## Importierung

1. Extrahiere das heruntergeladene Beatmap-Paket. Dort sollten viele Dateien mit dem Format [`.osz`](/wiki/Client/File_formats/osz_(file_format)) enthalten sein.
...
- Hinamizawa.ai – osu! data hub
  - [Mirror-Webseite](https://hinamizawa.ai/osu/map-packs/) von ::{ flag=CW }:: ::TheMoonBunny::{ user=902250 }
- Alter Archivierungsort vor der Migration zu `packs.ppy.sh` (ungefähr datiert auf den 07.05.2023)
  - [MEGA drive](https://mega.nz/folder/Rl4hkKZQ#L1LXE4UgMH00eJF1xqMytw) von ::{ flag=AT }:: ::Stefan::{ user=626907 }
- [(Un)official Beatmap Pack Sheet](https://osu.ppy.sh/community/forums/topics/1528191)
  - [Google Spreadsheet](https://docs.google.com/spreadsheets/d/1gcXL9gubcWEKY1X2taxJdBGjFrqEpkNmjHU7LFpcJRo) von ::{ flag=KR }:: ::Shige-Tori\[a\]::{ user=4459449 }
- [osu! Beatmap Pack Mirror v2](https://osu.ppy.sh/community/forums/topics/57381)
  - [Mirror-Webseite](http://osu.yas-online.net/) von ::{ flag=DE }:: ::nanashiRei::{ user=807630 }
...
- [Osu! Beatmap Packs @ Resilio Sync](https://osu.ppy.sh/community/forums/topics/1255023)
  - [Resilio Sync torrent file](https://link.resilio.com/#f=osu%21%20Beatmap%20Packs&sz=19E2&t=1&s=JHR4G3EUWCAOAKJT6HITFDGMENTSXU7U&i=CASDYUCU4VP4JUMPRYFZLFZK5EIXANSEE&v=2.7&a=2) von ::{ flag=RU }:: ::glukki::{ user=14285150 }
- [[Beatmap Packs] All ranked maps](https://osu.ppy.sh/community/forums/topics/330552)
  - [Torrent file](https://drive.google.com/drive/folders/1_iOU-sWjjugD7ww8Jsl1ullihcVXh50F?usp=sharing) von ::{ flag=RE }:: ::Elessey::{ user=4925105 }
- [osu! Torrent Beatmap Packs](https://osu.ppy.sh/community/forums/topics/687910)
  - [PandoTracker website](https://pandotracker.me) von ::{ flag=IT }:: ::- Pandoro::{ user=2574057 }

Bitte beachte, dass für das Herunterladen aller verfügbaren Pakete über einen Torrent-Client viel Speicherplatz (und eine große Bandbreite) benötigt wird.
