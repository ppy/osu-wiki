...
Сборки карт — это `.zip`-файлы, содержащие в себе несколько карт. Их названия основаны на содержимом (так например, `Approved Beatmap Pack #7` будет содержать в себе только [одобренные](/wiki/Beatmaps/Category#одобренные) карты).
