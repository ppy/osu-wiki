...
**Жанр** и **язык** песни — поля с [метаданными](/wiki/Beatmap_Editor/Song_Setup#song-and-map-metadata), которые можно заполнить после публикации [карты](/wiki/Beatmap). Искать по ним можно через веб-сайт и в osu!(lazer)<!-- TODO: link me --> (но не в стабильной версии osu!).
