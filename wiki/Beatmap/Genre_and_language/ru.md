...
**Жанр** и **язык** песни — поля с метаданными<!-- TODO: link -->, которые можно заполнить после публикации [карты](/wiki/Beatmap). Искать по ним можно через веб-сайт и в osu! (lazer release)<!-- TODO: link me --> (но не в стабильной версии osu!).
