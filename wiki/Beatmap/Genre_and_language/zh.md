...
谱面的歌曲风格与语言能通过在谱面详情处悬停光标，并点击铅笔按钮来修改。修改权限取决于玩家所在的[用户组](/wiki/People/The_Team#用户组)和[谱面状态](/wiki/Beatmap/Category#现有分类)：
...
- [谱面审核成员 (BN)](/wiki/People/The_Team/Beatmap_Nominators) 可以在谱面处于[过审 (Qualified)](/wiki/Beatmap/Category#过审-(qualified))、制作中 (WIP)、待定 (Pending) 状态时修改。
- [社区喜爱计划团队 (LVD)](/wiki/People/The_Team/Project_Loved_Team) 成员可以在谱面处于[社区喜爱 (Loved)](/wiki/Beatmap/Category#社区喜爱-(loved)) 状态时修改。
