...
Die **Sternebewertung** (auch **Star rating** oder ***SR*** genannt) beschreibt den Schwierigkeitsgrad einer [Beatmap](/wiki/Beatmap), der automatisch vom osu!-Client berechnet wird. Die Sternebewertung spielt eine große Rolle bei der Vergabe von [Performance-Punkten](/wiki/Performance_points). Diese Zahl ist auf der [Songauswahl](/wiki/Client/Interface#songauswahl) und auf der Informationsseite der Beatmap zu sehen.
