...
La singola difficoltà delle beatmap maratona inoltre doveva essere chiamata "Marathon" per bypassare il Sistema di Invio delle Beatmap al tempo e prevenire l'entrata della beatmap nella categoria [In attesa](/wiki/Beatmap/Category#work-in-progress-and-pending). Una volta classificate, le beatmap maratona entravano nella categoria [Approvate](/wiki/Beatmap/Category#approved) invece che in [Classificate](/wiki/Beatmap/Category#ranked) per segnalare che fossero maratone. La categoria fu poi abbandonata in favore della categoria Classificate.
