...
Una *sección de dificultad* es una lista de todas las dificultades de invitados (a menudo junto con los íconos respectivos) y sus creadores ubicados en una descripción del beatmap. Se utiliza sobre todo para dar crédito a los mapeadores invitados.
