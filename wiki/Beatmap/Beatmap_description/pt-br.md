...
- Informações que ajudam um jogados a decidir se eles querem ou não o baixar um beatmap
- Uma lista de edições, ou um registro de mudanças

### Imagens

Muitas descrições de beatmap contém pelo menos uma imagem (normalmente uma animada [GIF](https://en.wikipedia.org/wiki/GIF) sou semelhantes) que é usado para expressar e ilustrar o criador, a música, e/ou o beatmap de forma breve. Eles também podem servir como um título ou um cabeçalho para adicionar estilo e qualidade. Para saber mais como adicionar uma imagem, olhe o  [a sessão do artigo do BBCode em imagens](/wiki/BBCode#images).
