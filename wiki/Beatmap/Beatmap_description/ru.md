...
В описании обычно упоминаются все гостевые сложности карты (вместе с соответствующими иконками) и имена гостевых мапперов. Если вы хотите поступить так же, иконки можно взять из [статьи про сложность](/wiki/Beatmap/Difficulty).
