...
::: alert-notice
**Внимание**
некоторые из звуковых или визуальных компонентов карты отключаются на [панели визуальных настроек](/wiki/Client/Interface/Visual_settings).
:::
...
**Сложность** — это файл с [расширением `.osu`](/wiki/Client/File_formats/osu_(file_format)), который содержит в себе расположение игровых объектов, хитсаундов и эффектов вроде [киаи](/wiki/Gameplay/Kiai_time). В нём также указаны [настройки сложности](/wiki/Client/Beatmap_editor/Song_setup#difficulty) и другие параметры, влияющие на игровой процесс. Разные сложности имеют разную структуру и иногда созданы только для одного [игрового режима](/wiki/Game_mode). Для оценки требуемого уровня игровых навыков стоит воспользоваться [звёздами сложности](/wiki/Beatmap/Star_rating).
