...
**Сложность** карты — это игровой уровень, хранящийся в текстовом файле [формата `.osu`](/wiki/osu!_File_Formats/Osu_(file_format)). Он состоит из [игровых объектов](/wiki/Hit_object), которые принадлежат отдельному [режиму игры](/wiki/Game_mode) и расположены в соответствии с [таймингом](/wiki/Glossary#timing-section) песни. У сложности есть несколько компонент, влияющих на игровой процесс. По названию и числу [звёзд сложности](/wiki/Beatmapping/Star_rating) обычно можно сказать, какой уровень навыков она требует.

Игровые объекты объединяются в [паттерны](/wiki/Beatmap/Pattern), также зависящие от игровых режимов и определяющие общий стиль, внешний вид сложности и процесс её прохождения. На процесс игры также влияют [настройки сложности](/wiki/Beatmap_Editor/Song_Setup#difficulty), установленные её автором или изменённые с помощью [игровых модификаторов](/wiki/Game_modifier).
