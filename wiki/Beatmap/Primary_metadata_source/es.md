...
Una **fuente principal de metadatos** es una fuente para los campos `Artista`, `Título` y `Fuente` en los [metadatos](/wiki/Client/Beatmap_editor/Song_Setup#song-and-map-metadata) de un [beatmap](/wiki/Beatmap) promocionados oficialmente por el artista de la canción o su sello.
...
Los beatmaps que apuntan al estado [clasificado](/wiki/Beatmap/Category#clasificados) deben usar metadatos de una fuente principal. Véase los [criterios de clasificación](/wiki/Ranking_Criteria#metadata) para obtener más reglas y pautas con respecto a los metadatos del beatmap.
