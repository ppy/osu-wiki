...
Une **source de métadonnées primaire** est une source pour les champs `Artiste`, `Titre`, et `Source` dans les [métadonnées](/wiki/Beatmap_Editor/Song_Setup#métadonnées-des-chansons-et-des-maps) d'une [beatmap](/wiki/Beatmap), officiellement promue par l'artiste de la chanson ou son label.
