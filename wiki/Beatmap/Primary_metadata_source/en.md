...
A **primary metadata source** is a source for `Artist`, `Title`, and `Source` fields in a [beatmap](/wiki/Beatmap)'s [metadata](/wiki/Beatmap_Editor/Song_Setup#song-and-map-metadata) officially promoted by the song's artist or their label.
