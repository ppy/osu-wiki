...
**Первоисточник метаданных** (англ. *primary metadata source*) — материал, официально принадлежащий исполнителю песни или её издателю, откуда берутся [метаданные](/wiki/Client/Beatmap_editor/Song_setup#general) для [карты](/wiki/Beatmap), то есть поля `Artist`, `Title` и `Source`.
