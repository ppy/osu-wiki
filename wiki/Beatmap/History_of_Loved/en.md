...
Before the second round of "Captain's Pick", Toy [announced on the forums](https://osu.ppy.sh/community/forums/topics/662761) that the maps chosen for voting would be sourced from community submissions on a Google [form](https://docs.google.com/forms/d/e/1FAIpQLSdbgHOVqMF8wQQKSdddW1JhC10ff6C7fb4JbEW7PBQTn9gAqg/viewform "Google Forms") and [sheet](https://docs.google.com/spreadsheets/d/1HgHwtO3kIzT8R4ocEJMZTosADrGJRJOFL-TZI97tZS4/edit "Google Sheets"). Toy hoped that this would "work better in the long-run than previous Loved implementations" by giving Loved participants more say in the voting.
