...
::: alert-note
**Note:** For the osu!(lazer) version of this article, see: [HP drain rate (lazer)](/wiki/Beatmap/HP_drain_rate_(lazer))
:::

::: alert-note
**Note:** For health as a gameplay mechanic, see [Health](/wiki/Gameplay/Health)
:::
...
There are five mods that alter the HP drain rate when activated:
