...
For beatmaps aiming for [Ranked](/wiki/Beatmap/Category#ranked), HP drain rate values must comply with the [Game mode specific ranking criteria](/wiki/Ranking_criteria#game-mode-specific-ranking-criteria). Each game mode defines specific HP drain rate ranges for each difficulty level.
