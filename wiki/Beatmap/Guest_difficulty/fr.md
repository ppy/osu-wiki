...
Bien qu'elles ne soient pas obligatoires, les difficultés d'invités peuvent être bénéfiques en de nombreuses occasions, car elles présentent souvent des styles de mapping complètement différents les uns des autres, ce qui permet de diversifier la beatmap et de réduire l'épuisement du mapping. Les difficultés d'invités sont le plus souvent demandées par le biais de messages privés entre mappeurs, mais elles peuvent aussi être demandées par d'autres moyens, comme le canal `#mapping` du jeu ou les [files d'attente de modding](https://osu.ppy.sh/community/forums/60).

Les difficultés d'invitées ne doivent pas être confondues avec les difficultés qui mettent en scène plusieurs mappeurs, qui sont plutôt connues sous le nom de *[collabs](/wiki/Beatmap/Beatmap_collaborations)*.
...
Sur la page de [discussion d'une beatmap](wiki/Beatmap_Discussion), l'hôte de la beatmap peut transférer la propriétaire des difficultés d'invitées à leurs mappeurs respectifs par le biais du bouton `Difficulty Owner`. Cela permet aux propriétaires des difficultés d'invitées de résoudre eux-mêmes les problèmes en suspens dans leurs difficultés.

Le propriétaire d'une difficulté d'invitée ne peut pas être modifiée si le beatmap est [qualifiée](wiki/Beatmap/Category#qualifiée), [classée](wiki/Beatmap/Category#classée), ou [loved](wiki/Beatmap/Category#loved).