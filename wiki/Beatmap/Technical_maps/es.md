...
![Flow difícil (Densetsu no Matsuri)](img/beatmap_hard_flow-ES.jpg "Patrón de un beatmap con un flow difícil")
...
![Forma irregular de un slider (MARENOL)](img/irregular_slider-ES.jpg "Forma irregular de un slider (slider SV)")
