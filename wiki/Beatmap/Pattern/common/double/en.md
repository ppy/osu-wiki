...
A **Double** pattern is made when 2 [hit objects](/wiki/Gameplay/Hit_object) occur after each other in a 1/2 or faster rythm spacing.
...
In the [osu!mania](/wiki/Game_mode/osu!mania) [gamemode](/wiki/Game_mode), Doubles are known as [Mini jacks](/wiki/Game_mode/osu!mania/jack)
