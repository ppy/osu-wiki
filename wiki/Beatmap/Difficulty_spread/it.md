...
Le beatmap [rankate](/wiki/Beatmap/Category#ranked) hanno diversi requisiti riguardanti la distribuzione delle difficoltà secondo i [criteri di classificazione](/wiki/Ranking_criteria):

- Tutti i [livelli di difficoltà](/wiki/Beatmap/Difficulty#difficulty-levels) all'interno dell'intervallo di distribuzione devono essere presenti.
