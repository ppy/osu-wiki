...
Les **collaborations d'une beatmap**, ou ***collabs***, sont des beatmaps créées par plusieurs personnes. Le terme *collab* peut désigner une [difficulté](/wiki/Beatmap/Difficulty) ou une [beatmap](/wiki/Beatmap), avec des [difficultés d'invités](/wiki/Glossary#guest-difficulty).
