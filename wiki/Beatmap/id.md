...
<!-- TODO: would be very cool to have a separate article for osu! (lazer release) as well (issue #4686) -->
...
Seiring berjalannya waktu, sistem Ranking Chart ini kemudian perlahan mulai berubah wujud menjadi [Beatmap Spotlight](/wiki/Beatmap_Spotlights) yang sama, tetapi daftar putar dilakukan di osu! (lazer release).
