...
비트맵은 **[비트맵셋](Beatmapset)**의 일부에 포함되어 만들어집니다. 비트맵들을 한데 묶어서 웹사이트에 [제출](/wiki/Glossary#bss)해 [비트맵 목록](https://osu.ppy.sh/beatmapsets)에 보이게 합니다. 통상적으로 한 노래에 서로 다른 [난이도](/wiki/Difficulties)를 가진 비트맵들로 구성됩니다.
