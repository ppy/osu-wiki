...
La catégorie **cimetière** correspond aux beatmaps qui ont été abandonnées par leurs créateurs. Les beatmaps sont déplacées automatiquement de la catégorie [Work In Progress et En attente](#work-in-progress-et-en-attente) vers la catégorie Graveyard lorsqu'elles n'ont pas été mises à jour pendant 4 semaines. Les beatmaps au cimetière ne disposent pas de classements. Cependant, elles peuvent toujours être téléchargées et jouées, et [contribuer aux statistiques de jeu](#unranked-beatmaps-statistics). Ils utilisent l'icône de point d'interrogation (![](/wiki/shared/status/graveyard.png)) dans l'[écran de sélection des beatmaps](/wiki/Interface#song-selection-screen).

Une fois qu'une beatmap est graveyarded, elle peut revivre (c'est-à-dire être ramenée au statut [en attente](#work-in-progress-et-en-attente)). Pour ce faire, il suffit de mettre à jour la beatmap via le [système de soumission des beatmaps](/wiki/Glossary#bss).

### Work In Progress et En attente

Les catégories **work in progress** (communément appelé *WIP*) et **En attente** sont les deux catégories dans lesquelles les beatmaps sont placées lors de leur soumission initiale. Les beatmaps de ces catégories peuvent passer dans la catégorie [qualifiée](#qualifiée) après [nomination](/wiki/Beatmap_ranking_procedure#nominations) par au moins deux [Beatmap Nominators](/wiki/People/The_Team/Beatmap_Nominators). Cela inclut généralement un grand nombre de commentaires de la part des [modders](/wiki/Glossary#modder) par le biais du [modding](/wiki/Modding). Les beatmaps WIP et En attente n'ont pas de classement, mais [contribuent aux statistiques de jeu](#unranked-beatmaps-statistics). Elles utilisent l'icône de point d'interrogation (![](/wiki/shared/status/pending.png)) dans l'écran de sélection des beatmaps.
