...
Sejak tanggal [7 Agustus 2020](https://osu.ppy.sh/home/changelog/stable40/20200807.3), beatmap dari kategori [Graveyard](#graveyard) dan [Work in Progress dan Pending](#work-in-progress-and-pending) juga berkontribusi terhadap jumlah main dan skor total dari pemain. Beatmap dengan kategori tersebut juga memiliki statistik bermainnya sendiri (jumlah main, tingkat kesuksesan, dan letak-letak kegagalan) yang sebelumnya hanya ditunjukkan untuk beatmap [Qualified](#qualified) dan [Ranked](#ranked).
