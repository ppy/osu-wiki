...
::: alert-notice
**Внимание**
здесь и далее намеренно приводятся устоявшиеся названия категорий без перевода.
:::
...
Карты категории Approved отмечены галочкой (![](/wiki/shared/status/approved.png)) в списке карт клиента и имеют такую же игровую механику, как и ранкнутые карты.
