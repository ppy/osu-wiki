...
Les **Grades**, dans osu!, sont un ensemble de lettres représentant la performance d'un joueur sur une [beatmap](/wiki/Beatmap) donné. Les notes accompagnent le [score](/wiki/Score) total sur l'écran des résultats et apparaissent dans toutes les listes à côté des scores.
