...
[Internet Relay Chat](https://en.wikipedia.org/wiki/Internet_Relay_Chat), dikenal juga sebagai IRC, adalah sebuah protokol standar yang sering digunakan untuk mengobrol dengan banyak pengguna lain yang tersedia.
...
| [ircII](http://eterna.com.au/ircii) | Ketik `/ignore * crap` |
...
| [KVIrc](https://kvirc.net) | Kunjungi [utas ini](http://kvirc.ru/forum/?topic=609.0) di forum resmi KVIrc |
| [mIRC](https://mirc.com) | Buke Pengaturan mIRC (Tools - Options / Alt + O), di bawah IRC, klik tombol "Events..." dan ganti Joins and Parts menjadi "Hide" |
