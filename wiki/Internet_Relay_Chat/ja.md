...
| [ircII](http://eterna.com.au/ircii) | `/ignore * crap` を入力 |
...
| [KVIrc](https://kvirc.net) | 公式KVIrcフォーラムの[このスレッド](http://kvirc.ru/forum/?topic=609.0)にアクセスしてください。 |
| [mIRC](https://mirc.com) | mIRCオプション(Tools - Options / Alt + O)に移動し、IRCツリーで"Events..."ボタンをクリックして、JoinsとPartsを"Hide"に変更します。 |
