...
По умолчанию, большинство IRC-клиентов сообщают, когда кто-то заходит на канал или покидает его. В масштабах osu!Bancho такие события становятся шумом и очень быстро засоряют чат. Для удобства ниже описано, как их отключить в некоторых популярных клиентах:
