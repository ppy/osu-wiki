...
| [ircII](http://eterna.com.au/ircii) | `/ignore` |
...
| [KVIrc](https://kvirc.net) | Consulte [this thread](http://kvirc.ru/forum/?topic=609.0) nos forums oficiais do KVIrc. |
| [mIRC](https://mirc.com) | Ferramentas » Opções » selecione "IRC". Clique no botão"Events...". Mude "joins", "parts", "quits", e "nicks" para as configurações desejadas: "No Status" ou "Esconder" são boas opções [1](https://forums.linuxmint.com/viewtopic.php?t=215223). |
