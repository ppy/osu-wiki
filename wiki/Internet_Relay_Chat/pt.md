...
\| [Weechat](http://www.weechat.org)         | /filter add irc_smart_weechat irc.algumnome.#filtro_inteligente_irc dealgumcanal \*  
...
\| [XChat](http://www.xchat.org)             | Clique com o direito na aba que quer mudar. No submenu do nome do canal, tem uma caixa de seleção "Show join/part messages", simplesmente desmarque isso. Ou digite/set irc_conf_mode 1 [2](http://xchat.org/faq/#q211) para desativar mensagens de todos os canais. |
