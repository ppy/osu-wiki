...
Les utilisateurs avec _statut vocal_ sont également connectés via un client IRC, à l'exception des modérateurs de discussion qui ont toujours le statut _opérateur (+o)_, quel que soit le client utilisé.
