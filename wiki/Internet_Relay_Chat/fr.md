...
| [ircII](http://eterna.com.au/ircii) | Taper `/ignore * crap` |
...
| [KVIrc](https://kvirc.net) | Visitez [ce fil de discussions](http://kvirc.ru/forum/?topic=609.0) sur les forums officiels de KVIrc. |
| [mIRC](https://mirc.com) | Allez dans les options mIRC ((Tools - Options / Alt + O), sous l’arborescence IRC, cliquez sur le bouton "Events..." et changez Join/Quit par "Hide". |
