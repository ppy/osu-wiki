...
osu! 使用IRC协议进行游戏内聊天([英文:Chat Console](/wiki/Chat_Console). 通过其他的IRC客户端,你可以不打开osu!即可和你的好友聊天. 注意osu! Bancho使用的IRC协议并不是标准的IRC协议,因此某些IRC客户端在osu! Bancho上可能无法正常运行.
...
| [ircII](http://eterna.com.au/ircii) | `/ignore * crap` |
...
| [KVIrc](https://kvirc.net) | 参阅[KVIrc论坛上的信息](http://kvirc.ru/forum/?topic=609.0) . |
| [mIRC](https://mirc.com) | Tools » Options » pick "IRC". Click the "Events..." button. Change the "joins", "parts", "quits", and "nicks" to your desired settings: "In Status" or "Hide" are good options [1](https://forums.linuxmint.com/viewtopic.php?t=215223). |
