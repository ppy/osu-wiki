...
_Your IRC password is different from your account password. **Do not share it to others**._
...
Users with _voice status_ are also connected using an IRC client, except for chat moderators who always have _operator (+o)_ status regardless of what client they use.
