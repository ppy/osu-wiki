...
**인터넷 릴레이 챗** (**IRC**)는 수많은 온라인 유저들과 대화하기 위해 사용되는 응용 계층 프로토콜입니다.

## osu!Bancho

*주의해야 할 점: 이 서버는 IRC 프로토콜의 일부 기능만을 구현했습니다. 일부 기본 기능이 없는 IRC 클라이언트 (예: [HexChat](https://hexchat.github.io/))은 제대로 작동하지 않거나 아예 작동을 안 할 수도 있습니다.*

*osu!Bancho* (흔히 *Bancho*라고 줄여 부름)은 IRC (인게임 채팅)을 위한 게이트웨이를 제공합니다. 최신 IRC 클라이언트를 사용해 접속할 수 있습니다 (밑으로 스크롤 해 제일 자주 쓰이는 것들을 확인하실 수 있습니다).
...
또는, `cho.ppy.sh`의 다른 주소를 입력해보세요 (이 주소도 osu!Bancho로 연결됩니다).
