...
| [KVIrc](https://kvirc.net) | Holt euch die Informationen in [diesem Thread](http://kvirc.ru/forum/?topic=609.0) vom offiziellen KVIrc Forum. |
| [mIRC](https://mirc.com) | Tools » Options » wählt "IRC". Klickt auf den "Events..." Button. Ändert die "joins", "parts", "quits", und "nicks" zu der jeweiligen Einstellung: "In Status" oder "Hide" sind gute Optionen. [1](https://forums.linuxmint.com/viewtopic.php?t=215223). |
