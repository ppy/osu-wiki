...
- The tabs list the currently available channels. Simply click on a tab to move to that channel. Click the plus button to display a list of new channels to join.
