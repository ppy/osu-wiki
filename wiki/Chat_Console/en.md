...
-   The colors of the usernames have different meanings.
...
| Pale   | Non-supporters |
| Yellow | Supporters |
| Red    | [Global Moderation Team](/wiki/People/Global_Moderation_Team) or [Quality Assurance Team](/wiki/People/Quality_Assurance_Team) member |
...
| Cyan  | [peppy](https://osu.ppy.sh/u/2), the creator of osu! |
...
*[osu!academy](/wiki/Announcements/osu!academy) covered this page in [Episode 6 (6:52)](https://www.youtube.com/watch?v=cyYRl-a5xII) along with [Multiplayer](/wiki/Multi).*
...
![Example of Extended chat console](/img/Extendedchatconsole.png "Example of Extended chat console")

Each user logged in *osu!* has a user panel displayed in Extended Chat. By default, it displays general information (name, total ranked score, rank, accuracy, play count and the user's avatar, if any). When the mouse cursor is hovering over it, it displays a different set of information (name, rank, avatar if any, local time, time zone, location by country and, if allowed by the user, city, and what they are doing).

-   Friends only limits the display to your friends.
-   Lock Panels stops the panels from jumping around (this also includes new users).
...
![Detailed explanation about the panel colour](/img/Extendedchatconsole2.png "Detailed explanation about the panel colour")
...
![Example of user panel options](/img/Userpaneloptions.png "Example of user panel options")
...
|:-------:|:------:|:-------:|:------------------:|
|/addfriend \[user\] /delfriend \[user\]|Add/remove \[user\] to/from your friends list.| /addfriend Amigo | You are now friends with Amigo.|
...
| /bb | Sends a message to bancho like rank \[number\]| /bb rank 1| [15/11/12] Stats for [Uan](https://osu.ppy.sh/u/147623): Score: 47,323,299,680 (#1)Plays: 176293 (lv102)
...
|/nopm| Toggle to allow private messages either from everyone or friends only| /nopm| (A [pop-up banner](https://w.ppy.sh/4/44/CC_nopm.jpg) will appear at the center detailing you are allowing everyone/friends only for private messages)|
