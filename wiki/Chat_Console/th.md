...
|-------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|
| ![Player is idle](img/Chat_Console-Idle.jpg "Player is idle")                                             | 1. น้ำเงินเข้ม - ผู้เล่นไม่ได้ทำอะไร หรือคุยในแชทเฉยๆ                                           |
| ![Player is playing](img/Chat_Console-Playing.jpg "Player is playing")                                    | 2. เทา - กำลังเล่นคนเดียว                                                                       |
| ![Player is watching](img/Chat_Console-Watching.jpg "Player is watching")                                 | 3. ฟ้า - ดู Replay หรือดูใครซักคนเล่นอยู่                                                       |
| ![Player is editing a beatmap](img/Chat_Console-Editing.jpg "Player is editing a beatmap")                | 4. แดง - แก้ไขบีทแมพตัวเอง                                                                      |
| ![Player is testing a beatmap](img/Chat_Console-Testing.jpg "Player is testing a beatmap")                | 5. ม่วง - ทดสอบบีทแมพ (ของเราหรือคนอื่นก็ได้)                                                   |
| ![Player is submitting a beatmap](img/Chat_Console-Submitting.jpg "Player is submitting a beatmap")       | 6. เขียวแกมน้ำเงิน - อัพโหลดบีทแมพ (ทั้งอัพโหลดใหม่หรืออัพเดท) ของตัวเองที่ทำไว้                |
| ![Player is modding a beatmap](img/Chat_Console-Modding.jpg "Player is modding a beatmap")                | 7. เขียว - กำลัง Mod หรือแก้ไขบีทแมพของคนอื่น                                                   |
| ![Player in Mulitplayer](img/Chat_Console-Multiplayer.jpg "Player in Mulitplayer")                        | 8. น้ำตาล - อยู่ในโหลดเล่นหลายคน แต่ยังไม่ได้เล่น                                               |
| ![Player is playing in Multiplayer](img/Chat_Console-Multiplaying.jpg "Player is playing in Multiplayer") | 9. เหลือง - อยู่ในโหลดเล่นหลายคน กำลังเล่นอยู่                                                  |
| ![Player is Afk](img/Chat_Console-Afk.jpg "Player is Afk")                                                | 10. ดำ - อยู่นิ่งๆ นานเกินสองนาทีครึ่ง                                                          |
| ![Player is connected via IRC](img/Chat_Console-IRC.jpg "Player is connected via IRC")                    | 11. น้ำเงินเข้ม (แต่ไม่มีรายละเอียดผู้เล่น) - ผู้เล่นที่ล็อคอินผ่านระบบ IRC (ได้แค่แชทเท่านั้น) |
