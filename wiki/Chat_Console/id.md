...
| `/np` | Menampilkan lagu yang sedang kamu dengarkan atau yang kamu mainkan pada obrolan | `/np` | (If playing) * John is playing [Peter Lambert - osu! tutorial\[Gameplay Basics\]](https://osu.ppy.sh/b/22538) |
