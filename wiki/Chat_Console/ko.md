...
| 흰색     | 당신입니다                                                                                                                                        |
| 노랑색    | 다른 유저입니다                                                                                                                                   |
| 주황색    | (/wiki/shared/osu!supporter.png "Supporter Tag") 서포터                                                                                             |
| 빨간색    | BAT(뱃) 또는 GMT                                                                                                                                  |
...
| /clear                                 | 현재 채팅창에서 지난 메세지들을 삭제합니다.                                            | /clear                          | (Clears basically <em>everything</em> on the current tab)                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| /nopm                                  | 친구목록 외의 플레이어의 PM송신을 제한합니다.                                          | /nopm                           | (A <a href="Media:CC_nopm.jpg" title="wikilink">pop-up banner</a> will appear at the center detailing you are allowing everyone/friends only for private messages)                                                                                                                                                                                                                                                                                                      |
...
|키보드 단축키 |효과|
|- |-|
|PageUp / PageDown|채팅창을 움직여보세요. 마우스 휠로 조작할 수 있습니다.|
