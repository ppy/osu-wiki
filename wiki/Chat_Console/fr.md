...
|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| ![Player is idle](img/Chat_Console-Idle.jpg "Player is idle")                                             | Bleu foncé - Aucun des autres statuts                                                                          |
| ![Player is playing](img/Chat_Console-Playing.jpg "Player is playing")                                    | Gris - L'utilisateur joue une map.                                                                             |
| ![Player is watching](img/Chat_Console-Watching.jpg "Player is watching")                                 | Bleu clair/violet - L'utilisateur regarde un joueur jouer une map ou un replay.                                |
| ![Player is editing a beatmap](img/Chat_Console-Editing.jpg "Player is editing a beatmap")                | Rouge - L'utilisateur édite une de ses maps.                                                                   |
| ![Player is testing a beatmap](img/Chat_Console-Testing.jpg "Player is testing a beatmap")                | Vert - L'utilisateur édite une map de quelqu'un d'autre.                                                       |
| ![Player is submitting a beatmap](img/Chat_Console-Submitting.jpg "Player is submitting a beatmap")       | Violet - L'utilisateur test une map depuis l'éditeur.                                                          |
| ![Player is modding a beatmap](img/Chat_Console-Modding.jpg "Player is modding a beatmap")                | Turquoise - L'utilisateur est en train de mettre une map en ligne.                                             |
| ![Player in Mulitplayer](img/Chat_Console-Multiplayer.jpg "Player in Mulitplayer")                        | Marron - L'utilisateur est en multijoueur mais ne joue pas.                                                    |
| ![Player is playing in Multiplayer](img/Chat_Console-Multiplaying.jpg "Player is playing in Multiplayer") | Jaune - L'utilisateur joue en multijoueur.                                                                     |
| ![Player is Afk](img/Chat_Console-Afk.jpg "Player is Afk")                                                | Noir - L'utisateur ne fait rien depuis plusieurs minutes                                                       |
| ![Player is connected via IRC](img/Chat_Console-IRC.jpg "Player is connected via IRC")                    | Bleu foncé - Player is not ingame, but logged in from an IRC client or stats are not available. |
