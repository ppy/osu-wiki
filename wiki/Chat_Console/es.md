...
![Consola del Chat](img/Chat_Console.jpg "Consola del chat")
...
![Consola de chat ampliada](img/Chat_Console-Extended.jpg "Extended chat console")
...
|-----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![El jugador está inactivo](img/Chat_Console-Idle.jpg "El jugador esta inactivo")                                             | Azul marino - Los jugadores están inactivos, o no están haciendo nada, o simplemente están chateando.                                                     |
| ![El jugador esta jugando](img/Chat_Console-Playing.jpg "El jugador esta jugando")                                        | Gris - Jugando un beatmap solo.                                                                                                                      |
| ![El jugador esta espectando](img/Chat_Console-Watching.jpg "El jugador esta observando")                                   | Celeste - Viendo una repetición o espectando a alguien.                                                                                                   |
| ![El jugador esta editando un beatmap](img/Chat_Console-Editing.jpg "El jugador esta editando un beatmap")                  | Rojo - Editando su propio beatmap.                                                                                                                        |
| ![El jugador está probando un beatmap](img/Chat_Console-Testing.jpg "El jugador esta probando un beatmap")                  | Purpura - Juego de prueba de un beatmap, ya sea su beatmap o no.                                                                                              |
| ![El jugador está enviando un beatmap](img/Chat_Console-Submitting.jpg "El jugador esta subiendo un beatmap")            | Turquesa - Enviando (tanto subiendo o actualizando) el beatmap que han hecho.                                                                             |
| ![El jugador esta modificando un beatmap](img/Chat_Console-Modding.jpg "Es jugador le esta modificando un beatmap")               | Verde - Modificando o editando el beatmap de otra persona.                                                                                                |
| ![El jugador esta en el Multijugador](img/Chat_Console-Multiplayer.jpg "El jugador este en el multijugador")                     | Cafe - El usuario está en modo multijugador, pero no está jugando.                                                                                        |
| ![El jugador esta jugando en el Multijugador](img/Chat_Console-Multiplaying.jpg "El jugador esta jugando en multijugador") | Amarillo - Actualmente jugando en multijugador.                                                                                                           |
| ![El jugador esta AFK](img/Chat_Console-Afk.jpg "El jugador esta Afk")                                                    | Negro - Inactivo o fuera del teclado (AFK).                                                                                                               |
| ![El jugador está conectado a través de IRC.](img/Chat_Console-IRC.jpg "El jugador esta conectado via IRC")               | Azul oscuro sin contenido - El jugador no está dentro del juego, pero ha iniciado sesión desde un cliente de IRC o las estadísticas no están disponibles. |
