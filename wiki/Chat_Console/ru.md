...
-   Цвета имен пользователей означают разные вещи:
    ...
    -   **Желтый:** ![Supporter Tag](/wiki/shared/osu!supporter.png "Supporter Tag") Саппорт.
    -   **Красный:** БАТ или GMT.
    ...
    -   **Голубой:** [peppy](https://osu.ppy.sh/u/2 "peppy"), Создатель osu!.
    -   **Розовый:** [BanchoBot][BanchoBot](/wiki/BanchoBot/ "BanchoBot")  
...
| /names                                   | Показать всех IRC пользователей.                                                                                                                                                 | /names                                       | (Появляется список ников)                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| /np                                      | Напечатать в чат какую песню вы сейчас слушаете или выбираете.                                                                                                                   | /np                                          | (Если играет) *John играет в Peter Lambert - osu! tutorial [Gameplay basics] Game Modes Relax/Autopilot +Difficulty increasing mod -Difficulty decreasing mod/SpunOut #K. (Если вы ничего не делаете,то печатается песня которая играет в плеере osu!) *John слушает Peter Lambert - osu! tutorial. (Если наблюдает автоигру) *John наблюдает Peter Lambert - osu! tutorial [Gameplay basics] Game Modes Relax/Autopilot +Difficulty increasing mod -Difficulty decreasing mod/SpunOut #K Autoplay |
...
|--------------------|--------------------------------------------------------|
| PageUp / PageDown  | Прокрутить окно чата.Можно использовать колесико мыши. |
