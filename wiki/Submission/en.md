...
[Beatmaps](/wiki/Beatmaps) can be submitted to the osu! website via the [in-game editor](/wiki/Beatmap_Editor). Submitting a beatmap allows it to receive attention from other users and potentially enter the [Ranked](/wiki/Beatmaps/Category#ranked) or [Loved](/wiki/Beatmaps/Category#loved) categories.
