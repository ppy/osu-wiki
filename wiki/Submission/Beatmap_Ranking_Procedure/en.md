...
Note: If your map has a bubble, then it will be popped if you update it. If the update was not drastic (ex. All you did was fix a [slider](/wiki/Hit_Objects#sliders)), then just ask the BN who bubbled it to rebubble it. Your map will gain 5 [SP](/wiki/Glossary/#star-priority) for a popped bubble icon.
...
Following up from [\#ranked](/wiki/Beatmaps), a BN can approve these beatmaps if they are longer than 5 minutes long (aka [marathon](/wiki/Glossary/#marathon) beatmaps) and/or that do not follow the [ranking criteria](/wiki/Ranking_Criteria) but are considered "okay" by a BN.
