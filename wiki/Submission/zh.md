...
[谱面](/wiki/Beatmaps)可以通过[谱面编辑器](/wiki/Beatmap_Editor)提交至 osu! 网站。提交谱面可以使其他用户注意到该谱面，且该谱面可能会标记为 [Ranked](/wiki/Beatmaps/Category#ranked) 或 [Loved](/wiki/Beatmaps/Category#loved)。
