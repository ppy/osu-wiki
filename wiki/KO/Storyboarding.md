[200px|thumb|right|EBA중 Walkie Talkie Man 플레이 화면. 단, 이 화면은 "Elite Beat 300"을 따냈을 때만 나온다.](image:sbpassing.png "wikilink") [200px|thumb|right|미스나 50을 띄웠을 때의 경우.](image:sbfailing.png "wikilink") **스토리보드** (Storyboard, SB) 란 비트맵 화면을 장식하거나 플레이방식을 변경하는 등의 목적을 위해 위해 유저가 만든 640x480 픽셀 크기의 배경요소를 말합니다. 이것은 어떤 요소로든 구성할 수 있는데, 보통 유저들이 예술적으로 느낄 수 있는 시각적인 효과들로 구성된 것이 많습니다.
...
[스토리보드 에디터는](KO:Storyboard_Editor "wikilink") 비트맵 에디터 중 Design 탭(단축키: F2)에서 찾아볼 수 있습니다. 기본적으로 이 에디터는 스프라이트를 쉽고 간단하게 사용자가 원하는 대로 움직일 수 있게 해주지만, 종종 투박하면서 스토리보드의 기초적인 부분 외엔 아무것도 못한다고 생각될 수도 있습니다.

하지만 스토리보드 제작에 익숙한 유저들은 [스토리보드 스크립트를](KO:Storyboard_Scripting "wikilink") 사용해 더욱 다양한 모션을 만들어내기도 합니다. 자세한 내용은 해당 문서를 참조해주시기 바랍니다.

풀 스토리보드
-------------

스토리보드가 들어간 대다수의 랭크맵은 시각효과만 들어가있는 경우가 많기 때문에 그 리스트를 본 페이지에서 전부 보여드리기는 어렵습니다. (참고로 해당 리스트는 \[<http://osu.ppy.sh/p/beatmaplist?s=7&o=1&q>=&r=0&g=0&la=0&sb=1 여기\])

따라서 본 페이지에서는 **풀 스토리보드**가 포함된 비트맵만 보여드립니다. 그 외의 작품은 [여기에서](KO:Storyboarding/Maps "wikilink") 확인해주시기 바랍니다.
...
### 게임 진행방식을 바꾸는 스토리보드 작품

-   [Seether - Fake It](http://osu.ppy.sh/s/48738)
-   [M2U - BlythE (Osuka)](http://osu.ppy.sh/s/26932)

기타 스토리보드 작품은 **[이곳](KO:Storyboarding/Maps "wikilink")**에서 확인하실 수 있습니다.
