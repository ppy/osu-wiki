...
**\#modreqs (\#모드리퀘)** 는 osu!의 채팅시스템 중 하나로서, 플레이어들은 여기에서 [모딩의](KO:Modding "wikilink") 리퀘스트가 이루어집니다.

20개의 최신리퀘스트를 표시하는 것으로, 몇가지의 방법으로 [Bancho/반초](KO:Glossary#Bancho "wikilink") 의 표시가 가능합니다:
...
-   [special map listing](http://osu.ppy.sh/p/beatmaplist&r=8)을 열어, 20개의 최신 리퀘스트와 몇개의 특별한 리퀘스트를 받을 수 있습니다.
