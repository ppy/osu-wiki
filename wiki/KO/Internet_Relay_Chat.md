...
Osu!는 그동안 [게임 내 채팅](KO:Chat_Console "wikilink") 에서 IRC 프로트콜을 사용해 왔습니다. 당신은 당신의 친구와 연결하여 Osu!에서 채팅을 할수 있습니다. Bancho는 IRC 프로트콜을 구현하고 어떠한 방식으로도 구현하기 위해 노력했으나 IRC의 모든 기능은 없습니다.
