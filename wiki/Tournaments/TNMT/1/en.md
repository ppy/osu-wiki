...
- Join match
  - The match room has **TNMT** as prefix and players in this match will receive invitation.
  - Players should enter the room 10 minutes before match time.
- Disconnection
  - If disconnect happened **in 30 seconds after map started**
    - Inform the referee so disconnected player can ask for re-attempted.
    - Only 2 chances to re-attempted.
  - If disconnect happened **in 30 seconds before map end**
    - If player finish the map, he should upload the score screenshot through `Shift`+`F12` and give the link to referee.
