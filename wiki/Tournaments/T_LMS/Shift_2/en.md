...
The **Taiko LMS: Shift Cup 2** (***TLMS:SC2***) was a worldwide 4v4 double-elimination osu!taiko tournament hosted by ::{ flag=US }:: ::Backfire::{ user=263110 } and ::{ flag=GB }:: ::Lno::{ user=1900787 }. Teams would gather a team of 4 (with the option of 2 back-ups) in a 4-on-4 knock-out style match. This was the second instalment of the Taiko Shift Cup and part of the Taiko LMS tournaments.
...
| Position | Member(s) |
| :-- | :-- |
| Organizer | ::{ flag=US }:: ::Backfire::{ user=263110 }, ::{ flag=GB }:: ::Lno::{ user=1900787 } |
| Mappool selector | ::{ flag=US }:: ::Backfire::{ user=263110 }, ::{ flag=RU }:: ::Dayzeek::{ user=5009970 }, ::{ flag=GB }:: ::Lno::{ user=1900787 } |
| Referee | ::{ flag=HK }:: ::Akali393394::{ user=9686628 }, ::{ flag=NL }:: ::Boaz::{ user=13302996 }, ::{ flag=CL }:: ::Catulus::{ user=6276709 }, ::{ flag=PL }:: ::Deroo::{ user=8360475 }, ::{ flag=SG }:: ::Element118::{ user=2283992 }, ::{ flag=US }:: ::ITotallyGetThat::{ user=8770622 }, ::{ flag=FR }:: ::Kasumii-sama::{ user=6177263 }, ::{ flag=SE }:: ::Nurend::{ user=9905079 } |
| Streamer | ::{ flag=PL }:: ::Deroo::{ user=8360475 }, ::{ flag=SG }:: ::Element118::{ user=2283992 }, ::{ flag=US }:: ::ITotallyGetThat::{ user=8770622 }, ::{ flag=DE }:: ::Sayira::{ user=7253958 } |
| Commentator | ::{ flag=US }:: ::AuroraPhasmata::{ user=13664116 }, ::{ flag=AU }:: ::Beat43210::{ user=5664171 }, ::{ flag=CL }:: ::Catulus::{ user=6276709 }, ::{ flag=DE }:: ::Drecksackblase::{ user=6278008 }, ::{ flag=US }:: ::Ethaaaan::{ user=9536977 }, ::{ flag=TR }:: ::frukoyurdakul::{ user=7612550 }, ::{ flag=DE }:: ::Heam::{ user=4705120 }, ::{ flag=SE }:: ::Raphalge::{ user=3918650 }, ::{ flag=AR }:: ::Vaf::{ user=12589048 } |
...
| Team | Members |
| :-- | :-- |
| **100% taiko juice** | ::{ flag=RU }:: **::night\1flower::{ user=11574707 }**, ::{ flag=CN }:: ::te2035::{ user=6294200 }, ::{ flag=UA }:: ::Don Omar::{ user=689414 }, ::{ flag=CA }:: ::CaesarSalad99::{ user=12392840 }, ::{ flag=FR }:: ::BananaW::{ user=9298106 }, ::{ flag=CA }:: ::beary605::{ user=2198070 } |
| **a** | ::{ flag=KR }:: **::BamgoeSN::{ user=1152851 }**, ::{ flag=KR }:: ::Konpaku Sariel::{ user=533502 }, ::{ flag=KR }:: ::oL0::{ user=1134683 }, ::{ flag=KR }:: ::POCARI SWEAT::{ user=5082685 }, ::{ flag=KR }:: ::Lamery::{ user=4557972 }, ::{ flag=KR }:: ::TWIL1GHT::{ user=12478373 } |
| **abibibubibui** | ::{ flag=DE }:: **::frz::{ user=6956922 }**, ::{ flag=TR }:: ::frukoyurdakul::{ user=7612550 }, ::{ flag=DE }:: ::jleste::{ user=8275687 }, ::{ flag=CA }:: ::janitore::{ user=3307897 }, ::{ flag=BR }:: ::HiroK::{ user=4050738 }, ::{ flag=DE }:: ::Xay::{ user=961417 } |
| **cloudfag's harem** | ::{ flag=RU }:: **::cloudfags::{ user=5285786 }**, ::{ flag=RU }:: ::TwinT::{ user=9976154 }, ::{ flag=US }:: ::Catgirl::{ user=2771995 }, ::{ flag=PL }:: ::bernard351::{ user=9511518 }, ::{ flag=PL }:: ::pestoszx::{ user=12144395 }, ::{ flag=RU }:: ::Den4ik228::{ user=7115174 } |
| **Dancing Pallbearers** | ::{ flag=ID }:: **::apaajaboleh10::{ user=5151647 }**, ::{ flag=ID }:: ::ketiduran::{ user=2180885 }, ::{ flag=ID }:: ::Aesa::{ user=3285867 }, ::{ flag=ID }:: ::Nishizumi::{ user=2496768 }, ::{ flag=ID }:: ::Naverlyn::{ user=14324722 }, ::{ flag=ID }:: ::Katdon\_donKat::{ user=8089664 } |
| **Easter Egg** | ::{ flag=FR }:: **::DemonWaves::{ user=3909293 }**, ::{ flag=FR }:: ::Mokip::{ user=11404841 }, ::{ flag=FR }:: ::Chernobog::{ user=3317042 }, ::{ flag=FR }:: ::Madeline::{ user=2812098 }, ::{ flag=FR }:: ::kamaboko117::{ user=9508031 }, ::{ flag=FR }:: ::Ladybug::{ user=4833654 } |
| **EuroGamers -Jaye** | ::{ flag=IT }:: **::D3kuu::{ user=7807444 }**, ::{ flag=IT }:: ::Ikkun::{ user=1059945 }, ::{ flag=ES }:: ::AlvaroYL::{ user=6333166 }, ::{ flag=GB }:: ::goheegy::{ user=8057655 }, ::{ flag=DE }:: ::Mew::{ user=2345156 }, ::{ flag=PL }:: ::CreepyDuck::{ user=2435013 } |
| **juju on that Beat43210** | ::{ flag=AU }:: **::Beat43210::{ user=5664171 }**, ::{ flag=US }:: ::HoopWheat::{ user=12177903 }, ::{ flag=US }:: ::ThatTaikoGuy::{ user=4640844 }, ::{ flag=US }:: ::Obama Taichou::{ user=3220847 }, ::{ flag=US }:: ::Ethaaaan::{ user=9536977 }, ::{ flag=US }:: ::Shyguy::{ user=178038 } |
| **loli meme patrol** | ::{ flag=RU }:: **::Nozdormu::{ user=7169208 }**, ::{ flag=CA }:: ::Vysha::{ user=4908773 }, ::{ flag=RU }:: ::Akonine::{ user=7774222 }, ::{ flag=RU }:: ::Voenkom::{ user=10168328 }, ::{ flag=RU }:: ::Naninub::{ user=8188876 }, ::{ flag=RU }:: ::Starger::{ user=3398715 } |
| **Los Panas** | ::{ flag=EC }:: **::Gamelan4::{ user=9856910 }**, ::{ flag=CL }:: ::Ulqui::{ user=1263669 }, ::{ flag=BR }:: ::Skull Kid::{ user=3044264 }, ::{ flag=BR }:: ::Coryn::{ user=2828556 }, ::{ flag=BR }:: ::Foxeru::{ user=7479684 }, ::{ flag=BR }:: ::Kyoumo::{ user=8145223 } |
| **null** | ::{ flag=JP }:: **::gekiowata::{ user=8929896 }**, ::{ flag=JP }:: ::izu\1illya::{ user=12155303 }, ::{ flag=JP }:: ::4sbet1::{ user=11563671 }, ::{ flag=JP }:: ::nuzojon::{ user=9773629 }, ::{ flag=JP }:: ::4mehibiki::{ user=10489413 }, ::{ flag=JP }:: ::Quantom\1osu::{ user=7935131 } |
| **Pokochin Brothers** | ::{ flag=JP }:: **::Yoroiari::{ user=6056862 }**, ::{ flag=JP }:: ::tamakagi2000::{ user=9540073 }, ::{ flag=JP }:: ::nyanmi-1828::{ user=6866480 }, ::{ flag=JP }:: ::Maeda::{ user=12615278 }, ::{ flag=JP }:: ::Maimaing::{ user=14520910 }, ::{ flag=JP }:: ::KuroKuroKuro::{ user=11931563 } |
| **Remii and the E-Girls** | ::{ flag=AU }:: **::dad come back::{ user=4691373 }**, ::{ flag=AU }:: ::Tsubasa2::{ user=6835183 }, ::{ flag=AU }:: ::r1chyy::{ user=11499467 }, ::{ flag=AU }:: ::acid::{ user=2913584 } |
| **RJ is a furry** | ::{ flag=US }:: **::cheese salad::{ user=6349821 }**, ::{ flag=US }:: ::R J::{ user=6490509 }, ::{ flag=US }:: ::Whulf::{ user=11601107 }, ::{ flag=US }:: ::Loopy542::{ user=5468461 }, ::{ flag=US }:: ::ChurroChef::{ user=9258564 }, ::{ flag=US }:: ::AuroraPhasmata::{ user=13664116 } |
| **Syria** | ::{ flag=DE }:: **::Drecksackblase::{ user=6278008 }**, ::{ flag=US }:: ::quickvik::{ user=4410873 }, ::{ flag=US }:: ::3san::{ user=8050850 }, ::{ flag=US }:: ::giyokon::{ user=10852632 }, ::{ flag=AR }:: ::BossPlays::{ user=7341471 }, ::{ flag=TW }:: ::X a v y::{ user=3738344 } |
| **the bros 3** | ::{ flag=GR }:: **::Genjuro::{ user=3196091 }**, ::{ flag=US }:: ::closed::{ user=5116922 }, ::{ flag=BR }:: ::Kqrth::{ user=4115718 }, ::{ flag=DE }:: ::i like trap::{ user=3624499 }, ::{ flag=GB }:: ::Horiizon::{ user=14513386 } |
| **United Kingdom B** | ::{ flag=GB }:: **::Metzo::{ user=10633982 }**, ::{ flag=GB }:: ::Teezel::{ user=7528639 }, ::{ flag=GB }:: ::Daniels::{ user=12439209 }, ::{ flag=GB }:: ::Moonwake::{ user=6657019 }, ::{ flag=GB }:: ::hammygames::{ user=12232503 }, ::{ flag=GB }:: ::\_DUSK\_::{ user=6092181 } |
| **Where is JDrago1-13?** | ::{ flag=SE }:: **::Raphalge::{ user=3918650 }**, ::{ flag=KR }:: ::Peaceful::{ user=165027 }, ::{ flag=US }:: ::JDrago14::{ user=7690078 }, ::{ flag=IT }:: ::coed::{ user=3716665 }, ::{ flag=VE }:: ::Colorojo12::{ user=5136821 }, ::{ flag=IT }:: ::LordEnder::{ user=4609767 } |
| **Windjammers** | ::{ flag=DE }:: **::Sayira::{ user=7253958 }**, ::{ flag=DE }:: ::\[TaikoTori\]::{ user=1074143 }, ::{ flag=DE }:: ::Ak1o::{ user=1600041 }, ::{ flag=DE }:: ::Mikalodo::{ user=8498207 }, ::{ flag=DE }:: ::QEpicAce::{ user=9489153 }, ::{ flag=DE }:: ::Zetera::{ user=587737 } |
| **Yona and the Macacos** | ::{ flag=BR }:: **::Mikudayo::{ user=5235718 }**, ::{ flag=FR }:: ::Yona::{ user=7930622 }, ::{ flag=BR }:: ::Berg::{ user=8097465 }, ::{ flag=IT }:: ::A-40::{ user=14510301 }, ::{ flag=ES }:: ::LZD::{ user=224335 }, ::{ flag=BR }:: ::Lazarento::{ user=3224958 } |
| **ヴぇ** | ::{ flag=JP }:: **::Six b0xes::{ user=8303357 }**, ::{ flag=JP }:: ::syaron105::{ user=8741695 }, ::{ flag=JP }:: ::miki308::{ user=7632508 }, ::{ flag=JP }:: ::kvgyubh::{ user=8244404 }, ::{ flag=JP }:: ::konohahakase::{ user=11325757 }, ::{ flag=JP }:: ::remiria3150::{ user=4376346 } |
...
| Placing | Team |
| :-- | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | **Where is JDrago1-13?** (::{ flag=SE }:: ::Raphalge::{ user=3918650 }, ::{ flag=KR }:: ::Peaceful::{ user=165027 }, ::{ flag=US }:: ::JDrago14::{ user=7690078 }, ::{ flag=IT }:: ::coed::{ user=3716665 }, ::{ flag=VE }:: ::Colorojo12::{ user=5136821 }, ::{ flag=IT }:: ::LordEnder::{ user=4609767 }) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | **abibibubibui** (::{ flag=DE }:: ::frz::{ user=6956922 }, ::{ flag=TR }:: ::frukoyurdakul::{ user=7612550 }, ::{ flag=DE }:: ::jleste::{ user=8275687 }, ::{ flag=CA }:: ::janitore::{ user=3307897 }, ::{ flag=BR }:: ::HiroK::{ user=4050738 }, ::{ flag=DE }:: ::Xay::{ user=961417 }) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | **EuroGamers -Jaye** (::{ flag=IT }:: ::D3kuu::{ user=7807444 }, ::{ flag=IT }:: ::Ikkun::{ user=1059945 }, ::{ flag=ES }:: ::AlvaroYL::{ user=6333166 }, ::{ flag=GB }:: ::goheegy::{ user=8057655 }, ::{ flag=DE }:: ::Mew::{ user=2345156 }, ::{ flag=PL }:: ::CreepyDuck::{ user=2435013 }) |
