...
2. Каждый список карт будет состоять из пяти групп: NoMod, Hard Rock, Hidden, Double Time и FreeMod.
...
6. Карты из групп Hidden, Hard Rock и Double Time будут играться с соответствующими модами.
7. Карты из группы FreeMod могут играться с Hidden, Hard Rock, Flashlight или вообще без модов.
