...
|  | Country | Members |
| :-: | :-: | :-- |
| ::{ flag=AT }::/::{ flag=DE }:: | **Austria - Germany** | **::TouhouNerd::{ user=396056 }**, ::Hanyuu::{ user=73480 }, ::Nharox::{ user=6794 }, ::Snowball::{ user=152238 }, ::unbelievable::{ user=491021 } |
| ::{ flag=AR }:: | **Argentina** | **::Wishy22::{ user=495477 }**, ::Grisuh::{ user=221500 }, ::lota78::{ user=50727 }, ::RocknRolla::{ user=135622 }, ::Vivere::{ user=101521 }, ::violentt::{ user=87231 } |
| ::{ flag=BR }:: | **Brazil** | **::fabriciorby::{ user=209664 }**, ::Antsu::{ user=92953 }, ::Blue Dragon::{ user=19048 }, ::Coy::{ user=150434 }, ::Guerra::{ user=271144 }, ::Poisonchan::{ user=227881 } |
| ::{ flag=CA }:: | **Canada** | **::FurukawaPan::{ user=32067 }**, ::Ever 14::{ user=507051 }, ::Hiyorin::{ user=493961 }, ::Soulclenz::{ user=190109 }, ::timotmcc::{ user=41809 }, ::yanggaog::{ user=129119 } |
| ::{ flag=CL }:: | **Chile** | **::nVidi4x::{ user=203181 }**, ::Art-FzTT::{ user=248453 }, ::ElxBeta::{ user=75515 }, ::Mesita::{ user=201459 }, ::netofe::{ user=324198 } |
| ::{ flag=CN }:: | **China** | **::kiddly::{ user=74937 }**, ::xierbaliti::{ user=34044 }, ::KanbeKotori::{ user=107426 }, ::Sprosive::{ user=227717 }, ::lzy::{ user=135567 }, ::Brother\_Lu::{ user=700309 } |
| ::{ flag=DO }:: | **Dominican Republic** | **::Lissette::{ user=19835 }**, ::jmt\_3::{ user=317242 }, ::Lizbeth::{ user=21970 }, ::Magestix::{ user=50885 } |
| ::{ flag=FI }:: | **Finland** | **::heintsi::{ user=63185 }**, ::Lanttu::{ user=57448 }, ::morovaa::{ user=127777 }, ::Mukku::{ user=71756 }, ::Orkel::{ user=39385 }, ::Sutsuka::{ user=29089 } |
| ::{ flag=FR }:: | **France** | **::maestro delphine::{ user=472848 }**, ::\_LRJ\_::{ user=284905 }, ::galvenize::{ user=381444 }, ::JesusYamato::{ user=482442 }, ::Shiro::{ user=113005 }, ::Yomi::{ user=366059 } |
| ::{ flag=DE }:: | **Germany** | **::Shael::{ user=132308 }**, ::eMJaReL::{ user=65761 }, ::Jalatiphra::{ user=94386 }, ::LuniaFreak::{ user=473895 }, ::Neruell::{ user=112257 }, ::Shinespark::{ user=126293 } |
| ::{ flag=ID }:: | **Indonesia** | **::Hakeru Prismriver::{ user=345422 }**, ::awell::{ user=341298 }, ::awesomewithin::{ user=81652 }, ::dNextGen::{ user=346320 }, ::intermu::{ user=193198 }, ::Rasyad95::{ user=157956 } |
| ::{ flag=IT }:: | **Italy** | **::Card N'FoRcE::{ user=3936 }**, ::\[Takuya\]::{ user=342372 }, ::kr4t0s88::{ user=40737 }, ::Lunah::{ user=1227377 }, ::osuplayer111::{ user=33599 }, ::Valde::{ user=208531 } |
| ::{ flag=JP }:: | **Japan** | **::MeRcYyy::{ user=75595 }**, ::Ozouni::{ user=69600 }, ::Rigeru::{ user=61154 }, ::Rorry::{ user=198574 }, ::SiLviA::{ user=409747 }, ::taNa::{ user=61101 } |
| ::{ flag=MO }:: | **Macau** | **::Ballance::{ user=165946 }**, ::\_\_\_\_\_B::{ user=247901 }, ::starpun1::{ user=144523 }, ::wl01939929::{ user=456163 }, ::xinhe::{ user=252936 } |
| ::{ flag=MY }:: | **Malaysia** | **::The 08 team\_Bourdon::{ user=275686 }**, ::akupp::{ user=249825 }, ::DragonSparta::{ user=216909 }, ::Crimson\_SoulZ::{ user=91320 }, ::mekadon::{ user=157835 }, ::mycyber::{ user=187910 } |
| ::{ flag=NL }:: | **Netherlands** | **::GladiOol::{ user=23326 }**, ::Awoken::{ user=256802 }, ::eddieee::{ user=260284 }, ::happy30::{ user=27767 }, ::Henkie::{ user=16944 }, ::Lesjuh::{ user=44308 } |
| ::{ flag=NZ }:: | **New Zealand** | **::NumoT123::{ user=282930 }**, ::Acidsky-::{ user=116608 }, ::deadbeat::{ user=128370 }, ::jiantz::{ user=330252 }, ::SkyE-::{ user=114796 }, ::toejamms::{ user=231111 } |
| ::{ flag=PH }:: | **Philippines** | **::dayun10::{ user=570310 }**, ::bakaloidsky::{ user=504885 }, ::blacksymbian::{ user=53956 }, ::jockeytiyan::{ user=133618 }, ::nachopiggy::{ user=95637 }, ::WyndII::{ user=46538 } |
| ::{ flag=PL }:: | **Poland** | **::ShaggoN::{ user=39129 }**, ::fartownik::{ user=56917 }, ::kuburaczek::{ user=29130 }, ::Niko-::{ user=175141 }, ::rEdo::{ user=49329 }, ::White Wolf::{ user=39828 } |
| ::{ flag=PT }:: | **Portugal** | **::JonnyThatJonny::{ user=201290 }**, ::creativ::{ user=280158 }, ::makkura::{ user=344086 }, ::Pereira006::{ user=537344 }, ::sttailruby12::{ user=213335 } |
| ::{ flag=RU }:: | **Russian Federation** | **::GaShiK::{ user=227643 }**, ::Akai-::{ user=649471 }, ::CracK::{ user=119933 }, ::Kotya::{ user=297551 }, ::larch::{ user=296787 }, ::TKiller::{ user=113027 } |
| ::{ flag=KR }:: | **South Korea** | **::KRZY::{ user=114017 }**, ::Binjip::{ user=261694 }, ::Cookiezi::{ user=124493 }, ::ehRh::{ user=272117 }, ::M A I D::{ user=216472 }, ::Reisen Udongein::{ user=232942 } |
| ::{ flag=ES }:: | **Spain** | **::X\_Ray::{ user=160937 }**, ::choche::{ user=239850 }, ::hyperluigi::{ user=43921 }, ::Lionheart69::{ user=88152 }, ::migul::{ user=423217 }, ::Skullboss::{ user=48527 } |
| ::{ flag=SE }:: | **Sweden** | **::beko1994::{ user=310548 }**, ::Darkoff::{ user=131072 }, ::palinus::{ user=214706 }, ::Saten-san::{ user=444506 }, ::Vikkez::{ user=235215 }, ::Xgor::{ user=98661 } |
| ::{ flag=TW }:: | **Taiwan** | **::Uan::{ user=147623 }**, ::0222101916::{ user=122650 }, ::FuNnY--::{ user=398097 }, ::NanaDesu::{ user=163474 }, ::Rucker::{ user=147515 }, ::Tomoka Rin::{ user=125308 } |
| ::{ flag=UA }:: | **Ukraine** | **::Gorlum::{ user=347635 }**, ::gef::{ user=226175 }, ::Mosya::{ user=77835 }, ::RainForce::{ user=192251 }, ::rockleejkooo::{ user=384003 } |
| ::{ flag=GB }:: | **United Kingdom** | **::Doomsday::{ user=18983 }**, ::aevv::{ user=390955 }, ::DiamondCrash::{ user=123790 }, ::jericho2442::{ user=88904 }, ::Natteke::{ user=157177 } |
| ::{ flag=US }:: | **United States** | **::Lybydose::{ user=64501 }**, ::Cyclone::{ user=18589 }, ::ebacho::{ user=129932 }, ::Mafiamaster::{ user=17695 }, ::naptime::{ user=277682 } |
...
| Placing | Team |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=TW }:: **Taiwan** (**::Uan::{ user=147623 }**, ::0222101916::{ user=122650 }, ::FuNnY--::{ user=398097 }, ::NanaDesu::{ user=163474 }, ::Rucker::{ user=147515 }, ::Tomoka Rin::{ user=125308 }) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=NL }:: **Netherlands** (**::GladiOol::{ user=23326 }**, ::Awoken::{ user=256802 }, ::eddieee::{ user=260284 }, ::happy30::{ user=27767 }, ::Henkie::{ user=16944 }, ::Lesjuh::{ user=44308 }) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=KR }:: **South Korea** (**::KRZY::{ user=114017 }**, ::Binjip::{ user=261694 }, ::Cookiezi::{ user=124493 }, ::ehRh::{ user=272117 }, ::M A I D::{ user=216472 }, ::Reisen Udongein::{ user=232942 }) |
