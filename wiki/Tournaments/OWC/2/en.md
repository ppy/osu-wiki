...
|  | Country | Members |
| :-: | :-: | :-- |
| ::{ flag=AR }:: | **Argentina** | **::Wishy22::{ user=495477 }**, ::Ever17::{ user=173114 }, ::Darksonic::{ user=570042 }, ::Glazbom::{ user=608277 }, ::Metro::{ user=306737 }, ::Salvage::{ user=242119 }, *::Hernan::{ user=516680 }*[^ko-stage-note] |
| ::{ flag=AU }:: | **Australia** | **::Mizorex::{ user=591469 }**, ::damiaanzx::{ user=635030 }, ::Frankcons::{ user=594006 }, ::Hark::{ user=43265 }, ::Mikey::{ user=979780 }, ::Neko\_Lover::{ user=596535 } |
| ::{ flag=AT }:: | **Austria** | **::-Lennox-::{ user=489103 }**, ::Hakkero::{ user=177913 }, ::Hanyuu::{ user=73480 }, ::M A R I O::{ user=594424 }, ::novaaa::{ user=953405 }, ::Snowball::{ user=152238 } |
| ::{ flag=BR }:: | **Brazil** | **::Blue Dragon::{ user=19048 }**, ::antsu::{ user=92953 }, ::Caco::{ user=635173 }, ::fabriciorby::{ user=209664 }, ::Fumi-chan::{ user=181432 }, ::Katsuri::{ user=701726 }, *::K3nsh1n\_H1mur4::{ user=197834 }*,[^group-stage-note] *::Asterio::{ user=803906 }*,[^ko-stage-note] *::gabaeba::{ user=867902 }*[^ko-stage-note] |
| ::{ flag=BG }:: | **Bulgaria** | **::Lolicore Flandre::{ user=447818 }**, ::ColdChester::{ user=483663 }, ::las7h0p3::{ user=113972 }, ::Orihara Izaya::{ user=513842 }, ::r-Beatz::{ user=472311 }, ::werewolf0girl::{ user=213292 } |
| ::{ flag=CA }:: | **Canada** | **::FurukawaPan::{ user=32067 }**, ::Glass::{ user=228532 }, ::Satonaka::{ user=767009 }, ::shaNk::{ user=905124 }, ::SilentWings::{ user=118992 }, ::YodaSnipe::{ user=673746 }, *::RB\_Oliver::{ user=229206 }*,[^ko-stage-note] *::those::{ user=557166 }*[^ko-stage-note] |
| ::{ flag=CL }:: | **Chile** | **::nVidi4x::{ user=203181 }**, ::Art-FzTT::{ user=248453 }, ::b1choO::{ user=461132 }, ::b4ss\_::{ user=493712 }, ::Ignacio::{ user=2881294 }, ::Mesita::{ user=201459 } |
| ::{ flag=DK }:: | **Denmark** | **::Emaal::{ user=85070 }**, ::BongHat::{ user=369746 }, ::Circlemuncher::{ user=873335 }, ::m4w11::{ user=509620 }, ::PlasticSmoothie::{ user=296565 }, *::DennisGG::{ user=1008997 }*[^group-stage-note] |
| ::{ flag=FI }:: | **Finland** | **::ragelewa::{ user=475021 }**, ::ethox::{ user=441380 }, ::heintsi::{ user=63185 }, ::Orkel::{ user=39385 }, ::Sutsuka::{ user=29089 }, ::Zapy::{ user=251395 }, *::Valentiino::{ user=918773 }*[^group-stage-note] |
| ::{ flag=FR }:: | **France** | **::Odaril::{ user=113005 }**, ::\_LRJ\_::{ user=284905 }, ::galvenize::{ user=381444 }, ::Kanna::{ user=366059 }, ::Mustaash::{ user=1669213 }, ::XPJ38::{ user=273531 }, *::Maestro::{ user=472848 }*[^group-stage-note] |
| ::{ flag=DE }:: | **Germany** | **::DoKoLP::{ user=537084 }**, ::Blacky::{ user=268788 },[^blacky-note] ::Scanlatione::{ user=393337 }, ::ShadowSoul::{ user=494970 }, ::Shael::{ user=132308 }, ::SuperCracker::{ user=145639 }, *::-libili-::{ user=706289 }*,[^group-stage-note] *::Asozial::{ user=833594 }*,[^group-stage-note] *::Neruell::{ user=112257 }*,[^ko-stage-note] *::Tom94::{ user=1857058 }*[^ko-stage-note] |
| ::{ flag=HK }:: | **Hong Kong** | **::KanaRin::{ user=310747 }**, ::henry04213::{ user=793536 }, ::HineX::{ user=13854 }, ::Kirito47::{ user=545514 }, ::Miu Matsuoka::{ user=10641 }, ::Pokie::{ user=207340 }, *::-\[L\]ightz::{ user=707840 }*[^group-stage-note] |
| ::{ flag=HU }:: | **Hungary** | **::Kuroi Mato::{ user=584921 }**, ::higurush::{ user=602159 }, ::Kozuki Kallen::{ user=816305 }, ::TaylorXIII::{ user=351814 }, ::tasli::{ user=59650 }, [TsukishimaKirari x\]](https://osu.ppy.sh/users/816358) |
| ::{ flag=ID }:: | **Indonesia** | **::Hakeru Prismriver::{ user=345422 }**, ::awell::{ user=341298 }, ::awesomewithin::{ user=81652 }, ::dNextGen::{ user=346320 }, ::gatitoneku::{ user=363377 }, ::xeqta::{ user=524530 } |
| ::{ flag=JP }:: | **Japan** | **::SiLviA::{ user=409747 }**, ::Apricot::{ user=438547 }, ::Flute::{ user=211278 }, ::Iris::{ user=758181 }, ::Sinch::{ user=360552 }, ::tobaku2784::{ user=113855 }, *::val0108::{ user=243917 }*[^group-stage-note] |
| ::{ flag=LV }:: | **Latvia** | **::\_Angel::{ user=341851 }**, ::GummyChan::{ user=757683 }, ::LoGo::{ user=750382 }, ::Vmx::{ user=967501 } |
| ::{ flag=MY }:: | **Malaysia** | **::akupp::{ user=249825 }**, ::Gon::{ user=583765 }, ::RhaiizoN::{ user=758295 }, ::The 08 team\_Bourdon::{ user=275686 }, ::xsrsbsns::{ user=414427 }, ::zenki0013::{ user=89646 } |
| ::{ flag=NL }:: | **Netherlands** | **::GladiOol::{ user=23326 }**, ::Awoken::{ user=256802 }, ::eddieee::{ user=260284 }, ::Henkie::{ user=16944 }, ::Lesjuh::{ user=44308 }, ::zozozofun::{ user=58727 } |
| ::{ flag=NZ }:: | **New Zealand** | **::jiantz::{ user=330252 }**, ::Bob\_the\_Cat::{ user=121470 }, ::deadbeat::{ user=128370 }, ::Kiiwa::{ user=231111 }, ::kwk::{ user=365586 }, ::numot123::{ user=282930 } |
| ::{ flag=NO }:: | **Norway** | **::kriers::{ user=333241 }**, ::AndreasHD::{ user=369956 }, ::CXu::{ user=84841 }, ::Danzai::{ user=73852 }, ::Druidianna::{ user=682834 }, ::KinomiCandy::{ user=375143 }, *::Oscarface92::{ user=284347 }*[^group-stage-note] |
| ::{ flag=PH }:: | **Philippines** | **::Mystgun::{ user=720029 }**, ::jannnnnn::{ user=818399 }, ::dayun10::{ user=570310 }, ::Osu Tatakae Ouendan::{ user=594210 }, ::Pizzicatto::{ user=692610 }, ::usagijirosan::{ user=714230 } |
| ::{ flag=PL }:: | **Poland** | **::fartownik::{ user=56917 }**, ::Kubu::{ user=29130 }, ::Piotrekol::{ user=304520 }, ::rEdo::{ user=49329 }, ::White Wolf::{ user=39828 }, *::Niko-::{ user=175141 }*[^ko-stage-note] |
| ::{ flag=PT }:: | **Portugal** | **::creativ::{ user=280158 }**, ::cococococo::{ user=715052 }, ::JonnyThatJonny::{ user=201290 }, ::makkura::{ user=344086 }, ::Maraiga::{ user=213335 }, ::Pereira006::{ user=537344 } |
| ::{ flag=RU }:: | **Russian Federation** | **::Akai-::{ user=649471 }**, ::cr1m::{ user=803766 }, ::kapehh::{ user=360958 }, ::Kert::{ user=119933 }, ::Rost94::{ user=490568 }, ::Vpalach::{ user=232729 }, *::BinGOSU3::{ user=610462 }*[^ko-stage-note] |
| ::{ flag=KR }:: | **South Korea** | **::KRZY::{ user=114017 }**, ::CheEZ::{ user=272117 }, ::K i R i K a R u::{ user=139670 }, ::moneto::{ user=242788 }, ::Reisen Udongein::{ user=232942 }, ::Remilia-Scarlet::{ user=602783 } |
| ::{ flag=SE }:: | **Sweden** | **::theowest::{ user=60604 }**, ::failboat::{ user=276074 }, ::Gyuunyu::{ user=799102 }, ::Hanyuu-chan::{ user=881369 }, ::Holmir::{ user=453435 }, ::Nidert::{ user=817211 }, *::m4w11::{ user=509620 }*[^group-stage-note] |
| ::{ flag=TW }:: | **Taiwan** | **::Saya-Honmei::{ user=2865291 }**, ::SnowWhite::{ user=50265 }, ::Tomoka Rin::{ user=125308 }, ::wizoza83098::{ user=164156 }, ::YuyuKo sama::{ user=234788 }, ::ZRush::{ user=398097 } |
| ::{ flag=TH }:: | **Thailand** | **::Frostmourne::{ user=199669 }**, ::aumu1995::{ user=235752 }, ::bufo::{ user=141605 }, ::blackspell::{ user=601173 }, ::NonxE::{ user=319312 }, ::termerys::{ user=84964 }, *::0OoMickeyoO0::{ user=317494 }*[^group-stage-note] |
| ::{ flag=UA }:: | **Ukraine** | **::Gorlum::{ user=347635 }**, ::\[milky\]::{ user=288597 }, ::rockleejkooo::{ user=384003 }, ::uljjang::{ user=3784417 }, *::Granje::{ user=496387 }*[^ko-stage-note] |
| ::{ flag=US }:: | **United States** | **::Kyou-kun::{ user=285711 }**, ::Cyclone::{ user=18589 }, ::david huhh::{ user=278954 }, ::Derekku::{ user=91341 }, ::geckogates::{ user=252524 }, ::Lybydose::{ user=64501 } |
| ::{ flag=UY }:: | **Uruguay** | **::maay::{ user=160970 }**, ::AlrdyExists::{ user=407022 }, ::GonixZ::{ user=612622 }, ::H1ko::{ user=58710 }, ::Snepif::{ user=408088 }, ::Z e o n::{ user=539876 } |
| ::{ flag=VN }:: | **Vietnam** | **::Misuzu-san::{ user=358563 }**, ::BridgetteLSatellizer::{ user=854083 }, ::JerryC::{ user=279278 }, ::kira\_lacus1995::{ user=996435 }, ::xLightningx::{ user=1007806 }, *::Shin1801::{ user=604492 }*[^group-stage-note] |
...
| Placing | Team |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=KR }:: **South Korea** (**::KRZY::{ user=114017 }**, ::CheEZ::{ user=272117 }, ::K i R i K a R u::{ user=139670 }, ::moneto::{ user=242788 }, ::Reisen Udongein::{ user=232942 }, ::Remilia-Scarlet::{ user=602783 }) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=JP }:: **Japan** (**::SiLviA::{ user=409747 }**, ::Apricot::{ user=438547 }, ::Flute::{ user=211278 }, ::Iris::{ user=758181 }, ::Sinch::{ user=360552 }, ::tobaku2784::{ user=113855 }, *::val0108::{ user=243917 }*[^group-stage-note]) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=BR }:: **Brazil** (**::Blue Dragon::{ user=19048 }**, ::antsu::{ user=92953 }, ::Caco::{ user=635173 }, ::fabriciorby::{ user=209664 }, ::Fumi-chan::{ user=181432 }, ::Katsuri::{ user=701726 }, *::K3nsh1n\_H1mur4::{ user=197834 }*,[^group-stage-note] *::Asterio::{ user=803906 }*,[^ko-stage-note] *::gabaeba::{ user=867902 }*[^ko-stage-note]) |
