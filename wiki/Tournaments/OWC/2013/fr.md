...
La **_osu! World Cup 2013_** (ou **OWC 2013**, littéralement « coupe du monde de osu! ») était la quatrième édition d'une compétition internationale annuelle où les meilleurs joueurs de osu! du monde entier s'affrontent en équipe pour remporter la victoire et représenter leur pays.
...
| Country                    | Members                                                                                                                                                                                                                                                                                                                                                                              |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ![][flag_CN] China         | **[Furudo_Erika](https://osu.ppy.sh/users/169878)**, [wobeinimacao](https://osu.ppy.sh/users/350723), [N a n o](https://osu.ppy.sh/users/694114), [5231_Kinoko](https://osu.ppy.sh/users/181057), [GGBY](https://osu.ppy.sh/users/629717), [Dsan](https://osu.ppy.sh/users/1266166), [InabaTewi](https://osu.ppy.sh/users/1078004), [GunS_N_Rose](https://osu.ppy.sh/users/1349849)  |
...
| ![][flag_AT] Austria     | **Omgforz**, WhitePhoenixLP, M3tr01d, Alumetorz, Jin_Back7, SunBurn                    |
...
| ![][flag_FR] France      | **-Kamui-**, Worne, NerO, Kynan, Timal75, Musty, The_badin, My Not                     |
...
| ![][flag_NL] Netherlands | **happy30**, Yoeri, BiG_ChilD, Kris, Synchrostar, R3laX3R, Kyshiro, Jackylam5          |
...
| ![][flag_BG] Bulgaria    | **Scrublord**, Defacer, b1o, -Arthus-, Supbads, Angeloid_Alpha, Hardatyou             |
...
| ![][flag_SG] Singapore   | **Bardiche_Z**, Alacartx, phox, Wishxrai, Theseanbei, deokoking, CloudNep, SenaAiriii |
...
-   Tiebreaker
    -   **[DJ Okawari - Luv Letter (nold_1702) \[Posthumous\]](https://osu.ppy.sh/beatmaps/127363)**

### Huitièmes de finale

**[Cliquez ici pour télécharger l'intégralité des beatmaps de cette phase](https://www.mediafire.com/download/e62iav4kb90981b/Round_of_16_Pack.rar)** (attention : ce pack ne reflète pas les derniers changements dans le choix des beatmaps ; en l'occurrence, _Justice Breaker_ et _Saigetsu_ n'y sont pas présents)
...
-   NoMod
    ...
    -   [Neru - Ningen Shikkaku (nold_1702) \[Posthumous\]](https://osu.ppy.sh/beatmaps/237848)
...
-   DoubleTime
    ...
    -   [Makou - Fermion (MoonFragrance) \[Maximum\]](https://osu.ppy.sh/beatmaps/72284)
...
2.  Les maps prévues pour chaque phase seront annoncées publiquement par l'équipe de sélection des beatmaps le dimanche précédent le début de chaque phase. Aucune autre beatmap ne peut être jouée durant les matchs.
    -   Une map, le _tiebreaker_, servira à départager deux équipes à égalité à la fin d'un match. Elle ne peut être utilisée pour une autre fin.
...
5.  Les _revives_ (revenir d'un statut d'échec à un statut normal au sein d'une partie en remplissant la barre de vie au maximum) sont autorisés.
...
1.  Chaque équipe doit être constituée au minimum de 4 joueurs.
    ...
    2.  Le responsable d'une équipe, le _capitaine_, doit être spécifié.
