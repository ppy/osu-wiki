...
2. Битмапы для каждого раунда будут заявлены за неделю до него. Только эти битмапы будут доступными для игры на турнире.
   ...
   2. Также, для каждого раунда будут заготовлены битмапы, предназначенные для игры с модами Double Time, Hard Rock, Hidden и для режима свободных модов.
...
2. Каждый пул будет состоять из пяти брекетов: для игры без модов, для игры с Hidden, для игры c Hard Rock, для игры с Double Time и для игры со свободным выбором модов.
...
7. Битмапы из брекета, предназначенных для игры со свободными модами битмап, будут играться с модами из Hidden, Flashlight, Hard Rock, которые будет выбирать для себя конкретный игрок. Этот игрок может выбрать от нуля до трёх модов включительно.
