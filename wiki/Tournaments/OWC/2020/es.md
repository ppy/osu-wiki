...
![Logo de la OWC 2020](/wiki/shared/news/banners/OWC_2020_banner.jpg)

La **osu! World Cup 2020** (***OWC 2020***) fue un torneo por países organizado por el [osu! team](/wiki/People/osu!_team). Fue la undécima edición de la osu! World Cup.

## Calendario del torneo

| Evento | Marca de tiempo |
| --: | :-- |
| Fase de registro | 24/9/2020 - 8/10/2020 |
...
¡La osu! World Cup 2020 ofreció un pozo de premios de 5000 dólares y mercancía de edición limitada!

| Posición | Premio(s) |
| :-: | :-- |
| ![Corona de oro](/wiki/shared/crown-gold.png "1er lugar") | 50 % del pozo de premios, mercancía exclusiva, una insignia para el perfil, título de usuario «osu! Champion» por un año |
| ![Corona de plata](/wiki/shared/crown-silver.png "2do lugar") | 36 % del pozo de premios, mercancía exclusiva, una insignia para el perfil |
| ![Corona de bronce](/wiki/shared/crown-bronze.png "3er lugar") | 14 % del pozo de premios, mercancía exclusiva, una insignia para el perfil |
...
La osu! World Cup 2020 estuvo a cargo del osu! team y varios miembros de la comunidad.

| Posición | Miembro(s) |
| :-- | :-- |
| Administrador | ::{ flag=AR }:: ::juankristal::{ user-id=443656 }, ::{ flag=CL }:: ::WalterToro::{ user-id=5281416 } |
| Selector de mapas | ::{ flag=AU }:: ::Kano::{ user-id=3036203 }, ::{ flag=AT }:: ::Omgforz::{ user-id=578943 } |
| Probador del mappool | ::{ flag=US }:: ::DigitalHypno::{ user-id=4384207 }, ::{ flag=MA }:: ::FGSky::{ user-id=2094566 }, ::{ flag=US }:: ::idke::{ user-id=4650315 }, ::{ flag=US }:: ::Skill::{ user-id=7802027 }, ::{ flag=US }:: ::UberFazz::{ user-id=8646059 }, ::{ flag=PL }:: ::Zelq::{ user-id=8953955 } |
| Comentarista | ::{ flag=CA }:: ::Azer::{ user-id=2155578 }, ::{ flag=US }:: ::BTMC::{ user-id=3171691 }, ::{ flag=GB }:: ::Bubbleman::{ user-id=5182050 }, ::{ flag=US }:: ::ChillierPear::{ user-id=9501251 }, ::{ flag=US }:: ::Dohland::{ user-id=5220511 }, ::{ flag=GB }:: ::Doomsday::{ user-id=18983 }, ::{ flag=US }:: ::Halfslashed::{ user-id=4598899 }, ::{ flag=AU }:: ::Kano::{ user-id=3036203 }, ::{ flag=AU }:: ::Monk The Don::{ user-id=4012086 }, ::{ flag=US }:: ::Monko2k::{ user-id=4852013 }, ::{ flag=AT }:: ::Omgforz::{ user-id=578943 }, ::{ flag=US }:: ::this1neguy::{ user-id=1797189 }, ::{ flag=KR }:: ::ToGlette::{ user-id=1076236 }, ::{ flag=AU }:: ::Vivace::{ user-id=3698691 }, ::{ flag=US }:: ::Will Stetson::{ user-id=4909088 } |
| Árbitro | ::{ flag=ES }:: ::Deif::{ user-id=318565 }, ::{ flag=AU }:: ::ill onion::{ user-id=8306102 }, ::{ flag=BR }:: ::LeoFLT::{ user-id=3668779 }, ::{ flag=NL }:: ::nik::{ user-id=10077264 }, ::{ flag=DE }:: ::p3n::{ user-id=123703 }, ::{ flag=US }:: ::tigereyes144::{ user-id=6499811 }, ::{ flag=CL }:: ::WalterToro::{ user-id=5281416 }, ::{ flag=GB }:: ::Yazzehh::{ user-id=7068973 } |
| Estadístico | ::{ flag=BR }:: ::LeoFLT::{ user-id=3668779 }, ::{ flag=DE }:: ::Nwolf::{ user-id=1910766 } |

## Enlaces

- [Hilo de discusión](https://osu.ppy.sh/community/forums/topics/1150567)
- [Transmisión en vivo](https://www.twitch.tv/osulive)
- [Challonge de los brackets](https://challonge.com/OWC_2020)
- [Página de Pick'ems](https://pickem.hwc.hr/tournaments/47) alojada por ::{ flag=DE }:: ::hallowatcher::{ user-id=1874761 }
- **[Hoja de estadísticas](https://docs.google.com/spreadsheets/d/e/2PACX-1vRK1VndO4Dng6TJ2yM8dedF7Bkf0b-VvrK2T5US5Y-YkI-fpxZhNanWWJOdTB-2BrW9eu8o62sGm5_G/pubhtml)**

## Participantes

|  | País | Miembros |
| :-: | :-: | :-- |
| ::{ flag=AR }:: | **Argentina** | **::SlowBurn::{ user-id=3608846 }**, [Lexalia](https://osu.ppy.sh/users/1887616), ::Pein::{ user-id=2212941 }, [Penguo](https://osu.ppy.sh/users/4389490), ::Cata::{ user-id=5958063 }, [Emiru Ikuno](https://osu.ppy.sh/users/6169195), ::Amuro::{ user-id=7119659 }, [Emiru Ikuno 2](https://osu.ppy.sh/users/9393446) |
| ::{ flag=AU }:: | **Australia** | **::Jordan The Bear::{ user-id=7477458 }**, [Dumii](https://osu.ppy.sh/users/3068044), ::uyghti::{ user-id=3641404 }, [rairiku](https://osu.ppy.sh/users/4945688), ::-Machine-::{ user-id=5459981 }, [ASecretBox](https://osu.ppy.sh/users/7341183), ::mrekk::{ user-id=7562902 }, [jordanlr7](https://osu.ppy.sh/users/11652827) |
| ::{ flag=AT }:: | **Austria** | **::goosefedora::{ user-id=2323131 }**, [Teppi](https://osu.ppy.sh/users/1371974), ::Kizan::{ user-id=3074197 }, [LWMF](https://osu.ppy.sh/users/3632402), ::Sparkxei::{ user-id=4601608 }, [TiltBoi](https://osu.ppy.sh/users/6311630), ::FeeDyy::{ user-id=8123308 }, [Micca](https://osu.ppy.sh/users/8179335) |
| ::{ flag=BE }:: | **Bélgica** | **::Hanori::{ user-id=7078544 }**, [Fblade](https://osu.ppy.sh/users/3168085), ::\[Sven\]::{ user-id=3695504 }, [MetaBee](https://osu.ppy.sh/users/3706039), ::5joshi::{ user-id=4279650 }, [Mornis](https://osu.ppy.sh/users/6479616), ::KyZzo::{ user-id=9014203 }, [Loriax](https://osu.ppy.sh/users/11331829) |
| ::{ flag=BR }:: | **Brasil** | **::MouseEasy::{ user-id=1558603 }**, [Coreanmaluco](https://osu.ppy.sh/users/3149577), ::Sanjilift::{ user-id=3260571 }, [Tusk](https://osu.ppy.sh/users/4253615), ::Mystia::{ user-id=4277702 }, [xxluizxx47](https://osu.ppy.sh/users/4687701), ::niii\_san::{ user-id=5403374 }, [Dada](https://osu.ppy.sh/users/9119507) |
| ::{ flag=SK }:: | **Eslovaquia** | **::Tikef::{ user-id=9149213 }**, [PeteX](https://osu.ppy.sh/users/1285945), ::MarGenDo::{ user-id=3340086 }, [Hranolka](https://osu.ppy.sh/users/6149947), ::-YoYo-::{ user-id=6158076 }, [PemiX](https://osu.ppy.sh/users/6974470), ::Ezreal156::{ user-id=7358639 }, [SneakY NickY](https://osu.ppy.sh/users/8847379) |
| ::{ flag=KR }:: | **Corea del Sur** | **::Karuna::{ user-id=8775024 }**, [Ponytail](https://osu.ppy.sh/users/1516650), ::Nelitoru::{ user-id=2511839 }, [Nopekjk](https://osu.ppy.sh/users/4585186), ::Zeisen-::{ user-id=7892320 }, [FlyingTuna](https://osu.ppy.sh/users/9224078), ::\[RyuTell\]::{ user-id=9397144 }, [\[Karcher\]](https://osu.ppy.sh/users/11443437) |
| ::{ flag=ES }:: | **España** | **::amborgesa::{ user-id=1968481 }**, [-Shizuru](https://osu.ppy.sh/users/5133150), ::Frosiito::{ user-id=6462387 }, [Margo](https://osu.ppy.sh/users/6995685), ::Kalal331::{ user-id=8433636 }, [-Hideki-](https://osu.ppy.sh/users/8688804), ::NHarmonia::{ user-id=9582556 }, [A N T O N I O](https://osu.ppy.sh/users/12760743) |
| ::{ flag=SE }:: | **Suecia** | **::\[ Coach \]::{ user-id=2854598 }**, [nautzz](https://osu.ppy.sh/users/2012039), ::Felrion::{ user-id=3673083 }, [Saika0k1](https://osu.ppy.sh/users/4316633), ::\[ Blue \]::{ user-id=4859699 }, [Reedkatt](https://osu.ppy.sh/users/8335950), ::Andros::{ user-id=9072586 }, [scylla](https://osu.ppy.sh/users/9405745) |
| ::{ flag=CH }:: | **Suiza** | **::Ayeka::{ user-id=7225922 }**, [Akani](https://osu.ppy.sh/users/2323137), ::Niven::{ user-id=5297955 }, [steini](https://osu.ppy.sh/users/5676259), ::Mytlex::{ user-id=7045024 }, [Sil](https://osu.ppy.sh/users/7924600), ::CeriixZ::{ user-id=9533853 }, [Mizurii 2](https://osu.ppy.sh/users/10394866) |
| ::{ flag=TW }:: | **Taiwán** | **::Shiina Noriko::{ user-id=1285637 }**, [Flask](https://osu.ppy.sh/users/959763), ::Eunha -::{ user-id=1234432 }, [\_Shield](https://osu.ppy.sh/users/1860489), ::GfMRT::{ user-id=3163649 }, [\[ Zane \]](https://osu.ppy.sh/users/3517706), ::Spinesnight::{ user-id=4519494 }, [Rizer](https://osu.ppy.sh/users/5155973) |
| ::{ flag=TH }:: | **Tailandia** | **::Trigonoculus::{ user-id=7627013 }**, [Chorus](https://osu.ppy.sh/users/3504692), ::- Mekumin -::{ user-id=3744339 }, [Ithi](https://osu.ppy.sh/users/4782236), ::Shye::{ user-id=4805243 }, [- Seen -](https://osu.ppy.sh/users/5082392), ::minecrafter::{ user-id=9389213 } |
| ::{ flag=TR }:: | **Turquía** | **::heyronii::{ user-id=5642779 }**, [\[-Shadowa-\]](https://osu.ppy.sh/users/1313327), ::-Kanzaki::{ user-id=1652478 }, [-Kemsyt](https://osu.ppy.sh/users/3170401), ::egemenbsrms::{ user-id=4520477 }, [Mikatsu](https://osu.ppy.sh/users/6612642), ::Raikouhou::{ user-id=8007528 }, [edizberkserbest](https://osu.ppy.sh/users/9256771) |
| ::{ flag=UA }:: | **Ucrania** | **::dench::{ user-id=10073635 }**, [Sadness](https://osu.ppy.sh/users/6560835), ::Ponyawka::{ user-id=6997572 }, [magnatagamer123](https://osu.ppy.sh/users/7587763), ::Kryterion::{ user-id=9920144 }, [Dim0ND](https://osu.ppy.sh/users/10096496), ::1Max::{ user-id=11653711 }, [netwhynot](https://osu.ppy.sh/users/11794209) |
| ::{ flag=GB }:: | **Reino Unido** | **::Bubbleman::{ user-id=5182050 }**, [Doomsday](https://osu.ppy.sh/users/18983), ::Ventus::{ user-id=1986262 }, [Malteser](https://osu.ppy.sh/users/5218178), ::Bloobleman::{ user-id=6778877 }, [Kingling](https://osu.ppy.sh/users/7010761), ::Voss::{ user-id=7657761 }, [majoreh](https://osu.ppy.sh/users/7959222) |
| ::{ flag=US }:: | **Estados Unidos** | **::im a fancy lad::{ user-id=4908650 }**, [Aireu](https://osu.ppy.sh/users/1650010), ::kablaze::{ user-id=3043603 }, [BTMC](https://osu.ppy.sh/users/3171691), ::fieryrage::{ user-id=3533958 }, [Apraxia](https://osu.ppy.sh/users/4194445), ::Vaxei::{ user-id=4787150 }, [SWAGGYSWAGSTER](https://osu.ppy.sh/users/7813296) |
| ::{ flag=UY }:: | **Uruguay** | **::daanit::{ user-id=6159669 }**, [Madozito](https://osu.ppy.sh/users/4054429), ::Saphity::{ user-id=5382216 }, [-PloX](https://osu.ppy.sh/users/6404583), ::Kazuki K::{ user-id=6407282 }, [Rebo](https://osu.ppy.sh/users/6942259), ::FDX::{ user-id=8987016 } |
| ::{ flag=VN }:: | **Vietnam** | **::Tuon::{ user-id=6673790 }**, [Ui chan](https://osu.ppy.sh/users/5449433), ::\_Kuroni\_::{ user-id=6159305 }, [Hoaq](https://osu.ppy.sh/users/7696512), ::Huukun::{ user-id=8114571 }, [FukutoTojido](https://osu.ppy.sh/users/8266808), ::sindes19::{ user-id=11021073 } |

## Podio

![](img/podium.jpg "Podio de la OWC 2020")
...
Las estadísticas de la gran Final se pueden encontrar en [esta hoja de cálculo](https://docs.google.com/spreadsheets/d/1Csyk7zgrDF4iFJvgFRiBniCS6ZsQyXEkndNVUB65Un8/edit?rm=minimal).

Sábado, 5 de diciembre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| Canadá ::{ flag=CA }:: | 0 | **7** | ::{ flag=DE }:: **Alemania** | [#1](https://osu.ppy.sh/community/matches/71028303) |

Domingo, 6 de diciembre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| **Estados Unidos** ::{ flag=US }:: | **7** | 6 | ::{ flag=DE }:: Alemania | [#1](https://osu.ppy.sh/community/matches/71094276) |

### Finales

Las estadísticas de las finales se pueden encontrar en [esta hoja de cálculo](https://docs.google.com/spreadsheets/d/1KV6_iFufp0azzzhcXwbX12hVsImkUY2-ss2Cp-UVU2I/edit?rm=minimal).

Sábado, 28 de noviembre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| **Alemania** ::{ flag=DE }:: | **7** | 3 | ::{ flag=AU }:: Australia | [#1](https://osu.ppy.sh/community/matches/70607012) |
| **Japón** ::{ flag=JP }:: | **7** | 6 | ::{ flag=BR }:: Brasil | [#1](https://osu.ppy.sh/community/matches/70615882) |
| **Estados Unidos** ::{ flag=US }:: | **7** | 1 | ::{ flag=CA }:: Canadá | [#1](https://osu.ppy.sh/community/matches/70645551) |

Domingo, 29 de noviembre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| Japón ::{ flag=JP }:: | 5 | **7** | ::{ flag=DE }:: **Alemania** | [#1](https://osu.ppy.sh/community/matches/70672537) |

### Semifinales

Las estadísticas de las semifinales se pueden encontrar en [esta hoja de cálculo](https://docs.google.com/spreadsheets/d/122QSYVa2tQo9LsSPzUB6jl2jpvpHxuG-6OmrWZ_ZBIk/edit?rm=minimal).
...
| **Corea del Sur** ::{ flag=KR }:: | **6** | 1 | ::{ flag=RU }:: Federación de Rusia | [#1](https://osu.ppy.sh/community/matches/70216160) |
| **Brasil** ::{ flag=BR }:: | **6** | 5 | ::{ flag=TW }:: Taiwán | [#1](https://osu.ppy.sh/community/matches/70220193) |
| **Canadá** ::{ flag=CA }:: | **6** | 3 | ::{ flag=JP }:: Japón | [#1](https://osu.ppy.sh/community/matches/70228660) |
| **Estados Unidos** ::{ flag=US }:: | **6** | 0 | ::{ flag=DE }:: Alemania | [#1](https://osu.ppy.sh/community/matches/70236028) |
...
| Corea del Sur ::{ flag=KR }:: | 0 | **6** | ::{ flag=BR }:: **Brasil** | [#1](https://osu.ppy.sh/community/matches/70279413) |

### Cuartos de final

Las estadísticas de los cuartos de final se pueden encontrar en [esta hoja de cálculo](https://docs.google.com/spreadsheets/d/1M0EikaR4xZr4T-eKapCVReNAazTgE8P1Gjn_CSb4mQw/edit?rm=minimal).

Sábado, 14 de noviembre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| **Australia** ::{ flag=AU }:: | **6** | 0 | ::{ flag=IT }:: Italia | [#1](https://osu.ppy.sh/community/matches/69818788) |
| Rumanía ::{ flag=RO }:: | 4 | **6** | ::{ flag=SG }:: **Singapur** | [#1](https://osu.ppy.sh/community/matches/69820364) |
| **Reino Unido** ::{ flag=GB }:: | **6** | 0 | ::{ flag=PH }:: Filipinas | [#1](https://osu.ppy.sh/community/matches/69823389) |
| **Indonesia** ::{ flag=ID }:: | **6** | 3 | ::{ flag=AR }:: Argentina | [#1](https://osu.ppy.sh/community/matches/69827164) |
| **Federación de Rusia** ::{ flag=RU }:: | **6** | 3 | ::{ flag=MY }:: Malasia | [#1](https://osu.ppy.sh/community/matches/69827447) |
| **Francia** ::{ flag=FR }:: | **6** | 2 | ::{ flag=SE }:: Suecia | [#1](https://osu.ppy.sh/community/matches/69831548) |
| **Taiwán** ::{ flag=TW }:: | **6** | 4 | ::{ flag=CL }:: Chile | [#1](https://osu.ppy.sh/community/matches/69833714) |
| **Polonia** ::{ flag=PL }:: | **6** | 3 | ::{ flag=FI }:: Finlandia | [#1](https://osu.ppy.sh/community/matches/69842272) |
| **Estados Unidos** ::{ flag=US }:: | **6** | 2 | ::{ flag=BR }:: Brasil | [#1](https://osu.ppy.sh/community/matches/69847774) |

Domingo, 15 de noviembre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| **Canadá** ::{ flag=CA }:: | **6** | 2 | ::{ flag=HK }:: Hong Kong | [#1](https://osu.ppy.sh/community/matches/69868194) |
| **Australia** ::{ flag=AU }:: | **6** | 1 | ::{ flag=SG }:: Singapur | [#1](https://osu.ppy.sh/community/matches/69878384) |
| **Alemania** ::{ flag=DE }:: | **6** | 4 | ::{ flag=KR }:: Corea del Sur | [#1](https://osu.ppy.sh/community/matches/69883774) |
| China ::{ flag=CN }:: | 1 | **6** | ::{ flag=JP }:: **Japón** | [#1](https://osu.ppy.sh/community/matches/69885050) |
| Reino Unido ::{ flag=GB }:: | 4 | **6** | ::{ flag=ID }:: **Indonesia** | [#1](https://osu.ppy.sh/community/matches/69884934) |
| Francia ::{ flag=FR }:: | 3 | **6** | ::{ flag=TW }:: **Taiwán** | [#1](https://osu.ppy.sh/community/matches/69887968) |
| **Federación de Rusia** ::{ flag=RU }:: | **6** | 2 | ::{ flag=PL }:: Polonia | [#1](https://osu.ppy.sh/community/matches/69891597) |

### Octavos de final

Las estadísticas de los octavos de final se pueden encontrar en [esta hoja de cálculo](https://docs.google.com/spreadsheets/d/1b1iHKwiq-b3BD3XtSbtRfzp2Z4VbbsE6k4fnrphei-Y/edit?rm=minimal).

Sábado, 7 de noviembre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| **Corea del Sur** ::{ flag=KR }:: | **5** | 2 | ::{ flag=GB }:: Reino Unido | [#1](https://osu.ppy.sh/community/matches/69440920) |
| Federación de Rusia ::{ flag=RU }:: | 0 | **5** | ::{ flag=JP }:: **Japón** | [#1](https://osu.ppy.sh/community/matches/69443152) |
| **Filipinas** ::{ flag=PH }:: | **5** | 1 | ::{ flag=NL }:: Países Bajos | [#1](https://osu.ppy.sh/community/matches/69443155) |
| Ucrania ::{ flag=UA }:: | 1 | **5** | ::{ flag=CL }:: **Chile** | [#1](https://osu.ppy.sh/community/matches/69451875) |
| **Canadá** ::{ flag=CA }:: | **5** | 4 | ::{ flag=TW }:: Taiwán | [#1](https://osu.ppy.sh/community/matches/69454898) |
| Estonia ::{ flag=EE }:: | 2 | **5** | ::{ flag=AR }:: **Argentina** | [#1](https://osu.ppy.sh/community/matches/69458436) |
| **Estados Unidos** ::{ flag=US }:: | **5** | 1 | ::{ flag=RO }:: Rumanía | [#1](https://osu.ppy.sh/community/matches/69461948) |
| Israel ::{ flag=IL }:: | 3 | **5** | ::{ flag=FI }:: **Finlandia** | [#1](https://osu.ppy.sh/community/matches/69462590) |

Domingo, 8 de noviembre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| Australia ::{ flag=AU }:: | 3 | **5** | ::{ flag=BR }:: **Brasil** | [#1](https://osu.ppy.sh/community/matches/69483825) |
| México ::{ flag=MX }:: | 0 | **5** | ::{ flag=SG }:: **Singapur** | [#1](https://osu.ppy.sh/community/matches/69488231) |
| Francia ::{ flag=FR }:: | 1 | **5** | ::{ flag=HK }:: **Hong Kong** | [#1](https://osu.ppy.sh/community/matches/69504281) |
| **Alemania** ::{ flag=DE }:: | **5** | 4 | ::{ flag=ID }:: Indonesia | [#1](https://osu.ppy.sh/community/matches/69503931) |
| Polonia ::{ flag=PL }:: | 1 | **5** | ::{ flag=CN }:: **China** | [#1](https://osu.ppy.sh/community/matches/69506960) |
| **Malasia** ::{ flag=MY }:: | **5** | 3 | ::{ flag=NO }:: Noruega | [#1](https://osu.ppy.sh/community/matches/69506899) |
| Austria ::{ flag=AT }:: | 0 | **5** | ::{ flag=IT }:: **Italia** | [#1](https://osu.ppy.sh/community/matches/69509429) |
| Turquía ::{ flag=TR }:: | 1 | **5** | ::{ flag=SE }:: **Suecia** | [#1](https://osu.ppy.sh/community/matches/69511841) |

### Dieciseisavos de final

Las estadísticas de los dieciseisavos de final se pueden encontrar en [esta hoja de cálculo](https://docs.google.com/spreadsheets/d/1Kj0Y1ycdQjPPGIBNUvJqnEi4U5UlBvJPhkXQbsmTYLg/edit?rm=minimal).

Sábado, 31 de octubre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| **Canadá** ::{ flag=CA }:: | **5** | 0 | ::{ flag=PH }:: Filipinas | [#1](https://osu.ppy.sh/community/matches/69063884) |
| **Corea del Sur** ::{ flag=KR }:: | **5** | 4 | ::{ flag=UA }:: Ucrania | [#1](https://osu.ppy.sh/community/matches/69076593) |
| **Australia** ::{ flag=AU }:: | **5** | 0 | ::{ flag=IL }:: Israel | [#1](https://osu.ppy.sh/community/matches/69076650) |
| **Taiwán** ::{ flag=TW }:: | **5** | 2 | ::{ flag=NL }:: Países Bajos | [#1](https://osu.ppy.sh/community/matches/69078444) |
| Suecia ::{ flag=SE }:: | 1 | **5** | ::{ flag=ID }:: **Indonesia** | [#1](https://osu.ppy.sh/community/matches/69080547) |
| **Hong Kong** ::{ flag=HK }:: | **5** | 1 | ::{ flag=AR }:: Argentina | [#1](https://osu.ppy.sh/community/matches/69081600) |
| **Japón** ::{ flag=JP }:: | **5** | 1 | ::{ flag=SG }:: Singapur | [#1](https://osu.ppy.sh/community/matches/69082852) |
| **Polonia** ::{ flag=PL }:: | **5** | 0 | ::{ flag=AT }:: Austria | [#1](https://osu.ppy.sh/community/matches/69085337) |
| **Francia** ::{ flag=FR }:: | **5** | 1 | ::{ flag=EE }:: Estonia | [#1](https://osu.ppy.sh/community/matches/69088199) |
| **Federación de Rusia** ::{ flag=RU }:: | **5** | 0 | ::{ flag=MX }:: México | [#1](https://osu.ppy.sh/community/matches/69090928) |
| **Brasil** ::{ flag=BR }:: | **5** | 0 | ::{ flag=FI }:: Finlandia | [#1](https://osu.ppy.sh/community/matches/69093855) |

Domingo, 1 de noviembre de 2020:

| Equipo 1 |  |  | Equipo 2 | Enlance del partido |
| --: | :-: | :-: | :-- | :-- |
| **Estados Unidos** ::{ flag=US }:: | **5** | 1 | ::{ flag=MY }:: Malasia | [#1](https://osu.ppy.sh/community/matches/69116338) |
| **China** ::{ flag=CN }:: | **5** | 2 | ::{ flag=IT }:: Italia | [#1](https://osu.ppy.sh/community/matches/69136884) |
| **Reino Unido** ::{ flag=GB }:: | **5** | 2 | ::{ flag=CL }:: Chile | [#1](https://osu.ppy.sh/community/matches/69136893) |
| **Rumanía** ::{ flag=RO }:: | **5** | 4 | ::{ flag=NO }:: Noruega | [#1](https://osu.ppy.sh/community/matches/69141778) |
| **Alemania** ::{ flag=DE }:: | **5** | 0 | ::{ flag=TR }:: Turquía | [#1](https://osu.ppy.sh/community/matches/69146008) |

### Clasificatorias

Las estadísticas de las clasificatorias se pueden encontrar en [esta hoja de cálculo](https://docs.google.com/spreadsheets/d/1BtrSLxDKdwPKXjIgbOkeojD0W80MAdH5ady__RIWj3Y/edit?&rm=minimal).
...
1. Un árbitro creará una sala multijugador con 15 minutos de antelación. Los jugadores deben reunirse durante este periodo.
   - La configuración de la sala es osu!, Team-Vs., Condición de victoria: 'Score V2'. El nombre de la sala debe ser «OWC 2020: (TeamRed) vs (TeamBlue)».
...
5. Los equipos tendrán 2 minutos para elegir un beatmap y 2 minutos para prepararse.
   - En caso de que un equipo tarde más de 2 minutos en elegir un mapa, recibirán una advertencia del árbitro, en ocurrencias posteriores, el árbitro elegirá un mapa aleatorio disponible para elegir del mappool usando `!roll X`, donde X es el número de mapas disponibles para elegir en el mappool.
   - Cada equipo recibirá un «tiempo muerto táctico» de **dos minutos**, que se puede usar en cualquier momento durante la selección de mapas de su equipo, **una vez por partido**. *El tiempo muerto táctico es opcional y no se requiere su uso*.
...
5. **El mod NoFail será forzado en cada mapa.**
