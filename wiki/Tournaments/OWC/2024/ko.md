...
**osu! 월드컵 2024** (***OWC 2024***)는 [osu! 팀](/wiki/People/osu!_team)이 주최한 국가 기반 토너먼트입니다. 이것은 15번째 osu! 월드컵이기도 합니다.
...
| 퀄리파이어 맵풀 쇼케이스 | 2024-10-20 (14:00 UTC) |
...
- **[등록은 여기에서 가능합니다.](https://osu.ppy.sh/community/tournaments/47)**
...
2. 임시 캡틴은 해당 국가의 후보 중 선수를 선택하여 팀을 구성하게 됩니다.
   ...
   - **10월 18일 23:59 UTC까지 팀 목록을 보내지 않는 팀은 대회에서 실격됩니다.**
...
2. 32강과 16강에선 **한 개의 비트맵**을 밴하게 되며, 쿼터파이널부터 **두 개의 비트맵**으로 늘어나게 됩니다. 각 팀은  No Mod를 제외한 같은 모드를 2개 이상 밴할 수 없습니다. 해당 비트맵은 경기가 진행되는 동안 어느 팀에서도 선택할 수 없습니다.
 - "더블밴"(2개 이상의 동일한 모드 맵풀을 연속적으로 밴하는 것을 의미합니다)은 허용됩니다.
...
7. 각 팀은 밴/픽/준비 시간에 2분의 추가시간이 부여되는 타임아웃을 한번 사용할 수 있습니다.  *타임아웃은 선택 사항입니다.*
   - 타이브레이커에서의 타임아웃은 팀이 사용가능한 횟수와 관계없이 **한번만** 요청할 수 있으며, 양 팀의 캡틴이 동의해야 합니다.
...
- 요청시 다른 시간도 가능하며 자세한 내용은 토너먼트 매니저에게 연락해 주세요.
