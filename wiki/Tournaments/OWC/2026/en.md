...
![OWC 2026 banner](img/owc2026-banner.jpg)

The **osu! World Cup 2026** (***OWC 2026***) is a country-based osu! tournament hosted by the [osu! team](/wiki/People/osu!_team). It is the seventeenth instalment of the osu! World Cup.

## Tournament schedule

| Event | Timestamp |
| --: | :-- |
| Registration phase | 2026-09-26 (00:00 UTC)/2026-10-10 (23:59 UTC) |
| Qualifier showcase | 2026-10-18 (17:00 UTC) |
| Qualifier stage | 2026-10-24/2026-10-25 |
| Group Stage | 2026-10-31/2026-11-08 |
| Round of 16 | 2026-11-14/2026-11-15 |
| Quarterfinals | 2026-11-21/2026-11-22 |
| Semifinals | 2026-11-28/2026-11-29 |
| Finals | 2026-12-05/2026-12-06 |
| Grand Finals | 2026-12-12/2026-12-13 |

*Note: The Group stage runs for two weeks.*

## Prizes

The osu! World Cup 2026 offers a $10,000 cash prize pool and limited-edition merch.
...
The osu! World Cup 2026 is run by the [osu! team](/wiki/People/osu!_team) and various community members.
...
| Mappool helper | ::{ flag=JP }:: [arthRo](https://osu.ppy.sh/users/21663721), ::{ flag=BR }:: [Blue Dragon](https://osu.ppy.sh/users/19048), ::{ flag=HK }:: [Chaoslitz](https://osu.ppy.sh/users/3621552), ::{ flag=CA }:: [D I O](https://osu.ppy.sh/users/3958619), ::{ flag=CA }:: [Deca](https://osu.ppy.sh/users/9088487), ::{ flag=GB }:: [DeviousPanda](https://osu.ppy.sh/users/4966334), ::{ flag=CA }:: [El Condor Pasa](https://osu.ppy.sh/users/4415285), ::{ flag=PH }:: [enri](https://osu.ppy.sh/users/8640970), ::{ flag=PH }:: [milktea0019](https://osu.ppy.sh/users/9642774), ::{ flag=RU }:: [netnesanya](https://osu.ppy.sh/users/6017901), ::{ flag=HK }:: [Petal](https://osu.ppy.sh/users/7354729), ::{ flag=US }:: [revoh](https://osu.ppy.sh/users/8165181), ::{ flag=CA }:: [Serenhaide](https://osu.ppy.sh/users/10466315), ::{ flag=HK }:: [seros](https://osu.ppy.sh/users/10562853), ::{ flag=US }:: [toybot](https://osu.ppy.sh/users/2848604) |
| Mappool playtester | *TBA* |
| Mapper | *TBA* |
| Spread contributors | **::{ flag=US }:: [Cytusine](https://osu.ppy.sh/users/11557554)**, *more TBA* |
| Commentator | *TBA* |
...
1. Every user interested in joining their country's team signs up individually.
   ...
   - The provisional captain will receive a private message on the osu! website containing further instructions via the announcement feature, titled "osu! World Cup 2026 - Team {Country Name}".
2. The provisional captain will then form their team by selecting players from the candidate pool for their country.
   ...
   - **Teams that do not send their team list by October 17, 23:59 UTC will be disqualified from the competition.**
...
- In the Group stage, teams need to win 5 maps to win a match (best of 9).
- In the Round of 16, Quarterfinals and Semifinals, teams need to win 6 maps to win a match (best of 11).
...
1. A referee will create a multiplayer room 10 minutes before the scheduled match time. Teams must join the lobby in that period.
   - The room settings are `Game mode: "osu!"`, `Team mode: "Team Vs"` and `Score mode: "ScoreV2"`. The room name must follow the pattern of `OWC2026: ({Red Team}) VS ({Blue Team})`. The team mentioned first in the room name must be the red team, the team mentioned second in the room name must be the blue team.
2. Each team may ban **one beatmap** to be selected from the pool in the Group stage, increased to **two beatmaps** from Round of 16 onwards. These beatmaps may not be picked by any team for the entire duration of the match.
...
3. The mappool sizes are as follows:
   ...
   - Round of 16, Quarterfinals, Semifinals, Finals, and Grand Finals: 20 beatmaps
...
2. Matches in the Qualifiers will be held during specific time slots proposed by the tournament managers. Each team may choose a time slot in which they want to play.
   - **Teams that do not pick a time slot by October 22, 23:59 UTC will be considered disqualified.**
