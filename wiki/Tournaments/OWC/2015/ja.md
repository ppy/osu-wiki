...
| Event | Timestamp |
| :-- | :-- |
| 登録期間 | 2015-10-01/2015-10-18 |
| チーム選定 | 2015-11-01 (14:00 UTC) |
| グループステージ | 2015-11-07/2015-11-08 |
| ベスト16決定 | 2015-11-15 |
| 準々決勝 | 2015-11-21/2015-11-22 |
| 準決勝 | 2015-11-28/2015-11-29 |
| 決勝- Week 1 | 2015-12-05/2015-12-06 |
| 決勝 - Week 2 | 2015-12-13 |

## 賞品

| 順位 | 賞品 |
| :-- | :-- |
| ![ゴールドクラウン](/wiki/shared/crown-gold.png "1位") | 集められた賞金プールの50%、ユニークプロフィールバッジ、「osu! Champion」のユーザータイトル |
| ![シルバークラウン](/wiki/shared/crown-silver.png "2位") | 集められた賞金プールの38％、ユニークプロフィールバッジ |
| ![ブロンズクラウン](/wiki/shared/crown-bronze.png "3位") | 集められた賞金プールの12％、ユニークプロフィールバッジ |

## 組織

osu! World Cup 2015は、様々なコミュニティのメンバーによって運営されました。

| 役職 | メンバー |
| :-- | :-- |
| マネージャー | ::{ flag=ES }:: ::Deif::{ user-id=318565 }、::{ flag=DE }:: ::Loctav::{ user-id=71366 }、::{ flag=DE }:: ::p3n::{ user-id=123703 }、::{ flag=FR }:: ::shARPII::{ user-id=776257 } |
| マッププール選択者 | ::{ flag=FR }:: ::Cherry Blossom::{ user-id=1156742 }、::{ flag=HK }:: ::Skystar::{ user-id=873961 }、::{ flag=KR }:: ::ToGlette::{ user-id=1076236 } |
| 配信 | ::{ flag=DE }:: ::Loctav::{ user-id=71366 }、::{ flag=PL }:: ::Marcin::{ user-id=722665 } |
| コメンテーター | ::{ flag=US }:: ::Chippy::{ user-id=2314115 }、::{ flag=NZ }:: ::deadbeat::{ user-id=128370 }、::{ flag=GB }:: ::Doomsday::{ user-id=18983 }、::{ flag=AR }:: ::juankristal::{ user-id=443656 }、::{ flag=GB }:: ::Raiku::{ user-id=1525538 }、::{ flag=US }:: ::rfandomization::{ user-id=3716999 }、::{ flag=US }:: ::Zak::{ user-id=1375955 }、::{ flag=US }:: ::ztrot::{ user-id=6347 } |
| 統計 | ::{ flag=PL }:: ::Marcin::{ user-id=722665 } |
...
|  | 国 | メンバー |
| :-: | :-: | :-- |
| ::{ flag=AR }:: | **アルゼンチン** | **::GaTu::{ user-id=3583351 }**, [benjacala](https://osu.ppy.sh/users/1625740), ::chucentry::{ user-id=2498731 }, [Dreamcast](https://osu.ppy.sh/users/1565577), ::Enhu::{ user-id=2840499 }, [Fr0th](https://osu.ppy.sh/users/3458870), ::Graphite Edge::{ user-id=825712 }, [Peingod](https://osu.ppy.sh/users/2212941) |
| ::{ flag=AU }:: | **オーストラリア** | **::Bauxe::{ user-id=1881685 }**, [\[ ZhengS \]](https://osu.ppy.sh/users/2671317), ::Aloha::{ user-id=792176 }, [Hexicate](https://osu.ppy.sh/users/2171562), ::JappyBabes::{ user-id=697783 }, [Jaybladezz](https://osu.ppy.sh/users/3725492), ::Meowt3dCheeze::{ user-id=634837 }, [Tokichii](https://osu.ppy.sh/users/557197) |
| ::{ flag=IT }:: | **イタリア** | **::xiAmME::{ user-id=1428960 }**, [- Croma -](https://osu.ppy.sh/users/1752181), ::DT-sama::{ user-id=3525018 }, [Gian](https://osu.ppy.sh/users/2105981), ::Kirin::{ user-id=1852356 }, [LLoyd-chan](https://osu.ppy.sh/users/2849149), ::Nemis::{ user-id=1635091 }, [umii](https://osu.ppy.sh/users/2538695) |
...
| ::{ flag=LV }:: | **ラトビア** | **::LoGo::{ user-id=750382 }**, [Edijs](https://osu.ppy.sh/users/2799835), ::Emula::{ user-id=2891792 }, [Forseen](https://osu.ppy.sh/users/556012), ::Jesus\[Krists\]::{ user-id=2842992 }, [Vmx](https://osu.ppy.sh/users/967501), ::xoho::{ user-id=3647897 } |
| ::{ flag=LT }:: | **リトアニア** | **::QonQuest::{ user-id=988503 }**, [Auji](https://osu.ppy.sh/users/4114438), ::Azerite::{ user-id=2562987 }, [Mazzerin](https://osu.ppy.sh/users/2942381), ::Midget::{ user-id=4141635 }, [PainSinger](https://osu.ppy.sh/users/697843), ::Shelbis::{ user-id=2639159 }, [Zinkon](https://osu.ppy.sh/users/85043) |
| ::{ flag=MY }:: | **マレーシア** | **::ClawViper::{ user-id=2681361 }**, [Amane-](https://osu.ppy.sh/users/2276847), ::caleb123456::{ user-id=2205376 }, [Ex6TenZ](https://osu.ppy.sh/users/2676512), ::Gon::{ user-id=583765 }, [Rampax](https://osu.ppy.sh/users/3995630), ::Rumia-::{ user-id=1787171 }, [xsrsbsns](https://osu.ppy.sh/users/414427) |
| ::{ flag=MX }:: | **メキシコ** | **::Broodich::{ user-id=2484629 }**, [Atheneon](https://osu.ppy.sh/users/2164627), ::Atsuro::{ user-id=2279351 }, [Eiikon](https://osu.ppy.sh/users/2553519), ::Id\_Beat::{ user-id=3431380 }, [KevEz](https://osu.ppy.sh/users/2271558), ::lndex::{ user-id=2038320 }, [Psycopath-](https://osu.ppy.sh/users/3233957) |
| ::{ flag=NL }:: | **オランダ** | **::taku::{ user-id=684433 }**, [Chidori](https://osu.ppy.sh/users/525856"), ::HappyStick::{ user-id=256802 }, [jackylam5](https://osu.ppy.sh/users/1540807), ::Kyshiro::{ user-id=640611 }, [Menthuthuyoupi](https://osu.ppy.sh/users/2715937), ::Pittigbaasje::{ user-id=2167433 }, [Synchrostar](https://osu.ppy.sh/users/419705) |
| ::{ flag=NZ }:: | **ニュージーランド** | **::shortpotato::{ user-id=1266102 }**, [\[ Pustules \]](https://osu.ppy.sh/users/2419478), ::a loli::{ user-id=1488796 }, [Grimacee](https://osu.ppy.sh/users/2352484), ::kiyumi::{ user-id=3701898 }, [momochan](https://osu.ppy.sh/users/4827310), ::Tang::{ user-id=2162609 }, [yellowy246](https://osu.ppy.sh/users/3833980) |
| ::{ flag=NO }:: | **ノルウェー** | **::Tobi::{ user-id=2970667 }**, [CXu](https://osu.ppy.sh/users/84841), ::-GN::{ user-id=895581 }, [HundurThePanda](https://osu.ppy.sh/users/3145033), ::Liqh::{ user-id=3409838 }, [-PC](https://osu.ppy.sh/users/2916414), ::Sebu::{ user-id=3990173 }, [warrock](https://osu.ppy.sh/users/2841744) |
...
| ::{ flag=TH }:: | **タイ** | **::FrostxE::{ user-id=199669 }**, [- Phantasma -](https://osu.ppy.sh/users/1427407), ::bossm::{ user-id=654123 }, [Mikkuri](https://osu.ppy.sh/users/317494), ::NonxE::{ user-id=319312 }, [Romantic](https://osu.ppy.sh/users/1592894) |
| ::{ flag=UA }:: | **ウクライナ** | **::Aka::{ user-id=1307553 }**, [blednak](https://osu.ppy.sh/users/912627), ::FllareA::{ user-id=1163931 }, [Granje](https://osu.ppy.sh/users/496387), ::-Ranndom-::{ user-id=5022536 }, [wasisdasS](https://osu.ppy.sh/users/1999698), ::Yoru-hide::{ user-id=791121 } |
| ::{ flag=GB }:: | **イギリス** | **::jesus1412::{ user-id=230116 }**, [Bubbleman](https://osu.ppy.sh/users/5182050), ::Doomsday::{ user-id=18983 }, [Raiku](https://osu.ppy.sh/users/1525538), ::Run-Cat::{ user-id=4361729 }, [Tasty Beverage](https://osu.ppy.sh/users/960620), ::Xim::{ user-id=2083664 } |
| ::{ flag=US }:: | **アメリカ合衆国** | **::Xilver::{ user-id=3099689 }**, [\[Toy\]](https://osu.ppy.sh/users/2757689), ::0120::{ user-id=1901534 }, [Axarious](https://osu.ppy.sh/users/2614511), ::Natalia::{ user-id=2162669 }, [Ritzeh](https://osu.ppy.sh/users/1028387), ::Seouless::{ user-id=3328676 }, [Zodiaack](https://osu.ppy.sh/users/3096229) |

## グループ

| グループ | トップシード | ハイシード | ミッドシード | ローシード |
| :-: | :-- | :-- | :-- | :-- |
| **A** | ::{ flag=US }:: アメリカ合衆国 | ::{ flag=AU }:: オーストラリア | ::{ flag=MY }:: マレーシア | ::{ flag=MX }:: メキシコ |
| **B** | ::{ flag=FR }:: フランス | ::{ flag=HK }:: 香港 | ::{ flag=LT }:: リトアニア | ::{ flag=IT }:: イタリア |
| **C** | ::{ flag=PL }:: ポーランド | ::{ flag=CA }:: カナダ | ::{ flag=LV }:: ラトビア | ::{ flag=UA }:: ウクライナ |
| **D** | ::{ flag=CN }:: 中国 | ::{ flag=GB }:: イギリス | ::{ flag=JP }:: 日本 | ::{ flag=PH }:: フィリピン |
| **E** | ::{ flag=KR }:: 韓国 | ::{ flag=FI }:: フィンランド | ::{ flag=AR }:: アルゼンチン | ::{ flag=NZ }:: ニュージーランド |
| **F** | ::{ flag=RU }:: ロシア連邦 | ::{ flag=BR }:: ブラジル | ::{ flag=NO }:: ノルウェー | ::{ flag=GR }:: ギリシャ |
| **G** | ::{ flag=DE }:: ドイツ | ::{ flag=NL }:: オランダ | ::{ flag=TH }:: タイ | ::{ flag=SG }:: シンガポール |
| **H** | ::{ flag=TW }:: 台湾 | ::{ flag=AT }:: オーストリア | ::{ flag=SE }:: スウェーデン | ::{ flag=PT }:: ポルトガル |
...
7. [Visual Settings](/wiki/Client/Interface/Visual_settings)を選択することができます。
8. 引き分けの場合は、その試合は無効になります
9. プレイヤーが回線切れになった場合、failしたとして扱われます。
   1. ビートマップが始まってから30秒以内に回線が切れた場合は、再度試合をしますが、これは審判の判断によります。
10. ゲームが無効にならない限り、同じビートマップを使うことは出来ません。
11. 必要最低限のプレイヤーが揃わない場合、延長できる試合までの時間は最大で10分です。
12. 試合中の選手交代は可能です。
13. ラグはビートマップを無効にする理由にはなり得ません。
...
17. 反則行為で試合を邪魔すること、不適切なウォームアップ用ビートマップ (下記参照)の選択、他のプレイヤーや審判を侮辱・挑発すること、試合への遅刻、その他故意と思われる不適切な行いは厳しく禁止します。
18. マルチプレイヤーチャットルームは、[osu!コミュニティルール](/wiki/Rules)に基づいています。全てのチャットルールはマルチプレイヤーチャットルームにも適用されます。
...
2. 正当で真剣な登録を保証するため、各登録ユーザーは大会運営者にチェックされます。
   ...
   3. 候補者リストに載るためには、これまでの12ヶ月間、 [osu!コミュニティルール](/wiki/Rules) を破っていないことが求められます。
3. 問題なく編成されたチームは全て登録段階後に発表されます。
4. 除外されたプレイヤーで、その決定に意義がある場合は、[tournaments@ppy.sh](mailto:tournaments@ppy.sh)に申し出てください。
5. ビートマップ選択者はプレイヤーとして大会に参加できません。

### ステージ説明

1. 1st ステージ(グループステージ)では、8グループに分けられ、1グループは4チームとなります。
2. それぞれのグループ内の全てのチームはグループ内全てのチームと総当たりします。
3. 各グループの順位は各チームの戦績を以下の優先順位に並べ替えて決定します。
   - 勝利した試合数が多い。
   - `(勝利したマップ数)-(敗北したマップ数)}`が多い。
   - 獲得したマップ数が多い。
   - `∑{(総得点差)/(最大得点)}`が高い。
   - 再戦の勝者。
4. 各グループのトップ2チームはダブルエリミネーション・ステージに進出します。
5. ダブルエリミネーション・ステージでは、勝者は次のステージに、敗者は敗者枠に移動されます。
6. [この図](/wiki/shared/stages-visual.png)に従い、ステージは下記のように分けられます。
...
7. **勝利条件:**
   ...
   - ベスト16決定ステージそして準々決勝で勝利するには、5つのビートマップで勝利しなければいけません。(Best of 9)
   - 準決勝そして決勝のWeek 1で勝利するには、6つのビートマップで勝利しなければいけません。(Best of 11)
   - 決勝のWeek 2では、7つのビートマップで勝利しなければいけません。 (Best of 13)

### 試合の説明

1. 審判が試合15分前にマルチルームを作成します。プレイヤーはこの段階で集まってください。
   1. 部屋の設定は：osu!、Team-Vs、勝敗条件:Scoreです。部屋の名前は、"OWC 2015: TeamBlue vs TeamRed" です。(**後から変更される可能性があります。**)
   2. 部屋の名前で先に名前が書かれているチームが青チーム、次に書かれているチームが赤チームです。
2. プレイヤーは自由に2つウォーミングアップビートマップを選んでください。疑わしい内容のあるビートマップを使うことは禁止されています。言語に関わらず、冒涜的、裸体、暴力的その他不適切な内容の映像や曲の使用を禁止します。
...
8. 同点決勝ビートマップはModの条件でプレイされます。
   1. 同点決勝ビートマップをプレイする際は、誰もModをつけなくても構いません。
