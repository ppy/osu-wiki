...
| Puesto | Premios |
| :-- | :-- |
| ![Corona de oro](/wiki/shared/crown-gold.png "Primer puesto") | 6 meses de osu!supporter, insignia de perfil única, título de usuario «Taiko Champion» durante un año, mercancía de osu! |
...
La osu! Taiko World Cup 2015 fue dirigida por varios miembros de la comunidad.

| Posición | Miembros |
| :-- | :-- |
| Gerente | ::{ flag=ES }:: ::Deif::{ user-id=318565 }, ::{ flag=DE }:: ::Loctav::{ user-id=71366 }, ::{ flag=DE }:: ::p3n::{ user-id=123703 } |
| Selector de la mappool | ::{ flag=DE }:: ::OnosakiHito::{ user-id=290128 } |
| Streamer | ::{ flag=PL }:: ::Marcin::{ user-id=722665 }, ::{ flag=AU }:: ::peppy::{ user-id=2 }, ::{ flag=FR }:: ::shARPII::{ user-id=776257 } |
| Comentarista | ::{ flag=FR }:: ::Mr Color::{ user-id=116078 }, ::{ flag=US }:: ::ztrot::{ user-id=6347 } |
...
| ::{ flag=CA }:: | **Canadá** | **::Tasha::{ user-id=1031958 }**, [Fudgyking](https://osu.ppy.sh/users/3802922), ::IControl::{ user-id=2307285 }, [Ilfri-chan](https://osu.ppy.sh/users/2518210), ::janitoreihil::{ user-id=3307897 }, [Wheelcakes](https://osu.ppy.sh/users/3513722) |
...
| ::{ flag=DK }:: | **Dinamarca** | **::Zheant::{ user-id=708656 }**, [Broder](https://osu.ppy.sh/users/2507101), ::Only1Magma::{ user-id=3922957 }, [TraxieChan](https://osu.ppy.sh/users/455552) |
| ::{ flag=FI }:: | **Finlandia** | **::DarkSylarn::{ user-id=4266840 }**, [Pelaaja\_X](https://osu.ppy.sh/users/3543051), ::zheep::{ user-id=1889827 } |
| ::{ flag=FR }:: | **Francia** | **::Nashmun::{ user-id=49031 }**, [\_Gezo\_](https://osu.ppy.sh/users/481582), ::Fraolinch::{ user-id=205257 }, [Jinyan](https://osu.ppy.sh/users/669531), ::omegaflo::{ user-id=83291 }, [TimmyAkmed](https://osu.ppy.sh/users/1799973) |
| ::{ flag=DE }:: | **Alemania** | **::Luna::{ user-id=588007 }**, [\[TaikoSlaxi\]](https://osu.ppy.sh/users/1365973), ::\[TaikoTori\]::{ user-id=1074143 }, [DarkDunskin](https://osu.ppy.sh/users/98985), ::Mew104::{ user-id=2345156 }, [tiamus](https://osu.ppy.sh/users/515277) |
...
| ::{ flag=HU }:: | **Hungría** | **::\_verto\_::{ user-id=2015300 }**, [-Arp-](https://osu.ppy.sh/users/3027305), ::lussy\_6::{ user-id=226128 } |
...
| ::{ flag=IT }:: | **Italia** | **::Ikkun::{ user-id=1059945 }**, [DuBisk](https://osu.ppy.sh/users/3371035), ::Earine::{ user-id=2485549 }, [Jey](https://osu.ppy.sh/users/2480153), ::LinkerWTF::{ user-id=1407595 }, [Morshu](https://osu.ppy.sh/users/166169) |
| ::{ flag=JP }:: | **Japón** | **::sobatsuyu100::{ user-id=2076374 }**, [1RoHa\_](https://osu.ppy.sh/users/4632503), ::cagalin::{ user-id=2586173 }, [coDMo2ooo](https://osu.ppy.sh/users/3644233), ::Rydan72261::{ user-id=5309575 }, [tasuke912](https://osu.ppy.sh/users/2774767) |
| ::{ flag=NO }:: | **Noruega** | **::agu::{ user-id=1109122 }**, [K i u i](https://osu.ppy.sh/users/1794766), ::Yukizo::{ user-id=2345079 } |
| ::{ flag=PH }:: | **Filipinas** | **::senkai::{ user-id=1150178 }**, [Alkaeid](https://osu.ppy.sh/users/567322), ::Primrea::{ user-id=943743 }, [Rumovik](https://osu.ppy.sh/users/3831514) |
| ::{ flag=PL }:: | **Polonia** | **::Acrith::{ user-id=389880 }**, [DarkStoorM](https://osu.ppy.sh/users/174347), ::Dess1210::{ user-id=295855 }, [Elfie](https://osu.ppy.sh/users/1676016), ::-Jamu-::{ user-id=2271556 }, [Karryu](https://osu.ppy.sh/users/3402967) |
| ::{ flag=SG }:: | **Singapur** | **::taikoplayer123::{ user-id=3580055 }**, [SilverSufuru](https://osu.ppy.sh/users/3769280), ::xKwan::{ user-id=403397 } |
| ::{ flag=KR }:: | **Corea del Sur** | **::bbj0920::{ user-id=87546 }**, [Lunaris Filia](https://osu.ppy.sh/users/1807472), ::L y s::{ user-id=211825 }, [Runa](https://osu.ppy.sh/users/4643294), ::SweetBloodyLove::{ user-id=139827 } |
| ::{ flag=ES }:: | **España** | **::Hanjamon::{ user-id=1703330 }**, [AlexGc96](https://osu.ppy.sh/users/1130179), ::CARRI::{ user-id=854536 }, [MYRKUL](https://osu.ppy.sh/users/255933), ::taigoplayers::{ user-id=3687287 } |
| ::{ flag=SE }:: | **Suecia** | **::Bnyuu::{ user-id=2290294 }**, [boat](https://osu.ppy.sh/users/276074), ::Tanaka::{ user-id=1897905 }, [WilleGO97](https://osu.ppy.sh/users/3880756) |
| ::{ flag=TW }:: | **Taiwán** | **::-\[ ix Ishida xi \]-::{ user-id=242910 }**, [howar5041](https://osu.ppy.sh/users/584411), ::jordan\_sur::{ user-id=2960947 }, [mliencheng](https://osu.ppy.sh/users/586659), ::monkeydluffy3u4::{ user-id=2277798 }, [zx\_baka\_0502442](https://osu.ppy.sh/users/457766) |
| ::{ flag=UA }:: | **Ucrania** | **::Anny::{ user-id=249094 }**, [Aka](https://osu.ppy.sh/users/1307553), ::gavnono::{ user-id=1625581 } |
| ::{ flag=US }:: | **Estados Unidos** | **::Two Fruit Cakes::{ user-id=437259 }**, [FLANKs](https://osu.ppy.sh/users/2398168), ::goatlife::{ user-id=4408784 }, [Kuro](https://osu.ppy.sh/users/1735031), ::OzzyOzrock::{ user-id=465153 }, [Shyguy](https://osu.ppy.sh/users/178038) |
...
| Puesto | Equipo |
| :-: | :-- |
| ![Corona de oro](/wiki/shared/crown-gold.png "Primer puesto") | ::{ flag=JP }:: **Japón** (**::sobatsuyu100::{ user-id=2076374 }**, [1RoHa\_](https://osu.ppy.sh/users/4632503), ::cagalin::{ user-id=2586173 }, [coDMo2ooo](https://osu.ppy.sh/users/3644233), ::Rydan72261::{ user-id=5309575 }, [tasuke912](https://osu.ppy.sh/users/2774767)) |
| ![Corona de plata](/wiki/shared/crown-silver.png "Segundo puesto") | ::{ flag=TW }:: **Taiwán** (**::-\[ ix Ishida xi \]-::{ user-id=242910 }**, [howar5041](https://osu.ppy.sh/users/584411), ::jordan\_sur::{ user-id=2960947 }, [mliencheng](https://osu.ppy.sh/users/586659), ::monkeydluffy3u4::{ user-id=2277798 }, [zx\_baka\_0502442](https://osu.ppy.sh/users/457766)) |
| ![Corona de bronce](/wiki/shared/crown-bronze.png "Tercer puesto") | ::{ flag=FR }:: **Francia** (**::Nashmun::{ user-id=49031 }**, [\_Gezo\_](https://osu.ppy.sh/users/481582), ::Fraolinch::{ user-id=205257 }, [Jinyan](https://osu.ppy.sh/users/669531), ::omegaflo::{ user-id=83291 }, [TimmyAkmed](https://osu.ppy.sh/users/1799973)) |
...
- NoMod
  ...
  3. [O-Life Japón - Yakujinsama no Couple Dance (AngelHoney) \[Taiko\]](https://osu.ppy.sh/beatmapsets/16990#taiko/95812)
  4. [Shounen Radio - neu (Filipinas) \[Ono's Taiko Inner Oni\]](https://osu.ppy.sh/beatmapsets/58422#taiko/224171)
  5. [TJ.Hangneil - Kamui (7odoa) \[TK\]](https://osu.ppy.sh/beatmapsets/39017#taiko/139780)
  6. [Falcom Sound Equipo jdk - Ernst (Pheon) \[Oni\]](https://osu.ppy.sh/beatmapsets/65379#taiko/191565)
- Hidden
...
- HardRock
  1. [ParagonX9 - Chaoz Japón (Mustaash) \[Firce777's Hell Oni\]](https://osu.ppy.sh/beatmapsets/31115#taiko/102527)
...
| --: | :-: | :-: | :-- | :-- |
| **Japón** ::{ flag=JP }:: | **6** | 3 | ::{ flag=TW }:: Taiwán | [#1](https://osu.ppy.sh/community/matches/15407376) |
...
| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| **Taiwán** ::{ flag=TW }:: | **6** | 4 | ::{ flag=US }:: Estados Unidos | [#1](https://osu.ppy.sh/community/matches/15204870) |
| ::{ flag=KR }:: Corea del Sur | 0 | **6** | ::{ flag=HK }:: **Hong Kong** | [#1](https://osu.ppy.sh/community/matches/15206617) |
| ::{ flag=JP }:: **Japón** | **6** | 2 | ::{ flag=FR }:: Francia | [#1](https://osu.ppy.sh/community/matches/15210189) |
| ::{ flag=FR }:: Francia | 1 | **6** | ::{ flag=TW }:: **Taiwán** | [#1](https://osu.ppy.sh/community/matches/15239715) |

Domingo, 5 de abril de 2015:

| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| **Taiwán** ::{ flag=TW }:: | **6** | 0 | ::{ flag=HK }:: Hong Kong | [#1](https://osu.ppy.sh/community/matches/15233261) |
...
| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| Polonia ::{ flag=PL }:: | 1 | **6** | ::{ flag=HK }:: **Hong Kong** | [#1](https://osu.ppy.sh/community/matches/15037749) |
| Argentina ::{ flag=AR }:: | 2 | **6** | ::{ flag=CN }:: **China** | [#1](https://osu.ppy.sh/community/matches/15040695) |
| **Canadá** ::{ flag=CA }:: | **6** | 4 | ::{ flag=DE }:: Alemania | [#1](https://osu.ppy.sh/community/matches/15044042) |
| Finlandia ::{ flag=FI }:: | 1 | **6** | ::{ flag=US }:: **Estados Unidos** | [#1](https://osu.ppy.sh/community/matches/15047132) |

Domingo, 29 de marzo de 2015:

| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| Canadá ::{ flag=CA }:: | 2 | **6** | ::{ flag=HK }:: **Hong Kong** | [#1](https://osu.ppy.sh/community/matches/15060059) |
| China ::{ flag=CN }:: | 4 | **6** | ::{ flag=US }:: **Estados Unidos** | [#1](https://osu.ppy.sh/community/matches/15062240) |
| **Japón** ::{ flag=JP }:: | **6** | 3 | ::{ flag=TW }:: Taiwán | [#1](https://osu.ppy.sh/community/matches/15063686) |
| Corea del Sur ::{ flag=KR }:: | 0 | **6** | ::{ flag=FR }:: **Francia** | [#1](https://osu.ppy.sh/community/matches/15065321) |
...
| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| ::{ flag=FI }:: **Finlandia** | **5** | 0 | Ucrania ::{ flag=UA }:: | *victoria por ausencia* |
| ::{ flag=PH }:: Filipinas | 0 | **5** | **Polonia** ::{ flag=PL }:: | [#1](https://osu.ppy.sh/community/matches/14871909) |
| ::{ flag=ES }:: España | 1 | **5** | **Argentina** ::{ flag=AR }:: | [#1](https://osu.ppy.sh/community/matches/14876376) |
| ::{ flag=ID }:: Indonesia | 0 | **5** | **Canadá** ::{ flag=CA }:: | [#1](https://osu.ppy.sh/community/matches/14878188) |

Domingo, 22 de marzo de 2015:

| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| Hong Kong ::{ flag=HK }:: | 2 | **5** | ::{ flag=JP }:: **Japón** | [#1](https://osu.ppy.sh/community/matches/14901856) |
| **Corea del Sur** ::{ flag=KR }:: | **5** | 1 | ::{ flag=CN }:: China | [#1](https://osu.ppy.sh/community/matches/14903787) |
| **Taiwán** ::{ flag=TW }:: | **5** | 2 | ::{ flag=DE }:: Alemania | [#1](https://osu.ppy.sh/community/matches/14906461) |
| Estados Unidos ::{ flag=US }:: | 4 | **5** | ::{ flag=FR }:: **Francia** | [#1](https://osu.ppy.sh/community/matches/14909642) |
...
| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| Finlandia ::{ flag=FI }:: | 1 | **5** | **Hong Kong** ::{ flag=HK }:: | [#1](https://osu.ppy.sh/community/matches/14707422) |
| Ucrania ::{ flag=UA }:: | 0 | **5** | **Japón** ::{ flag=JP }:: | [#1](https://osu.ppy.sh/community/matches/14708468) |
| **Taiwán** ::{ flag=TW }:: | **5** | 0 | España ::{ flag=ES }:: | [#1](https://osu.ppy.sh/community/matches/14709773) |
| **Alemania** ::{ flag=DE }:: | **5** | 1 | Argentina ::{ flag=AR }:: | [#1](https://osu.ppy.sh/community/matches/14711069) |
| **Francia** ::{ flag=FR }:: | **5** | 0 | Polonia ::{ flag=PL }:: | [#1](https://osu.ppy.sh/community/matches/14712960) |

Domingo, 15 de marzo de 2015:

| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| Canadá ::{ flag=CA }:: | 3 | **5** | ::{ flag=CN }:: **China** | [#1](https://osu.ppy.sh/community/matches/14731480) |
| ::{ flag=US }:: **Estados Unidos** | **5** | 0 | ::{ flag=PH }:: Filipinas | [#1](https://osu.ppy.sh/community/matches/14732731) |
| Indonesia ::{ flag=ID }:: | 2 | **5** | ::{ flag=KR }:: **Corea del Sur** | [#1](https://osu.ppy.sh/community/matches/14733838) |
...
| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| Australia ::{ flag=AU }:: | 2 | **4** | ::{ flag=KR }:: **Corea del Sur** | [#1](https://osu.ppy.sh/community/matches/14545441) |
| Singapur ::{ flag=SG }:: | 0 | **4** | ::{ flag=PH }:: **Filipinas** | *victoria por ausencia* |
| Indonesia ::{ flag=ID }:: | 1 | **4** | ::{ flag=HK }:: **Hong Kong** | [#1](https://osu.ppy.sh/community/matches/14545446) |
| Singapur ::{ flag=SG }:: | 0 | **4** | ::{ flag=FI }:: **Finlandia** | *victoria por ausencia* |
| Ucrania ::{ flag=UA }:: | 2 | **4** | ::{ flag=CN }:: China | [#1](https://osu.ppy.sh/community/matches/14546205) |
| Corea del Sur ::{ flag=KR }:: | 1 | **4** | ::{ flag=TW }:: **Taiwán** | [#1](https://osu.ppy.sh/community/matches/14546208) |
| Australia ::{ flag=AU }:: | 0 | **4** | ::{ flag=PH }:: **Filipinas** | [#1](https://osu.ppy.sh/community/matches/14546210) |
| Alemania ::{ flag=DE }:: | 1 | **4** | ::{ flag=CN }:: **China** | [#1](https://osu.ppy.sh/community/matches/14547310) |
| Finlandia ::{ flag=FI }:: | 0 | **4** | ::{ flag=TW }:: **Taiwán** | [#1](https://osu.ppy.sh/community/matches/14547314) |
| Italia ::{ flag=IT }:: | 0 | **4** | ::{ flag=JP }:: **Japón** | [#1](https://osu.ppy.sh/community/matches/14547317) |
| Hungría ::{ flag=HU }:: | 0 | **4** | ::{ flag=ID }:: **Indonesia** | *victoria por ausencia* |
| España ::{ flag=ES }:: | 1 | **4** | ::{ flag=HK }:: **Hong Kong** | [#1](https://osu.ppy.sh/community/matches/14547324) |
| Noruega ::{ flag=NO }:: | 3 | **4** | ::{ flag=UA }:: Ucrania | [#1](https://osu.ppy.sh/community/matches/14548494) |
| Singapur ::{ flag=SG }:: | 0 | **4** | ::{ flag=KR }:: **Corea del Sur** | *victoria por ausencia* |
| **Indonesia** ::{ flag=ID }:: | **4** | 2 | ::{ flag=ES }:: España | [#1](https://osu.ppy.sh/community/matches/14548501) |
| Suecia ::{ flag=SE }:: | 0 | **4** | ::{ flag=JP }:: **Japón** | [#1](https://osu.ppy.sh/community/matches/14548506) |
| Hungría ::{ flag=HU }:: | 0 | **4** | ::{ flag=HK }:: **Hong Kong** | *victoria por ausencia* |
| Chile ::{ flag=CL }:: | 0 | **4** | ::{ flag=ES }:: **España** | [#1](https://osu.ppy.sh/community/matches/14558945) |
| Noruega ::{ flag=NO }:: | 0 | **4** | ::{ flag=DE }:: **Alemania** | [#1](https://osu.ppy.sh/community/matches/14559005) |
| Italia ::{ flag=IT }:: | 0 | **4** | ::{ flag=AR }:: **Argentina** | [#1](https://osu.ppy.sh/community/matches/14559011) |
| Dinamarca ::{ flag=DK }:: | 0 | **4** | ::{ flag=PL }:: **Polonia** | [#1](https://osu.ppy.sh/community/matches/14559024) |
| Suecia ::{ flag=SE }:: | 0 | **4** | ::{ flag=CA }:: **Canadá** | [#1](https://osu.ppy.sh/community/matches/14559030) |
| Chile ::{ flag=CL }:: | 0 | **4** | ::{ flag=US }:: **Estados Unidos** | [#1](https://osu.ppy.sh/community/matches/14560666) |
| Canadá ::{ flag=CA }:: | 1 | **4** | ::{ flag=AR }:: **Argentina** | [#1](https://osu.ppy.sh/community/matches/14560675) |
| Italia ::{ flag=IT }:: | 0 | **4** | ::{ flag=FR }:: **Francia** | [#1](https://osu.ppy.sh/community/matches/14560678) |
| Dinamarca ::{ flag=DK }:: | 1 | **4** | ::{ flag=DE }:: **Alemania** | [#1](https://osu.ppy.sh/community/matches/14560685) |
| España ::{ flag=ES }:: | 1 | **4** | ::{ flag=US }:: **Estados Unidos** | [#1](https://osu.ppy.sh/community/matches/14563829) |
| Italia ::{ flag=IT }:: | 0 | **4** | ::{ flag=CA }:: **Canadá** | [#1](https://osu.ppy.sh/community/matches/14563841) |
| Suecia ::{ flag=SE }:: | 0 | **4** | ::{ flag=AR }:: **Argentina** | *victoria por ausencia* |
| Canadá ::{ flag=CA }:: | 0 | **4** | ::{ flag=FR }:: **Francia** | [#1](https://osu.ppy.sh/community/matches/14565653) |
| Hungría ::{ flag=HU }:: | 0 | **4** | ::{ flag=US }:: **Estados Unidos** | *victoria por ausencia* |

Domingo, 8 de marzo de 2015:

| Equipo 1 |  |  | Equipo 2 | Enlace del partido |
| --: | :-: | :-: | :-- | :-- |
| Indonesia ::{ flag=ID }:: | 0 | **4** | ::{ flag=US }:: **Estados Unidos** | [#1](https://osu.ppy.sh/community/matches/14569915) |
| Argentina ::{ flag=AR }:: | 0 | **4** | ::{ flag=JP }:: **Japón** | [#1](https://osu.ppy.sh/community/matches/14569921) |
| Chile ::{ flag=CL }:: | 0 | **4** | ::{ flag=HK }:: **Hong Kong** | [#1](https://osu.ppy.sh/community/matches/14569922) |
| Hong Kong ::{ flag=HK }:: | 2 | **4** | ::{ flag=US }:: **Estados Unidos** | [#1](https://osu.ppy.sh/community/matches/14571275) |
| Canadá ::{ flag=CA }:: | 1 | **4** | ::{ flag=JP }:: **Japón** | [#1](https://osu.ppy.sh/community/matches/14571278) |
| **Indonesia** ::{ flag=ID }:: | **4** | 2 | ::{ flag=CL }:: Chile | [#1](https://osu.ppy.sh/community/matches/14571285) |
| Australia ::{ flag=AU }:: | 2 | **4** | ::{ flag=SG }:: **Singapur** | [#1](https://osu.ppy.sh/community/matches/14571288) |
| Australia ::{ flag=AU }:: | 0 | **4** | ::{ flag=TW }:: **Taiwán** | [#1](https://osu.ppy.sh/community/matches/14578652) |
| Filipinas ::{ flag=PH }:: | 0 | **4** | ::{ flag=KR }:: **Corea del Sur** | *victoria por ausencia* |
| Australia ::{ flag=AU }:: | 1 | **4** | ::{ flag=FI }:: **Finlandia** | [#1](https://osu.ppy.sh/community/matches/14579505) |
| Polonia ::{ flag=PL }:: | 3 | **4** | ::{ flag=CN }:: **China** | [#1](https://osu.ppy.sh/community/matches/14579508) |
| Francia ::{ flag=FR }:: | 1 | **4** | ::{ flag=JP }:: **Japón** | [#1](https://osu.ppy.sh/community/matches/14579513) |
| Singapur ::{ flag=SG }:: | 0 | **4** | ::{ flag=TW }:: **Taiwán** | [#1](https://osu.ppy.sh/community/matches/14579517) |
| Finlandia ::{ flag=FI }:: | 0 | **4** | ::{ flag=KR }:: **Corea del Sur** | [#1](https://osu.ppy.sh/community/matches/14580453) |
| Noruega ::{ flag=NO }:: | 0 | **4** | ::{ flag=PL }:: **Polonia** | *victoria por ausencia* |
| Dinamarca ::{ flag=DK }:: | 0 | **4** | ::{ flag=CN }:: **China** | [#1](https://osu.ppy.sh/community/matches/14580459) |
| Ucrania ::{ flag=UA }:: | 1 | **4** | ::{ flag=DE }:: **Alemania** | [#1](https://osu.ppy.sh/community/matches/14580461) |
| Filipinas ::{ flag=PH }:: | 0 | **4** | ::{ flag=TW }:: **Taiwán** | [#1](https://osu.ppy.sh/community/matches/14581346) |
| Hungría ::{ flag=HU }:: | 0 | **4** | ::{ flag=ES }:: **España** | *victoria por ausencia* |
| **Italia** ::{ flag=IT }:: | **4** | 0 | ::{ flag=SE }:: Suecia | [#1](https://osu.ppy.sh/community/matches/14581351) |
| Noruega ::{ flag=NO }:: | 0 | **4** | ::{ flag=DK }:: **Dinamarca** | *victoria por ausencia* |
| **Finlandia** ::{ flag=FI }:: | **4** | 0 | ::{ flag=PH }:: Filipinas | [#1](https://osu.ppy.sh/community/matches/14582413) |
| Dinamarca ::{ flag=DK }:: | 0 | **4** | ::{ flag=UA }:: **Ucrania** | [#1](https://osu.ppy.sh/community/matches/14582415) |
| Suecia ::{ flag=SE }:: | 0 | **4** | ::{ flag=FR }:: **Francia** | [#1](https://osu.ppy.sh/community/matches/14582418) |
| Polonia ::{ flag=PL }:: | 1 | **4** | ::{ flag=DE }:: **Alemania** | [#1](https://osu.ppy.sh/community/matches/14582420) |
| Noruega ::{ flag=NO }:: | 1 | **4** | ::{ flag=CN }:: **China** | [#1](https://osu.ppy.sh/community/matches/14584962) |
| Ucrania ::{ flag=UA }:: | 1 | **4** | ::{ flag=PL }:: **Polonia** | [#1](https://osu.ppy.sh/community/matches/14584969) |
| Argentina ::{ flag=AR }:: | 1 | **4** | ::{ flag=FR }:: **Francia** | [#1](https://osu.ppy.sh/community/matches/14584970) |
| Hungría ::{ flag=HU }:: | 0 | **4** | ::{ flag=CL }:: **Chile** | [#1](https://osu.ppy.sh/community/matches/14584973) |
...
1. Cada usuario interesado en formar parte del equipo de su país se inscribe individualmente.
   - La dirección del torneo creará una lista de candidatos potenciales para el equipo de un país.
   - La dirección del torneo declara a uno de los candidatos capitán del equipo del país, aunque sea temporalmente.
   - El capitán declarado puede formar su equipo a partir de la lista de candidatos de su país.
2. Para garantizar inscripciones válidas y serias, cada usuario registrado será comprobado por la dirección del torneo.
   - Cada usuario inscrito será asignado a la lista de candidatos de su respectivo país.
   - Para ser aceptado con éxito en la lista, tiene que asegurarse de que su clasificación global de Taiko es superior a \#8000.
   - Para ser aceptado con éxito en la lista, tiene que asegurarse de no haber violado las [reglas de la comunidad de osu!](/wiki/Rules) en los últimos 12 meses.
3. Para registrarse, [envíe un MP a Loctav](https://osu.ppy.sh/home/messages/users/71366) titulado «Registro TWC».
   - Añada su zona horaria local al MP de registro.
   - Recibirá una respuesta de confirmación si su registro ha llegado correctamente. Su inscripción está entonces en espera.
...
7. Los resultados se publicarán a través del sitio de estadísticas.
...
9. El tamaño del bracket NoMod será de 6 en todas las fases.
10. El tamaño de los brackets específicos de mod será de 3 en todas las etapas.
