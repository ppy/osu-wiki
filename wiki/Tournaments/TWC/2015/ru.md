...
2. Сетка карт для каждого этапа будет оглашена заранее в последнее воскресенье перед этапом.
   ...
   - В наличии также будут сетки для игры с [Hidden](/wiki/Game_modifier), [HardRock](/wiki/Game_modifier), [DoubleTime](/wiki/Game_modifier) и произвольными модами.
...
2. Каждый пул состоит из пяти сеток: NoMod, [Hidden](/wiki/Game_modifier), [HardRock](/wiki/Game_modifier), [DoubleTime](/wiki/Game_modifier) и FreeMod.
