...
2. Сетка карт для каждого этапа будет оглашена заранее в последнее воскресенье перед этапом.
   ...
   - В наличии также будут сетки для игры с [Hidden](/wiki/Game_modifier/Hidden), [Hard Rock](/wiki/Game_modifier/Hard_Rock), [Double Time](/wiki/Game_modifier/Double_Time) и произвольными модами.
...
2. Каждый пул состоит из пяти сеток: NoMod, [Hidden](/wiki/Game_modifier/Hidden), [Hard Rock](/wiki/Game_modifier/Hard_Rock), [Double Time](/wiki/Game_modifier/Double_Time) и FreeMod.
...
6. Карты из сеток Hidden, Hard Rock и Double Time будут играться только с соответствующими модами.
7. Карты из сетки FreeMod могут играться с модами Hidden, Hard Rock или обоими сразу (каждый игрок волен выбирать сам).
