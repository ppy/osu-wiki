...
osu!taiko 월드컵은 2024 최소 $2,000 상금과 한정판 상품을 제공합니다.
...
osu!taiko 월드컵 2024은 osu!팀과 여러명의 커뮤니티 멤버들로 운영됩니다.
...
- **[참가 신청하기](https://osu.ppy.sh/community/tournaments/43)**
...
7. 경기 시간에 필요한 최소 인원보다 적은 인원이 참석할 경우, 경기는 최대 10분간 지연이 가능합니다. 이 지연 이후에도 양 팀 모두 최소 인원보다 적은 경우, 더 많은 플레이어가 있는 팀에 *부전승이 선언됩니다*
   - 필수인 최소 플레이어는 로비에 빈 자리 없이 비트맵을 플레이하는 데 필요한 플레이어의 수입니다. (즉, 경기를 시작하기 위해선 2명의 플레이어가 있어야 합니다).
