...
-   NoMod
    ...
    -   [yak_won - Lucid (Raja) \[Radiant\]](https://osu.ppy.sh/beatmapsets/496093#osu/1055975)
...
| ------------------: | :---: | :---: | :------------------- | :-------------------------------------------------- |
| Urushihara Fan Club |   -1  | **0** | **Futon's Bunker**   | _win by default_                                    |
...
|  Alligator Space Jam |   -1  | **0** | **rooGya**                | _win by default_                                    |
...
|                   yayo |   -1  | **0** | **Dziadzia team**       | _win by default_                                    |
...
| Alligator Space Jam |   -1  | **0** | **Sakura Trick**      | _win by default_                                    |
