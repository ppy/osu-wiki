...
The **osu! FumoFumo Cup: Summer Lights** (***OFFC: SL***) was a 4v4 double-elimination osu! tournament hosted by ::{ flag=CN }:: ::- Isuzu Ren -::{ user-id=13217389 }. The tournament featured a brand-new chess-style ban/pick gameplay mechanics based on the traditional tournament rules. It was the second iteration of the osu! FumoFumo Cup tournament series.
...
| Position | Member(s) |
| :-- | :-- |
| Host | ::{ flag=CN }:: ::- Isuzu Ren -::{ user-id=13217389 } |
| Rulemaker | ::{ flag=CN }:: ::- Isuzu Ren -::{ user-id=13217389 }, ::{ flag=CN }:: ::kitakore::{ user-id=33887163 }, ::{ flag=CN }:: ::NaughtyChas::{ user-id=15349720 } |
| Developer | ::{ flag=CN }:: ::cdwcgt::{ user-id=14721101 }, ::{ flag=CN }:: ::MoeRain233::{ user-id=30973609 }, ::{ flag=CN }:: ::NaughtyChas::{ user-id=15349720 } |
| Graphic designer | ::{ flag=CN }:: ::AeCw::{ user-id=6781503 }, ::{ flag=CN }:: ::Citrusis::{ user-id=30298378 }, ::{ flag=CN }:: ::sourflour::{ user-id=5237349 } |
| Mappool selector | ::{ flag=CN }:: ::- Isuzu Ren -::{ user-id=13217389 }, ::{ flag=CN }:: ::5atori Komeiji::{ user-id=34282059 }, ::{ flag=CN }:: ::FcEazy::{ user-id=7825227 }, ::{ flag=CN }:: ::Koishi Komeiji::{ user-id=33295812 }, ::{ flag=CN }:: ::My Angel Bronya::{ user-id=17857203 } |
...
| Playtester | ::{ flag=CN }:: ::- Isuzu Ren -::{ user-id=13217389 }, ::{ flag=CN }:: ::-Rosmontis-::{ user-id=34323353 }, ::{ flag=CN }:: ::\1SHK\1\1Firra::{ user-id=15175276 }, ::{ flag=CN }:: ::chanliuko::{ user-id=32289237 }, ::{ flag=CN }:: ::FcEazy::{ user-id=7825227 }, ::{ flag=CN }:: ::My Angel Bronya::{ user-id=17857203 } |
| Referee | ::{ flag=CN }:: ::- Isuzu Ren -::{ user-id=13217389 }, ::{ flag=CN }:: ::\1SHK\1\1Firra::{ user-id=15175276 }, ::{ flag=CN }:: ::Koishi Komeiji::{ user-id=33295812 }, ::{ flag=CN }:: ::Komeiji\1Satori\1::{ user-id=15114200 }, ::{ flag=CN }:: ::Paraliesa::{ user-id=30595368 }, ::{ flag=CN }:: ::SparkNights::{ user-id=9641731 } |
| Streamer | ::{ flag=CN }:: ::- Isuzu Ren -::{ user-id=13217389 }, ::{ flag=CN }:: ::Dr\1Shindo::{ user-id=30895664 }, ::{ flag=CN }:: ::FroZZZZZen::{ user-id=29235972 }, ::{ flag=CN }:: ::NaughtyChas::{ user-id=15349720 } |
| Commentator | ::{ flag=CN }:: ::- Isuzu Ren -::{ user-id=13217389 }, ::{ flag=CN }:: ::My Angel Bronya::{ user-id=17857203 }, ::{ flag=CN }:: ::Nosenso::{ user-id=30329943 }, ::{ flag=CN }:: ::S tella::{ user-id=16018639 } |
| Spreadsheet designer | ::{ flag=CA }:: ::Dura::{ user-id=5185609 }, ::{ flag=CN }:: ::sourflour::{ user-id=5237349 } |
...
| Distinction | Player |
| :-- | :-- |
| MVP (from 1st place team) | ::{ flag=DE }:: ::yiyao1229::{ user-id=30979124 } |
| SVP (from 2nd place team) | ::{ flag=HK }:: ::Mithra Tercera::{ user-id=2955661 } |
| Best Planned Strategist (from the polls) | (Pending) |
| Best Labor Strategist (from the polls) | (Pending) |
| Player with the highest overall HD score | ::{ flag=CN }:: ::Kdlake::{ user-id=29938752 } |
| Player with the highest overall HR score | ::{ flag=CN }:: ::RABBIT2::{ user-id=10260284 } |
