...
The **osu! FumoFumo Cup: Summer Lights** (***OFFC: SL***) was a 4v4 double-elimination osu! tournament hosted by ::{ flag=CN }:: ::- Isuzu Ren -::{ user=13217389 }. The tournament featured a brand-new chess-style ban/pick gameplay mechanics based on the traditional tournament rules. It was the second iteration of the osu! FumoFumo Cup tournament series.
...
| Position | Member(s) |
| :-- | :-- |
| Host | ::{ flag=CN }:: ::- Isuzu Ren -::{ user=13217389 } |
| Rulemaker | ::{ flag=CN }:: ::- Isuzu Ren -::{ user=13217389 }, ::{ flag=CN }:: ::kitakore::{ user=33887163 }, ::{ flag=CN }:: ::NaughtyChas::{ user=15349720 } |
| Developer | ::{ flag=CN }:: ::cdwcgt::{ user=14721101 }, ::{ flag=CN }:: ::MoeRain233::{ user=30973609 }, ::{ flag=CN }:: ::NaughtyChas::{ user=15349720 } |
| Graphic designer | ::{ flag=CN }:: ::AeCw::{ user=6781503 }, ::{ flag=CN }:: ::Citrusis::{ user=30298378 }, ::{ flag=CN }:: ::sourflour::{ user=5237349 } |
| Mappool selector | ::{ flag=CN }:: ::- Isuzu Ren -::{ user=13217389 }, ::{ flag=CN }:: ::5atori Komeiji::{ user=34282059 }, ::{ flag=CN }:: ::FcEazy::{ user=7825227 }, ::{ flag=CN }:: ::Koishi Komeiji::{ user=33295812 }, ::{ flag=CN }:: ::My Angel Bronya::{ user=17857203 } |
| Custom mapper | ::{ flag=PH }:: ::Amateurre::{ user=7326908 }, ::{ flag=HK }:: ::Arushii::{ user=15664628 }, ::{ flag=PH }:: ::Flame Haze::{ user=8922155 }, ::{ flag=CN }:: ::NatsuRin::{ user=20653857 }, ::{ flag=AU }:: ::nominomu::{ user=30485380 }, ::{ flag=HK }:: ::Petal::{ user=7354729 }, ::{ flag=VN }:: ::Selcas::{ user=12545835 }, ::{ flag=ID }:: ::Shurelia::{ user=3807986 }, ::{ flag=JP }:: ::Soyuha::{ user=14208375 }, ::{ flag=CN }:: ::SparkNights::{ user=9641731 }, ::{ flag=CN }:: ::X Light::{ user=1814662 } |
| Playtester | ::{ flag=CN }:: ::- Isuzu Ren -::{ user=13217389 }, ::{ flag=CN }:: ::-Rosmontis-::{ user=34323353 }, ::{ flag=CN }:: ::\1SHK\1\1Firra::{ user=15175276 }, ::{ flag=CN }:: ::chanliuko::{ user=32289237 }, ::{ flag=CN }:: ::FcEazy::{ user=7825227 }, ::{ flag=CN }:: ::My Angel Bronya::{ user=17857203 } |
| Referee | ::{ flag=CN }:: ::- Isuzu Ren -::{ user=13217389 }, ::{ flag=CN }:: ::\1SHK\1\1Firra::{ user=15175276 }, ::{ flag=CN }:: ::Koishi Komeiji::{ user=33295812 }, ::{ flag=CN }:: ::Komeiji\1Satori\1::{ user=15114200 }, ::{ flag=CN }:: ::Paraliesa::{ user=30595368 }, ::{ flag=CN }:: ::SparkNights::{ user=9641731 } |
| Streamer | ::{ flag=CN }:: ::- Isuzu Ren -::{ user=13217389 }, ::{ flag=CN }:: ::Dr\1Shindo::{ user=30895664 }, ::{ flag=CN }:: ::FroZZZZZen::{ user=29235972 }, ::{ flag=CN }:: ::NaughtyChas::{ user=15349720 } |
| Commentator | ::{ flag=CN }:: ::- Isuzu Ren -::{ user=13217389 }, ::{ flag=CN }:: ::My Angel Bronya::{ user=17857203 }, ::{ flag=CN }:: ::Nosenso::{ user=30329943 }, ::{ flag=CN }:: ::S tella::{ user=16018639 } |
| Spreadsheet designer | ::{ flag=CA }:: ::Dura::{ user=5185609 }, ::{ flag=CN }:: ::sourflour::{ user=5237349 } |
...
| Team # | Name | Members |
| :-: | :-: | :-- |
| **Team A** | 多啦A梦 | ::{ flag=HK }:: ::Kdlake::{ user=29938752 }, ::{ flag=HK }:: ::Ayaneruuu::{ user=14533605 }, ::{ flag=DE }:: ::yiyao1229::{ user=30979124 }, ::{ flag=CN }:: ::- Rika Ayano -::{ user=9037287 }, ::{ flag=CN }:: ::-SummerSky-::{ user=18955845 }, ::{ flag=TW }:: ::touhou chef::{ user=24533023 }, ::{ flag=HK }:: ::\1SHK\1 Arcadia::{ user=13888511 }, ::{ flag=KR }:: ::09X::{ user=36963238 } |
| **Team B** | 都是SummerSky害的 | ::{ flag=CN }:: ::MogenNotFound::{ user=14494010 }, ::{ flag=CN }:: ::Sonoboi::{ user=10040597 }, ::{ flag=TW }:: ::\1 Luka \1::{ user=11923800 }, ::{ flag=CN }:: ::\1SHK\1T\1T::{ user=13999223 }, ::{ flag=CN }:: ::zmyk::{ user=11396041 }, ::{ flag=CN }:: ::misaki233::{ user=14103871 }, ::{ flag=CN }:: ::Hekiru::{ user=16446039 }, ::{ flag=CN }:: ::misaki233::{ user=14103871 } |
| **Team C** | 不是夏天我不草 | ::{ flag=CN }:: ::oliwakami::{ user=3046750 }, ::{ flag=CN }:: ::jj986544591::{ user=2917990 }, ::{ flag=HK }:: ::-xxx Rumia-::{ user=5936405 }, ::{ flag=CA }:: ::Akisa 18::{ user=16134378 }, ::{ flag=CN }:: ::HD1::{ user=21398264 }, ::{ flag=TW }:: ::miltonfs::{ user=32610281 }, ::{ flag=US }:: ::Yuan233123::{ user=15454134 }, ::{ flag=CN }:: ::CloudLinker::{ user=19465414 } |
| **Team D** | 给你一拳 | ::{ flag=US }:: ::Texas::{ user=8281276 }, ::{ flag=CN }:: ::Pager::{ user=15030466 }, ::{ flag=CN }:: ::gxytcgxytc::{ user=874891 }, ::{ flag=TW }:: ::N i s u::{ user=4647311 }, ::{ flag=CN }:: ::carrywind::{ user=12228018 }, ::{ flag=CN }:: ::-SmilingTeresa::{ user=4524794 }, ::{ flag=CN }:: ::noneght::{ user=16801578 }, ::{ flag=TW }:: ::12231337::{ user=37845705 } |
| **Team E** | Valorant after this | ::{ flag=CA }:: ::ShandenYamada::{ user=13413713 }, ::{ flag=TW }:: ::jocore::{ user=30157397 }, ::{ flag=CN }:: ::Firia::{ user=9164037 }, ::{ flag=CN }:: ::Slay\1conceit::{ user=5568835 }, ::{ flag=CN }:: ::i hate TB::{ user=31443365 }, ::{ flag=HK }:: ::itsushini::{ user=17074316 }, ::{ flag=CN }:: ::Mars New::{ user=8926316 } |
| **Team F** | 原來OFFC:SL的S不是suiji的意思嗎 | ::{ flag=MO }:: ::-PSC-::{ user=24350045 }, ::{ flag=HK }:: ::AbbeyChan6203::{ user=20971891 }, ::{ flag=TW }:: ::daiimu::{ user=17792515 }, ::{ flag=CN }:: ::Hakumo Shiro::{ user=5179557 }, ::{ flag=CN }:: ::9898::{ user=1624459 }, ::{ flag=CN }:: ::Fyu\1Neru::{ user=6699436 }, ::{ flag=CN }:: ::MizukiQwQ::{ user=15154497 }, ::{ flag=AE }:: ::SzZzC::{ user=32630602 } |
| **Team G** | 让你选DT你龙吗 | ::{ flag=CN }:: ::1611::{ user=10462385 }, ::{ flag=CN }:: ::SongDD::{ user=17049803 }, ::{ flag=CN }:: ::Bochi the osu::{ user=30284920 }, ::{ flag=CN }:: ::Hakumo Ai::{ user=694480 }, ::{ flag=TW }:: ::Ama\1tw::{ user=28536684 }, ::{ flag=CN }:: ::Lilim Harlot::{ user=29552621 }, ::{ flag=CN }:: ::forzenyubi::{ user=9661461 }, ::{ flag=SG }:: ::AthoraX::{ user=17689709 } |
| **Team H** | zako psc | ::{ flag=HK }:: ::Fallen\1HK::{ user=13981456 }, ::{ flag=CN }:: ::eric1388::{ user=20384257 }, ::{ flag=HK }:: ::Mithra Tercera::{ user=2955661 }, ::{ flag=CN }:: ::RABBIT2::{ user=10260284 }, ::{ flag=MO }:: ::7White::{ user=17159216 }, ::{ flag=TW }:: ::Mou li kai::{ user=30593882 }, ::{ flag=CN }:: ::Pouxba::{ user=16378561 }, ::{ flag=CN }:: ::comgrat::{ user=12830046 } |
...
| Placing | Team |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | 多啦A梦 |
...
| Distinction | Player |
| :-- | :-- |
| MVP (from 1st place team) | ::{ flag=DE }:: ::yiyao1229::{ user=30979124 } |
| SVP (from 2nd place team) | ::{ flag=HK }:: ::Mithra Tercera::{ user=2955661 } |
| Best Planned Strategist (from the polls) | (Pending) |
| Best Labor Strategist (from the polls) | (Pending) |
| Player with the highest overall HD score | ::{ flag=CN }:: ::Kdlake::{ user=29938752 } |
| Player with the highest overall HR score | ::{ flag=CN }:: ::RABBIT2::{ user=10260284 } |
