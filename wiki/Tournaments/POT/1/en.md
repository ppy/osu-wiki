...
| Position | Member(s) |
| :-- | :-- |
| Host | ::{ flag=ID }:: ::Splacten::{ user=10018405 }, ::{ flag=ID }:: ::Larzz::{ user=10483670 } |
| Mappool selector | ::{ flag=ID }:: ::Splacten::{ user=10018405 }, ::{ flag=ID }:: ::Larzz::{ user=10483670 } |
| Playtester | ::{ flag=ID }:: ::Rayhan Hamil::{ user=4085825 }, ::{ flag=ID }:: ::Crezz::{ user=7108275 } |
| Streamer | ::{ flag=ID }:: ::kilgo::{ user=9692053 }, ::{ flag=ID }:: ::Victim\_Crasher::{ user=2084869 } |
| Commentator | ::{ flag=ID }:: ::kilgo::{ user=9692053 }, ::{ flag=ID }:: ::Victim\_Crasher::{ user=2084869 }, ::{ flag=ID }:: ::Fyl::{ user=10069307 } |
| Referee | ::{ flag=ID }:: ::kilgo::{ user=9692053 }, ::{ flag=ID }:: ::Romizzz::{ user=6154769 } |
| Graphic designer | ::{ flag=ID }:: ::Victim\_Crasher::{ user=2084869 } |
...
| :-: | :-- | :-- |
| 1 | ::{ flag=ID }:: ::Victim\_Crasher::{ user=2084869 } | 1.6 |
| 2 | ::{ flag=ID }:: ::Lindaine::{ user=4572717 } | 2.8 |
| 3 | ::{ flag=ID }:: ::ReeyaDono::{ user=10969698 } | 4.1 |
| 4 | ::{ flag=ID }:: ::DigiM::{ user=2659328 } | 5.7 |
| 5 | ::{ flag=ID }:: ::StingRay::{ user=2215822 } | 5.9 |
| 6 | ::{ flag=ID }:: ::cuna::{ user=14505580 } | 7.3 |
| 7 | ::{ flag=ID }:: ::larrypult::{ user=12255948 } | 7.6 |
| 8 | ::{ flag=ID }:: ::naruto-sasuke::{ user=4072413 } | 7.9 |
| 9 | ::{ flag=ID }:: ::nasje::{ user=7579498 } | 8.0 |
| 10 | ::{ flag=ID }:: ::hamdanpapeng::{ user=10854143 } | 9.1 |
| 11 | ::{ flag=ID }:: ::DeltaE::{ user=8361921 } | 10.2 |
| 12 | ::{ flag=ID }:: ::ana\_kunn::{ user=2868409 } | 10.3 |
...
| Placing | Player |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=ID }:: ::ReeyaDono::{ user=10969698 } |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=ID }:: ::Lindaine::{ user=4572717 } |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=ID }:: ::Victim\_Crasher::{ user=2084869 } |
...
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | ::Victim\_Crasher::{ user=2084869 } ::{ flag=ID }:: | 4 | **7** | ::{ flag=ID }:: **::ReeyaDono::{ user=10969698 }** | [#1](https://osu.ppy.sh/community/matches/79301199) |

Sunday, 4 April 2021, Grand Final:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Grand Final | ::Lindaine::{ user=4572717 } ::{ flag=ID }:: | 4 | **7** | ::{ flag=ID }:: **::ReeyaDono::{ user=10969698 }** | [#1](https://osu.ppy.sh/community/matches/79843882) |
| Grand Final (Bracket Reset) | **::ReeyaDono::{ user=10969698 }** ::{ flag=ID }:: | **7** | 2 | ::{ flag=ID }:: ::Lindaine::{ user=4572717 } | [#1](https://osu.ppy.sh/community/matches/79930736) |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | ::StingRay::{ user=2215822 } ::{ flag=ID }:: | 2 | **6** | ::{ flag=ID }:: **::cuna::{ user=78462242 }** | [#1](https://osu.ppy.sh/community/matches/78462242) |
| Lower | **::ReeyaDono::{ user=10969698 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::DigiM::{ user=2659328 } | [#1](https://osu.ppy.sh/community/matches/78458122) |

Saturday, 20 March 2021:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | ::cuna::{ user=78462242 } ::{ flag=ID }:: | 0 | **6** | ::{ flag=ID }:: **::ReeyaDono::{ user=10969698 }** | [#1](https://osu.ppy.sh/community/matches/78462242) |

Sunday, 21 March 2021:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | ::Victim\_Crasher::{ user=2084869 } ::{ flag=ID }:: | 3 | **6** | ::{ flag=ID }:: **::Lindaine::{ user=4572717 }** | [#1](https://osu.ppy.sh/community/matches/78646519) |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::Lindaine::{ user=4572717 }** ::{ flag=ID }:: | **6** | 4 | ::{ flag=ID }:: ::ReeyaDono::{ user=10969698 } | [#1](https://osu.ppy.sh/community/matches/78055535) |
| Upper | **::Victim\_Crasher::{ user=2084869 }** ::{ flag=ID }:: | **6** | 0 | ::{ flag=ID }:: ::StingRay::{ user=2215822 } | [#1](https://osu.ppy.sh/community/matches/78047446) |
| Lower | **::cuna::{ user=14505580 }** ::{ flag=ID }:: | **6** | 0 | ::{ flag=ID }:: ::larrypult::{ user=12255948 } | [#1](https://osu.ppy.sh/community/matches/78059749) |

Monday, 15 March 2021:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | **::DigiM::{ user=2659328 }** ::{ flag=ID }:: | **6** | 5 | ::{ flag=ID }:: ::nasje::{ user=7579498 } | [#1](https://osu.ppy.sh/community/matches/78050310) |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::ReeyaDono::{ user=10969698 }** ::{ flag=ID }:: | **5** | 3 | ::{ flag=ID }:: ::cuna::{ user=14505580 } | [#1](https://osu.ppy.sh/community/matches/77278333) |

Saturday, 6 March 2021:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::Lindaine::{ user=4572717 }** ::{ flag=ID }:: | **5** | 0 | ::{ flag=ID }:: ::larrypult::{ user=12255948 } | [#1](https://osu.ppy.sh/community/matches/77368933) |

Sunday, 7 March 2021:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | ::DigiM::{ user=2659328 } ::{ flag=ID }:: | 3 | **5** | ::{ flag=ID }:: **::StingRay::{ user=2215822 }** | [#1](https://osu.ppy.sh/community/matches/77455381) |
| Upper | **::Victim\_Crasher::{ user=2084869 }** ::{ flag=ID }:: | **5** | 0 | ::{ flag=ID }:: ::nasje::{ user=7579498 } | [#1](https://osu.ppy.sh/community/matches/77451609) |

Wednesday, 10 March 2021:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | **::DigiM::{ user=2659328 }** ::{ flag=ID }:: | **5** | 0 | ::{ flag=ID }:: ::hamdanpapeng::{ user=10854143 } | [#1](https://osu.ppy.sh/community/matches/77683525) |
| Lower | **::cuna::{ user=14505580 }** ::{ flag=ID }:: | **5** | 2 | ::{ flag=ID }:: ::naruto-sasuke::{ user=4072413 } | [#1](https://osu.ppy.sh/community/matches/77686417) |

Thursday, 11 March 2021:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | **::larrypult::{ user=12255948 }** ::{ flag=ID }:: | **5** | 2 | ::{ flag=ID }:: ::ana\_kunn::{ user=2868409 } | [#1](https://osu.ppy.sh/community/matches/77764333) |
| Lower | **::nasje::{ user=7579498 }** ::{ flag=ID }:: | **5** | 2 | ::{ flag=ID }:: ::DeltaE::{ user=8361921 } | [#1](https://osu.ppy.sh/community/matches/77753957) |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | ::naruto-sasuke::{ user=4072413 } ::{ flag=ID }:: | 1 | **5** | ::{ flag=ID }:: **::nasje::{ user=7579498 }** | [#1](https://osu.ppy.sh/community/matches/77245889) |
| Upper | **::cuna::{ user=14505580 }** ::{ flag=ID }:: | **5** | 0 | ::{ flag=ID }:: ::DeltaE::{ user=8361921 } | [#1](https://osu.ppy.sh/community/matches/77270247) |

Saturday, 27 February 2021:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::larrypult::{ user=12255948 }** ::{ flag=ID }:: | **5** | 3 | ::{ flag=ID }:: ::hamdanpapeng::{ user=10854143 } | [#1](https://osu.ppy.sh/community/matches/77363288) |

Sunday, 28 February 2021:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::StingRay::{ user=2215822 }** ::{ flag=ID }:: | **5** | 0 | ::{ flag=ID }:: ::ana\_kunn::{ user=2868409 } | [#1](https://osu.ppy.sh/community/matches/77448647) |
