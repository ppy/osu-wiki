...
The **PERAK osu! Tournament** was a double-elimination 1v1 osu! tournament hosted by ![][flag_ID] [Splacten](https://osu.ppy.sh/users/10018405) and ![][flag_ID] [Larzz](https://osu.ppy.sh/users/10483670) which was being held as a part of the [PERAK Games League](https://perak.cs.ui.ac.id/ "Pesta Rakyat Komputer") festival. The tournament was open to all players who were registered as a student at (or as an alumni of) [Universitas Indonesia's Faculty of Computer Science](https://cs.ui.id "Computer Science Universitas Indonesia") regardless of rank. It was the first iteration of the PERAK osu! Tournament.
...
1. All interested players are required to register into the tournament individually.
   - In order to be eligible to play in the tournament, a player must be able to attest their status as a registered student at (or as an alumni of) [Universitas Indonesia's Faculty of Computer Science](https://cs.ui.id "Computer Science Universitas Indonesia") by showing a valid [EMAS UI credential](http://emas.ui.ac.id "EMAS UI") to the Tournament Management.
