...
The **Ascaveth Invitational Tournament 2023: Last Chance Qualifier** (***AIT 2023: LCQ***) was an Indonesian double-elimination 1v1 osu! tournament hosted by ::{ flag=ID }:: ::Ascaveth::{ user=3245206 }. The tournament was open to all players from Indonesia as a way to qualify to the main [Ascaveth Invitational](/wiki/Tournaments/AIT) LAN tournament. It was the first Last Chance Qualifier event to be held in the history of the Ascaveth Invitational Tournament.
...
| Admin | ::{ flag=ID }:: ::Sunohara Shun::{ user=3484548 }, ::{ flag=ID }:: ::Crezz::{ user=7108275 }, ::{ flag=ID }:: ::Niva::{ user=197805 }, ::{ flag=ID }:: ::Vvn::{ user=3204677 }, ::{ flag=ID }:: ::Deorum::{ user=5933031 }, ::{ flag=ID }:: ::Rumberkren::{ user=3925053 }, ::{ flag=ID }:: ::Genjitsu::{ user=3531490 } |
| Mappool selector | ::{ flag=ID }:: ::Sunohara Shun::{ user=3484548 }, ::{ flag=ID }:: ::Crezz::{ user=7108275 }, ::{ flag=ID }:: ::fnayR::{ user=2800253 } |
...
| :-: | --: | :-: | :-: | :-- | :-- |
| NGF-1 | **::Rosemi Lovelock::{ user=1987591 }** ::{ flag=ID }:: | **7** | 5 | ::{ flag=ID }:: ::DeathHydra::{ user=7457788 } | [#1](https://osu.ppy.sh/community/matches/111072284) |

Monday, 30 October 2023:

| Match code | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| NGF-2 | **::DEETO::{ user=7457788 }** ::{ flag=ID }:: | **7** | 0 | ::{ flag=ID }:: ::Rosemi Lovelock::{ user=1987591 } | [#1](https://osu.ppy.sh/community/matches/111099149) |

::{ flag=ID }:: ***::DEETO::{ user=7457788 }** went on to qualify for the Ascaveth Invitational Tournament 2023 as the second winner of the Last Chance Qualifier.*
...
| Match code | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| LGF-1 | ::DeathHydra::{ user=7457788 } ::{ flag=ID }:: | 1 | **7** | ::{ flag=ID }:: **::DEETO::{ user=7457788 }** | [#1](https://osu.ppy.sh/community/matches/110970349) |

Sunday, 22 October 2023:

| Match code | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| GF-1 | **::ThatNOOBGuy::{ user=11091594 }** ::{ flag=ID }:: | **7** | 5 | ::{ flag=ID }:: ::DEETO::{ user=7457788 } | [#1](https://osu.ppy.sh/community/matches/110986762) |

::{ flag=ID }:: ***::ThatNOOBGuy::{ user=11091594 }** went on to qualify for the Ascaveth Invitational Tournament 2023 as the first winner of the Last Chance Qualifier.*
...
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::ThatNOOBGuy::{ user=11091594 }** ::{ flag=ID }:: | **7** | 1 | ::{ flag=ID }:: ::DeathHydra::{ user=7457788 } | [#1](https://osu.ppy.sh/community/matches/110871694) |
| Lower | **::DEETO::{ user=7457788 }** ::{ flag=ID }:: | **7** | 0 | ::{ flag=ID }:: ::XenoitesBadPog::{ user=11461426 } | [#1](https://osu.ppy.sh/community/matches/110876209) |
| Lower | **::Rosemi Lovelock::{ user=1987591 }** ::{ flag=ID }:: | **7** | 0 | ::{ flag=ID }:: ::BlankTap::{ user=10137131 } | *win by default* |

Sunday, 15 October 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | ::Rosemi Lovelock::{ user=1987591 } ::{ flag=ID }:: | 1 | **7** | ::{ flag=ID }:: **::DEETO::{ user=7457788 }** | [#1](https://osu.ppy.sh/community/matches/110892709) |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | ::Ninomae Ina-nis::{ user=11983229 } ::{ flag=ID }:: | 5 | **6** | ::{ flag=ID }:: **::BlankTap::{ user=10137131 }** | [#1](https://osu.ppy.sh/community/matches/110774274) |
| Upper | **::ThatNOOBGuy::{ user=11091594 }** ::{ flag=ID }:: | **6** | 0 | ::{ flag=ID }:: ::DEETO::{ user=7457788 } | *win by default* |

Sunday, 8 October 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | ::Rosemi Lovelock::{ user=1987591 } ::{ flag=ID }:: | 4 | **6** | ::{ flag=ID }:: **::DeathHydra::{ user=7457788 }** | [#1](https://osu.ppy.sh/community/matches/110795862) |
| Lower | ::Suikami::{ user=1929336 } ::{ flag=ID }:: | 5 | **6** | ::{ flag=ID }:: **::XenoitesBadPog::{ user=11461426 }** | [#1](https://osu.ppy.sh/community/matches/110796867) |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::DeathHydra::{ user=7457788 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::XenoitesBadPog::{ user=11461426 } | [#1](https://osu.ppy.sh/community/matches/110677568) |
| Upper | **::DEETO::{ user=7457788 }** ::{ flag=ID }:: | **6** | 0 | ::{ flag=ID }:: ::BlankTap::{ user=11461426 } | [#1](https://osu.ppy.sh/community/matches/110677568) |
| Upper | **::ThatNOOBGuy::{ user=11091594 }** ::{ flag=ID }:: | **6** | 0 | ::{ flag=ID }:: ::Ninomae Ina-nis::{ user=11983229 } | *win by default* |

Sunday, 1 October 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::Rosemi Lovelock::{ user=1987591 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::Suikami::{ user=1929336 } | [#1](https://osu.ppy.sh/community/matches/110698374) |
...
| :-: | :-- | :-- |
| 1 | ::{ flag=ID }:: **::ThatNOOBGuy::{ user=11091594 }** | 9.84 |
| 2 | ::{ flag=ID }:: **::Rosemi Lovelock::{ user=1987591 }** | 8.70 |
| 3 | ::{ flag=ID }:: **::DeathHydra::{ user=7457788 }** | 7.91 |
| 4 | ::{ flag=ID }:: **::DEETO::{ user=10069909 }** | 7.49 |
| 5 | ::{ flag=ID }:: **::BlankTap::{ user=10137131 }** | 7.24 |
| 6 | ::{ flag=ID }:: **::XenoitesBadPog::{ user=11461426 }** | 7.09 |
| 7 | ::{ flag=ID }:: **::Suikami::{ user=1929336 }** | 6.76 |
| 8 | ::{ flag=ID }:: **::Ninomae Ina-nis::{ user=11983229 }** | 6.59 |
| 9 | ::{ flag=ID }:: ::MejiroMcQueen::{ user=11320627 } | 6.55 |
| 10 | ::{ flag=ID }:: ::Anhydrous::{ user=11272510 } | 5.92 |
| 11 | ::{ flag=ID }:: ::Caruma::{ user=13187450 } | 5.80 |
| 12 | ::{ flag=ID }:: ::Kirinagi::{ user=5937545 } | 5.25 |
| 13 | ::{ flag=ID }:: ::timing::{ user=12763134 } | 5.03 |
| 14 | ::{ flag=ID }:: ::\[u\_u\]::{ user=8688737 } | 4.97 |
| 15 | ::{ flag=ID }:: ::Sirius Symboli::{ user=11025519 } | 4.48 |
| 16 | ::{ flag=ID }:: ::Seox::{ user=3793938 } | 3.23 |
| 17 | ::{ flag=ID }:: ::MaxNoLimit::{ user=13415030 } | 2.65 |
| 18 | ::{ flag=ID }:: ::GabenRipAim::{ user=19036792 } | 1.22 |
| 19 | ::{ flag=ID }:: ::NasiGaPakeNasi::{ user=17519250 } | 1.14 |
| 20 | ::{ flag=ID }:: ::Alvin\_Gaming::{ user=29999134 } | 0.70 |
