...
|  | Country | Members |
| :-: | :-: | :-- |
| ::{ flag=CA }:: | **99% Canadian** | **::ERA Sunny::{ user=16468962 }**, ::DimplesRMe::{ user=13348268 }, ::Verdon::{ user=14196373 } |
...
| ::{ flag=NL }:: | **Netherlands** | **::Shoira::{ user=13377652 }**, ::Freek::{ user=9630674 }, ::Boaz::{ user=13302996 }, ::samuelhklumpers::{ user=10945523 } |
...
| ::{ flag=VN }:: | **Vietnam-A** | **::Lott::{ user=13821222 }**, ::RandomNameIdk::{ user=24042710 }, ::\[LS\]Tokiyume::{ user=13219309 }, ::nahieu2005::{ user=22069182 }, ::Cessna::{ user=16868806 } |
| ::{ flag=VN }:: | **Vietnam-B** | **::Walker37712::{ user=30644569 }**, ::ldminh4354::{ user=30855778 }, ::aiyern::{ user=13826244 } |
