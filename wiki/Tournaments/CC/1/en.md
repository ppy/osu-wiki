...
The **Corgi Cup: June 2016** (***CC***) was a 1v1 single-elimination osu! tournament hosted by ::{ flag=FI }:: ::M8gazine::{ user=5039710 }, ::{ flag=GB }:: ::Doomsday::{ user=18983 }, and ::{ flag=GB }:: ::Yazzehh::{ user=7068973 }. It was the first instalment of the Corgi Cup.
...
| Position | Member(s) |
| :-- | :-- |
| Host | ::{ flag=FI }:: ::M8gazine::{ user=5039710 } |
| Co-host | ::{ flag=GB }:: ::Yazzehh::{ user=7068973 }, ::{ flag=GB }:: ::Doomsday::{ user=18983 } |
| Mappool selector | ::{ flag=GB }:: ::Doomsday::{ user=18983 }, ::{ flag=PL }:: ::Wilchq::{ user=2021758 } |
| Streamer | ::{ flag=GB }:: ::Doomsday::{ user=18983 } |
| Commentator | ::{ flag=GB }:: ::Doomsday::{ user=18983 }, ::{ flag=GB }:: ::- Isozaki -::{ user=3987676 }, ::{ flag=GB }:: ::Doomsday is bad::{ user=3481378 } |
| Designer | ::{ flag=GB }:: ::Doomsday::{ user=18983 } |
| Referee | ::{ flag=RS }:: ::SirCircle::{ user=3794917 }, ::{ flag=GB }:: ::Yazzehh::{ user=7068973 }, ::{ flag=FI }:: ::M8gazine::{ user=5039710 } |
...
| Seed | Members |
| :-: | :-- |
| Group A | ::{ flag=GB }:: ::Pelzio::{ user=4775226 }, ::{ flag=GB }:: Sopison <!-- missing -->, ::{ flag=US }:: ::Micmck101::{ user=5117269 }, ::{ flag=GB }:: ::Hydria::{ user=808176 } |
| Group B | ::{ flag=US }:: ::zelda101::{ user=4502238 }, ::{ flag=US }:: ::Lazulite::{ user=4094169 }, ::{ flag=GB }:: ::SteffoST::{ user=6566765 }, ::{ flag=GB }:: ::djsettle::{ user=4010354 } |
| Group C | ::{ flag=SE }:: ::Atrocious::{ user=5126607 }, ::{ flag=GB }:: ::Seraxis::{ user=5068922 }, ::{ flag=GB }:: ::MagicMantwon::{ user=6183136 }, ::{ flag=GB }:: ::dong::{ user=4422446 } |
| Group D | ::{ flag=GB }:: ::rafalbrew::{ user=3872602 }, ::{ flag=GB }:: ::YouKittenMe::{ user=6129402 }, ::{ flag=DE }:: ::Blegie::{ user=6063132 }, ::{ flag=CZ }:: ::NyarkoO::{ user=6622567 } |
...
| Placing | Player |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=GB }:: ::rafalbrew::{ user=3872602 } |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=GB }:: ::Pelzio::{ user=4775226 } |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=US }:: ::zelda101::{ user=4502238 } |
