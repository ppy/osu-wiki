...
| Position | Member(s) |
| :-- | :-- |
| Mappooler | ::{ flag=US }:: ::Ahntaea::{ user-id=4941097 }, ::{ flag=US }:: ::Darin on osu::{ user-id=4839876 }, ::{ flag=CN }:: ::friidryce::{ user-id=8271310 }, ::{ flag=US }:: ::Harrharrqi::{ user-id=2744592 }, ::{ flag=US }:: ::jms8720::{ user-id=2570828 }, ::{ flag=US }:: ::philisophic::{ user-id=7040672 }, ::{ flag=US }:: ::Riku on osu::{ user-id=3071659 }, ::{ flag=US }:: ::Yattaze::{ user-id=13870255 } |
| Commentator | ::{ flag=US }:: ::Riku on osu::{ user-id=3071659 }, ::{ flag=US }:: ::Yattaze::{ user-id=13870255 } |
| Designer | ::{ flag=US }:: ::Potor10::{ user-id=8029687 } |
| Referee | ::{ flag=US }:: ::Darin on osu::{ user-id=4839876 }, ::{ flag=CN }:: ::friidryce::{ user-id=8271310 }, ::{ flag=US }:: ::philisophic::{ user-id=7040672 }, ::{ flag=US }:: ::jms8720::{ user-id=2570828 } |

## Podium and prizes

| Placing | Player | Prizes |
| :-: | :-- | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=US }:: ::Chzaron::{ user-id=11607790 } | 6 months of osu!supporter, Vulkan TKL keyboard |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=US }:: ::Kenny::{ user-id=1225459 } | 3 months of osu!supporter, Aorus M4 mouse |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=US }:: ::-ether-::{ user-id=6131258 } | 1 month of osu!supporter, MSI Grabbag |
...
- ::{ flag=US }:: ::-ether-::{ user-id=6131258 }
- ::{ flag=US }:: ::\[KOR\] Sora::{ user-id=11985468 }
- ::{ flag=US }:: ::atlae99::{ user-id=29787503 }
- ::{ flag=US }:: ::Chzaron::{ user-id=11607790 }
- ::{ flag=US }:: ::crikhard::{ user-id=7023000 }
- ::{ flag=US }:: ::Daprin::{ user-id=10961983 }
- ::{ flag=US }:: ::dyndenial::{ user-id=16779673 }
- ::{ flag=US }:: ::firenoo::{ user-id=10815041 }
- ::{ flag=US }:: ::freddiiieeee::{ user-id=7112839 }
- ::{ flag=US }:: ::jazzberry::{ user-id=11055678 }
- ::{ flag=US }:: ::jms8719::{ user-id=2042565 }
- ::{ flag=US }:: ::Kenny::{ user-id=1225459 }
- ::{ flag=US }:: ::leeeroy::{ user-id=12620812 }
- ::{ flag=US }:: ::potato48::{ user-id=10724175 }
- ::{ flag=US }:: ::SeaAE::{ user-id=12354364 }
- ::{ flag=US }:: ::Strider::{ user-id=4553852 }
- ::{ flag=US }:: ::Vysion::{ user-id=11594132 }
...
| --: | :-: | :-: | :-- | :-- |
| **::Chzaron::{ user-id=11607790 }** ::{ flag=US }:: | **6** | 1 | ::{ flag=US }:: ::Kenny::{ user-id=1225459 } | [#1](https://osu.ppy.sh/community/matches/101038923) |
...
| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| **::Chzaron::{ user-id=11607790 }** ::{ flag=US }:: | **5** | 2 | ::{ flag=US }:: ::-ether-::{ user-id=6131258 } | [#1](https://osu.ppy.sh/community/matches/101037695) |

#### Losers bracket

| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| ::-ether-::{ user-id=6131258 } ::{ flag=US }:: | -1 | **0** | ::{ flag=US }:: **::Kenny::{ user-id=1225459 }** | *forfeit* |
...
| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| **::Chzaron::{ user-id=11607790 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::Kenny::{ user-id=1225459 } | [#1](https://osu.ppy.sh/community/matches/101035941) |
| ::Daprin::{ user-id=10961983 } ::{ flag=US }:: | 3 | **4** | ::{ flag=US }:: **::-ether-::{ user-id=6131258 }** | [#1](https://osu.ppy.sh/community/matches/101035950) |

#### Losers bracket

| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| **::Daprin::{ user-id=10961983 }** ::{ flag=US }:: | **5** | 3 | ::{ flag=US }:: ::potato48::{ user-id=10724175 } | [#1](https://osu.ppy.sh/community/matches/101036960) |
| **::Kenny::{ user-id=1225459 }** ::{ flag=US }:: | **5** | 3 | ::{ flag=US }:: ::Strider::{ user-id=4553852 } | [#1](https://osu.ppy.sh/community/matches/101036948) |
| ::Daprin::{ user-id=10961983 } ::{ flag=US }:: | 4 | **5** | ::{ flag=US }:: **::Kenny::{ user-id=1225459 }** | [#1](https://osu.ppy.sh/community/matches/101037708) |
...
| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| **::Chzaron::{ user-id=11607790 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::potato48::{ user-id=10724175 } | [#1](https://osu.ppy.sh/community/matches/101033416) |
| ::\[KOR\] Sora::{ user-id=11985468 } ::{ flag=US }:: | 1 | **4** | ::{ flag=US }:: **::Kenny::{ user-id=1225459 }** | [#1](https://osu.ppy.sh/community/matches/101033422) |
| **::Daprin::{ user-id=10961983 }** ::{ flag=US }:: | **4** | 2 | ::{ flag=US }:: ::Strider::{ user-id=4553852 } | [#1](https://osu.ppy.sh/community/matches/101033425) |
| ::crikhard::{ user-id=7023000 } ::{ flag=US }:: | 0 | **4** | ::{ flag=US }:: **::-ether-::{ user-id=6131258 }** | [#1](https://osu.ppy.sh/community/matches/101033431) |

#### Losers bracket

| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| ::\[KOR\] Sora::{ user-id=11985468 } ::{ flag=US }:: | 3 | **4** | ::{ flag=US }:: **::leeeroy::{ user-id=12620812 }** | [#1](https://osu.ppy.sh/community/matches/101035038) |
| **::potato48::{ user-id=10724175 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::Vysion::{ user-id=11594132 } | [#1](https://osu.ppy.sh/community/matches/101035367) |
| **::crikhard::{ user-id=7023000 }** ::{ flag=US }:: | **4** | 1 | ::{ flag=US }:: ::jazzberry::{ user-id=11055678 } | [#1](https://osu.ppy.sh/community/matches/101034821) |
| **::Strider::{ user-id=4553852 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::dyndenial::{ user-id=16779673 } | [#1](https://osu.ppy.sh/community/matches/101035380) |
| ::leeeroy::{ user-id=12620812 } ::{ flag=US }:: | 3 | **4** | ::{ flag=US }:: **::potato48::{ user-id=10724175 }** | [#1](https://osu.ppy.sh/community/matches/101036224) |
| ::crikhard::{ user-id=7023000 } ::{ flag=US }:: | 1 | **4** | ::{ flag=US }:: **::Strider::{ user-id=4553852 }** | [#1](https://osu.ppy.sh/community/matches/101036226) |
...
| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| **::Chzaron::{ user-id=11607790 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::firenoo::{ user-id=10815041 } | [#1](https://osu.ppy.sh/community/matches/101031724) |
| **::potato48::{ user-id=10724175 }** ::{ flag=US }:: | **4** | 1 | ::{ flag=US }:: ::dyndenial::{ user-id=16779673 } | [#1](https://osu.ppy.sh/community/matches/101032594) |
| **::\[KOR\] Sora::{ user-id=11985468 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::jazzberry::{ user-id=11055678 } | [#1](https://osu.ppy.sh/community/matches/101031620) |
| **::Kenny::{ user-id=1225459 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::SeaAE::{ user-id=12354364 } | [#1](https://osu.ppy.sh/community/matches/101031633) |
| **::Daprin::{ user-id=10961983 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::Vysion::{ user-id=11594132 } | [#1](https://osu.ppy.sh/community/matches/101031639) |
| **::Strider::{ user-id=4553852 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::jms8719::{ user-id=2042565 } | [#1](https://osu.ppy.sh/community/matches/101031762) |
| **::crikhard::{ user-id=7023000 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::freddiiieeee::{ user-id=7112839 } | [#1](https://osu.ppy.sh/community/matches/101031744) |
| **::-ether-::{ user-id=6131258 }** ::{ flag=US }:: | **4** | 3 | ::{ flag=US }:: ::leeeroy::{ user-id=12620812 } | [#1](https://osu.ppy.sh/community/matches/101031752) |

#### Losers bracket

| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| ::freddiiieeee::{ user-id=7112839 } ::{ flag=US }:: | 0 | **4** | ::{ flag=US }:: **::leeeroy::{ user-id=12620812 }** | [#1](https://osu.ppy.sh/community/matches/101033421) |
| ::jms8719::{ user-id=2042565 } ::{ flag=US }:: | 3 | **4** | ::{ flag=US }:: **::Vysion::{ user-id=11594132 }** | [#1](https://osu.ppy.sh/community/matches/101033430) |
| ::SeaAE::{ user-id=12354364 } ::{ flag=US }:: | -1 | **0** | ::{ flag=US }:: **::jazzberry::{ user-id=11055678 }** | *forfeit* |
| **::dyndenial::{ user-id=16779673 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::firenoo::{ user-id=10815041 } | [#1](https://osu.ppy.sh/community/matches/101033452) |
...
| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| **::firenoo::{ user-id=10815041 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::atlae99::{ user-id=29787503 } | [#1](https://osu.ppy.sh/community/matches/101030746) |

#### Losers bracket

| Player 1 |  |  | Player 2 | Match link |
| --: | :-: | :-: | :-- | :-- |
| **::leeeroy::{ user-id=12620812 }** ::{ flag=US }:: | **4** | 0 | ::{ flag=US }:: ::atlae99::{ user-id=29787503 } | [#1](https://osu.ppy.sh/community/matches/101032916) |
...
| Player | Average rank |
| :-- | --: |
| ::{ flag=US }:: ::Chzaron::{ user-id=11607790 } | 3.1 |
| ::{ flag=US }:: ::Daprin::{ user-id=10961983 } | 3.6 |
| ::{ flag=US }:: ::crikhard::{ user-id=7023000 } | 4.1 |
| ::{ flag=US }:: ::\[KOR\] Sora::{ user-id=11985468 } | 4.3 |
| ::{ flag=US }:: ::Kenny::{ user-id=1225459 } | 4.6 |
| ::{ flag=US }:: ::-ether-::{ user-id=6131258 } | 4.8 |
| ::{ flag=US }:: ::Strider::{ user-id=4553852 } | 8.0 |
| ::{ flag=US }:: ::potato48::{ user-id=10724175 } | 8.7 |
| ::{ flag=US }:: ::dyndenial::{ user-id=16779673 } | 8.8 |
| ::{ flag=US }:: ::jms8719::{ user-id=2042565 } | 9.5 |
| ::{ flag=US }:: ::leeeroy::{ user-id=12620812 } | 10.9 |
| ::{ flag=US }:: ::SeaAE::{ user-id=12354364 } | 11.0 |
| ::{ flag=US }:: ::jazzberry::{ user-id=11055678 } | 12.3 |
| ::{ flag=US }:: ::freddiiieeee::{ user-id=7112839 } | 13.0 |
| ::{ flag=US }:: ::Vysion::{ user-id=11594132 } | 14.2 |
| ::{ flag=US }:: ::firenoo::{ user-id=10815041 } | 15.2 |
| ::{ flag=US }:: ::atlae99::{ user-id=29787503 } | 16.9 |
