...
The **Coffee Hispanic Tournament** (***CHT***) was a single-elimination 2v2 osu! tournament hosted by ::{ flag=AR }:: ::Vaf::{ user=12589048 }, ::{ flag=AR }:: ::iNeuu\_Z::{ user=9112463 }, and ::{ flag=US }:: ::tigereyes144::{ user=6499811 }. The tournament was restricted to Spanish-speaking countries only. This was the first instalment of the Coffee Hispanic Tournament.
...
| Placing | Team |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | **United States** (::{ flag=CL }:: **::Barack::{ user=9402889 }**, ::{ flag=PE }:: ::Hoshinomori::{ user=4112621 }) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | **Noveno Gaston** (::{ flag=ES }:: **::JoanaBob::{ user=10966302 }**, ::{ flag=AR }:: ::Mariano::{ user=6371395 }) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | **Hallo y caspi** (::{ flag=ES }:: **::caspi99::{ user=7610747 }**, ::{ flag=DE }:: ::hallowatcher::{ user=1874761 }) |
...
| #6 | ::{ flag=AR }:: ::AxelOsu::{ user=1887616 } | 68 |
