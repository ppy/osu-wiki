...
| 名次 | 奖励 |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "冠军") | 个人主页奖章，*TBA* |
...
8. 比赛中可以自由上下选手，除了触发特定规则的情况下。
9. 如果一局比赛以平局结束，这局将会重赛。
10. 如果队员比赛中遇到了技术问题，在 30 秒内或者谱面的 25% 时间内掉线可以申请重赛。裁判可以自行决定是否否决这一请求。
    - 游戏卡顿延迟并不会被作为一个可行的理由。
    - 如果发生了重赛，那么比赛双方的选手必须保持和初次相同。如果其中有选手确实无法比赛，那么双方都允许换人。
    - 禁止滥用此规则，如果裁判发现有队伍故意利用此规则，其可以拒绝重赛请求。
11. 如果选手掉线，成绩不会被计入总分，除非该选手提供成绩证明。可接受的内容如下：
...
12. 选手应该保持比赛流畅，严禁故意拖延。如选手过度的拖延时间，裁判可自行决定是否判罚。严禁通过犯规、侮辱或挑衅其他选手或工作人员、拖延时间或其他故意不当行为来扰乱比赛，如有违反将受到相应的惩罚。
13. 任何试图操纵比赛结果或之后比赛的企图将可能导致队伍和队员立刻被撤销比赛资格，这些行为包括但不限于：
    - 与其他队伍或队员串通，以迫使他们进行所需的比赛。
    - 故意打得不好而输掉一局或一整场。
    - 在没有提供充分理由，或为了获得更有利的局面的情况下放弃一场比赛。
14. 比赛期间，必须尊重所有选手和工作人员，遵循裁判和主办方的指示，不得反对裁判和主办方最终决定。
15. 比赛房间中的聊天室也受到 [规章制度](/wiki/Rules) 的约束，玩家在比赛房间中所有聊天信息均需遵守相应规则。
...
17. 裁判可以根据情况调整 `timers` 的长度。
18. 主办方可以在没有事先警告的情况下，要求选手开直播或录像。
19. 任何与赛事相关的投诉应发送至 osu! 官方举报表单。
20. 主办方保留修改规则的权利，任何修改将会提前宣布。
...
2. 为了保证报名有效，所有参赛选手将递交至 [锦标赛筛查](/wiki/zh/Tournaments/Official_support#锦标赛筛查-(screen))。
