2017年华人osu!mania 4K大赛
=============================

![CMT 4K 2017](pic.png)

 **2017年华人osu!mania 4K大赛**(以下均简写为**CMT 4K 2017**)为华人区个人比赛，是由CMT团队举办的第二届华人osu!mania 4K大赛。比赛所用地图均为osu!mania 4K专用谱。
...
1. **2017年华人osu!mania 4K大赛**(以下均简写为**CMT 4K 2017**)为华人区个人比赛，是由CMT团队举办的第二届华人osu!mania 4K大赛。比赛所用地图均为osu!mania 4K专用谱。
2. 每场比赛的地图库将于比赛前一周的周末由地图库管理员放出，图库内包含若干张Free-Mod地图:  
	&emsp;a) 其中的Tie-breaker（决胜）地图仅用于决胜局比赛。  
	&emsp;b) 所有地图均在Free-mod池下。
...
9. 如果选手因为掉线直接跳出 mp 房间界面而未能完成该图，则按以下方法处理：  
	&emsp;a) 在比赛开始 30 秒内发生的，应予以重赛。  
	&emsp;b) 否则视作失败（Failed）。
...
2. 玩家满足以下条件的可以报名参加CMT 4K 2017:
     ...
     - 玩家赛时使用时区无限制。  
     - 玩家使用汉语作为主要语言。  
     - 本次比赛对rank无强制要求，建议#4000 rank之内的玩家参赛。  
     - 如果参赛者在过去一年内于 osu!社区或在比赛中有过不良记录，我们可能会取消其参赛资格。  
...
7. 获胜条件:  
     ...
     - 小组赛为**7**局 **4**胜(Best-of-**7**)。
     - 16强和1/4决赛为**9**局 **5**胜(Best-of-**9**)。
     - 半决赛与决赛第**1**周为**11**局**6**胜(Best-of-**11**)。
     - 总决赛为**13**局**7**胜(Best-of-**13**)。
8. 根据赛程安排，这些赛事的编排如下： 
...
### 资格赛
1. 一位记录员会在赛事开始前**15**分钟创建一个Multiplayer(mp)房间，选手需要在此时集合:  
...
4. 所有地图，包括决胜图，都使用Free-mod进行:
     - 任何选手都可以自行选择Hidden(HD), Flashlight(FL), 或其他Mod。
