...
La **Catch French Cup 4** (***CFC 4***) était un tournoi osu!catch français en 1v1 organisé par ::{ flag=CA }:: ::Sinaeb::{ user=1576095 } et ::{ flag=FR }:: ::Kasumii-sama::{ user=6177263 }. Ceci était la quatrième édition de la Catch French Cup.
...
| Classement | Joueur |
| :-: | :-- |
| ![Couronne d'or](/wiki/shared/crown-gold.png "1ère place") | ::{ flag=FR }:: ::Alostis::{ user=2986875 } |
| ![Couronne d'argent](/wiki/shared/crown-silver.png "2ème place") | ::{ flag=TN }:: ::-Ken::{ user=4430811 } |
