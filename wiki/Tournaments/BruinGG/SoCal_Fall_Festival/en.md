...
- ::{ flag=US }:: **::Kahli::{ user=8926244 }** (Kahli#3822)
- ::{ flag=US }:: ::DigitalHypno::{ user=4384207 } (DigitalHypno#6473)
- ::{ flag=ID }:: ::LLEENN::{ user=2427901 } (LLEENN#0001)
- ::{ flag=US }:: ::Riku on osu::{ user=3071659 } (naranjasagged#8308)
- ::{ flag=US }:: ::Scientia Fe::{ user=7872968 } (Scientia#3691)
