...
2. **Map scoring is based on Score V2**. It uses an alternative way of weighting hit objects, accuracy and combo and alters various gameplay elements. It is available as unranked mod in song selection for practise on the Cutting Edge build.
3. The maps for each round will be announced by the mapset selector in advance on the Sunday before the actual matches take place. Only these will be used during the respective matches.
  1. One map will be given as a tiebreaker map. This map will only be played in case of a tie.
...
18. The multiplayer chatrooms underlie the [[Rules|osu! community rules]]. All chat rules apply to the multiplayer chatrooms, too.
...
21. Penalties for violating the tournament rules can be:
  1. Exclusion of specific players for one map
  2. Exclusion of specific players for an entire match
  3. Declaring the match as Lost by Default
  4. Disqualification from the entire tournament
...
2. To ensure valid and serious registrations, every registered user will be checked by the Tournament Management.
  ...
  3. To be successfully accepted on the list, you have to ensure that you did not violate the [[Rules|osu! community rules]] within the last 12 months.
...
9. When playing the tiebreaker, no one needs to have a mode activated.
