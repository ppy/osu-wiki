...
| Position | Member(s) |
| :-- | :-- |
| Manager | ::{ flag=AR }:: ::juankristal::{ user=443656 }, ::{ flag=US }:: ::stupud man::{ user=2141612 }, ::{ flag=CL }:: ::WalterToro::{ user=5281416 } |
| Mappool selector | ::{ flag=BR }:: ::Guilhermeziat::{ user=3661387 }, ::{ flag=US }:: ::lemonguy::{ user=4693052 }, ::{ flag=SG }:: ::Shoegazer::{ user=2520707 }, ::{ flag=US }:: ::stupud man::{ user=2141612 }, ::{ flag=US }:: ::Toaph Daddy::{ user=7616811 } |
| Referee | ::{ flag=NL }:: ::Albionthegreat::{ user=9853595 }, ::{ flag=PL }:: ::Benzopirene::{ user=1887068 }, ::{ flag=IN }:: ::Speshimen::{ user=7720204 }, ::{ flag=GB }:: ::StartAndSelect::{ user=8720555 }, ::{ flag=US }:: ::stupud man::{ user=2141612 }, ::{ flag=PH }:: ::SurfChu85::{ user=4469895 }, ::{ flag=US }:: ::Toaph Daddy::{ user=7616811 }, ::{ flag=CL }:: ::WalterToro::{ user=5281416 }, ::{ flag=HK }:: ::zero2snow::{ user=7751516 } |
| Streamer | ::{ flag=NL }:: ::Albionthegreat::{ user=9853595 }, ::{ flag=FI }:: ::Camopoltergeist::{ user=8132964 }, ::{ flag=AR }:: ::juankristal::{ user=443656 }, ::{ flag=PL }:: ::Kamikaze::{ user=2124783 }, ::{ flag=SE }:: ::Mestro::{ user=4798263 }, ::{ flag=BE }:: ::NightNarumi::{ user=4381142 }, ::{ flag=US }:: ::Penguinosity::{ user=10235296 }, ::{ flag=US }:: ::stupud man::{ user=2141612 } |
| Commentator | ::{ flag=NL }:: ::Albionthegreat::{ user=9853595 }, ::{ flag=ID }:: ::\[Crz\]Crysarlene::{ user=5492871 }, ::{ flag=SE }:: ::Davvy::{ user=10047413 }, ::{ flag=US }:: ::Halogen-::{ user=169992 }, ::{ flag=AR }:: ::juankristal::{ user=443656 }, ::{ flag=PL }:: ::Kamikaze::{ user=2124783 }, ::{ flag=US }:: ::-mint-::{ user=8976576 }, ::{ flag=ID }:: ::Mipha-::{ user=5767941 }, ::{ flag=FR }:: ::Paturages::{ user=1375479 }, ::{ flag=AU }:: ::PingLaw::{ user=5401523 }, ::{ flag=AU }:: ::PotassiumF::{ user=4247722 }, ::{ flag=SG }:: ::Raveille::{ user=1388767 }, ::{ flag=SG }:: ::Shoegazer::{ user=2520707 }, ::{ flag=US }:: ::stupud man::{ user=2141612 }, ::{ flag=US }:: ::Toaph Daddy::{ user=7616811 }, ::{ flag=CL }:: ::WalterToro::{ user=5281416 } |
| Designer | ::{ flag=PH }:: ::OsuMe65::{ user=852867 }, ::{ flag=US }:: ::stupud man::{ user=2141612 } |
...
| Seed | Users |
| :-- | :-- |
| Top (#1 - #16) | ::{ flag=CL }:: ::\[GS\]Myuka::{ user=10072733 }, ::{ flag=BR }:: ::SillyFangirl::{ user=2288363 }, ::{ flag=GB }:: ::XxNewson1234xX::{ user=9895650 }, ::{ flag=PH }:: ::Silhoueska Elze::{ user=11517895 }, ::{ flag=GB }:: ::Pope Gadget::{ user=2288341 }, ::{ flag=TH }:: ::HowToPlayLN::{ user=10879600 }, ::{ flag=PH }:: ::bojii::{ user=10083439 }, ::{ flag=US }:: ::Alter-::{ user=4980256 }, ::{ flag=JP }:: ::AMDuskia1996::{ user=10242062 }, ::{ flag=FR }:: ::Auraah::{ user=10015908 }, ::{ flag=US }:: ::BaniiYanii::{ user=11888159 }, ::{ flag=US }:: ::mashu::{ user=12028216 }, ::{ flag=GB }:: ::Yonk\_::{ user=5156656 }, ::{ flag=AR }:: ::BossPlays::{ user=7341471 }, ::{ flag=US }:: ::Halogen-::{ user=169992 }, ::{ flag=FR }:: ::ZayyKen::{ user=8624433 } |
| High (#17 - #32) | ::{ flag=VN }:: ::Asrielly::{ user=2656302 }, ::{ flag=US }:: ::Geno\_::{ user=19392649 }, ::{ flag=PH }:: ::TheMysteryL::{ user=14113974 }, ::{ flag=US }:: ::WaterMelonTube::{ user=11937337 }, ::{ flag=GB }:: ::xSnaggles::{ user=3799946 }, ::{ flag=AR }:: ::\[Crz\]kOvID-::{ user=13858488 }, ::{ flag=US }:: ::ERA Zenith::{ user=7128063 }, ::{ flag=IT }:: ::Jeersy::{ user=11636434 }, ::{ flag=BR }:: ::\[LS\]LeMarcinho::{ user=13347579 }, ::{ flag=VN }:: ::CPT\_Sivelia::{ user=12562107 }, ::{ flag=GB }:: ::Zoobin4::{ user=10055204 }, ::{ flag=VE }:: ::\_Yisus\_::{ user=1489811 }, ::{ flag=DE }:: ::jkzu123::{ user=15806513 }, ::{ flag=TH }:: ::ZCFirsTT::{ user=11179361 }, ::{ flag=UY }:: ::etterna in osu::{ user=5243536 }, ::{ flag=AR }:: ::gxrl::{ user=13226626 } |
| Low (#33 - #96) | ::{ flag=PL }:: ::DaDarkDragon::{ user=8902097 }, ::{ flag=US }:: ::TTenko::{ user=13802345 }, ::{ flag=US }:: ::etterna and osu::{ user=13712190 }, ::{ flag=US }:: ::ASharpp::{ user=12657177 }, ::{ flag=AU }:: ::ruka::{ user=6117525 }, ::{ flag=NL }:: ::Bakuretsue::{ user=10960533 }, ::{ flag=TH }:: ::SHOKO -::{ user=10279743 }, ::{ flag=CH }:: ::Tupidix::{ user=8655604 }, ::{ flag=BR }:: ::Yuragi::{ user=8501380 }, ::{ flag=CA }:: ::Stability::{ user=6701738 }, ::{ flag=GB }:: ::AirSpan::{ user=5063207 }, ::{ flag=CL }:: ::\[Crz\]Arkener::{ user=4116072 }, ::{ flag=IE }:: ::SPLOwON::{ user=15225195 }, ::{ flag=US }:: ::HeZeuS::{ user=7387788 }, ::{ flag=GB }:: ::Zycrxd::{ user=14245127 }, ::{ flag=US }:: ::\[GS\]Antunder::{ user=10416995 }, ::{ flag=GB }:: ::PikachuNick::{ user=4168230 }, ::{ flag=BR }:: ::Gabi Kamui::{ user=10658391 }, ::{ flag=MY }:: ::Cryolien::{ user=1626983 }, ::{ flag=SG }:: ::AdamAckerville::{ user=12297375 }, ::{ flag=US }:: ::oleka::{ user=9423766 }, ::{ flag=US }:: ::Unholy::{ user=7672414 }, ::{ flag=PH }:: ::\[LS\]Acestrol::{ user=13470043 }, ::{ flag=TH }:: ::Freshky::{ user=11959687 }, ::{ flag=ES }:: ::Guldakh::{ user=8553078 }, ::{ flag=FR }:: ::Ping36::{ user=9388217 }, ::{ flag=BR }:: ::Lenn::{ user=11236829 }, ::{ flag=GB }:: ::Solleks::{ user=9683287 }, ::{ flag=PL }:: ::Tidek::{ user=743282 }, ::{ flag=SG }:: ::Polytetral::{ user=8612061 }, ::{ flag=BR }:: ::Soore::{ user=15753462 }, ::{ flag=MY }:: ::\1-Leon-\1::{ user=13382147 }, ::{ flag=AR }:: ::Ingrid10::{ user=9786011 }, ::{ flag=PY }:: ::MomonSama::{ user=7762488 }, ::{ flag=NZ }:: ::CappK::{ user=16837177 }, ::{ flag=PL }:: ::SitekX::{ user=3840946 }, ::{ flag=NL }:: ::2fast4you98::{ user=5183940 }, ::{ flag=US }:: ::Ery::{ user=9872668 }, ::{ flag=HU }:: ::Verald::{ user=5766307 }, ::{ flag=AU }:: ::Vegemite::{ user=13111686 }, ::{ flag=ID }:: ::RetroEX::{ user=10540515 }, ::{ flag=TH }:: ::LoliconTowa::{ user=8103540 }, ::{ flag=GB }:: ::Hayabusa::{ user=3104108 }, ::{ flag=CL }:: ::Xan-::{ user=5919873 }, ::{ flag=CA }:: ::CommandoBlack::{ user=7025841 }, ::{ flag=FR }:: ::DragonSonic::{ user=7294830 }, ::{ flag=ID }:: ::\[ReyZ\]::{ user=16768803 }, ::{ flag=TH }:: ::shokoha::{ user=14134289 }, ::{ flag=BE }:: ::Mortelspawn\1::{ user=5331420 }, ::{ flag=CA }:: ::\[ro\]Nosteal::{ user=8160564 }, ::{ flag=US }:: ::thatcow::{ user=10629473 }, ::{ flag=HK }:: ::Quotient GD::{ user=11313227 }, ::{ flag=US }:: ::-Lethal-::{ user=5125822 }, ::{ flag=US }:: ::\_Seth::{ user=8111953 }, ::{ flag=BR }:: ::Zergh::{ user=3181281 }, ::{ flag=SG }:: ::\[LS\]PlzNjoyGame::{ user=15210942 }, ::{ flag=HK }:: ::Dream Fire::{ user=11198186 }, ::{ flag=US }:: ::blizzo::{ user=13581430 }, ::{ flag=NL }:: ::samuelhklumpers::{ user=10945523 }, ::{ flag=PH }:: ::MowseChow::{ user=11341964 }, ::{ flag=DE }:: ::Sirbeyy::{ user=12917829 }, ::{ flag=ID }:: ::Proxae::{ user=8410575 }, ::{ flag=DK }:: ::Jole::{ user=2883132 }, ::{ flag=AR }:: ::prodilex::{ user=9472628 } |
| Bottom (#97 - #128) | ::{ flag=US }:: ::Matthia::{ user=19804607 }, ::{ flag=US }:: ::ok bye::{ user=15063813 }, ::{ flag=ID }:: ::nayuu::{ user=12561379 }, ::{ flag=MY }:: ::-Einar-::{ user=8782656 }, ::{ flag=PE }:: ::Kien io::{ user=10055648 }, ::{ flag=ID }:: ::Brinhildr::{ user=5833779 }, ::{ flag=MX }:: ::\[LS\]Shuri::{ user=14593518 }, ::{ flag=VN }:: ::Lottery61::{ user=13821222 }, ::{ flag=US }:: ::Tazin\_::{ user=9499508 }, ::{ flag=ES }:: ::RandomeLoL::{ user=7080063 }, ::{ flag=NZ }:: ::sophhhia::{ user=14833226 }, ::{ flag=BR }:: ::Crymeno::{ user=6165105 }, ::{ flag=PH }:: ::Eon Musk::{ user=12239110 }, ::{ flag=IT }:: ::Kiraz::{ user=3807675 }, ::{ flag=RU }:: ::wolfpup08::{ user=11939641 }, ::{ flag=BR }:: ::Namirin-chan::{ user=6761832 }, ::{ flag=BR }:: ::soutin::{ user=11771029 }, ::{ flag=PH }:: ::DaMeMeThEiFxD::{ user=14324153 }, ::{ flag=TH }:: ::basicmaime::{ user=6537441 }, ::{ flag=AR }:: ::jLuyalb::{ user=7093698 }, ::{ flag=BE }:: ::spamblock::{ user=11968058 }, ::{ flag=PL }:: ::\_underjoy::{ user=2235750 }, ::{ flag=US }:: ::dinga dog::{ user=12206447 }, ::{ flag=DE }:: ::Niko\_Plays::{ user=9409456 }, ::{ flag=ID }:: ::Fyl::{ user=10069307 }, ::{ flag=NL }:: ::NightNarumi::{ user=4381142 }, ::{ flag=TH }:: ::MIkuaimbot::{ user=17699745 }, ::{ flag=DE }:: ::medium kek::{ user=11625617 }, ::{ flag=US }:: ::zVols::{ user=17057515 }, ::{ flag=PL }:: ::Mr\_adamello::{ user=7420894 }, ::{ flag=SE }:: ::Trymatic::{ user=14762260 }, ::{ flag=PH }:: ::- O R E O::{ user=17802217 } |
