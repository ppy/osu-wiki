...
The **Springtime osu!mania Free-for-all Tournament 6** (***SOFT 6***) is a 1v1 country-independent osu!mania 4-key tournament.
...
- Spreadsheets
  - [Master](https://docs.google.com/spreadsheets/d/14u2KPvKuiCUMj-LIIrN52abUI2Pl-3OWO1PMARJl2_I/edit?rm=minimal#gid=1898286376)
...
- Regardless of the number of entrants and eliminations, the qualification process will also be done to seed players. Players will be ordered based on their average score rating on all four songs, with the best average score rating being seed \#1, and the worst average score rating being seed _n_; _n_ being the number of players in the qualification stage.
...
- After the qualification round, the remaining players will be divided into 4 different groups based on their qualification seeds. Each group will have a different set of protocol to follow.
  - **1st-16th seeds**: The top 16 seeds of the qualification stage will advance directly into Group Stage of the tournament. They do not need to participate in any matches in Playoff Stage.
  - **17th-32nd seeds**: Players within this group will participate in one match in Playoff Stage. Their opponent will be a player from the 97th to 128th seed group. Players who win their matches in this stage will advance to Group Stage.
  - **33rd-96th seeds**: Players within this group will participate in one match in Playoff Stage. Their opponent will be a player in the 33rd to 96th seed group - more specifically, `(129 - player's seed)`. Players who win their match in this stage will advance to Group Stage.
  - **97th-128th seeds**: Players within this group will participate in **two matches** in Playoff Stage. Their first opponent will be a player in the 97th to 128th seed group - more specifically, `(225 - player's seed)`. If the player wins their first match, their second opponent will be a player in the 17th to 32nd seed group. Players who win both of their matches in this stage will advance to Group Stage.
...
- After Group Stage, the remaining players will be seeded based on their performance in Group Stage. This will be used to determine the remaining players' opponents for the bracket stage. In particular, their opponent for the bracket stage will be `(33 - player's GS seed)`.
...
- ***It is our right as tournament staff to expect that you will arrive for your matches before your expected time***.
  ...
  - In the extreme circumstance where both players do not show, **the player with the higher group stage seed in the match-up will advance automatically**. In Playoff Stage, **the player with the higher qualifier seed in the match-up will advance automatically**.
...
- Warm-up songs will be on FreeMod, which allows for any special modifications that players see fit for the purpose of warming up properly. If agreed upon by both players, warm-up songs can be played on DT or HT so long as their drain time does not exceed the corresponding limits.
...
- Players will be instructed to do a `!roll` command by the referee that is overseeing the match. The player with the winning roll decides whether they want to protect, ban and pick first, or whether they want to protect, ban and pick second.
- After the protects, bans, and rolls have concluded, the player with first pick instructs the referee of their song selection, and the referee will switch to that song. After that song concludes, the other player will pick a song, and this process will continue until one of the two conditions is satisfied:
  ...
  2. Both players are at match point at the same time.
     ...
     - The winner of the tiebreaker will progress to the next match of the tournament, while the loser will be eliminated or sent to the loser's bracket, depending on their position of the tournament.
