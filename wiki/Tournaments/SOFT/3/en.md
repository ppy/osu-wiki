...
| Coordinator | ::{ flag=GB }:: ::-Konner-::{ user=6108644 }, ::{ flag=SG }:: ::Shoegazer::{ user=2520707 } |
| Mappool selector | ::{ flag=US }:: ::Gekido-::{ user=4693052 }, ::{ flag=BR }:: ::Guilhermeziat::{ user=3661387 }, ::{ flag=AR }:: ::juankristal::{ user=443656 }, ::{ flag=SG }:: ::Shoegazer::{ user=2520707 } |
| Referee | ::{ flag=BR }:: ::andreymc::{ user=5691061 }, ::{ flag=US }:: ::Ciel::{ user=1455309 }, ::{ flag=US }:: ::Halogen-::{ user=169992 }, ::{ flag=GB }:: ::Hydria::{ user=808176 }, ::{ flag=AR }:: ::juankristal::{ user=443656 }, ::{ flag=GB }:: ::-Konner-::{ user=6108644 }, ::{ flag=PH }:: ::MapleSyrup-::{ user=1192936 }, ::{ flag=FR }:: ::Mathisca::{ user=2227462 }, ::{ flag=AU }:: ::nonamegohst::{ user=4384859 }, ::{ flag=SG }:: ::Raveille::{ user=1388767 }, ::{ flag=BR }:: ::shadowsnoop::{ user=7064939 }, ::{ flag=PH }:: ::SurfChu85::{ user=4469895 }, ::{ flag=CL }:: ::WalterToro::{ user=5281416 } |
| Streamer | ::{ flag=FI }:: ::Camopoltergeist::{ user=8132964 }, ::{ flag=AR }:: ::juankristal::{ user=443656 }, ::{ flag=SE }:: ::laughingcomet::{ user=3432877 }, ::{ flag=BR }:: ::shadowsnoop::{ user=7064939 }, ::{ flag=RU }:: ::Willjoy::{ user=2484373 } |
| Commentator | ::{ flag=US }:: ::Daikyi::{ user=811832 }, ::{ flag=BR }:: ::Guilhermeziat::{ user=3661387 }, ::{ flag=US }:: ::Halogen-::{ user=169992 }, ::{ flag=AR }:: ::juankristal::{ user=443656 }, ::{ flag=AU }:: ::Knif3rism::{ user=4145830 }, ::{ flag=SE }:: ::laughingcomet::{ user=3432877 }, ::{ flag=AU }:: ::Lusty Platypus::{ user=2956184 }, ::{ flag=AU }:: ::nonamegohst::{ user=4384859 }, ::{ flag=GB }:: ::Pope Gadget::{ user=2288341 }, ::{ flag=AU }:: ::PotassiumF::{ user=4247722 }, ::{ flag=ID }:: ::RemFangirl::{ user=5767941 }, ::{ flag=US }:: ::Ruins::{ user=1408132 }, ::{ flag=SG }:: ::Shoegazer::{ user=2520707 }, ::{ flag=US }:: ::stupud man::{ user=2141612 }, ::{ flag=US }:: ::TheToaphster::{ user=7616811 } |
| Designer | ::{ flag=AR }:: ::aluuu::{ user=4585260 }, ::{ flag=PH }:: ::OsuMe65::{ user=852867 }, ::{ flag=GB }:: ::Pope Gadget::{ user=2288341 }, ::{ flag=US }:: ::Ruins::{ user=1408132 }, ::{ flag=CL }:: ::Valelup::{ user=6497014 } |
| Statistician | ::{ flag=SG }:: ::Shoegazer::{ user=2520707 }, ::{ flag=PH }:: ::SurfChu85::{ user=4469895 } |
...
| Seed | Users |
| :-- | :-- |
| Top (#1 - #16) | ::{ flag=US }:: ::TheToaphster::{ user=7616811 }, ::{ flag=CA }:: ::Dawt::{ user=2747704 }, ::{ flag=US }:: ::-Electro-::{ user=3251373 }, ::{ flag=BR }:: ::Lothus::{ user=9530019 }, ::{ flag=JP }:: ::inteliser::{ user=1824775 }, ::{ flag=SE }:: ::Couil::{ user=6872025 }, ::{ flag=PL }:: ::SitekX::{ user=3840946 }, ::{ flag=ID }:: ::RemFangirl::{ user=5767941 }, ::{ flag=MX }:: ::\_Mytros\_::{ user=6507028 }, ::{ flag=FR }:: ::Azubeur::{ user=1594604 }, ::{ flag=PL }:: ::Tidek::{ user=743282 }, ::{ flag=GB }:: ::Pipper::{ user=4168230 }, ::{ flag=BR }:: ::andreymc::{ user=5691061 }, ::{ flag=ES }:: ::aitor98::{ user=3154852 }, ::{ flag=MY }:: ::Minisora::{ user=9627666 }, ::{ flag=SE }:: ::\[ Vento \]::{ user=1612580 } |
| High (#17 - #32) | ::{ flag=US }:: ::Chrubble::{ user=2594280 }, ::{ flag=CA }:: ::Panshow::{ user=5872899 }, ::{ flag=CL }:: ::Rythze::{ user=469808 }, ::{ flag=US }:: ::DJKhaled::{ user=1718717 }, ::{ flag=CL }:: ::WalterToro::{ user=5281416 }, ::{ flag=US }:: ::HeZeus::{ user=7387788 }, ::{ flag=PH }:: ::MapleSyrup-::{ user=1192936 }, ::{ flag=RU }:: ::Mage::{ user=5527957 }, ::{ flag=US }:: ::RemiFlan::{ user=3061151 }, ::{ flag=GB }:: ::Traps Are Cute::{ user=3359035 }, ::{ flag=GB }:: ::Pope Gadget::{ user=2288341 }, ::{ flag=CN }:: ::DawnX::{ user=8534840 }, ::{ flag=JP }:: ::3KO3::{ user=8107835 }, ::{ flag=PL }:: ::Kamikaze::{ user=2124783 }, ::{ flag=BE }:: ::NightNarumi::{ user=4381142 }, ::{ flag=GB }:: ::xSnaggles::{ user=3799946 } |
| Low (#33 - #96) | ::{ flag=BE }:: ::yetified::{ user=6914714 }, ::{ flag=FR }:: ::Elementaires::{ user=2284328 }, ::{ flag=PL }:: ::\_underjoy::{ user=2235750 }, ::{ flag=TH }:: ::floodlord::{ user=2772110 }, ::{ flag=PH }:: ::SurfChu85::{ user=4469895 }, ::{ flag=PH }:: ::joseee-::{ user=10083439 }, ::{ flag=FI }:: ::Camopoltergeist::{ user=8132964 }, ::{ flag=CA }:: ::CommandoBlack::{ user=7025841 }, ::{ flag=CN }:: ::\[Crz\]ScSolAr::{ user=1591215 }, ::{ flag=JP }:: ::sleetgirl::{ user=10745260 }, ::{ flag=TH }:: ::- \[ Yuki \] -::{ user=7440728 }, ::{ flag=FR }:: ::Cunu::{ user=7190228 }, ::{ flag=JP }:: ::AMDuskia1996::{ user=10242062 }, ::{ flag=AU }:: ::Lusty Platypus::{ user=2956184 }, ::{ flag=PL }:: ::Arkitev::{ user=6905790 }, ::{ flag=CN }:: ::pikechu::{ user=6511662 }, ::{ flag=US }:: ::dhn::{ user=8987388 }, ::{ flag=DE }:: ::LastExceed::{ user=6232245 }, ::{ flag=US }:: ::Neuro-::{ user=7687954 }, ::{ flag=US }:: ::2dw::{ user=9331760 }, ::{ flag=SG }:: ::Polytetral::{ user=8612061 }, ::{ flag=SG }:: ::Raveille::{ user=1388767 }, ::{ flag=FI }:: ::-Oreo-::{ user=5099222 }, ::{ flag=FR }:: ::DemonWaves::{ user=3909293 }, ::{ flag=TH }:: ::Phoenix530::{ user=9633611 }, ::{ flag=BR }:: ::SillyFangirl::{ user=2288363 }, ::{ flag=PL }:: ::Cyan\_Star::{ user=8679184 }, ::{ flag=PH }:: ::Lenfried-::{ user=5314573 }, ::{ flag=CA }:: ::Kengy::{ user=8864630 }, ::{ flag=PL }:: ::DaDarkDragon::{ user=8902097 }, ::{ flag=AU }:: ::PotassiumF::{ user=4247722 }, ::{ flag=PL }:: ::Hlimak::{ user=1340272 }, ::{ flag=FR }:: ::Koiidex::{ user=5193488 }, ::{ flag=US }:: ::Psychodic::{ user=4380139 }, ::{ flag=PL }:: ::Miq::{ user=2424440 }, ::{ flag=CA }:: ::arpia97::{ user=6363008 }, ::{ flag=FR }:: ::Adri::{ user=4579132 }, ::{ flag=ES }:: ::Userbacker::{ user=1872307 }, ::{ flag=PL }:: ::Benzopirene::{ user=1887068 }, ::{ flag=FR }:: ::Tantei B::{ user=6063108 }, ::{ flag=MY }:: ::\[Xiiao\]Ray::{ user=8287005 }, ::{ flag=MY }:: ::Kaname-san92::{ user=764535 }, ::{ flag=GB }:: ::lazer09909::{ user=6222691 }, ::{ flag=PH }:: ::nyx-::{ user=9883834 }, ::{ flag=TH }:: ::TheNewBungping::{ user=6291395 }, ::{ flag=PL }:: ::Nick Wilde::{ user=8902097 }, ::{ flag=ID }:: Lafreniere, ::{ flag=DE }:: ::Malox::{ user=4516252 }, ::{ flag=MY }:: ::never214::{ user=11332742 }, ::{ flag=SE }:: ::YoShiZoRi::{ user=5045509 }, ::{ flag=FI }:: ::princesswell::{ user=4789005 }, ::{ flag=TH }:: ::SharpKunG1412::{ user=6535376 }, ::{ flag=AU }:: ::AngeLItchysick::{ user=9527845 }, ::{ flag=SE }:: ::Craty::{ user=3918056 }, ::{ flag=AU }:: ::-Xenovia-::{ user=5259743 }, ::{ flag=FR }:: ::\_dk::{ user=4592369 }, ::{ flag=PL }:: ::ArchGMSati::{ user=5508623 }, ::{ flag=NL }:: ::2fast4you98::{ user=5183940 }, ::{ flag=BR }:: ::Zergh::{ user=3181281 }, ::{ flag=AR }:: ::Fisk-::{ user=5748843 }, ::{ flag=US }:: ::afrono::{ user=1320102 }, ::{ flag=GB }:: ::SleepyDarkrai::{ user=5063207 }, ::{ flag=PH }:: ::TheArge::{ user=9919550 }, ::{ flag=ZA }:: ::Cyrosu::{ user=7748432 } |
| Bottom (#97 - #128) | ::{ flag=PL }:: ::Moskas::{ user=1934077 }, ::{ flag=MX }:: ::Daybreak::{ user=3072763 }, ::{ flag=DK }:: ::tailsdk::{ user=6751666 }, ::{ flag=PL }:: ::Kroly-::{ user=6382502 }, ::{ flag=ID }:: ::lombit::{ user=5114499 }, ::{ flag=PH }:: ::bananacake304::{ user=3741704 }, ::{ flag=AR }:: ::repoz::{ user=6719880 }, ::{ flag=BR }:: ::Shedin::{ user=4794096 }, ::{ flag=PL }:: ::Open::{ user=7082921 }, ::{ flag=BE }:: ::Akeyro::{ user=1933624 }, ::{ flag=ID }:: ::twistedclever::{ user=10034605 }, ::{ flag=AU }:: ::Framps::{ user=3580643 }, ::{ flag=PH }:: ::\_Shirayukihime\_::{ user=875341 }, ::{ flag=GB }:: ::BlankPxl::{ user=5248545 }, ::{ flag=GB }:: ::Natty2708::{ user=9360317 }, ::{ flag=PL }:: ::Kruppol::{ user=2353894 }, ::{ flag=CL }:: ::Matiias::{ user=3215366 }, ::{ flag=IT }:: ::Enjoy-::{ user=9192514 }, ::{ flag=AR }:: ::BubShish::{ user=7110363 }, ::{ flag=US }:: ::Fizzy::{ user=6805802 }, ::{ flag=CA }:: ::loafusofbread::{ user=9278959 }, ::{ flag=GB }:: ::loopyloo::{ user=6562873 }, ::{ flag=BR }:: ::StartMetal::{ user=7806505 }, ::{ flag=DE }:: ::Kaionacho::{ user=4680653 }, ::{ flag=AU }:: ::Spartan-::{ user=2145124 }, ::{ flag=PH }:: ::Mentai Cosmic::{ user=6908508 }, ::{ flag=PL }:: ::Brunosky::{ user=1639587 }, ::{ flag=ES }:: ::Nyanpasuuu::{ user=5442427 }, ::{ flag=PH }:: ::Kaleiodo::{ user=4657592 }, ::{ flag=IT }:: ::Tantuz::{ user=7794657 }, ::{ flag=AR }:: ::JotaCe::{ user=4502231 }, ::{ flag=PL }:: ::jasionnn::{ user=6886081 } |
...
| Placing | User |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=BR }:: ::Lothus::{ user=9530019 } |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=JP }:: ::inteliser::{ user=1824775 } |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=US }:: ::TheToaphster::{ user=7616811 } |
