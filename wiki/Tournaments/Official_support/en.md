...
- The tournament does not collect any sensitive personal documentation from any users for any reason unless strictly required by law.
  ...
  - If your country has a legal requirement which requires official identification of your players, these legal requirements must be submitted to [tournaments@ppy.sh](mailto:tournaments@ppy.sh) well in advance of your competition and must be approved by the osu! team.
