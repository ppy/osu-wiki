...
- La hauteur doit toujours être **180px**. Les autres valeurs NE conviennent pas.
- Toutes les images de bannière seront traitées en tant que `2x`, ce qui signifie qu'elles seront exportées à une échelle de 50% dans une image `1x`. Concevez vos images de manière à ce qu'elles soient lisibles à la moitié de leur taille. Les utilisateurs verront l'une ou l'autre image en fonction de la résolution qu'ils auront choisie.
