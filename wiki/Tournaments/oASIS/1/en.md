...
The **osu! Amateur Solo Indonesia Showdown** (***oASIS*** or ***o!ASIS***) was a double-elimination 1v1 osu! tournament hosted by ::{ flag=ID }:: ::Millie::{ user=3484548 }. The tournament was open to all players from Indonesia with a global rank of #10,000 or lower. It was the first instalment of the osu! Amateur Solo Indonesia Showdown tournament series.
...
| Mappool selector | ::{ flag=ID }:: ::-TwiHD::{ user=5470299 }, ::{ flag=ID }:: ::BlankTap::{ user=10137131 }, ::{ flag=ID }:: ::Seox::{ user=3793938 } |
| Mappool helper | ::{ flag=ID }:: ::Millie::{ user=3484548 }, ::{ flag=ID }:: ::Niva::{ user=197805 }, ::{ flag=ID }:: ::Kuro Fuyusaki::{ user=2667496 } |
| Playtester | ::{ flag=ID }:: ::malvon::{ user=11113661 }, ::{ flag=ID }:: ::Caviar-::{ user=10474988 }, ::{ flag=ID }:: ::PatrickFPSGamer::{ user=4796773 } |
| Streamer | ::{ flag=ID }:: ::Millie::{ user=3484548 }, ::{ flag=MY }:: ::Laphii::{ user=9364594 } |
| Commentator | ::{ flag=ID }:: ::Millie::{ user=3484548 }, ::{ flag=ID }:: ::BlankTap::{ user=10137131 } |
| Referee | ::{ flag=ID }:: ::YaeMyMommy::{ user=17278897 }, ::{ flag=ID }:: ::Vincent A::{ user=11050632 }, ::{ flag=MY }:: ::Kokoro Amamiya::{ user=9534110 }, ::{ flag=PH }:: ::-Pekora-::{ user=17959882 }, ::{ flag=HK }:: ::ShadeCegLgMn::{ user=12609866 } |
| Graphic designer | ::{ flag=ID }:: ::Felter::{ user=5865319 } |
| Spreadsheet manager | ::{ flag=ID }:: ::Millie::{ user=3484548 } |
...
| :-: | :-- | :-- |
| 1 | ::{ flag=ID }:: ::im a cute bunny::{ user=12578000 } | 10.566 |
| 2 | ::{ flag=ID }:: ::akebono::{ user=1815316 } | 10.337 |
| 3 | ::{ flag=ID }:: ::nsfuu::{ user=10849159 } | 10.154 |
| 4 | ::{ flag=ID }:: ::SDKO::{ user=4858555 } | 9.258 |
| 5 | ::{ flag=ID }:: ::Icun::{ user=17908427 } | 9.114 |
| 6 | ::{ flag=ID }:: ::Zoont::{ user=7109269 } | 8.832 |
| 7 | ::{ flag=ID }:: ::AlanEt::{ user=15037088 } | 8.825 |
| 8 | ::{ flag=ID }:: ::-CircleParadox-::{ user=10423227 } | 8.788 |
| 9 | ::{ flag=ID }:: ::Frixell::{ user=15601286 } | 8.630 |
| 10 | ::{ flag=ID }:: ::fnayR::{ user=2800253 } | 8.533 |
| 11 | ::{ flag=ID }:: ::cerena::{ user=5411734 } | 8.345 |
| 12 | ::{ flag=ID }:: ::CubeixID200::{ user=10678919 } | 7.996 |
| 13 | ::{ flag=ID }:: ::Honoka-Chan::{ user=11912828 } | 7.768 |
| 14 | ::{ flag=ID }:: ::ArchieA7::{ user=7087699 } | 7.710 |
| 15 | ::{ flag=ID }:: ::HyuugaDesuka::{ user=22684871 } | 7.705 |
| 16 | ::{ flag=ID }:: ::-Lunix::{ user=12964890 } | 7.550 |
...
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | ::akebono::{ user=1815316 } ::{ flag=ID }:: | 5 | **7** | ::{ flag=ID }:: **::SDKO::{ user=4858555 }** | [#1](https://osu.ppy.sh/community/matches/107421064) |

Monday, 21 March 2023, Grand Final:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Grand Final | **::im a cute bunny::{ user=12578000 }** ::{ flag=ID }:: | **7** | 4 | ::{ flag=ID }:: ::SDKO::{ user=4858555 } | [#1](https://osu.ppy.sh/community/matches/107484474) |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | ::Icun::{ user=17908427 } ::{ flag=ID }:: | 3 | **7** | ::{ flag=ID }:: **::nsfuu::{ user=10849159 }** | [#1](https://osu.ppy.sh/community/matches/107284824) |

Saturday, 11 March 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | ::cerena::{ user=5411734 } ::{ flag=ID }:: | 3 | **7** | ::{ flag=ID }:: **::SDKO::{ user=4858555 }** | [#1](https://osu.ppy.sh/community/matches/107300886) |

Sunday, 12 March 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::im a cute bunny::{ user=12578000 }** ::{ flag=ID }:: | **7** | 4 | ::{ flag=ID }:: ::akebono::{ user=1815316 } | [#1](https://osu.ppy.sh/community/matches/107306855) |
| Lower | ::nsfuu::{ user=10849159 } ::{ flag=ID }:: | 0 | **7** | ::{ flag=ID }:: **::SDKO::{ user=4858555 }** | *win by default* |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | **::nsfuu::{ user=10849159 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::Frixell::{ user=15601286 } | [#1](https://osu.ppy.sh/community/matches/107153567) |

Saturday, 4 March 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | ::-CircleParadox-::{ user=10423227 } ::{ flag=ID }:: | 2 | **6** | ::{ flag=ID }:: **::Zoont::{ user=7109269 }** | [#1](https://osu.ppy.sh/community/matches/107172717) |
| Upper | **::im a cute bunny::{ user=12578000 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::Icun::{ user=17908427 } | [#1](https://osu.ppy.sh/community/matches/107171437) |
| Lower | **::fnayR::{ user=2800253 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::CubeixID200::{ user=10678919 } | [#1](https://osu.ppy.sh/community/matches/107175274) |
| Lower | **::SDKO::{ user=4858555 }** ::{ flag=ID }:: | **6** | 3 | ::{ flag=ID }:: ::HyuugaDesuka::{ user=22684871 } | [#1](https://osu.ppy.sh/community/matches/107174242) |

Sunday, 5 March 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | **::SDKO::{ user=4858555 }** ::{ flag=ID }:: | **6** | 3 | ::{ flag=ID }:: ::Zoont::{ user=7109269 } | [#1](https://osu.ppy.sh/community/matches/107197629) |

Monday, 6 March 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | **::nsfuu::{ user=10849159 }** ::{ flag=ID }:: | **6** | 0 | ::{ flag=ID }:: ::fnayR::{ user=2800253 } | [#1](https://osu.ppy.sh/community/matches/107197662) |
| Upper | **::akebono::{ user=1815316 }** ::{ flag=ID }:: | **6** | 3 | ::{ flag=ID }:: ::cerena::{ user=5411734 } | [#1](https://osu.ppy.sh/community/matches/107210408) |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | ::nsfuu::{ user=10849159 } ::{ flag=ID }:: | 4 | **6** | ::{ flag=ID }:: **::cerena::{ user=5411734 }** | [#1](https://osu.ppy.sh/community/matches/107028501) |

Saturday, 25 February 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Lower | **::CubeixID200::{ user=10678919 }** ::{ flag=ID }:: | **6** | 3 | ::{ flag=ID }:: ::Honoka-Chan::{ user=11912828 } | [#1](https://osu.ppy.sh/community/matches/107045025) |

Sunday, 26 February 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | ::SDKO::{ user=4858555 } ::{ flag=ID }:: | 3 | **6** | ::{ flag=ID }:: **::Icun::{ user=17908427 }** | [#1](https://osu.ppy.sh/community/matches/107066197) |
| Lower | **::HyuugaDesuka::{ user=22684871 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::AlanEt::{ user=15037088 } | [#1](https://osu.ppy.sh/community/matches/107069121) |
| Lower | **::Frixell::{ user=15601286 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::-Lunix::{ user=12964890 } | [#1](https://osu.ppy.sh/community/matches/107070091) |
| Upper | **::im a cute bunny::{ user=12578000 }** ::{ flag=ID }:: | **6** | 0 | ::{ flag=ID }:: ::-CircleParadox-::{ user=10423227 } | [#1](https://osu.ppy.sh/community/matches/107071382) |
| Upper | **::akebono::{ user=1815316 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::fnayR::{ user=2800253 } | [#1](https://osu.ppy.sh/community/matches/107071230) |
| Lower | **::Zoont::{ user=7109269 }** ::{ flag=ID }:: | **6** | 2 | ::{ flag=ID }:: ::ArchieA7::{ user=7087699 } | [#1](https://osu.ppy.sh/community/matches/107072405) |
...
| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | **::Icun::{ user=17908427 }** ::{ flag=ID }:: | **5** | 2 | ::{ flag=ID }:: ::CubeixID200::{ user=10678919 } | [#1](https://osu.ppy.sh/community/matches/106873620) |
| Upper | **::-CircleParadox-::{ user=10423227 }** ::{ flag=ID }:: | **5** | 4 | ::{ flag=ID }:: ::Frixell::{ user=15601286 } | [#1](https://osu.ppy.sh/community/matches/106891584) |

Saturday, 18 February 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | ::Zoont::{ user=7109269 } ::{ flag=ID }:: | 4 | **5** | ::{ flag=ID }:: **::cerena::{ user=5411734 }** | [#1](https://osu.ppy.sh/community/matches/106913383) |
| Upper | **::nsfuu::{ user=10849159 }** ::{ flag=ID }:: | **5** | 1 | ::{ flag=ID }:: ::ArchieA7::{ user=7087699 } | [#1](https://osu.ppy.sh/community/matches/106914487) |
| Upper | **::akebono::{ user=1815316 }** ::{ flag=ID }:: | **5** | 4 | ::{ flag=ID }:: ::HyuugaDesuka::{ user=22684871 } | [#1](https://osu.ppy.sh/community/matches/106915198) |
| Upper | **::im a cute bunny::{ user=12578000 }** ::{ flag=ID }:: | **5** | 0 | ::{ flag=ID }:: ::-Lunix::{ user=12964890 } | [#1](https://osu.ppy.sh/community/matches/106912181) |

Sunday, 19 February 2023:

| Bracket | Player 1 |  |  | Player 2 | Match link |
| :-: | --: | :-: | :-: | :-- | :-- |
| Upper | ::AlanEt::{ user=15037088 } ::{ flag=ID }:: | 4 | **5** | ::{ flag=ID }:: **::fnayR::{ user=2800253 }** | [#1](https://osu.ppy.sh/community/matches/106937367) |
| Upper | **::SDKO::{ user=4858555 }** ::{ flag=ID }:: | **5** | 0 | ::{ flag=ID }:: ::Honoka-Chan::{ user=11912828 } | [#1](https://osu.ppy.sh/community/matches/106931400) |
