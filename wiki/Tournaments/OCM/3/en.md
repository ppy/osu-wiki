...
The **osu! Cup Master 3: osu!catch edition** (***OCM3***) is a a two-on-two team based osu!catch tournament hosted by ::{ flag=PA }:: ::Jafett::{ user-id=2317102 } and ::{ flag=MX }:: ::daxeroz::{ user-id=1170156 }. It is the third instalment of the osu! Cup Master.
...
| Position | Member(s) |
| :-: | :-- |
| Host | ::{ flag=PA }:: ::Jafett::{ user-id=2317102 }, ::{ flag=MX }:: ::daxeroz::{ user-id=1170156 } |
| Manager | ::{ flag=CL }:: ::Metak::{ user-id=2861255 } |
| Mappool selector | ::{ flag=MX }:: ::daxeroz::{ user-id=1170156 }, ::{ flag=MX }:: ::firu::{ user-id=10516547 } , ::{ flag=CL }:: ::lineqtxz::{ user-id=989542 } |
| Commentator | ::{ flag=PE }:: ::-Boltic-::{ user-id=5297904 }, ::{ flag=FR }:: ::Rougoku::{ user-id=6900166 }, ::{ flag=CL }:: ::lechuguin::{ user-id=2872000 }, ::{ flag=LU }:: ::Gae::{ user-id=7787785 }, ::{ flag=ID }:: ::dika312::{ user-id=741613 } |
| Referee | ::{ flag=CL }:: ::Hinoshi::{ user-id=9200197 }, ::{ flag=PE }:: ::-Boltic-::{ user-id=5297904 }, ::{ flag=CL }:: ::Danilo::{ user-id=1350613 }, ::{ flag=CL }:: ::Metak::{ user-id=2861255 }, ::{ flag=UY }:: ::Neimex23::{ user-id=7293703 }, ::{ flag=GB }:: ::StartAndSelect::{ user-id=8720555 }, ::{ flag=PA }:: ::Jafett::{ user-id=2317102 } |
| Designer | ::{ flag=MX }:: ::ShadowMerry::{ user-id=3104864 } |
| Streamer | ::{ flag=MX }:: ::daxeroz::{ user-id=1170156 }, ::{ flag=LU }:: ::Gae::{ user-id=7787785 } |
...
|  | Team | Members |
| :-: | :-: | :-- |
| ![](img/teams/acelga.png) | Acelga | ::{ flag=CL }:: ::eldnl::{ user-id=285756 }, ::{ flag=CL }:: ::Aryssiel::{ user-id=2389481 }, ::{ flag=CL }:: ::NachoL::{ user-id=1250096 } |
| ![](img/teams/mybloodtrailsoplica.png) | My blood trail soplica | ::{ flag=PL }:: ::Phob::{ user-id=6069462 }, ::{ flag=PL }:: ::Mniam::{ user-id=6050530 }, ::{ flag=PL }:: ::Verti::{ user-id=10674528 } |
| ![](img/teams/loschoripondios.png) | Los Choripondios | ::{ flag=CL }:: ::alluya69::{ user-id=2212951 }, ::{ flag=CL }:: ::-Kotaru-::{ user-id=9131357 }, ::{ flag=CL }:: ::-Naroh::{ user-id=9087831 } |
| ![](img/teams/115.png) | 115 | ::{ flag=ES }:: ::Dogma::{ user-id=4175333 }, ::{ flag=DE }:: ::bro gamer NR1::{ user-id=9573527 }, ::{ flag=JP }:: ::noob desu::{ user-id=4808804 }, ::{ flag=US }:: ::ChewyTarTar::{ user-id=13978275 } |
| ![](img/teams/bjirrsquad.png) | Bjirr Squad | ::{ flag=ID }:: ::Chiya--::{ user-id=7934854 }, ::{ flag=ID }:: ::ZYX\1GAME::{ user-id=3770612 }, ::{ flag=ID }:: ::Zephirine::{ user-id=9629190 } |
| ![](img/teams/iaffi.png) | Iaffi | ::{ flag=CL }:: ::Lyna Paulina::{ user-id=10434422 }, ::{ flag=HN }:: ::- AnGel::{ user-id=12931440 }, ::{ flag=HN }:: ::\1-Cris-\1::{ user-id=14599677 } |
| ![](img/teams/wwwww.png) | wwwww | ::{ flag=AR }:: ::-Story-::{ user-id=8172283 }, ::{ flag=AU }:: ::Beerus::{ user-id=5529199 }, ::{ flag=GB }:: ::Matt\1H::{ user-id=4067115 } |
| ![](img/teams/krns.png) | KNRS | ::{ flag=FR }:: ::Noctalium::{ user-id=6488167 }, ::{ flag=FR }:: ::Kasumii-sama::{ user-id=6177263 }, ::{ flag=FR }:: ::Shyeart::{ user-id=2022144 }, ::{ flag=FR }:: ::Rougoku::{ user-id=6900166 } |
| ![](img/teams/futalovers.png) | Futa Lovers | ::{ flag=BR }:: ::BeyondArea::{ user-id=8642224 }, ::{ flag=BR }:: ::S a y u n::{ user-id=3770603 }, ::{ flag=BR }:: ::Endou-::{ user-id=10792711 }, ::{ flag=BR }:: ::Hanik::{ user-id=4533507 } |
| ![](img/teams/smukur.png) | Smukur es colombiano | ::{ flag=CO }:: ::Titan-::{ user-id=7855767 }, ::{ flag=CO }:: ::Zyonii::{ user-id=9519851 }, ::{ flag=MX }:: ::Cxlucha::{ user-id=5063961 }, ::{ flag=PE }:: ::-Boltic-::{ user-id=5297904 } |
| ![](img/teams/izayoi.png) | IZAYOI XXX is the captain | ::{ flag=TW }:: ::Timewasdeapsea::{ user-id=8682905 }, ::{ flag=TW }:: ::IZAYOI XXX::{ user-id=3538446 }, ::{ flag=TW }:: ::Psc\1IceRain::{ user-id=3359485 }, ::{ flag=TW }:: ::qq11123334::{ user-id=11807319 } |
| ![](img/teams/qtdoku.png) | QT DOKU | ::{ flag=JP }:: ::LieLoom::{ user-id=4892798 }, ::{ flag=HK }:: ::Novoids::{ user-id=5163523 }, ::{ flag=ID }:: ::LeWind::{ user-id=9718235 }, ::{ flag=RU }:: ::Kitsunlvy::{ user-id=7055384 } |
| ![](img/teams/idk2.png) | idk lol | ::{ flag=US }:: ::Depths::{ user-id=3935174 }, ::{ flag=HK }:: ::AutoLs::{ user-id=9155988 }, ::{ flag=US }:: ::Secre::{ user-id=2306637 }, ::{ flag=US }:: ::diao::{ user-id=500696 } |
| ![](img/teams/araganes.png) | Araganes | ::{ flag=CO }:: ::Deley-::{ user-id=8291465 }, ::{ flag=CO }:: ::Juansy-::{ user-id=12588215 }, ::{ flag=VE }:: ::Hisashi Shimoro::{ user-id=6736420 } |
| ![](img/teams/obama.png) | Obama's Bizarre adventures | ::{ flag=PL }:: ::AmaZ::{ user-id=6097002 }, ::{ flag=PL }:: ::Jakkubon::{ user-id=3396013 }, ::{ flag=TW }:: ::Sanami::{ user-id=1629471 }, ::{ flag=FI }:: ::forgottentaco::{ user-id=6109660 } |
| ![](img/teams/retired.png) | Retired players comeback | ::{ flag=PL }:: ::BoberOfDarkness::{ user-id=3427748 }, ::{ flag=PL }:: ::Kosmit::{ user-id=1749173 }, ::{ flag=PL }:: ::Krzysiek::{ user-id=294277 }, ::{ flag=PL }:: ::schizosvenia::{ user-id=4600126 } |
