...
The **osu! Cup Master 3: osu!catch edition** (***OCM3***) is a a two-on-two team based osu!catch tournament hosted by ::{ flag=PA }:: ::Jafett::{ user=2317102 } and ::{ flag=MX }:: ::daxeroz::{ user=1170156 }. It is the third instalment of the osu! Cup Master.
...
| Position | Member(s) |
| :-: | :-- |
| Host | ::{ flag=PA }:: ::Jafett::{ user=2317102 }, ::{ flag=MX }:: ::daxeroz::{ user=1170156 } |
| Manager | ::{ flag=CL }:: ::Metak::{ user=2861255 } |
| Mappool selector | ::{ flag=MX }:: ::daxeroz::{ user=1170156 }, ::{ flag=MX }:: ::firu::{ user=10516547 } , ::{ flag=CL }:: ::lineqtxz::{ user=989542 } |
| Commentator | ::{ flag=PE }:: ::-Boltic-::{ user=5297904 }, ::{ flag=FR }:: ::Rougoku::{ user=6900166 }, ::{ flag=CL }:: ::lechuguin::{ user=2872000 }, ::{ flag=LU }:: ::Gae::{ user=7787785 }, ::{ flag=ID }:: ::dika312::{ user=741613 } |
| Referee | ::{ flag=CL }:: ::Hinoshi::{ user=9200197 }, ::{ flag=PE }:: ::-Boltic-::{ user=5297904 }, ::{ flag=CL }:: ::Danilo::{ user=1350613 }, ::{ flag=CL }:: ::Metak::{ user=2861255 }, ::{ flag=UY }:: ::Neimex23::{ user=7293703 }, ::{ flag=GB }:: ::StartAndSelect::{ user=8720555 }, ::{ flag=PA }:: ::Jafett::{ user=2317102 } |
| Designer | ::{ flag=MX }:: ::ShadowMerry::{ user=3104864 } |
| Streamer | ::{ flag=MX }:: ::daxeroz::{ user=1170156 }, ::{ flag=LU }:: ::Gae::{ user=7787785 } |
...
|  | Team | Members |
| :-: | :-: | :-- |
| ![](img/teams/acelga.png) | Acelga | ::{ flag=CL }:: ::eldnl::{ user=285756 }, ::{ flag=CL }:: ::Aryssiel::{ user=2389481 }, ::{ flag=CL }:: ::NachoL::{ user=1250096 } |
| ![](img/teams/mybloodtrailsoplica.png) | My blood trail soplica | ::{ flag=PL }:: ::Phob::{ user=6069462 }, ::{ flag=PL }:: ::Mniam::{ user=6050530 }, ::{ flag=PL }:: ::Verti::{ user=10674528 } |
| ![](img/teams/loschoripondios.png) | Los Choripondios | ::{ flag=CL }:: ::alluya69::{ user=2212951 }, ::{ flag=CL }:: ::-Kotaru-::{ user=9131357 }, ::{ flag=CL }:: ::-Naroh::{ user=9087831 } |
| ![](img/teams/115.png) | 115 | ::{ flag=ES }:: ::Dogma::{ user=4175333 }, ::{ flag=DE }:: ::bro gamer NR1::{ user=9573527 }, ::{ flag=JP }:: ::noob desu::{ user=4808804 }, ::{ flag=US }:: ::ChewyTarTar::{ user=13978275 } |
| ![](img/teams/bjirrsquad.png) | Bjirr Squad | ::{ flag=ID }:: ::Chiya--::{ user=7934854 }, ::{ flag=ID }:: ::ZYX\1GAME::{ user=3770612 }, ::{ flag=ID }:: ::Zephirine::{ user=9629190 } |
| ![](img/teams/iaffi.png) | Iaffi | ::{ flag=CL }:: ::Lyna Paulina::{ user=10434422 }, ::{ flag=HN }:: ::- AnGel::{ user=12931440 }, ::{ flag=HN }:: ::\1-Cris-\1::{ user=14599677 } |
| ![](img/teams/wwwww.png) | wwwww | ::{ flag=AR }:: ::-Story-::{ user=8172283 }, ::{ flag=AU }:: ::Beerus::{ user=5529199 }, ::{ flag=GB }:: ::Matt\1H::{ user=4067115 } |
| ![](img/teams/krns.png) | KNRS | ::{ flag=FR }:: ::Noctalium::{ user=6488167 }, ::{ flag=FR }:: ::Kasumii-sama::{ user=6177263 }, ::{ flag=FR }:: ::Shyeart::{ user=2022144 }, ::{ flag=FR }:: ::Rougoku::{ user=6900166 } |
| ![](img/teams/futalovers.png) | Futa Lovers | ::{ flag=BR }:: ::BeyondArea::{ user=8642224 }, ::{ flag=BR }:: ::S a y u n::{ user=3770603 }, ::{ flag=BR }:: ::Endou-::{ user=10792711 }, ::{ flag=BR }:: ::Hanik::{ user=4533507 } |
| ![](img/teams/smukur.png) | Smukur es colombiano | ::{ flag=CO }:: ::Titan-::{ user=7855767 }, ::{ flag=CO }:: ::Zyonii::{ user=9519851 }, ::{ flag=MX }:: ::Cxlucha::{ user=5063961 }, ::{ flag=PE }:: ::-Boltic-::{ user=5297904 } |
| ![](img/teams/izayoi.png) | IZAYOI XXX is the captain | ::{ flag=TW }:: ::Timewasdeapsea::{ user=8682905 }, ::{ flag=TW }:: ::IZAYOI XXX::{ user=3538446 }, ::{ flag=TW }:: ::Psc\1IceRain::{ user=3359485 }, ::{ flag=TW }:: ::qq11123334::{ user=11807319 } |
| ![](img/teams/qtdoku.png) | QT DOKU | ::{ flag=JP }:: ::LieLoom::{ user=4892798 }, ::{ flag=HK }:: ::Novoids::{ user=5163523 }, ::{ flag=ID }:: ::LeWind::{ user=9718235 }, ::{ flag=RU }:: ::Kitsunlvy::{ user=7055384 } |
| ![](img/teams/idk2.png) | idk lol | ::{ flag=US }:: ::Depths::{ user=3935174 }, ::{ flag=HK }:: ::AutoLs::{ user=9155988 }, ::{ flag=US }:: ::Secre::{ user=2306637 }, ::{ flag=US }:: ::diao::{ user=500696 } |
| ![](img/teams/araganes.png) | Araganes | ::{ flag=CO }:: ::Deley-::{ user=8291465 }, ::{ flag=CO }:: ::Juansy-::{ user=12588215 }, ::{ flag=VE }:: ::Hisashi Shimoro::{ user=6736420 } |
| ![](img/teams/obama.png) | Obama's Bizarre adventures | ::{ flag=PL }:: ::AmaZ::{ user=6097002 }, ::{ flag=PL }:: ::Jakkubon::{ user=3396013 }, ::{ flag=TW }:: ::Sanami::{ user=1629471 }, ::{ flag=FI }:: ::forgottentaco::{ user=6109660 } |
| ![](img/teams/retired.png) | Retired players comeback | ::{ flag=PL }:: ::BoberOfDarkness::{ user=3427748 }, ::{ flag=PL }:: ::Kosmit::{ user=1749173 }, ::{ flag=PL }:: ::Krzysiek::{ user=294277 }, ::{ flag=PL }:: ::schizosvenia::{ user=4600126 } |
