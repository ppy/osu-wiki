...
|  | Country | Members |
| :-: | :-- | :-- |
| ::{ flag=AR }:: | **Argentina** | **::APRL03::{ user=11394892 }**, ::joako_loco::{ user=13659177 }, ::monten505::{ user=21702734 }, ::Mateo12345::{ user=16481146 }, ::Iplaygames13::{ user=24253806 }, ::ElMancoDelSiglo::{ user=22447212 } |
| ::{ flag=AU }:: | **Australia** | **::PotassiumF::{ user=4247722 }**, ::HD_AdreNaline::{ user=10540368 }, ::Orcanos::{ user=13762441 }, ::-Ainsel-::{ user=27855382 }, ::Jerold::{ user=18481219 }, ::-Willow-::{ user=11247298 } |
...
| ::{ flag=CZ }:: | **Czechia-Slovakia** | **::Kiruliatkoska::{ user=13013350 }**, ::144p_uhd::{ user=19156437 }, ::Foxy007cz::{ user=17740440 }, ::TicTimeless::{ user=15142530 }, ::AlejarTV::{ user=12568571 } |
...
| ::{ flag=FR }:: | **France** | **::Jerem\[Monkey\]::{ user=13431947 }**, ::- Stay -::{ user=19910862 }, ::\[RUE\]J K L::{ user=16518063 }, ::Simca_::{ user=9718775 }, ::billiack::{ user=14013641 }, ::ssiizz_::{ user=16487992 } |
| ::{ flag=DE }:: | **Germany** | **::ERA medium kek::{ user=11625617 }**, ::Crqstalized7::{ user=14131275 }, ::Blacku1::{ user=14160917 }, ::ERA Sirbeyy::{ user=12917829 }, ::Lotex09::{ user=14114899 }, ::Niko_Plays::{ user=9409456 } |
| ::{ flag=GR }:: | **Greece** | **::-Puyu::{ user=10398348 }**, ::TreaKii::{ user=17665565 }, ::Demersio::{ user=30279494 }, ::\[FB\] Debris::{ user=34120247 } |
| ::{ flag=HK }:: | **Hong Kong** | **::pofnkul::{ user=23717210 }**, ::popy_gd::{ user=30829023 }, ::\[Mom\] -So1-::{ user=18265431 }, ::\[Mom\] xbob::{ user=18481445 }, ::TheAo0402::{ user=16157387 }, ::ERDFS::{ user=28707779 } |
...
| ::{ flag=JP }:: | **Japan** | **::AxReo::{ user=10924058 }**, ::hashimoto1129::{ user=14832777 }, ::yoshyap::{ user=16608860 }, ::HyAn3355::{ user=19500985 }, ::rusk_BT::{ user=6795897 }, ::faaaaas::{ user=28750311 } |
...
| ::{ flag=MX }:: | **Mexico** | **::Dex uwu::{ user=12084755 }**, ::happergamer::{ user=15513319 }, ::\[TK\]Martin_22::{ user=9653729 }, ::\[DT\] Lun1x::{ user=20578625 }, ::\[TK\]Mapxa::{ user=16078911 }, ::Sillot::{ user=29716889 } |
...
| ::{ flag=RO }:: | **Romania** | **::Mich_::{ user=11784492 }**, ::Bluestone413::{ user=17705451 }, ::SplatK::{ user=28168805 }, ::RteEz::{ user=15265534 }, ::Kiirbo::{ user=14985143 } |
...
| ::{ flag=SG }:: | **Singapore** | **::Fallingtuna::{ user=19834488 }**, ::MrDabian::{ user=19660729 }, ::dolfin-_::{ user=24531833 }, ::Pokeccino::{ user=18472374 }, ::Master193::{ user=16724650 }, ::megasheeper::{ user=21903060 } |
...
| ::{ flag=TW }:: | **Taiwan** | **::amano_hina::{ user=19882148 }**, ::-Veloce-::{ user=23248427 }, ::diablorex1234::{ user=11912607 }, ::Shice2566::{ user=16191180 }, ::Hanson351::{ user=26888475 }, ::SaKuRaLaN::{ user=6193819 } |
...
| ::{ flag=TR }:: | **Türkiye** | **::Zmor0133::{ user=6419257 }**, ::Ahmet_Selman::{ user=27296956 }, ::hel0l::{ user=28554005 } |
...
| Placing | Team |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=VN }:: **Vietnam** (**::\[LS\]Vixile::{ user=26233321 }**, ::\[LS\]Tokiyume::{ user=13219309 }, ::OrangeJuiceQT::{ user=24534466 }, ::SturpdaFuro::{ user=22644374 }, ::Rxizuna::{ user=16055641 }, ::TvS SorAKuN::{ user=11115041 }) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=US }:: **United States** (**::Retina::{ user=11392859 }**, ::Tonels::{ user=15179858 }, ::ERA Basil::{ user=7097990 }, ::z2a::{ user=12542173 }, ::charlie72::{ user=14177626 }, ::- Sky -::{ user=15255368 }) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=TW }:: **Taiwan** (**::amano_hina::{ user=19882148 }**, ::-Veloce-::{ user=23248427 }, ::diablorex1234::{ user=11912607 }, ::Shice2566::{ user=16191180 }, ::Hanson351::{ user=26888475 }, ::SaKuRaLaN::{ user=6193819 }) |
