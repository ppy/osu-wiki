...
|  | Country | Members |
| :-: | :-: | :-- |
| ::{ flag=AR }:: | **Argentina** | **::Greedom::{ user=10696707 }**, ::BL5::{ user=13187997 }, ::menphiss::{ user=6185083 }, ::NEDEAAAHHHH::{ user=65724 }, ::prodilex::{ user=9472628 }, ::-ZiRo-::{ user=14233342 } |
| ::{ flag=AU }:: | **Australia** | **::HD\_AdreNaline::{ user=10540368 }**, ::DarkistDeci::{ user=13360768 }, ::fvrex::{ user=11863699 }, ::Nerd Guy::{ user=11247298 }, ::saturnide::{ user=14670668 }, ::shnacc::{ user=11373924 } |
| ::{ flag=BE }:: | **Belgium** | **::spamblock::{ user=11968058 }**, ::flyerbram002::{ user=12725421 }, ::furious\_0803::{ user=14306726 }, ::Joppe27::{ user=11753018 }, ::Lumacasi::{ user=12654779 }, ::shaafs::{ user=8811695 } |
| ::{ flag=BR }:: | **Brazil** | **::Yuragi::{ user=8501380 }**, ::Chiara::{ user=5642989 }, ::Halo-::{ user=7572142 }, ::Lenn::{ user=11236829 }, ::Namirin-chan::{ user=6761832 }, ::Soore::{ user=15753462 } |
| ::{ flag=CA }:: | **Canada** | **::Sinaeb::{ user=1576095 }**, ::\[LS\]Byte::{ user=15174223 }, ::Aesis::{ user=7253252 }, ::archived\_files::{ user=16468962 }, ::jac0b150::{ user=9160118 }, ::pqq::{ user=13576147 } |
| ::{ flag=CN }:: | **China** | **::Tamaki Iroha::{ user=11238501 }**, ::-H i k a r i-::{ user=7109287 }, ::Mimosa\_::{ user=9623928 }, ::Peri\_Spirit::{ user=17908964 }, ::Remilia\_HY::{ user=9189444 }, ::Snowkyou::{ user=12513448 } |
| ::{ flag=DO }:: | **Dominican Republic** | **::Antalf::{ user=8793773 }**, ::Fortnito::{ user=9964045 }, ::-Julio::{ user=13663757 }, ::Kaito-kun::{ user=4715184 } |
| ::{ flag=FI }:: | **Finland** | **::Oreo::{ user=5099222 }**, ::Akseliq::{ user=10393606 }, ::Megaforce::{ user=4487551 }, ::Nauchi::{ user=10157316 } |
| ::{ flag=FR }:: | **France** | **::ZayyKen::{ user=8624433 }**, ::Adri::{ user=4579132 }, ::Limbecile::{ user=12341059 }, ::Paturages::{ user=1375479 }, ::Ping36::{ user=9388217 }, ::Satsukel::{ user=9066390 } |
| ::{ flag=DE }:: | **Germany** | **::Niko\_Plays::{ user=9409456 }**, ::cakeboss05::{ user=12586864 }, ::Der\_Entsafter69::{ user=13210231 }, ::medium kek::{ user=11625617 }, ::Sirbeyy::{ user=12917829 }, ::Tiger::{ user=10242297 } |
| ::{ flag=HK }:: | **Hong Kong** | **::Irone OSU::{ user=10678230 }**, ::-\[ Infinity \]-::{ user=13354367 }, ::\[\_isolated\_\]::{ user=6187838 }, ::MCPXiaoBai::{ user=11259611 }, ::roy2206::{ user=15035633 }, ::Ryan413::{ user=14178967 } |
| ::{ flag=ID }:: | **Indonesia** | **::Fyl::{ user=10069307 }**, ::Brinhildr::{ user=5833779 }, ::Fr05tyGD::{ user=14230684 }, ::Jibran-::{ user=14588134 }, ::Kazumine-::{ user=6372345 }, ::tentrempm::{ user=8346342 } |
| ::{ flag=IL }:: | **Israel** | **::nadavv::{ user=7673299 }**, ::mufugai::{ user=7766552 }, ::ophir\_mania::{ user=18782031 }, ::Suycc::{ user=10811226 }, ::-Zero-::{ user=4192103 } |
| ::{ flag=IT }:: | **Italy** | **::WePlant::{ user=6997209 }**, ::Kiraz::{ user=3807675 }, ::Relae::{ user=14455536 }, ::SaibelFangirl::{ user=10100437 }, ::v3yron03::{ user=8825208 }, ::xxmaschxx::{ user=11281246 } |
| ::{ flag=MY }:: | **Malaysia** | **::\[-Leon-\]::{ user=13382147 }**, ::Expired112::{ user=8782656 }, ::FastTapper::{ user=11787977 }, ::Ju1nY11::{ user=14743871 }, ::StyGix::{ user=7745408 }, ::Unicow::{ user=9444174 } |
| ::{ flag=NL }:: | **Netherlands** | **::2fast4you98::{ user=5183940 }**, ::Freek::{ user=9630674 }, ::NightNarumi::{ user=4381142 }, ::Ready Perfectly::{ user=10944966 }, ::samuelhklumpers::{ user=10945523 }, ::Shoira::{ user=13377652 } |
| ::{ flag=NZ }:: | **New Zealand** | **::- Abby -::{ user=7740118 }**, ::jrny::{ user=11328112 }, ::KrXza::{ user=15562344 }, ::loljames::{ user=11447670 }, ::Pengjouc::{ user=12532112 }, ::Sparxe::{ user=5750235 } |
| ::{ flag=NO }:: | **Norway** | **::\[RS\] Freddy::{ user=5235218 }**, ::prebert123::{ user=7859738 }, ::-TeaBee-::{ user=12304069 } |
| ::{ flag=PE }:: | **Peru** | **::Kien io::{ user=10055648 }**, ::artumax::{ user=8916149 }, ::JoseCR::{ user=15625687 }, ::Kamikho::{ user=12664851 }, ::SanBernardo::{ user=10593915 } |
| ::{ flag=PH }:: | **Philippines** | **::Arccat::{ user=4848294 }**, ::Eon Musk::{ user=12239110 }, ::Gerwin13::{ user=15776185 }, ::GTXCZE::{ user=9209185 }, ::Lawrence Angelo::{ user=10373568 }, ::Silicosis::{ user=15548876 } |
| ::{ flag=PL }:: | **Poland** | **::Otis1204::{ user=11431349 }**, ::KFCmonkey1::{ user=14295411 }, ::Moskas::{ user=1934077 }, ::Mr\_adamello::{ user=7420894 }, ::s\_kolorowa::{ user=11430587 }, ::Yamakazi::{ user=4726691 } |
| ::{ flag=RO }:: | **Romania** | **::ProEmi69::{ user=12712916 }**, ::SuperDenis69::{ user=12791287 }, ::YunioChan::{ user=13930396 } |
| ::{ flag=RU }:: | **Russian Federation** | **::YaLTeR::{ user=3910006 }**, ::Cheblan::{ user=11252985 }, ::Dolphy-::{ user=9343460 }, ::exockort::{ user=7424754 }, ::Illumnus::{ user=9504954 } |
| ::{ flag=SG }:: | **Singapore** | **::Blerargh::{ user=7609510 }**, ::\[LS\]PlzNjoyGame::{ user=15210942 }, ::dabreadosan::{ user=16870002 }, ::doomsday50::{ user=11654310 } |
| ::{ flag=KR }:: | **South Korea** | **::Nabi-::{ user=9014584 }**, ::aircraft::{ user=4679055 }, ::DHLEE727::{ user=3428908 }, ::FH7396512A::{ user=8250228 }, ::ID\_VEGA::{ user=15910488 }, ::VrChatGamer::{ user=14213383 } |
| ::{ flag=ES }:: | **Spain** | **::RandomeLoL::{ user=7080063 }**, ::Carapucho::{ user=9552883 }, ::game\_maker26::{ user=4876699 }, ::MantequillAlex::{ user=11499752 }, ::Saguihex::{ user=5301791 } |
| ::{ flag=SE }:: | **Sweden** | **::diamondBIaze::{ user=10553827 }**, ::Akrylpryl::{ user=2601122 }, ::FemFiskar::{ user=9059265 }, ::greendor::{ user=10819978 }, ::oliverq::{ user=14888056 }, ::Henkayy::{ user=3003778 } |
| ::{ flag=CH }:: | **Switzerland** | **::DrLou::{ user=13472706 }**, ::danegger50::{ user=9026563 }, ::sinyst::{ user=10898621 }, ::zipp::{ user=6839722 } |
| ::{ flag=TW }:: | **Taiwan** | **::2zi::{ user=10137329 }**, ::\[-ICHINO-\]::{ user=13643601 }, ::Joylintp::{ user=13579078 }, ::mmi366127::{ user=11273333 }, ::Pdog4ni::{ user=14581544 }, ::SaKuRaLaN::{ user=6193819 } |
| ::{ flag=TH }:: | **Thailand** | **::palmEuEi::{ user=13656264 }**, ::FarmMyLife::{ user=12621947 }, ::IjustLuvBanana::{ user=16011592 }, ::shokoha::{ user=14134289 }, ::Trillerspec::{ user=8324386 }, ::Zytosy::{ user=3290734 } |
| ::{ flag=TR }:: | **Turkey** | **::Alaryum::{ user=11667189 }**, ::CemshiCoban::{ user=13780807 }, ::demXtre::{ user=13603342 }, ::FCorQuit::{ user=7821748 }, ::hsod::{ user=15391485 }, ::xhsi::{ user=16137157 } |
| ::{ flag=GB }:: | **United Kingdom** | **::MaDD::{ user=7405208 }**, ::-Deepdive-::{ user=13338645 }, ::H1Pur::{ user=15756120 }, ::-Isla-::{ user=11080606 }, ::OwOasis::{ user=11133352 }, ::Zycrxd::{ user=14245127 } |
| ::{ flag=US }:: | **United States** | **::KamaTheCrimson::{ user=6362259 }**, ::\[GS\]Rose::{ user=9481266 }, ::doctor big::{ user=7958845 }, ::Feylos::{ user=4565040 }, ::Retina::{ user=11392859 }, ::Scep::{ user=11196445 } |
| ::{ flag=VN }:: | **Vietnam** | **::Fenestrox::{ user=14714826 }**, ::Blulletgun::{ user=13122043 }, ::DoraSPS::{ user=16005504 }, ::Elzitallzila::{ user=14193228 }, ::eufugu::{ user=13398090 }, ::Thien-boiiii::{ user=16629204 } |
...
| Placing | Team |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=PH }:: **Philippines** (**::Arccat::{ user=4848294 }**, ::Eon Musk::{ user=12239110 }, ::Gerwin13::{ user=15776185 }, ::GTXCZE::{ user=9209185 }, ::Lawrence Angelo::{ user=10373568 }, ::Silicosis::{ user=15548876 }) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=MY }:: **Malaysia** (**::\[-Leon-\]::{ user=13382147 }**, ::Expired112::{ user=8782656 }, ::FastTapper::{ user=11787977 }, ::Ju1nY11::{ user=14743871 }, ::StyGix::{ user=7745408 }, ::Unicow::{ user=9444174 }) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=BR }:: **Brazil** (**::Yuragi::{ user=8501380 }**, ::Chiara::{ user=5642989 }, ::Halo-::{ user=7572142 }, ::Lenn::{ user=11236829 }, ::Namirin-chan::{ user=6761832 }, ::Soore::{ user=15753462 }) |
