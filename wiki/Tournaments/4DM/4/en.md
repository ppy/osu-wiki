...
|  | Country | Members |
| :-: | :-- | :-- |
| ::{ flag=AR }:: | **Argentina** | **::menphiss::{ user=6185083 }**, ::BL5::{ user=13187997 }, ::-Tebo-::{ user=12092659 }, ::DUELODER::{ user=8224116 }, ::Mateo12345::{ user=16481146 }, ::chwisuwu::{ user=11394892 } |
| ::{ flag=AU }:: | **Australia** | **::\[ Decku \]::{ user=13360768 }**, ::FluffyGMD::{ user=10502251 }, ::fvrex::{ user=11863699 }, ::HD\1AdreNaline::{ user=10540368 }, ::Maid Bnot::{ user=16954929 }, ::Nerd Guy::{ user=11247298 } |
| ::{ flag=BE }:: | **Belgium** | **::spamblock::{ user=11968058 }**, ::shaafs::{ user=8811695 }, ::brug::{ user=13031731 }, ::flyerbram002::{ user=12725421 }, ::xXyarnuXx::{ user=15103105 }, ::hydreigon2004::{ user=14053380 } |
| ::{ flag=BR }:: | **Brazil** | **::Zergh::{ user=3181281 }**, ::Maykee kee::{ user=23091978 }, ::terror67890::{ user=12079742 }, ::soutin::{ user=11771029 }, ::UltraBlack::{ user=15677134 }, ::MaxJunior::{ user=7163621 } |
| ::{ flag=CA }:: | **Canada** | **::\[LS\]Byte::{ user=15174223 }**, ::acolyde::{ user=20955186 }, ::svp-::{ user=13887380 }, ::AmariaLove::{ user=17036270 }, ::Mystiik::{ user=17242265 }, ::twitch chat::{ user=12723207 } |
| ::{ flag=CL }:: | **Chile** | **::NewMaxsue::{ user=16910603 }**, ::-Pauze-::{ user=10877381 }, ::\[TMEO\]Daichi::{ user=10051871 }, ::NifloX\1::{ user=17478713 }, ::Aweonao\1cL::{ user=11915961 } |
| ::{ flag=CO }:: | **Colombia** | **::xNett::{ user=4998501 }**, ::\[TK\] Dante::{ user=11533730 }, ::ThrasherBoi::{ user=19223042 }, ::LuXur666::{ user=13765756 }, ::billabong89::{ user=13896159 }, ::RsebaS::{ user=6318977 } |
| ::{ flag=DK }:: | **Denmark** | **::hydrofurious::{ user=9914256 }**, ::b2o0d1i6l::{ user=13692007 }, ::Stoom::{ user=13572493 }, ::Haveaffald::{ user=12854716 }, ::Nunkefaderen::{ user=5352616 } |
| ::{ flag=DO }:: | **Dominican Republic** | **::-Julio::{ user=13663757 }**, ::Antalf::{ user=8793773 }, ::alex10500::{ user=24893505 }, ::Kaito-kun::{ user=4715184 }, ::\[Antonio\]::{ user=21599285 }, ::Iwil::{ user=21187821 } |
| ::{ flag=EC }:: | **Ecuador** | **::-Guille::{ user=17497166 }**, ::MatuB3::{ user=16721166 }, ::ZoockPeater::{ user=23407392 }, ::-Kokito::{ user=17530958 }, ::JostinC::{ user=19899203 }, ::\[-Jona-\]::{ user=19727643 } |
| ::{ flag=FI }:: | **Finland** | **::TelyTappy::{ user=18802107 }**, ::\[WP\]Danitskin::{ user=4337529 }, ::CompactFish::{ user=19069184 }, ::D4SHI::{ user=10204193 }, ::Maffe::{ user=4773855 } |
| ::{ flag=FR }:: | **France** | **::Paturages::{ user=1375479 }**, ::Gray Hardrock::{ user=9049282 }, ::Keskidi::{ user=14015337 }, ::Satsukel::{ user=9066390 }, ::BlackyDay::{ user=5724831 }, ::MisteurFR::{ user=14055233 } |
| ::{ flag=DE }:: | **Germany** | **::ERA medium kek::{ user=11625617 }**, ::Tiger::{ user=10242297 }, ::cakeboss05::{ user=12586864 }, ::\[LS\]Punish::{ user=10615367 }, ::-SparklingCat-::{ user=15440118 }, ::Gtrafh::{ user=9950122 } |
| ::{ flag=GT }:: | **Guatemala** | **::CesarGS::{ user=17433785 }**, ::Lewiss-::{ user=22585752 }, ::Yosuf::{ user=21203522 }, ::kelloaki::{ user=12678795 }, ::iSeraphine::{ user=14862011 }, ::MR acefrio::{ user=17834713 } |
| ::{ flag=HK }:: | **Hong Kong** | **::Ricizus::{ user=10395139 }**, ::DreamChocolate::{ user=17483369 }, ::Netr0::{ user=10145801 }, ::NotXbxx::{ user=18481445 }, ::SackboyBrownie::{ user=18111392 }, ::sauceboyexe9::{ user=18265431 } |
| ::{ flag=ID }:: | **Indonesia** | **::Revv-::{ user=12424909 }**, ::\[ -Asriel- \]::{ user=11829623 }, ::IkanMbak::{ user=10151763 }, ::denzeljr::{ user=14335907 }, ::Reihynn::{ user=16630515 }, ::KironoJr::{ user=5179764 } |
| ::{ flag=IT }:: | **Italy** | **::Bestfast::{ user=11616192 }**, ::\_Tom\101::{ user=6083660 }, ::EliteDreamer::{ user=18274507 }, ::SimoHero::{ user=3262821 }, ::xIceWolf::{ user=5420382 }, ::michxxx::{ user=16965810 } |
| ::{ flag=JP }:: | **Japan** | **::u8\1sunflower::{ user=15241608 }**, ::MSKFA kemi::{ user=7830397 }, ::Kazusa\1T::{ user=12739508 }, ::gyoza\1goki::{ user=18144664 }, ::milk369::{ user=20279580 }, ::syo73::{ user=14495182 } |
| ::{ flag=MY }:: | **Malaysia** | **::Auxesiaa::{ user=16417718 }**, ::JayLye::{ user=14892447 }, ::\[Break\]LCJQ::{ user=11283859 }, ::\[RGK\]Cheoky29::{ user=14901072 }, ::SatioLightLL::{ user=3760209 }, ::KirinChibi::{ user=8209312 } |
| ::{ flag=MX }:: | **Mexico** | **::Hanamaru-::{ user=10595982 }**, ::Herarudo::{ user=12086252 }, ::HectorAF01::{ user=12815564 }, ::\[TK\]Martin\122::{ user=9653729 }, ::-Yisus::{ user=17941054 }, ::\[LS\]rudify::{ user=16425015 } |
| ::{ flag=NL }:: | **Netherlands** | **::NightNarumi::{ user=4381142 }**, ::samuelhklumpers::{ user=10945523 }, ::Freek::{ user=9630674 }, ::Ready Perfectly::{ user=10944966 }, ::spitskool::{ user=14099022 }, ::Saemitsu::{ user=14262789 } |
| ::{ flag=NI }:: | **Nicaragua** | **::KevinRJF::{ user=14309000 }**, ::\_ZaFkieL\_::{ user=11372299 }, ::BiggestBlast::{ user=20455347 }, ::BlenkchL::{ user=15714839 } |
| ::{ flag=PA }:: | **Panama** | **::NukeW4rrior::{ user=14133702 }**, ::\[ Ender \]::{ user=10837305 }, ::Endy05::{ user=19859076 }, ::GC2404::{ user=14952379 }, ::Merrit::{ user=15833550 } |
| ::{ flag=PE }:: | **Peru** | **::Kamikho::{ user=12664851 }**, ::Miaurichesu::{ user=10055648 }, ::henryalexbr::{ user=23528661 }, ::Sp3ctro::{ user=18344249 }, ::ericcccc2::{ user=12595010 }, ::RoXaS3578::{ user=10658871 } |
| ::{ flag=PH }:: | **Philippines** | **::Lazereed::{ user=12894120 }**, ::Frossno::{ user=17480973 }, ::CuB-03::{ user=18560307 }, ::Akatsumi Chan::{ user=11306351 }, ::Lordieee::{ user=10010130 }, ::EpicBaconBoi::{ user=16391523 } |
| ::{ flag=PL }:: | **Poland** | **::Mr\1adamello::{ user=7420894 }**, ::Eclipse-::{ user=8493070 }, ::Hlimak::{ user=1340272 }, ::Moskas::{ user=1934077 }, ::Zymasis39::{ user=9477978 }, ::Bexi::{ user=11548612 } |
| ::{ flag=RU }:: | **Russian Federation** | **::wolfpup08::{ user=11939641 }**, ::Nikita3006::{ user=6771608 }, ::\_Altair\_::{ user=12642757 }, ::Illumnus::{ user=9504954 }, ::\[LN\]numuser::{ user=12585687 }, ::InkSys::{ user=11656629 } |
| ::{ flag=SG }:: | **Singapore** | **::awdse22::{ user=8743513 }**, ::IcyFr05ty::{ user=14138696 }, ::Messica::{ user=19838168 }, ::sd3d::{ user=17289816 }, ::TheFunk::{ user=13981991 } |
| ::{ flag=ZA }:: | **South Africa** | **::dsdsdd::{ user=16299498 }**, ::p6yb::{ user=23429747 }, ::Cyrosu::{ user=7748432 }, ::Bladehunter::{ user=17153468 } |
| ::{ flag=ES }:: | **Spain** | **::game\1maker26::{ user=4876699 }**, ::Enthalpy::{ user=9552883 }, ::LittleDemonRiri::{ user=15114039 }, ::ShiroPeDeFresa::{ user=16020685 }, ::Kracohc::{ user=11554942 }, ::Froggie09::{ user=14332005 } |
| ::{ flag=SE }:: | **Sweden** | **::diamondBIaze::{ user=10553827 }**, ::oliverq::{ user=14888056 }, ::Johnney101::{ user=11928361 }, ::Aizeia::{ user=4588239 }, ::NeonDrakon::{ user=6315000 } |
| ::{ flag=TW }:: | **Taiwan** | **::2zi::{ user=10137329 }**, ::\[-NEinO-\]::{ user=8630038 }, ::blacktea12::{ user=13389861 }, ::Joylintp::{ user=13579078 }, ::Nobu150::{ user=12296460 }, ::Pdog4ni::{ user=14581544 } |
| ::{ flag=TH }:: | **Thailand** | **::shokoha::{ user=14134289 }**, ::nanonbandusty::{ user=15543726 }, ::--Pavin--::{ user=12046267 }, ::iN0SleePz::{ user=7192826 }, ::FarmMyLife::{ user=12621947 }, ::C4P741N::{ user=7892722 } |
| ::{ flag=UA }:: | **Ukraine** | **::Shailexi::{ user=11375371 }**, ::LonBertZend::{ user=10484445 }, ::Arstz::{ user=10844754 }, ::ADshush::{ user=15231447 }, ::Babylkaa::{ user=11943363 }, ::kondratio::{ user=7100478 } |
| ::{ flag=AE }:: | **United Arab Emirates** | **::drag\1::{ user=17959501 }**, ::iVALORUS::{ user=12096188 }, ::Testlng::{ user=20465487 }, ::JPBenedictGame::{ user=12304092 } |
| ::{ flag=GB }:: | **United Kingdom** | **::MaDD::{ user=7405208 }**, ::H1Pur::{ user=15756120 }, ::Pluty::{ user=6563045 }, ::username1947::{ user=16162078 }, ::\[LS\]Taylor::{ user=15843981 }, ::Finibee::{ user=8678616 } |
| ::{ flag=US }:: | **United States** | **::\_Seth::{ user=8111953 }**, ::Retina::{ user=11392859 }, ::StayHighKids::{ user=11805458 }, ::ERA Klarion::{ user=13857986 }, ::FullCombro::{ user=12045149 }, ::Imperialtrinity::{ user=5066305 } |
| ::{ flag=UY }:: | **Uruguay** | **::El Milanga::{ user=12264918 }**, ::Xion-Z::{ user=22026308 }, ::not-koko::{ user=19136873 } |
| ::{ flag=VE }:: | **Venezuela** | **::Edvo::{ user=8301758 }**, ::Doryoku::{ user=5639725 }, ::Shinsekai-::{ user=2140739 }, ::calvingarrix666::{ user=17881051 }, ::ArnaldoCasanova::{ user=17823683 }, ::JoseNoEsProBv::{ user=24398259 } |
| ::{ flag=VN }:: | **Vietnam** | **::Micleak::{ user=16140674 }**, ::XN\1The\1XD::{ user=15271902 }, ::TheUltimateDex::{ user=21188734 }, ::Tree Palm::{ user=11994321 }, ::Thien-boiiii::{ user=16629204 }, ::quangminh1548::{ user=17547210 } |
...
| Placing | Team |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=FR }:: **France** (**::Paturages::{ user=1375479 }**, ::Gray Hardrock::{ user=9049282 }, ::Keskidi::{ user=14015337 }, ::Satsukel::{ user=9066390 }, ::BlackyDay::{ user=5724831 }, ::MisteurFR::{ user=14055233 }) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=TH }:: **Thailand** (**::shokoha::{ user=14134289 }**, ::nanonbandusty::{ user=15543726 }, ::--Pavin--::{ user=12046267 }, ::iN0SleePz::{ user=7192826 }, ::FarmMyLife::{ user=12621947 }, ::C4P741N::{ user=7892722 }) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=PE }:: **Peru** (**::Kamikho::{ user=12664851 }**, ::Miaurichesu::{ user=10055648 }, ::henryalexbr::{ user=23528661 }, ::Sp3ctro::{ user=18344249 }, ::ericcccc2::{ user=12595010 }, ::RoXaS3578::{ user=10658871 }) |
