...
The **Speed of Light Mania Tournament** (***SOLMT***) is a head-to-head (1 vs. 1) osu!mania tournament.
...
- [Discord server](https://discord.gg/Zmha38K)
...
| **C** | ![][flag_PH] bojii | ![][flag_RU] AngeloLagusa | ![][flag_FR] DragonSonic | ![][flag_UK] zHotRoD |
...
More details can be found on the [bracket information Google sheet](https://docs.google.com/spreadsheets/d/16lPxdtUsuDTyArGgtW-nnnLMycFqN0j55O3TO2GpdBo/edit#gid=649487813).
...
| bojii ![][flag_PH] | **4** | 0 | ![][flag_UK] zHotRoD | *win by default* |
...
| **DragonSonic** ![][flag_FR] | **4** | 0 | ![][flag_UK] zHotRoD | [#1](https://osu.ppy.sh/community/matches/56657797) |
| zHotRoD ![][flag_UK] | 0 | **4** | ![][flag_RU] **AngeloLagusa** | [#1](https://osu.ppy.sh/community/matches/56658956) |
...
| yahweh ![][flag_US] | 0 | 0 | ![][flag_RU] artslay | *neither player was present* |
...
- With the exception of the qualifiers (which does not have a winning condition), each tournament round will have a selectable mappool of a certain size, a tiebreaker song, and a winning condition. The format is as follows:
  - **Qualifiers:** 4 song mappool, no winning condition, no tiebreaker song
...
[flag_UK]: /wiki/shared/flag/UK.gif
