...
| **D** | ![][flag_TH] -\[DaNieL_TH]- | ![][flag_US] Playboi Carti   | ![][flag_PH] Shiyui-       | ![][flag_RU] TruthIsNear     |
...
| ------------------------: | :---: | :-: | :--------------------- | :-------------------------------------------------- |
| **andreymc** ![][flag_BR] | **8** |  0  | ![][flag_MY] cheewee10 | _win by default_                                    |
...
|   SillyFangirl ![][flag_BR] |  0  | **7** | ![][flag_BR] **andreymc** | _win by default_                                    |
...
|                      Player 1 |       |       | Player 2                | Match link                                          |
| ----------------------------: | :---: | :---: | :---------------------- | :-------------------------------------------------- |
|       stupud man ![][flag_US] |   0   | **7** | ![][flag_US] **HeZeus** | _win by default_                                    |
...
|                  Player 1 |       |       | Player 2                  | Match link                                          |
| ------------------------: | :---: | :---: | :------------------------ | :-------------------------------------------------- |
| SillyFangirl ![][flag_BR] |   0   | **7** | ![][flag_PH] **bojii**    | _win by default_                                    |
...
|          realqarp ![][flag_PH] |   0   | **6** | ![][flag_US] **Unholy**          | _win by default_                                    |
...
|        **HeZeuS** ![][flag_US] | **6** |   0   | ![][flag_BR] Gabi Kamui          | _win by default_                                    |
| **loafusofbread** ![][flag_CA] | **6** |   0   | ![][flag_US] Logan636            | _win by default_                                    |
...
|   loafusofbread ![][flag_CA] |   0   | **6** | ![][flag_PH] **Cohue**   | _win by default_                                    |
...
|     \[Crz]Lochie ![][flag_AU] |   0   | **6** | ![][flag_MY] cheewee10    | _forfeited_                                         |
| **AngeloLagusa** ![][flag_RU] | **6** |   1   | ![][flag_TW] AW ZERO      | [#1](https://osu.ppy.sh/community/matches/57130560) |
|   **FoXCHANNEL** ![][flag_RU] | **6** |   0   | ![][flag_VN] Baoketban123 | _win by default_                                    |
|        **Lerck** ![][flag_RU] | **6** |   0   | ![][flag_RU] N1ckn1ght    | _win by default_                                    |
...
|          **dhn** ![][flag_US] | **6** |   0   | ![][flag_KR] NKEYBOARD         | _win by default_                                    |
...
|           Proxae ![][flag_ID] |   0   | **6** | ![][flag_BR] **Kyut**          | _win by default_                                    |
|          Strachy ![][flag_FI] |   0   | **6** | ![][flag_CA] **loafusofbread** | _win by default_                                    |
|       **HeZeuS** ![][flag_US] | **6** |   0   | ![][flag_US] Playboi Carti     | _win by default_                                    |
...
|            Strachy ![][flag_FI] |   0   | **5** | ![][flag_MY] **cheewee10** | _win by default_                                    |
...
|          **bojii** ![][flag_PH] | **4** |   0   | ![][flag_RU] AngeloLagusa        | _win by default_                                    |
...
|            Shiyui- ![][flag_PH] |   0   | **4** | ![][flag_TH]  **-\[DaNieL_TH]-** | [#1](https://osu.ppy.sh/community/matches/56628847) |
|              Halo- ![][flag_BR] |   0   | **4** | ![][flag_AU] **\[Crz]Lochie**    | [#1](https://osu.ppy.sh/community/matches/56628849) |
|       **realqarp** ![][flag_PH] | **4** |   0   | ![][flag_RU] artslay             | _win by default_                                    |
|              bojii ![][flag_PH] | **4** |   0   | ![][flag_GB] zHotRoD             | _win by default_                                    |
| **-\[DaNieL_TH]-** ![][flag_TH] | **4** |   0   | ![][flag_RU] TruthIsNear         | [#1](https://osu.ppy.sh/community/matches/56630804) |
...
| **AngeloLagusa** ![][flag_RU] | **4** |   0   | ![][flag_FR] DragonSonic       | _win by default_                                    |
...
|      \[ Albedo ] ![][flag_ID] |   0   | **4** | ![][flag_AR] **ByDarking**     | _win by default_                                    |
|            Halo- ![][flag_BR] |   0   | **4** | ![][flag_KR] **NKEYBOARD**     | [#1](https://osu.ppy.sh/community/matches/56660777) |
|      **AW ZERO** ![][flag_TW] | **4** |   0   | ![][flag_US] yahweh            | _win by default_                                    |
|       **Proxae** ![][flag_ID] | **4** |   3   | ![][flag_AR] jLuyalb           | [#1](https://osu.ppy.sh/community/matches/56660893) |
|   **FoXCHANNEL** ![][flag_RU] | **4** |   0   | ![][flag_DO] Kaito-kun         | _win by default_                                    |
|       Monkerzaza ![][flag_TH] |   0   | **4** | ![][flag_BR] **Halo-**         | _win by default_                                    |
|           yahweh ![][flag_US] |   0   |   0   | ![][flag_RU] artslay           | _forfeited_                                         |
|      **jLuyalb** ![][flag_AR] | **4** |   2   | ![][flag_ID] StyxFearNite      | [#1](https://osu.ppy.sh/community/matches/56663058) |
|   **Gabi Kamui** ![][flag_BR] | **4** |   0   | ![][flag_ID] \[ Albedo ]       | _win by default_                                    |
...
|             Blujae ![][flag_NZ] |   0   | **4** | ![][flag_FI] **Camopoltergeist** | _win by default_                                    |
|    VarvalianFanboy ![][flag_KR] |   0   | **4** | ![][flag_PH] **Cohue**           | _win by default_                                    |
|     Crumpetfiddler ![][flag_AU] |   0   | **4** | ![][flag_VN] **MashedPotato**    | [#1](https://osu.ppy.sh/community/matches/56794396) |
|          **Cohue** ![][flag_PH] | **4** |   0   | ![][flag_AR] Mateocristaldo      | _win by default_                                    |
| **Crumpetfiddler** ![][flag_AU] | **4** |   0   | ![][flag_BR] Kyut                | _win by default_                                    |
|     Mateocristaldo ![][flag_AR] |   0   |   0   | ![][flag_PH] swarmsii            | _neither player was present_                        |
...
|             Antalf ![][flag_DO] |   0   | **4** | ![][flag_MY] **cheewee10**       | _win by default_                                    |
...
|      **Nikolayio** ![][flag_ES] | **4** |   0   | ![][flag_DO] Antalf              | _win by default_                                    |
...
|             Blujae ![][flag_NZ] |   0   | **4** | ![][flag_US] **stupud man**      | _win by default_                                    |
|             Ping36 ![][flag_FR] |   0   | **4** | ![][flag_BR] **andreymc**        | [#1](https://osu.ppy.sh/community/matches/56805637) |
|  **loafusofbread** ![][flag_CA] |   4   |   0   | ![][flag_LV] CrayZigg            | _win by default_                                    |
...
|         Kenrit-San ![][flag_MX] |   0   | **4** | ![][flag_FI]  **Strachy**        | _win by default_                                    |
|          **Reo09** ![][flag_EC] | **4** |   0   | ![][flag_NZ] Blujae              | _win by default_                                    |
...
|            Dilly_P ![][flag_US] |   2   | **4** | ![][flag_CA] **loafusofbread**   | [#1](https://osu.ppy.sh/community/matches/56813455) |
...
|              Reo09 ![][flag_EC] |   0   | **4** | ![][flag_US] **stupud man**      | _win by default_                                    |
...
|              Ping36 ![][flag_FR] |   0   |   0   | ![][flag_RU] AsyaKys             | _neither player was present_                        |
|         **Strachy** ![][flag_FI] | **4** |   0   | ![][flag_VN] baoketban123        | [#1](https://osu.ppy.sh/community/matches/56823485) |
|             AsyaKys ![][flag_RU] |   0   | **4** | ![][flag_RU] **c1e4r**           | _win by default_                                    |
|  **Mateocristaldo** ![][flag_AR] | **4** |   0   | ![][flag_KR] VarvalianFanboy     | _win by default_                                    |
|    **baoketban123** ![][flag_VN] | **4** |   0   | ![][flag_MX] Kenrit-San          | _win by default_                                    |
|       **N1ckn1ght** ![][flag_RU] | **4** |   0   | ![][flag_US] Lights              | [#1](https://osu.ppy.sh/community/matches/56827893) |
|    **baoketban123** ![][flag_VN] | **4** |   0   | ![][flag_US]  -Electro-          | _win by default_                                    |
|            CrayZigg ![][flag_LV] |   2   | **4** | ![][flag_US] **Dilly_P**         | [#1](https://osu.ppy.sh/community/matches/56830000) |
|          **Lights** ![][flag_US] | **4** |   0   | ![][flag_CO] Cansta              | _win by default_                                    |
|             Dilly_P ![][flag_US] |   1   | **4** | ![][flag_PE] **DaZeRo5**         | [#1](https://osu.ppy.sh/community/matches/56832151) |
...
|          stupud man ![][flag_US] |   0   | **4** | ![][flag_FI] **Camopoltergeist** | _win by default_                                    |
...
-   The room configuration is osu, Team-Vs, Win Condition: 'ScoreV2'. The room name must be "(SOL Tournament): (_Player1_) vs (_Player2_)".
