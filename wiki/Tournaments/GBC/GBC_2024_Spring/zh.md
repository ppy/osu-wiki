...
1. 比赛开始前5分钟，裁判提前建好多人房间，选手必须在此期间进房。
   - 房间设置为： `Game mode: "osu!mania"`, `Team mode: "Head-to-Head"`, `Score mode: "ScoreV2"`。房间必须命名为： `GBC 2024 Spring`.
