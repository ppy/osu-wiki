...
| ::{ flag=BR }:: | **Brazil** | **::Lazarento::{ user=3224958 }**, ::Uzi I::{ user=6042123 }, ::AiAyako::{ user=7003491 }, ::Lolligerjoj::{ user=9053338 }, ::mihinho::{ user=6509269 } |
...
| ::{ flag=DE }:: | **Germany A** | **::Capu::{ user=2474015 }**, ::\[TaikoTori\]::{ user=1074143 }, ::QEpicAce::{ user=9489153 }, ::Siegmund99::{ user=5168596 }, ::xBourbon\_Kid::{ user=645775 } |
| ::{ flag=DE }:: | **Germany B** | **::Aninoss::{ user=7364706 }**, ::Sayira::{ user=7253958 }, ::JanteSmith::{ user=371772 }, ::Naugustogi::{ user=6803970 } |
...
| ::{ flag=MX }:: | **Mexico** | **::Iojioji::{ user=1346121 }**, ::ZaveryK::{ user=10913397 }, ::L\_CORTES\_01::{ user=12548363 } |
| ::{ flag=NL }:: | **Netherlands** | **::Krekker::{ user=8265940 }**, ::Hypello::{ user=1594036 }, ::jesse-98::{ user=502722 }, ::StrijkIjzer::{ user=4130926 } |
| ::{ flag=PH }:: | **Philippines** | **::yuki\_momoiro722::{ user=7186791 }**, ::Niro-::{ user=6443899 }, ::A i r::{ user=10363380 }, ::Yron8::{ user=1537747 } |
| ::{ flag=PL }:: | **Poland** | **::Agresywny Arbuz::{ user=7056658 }**, ::Tetsurio::{ user=2044810 }, ::-Jamu-::{ user=2271556 }, ::Wolfgang::{ user=7184324 }, ::fafik99::{ user=1787011 } |
| ::{ flag=RU }:: | **Russian Federation A** | **::Nozdormu::{ user=7169208 }**, ::Akonine::{ user=7774222 }, ::pavlukivan::{ user=8321579 }, ::CrowWhite::{ user=8638977 }, ::TwinT::{ user=9976154 } |
| ::{ flag=RU }:: | **Russian Federation B** | **::-Rmdy::{ user=1933816 }**, ::JW-Dash::{ user=5285786 }, ::oserry::{ user=11973082 }, ::Starger::{ user=3398715 }, ::Crysally::{ user=7792131 } |
...
| ::{ flag=KR }:: | **South Korea** | **::POCARI-SWEAT::{ user=5082685 }**, ::bbj0920::{ user=87546 }, ::yuhuna\1kor::{ user=13046017 }, ::\[Akita-Neru\]::{ user=613944 }, ::TRAtOrTs::{ user=12481695 } |
| ::{ flag=ES }:: | **Spain** | **::naliem::{ user=3252709 }**, ::RuinedChicken::{ user=7983713 }, ::Machango::{ user=7180552 }, ::Nara\_NB::{ user=3593992 } |
| ::{ flag=TW }:: | **Taiwan** | **::- DeveRUX -::{ user=2900875 }**, ::Hatsuse::{ user=697007 }, ::nw9v4g46::{ user=2169329 }, ::david649713::{ user=1390823 } |
| ::{ flag=GB }:: ::{ flag=PT }:: | **United Kingdom/Portugal** | **::Metzo::{ user=10633982 }**, ::w1ll::{ user=11406987 }, ::Ali161102::{ user=7582420 }, ::Yumi\_Hideaki::{ user=10081162 } |
| ::{ flag=US }:: | **United States A** | **::Backfire::{ user=263110 }**, ::ChurroChef::{ user=9258564 }, ::CaptainEChan::{ user=9536977 }, ::dragonworm::{ user=11464752 } |
| ::{ flag=US }:: | **United States B** | **::driodx::{ user=9709548 }**, ::Shindamama::{ user=12780046 }, ::R J::{ user=6490509 }, ::DiggyDogg::{ user=5014664 } |
