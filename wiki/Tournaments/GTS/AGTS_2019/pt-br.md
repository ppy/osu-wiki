...
|  | País | Membros |
| :-: | :-: | :-- |
| ::{ flag=DE }:: | **Alemanha A** | **::Capu::{ user=2474015 }**, ::\[TaikoTori\]::{ user=1074143 }, ::QEpicAce::{ user=9489153 }, ::Siegmund99::{ user=5168596 }, ::xBourbon\_Kid::{ user=645775 } |
| ::{ flag=DE }:: | **Alemanha B** | **::Aninoss::{ user=7364706 }**, ::Sayira::{ user=7253958 }, ::JanteSmith::{ user=371772 }, ::Naugustogi::{ user=6803970 } |
| ::{ flag=AR }:: | **Argentina** | **::Pollotuc::{ user=42440 }**, ::juanilp4evr::{ user=6413125 }, ::Atreevete::{ user=2615199 }, ::warning dark::{ user=5040981 } |
| ::{ flag=AU }:: | **Austrália** | **::Beat43210::{ user=5664171 }**, ::Tsubasa2::{ user=6835183 }, ::richy2001::{ user=11499467 }, ::AmateurMonkeyYT::{ user=8379046 } |
| ::{ flag=AT }:: | **Áustria** | **::animexamera::{ user=7511357 }**, ::morth1::{ user=7246874 }, ::Der Katze::{ user=7645997 }, ::kBocaj::{ user=11453341 }, ::Amane::{ user=6821436 } |
| ::{ flag=BR }:: | **Brasil** | **::Lazarento::{ user=3224958 }**, ::Uzi I::{ user=6042123 }, ::AiAyako::{ user=7003491 }, ::Lolligerjoj::{ user=9053338 }, ::mihinho::{ user=6509269 } |
...
| ::{ flag=US }:: | **Estados Unidos B** | **::driodx::{ user=9709548 }**, ::Shindamama::{ user=12780046 }, ::R J::{ user=6490509 }, ::DiggyDogg::{ user=5014664 } |
...
| ::{ flag=PL }:: | **Polónia** | **::Agresywny Arbuz::{ user=7056658 }**, ::Tetsurio::{ user=2044810 }, ::-Jamu-::{ user=2271556 }, ::Wolfgang::{ user=7184324 }, ::fafik99::{ user=1787011 } |
| ::{ flag=GB }:: ::{ flag=PT }:: | **Reino Unido/Portugal** | **::Metzo::{ user=10633982 }**, ::w1ll::{ user=11406987 }, ::Ali161102::{ user=7582420 }, ::Yumi\_Hideaki::{ user=10081162 } |
| ::{ flag=RU }:: | **Rússia A** | **::Nozdormu::{ user=7169208 }**, ::Akonine::{ user=7774222 }, ::pavlukivan::{ user=8321579 }, ::CrowWhite::{ user=8638977 }, ::TwinT::{ user=9976154 } |
| ::{ flag=RU }:: | **Rússia B** | **::-Rmdy::{ user=1933816 }**, ::JW-Dash::{ user=5285786 }, ::oserry::{ user=11973082 }, ::Starger::{ user=3398715 }, ::Crysally::{ user=7792131 } |
