...
|  | Team | Members |
| :-: | :-- | :-- |
| ::{ flag=AR }:: | **Argentina A** | **::galogk::{ user=7781648 }**, ::LemonDust::{ user=8065042 }, ::Playersesamol::{ user=9288649 } |
| ::{ flag=AR }:: | **Argentina B** | **::Santi199::{ user=9346502 }**, ::Alan Reaven::{ user=5422789 }, ::hivstex::{ user=14597896 }, ::VIolE\_::{ user=19213988 } |
| ::{ flag=BE }:: | **Belgium** | **::autolsfanboy::{ user=10742890 }**, ::Xenosi::{ user=6157735 } |
| ::{ flag=BR }:: | **Brazil** | **::gabrielmuniz::{ user=4598907 }**, ::Mixtrik::{ user=7902567 } |
| ::{ flag=CA }:: | **Canada** | **::dots\_::{ user=15429414 }**, ::Aidrestan::{ user=11928691 }, ::DimplesRMe::{ user=13348268 }, ::Imacow46::{ user=4366403 }, ::Phoenixien::{ user=13254473 } |
| ::{ flag=CL }:: | **Chile** | **::Xeroblic::{ user=8004633 }**, ::\[ w q l f \]::{ user=11966019 }, ::Mr Benya kun::{ user=17429506 } |
| ::{ flag=CN }:: | **China** | **::154s8a6::{ user=7562543 }**, ::imzk::{ user=2526837 }, ::lolol727::{ user=15030466 }, ::shenglinnn::{ user=10286018 } |
| ::{ flag=CO }:: | **Colombia** | **::Carlosflow::{ user=11940767 }**, ::Alidrio73::{ user=23292800 }, ::JhonDarkness::{ user=9116107 }, ::ParraCharlie::{ user=18425848 } |
| ::{ flag=FI }:: | **Finland** | **::Mesda::{ user=5049430 }**, ::Minami-Kotori::{ user=3083539 } |
| ::{ flag=FR }:: | **France** | **::Reia::{ user=2672643 }**, ::Haypzeh::{ user=9950381 }, ::Nozuchi::{ user=5858447 }, ::Sobarashi::{ user=14105435 }, ::thereal8tsu::{ user=24854553 } |
| ::{ flag=DE }:: | **Germany A** | **::ph1::{ user=22194163 }**, ::Horsti::{ user=21774764 }, ::LilacCos::{ user=12265200 }, ::Max Schradin::{ user=3268096 } |
| ::{ flag=DE }:: | **Germany B** | **::Musubi::{ user=9562353 }**, ::Njorn5::{ user=14021759 }, ::OcklePod::{ user=7094393 }, ::VANCANTORUS::{ user=12820940 } |
| ::{ flag=HK }:: | **Hong Kong** | **::YonGin::{ user=7109317 }**, ::autofanboy::{ user=636114 }, ::boeing747::{ user=5975021 }, ::Tsuwagi::{ user=9313951 } |
| ::{ flag=ID }:: | **Indonesia A** | **::Zedfish::{ user=22615825 }**, ::AciTelor::{ user=16390988 }, ::Sagasemat::{ user=16761278 }, ::Sleepti::{ user=7137930 }, ::Tegarpmngks::{ user=8819702 } |
| ::{ flag=ID }:: | **Indonesia B** | **::raynald::{ user=25094413 }**, ::salym::{ user=19089549 }, ::tjandra::{ user=13695950 }, ::Zest2822::{ user=24002878 } |
| ::{ flag=IT }:: | **Italy** | **::CAZZO ANTONIO::{ user=20822544 }**, ::DarkGiangi::{ user=16896082 }, ::davipetre::{ user=22524142 }, ::neymar95you::{ user=4734947 }, ::silvia\_osu::{ user=22074782 } |
| ::{ flag=JP }:: | **Japan A** | **::PetitRabbit::{ user=16716194 }**, ::KleCru\_Ranma::{ user=15868630 }, ::kumakki::{ user=11680013 }, ::MODE\_SP::{ user=15010333 }, ::WhiteSakata::{ user=15400295 } |
| ::{ flag=JP }:: | **Japan B** | **::basshhii0610::{ user=27997121 }**, ::empoyo\_silva::{ user=15882542 }, ::hinun::{ user=21642305 } |
| ::{ flag=LT }:: | **Lithuania** | **::eimazuba::{ user=8513077 }**, ::Strategas::{ user=2971837 } |
| ::{ flag=MY }:: | **Malaysia** | **::JoelG 12::{ user=18403677 }**, ::5oulpoint::{ user=10194919 }, ::AstralLoki::{ user=14100384 }, ::Haryume::{ user=9351030 }, ::Koeil::{ user=16663752 } |
| ::{ flag=MX }:: | **Mexico** | **::Hivan111::{ user=13525805 }**, ::Ganz0::{ user=26193210 }, ::Yawlo::{ user=10869622 } |
| ::{ flag=NZ }:: | **New Zealand** | **::Bulturst::{ user=14777912 }**, ::g l o w g l o w::{ user=13701453 } |
| ::{ flag=NO }:: | **Norway** | **::Defectum::{ user=8631719 }**, ::wohooooooo::{ user=3095685 } |
| ::{ flag=PE }:: | **Peru** | **::FabriGamer84::{ user=20882798 }**, ::DaKub::{ user=11885200 }, ::StarrySergal::{ user=14429959 } |
| ::{ flag=PH }:: | **Philippines** | **::Shiori Shiomiya::{ user=11154860 }**, ::-Birds-::{ user=15273352 }, ::Euanofthedead::{ user=15676812 }, ::Syntoxical::{ user=18105116 }, ::Vanossfoxy24::{ user=21152418 } |
| ::{ flag=PL }:: | **Poland** | **::LewusekX44::{ user=9997359 }**, ::-Green tea-::{ user=12130367 }, ::FuGuS::{ user=6537593 }, ::pypieci909::{ user=7843038 }, ::Szafa11x::{ user=14075839 } |
| ::{ flag=PT }:: | **Portugal** | **::ImDem0nPT::{ user=12733839 }**, ::Warpzoned::{ user=18649724 } |
| ::{ flag=RU }:: | **Russian Federation** | **::Vasyadogs::{ user=7239762 }**, ::AlloRus::{ user=16418971 }, ::Kandelion::{ user=20779044 }, ::mekkimous::{ user=17381947 }, ::SergoM4444::{ user=10515166 } |
| ::{ flag=SG }:: | **Singapore** | **::helios44::{ user=7838361 }**, ::AngelicK0::{ user=14319366 }, ::Kings::{ user=1016926 }, ::lovemathboy::{ user=4220829 } |
| ::{ flag=KR }:: | **South Korea** | **::Civil oath::{ user=3216107 }**, ::0Lo::{ user=21598290 }, ::Amamya::{ user=1997633 } |
| ::{ flag=ES }:: | **Spain** | **::Pollo del KFC::{ user=20047906 }**, ::9237::{ user=28604533 }, ::\[-Vappy-\]::{ user=10588504 }, ::Helox::{ user=18275040 }, ::WIzh::{ user=25458009 } |
| ::{ flag=SE }:: | **Sweden** | **::TpSlimigt::{ user=2813324 }**, ::MCR::{ user=16064026 }, ::NinjaKitty::{ user=4331767 } |
| ::{ flag=TW }:: | **Taiwan** | **::-Maruko-::{ user=16494567 }**, ::HaHaNa::{ user=6951543 }, ::Joylintp::{ user=13579078 }, ::Mashyuf::{ user=14356517 }, ::X\_rrrr\_X::{ user=15478284 } |
| ::{ flag=TH }:: | **Thailand** | **::\[ Naris \]::{ user=7033479 }**, ::krakenlord420::{ user=13238024 }, ::poomzza::{ user=7617580 }, ::ppgamer::{ user=7172288 } |
| ::{ flag=GB }:: | **United Kingdom A** | **::Ethereal\_Winter::{ user=9780417 }**, ::arialle::{ user=18597899 }, ::Fyll-nds::{ user=14878199 }, ::MaranTheLemon::{ user=13969379 }, ::esperism::{ user=16583271 } |
| ::{ flag=GB }:: | **United Kingdom B** | **::Fluxey::{ user=9098192 }**, ::Greninja::{ user=8579186 }, ::JudePrice11::{ user=10494749 } |
| ::{ flag=US }:: | **United States A** | **::BlitzArk::{ user=7330584 }**, ::bvyans::{ user=7789926 }, ::CacoPholey::{ user=11722058 }, ::Lecter::{ user=5121499 } |
| ::{ flag=US }:: | **United States B** | **::Vitamim::{ user=16700987 }**, ::Cm0nsters::{ user=10951981 }, ::LuriCookie::{ user=9517612 }, ::Morivv::{ user=14961676 }, ::Nyahnny::{ user=16807933 } |
| ::{ flag=VE }:: | **Venezuela** | **::RaFaReAcH::{ user=10491903 }**, ::PikachuMeh::{ user=10524500 } |
| ::{ flag=VN }:: | **Vietnam A** | **::njshift1::{ user=16688499 }**, ::-M\_A\_T\_C\_H\_A-::{ user=26012543 }, ::-Triet-::{ user=26266042 }, ::Creeperbrine303::{ user=22515524 } |
| ::{ flag=VN }:: | **Vietnam B** | **::MyWifeMiku::{ user=21290592 }**, ::DeepInDark::{ user=19817503 }, ::hi\_there\_osu::{ user=22698999 } |
...
| Placing | Team |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | ::{ flag=JP }:: **Japan A** (**::PetitRabbit::{ user=16716194 }**, ::KleCru\_Ranma::{ user=15868630 }, ::kumakki::{ user=11680013 }, ::MODE\_SP::{ user=15010333 }, ::WhiteSakata::{ user=15400295 }) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | ::{ flag=HK }:: **Hong Kong** (**::YonGin::{ user=7109317 }**, ::autofanboy::{ user=636114 }, ::boeing747::{ user=5975021 }, ::Tsuwagi::{ user=9313951 }) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | ::{ flag=US }:: **United States B** (**::Vitamim::{ user=16700987 }**, ::Cm0nsters::{ user=10951981 }, ::LuriCookie::{ user=9517612 }, ::Morivv::{ user=14961676 }, ::Nyahnny::{ user=16807933 }) |
