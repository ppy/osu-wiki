...
3. Le système de score utilisé sera le **ScoreV2.**
...
3. Chaque mappool est constitué de 6 parties: NoMod, Hidden, Hard Rock, Double Time, FreeMod, et Tiebreaker.
...
6. Les maps en Freemod sont jouées avec FreeMod activé. Chaque joueur peut choisir entre **Hidden, Hard Rock ou les deux. Au moins un joueur de chaque équipe doit avoir au moins un mod activé.**
