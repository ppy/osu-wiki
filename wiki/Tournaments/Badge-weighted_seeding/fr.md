...
- `global_rank` (≥ 1): [Classement des points de performance](/wiki/Ranking#performance-points-ranking) du joueur sur le classement global correspondant au même [modes de jeu](/wiki/Game_mode) du tournoi.
