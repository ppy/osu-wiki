...
**osu!catch CIS Open Tournament 2022** (***COT2022***, ***КОТ2022***) — сольный osu!catch турнир в формате double-elimination, организованный ::{ flag=UA }:: ::bernkastel feet::{ user=13681464 } и ::{ flag=RU }:: ::ThankYou::{ user=4571241 }. В турнире могут принимать участие русскоговорящие игроки из стран СНГ и Прибалтики. COT22 был второй итерацией турнира osu!catch CIS Open Tournament.
...
| Место | Игрок |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "Первое место") | ::{ flag=RU }:: ::Memoriola::{ user=6856387 } |
| ![Silver crown](/wiki/shared/crown-silver.png "Второе место") | ::{ flag=RU }:: ::Nelly::{ user=4741164 } |
| ![Bronze crown](/wiki/shared/crown-bronze.png "Третье место") | ::{ flag=RU }:: ::KitsunIvy::{ user=7055384 } |
...
| :-: | --: | :-: | :-: | :-- | :-- |
| Нижняя | ::KitsunIvy::{ user=7055384 } ::{ flag=RU }:: | 2 | **7** | ::{ flag=RU }:: **::Nelly::{ user=4741164 }** | [#1](https://osu.ppy.sh/community/matches/98623588) |

Суббота, 12 марта 2022:

| Сетка | Игрок 1 |  |  | Игрок 2 | Ссылка на матч |
| :-: | --: | :-: | :-: | :-- | :-- |
| Гранд-финал | **::Memoriola::{ user=6856387 }** ::{ flag=RU }:: | **7** | 3 | ::{ flag=RU }:: ::Nelly::{ user=4741164 } | [#1](https://osu.ppy.sh/community/matches/98655352) |
...
| Сетка | Игрок 1 |  |  | Игрок 2 | Ссылка на матч |
| :-: | --: | :-: | :-: | :-- | :-- |
| Верхняя | ::FruktoLove::{ user=8417087 } ::{ flag=UA }:: | 0 | **6** | ::{ flag=RU }:: **::Kenny331::{ user=11534285 }** | *выигран по умолчанию* |
| Верхняя | **::Memoriola::{ user=6856387 }** ::{ flag=RU }:: | **6** | 5 | ::{ flag=RU }:: ::Nelly::{ user=4741164 } | [#1](https://osu.ppy.sh/community/matches/98431626) |
| Нижняя | **::KitsunIvy::{ user=7055384 }** ::{ flag=RU }:: | **6** | 0 | ::{ flag=RU }:: ::cosilgam::{ user=15960747 } | [#1](https://osu.ppy.sh/community/matches/98434650) |

Воскресенье, 6 марта 2022:

| Сетка | Игрок 1 |  |  | Игрок 2 | Ссылка на матч |
| :-: | --: | :-: | :-: | :-- | :-- |
| Нижняя | ::Kenny331::{ user=11534285 } ::{ flag=RU }:: | 5 | **6** | ::{ flag=RU }:: **::KitsunIvy::{ user=7055384 }** | [#1](https://osu.ppy.sh/community/matches/98471760) |
...
| Сетка | Игрок 1 |  |  | Игрок 2 | Ссылка на матч |
| :-: | --: | :-: | :-: | :-- | :-- |
| Верхняя | ::KitsunIvy::{ user=7055384 } ::{ flag=RU }:: | 2 | **6** | ::{ flag=RU }:: **::Memoriola::{ user=6856387 }** | [#1](https://osu.ppy.sh/community/matches/98207047) |
| Нижняя | **::cosilgam::{ user=15960747 }** ::{ flag=RU }:: | **6** | 0 | ::{ flag=RU }:: ::yuinn::{ user=11239593 } | [#1](https://osu.ppy.sh/community/matches/98200762) |
| Нижняя | **::Kenny331::{ user=11534285 }** ::{ flag=RU }:: | **6** | 1 | ::{ flag=RU }:: ::dark rainbow::{ user=10557830 } | [#1](https://osu.ppy.sh/community/matches/98202559) |
| Нижняя | ::\[-Nyaruko-\]::{ user=13712671 } ::{ flag=UA }:: | 5 | **6** | ::{ flag=RU }:: **::BocDyx::{ user=7926192 }** | [#1](https://osu.ppy.sh/community/matches/98204752) |

Воскресенье, 27 февраля 2022:

| Сетка | Игрок 1 |  |  | Игрок 2 | Ссылка на матч |
| :-: | --: | :-: | :-: | :-- | :-- |
| Верхняя | **::Nelly::{ user=4741164 }** ::{ flag=RU }:: | **6** | 0 | ::{ flag=UA }:: ::FruktoLove::{ user=8417087 } | *выигран по умолчанию* |
| Нижняя | **::vafara::{ user=18917363 }** ::{ flag=RU }:: | **6** | 0 | ::{ flag=LV }:: ::Soruki::{ user=11762423 } | [#1](https://osu.ppy.sh/community/matches/98240517) |
| Нижняя | ::vafara::{ user=18917363 } ::{ flag=RU }:: | 4 | **6** | ::{ flag=RU }:: **::Kenny331::{ user=11762423 }** | [#1](https://osu.ppy.sh/community/matches/98242204) |
...
| Нижняя | **::Mazuki::{ user=15208771 }** ::{ flag=RU }:: | **5** | 0 | ::{ flag=LV }:: ::oFKors01::{ user=26522965 } | *выигран по умолчанию* |
| Нижняя | **::Shadowbolts1::{ user=13962882 }** ::{ flag=UA }:: | **5** | 0 | ::{ flag=RU }:: ::PedobeerKoroche::{ user=19389015 } | *выигран по умолчанию* |

Воскресенье, 20 февраля 2022:

| Сетка | Игрок 1 |  |  | Игрок 2 | Ссылка на матч |
| :-: | --: | :-: | :-: | :-- | :-- |
| Верхняя | **::FruktoLove::{ user=8417087 }** ::{ flag=UA }:: | **5** | 0 | ::{ flag=RU }:: ::cosilgam::{ user=15960747 } | [#1](https://osu.ppy.sh/community/matches/97991698) |
| Верхняя | **::KitsunIvy::{ user=7055384 }** ::{ flag=RU }:: | **5** | 4 | ::{ flag=RU }:: ::Kenny331::{ user=11534285 } | [#1](https://osu.ppy.sh/community/matches/97993299) |
| Верхняя | **::Nelly::{ user=4741164 }** ::{ flag=RU }:: | **5** | 0 | ::{ flag=UA }:: ::\[-Nyaruko-\]::{ user=13712671 } | *выигран по умолчанию* |
| Нижняя | **::BocDyx::{ user=7926192 }** ::{ flag=RU }:: | **5** | 0 | ::{ flag=RU }:: ::catch the ExGon::{ user=12081746 } | [#1](https://osu.ppy.sh/community/matches/97991684) |
| Нижняя | **::dark rainbow::{ user=10557830 }** ::{ flag=RU }:: | **5** | 4 | ::{ flag=RU }:: ::Mazuki::{ user=15208771 } | [#1](https://osu.ppy.sh/community/matches/97995303) |
| Нижняя | **::yuinn::{ user=11239593 }** ::{ flag=RU }:: | **5** | 1 | ::{ flag=UA }:: ::Shadowbolts1::{ user=13962882 } | [#1](https://osu.ppy.sh/community/matches/97998932) |
| Нижняя | **::Soruki::{ user=11762423 }** ::{ flag=RU }:: | **5** | 0 | ::{ flag=UA }:: ::Violet Feets::{ user=15558360 } | *выигран по умолчанию* |
...
| Сетка | Игрок 1 |  |  | Игрок 2 | Ссылка на матч |
| :-: | --: | :-: | :-: | :-- | :-- |
| Верхняя | **::Memoriola::{ user=6856387 }** ::{ flag=RU }:: | **5** | 0 | ::{ flag=UA }:: ::Shadowbolts1::{ user=13962882 } | [#1](https://osu.ppy.sh/community/matches/97691557) |
| Верхняя | **::cosilgam::{ user=15960747 }** ::{ flag=RU }:: | **5** | 4 | ::{ flag=LV }:: ::Soruki::{ user=11762423 } | [#1](https://osu.ppy.sh/community/matches/97693687) |
| Верхняя | ::BocDyx::{ user=7926192 } ::{ flag=RU }:: | 1 | **5** | ::{ flag=RU }:: **::Kenny331::{ user=11534285 }** | [#1](https://osu.ppy.sh/community/matches/97695862) |
| Верхняя | **::vafara::{ user=18917363 }** ::{ flag=RU }:: | **5** | 4 | ::{ flag=RU }:: ::yuinn::{ user=11239593 } | [#1](https://osu.ppy.sh/community/matches/97700538) |
