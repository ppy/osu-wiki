...
| 图池管理 | ::{ flag=CN }:: [Tofu1222](https://osu.ppy.sh/user/6089608)、::{ flag=CN }:: ::hans1999::{ user=6679329 } |
| 直播裁判 | ::{ flag=CN }:: [aiyulu](https://osu.ppy.sh/user/189617)、::{ flag=CN }:: [Rasis](https://osu.ppy.sh/user/1209363)、::{ flag=CN }:: ::Flow Light::{ user=6705256 }、::{ flag=CN }:: ::kj415j45::{ user=9367540 } |
| 解说团队 | ::{ flag=CN }:: ::hans1999::{ user=6679329 }、::{ flag=CN }:: ::Flow Light::{ user=6705256 }、::{ flag=CN }:: [Rasis](https://osu.ppy.sh/user/1209363)、::{ flag=CN }:: ::644520858::{ user=5507069 }、::{ flag=CN }:: [wuhuanmin](https://osu.ppy.sh/user/935322) 、::{ flag=CN }:: [704661982](https://osu.ppy.sh/user/7080633) |
