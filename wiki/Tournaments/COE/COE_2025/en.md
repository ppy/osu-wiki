...
The matches will start once the scheduled time is reached and a referee is present.  There will be no warm ups during the match. Players get to decide the order. A short break is given between each map, the exact duration is at the discretion of the referee.
