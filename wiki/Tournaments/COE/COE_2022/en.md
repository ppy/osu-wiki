...
The **COE 1v1 Tournament 2022** (***COE1v12022***) was an international open-rank 1v1 tournament hosted by ::{ flag=US }:: ::ChillierPear::{ user=9501251 }. It was the second instalment of the COE 1v1 Tournament.
...
The COE 1v1 Tournament 2022 was run by various community members.

| Position | Member(s) |
| :-- | :-- |
| Organisation | ::{ flag=NL }:: ::cavoeboy::{ user=7361815 }, ::{ flag=US }:: ::ChillierPear::{ user=9501251 }, ::{ flag=FR }:: ::ThePooN::{ user=718454 }, ::{ flag=DE }:: ::Meyer::{ user=5452367 } |
| Mapper | ::{ flag=GB }:: ::CallieCube::{ user=7535045 }, ::{ flag=NL }:: ::happy30::{ user=27767 }, ::{ flag=US }:: ::olc::{ user=7081160 }, ::{ flag=BE }:: ::yaspo::{ user=4945926 }, ::{ flag=CA }:: ::Serenhaide::{ user=10466315 }, ::{ flag=GB }:: ::DeviousPanda::{ user=4966334 }, ::{ flag=JP }:: ::rollpan::{ user=3062998 }, ::{ flag=US }:: ::Woey::{ user=3792472 }, ::{ flag=AU }:: ::elicz1::{ user=8039342 }, ::{ flag=PL }:: ::Zelq::{ user=8953955 }, ::{ flag=US }:: ::Halfslashed::{ user=4598899 }, ::{ flag=CA }:: ::Gordon::{ user=7856835 }, ::{ flag=CN }:: ::Ryuusei Aika::{ user=7777875 }, ::{ flag=GB }:: ::Aistre::{ user=4879380 }, ::{ flag=SE }:: ::melwoine::{ user=12091109 } |
| Commentator | ::{ flag=PL }:: ::Bartek22830::{ user=6404027 }, ::{ flag=GB }:: ::bloo::{ user=6778877 }, ::{ flag=US }:: ::ChillierPear::{ user=9501251 }, ::{ flag=US }:: ::D I O::{ user=3958619 }, ::{ flag=US }:: ::Halfslashed::{ user=4598899 }, ::{ flag=US }:: ::M I L E S::{ user=6036351 }, ::{ flag=IT }:: ::Spazza17::{ user=3516241 }, ::{ flag=PL }:: ::Wilchq::{ user=2021758 }, ::{ flag=US }:: ::Woey::{ user=3792472 } |
| Referee | ::{ flag=US }:: ::ChillierPear::{ user=9501251 }, ::{ flag=IN }:: ::Speshimen::{ user=7720204 }, ::{ flag=FI }:: ::shdewz::{ user=10000899 }, ::{ flag=DE }:: ::TheHunter1::{ user=6496016 }, ::{ flag=US }:: ::\[K\]::{ user=16551387 } |
...
- [Pick'ems page](https://pickem.hwc.hr/tournaments/96) hosted by ::{ flag=DE }:: ::hallowatcher::{ user=1874761 }
...
| Seed No. | Player |
| :-: | :-- |
| 1 | ::{ flag=SE }:: ::Reedkatt::{ user=8335950 } |
| 2 | ::{ flag=PL }:: ::Bartek22830::{ user=6404027 } |
| 3 | ::{ flag=EE }:: ::Abyssal::{ user=5527745 } |
| 4 | ::{ flag=US }:: ::Trail Mix::{ user=3328742 } |
| 5 | ::{ flag=PL }:: ::Mastasz::{ user=1876565 } |
| 6 | ::{ flag=PL }:: ::Michni::{ user=3543130 } |
| **okinamo** ::{ flag=DE }:: | **5** | 2 | ::{ flag=GB }:: Malteser | [#1](https://osu.ppy.sh/multiplayer/rooms/219822) |
...
| Player A |  |  | Player B | Match link |
| --: | :-: | :-: | :-- | :-- |
| Reedkatt ::{ flag=SE }:: | 2 | **5** | ::{ flag=DK }:: **cat burger** | [#1](https://osu.ppy.sh/multiplayer/rooms/219800) |
...
| Player A |  |  | Player B | Match link |
| --: | :-: | :-: | :-- | :-- |
| Reedkatt ::{ flag=SE }:: | 3 | **5** | ::{ flag=GB }:: **Malteser** | [#1](https://osu.ppy.sh/multiplayer/rooms/219752) |
| **okinamo** ::{ flag=DE }:: | **5** | 3 | ::{ flag=DK }:: cat burger | [#1](https://osu.ppy.sh/multiplayer/rooms/219780) |
...
| Player A |  |  | Player B | Match link |
| --: | :-: | :-: | :-- | :-- |
| **Reedkatt** ::{ flag=SE }:: | **5** | 1 | ::{ flag=GB }:: bloo | [#1](https://osu.ppy.sh/multiplayer/rooms/219660) |
| badeu ::{ flag=RO }:: | 4 | **5** | ::{ flag=GB }:: **Malteser** | [#1](https://osu.ppy.sh/multiplayer/rooms/219668) |
| **okinamo** ::{ flag=DE }:: | **5** | 4 | ::{ flag=PL }:: Bartek22830 | [#1](https://osu.ppy.sh/multiplayer/rooms/219687) |
| **cat burger** ::{ flag=DK }:: | **5** | 2 | ::{ flag=PL }:: Michni | [#1](https://osu.ppy.sh/multiplayer/rooms/219712) |
...
| Player A |  |  | Player B | Match link |
| --: | :-: | :-: | :-- | :-- |
| **Reedkatt** ::{ flag=SE }:: | **5** | 0 | ::{ flag=DE }:: Ephix | [#1](https://osu.ppy.sh/multiplayer/rooms/219351) |
| oomfie mcdonald ::{ flag=SM }:: | 1 | **5** | ::{ flag=GB }:: **bloo** | [#1](https://osu.ppy.sh/multiplayer/rooms/219375) |
| Trail Mix ::{ flag=US }:: | 3 | **5** | ::{ flag=RO }:: **badeu** | [#1](https://osu.ppy.sh/multiplayer/rooms/219387) |
| Mastasz ::{ flag=PL }:: | 2 | **5** | ::{ flag=GB }:: **Malteser** | [#1](https://osu.ppy.sh/multiplayer/rooms/219415) |
| **Bartek22830** ::{ flag=PL }:: | **5** | 3 | ::{ flag=DE }:: angelkanna | [#1](https://osu.ppy.sh/multiplayer/rooms/219436) |
| **okinamo** ::{ flag=DE }:: | **5** | 4 | ::{ flag=NO }:: ninerik | [#1](https://osu.ppy.sh/multiplayer/rooms/219445) |
| abyssal ::{ flag=EE }:: | 1 | **5** | ::{ flag=DK }:: **cat burger** | [#1](https://osu.ppy.sh/multiplayer/rooms/219459) |
| **Michni** ::{ flag=PL }:: | **5** | 0 | ::{ flag=PL }:: Rafis | [#1](https://osu.ppy.sh/multiplayer/rooms/219483) |
...
- In the Qualifiers, players need to place in the top 16 seeds in order to advance to the single-elimination bracket.
- In the LAN round, players need to win 5 maps to win a match (best of 9).
