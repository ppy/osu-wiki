...
**第三届幽幽杯** (***YHC S3***) 是基于 osu! 主模式，娱乐为主的多人 (4v4) 打图游玩锦标赛，主办是 ::{ flag=CN }:: ::SIyuyuko::{ user=9794030 }。这是该系列赛的第三届比赛。
...
| 提供回放 | ::{ flag=CN }:: ::Hakumo Shiro::{ user=5179557 }, ::{ flag=CN }:: ::Hakumo Ai::{ user=694480 }, ::{ flag=CN }:: ::VialVistas::{ user=9697708 }, ::{ flag=CN }:: ::Sayori\_yui::{ user=7183040 }, ::{ flag=CN }:: ::Senbe1::{ user=6911753 }, ::{ flag=CN }:: ::carrywind::{ user=12228018 } |
