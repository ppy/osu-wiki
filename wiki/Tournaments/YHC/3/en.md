...
The **Yuyuko's Hidden Cup Season 3** (***YHC S3***) was a team-based 4v4 double-elimination osu! tournament hosted by ::{ flag=CN }:: ::SIyuyuko::{ user-id=9794030 }. It was the 3rd instalment of the Yuyuko's Hidden Cup.
...
| Showcaser | ::{ flag=CN }:: ::Hakumo Shiro::{ user-id=5179557 }, ::{ flag=CN }:: ::Hakumo Ai::{ user-id=694480 }, ::{ flag=CN }:: ::VialVistas::{ user-id=9697708 }, ::{ flag=CN }:: ::Sayori\_yui::{ user-id=7183040 }, ::{ flag=CN }:: ::Senbe1::{ user-id=6911753 }, ::{ flag=CN }:: ::carrywind::{ user-id=12228018 } |
