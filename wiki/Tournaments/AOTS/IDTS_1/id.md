...
**Indonesian Taiko Showdown** (**_IDTS_**) adalah turnamen eliminasi ganda satu-lawan-satu, mode osu!taiko regional Indonesia, yang diselenggarakan oleh ![][flag_ID] [fajar13k](https://osu.ppy.sh/users/7100002). Kali ini merupakan instalasi ke-1 dari turnamen Asian Taiko Showdown Taiko Showdown.
...
-   NoMod
    ...
    -   [Sara - Natu iro Present Wo BPM180 Ni Shitemita (asuasu_yura) \[Special\]](https://osu.ppy.sh/beatmaps/1078077&m=1)
...
-   NoMod
    ...
    -   [Yooh - Seraphim (koyomi_222) \[Inner Oni\]](https://osu.ppy.sh/beatmaps/926314&m=1)
...
|              Sabtu, 2017-06-03 |       |       |                         |                                                     |
| -----------------------------: | :---: | :---: | :---------------------- | :-------------------------------------------------- |
| **Katdon_donKat** ![][flag_ID] | **6** |   2   | ![][flag_ID] steven1    | [#1](https://osu.ppy.sh/community/matches/33568382) |
...
| Katdon_donKat ![][flag_ID] |   1   | **6** | ![][flag_ID] **Nishizumi** | [#1](https://osu.ppy.sh/community/matches/33621267) |
...
|        Katdon_donKat ![][flag_ID] |   1   | **6** | ![][flag_ID] **XK2238**    | [#1](https://osu.ppy.sh/community/matches/33440128) |
|        \_Destroyer\_ ![][flag_ID] |   4   | **6** | ![][flag_ID] **misaki_tk** | [#1](https://osu.ppy.sh/community/matches/33440300) |
...
|      **Shirai**- ![][flag_ID] | **6** |   4   | ![][flag_ID] misaki_tk   | [#1](https://osu.ppy.sh/community/matches/33465609) |

### Perempat Final

|              Sabtu, 2017-05-20 |       |     |                               |                                                     |
| -----------------------------: | :---: | :-: | :---------------------------- | :-------------------------------------------------- |
| **Katdon_donKat** ![][flag_ID] | **5** |  1  | ![][flag_ID] \_Destroyer\_    | [#1](https://osu.ppy.sh/community/matches/33286726) |
...
| **misaki_tk** ![][flag_ID] | **5** |   0   | ![][flag_ID] Volta       | -win by default-                                    |
...
| **Katdon_donKat** ![][flag_ID] | **5** |  2  | ![][flag_ID] Plua-     | [#1](https://osu.ppy.sh/community/matches/33132821) |
|     **Nishizumi** ![][flag_ID] | **5** |  1  | ![][flag_ID] misaki_tk | [#1](https://osu.ppy.sh/community/matches/33134539) |
...
|   H  |           **pmriva** ![][flag_ID] | **4** |   1   | ![][flag_ID] Franklin_DeJavu   | [#1](https://osu.ppy.sh/community/matches/32971269) |
...
|   F  |        **misaki_tk** ![][flag_ID] | **4** |   0   | ![][flag_ID] Rendang           | [#1](https://osu.ppy.sh/community/matches/32974229) |
|   E  |    **Katdon_donKat** ![][flag_ID] | **4** |   0   | ![][flag_ID] Volta             | [#1](https://osu.ppy.sh/community/matches/32975857) |
|   D  | **Lightning Wyvern** ![][flag_ID] | **4** |   0   | ![][flag_ID] Plua-             | [#1](https://osu.ppy.sh/community/matches/32975711) |
|   F  |            misaki_tk ![][flag_ID] |   1   | **4** | ![][flag_ID] **\_Destroyer\_** | [#1](https://osu.ppy.sh/community/matches/32975848) |
|   H  |          **Shirai-** ![][flag_ID] | **4** |   0   | ![][flag_ID] Franklin_DeJavu   | [#1](https://osu.ppy.sh/community/matches/32977134) |
...
|   E  | **Katdon_donKat** ![][flag_ID] | **4** |   0   | ![][flag_ID] Elisabeth-   | -win by default-                                    |
