...
| Posisi | Pemain |
| :-: | :-- |
| ![Mahkota Emas](/wiki/shared/crown-gold.png "Juara satu") | ::{ flag="ID" }:: [XK2238](https://osu.ppy.sh/users/1139209) |
| ![Mahkota Perak](/wiki/shared/crown-silver.png "Juara dua") | ::{ flag="ID" }:: [pmriva](https://osu.ppy.sh/users/2180885) |
| ![Mahkota Perunggu](/wiki/shared/crown-bronze.png "Juara tiga") | ::{ flag="ID" }:: [Nishizumi](https://osu.ppy.sh/users/2496768) |
