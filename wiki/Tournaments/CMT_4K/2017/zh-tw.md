...
![](/wiki/shared/GCrown.png) 3個月 osu! 支持者，主頁定制勛章，CrazyBoard Mark One 鍵盤；   
...
1. 在資格賽階段，全部選手隨機分為8人一組進行在線多人游戲（Multiplayer），每張圖按照圖池的順序打2遍，並取最高分數。4張圖分數之和就是選手的總成績。
...
1. 一位記錄員會在賽事開始前**15**分鐘創建一個在線多人游戲房間（Multiplayer），選手需要在此時集合：
