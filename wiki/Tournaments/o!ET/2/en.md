...
10. Mappool format will go as follows:
    - Qualifiers: 2 NoMod/1 Hidden/1 Hard Rock/1 Double Time.
    - Group Stage: 5 NoMod/2 Hidden/2 Hard Rock/2 Double Time/3 FreeMod/1 Tiebreaker.
    - RO16 and onwards: 6 NoMod/3 Hidden/3 Hard Rock/3 Double Time/3 FreeMod/1 Tiebreaker.
...
3. Matches will be played using TeamVS, Score v2 settings, which means the score of each player will be capped to 1M(+mod multiplier(s)&spinner bonus), but also that if two players from the same team fail, a point will be awarded to the other team who passed, even if there is only one player alive or if they fail afterwards. Failed scores **do not** count.
