...
|  | Team | Members |
| :-: | :-: | :-- |
| ![Austria-Hungary](img/AH.png) | **Austria-Hungary**[^austria-hungary] | **::fedoragoose::{ user=2323131 }**, ::z9a::{ user=13057699 }, ::z10a::{ user=18153252 }, ::defii::{ user=8698024 } |
| ![Baltics](img/BC.png) | **Baltics**[^baltics] | **::basketball::{ user=10290012 }**, ::cedru::{ user=10162611 }, ::ganjanov::{ user=11584075 }, ::Hera\1::{ user=8766780 } |
| ::{ flag=BR }:: | **Brazil** | **::dasdwqdf::{ user=5403374 }**, ::Coreanmaluco::{ user=3149577 }, ::-izzy::{ user=15225729 }, ::VitorSkull::{ user=10223298 }, ::shwq::{ user=22536015 }, ::vetoed::{ user=10909373 } |
| ::{ flag=CA }:: | **Canada** | **::PikaPwn::{ user=2012453 }**, ::nicki1324::{ user=612898 }, ::PinkEyeFan2013::{ user=13609904 }, ::fireblaze3028::{ user=9088637 }, ::pretty girl::{ user=11684952 }, ::leny::{ user=8222366 } |
| ::{ flag=CL }:: | **Chile** | **::Eunha::{ user=7701428 }**, ::Nekore::{ user=18946207 }, ::\1fefe::{ user=8133880 }, ::Oscar con boina::{ user=18284065 }, ::alfiu::{ user=17724014 }, ::YukariSmug::{ user=12211248 } |
| ::{ flag=CN }:: | **China** | **::lolol235::{ user=6090175 }**, ::Crystal::{ user=1646397 }, ::MidC::{ user=20461077 }, ::Ledeau\1Fox::{ user=15816872 } |
| ::{ flag=FI }:: | **Finland** | **::Amasetic::{ user=11375251 }**, ::AllyrD::{ user=9561644 }, ::Isak-::{ user=8702650 }, ::Tabletti::{ user=9523661 }, ::chu::{ user=14764185 }, ::BeerLovingGnome::{ user=4959454 } |
| ::{ flag=FR }:: | **France** | **::Hifkil::{ user=4301976 }**, ::Thuya::{ user=11750028 }, ::Satsukiiii::{ user=25626082 }, ::JapWhite::{ user=7068158 }, ::-Wum-::{ user=11170841 }, ::lonq noir::{ user=14165027 } |
| ::{ flag=DE }:: | **Germany** | **::Tim Kackner::{ user=14385814 }**, ::criller::{ user=8116659 }, ::Fleh::{ user=7780605 }, ::Bernkastel::{ user=5154946 }, ::SERBIATRUCKER13::{ user=15339747 }, ::120-cell::{ user=12571145 } |
| ::{ flag=GR }:: | **Greece** | **::JackPaX::{ user=11226645 }**, ::-Puyu::{ user=10398348 }, ::Nekkid::{ user=12145220 }, ::Mqnster::{ user=27672816 }, ::bob man::{ user=20263707 } |
| ![Iberia](img/IB.png) | **Iberia**[^iberia] | **::M A N O L O::{ user=12296128 }**, ::ESCRUPULILLO::{ user=18217876 }, ::RafaMat::{ user=10743390 }, ::A L E P H::{ user=6735738 }, ::Omeguii::{ user=10596572 }, ::towny1::{ user=16512684 } |
| ![Imperio Rioplatense](img/AY.png) | **Imperio Rioplatense**[^imperio-rioplatense] | **::Rebo::{ user=6942259 }**, ::Kazuki K::{ user=6407282 }, ::R1cho::{ user=13065919 }, ::viciobylike::{ user=18922516 }, ::Bomilk::{ user=7081596 }, ::Seiong::{ user=7341471 } |
| ::{ flag=ID }:: | **Indonesia** | **::Hakui Koyori::{ user=10717635 }**, ::Stixe::{ user=18351160 }, ::GNX::{ user=10069909 }, ::MineFrostID::{ user=12159899 }, ::Norlain::{ user=11983229 }, ::VtuberVoiceASMR::{ user=8780223 } |
| ::{ flag=JP }:: | **Japan** | **::Teacchyyy::{ user=7178423 }**, ::YMD::{ user=17202789 }, ::haga1115::{ user=6574823 }, ::yukin1014::{ user=8329753 }, ::Furamun::{ user=14671051 } |
| ::{ flag=NO }:: | **Norway** | **::Melvr::{ user=9211924 }**, ::Pinguinzi::{ user=9414229 }, ::nanolini::{ user=12353810 }, ::veirakk::{ user=15423958 }, ::chaotic\1turtle::{ user=5563397 }, ::HUNDUR::{ user=3145033 } |
| ![Oceania](img/OC.png) | **Oceania**[^oceania] | **::cyo::{ user=8195473 }**, ::palr::{ user=15429006 }, ::Arbusion::{ user=11469447 }, ::Xaver::{ user=7410343 }, ::ozy::{ user=11310423 }, ::Emilbus::{ user=11141578 } |
| ::{ flag=PH }:: | **Philippines** | **::NathanRam1918::{ user=4734703 }**, ::zonelouise::{ user=1492995 }, ::LordGabriel::{ user=9227895 }, ::aurora on osu::{ user=12352050 }, ::Alue::{ user=7467327 }, ::Icarussy::{ user=19526828 } |
| ::{ flag=PL }:: | **Poland** | **::szedis::{ user=14282987 }**, ::Bartek22830::{ user=6404027 }, ::Mastasz::{ user=1876565 }, ::Kosiarek::{ user=9086565 }, ::Tartis::{ user=9513980 }, ::alimentaire::{ user=4981809 } |
| ::{ flag=RO }:: | **Romania** | **::Lucrise::{ user=9719351 }**, ::etn::{ user=4581069 }, ::nanoya::{ user=12366071 }, ::badeu::{ user=1473890 }, ::origin\1::{ user=15095811 } |
| ::{ flag=RU }:: | **Russian Federation** | **::HandsomeMe::{ user=11376152 }**, ::Skrowell::{ user=9694263 }, ::-Din-::{ user=7972980 }, ::de\1nuke\1::{ user=9712285 }, ::Ice Shark::{ user=9459674 }, ::DaHuJka::{ user=6830745 } |
| ::{ flag=KR }:: | **South Korea** | **::Amamya Kokoro::{ user=2511839 }**, ::-Restia::{ user=7892320 }, ::Allegrissimo::{ user=9052194 }, ::Doomsday fanboy::{ user=4511522 }, ::fragranceofpage::{ user=11399348 }, ::Peresia::{ user=7027766 } |
| ::{ flag=SE }:: | **Sweden** | **::trumpatino69::{ user=10903510 }**, ::Jageko::{ user=5798349 }, ::TheNexusGamer::{ user=7205256 }, ::Zever::{ user=16620877 }, ::Purpol::{ user=14287201 }, ::Sleya::{ user=11961979 } |
| ::{ flag=TW }:: | **Taiwan** | **::\1Shield::{ user=1860489 }**, ::willy0214::{ user=8660293 }, ::\[ Zane \]::{ user=3517706 }, ::Rizer::{ user=5155973 }, ::DazzLE\1Wind::{ user=2537924 }, ::Kyros\1::{ user=23925029 } |
| ::{ flag=UA }:: | **Ukraine** | **::Ayla::{ user=4548264 }**, ::RafGPio::{ user=13705417 }, ::sur1::{ user=13872859 }, ::Slowpoke1327::{ user=9820878 }, ::gusniki::{ user=9830628 }, ::1Max::{ user=11653711 } |
| ::{ flag=GB }:: | **United Kingdom** | **::Bubbleman::{ user=5182050 }**, ::Mahmood::{ user=7627844 }, ::EZChamp::{ user=1719471 }, ::HAUNTE::{ user=7333471 }, ::skiatzo::{ user=16774872 }, ::lystia::{ user=11042418 } |
| ::{ flag=US }:: | **United States** | **::tekkito::{ user=7075211 }**, ::Pezz::{ user=10651106 }, ::EthantrixV2::{ user=10634348 }, ::BoshyMan741::{ user=4830687 }, ::\[C\]::{ user=7959945 }, ::Flameztear::{ user=13207763 } |
