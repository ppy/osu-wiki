...
|  | Team | Members |
| :-: | :-: | :-- |
| ::{ flag=AU }:: | **Australia** | **::palr::{ user=15429006 }**, ::Zyntex::{ user=11806306 }, ::cyo::{ user=8195473 }, ::Xaver::{ user=7410343 }, ::Drox-::{ user=4309566 }, ::saykk::{ user=18973222 } |
| ::{ flag=XX }:: | **Austria-Hungary**[^austria-hungary] | **::fedoragoose::{ user=2323131 }**, ::defii::{ user=8698024 }, ::z9a::{ user=13057699 }, ::z10a::{ user=18153252 }, ::Akuma no Tenshi::{ user=21811804 }, ::Nekoyase::{ user=10981997 } |
| ::{ flag=BR }:: | **Brazil** | **::monte::{ user=10077132 }**, ::-IZZY::{ user=15225729 }, ::Coreanmaluco::{ user=3149577 }, ::shwq::{ user=22536015 }, ::tayko::{ user=20328948 }, ::-Hirata::{ user=10188022 } |
| ::{ flag=CA }:: | **Canada** | **::PikaPwn::{ user=2012453 }**, ::puppy::{ user=6304246 }, ::Wanderio::{ user=16529875 }, ::noncycle::{ user=12701607 }, ::Rykaii::{ user=10792185 }, ::C-L::{ user=8901306 } |
| ::{ flag=CL }:: | **Chile** | **::alfiu::{ user=17724014 }**, ::Gonzah::{ user=12434652 }, ::\1fefe::{ user=8133880 }, ::nekore::{ user=18946207 }, ::Hanayume::{ user=12211248 } |
| ::{ flag=XX }:: | **Czechoslovakia**[^czechoslovakia] | **::Dri3x::{ user=11478426 }**, ::RafeuX::{ user=11553201 }, ::Seviade::{ user=10954912 } |
| ::{ flag=DE }:: | **Germany** | **::runnysunny::{ user=15339747 }**, ::-lion::{ user=24270105 }, ::Fleh::{ user=7780605 }, ::Sh4rq\1::{ user=11684622 }, ::Christiaaan::{ user=11804019 } |
| ::{ flag=FI }:: | **Finland** | **::Nev-::{ user=11836334 }**, ::Amasetic::{ user=11375251 }, ::Isak-::{ user=8702650 }, ::Mike Tyson::{ user=14764185 }, ::Marjus::{ user=10463344 } |
| ::{ flag=FR }:: | **France** | **::Musty::{ user=251683 }**, ::Hifkil::{ user=4301976 }, ::Satsukiiii::{ user=25626082 }, ::Thundur::{ user=4141918 }, ::JapWhite::{ user=7068158 }, ::lonq noir::{ user=14165027 } |
| ::{ flag=GB }:: | **United Kingdom** | **::fudge::{ user=11592896 }**, ::Bubbleman::{ user=5182050 }, ::SinqHD::{ user=15887523 }, ::polski1::{ user=18131614 }, ::Reimu Hakurei::{ user=12686213 }, ::velcro shoes::{ user=11345690 } |
| ::{ flag=GR }:: | **Greece** | **::JackPaX::{ user=11226645 }**, ::-Puyu::{ user=10398348 }, ::Nekkid::{ user=12145220 }, ::bob man::{ user=20263707 } |
| ::{ flag=HK }:: | **Hong Kong** | **::misha awa::{ user=14503423 }**, ::A21::{ user=11198996 }, ::F2X::{ user=16227745 }, ::maxbireo::{ user=4682646 }, ::Tsuwagi::{ user=9313951 }, ::Zoomeree::{ user=18802561 } |
| ::{ flag=XX }:: | **Iberia**[^iberia] | **::A L E P H::{ user=6735738 }**, ::towny1::{ user=16512684 }, ::\[dekori\]::{ user=17465075 }, ::ESCRUPULILLO::{ user=18217876 }, ::RafaMat::{ user=10743390 }, ::uatzap::{ user=16509171 } |
| ::{ flag=XX }:: | **Imperio Rioplatense**[^imperio-rioplatense] | **::Bomilk::{ user=7081596 }**, ::Tofy::{ user=11113067 }, ::viciobylike::{ user=18922516 }, ::Seiong::{ user=7341471 }, ::Rebo::{ user=6942259 }, ::helvetia::{ user=6407282 } |
| ::{ flag=ID }:: | **Indonesia** | **::GNX::{ user=10069909 }**, ::MineFrostID::{ user=12159899 }, ::im a fancy kids::{ user=16270893 }, ::Hakui Koyori::{ user=10717635 }, ::Norlain::{ user=11983229 }, ::VtuberVoiceASMR::{ user=8780223 } |
| ::{ flag=JP }:: | **Japan** | **::YMD::{ user=17202789 }**, ::k4rnu1::{ user=15537476 }, ::Homutan::{ user=8655635 }, ::haga1115::{ user=6574823 }, ::Rikuima::{ user=14035920 }, ::Furamun::{ user=14671051 } |
| ::{ flag=KR }:: | **South Korea** | **::Amamya Kokoro::{ user=2511839 }**, ::Allegrissimo::{ user=9052194 }, ::Chipori::{ user=7027766 }, ::MYKEYBOARD::{ user=15567583 }, ::Petit::{ user=4637369 }, ::Sherbet::{ user=11800154 } |
| ::{ flag=NO }:: | **Norway** | **::Melvr::{ user=9211924 }**, ::papercandle::{ user=12353810 }, ::HUNDUR::{ user=3145033 }, ::Pinguinzi::{ user=9414229 }, ::veirakk::{ user=15423958 }, ::zubs::{ user=4253615 } |
| ::{ flag=NZ }:: | **New Zealand** | **::Emilbus::{ user=11141578 }**, ::HaSappy::{ user=11518376 }, ::ozbert::{ user=23179637 }, ::Rail::{ user=11490085 }, ::pawbert::{ user=11547643 }, ::pii::{ user=13588932 } |
| ::{ flag=PH }:: | **Philippines** | **::NathanRam1918::{ user=4734703 }**, ::LordGabriel::{ user=9227895 }, ::Icarussy::{ user=19526828 }, ::\1Chonker::{ user=13858963 }, ::Rammu::{ user=10652837 }, ::Binninja::{ user=12110337 } |
| ::{ flag=RO }:: | **Romania** | **::origin\1::{ user=15095811 }**, ::badeu::{ user=1473890 }, ::etn::{ user=4581069 }, ::Remirakk::{ user=27758743 }, ::robotonic::{ user=14880483 }, ::capybaras::{ user=10111132 } |
| ::{ flag=RU }:: | **Russian Federation** | **::gamer228666::{ user=5981005 }**, ::nejzha::{ user=8105138 }, ::vljoy209::{ user=16870029 }, ::CR7MENTAL1TY::{ user=13334336 }, ::reimia::{ user=11243772 }, ::maxim::{ user=9459674 } |
| ::{ flag=SE }:: | **Sweden** | **::trumpatino69::{ user=10903510 }**, ::JAGEKO::{ user=5798349 }, ::Raidd::{ user=14945721 }, ::Timpower::{ user=11533034 }, ::TheNexusGamer::{ user=7205256 } |
| ::{ flag=SG }:: | **Singapore** | **::manicmacho::{ user=14490563 }**, ::Cymango::{ user=19256705 }, ::Mekeyo::{ user=10270787 }, ::Eagle5324::{ user=11987104 }, ::qstronaut::{ user=10958852 }, ::koyo::{ user=13623476 } |
| ::{ flag=TH }:: | **Thailand** | **::Lesperry::{ user=18092331 }**, ::-Kedama::{ user=12147277 }, ::ChaiPhukChep::{ user=9723127 }, ::Arz3::{ user=6571991 }, ::Hinamon::{ user=14017762 }, ::fuzzyu::{ user=21958501 } |
| ::{ flag=UA }:: | **Ukraine** | **::GET LOVED::{ user=13705417 }**, ::big\1tatik::{ user=15780777 }, ::doctor mojo::{ user=13872859 }, ::Kotsik::{ user=9820878 }, ::nooneloves::{ user=15885344 }, ::artlost::{ user=15507546 } |
| ::{ flag=US }:: | **United States** | **::Pezz::{ user=10651106 }**, ::tekkito::{ user=7075211 }, ::decaten::{ user=5645231 }, ::EthantrixV3::{ user=10634348 }, ::BoshyMan741::{ user=4830687 }, ::Flameztear::{ user=13207763 } |
