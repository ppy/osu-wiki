...
El **Spanish Showdown 2022** (***SS 2022***) fue un torneo español de doble eliminación 1vs1 de osu! organizado por ::{ flag=ES }:: ::E R N E S T O::{ user-id=2127413 }, ::{ flag=ES }:: ::M A N O L O::{ user-id=12296128 }, y ::{ flag=ES }:: ::Margo::{ user-id=6995685 }. El torneo iba dedicado a los mejores jugadores de osu! españoles, sin límite en su rango. Ha sido la segunda edición del Spanish Showdown.
...
| Posición | Miembro(s) |
| :-- | :-- |
| Organización | ::{ flag=ES }:: ::E R N E S T O::{ user-id=2127413 }, ::{ flag=ES }:: ::M A N O L O::{ user-id=12296128 }, ::{ flag=ES }:: ::Margo::{ user-id=6995685 } |
| Selección de mapas | ::{ flag=ES }:: ::M A N O L O::{ user-id=12296128 }, ::{ flag=ES }:: ::Margo::{ user-id=6995685 }, ::{ flag=ES }:: ::MeiFTW::{ user-id=15049805 }, ::{ flag=ES }:: ::Mortal::{ user-id=4759050 } |
| Creación de mapas | ::{ flag=ES }:: ::CebollaVladimir::{ user-id=15308238 }, ::{ flag=ES }:: ::Jaime Altozano::{ user-id=7567228 }, ::{ flag=HK }:: ::shoyeu::{ user-id=11854343 }, ::{ flag=ES }:: ::Yuri Enjoyer::{ user-id=6961543 } |
| Arbitraje | ::{ flag=ES }:: ::Bubble-::{ user-id=10559526 }, ::{ flag=BR }:: ::Checha::{ user-id=10157694 }, ::{ flag=CA }:: ::dinonesie::{ user-id=18315188 }, ::{ flag=ES }:: ::E R N E S T O::{ user-id=2127413 }, ::{ flag=ES }:: ::Jaime Altozano::{ user-id=7567228 }, ::{ flag=ES }:: ::LeonFlame::{ user-id=12152185 }, ::{ flag=ES }:: ::M A N O L O::{ user-id=12296128 }, ::{ flag=ES }:: ::Margo::{ user-id=6995685 }, ::{ flag=ES }:: ::Milasus::{ user-id=3359440 }, ::{ flag=US }:: ::\[K\]::{ user-id=16551387 } |
| Retransmisión | ::{ flag=ES }:: ::E R N E S T O::{ user-id=2127413 }, ::{ flag=ES }:: ::Margo::{ user-id=6995685 }, ::{ flag=ES }:: ::Milasus::{ user-id=3359440 } |
| Comentaristas | ::{ flag=ES }:: ::Frc::{ user-id=4739655 }, ::{ flag=ES }:: ::gabriseto::{ user-id=11583445 }, ::{ flag=ES }:: ::M A N O L O::{ user-id=12296128 }, ::{ flag=ES }:: ::marbl::{ user-id=9895270 }, ::{ flag=ES }:: ::Margo::{ user-id=6995685 }, ::{ flag=ES }:: ::mario bro::{ user-id=6735738 }, ::{ flag=ES }:: ::MeiFTW::{ user-id=15049805 }, ::{ flag=ES }:: ::Milasus::{ user-id=3359440 }, ::{ flag=ES }:: ::Mortal::{ user-id=4759050 }, ::{ flag=ES }:: ::Pagoz::{ user-id=12675978 }, ::{ flag=ES }:: ::Sakorii::{ user-id=14590106 }, ::{ flag=ES }:: ::SansREPZ::{ user-id=8865297 }, ::{ flag=AR }:: ::Vaf::{ user-id=12589048 } |
| Diseños | ::{ flag=CO }:: ::Clippy::{ user-id=6385568 }, ::{ flag=ES }:: ::Margo::{ user-id=6995685 } |
| Tabla de estadísticas | ::{ flag=US }:: ::HitomiChan\_::{ user-id=11633961 }, ::{ flag=ES }:: ::M A N O L O::{ user-id=12296128 } |
| Escritor de wiki | ::{ flag=ID }:: ::fajar13k::{ user-id=7100002 } |

## Enlaces

- [Hilo de discusión](https://osu.ppy.sh/community/forums/topics/1533166?n=1)
...
| Posición | Jugador |
| :-: | :-- |
| ![Corona de Oro](/wiki/shared/crown-gold.png "1er lugar") | ::{ flag=ES }:: **::A N T O N I O::{ user-id=12760743 }** |
| ![Corona de Plata](/wiki/shared/crown-silver.png "2ndo lugar") | ::{ flag=ES }:: **::Estopa::{ user-id=4470553 }** |
| ![Corona de Bronce](/wiki/shared/crown-bronze.png "3er lugar") | ::{ flag=ES }:: **::NHarmonia::{ user-id=9582556 }** |
...
**[¡Descarga el pack de mapas aquí! (62 MB)](https://drive.google.com/file/d/1KBOZ0u5DZsj5Md3cDTGjYcIdHXVVe0FM/view)**
...
1. El Spanish Showdown 2022 es un **torneo 1vs1** con un formato de doble eliminación, es decir, que habrá un bracket de perdedores.
