...
| Mappool selector | ::{ flag=SE }:: ::Davvy::{ user=10047413 }, ::{ flag=KR }:: ::Kawawa::{ user=4647754 }, ::{ flag=PL }:: ::\_underjoy::{ user=2235750 } |
| Mappool playtester | ::{ flag=MY }:: ::\_Kobii::{ user=6209713 }, ::{ flag=SG }:: ::Evening::{ user=2193881 }, ::{ flag=KR }:: ::Jakads::{ user=259972 }, ::{ flag=US }:: ::Jinjin::{ user=3360737 }, ::{ flag=KR }:: ::Kawawa::{ user=4647754 }, ::{ flag=PH }:: ::lenpai::{ user=5314573 }, ::{ flag=PH }:: ::MapleSyrup\-::{ user=1192936 }, ::{ flag=GB }:: ::Pope Gadget::{ user=2288341 }, ::{ flag=BR }:: ::roko100789::{ user=3224958 }, ::{ flag=US }:: ::stupud man::{ user=2141612 }, ::{ flag=PH }:: ::SurfChu85::{ user=4469895 } |
| Mapper | ::{ flag=MY }:: ::\_Kobii::{ user=6209713 }, ::{ flag=PL }:: ::\_underjoy::{ user=2235750 }, ::{ flag=SE }:: ::Davvy::{ user=10047413 }, ::{ flag=SG }:: ::Evening::{ user=2193881 }, ::{ flag=KR }:: ::Garalulu::{ user=757783 }, ::{ flag=CA }:: ::guden::{ user=11626065 }, ::{ flag=KR }:: ::Jakads::{ user=259972 }, ::{ flag=US }:: ::Jinjin::{ user=3360737 }, ::{ flag=KR }:: ::Kawawa::{ user=4647754 }, ::{ flag=DE }:: ::Leeju::{ user=18219603 }, ::{ flag=PH }:: ::lenpai::{ user=5314573 }, ::{ flag=PH }:: ::MapleSyrup\-::{ user=1192936 }, ::{ flag=PH }:: ::paulkappa::{ user=7115625 }, ::{ flag=KR }:: ::Remuring::{ user=6522146 }, ::{ flag=KR }:: ::TakJun::{ user=4356322 } |
| Commentator | ::{ flag=MY }:: ::Cryolien::{ user=1626983 }, ::{ flag=AR }:: ::juankristal::{ user=443656 }, ::{ flag=AU }:: ::PotassiumF::{ user=4247722 }, ::{ flag=SG }:: ::Raveille::{ user=1388767 }, ::{ flag=PH }:: ::SurfChu85::{ user=4469895 }, ::{ flag=US }:: ::Toaph Daddy::{ user=7616811 }, ::{ flag=US }:: ::-mint-::{ user=8976576 }, ::{ flag=US }:: ::-Sparky-::{ user=3187959 } |
| Referee | ::{ flag=NL }:: ::Albionthegreat::{ user=9853595 }, ::{ flag=AU }:: ::Fairy Bread::{ user=8306102 }, ::{ flag=CH }:: ::Icerite::{ user=7226287 }, ::{ flag=BR }:: ::LeoFLT::{ user=3668779 }, ::{ flag=NL }:: ::nik::{ user=10077264 }, ::{ flag=IN }:: ::Speshimen::{ user=7720204 }, ::{ flag=US }:: ::tigereyes144::{ user=6499811 }, ::{ flag=GB }:: ::Yazzehh::{ user=7068973 } |
...
- [Pick'ems page](https://pickem.hwc.hr/tournaments/76) hosted by ::{ flag=DE }:: ::hallowatcher::{ user=1874761 }
...
|  | Country | Members |
| :-: | :-: | :-- |
| ::{ flag=AR }:: | **Argentina** | **::lxLucasxl::{ user=3632846 }**, [DUELODER](https://osu.ppy.sh/users/8224116), ::Greedom::{ user=10696707 }, [LeongKat](https://osu.ppy.sh/users/11429144) |
| ::{ flag=AU }:: | **Australia** | **::sankansuki::{ user=2877926 }**, [ruka](https://osu.ppy.sh/users/6117525), ::Nerd Guy::{ user=11247298 }, [Bounter](https://osu.ppy.sh/users/11149878) |
| ::{ flag=BE }:: | **Belgium** | **::Coolgamer::{ user=4700778 }**, [shaafs](https://osu.ppy.sh/users/8811695), ::yetii::{ user=6914714 } |
| ::{ flag=BR }:: | **Brazil** | **::SillyFangirl::{ user=2288363 }**, [LothusFangirl](https://osu.ppy.sh/users/4685756), ::Makiba::{ user=7539957 }, [corninho](https://osu.ppy.sh/users/6507627) |
| ::{ flag=CA }:: | **Canada** | **::LelPop::{ user=10242770 }**, [ItsRewindTime](https://osu.ppy.sh/users/13622614), ::NunotabaShinobu::{ user=10809497 }, [UmmmMrMoo](https://osu.ppy.sh/users/15314355) |
| ::{ flag=CL }:: | **Chile** | **::Matiias::{ user=3215366 }**, [faz\_cL](https://osu.ppy.sh/users/7853143), ::Gonzaalooo::{ user=1948903 }, [Skalim](https://osu.ppy.sh/users/2225008) |
| ::{ flag=CN }:: | **China** | **::LiangIaiajan::{ user=5144698 }**, [\[Crz\]Satori](https://osu.ppy.sh/users/7082178), ::tyrcs::{ user=13026904 }, [yuwenhao1](https://osu.ppy.sh/users/14318312) |
| ::{ flag=CO }:: | **Colombia** | **::xNett::{ user=4998501 }**, [Hakure](https://osu.ppy.sh/users/5597043), ::Temoote::{ user=10326318 }, [ag0](https://osu.ppy.sh/users/17989209) |
| ::{ flag=DK }:: | **Denmark** | **::Optane::{ user=7871427 }**, [Stoom](https://osu.ppy.sh/users/13572493) |
| ::{ flag=EE }:: | **Estonia** | **::hisaella::{ user=9557847 }**, [Arcaxio](https://osu.ppy.sh/users/16819909), ::Exlude::{ user=14137067 } |
| ::{ flag=FR }:: | **France** | **::Elementaires::{ user=2284328 }**, [AntoAa](https://osu.ppy.sh/users/3897919), ::Gray Hardrock::{ user=9049282 }, [CharlisMadCut](https://osu.ppy.sh/users/2863607) |
| ::{ flag=DE }:: | **Germany** | **::IceDynamix::{ user=8599070 }**, [TsukiyaWhiskers](https://osu.ppy.sh/users/12598261), ::Tyrfing61::{ user=7437049 }, [ElectroYan](https://osu.ppy.sh/users/3357640) |
| ::{ flag=HU }:: | **Hungary** | **::FR4-::{ user=10539285 }**, [kacsa14](https://osu.ppy.sh/users/17385733) |
| ::{ flag=IN }:: | **India** | **::Xyphoes::{ user=12178324 }**, [MrMaharaj](https://osu.ppy.sh/users/18364256) |
| ::{ flag=ID }:: | **Indonesia** | **::Yanamon::{ user=2655836 }**, [Onta\_Bekasi](https://osu.ppy.sh/users/8677684), ::reyss::{ user=4557440 }, [Exyph](https://osu.ppy.sh/users/10364342) |
| ::{ flag=JP }:: | **Japan** | **::Lenxis\_::{ user=10133496 }**, [Suzuha\_l](https://osu.ppy.sh/users/6132697), ::My Angel Koishi::{ user=8273098 }, [LuluM](https://osu.ppy.sh/users/13151924) |
| ::{ flag=MO }:: | **Macau** | **::idqoos123::{ user=3946113 }**, [capchon](https://osu.ppy.sh/users/8566617) |
| ::{ flag=MY }:: | **Malaysia** | **::cheewee10::{ user=4477497 }**, [Neokje](https://osu.ppy.sh/users/7727987), ::Enie::{ user=11976455 }, [ZYuan](https://osu.ppy.sh/users/3337688) |
| ::{ flag=NL }:: | **Netherlands** | **::Freek::{ user=9630674 }**, [DravenXTaric](https://osu.ppy.sh/users/11999500), ::LokSG::{ user=14516576 }, [Tyronix](https://osu.ppy.sh/users/11290311) |
| ::{ flag=NZ }:: | **New Zealand** | **::Worms::{ user=1963937 }**, [Sparxe](https://osu.ppy.sh/users/5750235), ::CappK::{ user=16837177 } |
| ::{ flag=NO }:: | **Norway** | **::masaya::{ user=5818319 }**, [-TeaBee-](https://osu.ppy.sh/users/12304069), ::\[RS\] F4st::{ user=7676585 }, [Endroma](https://osu.ppy.sh/users/10340462) |
| ::{ flag=PE }:: | **Peru** | **::Julio1212-::{ user=2208895 }**, [Byron159](https://osu.ppy.sh/users/8639180) |
| ::{ flag=PH }:: | **Philippines** | **::- Kura -::{ user=11420405 }**, [\[Crz\]joseee-](https://osu.ppy.sh/users/10083439), ::LackPoints::{ user=8748664 }, [Sanni](https://osu.ppy.sh/users/3036686) |
| ::{ flag=PL }:: | **Poland** | **::SitekX::{ user=3840946 }**, [Hudonom](https://osu.ppy.sh/users/1654221), ::Yamakazi::{ user=4726691 }, [Eclipse-](https://osu.ppy.sh/users/8493070) |
| ::{ flag=PT }:: | **Portugal** | **::Rodrig0v::{ user=138866 }**, [CurlMike](https://osu.ppy.sh/users/7968696), ::JAHDONG::{ user=11445021 }, [Rosa](https://osu.ppy.sh/users/7385703) |
| ::{ flag=RO }:: | **Romania** | **::robby250::{ user=2653437 }**, [AlexPlayz OSU](https://osu.ppy.sh/users/18341280), ::fakebrin::{ user=8185118 } |
| ::{ flag=RU }:: | **Russian Federation** | **::Mage::{ user=5527957 }**, [Legend27](https://osu.ppy.sh/users/6283029), ::karayss::{ user=7156634 }, [Illumnus](https://osu.ppy.sh/users/9504954) |
| ::{ flag=SG }:: | **Singapore** | **::DarryllV::{ user=11759693 }**, [awdse22](https://osu.ppy.sh/users/8743513), ::ByeForNow::{ user=7199159 }, [Paralit](https://osu.ppy.sh/users/876528) |
| ::{ flag=KR }:: | **South Korea** | **::Estonians::{ user=7014697 }**, [yz1155](https://osu.ppy.sh/users/2071008), ::dressurf::{ user=758406 }, [0133](https://osu.ppy.sh/users/12346181) |
| ::{ flag=ES }:: | **Spain** | **::aitor98::{ user=3154852 }**, [CrewK fanboy](https://osu.ppy.sh/users/7860283), ::Notpx-::{ user=8519296 }, [Quenlla](https://osu.ppy.sh/users/4725379) |
| ::{ flag=SE }:: | **Sweden** | **::Sadcat::{ user=4123399 }**, [Craty](https://osu.ppy.sh/users/3918056), ::Vortex-::{ user=4999669 } |
| ::{ flag=CH }:: | **Switzerland** | **::Akayro::{ user=2573716 }**, [Gamer97](https://osu.ppy.sh/users/4952941) |
| ::{ flag=TW }:: | **Taiwan** | **::\[ Snow Rabbit \]::{ user=1833280 }**, [\[Crz\]FolAH1217](https://osu.ppy.sh/users/6232458), ::hero\_jeff::{ user=3375226 }, [IllIlllIIlIIlIl](https://osu.ppy.sh/users/7227070) |
| ::{ flag=TH }:: | **Thailand** | **::LostCool::{ user=766374 }**, [Myzki](https://osu.ppy.sh/users/3221985), ::harlemshake555::{ user=7355319 }, [PanicP](https://osu.ppy.sh/users/561493) |
| ::{ flag=GB }:: | **United Kingdom** | **::Vygatron::{ user=3628783 }**, [username1947](https://osu.ppy.sh/users/16162078), ::Lelloq::{ user=8610776 }, [aid\_](https://osu.ppy.sh/users/12808079) |
| ::{ flag=US }:: | **United States** | **::Alter-::{ user=4980256 }**, [Terni](https://osu.ppy.sh/users/3279570), ::\[GS\]Teo::{ user=7081478 }, [RevVoJH](https://osu.ppy.sh/users/7286896) |
