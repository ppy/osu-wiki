...
The **Hidden Only Tournament** (***HOT***) was a worldwide double-elimination 2v2 osu! tournament hosted by ::{ flag=TR }:: ::112servis::{ user-id=3953470 }, ::{ flag=CN }:: ::real MikeL::{ user-id=10732897 }, and ::{ flag=TH }:: ::Seaweed::{ user-id=5151214 }. Tournament where maps were played under Hidden and Hidden/DoubleTime mods only. This was the first instalment of the Hidden Only Tournament.
...
| Position | Member(s) |
| :-- | :-- |
| Organizer | ::{ flag=TR }:: ::112servis::{ user-id=3953470 }, ::{ flag=CN }:: ::real MikeL::{ user-id=10732897 }, ::{ flag=TH }:: ::Seaweed::{ user-id=5151214 } |
| Mappool selector | ::{ flag=CA }:: ::dqwed::{ user-id=9977100 }, ::{ flag=AU }:: ::Gala::{ user-id=3385634 }, ::{ flag=FR }:: ::Kaeldori::{ user-id=962519 }, ::{ flag=CN }:: ::real MikeL::{ user-id=10732897 }, ::{ flag=TH }:: ::Seaweed::{ user-id=5151214 } |
| Referee | ::{ flag=BR }:: ::DizzyH::{ user-id=9896172 }, ::{ flag=AU }:: ::Gala::{ user-id=3385634 }, ::{ flag=DE }:: ::GDLenny::{ user-id=8406711 }, ::{ flag=VN }:: ::Hoaq::{ user-id=7696512 }, ::{ flag=AU }:: ::ill onion::{ user-id=8306102 }, ::{ flag=US }:: ::moss-::{ user-id=9918921 }, ::{ flag=DE }:: ::real cute::{ user-id=9172811 }, ::{ flag=US }:: ::Pristine Toast::{ user-id=12324616 }, ::{ flag=CA }:: ::shineasone::{ user-id=6203507 }, ::{ flag=US }:: ::Suicune3::{ user-id=6895187 }, ::{ flag=DE }:: ::TheHunter1::{ user-id=6496016 }, ::{ flag=US }:: ::travis\1ba::{ user-id=10822220 }, ::{ flag=GB }:: ::Yazzehh::{ user-id=7068973 } |
| Streamer | ::{ flag=CA }:: ::Clarkyclarker::{ user-id=11664411 }, ::{ flag=CA }:: ::Takiaz::{ user-id=11177233 } |
| Commentator | ::{ flag=US }:: ::Suicune3::{ user-id=6895187 }, ::{ flag=AR }:: ::Vaf::{ user-id=12589048 } |
| Designer | ::{ flag=NL }:: ::Mirai Subject::{ user-id=5639709 } |
| Statistician | ::{ flag=TR }:: ::112servis::{ user-id=3953470 } |
...
| Team | Members |
| :-- | :-- |
| **:rooGya:** | ::{ flag=US }:: **::Akamatsu::{ user-id=8607968 }**, ::{ flag=US }:: ::Leotic::{ user-id=4263943 }, ::{ flag=US }:: ::vekt0r::{ user-id=8484892 }, ::{ flag=CA }:: ::ktgster::{ user-id=53378 } |
| **3山刪白狼** | ::{ flag=TW }:: **::EthanTC::{ user-id=9539163 }**, ::{ flag=TW }:: ::hakuna desu::{ user-id=7633130 }, ::{ flag=TW }:: ::9ami::{ user-id=1499997 }, ::{ flag=TW }:: ::Sakurai-Momoka::{ user-id=8165722 } |
| **akinari** | ::{ flag=IT }:: **::uwujulio::{ user-id=11409111 }**, ::{ flag=IT }:: ::Massimo99::{ user-id=3516728 }, ::{ flag=IT }:: ::SIMONETRAPANI::{ user-id=7329177 }, ::{ flag=IT }:: ::Akinari::{ user-id=4001304 } |
| **ar7** | ::{ flag=US }:: **::suraimu::{ user-id=11776859 }**, ::{ flag=GB }:: ::\_joe::{ user-id=11042418 }, ::{ flag=US }:: ::Boolin::{ user-id=10664409 }, ::{ flag=AR }:: ::xci::{ user-id=8822528 } |
| **ASSCRAXS** | ::{ flag=FI }:: **::HENKSELI::{ user-id=7005392 }**, ::{ flag=FI }:: ::Kyttis::{ user-id=5266023 }, ::{ flag=FI }:: ::Roba::{ user-id=5210561 }, ::{ flag=FI }:: ::-Cento::{ user-id=2565831 } |
| **bojowa wiertarka** | ::{ flag=GB }:: **::Aistre::{ user-id=4879380 }**, ::{ flag=PL }:: ::Antares-::{ user-id=2194763 }, ::{ flag=PL }:: ::browiec::{ user-id=9426712 }, ::{ flag=GR }:: ::JackPaX::{ user-id=11226645 } |
| **butterfly** | ::{ flag=TH }:: **::Deppyforce::{ user-id=5286213 }**, ::{ flag=TH }:: ::Applause::{ user-id=1832711 }, ::{ flag=CO }:: ::Schwarze::{ user-id=6575153 }, ::{ flag=PL }:: ::-yeXa-::{ user-id=10344658 } |
| **can't read HD** | ::{ flag=FR }:: **::\[Trislot\]::{ user-id=10524079 }**, ::{ flag=CH }:: ::Nemesis1925::{ user-id=10394866 }, ::{ flag=CH }:: ::Sil::{ user-id=7924600 }, ::{ flag=CH }:: ::McKensy::{ user-id=4025457 } |
| **Carlos** | ::{ flag=CA }:: **::mits::{ user-id=6256255 }**, ::{ flag=US }:: ::freedomdiver::{ user-id=8482062 }, ::{ flag=CA }:: ::Vararaup::{ user-id=8257675 }, ::{ flag=US }:: ::Thorfaen::{ user-id=12272964 } |
| **C-O-C-A-I-N-E** | ::{ flag=SE }:: **::Nitroz::{ user-id=5256529 }**, ::{ flag=US }:: ::-Tynamo::{ user-id=3638962 }, ::{ flag=US }:: ::vikala::{ user-id=2848604 }, ::{ flag=BR }:: ::Polaco::{ user-id=1057782 } |
| **colegas 1** | ::{ flag=BR }:: **::Take no Hana::{ user-id=3628613 }**, ::{ flag=BR }:: ::Little Sister::{ user-id=4135257 }, ::{ flag=BR }:: ::Tell::{ user-id=2125109 }, ::{ flag=BR }:: ::NEURONIO::{ user-id=7198334 } |
| **comet** | ::{ flag=PE }:: **::Hoshinomori::{ user-id=4112621 }**, ::{ flag=BR }:: ::Dada::{ user-id=9119507 }, ::{ flag=UY }:: ::-Ritsumi-::{ user-id=5218320 }, ::{ flag=PL }:: ::GunOfGaming::{ user-id=5522259 } |
| **cringe mod** | ::{ flag=US }:: **::The Lewd Loli::{ user-id=11010369 }**, ::{ flag=CA }:: ::Sepid::{ user-id=12032130 }, ::{ flag=CA }:: ::Arav::{ user-id=9843825 }, ::{ flag=CA }:: ::XepiccatX::{ user-id=8891102 } |
| **Eat 'Em Up** | ::{ flag=DE }:: **::LwL::{ user-id=3556856 }**, ::{ flag=DE }:: ::papika::{ user-id=7093373 }, ::{ flag=FR }:: ::Lexonox::{ user-id=7640581 }, ::{ flag=JP }:: ::Valtz::{ user-id=5911299 } |
| **HD Heroes** | ::{ flag=US }:: **::Kahli::{ user-id=8926244 }**, ::{ flag=FI }:: ::shdewz::{ user-id=10000899 }, ::{ flag=US }:: ::fooders::{ user-id=7545218 }, ::{ flag=CL }:: ::ign::{ user-id=9360528 } |
| **HR Main** | ::{ flag=ID }:: **::Walfrid::{ user-id=6600809 }**, ::{ flag=ID }:: ::Fuma::{ user-id=1501956 }, ::{ flag=SG }:: ::Rtzer0::{ user-id=5407620 }, ::{ flag=BR }:: ::est::{ user-id=12668724 } |
| **i hate osu** | ::{ flag=US }:: **::minitaz64::{ user-id=9360417 }**, ::{ flag=CA }:: ::XenoPenguino::{ user-id=12045254 }, ::{ flag=US }:: ::i hate osu::{ user-id=11915154 } |
| **Kärpät Oulu** | ::{ flag=FI }:: **::Ataraksia::{ user-id=7503114 }**, ::{ flag=SK }:: ::Hranolka::{ user-id=6149947 }, ::{ flag=CZ }:: ::-Soni-::{ user-id=7577835 } |
| **Koppepan Gaming** | ::{ flag=SE }:: **::MRL::{ user-id=8309500 }**, ::{ flag=JP }:: ::\_tottoko\_::{ user-id=8354698 }, ::{ flag=JP }:: ::Koppe::{ user-id=6744452 }, ::{ flag=JP }:: ::deit::{ user-id=11969374 } |
| **loading...** | ::{ flag=CA }:: **::noncycle::{ user-id=12701607 }**, ::{ flag=CA }:: ::Kifo::{ user-id=8514740 }, ::{ flag=BY }:: ::Razelyn::{ user-id=9390208 } |
| **macachi pec** | ::{ flag=MX }:: **::Atsuro::{ user-id=2279351 }**, ::{ flag=MX }:: ::Flameshock::{ user-id=8349047 }, ::{ flag=MX }:: ::Viva Viva Happy::{ user-id=4269282 } |
| **newton is gey** | ::{ flag=PH }:: **::xidorn::{ user-id=7904667 }**, ::{ flag=MY }:: ::Sei Shaneagon::{ user-id=3677251 }, ::{ flag=ID }:: ::F4UZ4N::{ user-id=11070577 }, ::{ flag=PH }:: ::newton-::{ user-id=5875419 } |
| **nothing to hide** | ::{ flag=AU }:: **::loveleft::{ user-id=9240047 }**, ::{ flag=KR }:: ::Atipir::{ user-id=8991722 }, ::{ flag=AU }:: ::Kavash::{ user-id=3096297 }, ::{ flag=NO }:: ::Naigo::{ user-id=10640486 } |
| **Omero Kamalio** | ::{ flag=IT }:: **::Yumikuta::{ user-id=5193961 }**, ::{ flag=IT }:: ::Kiirochii::{ user-id=6387149 }, ::{ flag=SM }:: ::Arge::{ user-id=11215030 } |
| **osuplayer111** | ::{ flag=SG }:: **::phox::{ user-id=772295 }**, ::{ flag=SG }:: ::moosepi::{ user-id=1868745 }, ::{ flag=SG }:: ::DVDthe1st::{ user-id=2138989 }, ::{ flag=CA }:: ::Rijrya::{ user-id=11186709 } |
| **Phrygian Friends** | ::{ flag=US }:: **::Will Stetson::{ user-id=4909088 }**, ::{ flag=US }:: ::Vertarix::{ user-id=7315668 }, ::{ flag=US }:: ::ruyunata::{ user-id=8880920 }, ::{ flag=US }:: ::Leftoverss::{ user-id=4665746 } |
| **Pocket Galaxy** | ::{ flag=US }:: **::M I L E S::{ user-id=6036351 }**, ::{ flag=GB }:: ::Malteser::{ user-id=5218178 }, ::{ flag=BE }:: ::5joshi::{ user-id=4279650 }, ::{ flag=FR }:: ::VROUM CV VITE::{ user-id=7630971 } |
| **ramon's nipples** | ::{ flag=US }:: **::Tuco::{ user-id=11706350 }**, ::{ flag=US }:: ::YoshiLover456::{ user-id=6843383 }, ::{ flag=DE }:: ::mp4::{ user-id=8401905 }, ::{ flag=GB }:: ::RndGuy::{ user-id=1201586 } |
| **RSRPlayers** | ::{ flag=MX }:: **::-Euphxrya::{ user-id=11355499 }**, ::{ flag=DE }:: ::\[Ryyuu\]::{ user-id=8647044 }, ::{ flag=PE }:: ::P r a h::{ user-id=10509043 }, ::{ flag=MX }:: ::Siros::{ user-id=3787685 } |
| **sawada's team** | ::{ flag=GB }:: **::Chemistry::{ user-id=6069540 }**, ::{ flag=FR }:: ::Sukiye::{ user-id=3674590 }, ::{ flag=US }:: ::payney::{ user-id=11237996 }, ::{ flag=CA }:: ::mahloola::{ user-id=8759374 } |
| **Saxophone Bug** | ::{ flag=AR }:: **::Penguo::{ user-id=4389490 }**, ::{ flag=AR }:: ::Cata::{ user-id=5958063 }, ::{ flag=AR }:: ::Shig::{ user-id=6117281 }, ::{ flag=AR }:: ::-Kao-::{ user-id=7807935 } |
| **Stafferino** | ::{ flag=US }:: **::Dios Dong::{ user-id=3958619 }**, ::{ flag=US }:: ::ChillierPear::{ user-id=9501251 }, ::{ flag=US }:: ::LolForest::{ user-id=1429071 }, ::{ flag=GB }:: ::AlexDark69::{ user-id=5146647 } |
| **sut\_gasm** | ::{ flag=GB }:: **::FuzzyL::{ user-id=12925539 }**, ::{ flag=GB }:: ::Hoshik::{ user-id=10822769 }, ::{ flag=US }:: ::Da Hyun::{ user-id=12541049 }, ::{ flag=GB }:: ::Venoxia::{ user-id=7333471 } |
| **sut\_son nose** | ::{ flag=GB }:: **::Sobriquet::{ user-id=3891023 }**, ::{ flag=GB }:: ::Shachi::{ user-id=6546933 }, ::{ flag=GB }:: ::DanZqa::{ user-id=4572097 }, ::{ flag=GB }:: ::Gazza::{ user-id=3648459 } |
| **what** | ::{ flag=SG }:: **::Heresy::{ user-id=8876938 }**, ::{ flag=SG }:: ::\_gt::{ user-id=8301957 }, ::{ flag=ID }:: ::Takaichi::{ user-id=909745 }, ::{ flag=SG }:: ::Hecatia::{ user-id=8244635 } |
| **잉여여신** | ::{ flag=US }:: **::Kamayami::{ user-id=13380270 }**, ::{ flag=US }:: ::Tennoji Rina::{ user-id=7661503 }, ::{ flag=CA }:: ::edouard48::{ user-id=10199258 } |
...
| Placing | Team |
| :-: | :-- |
| ![Gold crown](/wiki/shared/crown-gold.png "1st place") | **:rooGya:** (::{ flag=US }:: ::Akamatsu::{ user-id=8607968 }, ::{ flag=US }:: ::Leotic::{ user-id=4263943 }, ::{ flag=US }:: ::vekt0r::{ user-id=8484892 }, ::{ flag=CA }:: ::ktgster::{ user-id=53378 }) |
| ![Silver crown](/wiki/shared/crown-silver.png "2nd place") | **Pocket Galaxy** (::{ flag=US }:: ::M I L E S::{ user-id=6036351 }, ::{ flag=GB }:: ::Malteser::{ user-id=5218178 }, ::{ flag=BE }:: ::5joshi::{ user-id=4279650 }, ::{ flag=FR }:: ::VROUM CV VITE::{ user-id=7630971 }) |
| ![Bronze crown](/wiki/shared/crown-bronze.png "3rd place") | **Phrygian Friends** (::{ flag=US }:: ::Will Stetson::{ user-id=4909088 }, ::{ flag=US }:: ::Vertarix::{ user-id=7315668 }, ::{ flag=US }:: ::ruyunata::{ user-id=8880920 }, ::{ flag=US }:: ::Leftoverss::{ user-id=4665746 }) |
