...
The **Touhou Project Mania Cup 2nd** (***TMC 2nd***) was a team-based 2v2 osu!mania 4K tournament hosted by ::{ flag=CN }:: ::\[GB\]Sanae::{ user-id=11238501 }. The main theme of this tournament the Touhou Project. Unlike the previous year, the pool used for TMC 2nd is 100% based on original and fan-made Touhou music. It is the second instalment of the Touhou Project Mania Cup.
...
| Co-host | ::{ flag=GB }:: ::-Deepdive-::{ user-id=13338645 }, ::{ flag=CN }:: ::cdwcgt::{ user-id=14721101 } |
| Mappool selector | ::{ flag=GB }:: ::-Deepdive-::{ user-id=13338645 }, ::{ flag=CN }:: ::\[Crz\]hinako1804::{ user-id=13747903 }, ::{ flag=MX }:: ::\[OSC\]Amagai::{ user-id=9658070 }, ::{ flag=ID }:: ::eZmmR::{ user-id=8647138 }, ::{ flag=GB }:: ::H1Pur::{ user-id=15756120 }, ::{ flag=CN }:: ::\[GB\]Sanae::{ user-id=11238501 }, ::{ flag=CN }:: ::YuEast 2018::{ user-id=13953619 } |
| Mappool tester | ::{ flag=CN }:: ::\[GB\]Mafufu::{ user-id=10884561 }, ::{ flag=GB }:: ::Eliminate::{ user-id=9169747 }, ::{ flag=GB }:: ::H1Pur::{ user-id=15756120 }, ::{ flag=SG }:: ::Kings::{ user-id=1016926 } |
| Custom mapper | ::{ flag=GB }:: ::-Deepdive-::{ user-id=13338645 }, ::{ flag=CN }:: ::\[Crz\]hinako1804::{ user-id=13747903 }, ::{ flag=CN }:: ::\[GB\]Mafufu::{ user-id=10884561 }, ::{ flag=MX }:: ::\[OSC\]Amagai::{ user-id=9658070 }, ::{ flag=CN }:: ::Blue\1Potion::{ user-id=13094831 }, ::{ flag=CN }:: ::cherrychou::{ user-id=7214023 }, ::{ flag=ID }:: ::eZmmR::{ user-id=8647138 }, ::{ flag=GB }:: ::H1Pur::{ user-id=15756120 }, ::{ flag=CN }:: ::\[GB\]Sanae::{ user-id=11238501 }, ::{ flag=CN }:: ::Miscedence::{ user-id=15382838 }, ::{ flag=CN }:: ::YuEast 2018::{ user-id=13953619 }, ::{ flag=HK }:: ::zero2snow::{ user-id=7751516 } |
| Showcaser | ::{ flag=GB }:: ::-Deepdive-::{ user-id=13338645 }, ::{ flag=TW }:: ::\[Crz\]Ha0201::{ user-id=12243730 }, ::{ flag=CN }:: ::\[GB\]AelSan::{ user-id=14095291 }, ::{ flag=CN }:: ::\[GB\]Mafufu::{ user-id=10884561 }, ::{ flag=CN }:: ::\[GB\]Thaumiel::{ user-id=15017771 }, ::{ flag=GB }:: ::Eliminate::{ user-id=9169747 }, ::{ flag=GB }:: ::H1Pur::{ user-id=15756120 }, ::{ flag=HK }:: ::zero2snow::{ user-id=7751516 } |
| Referee | ::{ flag=GB }:: ::-Deepdive-::{ user-id=13338645 }, ::{ flag=CN }:: ::\[GB\]Mafufu::{ user-id=10884561 }, ::{ flag=CN }:: ::cdwcgt::{ user-id=14721101 }, ::{ flag=GB }:: ::H1Pur::{ user-id=15756120 }, ::{ flag=CN }:: ::\[GB\]Sanae::{ user-id=11238501 }, ::{ flag=BR }:: ::Konohana Lucia::{ user-id=8642224 }, ::{ flag=ID }:: ::SanjayaIH::{ user-id=12202728 }, ::{ flag=DE }:: ::TheHunter1::{ user-id=6496016 }, ::{ flag=ID }:: ::Yukari\_Sama::{ user-id=6316524 } |
| Streamer | ::{ flag=GB }:: ::-Deepdive-::{ user-id=13338645 }, ::{ flag=PH }:: ::\[KN\]Tenshi::{ user-id=18520056 }, ::{ flag=CN }:: ::aiyulu::{ user-id=189617 }, ::{ flag=PL }:: ::Bexi::{ user-id=11548612 }, ::{ flag=CN }:: ::cdwcgt::{ user-id=14721101 }, ::{ flag=US }:: ::Doelon::{ user-id=17422924 }, ::{ flag=US }:: ::SunApple::{ user-id=11817622 } |
| Commentator | ::{ flag=GB }:: ::-Deepdive-::{ user-id=13338645 }, ::{ flag=US }:: ::-Sparky-::{ user-id=3187959 }, ::{ flag=CN }:: ::\[GB\]yobrevelc::{ user-id=14128407 }, ::{ flag=PH }:: ::\[KN\]Tenshi::{ user-id=18520056 }, ::{ flag=KR }:: ::\[LS\] Rollpan::{ user-id=19584910 },  ::{ flag=US }:: ::Dynascape::{ user-id=8784587 }, ::{ flag=GB }:: ::H1Pur::{ user-id=15756120 }, ::{ flag=SG }:: ::Kings::{ user-id=1016926 }, ::{ flag=VN }:: ::MashedPotato::{ user-id=10494860 }, ::{ flag=US }:: ::PorkIsGreat::{ user-id=10756322 }，::{ flag=PH }:: ::Silhoueska Elze::{ user-id=11517895 }, ::{ flag=US }:: ::SunApple::{ user-id=11817622 }, ::{ flag=GB }:: ::TingMomentum::{ user-id=12489832 }, ::{ flag=BH }:: ::Unitori-::{ user-id=15772814 } |
| Statistician | ::{ flag=VN }:: ::MashedPotato::{ user-id=10494860 } |
| Banner designer | ::{ flag=HK }:: ::Chaoslitz::{ user-id=3621552 } |
| Storyboarder | ::{ flag=CN }:: ::\[RT\]Alleyne::{ user-id=11279273 }, ::{ flag=CN }:: ::aiyulu::{ user-id=189617 } |
| Community contributor | ::{ flag=CN }:: ::\[RT\]Alleyne::{ user-id=11279273 }, ::{ flag=CA }:: ::Nezu-::{ user-id=21963245 } |
| Wiki editor | ::{ flag=CN }:: ::cdwcgt::{ user-id=14721101 }, ::{ flag=CN }:: ::Rush\_FTK::{ user-id=3046856 } |
...
| Team | Members |
| :-: | :-- |
| **:1217angry:** | ::{ flag=TW }:: **::Pdog4ni::{ user-id=14581544 }**, ::{ flag=MY }:: ::Auxesiaa::{ user-id=16417718 }, ::{ flag=TW }:: ::\[Rweiru\]::{ user-id=11234907 }, ::{ flag=TW }:: ::blacktea12::{ user-id=13389861 } |
| **Komeiji Sisters** | ::{ flag=NL }:: **::LuluChanTV::{ user-id=10192760 }**, ::{ flag=NO }:: ::-TeaBee-::{ user-id=12304069 } |
| **Chrome Beretta** | ::{ flag=TW }:: **::Nobu150::{ user-id=12296460 }**, ::{ flag=PH }:: ::Samu\12211::{ user-id=20689466 }, ::{ flag=PH }:: ::Voidkun::{ user-id=19808091 } |
| **ICHIGAY!!!** | ::{ flag=MY }:: **::\[Break\]LCJQ::{ user-id=11283859 }**, ::{ flag=TW }:: ::\[-ICHINO-\]::{ user-id=13643601 }, ::{ flag=MY }:: ::StyGix::{ user-id=7745408 }, ::{ flag=TH }:: ::palmEuEi::{ user-id=13656264 } |
| **ATKR** | ::{ flag=ID }:: **::Lumierce::{ user-id=16706212 }**, ::{ flag=ID }:: ::NikanzuGZ::{ user-id=16198858 }, ::{ flag=ID }:: ::VeganFanBoy::{ user-id=16768803 } |
| **Œil** | ::{ flag=FR }:: **::Auraah::{ user-id=10015908 }**, ::{ flag=FR }:: ::Elementaires::{ user-id=2284328 }, ::{ flag=FR }:: ::Koiidex::{ user-id=5193488 }, ::{ flag=FR }:: ::ZayyKen::{ user-id=8624433 } |
| **Junimo** | ::{ flag=US }:: **::GripWarrior::{ user-id=11734610 }**, ::{ flag=US }:: ::Iylwrychi::{ user-id=7794488 }, ::{ flag=US }:: ::mashu::{ user-id=12028216 }, ::{ flag=US }:: ::\[GS\]Diamond::{ user-id=13076648 } |
| **offbrand mwc** | ::{ flag=PH }:: **::Silhoueska Elze::{ user-id=11517895 }**, ::{ flag=US }:: ::ok bye::{ user-id=15063813 }, ::{ flag=PH }:: ::- O R E O::{ user-id=17802217 } |
| **qgmodfanclub** | ::{ flag=CH }:: **::Tubey::{ user-id=16790509 }**, ::{ flag=HK }:: ::Larksymoo::{ user-id=19593133 }, ::{ flag=MY }:: ::Hong727::{ user-id=15194755 } |
| **TheAnswerIsPorn** | ::{ flag=US }:: **::SunApple::{ user-id=11817622 }**, ::{ flag=US }:: ::RhymesWithMash::{ user-id=18834550 }, ::{ flag=US }:: ::Orca-::{ user-id=7958845 }, ::{ flag=US }:: ::\[LS\]Fox::{ user-id=15270411 } |
| **bru.** | ::{ flag=VN }:: **::Lott::{ user-id=13821222 }**, ::{ flag=PL }:: ::Likieras::{ user-id=17548825 }, ::{ flag=TH }:: ::Trushi::{ user-id=19629933 }, ::{ flag=PH }:: ::XxSmuckxX::{ user-id=15748558 } |
| **Knation** | ::{ flag=PH }:: **::4Kenn::{ user-id=20496815 }**, ::{ flag=PH }:: ::Axfaerie::{ user-id=13857689 }, ::{ flag=PH }:: ::TheMysteryL::{ user-id=14113974 }, ::{ flag=PH }:: ::betanrobot::{ user-id=16021427 } |
| **badplayers49** | ::{ flag=SG }:: **::Roxybuff::{ user-id=11917711 }**, ::{ flag=SG }:: ::ecfecfehycbey::{ user-id=15323784 }, ::{ flag=SG }:: ::Eliminate 2::{ user-id=12297375 } |
| **ExtraRipeApples** | ::{ flag=DE }:: **::ERA Punish::{ user-id=10615367 }**, ::{ flag=DE }:: ::ERA medium kek::{ user-id=11625617 }, ::{ flag=US }:: ::ERA Zenith::{ user-id=7128063 }, ::{ flag=US }:: ::ERA Klarion::{ user-id=13857986 } |
| **monkey bussines** | ::{ flag=NL }:: **::Shoira::{ user-id=13377652 }**, ::{ flag=NL }:: ::Freek::{ user-id=9630674 }, ::{ flag=NL }:: ::samuelhklumpers::{ user-id=10945523 }, ::{ flag=NL }:: ::Ready Perfectly::{ user-id=10944966 } |
| **FNF Club Germany** | ::{ flag=DE }:: **::d3lt3x::{ user-id=14283669 }**, ::{ flag=DE }:: ::Sazkey::{ user-id=10039087 }, ::{ flag=DE }:: ::Der\1Entsafter69::{ user-id=13210231 }, ::{ flag=DE }:: ::-SparklingCat-::{ user-id=15440118 } |
| **I MUST SESE** | ::{ flag=CN }:: **::Rizazyh::{ user-id=13673300 }**, ::{ flag=CN }:: ::Black Aurora::{ user-id=17861631 }, ::{ flag=CN }:: ::hitohad::{ user-id=13651980 }, ::{ flag=CN }:: ::\[GB\]Foxy1459::{ user-id=14938400 } |
| **Polygon** | ::{ flag=JP }:: **::yuukituk::{ user-id=11998955 }**, ::{ flag=TH }:: ::Achino::{ user-id=13349388 } |
| **Fumo** | ::{ flag=MY }:: **::-Einar-::{ user-id=8782656 }**, ::{ flag=PH }:: ::Akatsumi Chan::{ user-id=11306351 }, ::{ flag=MY }:: ::Ju1nY11::{ user-id=14743871 }, ::{ flag=CN }:: ::WLYMinato::{ user-id=12703319 } |
| **Appendicitis** | ::{ flag=BR }:: **::DemiFiendSMT::{ user-id=20051971 }**, ::{ flag=BR }:: ::LeMarcinho::{ user-id=13347579 }, ::{ flag=VN }:: ::Tuyet::{ user-id=14821320 }, ::{ flag=BR }:: ::Sprrumnk Lokii::{ user-id=10622472 } |
| **Ricemakers** | ::{ flag=ID }:: **::I\1cantplay::{ user-id=18309106 }**, ::{ flag=ID }:: ::\[Albert\]::{ user-id=12689667 }, ::{ flag=ID }:: ::IceVee::{ user-id=8108213 }, ::{ flag=ID }:: ::Dogethedoge25::{ user-id=15597315 } |
| **omsim** | ::{ flag=PH }:: **::\[Crz\]joseee-::{ user-id=10083439 }**, ::{ flag=PH }:: ::Arccat::{ user-id=4848294 }, ::{ flag=PH }:: ::J1002::{ user-id=11958940 }, ::{ flag=PH }:: ::Vulpsi::{ user-id=12584420 } |
| **Black Stick Rot** | ::{ flag=GB }:: **::TingMomentum::{ user-id=12489832 }**, ::{ flag=DE }:: ::nanhira::{ user-id=15806513 }, ::{ flag=PH }:: ::Silicosis::{ user-id=15548876 } |
| **oh10** | ::{ flag=PH }:: **::\[KN\]CuB-03::{ user-id=18560307 }**, ::{ flag=PH }:: ::Dyei::{ user-id=23643731 }, ::{ flag=PH }:: ::Hagorromoo::{ user-id=11923046 }, ::{ flag=PH }:: ::EpicBaconBoi::{ user-id=16391523 } |
| **house deepwoken** | ::{ flag=US }:: **::BaniiYanii::{ user-id=11888159 }**, ::{ flag=US }:: ::\[GS\]Antunder::{ user-id=10416995 }, ::{ flag=US }:: ::SplegoNinjago::{ user-id=13488298 }, ::{ flag=CA }:: ::\[ro\]Nosteal::{ user-id=8160564 } |
| **yes** | ::{ flag=CZ }:: **::grillroasted::{ user-id=18271627 }**, ::{ flag=BR }:: ::Gabi Kamui::{ user-id=10658391 } |
| **Shion Lovers** | ::{ flag=JP }:: **::kazuin::{ user-id=10739680 }**, ::{ flag=US }:: ::walnutt::{ user-id=8617859 }, ::{ flag=US }:: ::\[GS\]Pusheen::{ user-id=10192251 }, ::{ flag=US }:: ::dinga dog::{ user-id=12206447 } |
| **Estudia Sonso** | ::{ flag=PE }:: **::bxd\1juice::{ user-id=17152485 }**, ::{ flag=PE }:: ::-Lalito898::{ user-id=15098503 }, ::{ flag=PE }:: ::no6hope::{ user-id=12193700 } |
| **Hourai Elixir** | ::{ flag=CA }:: **::Stability::{ user-id=6701738 }**, ::{ flag=CA }:: ::GDMem::{ user-id=10804091 }, ::{ flag=CA }:: ::loafusofbread::{ user-id=9278959 }, ::{ flag=CA }:: ::arpia97::{ user-id=6363008 } |
| **TouWhou?** | ::{ flag=CA }:: **::AmariaLove::{ user-id=17036270 }**, ::{ flag=CA }:: ::RaGe Radical::{ user-id=13887380 }, ::{ flag=CA }:: ::Nezukiki::{ user-id=21963245 }, ::{ flag=CA }:: ::walmart5193::{ user-id=16468962 } |
| **holiv reprdution** | ::{ flag=BH }:: **::Unitori-::{ user-id=15772814 }**, ::{ flag=QA }:: ::cyta\_::{ user-id=15444660 }, ::{ flag=ID }:: ::Revv-::{ user-id=12424909 }, ::{ flag=SA }:: ::HeSo71::{ user-id=12556314 } |
| **los uras** | ::{ flag=AR }:: **::aluuu::{ user-id=4585260 }**, ::{ flag=AR }:: ::lxLucasxl::{ user-id=3632846 }, ::{ flag=AR }:: ::C90::{ user-id=13858488 } |
| **Manip as Gaeilge** | ::{ flag=IE }:: **::evanxo::{ user-id=10681173 }**, ::{ flag=IE }:: ::Just FC::{ user-id=14646283 } |
| **sllab amogus** | ::{ flag=HK }:: **::MegMewtwoZ::{ user-id=13235067 }**, ::{ flag=TH }:: ::banan::{ user-id=16011592 }, ::{ flag=VN }:: ::CPT\1Sivelia::{ user-id=12562107 }, ::{ flag=SG }:: ::IJosephI\[GS\]::{ user-id=13353749 } |
| **rice quadruplets** | ::{ flag=US }:: **::\[Crz\]Mitter::{ user-id=14551764 }**, ::{ flag=SG }:: ::Xvenn::{ user-id=13390529 }, ::{ flag=SG }:: ::upr-::{ user-id=14099962 }, ::{ flag=US }:: ::Darkmew2::{ user-id=13921965 } |
| **Watermelon** | ::{ flag=ID }:: **::Fr05tyGD::{ user-id=14230684 }**, ::{ flag=VN }:: ::Micleak::{ user-id=16140674 }, ::{ flag=PH }:: ::DaMeMeThEiFxD::{ user-id=14324153 } |
| **Cirno Fumo** | ::{ flag=MY }:: **::Solify::{ user-id=12054898 }**, ::{ flag=MY }:: ::LouisZpro::{ user-id=6231292 }, ::{ flag=US }:: ::KamaCrimson::{ user-id=6362259 } |
| **CHONGER** | ::{ flag=GB }:: **::jamge::{ user-id=2377299 }**, ::{ flag=US }:: ::amge::{ user-id=5116922 } |
| **Among Sus** | ::{ flag=FR }:: **::LuKxHiro::{ user-id=13363947 }**, ::{ flag=US }:: ::Ant::{ user-id=6725338 } |
| **Why not** | ::{ flag=PH }:: **::Euanofthedead::{ user-id=15676812 }**, ::{ flag=PH }:: ::Giannithegdnoob::{ user-id=15673828 } |
| **Amongus w** | ::{ flag=ID }:: **::NoEL123n::{ user-id=3602232 }**, ::{ flag=ID }:: ::chantomoe::{ user-id=20835843 }, ::{ flag=ID }:: ::Ihram-San::{ user-id=9908055 }, ::{ flag=ID }:: ::KinoJourney::{ user-id=15798093 } |
| **random people yes** | ::{ flag=PH }:: **::theXiMOON12::{ user-id=23541667 }**, ::{ flag=PH }:: ::Redreig::{ user-id=22716609 } |
| **Sierra Leone** | ::{ flag=US }:: **::cygerion::{ user-id=20020441 }**, ::{ flag=US }:: ::EpsilonMaiagare::{ user-id=3855052 }, ::{ flag=US }:: ::AwsumKyl3::{ user-id=9620690 }, ::{ flag=US }:: ::- Sky -::{ user-id=15255368 } |
| **Ordirehv** | ::{ flag=NL }:: **::2fast4you98::{ user-id=5183940 }**, ::{ flag=NL }:: ::Bakuretsue::{ user-id=10960533 }, ::{ flag=NL }:: ::Toxic scent::{ user-id=12599154 }, ::{ flag=CN }:: ::\[Crz\]Caicium::{ user-id=10702235 } |
| **cutecat.jpeg** | ::{ flag=BR }:: **::Sandroca::{ user-id=13221078 }**, ::{ flag=BR }:: ::Joaodapesti::{ user-id=12140623 } |
| **YEP** | ::{ flag=MY }:: **::Kibitz::{ user-id=7418493 }**,  ::{ flag=US }:: ::Dhark::{ user-id=18662422 } |
| **ODV** | ::{ flag=FR }:: **::Langoustins::{ user-id=17194567 }**, ::{ flag=FR }:: ::Celian43::{ user-id=20046970 } |
| **skill issue** | ::{ flag=AR }:: **::astoneworm::{ user-id=23410931 }**, ::{ flag=US }:: ::silicosis et::{ user-id=12253636 } |
| **OibdciHvete** | ::{ flag=PH }:: **::JayAreEee::{ user-id=10852557 }**, ::{ flag=PH }:: ::FiddleMinger::{ user-id=10300115 }, ::{ flag=PH }:: ::Flare\1Drake::{ user-id=11628350 } |
| **sham macro** | ::{ flag=NZ }:: **::kit-::{ user-id=10981171 }**, ::{ flag=AU }:: ::Merami Crab::{ user-id=11523326 }, ::{ flag=AU }:: ::Kites::{ user-id=4922584 } |
| **BEAN TEAM** | ::{ flag=US }:: **::-Sparky-::{ user-id=3187959 }**, ::{ flag=US }:: ::LeftyRighty::{ user-id=2934698 } |
| **Volvo Gaming** | ::{ flag=US }:: **::ERA Jungle::{ user-id=9709652 }**, ::{ flag=US }:: ::swagmember::{ user-id=23005425 }, ::{ flag=CA }:: ::ZeMaB::{ user-id=15633324 } |
| **Mage's Orphans** | ::{ flag=DE }:: **::Yenaek::{ user-id=10967343 }**, ::{ flag=GB }:: ::SinCrone::{ user-id=9426809 } |
| **Assmen** | ::{ flag=BE }:: **::flyerbram002::{ user-id=12725421 }**, ::{ flag=BE }:: ::shaafs::{ user-id=8811695 }, ::{ flag=BE }:: ::Reilyy::{ user-id=6539319 } |
| **Team Pixula** | ::{ flag=CL }:: **::Rhyzt\1cL::{ user-id=10235085 }**, ::{ flag=CL }:: ::Xan-::{ user-id=5919873 }, ::{ flag=CL }:: ::\[GS\]Myuka::{ user-id=10072733 }, ::{ flag=CL }:: ::\[LS\]Choc\1cL::{ user-id=9729501 } |
| **maimai 4ever** | ::{ flag=ID }:: **::dendygaming::{ user-id=8678715 }**, ::{ flag=ID }:: ::aryadevil::{ user-id=5514809 } |
| **mkwii>mk8** | ::{ flag=DE }:: **::Niko\1Plays::{ user-id=9409456 }**, ::{ flag=DE }:: ::Cobraxx::{ user-id=9620182 } |
| **We Luv Alpaca** | ::{ flag=PE }:: **::Sebas1234213::{ user-id=23218007 }**, ::{ flag=PE }:: ::Lya-::{ user-id=23248625 }, ::{ flag=PE }:: ::\[Boywhat\]::{ user-id=17551398 }, ::{ flag=PE }:: ::Bultrax::{ user-id=20854233 } |
| **Trash** | ::{ flag=IE }:: **::MilkWatcher::{ user-id=13794811 }**, ::{ flag=US }:: ::Trontin::{ user-id=17785322 } |
