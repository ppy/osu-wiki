...
The **Touhou Project Mania Cup 3rd** (***THMC 3rd***) was a team-based 2v2 osu!mania 4K tournament hosted by ::{ flag=CN }:: ::\[GB\]Sanae::{ user=11238501 }. The main theme of this tournament was the *Touhou Project*. The pool used for THMC 3rd is 100% based on original and fan-made *Touhou* music. It was the third instalment of the Touhou Project Mania Cup.
...
- [Statistics spreadsheet](https://docs.google.com/spreadsheets/d/1VQzTrKuRg0eo9Y0HoALe7qzyltvbXYoURO9wJGdAZdg/edit?usp=sharing) made by ::PatouZ::{ user=7306522 }

## Participants

| Team | Members |
| :-: | :-- |
| **:1217angry:** | ::{ flag=TW }:: **::blacktea12::{ user=13389861 }**, ::{ flag=TW }:: ::Axium0w0::{ user=16125443 }, ::{ flag=TW }:: ::Pdog4ni::{ user=14581544 } |
| **"undecided"** | ::{ flag=PH }:: **::DaMeMeThEiFxD::{ user=14324153 }**, ::{ flag=SG }:: ::ERA Adam::{ user=12297375 }, ::{ flag=US }:: ::carpal tunnel::{ user=34314648 }, ::{ flag=CL }:: ::nyawaa::{ user=10235085 } |
| **4VKZ** | ::{ flag=RU }:: **::tchyoouschqueey::{ user=6691100 }**, ::{ flag=RU }:: ::HV4::{ user=25913397 }, ::{ flag=RU }:: ::ZugamiRA::{ user=11026954 }, ::{ flag=RU }:: ::Zavodila2121::{ user=26938475 } |
...
| **pepega team reborn** | ::{ flag=ID }:: **::\[ Raiid \]::{ user=20037405 }**, ::{ flag=ID }:: ::\[ Heez \]::{ user=17957861 }, ::{ flag=ID }:: ::MudoffarMubarak::{ user=14880981 } |
| **POHORONNIy Team** | ::{ flag=BY }:: **::GloWer::{ user=15442379 }**, ::{ flag=UA }:: ::Jek1::{ user=11591198 }, ::{ flag=RU }:: ::SonicBMX::{ user=13151959 } |
| **Polygon** | ::{ flag=JP }:: **::yuukituk::{ user=11998955 }**, ::{ flag=TH }:: ::Kanimiko::{ user=17491817 }, ::{ flag=TH }:: ::Phachon::{ user=20179559 }, ::{ flag=TH }:: ::Achino::{ user=13349388 } |
| **Pterodactyl Enthusiasts** | ::{ flag=US }:: **::Tevelkin::{ user=18508394 }**, ::{ flag=US }:: ::dojin::{ user=11828494 } |
| **QUŒCOUBEH** | ::{ flag=FR }:: **::PatouZ::{ user=7306522 }**, ::{ flag=FR }:: ::Auraah::{ user=10015908 }, ::{ flag=FR }:: ::Azubeur::{ user=1594604 }, ::{ flag=FR }:: ::Jeremkyurem::{ user=13431947 } |
| **Real Skill issue** | ::{ flag=TH }:: **::--Pavin--::{ user=12046267 }**, ::{ flag=KZ }:: ::revokeww::{ user=18267981 }, ::{ flag=GB }:: ::XxNewson1234xX::{ user=9895650 } |
| **Really Rubbish Mania Team** | ::{ flag=US }:: **::BottleXYZ::{ user=31774568 }**, ::{ flag=US }:: ::Destroyer5796::{ user=17628338 }, ::{ flag=PH }:: ::trappy::{ user=19481261 }, ::{ flag=US }:: ::looig::{ user=20869640 } |
...
| **Walnuts** | ::{ flag=GB }:: **::\[Crz\]Envy::{ user=11817815 }**, ::{ flag=US }:: ::Asharpp::{ user=12657177 }, ::{ flag=US }:: ::Znow::{ user=15513303 }, ::{ flag=US }:: ::\[LS\]eeriee::{ user=19133938 } |
| **Weakest Captain** | ::{ flag=KR }:: **::GungunK::{ user=25311011 }**, ::{ flag=KR }:: ::PocaFanboy::{ user=6912079 }, ::{ flag=KR }:: ::qtepote::{ user=18278945 }, ::{ flag=KR }:: ::fhdmtmf::{ user=14454420 } |
| **What's Meramipoppin** | ::{ flag=US }:: **::PeachMarrow::{ user=15926730 }**, ::{ flag=SG }:: ::Messica::{ user=19838168 }, ::{ flag=VN }:: ::Qutilt::{ user=16214723 }, ::{ flag=SG }:: ::Seiron::{ user=18666852 } |
