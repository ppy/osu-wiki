...
| Mappool selector | ::{ flag=CN }:: [F D Flourite](https://osu.ppy.sh/users/2459589), ::{ flag=UA }:: [M0RU](https://osu.ppy.sh/users/13681464), ::{ flag=CA }:: [wwwww](https://osu.ppy.sh/users/8434466), ::{ flag=CA }:: [Yoshi\_green](https://osu.ppy.sh/users/1035891), ::{ flag=TN }:: [\-Ken](https://osu.ppy.sh/users/4430811) |
...
- Hidden
  1. [Denzel Curry - Walkin (Cold Blooded Soul Version) (JierYagtama) \[Cold Blooded Eyez\]](https://osu.ppy.sh/beatmapsets/1988437#fruits/4130792)
...
- Double Time
  1. [Feint - Laurence (Kimitakari) (Kimitakari) \[Rain (CWC Ver.)\] *(temporary link)*](https://leoflt.com/s/gS3q)
