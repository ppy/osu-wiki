...
|  | 国家/地区 | 选手 |
| --: | :-: | :-- |
| ::{ flag=AR }:: | **阿根廷** | **::NightWar::{ user=1209167 }**, ::Gundisalv::{ user=1160340 }, ::Litooo::{ user=1170107 }, ::musicguy007::{ user=2159777 } |
| ::{ flag=AT }:: | **奥地利** | **::\[ K a z u \]::{ user=1902480 }**, ::Raaban::{ user=1569025 }, ::xXMarcelXx::{ user=2355698 }, ::Zuyanta::{ user=2772759 } |
| ::{ flag=BO }:: | **玻利维亚** | **::donjuan\_217::{ user=2169426 }**, ::brian\_rqc::{ user=3710738 }, ::gakupoXD::{ user=871103 }, ::Zen Youkai::{ user=3364257 } |
| ::{ flag=CA }:: | **加拿大** | **::Kitokofox::{ user=1815420 }**, ::Kitsunemimi::{ user=100037 }, ::Sumaki::{ user=207916 } |
| ::{ flag=CL }:: | **智利** | *disbanded* |
| ::{ flag=CN }:: | **中国** | **::Dusk::{ user=533210 }**, ::hy1hy1hy::{ user=243877 }, ::Ibuki Suika::{ user=290249 }, ::MisakaMikoto::{ user=434917 } |
| ::{ flag=HR }:: | **克罗地亚** | **::Meikyuuiri Tsumi::{ user=404314 }**, ::Animewolf::{ user=949513 }, ::TinTin::{ user=2227976 } |
| ::{ flag=DK }:: | **丹麦** | **::-Crab-::{ user=2563435 }**, ::FlowHomie::{ user=2831095 }, ::jacoblemming12::{ user=3593786 }, ::TheCo0k1e::{ user=3386472 } |
| ::{ flag=EE }:: | **爱沙尼亚** | **::fanatik::{ user=913992 }**, ::KostjaSun::{ user=2450912 }, ::warstape::{ user=1133783 } |
| ::{ flag=FI }:: | **芬兰** | **::YERTI::{ user=1490757 }**, ::Mianki::{ user=39658 }, ::MrSake::{ user=264729 }, ::Static Noise Bird::{ user=826132 } |
| ::{ flag=FR }:: | **法国** | *disbanded* |
| ::{ flag=DE }:: | **德国** | **::DeathXHunter::{ user=405326 }**, ::NoteKuroi::{ user=186642 }, ::Nyan-Zapo::{ user=480676 } |
| ::{ flag=HK }:: | **香港** | **::alienflybot::{ user=636114 }**, ::\[\_NaGI\]::{ user=788406 }, ::HineX::{ user=13854 }, ::longkitang::{ user=1744806 }, ::XXXZ::{ user=1226238 } |
| ::{ flag=ID }:: | **印度尼西亚** | **::Shurelia::{ user=3807986 }**, ::- Rii -::{ user=3734591 }, ::\_EliteYud\_::{ user=2365634 }, ::Deceitful::{ user=1396447 }, ::Yoshida Haru-::{ user=3073351 } |
| ::{ flag=JP }:: | **日本** | **::uppia::{ user=1513301 }**, ::giru HD::{ user=707456 }, ::Lafollia::{ user=827985 }, ::Magiyu::{ user=1667470 }, ::rullu::{ user=595140 }, ::sekirei::{ user=1643335 } |
| ::{ flag=MY }:: | **马来西亚** | **::-Rin::{ user=1202101 }**, ::kho keng chung::{ user=369045 }, ::QHideaki13::{ user=733998 }, ::Rick--::{ user=950241 }, ::Shadow Fear::{ user=635485 } |
| ::{ flag=MX }:: | **墨西哥** | **::Lostty::{ user=2118519 }**, ::blacklotus::{ user=2115337 }, ::ChibiOzed::{ user=1690328 } |
| ::{ flag=NL }:: | **荷兰** | **::Givralii::{ user=2466879 }**, ::CakeAndBanana::{ user=1981424 }, ::Greaper::{ user=2369776 }, ::Nebux::{ user=2342051 }, ::wesley221::{ user=2407265 } |
| ::{ flag=NZ }:: | **新西兰** | **::IQ166::{ user=1452911 }**, ::JakeCC::{ user=88973 }, ::Nibble147::{ user=3866541 } |
| ::{ flag=NO }:: | **挪威** | **::Kiwikun::{ user=1794766 }**, ::Azeidith::{ user=2819676 }, ::Hakkun::{ user=2179438 }, ::lanki33::{ user=2535200 }, ::Zerzxes::{ user=2094253 } |
| ::{ flag=PE }:: | **秘鲁** | *已解散* |
| ::{ flag=PH }:: | **菲律宾** | *已解散* |
| ::{ flag=PL }:: | **波兰** | **::WujekGrzyb::{ user=258289 }**, ::Kosmit::{ user=1749173 }, ::Scorpionek::{ user=149730 }, ::wampir::{ user=261497 } |
| ::{ flag=SG }:: | **新加坡** | **::Accel::{ user=1169796 }**, ::He Ang Erika::{ user=2451381 }, ::Kagayane::{ user=1777691 }, ::Otaku\_MQ::{ user=2650135 }, ::Ridicule::{ user=3473425 } |
| ::{ flag=KR }:: | **韩国** | **::Spectator::{ user=702598 }**, ::dae6254::{ user=563262 }, ::Frobe::{ user=670365 }, ::Kuzino::{ user=158552 }, ::Last Bubble::{ user=1302259 } |
| ::{ flag=ES }:: | **西班牙** | **::SK Eternal::{ user=588046 }**, ::Raimon::{ user=609627 }, ::RAMONLINKK::{ user=843155 }, ::Nokeru-Chan::{ user=602315 }, ::sarkras::{ user=709625 } |
| ::{ flag=SE }:: | **瑞典** | **::Yukiteru Amano::{ user=1894511 }**, ::-Airi-::{ user=2546340 }, ::Negri\_sk::{ user=2231396 }, ::Suzuki::{ user=2960209 }, ::Walterx8::{ user=1993041 } |
| ::{ flag=TW }:: | **台湾** | *取消资格* |
| ::{ flag=TH }:: | **泰国** | **::boomngong::{ user=1090858 }**, ::0814587134::{ user=1054016 }, ::Nansugumi::{ user=795915 } |
| ::{ flag=GB }:: | **英国** | **::destructor966::{ user=2667584 }**, ::bubbz::{ user=86414 }, ::Nanomight::{ user=160439 }, ::DarkKanaki::{ user=2614160 }, ::Phlo10::{ user=2643155 } |
| ::{ flag=US }:: | **美国** | **::Zak::{ user=1375955 }**, ::-itsy\_v2-::{ user=2815946 }, ::-Kurisu-::{ user=500696 }, ::Minky::{ user=1978891 }, ::-Ryuuji-::{ user=2107523 }, ::TenguKing9::{ user=1637716 } |
| ::{ flag=UY }:: | **乌拉圭** | **::Themaster155::{ user=1850067 }**, ::quique95::{ user=472924 }, ::S3B4::{ user=3437784 }, ::Truxxxton::{ user=1379428 } |
...
| 名次 | 队伍 |
| :-: | :-- |
| ![金冠](/wiki/shared/crown-gold.png "冠军") | ::{ flag=KR }:: **韩国** (**::Spectator::{ user=702598 }**, ::dae6254::{ user=563262 }, ::Frobe::{ user=670365 }, ::Kuzino::{ user=158552 }, ::Last Bubble::{ user=1302259 }) |
| ![银冠](/wiki/shared/crown-silver.png "亚军") | ::{ flag=DE }:: **德国** (**::DeathXHunter::{ user=405326 }**, ::NoteKuroi::{ user=186642 }, ::Nyan-Zapo::{ user=480676 }) |
| ![铜冠](/wiki/shared/crown-bronze.png "季军") | ::{ flag=SE }:: **瑞典** (**::Yukiteru Amano::{ user=1894511 }**, ::-Airi-::{ user=2546340 }, ::Negri\_sk::{ user=2231396 }, ::Suzuki::{ user=2960209 }, ::Walterx8::{ user=1993041 }) |
