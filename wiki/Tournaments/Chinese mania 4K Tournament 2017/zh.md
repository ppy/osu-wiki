...
本次比赛奖品由音游网和汉斯共同赞助  
![](http://w.ppy.sh/6/6e/GCrown.png) 3个月![撒泼特]，及主页定制勋章；  
...
[TW]:https://s.ppy.sh/images/flags/tw.gif
...
[LeaF – I (_UJ’s Another)](https://osu.ppy.sh/b/928341)  
...
2. 玩家满足以下条件的可以报名参加CMT 4K 2017：  
	...
	- 玩家赛时使用时区无限制。  
	- 玩家使用汉语作为主要语言。  
	- 本次比赛对rank无强制要求，建议4000rank之内的玩家参赛。  
...
4. 小组内每个选手的排名根据以下优先级排序：  
	...
	- 选手有更高的 Σ{(分差)/(该图分数)}。  
	- 以上皆平手时加赛的胜利者。
5. 每个小组前__2__名选手将晋级到淘汰赛(人数可能根据实际报名人数变化)。
...
8. 获胜条件：
	...
	- 小组赛为__7__局 __4__胜(Best-of-**7**)。
	- 16强(Round of 16)和1/4决赛(Quarter-Finals)为__9__局 __5__胜(Best-of-**9**)。
...
3. 每位选手从图池中选择__1__个禁手图(Banned Map)，这些禁手图将在这场比赛中不能被任何选手选用。
...
2. 图池地图数根据赛程变化：
	...
	- 16强与1/4决赛各有**14**张图。
	- 半决赛与决赛各有**16**张图。
3. 每一个图池包括一个Tie-breaker（决胜图）(资格赛除外)。
