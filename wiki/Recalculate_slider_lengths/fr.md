...
**Recalculer les slider lengths** est une commande sous l'onglet `Timing` dans l'[éditeur de beatmap](/wiki/Beatmap_Editor). Son utilisation est suggérée après un changement de [BPM](/wiki/Beatmapping/Beats_per_minute) si la [beatmap](/wiki/Beatmap) possède déjà des [sliders](/wiki/Hit_object/Slider).
