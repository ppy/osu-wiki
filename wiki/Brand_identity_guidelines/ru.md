...
В этой статье приведены стандарты оформления проектов, связанных с osu!. Их можно использовать без отдельного разрешения.

Дизайн-кит можно [скачать с Google Drive](https://drive.google.com/file/d/1TmUot5nu49p71icz4u3G68njLAQOeQrG/view?usp=sharing) (внутри могут быть устаревшие элементы). Вместо рекомендаций из вложенного PDF-файла пользуйтесь данной статьёй.
