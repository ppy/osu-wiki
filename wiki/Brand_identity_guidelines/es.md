...
[Descarga aquí el kit de diseño](https://drive.google.com/file/d/1TmUot5nu49p71icz4u3G68njLAQOeQrG/view). El kit de diseño vinculado contiene algunos recursos obsoletos. También ten en cuenta que el PDF incluido está desactualizado y se debe usar esta página en su lugar.

## osu!

El nombre del juego, osu!, no debe escribirse con mayúscula ni en cursiva. La marca oficial de osu! no debe usar ningún espacio:
...
- Puedes agregar un degradado lineal a la galleta. No se recomiendan los degradados radiales, ya que el anillo y el elemento central pueden aparecer en colores completamente diferentes.
- Puedes enmascarar una obra de arte como textura para la galleta; sin embargo, la galleta debe mantener un buen contraste con el fondo.
...
- **No** cambies ningún elemento de la galleta por otra cosa.
- **No** elimines ningún elemento de la galleta.
...
- **No** agregues un degradado a la galleta a todo color.
- **No** uses otros colores.
- **No** agregues nada a la galleta.
- **No** cambies ningún elemento de la galleta por otra cosa.
