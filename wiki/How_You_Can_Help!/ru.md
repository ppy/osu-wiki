...
*Это — перевод поста, который как-то раз взял и написал, а потом попросил превратить в статью сам [peppy](https://osu.ppy.sh/u/2 "peppy").
Оригинал поста можно найти на форуме: [How you can help!](http://osu.ppy.sh/forum/t/83155)*
...
Чтобы на сайте постоянно была самая актуальная информация, мне бы хотелось все возможные текстовые материалы перенести на вики, а именно: FAQ, критерии ранкинга, различные руководства, историческую и прочую справку.
...
- Следите за [пулл-реквестами](https://github.com/ppy/osu-wiki/pulls "Пулл-реквесты") (можно даже в закладки добавить), смотрите, чтобы никто не добавил глупостей или ошибок, пишите к ним ревью.
...
В osu! есть модераторы, но за потоком активности в 25+ каналах — и тем более на форумах — трудно пристально следить, но это легко исправить.

### Откуда начать:

- Читайте свои любимые чаты и форумы.
- Если видите что-то неподобаюющее или нарушающее правила, используйте команду `!report`, чтобы связаться с модераторами.
...
- Выберите один из этих форумов: [Техподдержка](http://osu.ppy.sh/forum/5), [Помощь с маппингом](http://osu.ppy.sh/forum/56), [Сторибординг](http://osu.ppy.sh/forum/20), [Геймплей и ранкинги](http://osu.ppy.sh/forum/13).
...
Несмотря на то, что для ранкинга существуют отдельные команды, помогать может любой желающий.
Пишите отзывы к опубликованным картам, оставляйте конструктивную критику, и, возможно, когда-нибудь вы попадёте в одну из тех самых команд!

### Откуда начать:

- Исследуйте [список опубликованных карт](http://osu.ppy.sh/p/beatmaplist&s=7&r=2) по любимым артистам или песням (или выберите карту наугад).
...
- Если у вас много свободного времени, создайте очередь моддинга в [соответствующем форуме](http://osu.ppy.sh/forum/60) и пишите моды.
...
- Загляните в [турнирный форум](http://osu.ppy.sh/forum/55).
Возможно, вы придётесь кстати, например, выступите в качестве зрителя или судьи.
- Исследуйте [форум по разработке](http://osu.ppy.sh/forum/2).
Активность там низкая, но [проекты](http://osu.ppy.sh/forum/t/58855) [более](http://osu.ppy.sh/forum/t/80027) [серьёзны](http://osu.ppy.sh/forum/t/79354) и масштабны.
- Влейтесь в какой-нибудь [проект по маппингу](http://osu.ppy.sh/forum/53) и замутите с другими мапперами коллаб.
...
- Оживите [osu!monthly](http://osu.ppy.sh/forum/t/75017), я без него скучаю :<
