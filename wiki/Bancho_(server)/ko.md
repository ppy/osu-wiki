...
유지 보수 시간동안, Bancho는 몇 번씩 재시작될 수 있습니다. 게임 내 알림 시스템을 통해 카운트다운과 함께 채팅에 주기적인 경고 메시지를 모든 유저에게 전달합니다. 그 외의 모든 기능은 다른 [API](/wiki/osu!api)를 통해 처리되므로 Bancho 재시작은 채팅과 멀티플레이어에만 영향을 미칩니다.[^score-upload-ref]
