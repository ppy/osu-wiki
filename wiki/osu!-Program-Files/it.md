...
By default `C:\Program` `Files\osu!` where "C:" is your harddisk with osu! installed. For Windows 8, `C:\Program` `Files(x86)\osu!`.

<img src="Folder.png" title="fig:Folder.png" alt="Folder.png" width="50" height="50" /> Folders
===============================================================================================
...
Appears if you used the [Skin Selector's "Export as .osk"](IT:Options#Skin_Selector "wikilink") or [Beatmap Editor's "Export Package"](IT:Beatmap_Editor/Menu#File "wikilink"). **Holds .osz (beatmap)/.osk (skin) file you had exported from osu!.** [For how-to, click me](IT:Osu!_File_Formats#From_the_game "wikilink").
...
-   osu!.{YOUR PC NAME}.cfg ("[Options](IT:Options "wikilink") screen". Also contains [deprecated/interesting variables and sensitive information](IT:User_configuration_file "wikilink"))
