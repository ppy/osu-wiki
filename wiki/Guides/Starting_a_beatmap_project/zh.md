...
*没错，你的帖子标题会决定别的 osu! 用户是否支持你的谱面项目，甚至这在他们点进来之前就会发生！*

你应该在标题前添加 `[Discography]`（唱片目录）/ `[Album]`（专辑）/ `[Collab]`（合作）。如果你的帖子标题不够有描述性，那么你的项目很可能会被忽视，或被移动到[废弃的荒地](/wiki/Community/Forum/Abandoned_Wasteland)。

一些好标题的例子：

- `[Album] Pandora Voxx -complete-`（`[专辑] Pandora Voxx -已完成-`）
- `[Discography] Deemo`（`[唱片目录] Deemo`）

反面例子：

- `starting a new project, need your help with this album`（`我正在发起一个新的项目，这个专辑需要你的帮助`）

### 我应该使用哪一个？

**唱片目录（Discography）**：由歌手，团体或作曲家发布的，或游戏音轨中包含的一系列专辑或音乐。
