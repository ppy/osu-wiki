...
There are situations when one red bar is not enough (some example will be [Bad Apple](https://osu.ppy.sh/b/64780), [DJ Amuro's A](https://osu.ppy.sh/b/20841) or [kemu's Ikasama Life Game](https://osu.ppy.sh/b/183240)). Admit it, it can range from hardrock, metal, any guitar compositions, concerts, live performances, songs with audible acceleration/deceleration/pause ([Black∞Hole's Pluto](https://osu.ppy.sh/b/147406)) and so on. Even by using the metronome, certain parts of a song (likely on the climax or ending section) it no longer snaps into the previous rhythm. The song's tempo suddenly bumps up/down a notch, the singer suddenly starts singing frantically/melodically and goes off, and the musical instruments are played extensively/acoustically. In this scenario, shifting or changing the first red bar to fit the tempo will not help.
