...
Одновременно с отбиванием нот нужно поглядывать на левую часть окна редактора. Там находится нужная строчка, которая выглядит примерно так: _Mistimed Hits: 38% (ave 17 ms late)._
