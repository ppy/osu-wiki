...
2. Mulailah menyesuaikan Universal offset ke atas atau bawah, menggunakan tombol panah yang sesuai, atau roda gulir mouse.
...
Jika Kamu merasa metronom terasa terlalu cepat atau terlalu lambat untuk lagu tersebut, Kamu mungkin perlu mengaktifkan `Half tick` atau` Double tick` di kiri atas layar untuk mempermudah.
