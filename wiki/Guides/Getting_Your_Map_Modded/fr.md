...
Si vous souhaitez que votre map soit [classée](/wiki/Beatmaps/Category#ranked), vous devrez vous la faire [modder](/wiki/Modding). Il y a plusieurs moyens d'y arriver.
