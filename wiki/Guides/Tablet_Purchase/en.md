...
Lastly, CTL-480 tablets can be had for very cheap on second-hand sites like eBay or Amazon, although they are often hard to find, due to the discontinuation of the manufacturing, but if you could find one for a reasonable price, they are definitely worth checking out if you're also going to be doing digital art as well. Beside the Wacom CTL-480, that is commonly used and praised by players. There is also the CTL-470 lineup (such as the 470, 471 and 472) and CTL-4100, which is the latest models from Wacom, offering the same quality, if not better than the CTL-480.
