...
This should consist `[Discography]` / `[Album]` / `[Collab]` before the title. Chances are high that your project will be ignored or moved to [AW](/wiki/Beatmap/Category) if the thread's title lacks on informations.
