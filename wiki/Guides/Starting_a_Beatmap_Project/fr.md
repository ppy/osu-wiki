...
Il devrait commencer par `[Discography]` / `[Album]` / `[Collab]` avant le titre. Il y a de grandes chances que votre projet soit ignoré ou déplacé dans [AW](/wiki/Beatmap/Category) si le titre du sujet manque d'informations.
