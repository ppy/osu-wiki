...
-   Договоритесь использовать (_spacing_) разное расстояние между нотами или (_distance snapping_) зафиксировать его и придерживаться.
...
**_Еще несколько советов прежде чем начать совместный проект_**:
