...
- [Guide pour mapper sur osu!mania](osu!mania_Mapping_Guide)
- [Régler le décalage sur le bon temps](Setting_the_Offset_on_the_Correct_Beat)
- [Commencer un projet de beatmap](Starting_a_Beatmap_Project)
- [Vidéos venant de YouTube](Videos_From_Youtube)

## Modding

*Page principale : [Modding](/wiki/Modding)*

- [Faire modder sa map](Getting_Your_Map_Modded)
- [Comment faire ranker votre map](How_To_Get_Your_Map_Ranked)

## Jouer

- [Tutoriel du débutant](Beginner's_Tutorial)
- [Aide aux problèmes d'incompatibilité d'OpenGL](GL_Support_Issues)
- [Comment jouer à osu!mania](How_to_Play_osu!mania)
- [Comment utiliser l'assistant de décalage](How_to_Use_the_Offset_Wizard)
- [Faire des enregistrements d'osu!](Recording_osu!)
- [Chercher et télécharger des beatmaps](Searching_and_Downloading_Beatmaps)
- [Acheter une tablette](Tablet_Purchase)
- [Trucs et astuces pour améliorer ses compétences](Tips_and_Tricks_on_Skill_Improvement)
...
- [Recadrer des arrière-plans complexes](Cropping_with_Complex_Backgrounds)
- [Recadrer des arrière-plans simples](Cropping_with_Simple_Backgrounds)
- [Faire des spinners proprement centrés](Making_Properly_Centered_Spinners)
