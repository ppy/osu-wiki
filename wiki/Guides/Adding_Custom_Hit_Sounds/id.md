...
- atau membuat kustom hit sound sendiri
...
5. Klik *Open song folder*
6. *dan letakkan semuanya disana*

Karena sekarang Anda telah memiliki berkas hit sound di dalam folder beatmap tersebut, penting untuk menamai berkas-berkas tersebut sesuai dengan yang Anda inginkan. Contohnya, berkas-berkas tersebut bisa dinamai dengan "finish", "whistle", "clap", "normal hit", atau "loud noises".

Tergantung jenis hit sound mana yang Anda inginkan, Anda harus menamai file tersebut dengan awalan "soft", "normal" atau "drum".
...
Jangan lupa buka timing setup dan ubah hit sound ke *Custom*, dan pilih nomor yang lebih spesifik.
