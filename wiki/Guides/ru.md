...
Здесь приведён список руководств за авторством разных игроков osu!. Большинство из этих статей были сперва опубликованы на форуме osu! в отдельных темах, а затем викифицированы.
