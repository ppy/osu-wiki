...
_Заметка:_ Последние 3 сэмпла будут проигрываться вместе с обычным хитсаундом. То есть, в случае свистка будут при попадании в ноту будут проиграны и hitnormal и hitwhistle звуки.
...
_Заметка:_ Последние 3 сэмпла будут проигрываться вместе с обычным хитсаундом.
