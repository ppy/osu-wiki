...
Jika masalahmu tidak dapat diperbaiki berdasarkan solusi di atas, bukalah sebuah thread pada [forum bantuan](https://osu.ppy.sh/community/forums/5) dengan hasil dari [program ini](http://realtech-vr.com/home/glview) dan gl_info.txt kamu jika kamu menggunakan versi Cutting Edge (berkas gl_info.txt berada pada direktori instalasi osu!mu). Gunakan bahasa Inggris agar para pengembang dapat memahami dan membantu menyelesaikan permasalahanmu.
