...
Ce tutoriel est destiné aux cartographes qui veulent une chanson de jeux vidéo, principalement des consoles comme PS2, GCN/Wii, Xbox 360, etc. Il peut inclure des consoles portables et plus anciennes (voir SNES, PS1, PSP, N64, NDS, etc.) mais il faut plus de choses pour obtenir la musique de ces consoles.

## Avant de commencer

Ce tutoriel nécessitera plusieurs choses. Ils seront énumérés au cas où vous ne les auriez pas, de sorte que si vous ne les avez pas, vous pourrez les télécharger ou chercher des informations supplémentaires à leur sujet :
...
-   **LAME Encoder.** Ceci est nécessaire pour convertir la chanson au format MP3 afin que vous puissiez la charger dans [osu!](/wiki/Glossary) et commencez à cartographier !
...
*Note 2 : Certains jeux utilisent une extension différente ou pas d'extension du tout en raison de limitations du moteur/gémissements du programmeur/quel que soit le motif. En général, une recherche sur Google peut vous donner des informations sur ces jeux spécifiques.*

## Chargement de notre chanson

One fois que vous êtes dans le dossier musique du jeu, il est temps de charger les chansons sur foobar2000. Pour ce faire, sélectionnez tous les fichiers du dossier et faites-les glisser vers la fenêtre de foobar. Une fois que les chansons sont chargées, écoutez-les jusqu'à ce que vous arriviez à la chanson souhaitée. Dans ce tutoriel, nous recherchons le *Chapitre 3 Boss Battle Theme* (Nous ne pouvons pas gâcher le vrai nom pour ceux qui jouent encore au jeu :p) donc notre fichier est **btl\_gns1\_32k.stm**.
N'hésitez pas à écouter la chanson si vous le souhaitez.
...
Cette liste vous donnera la bonne configuration pour les convertir en osu !

-   **Format de sortie:** Format : MP3 (BOITEUX), V2. *(Le débit se réglera sur 190kbps)*
