...
Certain songs may have [time signatures](/wiki/Music_theory/Time_signature) that are not divided into [quarter notes](/wiki/Music_theory/Beat) (e.g. `3/4`, `4/4`, `7/4`, ...), but rather into eighth notes (e.g. `6/8`, `7/8`, ...). While the current editor does not support these `#/8` time signatures, there are ways to properly incorporate this timing into osu!.
