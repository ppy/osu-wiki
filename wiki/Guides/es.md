...
-   [Preguntas frecuentes](/wiki/FAQ)
    ...
    -   [Manejo de trampas](/wiki/Reporting_Bad_Behaviour/Handling_Cheating)
...
-   [Criterio de ranking](/wiki/Ranking_Criteria)
    -   [Para Standard](/wiki/Ranking_Criteria/osu!)
    -   [Para Taiko](/wiki/Ranking_Criteria/osu!taiko)
    -   [Para Catch the Beat](/wiki/Ranking_Criteria/osu!catch)
    -   [Para Mania](/wiki/Ranking_Criteria/osu!mania)
...
-   [¿Cómo son aprobados los Beatmaps?](/wiki/Submission/Beatmap_Ranking_Procedure)
...
-   [Librería de Hitsounds Personalizados](/wiki/Beatmap_Editor_Guides/Custom_Hit_Sound_Library)
-   [Añadiendo Hitsounds Personalizados](/wiki/Beatmap_Editor_Guides/Adding_Custom_Hit_Sounds)
...
-   [Edición de Audio](/wiki/Beatmap_Editor_Guides/Audio_Editing)
-   [Modificaciones básicas a MP3](/wiki/Beatmap_Editor_Guides/Basic_MP3_Modifications)
-   [Obteniendo canciones de videojuegos](/wiki/Beatmap_Editor_Guides/Getting_Songs_from_Video_Games)

Guías de Edición de Video
-------------------------

-   [Comprimiendo videos](/wiki/Beatmap_Editor_Guides/Compressing_Videos)
-   [Videos para Youtube](/wiki/Beatmap_Editor_Guides/Videos_from_Youtube)
...
-   [Haciendo una buena grabación para Youtube](/wiki/List_of_Guides/Recording_osu!)
...
-   [Cambiando el título o artista a un mapa](/wiki/Beatmap_Editor_Guides/Changing_the_Map's_Artist_or_Title)

Guías del Foro
--------------

-   [BBCode](/wiki/BBCode)
-   [Empezando un Proyecto de Beatmap](/wiki/Modding_Guides/Starting_a_Beatmap_Project)
