...
-   图有可能带有 [Hidden](/wiki/Game-Modifiers/zh.md)、[HardRock](/wiki/Game-Modifiers/zh.md)、[DoubleTime或者自由选择mod](/wiki/Game-Modifiers/zh.md)。
...
6.  允许使用 [Visual Settings](/wiki/Game-Modifiers/zh.md) 。
...
1.  每个环节都有独立的图池
2.  每个图池里都有5个模式: NoMod（无mod）、[Hidden](/wiki/Game-Modifiers/zh.md)、[HardRock](/wiki/Game-Modifiers/zh.md)、[DoubleTime](/wiki/Game-Modifiers/zh.md) 以及 FreeMod（自由选择mod）
3.  每个图池里会有23张图
4.  每个图池里都有一张决胜图
