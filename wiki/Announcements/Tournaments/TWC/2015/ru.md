...
**osu! Taiko World Cup 2015** (***TWC 2015*** ) — пятый по счёту всемирный турнир по тайко, который проводят [турнир-менеджеры](http://osu.ppy.sh/g/26). Он длится с 12 января по 15 апреля 2015 года. Победителем предыдущего турнира была **![](Jp.gif "fig:Jp.gif") Япония**.
...
| <img src="GCrown.png" title="GCrown.png" alt="GCrown.png" width="20" /> | Саппорт на 6 месяцев, иконка в профиле, титул "Taiko Champion", приз от администрации |
|-------------------------------------------------------------------------|---------------------------------------------------------------------------------------|
| <img src="SCrown.png" title="SCrown.png" alt="SCrown.png" width="20" /> | Саппорт на 3 месяца                                                                   |
| <img src="BCrown.png" title="BCrown.png" alt="BCrown.png" width="20" /> | Саппорт на 1 месяц                                                                    |

Персонал
========

| Организаторы | ![](De.gif "fig:De.gif") | ![](De.gif "fig:De.gif") | ![](Es.gif "fig:Es.gif") |
|--------------|--------------------------------------------------------------------------------|
| Подбор карт  | ![](De.gif "fig:De.gif")                                                       |
| Стримеры     | ![](Au.gif "fig:Au.gif") | ![](Pl.gif "fig:Pl.gif") | ![](Fr.gif "fig:Fr.gif") |
| Комментаторы | ![](Fr.gif "fig:Fr.gif") | ![](Us.gif "fig:Us.gif")                            |
| Статистик    | ![](Pl.gif "fig:Pl.gif")                                                       |
...
-   [osu! Taiko World Cup 2015 на Twitch](http://www.twitch.tv/osulive/)
...
2.  Сетка карт для каждого этапа будет оглашена заранее в последнее воскресенье перед этапом.
    ...
    -   В наличии также будут сетки для игры с [Hidden](HD "wikilink"), [HardRock](HR "wikilink"), [DoubleTime](DT "wikilink") и произвольными модами.
...
2.  Чтобы обеспечить корректность и серьёзность заявок, каждая из них будет проверена менеджерами турнира.
    1.  Каждый из игроков будет занесён в список кандидатов соответствующей страны. Чтобы попасть в список, Вами должны быть выполнены следующие условия:
        ...
        -   За вами не должно числиться нарушения [правил сообщества](RU:Rules "wikilink") за последние 12 месяцев.

3.  Для регистрации, [отправьте Локтаву сообщение](http://osu.ppy.sh/forum/ucp.php?i=pm&mode=compose&u=71366) с заголовком "TWC Registration".
...
5.  Дальнейшие этапы проводятся по [системе с двойным утешением](wikipedia:ru:Олимпийская_система_с_выбыванием_после_двух_поражений "wikilink"): выигравшая команда переходит в следующий этап, проигравшая попадает в сетку проигравших.
...
2.  Каждый пул состоит из пяти сеток: NoMod, [Hidden](Hidden "wikilink"), [HardRock](HardRock "wikilink"), [DoubleTime](DoubleTime "wikilink") и FreeMod.
