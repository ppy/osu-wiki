...
2.  Сетка карт для каждого этапа будет оглашена заранее в последнее воскресенье перед этапом.
    ...
    -   В наличии также будут сетки для игры с [Hidden](/wiki/Game_Modifiers/ru.md), [HardRock](/wiki/Game_Modifiers/ru.md), [DoubleTime](/wiki/Game_Modifiers/ru.md) и произвольными модами.
...
2.  Каждый пул состоит из пяти сеток: NoMod, [Hidden](/wiki/Game_Modifiers/ru.md), [HardRock](/wiki/Game_Modifiers/ru.md), [DoubleTime](/wiki/Game_Modifiers/ru.md) и FreeMod.
