...
2.  Сетка карт для каждого этапа будет оглашена заранее в последнее воскресенье перед этапом.
    ...
    -   В наличии также будут сетки для игры с [Hidden](/wiki/Game-Modifiers/ru.md), [HardRock](/wiki/Game-Modifiers/ru.md), [DoubleTime](/wiki/Game-Modifiers/ru.md) и произвольными модами.
...
2.  Чтобы обеспечить корректность и серьёзность заявок, каждая из них будет проверена менеджерами турнира.
    1.  Каждый из игроков будет занесён в список кандидатов соответствующей страны. Чтобы попасть в список, Вами должны быть выполнены следующие условия:
        ...
        -   За вами не должно числиться нарушения [правил сообщества](/wiki/Rules/ru.md) за последние 12 месяцев.
...
2.  Каждый пул состоит из пяти сеток: NoMod, [Hidden](/wiki/Game-Modifiers/ru.md), [HardRock](/wiki/Game-Modifiers/ru.md), [DoubleTime](/wiki/Game-Modifiers/ru.md) и FreeMod.
