...
- **2009-02-04:** ::{ flag=US }:: ::Ivalset::{ user-id=827 } dititahkan sebagai [BAT manager](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers) pertama. <!-- https://osu.ppy.sh/community/forums/topics/36869?start=81784 -->
...
- **2009-03-04:** ::{ flag=US }:: ::Ivalset::{ user-id=827 } meluncurkan [Delegation of the Beatmap Approval Deciding Authorities; Submission Squad](/wiki/People/Beatmap_Appreciation_Team/Delegation_of_the_Beatmap_Approval_Deciding_Authorities_Submission_Squad) (*BADASS*). <!-- https://osu.ppy.sh/community/forums/topics/10638 -->
...
- **2009-11-10:** ::{ flag=SG }:: ::Pasonia::{ user-id=43345 } ditunjuk selaku BAT manager setelah ::{ flag=US }:: ::Ivalset::{ user-id=827 } mengundurkan diri.
...
- **2009-12-27:** [Mapping Assistance Team](/wiki/People/Mapping_Assistance_Team) (*MAT*) dibentuk.
  ...
  - ::{ flag=AU }:: ::Ephemeral::{ user-id=102335 } menjabat sebagai [MAT Leader](/wiki/People/Mapping_Assistance_Team/MAT_Leaders) pada awal pembentukan MAT. <!-- https://osu.ppy.sh/community/forums/topics/21854 -->
...
- **2010-08-27:** ::{ flag=US }:: ::ztrot::{ user-id=6347 } ditunjuk selaku MAT Leader setelah ::{ flag=AU }:: ::Ephemeral::{ user-id=102335 } mengundurkan diri. <!-- https://osu.ppy.sh/community/forums/topics/36208 -->
...
- **2010-12-31:** ::{ flag=US }:: ::Derekku::{ user-id=91341 } ditunjuk sebagai BAT manager setelah ::{ flag=SG }:: ::Pasonia::{ user-id=43345 } mengundurkan diri.
...
- **2013-05-15:** Posisi [Triumvir Conglomerate](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers#triumvir-conglomerate) diperkenalkan kepada publik. <!-- https://osu.ppy.sh/community/forums/topics/132665 -->
  - Peran BAT manager yang sebelumnya hanya dijabat oleh satu orang kini dipangku oleh tiga orang secara paralel. Setiap anggota Triumvir Conglomerate merupakan perwakilan dari wilayah geografisnya masing-masing, di mana ::{ flag=US }:: ::Garven::{ user-id=244216 } mewakili Amerika Utara, ::{ flag=CN }:: ::NatsumeRin::{ user-id=151679 } mewakili Asia, dan ::{ flag=FR }:: ::Kurai::{ user-id=77089 } mewakili Eropa.
  ...
  - Di kala ketiga anggota Triumvir Conglomerate tidak dapat mengambil keputusan yang mutlak atas suatu permasalahan yang ada, ::{ flag=AU }:: ::Ephemeral::{ user-id=102335 } dan para petinggi osu! lainnya berhak untuk mengambil tindakan atas nama Triumvir Conglomerate dan anggota BAT lainnya.
...
- **2013-12-22:** Jabatan [Triumvir Conglomerate](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers#triumvir-conglomerate) dipindahtangankan ke tiga nama baru untuk memberikan suasana baru bagi para anggota BAT yang bertugas.
  - ::{ flag=US }:: ::Charles445::{ user-id=85000 } ditunjuk sebagai perwakilan Amerika Utara, ::{ flag=CN }:: ::popner::{ user-id=759860 } ditunjuk sebagai perwakilan Asia, dan ::{ flag=DE }:: ::Loctav::{ user-id=71366 } ditunjuk sebagai perwakilan Eropa yang baru. <!-- https://osu.ppy.sh/community/forums/topics/172289 -->
...
- **2015-06-06:** Diskualifikasi yang dilangsungkan oleh anggota QAT pada forum osu! sepenuhnya dianonimkan.
  - Seluruh post yang dibuat atas nama QAT ditulis oleh akun "::Quality Assurance Team::{ user-id=6616586 }".
...
- **2016-04-25:** Anggota QAT mulai mengecek beatmap-beatmap Qualified *secara reaktif* alih-alih secara proaktif.
  ...
  - Terdapat pengecualian dalam hal pemeriksaan metadata, di mana QAT (di bawah kepemimpinan ::{ flag=HK }:: ::IamKwaN::{ user-id=1856463 }) tetap menelaah keabsahan metadata pada beatmap Qualified yang ada secara proaktif. <!-- https://osu.ppy.sh/community/forums/topics/447417 + https://osu.ppy.sh/community/forums/topics/447428-->
...
- **2016-07-20:** [United Beat-Knights of Ranking Criteria](/wiki/Ranking_criteria/Ranking_Criteria_Council#united-beat-knights-of-ranking-criteria) (*UBKRC*) dibentuk untuk menggantikan Ranking Criteria Council.
  ...
  - Grup ini diketuai oleh ::{ flag=DE }:: ::Okoratu::{ user-id=1623405 } dan ::{ flag=US }:: ::pishifat::{ user-id=3178418 }.
...
- **2016-09-30:** Program [Community Mentorship](/wiki/Community/Community_Mentorship_Program) diluncurkan ulang.
  ...
  - Program ini diketuai oleh ::{ flag=DE }:: ::Okoratu::{ user-id=1623405 } dan ::{ flag=AR }:: ::Yuii-::{ user-id=2935923 }. <!-- https://osu.ppy.sh/community/forums/topics/506906 -->
...
- **2017-05-23:** ::{ flag=SE }:: ::Naxess::{ user-id=8129817 } meluncurkan bot Discord [Aiess](/wiki/Community/Projects#miscellaneous).
...
- **2017-12-17:** ::{ flag=DE }:: ::Loctav::{ user-id=71366 } sepenuhnya mengundurkan diri dari tim inti osu! dan melepas segala bentuk tanggung jawab yang dibebankan kepadanya, termasuk selaku QAT leader. <!-- https://clips.twitch.tv/BrightFragilePepperoniAllenHuhu -->
...
- **2018-05-22:** ::{ flag=DE }:: ::Mao::{ user-id=2204515 } ditunjuk sebagai [QAT leader](/wiki/People/Quality_Assurance_Team/QAT_Leaders) setelah ::{ flag=DE }:: ::Okoratu::{ user-id=1623405 } mengundurkan diri.
...
- **2018-06-21:** Regu [Quality Assurance Helper](/wiki/People/Beatmap_Nominators/General_Information#quality-assurance) didirikan.
  ...
  - Regu ini bekerja melalui situs Trello dengan dibantu oleh bot Aiess yang dibuat oleh ::{ flag=SE }:: ::Naxess::{ user-id=8129817 }.
...
- **2018-12-17:** ::{ flag=GB }:: ::-Mo-::{ user-id=2202163 } ditunjuk sebagai [QAT leader](/wiki/People/Quality_Assurance_Team/QAT_Leaders) setelah ::{ flag=GB }:: ::JBHyperion::{ user-id=4879508 } mengundurkan diri.
  - Ia melanjutkan tugas QAT leader sebelumnya dalam bekerja sama dengan tim inti osu! untuk memoderasi lingkungan mapping dan modding secara keseluruhan. <!-- source is discord logs -->
...
- **2019-08-05:** ::{ flag=SE }:: ::Naxess::{ user-id=8129817 } merilis program [Mapset Verifier](/wiki/Community/Projects#modding) yang ditujukan untuk membantu anggota Beatmap Nominator dalam menangani berbagai isu yang terdapat pada suatu beatmap.
...
- **2019-10-22:** ::{ flag=US }:: ::Ascendance::{ user-id=2931883 } ditunjuk sebagai NAT leader setelah ::{ flag=DE }:: ::Mao::{ user-id=2204515 } mengundurkan diri.
...
- **2020-02-21:**  NAT tidak lagi dipimpin secara terpusat setelah ::{ flag=US }:: ::Ascendance::{ user-id=2931883 } mengundurkan diri sebagai NAT leader.
...
- **2020-04-11:** Buletin Mappers' Report <!-- TODO: stub --> yang diprakarsai oleh ::{ flag=DE }:: ::Feerum::{ user-id=4815717 } mulai dipublikasikan secara rutin pada laman berita osu! setiap bulannya. Buletin ini merangkum berbagai kabar terkini seputar mapping dan modding dari waktu ke waktu.
...
- **2021-09-11:** ::{ flag=AU }:: ::peppy::{ user-id=2 } mengubah peraturan Ranking Criteria yang terkait dengan penggunaan kolom Source. <!-- https://github.com/ppy/osu-wiki/commit/02dee3fff09c3e890dc408271bb3d2d93c3c5b2d -->
...
- **2022-01-21:** Fitur *BN Finder* dirilis pada [situs web Beatmap Nominator](https://bn.mappersguild.com/) untuk memudahkan proses pencarian BN.
  ...
  - Setelah hasil kecocokan ditinjau, ::bot mappersguild::{ user-id=23648635 } akan mengirimkan pesan kepada pengguna yang menginformasikan apakah beatmap mereka diterima atau ditolak.
