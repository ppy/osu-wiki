...
- **2009-02-04:** ::{ flag=US }:: ::Ivalset::{ user=827 } was promoted as the first [BAT manager](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers). <!-- https://osu.ppy.sh/community/forums/topics/36869?start=81784 -->
...
- **2009-03-04:** ::{ flag=US }:: ::Ivalset::{ user=827 } launched the first [Delegation of the Beatmap Approval Deciding Authorities; Submission Squad](/wiki/People/Beatmap_Appreciation_Team/Delegation_of_the_Beatmap_Approval_Deciding_Authorities_Submission_Squad) (*BADASS*). <!-- https://osu.ppy.sh/community/forums/topics/10638 -->
...
- **2009-11-10:** ::{ flag=SG }:: ::Pasonia::{ user=43345 } was appointed as BAT manager after ::{ flag=US }:: ::Ivalset::{ user=827 } stepped down.
...
- **2009-12-27:** The [Mapping Assistance Team](/wiki/People/Mapping_Assistance_Team) (*MAT*) launched.
  ...
  - ::{ flag=AU }:: ::Ephemeral::{ user=102335 } was the group's first [MAT Leader](/wiki/People/Mapping_Assistance_Team/MAT_Leaders). <!-- https://osu.ppy.sh/community/forums/topics/21854 -->
...
- **2010-08-27:** ::{ flag=US }:: ::ztrot::{ user=6347 } was appointed as MAT leader after ::{ flag=AU }:: ::Ephemeral::{ user=102335 } stepped down. <!-- https://osu.ppy.sh/community/forums/topics/36208 -->
...
- **2010-12-31:** ::{ flag=US }:: ::Derekku::{ user=91341 } was appointed as BAT leader after ::{ flag=SG }:: ::Pasonia::{ user=43345 } stepped down.
...
- **2013-05-15:** The [Triumvir Conglomerate](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers#triumvir-conglomerate) was formed. <!-- https://osu.ppy.sh/community/forums/topics/132665 -->
  - The role of BAT manager was split between 3 users from different regions in an attempt to promote equal input among mapping subgroups. ::{ flag=US }:: ::Garven::{ user=244216 } represented North America, ::{ flag=CN }:: ::NatsumeRin::{ user=151679 } represented Asia, and ::{ flag=FR }:: ::Kurai::{ user=77089 } represented Europe.
  ...
  - When the 3 members did not agree on a decision, it needed to be decided by a higher-up (most often ::{ flag=AU }:: ::Ephemeral::{ user=102335 }).
...
- **2013-12-22:** The [Triumvir Conglomerate](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers#triumvir-conglomerate) cycled its regional leaders to avoid burnout.
  - ::{ flag=US }:: ::Charles445::{ user=85000 } represented North America, ::{ flag=CN }:: ::popner::{ user=759860 } represented Asia, and ::{ flag=DE }:: ::Loctav::{ user=71366 } represented Europe. <!-- https://osu.ppy.sh/community/forums/topics/172289 -->
...
- **2015-06-06:** QAT disqualifications were anonymised on the forums.
  - All posts were written under a user named "::Quality Assurance Team::{ user=6616586 }".
...
- **2016-04-25:** The QAT began checking qualified maps for issues *reactively* rather than proactively.
  ...
  - Metadata checks were still done proactively by the QAT, headed by ::{ flag=HK }:: ::IamKwaN::{ user=1856463 }. <!-- https://osu.ppy.sh/community/forums/topics/447417 + https://osu.ppy.sh/community/forums/topics/447428-->
...
- **2016-07-20:** The [United Beat-Knights of Ranking Criteria](/wiki/Ranking_criteria/Ranking_Criteria_Council#united-beat-knights-of-ranking-criteria) (*UBKRC*) was created to replace the Ranking Criteria Council.
  ...
  - The group was managed by ::{ flag=DE }:: ::Okoratu::{ user=1623405 } and ::{ flag=US }:: ::pishifat::{ user=3178418 }.
...
- **2016-09-30:** The [Community Mentorship Program](/wiki/Community/Community_Mentorship_Program) re-launched after a long hiatus.
  ...
  - The program was led by ::{ flag=DE }:: ::Okoratu::{ user=1623405 } and ::{ flag=AR }:: ::Yuii-::{ user=2935923 } <!-- https://osu.ppy.sh/community/forums/topics/506906 -->
...
- **2017-05-23:** Discord bot [Aiess](/wiki/Community/Projects#miscellaneous) was created by ::{ flag=SE }:: ::Naxess::{ user=8129817 }.
...
- **2017-09-10:** The "[QAT Upheaval](https://osu.ppy.sh/community/forums/topics/635507)" was implemented. This was a series of changes in response to dissatisfaction from the mapping community under leadership by [osu! team](/wiki/People/osu!_team) higher-ups. Following this change, the QAT began self-leadership without higher-up intervention.
  ...
  - ::{ flag=DE }:: ::Okoratu::{ user=1623405 } and ::{ flag=GB }:: ::JBHyperion::{ user=4879508 } were appointed as [QAT leaders](/wiki/People/Quality_Assurance_Team/QAT_Leaders) by a vote of BN/QAT members. Their responsibility was to work with the osu! team to maintain the mapping and modding communities.
...
- **2017-12-17:** ::{ flag=DE }:: ::Loctav::{ user=71366 } stepped down from involvement in the osu! team, including his heavy participation in the QAT. <!-- https://clips.twitch.tv/BrightFragilePepperoniAllenHuhu -->
...
- **2018-05-22:** ::{ flag=DE }:: ::Mao::{ user=2204515 } became a [QAT leader](/wiki/People/Quality_Assurance_Team/QAT_Leaders) after ::{ flag=DE }:: ::Okoratu::{ user=1623405 } stepped down.
...
- **2018-06-21:** The [Quality Assurance Helper](/wiki/People/Beatmap_Nominators/General_Information#quality-assurance) initiative was created.
  ...
  - The program was managed via Trello and automated by ::{ flag=SE }:: ::Naxess::{ user=8129817 } through Aiess.
...
- **2018-12-17:** ::{ flag=GB }:: ::-Mo-::{ user=2202163 } became a [QAT leader](/wiki/People/Quality_Assurance_Team/QAT_Leaders) after ::{ flag=GB }:: ::JBHyperion::{ user=4879508 } stepped down.
  - Like his predecessor, he continued working with the osu! team to manage the mapping/modding scenes. <!-- source is discord logs -->
...
- **2019-08-05:** ::{ flag=SE }:: ::Naxess::{ user=8129817 } released the [Mapset Verifier](/wiki/Community/Projects#modding) tool, automating a significant portion of beatmap checking processes for Beatmap Nominators.
...
- **2019-10-22:** ::{ flag=US }:: ::Ascendance::{ user=2931883 } became a NAT leader after ::{ flag=DE }:: ::Mao::{ user=2204515 } stepped down.
...
- **2020-02-21:**  NAT leadership as a concept was discontinued as ::{ flag=US }:: ::Ascendance::{ user=2931883 } stepped down as NAT leader.
...
- **2020-04-11:** The Mappers' Report<!-- TODO: stub --> led by ::{ flag=DE }:: ::Feerum::{ user=4815717 } was created to summarise mapping community events via front page news posts.
...
- **2021-09-11:** ::{ flag=AU }:: ::peppy::{ user=2 } changed Ranking Criteria rule about the Source field. <!-- https://github.com/ppy/osu-wiki/commit/02dee3fff09c3e890dc408271bb3d2d93c3c5b2d -->
...
- **2022-01-21:** A new feature dedicated to making BN requests more convenient has been deployed to [the Beatmap Nominators website](https://bn.mappersguild.com/), called *BN Finder*.
  ...
  - After a match is accepted or denied, the ::mappersguild bot::{ user=23648635 } will send a message to the requester informing them of the consensus.
