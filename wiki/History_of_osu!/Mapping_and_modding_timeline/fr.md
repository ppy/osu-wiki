...
- **20/12/2008 :** Les conditions pour rejoindre la [Beatmap Approval Team](/wiki/People/Beatmap_Appreciation_Team) (*BAT*) ont été publiées.
...
- **04/02/2009 :** ::{ flag=US }:: ::Ivalset::{ user-id=827 } a été promu premier [BAT manager](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers).
...
- **04/03/2009 :** ::{ flag=US }:: ::Ivalset::{ user-id=827 } a lancé la première [Délégation des pouvoirs de décision en matière d'approbation des beatmap ; escouade de soumission](/wiki/People/Beatmap_Appreciation_Team/Delegation_of_the_Beatmap_Approval_Deciding_Authorities_Submission_Squad) (*BADASS*).
...
- **10/11/2009 :** ::{ flag=SG }:: ::Pasonia::{ user-id=43345 } a été nommé responsable des BAT après le départ de ::{ flag=US }:: ::Ivalset::{ user-id=827 }.
...
- **27/12/2009 :** L'équipe [Mapping Assistance Team](/wiki/People/Mapping_Assistance_Team) (*MAT*) est lancée.
  ...
  - ::{ flag=AU }:: ::Ephemeral::{ user-id=102335 } a été le premier [Leader MAT](/wiki/People/Mapping_Assistance_Team/MAT_Leaders) du groupe.
...
- **27/08/2010 :** ::{ flag=US }:: ::ztrot::{ user-id=6347 } a été nommé chef du MAT après le départ de ::{ flag=AU }:: ::Ephemeral::{ user-id=102335 }.
...
- **31/12/2010 :** ::{ flag=US }:: ::Derekku::{ user-id=91341 } a été nommé chef des BAT après la démission de ::{ flag=SG }:: ::Pasonia::{ user-id=43345 }.
...
- **15/05/2013 :** Le [Triumvir Conglomerate](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers#triumvir-conglomerate) a été formé.
  - Le rôle de gestionnaire de la BAT a été partagé entre 3 utilisateurs de différentes régions afin de promouvoir une contribution égale entre les sous-groupes de mapping. ::{ flag=US }:: ::Garven::{ user-id=244216 } représentait l'Amérique du Nord, ::{ flag=CN }:: ::NatsumeRin::{ user-id=151679 } l'Asie, et ::{ flag=FR }:: ::Kurai::{ user-id=77089 } l'Europe.
  ...
  - Lorsque les 3 membres n'étaient pas d'accord sur une décision, celle-ci devait être décidée par un supérieur (le plus souvent ::{ flag=AU }:: ::Ephemeral::{ user-id=102335 }).
...
- **22/12/2013 :** Le [Triumvir Conglomerate](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers#triumvir-conglomerate) fait tourner ses dirigeants régionaux pour éviter l'épuisement.
  - ::{ flag=US }:: ::Charles445::{ user-id=85000 } représentait l'Amérique du Nord, ::{ flag=CN }:: ::popner::{ user-id=759860 } l'Asie, et ::{ flag=DE }:: ::Loctav::{ user-id=71366 } l'Europe.
...
- **06/06/2015 :** Les disqualifications des QAT ont été rendues anonymes sur les forums.
  - Tous les messages ont été écrits sous un utilisateur nommé "::Quality Assurance Team::{ user-id=6616586 }".
...
- **25/04/2016 :** Le QAT a commencé à vérifier les beatmaps qualifiées pour les problèmes *réactifs* plutôt que proactifs.
  ...
  - Les contrôles des métadonnées étaient toujours effectués de manière proactive par les QAT, dirigée par ::{ flag=HK }:: ::IamKwaN::{ user-id=1856463 }.
...
- **20/07/2016 :** Le [United Beat-Knights of Ranking Criteria](/wiki/Ranking_criteria/Ranking_Criteria_Council#united-beat-knights-of-ranking-criteria) (*UBKRC*) a été créé pour remplacer le conseil des critères de classement.
  ...
  - Le groupe était géré par ::{ flag=DE }:: ::Okoratu::{ user-id=1623405 } et ::{ flag=US }:: ::pishifat::{ user-id=3178418 }.
...
- **30/09/2016 :** Le [Community Mentorship Program](/wiki/Community/Community_Mentorship_Program) a été relancé après une longue interruption.
  ...
  - Le programme était dirigé par ::{ flag=DE }:: ::Okoratu::{ user-id=1623405 } et ::{ flag=AR }:: ::Yuii-::{ user-id=2935923 }
...
- **23/05/2017 :** Le bot Discord [Aiess](/wiki/Community/Projects#divers) a été créé par ::{ flag=SE }:: ::Naxess::{ user-id=8129817 }.
...
- **10/09/2017 :** Le "[QAT Upheaval](https://osu.ppy.sh/community/forums/topics/635507)" a été mis en place. Il s'agissait d'une série de changements en réponse au mécontentement de la communauté de mapping sous la direction de l'[équipe du jeu](/wiki/People/osu!_team). Suite à ce changement, les QAT ont commencés à s'autogérer sans l'intervention de leurs supérieurs.
  ...
  - ::{ flag=DE }:: ::Okoratu::{ user-id=1623405 } et ::{ flag=GB }:: ::JBHyperion::{ user-id=4879508 } ont été nommés [responsables des QAT](/wiki/People/Quality_Assurance_Team/QAT_Leaders) par un vote des membres du BN/QAT. Leur responsabilité était de travailler avec l'équipe d'osu! pour maintenir les communautés de mapping et de modding.
...
- **17/12/2017 :** ::{ flag=DE }:: ::Loctav::{ user-id=71366 } a cessé de s'impliquer dans l'équipe d'osu!, notamment en participant activement au QAT.
...
- **03/03/2018 :** Le canal `#modding` a été créé sur le [serveur Discord osu!](/wiki/Community/Discord_servers#officielle).
...
- **22/05/2018 :** ::{ flag=DE }:: ::Mao::{ user-id=2204515 } devient un [responsable QAT](/wiki/People/Quality_Assurance_Team/QAT_Leaders) après que ::{ flag=DE }:: ::Okoratu::{ user-id=1623405 } se soit retiré.
...
- **21/06/2018 :** L'initiative [Quality Assurance Helper](/wiki/People/Beatmap_Nominators/General_Information#quality-assurance) a été créée.
  ...
  - Le programme a été géré via Trello et automatisé par ::{ flag=SE }:: ::Naxess::{ user-id=8129817 } via Aiess.
...
- **17/12/2018 :** ::{ flag=GB }:: ::-Mo-::{ user-id=2202163 } devient un [responsable QAT](/wiki/People/Quality_Assurance_Team/QAT_Leaders) après que ::{ flag=GB }:: ::JBHyperion::{ user-id=4879508 } s'est retiré.
  - Comme son prédécesseur, il a continué à travailler avec l'équipe d'osu! pour gérer les scènes de mapping/modding.
...
- **01/03/2019 :** La [Mappers' Guild](/wiki/Community/Mappers_Guild) est passée d'une inscription sur dossier à une inscription automatique pour toute personne ayant 3 beatmaps classées.
  ...
  - Le canal `#mappers-guild` a été créé dans le [serveur Discord osu!](/wiki/Community/Discord_servers#officielle).
...
- **05/08/2019 :** ::{ flag=SE }:: ::Naxess::{ user-id=8129817 } a publié l'outil [Mapset Verifier](/wiki/Community/Projects#modding), qui automatise une partie importante des processus de vérification des beatmaps pour les Beatmap Nominators.
...
- **22/10/2019 :** ::{ flag=US }:: ::Ascendance::{ user-id=2931883 } est devenu un leader du NAT après que ::{ flag=DE }:: ::Mao::{ user-id=2204515 } se soit retiré.
...
- **21/02/2020 :**  La direction de la NAT en tant que concept a été abandonnée lorsque ::{ flag=US }:: ::Ascendance::{ user-id=2931883 } a quitté la direction du NAT.
...
- **11/04/2020 :** Le Mappers' Report, dirigé par ::{ flag=DE }:: ::Feerum::{ user-id=4815717 }, a été créé pour résumer les événements de la communauté de mapping par le biais d'articles en première page.
...
- **11/09/2021 :** ::{ flag=AU }:: ::peppy::{ user-id=2 } a modifié la règle des critères de classement concernant le champ Source.
...
- **21/01/2022 :** Une nouvelle fonctionnalité dédiée à rendre les demandes de BN plus pratiques a été déployée sur [le site des Beatmap Nominators](https://bn.mappersguild.com/), appelée *BN Finder*.
  ...
  - Après l'acceptation ou le refus d'une correspondance, le ::bot mappersguild::{ user-id=23648635 } enverra un message au demandeur l'informant du consensus.
