...
- **4/2/2009:** ::{ flag=US }:: ::Ivalset::{ user=827 } fue promovido como el primer [administrador del BAT](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers).
  - Su función principal era organizar una nueva promoción del BAT y mejorar la actividad/competencia del BAT actual.

### Marzo

- **4/3/2009:** ::{ flag=US }:: ::Ivalset::{ user=827 } lanzó la primera [Delegation of the Beatmap Approval Deciding Authorities; Submission Squad](/wiki/People/Beatmap_Appreciation_Team/Delegation_of_the_Beatmap_Approval_Deciding_Authorities_Submission_Squad) (*BADASS*).
...
- **10/11/2009:** ::{ flag=SG }:: ::Pasonia::{ user=43345 } fue nombrado administrador del BAT después de que ::{ flag=US }:: ::Ivalset::{ user=827 } renunciara.
...
- **27/12/2009:** Se lanzó el [Mapping Assistance Team](/wiki/People/Mapping_Assistance_Team) (*MAT*).
  ...
  - ::{ flag=AU }:: ::Ephemeral::{ user=102335 } fue el primer [líder de grupo del MAT](/wiki/People/Mapping_Assistance_Team/MAT_Leaders).
...
- **27/8/2010:** ::{ flag=US }:: ::ztrot::{ user=6347 } fue nombrado líder del MAT después de que ::{ flag=AU }:: ::Ephemeral::{ user=102335 } renunciara.
...
- **31/12/2010:** ::{ flag=US }:: ::Derekku::{ user=91341 } fue nombrado líder del BAT después de que ::{ flag=SG }:: ::Pasonia::{ user=43345 } renunciara.
...
- **15/5/2013:** Se formó el [Triumvir Conglomerate](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers#triumvir-conglomerate).
  - El rol del administrador del BAT se dividió entre 3 usuarios de diferentes regiones en un intento de promover la igualdad de aportes entre los subgrupos de mapping. ::{ flag=US }:: ::Garven::{ user=244216 } representó a América del Norte, ::{ flag=CN }:: ::NatsumeRin::{ user=151679 } representó a Asia, y ::{ flag=FR }:: ::Kurai::{ user=77089 } representó a Europa.
  ...
  - Cuando los 3 miembros no estaban de acuerdo con una decisión, era necesario que la tomara un superior (la mayoría de las veces ::{ flag=AU }:: ::Ephemeral::{ user=102335 }).
...
- **22/12/2013:** El [Triumvir Conglomerate](/wiki/People/Beatmap_Appreciation_Team/BAT_Managers#triumvir-conglomerate) cicló a sus líderes regionales para evitar el agotamiento.
  - ::{ flag=US }:: ::Charles445::{ user=85000 } representó a América del Norte, ::{ flag=CN }:: ::popner::{ user=759860 } representó a Asia, y ::{ flag=DE }:: ::Loctav::{ user=71366 } representó a Europa.
...
- **6/6/2015:** Las descalificaciones del QAT se anonimizaron en los foros.
  - Todas las publicaciones se escribieron bajo un usuario llamado «::Quality Assurance Team::{ user=6616586 }».
...
- **25/4/2016:** El QAT comenzó a verificar mapas calificados en busca de problemas *reactivamente* en lugar de proactivamente.
  ...
  - El QAT, dirigido por ::{ flag=HK }:: ::IamKwaN::{ user=1856463 }, seguía realizando comprobaciones de metadatos de forma proactiva.
...
- **20/7/2016:** El [United Beat-Knights of Ranking Criteria](/wiki/Ranking_criteria/Ranking_Criteria_Council#united-beat-knights-of-ranking-criteria) (*UBKRC*) fue creado para reemplazar al Ranking Criteria Council.
  ...
  - El grupo fue administrado por ::{ flag=DE }:: ::Okoratu::{ user=1623405 } y ::{ flag=US }:: ::pishifat::{ user=3178418 }.
...
- **30/9/2016:** El [Community Mentorship Program](/wiki/Community/Community_Mentorship_Program) se relanzó después de una larga pausa.
  ...
  - El programa fue dirigido por ::{ flag=DE }:: ::Okoratu::{ user=1623405 } y ::{ flag=AR }:: ::Yuii-::{ user=2935923 }.
...
- **23/5/2017:** El bot de Discord [Aiess](/wiki/Community/Projects#otros-proyectos) fue creado por ::{ flag=SE }:: ::Naxess::{ user=8129817 }.
...
- **10/9/2017:** Se implementó el «[QAT Upheaval](https://osu.ppy.sh/community/forums/topics/635507)». Esta fue una serie de cambios en respuesta a la insatisfacción de la comunidad de mapping bajo el liderazgo de los superiores del [osu! team](/wiki/People/osu!_team). Después de este cambio, el QAT comenzó a autoliderarse sin intervención superior.
  ...
  - ::{ flag=DE }:: ::Okoratu::{ user=1623405 } y ::{ flag=GB }:: ::JBHyperion::{ user=4879508 } fueron designados como [líderes del QAT](/wiki/People/Quality_Assurance_Team/QAT_Leaders) por votación de los miembros del BN/QAT. Su responsabilidad era trabajar con el osu! team para mantener las comunidades de mapping y modding.
...
- **17/12/2017:** ::{ flag=DE }:: ::Loctav::{ user=71366 } renunció a su participación en el osu! team, incluyendo su fuerte participación en el QAT.
...
- **22/5/2018:** ::{ flag=DE }:: ::Mao::{ user=2204515 } se convirtió en un [líder del QAT](/wiki/People/Quality_Assurance_Team/QAT_Leaders) después de que ::{ flag=DE }:: ::Okoratu::{ user=1623405 } renunciara.
...
- **21/6/2018:** Se creó la iniciativa del [Quality Assurance Helper](/wiki/People/Beatmap_Nominators/General_Information#control-de-calidad).
  ...
  - El programa fue administrado a través de Trello y automatizado por ::{ flag=SE }:: ::Naxess::{ user=8129817 } a través de Aiess.
...
- **17/12/2018:** ::{ flag=GB }:: ::-Mo-::{ user=2202163 } se convirtió en un [líder del QAT](/wiki/People/Quality_Assurance_Team/QAT_Leaders) después de que ::{ flag=GB }:: ::JBHyperion::{ user=4879508 } renunciara.
  - Al igual que su antecesor, continuó trabajando con el osu! team para gestionar las escenas de mapping/modding.
...
- **5/8/2019:** ::{ flag=SE }:: ::Naxess::{ user=8129817 } lanzó la herramienta [Mapset Verifier](/wiki/Community/Projects#modding), que automatiza una parte importante de los procesos de verificación de los beatmaps para los Beatmap Nominators.
...
- **22/10/2019:** ::{ flag=US }:: ::Ascendance::{ user=2931883 } se convirtió en un líder del NAT después que ::{ flag=DE }:: ::Mao::{ user=2204515 } renunciara.
...
- **21/2/2020:** El liderazgo del NAT como concepto se suspendió cuando ::{ flag=US }:: ::Ascendance::{ user=2931883 } renunció como líder del NAT.
...
- **11/4/2020:** El Mappers' Report dirigido por ::{ flag=DE }:: ::Feerum::{ user=4815717 } fue creado para resumir los eventos de la comunidad de mapping a través de publicaciones de noticias de primera plana.
...
- **11/9/2021:** ::{ flag=AU }:: ::peppy::{ user=2 } cambió la regla de los criterios de clasificación sobre el campo Source.
...
- **21/1/2022:** Se implementó una nueva función dedicada a hacer que las solicitudes para BN sean más convenientes en [el sitio web de los Beatmap Nominators](https://bn.mappersguild.com/), llamada *BN Finder*.
  ...
  - Después de que se acepte o deniegue una coincidencia, el ::bot mappersguild::{ user=23648635 } enviará un mensaje al solicitante informándole del consenso.
