...
Une nouvelle version de l'éditeur osu!mania était en cours de développement. L'habillage du mode Taiko comporte désormais une barre de "métadonnées" (titre de la chanson et artiste sous le champ de jeu), le champ de jeu du mode Taiko n'est plus transparent et s'adapte au kiai time. La FAQ originale a été remplacée par le [osu! wiki](/wiki/FAQ).
...
En ce qui concerne le beatmapping, tous les membres de la MAT sont devenus membres du BAT, la MAT ayant été officiellement dissous car la frontière de pouvoir entre les membres de la MAT et de la BAT était trop proche.
...
[Un nouveau système de classement/modding est en cours de développement](https://osu.ppy.sh/community/forums/topics/129625) qui remplacera les anciens fils de discussion de style forum.

Pour le mode Multi, les joueurs peuvent désormais utiliser le mod spécial (Relax/Autopilot/SpunOut/ManiaKeys) lorsque le mode libre est activé par l'hôte. Du côté du skinning, les sprites par défaut du taiko en écran large (taiko `@2x`) ont été ajoutés. Les favoris A/B ont été complètement supprimés et remplacés par les Collections.

Trois nouveaux [succès](/wiki/Médailles) pour osu!mania ont été publiées (40 000 / 400 000 / 4 000 000 de touches pressées). Le design du profil de l'utilisateur a été retravaillé et votre "dernière visite" sera basée sur la connexion à Bancho (c'est-à-dire la connexion en jeu) plutôt que sur les visites du forum. Enfin, osu! a franchi le cap des 10 000 utilisateurs connectés simultanément !
...
![](img/2013-06_05.jpg "Disqus implémenté")
