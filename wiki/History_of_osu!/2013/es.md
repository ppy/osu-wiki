...
Para el modo multijugador, los jugadores ahora pueden usar el mod especial (Relax/Autopilot/SpunOut/ManiaKeys) cuando el anfitrión habilite el Free Mod. En el lado de skinning, se han agregado sprites predeterminados de pantalla ancha de taiko (taiko `@2x`). Los favoritos A/B se eliminaron por completo y fueron reemplazados por las colecciones.
