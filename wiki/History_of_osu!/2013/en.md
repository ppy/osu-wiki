...
BanchoBot's `!faq` command has been open to public for [translation](https://docs.google.com/a/ppy.sh/spreadsheet/ccc?key=0AlsSAL_F7-xDdHhUUjNSa19QendtcTdYUjE2S2hnVHc#gid=24). The legendary [BanchoBot](/wiki/BanchoBot) finally has a ::profile::{ user-id=3 }! The user panels display now adjusts to display four columns on all widescreen modes.
...
[The new regional BATmanagers](https://osu.ppy.sh/community/forums/topics/132667) began their first major recruitment of new BAT in to the team with the [Summer 2013 NewBAT Applications](https://osu.ppy.sh/community/forums/topics/142864). This provided a chance for the new managers to adequately handle new applications. The new regional managers were ::NatsumeRin::{ user-id=151679 } representing Asia/Oceania, ::Kurai::{ user-id=77089 } representing Europe, and ::Garven::{ user-id=244216 } representing America.
