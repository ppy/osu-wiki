...
Seperangkat perintah `!faq` untuk BanchoBot telah dibuka untuk umum supaya dapat [diterjemahkan](https://docs.google.com/a/ppy.sh/spreadsheet/ccc?key=0AlsSAL_F7-xDdHhUUjNSa19QendtcTdYUjE2S2hnVHc#gid=24). [BanchoBot](/wiki/BanchoBot) yang legendaris akhirnya memiliki ::profil tersendiri::{ user-id=3 }! Tampilan panel pengguna sekarang menyesuaikan resolusi layar untuk menampilkan empat kolom pada semua mode widescreen.
...
- [osu! Versi (Rilisan Publik) (2007-09)](https://osu.ppy.sh/community/forums/topics/130144)
...
![](img/2013-06_02.jpg "Contoh percobaan pembuatan beberapa akun")

![](img/2013-06_03.jpg "Contoh perbandingan di halaman info beatmap")

![](img/2013-06_04.jpg "Contoh profil pengguna saat ini")

![](img/2013-06_05.jpg "Disqus diimplementasikan")
...
[BATMANager regional baru](https://osu.ppy.sh/community/forums/topics/132667) memulai perekrutan besar pertama dari BAT baru ke dalam tim dengan [Summer 2013 NewBAT Applications](https://osu.ppy.sh/community/forums/topics/142864). Hal ini memberikan kesempatan bagi manajer baru untuk menangani aplikasi baru secara memadai. Manajer regional baru adalah ::NatsumeRin::{ user-id=151679 } yang mewakili Asia/Oceania, ::Kurai::{ user-id=77089 } mewakili Eropa, dan ::Garven::{ user-id=244216 } mewakili Amerika.
