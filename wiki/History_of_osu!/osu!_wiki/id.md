...
- **2011-12-05:** Landasan awal osu! wiki mulai dirintis, dengan ::{ flag=AU }:: ::Ephemeral::{ user=102335 } membuat beberapa penyuntingan awal.
...
- **2012-11-29:** ::{ flag=MX }:: ::Repflez::{ user=201392 } dan ::{ flag=RU }:: ::Dellirium::{ user=519032 } [ditambahkan](https://osu.ppy.sh/community/forums/posts/1944044) ke tim admin osu! wiki di Mediawiki.

### 2013

#### January

- **2013-01-27:** ::{ flag=AU }:: ::peppy::{ user=2 } memadankan tampilan osu! wiki dengan tampilan [situs utama osu!](https://osu.ppy.sh/community/forums/posts/2082803).
...
- **Tanggal yang tidak diketahui:** ::{ flag=NZ }:: ::deadbeat::{ user=128370 } dan ::{ flag=DE }:: ::Loctav::{ user=71366 } ditambahkan ke tim admin osu! wiki di MediaWiki.
...
- **Tanggal yang tidak diketahui:** Posisi ::{ flag=RU }:: ::Dellirium::{ user=519032 } sebagai admin digantikan oleh ::{ flag=FR }:: ::Shiro::{ user=113005 }.

### 2016

#### Februari

- **2016-02-22:** ::{ flag=PL }:: ::Ukami::{ user=820865 } dan ::{ flag=PL }:: ::Galkan::{ user=169570 } ditambahkan ke tim admin osu! wiki di MediaWiki.

#### April

- **2016-04-01:** ::{ flag=PH }:: ::Nathanael::{ user=2295078 } ditambahkan ke tim admin osu! wiki di MediaWiki.
...
- **2016-08-26:** ::{ flag=AU }:: ::peppy::{ user=2 } [membuat repositori osu-wiki](https://github.com/ppy/osu-wiki/tree/3433cbeeda9303a470647cad1c338d43f4272a2e).
...
- **2017-01-26:**::{ flag=AU }:: ::Ephemeral::{ user=102335 } berbicara seputar rencana integrasi antara repositori Github dengan situs web osu! itu sendiri pada [postingan blog pengembangan](https://blog.ppy.sh/post/156390386433/2017-01-dev-meeting).
- **Tanggal yang tidak diketahui:** ::{ flag=JP }:: ::nanaya::{ user=2387883 } merampungkan dukungan backend untuk osu! wiki yang baru, yang memungkinkan wiki ini untuk dapat sepenuhnya terintegrasi dengan situs web osu!.
...
- **Tanggal yang tidak diketahui:** ::{ flag=PL }:: ::TPGPL::{ user=3944705 } diberikan izin tulis khusus ke repositori osu! wiki.
...
- **2021-06-01:** ::{ flag=ID }:: ::GPR::{ user=10721349 } mengimplementasikan [overlay osu! wiki](https://github.com/ppy/osu/pull/12950) di [osu!(lazer)](/wiki/Client/Release_stream/Lazer), yang memungkinkan halaman wiki tertentu untuk dapat diakses secara langsung dari dalam klien osu!(lazer).
