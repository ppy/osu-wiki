...
| :-- | :-- |
| 05.12.2011 (08:13 UTC) | Erste Bearbeitung des osu!-Wikis von ::{ flag=AU }:: ::Ephemeral::{ user-id=102335 }. |
| 06.12.2011 | [Das osu!-Wiki ist jetzt live!](https://osu.ppy.sh/community/forums/topics/68525). |
| November 2012 | Das osu!-Wiki hat jetzt 3 Admins (::{ flag=RU }:: ::Dellirium::{ user-id=519032 } und ::{ flag=MX }:: ::Repflez::{ user-id=201392 } wurden hinzugefügt). Vorher war nur ::{ flag=AU }:: ::peppy::{ user-id=2 } der Admin. |
| 27.01.2013 (06:12 UTC) | ::{ flag=AU }:: ::peppy::{ user-id=2 } integrierte das osu!-Wiki in die Hauptseite. [Link zu peppys Beitrag](https://osu.ppy.sh/community/forums/posts/2082803). |
| 2014 | Das osu!-Wiki wird zu einem Informationszentrum für osu!, wobei die meisten der Webkopien wie [osu!-Team](/wiki/People/osu!_team) und [Regeln](/wiki/Rules) ersetzt werden. Auch hat das osu!-Wiki jetzt 5 Admins (::{ flag=DE }:: ::Loctav::{ user-id=71366 } und ::{ flag=NZ }:: ::deadbeat::{ user-id=128370 } werden hinzugefügt). |
| 2015 | Das osu!-Wiki erhielt wichtige Aktualisierungen der Übersetzungen in andere Sprachen. ::{ flag=RU }:: ::Dellirium::{ user-id=519032 } wurde durch ::{ flag=FR }:: ::Shiro::{ user-id=113005 } als einer der Admins des osu!-Wikis ersetzt. |
| 22.02.2016 | Das osu!-Wiki hat jetzt 8 Admins (::{ flag=PL }:: ::Ukami::{ user-id=820865 } und ::{ flag=PL }:: ::Galkan::{ user-id=169570 } werden hinzugefügt). |
| 01.04.2016 | Ein weiterer Admin trat dem osu!-Wiki bei (::{ flag=PH }:: ::Nathanael::{ user-id=2295078 }). |
...
| Datum | Beschreibung |
| :-- | :-- |
| 26.08.2016 | ::{ flag=AU }:: ::peppy::{ user-id=2 } [erstellte das Repository osu-wiki](https://github.com/ppy/osu-wiki/tree/3433cbeeda9303a470647cad1c338d43f4272a2e). ::{ flag=US }:: ::craftu::{ user-id=16468119 } und ::{ flag=US }:: ::XYLOO::{ user-id=27809907 } portierten den Inhalt innerhalb einer Woche aus MediaWiki in das Repository. |
...
| Januar 2017 | osu!web-Unterstützung des osu!-Wikis geschehen durch ::{ flag=JP }:: ::nanaya::{ user-id=2387883 }. |
| 05.01.2017 | Das osu!-Wiki-Projekt wird von ::{ flag=AU }:: ::Ephemeral::{ user-id=102335 } vorgeschlagen. |
...
| Juni 2017 | ::{ flag=PL }:: ::TPGPL::{ user-id=3944705 } wird mit Schreibzugriff für das Repository osu-wiki befördert. Ein Suchdienst für das osu!-Wiki wird in osu!web implementiert. |
