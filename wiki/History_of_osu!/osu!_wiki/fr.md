...
| :-- | :-- |
| 05/12/2011 (10h13 UTC+2) | Première édition du wiki d'osu! par ::{ flag=AU }:: ::Ephemeral::{ user=102335 }. |
| 06/12/2011 | [Le wiki d'osu! est maintenant en ligne !](https://osu.ppy.sh/community/forums/topics/68525). |
| Novembre 2012 | Le wiki d'osu! comporte maintenant 3 administrateurs : ::{ flag=RU }:: ::Dellirium::{ user=519032 } et ::{ flag=MX }:: ::Repflez::{ user=201392 } ont été ajoutés. Auparavant, seuls ::{ flag=AU }:: ::peppy::{ user=2 } était l'administrateur. |
| 27/01/2013 (06:12 UTC) | ::{ flag=AU }:: ::peppy::{ user=2 } a intégré le wiki d'osu! dans le design du site principal. [Lien vers l'article de peppy](https://osu.ppy.sh/community/forums/posts/2082803). |
| 2014 | Le wiki d'osu! devient un véritable centre d'information pour osu!, remplaçant la plupart des copies web telles que [l'équipe d'osu!](/wiki/People/osu!_team) et [règles](/wiki/Rules). De plus, le wiki d'osu! comporte maintenant 5 administrateurs : ::{ flag=DE }:: ::Loctav::{ user=71366 } et ::{ flag=NZ }:: ::deadbeat::{ user=128370 } ont été ajoutés. |
| 2015 | Le wiki d'osu! a reçu des mises à jour majeures de traductions d'autres langues. ::{ flag=RU }:: ::Dellirium::{ user=519032 } a été remplacé par ::{ flag=FR }:: ::Shiro::{ user=113005 } comme l'un des administrateurs du wiki d'osu! |
| 22/02/2016 | Le wiki d'osu! comporte maintenant 8 administrateurs : ::{ flag=PL }:: ::Ukami::{ user=820865 } et ::{ flag=PL }:: ::Galkan::{ user=169570 } ont été ajoutés. |
| 01/04/2016 | Un nouvel administrateur a rejoint le wiki d'osu! : ::{ flag=PH }:: ::Nathanael::{ user=2295078 }. |
...
| Date | Description |
| :-- | :-- |
| 26/08/2016 | ::{ flag=AU }:: ::peppy::{ user=2 } [a créé le dépôt osu-wiki](https://github.com/ppy/osu-wiki/tree/3433cbeeda9303a470647cad1c338d43f4272a2e). ::{ flag=US }:: ::craftu::{ user=16468119 } et ::{ flag=US }:: ::XYLOO::{ user=27809907 } ont transféré le contenu de MediaWiki vers le dépôt en une semaine. |
...
| Janvier 2017 | Soutien de l'osu!web au wiki d'osu! réalisé par ::{ flag=JP }:: ::nanaya::{ user=2387883 }. |
| 05/01/2017 | Le projet de l'osu! wiki est proposé par ::{ flag=AU }:: ::Ephemeral::{ user=102335 }. |
...
| Juin 2017 | ::{ flag=PL }:: ::TPGPL::{ user=3944705 } est promu avec un accès en écriture pour le dépôt osu-wiki. Le service de recherche sur l'osu!web pour le wiki d'osu! est implémenté. |
