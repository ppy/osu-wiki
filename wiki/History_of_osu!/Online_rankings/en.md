...
As of 11 July 2026, on the [osu! performance rankings](https://osu.ppy.sh/rankings/osu/performance) the rank #1 player is ::{ flag=AU }:: ::mrekk::{ user=7562902 }.
...
As of 21 July 2026, on the [osu!catch performance rankings](https://osu.ppy.sh/rankings/fruits/performance) the rank #1 player is ::{ flag=KR }:: ::Motion::{ user=3885626 }.

## ![][osu!mania] osu!mania

<!-- TODO: Add ranking history page similar to osu! -->

As of 4 April 2026, on the [osu!mania performance rankings](https://osu.ppy.sh/rankings/mania/performance) the rank #1 player is ::{ flag=KR }:: ::Kalkai::{ user=10790649 }.
