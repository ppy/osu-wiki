...
The [official release statement](https://osu.ppy.sh/home/news/2015-03-31-osucoins) explains that the osu!coin was introduced as a way to fund ::{ flag=AU }:: ::peppy::{ user=2 }'s private jet as the current monetisation scheme wouldn't allow him to buy it in his lifetime. The statement continues, explaining that each new player would start off with 10 osu!coins, and would be given 10 more for each passing day. Existing users would get an additional two osu!coins as an added bonus. Players could then gain more osu!coins by obtaining [combo](/wiki/Gameplay/Combo_(score_multiplier)). A single osu!coin would be obtained for every 100x combo.
