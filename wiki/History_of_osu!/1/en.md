...
The following are some of the history of osu! since its beginning. Special thanks to [Sinistro](https://osu.ppy.sh/u/Sinistro) for helping in compiling 2007/2008 content. [Source link](https://osu.ppy.sh/p/history).
...
![Song Selection for osu!editor](img/200707-01.jpg "Song Selection for osu!editor")
![Test-play 1](img/200707-02.jpg "Test-play 1")
![Test-play 2](img/200707-03.jpg "Test-play 2")
![Beatmapping hit-circles](img/200707-04.jpg "Beatmapping hit-circles")
...
**The birth of osu!** as far as the public is concerned. The **forums** as we know them today were **established**, and hosted from peppy's home server (ppy.sh). Attention was gained via a news announcement on <https://www.bemanistyle.com> which drew quite a few interested people with previous rhythm game experience.
...
Quickly after the public release, **the first play mods ([Easy](/wiki/Game_Modifiers/) and [No Fail](/wiki/Game_Modifiers/)) were added, as well as break sections (which up until now had been ignored and missing).** A large number of changes quickly made osu! look more and more like a commercial rhythm game.
...
![Solo Song Selection (note the addition of EZ and NF)](img/200710-03.jpg "Solo Song Selection (note the addition of EZ and NF)") ![Error message](img/200710-02.png "Error message")
...
--------
#### Game Modifiers
![No Video Mod](img/No_Video.png "No Video Mod") ![Hidden Mod](img/Hidden_v1.png "Hidden Mod")

A new **SS rank was added to the ranking system**, replacing S rank in cases where perfection was achieved. The **[No Video](/wiki/Game_Modifiers/) and [Hidden](/wiki/Game_Modifiers/) mods were introduced, and the SH and SSH ranks** to go with it. For the first time, **players could skin and assign normal and soft sample sets per timing section. .osz files could now be loaded by double-clicking them, or dragging them onto the osu! icon.**
...
![IRC usage example(see the SSH and osu! windows. Background is osu! development using Visual Studio.)](img/200711-03.jpg "IRC usage example(see the SSH and osu! windows. Background is osu! development using Visual Studio.)")

 The **"Beatmap Submission System" (BSS) was made public**, allowing users to easily upload and share their creations. This introduced the **status of pending and ranked maps** and helped organise the rapidly growing collection of user-submitted beatmaps. **In-game chat was added, as an IRC client built from scratch and connected to a standard irc server (no bancho yet). Extended chat was visible. Avatars and basic stats were displayed in game** (using an http-based communication). **Audio controls** were also added to the main menu, which also now plays a random song on startup. **Replays could be watched for both local scores and online plays.** Players could **spectate other players** (and spectator data was sent raw over [IRC](/wiki/Internet_Relay_Chat)!).

December
--------

**Songs can be edited by dragging them into the osu! window. Tooltips are now present explaining all the various buttons in the osu! menus and editor interface.** Many new quality skins were submitted by early skinners ([Holiday by LuigiHann](https://osu.ppy.sh/forum/t/1139/), [WindWaker by awp](https://osu.ppy.sh/forum/t/761/)). **New sorting methods were added to the song selection screen**. **peppy could now send universal announcements to all osu! players. Minor tweaks are made to gameplay, such as non-active circle dimming.**
...
![Osu2008.jpg](img/Osu2008.jpg "Osu2008.jpg")
...
![Taiko mod](img/Taiko.png "Taiko mod")
...
A major milestone in osu history was reached with the addition of the **[multiplayer (Multi)](/wiki/Multi) game mode.** Skinning options were expanded further regarding both graphics and sounds. Lastly, **multi-channel chat was possible for the first time.**

July
----

**The editor, multiplayer, storyboarding, graphics, chat console all received numerous improvements this month. The options screen received a new layout, and [custom key bindings](/wiki/Options) were introduced.**
...
A new ranked status ![Fire](/wiki/shared/Fire.gif "Fire") **approved** was added for maps which are of great quality but exceed ranking length or difficulty (or other) limits in some way. Maps in this status don't add to player's scores, but have scoreboards and act otherwise like a ![heart](/wiki/shared/Heart.gif "heart") **ranked** map.

September
---------

![Flashlight Mod](img/Flashlight_v1.png "Flashlight Mod") ![Spun Out Mod](img/Spun_Out_v1.png "Spun Out Mod") ![Auto Mod](img/Autoplay_v1.png "Auto Mod")

A slew of **new mods were unveiled this month: [Flashlight](/wiki/Game_Modifiers/#flashlight), [Spun Out](/wiki/Game_Modifiers/#spun-out) and [Auto](/wiki/Game_Modifiers/#auto)**. Auto scripts an AI player that completed (almost) any beatmap with perfect accuracy, and can also be accessed via the editor test mode. The limits of beatmap design were pushed farther with the addition of **more skinnable elements (including combo burst images), the clap sound sample, the ability to assign sound samples to individual slider endpoints and inherited timing sections. The song selection screen also received an overhaul.**
...
Another noticeable event is that the Catch the Beat score is [wiped](https://osu.ppy.sh/forum/viewtopic.php?f=9&t=7996) this month. Since then, the score multiplier of mods has been changed on Catch The Beat mod as well.
