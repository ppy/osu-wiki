...
osu! 网站中加入了一些新的功能，例如仅限 [osu!supporter](/wiki/osu!supporter)可用的以游玩状态作为标签的谱面过滤器，图包集，以及标题栏上可见的头像。[^web-update]

## 三月

为了得到更多更加有针对性和实用性的反馈，[预览版发布](https://osu.ppy.sh/community/forums/topics/48054?n=1)向支持者们开放。
...
[osu!monthly](/wiki/Community/osu!monthly) 的第一个版本由 ::{ flag=US }:: [jjrocks](https://osu.ppy.sh/30985) 和 ::{ flag=GB }:: ::Corin::{ user=639270 } 发布。它包含了从用户统计到[谱面评估团队 (BAT)](/wiki/People/Beatmap_Appreciation_Team) 和 [谱面协助团队 (MAT)](/wiki/People/Mapping_Assistance_Team) 的活动等不少内容。[^monthly-1]
...
::LuigiHann::{ user=1079 } 组织了第一场故事板制作大赛。在这场比赛中，选手们被要求为在[第三届官方作图大赛](https://osu.ppy.sh/community/forums/topics/47404?n=1)中冲进决赛圈的三张图制作对应的[故事板](/wiki/Storyboard)。[^storyboarding]
...
已注册用户的数量突破了 1,000,000 名。[^monthly-6]
