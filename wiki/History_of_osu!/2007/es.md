...
![](img/2007-07_01.jpg "Selección de canciones")
...
A finales de julio, el sistema de menú fue cambiado para añadir un poco de estilo al juego. Se completó la implementación inicial del slider, con una bola naranja no animada y algunas curvas relativamente feas. El ajuste de ritmo se agregó al editor, como una línea de tiempo y una interfaz de edición más robusta (muy similar a lo que ves en [compose](/wiki/Client/Beatmap_editor/Compose) actualmente).
