...
Quelques jours après l'incident (17 février), ::Ephemeral::{ user=102335 } a publié un post sur le [blog de peppy](https://blog.ppy.sh) essayant de clarifier le problème avec une série d'événements menant à la situation et ce que le staff d'osu! avait l'intention de faire pour le résoudre. Avec cela, il a été révélé que de nombreux changements étaient faits en ce qui concerne la structure de la BAT, le beatmapping en général, et les processus de classement avec peu ou pas de discussion préalable ou d'approbation explicite de la BAT ou de la QAT.[^meet-ephemeral][^mv2-timeline-doc]
...
**La panel de modding du nouveau site d'osu! (new.ppy.sh) a été mis en ligne afin de permettre des tests publics le 11 avril 2016.** Cependant, ces tests n'étaient disponibles que pour [Ice - L2 - Ascension : Act 2 (Liberation) (LordRaika)](https://osu.ppy.sh/beatmapsets/123760) et [Camellia - overcomplexification (ProfessionalBox)](https://osu.ppy.sh/beatmapsets/351408). Selon ::Loctav::{ user=71366 }, l'idée principale du panel était de diviser les problèmes en posts séparés, puis d'en discuter individuellement pour obtenir un suivi plus facile des problèmes et de s'en servir comme une partie des étapes vers la mise en œuvre du "Modding V2" tant attendu.[^mv2-feedback-thread]
...
**La QAT (Quality Assurance Team) et son implication dans les processus de beatmapping et de modding ont été considérablement modifiées le 25 avril 2016.** Les changements réalisés ont été décrits par ::Loctav::{ user=71366 } dans un post forum à ce moment :
...
| :-- | :-: | :-: | :-- |
| **Vote du staff** | [HDHR](https://soundcloud.com/billiummoto/hdhr) | ::BilliumMoto::{ user=3862471 } | Musique présentée en tant que beatmap officielle de concours, $250 USD à utiliser dans l'osu!store, badge de profil unique |
| **Première place du vote communautaire** | HDHR | BilliumMoto | N/A |
| **Deuxième place du vote communautaire** | [circles! (黒皇帝 Remix)](https://soundcloud.com/dialgadu77/circles-remix) | ::Sayaka-::{ user=398275 } | $50 USD à utiliser dans l'osu!store |
| **Troisième place du vote communautaire** | [circles! (happy30 Remix)](https://soundcloud.com/happy30/circles-happy30-remix) | ::happy30::{ user=27767 } | Mention honorable |
...
| :-- | :-: | :-: | :-- |
| **Première place** | Aiko | ::JMC::{ user=774010 } | Titre utilisateur **osu!artist**, 12 mois d'osu!supporter, $50 USD à utiliser dans l'osu!store |
| **Deuxième place** | Alisa | ::\[ Glitch \]::{ user=3781400 } | 3 mois d'osu!supporter |
| **Troisième place** | Tama | ::crystalsuicine::{ user=9974 } | 1 mois d'osu!supporter |
...
—::shARPII::{ user=776257 }, "GMT Applications Now Open"[^news-gmt-applications]
