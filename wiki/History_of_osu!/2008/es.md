...
El modo [Taiko](/wiki/Game_mode/osu!taiko) vio la luz por primera vez en este mes, así como otra adición importante, la compatibilidad de la secuencia de comandos de storyboard con `.osb`. También se pusieron a disposición sliders de varias partes y mensajes privados en el chat.
