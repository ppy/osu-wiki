...
- Có phải giới hạn khung hình của bạn được để ở `Unlimited` không? Hãy thử chỉnh thành `Optimal` xem nó có giúp đỡ không. Xem [unlimited](#unlimited) để lý giải vì sao `Unlimited` thường không phải là lựa chọn tốt nhất.
