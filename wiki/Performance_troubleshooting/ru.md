...
К сожалению, добиться стабильной работы osu! у всех пользователей достаточно сложно, поскольку оборудование у всех разное. С помощью этой страницы вы можете попробовать самостоятельно выяснить причину проблемы, а также узнать про конкретные понятия и процедуры, которые помогут техподдержке разобраться в вашей ситуации.
...
1. Откройте папку osu!, либо нажав на кнопку `Open osu! folder` в настройках игры, либо найдя её самостоятельно. В Windows osu! по умолчанию установлена в директорию `C:\Users\<yourPCusername>\AppData\Local\osu!`, в MacOS — в `/Applications/osu!.app/Contents/Resources/drive_c/osu!`.
2. Закройте osu!.
3. Откройте файл `osu!.<имя пользователя Windows>.cfg` в блокноте или другом текстовом редакторе.
