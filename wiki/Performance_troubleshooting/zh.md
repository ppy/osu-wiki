...
osu! 会尽最大努力以合理的默认设置运行，并在你正在执行/运行某些会导致游戏性能下降的事情时主动提醒您。

不幸的是，由于运行设备的偏差，osu! 很难确保每个用户可以得到最佳性能。这个页面旨在帮助你自我诊断你遇到的性能问题，同时也能让你学习故障排除所需要的特定术语（以及你可以做的检查）来帮助我们在你寻求帮助时能为你提供帮助。
...
- 检查在游戏设置中打开“Audio compatibility mode”是否有帮助。
...
- 检查它是否仍然在电脑重新启动后立即发生。
- 尝试关闭任何显示游戏内界面的应用程序（Discord，Steam，NVIDIA ShadowPlay等）
- 确保你启动了[游戏模式](https://support.xbox.com/zh-CN/help/games-apps/game-setup-and-play/use-game-mode-gaming-on-pc)<!-- 有没有更好的国内文章能贴啊 -->。它可以让 Windows 为 osu! 提供专用核心和资源。
- 打开任务管理器并按 CPU 排序（在详细信息下）。查找低帧率时 CPU 使用率高的程序，例如由后台病毒或杀毒软件。你可以在使用 Auto 让 osu! 自动播放谱面时，窗口化 osu! 或使用第二块屏幕显示任务管理器来诊断问题。

### 输入延迟

在敲击键盘，移动鼠标或数位板笔与在屏幕上看到相应的操作之间存在明显的延迟。当报告或诊断此问题时，以下方法可能会提供帮助：
...
在使用无限制前请优先使用此设置以减少渲染的帧数，从而降低[垃圾回收](https://zh.wikipedia.org/wiki/%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6_(%E8%A8%88%E7%AE%97%E6%A9%9F%E7%A7%91%E5%AD%B8))所需要的性能（他可能会导致屏幕卡顿）。
...
即便如此，如果发热和潜在的硬件过度工作不被视为问题，无限制设置可能是提供最稳定帧数的选项。
