...
不幸的是吗，由于运行设备的偏差，osu! 很难确保每个用户可以得到最佳性能。这个页面旨在帮助你自我诊断你遇到的性能问题，但也会提供你可以学习的特定术语（以及你可以做的检查）来帮助我们在你寻求帮助时能为你提供帮助。
...
- 打开任务管理器并按 CPU 排序（在详细信息下）。查找低帧率时CPU使用率高的程序，例如由后台病毒或杀毒软件。你可以在使用 Auto 让 osu! 自动播放谱面时，窗口化 osu! 或使用第二块屏幕显示任务管理器来诊断问题。
