...
- การทำผิดกฏอย่างต่อเนื่อง ไม่ว่าจะกี่ครั้งก็ตาม
...
กฏจะไม่มีการเตือน ผู้ที่โกงจะถูกแบนไม่จำกัดระยะเวลาสำหรับการทำผิดครั้งแรก โดยทางทีมอาจจะตัดสินใจปลดแบนออกถ้าผู้เล่นส่งคำร้องอุทธรณ์ (appeal) สำเร็จ
...
วิธีการรายงานนี้ก็ได้ผลเหมือนกับการรายงานผ่านหน้าโปรไฟล์ โดยการรายงานทั้งหมดจะไปอยู่ท่ี่จุดเดียวกัน
...
รอ 3 เดือนหลังจากการแบนครั้งสุดท้ายก่อนที่จะอุทธรณ์ โดยส่งอีเมล์ของคุณมาที่ [accounts@ppy.sh](mailto:accounts@ppy.sh) ใช้ชื่อหัวข้อของอีเมล์ว่า `Restriction Appeal: <username>`
...
อ่าน [Rules](/wiki/Rules) อย่างระมัดระวังและปฏิบัติตาม
