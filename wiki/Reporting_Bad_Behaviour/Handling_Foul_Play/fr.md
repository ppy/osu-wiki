...
Comme écrit dans [le règlement](/wiki/Rules), toute forme de modifications apportées au client osu!, le hack de score, l'utilisation de macros et la visée automatique des éléments sont considérés comme du cheat.
...
osu! utilise un système de détection automatique de triche combiné à des confirmations manuelles.
...
Il peut être difficile de le dire, mais vous devez croire et accepter la décision du staff. Le staff ne peut pas croire en la parole d'un joueur, il sait pertinemment que personne n'est digne de confiance à ce sujet.
...
Restez calme. **N'en parlez pas dans le chat public.** Ne donnez ces informations à aucune personne d'autre que le staff.
