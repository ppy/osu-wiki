# Traitement d'un acte criminel

## Pourquoi suis-je restreint ?

Un utilisateur peut être restreint s'il fait l'une des choses suivantes :

- Un mauvais comportement continu, quel que soit le nombre d'infractions qu'ils accumulent.
- Contournement d'une sanction en créant un nouveau compte.
- Partage de compte avec d'autres utilisateurs.
- Le multi-compte
- Piratage ou tricherie (voir ci-dessous).
...
## Qu'est-ce qui est considéré comme une tricherie ?

Les [règles](/wiki/Rules) stipulent que toute forme de manipulation du client, comme le piratage du score, les séquences de combo complètes activées par macro, la visée automatique et tout ce qui joue le jeu pour le joueur est considéré comme de la triche.

Il s'agit d'une règle à un coup. Dès leur première infraction, les tricheurs seront soumis à des restrictions pour une durée indéterminée. L'[Équipe de support](/wiki/People/The_Team/Account_support_team) peut décider de lever la restriction si l'appel est accepté.
...
## Prouvez que je/ils ont triché ! Dis-nous comment vous le savez !

L'équipe de support ne fournira aucune "preuve" concernant les restrictions, mais toutes sont placées avec une suspicion bien fondée. Il est extrêmement improbable que les utilisateurs normaux soient visés par de telles actions.

## Je vais faire une vidéo pour prouver mon innocence !

Désolé, mais si vous avez été restreint, l'équipe de support est déjà sûre que vous trichez. Une vidéo ne sera d'aucune utilité, car même celle-ci peut être falsifiée.
...
**Il s'agit de la méthode préférée pour signaler les suspicions de fraude, car elle fournit le plus d'informations aux membres de l'équipe de support.**

Sur le profil de l'utilisateur, un bouton `Signaler` apparaît lorsque vous cliquez sur les trois points à côté du bouton `Message`. Inscrivez toutes les informations qui peuvent prouver que l'utilisateur se comporte mal.
...
Dans les pages des beatmaps, vous pouvez signaler un utilisateur dans les classements supérieurs en cliquant sur le bouton `Signaler` à l'extrême droite de son score.
...
L'équipe de support attend des utilisateurs qu'ils fournissent un historique complet de leurs actions et qu'ils donnent les raisons pour lesquelles ils ne récidiveront pas à l'avenir.
