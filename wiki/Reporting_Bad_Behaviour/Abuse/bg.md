...
Докладвайте коментара на член от [Глобален Модераторски Екип](/wiki/People/The_Team/Global_Moderation_Team) възможно най-скоро.

За да направите това, кликнете върху име на член от ГМЕ в списъка от горната връзка. Това ще ви изпрати към профилната им страница. Ако не сте сигурни кого да изберете, просто използвайте [тази връзка](https://osu.ppy.sh/users/102335).

Кликнете върху бутона с пощенски плик точно под флага на държавата. Ще бъдете изпратени към чат екрана.

Поставете връзка към коментара с проблемно съдържание от форум и разкажете на ГМЕ за какво става на въпрос. Те ще премахнат коментара веднага щом могат.
...
## Член на един от доброволческите екипи (ЕОН, ГМЕ) се държи/говори/действа неприлично срещу мен!
...
## Потребител когото познавам е тормозен от член на доброволческите екипи (ЕОН, ГМЕ), но е прекалено уплашен за да говори!
