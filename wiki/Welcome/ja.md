...
_メインページ: [Beatmapping](/wiki/Beatmapping)._

ビートマッピングは、作者がビートマップを作る過程のことをいいます。この過程には、次の作業が含まれます: 曲選び、タイミングを合わせること、ビートマップを作ること。そして、ビートマップのテストプレイをすること。また、これらの作業が更に含まれることもあります: 動画を追加すること、[ストーリーボード](/wiki/storyboarding) を追加すること、[カスタムスキン](/wiki/skinning#getting-started) を追加すること。これら全ては作者1人だけで行ったり、他のプレイヤーと共同ですることもあります。また、_ストーリーボーダー_、_スキナー_や_ゲストクリエイター_といった人々に任せることもあります。これは彼らが何をするかに依存します。

## モッディング

_メインページ: [モッディング](/wiki/Modding)._

モッディングは、ユーザー（一般的に「モッダー」と呼ばれます）が、ペンディング（または進行中/ヘルプ）の段階にあるビートマップを審査する過程のことをいいます。モッディングのためのプレイは、ビートマップの質の保持ということにおいて大きな役割を担います。なぜなら、これは作者が自身のビートマップにおける問題を修正できるようにするからです。

## スキニング

_メインページ: [スキニング](/wiki/Skinning)._

_こちらもご覧ください: [スキンの作り方](/wiki/Skinning_Tutorial)._
