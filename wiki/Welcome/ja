...
- [マルチプレイ](/wiki/Multi/#getting-started)
...
*メインページ: [Beatmapping](/wiki/Beatmapping/#getting-started).*

ビートマッピングは、作者が譜面を作る過程のことをいいます。この過程には、次の作業が含まれます: 曲選び、タイミングを合わせること、譜面を作ること。そして、譜面のテストプレイをすること。また、これらの作業が更に含まれることもあります: 動画を追加すること、[ストーリーボード](/wiki/storyboarding/#getting-started) を追加すること、[カスタムスキン](/wiki/skinning/#getting-started) を追加すること。これら全ては作者1人だけで行ったり、他のプレイヤーと共同ですることもあります。また、*ストーリーボーダー*、*スキナー*や*ゲストクリエイター*といった人々に任せることもあります。これは彼らが何をするかに依存します。

## モッディング

*メインページ: [モッディング](/wiki/Modding/#getting-started).*

モッディングは、ユーザー（一般的に「モッダー」と呼ばれます）が、ペンディング（または進行中/ヘルプ）の段階にある譜面を審査する過程のことをいいます。モッディングのためのプレイは、譜面の質の保持ということにおいて大きな役割を担います。なぜなら、これは作者が自身の譜面における問題を修正できるようにするからです。

## スキニング

*メインページ: [スキニング](/wiki/Skinning).*

*こちらもご覧ください: [スキンの作り方](/wiki/Skinning_Tutorial).*

スキニングは、誰でもosu!の見え方を変えられるようにします。これはカーソルを変えるような小さなことから、すべてのゲームモードとインターフェースの外観をガラリと変えてしまうような大きなものまであります。
