...
_Hlavná stránka: [Beatmapovanie](/wiki/Beatmapping)_

Beatmapovanie je proces vytvárania beatmapy. Tento proces obnáša: výber hudby, časovanie a mapovanie beatmapy. Môže tiež obnášať: vytvorenie [storyboardu](/wiki/Storyboarding) a/alebo pridanie [vlastného skinu](/wiki/Skinning). Všetky tieto veci môže robiť jedna alebo viac osôb - môžu sa nazývať _storyboarderi_, _skineri_... čož závisí od toho, čo robia

## Modding

_Hlavná stránka: [Modding](/wiki/Modding)_

Modding je proces keď sa ostatní hráči pozrú na beatmapu (ktorá je v štádiu čakania na nominácie alebo stále v stave mapovania) a poskytnú spätnú väzbu. Modding má dôležitú rolu v kontrole kvality beatmapy, pretože tvorca/-ovia beatmapy môžu opraviť prípadné chyby s ňou.

## Skinovanie

_Hlavná stránka: [Skinovanie](/wiki/Skinning)_

_Pozri tiež: [Návod ku skinovaniu](/wiki/Skinning_Tutorial)_

Skinovanie dovoľuje komukoľvek zmeniť vzhľad osu!. Skinovanie sa môže pohybovať od jednoduchého zmenenia kurzoru, až po celkové zmenenie vzhľadu všetkých módov hrania a uživateľského prostredia.

## osu! wiki - Ako môžeš pomôcť!
