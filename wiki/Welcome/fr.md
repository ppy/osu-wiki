...
<!-- shared image -->
[.osz icon link]: /wiki/shared/osz_icon_full.png "Fichier .osz, un fichier de beatmap propre"
...
Une fois sur la page de la beatmap, il devrait y avoir un grand bouton "Doawnload Beatmap" (vous devez d'abord être connecté, sinon un bouton jaune vous dirigera vers la page de connexion).
...
Les succès (Achievements) sont de petits badges sur votre profil qui indiquent que quelqu'un a accomplit un but exceptionnel! Les badges de succès peuvent être débloqués de plusieurs manières comme en jouant beaucoup ou en atteignant un certain combo sur une seule map. Quand vous remplissez le critère, vous recevrez le badge dans "Online Results" et votre onglet de succès personnel. Cependant, le meilleur d'entre eux est la mission cachée, Hush-Hush, où le critère n'est pas connu et il en revient à vous de deviner comment l'avoir. Ils sont plutôt compliqués à avoir mais c'est satisfaisant quand vous réussissez à en obtenir un de vous-même.
...
Voilà les bases, ne soyez pas timides et demandez de l'aide en jeu ou sur les forums, aussi le osu!wiki est ici pour vous aider à mieux appréhender le jeu.
