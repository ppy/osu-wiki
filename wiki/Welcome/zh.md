...
作图是艺术家们创造一张谱面的必经之路。通常包含以下步骤：选歌、调整节拍、放置游戏元素、测试。可选项：添加视频，添加[故事板](/wiki/Storyboarding) ， 添加[自定义皮肤](/wiki/Skinning) 。这些步骤可以由谱面作者独自完成，也可以与他人合作完成，由此衍生出了 *故事板作者（storyboarders）* 、 *皮肤制作者（skinners）* 和 *客串作者（guest creators）* 等职业，取决于他们在作图中扮演的角色。

## 改图

*参考：[改图](/wiki/Modding)。*

改图指玩家们复查（Review）处于 Pending 或者 WIP/help 状态的谱面。这些玩家在控制谱面质量方面扮演了很重要的角色，因为谱面作者可以根据玩家们的意见解决谱面中的问题。
...
从 2016 年 8 月 26 日起， osu! wiki 迁移至 Github 仓库，因此我们的工作流也更新了。所有的贡献都在 [osu-wiki 的 Github 仓库](https://github.com/ppy/osu-wiki) 内进行，任何的改动都必须被复查并得到赞同（Approved）才能被写入 osu!wiki。
