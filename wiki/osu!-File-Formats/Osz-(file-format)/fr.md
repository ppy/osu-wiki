...
-   Des fichiers [.osu](FR:Osu_(file_format) "wikilink"), contenant les données de chaque difficultés: les notes, le BPM, la vélocité du slider, etc.
-   Un fichier [.osb](FR:Osb_(file_format) "wikilink"), utilisé pour le "[Design](FR:Design "wikilink")", il contient les données du "storyboard", comme leur déplacement, ou leur fondu.
-   Des fichiers divers pour le fichier [.osb](FR:Osb_(file_format) "wikilink"), comme des fichiers images, souvent placés dans un dossier tiers.
-   Des fichiers son (en .wav) pour asservir la map de [Hitsounds](FR:Hitsounds "wikilink"), placés à la racine, ceux-ci peuvent se faire contrôler, ainsi, le mappeur peux choisir quel flux de "Custom Hitsounds" choisir (pour en savoir plus, il est recommandé de voir la page [Skinning](FR:Skinning "wikilink"))
