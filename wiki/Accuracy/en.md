...
[beatmap wikilik]: /wiki/Beatmaps "Beatmaps"
...
- per [beatmap][beatmap wikilik]'s accuracy,
- one's overall accuracy, and
- [Performance Points (pp)][pp wikilink]'s accuracy.

In simple terms,

- the beatmap's accuracy is dependent on [Hit-scores][Score] gained,
...
This shows the grade, an overview of the hits, as well as the actual accuracy percentage.
...
| Term | Meaning |
| ---- | ------- |
| Error | **These two values represent how far off the early hits are on average, and how far off the late hits are on average.** The higher the [OD value](/wiki/Beatmap_Editor/Song_Setup) of the beatmap played, the lower these will have to be to do well. |
