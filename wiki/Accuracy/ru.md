...
-   [Параметр OD](/wiki/Song-Setup/ru.md) сыгранной карты;
-   Активированные моды [Easy](/wiki/Difficulties/Standard/Easy/ru.md) или [Hardrock](/wiki/Game-Modifiers/ru,md).
...
-   [PP](/wiki/Performance-Points/en.md)-точность. Она считается почти так же, как общая, но в расчётах участвует ещё и количество PP, полученное за каждую карту: чем больше PP у результата, тем сильней он влияет на точность. Таким образом, как и при расчёте игрового ранка, на PP-точность влияют только 100 лучших рекордов; всё, что находится ниже, имеет вес, близкий к нулю.
...
-   В связи с тем, как реализована работа игровых модов, погрешность и разброс умножаются на скорость песни. Таким образом, для реплеев с [Double Time](RU:Double_Time) результаты нужно разделить на 3/2. Аналогично, при игре с [Hardrock](RU:Hardrock) их нужно умножить на 4/3.
