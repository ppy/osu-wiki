...
Di osu!standard, akurasi dikalkulasi dengan menimbang penilaian yang diperoleh dari setiap hit obyek berdasarkan nilainya dan dibagi dengan jumlah maksimum yang mungkin.
...
Di osu!catch, akurasi dikalkulasi dengan mengambil jumlah hit obyek tanpa spinner terambil dibagi dengan jumlah hit obyek tanpa spinner. Semua hit obyek mempunyai nilai sama, kecuali pisang, karena mereka merupakan bagian dari putaran.
...
Grafik performa adalah sebuah grafik yang menampilkan performa pemain (berdasarkan bar kehidupan) selama bermain (waktu). Informasi tambahan dapat ditampilkan dengan menunjuk cursor dalam-game di atasnya.
...
Sebab cara mod [DT](/wiki/DT) (Double Time) dan [HT](/wiki/HT) (Half Time) diimplementasikan, nilai kesalahan dan laju tidak stabil akan dikalikan dengan faktor yang sama dengan lagu. Untuk mendapat nilai asli saat bermain DT, bagi hasil dengan 1.5. Sama halnya, kalikan hasil dengan 1.33 saat bermain HT.
...
Laju tidak stabil mewakili konsistensi penepatan dalam hit, dimana semakin kecil semakin baik (pemain atas sering mendapat skor dibawah 100). Catat bahwa nilai ini mengukur konsistensi, bukan akurasi, jadi konsisten dalam mengenai 15ms lebih dahulu itu sama dengan konsisten mengenai "tepat waktu." Formula dasarnya adalah standar penyimpangan dari kesalahan hit (dalam milisekon) dikalikan dengan 10.

### Putaran

*Catatan: Putaran hanya digunakan dalam [osu!standard](/wiki/osu!standard).*

Sebagai tambahan akurasi, beberapa informasi mengenai pemutar juga terdapat di tooltip yang sama.

#### Kecepatan

Kecepatan mewakili rata-rata RPM (putaran per menit) di semua pemutar dalam beatmap. Maks adalah RPM tertinggi yang dicapai dalam putaran beatmap manapun.

#### Laju tidak stabil

Laju tidak stabil mewakili rata-rata terharap Penyimpangan maksimum, dimana semakin kecil semakin baik. Formula tidak diketahui.
