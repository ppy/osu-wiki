...
- [Баги в osu!(stable)](https://github.com/ppy/osu-stable-issues)
...
Помните, что новые перенаправления должны быть а) краткими и б) пригодными к быстрому использованию.
...
Если вам нужна помощь в расшифровке автоматически найденных ошибок, обращайтесь на канал `#osu-wiki`.
