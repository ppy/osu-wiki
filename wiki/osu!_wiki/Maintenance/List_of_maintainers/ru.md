...
Если вам нужна помощь в внесение вклада в вики или проверки вашего pull request'a, отправьте сообщение в `#osu-wiki` канал на [osu!dev Дискорд сервере](/wiki/Community/osu!dev_Discord_server) и администратор или другой участник ответят вам (все администраторы знают английский).

## Администраторы вики

<!-- internal reference: https://github.com/orgs/ppy/teams/wiki/members -->

| osu! профиль | GitHub профиль | Статус | Дополнительный языки |
| :-- | :-- | :-- | :-- |
...
| ::{ flag=SE }:: [Walavouchey](https://osu.ppy.sh/users/5773079) | [Walavouchey](https://github.com/Walavouchey) | Неактивен | Финский, Шведский |
| ::{ flag=CL }:: [WalterToro](https://osu.ppy.sh/users/5281416) | [WalterToro](https://github.com/WalterToro) | Неактивен | Испанский |

## Администраторы новостей

Кураторы, редакторы и ответственные за все [новостные сообщения](https://osu.ppy.sh/home/news), появляющиеся на сайте.
Curators, editors, and approvers of all [news posts](https://osu.ppy.sh/home/news) that appear on the website.

| osu! профиль | GitHub профиль |
| :-- | :-- |
