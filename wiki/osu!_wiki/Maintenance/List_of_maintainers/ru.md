...
Администраторы следят за [трекером задач](https://github.com/ppy/osu-wiki/issues) osu! wiki, а также проверяют пулл-реквесты от всех желающих. В отличие от остальных пользователей, администраторы могут редактировать чужие пулл-реквесты и вливать их в ветку `master`, чтобы изменения были всем видны.
