...
- **Use mensajes de confirmación breves y significativos**, ya que permiten que los demás sepan lo que hay en el cuadro. Algo como `Reescribir la sección sobre patrones de salto` dice mucho más que `Actualizar es.md`.
