...
5. При внесенні правок слідуйте [критеріям оформлення статей](/wiki/Article_styling_criteria), наскільки це можливо.

6. [Зробіть комміт](#комміт), щоб зберегти зміни.

### Переміщення файлів

*Увага: через веб інтерфейс GitHub **не рекомендується** переносити декілька файлів, бо на кожне переміщення буде створений окремий комміт. Це, в свою чергу, робить історію змін [менш зрозумілою і наочною](/wiki/osu!_wiki/Contribution_guide/Best_practices#making-edits).*
...
*Увага: через веб-інтерфейс GitHub **не рекомендується** видаляти декілька файлів, тому що на кожне видалення буде створений окремий комміт. Це, в свою чергу, робить історію змін [менш зрозумілою і наглядною](/wiki/osu!_wiki/Contribution_guide/Best_practices#making-edits).*
