...
*For the generalized contribution process, see [GitHub flow - GitHub Docs](https://docs.github.com/en/get-started/quickstart/github-flow)*
...
2. Click the `Contribute↓` link and press the `Open pull request` button.
