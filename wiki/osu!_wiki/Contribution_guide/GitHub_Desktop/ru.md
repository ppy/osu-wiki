...
- При включении изменений в основной репозиторий, а также при обновлении вашей ветки, вы будете намного реже сталкиваться с [конфликтами](/wiki/osu!_wiki/Contribution_guide/Common_Issues#конфликты-в-пулл-реквесте).
