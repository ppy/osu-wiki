...
::: alert-notice
**Внимание**
если вы создаёте файлы через Проводник Windows, включите [отображение расширений файлов](http://setupwindows.ru/windows/kak-otobrazit-rasshirenie-fajlov#windows10).
:::
