...
- Чтобы добавить новый **перевод** имеющейся статьи, кликните правой клавишей по её папке и создайте новый файл с именем, состоящим из [одного из языковых кодов](/wiki/Article_styling_criteria/Formatting#locales) и расширения `.md`.
