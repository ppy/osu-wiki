...
Усі обговорення, які охоплюють вікі загалом, її розвиток та зміну статей, відбуваються на каналі `#osu-wiki` офіційного [osu!dev Discord серверу](/wiki/Community/osu!dev_Discord_server). Щоб дізнатися, як можна допомогти osu! вікі, перегляньте наступні статті:
