...
Некоторые статьи доступны на других языках. Перевод статей осуществляется самими членами сообщества, исходя из [списка поддерживаемых сайтом языков](/wiki/Article_styling_criteria/Formatting#локали).
