...
(Client, site web) Vérifier si au moins une difficulté de [DJ Fresh - Gold Dust](https://osu.ppy.sh/beatmapsets/28107) par ::{ flag=FR }:: ::galvenize::{ user=381444 } est téléchargée :

```
28107
```

(Site web) Trouver les beatmaps classées entre août et octobre 2010 qui contiennent au moins une seule difficulté faite par ::{ flag=GB }:: ::Natteke::{ user=157177 } :
