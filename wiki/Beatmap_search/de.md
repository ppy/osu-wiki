...
(Client, Webseite) Prüfe, ob mindestens ein Level von ::{ flag=FR }:: ::galvenize::{ user=381444 } aus [DJ Fresh - Gold Dust](https://osu.ppy.sh/beatmapsets/28107) heruntergeladen wurde:

```
28107
```

(Webseite) Finde Beatmaps, die zwischen August und Oktober 2010 gerankt wurden und mindestens ein von ::{ flag=GB }:: ::Natteke::{ user=157177 } erstelltes Level enthalten:
