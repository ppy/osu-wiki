...
A **time signature** is a musical term defining the number of [beats](/wiki/Beat) in a single [measure](/wiki/Music_theory/Measure) of the song (the top number), and which note indicates a single beat (the bottom number). For for a time signature of 4/4 (a.k.a. "common time"), this means that 4 1/4 notes (*crochets* or *quarter notes*) fit in one measure, while a time signature of 3/4 (a.k.a. "waltz" or "three-four-time") means that 3 1/4 notes fit in one measure.
