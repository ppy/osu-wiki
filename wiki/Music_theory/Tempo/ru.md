...
BPM и оффсет используются при настройке [тайминг-секций](/wiki/Beatmapping/Timing_section), которые при создании [карт](/wiki/Beatmap) служат для [точной расстановки](/wiki/Beatmapping/Snapping) [игровых объектов](/wiki/Gameplay/Hit_object). Это необходимо, чтобы ноты и прочие объекты попадали в ритм музыки.
