...
Una obvia excepción es en los streams largos donde un slider inverso es usado para reemplazar 4 circulos. Esto es probablemente mejor que usar sliders inversos de una repetición.
...
- El ritmo es muy dificil para ser divertido o casual de jugar.
...
- La canción está en un compás de tiempo swing, pero el mapeador odia el 1/6.
...
Si realmente quieres hacer overmapping debido a dificultad/diversión (la excusa más común), asegúrate de que no haya alguna otra forma de mapear las notas correctamente (como usando un slider inverso). Mapear un roll de 1/6 de división de tiempo con un slider inverso de 1/4 o 1/8 es simplemente incorrecto. Todos se juegan de manera idéntica, y la única diferencia es cómo suena y el impacto en la puntuación.
