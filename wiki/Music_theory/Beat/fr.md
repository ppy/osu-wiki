...
Un **beat** est un événement répétitif ou une unité de temps en musique, qui crée le rythme auquel une personne tape ou hoche la tête en écoutant.
...
Les autres notes sont exprimées par un temps en divisant ou en multipliant sa longueur. Le [beat snap divisor](/wiki/Client/Beatmap_editor/Beat_Snap_Divisor) de l'éditeur de beatmap le fait automatiquement pour un mappeur, ce qui permet de modifier la granularité temporelle à la volée.
