...
**Compose** is the place where a [mapper](mapper "wikilink") spent most of the time mapping out his/her design with respect to timeline after setting the BPM and Timing Sections. This is also the place where players can practice a ranked difficulty and inspect its design akin to DDR's Training mode.
...
For a newbie guide: [Beatmapping](Beatmapping "wikilink").
