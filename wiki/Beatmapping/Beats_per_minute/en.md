...
[Timing points](/wiki/Glossary#timing-section) use a BPM and offset to allow snapping [hit objects](/wiki/Hit_Objects) to the timeline when creating [beatmaps](/wiki/Beatmaps). Timeline snapping ensures gameplay aligns with the beat.
