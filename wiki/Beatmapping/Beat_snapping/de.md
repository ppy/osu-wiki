...
Das Rasterkonzept basiert auf den einheitlichen Grundsätzen der [Quantisierung](https://de.wikipedia.org/wiki/Quantisierung_(Musikbearbeitung)) und der Musikstruktur. Demnach haben Noten in den meisten Songs vorhersehbare Positionen, die auf den Längen der Teile eines [einzelnen Beats](/wiki/Music_theory/Beat) basieren. Durch eine geeignete Beateinteilung, die innerhalb eines Songs variieren kann, richten Mapper Hit-Objekte anhand der Noten eines Musikstücks aus.
