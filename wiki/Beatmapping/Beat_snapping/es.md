...
El **anclaje al ritmo** (a menudo simplemente *snapping*) se refiere a la posición de un [objeto](/wiki/Gameplay/Hit_object) en la [línea de tiempo de los objetos](/wiki/Client/Beatmap_editor/Timelines#hit-objects) en el [editor de beatmaps](/wiki/Client/Beatmap_editor). Cambiar el [divisor del anclaje al ritmo](/wiki/Client/Beatmap_editor/Beat_snap_divisor) permite que los objetos se adjunten a diferentes marcas cuando se mueven en la línea de tiempo.
