...
Le **star rating** (***SR***) décrit la difficulté d'une [beatmap](/wiki/Beatmap), qui est automatiquement calculée par le client d'osu!. Le star rating joue un rôle important dans l'attribution des [points de performance](/wiki/Performance_points). Ce nombre peut être vu sur l'[écran de sélection des musiques](/wiki/Client/Interface#écran-de-selection-des-beatmaps) et sur la page d'information d'une beatmap.
