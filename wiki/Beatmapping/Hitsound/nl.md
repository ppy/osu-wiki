...
tags:
  ...
  - hit-geluid
  - hitsound toevoeging
  - hitsound toevoegingen
  - hit sound toevoeging
  - hit sound toevoegingen
---

# Hitsound

*Zie ook: [Het toevoegen van aangepaste hitsounds](/wiki/Guides/Using_custom_hitsounds)*

**Hitsounds** (hit-geluiden) zijn de geluiden die osu! afspeelt als reactie op interactie bij [hitobjecten](/wiki/Gameplay/Hit_object). Hitsounds worden meestal gebruikt om auditieve feedback te geven aan de speler om hen te helpen hun [nauwkeurigheid](/wiki/Gameplay/Accuracy) te beoordelen ten opzichte van het lied.
...
Beatmappers kunnen standaard geluidssamples vervangen door aangepaste samples met behulp van de [beatmap](/wiki/Beatmap)folder. De [skin](/wiki/Skinning) van een speler kan ook standaard hitsounds vervangen op alle beatmaps. Details over hitsound samples zijn te vinden in het artikel over [hitsound skinning](/wiki/Skinning/Sounds#hitsounds).

[Spinners](/wiki/Gameplay/Hit_object/Spinner) en [sliders](/wiki/Gameplay/Hit_object/Slider) hebben extra spinner spin, spinner bonus, slider slide en slider tick hitsounds.
...
In tegenstelling tot de andere [spelmodi](/wiki/Game_mode), beïnvloeden hitsounds in [osu!taiko](/wiki/Game_mode/osu!taiko) rechtstreeks de gameplay van hun maps. Kats worden onderscheiden van Dons met whistles en claps, en grote noten worden onderscheiden van normale noten met finishers.
