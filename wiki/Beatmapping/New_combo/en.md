...
In [osu!standard](/wiki/Game_Modes/osu!), each [hit object](/wiki/Hit_object) has its own combo number and combo colour. When a new combo is started, the combo colour changes and the combo number resets to one. This counts up for each following object.

*Note: Spinners force the next hit object to start a new combo.*

## osu!catch

In [osu!catch](/wiki/Game_Modes/osu!catch), each type of fruit is coloured by the currently selected combo colour. When a new combo is started, the combo colour changes. Unlike osu!standard, fruits do not have a combo number.

## Other game modes

[osu!taiko](/wiki/Game_Modes/osu!taiko) and [osu!mania](/wiki/Game_Modes/osu!mania) do not use new combos.
