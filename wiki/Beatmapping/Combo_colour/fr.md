...
Dans le mode [osu!](/wiki/Game_mode/osu!), tous les [combosets](/wiki/Beatmapping/Combo) ont une couleur. Un nouveau combo est lancé lorsque la couleur de l'[objet](/wiki/Gameplay/Hit_object) change. Les couleurs se répètent en fonction du nombre de combos définis par le mappeur (ou par le fichier [skin.ini](/wiki/Skinning/skin.ini) du skin du joueur).
