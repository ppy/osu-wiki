...
In [osu!](/wiki/Game_mode/osu!) hebben alle [combosets](/wiki/Beatmapping/Combo) een kleur. Een nieuwe combo wordt gestart wanneer de kleur van het [hitobject](/wiki/Hit_object) verandert. De kleuren zullen zich blijven herhalen, afhankelijk van hoeveel de mapper er heeft gedefinieerd (of hoeveel jouw skin's [skin.ini](/wiki/Skinning/skin.ini) bestand definieert).
