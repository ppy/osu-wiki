...
**Мапінг**(також бітмапінг) це процес створювання [бітмап](/wiki/Beatmap) в osu! для проходження гравцями.
...
Зазвичай маппери намагаються отримати [рейтинговий](/wiki/Beatmap) статус на своїй бітмапі, який отримується за допомогою [процедури рейтингу бітмапи](/wiki/Beatmap_ranking_procedure).

Через те що osu! є ритм грою, пісня яку ви вибираєте для мапінгу повинна мати очевидний та постійний ритм.
Намагайтесь уникати пісень які мають зміни ритму (або швидкості) і також повільних пісень до того моменту поки ви не станете більш досвідченими в мапінгу.
...
Згодом відкриється сторінка редактора з вашим аудіо файлом.
Ваша нова пісня буде доступна знизу в списку з піснями, позначена фіолетовим кольором.
Якщо вона не зазначена в виборі пісень за  будь-яких причин, натисніть `F5` щоб скинути кеш бітмап і згодом вона з'явиться.
...
При розробці нової [бітмапи](/wiki/Beatmap) ви завжди будете бачити це вікно перед будь-якими іншими частинами редактора.
...
*Головна сторінка: [Дизайн](/wiki/Client/Beatmap_editor/Design) and [Storyboarding](/wiki/Storyboard#storyboarding)*

В редакторі вкладка дизайн є місцем де до вашої бітмапи ви можете встановити картинку фону, додати відео і/або зробити звичайний сторіборд.
В залежності від того що ви робите, ви можете використовувати вкладку дизайн як часто (якщо ви займаєтесь [SBS](/wiki/Storyboard/Scripting)(сторіборд скріптинг)) так і взагалі не використовувати.
