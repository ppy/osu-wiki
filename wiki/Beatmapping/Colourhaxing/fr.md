...
La **mise en couleur** désigne les créateurs qui définissent des couleurs spécifiques à utiliser pour les nouveaux combos, au lieu de faire défiler les couleurs disponibles dans l'ordre. Cela permet un contrôle total sur les couleurs des combos et peut être utilisé pour faire ressortir différentes sections d'une [beatmap](/wiki/Beatmap).
