...
**Colourhaxing** refers to creators setting specific colours to be used for new combos, instead of cycling through the available colours in order. This allows for full control over combo colours and can be used to make different sections of a [beatmap](/wiki/Beatmap) stand out.
