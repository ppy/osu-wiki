...
**HP drain rate** (***HP***) is a [beatmap](/wiki/Beatmap) difficulty setting that controls how much [health](/wiki/Beatmapping/Health) is passively lost to [health drain](/wiki/Beatmapping/Health_drain). It also affects how heavily a player is penalised for missing notes and how much health is gained back by accurately hitting [hit objects](/wiki/Hit_object).
