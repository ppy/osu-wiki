...
**Health**, or more commonly known as *HP*, is the value that determines if a player has failed or passed a [beatmap](/wiki/Beatmaps). Health can be seen in the health bar which updates as gameplay progresses. Health is largely determined by the [HP](/wiki/Beatmapping/Health_drain) difficulty setting, which is set by the beatmap creator.
...
In osu!standard health will decrease at a steady rate called [health drain](/wiki/Beatmapping/Health_drain), but can be replenished by catching fruits and drops.
