...
*다른 의미를 찾으시려면, [콤보 (동음이의어)](/wiki/Disambiguation/Combo)문서를 첨조하세요.*
...
[osu!catch](/wiki/Game_mode/osu!catch) 게임 모드에서는, 각 [과일](/wiki/Gameplay/Hit_object/Fruit)의 종류가 주어진 순서대로 색상이 지정됩니다. [쥬스 스트림](/wiki/Gameplay/Hit_object/Juice_stream)과 슬라이더의 끝에 위치한 과일은 언제나 처음 과일과 동일한 과일 색상을 가집니다만, [바나나](/wiki/Gameplay/Hit_object/Banana)는 항상 노란색으로 고정됩니다. 콤보가 완료된다면, 받는 사람의 접시에 쌓인 과일들은 바깥으로 터지듯 내보내집니다.
