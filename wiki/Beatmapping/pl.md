...
**Mapowanie** to proces tworzenia [beatmapy](/wiki/Beatmap) w osu!. Składa się na niego wybór utworu, ustawienie [timingu](/wiki/Client/Beatmap_editor/Timing), umieszczenie obiektów oraz (opcjonalnie) tworzenie skórki i/lub storyboard'u.
...
Kliknięcie dowolnego z powyższych linków wyświetli zestaw porad używanych przez twórców beatmap do tworzenia interesujących [map](/wiki/Beatmap) odpowiednich dla danego [poziomu trudności](/wiki/Beatmap/Difficulty).
