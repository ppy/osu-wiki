**매핑(Beatmapping)** 은 [비트맵을](KO:Beatmap "wikilink") 만드는 과정이다.

곡 선택, [타이밍](KO:Timing "wikilink"), 오브젝트 배치, 그리고 선택적으로 [스킨과](KO:Skinning "wikilink") [스토리보드의](KO:Storyboarding "wikilink") 제작 과정이 이에 포함된다.

이 문서에서는 매핑의 기초적인 것만을 다루기로 한다. (자세한 것은 [매핑 용어 일람](매핑_용어_일람 "wikilink") 문서를 참고)

가장 흔히 매핑에서 만들어지는 난이도는 다음과 같다

-   [이지](KO:Easy "wikilink")
-   [노멀](KO:Normal "wikilink")
-   [하드](KO:Hard "wikilink")
-   [인세인](KO:Insane "wikilink")

매퍼들이 커스텀 난이도명을 대신 넣는것도 보기 드문일이 아니다.

덧붙여서 [게스트 난이도도](KO:Guest_Difficulties "wikilink") 있으며, 보통 그 매퍼의 난이도라고 표기된다.(Larto's Insane등)
