...
The term "Etna sliders" were coined by ::awp::{ user-id=2650 } and named after a [character from Disgaea](https://disgaea.fandom.com/wiki/Etna) who appeared in one of his maps.

[This post was how it all began.](https://osu.ppy.sh/community/forums/posts/5783)

### Introverted Flow

Nominator: ::Lizzy::{ user-id=1394757 }
...
Nominator: ::rust45::{ user-id=117369 }
...
Nominator: ::MegaManEXE::{ user-id=951 }
...
Nominator: ::Mashley::{ user-id=41481 }
...
Nominator: ::Rukario::{ user-id=110372 }
...
This technique is named after by ::Krisom::{ user-id=99269 }.
...
Nominator: ::RandomJibberish::{ user-id=157879 }
...
Nominator: ::GladiOol::{ user-id=23326 }
...
Nominator: ::FishHook::{ user-id=167586 }
