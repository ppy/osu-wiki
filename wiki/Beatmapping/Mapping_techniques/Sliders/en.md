...
Nominator: ::kingcobra52::{ user=9934 }
...
The term "Etna sliders" were coined by ::awp::{ user=2650 } and named after a [character from Disgaea](https://disgaea.fandom.com/wiki/Etna) who appeared in one of his maps.

[This post was how it all began.](https://osu.ppy.sh/community/forums/posts/5783)

### Introverted Flow

Nominator: ::Lizzy::{ user=1394757 }
...
This technique is named after by ::Krisom::{ user=99269 }.
...
Nominator: ::RandomJibberish::{ user=157879 }
...
Nominator: ::FishHook::{ user=167586 }
