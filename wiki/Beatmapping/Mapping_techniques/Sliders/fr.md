...
Le terme "Etna sliders" a été inventé par ::awp::{ user=2650 } et nommé d'après un [personnage de Disgaea](https://disgaea.fandom.com/wiki/Etna) apparaissant sur l'une de ses beatmaps.

[C'est par ce post que tout a commencé.](https://osu.ppy.sh/community/forums/posts/5783)

### Introverted Flow

Nominateur : ::Lizzy::{ user=1394757 }
...
Nominateur : ::MegaManEXE::{ user=951 }
...
Nominateur : ::Rukario::{ user=110372 }
...
Cette technique a été baptisée par ::Krisom::{ user=99269 }.
...
Nominateur : ::RandomJibberish::{ user=157879 }
...
Nominateur : ::GladiOol::{ user=23326 }
...
Nominateur : ::FishHook::{ user=167586 }
