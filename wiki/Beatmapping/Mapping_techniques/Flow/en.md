...
- [Analyzing Flow in Beatmaps](https://osu.ppy.sh/community/forums/topics/86329), a guide by ::{ flag=US }:: ::Charles445::{ user=85000 }
- [Mapping Analysis #1 - Flow](https://osu.ppy.sh/home/news/2013-09-15-mapping-analysis-1-flow), a news post by ::{ flag=FR }:: ::Shiro::{ user=113005 }
- [flow + circles](https://www.youtube.com/watch?v=ig7nTSbWwVc) and [flow + sliders](https://www.youtube.com/watch?v=GYGatwQszwQ), episodes of the [osu!mapping](/wiki/Community/Video_series/osu!mapping) YouTube series by ::{ flag=US }:: ::pishifat::{ user=3178418 }
