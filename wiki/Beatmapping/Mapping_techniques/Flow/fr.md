...
- [Analyzing Flow in Beatmaps](https://osu.ppy.sh/community/forums/topics/86329), un guide par ::{ flag=US }:: ::Charles445::{ user-id=85000 }
- [Mapping Analysis #1 - Flow](https://osu.ppy.sh/home/news/2013-09-15-mapping-analysis-1-flow), un news post par ::{ flag=FR }:: ::Shiro::{ user-id=113005 }
- [flow + circles](https://www.youtube.com/watch?v=ig7nTSbWwVc) et [flow + sliders](https://www.youtube.com/watch?v=GYGatwQszwQ), épisodes de la série YouTube [osu!mapping](/wiki/Community/Video_series/osu!mapping) par ::{ flag=US }:: ::pishifat::{ user-id=3178418 }
