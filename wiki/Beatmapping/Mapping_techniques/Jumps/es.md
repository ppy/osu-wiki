...
# Técnicas de mapping para los jumps

*Véase [Técnicas básicas del mapping](/wiki/Beatmapping/Mapping_techniques/Basics#jumps) para una descripción de los jumps.*

## Círculos

### Antijumps

Nominador: ::Seibei4211::{ user-id=31537 }
...
Los **antijumps centrales** tienen una nota o un slider colocado en el centro a la vez que los otros objetos pero espaciados igual en la línea de tiempo como una forma de [antijump](#antijumps).
...
Nominador: ::Zekira::{ user-id=36749 }
...
Nominador: ::Blue Dragon::{ user-id=19048 }

Los **jumps basados en sliders B&F** consisten en hacer un jump (o triángulo) [de ida y vuelta](/wiki/Beatmapping/Mapping_techniques/Rhythm#ritmos-de-ida-y-vuelta) usando el slider como base para el jump.
...
Nominador: ::Card N'FoRcE::{ user-id=3936 }
