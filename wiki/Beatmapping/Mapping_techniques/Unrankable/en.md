...
This technique was named after the creator's former name, buraimaster1234 (now known as ::machol30::{ user=5772 }).

## Hold Sliders

::: alert-note
**Note:** Not to be confused with [Short Repeating Sliders](/wiki/Beatmapping/Mapping_techniques/Sliders#short-repeating-sliders).
:::
...
::: alert-note
**Note:** Not to be confused with [Short Spinners](/wiki/Beatmapping/Mapping_techniques/Spinners#short-spinners).
:::
