...
L'**overall difficulty** (***OD***) définit la difficulté d'obtenir une[précision](/wiki/Accuracy) élevée sur une [beatmap](/wiki/Beatmap). La valeur est comprise entre 0 et 10, une OD plus élevée exigeant plus de précision et d'exactitude. Étant donné que la précision est importante pour récupérer de la vie, l'overall difficulty influence également la difficulté pour réussir une beatmap.
