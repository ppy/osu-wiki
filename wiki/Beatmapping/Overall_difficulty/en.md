...
Higher OD values mean shorter time windows to clear [hit objects](/wiki/Hit_Objects), both in general and in terms of getting high score values. The maximum allowed offset for each of the hit windows in osu! and osu!mania, centered on the hit object's correct time, is defined by the following tables:
