...
A **timing section** in the [beatmap editor](/wiki/Beatmap_editor) denotes a change in the timing (e.g. [offset](/wiki/Offset) or [BPM](/wiki/Beatmapping/Beats_per_minute)) of a [beatmap](/wiki/Beatmaps). Beatmaps can have a single timing section that takes up the whole song or many timing sections that are split up throughout the song.
