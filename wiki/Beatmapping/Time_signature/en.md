...
A **time signature** is a musical term that indicates the number of [beats](/wiki/Beat) in a single measure (indicated by the top number), and what note indicates a single beat (indicated by the bottom number).
