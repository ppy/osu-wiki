...
*สำหรับบทความเวอร์ชัน osu!stable ดูที่: [Game modifier](/wiki/Gameplay/Game_modifier)*\
...
ม็อดแบ่งเป็นห้าหมวดคือ `Difficulty Reduction`, `Difficulty Increase`, `Automation`, `Conversion` และ `Fun` ม็อดสามารถลดหรือเพิ่ม Score Multiplier ได้ เมื่อใช้ม็อดสองตัวพร้อมกัน ตัวคูณของแต่ละม็อดจะถูกคูณเข้าด้วยกัน เช่น 1.06x * 1.12x = 1.1872x
...
**Personal Presets** อยู่ในหมวดของตัวเอง และให้ผู้เล่นบันทึกชุดม็อดใด ๆ เข้าไปได้โดยตรง ผู้เล่นสามารถตั้งชื่อได้ตามต้องการหรือเพิ่มคำอธิบายเสริมได้ Personal Presets แต่ละชุดจะเฉพาะกับโหมดเกมของมัน

#### Customise

คล้ายกับม็อด Difficulty Adjust (DA) การตั้งค่าที่เตรียมไว้ล่วงหน้าอย่าง **Customise** ช่วยให้ปรับประสบการณ์เล่นเกมได้ตามม็อดที่เลือก การเปลี่ยนแปลงใด ๆ ในการตั้งค่าเหล่านี้จะทำให้คะแนนเป็น unranked
