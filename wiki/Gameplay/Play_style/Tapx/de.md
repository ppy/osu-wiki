...
::: alert-notice
**Hinweis**
Dieser Spielstil benötigt die Verwendung eines Grafiktabletts.
:::

**Tapx** ist ein Tippstil für [Nur-Tablet](/wiki/Gameplay/Play_style#nur-tablet)-Spieler in [osu!](/wiki/Game_mode/osu!), bei dem Spieler durch das Drücken eines Tablet-Stifts auf ein Tablet Circles klicken, Slider verschieben und Spinner spinnen. Zusätzlich gibt es eine zweite Taste auf der Tastatur/dem Tablet, welche bei [Streams](/wiki/Beatmap/Pattern/osu!/Stream) und [Stacks](/wiki/Beatmapping/Mapping_techniques/Stack) zur Unterstützung dient. Diese Methode ist ziemlich schwierig für die meisten Spieler und ist nicht wirklich populär unter Tablet-Spielern.

## Streamen

::: alert-notice
**Hinweis**
Das Tasten-Overlay wird alle Berührungen des Tablets als `M1` anzeigen.
:::

Das Streamen via Tapx wird durch den rapiden Wechsel zwischen dem Drücken des Stifts auf ein Tablet und dem Drücken einer zugewiesenen, zweiten Taste (standardmäßig `Z` und `X`) ausgeführt. Einige Spieler fühlen sich wohl beim Wechsel zwischen einem Tipp auf das Tablet und der zweiten Taste bei jedem [Hit-Objekt](/wiki/Gameplay/Hit_object), ähnlich wie bei Spielern, die [alternierend](/wiki/Gameplay/Play_style/Alternating) die Tastendrücke zwischen jedem Hit-Objekt bestimmen.
