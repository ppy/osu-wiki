...
**フルコンボ**（もしくは、略して*FC*）とは、プレイヤーが[ビートマップ](/wiki/Beatmap)上で可能な限りの最大コンボ数を獲得することを表す言葉です。フルコンボは、ミス、[スライダーブレイク](/wiki/Gameplay/Judgement/Slider_break)、または[スライダーの終わり](/wiki/Hit_object/Slidertail)を失敗したことがない状態でビートマップをクリアすることでスコアになります。
