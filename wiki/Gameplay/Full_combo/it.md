...
**Full combo** (o *FC* in breve) è un termine usato per descrivere un giocatore che ottiene la massima [combo](/wiki/Beatmapping/Combo) possibile su una [beatmap](/wiki/Beatmap). Le full combo si ottengono superando una beatmap senza miss<!-- TODO: link -->, [sliderbreaks](/wiki/Gameplay/Judgement/Slider_break) e senza perdere [slider ends](/wiki/Gameplay/Hit_object/Slider/Slidertail).
