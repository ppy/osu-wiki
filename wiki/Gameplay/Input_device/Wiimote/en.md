...
**Wiimote** is the primary game controller for Nintendo [Wii](https://en.wikipedia.org/wiki/Wii "Wikipedia"). Although  mostly seen as gimmicky or silly, the Wiimote can be used in osu! to aim using the sensor bar. You can rebind any button to click in the osu! options.
