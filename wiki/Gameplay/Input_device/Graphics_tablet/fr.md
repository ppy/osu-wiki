...
Une **tablette graphique**, ou tout simplement une *tablette*, est un périphérique d'entrée destiné à l'origine au dessin numérique et à l'art, mais qui peut être utilisé comme moyen de contrôler le mouvement du curseur dans [osu!standard](/wiki/Game_mode/osu!). C'est l'un des styles de jeu les plus courants dans osu!standard.
