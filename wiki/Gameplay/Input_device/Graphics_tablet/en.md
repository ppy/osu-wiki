...
A **graphics tablet**, or just *tablet*, is an input device that is originally intended for digital drawing and artistry, but can be used as a way to control cursor movement in [osu! mode](/wiki/Game_mode/osu!) game mode. It is one of the most common play styles in osu!.
