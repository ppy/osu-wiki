...
Die [Wii](https://de.wikipedia.org/wiki/Wii) Tanzmatte benötigt einen [GameCube](https://de.wikipedia.org/wiki/GameCube) Controller-Adapter, um mit einem Computer zu funktionieren. Sobald die Tanzmatte mit dem Computer verbunden ist, kann man die richtigen Tasten in den osu!-Einstellungen belegen.