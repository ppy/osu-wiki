...
**跳舞墊**是使用玩家的腳來控制的輸入裝置。如下圖，跳舞墊需要放在地板上，玩家可以踩踏墊子上的 4 到 9 個方向來啟動按鍵。這類型的控制器最常使用在類似於 *[Dance Dance Revolution](https://en.wikipedia.org/wiki/Dance_Dance_Revolution "維基百科")* 的音樂遊戲中。
