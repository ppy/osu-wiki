...
玩家能获得的所有评价是 **D, C, B, A, S** 和 **SS**，从最差到最好排序。**银 S** 和 **银 SS** 需要打开 [Hidden](/wiki/Game_modifier/Hidden), [Flashlight](/wiki/Game_modifier/Flashlight) 或 [Fade In](/wiki/Game_modifier/Fade_In) 模组才能获取。
