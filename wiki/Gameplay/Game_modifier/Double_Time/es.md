...
::: alert-note
**Nota:** Para la versión de [lazer](/wiki/Client/Release_stream/Lazer) de este artículo, véase [Double Time (mod de lazer)](/wiki/Gameplay/Game_modifier_(lazer)/Double_Time_(lazer))
:::
...
::: alert-notice
**Aviso**
El método usado para aumentar la velocidad no aumenta el tono de la canción.
:::
...
![Valores modificados](img/GM_DT-ES.png "Captura de los valores del beatmap cambiados por el mod Double Time")
