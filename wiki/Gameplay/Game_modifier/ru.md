...
![Экран выбора модов](img/mod-selection-screen.jpg "Сравнение экранов выбора модов в osu! (слева вверху), osu!taiko (справа вверху), osu!catch (слева внизу) и osu!mania (справа внизу)")
...
Экран выбора модов можно открыть, кликнув при выборе карты на кнопку `Mods` в левом нижнем углу экрана или нажав на клавишу `F1`. После этого можно включить понравившиеся моды, кликая по их иконкам или нажимая соответствующие горячие клавиши, которые можно переназначить в настройках клиента.

Моды при выборе разделены на три категории: снижающие сложность, повышающие сложность, а  также особые моды. В зависимости от категории, мод может снижать, увеличивать или обнулять [множитель игровых очков](/wiki/Game_modifier/Score_multiplier). Когда одновременно выбраны несколько модов, их множители очков **перемножаются** (напр., `1.06x * 1.12x = 1.1872x`).

## Список модов

*См. также: [Сводка по игровым модификаторам](/wiki/Game_modifier/Summary)*
...
- [Target Practice (TP)](/wiki/Game_modifier/Target_Practice) ![][osu!] **доступен только в ветке обновлений Cutting Edge (Experimental)**
...
В [турнирных](/wiki/Tournaments) матчах **FreeMod** (***FM***) означает свободу выбора любых модов или их комбинаций. В некоторых турнилах есть отдельные правила, разъясняющие, какие моды в каких комбинациях допускается выбирать, и можно ли играть без модов вообще, если указан режим FreeMod.
