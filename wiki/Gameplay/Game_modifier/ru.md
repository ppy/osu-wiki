...
Моды на экране выбора разделены на три категории: снижающие сложность, повышающие сложность, а  также особые моды. В зависимости от категории, мод может снижать, увеличивать или обнулять [множитель игровых очков](/wiki/Game_modifier/Score_multiplier). Когда одновременно выбраны несколько модов, их множители очков **перемножаются** (напр., `1.06x * 1.12x = 1.1872x`).
