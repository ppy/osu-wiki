...
The **Double Time** mod increases the BPM of any beatmap by 50% and decreasing the length of the song by 33.3%. It also increases the [approach rate (AR)](/wiki/Beatmap/Approach_rate), [overall difficulty (OD)](/wiki/Beatmap/Overall_difficulty) or both depending on the selected [game mode](/wiki/Game_mode).
