...
::: alert-note
**Note:** For the [lazer](/wiki/Client/Release_stream/Lazer) version of this article, see [Fade In (lazer mod)](/wiki/Gameplay/Game_modifier_(lazer)/Fade_In_(lazer))
:::
...
::: alert-note
**Note:** Not to be confused with [Hidden (mod)](/wiki/Gameplay/Game_modifier/Hidden) or [Flashlight (mod)](/wiki/Gameplay/Game_modifier/Flashlight).
:::
