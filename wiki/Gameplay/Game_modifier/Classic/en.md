...
- **No slider head accuracy requirement** (default: enabled): [Sliders](/wiki/en/Gameplay/Hit_object/Slider) will work the same way they used to in osu!stable, so slider heads don't have to be hit accurately.
- **Apply classic note lock** (default: enabled): [Notelock](/wiki/en/Gameplay/Judgement/Notelock) will work the same way it used to in osu!stable.
...
- **Classic health** (default: enabled): [Health](/wiki/en/Gameplay/Health) will work similar to how it used to in osu!stable.
