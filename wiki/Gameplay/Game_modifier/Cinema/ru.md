...
*Об аналогичном моде в [lazer](/wiki/Client/Release_stream/Lazer) см. [Cinema (lazer)](/wiki/Gameplay/Game_modifier_(lazer)/Cinema_(lazer))*\
...
::: alert-notice
**Внимание**
при активации Cinema ваш рекорд не засчитается.
:::
