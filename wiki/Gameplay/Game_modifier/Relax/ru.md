...
::: alert-notice
**Внимание**
при включении Relax результат прохождения не повлияет на ваш ранг и не будет сохранён в локальной таблице рекордов.
:::
...
Relax скрывает игровой интерфейс: число [очков](/wiki/Gameplay/Score), [комбо](/wiki/Gameplay/Combo_(score_multiplier)) и промахи, — который можно вернуть, нажав `Shift` + `Tab`. Кроме того, мод удваивает скорость вращения [спиннеров](/wiki/Gameplay/Hit_object/Spinner), что позволяет получить за их прохождение больше очков, чем при обычной игре.
