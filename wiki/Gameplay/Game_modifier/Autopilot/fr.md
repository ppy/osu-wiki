...
Le mod Autopilot désactive également l'interface du jeu, masquant ainsi le [score](/wiki/Gameplay/Score), le [combo](/wiki/Gameplay/Combo_(score_multiplier)) et les ratés, bien que cela puisse être réactivé en appuyant sur `Shift` + `Tab`.
