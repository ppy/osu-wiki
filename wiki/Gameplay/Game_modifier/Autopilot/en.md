...
The Autopilot mod also disables the in-game interface, thus hiding the [score](/wiki/Gameplay/Score), [combo](/wiki/Gameplay/Combo_(score_multiplier)), and misses, although this can be re-enabled by pressing `Shift` + `Tab`.
