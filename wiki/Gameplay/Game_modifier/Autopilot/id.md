...
Mod Autopilot juga menonaktifkan antarmuka in-game sehingga [skor](/wiki/Gameplay/Score), [kombo](/wiki/Gameplay/Combo_(score_multiplier)), dan miss menjadi tidak terlihat, meskipun hal tersebut dapat diaktifkan kembali dengan menekan tombol `Shift` + `Tab`.
