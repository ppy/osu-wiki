...
*Эта статья — про мод, затемняющий игровое поле. О моде, убирающем круги вокруг нот, см. [Hidden (мод)](/wiki/Game_modifier/Hidden).*
...
- Описание: `Restricted view area`
- Режимы игры: ![][osu!] ![][osu!taiko] ![][osu!catch] ![][osu!mania]

## Описание

**Flashlight** (рус. *фонарик*, *ФЛ*) — [игровой модификатор](/wiki/Game_modifier), искусственно усложняющий [карту](/wiki/Beatmap) за счёт уменьшения видимой игровой области.
...
Освещённая область уменьшается при достижении 100x комбо, а затем — ещё раз при 200x. Если игрок сбивает комбо, она возвращается к исходному размеру. Кроме того, при прохождении [слайдеров](/wiki/Hit_object/Slider) уровень освещения временно снижается.
...
Flashlight считается многими самым сложным модом в osu!: чтобы поставить на карте рекорд, её нужно сначала полностью запомнить.
...
В [osu!mania](/wiki/Game_mode/osu!mania) область видимости имеет прямоугольную форму и расположена в центре игрового конвейера. Таким образом, Flashlight можно рассматривать как комбинацию модов Hidden и [Fade In](/wiki/Game_modifier/Fade_In), если не учитывать изменение размера области.
