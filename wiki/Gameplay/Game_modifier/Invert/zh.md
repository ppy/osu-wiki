...
**Invert** 模组将整个 osu!mania 游玩过程“反转”过来，玩家一开始需要按住所有按键，只能在[打击物件](/wiki/Gameplay/Hit_object)出现时松开。这种效果是以将除单点音符与原谱面[长条](/wiki/Gameplay/Hit_object/Hold_note)头部以外的位置均填充为长条来实现的。
