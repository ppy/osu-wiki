...
**Invert** 模组将整个 osu!mania 游玩过程“反转”过来，玩家一开始需要按住所有按键，只能在[打击物件](/wiki/Gameplay/Hit_object)出现时松开。这种效果是通过排除单点音符与[长条](/wiki/Beatmap/Pattern/osu!mania/Hold_note)头部的位置，将每列所有剩余的地方用长条覆盖来实现的。
