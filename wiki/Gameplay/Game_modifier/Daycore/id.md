...
![Ikon mod Daycore](/wiki/Gameplay/Game_modifier_(lazer)/img/mods/DC.png)
...
![Menu penyesuaian mod Daycore di dalama game](/wiki/Gameplay/Game_modifier_(lazer)/img/customise/DC.png)

- `Speed decrease` (0.50x–0.99x, default: 0.75x): Kecepatan beatmap yang dimainkan.

Mengubah pengaturan `Speed decrease` akan menyebabkan skor pemain menjadi **unranked**.
