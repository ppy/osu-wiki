...
**Daycore** 模组更改速度与调节难度的行为与 [Half Time (HT)](/wiki/Gameplay/Game_modifier/Half_Time_(lazer)) 完全一致，只是该模组将音频的频率（音调）降低 25%，而且不允许在自定义设置中更改音调。

## 自定义

![游戏客户端中 Daycore 模组的自定义设置](/wiki/Gameplay/Game_modifier_(lazer)/img/customise/DC.png)
