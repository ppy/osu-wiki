...
*Об аналогичном моде в [lazer](/wiki/Client/Release_stream/Lazer) см. [Half Time (lazer)](/wiki/Gameplay/Game_modifier_(lazer)/Half_Time_(lazer))*\
...
::: alert-notice
**Внимание**
метод, с помощью которого Half Time изменяет скорость аудио, может добавлять шумное или роботизированное звучание.
:::
