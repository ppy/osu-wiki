...
- [Target Practice (TP)](Target_Practice) ![][osu!] **Hanya tersedia pada osu! versi Cutting Edge (Experimental)**
...
Dalam lingkungan [turnamen](/wiki/Tournaments), istilah **No Mod** (***NM***) mengacu pada beatmap-beatmap yang harus dimainkan tanpa menggunakan mod apapun di samping mod-mod seperti [No Fail](No_Fail) dan [ScoreV2](ScoreV2) yang pada umumnya merupakan syarat wajib turnamen.
