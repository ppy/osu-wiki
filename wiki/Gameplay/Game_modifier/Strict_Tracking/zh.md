...
**Strict Tracking** 模组在玩家没有精准跟随[滑条](/wiki/Gameplay/Hit_object/Slider)的跟随圈时给出 Miss，包括漏掉[滑条点](/wiki/Gameplay/Hit_object/Slider/Slider_tick)或[滑条尾](/wiki/Gameplay/Hit_object/Slider/Slidertail)，没有按住空滑条路径，以及光标在任意时间内在跟随圈外。
