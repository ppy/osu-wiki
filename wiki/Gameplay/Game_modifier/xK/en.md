...
::: alert-notice
**Notice**
xK is a collective term for the key modifiers: 1K, 2K, 3K, 4K, 5K, 6K, 7K, 8K, and 9K.
:::
...
::: alert-note
**Note:** For the [lazer](/wiki/Client/Release_stream/Lazer) version of this article, see [Key mods (lazer)](/wiki/Gameplay/Game_modifier_(lazer)/Key_mods_(lazer))
:::
...
::: alert-notice
**Notice**
All xK mods will be ignored on osu!mania-specific beatmaps. Using the 1K, 2K, or 3K mod will result in an unranked play.
:::
