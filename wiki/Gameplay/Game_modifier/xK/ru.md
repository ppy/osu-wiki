...
*Примечание: xK - собирательный термин для модификаторов: 1K, 2K, 3K, 4K, 5K, 6K, 7K, 8K, and 9K.*
...
- Горячая клавиша по умолчанию: `Z` (каждое нажатие меняет мод от 4K до 9K, затем возвращается на 1K и меняет до 3K, а после выключает мод)
- Режимы игры: ![][osu!mania]

## Описание

*Примечание: osu!mania игнорирует все моды xK клавиш на особых для режима картах. 1K, 2K, или 3K приведёт к игре "НЕ НА РАНГ".*

[Игровые модификаторы](/wiki/Gameplay/Game_modifier) конвертируют [карты](/wiki/Beatmap) [osu!mania](/wiki/Game_mode/osu!mania) к выбранному количеству (xK) клавиш. Мод игнорирует стандартную настройку количества клавиш (K) на карте и уменьшает множитель в зависимости от разницы в количестве клавиш с выбранным модом xK.

Таблица ниже демонстрирует множители в зависимости от выбранного мода xK к стандартному количеству клавиш:
