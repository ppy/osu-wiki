...
- The mod multiplier is shown on osu!(stable)'s [mod selection screen](/wiki/Gameplay/Game_modifier) as `Score Multiplier`, while in osu!lazer it is called `Difficulty Multiplier`.
