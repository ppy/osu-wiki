...
- Le mod Mirror a été ajouté en septembre 2019, en réponse à une [demande de fonctionnalité](https://osu.ppy.sh/community/forums/topics/956618) par l'utilisateur ::Kamuy::{ user-id=7439226 }.
  - Au moment où la demande de fonctionnalité a été postée, il existait déjà un mod de type miroir implémenté dans [osu!(lazer)](/wiki/Client/Release_stream/Lazer), mais en raison de la nature du mod miroir, qui permet d'accroître l'accessibilité, il a été ajouté à la version stable d'osu! à ce moment-là.
...
- Le mod Mirror est le seul modificateur de jeu de la catégorie "Spécial" qui n'affecte ni le nombre de [points de performance (pp)](/wiki/Performance_points) ni le [score](/wiki/Gameplay/Score) qu'un joueur gagne, tout en restant classable.
