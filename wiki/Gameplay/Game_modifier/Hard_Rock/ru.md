...
В [osu!](/wiki/Game_mode/osu!) Hard Rock, помимо увеличения параметров карты, отражает её по вертикали (см. ниже). Некоторые [паттерны](/wiki/Beatmap/Pattern) могут из-за этого неестественно играться, что также увеличит сложность.
