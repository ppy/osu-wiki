...
选择界面的模组被分为三类：`降低难度`、`增加难度`、`特殊`。它们能作用于[`分数倍率`](/wiki/Game_modifier/Score_multiplier)，并使其减少、增加，或直接归零。当同时开启多个模组时，模组自带倍率的连乘结果将作为最终的分数倍率。（比如：`1.06x * 1.12x = 1.1872x`）

## 模组列表

*参见：[概要（游戏模组）](/wiki/Game_modifier/Summary)*
...
- [Target Practice (TP)](/wiki/Game_modifier/Target_Practice) ![][osu!] **仅在测试版 (Cutting Edge) 内可供开启**
