...
В [osu!](/wiki/Game_mode/osu!) при включении Easy вдвое снижаются [размер кругов (CS)](/wiki/Client/Beatmap_editor/Song_Setup#circle-size), [скорость появления нот (AR)](/wiki/Beatmapping/Approach_rate), [общая сложность (OD)](/wiki/Client/Beatmap_editor/Song_Setup#overall-difficulty) и [расход здоровья (HP)](/wiki/Client/Beatmap_editor/Song_Setup#hp-drain-rate).
...
В [osu!taiko](/wiki/Game_mode/osu!taiko) при включении Easy вдвое снижаются [скорость слайдеров](/wiki/Hit_object/Slider_velocity), общая сложность (OD) и расход здоровья (HP).
...
- Когда игрок расходует всё здоровье, анимация его восстановления в реплее не показывается. Вместо этого игра просто продолжается дальше, как при включённом моде [No Fail](/wiki/Game_modifier/No_Fail).
- При игре в [мультиплеере](/wiki/Client/Interface/Multiplayer) механика «жизней» не работает, если выбран режим игры [Tag Co-op или Tag Team Vs.](/wiki/Client/Interface/Multiplayer#tag-co-op-/-tag-team-vs)
