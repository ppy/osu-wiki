...
Unlike the other game modes, using the Easy mod in osu!taiko reduces note score requirement to gain health in osu!taiko, making the life bar fill up much more quickly to replace the two additional "lives" as it is impossible to fail in the middle of a song in taiko.
