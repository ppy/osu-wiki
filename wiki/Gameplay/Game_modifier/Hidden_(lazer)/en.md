...
- **Only fade approach circles** (default: disabled): Make the approach circles invisible without applying the fade effect on notes. Note that this makes the mod unranked and sets the score multiplier to 1.00x.
