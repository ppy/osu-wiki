...
По сравнению с osu!(stable), в osu!(lazer) он стал мягче. Он стал таким благодаря гораздо более щадящему временному окну: как только первый объект достигает смещения в 0 мс, следующий объект больше не блокируется и его можно сразу нажать. Вкратце, позднее окно попадания первой ноты больше не будет блокировать вторую ноту.
