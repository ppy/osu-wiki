...
В сравнении с osu!(stable), нотлок в osu!(lazer) стал более мягким. Он был смягчен благодаря значительно более щадящему временному окну: как только оффсет первого объекта достигает 0 мс, следующий объект больше не блокируется и его сразу можно нажать. Вкратце, позднее окно попадания по ранее пропущенной ноте больше не будет лочить следующую ноту.
