...
- На более высоких и быстрых сложностях нотлок не даёт сбиться с ритма и начать нажимать ноты как попало.

## Предотвращение

Нотлок можно предотвратить при маппинге, подбирая OD для [сложности](/wiki/Beatmap/Difficulty) в соответствии с её плотностью объектов и BPM песни. При BPM от 200 и выше рекомендуется использовать OD 5 и выше. Подробнее см. в руководстве [Avoiding notelock at high BPM](https://osu.ppy.sh/community/forums/topics/334458).
