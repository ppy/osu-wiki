...
La **salud** o *HP* es el valor que determina si un jugador logra pasar o fallar un [beatmap](/wiki/Beatmap). La salud se puede ver en la [barra de salud](/wiki/Client/Interface/Health_bar), que se actualiza a medida que avanza el juego. La configuración de dificultad de [tasa de drenaje de HP](/wiki/Beatmap/HP_drain_rate) determinará qué tan difícil será mantener un valor alto de salud.
...
- Un toque exitoso en el círculo (un mejor [juicio](/wiki/Gameplay/Judgement) conducirá a una mayor ganancia de salud; el último círculo del conjunto de combo otorgará más salud)
- Un golpe exitoso al inicio de un slider
- La bola del slider recogió todas las marcas con éxito
- La bola del slider tocó el final del slider o una flecha de reversión con éxito (un mejor juicio en la última marca conducirá a una mayor ganancia de salud)
- Completar un spinner y continuar girando (un mejor juicio al final del spinner conducirá a una mayor ganancia de salud)
...
- Perder una marca del slider o una flecha de reversión
...
- Obtener un 'Great' o un 'Good' en notas pequeñas/grandes

Pérdida de salud:

- Obtener un 'Miss' o un 'Bad' en notas pequeñas/grandes
...
En [osu!mania](/wiki/Game_mode/osu!mania), solo los objetos pueden afectar a la barra de salud, ya que el drenaje de salud está deshabilitado.
...
- Obtener un Rainbow 300, 300 o 200 (de mayor a menor ganancia)
- Sostener una nota larga con la tecla correcta
