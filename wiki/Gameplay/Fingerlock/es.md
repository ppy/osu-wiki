...
En ocasiones, se puede hacer referencia al «fingerlock» como `wrist lock`, `wristlock`, `wrist-lock`.
...
Aún no se ha encontrado ni se comprende en general una causa específica para el fingerlock. Sin embargo, hay algunos hábitos comunes que pueden causar o aumentar las posibilidades del fingerlock: sesiones de juego prolongadas (especialmente aquellas que repiten el mismo [beatmap](/wiki/Beatmap) repetidamente), mala postura o posición de la muñeca, o tensión innecesaria en la muñeca o los dedos durante periodos prolongados. Independientemente, lo más habitual es que el fingerlock se produzca una o dos veces durante una sesión de juego como resultado de una simple vacilación o de un tiempo de reacción lento.

## Remedios y prevención

Actualmente, no se conocen «remedios» para el fingerlock y, a menudo, se consideran innecesarios, ya que el fingerlock generalmente se resuelve solo poco después de que ocurre. Pero en los casos en los que se repite con frecuencia, muchos jugadores toman descansos, estiran los dedos o realizan otras actividades que dependen menos de dichos dedos. Los remedios antes mencionados también son estrategias de prevención eficaces, aunque nada de esto está garantizado.
