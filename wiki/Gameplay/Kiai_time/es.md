...
El **kiai time** o *kiai*, es un conjunto de efectos visuales distintivos que enfatizan una parte de un [beatmap](/wiki/Beatmap), el cual está inspirado[^taiko-roots] en Go-Go Time de la serie [Taiko no Tatsujin](https://es.wikipedia.org/wiki/Taiko_no_Tatsujin). Las secciones kiai se indican rociando fuentes de estrellas, estrellas que caen debajo del cursor y [objetos](/wiki/Gameplay/Hit_object) que parpadean al ritmo con la frecuencia de los [BPM](/wiki/Music_theory/Tempo). Efectos similares, como destellos laterales frecuentes y fuentes de estrellas, también son visibles en el [menú principal](/wiki/Client/Interface#menú-principal).

Si bien el kiai time no afecta las mecánicas de juego en osu!, osu!catch u osu!mania, proporciona una ganancia de [puntuación](/wiki/Gameplay/Score) del 20 % en [osu!taiko](/wiki/Game_mode/osu!taiko).
