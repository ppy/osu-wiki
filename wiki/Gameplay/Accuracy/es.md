...
En osu!, la precisión se calcula ponderando el [criterio](/wiki/Gameplay/Judgement) con el que se le da a cada nota, multiplicado por su valor y dividido por la cantidad maxima posible.
