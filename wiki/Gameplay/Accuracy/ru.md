...
::: alert-notice
**Внимание**
эта информация будет показана только после того, как вы сыграли карту или посмотрели её реплей, и пропадёт, если уйти со [страницы результатов](/wiki/Client/Interface#экран-результатов).
:::
...
::: alert-note
**Основная статья:** [Разброс нажатий](/wiki/Gameplay/Unstable_rate)
:::[Разброс нажатий](/wiki/Gameplay/Unstable_rate)

`Unstable Rate` (*UR*, жарг. *анстейбл*) — это [стандартное отклонение](https://ru.wikipedia.org/wiki/Среднеквадратическое_отклонение) ошибок попаданий, посчитанное в миллисекундах и затем умноженное на 10. Чем ниже это значение, тем стабильнее сыграна карта.

Следует заметить, что разброс нажатий и точность — это разные метрики. У точных рекордов часто низкий разброс нажатий, но вполне реально заработать одновременно и низкий разброс, и низкую точность — например, стабильно пробить все [объекты](/wiki/Gameplay/Hit_object) на [оценку 50](/wiki/Gameplay/Judgement/osu!).

### Spin

::: alert-notice
**Внимание**
Spin отображается только для [osu!](/wiki/Game_mode/osu!).
:::
