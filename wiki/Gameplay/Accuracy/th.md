...
เพราะว่า ม็อด [DT](/wiki/Game_modifier/Double_Time) (Double Time) และ [HT](/wiki/Game_modifier/Half_Time) (Half Time) มีการนำมาใช้ค่าของ ความผิดพลาด และ อัตราความไม่มั่นคง จะถูกคูณด้วยตัวคูณเดียวกันกับของแมพ เพื่อที่จะได้ค่าแท้จริงของ DT และหารผลลัพธ์ด้วย 1.5 ซึ่งคล้ายกับการคูณผลลัพธ์ด้วย 1.33 เมื่อเล่น HT
