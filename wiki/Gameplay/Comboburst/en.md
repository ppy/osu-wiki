...
**Combo bursts** celebrate achieving a [combo milestone](/wiki/Gameplay/Combo_milestone) by flashing a combo burst image. Said images are different for each game mode.
...
::: alert-notice
**Notice**
Combo bursts can be disabled in the [options](/wiki/Client/Options).
:::
