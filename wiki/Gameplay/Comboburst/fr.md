...
Les **combo bursts** sont des effets visuels qui célèbrent l'obtention d'un [combo milestone](/wiki/Gameplay/Combo_milestone) en faisant clignoter une image représentant l'éclat du combo. Ces images sont différentes pour chaque mode de jeu.
...
::: alert-notice
**Note**
les combo bursts peuvent être désactivés dans les [options](/wiki/Client/Options) du jeu.
:::
