...
- 在 [osu!mania](/wiki/Game_mode/osu!mania) 模式中，默认情况下一个动画人物会从舞台右侧跳出。

在 osu!、osu!taiko 与 osu!catch 模式中，当连击数低于 100x 时，星星会从游玩区域左右两侧中的一侧喷出，高于 100x 时则会在两侧同时喷出。在 osu!mania 模式中，星星会从舞台的左右两侧喷出。

*备注：可在[设置](/wiki/Client/Options)中禁用连击提示图。*
