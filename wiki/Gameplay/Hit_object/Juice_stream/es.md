...
Las **corrientes de jugo** son un elemento en [osu!catch](/wiki/Game_mode/osu!catch) que incluye gotas y gotitas. Las corrientes de jugo se generan cuando se coloca un [slider](/wiki/Gameplay/Hit_object/Slider) en el editor.
