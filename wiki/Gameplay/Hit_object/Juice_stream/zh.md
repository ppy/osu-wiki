...
*中果* 通常为中等大小，带颜色的[打击物件](/wiki/Hit_object)，出现在 [osu!catch](/wiki/Game_mode/osu!catch) 模式的[谱面](/wiki/Beatmap)内。水滴/中果等同于 [osu!](/wiki/Game_mode/osu!) 模式内的滑条点。如果游玩时，中果其后的[大果](/wiki/zh/Hit_object/Fruit)仅靠按冲刺键无法接住，那么这颗中果会变成红果。
