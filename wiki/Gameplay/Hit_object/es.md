...
En osu!, el siguiente círculo o slider que se toca, se resalta con un brillo ligeramente mayor en comparación de los otros objetos en el campo de juego. Sin embargo, el resaltado ya no será más visible cuando la [velocidad de aproximación](/wiki/Beatmap/Approach_rate) sea demasiado alta.
