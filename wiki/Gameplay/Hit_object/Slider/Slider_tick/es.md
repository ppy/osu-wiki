...
Las **marcas del slider** son pequeños puntos (marcas) que aparecen dentro de los [sliders](/wiki/Gameplay/Hit_object/Slider). La cantidad de marcas del slider utilizados en un slider depende de la [velocidad del slider](/wiki/Gameplay/Hit_object/Slider/Slider_velocity), [BPM](/wiki/Music_theory/Tempo) y el tiempo heredado.
