...
Le *note* sono elementi con cui il player puo interagire durante il gioco di una [beatmap](/wiki/Beatmap). Ogni [game mode](/wiki/Game_mode) ha il suo set unico di note che cambia la esperienza di gioco. Per una panoramica sulle note di ciascuna modalità di gioco, guarda la seguente tabella:
...
In osu!, la prossima nota o slider viene evidenziata con una luminosità leggermente maggiore rispetto alle altre note sul campo di gioco. Tuttavia, l'evidenziazione non sarà più visibile quando la [velocità di avvicinamento](/wiki/Beatmap/Approach_rate) è troppo alta.
