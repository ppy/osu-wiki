...
| :-: | :-: | :-: | :-: |
| [ヒットサークル](/wiki/Gameplay/Hit_object/Hit_circle) | ヒットサークル | [フルーツ](/wiki/Gameplay/Hit_object/Fruit) | ノーツ |
| [スライダー](/wiki/Gameplay/Hit_object/Slider) | ドラムロール | [ジュースストリーム](/wiki/Gameplay/Hit_object/Juice_stream) | ホールドノーツ |
| [スピナー](/wiki/Gameplay/Hit_object/Spinner) | デンデン | [バナナ](/wiki/Gameplay/Hit_object/Banana) | x |
| x | x | [ハイパーフルーツ](/wiki/Gameplay/Hit_object/Hyperfruit) | x |
...
osu!では、次にタップされるヒットサークルやスライダーが、プレイフィールド上の他のヒットオブジェクトと比較して、わずかに輝度を上げてハイライト表示されます。ただし、[接近率](/wiki/Beatmap/Approach_rate)が高すぎるとハイライトが表示されなくなります。
