...
Les **fruits** sont de gros [objets](/wiki/Gameplay/Hit_object) colorés présents dans les [beatmaps](/wiki/Beatmap) du mode [osu!catch](/wiki/Game_mode/osu!catch). Un [hyperfruit](/wiki/Gameplay/Hit_object/Hyperfruit) sera généré sur un fruit une fois que le fruit suivant ou le [drop](/wiki/Gameplay/Hit_object/Juice_stream#drop) est impossible à attraper avec un dash normal.
