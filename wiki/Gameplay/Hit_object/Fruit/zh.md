...
*大果 (fruits)* 是出现于 [osu!catch](/wiki/Game_mode/osu!catch) [谱面](/wiki/Beatmap)中的带颜色的大[打击物件](/wiki/Hit_object)。一旦下一个大果或[中果](/wiki/Hit_object/Juice_stream#drop)无法通过常规加速接住时，会生成[超级水果](/wiki/Hit_object/Hyperfruit)。
