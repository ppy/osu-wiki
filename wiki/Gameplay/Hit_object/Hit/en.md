...
![](img/taiko-hits.png "Regular and Finisher notes in osu!taiko")
...
**Finishers** (sometimes called *strong hits*) are bigger versions of the regular Dons and Kats where the player must press two buttons simultaneously of proper colour, instead of just one. Besides that, Finisher notes work the same as regular notes.
