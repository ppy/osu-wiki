...
Le projet est organisé par ::{ flag=TN }:: ::Hivie::{ user=14102976 }. Les membres de la communauté suivants sont responsables du choix des beatmaps :

- ::{ flag=SE }:: ::bite you death::{ user=6398464 }
- ::{ flag=US }:: ::ChillierPear::{ user=9501251 }
- ::{ flag=BR }:: ::Dada::{ user=9119507 }
- ::{ flag=GB }:: ::Kingling::{ user=7010761 }
