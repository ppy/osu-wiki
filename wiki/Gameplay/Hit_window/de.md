...
Die Anzahl und die Länge der Trefferfenster variiert je nach [Spielmodus](/wiki/Game_mode). Zum Beispiel existiert in [osu!catch](/wiki/Game_mode/osu!catch) kein Timing-Konzept, d. h. alle Hit-Objekte gelten als getroffen oder als verfehlt.
