...
Система ScoreV2 по умолчанию выключена. В одиночной игре её можно включить с помощью мода [ScoreV2](/wiki/Gameplay/Game_modifier/ScoreV2), а в [мультиплеере](/wiki/Gameplay/Multiplayer) — выбрав ScoreV2 в качестве условия для победы в матче.
