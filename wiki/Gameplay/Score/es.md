...
El ScoreV2 no está habilitado de forma predeterminada en el juego; en el juego solitario, solo puede habilitarse a través del modificador del juego [ScoreV2](/wiki/Gameplay/Game_modifier/ScoreV2), y en el juego [multijugador](/wiki/Gameplay/Multiplayer), el ScoreV2 se puede configurar como una condición ganadora durante la configuración del partido.
