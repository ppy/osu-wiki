...
- osu!mania is the only game mode with a score limit (under ScoreV1), which is set at 1,000,000 points with a 1.00x [score multiplier](/wiki/Gameplay/Game_modifier/Mod_multiplier(score_multiplier)).
