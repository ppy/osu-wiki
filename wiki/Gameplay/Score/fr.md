...
ScoreV2 n'est pas activé par défaut dans le gameplay. En partie seule, il peut être activé à l'aide du modificateur de jeu UNRANKED [ScoreV2](/wiki/Game_modifier/ScoreV2), et en [multijoueur](/wiki/Gameplay/Multiplayer), ScoreV2 peut être défini comme une condition de victoire pendant la configuration du match.
