...
- osu!mania est le seul mode de jeu avec une limite de score (sous ScoreV1), qui est fixée à 1 000 000 de points avec un [multiplicateur de score](/wiki/Gameplay/Game_modifier/Score_multiplier(mod_multiplier)) 1.00x.
