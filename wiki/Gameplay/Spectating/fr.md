...
**Specter** (abrégé en "spec") est un terme utilisé pour décrire le fait de regarder un autre joueur jouer une [beatmap](/wiki/Beatmap) en temps réel (avec un délai d'environ 500ms). Pour observer, ouvrez le chat étendue et cliquez sur un panneau utilisateur gris.
