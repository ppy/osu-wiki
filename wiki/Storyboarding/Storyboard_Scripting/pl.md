![Przykład skryptów w pliku .osb.](SBS Base.jpg "Przykład skryptów w pliku .osb.")
...
[Przeczytaj główne zasady przed zaczęciem skryptowania tła](PL:Storyboard_Scripting_General_Rules). Zaoszczędzi ci to późniejszych problemów. Tutaj możesz sprawdzić [specyfikację obiektów w sprite'ów](Storyboard_Objects) oraz [ich ruch](Storyboard_Scripting_Commands). Tutaj mamy [dodatkowe ciekawoski](Storyboard_Scripting_Miscellaneous).
