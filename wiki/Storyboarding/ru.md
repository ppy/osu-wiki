...
Пользователи, имеющие опыт в сторибординге, часто используют внутренний код  от SBE - [Storyboard Scripting](/wiki/Storyboard_Scripting) (SBS), так как он предлагает больше контроля. Подробнее см. В этой статье.
