...
Пользователи, имеющие опыт в сторибординге, часто используют внутренний код [Storyboard Scripting](/wiki/Storyboard_Scripting) (SBS) от SBE, так как он предлагает больше контроля. Подробнее см. В этой статье.
