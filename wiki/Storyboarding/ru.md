...
Пользователи, имеющие опыт в сторибординге, часто используют внутренний код от SBE - [Storyboard Scripting](/wiki/Storyboard_Scripting) (SBS), так как с помощью него можно точнее контролировать спрайты. Подробнее см. В этой статье.
