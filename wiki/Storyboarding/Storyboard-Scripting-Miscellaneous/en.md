...
Saving will replace the "12"s in color specification with "$number\_of\_loops", which *means* `_C,0,6000,7000,$number_of_loops,$number_of_loops,$number_of_loops` (invalid command)
