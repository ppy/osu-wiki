...
While the built-in editor offers an easy way to control the movement of sprites, it is often regarded as too hard for anything beyond the basics of storyboarding. As a result, storyboard creators, or [storyboarders](/wiki/Storyboarding/Storyboarder), often use [scipts and third-party programs](/wiki/Storyboard_Scripting) that generate code for osu! storyboards and provide high-level abstractions, such as particle systems.
