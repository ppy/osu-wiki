...
[스토리보드 에디터는](KO:Storyboard_Editor) 비트맵 에디터 중 Design 탭(단축키: F2)에서 찾아볼 수 있습니다. 기본적으로 이 에디터는 스프라이트를 쉽고 간단하게 사용자가 원하는 대로 움직일 수 있게 해주지만, 종종 투박하면서 스토리보드의 기초적인 부분 외엔 아무것도 못한다고 생각될 수도 있습니다.

하지만 스토리보드 제작에 익숙한 유저들은 [스토리보드 스크립트를](KO:Storyboard_Scripting) 사용해 더욱 다양한 모션을 만들어내기도 합니다. 자세한 내용은 해당 문서를 참조해주시기 바랍니다.

풀 스토리보드
-------------

스토리보드가 들어간 대다수의 랭크맵은 시각효과만 들어가있는 경우가 많기 때문에 그 리스트를 본 페이지에서 전부 보여드리기는 어렵습니다. (참고로 해당 리스트는 [여기](https://osu.ppy.sh/p/beatmaplist?s=7&o=1&q=&r=0&g=0&la=0&sb=1))

따라서 본 페이지에서는 **풀 스토리보드** 가 포함된 비트맵만 보여드립니다. 그 외의 작품은 [여기에서](KO:Storyboarding/Maps) 확인해주시기 바랍니다.
