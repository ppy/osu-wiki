...
2\. Navigate to the folder for where the files are to be uploaded into.
...
*Warning: This is **not recommended** because you can only delete one file at a time! This may create multiple "dumb" commits that may flag the reviewers into closing or stalling your pull request!*

1\. Open the code tab on your fork.

1\. Navigate to the file you want to delete and open it.
