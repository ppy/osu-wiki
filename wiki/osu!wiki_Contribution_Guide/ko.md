...
- [깃헙 웹 인터페이스](/wiki/owcg/GitHub_Web_Interface) - 온라인으로 수정합니다; 적은 문서 수정에 적합합니다.
- [깃헙 데스크톱](/wiki/owcg/GitHub_Desktop) - 로컬로 편집합니다; 다중 문서 수정에 적합합니다 (파일의 업로드, 삭제, 이동도 포합됩니다.)
...
** *GitHub Web Interface* 또는 *GitHub Desktop* 에서 편집을 진행 했다면, 다음 섹션으로 넘어가 주세요.**
