...
Les storyboards sont stockés dans des dossiers Beatmap de manière autonome. [fichiers `.osb`](/wiki/osu!_File_Formats/Osb_(file_format)) ou des extensions de la section `[Events]` de [fichiers `.osu`](/wiki/osu!_File_Formats/Osu_(file_format)). De ce fait, il est possible de créer différents storyboards pour différentes maps dans un [beatmap](/wiki/Beatmap).
