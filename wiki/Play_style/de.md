...
Tanzmatten sind Controller für Spiele wie die Serien [Dance Dance Revolution](https://de.wikipedia.org/wiki/Dance_Dance_Revolution) (DDR) und [Pump It Up](https://en.wikipedia.org/wiki/Pump_It_Up_(video_game_series)) (PIU). ([StepMania](https://wikipedia.org/wiki/StepMania) ist ein halbwegs bekannter, von der Community betriebener Klon dieser beiden Spiele).

Beim Spielen mit Tanzmatten "tanzen" Spieler auf der Matte, um Befehle einzugeben. DDR-Pads haben 4 Felder: hoch, runter, links und rechts. DDR-Solo-Pads fügen oben-links und oben-rechts hinzu. PIU-Pads have 5 Felder: oben-links, oben-rechts, unten-links, unten-rechts und in der Mitte. Es gibt auch einige 9 Pads, die sowohl mit PIU als auch mit DDR kompatibel sind, ohne dass ein Pad ausgetauscht werden muss. Normale DDR- und PIU-Pads werden oft im Doppelmodus in ihrem jeweiligen Spiel verwendet, wobei ein Spieler 2 Felder für einen Song benutzt. DDR-Solo-Spiele sind alle im Einzelspielermodus, daher sind sie in der Regel nicht verdoppelt.
