...
**Single-tapping** is a tapping style for [osu!](/wiki/Game_mode/osu!) game mode in which players click circles, slide sliders, and spin spinners using only one key on their keyboard (`Z` or `X` by default). This style is common amongst players of all skill levels and is the easiest to adapt to.
