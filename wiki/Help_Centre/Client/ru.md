...
### Как сохранить реплей? {#save-replay}
...
### osu! не может подключиться даже после добавления в исключения {#firewall-whitelist-useless}
...
### При игре на планшете курсор движется очень медленно {#slow-cursor}
