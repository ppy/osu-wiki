...
如果你的 osu!supporter 有效，你可以在谱面页面中查看你所有上传过成绩的谱面。方法是在谱面页面的分类中选择 “Ranked & Approved” ，然后在“玩过”分类中选择“玩过”（请先展开全部选项）。或者你也可以[点击这里](https://osu.ppy.sh/beatmapsets?played=played&s=7)直接访问，免去手动选择的麻烦。
