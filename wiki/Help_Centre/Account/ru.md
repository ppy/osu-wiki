...
Страна, показываемая в профиле, фиксируется при регистрации. Для определения страны используется адрес интернет-соединения, через которое вы зарегистрировались.

Ранее флаг в профиле можно было поменять при наличии документов, подтверждающих проживание в стране. После многочисленных случаев обмана мы решили отказаться от этой возможности.
