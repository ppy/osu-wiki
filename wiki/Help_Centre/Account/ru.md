...
Ниже — список распространённых проблем, связанных с игровым аккаунтом, и их возможных решений.

## Саппортер

### После покупки саппортера ничего не происходит
...
Если саппортер не пришёл в течение 24 часов, опишите проблему на английском в письме на [support@ppy.sh](mailto:support@ppy.sh).
...
Если вы попали в рестрикт, причину можно узнать у службы поддержки.

При читерстве, очень плохом поведении и других случаях, когда ваша вина доказана, апелляцию можно отправлять не ранее, чем через **три (3) месяца** с момента нарушения.
...
### Что такое турнирный бан?

Это запрет на участие во всех турнирах, имеющих официальную поддержку.

Турнирный бан выдаётся за намеренное нарушение правил osu! в ходе матча. Сюда входят любые попытки получить нечестное преимущество над оппонентами во время официального турнира, плохое отношение к участникам или организаторам турнира, а также попытки сорвать турнир или помешать его проведению.

Большинство турнирных банов выдаётся на конкретный срок (3 месяца, год и т.д.), но есть и бессрочные баны. Вне зависимости от длительности, любой турнирный бан **окончателен**, и его, в отличие от рестрикта, нельзя обжаловать.

## Доступ к аккаунту

### Не удаётся вспомнить логин или пароль

**Аккаунт можно восстановить с помощью [страницы сброса пароля](https://osu.ppy.sh/home/password-reset), если у вас есть доступ к привязанной к нему почте.**
...
### Ошибка 'Bancho authentication error'
...
### Веб-сайт пишет, что я слишком часто пытаюсь зайти
...
### Письма от osu! не приходят (или нет доступа к почте)
...
Если у пользователя **ненулевой плейкаунт** (учитываются все режимы), к 6 месяцам неактивности добавляется **дополнительное** время ожидания. Его можно [вычислить по формуле](https://www.desmos.com/calculator/b89siyv9j8), подставив вместо `v` чужой плейкаунт. Это необходимо, чтобы игроки не отбирали ники у активных пользователей или тех, кто перестал играть относительно недавно.

### Можно ли отменить смену ника?
...
### Можно ли скрыть историю изменений ника?

**Да, но с оговорками.**

Всю историю изменений убрать из профиля нельзя, но можно удалить отдельные пункты. Если какой-то из ваших прошлых ников выдаёт персональную информацию (например, имя) или позволяет найти ваш профиль на других веб-сайтах, свяжитесь со службой поддержки по адресу [accounts@ppy.sh](mailto:accounts@ppy.sh).

## Другие проблемы

### Неправильный флаг в профиле

**Вы вправе взять себе флаг страны, в которой проживаете.**

Страна, показываемая в профиле, определяется по месту регистрации аккаунта. К примеру, если вы ездили на зимние каникулы в Бельгию и там зарегистрировались в osu!, у вас будет бельгийский флаг и бельгийские таблицы рекордов по стране.

О смене флага можно попросить, если вы **на самом деле проживаете в другой стране**.

Для этого свяжитесь со [службой поддержки](/wiki/People/The_Team/Account_support_team) и приложите к письму доказательство вашей связи со страной. Это может быть паспорт, вид на жительство, водительское удостоверение или другой документ, подтверждающий личность. Его необходимо сфотографировать на фоне монитора с запущенным клиентом osu!, где выполнен вход в ваш аккаунт.

Ваши личные данные не будут никому переданы. Более того, мы рекомендуем их замазать (разумеется, так, чтобы по документу можно было определить страну выдачи!).

### Можно ли иметь несколько аккаунтов?

**Нет.**

Если у каждого игрока будет по нескольку аккаунтов, то таблицы рекордов станут никому не нужны.
...
osu! занимает позицию строго против мультиаккаунтов, в связи с чем каждый игрок может иметь только один аккаунт — первый им зарегистрированный.

Если вы владеете несколькими аккаунтами, свяжитесь с [accounts@ppy.sh](mailto:accounts@ppy.sh), чтобы уладить этот вопрос.

### Можно ли сбросить всю игровую статистику?
...
Пожалуйста, не пытайтесь обойти данный запрет и не регистрируйтесь заново для «сброса»: это против [правил](/wiki/Rules#community-rules), и ваш аккаунт будет забанен, как только о нём станет известно.

### Можно ли удалить свой аккаунт?

*О том, как удалить свой аккаунт, см. в статье [Политика конфиденциальности § Ваши права](/wiki/Legal/Privacy#your-rights-and-control).*

*Внимание: удаление аккаунта нельзя отменить, это навсегда.*

**Да** — свяжитесь с [privacy@ppy.sh](mailto:privacy@ppy.sh). Имейте в виду, что аккаунт будет удалён **насовсем**: это действие необратимо. Заново регистрироваться также нельзя, поскольку владение несколькими аккаунтами нарушает [правила](/wiki/Rules#community-rules). Таким образом, после удаления аккаунта вы никогда не сможете пользоваться любыми онлайн-возможностями osu!.

### Можно ли играть с чужого компьютера?
...
### Где найти все сыгранные или скачанные карты?
