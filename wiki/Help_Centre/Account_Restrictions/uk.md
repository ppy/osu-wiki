...
- **Зачекайте 24 години.** Деякі рестрiкти - результат автоматичного процесу. Ми веревіряємо репорти кожен день, будь ласка, зачекайте 24 години - якщо ваша лiмiтацiя була випадкова, вона буде знята в цьому періоді.
...
## Що я можу робити під час кулдауну?

- **Продовжуйте отримувати задоволення від гри!** Коли ваш акаунт є обмеженим і ви сидите в кулдауні, вам дозволено продовжувати гру на ньому (поки ви граєте на вашому оригінальному обліковому записі!). Результати, котры ви досягнете під час обмеження будуть надіслані на сервера, і якщо ваш запис буде відновлений, вони повернуться після розблокування його.
- **Підтримуйте хорошу поведінку.** Ми розуміємо, що обмеження може бути розчаруванням для вас, але ми думаємо, що це хоч якийсь шанс мати відпочинок від спiльноти. Спробуйте оминати взаємодію з общиною хоча б декілька днів (де б це не було: через Discord, соціальні мережі, інші способи контактування) для заспокоєння себе та розмірковування над діями, які могли внести в ваш обліковий запис причини для обмеження.
