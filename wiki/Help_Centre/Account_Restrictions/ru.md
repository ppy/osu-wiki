...
- **Подождите 24 часа.** Некоторые рестрикты могут быть наложены автоматически. Если аккаунт был ограничен по ошибке, то ограничение будет снято в течение 24 часов, так как новые случаи рестриктов проверяются ежедневно.
- **Свяжитесь со [службой поддержки по вопросам аккаунтов](/wiki/People/The_Team/Account_support_team).** Если аккаунт остался в рестрикте после ожидания, напишите письмо на [accounts@ppy.sh](mailto:accounts@ppy.sh) **с электронной почты, привязанной к аккаунту**, чтобы выяснить подробности. Приведите в письме свой ник, а также все возможные причины, по которым аккаунт мог попасть в рестрикт. Чем больше подробностей, тем проще будет решить проблему.
- Если вы точно убеждены, что рестрикт был ошибочным, свяжитесь с нами как можно скорее для пересмотра ограничений.

Если аккаунт попал в рестрикт за нарушение [правил](/wiki/Rules), то перед отправки апелляции обязательно должно пройти как минимум три месяца.

Если ваш основной аккаунт не попал в рестрикт, им можно пользоваться дальше. Не используйте свой мультиаккаунт, так как это может привести к дальнейшим санкциям.
...
Кроме того, в течение одного года нельзя будет изменять флаг аккаунта.

В некоторых случаях в условия снятия рестрикта входит запрет на участие в официальных турнирах и турнирах с наградой в виде значка в профиле, как в роли участника, так и в роли одного из организаторов турнира. Длительность такого ограничения составляет 1 год за нарушение (если у пользователя это уже вторая апелляция, бан длится 2 года). В письме со снятием рестрикта будет указан срок ограничения.
...
Иногда в рестрикт можно автоматически попасть уже после одобрения апелляции. В случае ошибки рестрикт будет снят в течение 24 часов. Если с вами случилось ровно это, не стесняйтесь писать в твиттер [@osusupport](https://twitter.com/osusupport) или письма по адресу [accounts@ppy.sh](mailto:accounts@ppy.sh).

После некоторых нарушений статистику аккаунта могут сбросить (частично или полностью). Это делается для того, чтобы удалить нечестно полученные рекорды **во всех режимах игры**, а также разблокированные медали и значки. **Количество игр и время игры сброшено не будет.**
...
## Мои письма игнорируют / Мне кажется, что мою апелляцию не полностью рассмотрели
...
**Пересмотр апелляций принимается только по адресу [appeal-review@ppy.sh](mailto:appeal-review@ppy.sh).** Пожалуйста, не пытайтесь связаться с командой osu! (или с добровольцами из других команд) через Twitter, Discord или любую другую платформу, чтобы обойти это ограничение, — они вам ничем не смогут помочь.

## Наиболее частые причины рестрикта и кулдауны
...
| Передача аккаунта третьим лицам | 3 месяца | Необходимость апелляции, годовой турнирный бан, частичный сброс аккаунта. |
| Использование читов | 3 месяца | Необходимость апелляции, годовой турнирный бан, полный сброс аккаунта. |
| Серьёзные нарушения правил | По-разному | Необходимость апелляции, длительность кулдауна зависит от нарушений. |
| Использование читов/передача аккаунта для турнира | 6 месяцев | Необходимость апелляции, частичный сброс аккаунта, турнирный бан навсегда. |
| Повторные нарушения | 6 месяцев | Необходимость апелляции, частичный сброс аккаунта, годовой турнирный бан за каждое нарушение. |
