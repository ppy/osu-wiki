...
- **Autres cas.** L'équipe de support aux comptes se réserve le droit de restreindre un compte pour des cas qui ne font pas partie des trois ci-dessus.
...
- **L'historique du compte.** Il n'est pas utile de trop le détailler. ela devrait inclure toutes vos infractions aux principales règles (multi-comptes, partage de compte, triche ou silences majeurs). Vous ne devez pas vous souvenir de toutes les dates, de chaque silence, ou chaque compte que vous avez créé, tant que vous restez honnête sur ce que vous avez fait. Cela inclut les règles que vous avez brisé tout en étant restreint, si c'est le cas.
- **Pourquoi vous avez brisé les règles.** Une explication de ce qui vous a mené à créer de nouveaux comptes, donner votre compte, tricher, etc. nous (et vous) aidera à déterminer si vous risquez de recommencer ou non. Si vous avez continué à commettre des infractions durant votre restriction, nous aimerions également savoir pourquoi.
...
- **Pourquoi nous devrions vous faire revenir.** La plupart du temps, ce point s'attache au second. Nous voulons nous assurer que vous ne recommencerez pas! Comprenez que  plus vous avez commis d'infractions, plus nous attendrons dans cette section de votre appel.
...
Par ailleurs, pour une période d'un an, nous n'accepterons pas de changement de drapeau sur votre compte.
...
Tous les mails envoyés à l'adresse de revue d'appels seront examinés par un tiers qui n'est pas impliqué dans les opérations quotidiennes de l'équipe de support et seront signalés pour une révision ou davantage de revue.

Veuillez comprendre que l'envoi d'un mail à cette adresse ne garantit qu'une deuxième revue ou la réponse initiale à votre appel, cela ne garantit pas un changement dans les résultats si vous avez enfreint les attentes impliquées dans le processus d'appel.

**Nous ne répondrons qu'aux requêtes de revue d'appels envoyés à [appeal-review@ppy.sh](mailto:appeal-review@ppy.sh).** N'essayez pas de contacter les membres de l'équipe osu! (ou les membres des équipes bénévoles) via Twitter, Discord ou toute autre plate-forme afin de contourner cette politique - ils ne peuvent pas vous aider.
