...
If an account has been found to be rightfully restricted, we will ask that the user waits for some time before sending their appeal. This is referred to as a _cooldown_, and its duration varies depending on the offences that have taken place.
