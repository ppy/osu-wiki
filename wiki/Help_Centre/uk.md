...
#### Я заплатив за тег прихильника, але я до сих пір його не маю!
...
Якщо пройшло більше ніж 24 години і ви до сих пір не маєте вашого тега прихильника, будь ласка, напишіть на нашу пошту [support@ppy.sh](mailto:support@ppy.sh) і розкажіть про вашу проблему.
...
Посилаючись до *[Обмеження облікових записів](/wiki/Help_Centre/Account_Restrictions)*, для більшої інформації про обмеження обліковки і для процесів апеляції.

### Вхід

#### Я забув свій нікнейм і пароль!

**Будь ласка, використовуйте [сторінку відновлення паролю](https://osu.ppy.sh/home/password-reset) для того, щоб отримати ваш обліковий запис автоматично, якщо ви до сих пір маєте доступ до поштової скриньки, з якою ви реєструвались.**

Якщо це не працює для вас (або ви не маєте доступу до вашої реєстраційної поштової скриньки), будь ласка, відправте нам повідомлення в нашу [команду допомоги](mailto:accounts@ppy.sh) зі всією інформацією, яка на вашу думку, може допомогти нам визнати, що ви є творцем цього облікового запису.
...
#### Мій обліковий запис був викраний!
...
Якщо це не працює для вас, будь ласка, відправте нам квиток допомоги негайно в [accounts@ppy.sh](mailto:accounts@ppy.sh) із найбільш індентифікуючою інформацією, як можливо, яка допоможе нам довести, що ви творець цього облікового запису.
...
Будь ласка, не включайте до складу реплей або дані реплею в ваш квиток - ми не зможемо використовувати це, щоб ідентифікувати ваше право власності на цей обліковий запис.
...
**Тут може бути проблема з вашою поштою, на яку прив\'язаний обліковий запис.**

Якщо ви пам\'ятаєте вашу пошту, на яку обліковий запис був прив\'язаний, або ви думаєте, що знаєте, спробуйте зайти в секцію поштової скриньки в [налаштування обліковки](https://osu.ppy.sh/home/account/edit), щоб змінити вашу пошту. Заповніть необхідні поля і натисніть на `Update`, коли ви готові.

Якщо ви загубили пароль від вашого облікового запису, або ви реально забули поштову скриньку, яку ви використовуєте, напишіть в [accounts@ppy.sh](mailto:accounts@ppy.sh). Будь-яка інформація, яку ви маєте про ваш запис (ваш нікнейм, будь-які скріншоти, які показують, що ви зайшли в клієнт, минулі транзакії через магазин, покупки сапорта та ін.) допоможе нам!
...
Якщо ви купили (або вам подарували) [тег прихильника](https://osu.ppy.sh/home/support) в цей момент, ви матимите змогу змінити ваш нікнейм **один раз** бесплатно. Ця зміна імені може бути викуплена в [osu!store](https://osu.ppy.sh/store/products/32).
...
Ми дозволяємо це зробити лиже раз на обліковий запис, то ж, будь ласка, будьте обережні перед тим, як подавати заявку!
...
Щоб підтвердити легітимність, команда запитає для доказу вашого проживання деякі речі - це може бути паспорт, ліцензія водія вашої країни, або якусь іншу форму ID. Ці речі також мають бути біля вашого монітора з відкритим клієнтом osu! і обліковий запис має бути в ньому залогінений.
...
Ми розглядаємо екстра "відновлення статистики" покупки в osu!store лише для хардкор гравців, які нічого хочуть, крім ідеалу в їхніх статистиках, але на сьогодні, ми не можемо очистити статистику обліковки для вас.
...
**Сторінка користувача є спеціальним елементом профіля юзера з [тегом прихильника](https://osu.ppy.sh/home/support). Вони можуть містити в собі все, що ви хочете - зображення ваших досягнень, ваших карт, в основному все, що ви побажаєте!**

Гравці з [тегом прихильника](https://osu.ppy.sh/home/support) мають привілеї редактування їхньої власної сторінки для показу самої веб-сторінки для всього світу. Сторінка користувача може мати все, що ви захочете до тих пір, поки воно підходить під [правила общини](/wiki/Rules)!
