...
#### Я заплатив за тег сапортера, але я до сих пір його не маю!

**В залежності від того, який платіжний сервіс ви використали (Paypal або Xsolla), тут тоже бути невелика затримка в обробці вашого платежа, перед тим, як він досягне нас.**

Зазвичай, ці проблеми самі по собі зникають за менше, ніж декілька годин, і наші системи автоматично застосують ваш тег до вашого акаунту.

Якщо пройшло більше ніж 24 години і ви до сих пір не маєте вашого сапорт тега, будь ласка, напишіть на нашу пошту [support@ppy.sh](mailto:support@ppy.sh) і розкажіть про вашу проблему.
...
**Персона з обмеженим акаунтом - це тимчасове або постійне обмеження від взаємодії з общиною в багатодіючому шляху, в тому числі переписування, участь в мультиплеєрі і його результати в таблиці лідерів.**

Якщо ваш акаунт став обмежений, ви, скоріше всього, дізнаєтесь, чому, після короткої розмови з підтримкою osu!.
...
Посилаючись до *[Обмеження акаунтів](/wiki/Help_Centre/Account_Restrictions)*, для більшої інформації про обмеження акаунтів і для процесів апеляції.

### Вхід

#### Я забув свій нікнейм і пароль!

**Будь ласка, використовуйте [сторінку відновлення паролю](https://osu.ppy.sh/home/password-reset) для того, щоб отримати ваш акаунт автоматично, якщо ви до сих пір маєте доступ до поштової скриньки, з якою ви реєструвались.**

Якщо це не працює для вас (або ви не маєте доступу до вашої реєстраційної поштової скриньки), будь ласка, відправте нам повідомлення в нашу [команду допомоги](mailto:accounts@ppy.sh) зі всією інформацією, яка на вашу думку, може допомогти нам визнати, що ви є творцем цього акаунту.

Хороша інформація може також вміщати в собі:

- Ім\'я поштової скриньки на яку ви зареєстрували акаунт, або інші скриньки, із якими він був асоційований раніше
- Будь-які квитанції з купленим тегом osu!supporter або інші речі, які знаходяться в osu!store
- Остання дата, яку ви пам\'ятаєте, за яку ви мали нормальний доступ до вашого акаунту
...
Якщо це не працює для вас, будь ласка, відправте нам квиток допомоги негайно в [accounts@ppy.sh](mailto:accounts@ppy.sh) із найбільш індентифікуючою інформацією, як можливо, яка допоможе нам довести, що ви творець цього акаунту.

Повідомлення від вашого реєстраційного адреса буде великий бонус в цьому моменті, як і інша інформація, яку може надати лише творець акаунту.

Будь ласка, не включайте до складу реплей або дані реплею в ваш квиток - ми не зможемо використовувати це, щоб ідентифікувати ваше право власності на цей акаунт.

#### Веб-сайт говорить мені, що я спробував зайти в свій акаунт забагато разів!

**Це тимчасовий захист, який проявляється після повторних помилкових спроб надати доступ до вашого акаунту. Спробуйте зайти ще раз декілька 10-20 хвилин.**
...
**Тут може бути проблема з вашою поштою, на яку прив\'язаний акаунт.**

Якщо ви пам\'ятаєте вашу пошту, на яку акаунт прив\'язаний, або ви думаєте, що знаєте, спробуйте зайти в секцію поштової скриньки в [налаштування акаунту](https://osu.ppy.sh/home/account/edit), щоб змінити вашу пошту. Заповніть необхідні поля і натисніть на `Update`, коли ви готові.

Якщо ви загубили пароль від вашого акаунту, або ви реально забули поштову скриньку, яку ви використовуєте, напишіть в [accounts@ppy.sh](mailto:accounts@ppy.sh). Будь-яка інформація, яку ви маєте про ваш акаунт (ваш нікнейм, будь-які скріншоти, які показують, що ви зайшли в клієнт, минулі транзакії через магазин, покупки сапорта та ін.) допоможе нам!
...
#### Чи я можу змінити нікнейм свого акаунта?

**Так, абсолютно!**

Якщо ви купили (або вам подарували) [тег сапортера](https://osu.ppy.sh/home/support) в цей момент, ви матимите змогу змінити ваш нікнейм **один раз** бесплатно. Ця зміна імені може бути викуплена в [osu!store](https://osu.ppy.sh/store/products/32).
...
Будь ласка, візьміть на примітку, що нікнейми мають дотримуватись нашими [правилами](/wiki/Rules), а точніше, вони не мають бути сильно образливими до інших користувачів, провокаційними або іншими запальними символами. В додатку, нікнейми які видають себе за іншого або ідентифікують громадських діячів (наприклад, знаменитостей, політиків та ін.) - не дозволені і будуть відвернуті, якщо ми взнаємо про них.

Якщо ви лише після незначної капіталізації або граматичниг/правописних змін, ви можете написати в [accounts@ppy.sh](mailto:accounts@ppy.sh), щоб надіслати запит на безплатну зміну імені, щоб виправити ці помилки. Ми не стягнем плату з вас за сорти таких змін, але ви **МАЄТЕ** зробити їх через поштову скриньку підтримки. Тримайте на думці, ми це робимо лише лімітовану кількість разів, тому будьте впевнені, що ви реально хочете це!
...
Ми дозволяємо це зробити лиже раз на акаунт, то ж, будь ласка, будьте обережні перед тим, як подавати заявку!

#### Мій нікнейм був змінений/повернутий назад!

**Ми робимо повернення нікнеймів лише тоді, коли ми бачимо їх недоречними або образливими.**
...
Якщо зміна імені була зроблена за допомогою бесплатної зміни, яка йде разом з сапортером, ми не можемо дати пропозицію, щоб змінити його ще раз.
...
#### Прапор на мому акаунті є неправильний!
...
Якщо ви створили акаунт під час канікул в США, ваш профіль буде асоціювати вас до США - ви також будете асоційовані в рейтингу країни США.

Команда допомоги з радістю змінить профіль на вашому акаунті через запит, **але лише якщо ви на цей час проживаєте в цій країні.**

Щоб підтвердити легітимність, команда запитає для доказу вашого проживання деякі речі - це може бути паспорт, ліцензія водія вашої країни, або якусь іншу форму ID. Ці речі також мають бути біля вашого монітора з відкритим клієнтом osu! і акаунт має бути в ньому залогінений.
...
#### Чи я можу зареєструвати більше, ніж один акаунт?

**На жаль, ні, ви не можете.**

Якщо ми дозволимо всім робити і грати на багатьох акаунтах, таблиця лідерів буде не точна!

Інші ігри мають багато проблим з цим, їх найчастіше звуть "смурфами" - акаунти з низьким часом гри і підсумки, які інфілюють таблицю рекордів і перешкоджають іншим гравцям грати конкурентно.

В osu!, ми против того, щоб користувачі мали декілька акаунтів, і ми маємо строге правило лише одного облікового запису на одну персону, завжди.

Ви маєте грати на першому акаунті, який ви вперше зареєстрували, і це все!

#### Чи можливо почати з початку чи зробити очистку статистики мого акаунту?

**Не в цей момент.**

Ми розглядаємо екстра "відновлення статистики" покупки в osu!store лише для хардкор гравців, які нічого хочуть, крім ідеалу в їхніх статистиках, але на сьогодні, ми не можемо очистити статистику акаунту для вас.

Ми не маємо на увазі, що ви можете робити новий акаунт для таких самих речей! Мати декілька акаунтів строго заборонено в нашій общині, і ми зробимо непрацездатними ті акаунти, які звернули нашу увагу.
...
Як тільки ви граєте на свому акаунті, ви можете грати osu! де завгодно.
...
**Ви можете побачити всі карти які ви грали на веб-сайті.**
...
На новому сайті, цей фільтр може бути знайдений по натиску "більше параметрів пошуку" в [сторінці списку карт](https://osu.ppy.sh/beatmapsets), тоді "Зіграно" в "Зіграно" секції. Альтернативно, ви можете використати [це посилання](https://osu.ppy.sh/beatmapsets?played=played), щоб безпосередньо отримати доступ до відфільтрованої сторінки.
...
Цей недолік іноді виникає інтеракцією з режимом сумісності, або просто-напросто гра не може знайти браузер за замовчуванням, щоб відкритьи посилання за допомогою нього.
...
**Ви можете примусити гру обновитись через меню налаштувань.**

1. Відкрийте osu!.
2. Відкрийте меню `Налаштування` або натисніть `Control` + `O` зазвичай.
3. Напишіть `update` в швидкий пошук, щоб стрибнути прямо до опції.
4. Натисніть на кнопку `Run osu! updater`.
...
**Будьте впевнені, що ви не шукаєте карти в межах якихось критерій (такі як складність, швидкість проходження і т. д.).**
...
#### Мій лічильний комбо, дисплей рахунку або екран точності відсутній!
...
Зручний спосіб - якщо ви сапортер osu!, ви можете використати фільтр `Ranked (Played)` в панелі osu!direct в грі або через [сторінку списка карт](https://osu.ppy.sh/p/beatmaplist?m=-1&r=7&g=0&la=0&ra=), щоб знайти будь-які карти на яких ви ставили результати в минулому.
...
**Результати можуть іноді зайняти трохи більше часу, щоб завантажитись з ігрових серверів, якщо ви завантажили багато нових карт за раз.**

Граючи гру або роблячи щось інше дозволить клієнту наздогнати це в задньому плані.
...
Звичайна прив\'язка клавіш для цієї особливості - `C`, і це буде працювати настільки довго, скільки ви тримаєте клавішу в натиснутому стані. Ви можете перев\'язати це в любий час в діалоговому вікні налаштувань `osu! Standard Mode`, секція `Change keyboard bindings`.

#### Як я можу зберегти свій реплей на результаті який я тільки що зробив?
...
#### Я відчуваю невеликі фрізи під час геймплею!
...
**Дуже старі комп\'ютери які навіть використовують дуже стару інтегровіну графіку в Intel чіпсетах можуть бути не дуже продуктивними, щоб тримати osu!, навіть на найнижчих налаштуваннях.**
...
**І той, і інший режим створює *значну* затримку. Повноекранний режим є оптимальний для найбільш плавного ігрового досвіду.**
...
##### Ваша гра недавно оновлювалась?

**Іноді, після ігрового оновлення, клієнт може безпричинно завмирати.**
...
#### Моя гра виглядає глючно, нібито графіка рветься!
...
Це нешкідливий (хоча і потворний!) ефект, який трапляеться тому що частота оновлень гри не синхронізована з частотою оновлень монітора.
...
Вмикання VSync-у або граючи у вікні або у режимі кордонів може спричиняти *невелику* кількість затримки, на жаль. Для більшість людей, це не спричиняє великої проблеми.

Пізніше, відео-карти від NVidia мають глобальну опцію в Контролі Панель NVidia, для встановлення глобальної частоти оновленя, яку називають "Швидка", яка також усунить цю проблему.

#### Я отримую пробему на стороні сервера, коли пробую грати онлайн!

**Сервера можуть мати проблеми.**
...
Спробуйте використати інший проксі або провайдера VPN - якщо все до сих пір провалюється, надішліть квиток підтримки на поштуT [accounts@ppy.sh](mailto:accounts@ppy.sh).

Якщо ви не використовуєте нічого з цього, тоді вам також потрібно надіслати квитом підтримки, бо здається, що ваше з\'єднання було внесено в чорний список по помилці.
...
**Переконайтесь, що osu! може правильно з\'єднатись до мережі Інтернет через будь-який мережевий екран або антивірусну програму, яку ви інсталювали на комп\'ютер.**
...
##### Дозволення програми через мережевий екран Windows

**У більшості установників Windows, мережевий екран Windows може бути звичайним ПЗ для цього.**

Щоб упевнитись, що osu! має доступ до мережі Інтернет, нам потрібно дозволити його, щоб комунікувати через мережевий екран Windows. Ось як перевірити і додати osu! в список програм:
...
Будь ласка, проконсультуйтесь з [артиклем офіціальної допомоги](https://support.kaspersky.com/7834) Kaspersky в додаванню програм в Довірену Зону.
...
Якщо ви до сих пір маєте проблеми зі з\'єднанням до наших ігрових серверів, будь ласка, відправте квиток допомоги нам на пошту [accounts@ppy.sh](mailto:accounts@ppy.sh). Нижченаведена інформвція допоможе нам вирішити вашу проблему швидко:

- Лог трасерування від команди `tracert` для серверів `cho.ppy.sh`, `osu.ppy.sh` і `m1.ppy.sh` (дивіться нижче для інструкції)
...
#### Я став сапортером але мій нікнейм у грі не жовтий!

**Ви завжди будете виглядати білим перед собою у внутрішньоігровому клієнті. Інші користувачи побачать вашу славну жовтизну!**

Це допоможе ідентифікувати ваші власні повідомлення від когось іншого. На цей час, тут немає опції вимкнути цю функцію.
...
`VSync` запустить гру в вертикальній прокрутці, яка дорівнює до вашого основного монітору, коли `Power Saving` і `Optimal` буде запускати гру з подвійною або восьмикратною частотою оновлення монітора, аж до 960Hz.

Ми рекомендуємо використовувати `VSync` в ситуаціях, де температура є проблемою.

Ви також можете використати утиліти, які дозволяють вам контролювати швидкість вашого процесора і відеокарти самостійно.
...
Щоб роспізнати що може спонукати це, ми рекомендуємо вам використовувати монітор температури процесора/відеокарти і тримати очі на ньому, коли ви граєте в osu!. Хорошим вибором програми буде використовувати [Piriform Speccy](https://www.piriform.com/speccy).

Якщо ви побачите, що температура вашої відеокарти або процесора вище ніж 90C або 194F, ваш комп\'ютер перегрітий і він в близькому порозі до автоматичного виключення.
...
#### Мій курсор стає божевільним, коли я пробую грати в osu!
...
##### Що таке необроблене введення, і як я можу його увімкнути?

**Необроблене введення спонукає гру використовувати чистий і більш прямий доступ до інформації від вашої периферії. Загалом, воно збільшує точність виходу від девайса.**
...
#### Я граю на графічному пристрої і мій курсор відчувається дуже повільним!I
...
![Екран Wacom Tablet Properties показує налаштування секції Mapping](img/Tabarea.png "Інтерфейс для зміни площі планшета на девайсах від  Wacom")

Вам до сих пір потрібно проконсультвуватись з виробником планшетів для зміни площі графічного пристрою для вашої периферії.

Всі планшети з брендом osu! підтримують необроблене введення за замовчуванням, і їхня чутливість може бути легко відрегулована за допомогою необробленого введення у грі і використовуючи повзунок зміни чустливості миші.
...
Це також може траплятись із-за проблем з клавішами на цифровій клавіатура, так як вони можуть використовуватись для прокрутки списка вибора пісні. Натискання на кнопку `NumLock` для відключення цифрової клавіатури і після цього натиснути `9` або `3` на пристрої може виправити цю проблему.

Ви також можете перевірити на заклинувші або зламані клавіші на вашій переферії.

#### Я завантажив Пак Карт але osu! завжди намагається "зремонтувати" файл!

**Вам потрібно розпакувати пак напряму в папку Songs.**

Більшість паків карт з\'являються в форматі `.rar`, який означає, що вони в запакованому архіві бітмап файлів. Вам потрібно розпакувати їх, використовуючи утиліту на вибір (ми рекомендуємо [7-Zip](https://7-zip.org)), спершу в директорію Songs.
...
#### Я не отримав відповідь на мій квиток підтримки і пройшло більше, ніж 2 тижні!

**Переважна більшість часу, це із-за великої кількості квитків, які надходять в нашу систему за раз.**

Ви завжди можете перенадіслати ваш відкритий на цей час квиток заради запитання про статус вашої справи, але упевніться, що ви не робите це більше, ніж один раз або двічі за тиждень. Ви також можете контактувати з нами в Twitter в [@osusupport](https://twitter.com/osusupport) для запитання про ваш квиток.

У рідких обставинах, від хронічно ображених користовачів, квиток підтримки може бути спеціально проігнорований, хоча команда підтримки **завжди** говорить вам, що вони не можуть одразу вам відповісти. Якщо ви не отримуєте сповіщення схожих на ці, вам не потрібно турбуватись!
...
В таких ситуаціях, ви можете відкрити квиток з командою підтримки за допомогоню надсилання пошти на [accounts@ppy.sh](mailto:accounts@ppy.sh) і обговорюючи вашу ситуацію з ними.

Якщо в якомусь сенсі ви сумніваєтесь в чомусь, що щось є доречне для сторінки користувача, ви можете написати будь-якому члену [Команди Глобальної Модерації](/wiki/People/Global_Moderation_Team) з тим, що ви плануєте упевнитись, і вони повідомлять вас, якщо все нормально.
...
Якщо ви хочете ігнорувати згадування вас, приватні повідомлення, або публічні повідомлення, ви можете просто додати відповідні `@h`, `@p`, `@c` до їхнього нікнейму. `The_Gatekeeper@c` буде ігнорувати повідомлення користувача в публічних чатах. Їх також можна комбінувати: `The_Gatekeeper@ph` буде ігнорувати згадування і приватні повідомлення, але залишить публічні повідомлення відкритими для вас.
...
##### Блокування нових приватних повідомлень в форумі від вас

Зайдіть в [налаштування облікового запису](https://osu.ppy.sh/home/account/edit) і натисніть `заблокувати приватні повідомлення для людей які не є у моєму списку друзів` в секції Політика конфіденціальностію Приватні повідомлення від вашого списку друзів будуть приходити.
...
**Сторінка користувача є спеціальним елементом профіля юзера з [тегом сапортера](https://osu.ppy.sh/home/support). Вони можуть містити в собі все, що ви хочете - зображення ваших досягнень, ваших карт, в основному все, що ви побажаєте!**

Гравці з [тегом сапортера](https://osu.ppy.sh/home/support) мають привілеї редактування їхньої власної сторінки для показу самої веб-сторінки для всього світу. Сторінка користувача може мати все, що ви захочете до тих пір, поки воно підходить під [правила общини](/wiki/Rules)!

Навіть якщо [тег сапортера](https://osu.ppy.sh/home/support) закінчиться, ваша користувацька сторінка **залишиться видимою** і ви до сих пір зможете редагувати її контент.

#### Чи мені потрібно використовувати мою пошту для реєстрації?
...
Навіть якщо ви втратите ваш пароль або отримати доступ до вашого акаунту, ваша реєстраційна поштова скринька є першим пунктом для контактування з вами.
...
#### Я osu!прихильник, але я не маю 10 очікуючих слотів!

**Номер доступних слотів залежить від номера рейтингових карт які ви маєте.**

За замовчуванням, кожен користувач має 2 очікуючих слотів. Один слот додається для кожної рейтингової карти яку має юзер аж до восьми слотів. Будучи сапортером, даруються 2 додаткових слотів, від 4, (без рейтингових карт) загалом до 10.
...
Якщо в майбутньому ви будете мати будь-які питання, будь ласка, сміливо подавайте квиток на пошту [support@ppy.sh](mailto:support@ppy.sh) для уточнення вашої проблеми.

#### Світлодіоди на моїй osu! nono клавіатури не працюють!

**Це може бути із-за декілька причин - корозія між світлодіодом і материнською платою, або певні обставини з ранішніми моделями, бракованими діодами.**
...
- Від\'єднайте зчеплення від тіла вашої річки, викриття батареї всередині.
- Видаліть AAA батарейку з пера.
- Переставте батарейку з новою брендованою AAA батареєю. **Спершу перевірте, чи нова батарейка функціонує в іншому пристроїV.**
- Упевніться, що позитивний і негативний кінець батарейки правильно поставлені в ручці. Там є позначки на девайсі, які вказують вам, який кінець куди йде.
- З\'єднайте зчеплення назад з вашою ручкою.
- Ослабляйте кнопку в задньому кінці (кінець гумки) до тих пір, поки воно не клікне.

Якщо після цього ваш планшетний блок працює правильно, розміщення ручки під самим пристроєм змусить курсор на вашому екрані рухатись.
...
Для виправлення цього, забезпечте, що девайс osu!go вибраний, натисніть правою кнопкою мишки на розділ RAW і оберіть опцію `Format`. Оберіть або `NTFS`, або `exFAT` під спадним меню `Файлова Система`.
...
Будь ласка, слідуйте [цим путівником](https://staging.tails.boum.org/doc/first_steps/reset/windows.en.html) для уточнення, як робити це.
...
Якщо ви зустрічаєте якісь проблеми з цим процесом, будь ласка, відправте нам повідомлення на нашу поштову скриньку [store@ppy.sh](mailto:store@ppy.sh) і ми з радістю допоможем вам.
...
Ці файли дуже зручні і можуть зробити вирішення навіть дуже тяжких тривіальних проблем.
