...
**Full combo** (or *FC* for short) is a term used to describe a player obtaining the maximum possible combo<!-- TODO: link --> on a [beatmap](/wiki/Beatmaps). Full combos are scored by passing a beatmap with no misses<!-- TODO: link -->, [sliderbreaks](/wiki/Gameplay/Slider_break), or dropped [slider ends](/wiki/Hit_object/Slidertail).
