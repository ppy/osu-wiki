...
## ส่วนหัวของ Beatmap (Beatmap header) {#beatmap-header}
...
ปุ่ม `Beatmap Page` จะนำคุณไปยังหน้าข้อมูล Beatmap (หน้าหลักของแมพ) หรือสามารถทำได้โดยคลิกที่ [ส่วนหัวของ Beatmap](#beatmap-header)
...
## ช่องส่งข้อความ (Submission field) {#submission-field}
...
## รายการการสนทนา (Discussions) {#discussions}

![](img/discussions.jpg "พื้นที่แสดงการสนทนา")

รายการการสนทนาคือที่ที่โพสต์จาก [ช่องส่งข้อความ](#submission-field) จะไปปรากฏอยู่ ผู้ใช้คนอื่นๆ สามารถเข้ามาดูและร่วมสนทนาได้โดยการคลิกปุ่ม `Respond` หรือ `Reply` ใต้โพสต์นั้นๆ และเมื่อเขียนเสร็จให้กด `Enter` หรือคลิก `Reply` เพื่อส่งข้อความ
