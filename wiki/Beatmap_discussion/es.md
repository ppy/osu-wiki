...
¡Puede seguir nuestras imágenes de [este beatmap](https://osu.ppy.sh/beatmapsets/924551/discussion) para familiarizarse con las discusiones de beatmaps o intentar abrir una página de discusión usted mismo!
...
- Seleccione la sección adecuada a la que está enviando su mod.
...
- Si te gusta el beatmap, considera hypearlo para acercarlo a la nominación.
...
*Para obtener información sobre la configuración de metadatos, véase: [Song Setup § Song and Map Metadata](/wiki/Client/Beatmap_editor/Song_Setup#song-and-map-metadata)*
...
Las opciones de clasificación cambian la forma en que se ven las discusiones de beatmaps. Cuando se elige una opción, cambia tanto la línea de tiempo de modding como la sección de modding para incluir solo el tipo de publicación seleccionado. Esto es especialmente útil para ver publicaciones pendientes en una página de discusión. Las diferentes opciones incluyen:

- `Mío` muestra sus propias publicaciones
- `Notas` muestra cualquier nota del mapper o del [Beatmap Nominator](/wiki/People/Beatmap_Nominators)
...
La línea de tiempo visual muestra todos los mods creados para una dificultad que usan una marca de tiempo. Al hacer clic en cualquiera de estos, se desplazará hacia abajo hasta el mod publicado en esa marca de tiempo. Tenga en cuenta que cualquier opción de filtrado cambiará lo que se muestra aquí. La línea de tiempo visual es una herramienta útil para ver cuánto se ha modificado un beatmap de un vistazo. Una línea de tiempo apretada significaría que un beatmap ya ha recibido mucha atención. La configuración de la dificultad seleccionada también se muestra en la parte superior derecha de la línea de tiempo visual. De izquierda a derecha, describen la `Duración`, `BPM`, `Número de círculos` y `Número de deslizadores` de una dificultad.
...
`General (Todas las dificultades)` muestra publicaciones que se aplican a todas las dificultades. Las publicaciones comunes en esta pestaña incluyen metadatos, notas y debates sobre el beatmap en su conjunto.
...
Si publica en la pestaña `Línea de tiempo`, debe incluir una marca de tiempo en su publicación. Si su marca de tiempo está cerca de otro mod, deberá confirmar que no aborda el problema que está enviando actualmente. **¡Revisa cada publicación antes de marcar la casilla!** Puede ser beneficioso `Anclar` el campo de modding mientras se comprueban otros problemas. Habilitar el anclaje permitirá que el campo de envío se desplace contigo.
