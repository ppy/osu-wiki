...
_See [Mapping Techniques/Basics](../Basics/#Jumps) for a description on symmetry._
...
Nominator(s): [Seibei4211](https://osu.ppy.sh/u/31537)

Anti-Jumps consists of a normal set of placed hit objects, followed by a stream of notes with half the spacing (placed closer) than the previous comboset.
...
Nominator(s): [Zekira](https://osu.ppy.sh/u/36749)
...
Nominator(s): [Blue Dragon](https://osu.ppy.sh/u/19048)
...
Endpoint slider jumps uses two sliders, and a hit circle.
