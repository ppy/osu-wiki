...
Nominator(s): [m980](https://osu.ppy.sh/u/3288)
...
Nominator(s): [0_o](https://osu.ppy.sh/u/56708)
...
Nominator(s): [Dragvon](https://osu.ppy.sh/u/126927)
...
Nominator(s): QiiXshinez

The diamond formation is just like the [Square Formation](../Square_Formation) or [Square Formation v2](../Square_Formation_v2) but uses rhombi instead of squares.

### Double Stacks

Nominator(s): [-Xero-](https://osu.ppy.sh/u/179314) and [F1r3tar](https://osu.ppy.sh/u/5590317)
...
These are pretty much the same as [Square Formation](../Square_Formation), but the order of the circles forces you to go diagonally through the square.
