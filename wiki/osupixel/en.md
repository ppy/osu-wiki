...
Scaling is applied to the main coordinate system which is used for [osu! gameplay](/wiki/Gameplay). In contrast, textures are scaled such that one [texture pixel](https://en.wikipedia.org/wiki/Texel_(graphics) "Wikipedia") corresponds to one screen pixel at 1024x768 resolution.
