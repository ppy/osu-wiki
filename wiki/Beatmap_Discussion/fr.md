...
Beatmap Discussion (introduit comme _Modding v2_) est maintenant en ligne !
...
_Note : Vous devez maintenant cliquer sur `Hype` pour ajouter du hype ; donner des éloges n'ajoutera plus de hype automatiquement._
...
_Note : Les utilisateurs normaux sont limités à 60 votes par heure, alors que les membres de BN et de NAT n'ont pas cette limite._
