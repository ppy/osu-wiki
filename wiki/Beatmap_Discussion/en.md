...
Beatmap Discussion (introduced as _Modding v2_) is now live!
...
_Note: You now have to click `Hype` to add hype; giving praise will no longer add hype automatically._
...
_Note: Normal users are limited to 60 votes per hour, while BN and NAT members do not have this limit._
