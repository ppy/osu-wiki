...
Le leader du projet a changé plusieurs fois dans son histoire : ::{ flag=US }:: ::SapphireGhost::{ user=388602 } a pris la tête du projet en mai 2012,[^manager-charts-sg] suivi par ::{ flag=US }:: ::DeathXShinigami::{ user=49516 }[^manager-charts-dxs] et ::{ flag=US }:: ::Makar::{ user=686389 }.[^manager-charts-makar] ::{ flag=DE }:: ::Loctav::{ user=71366 } et ::{ flag=DE }:: ::OnosakiHito::{ user=290128 } ont repris le projet en décembre 2013.[^manager-charts-loctav]
...
Renommé en Beatmap Spotlights en mars 2017,[^charts-renommé-dans-spotlights] le système lui-même est resté majoritairement cohérent tout en ajoutant des récompenses supplémentaires comme des médailles et en améliorant encore la présentation des Beatmap Spotlights. Lors d'un remaniement interne de la Quality Assurance Team, la responsabilité du projet a été réattribuée à ::{ flag=HU }:: ::Kurokami::{ user=260933 } et a remis en place une équipe de sélection basée sur la communauté. En novembre 2018, la fréquence des Spotlights a été modifiée pour un cycle de publication saisonnier.[^spotlights-saisonnier] En mars 2020, ::{ flag=DE }:: ::Loctav::{ user=71366 } a été nommé responsable du projet avec Kurokami, en le remaniant et en rassemblant une nouvelle équipe de curators d'osu![^spotlights-remanié-20-juin].

En août 2020, ::{ flag=HU }:: ::Kurokami::{ user=260933 } a quitté la direction du projet. Fin novembre 2020, ::{ flag=DE }:: ::Loctav::{ user=71366 } a également démissionné, et ::{ flag=PL }:: ::Venix::{ user=5999631 } a repris le projet avec ::{ flag=US }:: ::pishifat::{ user=3178418 }.

Après la conclusion de la saison du printemps 2021, le projet a été mis en pause, ce qui a duré jusqu'en septembre 2021, lorsque des efforts de relance ont émergé, avec ::{ flag=US }:: ::pishifat::{ user=3178418 } se retirant de son rôle de gestionnaire, et ::{ flag=TN }:: ::Hivie::{ user=14102976 }. En février 2022, le projet a repris ses activités après quelques changements structurels et d'équipe.

En octobre 2023, ::{ flag=AU }:: ::Crumpey::{ user=3518705 } a été nommé chef de projet pour aider à l'organisation générale du projet. En novembre 2023, ::{ flag=TN }:: ::Hivie::{ user=14102976 } a quitté ses fonctions.
