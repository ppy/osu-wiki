...
La temporada actual es la temporada Primavera 2023.
...
1. Una sola temporada dura 9 semanas y alterna entre 3 listas de reproducción.
   - Cada lista de reproducción está etiquetada con una letra.
   - Cada lista de reproducción consta de 2 dificultades Hard, 3 Insane y 4 Expert.
   - Durante las primeras 6 semanas, cada lista de reproducción tendrá una duración de 2 semanas.
   - Durante las últimas 3 semanas, cada lista de reproducción durará 1 semana.
2. El cronograma de cada temporada se anuncia al inicio de la misma.
3. La primera lista de reproducción de cada temporada será una lista de reproducción temática de algún tipo de característica especial.
...
### Tabla de clasificación estacional
...
2. Los participantes solo pueden poseer una puntuación clasificada semanal por lista de reproducción.
   - Volver a jugar una lista de reproducción otra semana hará que **solo cuente la mejor puntuación semanal**, sobrescribiendo la peor.
3. La tabla de clasificación se actualizará después de la conclusión de cada lista de reproducción.
   - A los participantes no se les informará su puntuación estacional exacta, sino que se les asignará a grupos de liga.
   - La tabla de clasificación se publicará en el [discord osu! community](https://discord.gg/0Vxo9AsejDkGlk3H), en el canal `#osu-spotlights` así como en el chat de la sala de la siguiente lista de reproducción.

### Recompensas

Las recompensas se distribuyen a los ganadores de la sala de juego de la lista de reproducción, a los creadores de las selecciones del Beatmap of the Season y a todos los participantes presentes en la tabla de clasificación de la temporada.

Los 10 mejores jugadores de cada sala de juego de las listas de reproducción recibirán **1 semana de [osu!supporter](/wiki/osu!supporter)**.
...
El umbral de nivel de Rhythm Incarnate se elige manualmente en función del recuento de participantes de la temporada y el tamaño general de otros niveles, aunque es un número absoluto que oscila entre los 2 primeros y los 50 primeros en la mayoría de los casos.

Esta tabla solo muestra una de las cuatro versiones de insignia. Cada modo de juego tiene su propia versión de insignia.
...
- `#beatmap-spotlights` en el [servidor de Discord osu! community](https://discord.gg/0Vxo9AsejDkGlk3H)
- `#osu-spotlights` en el [servidor de Discord osu!dev](https://discord.gg/ppy)
...
El proyecto sufrió varios cambios y adiciones, como [tablas de clasificación temáticas](https://osu.ppy.sh/rankings/osu/charts?spotlight=26), [tablas de clasificación restringida de mods](https://osu.ppy.sh/rankings/osu/charts?spotlight=19) o [tablas de clasificación de temporada](https://osu.ppy.sh/home/news/2014-07-18-june-2014-ranking-chart). Originalmente, los ganadores de las tablas de clasificación recibían etiquetas de [osu!supporter](/wiki/osu!supporter). Posteriormente, se agregaron recompensas para los mappers o los ganadores de la clasificación de temporada.
