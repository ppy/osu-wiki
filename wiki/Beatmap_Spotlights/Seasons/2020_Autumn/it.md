...
# Beatmap Spotlights Stagione 2 (Autunno 2020)
...
Al momento, per partecipare alle lobby multiplayer settimanali è necessario scaricare e installare [osu!(lazer)](/wiki/Client/Release_stream/Lazer).

1. Le lobby saranno aperte per tutta la settimana.
2. La playlist prevede anche l'utilizzo di mod.
   - Le mappe con le mod sono duplicati delle originali e il loro scopo è quello di dare una sfida ai giocatori esperti.
   - osu!taiko non è in grado di presentare le mod a causa di alcune limitazioni di lazer in questa stagione.
