...
# Beatmap Spotlights Stagione 3 (Inverno 2021)

## Programma

| Evento | Periodo |
| :-- | :-- |
| Inizio Stagione | 18 gennaio 2021 |
| Lobby Temporanea: Playlist A | 18 gennaio - 25 gennaio 2021 |
| Lobby Temporanea: Playlist B | 25 gennaio - 1 febbraio 2021 |
| Lobby Temporanea: Playlist C | 1 febbraio - 8 febbraio 2021 |
| Lobby Temporanea: Playlist D | 8 febbraio - 15 febbraio 2021 |
| Pausa | 15 febbraio - 22 febbraio 2021 |
| Lobby Temporanea: Playlist A | 22 febbraio - 1 marzo 2021 |
| Lobby Temporanea: Playlist B | 1 marzo - 8 marzo 2021 |
| Lobby Temporanea: Playlist C | 8 marzo - 15 marzo 2021 |
| Lobby Temporanea: Playlist D | 15 marzo - 22 marzo 2021 |
| Fine Stagione | 22 marzo 2021 |
...
1. Ogni venerdì di una stagione, viene aperta una singola lobby multigiocatore a turni. Tutti possono partecipare per l'intera settimana.
   - Ci sarà una settimana di pausa dopo la quale le lobby per ogni playlist verranno riaperte a cadenza settimanale.
2. Ogni lobby multiplayer temporanea fornisce una playlist predefinita di beatmap.
   - Ogni playlist è un sottoinsieme dell'intero roster di beatmap curate per la stagione in corso.
   - Ogni playlist contiene una distribuzione uniforme di beatmap Hard, Insane ed Expert.
   - Ogni playlist corrisponde alla lettera assegnata a ciascuna settimana. Pertanto, ogni playlist viene rigiocata una volta durante la stagione.
3. All'interno di una lobby a turni, tutti competono per ottenere una classifica specifica della stanza.
   - Le classifiche delle lobby si basano sul sistema di punteggio classificato. Pertanto, solo i migliori risultati di ogni beatmap all'interno della playlist vengono sommati per creare un punteggio classificato settimanale per ogni utente.
   - Ogni beatmap di una playlist conta allo stesso modo per il punteggio della classifica. Le difficoltà maggiori non forniscono ulteriore punteggio.
   - Il punteggio delle singole beatmap si basa sul sistema di punteggio di osu!(lazer).
4. Una volta conclusa una lobby a turni, il punteggio settimanale di ogni partecipante alla stanza verrà aggiunto alla classifica stagionale.
