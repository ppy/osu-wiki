...
# Beatmap Spotlights ซีซัน 3 (ฤดูหนาว 2021)

## กำหนดการ

| อีเวนต์ | เวลา |
| :-- | :-- |
| เริ่มฤดูกาล | 18 ม.ค., 2021 |
| Timeshift lobby: เพลย์ลิสต์ A | 18 ม.ค. - 25 ม.ค., 2021 |
| Timeshift lobby: เพลย์ลิสต์ B | 25 ม.ค. - 1 ก.พ., 2021 |
| Timeshift lobby: เพลย์ลิสต์ C | 1 ก.พ. - 8 ก.พ., 2021 |
| Timeshift lobby: เพลย์ลิสต์ D | 8 ก.พ. - 15 ก.พ., 2021 |
| ช่วงพัก | 15 ก.พ. - 22 ก.พ., 2021 |
| Timeshift lobby: เพลย์ลิสต์ A | 22 ก.พ. - 1 มี.ค., 2021 |
| Timeshift lobby: เพลย์ลิสต์ B | 1 มี.ค. - 8 มี.ค., 2021 |
| Timeshift lobby: เพลย์ลิสต์ C | 8 มี.ค. - 15 มี.ค., 2021 |
| Timeshift lobby: เพลย์ลิสต์ D | 15 มี.ค. - 22 มี.ค., 2021 |
| ปิดฤดูกาล | 22 มี.ค., 2021 |
...
1. ทุกวันศุกร์ของฤดูกาล จะเปิดห้อง timeshift multiplayer หนึ่งห้อง ทุกคนสามารถเข้าร่วมได้ตลอดทั้งสัปดาห์
   - จะมีช่วงพัก 1 สัปดาห์ จากนั้น lobby ของแต่ละเพลย์ลิสต์จะกลับมาเปิดอีกครั้งแบบรายสัปดาห์
2. แต่ละ timeshift multiplayer lobby จะมีเพลย์ลิสต์บีตแมปที่กำหนดไว้ล่วงหน้า
   ...
   - แต่ละเพลย์ลิสต์จะตรงกับตัวอักษรที่กำหนดให้แต่ละสัปดาห์ ดังนั้นแต่ละเพลย์ลิสต์จะถูกเล่นซ้ำหนึ่งครั้งต่อฤดูกาล
...
4. เมื่อ timeshift lobby จบลง คะแนน ranked score รายสัปดาห์ของผู้เข้าร่วมแต่ละคนในห้องจะถูกนำไปเพิ่มใน leaderboard ประจำฤดูกาล
