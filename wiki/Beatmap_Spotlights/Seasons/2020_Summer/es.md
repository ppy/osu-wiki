...
2. Cada sala multijugador temporal proporciona una lista de juego predefinida de beatmaps.
   ...
   - Cada lista de juego se corresponde con la letra asignada a cada semana. Por lo tanto, cada lista de juego se vuelve a jugar 3 veces durante una temporada.
...
Las siguientes tablas de clasificación también están disponibles como una [hoja de cálculo de Google](https://docs.google.com/spreadsheets/d/e/2PACX-1vRF46ZtScaNWb5KLAF0-CwJhTySle5r3xVhg15x1nTOXYrMWNpRx8HbsRizaQ2AwJpKARJRTtyHbdxs/pubhtml#).

### osu!

| Puesto | Nombre | Insignia |
| --: | :-- | :-: |
