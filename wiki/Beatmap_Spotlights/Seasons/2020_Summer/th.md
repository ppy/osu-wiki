...
| อีเวนต์ | เวลา |
| :-- | :-- |
| เริ่มฤดูกาล | 6 ก.ค., 2020 |
| Timeshift lobby: เพลย์ลิสต์ A | 10 ก.ค. - 12 ก.ค., 2020 |
| Timeshift lobby: เพลย์ลิสต์ B | 17 ก.ค. - 19 ก.ค., 2020 |
| Timeshift lobby: เพลย์ลิสต์ C | 24 ก.ค. - 26 ก.ค., 2020 |
| Timeshift lobby: เพลย์ลิสต์ D | 31 ก.ค. - 2 ส.ค., 2020 |
| Timeshift lobby: เพลย์ลิสต์ A | 7 ส.ค. - 9 ส.ค., 2020 |
| Timeshift lobby: เพลย์ลิสต์ B | 14 ส.ค. - 16 ส.ค., 2020 |
| Timeshift lobby: เพลย์ลิสต์ C | 21 ส.ค. - 23 ส.ค., 2020 |
| Timeshift lobby: เพลย์ลิสต์ D | 28 ส.ค. - 30 ส.ค., 2020 |
| Timeshift lobby: เพลย์ลิสต์ A and B | 4 ก.ย. - 6 ก.ย., 2020 |
| Timeshift lobby: เพลย์ลิสต์ C and D | 11 ก.ย. - 13 ก.ย., 2020 |
| ปิดฤดูกาล | 14 ก.ย. - 18 ก.ย., 2020 |
...
1. ทุกวันศุกร์ของฤดูกาล จะเปิดห้อง timeshift multiplayer หนึ่งห้อง ทุกคนสามารถเข้าร่วมได้เป็นเวลา 3 วัน
   - ใน 2 สัปดาห์สุดท้ายของฤดูกาล จะเปิด timeshift multiplayer lobby ให้กับทั้ง 2 เพลย์ลิสต์
2. แต่ละ timeshift multiplayer lobby จะมีเพลย์ลิสต์บีตแมปที่กำหนดไว้ล่วงหน้า
   - แต่ละเพลย์ลิสต์เป็นส่วนหนึ่งของรายชื่อบีตแมปที่ผ่านการคัดเลือกทั้งหมดของฤดูกาลปัจจุบัน
   - แต่ละเพลย์ลิสต์จะแบ่งบีตแมประดับ Hard, Insane และ Expert อย่างสมดุล
   - แต่ละเพลย์ลิสต์จะตรงกับตัวอักษรที่กำหนดให้แต่ละสัปดาห์ ดังนั้นแต่ละเพลย์ลิสต์จะถูกเล่นซ้ำ 3 ครั้งต่อฤดูกาล
3. ภายใน timeshift lobby ทุกคนจะแข่งกันบน leaderboard เฉพาะของห้องนั้น
   - leaderboard ของห้องอิงตามระบบ ranked score ดังนั้นระบบจะนำเฉพาะคะแนนที่ดีที่สุดของแต่ละบีตแมปในเพลย์ลิสต์มารวมกันเป็น ranked score รายสัปดาห์ของผู้เล่นแต่ละคน
   - บีตแมปทุกอันในเพลย์ลิสต์มีน้ำหนักต่อคะแนน leaderboard เท่ากัน ความยากที่สูงกว่าไม่ได้ให้คะแนนมากกว่า
   - คะแนนของแต่ละบีตแมปอิงตามระบบการให้คะแนนของ osu!(lazer)
4. คะแนน ranked score รวมรายสัปดาห์ที่เห็นใน timeshift lobby จะเรียกว่า "weekly ranked score" ตั้งแต่นี้เป็นต้นไป
5. เมื่อ timeshift lobby จบลง คะแนน ranked score รายสัปดาห์ของผู้เข้าร่วมแต่ละคนในห้องจะถูกนำไปเพิ่มใน leaderboard ประจำฤดูกาล
...
leaderboard ต่อไปนี้สามารถดูเป็น [Google Spreadsheet](https://docs.google.com/spreadsheets/d/e/2PACX-1vRF46ZtScaNWb5KLAF0-CwJhTySle5r3xVhg15x1nTOXYrMWNpRx8HbsRizaQ2AwJpKARJRTtyHbdxs/pubhtml#) ได้ด้วย

### osu!

| อันดับ | ชื่อ | เหรียญตรา |
| --: | :-- | :-: |
...
*หมายเหตุ: คุณสามารถ[ดาวน์โหลดเพลย์ลิสต์ osu! ทั้งหมด](https://osu.ppy.sh/beatmaps/packs/1992) เป็นบีตแมปแพ็กเดียวได้*
...
*หมายเหตุ: คุณสามารถ[ดาวน์โหลดเพลย์ลิสต์ osu! ทั้งหมด](https://osu.ppy.sh/beatmaps/packs/1993) เป็นบีตแมปแพ็กเดียวได้*
...
*หมายเหตุ: คุณสามารถ[ดาวน์โหลดเพลย์ลิสต์ osu! ทั้งหมด](https://osu.ppy.sh/beatmaps/packs/1994) เป็นบีตแมปแพ็กเดียวได้*
...
*หมายเหตุ: คุณสามารถ[ดาวน์โหลดเพลย์ลิสต์ osu! ทั้งหมด](https://osu.ppy.sh/beatmaps/packs/1995) เป็นบีตแมปแพ็กเดียวได้*
