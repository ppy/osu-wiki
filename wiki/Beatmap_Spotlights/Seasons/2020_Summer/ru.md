...
# Пилотный сезон Beatmap Spotlights (Summer 2020)

## Расписание

| Событие | Дата |
| :-- | :-- |
| Открытие сезона | 6 июля 2020 г. |
| Комната с Timeshift: плейлист A | 10–12 июля |
| Комната с Timeshift: плейлист B | 17–19 июля |
| Комната с Timeshift: плейлист C | 24–26 июля |
| Комната с Timeshift: плейлист D | 31 июля — 2 августа |
| Комната с Timeshift: плейлист A | 7–9 августа |
| Комната с Timeshift: плейлист B | 14–16 августа |
| Комната с Timeshift: плейлист C | 21–23 августа |
| Комната с Timeshift: плейлист D | 28–30 августа |
| Комната с Timeshift: плейлисты A и B | 4–6 сентября |
| Комната с Timeshift: плейлисты C и D | 11–13 сентября |
| Подведение итогов | 14–18 сентября |

## Еженедельные комнаты

Чтобы принять участие, скачайте и установите [osu!(lazer)](/wiki/Client/Release_stream/Lazer).

1. Каждая комната открывается для всех желающих в пятницу — на три дня.
   - В последние две недели сезона комнаты охватывают два плейлиста вместо одного.
...
4. Суммарный результат игрока на всех картах за неделю для краткости называется недельным результатом.
5. При закрытии комнаты недельный результат игрока прибавляется к его общему числу очков в сезонной таблице.

### Плейлист A

| Открытие | Закрытие | Комнаты |
| :-- | :-- | :-- |
...
Таблицы, приведённые ниже, также доступны в [Google Spreadsheet](https://docs.google.com/spreadsheets/d/e/2PACX-1vRF46ZtScaNWb5KLAF0-CwJhTySle5r3xVhg15x1nTOXYrMWNpRx8HbsRizaQ2AwJpKARJRTtyHbdxs/pubhtml#).

### osu!

| Позиция | Ник | Значок профиля |
| --: | :-- | :-: |
