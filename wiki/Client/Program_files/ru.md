...
::: alert-notice
**Внимание**
раньше реплеи записывались с низкой частотой кадров, которая потом была увеличена для более плавного воспроизведения.
:::
...
::: alert-notice
**Внимание**
для загрузки реплеев на YouTube может пригодиться [Osr2mp4: автоматическая конвертация реплея в видео](https://osu.ppy.sh/community/forums/topics/1104243).
:::
...
::: alert-notice
**Внимание**
чтобы сделать скриншот, нажмите горячую клавишу (`F12` по умолчанию).
:::
...
::: alert-warning
**Предупреждение**
изменение этих файлов может помешать корректной работе osu! или привести к потере ваших локальных данных.
:::
