# Отличия в геймплее в osu!(lazer)
...
Также есть некоторые различия в том, сколько очков за каждый объект и каждую оценку отвечают друг за друга.
...
### В некоторых случаях формирование струи сока может отличаться

Это может привести к некорректным оценкам в реплеях.
