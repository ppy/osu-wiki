...
*如果想要比较 lazer 和 stable 的功能差别，参见： [帮助中心/升级到 lazer § 功能对比](/wiki/Help_centre/Upgrading_to_lazer#功能对比)。*
...
在 lazer 之前，玩家只要判定在 50/MEH 的判定区间内点击滑条头，就可以获得完美的分数。这是出于一些历史原因而设定的，不太适合一款节奏类音乐游戏。因此，滑条头的判定以后会更严格。
...
过早点击滑条头也能立刻进入跟随状态，即使光标在滑条开始滑动之前离开了滑条头。

![](img/slider-early-leniency.gif)

此外，过晚点击滑条头也能让已经走过的滑条点或折返点判定为完成。

![](/wiki/shared/news/2023-12-18-osulazer-updates-preparing-for-ranked-play/slider-late-leniency.jpg "在此区间内点击会造成miss（更新前）")

Youtube上的官方[lazer 更新日志](https://www.youtube.com/watch?v=xTRwM3zhhj0&t=243s)有更详细的解释。
...
Youtube上的官方[lazer 更新日志](https://www.youtube.com/watch?v=SlWKKA-ltZY)有更详细的解释。
...
对 Aspire 谱面的兼容还需要进一步的考虑与考虑。比如未来游戏可能会正常支持隐形圆圈。
