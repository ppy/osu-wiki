...
| `Shift` + `F1` | Abre o [osu!status](https://x.com/osustatus) em seu navegador da web. (Apenas quando um erro de conexão aparecer.) |
...
| `Ctrl` + `Shift` + `L` | Volte para o último estado salvo (total). Isso vai recarregar absolutamente tudo. |
