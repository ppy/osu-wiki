...
5. osu! автоматически сделает всё остальное и установит карту.
   - Если по какой-то причине вы не видите установленных карт, нажмите `F5` на [экране выбора песен](/wiki/Interface#экран-выбора-песни) для их повторной обработки.
