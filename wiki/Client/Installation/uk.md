...
5. osu! автоматично обробить для вас залишки і завантажить набір карт.
   - Якщо по якийсь причині ви не бачите завантежених карт, настисніть кнопку `F5` в [Екрані вибору пісень](/wiki/Client/Interface#song-selection-screen) для повторної обробки.
...
4. Коли osu! закінчить завантаження набору карт, вона автоматично вивантажить його.
   - Якщо по якийсь причині ви не бачите завантажених карт, натисніть `F5` в [Екрані вибору піснень](/wiki/Client/Interface#song-selection-screen) для повторної обробки.
