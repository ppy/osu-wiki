...
[osu! (lazer release)](https://github.com/ppy/osu) - будущий игровой клиент osu!, который находится в разработке и умеет запускаться под macOS. Попробуйте его, если вы не гонитесь за [очками производительности](/wiki/Performance_points). Чтобы установить osu! (lazer release), выполните следующие шаги:

1. Откройте [страницу загрузки osu! (lazer release)](https://github.com/ppy/osu/releases/latest), скачайте архив `osu!.app.zip` и распакуйте его.
