...
[osu! (lazer release)](https://github.com/ppy/osu) є майбутнім osu! клієнтом, котрий на даний час є в розробці. Якщо ви не турбуєтесь за отримання [балів продуктивності](/wiki/Performance_points), тоді рекомендується випробувати його вами. Для інсталяції гри, виконайте наступні кроки:

1. Перейдіть на [сторінку завантаження osu! (lazer release)](https://github.com/ppy/osu/releases/latest), завантажте `osu!.app.zip` і розпакуйте його.
