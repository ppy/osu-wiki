...
5. osu! sẽ tự động xử lí nó cho bạn.
   - Nếu vì lí do nào đó mà bạn không thấy beatmap đó, ấn `F5` trong [Màn hinh chọn bài hát](/wiki/Client/Interface#song-selection-screen) để soát lại beatmap của bạn.
...
4. Sau khi osu! hoàn tất tải xuống beatmap, nó sẽ tự động hiện lên khi bạn vào màn hình chọn bài hát.
   - Nếu vì lí do nào đó mà bạn không thấy beatmap đó, ấn `F5` trong [Màn hinh chọn bài hát](/wiki/Client/Interface#song-selection-screen) để rà soát lại beatmap của bạn.
