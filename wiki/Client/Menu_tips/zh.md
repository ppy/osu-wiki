...
- 所有设置项均为动态更新，并会实时反馈到游戏中。尝试在游玩时暂停，并换一款皮肤吧！
- 每次更新，都会给客户端带来新特性。确保你游玩到的是最新版本！
- 如果你觉得 UI 尺寸不对，就尝试去调整设置里的 UI 缩放吧！
- 甚至在全屏模式下，你都可以尝试调整`屏幕缩放`模式，来调整游玩区域或 UI 的大小！
- 旧版客户端内叫做 [osu!direct](/wiki/osu!supporter#osu!direct) 的功能，现已对所有玩家开放！就像在网站上浏览谱面一样。你能在游戏里随时按下 `Ctrl` + `D`，来唤出它！
- 在回放界面内，拖动屏幕下方的难度条，能控制回放的播放位置！
- 即使你的 FPS 很低，使用多线程支持，你的操作和游戏判定也同样精准！
- 尝试在模组选择面板往下翻一翻，你能找到一堆有趣的新模组！
