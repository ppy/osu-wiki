...
These tips are copy-pasted as is; ignore formatting and writing inconsistencies. -->

# Menu tips

This article lists the various tips seen in the game, which contain useful and obscure information.
...
- If your game or mouse feels laggy, try toggling the Framerate Limit in Options or using Fullscreen mode/Letterboxing! It might just help!
...
- Customize your osu! experience with new skins! Download them from the Skinning forum.
...
These tips appear in the [beatmap editor](/wiki/Client/Beatmap_editor) below the hit object timeline.
...
- Try synchronizing the most important sounds in a song to clicks in gameplay. This is especially important when deciding slider rhythms!
- The “Beat Snap Divisor” option in the top right determines how objects synchronize to music. For most songs, sticking to the default “1/4" value will work fine.
...
- Bookmarks (Ctrl+B) are a fantastic tool to visualize a song’s changes. Many mappers separate large sections of music with bookmarks to easily coordinate changes in their mapping.
...
- Zoom in on the timeline by hovering your mouse over it, holding Alt, and scrolling with the mousewheel. You can also press the +/- buttons to the left of the timeline. 
...
These tips appear in the lazer version of the client upon startup, before the intro sequence.
