...
| [.osu](/wiki/Client/File_formats/Osu_(file_format)) | `x-osu-beatmap` | [difficoltà](/wiki/Beatmap/Difficoltà) di osu! |
...
I file `.osz` e `.osk` sono archivi contenenti rispettivamente beatmap e skin. Il loro contenuto viene estratto automaticamente da osu! quando li si apre:

- I file `.osz` vengono estratti nella directory `Songs`.
- I file `.osk` vengono estratti nella directory `Skins`.

Sapere come rendere un archivio di skin o beatmap riconosciuto da osu! renderà i vostri lavori più accessibili agli altri utenti.

### Utilizzo di un archiviatore
...
- Nelle impostazioni, fare clic su `Seleziona pelle`.
