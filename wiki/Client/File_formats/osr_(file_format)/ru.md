...
**.osr** — это формат файла для описания [реплея](/wiki/Gameplay/Replay) osu!. `.osr` файл может быть воспроизведён только если установлена та карта, на которой был записан реплей.
