...
**.osr** — это формат файла для описания [реплея](/wiki/Gameplay/Replay) osu!. Файл `.osr` можно посмотреть, только если в игре есть в точности та карта, на которой был записан реплей.
...
| Relax | 128 (7) |  |
| HalfTime | 256 (8) |  |
| Nightcore | 512 (9) | Всегда используется вместе с DT: 512 + 64 = 576. Заменяет неиспользуемый мод Taiko |
| Flashlight | 1024 (10) |  |
| Autoplay | 2048 (11) |  |
| SpunOut | 4096 (12) |  |
