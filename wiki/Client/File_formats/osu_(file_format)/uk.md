...
Так само, як і в osu!catch, об'єкти в osu!mania не використовують `y`. `x` використовується для визначення колонки; дивіться [розділ про довгі ноти](#довгі-ноти-(лише-osu!mania)).
