...
Một **uninherited** timing point có các thiết lập timing riêng của nó. Nhiều timing point kiểu này được dùng để thể hiện các thay đổi timing trong bài hát, chẳng hạn như [tempo](/wiki/Music_theory/Tempo), nhịp không đều, hoặc các [time signature](/wiki/Music_theory/Time_signature) khác nhau. Việc thêm một uninherited timing point mới sẽ reset metronome, khiến nó đếm nhịp từ offset của timing point đó, được xác định bằng mili giây.
