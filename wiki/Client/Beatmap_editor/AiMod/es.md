...
| Beatmap exceeds allowed upload size ({0}kb allowed) | El archivo `.osz` comprimido es demasiado grande. | Elimina los archivos no utilizados de la carpeta del mapa y comprime los activos (imágenes, vídeos, hitsounds, etc.) que tengan un tamaño inflado. | Consulta [este artículo](/wiki/Beatmapping/Beatmap_submission#limitaciones) para obtener más información sobre las limitaciones de envío de osu!. |
