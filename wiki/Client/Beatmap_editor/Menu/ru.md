...
| Автобаланс звука | **(доступно только для редактора osu!mania)** Сбалансировать звучание хитсаундов у всех игровых объектов в зависимости от их количества на одном тике временно́й шкалы и настроек громкости в [окне настройки тайминга](wiki/Client/Beatmap_editor/Timing/ru.md#окно-настройки-тайминга). |
