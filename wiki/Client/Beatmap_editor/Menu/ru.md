...
| Сдвинуть назад (`J`) | Свдинуть назад все выделенные объекты на шаг временной шкалы в зависимости от активного [делителя доли](/wiki/Client/Beatmap_editor/Beat_snap_divisor). |
