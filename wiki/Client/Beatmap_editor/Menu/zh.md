...
| 打开一个难度... | **用于编辑：**在难度间快速切换。**用于参考：**（仅限 [osu!mania](/wiki/Game_mode/osu!mania)）将所选难度物件盖在当前已打开难度的上方。 |
...
| 重新计算滑条长度 | 将所有[滑条尾](/wiki/Gameplay/Hit_object/Slider/Slidertail)与时间线上最近的节拍线自动重新对齐，**可能会缩短滑条长度**，需要手动检查。 |
