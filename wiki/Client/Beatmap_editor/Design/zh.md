...
**分别显示不同图层下故事板对象的列表。**点击 “Sprite Library” 来添加故事板元素。可以将新精灵（故事板对象）拖放到对应图层以分配之。新精灵默认位于“前景”图层。点击精灵名会显示并跳转到精灵的位置及时间帧。复制的精灵使用的名称与原精灵相同。使用 `Delete` 键或顶部菜单的编辑 -> 删除来删除精灵。
