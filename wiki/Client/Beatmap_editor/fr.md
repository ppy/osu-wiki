...
::: alert-note
**Remarque** : Pour les raccourcis de l'éditeur de beatmap, voir [Référence sur les raccourcis clavier & éditeur de beatmap](/wiki/Client/Keyboard_shortcuts#général)
:::
