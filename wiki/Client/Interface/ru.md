...
- \[12\] Ваш профиль. Нажатие на него открывает [настройки пользователя](#настройки-пользователя).
...
*Обратите внимание: нажав клавишу `Shift` и кнопку `Random` или клавишу `F2`, можно вернуться к предыдущей случайной карте.*
