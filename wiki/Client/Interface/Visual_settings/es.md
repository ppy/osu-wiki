...
::: alert-notice
**Aviso**
los cambios de la configuración visual se guardan por beatmap, pero algunos de ellos se perderán después de cerrar osu!. Para configurarlos globalmente (y para siempre), usa la barra lateral de [opciones](/wiki/Client/Options).
:::
