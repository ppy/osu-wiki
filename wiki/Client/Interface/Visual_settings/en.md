...
::: alert-notice
**Notice**
Visual settings changes are saved per beatmap but some of them will be lost after closing osu!. To set these globally (and forever) use the [options](/wiki/Client/Options) sidebar.
:::
