...
::: alert-notice
**Внимание**
выбранные настройки сохраняются отдельно для каждой карты, но частично сбрасываются после выхода из osu!. Чтобы выставить их раз и навсегда (и для всех карт сразу), воспользуйтесь [настройками клиента](/wiki/Client/Options).
:::
