...
![Okno czatu](img/Chatconsole1.png "Okno czatu")
...
![Rozszerzone okno czatu](img/Chat_Console-Extended.png "Rozszerzone okno czatu")
...
| Kolor panelu | Opis |
| :-- | :-- |
| ![Użytkownik jest bezczynny](img/Chat_Console-Idle.png "Użytkownik jest bezczynny") | Ciemnoniebieski - użytkownik jest bezczynny lub pisze na czacie. |
| ![Użytkownik gra](img/Chat_Console-Playing.png "Użytkownik gra") | Szary - użytkownik gra beatmapę w trybie jednoosobowym. |
| ![Użytkownik ogląda innego gracza](img/Chat_Console-Watching.png "Użytkownik ogląda innego gracza") | Jasnoniebieski - użytkownik ogląda powtórkę lub grę innego gracza. |
| ![Użytkownik edytuje beatmapę](img/Chat_Console-Editing.png "Użytkownik edytuje beatmapę") | Czerwony - użytkownik edytuje swoją beatmapę. |
| ![Użytkownik testuje beatmapę](img/Chat_Console-Testing.png "Użytkownik testuje beatmapę") | Fioletowy - użytkownik testuje beatmapę w edytorze. |
| ![Użytkownik przesyła beatmapę](img/Chat_Console-Submitting.png "Użytkownik przesyła beatmapę") | Turkusowy - użytkownik przesyła lub aktualizuje swoją beatmapę. |
| ![Użytkownik moduje beatmapę](img/Chat_Console-Modding.png "Użytkownik moduje beatmapę") | Zielony - użytkownik moduje lub edytuje czyjąś beatmapę. |
| ![Użytkownik znajduje się w trybie wieloosobowym](img/Chat_Console-Multiplayer.png "Użytkownik znajduje się w trybie wieloosobowym") | Brązowy - użytkownik znajduje się w trybie wieloosobowym, ale nie gra. |
| ![Użytkownik gra beatmapę w trybie wieloosobowym](img/Chat_Console-Multiplaying.png "Użytkownik gra beatmapę w trybie wieloosobowym") | Żółty - użytkownik gra beatmapę w trybie wieloosobowym. |
| ![Użytkownik jest nieaktywny](img/Chat_Console-Afk.png "Użytkownik jest nieaktywny") | Czarny - użytkownik nie wykonał żadnego działania przez dłuzszy czas. |
| ![Użytkownik jest połączony przez klienta IRC](img/Chat_Console-IRC.png "Użytkownik jest połączony przez klienta IRC") | Ciemnoniebieski, bez żadnej zawartości - użytkownik jest połączony przez klienta IRC albo jego statystyki nie są dostępne. |
