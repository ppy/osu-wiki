...
| `/chat [Benutzername]` oder `/msg [Benutzername]` oder `/query [Benutzername]` | Öffnet einen privaten Chatkanal mit `[Benutzername]`. | `/chat Deimos` | \[Kanal mit Deimos wird geöffnet\] |
