...
::: Infobox
![](img/hl-notification.png "Ein Beispiel einer Highlight-Benachrichtigung")
:::

Wenn eine Nachricht im Chat einen Highlight auslöst, dann wird der Nutzername des Absenders auf dieser Zeile grün angezeigt und die Nachricht zum Chat-Tab `#highlight` hinzugefügt. Zusätzlich blinkt das Symbol von osu! in der Taskleiste, falls das osu!-Fenster inaktiv ist.
