...
เมื่อมีข้อความแชทที่ทำให้เกิดการไฮไลต์ ชื่อของผู้ส่งในบรรทัดนั้นจะเปลี่ยนเป็น **สีเขียว** และข้อความนั้นจะถูกคัดลอกไปไว้ในแชนแนล `#highlight` เพื่อให้คุณตรวจสอบได้ง่าย นอกจากนี้ หากหน้าต่างเกม osu! ไม่ได้ถูกเลือกใช้งานอยู่ ไอคอนของเกมบนแถบงาน (Taskbar) จะกระพริบเพื่อแจ้งให้ทราบ
