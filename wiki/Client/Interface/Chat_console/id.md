...
| **Biru** | Pesan pribadi |
| **Biru muda** | ::peppy::{ user=2 }, pencipta osu! |
...
![Pilihan panel pengguna](img/Chat_Console-Userpaneloptions.jpg "Pilihan panel pengguna")
...
5. `Tambah Sebagai Teman/Hapus dari Daftar Teman`: Menambahkan/menghapus pengguna dari daftar temanmu.
6. `Laporkan Pengguna`: Melaporkan pengguna atas perilaku buruk yang mereka lakukan. Tidak untuk dipilih kecuali apabila memang terdapat pelanggaran yang perlu untuk dilaporkan. Kamu dapat melaporkan seseorang atas berbagai alasan tidak hanya dari dalam permainan, namun juga dari situs web seperti pada forum.
7. `Abaikan Pengguna`: Menyembunyikan seluruh entri chat yang dikirim oleh pengguna pada konsol chat milikmu.
8. `Tutup`: Menutup panel ini.
...
| `/bb` | Mengirimkan pesan ke Bancho untuk menjalankan perintah seperti `!stats [nama pengguna]`. | `/bb !stats Uan` | \[15/11/12\] Statistik untuk ::Uan::{ user=147623 }: Skor: 47,323,299,680 (#1) Jumlah Permainan: 176293 (lv102) Akurasi: 98.95% |
...
| :-- | :-- |
| `Page Up` / `Page Down` | Menggulirkan jendela chat. Kamu juga dapat melakukan hal ini dengan menggunakan roda mouse. |
| `Tab` | Melengkapi nama pengguna yang sedang diisi secara otomatis. |
| `F8` | Membuka/menutup konsol chat. |
| `F9` | Membuka/menutup konsol chat yang diperluas. |
| `Ctrl` + `C` / `V` | Menyalin/menempel teks. |
| `Alt` + `0` - `9` | Berpindah ke tab yang bersangkutan. |
