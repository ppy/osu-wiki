...
| **Cyan** | ::peppy::{ user=2 }, the creator of osu! |
...
| `/bb` | Sends a message to Bancho to execute a command like `!stats [user]` | `/bb !stats Uan` | \[15/11/12\] Stats for ::Uan::{ user=147623 }: Score: 47,323,299,680 (#1) Plays: 176293 (lv102) Accuracy: 98.95% |
