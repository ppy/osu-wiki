...
| **Mavi** | Özel Mesaj |
| **Camgöbeği** | ::peppy::{ user=2 }, osu!'nun yaratıcısı! |
...
| `/bb` | BanchoBot'a `!stats [kullanıcı]` gibi bir komutu doğrudan göndermenizi sağlar. | `/bb !stats Uan` | \[15/11/12] Stats for ::Uan::{ user=147623 }: Score: 47,323,299,680 (#1) Plays: 176293 (lv102) Accuracy: 98.95% |
