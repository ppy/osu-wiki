...
| `/bb` | 给 Bancho 发送消息以执行命令（比如 `!stats [用户]`）。如： rank `[number]` | `/bb !stats Uan` | \[15/11/12\] Stats for ::Uan::{ user=147623 }: Score: 47,323,299,680 (#1) Plays: 176293 (lv102) Accuracy: 98.95% |
