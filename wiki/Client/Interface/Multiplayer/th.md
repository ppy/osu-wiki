...
## การสร้างห้องใหม่ (Creating a new game) {#creating-a-new-game}
...
| :-: | :-- |
| `Ranked` / `Approved` / `Pending` / `Graveyard` | [หมวดหมู่บีทแมพ](/wiki/Beatmap/Category) การคลิกที่การ์ดจะเป็นการเปิดหน้าเว็บเพื่อให้ [ดาวน์โหลด](/wiki/Beatmap#downloading-beatmaps) |
...
*สำหรับข้อมูลเพิ่มเติม ดูหัวข้อ [เกมเพลย์ของโหมดทีม](#team-mode-gameplay)*
...
### โหมดทีม (Team mode) {#team-mode-gameplay}
