...
![](img/intro-screen.jpg "Ekran startowy")

## Menu główne

![](img/main-menu.jpg "Menu główne")
...
| Przycisk | Opis |
| :-: | :-- |
| ![](img/jukebox/previous-track.jpg "Poprzedni utwór") | Poprzedni utwór |
| ![](img/jukebox/play.jpg "Odtwórz") | Odtwórz |
| ![](img/jukebox/pause.jpg "Pauza") | Pauza |
| ![](img/jukebox/stop.jpg "Zatrzymaj muzykę!") | Zatrzymaj muzykę i cofnij bieżący utwór do początku |
| ![](img/jukebox/next-track.jpg "Następny utwór") | Następny utwór |
| ![](img/jukebox/view-song-info.jpg "Informacje o utworze") | Przełącz pomiędzy stałym wyświetlaniem informacji o bieżącym utworze a ich ukrywaniu po chwili. |
| ![](img/jukebox/jump-to-window.jpg "Ekran "Przejdź do"") | Przejdź do konkretnego utworu. Możesz szukać piosenek za pomocą wyszukiwarki lub filtrować je według kolekcji. |

Odtwarzaczem można sterować również za pomocą [skrótów klawiszowych](/wiki/Client/Keyboard_shortcuts#odtwarzacz-muzyki).

## Opcje użytkownika

![](img/user-options.jpg "Opcje użytkownika")
...
![](img/multi-lobby.jpg "Poczekalnia trybu wieloosobowego")

Tryb wieloosobowy pozwala grać zarówno z innymi graczami, jak i przeciwko nim.

## Wybór piosenki

![](img/song-selection.jpg "Wybór piosenki")
...
- ![](/wiki/shared/mode/osu.png) to [osu!](/wiki/Game_mode/osu!)
- ![](/wiki/shared/mode/taiko.png) to [osu!taiko](/wiki/Game_mode/osu!taiko)
- ![](/wiki/shared/mode/catch.png) to [osu!catch](/wiki/Game_mode/osu!catch)
- ![](/wiki/shared/mode/mania.png) to [osu!mania](/wiki/Game_mode/osu!mania)
...
![](img/game-mode-selector.jpg "Lista dostępnych trybów gry")
...
![](img/game-modifiers.jpg "Ekran wyboru modów")
...
![](img/beatmap-options.jpg "Dostępne opcje dla beatmap")
...
![](img/results-mania.jpg "Celność w trybie osu!mania")
...
![](img/medal-unlock.jpg "Odblokowanie medalu")
