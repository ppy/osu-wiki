...
*See also: [Unlock requirement](/wiki/Medals/Unlock_requirements)*
...
*See also: [Unlock requirement/Beatmap packs](Unlock_requirements/Beatmap_packs)*
...
All beatmaps have to be cleared in the [osu!](/wiki/Game_mode/osu!) game mode in order to qualify for the badge. The usage of either [difficulty reduction mods](/wiki/Game_modifier#difficulty-reduction) or [difficulty increase mods](/wiki/Game_modifier#difficulty-increase) is permitted.
...
*See also: [Unlock requirement/Skill](Unlock_requirements/Skill)*
...
*See also: [Unlock requirement/Dedication](Unlock_requirements/Dedication)*

**Dedication medals** are medals awarded upon reaching certain playcount milestones in a single game mode.

## Mod Introduction

*See also: [Game modifier](/wiki/Game_modifier) and [Unlock requirement/Mod introduction](Unlock_requirements/Mod_introduction)*
...
All Mod Introduction medals are eligible to be unlocked in any [game mode](/wiki/Game_mode).

## Hush-Hush

*See also: [Unlock requirement/Hush-Hush](Unlock_requirements/Hush-Hush)*
...
*See also: [Unlock requirement/Seasonal Spotlights](Unlock_requirements/Seasonal_spotlights)*
...
*See also: [Unlock requirement/Beatmap Challenge Packs](Unlock_requirements/Beatmap_challenge_packs)*
