...
Kecuali diterangkan lebih lanjut, seluruh beatmap yang terdapat pada masing-masing paket harus diselesaikan dalam mode [osu!](/wiki/Game_mode/osu!) untuk memenuhi persyaratan membuka medali. Penggunaan mod yang dapat [menurunkan](/wiki/Gameplay/Game_modifier#difficulty-reduction) atau [meningkatkan tingkat kesulitan](/wiki/Gameplay/Game_modifier#difficulty-increase) serta mod [Spun Out](/wiki/Gameplay/Game_modifier/Spun_Out) tidak dilarang.
