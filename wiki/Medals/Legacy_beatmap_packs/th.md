...
Beatmap pack เป็นส่วนสำคัญของชุมชน osu! ตั้งแต่ [เปิดตัวครั้งแรก](https://osu.ppy.sh/community/forums/topics/1853) โดย ::{ flag=US }:: [Saturos](https://osu.ppy.sh/users/3781) ย้อนไปในปี 2008 ซึ่ง pack บางชุดเชื่อมโยงกับ [achievement](/wiki/Medals) บางอย่างในเวลานั้น อย่างไรก็ตาม เมื่อ osu! และชุมชนเติบโตขึ้นตลอดหลายปี meta การแมปโดยรวมก็เปลี่ยนไปมากจากยุคแรก และด้วยความต้องการจำนวนมากจากผู้เล่น จึงมีการ overhaul beatmap pack จำนวนมาก [เมื่อวันที่ 18 มกราคม 2016](https://osu.ppy.sh/home/news/2016-01-18-osuweekly-44) เพื่อให้ pack เหล่านั้นโดยรวมยังเข้ากับยุคสมัย

บทความนี้แสดงเนื้อหาของ beatmap pack ที่เคยถูก overhaul ดังกล่าว ในสภาพ legacy/original ของมัน

## Anime Pack

### Volume 1

beatmap pack นี้เปิดตัวครั้งแรกโดย ::{ flag=US }:: [LuigiHann](https://osu.ppy.sh/users/1079) and ::{ flag=US }:: [DeathxShinigami](https://osu.ppy.sh/users/49516) ในปี 2011
...
beatmap pack นี้เปิดตัวครั้งแรกโดย ::{ flag=DE }:: [Larto](https://osu.ppy.sh/users/12328) and ::{ flag=US }:: [DeathxShinigami](https://osu.ppy.sh/users/49516) ในปี 2011
...
beatmap pack นี้เปิดตัวครั้งแรกโดย ::{ flag=US }:: [DeathxShinigami](https://osu.ppy.sh/users/49516) ในปี 2011
...
beatmap pack นี้เปิดตัวครั้งแรกโดย ::{ flag=US }:: [Seibei4211](https://osu.ppy.sh/users/31537) and ::{ flag=US }:: [DeathxShinigami](https://osu.ppy.sh/users/49516) ในปี 2011
...
- บีตแมป [Loituma - Ievan Polkka](https://osu.ppy.sh/beatmapsets/2463) ซึ่งรวมอยู่ใน Internet Pack (Volume 1) ขึ้นชื่อเรื่องการถูกดันไปยัง section [Approved](/wiki/Beatmap/Category#approved) ทั้งที่มีสปินเนอร์เพียงอันเดียว แม้บีตแมปจะถูก [ลบออกจากรายการ Approved beatmaps หลังจากนั้นไม่นาน](https://osu.ppy.sh/community/forums/posts/149328) แต่ซากของมันยังคงอยู่ใน Internet Pack (Volume 1) อยู่ดี

## Notes

[^polkka-unranked]: [Loituma - Ievan Polkka](https://osu.ppy.sh/beatmapsets/2463) เป็นบีตแมป unranked ไม่จำเป็นต้องเล่นบีตแมปนี้เพื่อให้ pack เสร็จครบ
