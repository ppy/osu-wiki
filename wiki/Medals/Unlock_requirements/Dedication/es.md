...
| 15,000 Plays | Consigue un total de 15 000 jugadas en osu!. | Debo... clic... círculos... |
...
| 40,000,000 Keys | Toca un total de 40 000 000 de teclas en osu!mania | Cuando alguien te pregunte cuántas teclas juegas, la respuesta ahora es 'sí'. |

## Desafío diario

| Nombre de la medalla | Requisito | Descripción |
| :-- | :-- | :-- |
| Daily Sprout | Consigue una racha de 1 día en el [desafío diario](/wiki/Gameplay/Daily_challenge). | Preparado para todo. |
| Weekly Sapling | Consigue una racha de 7 días en el [desafío diario](/wiki/Gameplay/Daily_challenge). | Ritmo circadiano calibrado. |
| Monthly Shrub | Consigue una racha de 30 días en el [desafío diario](/wiki/Gameplay/Daily_challenge). | Entrando en la rutina. |
