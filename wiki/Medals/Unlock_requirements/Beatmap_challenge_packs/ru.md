...
| MUZZ Pack | Пройти единственную сложность всех карт из подборки [MUZZ Pack](https://osu.ppy.sh/beatmaps/packs/A76). |
| Ariabl'eyeS Pack | Пройти единственную сложность всех карт из подборки [Ariabl'eyeS Pack](https://osu.ppy.sh/beatmaps/packs/A81). |
| USAO Pack | Пройти единственную сложность всех карт из подборки [USAO pack](https://osu.ppy.sh/beatmaps/packs/F1). |
