...
| Burned Out | Terminez une beatmap classée, qualifiée ou approuvée avec le mod [Spun Out](/wiki/Game_modifier/Spun_Out). Cette médaille ne peut ête obtenue que dans le mode de jeu [osu!](/wiki/Game_mode/osu!) car le mod `Spun Out` n'est pas présent dans les autres modes. |
