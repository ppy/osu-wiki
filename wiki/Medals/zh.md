...
奖章，曾被称为 *成就*，是在用户个人资料页面中展示出来的一枚枚小型图案，可以体现玩家的游戏水准和技巧。
...
以下展示的是8星的 *Pass* 和 *S* 奖章，实则从1星到8星都有对应的奖章。
...
特别注意，如果在一次游玩中使用了2个或更多的 mods，那么**不会**给玩家带来 *任何奖章* 。
...
- [查看旧版曲包（2009-2016），Stefan 更新前的版本](Legacy_Beatmap_Packs)。
