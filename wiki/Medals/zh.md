...
与谱面难度有关的奖章也能被分为两类，即 _Pass（通过）_与 _S_ 。
...
以下展示的是8星的 _Pass_ 和 _S_ 奖章，实际上从1星到8星都有对应的奖章。
...
mod 初体验类奖章可以通过初次使用相应的 mods 来完成谱面获得，以此来激励玩家主动尝试、体验游戏提供的各种不同的 mods。

特别注意，如果在一次游戏中使用了2个或更多的 mods ，那么这次游戏**不会**给玩家带来_任何一枚奖章_。
 
| 提高难度 | 降低难度 |  |
| :---- | :---: | :---: |
