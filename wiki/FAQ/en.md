...
If [Relax](/wiki/Game_modifier) mod was used, the score judgement only account for hit timing only (automatically rectify wrong colour hit with correct colour).
...
The bananas can be ignored with no health penalty. However, it can cost the extra points and health recovery from collecting the bananas. Notably, [Auto](/wiki/Game_modifier) mod will go above and beyond to catch *all* of the bananas without fail.
...
- Silver SS (SSH) = Normal grade SS with *[Hidden](/wiki/Game_modifier)* and/or *[Flashlight](/wiki/Game_modifier)* mod.
- Silver S (SH) = Normal grade S with *[Hidden](/wiki/Game_modifier)* and/or *[Flashlight](/wiki/Game_modifier)* mod.
