...
*For a detailed explanation of beatmaps, see: [Beatmaps](/wiki/Beatmaps)*

In the website, navigate under *[beatmaps](https://osu.ppy.sh/beatmapsets)*. Just remember to sign in with beforehand to allow downloading and searching beatmaps.
...
These are some guides in the forums for beginners in every game mode.

- [Beginner's Training](https://osu.ppy.sh/community/forums/topics/5456): an osu!standard guide suitable for beginners to play by **Pokebis**.
- [TBT Project [Training Manual For Taiko Beginner v2]](https://osu.ppy.sh/community/forums/topics/175867): an osu!taiko guide for beginners to learn osu!taiko by **OnosakiHito**.
- [CBT Project [Catch the Beat Beginner Tutorial]](https://osu.ppy.sh/community/forums/topics/131067): an osu!catch guide with a nice list of osu!catch beatmaps and basic explanation about osu!catch by **Kingkevin30**.
- [osu!mania maps, sorted by difficulty](https://osu.ppy.sh/community/forums/topics/147552) by **Entozer** and [\[GUIDE\] How to improve in osu!mania](https://osu.ppy.sh/community/forums/topics/146615) by **Drace** for a decent list sorted by relative player's difficulties, and providing an experienced gameplay insight for beginners starting out in osu!mania.

Also, [a ranked beatmap version of the osu! tutorial](https://osu.ppy.sh/beatmapsets/19928) is good for practicing some of the possible mapping design. It is an excellent training map for newbies and experienced players.

Lastly, there is a project by **Rivenation** for [advanced beatmap searching](https://osu.ppy.sh/community/forums/topics/380485 "osu!search - Advanced beatmap searching by Rivenation") named [osu!search](http://osusearch.com/ "osu!search") which not only has the same features as the official beatmap searchbar but also has some neat features to define a specific beatmap requirement.
...
Level will be based on total score accumulated when online with account regardless of pass or fail on the beatmap. The formula is [shown here](/wiki/Score/#level).
...
*Main page: [Options](/wiki/Options)*

![Options sidebar with quickicons](/wiki/shared/Options_quickicons.jpg)

From the *Input* icon in the *Options* sidebar as shown above, under **Keyboard** section as shown below.

![Options keyboard section](/wiki/shared/Options_keyboard.jpg)

**Game over? Where did I mess up?**

*Main page: [Replay](wiki/Replay)*
...
*For a full list of shortcuts, see: [Shortcut Key Reference](/wiki/Shortcut_Key_Reference)*

Pressing the `Insert` key (the default keyboard setting) will hide, pause (if playing) and mute osu! into the *Windows* sidebar. Find the osu! logo in the *Windows* sidebar, and click on it to return osu! to the state before pressing the key. It is called the **Boss key**, and can be modified in `Change keyboard bindings` (in `Options`, under *Keyboard* section), located at the end of the *Universal* section.
...
*For a full list of unofficial ports, see: [External Ports](/wiki/External_Ports)*

The current osu! client does not support any mobile platform.
...
- ![osu! icon](/wiki/shared/mode/osu.png) [opsu!](http://itdelatrisu.github.io/opsu/) [Windows/OS X/Linux/Android]:
  Java port of osu! chiefly done by **itdelatrisu** with **fluddokt** providing support for Android version.
- ![osu!taiko icon](/wiki/shared/mode/taiko.png) [T-Aiko! v2](https://osu.ppy.sh/community/forums/topics/58640) [Android/iOS]:
  osu!taiko mode ported by **low.moe (Guy-kun) team** with new daily ranked challenge and refined T-Aiko! leaderboard.
- ![osu! icon](/wiki/shared/mode/osu.png) [osu!stream](/wiki/osu!stream) [iOS]:
...
![osu! smoke settings](/wiki/shared/osu_smoke_set.jpg "Smoke key in Key Bindings")

**Why do I not have the max possible combo when I have no misses?**

![Image showing a slider with slider ticks, with top part during Edit and bottom part during play](/wiki/shared/Sliderticks.png)
...
*Note: For unranked beatmaps only.*

![Example of an .osu file content](/wiki/shared/Beatmap_not_owned.png)
