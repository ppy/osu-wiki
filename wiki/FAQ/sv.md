...
Om [Relax](/wiki/Game_modifier)-modifieraren används, fungerar bara muspekaren. Använd muspekaren för att följa hitobjekten som istället trycks automatiskt. Spinners måste fortfarande avklaras.

Om [Auto Pilot](/wiki/Game_modifier)-modifieraren används, fungerar endast knapparna. Muspekaren rör sig automatiskt till varje hitobjekt, som behövs bara tryckas i tid. Spinners kommer att automatiskt snurras i samma fart som [Spun Out](/wiki/Game_modifier)-modifieraren.
...
Om [Relax](/wiki/Game_modifier)-modifieraren används, räknas endast slag i rätt rytm (automatiskt korrigerar fel färg med korrekt färg).
...
Bananerna kan ignoreras utan straff på hälsan. Däremot går de möjliga poängen från att fånga dem förlorade. Noterbart är att [Auto](/wiki/Game_modifier)-modifieraren kan fånga alla bananer utan undantag.
...
Positionen av muspekaren har vanligtvis ingen betydelse. Om [Relax](/wiki/Game_modifier)-modifieraren används, kontrolleras fångaren med muspekaren istället. Däremot blir blir resultatet inte rankad (eftersom det tar bort svårigheten från osu!catch; fångarens konstanta hastighet och talrikskontroll).
...
Med the [xK](/wiki/Game_modifier)-modifieraren kan spelaren själv välja antalet tangenter från 1 till 9, men med medföljande nedsänkt poängfaktor. Emellertid fungerar den inte med osu!mania-specifika beatmaps.

Med [Co-Op](/wiki/Game_modifier)-modifieraren delar spelfältet itu och använder Co-Op-kontroller, vilket tillåter 2 spelare att spela samtidigt med upp till 18 tangenter med en nedsänkt poängfaktor. Notera att ett specificerat antal tangenter fördubblas inte i osu!mania-specifika beatmaps, men spelfältet delas ändå upp på mitten (vänster sida får fler tangenter vid udda antal), använder Co-Op-kontroller och har ingen nedsänkt poängfaktor.
...
- Silver SS (SSH) = Vanligt SS-rang med *[Hidden](/wiki/Game_modifier)*- och/eller *[Flashlight](/wiki/Game_modifier)*-modifierare.
- Silver S (SH) = Vanligt S-rang med *[Hidden](/wiki/Game_modifier)*- och/eller *[Flashlight](/wiki/Game_modifier)*-modifierare.
