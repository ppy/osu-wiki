...
`วิธีฝึกหัด: `[`Original` `tutorial` `(มาพร้อมกับ` `osu!` `เวอร์ชั่นPC)`](http://osu.ppy.sh/s/3756)`, `[`บิทแมปฝึกหัดเวอร์ชั่นแรงค์`](http://osu.ppy.sh/s/19928)
...
Pokebis ได้รวบรวมแมปที่เหมาะสมกับผู้เล่นมือใหม่ คุณสามารถหาได้จากกระทู้นี้ <http://osu.ppy.sh/forum/viewtopic.php?f=54&t=12788>
