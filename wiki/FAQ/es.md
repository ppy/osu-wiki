...
![Interfaz de osu!](/wiki/shared/osu-gameplay.jpg "Interfaz de juego de osu!")
...
![Interfaz para cambiar de modo](/wiki/shared/Interface_mode.png "Selector de modos en el selector de canciones (Solo)")
...
![Campo de juego de osu!taiko](/wiki/shared/Taiko_playfield.jpg "Interfaz del campo de juego de osu!taiko")
...
![Círculos de taiko](/wiki/shared/Taiko_hitcircles.jpg "Notas de osu!taiko de varios colores y tamaños")
...
![Un redoble de tambor de taiko](/wiki/shared/Taiko_drumroll.jpg "Un redoble de tambor de osu!taiko")
...
![Interfaz de osu!catch](/wiki/shared/catch-gameplay.jpg "Interfaz de juego de osu!catch")
...
![Diferencia del campo de juego entre un CS de 2 y un CS de 7](/wiki/shared/Catch_Playfield_27.jpg "Diferencia del campo de juego de osu!catch basado en el CS")
...
![Rastros de frutas](/wiki/shared/Catch_trails.jpg "Rastros de frutas en osu!catch")
...
![Hiperfrutas, y el catcher usando un hiperdash por recolectar hiperfrutas anteriores](/wiki/shared/Catch_hyperfruits.jpg "Hiperfrutas de osu!catch")
...
![Interfaz de osu!mania](/wiki/shared/mania-gameplay.jpg "Interfaz de juego de osu!mania")
...
![Campo de juego de osu!mania](/wiki/shared/Mania_playfield.jpg "Interfaz del campo de juego de osu!mania")
...
![Botones de los modos en el perfil (sitio web antiguo)](img/Profile_mode_buttons.gif "Botones de los modos en el perfil (sitio web antiguo)")
...
![Barra lateral de opciones con iconos rápidos](img/Options_quickicons-ES.png "Iconos rápidos de las opciones")
...
![Sección Teclado de las opciones](img/Options_keyboard-ES.png "Icono de controles en las opciones, sección Teclado")
...
![Configuración del humo en osu!](/wiki/shared/osu_smoke_set.jpg "Humo en los atajos del teclado")

#### ¿Por qué no tengo el máximo combo posible cuando no tengo fallos?

![Un slider en el editor de beatmaps en la parte superior; en la parte inferior, un slider mientras se juega un beatmap](/wiki/shared/Sliderticks.png "Un slider en el editor de beatmaps en la parte superior; en la parte inferior, un slider mientras se juega un beatmap")
...
![Ejemplo del contenido de un archivo .osu](/wiki/shared/Beatmap_not_owned.png "Ejemplo del contenido de un archivo .osu")
