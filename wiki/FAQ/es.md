...
`Tutorial: `[`Tutorial` `Origina` `(Incluido` `en` `la` `versión` `de` `osu!` `para` `PC)`](https://osu.ppy.sh/s/3756)`, `[`Version` `Rankeada` `del` `beatmap`](https://osu.ppy.sh/s/19928)
...
<img src="Mania Key Bind.png" title="fig:[Simétrico] Los colores de las teclas y su correspondiente lugar según el número de botones (desactualizado)" alt="[Simétrico] Los colores de las teclas y su correspondiente lugar según el número de botones (desactualizado)" width="200" /> <img src="Mania KEY Layouts.jpg" title="fig:Disposición de las teclas por defecto en osu!mania (Options-&gt;Controles)" alt="Disposición de las teclas por defecto en osu!mania (Options-&gt;Controles)" width="500" /> Existen dos diferentes estilos de disposición, *Simétrico* y *De Izquierda a Derecha*. (Pueden ser encontrados en Options-&gt;Controles)
...
Además, [la versión rankeada del beatmap del tutorial de osu!](https://osu.ppy.sh/s/19928)\] es buena para practicar algunos de los posibles diseños de mapping que encontrarás. Es un excelente beatmap de entrenamiento para jugadores principiantes y experimentados.
...
-   FAQ viejo de peppy
-   Peter Lambert - osu! tutorial ([Tutorial original](https://osu.ppy.sh/s/3756), [Versión rankeada](https://osu.ppy.sh/s/19928))
