...
- En osu!, los spinners han sido atenuados para que no sean molestos de completar.
  - El máximo número de spins por minuto posible es 477 que es también la velocidad con la que el mod [Auto](/wiki/Game_modifier) gira, mientras que el mod [Spun Out](/wiki/Game_modifier) gira a menos de 287 spins por minuto.
...
Si el mod [relax](/wiki/Game_modifier) es usado, el catcher se controla moviendo el ratón.
...
- SS de plata (SSH) = 100% de precisión con el(los) mod(s) '[hidden](/wiki/Game_modifier)' y/o '[flashlight](/wiki/Game_modifier)'.
- S de plata (SH) = Encima del 90% de 300s, menos del 1% de 50s y sin errores con el(los) mod(s) '[hidden](/wiki/Game_modifier)' y/o '[flashlight](/wiki/Game_modifier)'.
...
Pokebis ha compilado un conjunto de beatmaps adecuados para principiantes. Puedes encontrarlos aquí: [Link](https://osu.ppy.sh/community/forums/topics/5456).
...
Alternativamente, puedes [ordenar la lista de betmaps rankeados por dificultad](https://osu.ppy.sh/beatmapsets). Los beatmaps más fáciles están encima de la lista.
