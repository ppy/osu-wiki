...
Caso o mod [Relax](/wiki/Game_modifier) estiver sendo utilizado, o catcher pode ser movido com o mouse.
...
Existem dois tipos de padrão de teclas, *Simétrico* e *Esquerda-a-Direita*. (Podem ser encontrados em Opções->Input)
...
- SS Prateado (SSH) = 100% precisão jogando com mod '[hidden](/wiki/Game_modifier)' e/ou '[flashlight](/wiki/Game_modifier)'
- S Prateado (SH) = acima de 90% de 300s, menos de 1% de 50s sem perder nenhuma nota e jogando com o mod '[hidden](/wiki/Game_modifier)' e/ou '[flashlight](/wiki/Game_modifier)'.
