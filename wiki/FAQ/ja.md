...
無料です。
ですが公式サイトで[寄付](https://osu.ppy.sh/p/support)をしてサポーターとなることで、ゲーム内でビートマップをダウンロードできるようになったり、 ビートマップをアップロードできる数が増えたりします。
...
### 公式サイトで検索を掛けるときなどにプレイ済みビートマップと未プレイビートマップで条件を絞ることができるようになる
