...
Si le game modifier [Relax](/wiki/Game_modifier) est utilisé, seul le curseur fonctionnera. Utilisez le curseur pour suivre les hit objects, sans vous préoccuper de les taper. Les spinners doivent tout de même être faits.

Si le game modifier [Auto Pilot](/wiki/Game_modifier) est utilisé, seule l'entrée des appareils ne fonctionneront. Calculez le moment auquel taper les hit objects, sans vous occuper des mouvements du curseur. Les spinners iront à la vitesse du mod [Spun Out](/wiki/Game_modifier).
...
Si le mod [Relax](/wiki/Game_modifier) est utilisé, le jugement ne prendra compte que du timing des hits (ne prend pas en compte une mauvaise couleur).
...
Les bananes peuvent être ignorées, elles ne donnent pas de pénalité de vie. Cependant, cela peut coûter des points supplémentaires et de la récupération de vie de ne pas les récupérer. Le mod [Auto](/wiki/Game_modifier) fera quelque chose d'impossible: récupérer *toutes* kes bananes, sans en rater une seule.
...
- SS d'argent (SSH) = Grade SS normal avec le mod *[Hidden](/wiki/Game_modifier)* et/ou *[Flashlight](/wiki/Game_modifier)*.
- S d'argent (SH) = Grade S normal avec le mod *[Hidden](/wiki/Game_modifier)* et/ou *[Flashlight](/wiki/Game_modifier)*.
