...
*Spinner* adalah [hit object](/wiki/Hit_object) di [osu!](/wiki/Game_mode/osu!) yang menempati seluruh area bermain. Untuk melakukan spinner, tahan tombol mouse/keyboard yang ditentukan (atau letakkan pena ke permukaan tablet). Lalu, gunakan mouse (atau pena) dan putar spinner dengan gerakan melingkar (ke kedua arah) hingga spinner circle membesar keluar sepenuhnya. Pemberitahuan `Clear` akan muncul untuk menunjukkan bahwa spinner telah selesai. Jika spinner diselesaikan lebih awal, lanjutkan spinner untuk mengumpulkan bonus [skor](/wiki/Gameplay/Score) ekstra dan mendapatkan kembali [health](/wiki/Beatmapping/Health).
