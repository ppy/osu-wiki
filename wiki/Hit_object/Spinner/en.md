...
A *spinner* is a [hit object](/wiki/Hit_object) in [osu!](/wiki/Game_mode/osu!) which takes up the entire play area. To clear a spinner, hold down your specified mouse/keyboard-button (or keep the pen onto the tablet). From there, use the mouse (or pen) and spin the spinner in a circular motion (in either direction) until the spinner circle grows outwards completely. A *Clear* notice will appear to indicate that the spinner was completed. If the spinner was cleared early, continue spinning to collect an extra [score](/wiki/Gameplay/Score) bonus and gain some health back.
