...
*Объекты для ударов* это объекты на [карте](/wiki/Beatmaps/), с которыми игроки могут взаимодействовать во время игры. Каждый [игровой режим](/wiki/Game_Modes) имеет свой собственный набор элементов, который отличает его от других режимов. В таблице ниже показаны названия объектов в каждом режиме (объекты без перевода не имеют аналога в русском языке):
