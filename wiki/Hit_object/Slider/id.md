...
Slider tick adalah lingkaran kecil yang muncul secara berkala di sepanjang sliderbody. Pemain hanya gagal untuk melakukan slider sepenuhnya jika kursor berada di luar jangkauan slider ball (ditentukan oleh lingkaran di sekitar slider ball) atau tombol tidak ditekan saat slider ball melewati slider tick. Berada di luar jangkauan bola slider atau tidak menekan tombol pada waktu lain tidak akan menghasilkan penalti (meskipun tidak disarankan karena dapat dengan mudah mengakibatkan sliderbreak). Melewati slider tail atau slide rtick akan memberikan Mengklik hit circle akan menambahkan [health](/wiki/Beatmapping/Health) yang sangat kecil ke [health bar](/wiki/Client/Interface/Health_bar); biasanya hanya cukup untuk menjaga health bar di tempatnya.
