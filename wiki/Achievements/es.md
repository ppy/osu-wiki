Los **Logros *(Achievements)*** son pequeñas insignias en el perfil de alguien que indican que alguien ha llevado a cabo un objetivo excepcional. Actualmente, están divididos en 4 grupos.

Beatmap Packs
=============

**Los Beatmap Packs** son logros pueden ser obtenidos por **Jugar cada beatmap a al menos una vez en cualquier dificultad** Dentro de un [Theme Beatmap Pack](http://osu.ppy.sh/p/packlist?t=t). Deberá jugar en Modo [osu! Standard](ES:Standard "wikilink") para calificar a **CLEARED (Completado)** en el [Beatmap Pack Listing](http://osu.ppy.sh/p/packlist?t=t) y ganar la insignia.
...
Los Logros de **Combo** Se puede obtener al adquirir un determinado [Combo](Combo "wikilink") en el modo osu! Standard y se puede completar con cualquier canción.
...
Los logros por **Dedicación (Dedication)** pueden ser obtenidos por (Jugando continuamente en modo Standard / Recoger muchas frutas en modo [Catch the Beat (CTB)](ES:Catch_the_Beat "wikilink") / golpear un montón de golpes los tambores en modo [Taiko](ES:Taiko "wikilink") / presionando muchas teclas en [osu!mania](osu!mania "wikilink")).
...
<span style="color:#F00;text-decoration:underline;">Spoilear El método para desbloquear estos logros concretos "tendrá como resultado el Baneo de tu cuenta. "</span>(Era la regla antes del 16 de Agosto 2017. Esto ya es permitido)
