**Conquistas** (achievements) são pequenos emblemas para perfil que indicam que o usuário conseguiu realizar certo objetivo. Atualmente, eles são divididos em 4 grupos.

Beatmap Packs
=============

As conquistas de **Beatmap Packs** são obtidas por *' jogar todos os beatmaps de um [Beatmap Pack Temático](http://osu.ppy.sh/p/packlist?t=t) pelo menos uma vez (em qualquer dificuldade)*', sendo que o modo de jogo deva ser [osu!Standard](PT:Standard "wikilink").
...
As conquistas de **Combo** podem ser obtidas por conseguir um número específico de [Combo](Combo "wikilink") no modo Standard **em qualquer música**. Conseguir o mesmo combo em Taiko ou Catch the Beat não resultarão na obtenção da conquista.
...
As conquistas de **Dedication** (Dedicação) podem ser obtidas por jogar várias vezes no modo Standard, coletar várias frutas no [Catch the Beat](Catch_the_Beat "wikilink") acertar várias vezes os "tambores" do modo [Taiko](Taiko "wikilink") / pressionando varias teclas em [osu!mania](PT:Osu!mania "wikilink")
