...
#### Requirements:
 ...
 -   The mode must be [osu!Standard](/wiki/Game_Modes/Standard/it.md).                                       
...
**The Dedication** achievements can be obtained by (playing a lot of times in Standard mode / collecting many fruits in [Catch the Beat](/wiki/Game_Modes/Catch_the_Beat/it.md) mode/ hitting a lot of drum hits in [Taiko](/wiki/Game_Modes/Taiko/it.md) mode / pressing a lot of keys in [Mania](/wiki/Game_Modes/Osu!mania/it.md)).
