...
![RD gameplay](img/GM_Random.jpg "Comparison between original (left), Random mod only (middle), and Random mod with Co-Op mod (right) for osu!mania-specific (top) and non-specific (bottom) beatmaps")
