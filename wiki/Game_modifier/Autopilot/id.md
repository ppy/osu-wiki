...
Selain itu, nilai spins per minute (SPM) yang dilakukan oleh mod Autopilot juga sama seperti spins per minute yang dilakukan oleh mod [Spun Out](/wiki/Game_modifier/Spun_out). Dengan demikian, pemain tidak dapat meningkatkan SPM dengan cara memutar spinner menggunakan kursor mereka.
