...
- 설명:
  - ![][o!s]: `어프로치 서클이 사라지고 노트가 보였다 사라집니다. 이 모드를 켜면 점수에 배수가 붙습니다.`
  - ![][o!t]: `노트가 치기 전에 서서히 사라집니다!`
  - ![][o!c] `어프로치 서클이 사라지고 노트가 보였다 사라집니다. 이 모드를 켜면 점수에 배수가 붙습니다.`
  - ![][o!m]: `노트가 치기 전에 서서히 사라집니다!`
- HD를 사용할 수 있는 osu!의 장르: ![][o!s] ![][o!t] ![][o!c] ![][o!m]
...
[osu!standard](/wiki/Game_mode/osu!) 에서는, 히든 모드가 줄어드는 원을 없애고 히트 오브젝트가 나타난 직후 사라지게 하여 플레이어가 노트를 칠 타이밍을 기억하게 합니다. 또한 노트 배치 및 슬라이더 경로의 기억력을 요구합니다.
...
![osu!standard 에서의 HD 모드 게임 플레이](img/HD-standard.jpg "HD 모드가 켜진 상태에서의 osu!standard 게임 플레이")
...
난이도가 높은 비트맵에서는, 숙련된 플레이어들이 이 모드를 [HR](/wiki/Game_modififer/Hard_Rock) 모드 대신 많이 사용합니다. HR이 타이밍 창을 너무 작게 만들기 때문입니다.

osu!standard랑은 다르게 일반적으로 히든 모드는 플레이어들에게 다음에 오는 색깔을 기억하게 요구하기 때문에 리드 또는 익숙해지는 것이 훨씬 어렵습니다.
...
- 히든 모드는 [아자! 싸워라! 응원단](https://en.wikipedia.org/wiki/Osu!_Tatakae!_Ouendan "위키피디아")의 2번째 일본 DS 게임인 응원단 2 시리즈(osu!가 기반으로 한 게임)에서 처음 등장했습니다.
- 만약 이 모드를 켠 상태로 비트맵을 클리어 하여 S 또는 SS 등급을 얻었다면, 랭크가 은색으로 표시됩니다.
- 기본적으로, [osu!standard](/wiki/Game_mode/osu!standard)의 비트맵을 플레이할 때, 플레이어가 첫 [히트 오브젝트](/wiki/Hit_object)를 잘 칠 수 있도록 [어프로치 서클](/wiki/Hit_object/Approach_circle)이 일시적으로 표시됩니다. `게임 플레이` 옵션에서 끌 수 있습니다.
