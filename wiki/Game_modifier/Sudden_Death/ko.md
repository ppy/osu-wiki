...
**서든 데스** 모드는 [비트맵](/wiki/Beatmap)을 하는 도중 [노트](/wiki/Hit_Objects)를 놓치거나 슬라이더 틱을 놓쳤을 때 실패하게 됩니다. 이 모드는 [풀 콤보(FC)](/wiki/Full_combo)를 하려고 하는 플레이어에게 유용합니다. 서든 데스 모드를 사용할 때 [콤보 브레이크](/wiki/Glossary/Combobreak)가 나서 빠르게 다시 도전 하려는 유저에게 도움이 되는지 도움이 되지 않는지는 논란이 있습니다.
