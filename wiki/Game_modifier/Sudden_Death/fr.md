...
- Légende : `Ratez une note et échouez.`
- Modes de jeu compatibles : ![][o!s] ![][o!t] ![][o!c] ![][o!m]
- Variante : [Perfect](/wiki/Game_modifier/Perfect)

## Description

Le mod **Sudden Death** est un [modificateur de jeu](/wiki/Game_modifier) qui permet aux joueurs d'échouer une [beatmap](/wiki/Beatmap) lorsqu'ils manquent un [hit object](/wiki/Hit_Objects) ou ne parviennent pas à collecter un tick de slider. Ceci est utile pour les joueurs qui tentent un [full combo (FC)](/wiki/Glossary#fc). Bien qu'il y ait un débat quant à savoir si l'utilisation du mod Sudden Death ou le fait de réessayer au premier [combo break](/wiki/Glossary#combobreak) est utile ou nuisible pour les joueurs qui veulent s'améliorer rapidement.

Pour être plus précis, le mod Sudden Death ne fera échouer le beatmap que si l'une des situations suivantes se produit :

- Manque une note
- Rate la collecte d'un tick de slider (osu!standard uniquement)
- Ne pas réussir à compléter un spinner

Le mod Mort subite **ne fera pas** échouer la beatmap si l'une des situations suivantes se produit :

- Rate un [sliderend](/wiki/Hit_object/Slidertail) (c'est-à-dire un sliderbreak)
- Ne pas tenir/collecter sur un chemin d'un slider vide
...
- Si vous manquez une note alors que le mod Sudden Death est activé, une grande figure manquée supplémentaire apparaîtra dans [osu!standard](/wiki/Game_mode/osu!).
