...
- Légende :
  - ![][o!s]: `Vous n'avez pas besoin de cliquer. Vos doigts méritent une pause après toute cette agitation. ** LE SCORE RÉALISÉ NE SERA PAS COMPTABILISÉ **`
  - ![][o!t]: `Détendez-vous ! Vous ne serez plus embêté par les spinners surprise, les drumrolls difficile ou les katus inattendus. ** LE SCORE RÉALISÉ NE SERA PAS COMPTABILISÉ **`
  - ![][o!c]: `Utilisez la souris pour contrôler le personnage. ** LE SCORE RÉALISÉ NE SERA PAS COMPTABILISÉ **`
...
Dans le mode [osu!standard](/wiki/Game_mode/osu!), l'activation du mod Relax nécessite seulement que le joueur place son curseur sur un [objet](/wiki/Hit_object) ; tous les objets seront automatiquement tapés par osu!. Le mod rend impossible l'échec de la beatmap dans tous les modes de jeu.
...
Contrairement au mode osu!standard, dans osu!taiko, le mod Relax *affichera* le score, le combo et les ratés.
