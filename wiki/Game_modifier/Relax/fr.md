...
- Légende :
  - ![][o!s]: `Vous n'avez pas besoin de cliquer. Donnez à vos doigts qui cliquent et tapent une pause dans le feu de l'action. ** UNRANKED **`
  - ![][o!t]: `Détendez-vous ! Vous ne serez plus étourdi par des tourniquets de type ninja, des roulements de tambour exigeants ou des katu's inattendus. ** UNRANKED **`
  - ![][o!c]: `Utilisez la souris pour contrôler l'attrapeur. ** UNRANKED **`
- Modes de jeu compatibles : ![][o!s] ![][o!t] ![][o!c]
...
Dans [osu!standard](/wiki/Game_mode/osu!), l'activation du mod Relax nécessite seulement que le joueur place son curseur sur un [hit objects](/wiki/Hit_object) ; tous les hits objects seront automatiquement tapés par osu! Le mod rend impossible l'échec du beatmap dans tous les modes de jeu.
...
Dans [osu!taiko](/wiki/Game_mode/osu!taiko), le module Relax supprime le jugement de couleur : la couleur correcte pour la note est frappée indépendamment de la couleur donnée. Cependant, les couleurs des notes ne sont pas modifiées.
...
Contrairement à osu!standard, dans osu!taiko, le mod Relax *affichera* le score, le combo et les ratés.

### osu!catch

Dans [osu!catch](/wiki/Game_mode/osu!catch), le mod Relax permet de déplacer le personnage librement et à n'importe quelle vitesse avec la souris ou tout autre périphérique de déplacement du curseur.
