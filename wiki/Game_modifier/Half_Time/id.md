...
Mod **Half Time** adalah sebuah [game modifier](/wiki/Game_modifier) yang mengurangi kecepatan tempo (BPM) dari sebuah [beatmap](/wiki/Beatmap) ke 75% dari kecepatan awalnya, meingkatkan durasi dari lagu tersebut sebesar 33%, dan mengurangi sedikit jumlah [approach rate (AR)](/wiki/Beatmapping/Approach_rate), [overall difficulty (OD)](/wiki/Beatmapping/Overall_difficulty), [dan health (HP)](/wiki/Beatmapping/Health).

### osu!taiko

Pada [osu!taiko](/wiki/Game_mode/osu!taiko), lagu dan tempo yang sudah diperlambat menyebabkan not-not menjadi sangat bertumpuk karena AR yang telah dikurangi. Tetapi, karena cara denden dikalkulasikan pada osu!taiko, mereka sekarang memerlukan lebih banyak ketukan untuk diselesaikan dan mengakibatkan mereka untuk memberikan **jumlah nilai yang lebih tinggi daripada tanpa menggunakan mod** karena ketukan denden tidak terpengaruhi oleh [pengali skor](/wiki/Game_modifier/Score_multiplier).
...
Pada [osu!catch](/wiki/Game_mode/osu!catch), tempo nya diturunkan oleh faktor yang sama seperti di mode-mode permainan lainnya. Tetapi mod ini *juga* mengurangi kecepatan pemain, jadi fruit biasa tanpa mod lainnya *bisa* berubah menjadi sebuah fruit hyperdash.
