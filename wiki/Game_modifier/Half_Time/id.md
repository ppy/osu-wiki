...
Pada [osu!catch](/wiki/Game_mode/osu!catch), lagu dan tempo juga direndahkan oleh faktor yang sama seperti di mode-mode permainan lainnya. Tetapi mod ini *juga* mengurangi kecepatan pemain. Seluruh objek [fruit](/wiki/Hit_object/Fruit), [drop](/wiki/Hit_object/Juice_stream#drop), [droplet](/wiki/Hit_object/Juice_stream#droplet) dan [banana](/wiki/Hit_object/Banana) tetap sama.
