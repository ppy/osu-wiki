...
- The Mirror mod was added in September 2019, in response to a [feature request](https://osu.ppy.sh/community/forums/topics/956618) by user [Kamuy](https://osu.ppy.sh/users/7439226).
  - At the time of the feature request's posting, there was already a Mirror-like mod that was implemented in [osu! (lazer release)](https://github.com/ppy/osu#osu), but due to the Mirror mod's nature of increasing accessibility, it was added into the Stable release of osu! at the time.
