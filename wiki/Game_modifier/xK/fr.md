...
*Notice : Tous les mods xK seront ignorés sur les beatmaps spécifiques à osu!mania. L'utilisation des mods 1K, 2K ou 3K entraînera un jeu non classé.*

Il s'agit de [modificateurs de jeu](/wiki/Game_modifier) qui forceront toutes les [beatmap](/wiki/Beatmap) [osu!mania](/wiki/Game_mode/osu!mania) convertis à utiliser le paramètre K sélectionné. Cela ignore le paramètre K supposé de la beatmap au prix d'une diminution du multiplicateur de score, en fonction de la différence de K.
