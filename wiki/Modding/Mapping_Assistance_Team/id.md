...
**Mapping Assistance Team** (***MAT***) adalah grup yang bertanggung jawab untuk menilai kualitas dari [pending](/wiki/Beatmap/Category#work-in-progress-dan-pending) [beatmap](/wiki/Beatmap) dan merekomendasikannya ke bagian [ranking](/wiki/Beatmap/Category#ranked). Rekomendasi mereka diteruskan ke [Beatmap Appreciation Team](/wiki/Modding/Beatmap_Appreciation_Team) (*BAT*) dengan menempatkan sebuah [proto-bubble](/wiki/Modding/Proto-bubble), dan BAT kemudian akan membuat keputusan akhir apakah beatmap tersebut harus Ranked atau tidak.
