...
La **Mapping Assistance Team** (***MAT***) était un groupe chargé d'évaluer la qualité des [beatmaps](/wiki/Beatmap) [en attente](/wiki/Beatmap/Category#work-in-progress-et-en-attente) et de les recommander pour un futur [classement](/wiki/Beatmap/Category#classée). Leurs recommandations étaient transmises à la [Beatmap Appreciation Team](/wiki/Modding/Beatmap_Appreciation_Team) (*BAT*) en plaçant une [proto-bulle](/wiki/Modding/Proto-bubble), et la BAT prenait alors la décision finale quant à l'entrée de la beatmap dans la catégorie classée.
