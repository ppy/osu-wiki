...
1. Si votre mod a été utile pour le mappeur, il vous donnera un [Kudosu](/wiki/Modding/Kudosu). Les kudosus peuvent être utilisés afin d'augmenter la priorité de votre propre map.
...
Tout d'abord, téléchargez une map dans la partie [Pending Beatmap ou Work In Progress/Help](/wiki/Beatmap/Category#work-in-progress-and-pending) du forum (et non les parties [Ranked](/wiki/Beatmap/Category#ranked)/[Approved](/wiki/Beatmap/Category#approved) !). Vous pouvez choisir des maps au hasard ou ouvrir une modding queue dans la sous-partie **Modding Queue** en dessous de [Work In Progress/Help](/wiki/Beatmap/Category#work-in-progress-and-pending) et accepter des demandes de mods. Si vous avez l'intention d'ouvrir une modding queue, n'hésitez pas à jeter un coup d'oeil à certains d'entre eux pour vous donner une idée générale de leur fonctionnement.
...
Commencez en jouant cette difficulté normalement ou en utilisant le [test mode](/wiki/Beatmap_Editor/Test_mode). Ceci est une partie importante du modding car elle permet au moddeur de comprendre quels sont les [Patterns](/wiki/Mapping_Techniques) qui se jouent correctement. Notez tout ce qui semble bizarre (difficulté trop élevée ou trop basse, pattern pas très esthétique ou difficilement jouable, etc...).
...
Étant donné qu'osu! est un jeu de rythme, il est évident que tous les éléments d'une map doivent correspondre parfaitement à la musique jouée. Si certaines notes qui pourraient faire “mieux sonner” la map semblent manquantes, n'hésitez pas à en faire la remarque. Si certaines notes semblent [overmappés](/wiki/Beatmapping/Overmapping), n'hésitez pas non plus a suggérer de les effacer. Si n'importe quel élément de la map sonne mal ou semble bizarre lorsqu'elle est jouée, c'est probablement que cet élément a été mal placé, mal timé ou bien qu'il soit trop court ou trop long (sliders ou spinners). Il faut aussi noter que le modding des [Hitsounds](/wiki/Beatmapping/Hitsound) est très important aussi, des [Hitsounds](/wiki/Beatmapping/Hitsound) bien placées aident à avoir une meilleure consonance dans la beatmap et permettent pour les meilleurs mappeurs d'avoir une meilleure ambiance audio durant la beatmap. N'hésitez pas non plus à les suggérer.
