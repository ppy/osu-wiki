...
Le **modding** est l'acte de fournir des commentaires sur la [beatmap](/wiki/Beatmap) d'un autre utilisateur. Un utilisateur qui fait du modding est appelé un *modder*, et ses messages collectifs sur la discussion d'un beatmap sont appelés un *mod*.
...
- Le forum [Modding Queues](https://osu.ppy.sh/community/forums/60) est la plateforme la plus utilisée pour trouver des beatmaps à modder et demander des mods. Un utilisateur peut créer son propre fil de discussion, appelé "file d'attente", pour que d'autres utilisateurs puissent poster des maps à modder.
  ...
  Le créateur de chaque file d'attente en dicte les règles, contrôlant quels beatmaps sont viables pour recevoir des mods. Les files d'attente sont généralement ouvertes aux demandes de deux types de mods :
...
- Il n'est **pas** recommandé d'effectuer des recherches dans la liste des beatmaps en attente pour trouver des beatmaps à modder, car la plupart des soumissions ne visent pas le statut classée, et leurs créateurs ne répondront donc potentiellement pas aux mods.

## Comment modder

Pour modder un beatmap, commencez par télécharger la version la plus récente et ouvrez sa [page de discussion](/wiki/Beatmap_Discussion). Jouez à la [difficulté](/wiki/Beatmap/Difficulty) que vous souhaitez modifier et gardez à l'esprit tout problème lié au gameplay. Lorsque vous avez terminé, ouvrez la difficulté dans l'éditeur et analysez-la à la recherche d'autres problèmes.
...
Les mappeurs fournissent régulièrement des [kudosu](/wiki/Modding/Kudosu) aux messages des modder qu'ils considèrent comme utiles en cliquant sur le bouton de vote "like". Cette statistique est enregistrée sur le profil d'un individu et est référencée lors de la demande d'adhésion aux [Beatmap Nominators](/wiki/People/The_Team/Beatmap_Nominators).

## Types de postes des modders
