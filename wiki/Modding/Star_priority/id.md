...
1. Sebuah sistem untuk membantu Beatmap Nominator dalam menemukan beatmap yang layak untuk dibubble dan kemudian diberi ranking.
   ...
   - Diperlukan setidaknya 12 star priority agar sebuah beatmap dapat di-[bubble](/wiki/Modding/Bubble) atau diberikan status ranked.
2. Suatu sistem untuk menentukan apakah suatu Permintaan Fitur diinginkan oleh komunitas.
   ...
   - Pengguna yang sedang memiliki osu! supporter saat pemungutan suara dapat memberikan dua bintang (![Star](img/star.png)) tiap satu suara, sedangkan pengguna yang tidak memiliki osu! supporter dapat memberikan sebuah bintang tiap suaranya. Pengguna dapat memberikan beberapa bintang tergantung pada seberapa banyak sisa suara mereka.
   - *Catatan: Forum Feature Request saat ini sudah tidak dipakai dan telah digantikan oleh alur [GitHub Discussions](https://github.com/ppy/osu/discussions)*
