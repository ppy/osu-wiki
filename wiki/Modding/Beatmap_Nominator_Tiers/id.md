...
- BN tingkat 1 dapat memberikan nominasi pertama pada sebuah map (atau nominasi kedua untuk beatmap [Approved](/wiki/Beatmaps#approved)).
...
Tingkatan Beatmap Nominator adalah pendahulu dari pembeda [Full Beatmap Nominators](/wiki/People/The_Team/Beatmap_Nominators#full-beatmap-nominators) dan [Probationary Beatmap Nominators](/wiki/People/The_Team/Beatmap_Nominators#probationary-beatmap-nominators) yang sudah diterapkan sejak September 2017. Izin mereka hampir sama, namun pengguna tidak bisa tetap berada di tingkat yang lebih rendah (probation) lebih dari 2 bulan. Jika seorang pengguna tidak siap untuk menjadi Full BN setelah 2 bulan, mereka akan dihapus dari BN.
