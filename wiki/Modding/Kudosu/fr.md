...
Le kudosu est attribué aux posts de modding qui ont aidé et apporté des suggestions utiles pour la map. Si un mappeur trouve qu'un post de modding est utile et montre un problème valide, il peut cliquer sur le bouton de pouce en l'air et récompenser d'un kudosu l'utilisateur ayant fait le post de modding.
...
De nos jours, le kudosu est utilisé dans l'évaluation de la capicité d'un utilisateur à [devenir](/wiki/People/The_Team/Beatmap_Nominators/Becoming_a_Beatmap_Nominator) un [Beatmap Nominator](/wiki/People/The_Team/Beatmap_Nominators). Un utilisateur doit avoir 200 kudosu sur osu! ou 150 kudosu en osu!taiko, osu!catch ou osu!mania pour faire une demande.
