...
現在、kudosuは[ビートマップノミネーター](/wiki/People/Beatmap_Nominators/Becoming_a_Beatmap_Nominator)に[なる](/wiki/People/Beatmap_Nominators)ための基準に使われており、ユーザーはosu!で200票、またはosu!taiko、osu!catch、osu!maniaのどれか一つで150票持つことでそのモードのノミネーターになる条件を一つ満たすことができます。
