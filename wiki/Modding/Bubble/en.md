...
In the modern [beatmap ranking procedure](/wiki/Beatmap_ranking_procedure), the equivalent of a bubble is the first [nomination](/wiki/Beatmap_ranking_procedure#nominations) given by a [beatmap nominator](/wiki/People/The_Team/Beatmap_Nominators).
