...
Previously, in the era of [forum modding](/wiki/Modding/Forum_modding), nominations were expressed through a combination of ![Bubble icon](/wiki/shared/icon/bubble.gif) [bubble](/wiki/Modding/Bubble) and ![Heart icon](/wiki/shared/icon/heart.gif) rank posts, where a bubble icon meant the first nomination, and the heart icon was the second. Maps going for [approval](/wiki/Beatmap/Category#approved) instead of ranking needed to abide by a slightly different set of rules and required three nominations, with the last of them having a ![Flame icon](/wiki/shared/icon/flame.gif) flame icon.
