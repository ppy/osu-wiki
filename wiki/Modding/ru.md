...
Чаще всего моды пишут для повышения качества карты, идущей в категорию [Ranked](/wiki/Beatmaps/Category#ranked). Так как моддинг — довольно тщательный процесс, требующий долгого анализа карты, пользователи часто модят, чтобы лучше понимать маппинг.
...
Просто так искать карты для моддинга в категории [Pending](/wiki/Beatmaps/Category#pending) **не** рекомендуется: авторы большинства из них не планируют их ранкать, и ваш мод вряд ли будет применён.
