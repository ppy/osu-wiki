...
Ensuite, le système de discussion des beatmap et le [code de conduite pour le modding et le mapping] (/wiki/Rules/Code_de_conduite_pour_le_modding_et_le_mapping#making-a-mod-post) ont été développés et mis à disposition pour restructurer le modding et en faire une expérience plus agréable pour toutes les personnes impliquées :
