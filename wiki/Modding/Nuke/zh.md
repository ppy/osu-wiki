...
- 未能遵守[谱面上架标准 (RC)](/wiki/Ranking_criteria) 的基本要求。
  - 含有时间轴测错了的段落。
  - 含有在空间和/或时间上随意随机摆放的[打击物件](/wiki/Gameplay/Hit_object)。
  - 极富挑战性，或者特别激进的谱面（比如整张谱面的内容只有一个[转盘](/wiki/Gameplay/Hit_object/Spinner)）。
- 无视[行为准则](/wiki/Rules/Code_of_conduct_for_modding_and_mapping)。

从技术上来说，核弹功能依然存在于论坛上，但随着 [v2 摸图系统](/wiki/Beatmap_discussion)和[谱面否决 (veto)](/wiki/People/Beatmap_Nominators/Beatmap_Veto) 机制的设立，它实际上已经被取代，在当前的摸图系统中失去了作用。
