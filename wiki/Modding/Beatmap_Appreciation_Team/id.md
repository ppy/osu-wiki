...
**Beatmap Appreciation Team** (***BAT***, sebelumnya dikenal sebagai *Beatmap Approval Team*) adalah sebuah grup yang bertanggung jawab untuk mengawasi proses [ranking dan diskualifikasi](/wiki/Beatmap_ranking_procedure) beatmap di dalam sistem [forum modding](/wiki/Modding/Forum_modding). Anggota BAT juga memiliki alat dasar untuk moderasi di dalam game dan forum seperti yang digunakan oleh [Global Moderation Team](/wiki/People/The_Team/Global_Moderation_Team) (*GMT*).
