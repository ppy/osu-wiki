Getting Your Map Modded (Русский)
==================================

Для того, чтобы вашу карту [ранкнули](RU:Beatmaps "wikilink"), её должны [помоддить](RU:Modding "wikilink") другие люди. Есть несколько способов добиться этого.
...
[БанчоБот](RU:Glossary#Банчо "wikilink") запоминает 20 последних запросов на моддинг. Эти запросы можно увидеть следующими способами:
...
-   Посетите [специальный список карт](http://osu.ppy.sh/p/beatmaplist&r=8) на главном сайте, где будут 20 последних запросов и несколько дополнительных.
...
**Очереди** — это темы на форуме, где вы постите карты, а создатели этих тем моддят их. Они находятся на главном сайте [вот здесь](http://osu.ppy.sh/forum/60). Но стоит помнить, что (почти) каждая тема (очередь) имеет свои правила, читайте их внимательно (!). При соблюдении всех правил (или их отсутствии) вашу карту помоддят.
...
Просто попросить других людей помоддить вашу карту — это хороший способ получить моды, но только в том случае, если вы спрашиваете правильных людей. Не сложно догадаться, что спрашивать людей, которые не разбираются в маппинге/моддинге, бессмысленно. Ищите пользователей, у которых приличное количество [кудос](RU:Kudosu "wikilink") и нет очереди; чаще всего они примут твой запрос, если они не заняты.
