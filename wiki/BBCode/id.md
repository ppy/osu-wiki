...
**Menekankan** kata-kata atau seluruh paragraf dengan cara _memiringkan teks_ kata yang disorot, tag ini lebih efektif daripada [bold](#bold) dalam situasi penekanan kata mana yang butuh sorotan miring.
...
**Menambahkan Tautan Langsung** menggunakan tombol Google _I'm Feeling Lucky_ dengan teks yang sudah disediakan.
