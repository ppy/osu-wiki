...
::: alert-notice
**Внимание**
можно не использовать `[url]`, если название не важно: вставленная ссылка будет работать и так.
:::
...
::: alert-notice
**Внимание**
списки в BBCode можно объединять, но форматирование в них может сломаться.
:::
