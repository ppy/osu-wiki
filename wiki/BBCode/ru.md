...
Тег `[c]` включает моноширинный шрифт и меняет цвет фона текста на серый. В противовес [фрагменту кода](#фрагмент-код), этот тег работает только с текстом, набранным в одну строку.
...
Вместо `IMAGE_URL` нужно вписать ссылку на картинку, которую вы хотите использовать. Она должна быть прямой (вести сразу на изображение).
