...
ユーザーIDで指定した場合、開始タグと終了タグの間のテキストは解析されません。ユーザー名のみで指定した場合で、リンク先のユーザーがユーザー名を変更した場合、リンクは機能しなくなります。
...
タイプの引数に`1`、`a`、`A`、`i`、`I`のどれかを指定すると、それぞれ数字、ローマ字(小文字)、ローマ字(大文字)、ローマ数字(小文字)、ローマ数字(大文字)としてフォーマットされます。
