...
**Enfatiza** palabras o un párrafo entero de una manera _menos intensa que_ [negrita](#negrita).
...
**Agrega un enlace directo a una página** usando el botón de Google _I'm Feeling Lucky_ usando el texto proporcionado.
