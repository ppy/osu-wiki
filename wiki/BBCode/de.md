...
::: alert-note
**Anmerkung:** Für eine Liste aller Farbkodierungen, siehe [X11 Farbkodierung](https://de.abcdef.wiki/wiki/X11_color_names)
:::
...
- Dieser Wikiartikel wurde ursprünglich adaptiert aus dem Forenbeitrag ["HOW TO: Forum BBCodes"](https://osu.ppy.sh/community/forums/topics/445599) von ::Stefan::{ user=626907 }.
