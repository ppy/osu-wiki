...
**Uwydatnij** tekst w _łagodniejszy_ sposób niż poprzez [pogrubienie](#pogrubienie).
...
Dodaje łącze do strony wyszukanej dzięki funkcji _Szczęśliwy traf_ wyszukiwarki Google.
