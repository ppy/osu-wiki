...
**Souligne** des mots ou un paragraphe entier d'une manière _plus légère_ que le [gras](#gras).
...
**Ajoute un lien direct vers une page** à l'aide du bouton _J'ai de la chance_ de Google, à l'aide du texte fourni.
