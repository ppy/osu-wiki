...
これが完了すると、リズムアドベンチャーを開始する準備が整いました！[ビートマップを追加](/wiki/Installation#ビートマップセットを追加)して遊んだり、[スキンを作成](/wiki/Skinning)したり、[ビートマップを作成](/wiki/Beatmapping)したりできます。[Introductions サブフォーラム](https://osu.ppy.sh/community/forums/8)で「こんにちは」と挨拶することもできます。
