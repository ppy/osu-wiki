...
게임안에서 도움이 필요할경우 `f8` 또는 `f9`키를 누른 후 `/join help`를 입력하면 `#help` [채팅방](/wiki/Internet_Relay_Chat)으로 이동되므로 여기서 물어봐주세요! 또는 [help포럼]을 이용해주세요.(https://osu.ppy.sh/community/forums/5).
