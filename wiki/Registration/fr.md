...
1. Après [l'installation](/wiki/Installation) d'osu!, il vous sera demandé de vous connecter ou de vous inscrire. En supposant que vous soyez ici parce que vous avez besoin d’un compte, cliquez sur `Créer un compte`.
...
Si vous avez besoin d’une aide supplémentaire dans le jeu, vous pouvez demander dans le canal [IRC](/wiki/IRC) (Internet Relay Chat) `#help` en ouvrant la console de chat (pressez `F8` ou `F9` en jeu) puis tapez `/join help`. Vous pourrez également poser votre question dans le [sous-forum Help](https://osu.ppy.sh/community/forums/5).
