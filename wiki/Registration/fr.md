...
2.  Remplissez tous les champs du formulaire.
    -   Pour le champ `Nom d'utilisateur`, il y a un maximum de 15 caractères; dont ne peuvent être que des caractères alphanumériques, en sont donc exclus (`a-z`, `A-Z`, `0-9`), soulignés (`_`), crochets, (`[` et `]`), tirets (`-`), et espace (` `).
...
Si vous avez besoin d’une aide supplémentaire dans le jeu, vous pouvez demander dans le canal `#help` [IRC](/wiki/IRC) (Internet Relay Chat) en ouvrant la console de chat (pressez `F8` ou `F9` en jeu) puis tapez `/join help`. Vous pourrez également poser votre question dans le [sous forum Help](https://osu.ppy.sh/community/forums/5).
