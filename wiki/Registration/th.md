...
ถ้าต้องการความช่วยเหลือเพิ่มเติม สามารถขอความช่วยเหลือได้ในช่อง `#help` บน [IRC](/wiki/Internet_Relay_Chat) โดยการเปิดคอนโซลการพูดคุย (กด `F8` หรือ `F9` ในเกม) จากนั้นพิมพ์ `/join help` หรืออีกวิธีการคือสามารถโพสถามได้ที่[ซับฟอรั่ม Help](https://osu.ppy.sh/community/forums/5) เหมือนกัน
