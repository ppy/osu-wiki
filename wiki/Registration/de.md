...
1. Nach der [Installation](/wiki/Installation) und dem Starten von osu! fordert dich das Spiel zum Einloggen oder Registrieren auf. Zum Erstellen eines Accounts musst du nur auf `Create an Account` klicken und osu! im Hintergrund offen lassen. Nun sollte sich die [Account erstellen](/p/register)-Webseite öffnen.
...
2. Fülle alle Felder des Formulars aus.
    ...
    - Verwende deine echte E-Mail-Adresse. Sie wird zum Zurücksetzen deines Passwortes und zum Versenden von Bestätigungscodes verwendet, daher solltest du immer auf sie zugreifen können (verwende keine "Throwaway"-E-Mail-Adresse).
