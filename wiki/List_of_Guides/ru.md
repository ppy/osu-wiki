...
Кроме того, очень хорошим источником руководств является весь форум [General Questions](https://osu.ppy.sh/forum/56).

Если вы решите перевести какое-нибудь из руководств и/или добавить его на вики, пожалуйста, сначала загляните в [справку по редактированию статей](/wiki/Contents). После окончания перевода не забудьте [добавить ссылку в шаблон](/wiki/index.php?title=Template:Guides/RU&action=edit), расположенный внизу статьи, а также в саму статью.

FAQ и критерии ранкинга
-----------------------

-   [Общая справка](/wiki/FAQ) — краткая справка, покрывающая большинство вещей, нужных среднестатистическому игроку.
    -   [Привет](/wiki/Welcome) — введение в курс дела.
    -   [Официальные правила](/wiki/Rules) — то, что вы должны прочитать первым делом.
    -   [Регистрация](/wiki/Registration) — если у вас внезапно не получилось.
    -   [Установка](/wiki/Installation) — как установить игру.
...
-   [AIBat](https://osu.ppy.sh/forum/t/55305) — проверяет карту на наличие многих ошибок, которые трудно или утомительно искать вручную.
-   [osu!ModdingAssistant](https://github.com/xSigi/osuModdingAssistant) — современная замена AIBat.

Скиннинг и хитсаунды
--------------------

-   [Скининг](/wiki/Skinning)
-   [Создание скинов](/wiki/Skinning/Tutorial)
    -   [Интерфейс](/wiki/Skinning/Tutorial/Interface)
