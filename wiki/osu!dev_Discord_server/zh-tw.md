...
**osu!dev** 是官方的 [Discord](https://discordapp.com "Discord 官網") 伺服器，用於 osu! 的開源及社群專案。也是為 osu! 貢獻及聯繫 [osu! 團隊](/wiki/People/The_Team)的主要場所。
...
| 專案 | 頻道 |
| :-- | :-- |
| [osu!lazer](https://github.com/ppy/osu "在 Github 上的 ppy/osu") | `#osu-lazer` |
| [osu!framework](https://github.com/ppy/osu-framework "在 Github 上的 ppy/osu-framework") | `#osu-framework` |
| [osu!web](https://github.com/ppy/osu-web "在 Github 上的 ppy/osu-web") | `#osu-web` |
...
| [osu! wiki](https://github.com/ppy/osu-wiki "在 Github 上的 ppy/osu-wiki") | `#osu-wiki` |
