...
_Note: This article lists the default keyboard shortcuts. You can change some of them in the [options](/wiki/Options)._
...
_Note: Not all of these work in the Multi mode's song select screen._
...
_Note: Pressing the shortcut key will toggle it. You need to be in the game modifiers menu to use these shortcuts._

_Note: Target practice (osu!standard), 1K and 2K (osu!mania), Co-op (osu!mania), and Mirror (osu!mania) do not have shortcuts._
...
_Notice: You must use the cuttingedge release stream to use these._
...
_Main page: [Beatmap Editor](/wiki/Beatmap_Editor)_
