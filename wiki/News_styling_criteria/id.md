...
Siapapun yang tertarik untuk berkontribusi atau menulis postingan berita, hubungi kami di saluran `#osu-news` dari [server Discord osu!](https://discord.com/invite/ppy). Alternatifnya hubungi ::{ flag=AU }:: ::Ephemeral::{ user=102335 } atau [wiki aktif atau pengelola berita](/wiki/People/osu!_wiki_maintainers) mana pun.
