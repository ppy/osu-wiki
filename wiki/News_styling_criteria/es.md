...
- Todas las noticias deberían incluir y enlazar a la imagen usada en la portada en la carpeta [`wiki/shared/news/`](https://github.com/ppy/osu-wiki/tree/master/wiki/shared/news). En los casos excepcionales en los que no se desee usar ninguna portada, usa la imagen predeterminada: `https://osu.ppy.sh/images/headers/news-show-default.jpg`.
