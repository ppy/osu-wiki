...
如有撰写新闻稿或为此做出贡献，请前往 [osu! Discord 服务器](https://discord.com/invite/ppy) 的 `#osu-news` 频道，或直接联系 ::{ flag=TN }:: ::Hivie::{ user=14102976 }、::{ flag=ES }:: ::RandomeLoL::{ user=7080063 }、::{ flag=SE }:: ::Walavouchey::{ user=5773079 } 或者其他任意比较活跃的 [wiki 或新闻维护者](/wiki/People/osu!_wiki_maintainers)。
