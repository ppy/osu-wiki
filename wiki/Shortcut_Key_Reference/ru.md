...
Все они перечислены в списке следующим далее.

**Заметка:** некоторые из комбинаций можно поменять в [настройках](/wiki/options)!
Используемые в данном списке сочетания клавиш установлены по умолчанию.
