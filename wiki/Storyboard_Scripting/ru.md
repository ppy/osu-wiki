...
Видеообзор концепций, применяющихся в скриптинге сториборд, от [Doomsday](https://osu.ppy.sh/users/18983): [osu! - Storyboard Scripting for Beginners (12:22)](https://www.youtube.com/watch?v=UJ1YLDs-bZg "YouTube").

## Полная спецификация

*Важно: Сначала сохраните сториборд в редакторе игры для автоматической оптимизации, и только потом в текстовом редакторе. **Сохраняйтесь чаще**, чтобы предотвратить случайную потерю сделанных изменений.*
