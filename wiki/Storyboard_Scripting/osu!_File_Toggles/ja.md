...
ストーリーボードでは正しい画像名を対象に選択すればプレイヤーが現在使用しているスキンから画像を参照させることも可能です。ただし既にスキンをフォルダ内に含んでいる場合はこれは特に意味のないものとなります。[ソース](https://osu.ppy.sh/forum/viewtopic.php?p=141760#p141760)
