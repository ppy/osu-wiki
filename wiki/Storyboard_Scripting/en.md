...
In addition to the [built-in storyboard editor](/wiki/Beatmap_Editor/Design) to create [storyboards](/wiki/Storyboards) for maps, a plain text editor, such as Notepad or [Notepad++](http://www.notepad-plus-plus.org/), can also be used. This workflow is called **storyboarding by scripting**, or SBS, and allows one to be more precise (to the pixel and the millisecond) as to when sprites appear, how they behave, and so on.
...
Before writing storyboard scripts, please read about [the terms and basic concepts](/wiki/Storyboard_Scripting/General_Rules) to prevent possible further issues and misunderstanding. For more in-depth explanations, see:
