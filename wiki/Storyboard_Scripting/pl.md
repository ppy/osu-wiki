...
[Przeczytaj główne zasady przed zaczęciem skryptowania tła](/wiki/Storyboarding/Storyboard_Scripting_General_Rules). Zaoszczędzi ci to późniejszych problemów. Tutaj możesz sprawdzić [specyfikację obiektów w sprite'ów](/wiki/Storyboarding/Objects) oraz [ich ruch](/wiki/Storyboarding/Storyboard_Scripting_Commands). Tutaj mamy [dodatkowe ciekawoski](/wiki/Storyboarding/Storyboard_Scripting_Miscellaneous).
