...
Дякую за інтерес, проявлений до osu! wiki.

Ця стаття адресована тим, кто раніше не працював з GitHub і не брав участь в редагуванні osu! wiki. Якщо такий досвід є, то далі можна не читати: користуйтеся схемою «одна стяття (чи група статей на одну тематику) - одна гілка».
...
3. Відстающа гілка не містить в собі всіх свіжих змін з оригінального репозиторія. В такому випадку, при редактуванні osu! wiki, ви можете працювати з застарілими статтями і не знати про нові правки.

4. Щоб взнати, як синхронізувати гілку, подивіться в [список проблем при роботі з osu! wiki і їх рішень](/wiki/owcg/Common_Issues#відстающа-гілка-master).
...
- Через [веб-інтерфейс GitHub](/wiki/owcg/GitHub_Web_Interface), що зручно при роботі з одною статтею.
- В вашому улюбленому текстовому редакторі, використовуючи [GitHub Desktop](/wiki/owcg/GitHub_Desktop). Цей варіант підходить для декількох статей або масових правок.
...
2. При наявності ваших недавніх коммітів в форк ви побачите жовту полоску, як на скріншоті нижче.

   ![](img/github-recent.jpg)

3. Якщо полоска видна, натисніть на кнопку `Compare & pull request` і перейдіть до 8 кроку. Якщо ні - на кнопку `New pull request` (наступний крок).
...
6. В списку `compare` виберіть гілку, яку ви хотіли відправити в пулл-реквесті (вони відсортовані по алфавіту).
...
8. В заголовку коротко опишіть суть пулл-реквеста: що ви дописуєте або виправляєте. Для простоти можна вказати лише назву статті.
   ...
   Якщо це переклад, вставте перед заголовком пулл-реквеста назву мови, на який ви переводите. Наприклад, `[UK] Github Desktop` означає, що ви оновляєте (або створюєте) переклад [статті про Github Desktop](wiki/owcg/GitHub_Desktop) на українську мову.

9. Напишіть опис до пулл-реквеста. В нього можна додати все, що ви хочете донести до оглядача, наприклад, «Needs formatting check» або «Перевірте граматику, будь ласка». Крім цього, можна вказати баги, які пулл-реквест закриє, наприклад, «resolves #1» (дв. справку GitHub [«Closing issues using keywords»](https://help.github.com/articles/closing-issues-using-keywords/)).

10. Коли все буде готово, натисніть на кнопку `Create pull request`.

   ![](img/new-pull-request.png)

11. Про те, що буде далі, можна вказати в розділах про [перевірку](#перевірка) і [злиття змін](#злиття-змін).

### Перевірка

Зразу після створення пулл-реквеста, його можуть побачити і прокоментувати інші люди, вказав на можливі недоліки. Пулл-реквест, де довгий час нічого не робиться, можуть закрити, із-за цього ваша задача - **стежити за коментуванням, відповідати на них і виправляти знайдені помилки.** Якщо ви хочете, щоб вашу роботу перевірили, напишіть в [діскорд osu!dev](https://discord.gg/ppy), в каналі `#osu-wiki` або в коментаріях на GitHub.
