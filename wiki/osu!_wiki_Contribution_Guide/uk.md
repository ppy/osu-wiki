...
Ця стаття адресована тим, хто раніше не працював з GitHub і не брав участь в редагуванні osu! wiki. Якщо такий досвід є, то далі можна не читати: користуйтеся схемою «одна стяття (чи група статей на одну тематику) - одна гілка».
...
4. Щоб дізнатись, як синхронізувати гілку, подивіться в [список проблем при роботі з osu! wiki і їх рішень](/wiki/owcg/Common_Issues#відстающа-гілка-master).
...
8. В заголовку коротко опишіть суть пулл-реквеста: що ви дописуєте або виправляєте. Для простоти можна вказати лише назву статті.
   ...
   Якщо це переклад, вставте перед заголовком пулл-реквеста назву мови, на яку ви перекладаєте. Наприклад, `[UK] Github Desktop` означає, що ви оновляєте (або створюєте) переклад [статті про Github Desktop](wiki/owcg/GitHub_Desktop) на українську мову.
