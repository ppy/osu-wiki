...
4. Щоб дізнатись, як синхронізувати гілку, подивіться в [список проблем при роботі з osu! wiki і їх рішень](/wiki/osu!_wiki_Contribution_Guide/Common_Issues#відстающа-гілка-master).
...
- Через [веб-інтерфейс GitHub](/wiki/osu!_wiki_Contribution_Guide/GitHub_Web_Interface), що зручно при роботі з одною статтею.
- В вашому улюбленому текстовому редакторі, використовуючи [GitHub Desktop](/wiki/osu!_wiki_Contribution_Guide/GitHub_Desktop). Цей варіант підходить для декількох статей або масових правок.
...
8. В заголовку коротко опишіть суть пулл-реквеста: що ви дописуєте або виправляєте. Для простоти можна вказати лише назву статті.
   ...
   Якщо це переклад, вставте перед заголовком пулл-реквеста назву мови, на яку ви перекладаєте. Наприклад, `[UK] Github Desktop` означає, що ви оновляєте (або створюєте) переклад [статті про Github Desktop](wiki/osu!_wiki_Contribution_Guide/GitHub_Desktop) на українську мову.
