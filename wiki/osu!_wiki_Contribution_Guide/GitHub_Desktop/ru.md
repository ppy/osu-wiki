...
- При включении изменений в основной репозиторий, а также при обновлении вашей ветки, вы будете намного реже сталкиваться с [конфликтами](/wiki/osu!_wiki_Contribution_Guide/Common_Issues#конфликты-в-пулл-реквесте).
...
9. Переходите к [публикации изменений](/wiki/osu!_wiki_Contribution_Guide#публикация-изменений).
