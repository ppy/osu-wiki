...
*Éste artículo continua desde [la página principal](/wiki/osu!_wiki_Contribution_Guide)* y asume que estarás usando [GitHub para Escritorio](https://desktop.github.com). **Puedes usar otros clientes de Git bajo tus propios términos.** Incluso si es que trabajas localmente, seguirás necesitando entrar a GitHub para crear 'pull requests' para hacer que tus cambios pasen.
...
4. Continua a [Clonando](#clonando).
...
5. Continua a [Ramificando](#ramificando).
...
3. Continua a [Editando](#editando).

## Editando

1. En el archivo en el que has clonado el repositorio, navega al archivo que quieres editar. Los artículos están organizados por el nombre de los archivos, siendo el nombre de los archivos y los archivos `.md` los locales.
...
4.Continua a [Haciendo 'commits' y 'pushes'](#haciendo-'commits'-y-'pushes').

### Moviendo archivos existentes

1. Usa el Explorador de Archivos de Windows para mover archivos a cualquier parte.
2. Continua a [Haciendo 'commits' y 'pushes'](#haciendo-'commits'-y-'pushes').
...
2. Pör defecto, GitHub para Escritorio automáticamente seleccionará todos tus cambios.
