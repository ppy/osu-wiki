...
1. В залежності від типу файла, використовуйте зручний вам інструмент: Провідник Windows, текстовий або графічний редактор. При створенні перекладу статті використовуйте для імені файла [скорочену назву локалі](/wiki/ASC#locales) (`uk` для української мови).
2. [Зробіть комміт](#комміт-та-вивантаження-змін), щоб зберегти зміни.
