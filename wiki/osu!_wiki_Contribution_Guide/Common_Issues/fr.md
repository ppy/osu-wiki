...
10. Ignorer le titre et la zone de description et cliquer sur `Create pull request` encore.
...
Lorsque vous avez créé votre fork du `osu-wiki`, vous avez pris un instantané du contenu à ce moment précis. Le problème est qu’il ne se met pas automatiquement à jour et que GitHub n’a pas de solution miracle pour le faire à votre place.
