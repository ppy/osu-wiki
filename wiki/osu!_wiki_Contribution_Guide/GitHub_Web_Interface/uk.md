...
*Ця стаття є продовженням основного [посібника](/wiki/owcg).* Якщо ви збрираєтесь редагувати декілька статей або файлів, використовуйте [GitHub Desktop](/wiki/owcg/GitHub_Desktop).
...
8. Переходимо до [публікації змін](/wiki/owcg#публікація-змін) в оригінальний репозиторій.
