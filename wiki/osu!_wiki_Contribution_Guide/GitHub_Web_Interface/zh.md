...
_父页面: [osu! wiki 贡献指南](/wiki/owcg)._

_这篇文章继续父页面的内容._ 如果你打算修改多篇文章（包括上传，删除，移动图片或其他文件），请阅读另一篇指南——[GitHub Desktop](/wiki/owcg/GitHub_Desktop)。
...
_提示：你也可以上传文件夹。_这适用于在本地创建并上传多篇文章的情况。

### 删除文件

_警告：**不建议**这么做，因为你只能一次删除一个文件！可能会制造很多“无意义”的提交，让其他审阅人员误解而关闭你的 Pull Request。_
