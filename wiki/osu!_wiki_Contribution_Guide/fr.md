...
Merci de votre intérêt pour aider à rendre l'osu! wiki meilleur ! Ce guide de démarrage rapide est destiné aux nouveaux arrivants qui n'ont jamais travaillé avec GitHub et les workflow de contribution d'osu! wiki avant. Si vous avez déjà utilisé GitHub, n'hésitez pas à ignorer ce guide et à suivre le flux de travaux commun aux branches de fonctionnalités pour les mises à jour de contenu dans ce référentiel.
...
1. [S'inscrire](https://github.com/join) sur GitHub si vous n'avez pas de compte.
...
- [Interface Web GitHub](/wiki/owcg/GitHub_Web_Interface) - éditer en ligne; c'est le meilleur choix pour l'édition d'un seul article
