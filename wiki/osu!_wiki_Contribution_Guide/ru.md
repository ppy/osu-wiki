...
4. Чтобы узнать, как синхронизировать ветку, загляните в [список проблем при работе с osu! wiki и их решений](/wiki/osu!_wiki_Contribution_Guide/Common_Issues#отстающая-ветка-master).
...
- Через [веб-интерфейс GitHub](/wiki/osu!_wiki_Contribution_Guide/GitHub_Web_Interface), что удобно при работе с одной статьёй.
- В вашем любимом текстовом редакторе, пользуясь [GitHub Desktop](/wiki/osu!_wiki_Contribution_Guide/GitHub_Desktop). Этот вариант подходит для нескольких статей или массовых правок.
