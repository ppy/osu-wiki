...
osu! wiki 개선에 관심을 가져주셔서 감사합니다! 이 빠른시작 가이드는 GitHub과 osu! wiki 기여 방법에 대해서 모르는 신입유저를 위해 제작되었습니다. 혹시 자신이 GitHub을 사용한 경험이 있다면, 이 가이드를 스킵하시고, feature-branch 방식으로 이 레포지토리에 컨텐츠를 업데이트 해주시면 감사하겠습니다.
