...
_Note: 편집할 수 있는 방법이 위 두가지만 있는 것이 아닙니다. 이 가이드를 간단하게 하기 위해, 이 문서는 다른 방법을 심도있게 다루지는 않겠습니다. GitHub 웹 인터페이스나 데스크톱에서 할 수 있는 내용을 할 수 있는 서드파티 소프트웨어가 있습니다._

**_GitHub 웹 인터페이스_ 또는 _GitHub 데스크톱_에서 편집을 진행 했다면, 다음 섹션으로 넘어가 주세요.**
