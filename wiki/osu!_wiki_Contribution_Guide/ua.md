...
8. В заголовку коротко опишіть суть пулл-реквеста: що ви дописуєте або виправляєте. Для простоти можна вказати лише назву статті.
   ...
   Якщо це переклад, вставте перед заголовком пулл-реквеста назву мови, на який ви переводите. Наприклад, `[UA] Github Desktop` означає, що ви оновляєте (або створюєте) переклад [статті про Github Desktop](wiki/owcg/GitHub_Desktop) на українську мову.
