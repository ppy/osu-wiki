...
2.  **Deja que los moderadores manejen los problemas del chat.** Puedes mencionarles algun punto donde infrinjan las reglas usando el comando `!report <username> <motivo>` y ellos se encargarán del resto.
