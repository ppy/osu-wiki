...
2.  **Deja que los moderadores manejen los problemas del chat.** uedes mencionarles algun punto donde infrinjan las reglas usando el comando `!report`, o sino dar la explicación de manera corta, ej. `!report <username> <motivo>`, y ellos se encargarán del resto.
3.  **Si alguien fue silenciado o restringido, Dejalo y no empiecen a hablar al respecto de esa situación.** Si alguien ha sido restringido, su caso solo es responsable por ellos y los administradores del juego - Absolutamente nadie mas!.
...
7.  **Solo comparte enlaces a sitios web con contenido relevante y legal.** Los sitios web de streaming (Crunchyroll, Animelabs) son permitidos, así como cualquier servidor de contenido legal. Sin embargo, los servicios tipo "Warez" (contenido pirata) no son permitidos. Hacer publicidad en el chat sobre canales via Twitch en referencia a otros juegos que no son osu! solo es permitido en `#videogames`.
...
1. **Ningún tema en Off-Topic tiene valor.** Son simplemente, basura. Si tus temas se siguen moviendo a Off-Topic, se juzgará de que no son dignos de una discusión seria, toma el indicio.
2. **La estupidez excesiva es mala.** Ser encarecidamente mudo está bien, y cae en el modus operandi del Shitposting (o Mensajeo-basura o sin sentido), La verdadera estupidez nunca está bien. Si no puedes distinguir la diferencia, ya estás rompiendo la regla.
